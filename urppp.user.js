...
,
        ...
        css += [
          ...
          'html[data-urppp-skin="organic"] #urppp-clean-root .uc-btn,html[data-urppp-skin="organic"] #urppp-clean-root .uc-top-actions .uc-btn,html[data-urppp-skin="organic"] #urppp-clean-root .uc-tabbar button,html[data-urppp-skin="organic"] #urppp-clean-root button.uc-btn{border-radius:12px!important;border:1px solid var(--border)!important;box-shadow:none!important;background:var(--input-bg)!important;color:var(--text)!important;}',
          ...
          'html[data-urppp-skin="organic"] #urppp-clean-root .uc-lesson{border-radius:12px!important;border:1px solid color-mix(in srgb,var(--primary) 22%,var(--border))!important;box-shadow:none!important;}',
          'html[data-urppp-skin="organic"] #urppp-clean-root .uc-grid-cell{border-radius:10px!important;border:1px solid color-mix(in srgb,var(--border) 80%,transparent)!important;box-shadow:none!important;background:var(--input-bg)!important;}',
          'html[data-urppp-skin="organic"] #urppp-clean-root .uc-avatar{border-radius:14px!important;border:1px solid var(--border)!important;}',
