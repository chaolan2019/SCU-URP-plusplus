...
`;function Ec(p){p.querySelectorAll("td, th").forEach(n=>{n.style.removeProperty("background"),n.style.removeProperty("background-color")}),p.querySelectorAll("th[rowspan]").forEach(n=>{n.style.removeProperty("width"),n.style.setProperty("white-space","nowrap"),n.style.setProperty("text-align","center")}),p.querySelectorAll("table").forEach(n=>{n.style.setProperty("background","#ffffff","important"),n.style.setProperty("background-color","#ffffff","important"),n.style.setProperty("border","none","important"),n.style.setProperty("color","#000000","important")}),p.querySelectorAll("th").forEach(n=>{if(n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important"),n.style.setProperty("font-weight","normal","important"),n.childNodes.length===1&&n.firstChild&&n.firstChild.nodeType===3){let c=document.createElement("span");c.textContent=n.textContent,n.textContent="",n.appendChild(c)}}),p.querySelectorAll("thead th").forEach(n=>{n.style.setProperty("background","#dddddd","important"),n.style.setProperty("background-color","#dddddd","important")}),p.querySelectorAll("tbody th").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important")}),p.querySelectorAll("td").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important"),n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important")})}a(Ec,"normalizeNativePdfStage");function Yp(p){let n=Sc(),c=document.createElement("div");c.id="urppp-pdf-stage",c.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(n||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=p.cloneNode(!0);kc(u),Ac(u),d.appendChild(u),c.appendChild(d),Ec(u);let A=document.createElement("style");A.id="urppp-pdf-reset-style",A.textContent=_c,document.head.appendChild(A),document.body.appendChild(c);let P=c.querySelector("#urppp-pdf-mycoursetable"),_=c.querySelector("#urppp-pdf-page")||c;if(!P)throw c.remove(),new Error("无法建立原生课表捕获节点");return{stage:c,target:P,page:_,sourceHost:p}}a(Yp,"cloneNativePdfStage");var oa=0;function de(){return oa>0}a(de,"isNativePdfIsolationActive");function Cc(p){return!p||p.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(p.id||"")||p.hasAttribute("data-urppp-style")?!0:(p.textContent||"").includes("urppp-")}a(Cc,"isUrpppOwnedStyle");function Qp(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(Qp,"defaultPage");function Kp(p,n){let c=p&&typeof p.requestAnimationFrame=="function"?p.requestAnimationFrame.bind(p):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return c?c(n):setTimeout(n,0)}a(Kp,"scheduleFrame");function Pc(p={}){let n=p.document||(typeof document<"u"?document:null),c=p.page||Qp();if(!n)throw new Error("原生 PDF 隔离缺少 document");let d=n.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");oa+=1;let u=[d,...d.querySelectorAll("*")],A=[],P=n.getElementById("soliderbox");P&&A.push(P);let _=d.parentElement;for(;_&&_!==n.documentElement;){let x=_.classList;(_.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&A.push(_),_=_.parentElement}let y=n.getElementById("page-content-template")||n.querySelector(".page-content");y&&!A.includes(y)&&A.push(y);let S=[...u,...A],f=S.map(x=>({element:x,style:x.getAttribute("style")})),w=Array.from(n.querySelectorAll("style")).filter(Cc).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),T=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=c&&c.divBuild,g=c&&c.__urpppOriginalDivBuild,b=!1,v=a(()=>{b||(b=!0,c&&c.divBuild===g&&typeof C=="function"&&(c.divBuild=C),f.forEach(({element:x,style:E})=>{x.isConnected&&(E===null?x.removeAttribute("style"):x.setAttribute("style",E))}),T.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),w.forEach(({style:x,disabled:E,media:q})=>{try{q===null?x.removeAttribute("media"):x.setAttribute("media",q),x.sheet&&(x.sheet.disabled=E)}catch{}}),oa=Math.max(0,oa-1),Kp(c,()=>{try{typeof p.onAfterRestore=="function"&&p.onAfterRestore()}catch{}}))},"restore");try{return w.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),S.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(E=>{x.style.getPropertyPriority(E)==="important"&&(E==="height"&&x.matches("td, th")||x.style.removeProperty(E))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),T.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),c&&typeof g=="function"&&(c.divBuild=g),v}catch(x){throw v(),x}}a(Pc,"isolateScheduleForNativeExport");function Xp(p,n={}){return new Promise((c,d)=>{let u=n.page||Qp(),A=u&&u.back,P=u&&u.html2canvas;if(!p||typeof A!="function"){d(new Error("教务原生导出依赖未就绪"));return}let _=null;try{_=Pc(n)}catch(g){d(g);return}let y=0,S=!1,f=null,w=null,T=a(g=>{if(!S){S=!0,y&&clearTimeout(y),u&&f&&u.back===f&&(u.back=A),w&&u.html2canvas===w&&(u.html2canvas=P);try{_&&_()}catch{}g?d(g):c()}},"settle"),C=a(g=>T(g instanceof Error?g:new Error(String(g))),"fail");typeof P=="function"&&(w=a(function(){let g=P.apply(this,arguments);return g&&typeof g.catch=="function"&&g.catch(C),g},"scopedCanvas"),u.html2canvas=w),f=a(function(){try{return A.apply(this,arguments)}finally{setTimeout(()=>T(),0)}},"wrappedBack"),u.back=f,y=setTimeout(()=>{try{A.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},n.timeoutMs||60*1e3),Kp(u,()=>{try{p.click()}catch(g){C(g)}})})}a(Xp,"exportNativePdfIsolated");var Zp=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
`;var ei=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var ri=`.urppp-export-wrap{position:relative!important;display:inline-flex!important;align-items:center!important;flex:0 0 auto!important;margin-left:7px!important;font-weight:400!important;vertical-align:middle!important;white-space:nowrap!important}
...
`;var oi=`      /* 表格美化：业务表格、分页、公告卡片（table-beautify） */
...
`;var pi=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function ci(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(ci,"createCleanModeState");function di(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(di,"resetCleanModeData");function ui({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(A){p.catalog=p.catalog||[],p.roomError=String(A&&A.message||A),console.warn("[URP++] room catalog",A)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&di(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let A=await n.ensureTermWeekResolved();!p.weekLocked&&A>=1&&(p.viewWeek=A)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(A){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(A)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(A){p.schedule={courses:[],error:String(A&&A.message||A)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}})(),(async()=>{let A=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),A=p.scores,n.reconcileProfileAndScores(),A&&!A.error&&!A.evaluationReady&&n.enrichScoresWithEvaluation(A).then(()=>{p.scores===A&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(ui,"createCleanModeDataLoader");var ar={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},zc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Er={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function bi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(bi,"calToday");function go(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(go,"calDayDiff");function fo(p,n){let c=go(ar[p].start,n);return c<0?0:Math.floor(c/7)+1}a(fo,"calWeekNo");function ho(p){return zc[p]||""}a(ho,"calLunar");function mi(p){return String(p||"").slice(5)}a(mi,"calYY");function Lc(p){let n=p||bi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(Lc,"calActiveTerm");function xo(p,n){let c=p&&ar[p]?p:"autumn",d=ar[c],u=n||bi(),A=d.events.map(f=>({e:f,d:go(u,f.start)})).filter(f=>f.d>=-0).sort((f,w)=>f.d-w.d)[0],P=A?go(u,A.e.start):null,_=fo(c,u),y=Math.max(0,Math.min(100,_/d.weeks*100)),S=u>=d.start;return{term:d,termId:c,next:A,daysLeft:P,weekNo:_,progress:y,started:S,today:u}}a(xo,"calStatus");function gi(p,n){let c=xo(p,n),d=c.next?Er[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(gi,"calendarSummaryHtml");function fi(p,n){let c=xo(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(fi,"calendarSummaryCompactHtml");function hi(p,n){let c=xo(p,n),d=c.next?Er[c.next.e.t].color:"#c9cdd4",u=c.term,A=Object.keys(ar).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${ar[w].name}</button>`).join(""),P=`<div class="cal-widget">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[w].map(C=>{let g=Er[C.t].color,b=C.end&&C.end!==C.start?"~"+mi(C.end):"",v=fo(c.termId,C.start)>0?`第 ${fo(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
          <span class="cal-ev-dot" style="background:${g}"></span>
          <span class="cal-ev-date">${mi(C.start)}${b||""}<em>${ho(C.start)||"&nbsp;"}</em></span>
  ...
  </div>`}a(hi,"calendarModalHtml");function xi(p,n){let c=typeof document<"u"?document:null;if(!c)return;bo();let d=p&&ar[p]?p:Lc(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${hi(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>bo()),u.addEventListener("click",A=>{let P=A.target;if(P&&P.closest&&P.closest(".cal-close")){bo();return}let _=P&&P.closest?P.closest("[data-cal-term]"):null;if(_){let y=u.querySelector(".cal-body");y&&(y.innerHTML=hi(_.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(S=>S.classList.toggle("ac",S.dataset.calTerm===_.dataset.calTerm))}})}a(xi,"openCalendarModal");function bo(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(bo,"closeCalendarModal");function yi(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),xi())})}a(yi,"bindCalendarOpen");var na=!1;function yo(){let p=typeof document<"u"?document:null;if(!p||na)return na;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
...
</svg>`}a(zi,"donutSvg");var $c=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),Mc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',Ic='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function Li({deps:p}){let n=p&&p.palette||$c;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
...
<div class="urppp-sa-grid">
  <section class="urppp-sa-card urppp-sa-trend">
    ...
    <div class="urppp-sa-chart-scroll">${ia({trend:S.trend,palette:n,layout:T})}</div>
  </section>
  <section class="urppp-sa-card urppp-sa-share">
    <h5 class="urppp-sa-card-title">课程类型构成</h5>
    <div class="urppp-sa-share-body">
      <div class="urppp-sa-donut">${zi({items:w.items,requiredRatio:w.requiredRatio,palette:n})}</div>
...
<div class="urppp-sa-grid">
  ...
  `;function _(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(_,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function f(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=_("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=_("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(f,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{f(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",g="urppp_scheme_v1",b="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",M="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",K=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:ft,syncThemeDotGroup:Z}=Ni({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Xt,getAccent:Qt,getBrutalActivePalette:zo,getBrutalPaletteById:pr,getBrutalSelectedPalette:Po,getCurrent:Jt,getScheme:$e,getSkin:Zt,isThemeModeAvailable:or,setBrutalPalette:Lo,skinSupportsDark:Ie,skinSupportsDynamic:Ne,skinSupportsFixedPalettes:Co},settings:{ensureSettingsPanel:an,openSettingsPanel:tn,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let j=document.createElement("li");j.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",j.appendChild(o),r.appendChild(j)}let l=o.closest("li")||o.parentElement,m=Array.from(r.children).find(j=>{let R=j.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",X=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(X)}),h=Array.from(r.children).find(j=>j.classList.contains("light-blue")),k=m||h||null;k&&l&&k!==l&&((l.compareDocumentPosition(k)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,k)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let $=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),$&&s.parentElement!==$&&$.appendChild(s),$&&$.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let B=s.querySelector("#search-input"),z=s.querySelector("form");if(!B||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let D=s.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),B.style.setProperty("display","block","important"),B.style.setProperty("width","100%","important"),B.style.setProperty("height","36px","important"),B.style.setProperty("box-sizing","border-box","important"),B.style.setProperty("padding","0 12px","important"),B.style.setProperty("border","1px solid var(--border)","important"),B.style.setProperty("border-radius","var(--radius-sm)","important"),B.style.setProperty("background","var(--input-bg)","important"),B.style.setProperty("color","var(--text)","important");let J=a(j=>{s.dataset.open=j?"1":"0",s.style.setProperty("width",j?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",j?"1":"0","important"),s.style.setProperty("pointer-events",j?"auto":"none","important"),i.setAttribute("aria-expanded",j?"true":"false"),j&&setTimeout(()=>B.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",j=>{j.preventDefault(),j.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",j=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(j.target)||F?.contains(j.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function N(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,l=0,m=(o+i)/2;if(o!==i){let h=o-i;switch(l=m>.5?h/(2-o-i):h/(o+i),o){case t:s=(e-r)/h+(e<r?6:0);break;case e:s=(r-t)/h+2;break;default:s=(t-e)/h+4;break}s/=6}return{h:s*360,s:l,l:m}}a(N,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,i=o*(1-Math.abs(t/60%2-1)),s=r-o/2,l=0,m=0,h=0;return t<60?(l=o,m=i):t<120?(l=i,m=o):t<180?(m=o,h=i):t<240?(m=i,h=o):t<300?(l=i,h=o):(l=o,h=i),{r:Math.round((l+s)*255),g:Math.round((m+s)*255),b:Math.round((h+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:i,b:s}=Y(t,e,r);return yr(o,i,s)}a(tt,"hslHex");function bt(t){let{r:e,g:r,b:o}=Ze(Gt(t)||mt),i=N(e,r,o);return i.s<.12&&(i.s=.18),i}a(bt,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,i=Math.max(0,Math.min(.95,e));return tt(t,i,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Gt(t)||mt,{h:r,s:o}=bt(e),i=Ft(r),s=Math.min(.72,Math.max(.28,o*.78));return ht(i,s,42)}a(Pt,"companionColor");function It(t,e){let r=Gt(t)||mt,{h:o,s:i}=bt(r),l=zt(e||ot),m=Math.min(.92,Math.max(.35,i*l.chroma)),h=Pt(r),{h:k}=bt(h),$=ht(o,m,l.primaryTone),B=ht(o,m,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),D,J,j;l.whiteCard?(D=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",j="#E5E7EB"):l.duo?(D=Bt(yt(h,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),j=Bt("#E5E7EB",h,.16)):(D=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),j=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?h:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),F=ht(o,Math.min(.45,m*.55),14),X=ye(ht(o,m*.3,34),.88),ut=ye(ht(o,m*.22,46),.76),vt=ye($,.18),Et="0 4px 12px "+ye($,.1)+", 0 1px 2px "+ye($,.05);return{"--bg":D,"--surface":J,"--text":F,"--text-secondary":X,"--text-muted":ut,"--border":j,"--border-focus":$,"--input-bg":R,"--primary":$,"--primary-hover":B,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":h}}a(It,"buildMaterialSchemeVars");function Xt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Xt,"buildSchemePreview");function Te(t){let e=Gt(t)||Qt()||mt;return K.map(r=>Object.assign({},r,Xt(e,r.id)))}a(Te,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Qt(){return Gt(GM_getValue(T,""))||""}a(Qt,"getAccent");function $e(){let t=String(GM_getValue(g,ot)||ot);return K.some(e=>e.id===t)?t:ot}a($e,"getScheme");function la(t){let e=K.some(r=>r.id===t)?t:ot;return GM_setValue(g,e),e}a(la,"setScheme");function Bi(t,e){if(!t)return;let r=Gt(t);if(r){if(GM_setValue(T,r),e&&e.scheme&&la(e.scheme),e&&e.skipTheme){let o=ao(r,.15),i=ye(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",i);try{ft()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{ft()}catch{}try{Dt()}catch{}}}a(Bi,"applyAccent");function ca(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(ca,"getAccentPresets");function Fi(t){let e=Gt(t||Qt()||mt);if(!e)return ca();let r=ca();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(Fi,"saveAccentPreset");function Kt(){try{return!!GM_getValue(b,!1)}catch{return!1}}a(Kt,"isThemeFollowSystem");function Cr(t){return GM_setValue(b,!!t),!!t}a(Cr,"setThemeFollowSystem");function da(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(da,"isCleanDefault");function Di(t){return GM_setValue(v,!!t),!!t}a(Di,"setCleanDefault");function ua(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(ua,"isCleanAnalysisDirect");function ji(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(ji,"setCleanAnalysis");function we(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(we,"isAppleEdgeLine");function Oi(t){return GM_setValue(E,!!t),!!t}a(Oi,"setAppleEdgeLine");function ma(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(ma,"isAutoUpdateCheck");function Hi(t){return GM_setValue(c,!!t),!!t}a(Hi,"setAutoUpdateCheck");function Pr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(Pr,"readJsonSetting");function zr(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(zr,"writeJsonSetting");function ke(){return co(Pr(O,null))}a(ke,"getPrivacySettings");function ha(t){return zr(O,co(t))}a(ha,"setPrivacySettings");function Me(){return _r(Pr(M,null))}a(Me,"getCustomIdentity");function ko(t){return zr(M,_r(t))}a(ko,"setCustomIdentity");function ba(){let t=Pr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ba,"getScheduleFirstMondayMap");function Ao(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ba();r[String(t)]=String(e),zr(H,r)}a(Ao,"rememberScheduleFirstMonday");function Lr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=Pr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},i={enabled:!!o.enabled,mapping:qe(o.mapping||kr)};return et="",i}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:qe(kr)}}}a(Lr,"getScheduleJsonFormatSettings");function So(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:qe(e.mapping||kr)};return et="",zr(G,r)}a(So,"setScheduleJsonFormatSettings");function _o(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(_o,"isHomePage");function qr(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(qr,"isFollowUseDynamic");function ga(t){return GM_setValue(q,!!t),!!t}a(ga,"setFollowUseDynamic");function Ri(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Ri,"systemPrefersDark");function me(){return Ri()&&Ie()?"dark":qr()&&Ne()?"scu-red":"default"}a(me,"resolveFollowThemeName");function or(t,e){return t==="dark"?Ie(e):t==="scu-red"?Ne(e):t==="default"}a(or,"isThemeModeAvailable");function Wt(t,e){e=e||{},!Ie()&&Kt()&&Cr(!1),!Ne()&&qr()&&ga(!1),e.manual&&Cr(!1);let r;e.system||Kt()&&!e.manual?r=me():(r=Ct[t]?t:Jt()||"default",Ct[r]||(r="default")),or(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(w,r),ue();let i=document.getElementById("urppp-theme-vars")||(()=>{let k=document.createElement("style");return k.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(k),k})(),s=Qt(),l=Object.assign({},o.vars);if(r==="scu-red"){let k=s||mt,$=$e();l=Object.assign(l,It(k,$));let B=l["--primary"]||k,z=l["--primary-hover"]||ao(B,.12);document.documentElement.style.setProperty("--urppp-accent",B),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||ye(B,.15)),document.documentElement.style.setProperty("--urppp-seed",k),document.documentElement.style.setProperty("--urppp-scheme",$)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let m=":root {";for(let[k,$]of Object.entries(l))m+=`${k}:${$};`;m+="}",i.textContent=m,document.body&&(document.body.style.fontFamily=o.font);try{let k=document.documentElement;k.dataset.urpppTheme=r,k.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),k.classList.add("urppp-theme-"+r),k.classList.toggle("urppp-theme-follow",Kt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Kt()))}catch{}try{ee()}catch{}try{ft()}catch{}try{Dt()}catch{}try{Go()}catch{}try{Zi()}catch{}let h=document.getElementById("urppp-boot-loader");h&&(h.style.fontFamily=o.font)}a(Wt,"applyTheme");function Jt(){return GM_getValue(w,"default")}a(Jt,"getCurrent");function he(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(he,"themeDownloaded");function nr(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(nr,"localThemes");function Ui(t,e){try{let r=nr();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Ui,"saveLocalTheme");function Wi(t){try{let e=nr();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(Wi,"removeLocalTheme");function fa(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(fa,"storeThemeStyleEl");function Gi(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(Gi,"removeStoreThemeStyle");function Eo(){u.forEach(t=>{let e="urppp_theme_css_"+t.id,r="";try{r=GM_getValue(e,"")||""}catch{}r&&(fa(t.id).textContent=r);let o="";try{o=GM_getValue("urppp_card_css_"+t.id,"")||""}catch{}o&&Oe([{id:t.id,cardCss:o}])});try{ee()}catch{}}a(Eo,"injectAllStoreThemeStyles");function Zt(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||he(e.id))||nr()[t]&&he(t)?t:"apple"}a(Zt,"getSkin");function xa(t,e){let r=t||Zt(),o=u.find(i=>i.id===r);return!!(o&&o[e])}a(xa,"getSkinCapability");function Ie(t){return xa(t,"dark")}a(Ie,"skinSupportsDark");function Ne(t){return xa(t,"dynamic")}a(Ne,"skinSupportsDynamic");function Co(t){return xa(t,"palettes")}a(Co,"skinSupportsFixedPalettes");function pr(t){return Q.find(e=>e.id===t)||Q[0]}a(pr,"getBrutalPaletteById");function Po(){let t=String(GM_getValue(I,"acid")||"acid"),e=pr(t);return e.id===V?pr("acid"):e}a(Po,"getBrutalSelectedPalette");function zo(){let t=String(GM_getValue(L,V)||V);return pr(t)}a(zo,"getBrutalActivePalette");function Lo(t,e){let r=e||{},o=pr(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{ee()}catch{}try{ft()}catch{}try{Dt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}}a(Lo,"setBrutalPalette");function Ji(t){let e=t||Zt();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&we()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&we()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Ji,"getSkinShapeOverrides");function Be(){try{let t=Zt();if(t==="apple")return we()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Be,"urpppCardBorderValue");function ee(){let t=Zt();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&we();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=Ji(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=zo();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=we(),l=s?"1px solid rgba(0,0,0,0.08)":"none",m=s?"1px solid rgba(255,255,255,0.10)":"none",h=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+m+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+h+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let i=document.head||document.documentElement;e.parentNode===i&&i.lastElementChild!==e&&i.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Yt(document)}catch{}},0)}a(ee,"applySkinAttr");function qo(t){let e=u.find(i=>i.id===t&&i.ready&&(i.installed!==!1||he(i.id))),r=!e&&nr()[t]&&he(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||ga(!1),!o.dark&&Kt()&&Cr(!1);let i=Kt(),s=i?me():Jt(),l=or(s,e.id)?s:"default";ee(),Wt(l,{system:i})}catch{try{ee()}catch{}}try{Dt()}catch{}try{ft()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}return!0}a(qo,"setSkin");function Vi(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Kt())try{Wt(me(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(Vi,"bindSystemThemeListener");try{Kt()?Wt(me(),{system:!0}):Wt(Jt())}catch{}try{ee()}catch{}try{Vi()}catch{}function Yi(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let i=e.match(o);if(i)return i[0].trim()}return""}a(Yi,"extractLoginErrorMessage");function To(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(To,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=Yi(e),i=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let m=location.pathname==="/loginEn",h=a((R,F)=>m?F:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      ${i}
    </div>`}a(us,"themeStoreCard");async function Ta(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await ge()).filter(o=>o.type==="theme"&&!he(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Oe(r),e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>us(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>ms(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(Ta,"fetchCatalogThemes");async function ms(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await ge()).find(l=>l.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o=await sn(r);if(o==="fail"){alert("签名校验失败：该条目可能被篡改，已停止下载"),e.disabled=!1,e.textContent="下载";return}if(o==="unknown"&&r._srcPub&&!confirm("该源无有效签名校验，可能被篡改。是否自担风险继续下载？")){e.disabled=!1,e.textContent="下载";return}let i="";for(let l of r.entry)try{let m=await fetch(l,{cache:"no-store"});if(m.ok){i=await m.text();break}}catch{}if(!i){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,i)}catch{}if(r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{fa(t).textContent=i}catch{}try{Oe([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;let s=e.closest&&e.closest(".urppp-store-inline");if(s){try{let l=s.querySelector("#urppp-theme-manage");l&&await Dr(l)}catch{}try{Ta(s)}catch{}}try{Dt()}catch{}}a(ms,"downloadStoreTheme");function hs(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,i=e&&e.repo||t.repo,s=i?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(i)}">仓库</button>`:"",l=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"",m=Zt()===t.id;return`<div class="urppp-skin-card${m?" is-active":""}" data-skin="${at(t.id)}">
    ...
    </div>`}a(nn,"storeManageSettingsHtml");let bs=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];function dr(){try{let t=JSON.parse(GM_getValue("urppp_store_sources","[]"));return Array.isArray(t)?t:[]}catch{return[]}}a(dr,"getCustomSources");function $a(t){try{GM_setValue("urppp_store_sources",JSON.stringify(t))}catch{}}a($a,"saveCustomSources");let Ae=null;async function ge(t){if(Ae&&!t)return Ae;let e=a((k,$)=>Promise.race([k,new Promise((B,z)=>setTimeout(()=>z(new Error("timeout")),$))]),"withTimeout"),r=a(async k=>{try{let $=await e(fetch(k,{cache:"no-store"}),5e3);if(!($&&$.ok))return null;let B=await $.json();return B&&Array.isArray(B.items)?B:null}catch{return null}},"fetchCatalogDoc"),o=null;for(let k of bs){let $=await r(k);if($&&(o=$,$.items.some(B=>B.type==="theme"&&B.cardCss)))break}let i=o&&o.items||[],s=dr().filter(k=>k&&k.url&&k.enabled!==!1),l=await Promise.allSettled(s.map(async k=>{let $=await r(k.url);return{doc:$,pubkey:$?$.pubkey:""}})),m=[...i],h=new Set(m.map(k=>k&&k.id).filter(Boolean));for(let k of l){if(!(k.status==="fulfilled"&&k.value&&k.value.doc))continue;let $=k.value.pubkey||"";for(let B of k.value.doc.items)!B||!B.id||h.has(B.id)||(h.add(B.id),$&&(B._srcPub=$),m.push(B))}return Ae=m,m}a(ge,"fetchCatalogList");let Ma=(function(){try{if(typeof crypto<"u"&&crypto&&crypto.subtle)return crypto.subtle;let t=typeof unsafeWindow<"u"&&unsafeWindow?unsafeWindow:typeof window<"u"?window:null;if(t&&t.crypto&&t.crypto.subtle)return t.crypto.subtle}catch{}return null})();function Ia(t){if(Array.isArray(t))return t.map(Ia);if(t&&typeof t=="object"){let e={};for(let r of Object.keys(t).filter(o=>o!=="signature"&&o!=="_srcPub").sort())e[r]=Ia(t[r]);return e}return t}a(Ia,"normalizeEntry");function pn(t){try{let e=atob(t),r=new Uint8Array(e.length);for(let o=0;o<e.length;o+=1)r[o]=e.charCodeAt(o);return r}catch{return null}}a(pn,"b64ToU8");async function gs(t,e){if(!Ma)return null;if(!e||!t||!t.signature)return!1;try{let r=pn(e);if(!r)return null;let o=await Ma.importKey("raw",r,{name:"Ed25519"},!1,["verify"]),i=pn(t.signature);if(!i)return!1;let s=new TextEncoder().encode(JSON.stringify(Ia(t)));return await Ma.verify({name:"Ed25519"},o,i,s)}catch{return null}}a(gs,"verifyEntrySignature");async function sn(t){let e=t&&t._srcPub;if(!e)return"trust";let r=await gs(t,e);return r===!0?"ok":r===!1?"fail":"unknown"}a(sn,"guardEntrySignature");function ln(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let i=0;i<Math.max(r.length,o.length);i+=1){let s=r[i]||0,l=o[i]||0;if(s!==l)return s>l}return!1}a(ln,"versionGt");function fs(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let i=t.querySelector('[data-theme-use="'+o.id+'"]');i&&ln(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(cn(i.closest(".urppp-skin-card"),"主题"),r+=1);let s=t.querySelector('[data-plugin-id="'+o.id+'"]');if(s){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&ln(o.version,l.version)&&(cn(s.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(fs,"applyStoreUpdateBadges");function cn(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(cn,"addUpdateBadge");function dn(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),i=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");i(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),i()}),r.addEventListener("click",async()=>{r.disabled=!0;let s=r.textContent;r.textContent="检查中…";try{let l=await ge(),m=fs(t,l);r.textContent=m?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=s,r.disabled=!1},1600)})}a(dn,"bindStoreManageSettings");function xs(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${nn()}<button type="button" class="urppp-set-btn ghost" data-add-local-theme style="width:100%;margin:0 0 10px">＋ 添加本地主题</button><input type="file" accept=".css,.txt" data-local-theme-file style="display:none"><div class="urppp-store-bd"><div id="urppp-theme-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div></div>
          <div class="urppp-store-pane" data-pane="sources" style="display:none">${un()}</div>
        </div>
      </div>`,on(t),dn(t),ys(t),mn(t),Ta(t),Dr(t.querySelector("#urppp-theme-manage"))}a(xs,"renderThemeStoreBody");function un(){let t=dr();return`<div class="urppp-src-manage">
    ...
    </div>`}a(un,"storeSourcesHtml");function mn(t){let e=t.querySelector("[data-src-add]");if(e){let r=t.querySelector("[data-src-url]"),o=t.querySelector("[data-src-name]");e.addEventListener("click",async()=>{let i=(r.value||"").trim();if(!i)return;e.disabled=!0;let s=e.textContent;e.textContent="验证中…";try{let l=await fetch(i,{cache:"no-store"});if(!(l&&l.ok))throw new Error("无法访问");let m=await l.json();if(!(m&&Array.isArray(m.items)))throw new Error("不是合法 catalog（无 items）");let h=dr();if(h.some(k=>k.url===i)){alert("该源已存在");return}h.push({name:(o.value||"").trim()||i,url:i,enabled:!0}),$a(h),Ae=null,Na(t)}catch(l){alert("添加失败："+(l&&l.message?l.message:l))}finally{e.disabled=!1,e.textContent=s}})}t.querySelectorAll("[data-src-toggle]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcToggle),i=dr();i[o]&&(i[o].enabled=i[o].enabled===!1,$a(i),Na(t))})),t.querySelectorAll("[data-src-del]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcDel),i=dr();i[o]&&(i.splice(o,1),$a(i),Na(t))}))}a(mn,"bindStoreSources");function Na(t){let e=t.querySelector('[data-pane="sources"]');if(e){let r=t;e.innerHTML=un(),mn(r)}}a(Na,"refreshStoreSources");function ys(t){let e=t.querySelector("[data-add-local-theme]"),r=t.querySelector("[data-local-theme-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text(),s=i.match(/html\[data-urppp-skin="([\w-]+)"\]/);if(!s){alert('未能从 CSS 中识别主题 id（需要 html[data-urppp-skin="…"]）'),r.value="";return}let l=s[1];try{GM_setValue("urppp_theme_css_"+l,i)}catch{}Ui(l,{name:l,desc:"本地主题",author:"本地",version:"1.0.0"});try{fa(l).textContent=i}catch{}r.value="";try{Dr(t.querySelector("#urppp-theme-manage"))}catch{}}))}a(ys,"bindLocalThemeImport");function vs(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
...
`).trim()}a(gn,"extractChangelogRange");function fn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(fn,"ensureUpdateToastStyles");function Cs(t){let e=String(t||"").replace(/\r\n/g,`
