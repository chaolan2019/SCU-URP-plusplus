...
`;function Zp(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(Zp,"createCleanModeState");function ti(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(ti,"resetCleanModeData");function ei({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(k){p.catalog=p.catalog||[],p.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&ti(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let k=await n.ensureTermWeekResolved();!p.weekLocked&&k>=1&&(p.viewWeek=k)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(k){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(k){p.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}})(),(async()=>{let k=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),k=p.scores,n.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&n.enrichScoresWithEvaluation(k).then(()=>{p.scores===k&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(ei,"createCleanModeDataLoader");var ar={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},hc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Sr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function oi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(oi,"calToday");function so(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(so,"calDayDiff");function lo(p,n){let c=so(ar[p].start,n);return c<0?0:Math.floor(c/7)+1}a(lo,"calWeekNo");function po(p){return hc[p]||""}a(po,"calLunar");function ri(p){return String(p||"").slice(5)}a(ri,"calYY");function bc(p){let n=p||oi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(bc,"calActiveTerm");function co(p,n){let c=p&&ar[p]?p:"autumn",d=ar[c],u=n||oi(),k=d.events.map(f=>({e:f,d:so(u,f.start)})).filter(f=>f.d>=-0).sort((f,w)=>f.d-w.d)[0],P=k?so(u,k.e.start):null,S=lo(c,u),y=Math.max(0,Math.min(100,S/d.weeks*100)),A=u>=d.start;return{term:d,termId:c,next:k,daysLeft:P,weekNo:S,progress:y,started:A,today:u}}a(co,"calStatus");function ni(p,n){let c=co(p,n),d=c.next?Sr[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
    ...
    <span class="cal-c-dot" style="background:${c.next?Sr[c.next.e.t].color:"#c9cdd4"}"></span>
  ...
  </button>`}a(pi,"calendarSummaryCompactHtml");function ai(p,n){let c=co(p,n),d=c.next?Sr[c.next.e.t].color:"#c9cdd4",u=c.term,k=Object.keys(ar).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${ar[w].name}</button>`).join(""),P=`<div class="cal-widget">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[w].map(C=>{let h=Sr[C.t].color,m=C.end&&C.end!==C.start?"~"+ri(C.end):"",v=lo(c.termId,C.start)>0?`第 ${lo(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${A(C.start)}">
          ...
          <span class="cal-ev-tag" style="color:${h};background:${h}1a">${Sr[C.t].label}</span>
  ...
  </div>`}a(ai,"calendarModalHtml");function ii(p,n){let c=typeof document<"u"?document:null;if(!c)return;io();let d=p&&ar[p]?p:bc(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
...
<div class="urppp-sa-grid">
  ...
  `;function S(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(S,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function A(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(A,"cleanupPageLoadingOverlays");function f(t){try{let e=t&&t.querySelectorAll?t:document;A(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=S("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=S("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(f,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{f(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",h="urppp_scheme_v1",m="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",_="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",$="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:ft,syncThemeDotGroup:Z}=_i({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Xt,getAccent:Yt,getBrutalActivePalette:Ao,getBrutalPaletteById:nr,getBrutalSelectedPalette:ko,getCurrent:Qt,getScheme:Te,getSkin:Zt,isThemeModeAvailable:or,setBrutalPalette:So,skinSupportsDark:Ie,skinSupportsDynamic:Ne,skinSupportsFixedPalettes:wo},settings:{ensureSettingsPanel:Xo,openSettingsPanel:Vo,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let D=document.createElement("li");D.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",D.appendChild(o),r.appendChild(D)}let l=o.closest("li")||o.parentElement,b=Array.from(r.children).find(D=>{let R=D.querySelector(":scope > a");if(!R)return!1;let B=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return B.includes("customerServiceCenter")||/help|service|support/i.test(B)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),g=Array.from(r.children).find(D=>D.classList.contains("light-blue")),E=b||g||null;E&&l&&E!==l&&((l.compareDocumentPosition(E)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,E)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let M=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),M&&s.parentElement!==M&&M.appendChild(s),M&&M.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let j=s.querySelector("#search-input"),z=s.querySelector("form");if(!j||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let F=s.querySelector(".input-icon");F&&(F.style.setProperty("display","block","important"),F.style.setProperty("position","relative","important")),j.style.setProperty("display","block","important"),j.style.setProperty("width","100%","important"),j.style.setProperty("height","36px","important"),j.style.setProperty("box-sizing","border-box","important"),j.style.setProperty("padding","0 12px","important"),j.style.setProperty("border","1px solid var(--border)","important"),j.style.setProperty("border-radius","var(--radius-sm)","important"),j.style.setProperty("background","var(--input-bg)","important"),j.style.setProperty("color","var(--text)","important");let J=a(D=>{s.dataset.open=D?"1":"0",s.style.setProperty("width",D?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",D?"1":"0","important"),s.style.setProperty("pointer-events",D?"auto":"none","important"),i.setAttribute("aria-expanded",D?"true":"false"),D&&setTimeout(()=>j.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",D=>{D.preventDefault(),D.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",D=>{let R=document.getElementById("form-search"),B=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(D.target)||B?.contains(D.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    <div id="urppp-root">
      ...
      ${i}
    </div>`}a(Zi,"themeStoreCard");async function Pa(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await ke()).filter(o=>o.type==="theme"&&!Me(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Oe(r),e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>Zi(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>ts(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(Pa,"fetchCatalogThemes");async function ts(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await ke()).find(s=>s.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o="";for(let s of r.entry)try{let l=await fetch(s,{cache:"no-store"});if(l.ok){o=await l.text();break}}catch{}if(!o){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,o)}catch{}if(r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{yo(t).textContent=o}catch{}try{Oe([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;let i=e.closest&&e.closest(".urppp-store-inline");if(i){try{let s=i.querySelector("#urppp-theme-manage");s&&await za(s)}catch{}try{Pa(i)}catch{}}try{Dt()}catch{}}a(ts,"downloadStoreTheme");function es(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,i=e&&e.repo||t.repo,s=i?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(i)}">仓库</button>`:"",l=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"",b=Zt()===t.id;return`<div class="urppp-skin-card${b?" is-active":""}" data-skin="${at(t.id)}">
