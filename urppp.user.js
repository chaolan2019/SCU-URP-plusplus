...
`;function mi(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(mi,"createCleanModeState");function hi(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(hi,"resetCleanModeData");function bi({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(A){p.catalog=p.catalog||[],p.roomError=String(A&&A.message||A),console.warn("[URP++] room catalog",A)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&hi(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let A=await n.ensureTermWeekResolved();!p.weekLocked&&A>=1&&(p.viewWeek=A)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(A){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(A)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(A){p.schedule={courses:[],error:String(A&&A.message||A)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}})(),(async()=>{let A=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),A=p.scores,n.reconcileProfileAndScores(),A&&!A.error&&!A.evaluationReady&&n.enrichScoresWithEvaluation(A).then(()=>{p.scores===A&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(bi,"createCleanModeDataLoader");var nr={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},qc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Cr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function xi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(xi,"calToday");function go(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(go,"calDayDiff");function xo(p,n){let c=go(nr[p].start,n);return c<0?0:Math.floor(c/7)+1}a(xo,"calWeekNo");function bo(p){return qc[p]||""}a(bo,"calLunar");function fi(p){return String(p||"").slice(5)}a(fi,"calYY");function Tc(p){let n=p||xi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(Tc,"calActiveTerm");function yo(p,n){let c=p&&nr[p]?p:"autumn",d=nr[c],u=n||xi(),A=d.events.map(g=>({e:g,d:go(u,g.start)})).filter(g=>g.d>=-0).sort((g,w)=>g.d-w.d)[0],P=A?go(u,A.e.start):null,_=xo(c,u),y=Math.max(0,Math.min(100,_/d.weeks*100)),S=u>=d.start;return{term:d,termId:c,next:A,daysLeft:P,weekNo:_,progress:y,started:S,today:u}}a(yo,"calStatus");function yi(p,n){let c=yo(p,n),d=c.next?Cr[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(vi,"calendarSummaryCompactHtml");function gi(p,n){let c=yo(p,n),d=c.next?Cr[c.next.e.t].color:"#c9cdd4",u=c.term,A=Object.keys(nr).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${nr[w].name}</button>`).join(""),P=`<div class="cal-widget">
  ...
  </div>`,_=u.events.slice().sort((w,T)=>w.start<T.start?-1:1),y={};_.forEach(w=>{(y[w.start.slice(0,7)]=y[w.start.slice(0,7)]||[]).push(w)});let S=a(w=>w===c.today?" cal-today":"","todayFlag"),g=Object.keys(y).map(w=>{let[,T]=w.split("-");return`<div class="cal-mon">
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${q?"":" hidden"}>${A()}</div>
      ...
      </button>`).join("")}</div>`}a(g,"servicesHtml");function w(){let x=n.personalizedProfile(p.profile||{}),E=p.schedule&&p.schedule.courses||[],q=p.scores&&p.scores.passing&&p.scores.passing[0]||{summary:n.summarizeCourses([])},I=p.scores&&p.scores.schemes||[];p.scores&&p.scores.majorIdx!=null&&p._schemeInited!==!0&&(p.activeSchemeIdx=p.scores.majorIdx||0,p._schemeInited=!0);let L=I[p.activeSchemeIdx]||I[0]||{summary:n.summarizeCourses([]),title:"方案成绩"},O=x.avatar?`<img src="${n.escapeHtml(x.avatar)}" alt="">`:`<span>${n.escapeHtml((x.name||"同")[0])}</span>`,M=p.loading.scores?'<div class="uc-loading">成绩加载中</div>':p.scores&&p.scores.error?`<div class="uc-empty">${n.escapeHtml(p.scores.error)}</div>`:`<div class="uc-score-grid">
      ...
      <div class="uc-occ"><table class="uc-occ-table">${q}${I}</table></div>`}a(f,"occupancyHtml");function b(){let x=n.ensureRoot(),E=x.querySelector("#uc-body");n.getViewWeekNumber();let q=typeof window<"u"&&window.matchMedia?window.matchMedia:null,I=q&&q("(max-width:900px)").matches,L=!p.uiReady;E.innerHTML=I?T():w(),L?(p.uiReady=!0,x.classList.remove("uc-settled"),clearTimeout(x.__ucSettleTimer),x.__ucSettleTimer=setTimeout(()=>{p.open&&x.classList.add("uc-settled")},480)):x.classList.add("uc-settled"),n.bindUI(E),n.applyPersonalDisplay(E)}a(b,"render");function v(){if(!p.open||c)return;let x=a(()=>{c=0,p.open&&b()},"run"),E=typeof requestAnimationFrame=="function"?requestAnimationFrame:null;c=E?E(x):setTimeout(x,0)}return a(v,"scheduleRender"),{analysisHtml:A,metricHtml:u,occupancyHtml:f,render:b,renderScheduleBoard:y,roomPickerHtml:C,scheduleRender:v,scoreSectionHtml:P}}a(_i,"createCleanModeRenderer");function Ei({state:p,deps:n}){function c(w,T){return!w||(w.__urpppCleanUiBindings||(w.__urpppCleanUiBindings=new Set),w.__urpppCleanUiBindings.has(T))?!1:(w.__urpppCleanUiBindings.add(T),!0)}a(c,"markCleanUiBound");function d(w){if(!w)return;try{n.bindScheduleExportHosts(w)}catch(C){console.warn("[URP++] schedule export menu",C)}w.querySelectorAll("[data-score]").forEach(C=>{c(C,"score")&&C.addEventListener("click",()=>_(C.getAttribute("data-score")))}),w.querySelectorAll("[data-sa-tab]").forEach(C=>{c(C,"saTab")&&C.addEventListener("click",()=>{p.scoreAnalysisTab=C.getAttribute("data-sa-tab")==="analysis"?"analysis":"overview",n.render()})}),w.querySelectorAll("[data-href]").forEach(C=>{c(C,"href")&&C.addEventListener("click",f=>{let b=C.getAttribute("data-href");b&&(f.preventDefault(),n.closeCleanMode(),location.href=b)})}),w.querySelectorAll("[data-eval-url]").forEach(C=>{c(C,"eval")&&C.addEventListener("click",f=>{let b=C.getAttribute("data-eval-url");b&&(f.preventDefault(),f.stopPropagation(),n.closeCleanMode(),location.href=b)})}),w.querySelectorAll('[data-action="room"]').forEach(C=>{c(C,"room")&&C.addEventListener("click",()=>y())}),w.querySelectorAll("[data-room-reload]").forEach(C=>{c(C,"roomReload")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),n.ensureRoomCatalogLoaded(!0)})}),w.querySelectorAll("[data-build-path]").forEach(C=>{c(C,"building")&&C.addEventListener("click",async()=>{let f=C.getAttribute("data-build-path"),b=(C.textContent||"").trim(),v=C.getAttribute("data-cn")||"",x=C.getAttribute("data-bn")||"",E=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;p.roomDateOffset=0,await g({path:f,name:b,campusNumber:v,buildingNumber:x,dateOffset:0},b,E)})}),w.querySelectorAll("[data-room-day]").forEach(C=>{c(C,"roomDay")&&C.addEventListener("click",async f=>{f.preventDefault(),f.stopPropagation();let b=parseInt(C.getAttribute("data-room-day")||"0",10)||0;if(!p.currentBuilding)return;p.roomDateOffset=b;let v=Object.assign({},p.currentBuilding,{dateOffset:b}),x=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;await g(v,v.name||"",x)})});let T=w.querySelector("#uc-room-back");T&&(T.onclick=()=>{p.occupancy=null,p.currentBuilding=null;let C=T.closest("#uc-room-panel")||document.querySelector("#uc-room-panel")||document.querySelector("#uc-modal-body");C&&C.id==="uc-modal-body"||C&&C.id==="uc-room-panel"?(C.innerHTML=n.roomPickerHtml(),d(C)):n.render()}),w.querySelectorAll(".uc-slot.busy[data-occ]").forEach(C=>{c(C,"occupancy")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();try{let b=JSON.parse(C.getAttribute("data-occ")||"{}");A("占用详情",`
          ...
          `,"")}catch{}})}),w.querySelectorAll("[data-week-delta]").forEach(C=>{c(C,"weekDelta")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();let b=parseInt(C.getAttribute("data-week-delta")||"0",10)||0,v=p.schedule&&p.schedule.courses||[],x=n.inferMaxWeek(v),E=n.getViewWeekNumber();p.weekLocked=!0,p.viewWeek=Math.min(x,Math.max(1,E+b)),n.render();let q=document.querySelector("#urppp-clean-root .uc-week-label");q&&(q.classList.remove("uc-pop"),q.offsetWidth,q.classList.add("uc-pop"))})}),w.querySelectorAll("[data-week-reset]").forEach(C=>{c(C,"weekReset")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),p.weekLocked=!1;let b=n.getCurrentWeekNumber()||p._termWeek||1;p.viewWeek=b,n.render();let v=document.querySelector("#urppp-clean-root .uc-week-label");v&&(v.classList.remove("uc-pop"),v.offsetWidth,v.classList.add("uc-pop"))})})}a(d,"bindUI");let u=[];function A(w,T,C,f){f=f||{};let b=n.ensureRoot(),v=b.querySelector("#uc-mask"),x=b.querySelector("#uc-modal");f.stack&&x.classList.contains("open")?u.push({title:b.querySelector("#uc-modal-title").textContent,body:b.querySelector("#uc-modal-body").innerHTML,ft:b.querySelector("#uc-modal-ft").innerHTML}):f.stack||(u.length=0),v.classList.add("open"),x.classList.add("open"),b.querySelector("#uc-modal-title").textContent=w,b.querySelector("#uc-modal-body").innerHTML=T,b.querySelector("#uc-modal-ft").innerHTML=C||"",d(b.querySelector("#uc-modal-body")),d(b.querySelector("#uc-modal-ft")),n.applyPersonalDisplay(b.querySelector("#uc-modal"))}a(A,"openModal");function P(){let w=n.rootEl();if(w){if(u.length){let T=u.pop();w.querySelector("#uc-modal-title").textContent=T.title,w.querySelector("#uc-modal-body").innerHTML=T.body,w.querySelector("#uc-modal-ft").innerHTML=T.ft||"",d(w.querySelector("#uc-modal-body")),d(w.querySelector("#uc-modal-ft"));return}w.querySelector("#uc-mask").classList.remove("open"),w.querySelector("#uc-modal").classList.remove("open")}}a(P,"closeModal");function _(w){let T=p.scores&&p.scores.passing&&p.scores.passing[0]||{courses:[],summary:n.summarizeCourses([])},C=p.scores&&p.scores.schemes||[];w==="scheme"&&p.scores&&p.scores.majorIdx!=null&&p._schemeInited!==!0&&(p.activeSchemeIdx=p.scores.majorIdx||0,p._schemeInited=!0);let f=C[p.activeSchemeIdx]||C[0]||{courses:[],summary:n.summarizeCourses([]),title:"方案成绩"},b=w==="scheme"?f:T,v=w==="scheme"?"scheme":"passing";p.selected[v]||(p.selected[v]=new Set);let x=w==="scheme"&&C.length>1?`<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">${C.map((Z,dt)=>`<button type="button" class="uc-btn ${dt===p.activeSchemeIdx?"primary":""}" data-scheme-idx="${dt}"><span data-urppp-private="organization">${n.escapeHtml((Z.title||"方案").slice(0,28))}</span></button>`).join("")}</div>`:"",E=a(Z=>{let dt=!!(Z&&(Z.unevaluated||n.isUnevaluatedScore(Z.score))),kt=n.scoreToNumber(Z&&Z.score),wt="";dt?wt=kt!=null&&kt<60?"uneval-fail":"uneval":kt!=null?wt=kt>=60?"pass":"fail":/不及格|不合格|不通过/.test(String(Z&&Z.score||""))?wt="fail":Z&&Z.score&&(wt="pass");let Ct=n.escapeHtml(Z&&Z.score||"—"),N=dt?Z.evalUrl||"/student/teachingEvaluation/newEvaluation/index":"";return N?`<span class="uc-score-cell ${wt}" data-eval-url="${n.escapeHtml(N)}" title="未评教，点击前往评教">${Ct}</span>`:`<span class="uc-score-cell ${wt}">${Ct}</span>`},"scoreCellHtml"),q=(b.courses||[]).map((Z,dt)=>{let kt=p.selected[v].has(dt),wt=n.isValidOfficialGpa(Z.officialGpa)?Z.officialGpa:n.scoreToGpa(Z.score),Ct=!!(Z.unevaluated||n.isUnevaluatedScore(Z.score));return`<tr class="${kt?"is-on":""}${Ct?" is-uneval":""}" data-idx="${dt}">
      ...
      </tr>`}).join("");A(w==="scheme"?"方案成绩 · "+(f.title||""):"全部及格成绩",`
    ...
    `,P.appendChild(g);let w=P.querySelector("#warningInfo");w&&document.body.appendChild(w),_.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let T=g.querySelector("#urppp-stats"),C=Math.max(S.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',T.appendChild(E)}function f(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&(T.innerHTML="",x.forEach(E=>{let q=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),I=q[0]||"",L=q.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),M=/[\u4e00-\u9fa5]/.test(I)||I.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=p.statCardPrivacyMarkup(I,L);G.innerHTML=`<div class="${M}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,T.appendChild(G)}))}if(a(f,"updateStats"),f(),y){let x=new MutationObserver(()=>f());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let b=g.querySelector("#urppp-left"),v=g.querySelector("#urppp-right");u(_[5],b,"我的日程安排"),u(_[0],v,"通知公告"),u(_[1],v,"我的待办任务"),u(_[2],v,"可申请业务"),u(_[3],v,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(A,"rebuildDashboard"),{rebuildDashboard:A,refreshHomeFullCalendar:c,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(Pi,"createDashboardController");function ve(p){return Math.round((Number(p)||0)*100)/100}a(ve,"round2");var $c=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],zi={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},Mc=[{key:"required",label:"必修",test:a(p=>/必修/.test(p),"test")},{key:"elective",label:"任选",test:a(p=>/任选/.test(p),"test")},{key:"optional",label:"选修",test:a(p=>/选修/.test(p),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function Li(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d+)/);return n?`${n[1].slice(2)}-${n[2].slice(2)}-${n[3]}`:String(p||"")}a(Li,"shortTerm");function sa({deps:p}){let n=p.scoreToNumber,c=p.scoreToGpa;function d(f){let b=n(f);if(b!=null)return b;let v=String(f||"").trim().toUpperCase();return zi[v]!=null?zi[v]:null}a(d,"scoreToNumberWithLevels");function u(f){return!f||f.unevaluated?!1:d(f.score)!=null}a(u,"hasScore");function A(f){let b=String(f||"").match(/^(\d{4})-(\d{4})-(\d+)/);return b?[Number(b[1]),Number(b[3])]:[9999,9999]}a(A,"termOrderKey");function P(f){let b=f&&f.passing&&f.passing[0];return b&&b.courses||[]}a(P,"allCourses");function _(f){let b=f&&f.officialGpa,v=Number(b);return b!=null&&Number.isFinite(v)&&v>=0&&v<=5?v:null}a(_,"officialGpa");function y(f){let b=_(f);return b??c(f.score)}a(y,"courseGpa");function S({scorePack:f,profile:b}){let v=P(f),x=b&&b.majorGpa?String(b.majorGpa).trim():"",E=0,q=0,I=0,L=0,O=0,M=0;return v.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,q+=U*G;let et=y(H);et!=null&&(I+=et*G,L+=G,H.required&&(O+=et*G,M+=G))}),{majorGpa:x,requiredGpa:ve(M?O/M:0),avgGpa:ve(L?I/L:0),avgScore:ve(E?q/E:0),totalCredit:ve(E),courseCount:v.length}}a(S,"computeMetrics");function g(f){let b=new Map;return(f||[]).forEach(v=>{if(!u(v))return;let x=v.term||"未分组",E=b.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},b.set(x,E));let q=Number(v.credit)||0,I=d(v.score);if(I==null||(E.count+=1,q<=0))return;E.credit+=q,E.scoreW+=I*q;let L=y(v);L!=null&&(E.gpaW+=L*q,E.gpaCredit+=q)}),Array.from(b.values()).map(v=>({term:v.term,label:Li(v.term),count:v.count,credit:ve(v.credit),avgScore:ve(v.credit?v.scoreW/v.credit:0),avgGpa:ve(v.gpaCredit?v.gpaW/v.gpaCredit:0)})).sort((v,x)=>{let E=A(v.term),q=A(x.term);return E[0]-q[0]||E[1]-q[1]})}a(g,"computeTrend");function w(f){let b=$c.map(x=>({...x,count:0,credit:0}));(f||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let q=b.find(I=>E>=I.min&&E<=I.max);q&&(q.count+=1,q.credit+=Number(x.credit)||0)});let v=b.reduce((x,E)=>Math.max(x,E.count),1);return b.map(x=>({...x,ratio:Math.round(x.count/v*100)}))}a(w,"computeBands");function T(f){let b=Mc.map(q=>({...q,credit:0,count:0}));(f||[]).forEach(q=>{if(!u(q))return;let I=String(q.attr||""),L=b.find(O=>O.test(I));L&&(L.credit+=Number(q.credit)||0,L.count+=1)});let v=b.reduce((q,I)=>q+I.credit,0)||1,x=b.filter(q=>q.count>0).map(q=>({key:q.key,label:q.label,credit:ve(q.credit),count:q.count,ratio:Math.round(q.credit/v*100)})),E=x.find(q=>q.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a(T,"computeShare");function C({scorePack:f,profile:b}){let v=P(f);return{metrics:S({scorePack:f,profile:b}),trend:g(v),bands:w(v),share:T(v),empty:v.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:_,scoreToNumberWithLevels:d,shortTerm:Li}}a(sa,"createScoreAnalysisData");var ne="var(--text-secondary)",ko="var(--border)";function pe(p){return at(String(p??""))}a(pe,"escapeLabel");function qi(p,n,c){let d=!!(p&&p.variant==="mobile");if(n==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},_=Math.max(56,Number(p&&p.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,c)*_),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},A=Math.max(44,Number(p&&p.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,c)*A),height:236,pad:u}}a(qi,"resolveChartLayout");function wo({width:p,height:n,mobile:c,kind:d,label:u}){let A=c?` data-urppp-chart-layout="mobile" style="width:max(100%,${p}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${p} ${n}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${A}>`}a(wo,"openSvg");function la({trend:p,palette:n,layout:c}){let d=(p||[]).filter(rt=>rt&&rt.avgScore!=null),u=qi(c,"trend",d.length),{width:A,height:P,pad:_,mobile:y}=u,S=A-_.left-_.right,g=P-_.top-_.bottom;if(!d.length)return`${wo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let w=d.length,T=a(rt=>_.left+(rt+.5)*(S/w),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),f=d.map(rt=>Number(rt.avgScore)||0),b=d.map(rt=>Number(rt.credit)||0),v=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...f)-4),q=Math.min(100,Math.max(...f)+4),I=Math.max(1,...b),L=x-v||1,O=q-E||1,M=a(rt=>_.top+g-(rt-v)/L*g,"yGpa"),H=a(rt=>_.top+g-(rt-E)/O*g,"yScore"),G=a(rt=>_.top+g-rt/I*g*.9,"yCredit"),U=d.map((rt,st)=>`${T(st)},${M(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${T(st)},${H(rt.avgScore)}`).join(" "),it=[0,.25,.5,.75,1].map(rt=>{let st=_.top+g-rt*g;return`<line x1="${_.left}" y1="${st.toFixed(1)}" x2="${A-_.right}" y2="${st.toFixed(1)}" stroke="${ko}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),mt=d.map((rt,st)=>{let gt=T(st),Z=y?Math.min(30,S/w*.42):Math.min(26,S/w*.32),dt=G(rt.credit);return`<rect x="${(gt-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(_.top+g-dt).toFixed(1)}" rx="3" fill="${n.credit}" opacity="0.55"/>
<text x="${gt.toFixed(1)}" y="${(dt-4).toFixed(1)}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.credit)}</text>`}).join(""),V=d.map((rt,st)=>`<text x="${T(st).toFixed(1)}" y="${P-16}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.label)}</text>`).join(""),Q=d.map((rt,st)=>{let gt=S/w,Z=T(st)-gt/2,dt=[`学期 ${rt.label}`,`课程 ${rt.count} 门`,`修读学分 ${rt.credit}`,`加权均分 ${rt.avgScore}`,`平均绩点 ${rt.avgGpa}`].join(`
`);return`<rect class="urppp-sa-hover" x="${Z.toFixed(1)}" y="${_.top}" width="${gt.toFixed(1)}" height="${g.toFixed(1)}" fill="transparent"><title>${pe(dt)}</title></rect>`}).join(""),ot=d.map((rt,st)=>`<circle cx="${T(st).toFixed(1)}" cy="${M(rt.avgGpa).toFixed(1)}" r="3.5" fill="${n.gpaLine}"/><text x="${T(st).toFixed(1)}" y="${(M(rt.avgGpa)-9).toFixed(1)}" text-anchor="middle" font-size="11.5" font-weight="600" fill="${n.gpaLine}">${pe(rt.avgGpa)}</text>`).join(""),X=d.map((rt,st)=>`<circle cx="${T(st).toFixed(1)}" cy="${H(rt.avgScore).toFixed(1)}" r="3" fill="${n.scoreLine}"/><text x="${T(st).toFixed(1)}" y="${(H(rt.avgScore)+17).toFixed(1)}" text-anchor="middle" font-size="11.5" fill="${n.scoreLine}">${pe(rt.avgScore)}</text>`).join(""),ct=y?`<g font-size="12">
...
<g>${V}</g>
${ct}
</svg>`}a(la,"trendChartSvg");function ca({bands:p,palette:n,layout:c}){let d=p||[],u=qi(c,"bands",d.length),{width:A,height:P,pad:_,mobile:y}=u,S=A-_.left-_.right,g=P-_.top-_.bottom,w=d.length||1,T=Math.max(1,...d.map(b=>b.count)),C=y?Math.min(32,S/w*.62):Math.min(40,S/w*.52),f=d.map((b,v)=>{let x=_.left+(v+.5)*(S/w),E=b.count?Math.max(8,b.count/T*g):0,q=_.top+g-E,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=b.range||(b.min===0?"<60":`${b.min}-${b.max===100?"100":b.max}`),O=[`${b.level||""}（绩点 ${b.gpa}）`,`百分制 ${L}`,`课程 ${b.count} 门`].join(`
...
${f}
</svg>`}a(ca,"bandsChartSvg");function Ti({items:p,requiredRatio:n,palette:c}){let _=2*Math.PI*56,y=(p||[]).filter(T=>T&&T.ratio>0),S=Math.max(0,Math.min(100,Math.round(Number(n)||0)));if(!y.length)return'<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成"></svg>';let g=-90,w=y.map(T=>{let C=T.ratio/100*_,b=`<circle cx="75" cy="75" r="56" fill="none" stroke="${c.share&&c.share[T.key]||c.required}" stroke-width="24"
...
<div class="urppp-sa-grid">
  ...
  `;function _(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(_,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function g(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=_("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=_("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(g,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{g(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",f="urppp_scheme_v1",b="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",M="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:gt,syncThemeDotGroup:Z}=Di({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Kt,getAccent:Qt,getBrutalActivePalette:qo,getBrutalPaletteById:ir,getBrutalSelectedPalette:Lo,getCurrent:Jt,getScheme:$e,getSkin:Zt,isThemeModeAvailable:pr,setBrutalPalette:To,skinSupportsDark:Ne,skinSupportsDynamic:Be,skinSupportsFixedPalettes:zo},settings:{ensureSettingsPanel:nn,openSettingsPanel:rn,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let j=document.createElement("li");j.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",j.appendChild(o),r.appendChild(j)}let l=o.closest("li")||o.parentElement,m=Array.from(r.children).find(j=>{let R=j.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),h=Array.from(r.children).find(j=>j.classList.contains("light-blue")),k=m||h||null;k&&l&&k!==l&&((l.compareDocumentPosition(k)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,k)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let $=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),$&&s.parentElement!==$&&$.appendChild(s),$&&$.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let B=s.querySelector("#search-input"),z=s.querySelector("form");if(!B||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let D=s.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),B.style.setProperty("display","block","important"),B.style.setProperty("width","100%","important"),B.style.setProperty("height","36px","important"),B.style.setProperty("box-sizing","border-box","important"),B.style.setProperty("padding","0 12px","important"),B.style.setProperty("border","1px solid var(--border)","important"),B.style.setProperty("border-radius","var(--radius-sm)","important"),B.style.setProperty("background","var(--input-bg)","important"),B.style.setProperty("color","var(--text)","important");let J=a(j=>{s.dataset.open=j?"1":"0",s.style.setProperty("width",j?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",j?"1":"0","important"),s.style.setProperty("pointer-events",j?"auto":"none","important"),i.setAttribute("aria-expanded",j?"true":"false"),j&&setTimeout(()=>B.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",j=>{j.preventDefault(),j.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",j=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(j.target)||F?.contains(j.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function N(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,l=0,m=(o+i)/2;if(o!==i){let h=o-i;switch(l=m>.5?h/(2-o-i):h/(o+i),o){case t:s=(e-r)/h+(e<r?6:0);break;case e:s=(r-t)/h+2;break;default:s=(t-e)/h+4;break}s/=6}return{h:s*360,s:l,l:m}}a(N,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,i=o*(1-Math.abs(t/60%2-1)),s=r-o/2,l=0,m=0,h=0;return t<60?(l=o,m=i):t<120?(l=i,m=o):t<180?(m=o,h=i):t<240?(m=i,h=o):t<300?(l=i,h=o):(l=o,h=i),{r:Math.round((l+s)*255),g:Math.round((m+s)*255),b:Math.round((h+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:i,b:s}=Y(t,e,r);return vr(o,i,s)}a(tt,"hslHex");function bt(t){let{r:e,g:r,b:o}=er(Gt(t)||mt),i=N(e,r,o);return i.s<.12&&(i.s=.18),i}a(bt,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,i=Math.max(0,Math.min(.95,e));return tt(t,i,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Gt(t)||mt,{h:r,s:o}=bt(e),i=Ft(r),s=Math.min(.72,Math.max(.28,o*.78));return ht(i,s,42)}a(Pt,"companionColor");function It(t,e){let r=Gt(t)||mt,{h:o,s:i}=bt(r),l=zt(e||ot),m=Math.min(.92,Math.max(.35,i*l.chroma)),h=Pt(r),{h:k}=bt(h),$=ht(o,m,l.primaryTone),B=ht(o,m,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),D,J,j;l.whiteCard?(D=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",j="#E5E7EB"):l.duo?(D=Bt(yt(h,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),j=Bt("#E5E7EB",h,.16)):(D=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),j=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?h:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),F=ht(o,Math.min(.45,m*.55),14),K=ye(ht(o,m*.3,34),.88),ut=ye(ht(o,m*.22,46),.76),vt=ye($,.18),Et="0 4px 12px "+ye($,.1)+", 0 1px 2px "+ye($,.05);return{"--bg":D,"--surface":J,"--text":F,"--text-secondary":K,"--text-muted":ut,"--border":j,"--border-focus":$,"--input-bg":R,"--primary":$,"--primary-hover":B,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":h}}a(It,"buildMaterialSchemeVars");function Kt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Kt,"buildSchemePreview");function Te(t){let e=Gt(t)||Qt()||mt;return X.map(r=>Object.assign({},r,Kt(e,r.id)))}a(Te,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Qt(){return Gt(GM_getValue(T,""))||""}a(Qt,"getAccent");function $e(){let t=String(GM_getValue(f,ot)||ot);return X.some(e=>e.id===t)?t:ot}a($e,"getScheme");function da(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(f,e),e}a(da,"setScheme");function ji(t,e){if(!t)return;let r=Gt(t);if(r){if(GM_setValue(T,r),e&&e.scheme&&da(e.scheme),e&&e.skipTheme){let o=oo(r,.15),i=ye(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",i);try{gt()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{gt()}catch{}try{Dt()}catch{}}}a(ji,"applyAccent");function ua(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(ua,"getAccentPresets");function Oi(t){let e=Gt(t||Qt()||mt);if(!e)return ua();let r=ua();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(Oi,"saveAccentPreset");function Xt(){try{return!!GM_getValue(b,!1)}catch{return!1}}a(Xt,"isThemeFollowSystem");function Pr(t){return GM_setValue(b,!!t),!!t}a(Pr,"setThemeFollowSystem");function ma(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(ma,"isCleanDefault");function Hi(t){return GM_setValue(v,!!t),!!t}a(Hi,"setCleanDefault");function ha(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(ha,"isCleanAnalysisDirect");function Ri(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(Ri,"setCleanAnalysis");function we(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(we,"isAppleEdgeLine");function Ui(t){return GM_setValue(E,!!t),!!t}a(Ui,"setAppleEdgeLine");function ba(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(ba,"isAutoUpdateCheck");function Wi(t){return GM_setValue(c,!!t),!!t}a(Wi,"setAutoUpdateCheck");function zr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(zr,"readJsonSetting");function Lr(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(Lr,"writeJsonSetting");function ke(){return uo(zr(O,null))}a(ke,"getPrivacySettings");function fa(t){return Lr(O,uo(t))}a(fa,"setPrivacySettings");function Me(){return Er(zr(M,null))}a(Me,"getCustomIdentity");function Ao(t){return Lr(M,Er(t))}a(Ao,"setCustomIdentity");function ga(){let t=zr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ga,"getScheduleFirstMondayMap");function So(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ga();r[String(t)]=String(e),Lr(H,r)}a(So,"rememberScheduleFirstMonday");function qr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=zr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},i={enabled:!!o.enabled,mapping:qe(o.mapping||Ar)};return et="",i}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:qe(Ar)}}}a(qr,"getScheduleJsonFormatSettings");function _o(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:qe(e.mapping||Ar)};return et="",Lr(G,r)}a(_o,"setScheduleJsonFormatSettings");function Eo(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(Eo,"isHomePage");function Tr(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(Tr,"isFollowUseDynamic");function xa(t){return GM_setValue(q,!!t),!!t}a(xa,"setFollowUseDynamic");function Gi(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Gi,"systemPrefersDark");function me(){return Gi()&&Ne()?"dark":Tr()&&Be()?"scu-red":"default"}a(me,"resolveFollowThemeName");function pr(t,e){return t==="dark"?Ne(e):t==="scu-red"?Be(e):t==="default"}a(pr,"isThemeModeAvailable");function Wt(t,e){e=e||{},!Ne()&&Xt()&&Pr(!1),!Be()&&Tr()&&xa(!1),e.manual&&Pr(!1);let r;e.system||Xt()&&!e.manual?r=me():(r=Ct[t]?t:Jt()||"default",Ct[r]||(r="default")),pr(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(w,r),ue();let i=document.getElementById("urppp-theme-vars")||(()=>{let k=document.createElement("style");return k.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(k),k})(),s=Qt(),l=Object.assign({},o.vars);if(r==="scu-red"){let k=s||mt,$=$e();l=Object.assign(l,It(k,$));let B=l["--primary"]||k,z=l["--primary-hover"]||oo(B,.12);document.documentElement.style.setProperty("--urppp-accent",B),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||ye(B,.15)),document.documentElement.style.setProperty("--urppp-seed",k),document.documentElement.style.setProperty("--urppp-scheme",$)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let m=":root {";for(let[k,$]of Object.entries(l))m+=`${k}:${$};`;m+="}",i.textContent=m,document.body&&(document.body.style.fontFamily=o.font);try{let k=document.documentElement;k.dataset.urpppTheme=r,k.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),k.classList.add("urppp-theme-"+r),k.classList.toggle("urppp-theme-follow",Xt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Xt()))}catch{}try{ee()}catch{}try{gt()}catch{}try{Dt()}catch{}try{Vo()}catch{}try{es()}catch{}let h=document.getElementById("urppp-boot-loader");h&&(h.style.fontFamily=o.font)}a(Wt,"applyTheme");function Jt(){return GM_getValue(w,"default")}a(Jt,"getCurrent");function he(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(he,"themeDownloaded");function Ie(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(Ie,"localThemes");function Co(t,e){try{let r=Ie();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Co,"saveLocalTheme");function Ji(t){try{let e=Ie();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(Ji,"removeLocalTheme");function ya(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(ya,"storeThemeStyleEl");function Vi(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(Vi,"removeStoreThemeStyle");function Po(){let t=new Set,e=a(r=>{if(t.has(r))return;t.add(r);let o="";try{o=GM_getValue("urppp_theme_css_"+r,"")||""}catch{}o&&(ya(r).textContent=o);let i="";try{i=GM_getValue("urppp_card_css_"+r,"")||""}catch{}i&&He([{id:r,cardCss:i}])},"injectOne");u.forEach(r=>e(r.id)),Object.keys(Ie()).forEach(r=>e(r));try{ee()}catch{}}a(Po,"injectAllStoreThemeStyles");function Zt(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||he(e.id))||Ie()[t]&&he(t)?t:"apple"}a(Zt,"getSkin");function va(t,e){let r=t||Zt(),o=u.find(i=>i.id===r);return!!(o&&o[e])}a(va,"getSkinCapability");function Ne(t){return va(t,"dark")}a(Ne,"skinSupportsDark");function Be(t){return va(t,"dynamic")}a(Be,"skinSupportsDynamic");function zo(t){return va(t,"palettes")}a(zo,"skinSupportsFixedPalettes");function ir(t){return Q.find(e=>e.id===t)||Q[0]}a(ir,"getBrutalPaletteById");function Lo(){let t=String(GM_getValue(I,"acid")||"acid"),e=ir(t);return e.id===V?ir("acid"):e}a(Lo,"getBrutalSelectedPalette");function qo(){let t=String(GM_getValue(L,V)||V);return ir(t)}a(qo,"getBrutalActivePalette");function To(t,e){let r=e||{},o=ir(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{ee()}catch{}try{gt()}catch{}try{Dt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}}a(To,"setBrutalPalette");function Yi(t){let e=t||Zt();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&we()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&we()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Yi,"getSkinShapeOverrides");function Fe(){try{let t=Zt();if(t==="apple")return we()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Fe,"urpppCardBorderValue");function ee(){let t=Zt();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&we();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=Yi(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=qo();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=we(),l=s?"1px solid rgba(0,0,0,0.08)":"none",m=s?"1px solid rgba(255,255,255,0.10)":"none",h=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+m+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+h+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let i=document.head||document.documentElement;e.parentNode===i&&i.lastElementChild!==e&&i.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Yt(document)}catch{}},0)}a(ee,"applySkinAttr");function $o(t){let e=u.find(i=>i.id===t&&i.ready&&(i.installed!==!1||he(i.id))),r=!e&&Ie()[t]&&he(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||xa(!1),!o.dark&&Xt()&&Pr(!1);let i=Xt(),s=i?me():Jt(),l=pr(s,e.id)?s:"default";ee(),Wt(l,{system:i})}catch{try{ee()}catch{}}try{Dt()}catch{}try{gt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}return!0}a($o,"setSkin");function Qi(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Xt())try{Wt(me(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(Qi,"bindSystemThemeListener");try{Xt()?Wt(me(),{system:!0}):Wt(Jt())}catch{}try{ee()}catch{}try{Qi()}catch{}function Xi(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let i=e.match(o);if(i)return i[0].trim()}return""}a(Xi,"extractLoginErrorMessage");function Mo(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(Mo,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=Xi(e),i=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let m=location.pathname==="/loginEn",h=a((R,F)=>m?F:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      ${o}${s}
    </div>`}a(fs,"themeManageCardHtml");async function jr(t){if(!t)return;let e=[];try{e=await fe()}catch{}let r=Ie(),o=Object.keys(r).map(s=>({id:s,name:r[s].name||s,desc:r[s].desc||"本地主题",version:r[s].version||"1.0.0",author:r[s].author||"本地",installed:!1})),i=u.filter(s=>s.installed!==!1||he(s.id)).concat(o.filter(s=>!u.some(l=>l.id===s.id)));if(!i.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}He(i.map(s=>e.find(l=>l.id===s.id))),t.innerHTML=`<div class="urppp-store-theme-grid">${i.map(s=>fs(s,e.find(l=>l.id===s.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(s=>s.addEventListener("click",()=>{if($o(s.dataset.themeUse)){try{Dt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(l=>{let m=l.dataset.skin,h=l.querySelector(".urppp-skin-apply"),k=Zt()===m;l.classList.toggle("is-active",k),h&&(h.classList.toggle("is-current",k),h.disabled=k,h.textContent=k?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(s=>s.addEventListener("click",()=>{let l=s.dataset.themeDel,m=Zt()===l;try{GM_setValue("urppp_theme_css_"+l,"")}catch{}try{GM_setValue("urppp_card_css_"+l,"")}catch{}Ji(l),Vi(l);try{if(m){GM_setValue(d,"apple");try{document.documentElement.removeAttribute("data-urppp-skin")}catch{}try{document.body&&document.body.removeAttribute("data-urppp-skin")}catch{}ee();let k=Xt(),$=k?me():Jt();Wt($,{system:k})}}catch{}try{Dt()}catch{}let h=t.closest(".urppp-store-inline");if(h){try{jr(t)}catch{}try{Ma(h)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(s=>s.addEventListener("click",()=>{try{window.open(s.dataset.repo,"_blank","noopener")}catch{}}))}a(jr,"fetchThemeManage");function sn(){return`<div class="urppp-store-settings">
      ...
      </div>`,pn(t),hn(t),ws(t),fn(t),Ma(t),jr(t.querySelector("#urppp-theme-manage"))}a(vs,"renderThemeStoreBody");function bn(){let t=ur();return`<div class="urppp-src-manage">
      ...
      </div>`,pn(t),hn(t),Ss(t),As(t.querySelector('[data-pane="download"]')),gn(t.querySelector("#urppp-plugin-manage"))}a(xn,"renderPluginStoreBody");function Ss(t){let e=t.querySelector("[data-add-local-plugin]"),r=t.querySelector("[data-local-plugin-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text();r.value="";try{new Function(i)()}catch(s){Re("本地插件加载失败："+(s&&s.message?s.message:s),"error")}try{gn(t.querySelector("#urppp-plugin-manage"))}catch{}}))}a(Ss,"bindLocalPluginImport");function _s(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>$a("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=Zt();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}u.filter(i=>i.installed!==!1||he(i.id)).forEach(i=>{let s=document.createElement("div");s.className="urppp-skin-card"+(i.id===o?" is-active":""),s.dataset.skin=i.id;let l=document.createElement("button");l.type="button",l.className="urppp-skin-apply";let m=i.installed!==!1||he(i.id);m?i.id===o&&i.ready?(l.classList.add("is-current"),l.textContent="使用中",l.disabled=!0):l.textContent="应用主题":(l.classList.add("is-disabled"),l.textContent="去下载"),l.addEventListener("click",h=>{if(h.preventDefault(),h.stopPropagation(),!m){$a("theme");return}if(!(i.id===o&&i.ready)&&$o(i.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),s.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),s.querySelector(".urppp-skin-name").textContent=i.name,s.querySelector(".urppp-skin-desc").textContent=i.desc,s.appendChild(l),r.appendChild(s)})}a(_s,"renderSkinCards");let Ue=[],Fa=!1;function Es(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,i=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(s=>{if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).finally(()=>{i&&clearTimeout(i)})}a(Es,"fetchWithTimeout");function Cs(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(i=>{i.status>=200&&i.status<400?r(i.responseText||""):o(new Error("HTTP "+i.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(i){o(i)}})}a(Cs,"gmRequestForUpdate");function Ps(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),Es(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return Cs(t,r);throw o})}a(Ps,"fetchTextForUpdate");async function Da(t,e,r=1e3){let o=[],i=t[0],s=t.slice(1),l=a(z=>Ps(z,e).then(D=>({url:z,text:D})).catch(D=>(o.push((z.split("/")[2]||z)+": "+(D&&D.message||D)),null)),"grab"),m=l(i),h=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),k=await Promise.race([m,h]);if(k!=="__TIMEOUT__"){if(k&&k.text&&k.text.length>0)return k.text;let D=(await Promise.all(s.map(l))).find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let $=Promise.all(s.map(l)).then(z=>{let D=z.find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),B=m.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([B,$])}a(Da,"fetchFirstAvailable");function Se(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(Se,"setUpdateStatus");async function ja(){let t=p,e="",r=!1,o="";try{let s=await Da(n.sourceUrls(n.versionJson)),l=JSON.parse(s);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let s=await Da(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=po(s)}if(!e)throw new Error("无法解析远程主插件版本");let i=wr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:i>0?"update":i===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:r?o:""}}a(ja,"checkMainUpdate");function yn(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let i=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,s=[],l;for(;(l=i.exec(o))!==null;)s.push({ver:l[1],index:l.index,headEnd:i.lastIndex});if(!s.length)return"";for(let h=0;h<s.length;h++){let k=h+1<s.length?s[h+1].index:o.length;s[h].body=o.slice(s[h].index,k).trim()}let m=[];for(let h of s)wr(h.ver,r)>0||wr(h.ver,e)<=0||m.push(h.body);return m.join(`
