...
#urppp-confirm{position:fixed;left:50%;bottom:24px;transform:translateX(-50%) translateY(16px);z-index:99999;display:flex;flex-direction:column;gap:10px;min-width:min(420px,88vw);padding:12px 14px;border-radius:var(--radius,12px);background:var(--bg-card,#fff);border:1px solid var(--border,#e6e8ec);box-shadow:0 10px 30px rgba(0,0,0,.16);opacity:0;pointer-events:none;transition:.22s}
...
#urppp-confirm .urppp-confirm-ops button{flex:1;min-height:28px;padding:5px 12px;font-size:12px;border-radius:var(--radius,6px);border:1px solid var(--border,#e6e8ec);background:var(--bg-input,#fff);color:var(--text,#16181d);cursor:pointer;transition:.15s}
