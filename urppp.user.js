...
`;function wc(p){p.querySelectorAll("td, th").forEach(n=>{n.style.removeProperty("background"),n.style.removeProperty("background-color")}),p.querySelectorAll("th[rowspan]").forEach(n=>{n.style.removeProperty("width"),n.style.setProperty("white-space","nowrap"),n.style.setProperty("text-align","center")}),p.querySelectorAll("table").forEach(n=>{n.style.setProperty("background","#ffffff","important"),n.style.setProperty("background-color","#ffffff","important"),n.style.setProperty("border","none","important"),n.style.setProperty("color","#000000","important")}),p.querySelectorAll("th").forEach(n=>{if(n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important"),n.style.setProperty("font-weight","normal","important"),n.childNodes.length===1&&n.firstChild&&n.firstChild.nodeType===3){let c=document.createElement("span");c.textContent=n.textContent,n.textContent="",n.appendChild(c)}}),p.querySelectorAll("thead th").forEach(n=>{n.style.setProperty("background","#dddddd","important"),n.style.setProperty("background-color","#dddddd","important")}),p.querySelectorAll("tbody th").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important")}),p.querySelectorAll("td").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important"),n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important")})}a(wc,"normalizeNativePdfStage");function Wp(p){let n=yc(),c=document.createElement("div");c.id="urppp-pdf-stage",c.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(n||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=p.cloneNode(!0);fc(u),xc(u),d.appendChild(u),c.appendChild(d),wc(u);let A=document.createElement("style");A.id="urppp-pdf-reset-style",A.textContent=vc,document.head.appendChild(A),document.body.appendChild(c);let P=c.querySelector("#urppp-pdf-mycoursetable"),_=c.querySelector("#urppp-pdf-page")||c;if(!P)throw c.remove(),new Error("无法建立原生课表捕获节点");return{stage:c,target:P,page:_,sourceHost:p}}a(Wp,"cloneNativePdfStage");var oa=0;function de(){return oa>0}a(de,"isNativePdfIsolationActive");function kc(p){return!p||p.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(p.id||"")||p.hasAttribute("data-urppp-style")?!0:(p.textContent||"").includes("urppp-")}a(kc,"isUrpppOwnedStyle");function Gp(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(Gp,"defaultPage");function Jp(p,n){let c=p&&typeof p.requestAnimationFrame=="function"?p.requestAnimationFrame.bind(p):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return c?c(n):setTimeout(n,0)}a(Jp,"scheduleFrame");function Ac(p={}){let n=p.document||(typeof document<"u"?document:null),c=p.page||Gp();if(!n)throw new Error("原生 PDF 隔离缺少 document");let d=n.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");oa+=1;let u=[d,...d.querySelectorAll("*")],A=[],P=n.getElementById("soliderbox");P&&A.push(P);let _=d.parentElement;for(;_&&_!==n.documentElement;){let x=_.classList;(_.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&A.push(_),_=_.parentElement}let y=n.getElementById("page-content-template")||n.querySelector(".page-content");y&&!A.includes(y)&&A.push(y);let S=[...u,...A],f=S.map(x=>({element:x,style:x.getAttribute("style")})),w=Array.from(n.querySelectorAll("style")).filter(kc).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),T=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=c&&c.divBuild,g=c&&c.__urpppOriginalDivBuild,h=!1,v=a(()=>{h||(h=!0,c&&c.divBuild===g&&typeof C=="function"&&(c.divBuild=C),f.forEach(({element:x,style:E})=>{x.isConnected&&(E===null?x.removeAttribute("style"):x.setAttribute("style",E))}),T.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),w.forEach(({style:x,disabled:E,media:q})=>{try{q===null?x.removeAttribute("media"):x.setAttribute("media",q),x.sheet&&(x.sheet.disabled=E)}catch{}}),oa=Math.max(0,oa-1),Jp(c,()=>{try{typeof p.onAfterRestore=="function"&&p.onAfterRestore()}catch{}}))},"restore");try{return w.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),S.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(E=>{x.style.getPropertyPriority(E)==="important"&&(E==="height"&&x.matches("td, th")||x.style.removeProperty(E))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),T.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),c&&typeof g=="function"&&(c.divBuild=g),v}catch(x){throw v(),x}}a(Ac,"isolateScheduleForNativeExport");function Vp(p,n={}){return new Promise((c,d)=>{let u=n.page||Gp(),A=u&&u.back,P=u&&u.html2canvas;if(!p||typeof A!="function"){d(new Error("教务原生导出依赖未就绪"));return}let _=null;try{_=Ac(n)}catch(g){d(g);return}let y=0,S=!1,f=null,w=null,T=a(g=>{if(!S){S=!0,y&&clearTimeout(y),u&&f&&u.back===f&&(u.back=A),w&&u.html2canvas===w&&(u.html2canvas=P);try{_&&_()}catch{}g?d(g):c()}},"settle"),C=a(g=>T(g instanceof Error?g:new Error(String(g))),"fail");typeof P=="function"&&(w=a(function(){let g=P.apply(this,arguments);return g&&typeof g.catch=="function"&&g.catch(C),g},"scopedCanvas"),u.html2canvas=w),f=a(function(){try{return A.apply(this,arguments)}finally{setTimeout(()=>T(),0)}},"wrappedBack"),u.back=f,y=setTimeout(()=>{try{A.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},n.timeoutMs||60*1e3),Jp(u,()=>{try{p.click()}catch(g){C(g)}})})}a(Vp,"exportNativePdfIsolated");var Yp=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
`;var Xp=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var Kp=`.urppp-export-wrap{position:relative!important;display:inline-flex!important;align-items:center!important;flex:0 0 auto!important;margin-left:7px!important;font-weight:400!important;vertical-align:middle!important;white-space:nowrap!important}
...
`;var ti=`      /* 表格美化：业务表格、分页、公告卡片（table-beautify） */
...
`;var ri=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function pi(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(pi,"createCleanModeState");function ii(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(ii,"resetCleanModeData");function si({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(A){p.catalog=p.catalog||[],p.roomError=String(A&&A.message||A),console.warn("[URP++] room catalog",A)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&ii(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let A=await n.ensureTermWeekResolved();!p.weekLocked&&A>=1&&(p.viewWeek=A)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(A){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(A)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(A){p.schedule={courses:[],error:String(A&&A.message||A)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}})(),(async()=>{let A=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),A=p.scores,n.reconcileProfileAndScores(),A&&!A.error&&!A.evaluationReady&&n.enrichScoresWithEvaluation(A).then(()=>{p.scores===A&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(si,"createCleanModeDataLoader");var ar={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},Sc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Er={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function di(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(di,"calToday");function ho(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(ho,"calDayDiff");function bo(p,n){let c=ho(ar[p].start,n);return c<0?0:Math.floor(c/7)+1}a(bo,"calWeekNo");function uo(p){return Sc[p]||""}a(uo,"calLunar");function li(p){return String(p||"").slice(5)}a(li,"calYY");function _c(p){let n=p||di(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(_c,"calActiveTerm");function go(p,n){let c=p&&ar[p]?p:"autumn",d=ar[c],u=n||di(),A=d.events.map(f=>({e:f,d:ho(u,f.start)})).filter(f=>f.d>=-0).sort((f,w)=>f.d-w.d)[0],P=A?ho(u,A.e.start):null,_=bo(c,u),y=Math.max(0,Math.min(100,_/d.weeks*100)),S=u>=d.start;return{term:d,termId:c,next:A,daysLeft:P,weekNo:_,progress:y,started:S,today:u}}a(go,"calStatus");function ui(p,n){let c=go(p,n),d=c.next?Er[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(ui,"calendarSummaryHtml");function mi(p,n){let c=go(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(mi,"calendarSummaryCompactHtml");function ci(p,n){let c=go(p,n),d=c.next?Er[c.next.e.t].color:"#c9cdd4",u=c.term,A=Object.keys(ar).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${ar[w].name}</button>`).join(""),P=`<div class="cal-widget">
    <div class="cal-w-left">
      ...
      <div class="cal-w-sub">${c.next?c.next.e.start+(c.next.e.end&&c.next.e.end!==c.next.e.start?" ~ "+c.next.e.end:""):""}${c.next&&uo(c.next.e.start)?" · "+uo(c.next.e.start):""}</div>
    </div>
    <div class="cal-w-mid">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[w].map(C=>{let g=Er[C.t].color,h=C.end&&C.end!==C.start?"~"+li(C.end):"",v=bo(c.termId,C.start)>0?`第 ${bo(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
          <span class="cal-ev-dot" style="background:${g}"></span>
          <span class="cal-ev-date">${li(C.start)}${h||""}<em>${uo(C.start)||"&nbsp;"}</em></span>
  ...
  </div>`}a(ci,"calendarModalHtml");function hi(p,n){let c=typeof document<"u"?document:null;if(!c)return;mo();let d=p&&ar[p]?p:_c(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${ci(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>mo()),u.addEventListener("click",A=>{let P=A.target;if(P&&P.closest&&P.closest(".cal-close")){mo();return}let _=P&&P.closest?P.closest("[data-cal-term]"):null;if(_){let y=u.querySelector(".cal-body");y&&(y.innerHTML=ci(_.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(S=>S.classList.toggle("ac",S.dataset.calTerm===_.dataset.calTerm))}})}a(hi,"openCalendarModal");function mo(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(mo,"closeCalendarModal");function bi(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),hi())})}a(bi,"bindCalendarOpen");var na=!1;function fo(){let p=typeof document<"u"?document:null;if(!p||na)return na;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${q?"":" hidden"}>${A()}</div>
      ...
      <div class="uc-col">
        ...
        </div>${(()=>{try{return ui()}catch{return""}})()}</div></div>
      ...
      </div>${(()=>{try{return mi()}catch{return""}})()}</div></div>
      ...
      <div class="uc-occ"><table class="uc-occ-table">${q}${I}</table></div>`}a(g,"occupancyHtml");function h(){let x=n.ensureRoot(),E=x.querySelector("#uc-body");n.getViewWeekNumber();let q=typeof window<"u"&&window.matchMedia?window.matchMedia:null,I=q&&q("(max-width:900px)").matches,L=!p.uiReady;E.innerHTML=I?T():w(),L?(p.uiReady=!0,x.classList.remove("uc-settled"),clearTimeout(x.__ucSettleTimer),x.__ucSettleTimer=setTimeout(()=>{p.open&&x.classList.add("uc-settled")},480)):x.classList.add("uc-settled"),n.bindUI(E),n.applyPersonalDisplay(E)}a(h,"render");function v(){if(!p.open||c)return;let x=a(()=>{c=0,p.open&&h()},"run"),E=typeof requestAnimationFrame=="function"?requestAnimationFrame:null;c=E?E(x):setTimeout(x,0)}return a(v,"scheduleRender"),{analysisHtml:A,metricHtml:u,occupancyHtml:g,render:h,renderScheduleBoard:y,roomPickerHtml:C,scheduleRender:v,scoreSectionHtml:P}}a(xi,"createCleanModeRenderer");function yi({state:p,deps:n}){function c(w,T){return!w||(w.__urpppCleanUiBindings||(w.__urpppCleanUiBindings=new Set),w.__urpppCleanUiBindings.has(T))?!1:(w.__urpppCleanUiBindings.add(T),!0)}a(c,"markCleanUiBound");function d(w){if(!w)return;try{n.bindScheduleExportHosts(w)}catch(C){console.warn("[URP++] schedule export menu",C)}w.querySelectorAll("[data-score]").forEach(C=>{c(C,"score")&&C.addEventListener("click",()=>_(C.getAttribute("data-score")))}),w.querySelectorAll("[data-sa-tab]").forEach(C=>{c(C,"saTab")&&C.addEventListener("click",()=>{p.scoreAnalysisTab=C.getAttribute("data-sa-tab")==="analysis"?"analysis":"overview",n.render()})}),w.querySelectorAll("[data-href]").forEach(C=>{c(C,"href")&&C.addEventListener("click",g=>{let h=C.getAttribute("data-href");h&&(g.preventDefault(),n.closeCleanMode(),location.href=h)})}),w.querySelectorAll("[data-eval-url]").forEach(C=>{c(C,"eval")&&C.addEventListener("click",g=>{let h=C.getAttribute("data-eval-url");h&&(g.preventDefault(),g.stopPropagation(),n.closeCleanMode(),location.href=h)})}),w.querySelectorAll('[data-action="room"]').forEach(C=>{c(C,"room")&&C.addEventListener("click",()=>y())}),w.querySelectorAll("[data-room-reload]").forEach(C=>{c(C,"roomReload")&&C.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation(),n.ensureRoomCatalogLoaded(!0)})}),w.querySelectorAll("[data-build-path]").forEach(C=>{c(C,"building")&&C.addEventListener("click",async()=>{let g=C.getAttribute("data-build-path"),h=(C.textContent||"").trim(),v=C.getAttribute("data-cn")||"",x=C.getAttribute("data-bn")||"",E=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;p.roomDateOffset=0,await f({path:g,name:h,campusNumber:v,buildingNumber:x,dateOffset:0},h,E)})}),w.querySelectorAll("[data-room-day]").forEach(C=>{c(C,"roomDay")&&C.addEventListener("click",async g=>{g.preventDefault(),g.stopPropagation();let h=parseInt(C.getAttribute("data-room-day")||"0",10)||0;if(!p.currentBuilding)return;p.roomDateOffset=h;let v=Object.assign({},p.currentBuilding,{dateOffset:h}),x=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;await f(v,v.name||"",x)})});let T=w.querySelector("#uc-room-back");T&&(T.onclick=()=>{p.occupancy=null,p.currentBuilding=null;let C=T.closest("#uc-room-panel")||document.querySelector("#uc-room-panel")||document.querySelector("#uc-modal-body");C&&C.id==="uc-modal-body"||C&&C.id==="uc-room-panel"?(C.innerHTML=n.roomPickerHtml(),d(C)):n.render()}),w.querySelectorAll(".uc-slot.busy[data-occ]").forEach(C=>{c(C,"occupancy")&&C.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation();try{let h=JSON.parse(C.getAttribute("data-occ")||"{}");A("占用详情",`
          ...
          `,"",{stack:!0})}catch{}})}),w.querySelectorAll(".uc-lesson[data-course]").forEach(C=>{c(C,"course")&&C.addEventListener("click",g=>{g.stopPropagation();try{let h=JSON.parse(C.getAttribute("data-course")||"{}"),v=`第${h.section||"?"}${h.span>1?"-"+(Number(h.section)+Number(h.span)-1):""}节`,x=(h.others||[]).map(E=>`<div class="uc-course-sub ${E.thisWeek?"":"is-fade"}">
            ...
            <div class="uc-course-detail">
              ...
              <div class="uc-cd-chip">${h.thisWeek?"当前周有课":"当前周无课"} · ${n.escapeHtml(v)} · ${n.escapeHtml(n.DAY_NAMES[h.day]||"")}</div>
            </div>
            ${x?'<div class="uc-hd" style="border:0;padding:14px 0 6px">同时段其他课程</div>'+x:""}
          `,"")}catch{}})}),w.querySelectorAll("[data-week-delta]").forEach(C=>{c(C,"weekDelta")&&C.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation();let h=parseInt(C.getAttribute("data-week-delta")||"0",10)||0,v=p.schedule&&p.schedule.courses||[],x=n.inferMaxWeek(v),E=n.getViewWeekNumber();p.weekLocked=!0,p.viewWeek=Math.min(x,Math.max(1,E+h)),n.render();let q=document.querySelector("#urppp-clean-root .uc-week-label");q&&(q.classList.remove("uc-pop"),q.offsetWidth,q.classList.add("uc-pop"))})}),w.querySelectorAll("[data-week-reset]").forEach(C=>{c(C,"weekReset")&&C.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation(),p.weekLocked=!1;let h=n.getCurrentWeekNumber()||p._termWeek||1;p.viewWeek=h,n.render();let v=document.querySelector("#urppp-clean-root .uc-week-label");v&&(v.classList.remove("uc-pop"),v.offsetWidth,v.classList.add("uc-pop"))})})}a(d,"bindUI");let u=[];function A(w,T,C,g){g=g||{};let h=n.ensureRoot(),v=h.querySelector("#uc-mask"),x=h.querySelector("#uc-modal");g.stack&&x.classList.contains("open")?u.push({title:h.querySelector("#uc-modal-title").textContent,body:h.querySelector("#uc-modal-body").innerHTML,ft:h.querySelector("#uc-modal-ft").innerHTML}):g.stack||(u.length=0),v.classList.add("open"),x.classList.add("open"),h.querySelector("#uc-modal-title").textContent=w,h.querySelector("#uc-modal-body").innerHTML=T,h.querySelector("#uc-modal-ft").innerHTML=C||"",d(h.querySelector("#uc-modal-body")),d(h.querySelector("#uc-modal-ft")),n.applyPersonalDisplay(h.querySelector("#uc-modal"))}a(A,"openModal");function P(){let w=n.rootEl();if(w){if(u.length){let T=u.pop();w.querySelector("#uc-modal-title").textContent=T.title,w.querySelector("#uc-modal-body").innerHTML=T.body,w.querySelector("#uc-modal-ft").innerHTML=T.ft||"",d(w.querySelector("#uc-modal-body")),d(w.querySelector("#uc-modal-ft"));return}w.querySelector("#uc-mask").classList.remove("open"),w.querySelector("#uc-modal").classList.remove("open")}}a(P,"closeModal");function _(w){let T=p.scores&&p.scores.passing&&p.scores.passing[0]||{courses:[],summary:n.summarizeCourses([])},C=p.scores&&p.scores.schemes||[];w==="scheme"&&p.scores&&p.scores.majorIdx!=null&&p._schemeInited!==!0&&(p.activeSchemeIdx=p.scores.majorIdx||0,p._schemeInited=!0);let g=C[p.activeSchemeIdx]||C[0]||{courses:[],summary:n.summarizeCourses([]),title:"方案成绩"},h=w==="scheme"?g:T,v=w==="scheme"?"scheme":"passing";p.selected[v]||(p.selected[v]=new Set);let x=w==="scheme"&&C.length>1?`<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">${C.map((Z,dt)=>`<button type="button" class="uc-btn ${dt===p.activeSchemeIdx?"primary":""}" data-scheme-idx="${dt}"><span data-urppp-private="organization">${n.escapeHtml((Z.title||"方案").slice(0,28))}</span></button>`).join("")}</div>`:"",E=a(Z=>{let dt=!!(Z&&(Z.unevaluated||n.isUnevaluatedScore(Z.score))),kt=n.scoreToNumber(Z&&Z.score),wt="";dt?wt=kt!=null&&kt<60?"uneval-fail":"uneval":kt!=null?wt=kt>=60?"pass":"fail":/不及格|不合格|不通过/.test(String(Z&&Z.score||""))?wt="fail":Z&&Z.score&&(wt="pass");let Ct=n.escapeHtml(Z&&Z.score||"—"),N=dt?Z.evalUrl||"/student/teachingEvaluation/newEvaluation/index":"";return N?`<span class="uc-score-cell ${wt}" data-eval-url="${n.escapeHtml(N)}" title="未评教，点击前往评教">${Ct}</span>`:`<span class="uc-score-cell ${wt}">${Ct}</span>`},"scoreCellHtml"),q=(h.courses||[]).map((Z,dt)=>{let kt=p.selected[v].has(dt),wt=n.isValidOfficialGpa(Z.officialGpa)?Z.officialGpa:n.scoreToGpa(Z.score),Ct=!!(Z.unevaluated||n.isUnevaluatedScore(Z.score));return`<tr class="${kt?"is-on":""}${Ct?" is-uneval":""}" data-idx="${dt}">
      ...
      ${x}${n.metricHtml(h.summary,w==="scheme"?"scheme":"passing")}
    ...
    `,P.appendChild(f);let w=P.querySelector("#warningInfo");w&&document.body.appendChild(w),_.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let T=f.querySelector("#urppp-stats"),C=Math.max(S.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',T.appendChild(E)}function g(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&(T.innerHTML="",x.forEach(E=>{let q=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),I=q[0]||"",L=q.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),M=/[\u4e00-\u9fa5]/.test(I)||I.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=p.statCardPrivacyMarkup(I,L);G.innerHTML=`<div class="${M}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,T.appendChild(G)}))}if(a(g,"updateStats"),g(),y){let x=new MutationObserver(()=>g());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let h=f.querySelector("#urppp-left"),v=f.querySelector("#urppp-right");u(_[5],h,"我的日程安排"),u(_[0],v,"通知公告"),u(_[1],v,"我的待办任务"),u(_[2],v,"可申请业务"),u(_[3],v,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(A,"rebuildDashboard"),{rebuildDashboard:A,refreshHomeFullCalendar:c,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(wi,"createDashboardController");function ye(p){return Math.round((Number(p)||0)*100)/100}a(ye,"round2");var Ec=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],ki={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},Cc=[{key:"required",label:"必修",test:a(p=>/必修/.test(p),"test")},{key:"elective",label:"任选",test:a(p=>/任选/.test(p),"test")},{key:"optional",label:"选修",test:a(p=>/选修/.test(p),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function Ai(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d+)/);return n?`${n[1].slice(2)}-${n[2].slice(2)}-${n[3]}`:String(p||"")}a(Ai,"shortTerm");function pa({deps:p}){let n=p.scoreToNumber,c=p.scoreToGpa;function d(g){let h=n(g);if(h!=null)return h;let v=String(g||"").trim().toUpperCase();return ki[v]!=null?ki[v]:null}a(d,"scoreToNumberWithLevels");function u(g){return!g||g.unevaluated?!1:d(g.score)!=null}a(u,"hasScore");function A(g){let h=String(g||"").match(/^(\d{4})-(\d{4})-(\d+)/);return h?[Number(h[1]),Number(h[3])]:[9999,9999]}a(A,"termOrderKey");function P(g){let h=g&&g.passing&&g.passing[0];return h&&h.courses||[]}a(P,"allCourses");function _(g){let h=g&&g.officialGpa,v=Number(h);return h!=null&&Number.isFinite(v)&&v>=0&&v<=5?v:null}a(_,"officialGpa");function y(g){let h=_(g);return h??c(g.score)}a(y,"courseGpa");function S({scorePack:g,profile:h}){let v=P(g),x=h&&h.majorGpa?String(h.majorGpa).trim():"",E=0,q=0,I=0,L=0,O=0,M=0;return v.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,q+=U*G;let et=y(H);et!=null&&(I+=et*G,L+=G,H.required&&(O+=et*G,M+=G))}),{majorGpa:x,requiredGpa:ye(M?O/M:0),avgGpa:ye(L?I/L:0),avgScore:ye(E?q/E:0),totalCredit:ye(E),courseCount:v.length}}a(S,"computeMetrics");function f(g){let h=new Map;return(g||[]).forEach(v=>{if(!u(v))return;let x=v.term||"未分组",E=h.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},h.set(x,E));let q=Number(v.credit)||0,I=d(v.score);if(I==null||(E.count+=1,q<=0))return;E.credit+=q,E.scoreW+=I*q;let L=y(v);L!=null&&(E.gpaW+=L*q,E.gpaCredit+=q)}),Array.from(h.values()).map(v=>({term:v.term,label:Ai(v.term),count:v.count,credit:ye(v.credit),avgScore:ye(v.credit?v.scoreW/v.credit:0),avgGpa:ye(v.gpaCredit?v.gpaW/v.gpaCredit:0)})).sort((v,x)=>{let E=A(v.term),q=A(x.term);return E[0]-q[0]||E[1]-q[1]})}a(f,"computeTrend");function w(g){let h=Ec.map(x=>({...x,count:0,credit:0}));(g||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let q=h.find(I=>E>=I.min&&E<=I.max);q&&(q.count+=1,q.credit+=Number(x.credit)||0)});let v=h.reduce((x,E)=>Math.max(x,E.count),1);return h.map(x=>({...x,ratio:Math.round(x.count/v*100)}))}a(w,"computeBands");function T(g){let h=Cc.map(q=>({...q,credit:0,count:0}));(g||[]).forEach(q=>{if(!u(q))return;let I=String(q.attr||""),L=h.find(O=>O.test(I));L&&(L.credit+=Number(q.credit)||0,L.count+=1)});let v=h.reduce((q,I)=>q+I.credit,0)||1,x=h.filter(q=>q.count>0).map(q=>({key:q.key,label:q.label,credit:ye(q.credit),count:q.count,ratio:Math.round(q.credit/v*100)})),E=x.find(q=>q.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a(T,"computeShare");function C({scorePack:g,profile:h}){let v=P(g);return{metrics:S({scorePack:g,profile:h}),trend:f(v),bands:w(v),share:T(v),empty:v.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:_,scoreToNumberWithLevels:d,shortTerm:Ai}}a(pa,"createScoreAnalysisData");var ne="var(--text-secondary)",yo="var(--border)";function pe(p){return at(String(p??""))}a(pe,"escapeLabel");function Si(p,n,c){let d=!!(p&&p.variant==="mobile");if(n==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},_=Math.max(56,Number(p&&p.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,c)*_),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},A=Math.max(44,Number(p&&p.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,c)*A),height:236,pad:u}}a(Si,"resolveChartLayout");function xo({width:p,height:n,mobile:c,kind:d,label:u}){let A=c?` data-urppp-chart-layout="mobile" style="width:max(100%,${p}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${p} ${n}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${A}>`}a(xo,"openSvg");function ia({trend:p,palette:n,layout:c}){let d=(p||[]).filter(rt=>rt&&rt.avgScore!=null),u=Si(c,"trend",d.length),{width:A,height:P,pad:_,mobile:y}=u,S=A-_.left-_.right,f=P-_.top-_.bottom;if(!d.length)return`${xo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let w=d.length,T=a(rt=>_.left+(rt+.5)*(S/w),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),g=d.map(rt=>Number(rt.avgScore)||0),h=d.map(rt=>Number(rt.credit)||0),v=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...g)-4),q=Math.min(100,Math.max(...g)+4),I=Math.max(1,...h),L=x-v||1,O=q-E||1,M=a(rt=>_.top+f-(rt-v)/L*f,"yGpa"),H=a(rt=>_.top+f-(rt-E)/O*f,"yScore"),G=a(rt=>_.top+f-rt/I*f*.9,"yCredit"),U=d.map((rt,st)=>`${T(st)},${M(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${T(st)},${H(rt.avgScore)}`).join(" "),it=[0,.25,.5,.75,1].map(rt=>{let st=_.top+f-rt*f;return`<line x1="${_.left}" y1="${st.toFixed(1)}" x2="${A-_.right}" y2="${st.toFixed(1)}" stroke="${yo}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),mt=d.map((rt,st)=>{let ft=T(st),Z=y?Math.min(30,S/w*.42):Math.min(26,S/w*.32),dt=G(rt.credit);return`<rect x="${(ft-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(_.top+f-dt).toFixed(1)}" rx="3" fill="${n.credit}" opacity="0.55"/>
...
`);return`<rect class="urppp-sa-hover" x="${Z.toFixed(1)}" y="${_.top}" width="${ft.toFixed(1)}" height="${f.toFixed(1)}" fill="transparent"><title>${pe(dt)}</title></rect>`}).join(""),ot=d.map((rt,st)=>`<circle cx="${T(st).toFixed(1)}" cy="${M(rt.avgGpa).toFixed(1)}" r="3.5" fill="${n.gpaLine}"/><text x="${T(st).toFixed(1)}" y="${(M(rt.avgGpa)-9).toFixed(1)}" text-anchor="middle" font-size="11.5" font-weight="600" fill="${n.gpaLine}">${pe(rt.avgGpa)}</text>`).join(""),X=d.map((rt,st)=>`<circle cx="${T(st).toFixed(1)}" cy="${H(rt.avgScore).toFixed(1)}" r="3" fill="${n.scoreLine}"/><text x="${T(st).toFixed(1)}" y="${(H(rt.avgScore)+17).toFixed(1)}" text-anchor="middle" font-size="11.5" fill="${n.scoreLine}">${pe(rt.avgScore)}</text>`).join(""),ct=y?`<g font-size="12">
...
</g>`;return`${xo({...u,kind:"trend",label:"学期成绩趋势"})}
${it}
${mt}
<g>${Q}</g>
...
<g>${V}</g>
${ct}
</svg>`}a(ia,"trendChartSvg");function sa({bands:p,palette:n,layout:c}){let d=p||[],u=Si(c,"bands",d.length),{width:A,height:P,pad:_,mobile:y}=u,S=A-_.left-_.right,f=P-_.top-_.bottom,w=d.length||1,T=Math.max(1,...d.map(h=>h.count)),C=y?Math.min(32,S/w*.62):Math.min(40,S/w*.52),g=d.map((h,v)=>{let x=_.left+(v+.5)*(S/w),E=h.count?Math.max(8,h.count/T*f):0,q=_.top+f-E,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=h.range||(h.min===0?"<60":`${h.min}-${h.max===100?"100":h.max}`),O=[`${h.level||""}（绩点 ${h.gpa}）`,`百分制 ${L}`,`课程 ${h.count} 门`].join(`
...
<text x="${x.toFixed(1)}" y="${(q-6).toFixed(1)}" text-anchor="middle" font-size="12.5" font-weight="600" fill="var(--text)">${pe(h.count)}</text>
<text x="${x.toFixed(1)}" y="${P-26}" text-anchor="middle" font-size="11" font-weight="600" fill="${ne}">${pe(L)}</text>
<text x="${x.toFixed(1)}" y="${P-12}" text-anchor="middle" font-size="12" fill="${ne}">${pe(h.gpa)}</text>`}).join("");return`${xo({...u,kind:"bands",label:"成绩分段分布"})}
<line x1="${_.left}" y1="${(_.top+f).toFixed(1)}" x2="${A-_.right}" y2="${(_.top+f).toFixed(1)}" stroke="${yo}" stroke-width="1"/>
${g}
</svg>`}a(sa,"bandsChartSvg");function _i({items:p,requiredRatio:n,palette:c}){let _=2*Math.PI*56,y=(p||[]).filter(T=>T&&T.ratio>0),S=Math.max(0,Math.min(100,Math.round(Number(n)||0)));if(!y.length)return'<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成"></svg>';let f=-90,w=y.map(T=>{let C=T.ratio/100*_,h=`<circle cx="75" cy="75" r="56" fill="none" stroke="${c.share&&c.share[T.key]||c.required}" stroke-width="24"
  stroke-dasharray="${C.toFixed(2)} ${_.toFixed(2)}"
  stroke-linecap="butt" transform="rotate(${f.toFixed(2)} 75 75)"/>`;return f+=T.ratio/100*360,h}).join("");return`<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成">
...
</svg>`}a(_i,"donutSvg");var Pc=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),zc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',Lc='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function Ei({deps:p}){let n=p&&p.palette||Pc;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
  <button type="button" class="urppp-sa-toggle" aria-expanded="false">
    <span class="urppp-sa-icon">${zc}</span>
...
<div class="urppp-sa-grid">
  ...
  <section class="urppp-sa-card urppp-sa-share">
    ...
    <div class="urppp-sa-share-body">
      <div class="urppp-sa-donut">${_i({items:w.items,requiredRatio:w.requiredRatio,palette:n})}</div>
...
<div class="urppp-sa-grid">
  ...
  `;function _(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(_,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function f(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let s=_("");s.style.minHeight="0",s.style.padding="0",r.parentElement&&r.parentElement.replaceChild(s,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=_("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(f,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{f(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",g="urppp_scheme_v1",h="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",M="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:ft,syncThemeDotGroup:Z}=Ti({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Kt,getAccent:Qt,getBrutalActivePalette:Co,getBrutalPaletteById:pr,getBrutalSelectedPalette:Eo,getCurrent:Jt,getScheme:$e,getSkin:Zt,isThemeModeAvailable:or,setBrutalPalette:Po,skinSupportsDark:Ie,skinSupportsDynamic:Ne,skinSupportsFixedPalettes:_o},settings:{ensureSettingsPanel:en,openSettingsPanel:Ko,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),s=document.getElementById("clickdiv"),i=document.getElementById("form-search");if(!o){let j=document.createElement("li");j.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",j.appendChild(o),r.appendChild(j)}let l=o.closest("li")||o.parentElement,b=Array.from(r.children).find(j=>{let R=j.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),m=Array.from(r.children).find(j=>j.classList.contains("light-blue")),k=b||m||null;k&&l&&k!==l&&((l.compareDocumentPosition(k)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,k)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let $=l;s?(s.removeAttribute("onclick"),s.setAttribute("role","button"),s.setAttribute("aria-label","搜索功能")):(s=document.createElement("button"),s.type="button",s.id="clickdiv",s.setAttribute("aria-label","搜索功能"),s.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(s)),s.style.setProperty("left","8px","important"),s.style.setProperty("position","relative","important"),s.style.setProperty("z-index","31","important"),i||(i=document.createElement("div"),i.id="form-search",i.className="nav-search",i.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),$&&i.parentElement!==$&&$.appendChild(i),$&&$.style.setProperty("position","relative","important"),i.classList.add("urppp-desktop-search"),i.style.setProperty("position","absolute","important"),i.style.setProperty("top","50%","important"),i.style.setProperty("right","24px","important"),i.style.setProperty("left","auto","important"),i.style.setProperty("transform","translateY(-50%)","important"),i.style.setProperty("width",i.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),i.style.setProperty("max-width","calc(100vw - 24px)","important"),i.style.setProperty("opacity",i.dataset.open==="1"?"1":"0","important"),i.style.setProperty("pointer-events",i.dataset.open==="1"?"auto":"none","important"),i.style.setProperty("z-index","1200","important"),i.style.setProperty("margin","0","important"),i.style.setProperty("background","transparent","important"),i.style.setProperty("border","0 solid transparent","important"),i.style.setProperty("box-shadow","none","important"),i.style.setProperty("overflow","visible","important"),i.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let B=i.querySelector("#search-input"),z=i.querySelector("form");if(!B||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let D=i.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),B.style.setProperty("display","block","important"),B.style.setProperty("width","100%","important"),B.style.setProperty("height","36px","important"),B.style.setProperty("box-sizing","border-box","important"),B.style.setProperty("padding","0 12px","important"),B.style.setProperty("border","1px solid var(--border)","important"),B.style.setProperty("border-radius","var(--radius-sm)","important"),B.style.setProperty("background","var(--input-bg)","important"),B.style.setProperty("color","var(--text)","important");let J=a(j=>{i.dataset.open=j?"1":"0",i.style.setProperty("width",j?"min(240px, calc(100vw - 24px))":"0px","important"),i.style.setProperty("opacity",j?"1":"0","important"),i.style.setProperty("pointer-events",j?"auto":"none","important"),s.setAttribute("aria-expanded",j?"true":"false"),j&&setTimeout(()=>B.focus(),30)},"setOpen");s.__urpppSearchBound||(s.__urpppSearchBound=!0,s.addEventListener("click",j=>{j.preventDefault(),j.stopImmediatePropagation(),J(i.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",j=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(j.target)||F?.contains(j.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function N(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),s=Math.min(t,e,r),i=0,l=0,b=(o+s)/2;if(o!==s){let m=o-s;switch(l=b>.5?m/(2-o-s):m/(o+s),o){case t:i=(e-r)/m+(e<r?6:0);break;case e:i=(r-t)/m+2;break;default:i=(t-e)/m+4;break}i/=6}return{h:i*360,s:l,l:b}}a(N,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,s=o*(1-Math.abs(t/60%2-1)),i=r-o/2,l=0,b=0,m=0;return t<60?(l=o,b=s):t<120?(l=s,b=o):t<180?(b=o,m=s):t<240?(b=s,m=o):t<300?(l=s,m=o):(l=o,m=s),{r:Math.round((l+i)*255),g:Math.round((b+i)*255),b:Math.round((m+i)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:s,b:i}=Y(t,e,r);return yr(o,s,i)}a(tt,"hslHex");function bt(t){let{r:e,g:r,b:o}=Ze(Gt(t)||mt),s=N(e,r,o);return s.s<.12&&(s.s=.18),s}a(bt,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,s=Math.max(0,Math.min(.95,e));return tt(t,s,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Gt(t)||mt,{h:r,s:o}=bt(e),s=Ft(r),i=Math.min(.72,Math.max(.28,o*.78));return ht(s,i,42)}a(Pt,"companionColor");function It(t,e){let r=Gt(t)||mt,{h:o,s}=bt(r),l=zt(e||ot),b=Math.min(.92,Math.max(.35,s*l.chroma)),m=Pt(r),{h:k}=bt(m),$=ht(o,b,l.primaryTone),B=ht(o,b,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),D,J,j;l.whiteCard?(D=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",j="#E5E7EB"):l.duo?(D=Bt(yt(m,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),j=Bt("#E5E7EB",m,.16)):(D=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),j=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?m:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),F=ht(o,Math.min(.45,b*.55),14),K=xe(ht(o,b*.3,34),.88),ut=xe(ht(o,b*.22,46),.76),vt=xe($,.18),Et="0 4px 12px "+xe($,.1)+", 0 1px 2px "+xe($,.05);return{"--bg":D,"--surface":J,"--text":F,"--text-secondary":K,"--text-muted":ut,"--border":j,"--border-focus":$,"--input-bg":R,"--primary":$,"--primary-hover":B,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":m}}a(It,"buildMaterialSchemeVars");function Kt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Kt,"buildSchemePreview");function Te(t){let e=Gt(t)||Qt()||mt;return X.map(r=>Object.assign({},r,Kt(e,r.id)))}a(Te,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Qt(){return Gt(GM_getValue(T,""))||""}a(Qt,"getAccent");function $e(){let t=String(GM_getValue(g,ot)||ot);return X.some(e=>e.id===t)?t:ot}a($e,"getScheme");function la(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(g,e),e}a(la,"setScheme");function $i(t,e){if(!t)return;let r=Gt(t);if(r){if(GM_setValue(T,r),e&&e.scheme&&la(e.scheme),e&&e.skipTheme){let o=eo(r,.15),s=xe(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",s);try{ft()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{ft()}catch{}try{Dt()}catch{}}}a($i,"applyAccent");function ca(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(ca,"getAccentPresets");function Mi(t){let e=Gt(t||Qt()||mt);if(!e)return ca();let r=ca();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(Mi,"saveAccentPreset");function Xt(){try{return!!GM_getValue(h,!1)}catch{return!1}}a(Xt,"isThemeFollowSystem");function Cr(t){return GM_setValue(h,!!t),!!t}a(Cr,"setThemeFollowSystem");function da(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(da,"isCleanDefault");function Ii(t){return GM_setValue(v,!!t),!!t}a(Ii,"setCleanDefault");function ua(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(ua,"isCleanAnalysisDirect");function Ni(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(Ni,"setCleanAnalysis");function ve(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(ve,"isAppleEdgeLine");function Bi(t){return GM_setValue(E,!!t),!!t}a(Bi,"setAppleEdgeLine");function ma(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(ma,"isAutoUpdateCheck");function Fi(t){return GM_setValue(c,!!t),!!t}a(Fi,"setAutoUpdateCheck");function Pr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(Pr,"readJsonSetting");function zr(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(zr,"writeJsonSetting");function we(){return so(Pr(O,null))}a(we,"getPrivacySettings");function ha(t){return zr(O,so(t))}a(ha,"setPrivacySettings");function Me(){return _r(Pr(M,null))}a(Me,"getCustomIdentity");function vo(t){return zr(M,_r(t))}a(vo,"setCustomIdentity");function ba(){let t=Pr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ba,"getScheduleFirstMondayMap");function wo(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ba();r[String(t)]=String(e),zr(H,r)}a(wo,"rememberScheduleFirstMonday");function Lr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=Pr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},s={enabled:!!o.enabled,mapping:qe(o.mapping||kr)};return et="",s}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:qe(kr)}}}a(Lr,"getScheduleJsonFormatSettings");function ko(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:qe(e.mapping||kr)};return et="",zr(G,r)}a(ko,"setScheduleJsonFormatSettings");function Ao(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(Ao,"isHomePage");function qr(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(qr,"isFollowUseDynamic");function ga(t){return GM_setValue(q,!!t),!!t}a(ga,"setFollowUseDynamic");function Di(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Di,"systemPrefersDark");function me(){return Di()&&Ie()?"dark":qr()&&Ne()?"scu-red":"default"}a(me,"resolveFollowThemeName");function or(t,e){return t==="dark"?Ie(e):t==="scu-red"?Ne(e):t==="default"}a(or,"isThemeModeAvailable");function Wt(t,e){e=e||{},!Ie()&&Xt()&&Cr(!1),!Ne()&&qr()&&ga(!1),e.manual&&Cr(!1);let r;e.system||Xt()&&!e.manual?r=me():(r=Ct[t]?t:Jt()||"default",Ct[r]||(r="default")),or(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(w,r),ue();let s=document.getElementById("urppp-theme-vars")||(()=>{let k=document.createElement("style");return k.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(k),k})(),i=Qt(),l=Object.assign({},o.vars);if(r==="scu-red"){let k=i||mt,$=$e();l=Object.assign(l,It(k,$));let B=l["--primary"]||k,z=l["--primary-hover"]||eo(B,.12);document.documentElement.style.setProperty("--urppp-accent",B),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||xe(B,.15)),document.documentElement.style.setProperty("--urppp-seed",k),document.documentElement.style.setProperty("--urppp-scheme",$)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let b=":root {";for(let[k,$]of Object.entries(l))b+=`${k}:${$};`;b+="}",s.textContent=b,document.body&&(document.body.style.fontFamily=o.font);try{let k=document.documentElement;k.dataset.urpppTheme=r,k.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),k.classList.add("urppp-theme-"+r),k.classList.toggle("urppp-theme-follow",Xt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Xt()))}catch{}try{ee()}catch{}try{ft()}catch{}try{Dt()}catch{}try{Uo()}catch{}try{Yi()}catch{}let m=document.getElementById("urppp-boot-loader");m&&(m.style.fontFamily=o.font)}a(Wt,"applyTheme");function Jt(){return GM_getValue(w,"default")}a(Jt,"getCurrent");function he(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(he,"themeDownloaded");function nr(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(nr,"localThemes");function ji(t,e){try{let r=nr();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(ji,"saveLocalTheme");function Oi(t){try{let e=nr();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(Oi,"removeLocalTheme");function fa(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(fa,"storeThemeStyleEl");function Hi(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(Hi,"removeStoreThemeStyle");function So(){u.forEach(t=>{let e="urppp_theme_css_"+t.id,r="";try{r=GM_getValue(e,"")||""}catch{}r&&(fa(t.id).textContent=r);let o="";try{o=GM_getValue("urppp_card_css_"+t.id,"")||""}catch{}o&&Oe([{id:t.id,cardCss:o}])});try{ee()}catch{}}a(So,"injectAllStoreThemeStyles");function Zt(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||he(e.id))||nr()[t]&&he(t)?t:"apple"}a(Zt,"getSkin");function xa(t,e){let r=t||Zt(),o=u.find(s=>s.id===r);return!!(o&&o[e])}a(xa,"getSkinCapability");function Ie(t){return xa(t,"dark")}a(Ie,"skinSupportsDark");function Ne(t){return xa(t,"dynamic")}a(Ne,"skinSupportsDynamic");function _o(t){return xa(t,"palettes")}a(_o,"skinSupportsFixedPalettes");function pr(t){return Q.find(e=>e.id===t)||Q[0]}a(pr,"getBrutalPaletteById");function Eo(){let t=String(GM_getValue(I,"acid")||"acid"),e=pr(t);return e.id===V?pr("acid"):e}a(Eo,"getBrutalSelectedPalette");function Co(){let t=String(GM_getValue(L,V)||V);return pr(t)}a(Co,"getBrutalActivePalette");function Po(t,e){let r=e||{},o=pr(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{ee()}catch{}try{ft()}catch{}try{Dt()}catch{}try{let s=document.getElementById("urppp-clean-root");s&&typeof s.__syncCleanThemeDots=="function"&&s.__syncCleanThemeDots()}catch{}}a(Po,"setBrutalPalette");function Ri(t){let e=t||Zt();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&ve()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&ve()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Ri,"getSkinShapeOverrides");function Be(){try{let t=Zt();if(t==="apple")return ve()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Be,"urpppCardBorderValue");function ee(){let t=Zt();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&ve();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let i=document.createElement("style");return i.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(i),i})(),r=Ri(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(i=>{o+=i+":"+r[i]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let i=Co();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+i.accent+";--brutal-secondary:"+i.secondary+";--brutal-info:"+i.info+";--brutal-warning:"+i.warning+";}"}e.textContent=o;return}if(t==="apple"){let i=ve(),l=i?"1px solid rgba(0,0,0,0.08)":"none",b=i?"1px solid rgba(255,255,255,0.10)":"none",m=i?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(i?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(i?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+b+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(i?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+m+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let s=document.head||document.documentElement;e.parentNode===s&&s.lastElementChild!==e&&s.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Yt(document)}catch{}},0)}a(ee,"applySkinAttr");function zo(t){let e=u.find(s=>s.id===t&&s.ready&&(s.installed!==!1||he(s.id))),r=!e&&nr()[t]&&he(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||ga(!1),!o.dark&&Xt()&&Cr(!1);let s=Xt(),i=s?me():Jt(),l=or(i,e.id)?i:"default";ee(),Wt(l,{system:s})}catch{try{ee()}catch{}}try{Dt()}catch{}try{ft()}catch{}try{let s=document.getElementById("urppp-clean-root");s&&typeof s.__syncCleanThemeDots=="function"&&s.__syncCleanThemeDots()}catch{}return!0}a(zo,"setSkin");function Ui(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Xt())try{Wt(me(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(Ui,"bindSystemThemeListener");try{Xt()?Wt(me(),{system:!0}):Wt(Jt())}catch{}try{ee()}catch{}try{Ui()}catch{}function Wi(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let s=e.match(o);if(s)return s[0].trim()}return""}a(Wi,"extractLoginErrorMessage");function Lo(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(Lo,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=Wi(e),s=r.querySelector('a[onclick*="toModifyPwd"]'),i=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let b=location.pathname==="/loginEn",m=a((R,F)=>b?F:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      <div class="uc">
        ...
        <div class="urppp-store-sub-body" id="urppp-store-sub-body"></div>`,e.appendChild(r),r.querySelector("#urppp-store-sub-back").onclick=is);let o=r.querySelector("#urppp-store-sub-title"),s=r.querySelector("#urppp-store-sub-body");o.textContent=t==="theme"?"主题商店":"插件商店",s.innerHTML="",t==="theme"?ms(s):dn(s),r.classList.add("open")}a(qa,"openStoreSubPanel");function is(){let t=document.getElementById("urppp-store-subpanel");if(!t)return;t.classList.remove("open");let e=t.querySelector("#urppp-store-sub-body");e&&(e.innerHTML="")}a(is,"closeStoreSubPanel");function rn(t){t.querySelectorAll(".urppp-store-tab").forEach(e=>{e.addEventListener("click",()=>{t.querySelectorAll(".urppp-store-tab").forEach(o=>o.className="urppp-store-tab"),e.className="urppp-store-tab ac",t.querySelectorAll(".urppp-store-pane").forEach(o=>o.style.display="none");let r=t.querySelector('.urppp-store-pane[data-pane="'+e.dataset.tab+'"]');r&&(r.style.display="")})})}a(rn,"bindStoreTabs");function Oe(t){Array.isArray(t)&&t.forEach(e=>{if(!e||!e.id)return;let r="";try{r=GM_getValue("urppp_card_css_"+e.id,"")||""}catch{}let o=r||e.cardCss||"";if(!o)return;let s=document.getElementById("urppp-store-card-css-"+e.id);s||(s=document.createElement("style"),s.id="urppp-store-card-css-"+e.id,(document.head||document.documentElement).appendChild(s)),s.textContent!==o&&(s.textContent=o)})}a(Oe,"ensureStoreCardStyles");function ss(t,e){let r=(u.find(i=>i.id===t.id)||{}).repo,o=t.repo||r,s=o?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(o)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-skin="${at(t.id)}">
      ...
      ${s}
    </div>`}a(ss,"themeStoreCard");async function Ta(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await Ae()).filter(o=>o.type==="theme"&&!he(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Oe(r),e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>ss(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>ls(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(Ta,"fetchCatalogThemes");async function ls(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await Ae()).find(i=>i.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o="";for(let i of r.entry)try{let l=await fetch(i,{cache:"no-store"});if(l.ok){o=await l.text();break}}catch{}if(!o){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,o)}catch{}if(r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{fa(t).textContent=o}catch{}try{Oe([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;let s=e.closest&&e.closest(".urppp-store-inline");if(s){try{let i=s.querySelector("#urppp-theme-manage");i&&await Dr(i)}catch{}try{Ta(s)}catch{}}try{Dt()}catch{}}a(ls,"downloadStoreTheme");function cs(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,s=e&&e.repo||t.repo,i=s?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(s)}">仓库</button>`:"",l=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"",b=Zt()===t.id;return`<div class="urppp-skin-card${b?" is-active":""}" data-skin="${at(t.id)}">
      ...
      <button type="button" class="urppp-skin-apply${b?" is-current":""}" data-theme-use="${at(t.id)}"${b?" disabled":""}>${b?"使用中":"使用"}</button>
      ${o}${i}
    </div>`}a(cs,"themeManageCardHtml");async function Dr(t){if(!t)return;let e=[];try{e=await Ae()}catch{}let r=nr(),o=Object.keys(r).map(i=>({id:i,name:r[i].name||i,desc:r[i].desc||"本地主题",version:r[i].version||"1.0.0",author:r[i].author||"本地",installed:!1})),s=u.filter(i=>i.installed!==!1||he(i.id)).concat(o.filter(i=>!u.some(l=>l.id===i.id)));if(!s.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}Oe(s.map(i=>e.find(l=>l.id===i.id))),t.innerHTML=`<div class="urppp-store-theme-grid">${s.map(i=>cs(i,e.find(l=>l.id===i.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(i=>i.addEventListener("click",()=>{if(zo(i.dataset.themeUse)){try{Dt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(l=>{let b=l.dataset.skin,m=l.querySelector(".urppp-skin-apply"),k=Zt()===b;l.classList.toggle("is-active",k),m&&(m.classList.toggle("is-current",k),m.disabled=k,m.textContent=k?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(i=>i.addEventListener("click",()=>{let l=i.dataset.themeDel,b=Zt()===l;try{GM_setValue("urppp_theme_css_"+l,"")}catch{}try{GM_setValue("urppp_card_css_"+l,"")}catch{}Oi(l),Hi(l);try{if(b){GM_setValue(d,"apple");try{document.documentElement.removeAttribute("data-urppp-skin")}catch{}try{document.body&&document.body.removeAttribute("data-urppp-skin")}catch{}ee();let k=Xt(),$=k?me():Jt();Wt($,{system:k})}}catch{}try{Dt()}catch{}let m=t.closest(".urppp-store-inline");if(m){try{Dr(t)}catch{}try{Ta(m)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(i=>i.addEventListener("click",()=>{try{window.open(i.dataset.repo,"_blank","noopener")}catch{}}))}a(Dr,"fetchThemeManage");function an(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(an,"storeManageSettingsHtml");let ds=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];function dr(){try{let t=JSON.parse(GM_getValue("urppp_store_sources","[]"));return Array.isArray(t)?t:[]}catch{return[]}}a(dr,"getCustomSources");function $a(t){try{GM_setValue("urppp_store_sources",JSON.stringify(t))}catch{}}a($a,"saveCustomSources");let ke=null;async function Ae(t){if(ke&&!t)return ke;let e=a((k,$)=>Promise.race([k,new Promise((B,z)=>setTimeout(()=>z(new Error("timeout")),$))]),"withTimeout"),r=a(async k=>{try{let $=await e(fetch(k,{cache:"no-store"}),5e3);if(!($&&$.ok))return null;let B=await $.json();return B&&Array.isArray(B.items)?B:null}catch{return null}},"fetchCatalogDoc"),o=null;for(let k of ds){let $=await r(k);if($&&(o=$,$.items.some(B=>B.type==="theme"&&B.cardCss)))break}let s=o&&o.items||[],i=dr().filter(k=>k&&k.url&&k.enabled!==!1),l=await Promise.allSettled(i.map(async k=>{let $=await r(k.url);return{doc:$,pubkey:$?$.pubkey:""}})),b=[...s],m=new Set(b.map(k=>k&&k.id).filter(Boolean));for(let k of l){if(!(k.status==="fulfilled"&&k.value&&k.value.doc))continue;let $=k.value.pubkey||"";for(let B of k.value.doc.items)!B||!B.id||m.has(B.id)||(m.add(B.id),$&&(B._srcPub=$),b.push(B))}return ke=b,b}a(Ae,"fetchCatalogList");function on(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let s=0;s<Math.max(r.length,o.length);s+=1){let i=r[s]||0,l=o[s]||0;if(i!==l)return i>l}return!1}a(on,"versionGt");function us(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let s=t.querySelector('[data-theme-use="'+o.id+'"]');s&&on(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(nn(s.closest(".urppp-skin-card"),"主题"),r+=1);let i=t.querySelector('[data-plugin-id="'+o.id+'"]');if(i){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&on(o.version,l.version)&&(nn(i.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(us,"applyStoreUpdateBadges");function nn(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(nn,"addUpdateBadge");function pn(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),s=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");s(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),s()}),r.addEventListener("click",async()=>{r.disabled=!0;let i=r.textContent;r.textContent="检查中…";try{let l=await Ae(),b=us(t,l);r.textContent=b?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=i,r.disabled=!1},1600)})}a(pn,"bindStoreManageSettings");function ms(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="sources" style="display:none">${sn()}</div>
        </div>
      </div>`,rn(t),pn(t),hs(t),ln(t),Ta(t),Dr(t.querySelector("#urppp-theme-manage"))}a(ms,"renderThemeStoreBody");function sn(){let t=dr();return`<div class="urppp-src-manage">
    ...
    </div>`}a(sn,"storeSourcesHtml");function ln(t){let e=t.querySelector("[data-src-add]");if(e){let r=t.querySelector("[data-src-url]"),o=t.querySelector("[data-src-name]");e.addEventListener("click",async()=>{let s=(r.value||"").trim();if(!s)return;e.disabled=!0;let i=e.textContent;e.textContent="验证中…";try{let l=await fetch(s,{cache:"no-store"});if(!(l&&l.ok))throw new Error("无法访问");let b=await l.json();if(!(b&&Array.isArray(b.items)))throw new Error("不是合法 catalog（无 items）");let m=dr();if(m.some(k=>k.url===s)){alert("该源已存在");return}m.push({name:(o.value||"").trim()||s,url:s,enabled:!0}),$a(m),ke=null,Ma(t)}catch(l){alert("添加失败："+(l&&l.message?l.message:l))}finally{e.disabled=!1,e.textContent=i}})}t.querySelectorAll("[data-src-toggle]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcToggle),s=dr();s[o]&&(s[o].enabled=s[o].enabled===!1,$a(s),Ma(t))})),t.querySelectorAll("[data-src-del]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcDel),s=dr();s[o]&&(s.splice(o,1),$a(s),Ma(t))}))}a(ln,"bindStoreSources");function Ma(t){let e=t.querySelector('[data-pane="sources"]');if(e){let r=t;e.innerHTML=sn(),ln(r)}}a(Ma,"refreshStoreSources");function hs(t){let e=t.querySelector("[data-add-local-theme]"),r=t.querySelector("[data-local-theme-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let s=await o.text(),i=s.match(/html\[data-urppp-skin="([\w-]+)"\]/);if(!i){alert('未能从 CSS 中识别主题 id（需要 html[data-urppp-skin="…"]）'),r.value="";return}let l=i[1];try{GM_setValue("urppp_theme_css_"+l,s)}catch{}ji(l,{name:l,desc:"本地主题",author:"本地",version:"1.0.0"});try{fa(l).textContent=s}catch{}r.value="";try{Dr(t.querySelector("#urppp-theme-manage"))}catch{}}))}a(hs,"bindLocalThemeImport");function bs(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
    ...
    </div>`}a(bs,"pluginStoreCard");async function gs(t){if(!t)return;let e=[];try{e=(await Ae()).filter(r=>r.type==="plugin"&&!(_t&&_t.api&&_t.api.isEnabled&&_t.api.isEnabled(r.id)))}catch{}if(!e.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载插件</p><p class="urppp-store-sub">已安装的插件不会再显示在这里。</p></div>';return}t.innerHTML=`<div class="urppp-store-theme-grid">${e.map(r=>bs(r)).join("")}</div>`,t.querySelectorAll("[data-plugin-apply]").forEach(r=>r.addEventListener("click",async()=>{r.disabled=!0;let o=r.textContent;r.textContent="下载中…";try{_t&&_t.api&&_t.api.install&&await _t.api.install(r.dataset.pluginApply,null),r.textContent="已安装";try{Dt()}catch{}}catch{r.textContent="失败"}setTimeout(()=>{r.textContent=o,r.disabled=!1},1200)})),t.querySelectorAll("[data-repo]").forEach(r=>r.addEventListener("click",()=>{try{window.open(r.dataset.repo,"_blank","noopener")}catch{}}))}a(gs,"fetchCatalogPlugins");async function cn(t){if(!t)return;let e=[];try{e=await Ae()}catch{}let r=_t&&_t.api&&_t.api.list&&_t.api.list()||[];if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}t.innerHTML=r.map(o=>{let s=e.find(b=>b.id===o.id),i=s&&s.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(s.downloads))}</span>`:"",l=o.repo||s&&s.repo?`<button type="button" class="urppp-set-btn ghost" data-repo="${at(o.repo||s.repo)}">仓库</button>`:"";return`<div class="urppp-store-item">
      ...
      </div>`,rn(t),pn(t),fs(t),gs(t.querySelector('[data-pane="download"]')),cn(t.querySelector("#urppp-plugin-manage"))}a(dn,"renderPluginStoreBody");function fs(t){let e=t.querySelector("[data-add-local-plugin]"),r=t.querySelector("[data-local-plugin-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let s=await o.text();r.value="";try{new Function(s)()}catch(i){alert("本地插件加载失败："+(i&&i.message?i.message:i))}try{cn(t.querySelector("#urppp-plugin-manage"))}catch{}}))}a(fs,"bindLocalPluginImport");function xs(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>qa("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=Zt();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}u.filter(s=>s.installed!==!1||he(s.id)).forEach(s=>{let i=document.createElement("div");i.className="urppp-skin-card"+(s.id===o?" is-active":""),i.dataset.skin=s.id;let l=document.createElement("button");l.type="button",l.className="urppp-skin-apply";let b=s.installed!==!1||he(s.id);b?s.id===o&&s.ready?(l.classList.add("is-current"),l.textContent="使用中",l.disabled=!0):l.textContent="应用主题":(l.classList.add("is-disabled"),l.textContent="去下载"),l.addEventListener("click",m=>{if(m.preventDefault(),m.stopPropagation(),!b){qa("theme");return}if(!(s.id===o&&s.ready)&&zo(s.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),i.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),i.querySelector(".urppp-skin-name").textContent=s.name,i.querySelector(".urppp-skin-desc").textContent=s.desc,i.appendChild(l),r.appendChild(i)})}a(xs,"renderSkinCards");let He=[],Ia=!1;function ys(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,s=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(i=>{if(!i.ok)throw new Error("HTTP "+i.status);return i.text()}).finally(()=>{s&&clearTimeout(s)})}a(ys,"fetchWithTimeout");function vs(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(s=>{s.status>=200&&s.status<400?r(s.responseText||""):o(new Error("HTTP "+s.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(s){o(s)}})}a(vs,"gmRequestForUpdate");function ws(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),ys(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return vs(t,r);throw o})}a(ws,"fetchTextForUpdate");async function Na(t,e,r=1e3){let o=[],s=t[0],i=t.slice(1),l=a(z=>ws(z,e).then(D=>({url:z,text:D})).catch(D=>(o.push((z.split("/")[2]||z)+": "+(D&&D.message||D)),null)),"grab"),b=l(s),m=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),k=await Promise.race([b,m]);if(k!=="__TIMEOUT__"){if(k&&k.text&&k.text.length>0)return k.text;let D=(await Promise.all(i.map(l))).find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let $=Promise.all(i.map(l)).then(z=>{let D=z.find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),B=b.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([B,$])}a(Na,"fetchFirstAvailable");function Se(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(Se,"setUpdateStatus");async function Ba(){let t=p,e="",r=!1,o="";try{let i=await Na(n.sourceUrls(n.versionJson)),l=JSON.parse(i);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let i=await Na(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=ao(i)}if(!e)throw new Error("无法解析远程主插件版本");let s=vr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:s>0?"update":s===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:r?o:""}}a(Ba,"checkMainUpdate");function un(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let s=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,i=[],l;for(;(l=s.exec(o))!==null;)i.push({ver:l[1],index:l.index,headEnd:s.lastIndex});if(!i.length)return"";for(let m=0;m<i.length;m++){let k=m+1<i.length?i[m+1].index:o.length;i[m].body=o.slice(i[m].index,k).trim()}let b=[];for(let m of i)vr(m.ver,r)>0||vr(m.ver,e)<=0||b.push(m.body);return b.join(`

`).trim()}a(un,"extractChangelogRange");function mn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(mn,"ensureUpdateToastStyles");function ks(t){let e=String(t||"").replace(/\r\n/g,`
...
`),s=[],i=!1,l=a(()=>{i&&(s.push("</ul>"),i=!1)},"closeList");for(let b=0;b<o.length;b++){let k=o[b].replace(/\s+$/,"");if(!k.trim()){l();continue}let $=k.match(/^(#{2,3})\s+(.+)$/);if($){l();let z=$[1].length,D=$[2];s.push(z===2?`<h2>${r(D)}</h2>`:`<h3>${r(D)}</h3>`);continue}let B=k.match(/^[-*]\s+(.+)$/);if(B){i||(s.push("<ul>"),i=!0),s.push(`<li>${r(B[1])}</li>`);continue}l(),s.push(`<p>${r(k)}</p>`)}return l(),s.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(ks,"renderChangelogMarkdown");function hn(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(s=>{s&&s.target!==e||s&&s.propertyName&&s.propertyName!=="opacity"&&s.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(hn,"hideUpdateToast");function As(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(s=>{s&&s.target!==e||s&&s.propertyName&&s.propertyName!=="opacity"&&s.propertyName!=="background-color"&&s.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(As,"hideChangelogModal");function bn(t,e){mn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,r.addEventListener("click",o=>{(o.target===r||o.target&&o.target.getAttribute&&o.target.getAttribute("data-close")==="1")&&As(r)}),document.documentElement.appendChild(r)),r.querySelector("h3").textContent=t||"更新日志",r.querySelector(".uuc-body").innerHTML=e||'<p class="uuc-meta">暂无更新日志</p>',r.__closing=!1,r.classList.remove("open","closing"),r.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add("open"))})}a(bn,"openChangelogModal");function Fa(t){mn();let e=document.getElementById("urppp-update-toast");e||(e=document.createElement("div"),e.id="urppp-update-toast",e.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>hn(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let s=o.getAttribute("data-act"),i=e.__pack||{};if(s==="later"){hn(e);return}if(s==="go"){let l=i.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(s==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=i.changelogMd;l||(l=await Na(n.sourceUrls("CHANGELOG.md")),i.changelogMd=l);let b=un(l,i.local,i.remote),m=b?ks(b):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';bn("更新日志 "+i.local+" → "+i.remote,m)}catch(l){bn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(Fa,"showUpdateToast");async function Da(){if(ma()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await Ba();t&&t.status==="update"&&Fa(t);let e=await Ss();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Da,"maybeAutoCheckUpdate");function Ss(){let t=(window.__urpppUpdateCheckers||He||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?_t.update("assist"):null).catch(()=>null)}a(Ss,"hotUpdateAssist");async function ja(){if(Ia)return;Ia=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Se("正在从多源检查更新…");try{let e=[Ba()];(He||[]).forEach(m=>{m&&typeof m.check=="function"&&e.push(Promise.resolve().then(()=>m.check()).then(k=>k||{id:m.id||"extra",name:m.name||"扩展",status:"err",message:"无结果"}).catch(k=>({id:m.id||"extra",name:m.name||"扩展",status:"err",message:String(k&&k.message||k)})))});let r=await Promise.all(e),o=r.map(m=>{if(!m)return"";if(m.status==="err")return`• <b>${at(m.name||m.id)}</b>：检查失败（${at(m.message||"unknown")}）`;if(m.status==="update"){let k="";if(m.id==="assist"&&_t&&_t.loaded("assist"))k=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let $=m.updateUrl?` <a href="${at(m.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",B=m.pageUrl?` <a href="${at(m.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";k=$+B}return`• <b>${at(m.name)}</b>：发现新版本 <b>${at(m.remote)}</b>（当前 ${at(m.local)}）${k}`}return m.status==="ahead"?`• <b>${at(m.name)}</b>：本地 ${at(m.local)} 新于远程 ${at(m.remote)}`:`• <b>${at(m.name)}</b>：已是最新（${at(m.local)}）`}).filter(Boolean),s=r.some(m=>m&&m.status==="update"),i=r.some(m=>m&&m.status==="err");Se(`${s?"检查完成：发现更新":i?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,i?"err":"ok");let b=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');b&&b.addEventListener("click",()=>{try{Se("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{Se("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(m=>{Se("重新装载失败："+(m&&m.message?m.message:m),"err")})}catch(m){Se("重新装载失败："+(m&&m.message?m.message:m),"err")}})}catch(e){Se("检查失败："+at(e&&e.message||e),"err")}finally{Ia=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(ja,"checkForUpdates");function gn(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+p,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(gn,"refreshUpdateStatusHint");function _s(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=He.findIndex(s=>s&&s.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?He[r]=o:He.push(o);try{let s=document.getElementById("urppp-set-update-status");s&&o.localVersion&&e==="assist"&&s.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{gn()}catch{}return!0}a(_s,"registerUpdateChecker");function Es(){let t={version:p,urls:n,check:ja,checkMain:Ba,registerChecker:_s,compareVersions:vr,parseUserscriptVersion:ao,extractChangelogRange:un,showUpdateToast:Fa,maybeAutoCheckUpdate:Da,listCheckers:a(()=>He.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(Es,"publishUpdateApi"),Es();let{rebuildSidebarCompletely:fn,syncMobileContentOffset:Re,syncSidebarUnderNavbar:_e}=qi({}),{rebuildDashboard:Cs}=wi({deps:{statCardPrivacyMarkup:Ts}}),Ps="urppp-clean-open",Oa={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ie(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ie,"isUnevaluatedScore");function jr(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(jr,"isValidOfficialGpa");function Or(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Or,"firstContentChar");function Ha(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Ha,"weekBitmapActive");function Ue(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ie(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Oa[o]!=null?Oa[o]:Oa[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ue,"scoreToGpa");function We(t){let e=String(t||"").trim();if(!e||ie(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(We,"scoreToNumber");function Ee(t){return Math.round((Number(t)||0)*100)/100}a(Ee,"round2");function xn(t){return/必修/.test(String(t||""))}a(xn,"isRequiredAttr");function re(t){let e=0,r=0,o=0,s=0,i=0,l=0,b=0,m=0;return(t||[]).forEach(k=>{if(k&&(k.unevaluated||ie(k.score)))return;let $=Number(k.credit)||0,B=We(k.score),z=jr(k.officialGpa)?Number(k.officialGpa):Ue(k.score);B==null||$<=0||(e+=$,r+=B*$,z!=null&&(o+=z*$,s+=$),k.required&&(i+=$,l+=B*$,z!=null&&(b+=z*$,m+=$)))}),{totalCredit:Ee(e),avgScore:Ee(e?r/e:0),avgGpa:Ee(s?o/s:0),requiredCredit:Ee(i),requiredGpa:Ee(m?b/m:0),requiredAvg:Ee(i?l/i:0),count:(t||[]).length}}a(re,"summarizeCourses");function Ra(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Ra,"absUrl");function Vt(t,e){let r=Ra(t),o=e&&e.method||"GET",s=e&&e.data||null;return new Promise((i,l)=>{let b=a((m,k)=>m?i(k):l(new Error(k||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:s||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(m=>{m.status>=200&&m.status<400?b(!0,m.responseText||""):b(!1,"HTTP "+m.status)},"onload"),onerror:a(()=>b(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:s||void 0}).then(m=>{if(!m.ok)throw new Error("HTTP "+m.status);return m.text()}).then(m=>b(!0,m)).catch(m=>b(!1,m&&m.message))})}a(Vt,"fetchText");function Hr(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Hr,"parseHtml");function yn(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=Yp,(document.head||document.documentElement).appendChild(t)}a(yn,"ensureFeatureStyles");function zs(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=Kp,(document.head||document.documentElement).appendChild(t)}a(zs,"ensureScheduleExportStyles");function Ls(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=Zp,(document.head||document.documentElement).appendChild(t)}a(Ls,"ensureSettingsStyles");function vn(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let s=r.cloneNode(!0);s.querySelectorAll("small, i, img, b, .badge").forEach(b=>b.remove());let i=(s.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(b=>{b.nodeType===Node.TEXT_NODE&&b.textContent.trim()&&b.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=i||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(vn,"ensureNavNameTarget");function Rr(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Rr,"classifyPrivacyLabel");function qs(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(qs,"classifyHomeDataKey");function Ur(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Ur,"homePrivateValueSpan");function Ts(t,e){let r=at(t),o=at(e),s=qs(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[s]||Rr(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:Ur("organization",s,o)}:{valueHtml:Ur("organization",s,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let b=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&b){let k=b.index||0,$=String(e).slice(0,k),B=String(e).slice(k+b[0].length);return{valueHtml:r,labelHtml:`${at($)}${Ur(l,s,at(b[0]))}${at(B)}`}}return{valueHtml:Ur(l,s,r),labelHtml:o}}a(Ts,"statCardPrivacyMarkup");function Ce(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||Sr;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||Sr)}a(Ce,"privacyReplacement");function ur(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(ur,"markPrivateText");function wn(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||Sr);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(wn,"markPrivateAvatar");function $s(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a($s,"markPrivateBlock");function Ms(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(Ms,"markDirectEditable");let ge=null;function kn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;ge&&ge.__finish&&ge.__finish(!1);let r=we();if(r.mode!=="custom"||!r.directEdit.enabled)return;let s=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),i=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),b=i.height>=8||!l?i:{left:i.left,top:l.top,width:Math.max(i.width,40),height:l.height},m=document.createElement("input"),k=getComputedStyle(t),$=Math.min(Math.max(b.width+64,140),Math.max(140,window.innerWidth-24)),B=Math.min(Math.max(12,b.left),Math.max(12,window.innerWidth-$-12)),z=Math.min(Math.max(12,b.top+(b.height-36)/2),Math.max(12,window.innerHeight-48));m.type="text",m.maxLength=80,m.className="urppp-direct-edit-input",m.value=s,m.setAttribute("aria-label","修改"+U[e]+"显示值"),m.style.left=B+"px",m.style.top=z+"px",m.style.setProperty("--urppp-direct-edit-width",$+"px"),m.style.fontFamily=k.fontFamily,m.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(k.fontSize)||14)))+"px";let D=!1,J=a(j=>{if(D||(D=!0,m.remove(),ge===m&&(ge=null),j))return;let R=we();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(m.value||"").trim().slice(0,80),ha(R),Yt(document),Va(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");m.__finish=J,m.addEventListener("click",j=>j.stopPropagation()),m.addEventListener("blur",()=>J(!1)),m.addEventListener("keydown",j=>{j.key==="Enter"&&(j.preventDefault(),J(!1)),j.key==="Escape"&&(j.preventDefault(),J(!0))}),document.documentElement.appendChild(m),ge=m,m.focus(),m.select()}a(kn,"openDirectEditInput");function Is(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),kn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),kn(e))},!0))}a(Is,"bindDirectEditInteraction");function Ns(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(Ns,"clearPrivacyDisplay");function An(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(An,"applyCustomText");function Bs(t){let e=t&&t.querySelectorAll?t:document,r=Me(),s=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?vn(e):null);An(s,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(b=>{let m=b.querySelector(".profile-info-name"),k=b.querySelector(".profile-info-value");!m||!k||String(m.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||An(k,r.nameEnabled,r.name)});let i=rr(r.avatar),l=r.avatarEnabled&&!!i;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(b=>{let m=b.getAttribute("src")||"";m&&m!==b.__urpppAppliedCustomSrc&&(b.__urpppOriginalSrc=m),l?(b.__urpppOriginalSrc==null&&(b.__urpppOriginalSrc=m),m!==i&&b.setAttribute("src",i),b.__urpppAppliedCustomSrc=i):b.__urpppAppliedCustomSrc!=null&&(b.__urpppOriginalSrc&&b.setAttribute("src",b.__urpppOriginalSrc),delete b.__urpppAppliedCustomSrc)})}a(Bs,"applyCustomIdentityDisplay");function Fs(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),s=r.querySelector(".profile-info-value, td:last-child");if(!o||!s||o===s)return;let i=Rr(o.textContent),l=Ce(e,i);l&&ur(s,l)})}a(Fs,"applyProfilePrivacy");function Ds(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let s=o.map(i=>{let l=Rr(i.textContent);return["grade","gpa","credit"].includes(l)?l:""});s.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(i=>{let l=i.querySelectorAll("td");s.forEach((b,m)=>{let k=Ce(e,b);b&&k&&ur(l[m],k)})})})}a(Ds,"applyScoreTablePrivacy");function js(t){let e=t&&t.querySelectorAll?t:document,r=we();if(r.mode==="off")return;let o=Ce(r,"name"),s=Ce(r,"avatar"),i=Ce(r,"schedule"),l=o?vn(e):e.querySelector?.(".urppp-user-name-value");o&&ur(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([k,$])=>{let B=Ce(r,$);B&&e.querySelectorAll(k).forEach(z=>ur(z,B))}),Ds(e,r);let m=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(k=>{let $=k.getAttribute("data-urppp-private"),B=k.getAttribute("data-urppp-edit-key"),D=(m&&B?String(r.directEdit.values[B]||"").trim():"")||Ce(r,$);!["avatar","schedule"].includes($)&&D&&ur(k,D),m&&B&&Ms(k,B)}),m&&Is(),Fs(e,r),s&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(k=>{let $=k.matches("img")?k:k.querySelector("img");$?wn($,s):(k.classList.add("urppp-private-avatar-block"),k.setAttribute("data-urppp-private-mask",s))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(k=>wn(k,s))),i){let k=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));k.filter($=>!k.some(B=>B!==$&&B.contains($))).forEach($=>$s($,i))}}a(js,"applyPrivacyDisplay");let Ua=0,se=[];function Sn(){let t=we(),e=Me();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(Sn,"personalDisplayIsEnabled");function Os(){se=se.filter(({root:t})=>t&&t.isConnected),se.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(Os,"resumePersonalDisplayObservers");function Yt(t){let e=t||document;se.forEach(({observer:r})=>r.disconnect());try{yn()}catch{}try{Ns(e)}catch{}try{Bs(e)}catch(r){console.warn("[URP++] custom identity",r)}try{js(e)}catch(r){console.warn("[URP++] privacy",r)}Sn()?(Os(),Rs()):(clearTimeout(Ua),se=[])}a(Yt,"applyPersonalDisplay");function Hs(t){clearTimeout(Ua),Ua=setTimeout(()=>Yt(t||document),140)}a(Hs,"schedulePersonalDisplay");function Wa(){try{nt&&nt.open&&Xe()}catch{}}a(Wa,"refreshCleanPersonalDisplay");function Rs(){if(!Sn()){se.forEach(({observer:t})=>t.disconnect()),se=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(se.some(r=>r.root===t))return;let e=new MutationObserver(()=>Hs(document));se.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(Rs,"bindPersonalDisplayObservers");function Us(t){let e=Object.assign({},t||{}),r=Me();r.nameEnabled&&r.name&&(e.name=r.name);let o=rr(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(Us,"personalizedProfile");let _n="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",Ws="/student/courseSelect/thisSemesterCurriculum/callback",Gs="/student/courseSelect/thisSemesterCurriculum/index";async function Js(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Vt(Ws),r=JSON.parse(e),o=er(r);if(o)return o}catch{}return""}a(Js,"resolveSchedulePlanCode");async function En(t){let e=await Js(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Vt(_n,r),s;try{s=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=er(s)),(!s.jcsjbs||!s.jcsjbs.length)&&e&&(s=JSON.parse(await Vt(_n,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let i=Pn(s,e,t);if(!i.courses.length)throw new Error("没有读取到可导出的课表数据");return i}a(En,"loadScheduleExportData");function Ga(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(Ga,"safeScheduleFilename");function Ja(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(Ja,"downloadBlob");function Vs(t){let e=Xr(t),r=Lr(),o=r.enabled?Zr(e,r.mapping):Kr(e),s=JSON.stringify(o,null,2)+`
`;return Ja(new Blob([s],{type:"application/json;charset=utf-8"}),Ga(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(Vs,"exportScheduleJson");function Cn(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let s=Number(r[4]);if(s<1||s>30)return"";let i=po(new Date);return i.setDate(i.getDate()-(s-1)*7),Ar(i)}a(Cn,"deriveCurrentSemesterMonday");function Pn(t,e,r){let o=e||er(t),s=Cn(o)||ba()[o]||"";return bp(t,o,r,{firstMonday:s})}a(Pn,"normalizeScheduleDataForPage");function Ys(t){let e=t.semester.planCode,r=ba()[e],o=Cn(e);return o?(wo(e,o),Promise.resolve(o)):tr(r)?Promise.resolve(r):new Promise((s,i)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||cp(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let b=a((m,k)=>{l.remove(),m?i(m):s(k)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>b(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let m=l.querySelector("input").value;tr(m)&&(wo(e,m),b(null,m))}),l.addEventListener("click",m=>{m.target===l&&b(new Error("已取消导出"))})})}a(Ys,"requestScheduleFirstMonday");async function Qs(t){let e=await Ys(t),r=up(t,e);return Ja(new Blob([r],{type:"text/calendar;charset=utf-8"}),Ga(t.semester.label)+".ics"),mp(t)}a(Qs,"exportScheduleIcs");let Xs={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function le(t,e,r){if(typeof document>"u")return Gt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let s=getComputedStyle(o).color;o.remove();let i=String(s||"").match(/[\d.]+/g)?.map(Number)||[];if(i.length>=3){let l=yr(i[0],i[1],i[2]),b=i.length>3?Math.max(0,Math.min(1,i[3])):1;return b<1?Bt(r||e,l,b):l}return Gt(s)||Gt(e)||"#000000"}a(le,"resolvedScheduleImageColor");function zn(){let t=Jt(),e=Zt(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},s={bg:le("--bg",o.bg),surface:le(e==="neu"?"--neu-base":"--surface",o.surface),input:le("--input-bg",o.input),text:le("--text",o.text),secondary:le("--text-secondary",o.secondary),muted:le("--text-muted",o.muted),border:le("--border",o.border,le(e==="neu"?"--neu-base":"--surface",o.surface)),primary:le("--primary",o.primary)},i={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(Xs[e]||e)+" · "+(Ct[t]&&Ct[t].name||t),colors:s,shape:i[e]||i.apple}}a(zn,"currentScheduleImageTheme");function Ln(t,e){return Sp(t,e||zn())}a(Ln,"buildScheduleSvg");function Ks(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),s=URL.createObjectURL(o),i=new Image;i.onload=()=>{try{let b=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),m=document.createElement("canvas");m.width=Math.floor(t.width*b),m.height=Math.floor(t.height*b);let k=m.getContext("2d");k.scale(m.width/t.width,m.height/t.height),k.fillStyle=t.background||"#F8FAFC",k.fillRect(0,0,t.width,t.height),k.drawImage(i,0,0,t.width,t.height),m.toBlob($=>$?e($):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(s)}},i.onerror=()=>{URL.revokeObjectURL(s),r(new Error("课表图片渲染失败"))},i.src=s})}a(Ks,"svgToPngBlob");async function Zs(t){let e=await Ks(Ln(t));Ja(e,Ga(t.semester.label)+".png")}a(Zs,"exportSchedulePng");function Va(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(Va,"showFeatureToast");let Ya=_p({document,window,ensureStyles:zs,loadData:En,exportJson:Vs,exportIcs:Qs,exportPng:Zs,showToast:Va,nativePageUrl:Gs,navigate:a(t=>{location.href=t},"navigate"),logger:console});function tl(t,e,r,o){return Ya.run(t,e,r,o)}a(tl,"runScheduleExport");function el(t){return Ya.createMenu(t)}a(el,"createScheduleExportMenu");function rl(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(rl,"disposeNativePdfCapture");function al(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let s=Wp(e);t.stage="ok",t.stageCards=s.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=s.target.querySelector("table")?s.target.querySelector("table").id:"none",rl(s)}catch(s){t.stage="failed",t.stageError=s&&s.message||String(s)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(al,"bindNativePdfDiagnose");function ol(t){return t?(al(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await Vp(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:lr})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Va("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(ol,"pagePdfExportHandler");function Qa(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Qa,"isPersonalSchedulePage");function nl(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(nl,"isScoreQueryPage");function Xa(){if(!Qa())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let s=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),i=el({source:"native",pdfHandler:ol(s)});if(i.id="urppp-native-schedule-export",s&&s.parentElement){s.__urpppNativeExportState||(s.__urpppNativeExportState={display:s.style.getPropertyValue("display"),displayPriority:s.style.getPropertyPriority("display"),ariaHidden:s.getAttribute("aria-hidden"),tabIndex:s.getAttribute("tabindex")}),s.setAttribute("data-urppp-native-export-source","1"),s.style.setProperty("display","none","important"),s.setAttribute("aria-hidden","true"),s.setAttribute("tabindex","-1"),s.parentElement.insertBefore(i,s.nextSibling);return}if(e)e.appendChild(i);else if(t)t.appendChild(i);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let b=document.createElement("div");b.className="urppp-export-fallback",b.appendChild(i),l.prepend(b)}}}a(Xa,"patchNativeScheduleExport");let Ge=null,Wr=0;function Ka(){clearTimeout(Wr),Wr=0,Ge&&Ge.observer.disconnect(),Ge=null}a(Ka,"disconnectNativeScheduleExportObserver");function pl(){if(!Qa()){Ka();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ge&&Ge.root===t&&t.isConnected)return;Ka();let e=new MutationObserver(()=>{clearTimeout(Wr),Wr=setTimeout(()=>Xa(),80)});e.observe(t,{childList:!0,subtree:!0}),Ge={root:t,observer:e}}a(pl,"bindNativeScheduleExportObserver");function qn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(qn,"restoreOptionalAttribute");function il(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let s=o.__urpppNativeExportState;s&&(s.display?o.style.setProperty("display",s.display,s.displayPriority):o.style.removeProperty("display"),qn(o,"aria-hidden",s.ariaHidden),qn(o,"tabindex",s.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(il,"removeNativeScheduleExport");let Tn=zi({deps:{styles:oi,loadScores:Gn,loadProfile:$n,scoreToNumber:We,scoreToGpa:Ue,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),sl=ap([Yr({id:"schedule-export",matches:a(t=>Qa(t.location),"matches"),mount:a(()=>{Xa(),pl()},"mount"),unmount:a(t=>{Ka(),il(t?.lifecycleKey)},"unmount")}),Yr({id:"score-analysis",matches:a(t=>nl(t.location),"matches"),mount:a(()=>{try{Tn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Tn.unmount()}catch{}},"unmount")})]);function Gr(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return sl.refresh({document,location,window,lifecycleKey:t})}a(Gr,"refreshRouteFeatures");function ll(t){Ya.bindHosts(t)}a(ll,"bindScheduleExportHosts");function mr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(mr,"normalizeProfileValue");function Jr(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(s=>mr(s).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let s=0;s<o.length;s++){let i=o[s],l=i.querySelector(".profile-info-name, th, label"),b=i.querySelector(".profile-info-value, td:last-child");if(!l||!b||l===b)continue;let m=mr(l.textContent).replace(/[：:]/g,"");if(!r.some($=>m===$||m.endsWith($)))continue;let k=mr(b.textContent);if(k&&k!=="—"&&k!=="-")return k}return""}a(Jr,"readLabeledProfileValue");function Je(t){return mr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Je,"cleanMajorPlanName");function cl(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),s=mr(o);if(/主修必修GPA/.test(s)){let i=s.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||s.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(i){let l=Number(i[1]),b=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||b===0||l>0)&&(e.majorGpa=i[1])}}if(/主修为|培养方案/.test(s)){let i=s.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||s.match(/^(.{2,60}?)\s*主修为/)||s.match(/主修为\s*(.{2,60})$/),l=Je(i&&i[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let b=/培养方案|教学计划/.test(l);(!e.majorPlan||b)&&(e.majorPlan=l)}}}),e}a(cl,"extractAcademicOverview");async function $n(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let i=r.querySelector(".urppp-user-name-value"),l=i&&i.__urpppOriginalText;l&&(t.name=String(l).trim());let b=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),m=t.name?null:b.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!m){let k=r.cloneNode(!0);k.querySelectorAll("small, i, img, b, .badge").forEach(B=>B.remove());let $=(k.textContent||"").replace(/\s+/g," ").trim();$=$.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),m=$.match(/([\u4e00-\u9fa5·]{2,12})/)}m&&m[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(m[1])&&(t.name=m[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let s=cl(document);t.majorPlan=s.majorPlan,t.majorGpa=s.majorGpa}catch{}try{let r=await Vt("/student/rollManagement/rollInfo/index"),o=Hr(r),s=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Jr(o,["姓名"]),!t.name)){let m=s.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);m&&(t.name=m[1].trim())}let i=Jr(o,["主修方案名称"]),l=Jr(o,["专业"]);t.studentId=Jr(o,["学号"]),i?t.majorPlan=Je(i):!t.majorPlan&&l&&(t.majorPlan=Je(l));let b=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(b&&b.getAttribute("src")&&!t.avatar){let m=b.getAttribute("src");t.avatar=/^https?:/i.test(m)?m:Ra(m)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a($n,"loadProfile");let Mn=["周日","周一","周二","周三","周四","周五","周六"];function Za(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(s=>{let i=String(s.id||"").match(/^(\d+)_(\d+)$/);if(!i)return;let l=parseInt(i[1],10),b=parseInt(i[2],10),m=l===7?0:l,k=s.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),$=k.length?k:[];if(!$.length&&(s.textContent||"").trim()){let B=(s.textContent||"").replace(/\s+/g," ").trim();B&&e.push({name:B.slice(0,40),teacher:"",place:"",week:"",day:m,section:b});return}$.forEach(B=>{let z=Array.from(B.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),D=(B.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(B.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",j=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=z.find(K=>/周/.test(K))||"",F=String(D).replace(/_\d+\s*$/,"").trim();!F||F.length<2||e.push({name:F,teacher:String(j).trim(),place:String(J||"").trim(),week:String(R).trim(),day:m,section:b})})});let o=new Set;return e.filter(s=>{let i=[s.day,s.section,s.name,s.place].join("|");return o.has(i)?!1:(o.add(i),!0)})}a(Za,"parseScheduleFromDoc");let In="urppp_term_week_v1";function Ve(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(In,e)}catch{}return e}a(Ve,"rememberTermWeek");function hr(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(In,0))||0;if(t>=1&&t<=30)return Ve(t)}catch{}return 0}a(hr,"readRememberedTermWeek");function br(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let s=e.match(r[o]);if(s){let i=parseInt(s[1],10);if(i>=1&&i<=30)return i}}return 0}a(br,"extractTermWeekFromText");function Pe(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let b=t[l],m=br(b.innerText||b.textContent||"")||br(b.innerHTML||"");if(m)return Ve(m)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=br(e);if(r)return Ve(r);let o=document.body&&document.body.innerText||"",s=br(o);if(s)return Ve(s);let i=hr();if(i)return i}catch{}return 0}a(Pe,"getCurrentWeekNumber");let Ye=null;function dl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(dl,"calTodayStr");function ul(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(s=>String(s).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(ul,"calAddDays");function gr(t){if(Ye)return Ye;let e=t||dl();return e>="2027-02-06"&&e<=ul("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(gr,"calVacation");function ml(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(ml,"festiveDecorHtml");function Nn(){let t=typeof document<"u"?document:null;if(!t)return;let e=gr()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",ml()):!e&&r&&r.remove()}a(Nn,"syncFestiveDecor");function Bn(t){Ye=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Ye&&Ye!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{Nn()}catch{}try{typeof Xe=="function"&&Xe()}catch{}return Ye}a(Bn,"setCalendarPhase");function hl(){return gr()}a(hl,"getCalendarPhase");function Fn(){if(gr()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=Pe()||hr()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(Fn,"getViewWeekNumber");async function bl(){let t=Pe();if(t>=1)return t;try{let e=await Vt("/index");if(t=br(e),t)return Ve(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),s=await Vt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),i=JSON.parse(s),l=Number(i&&i.jxzc);if(l>=1&&l<=30)return Ve(l)}catch{}return hr()||0}a(bl,"ensureTermWeekResolved");function gl(t){let e=Pe()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let s=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);s&&(e=Math.max(e,parseInt(s[2],10)||0));let i=String(r.week||"").match(/\d{1,2}/g);i&&i.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(gl,"inferMaxWeek");function Dn(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Dn,"weekBitActive");let jn=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function On(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return jn[e%jn.length]}a(On,"courseColor");function fl(t){let e=[],r=Pe();(t&&t.xkxx||[]).forEach(i=>{Object.keys(i||{}).forEach(l=>{let b=i[l];if(!b)return;let m=b.courseName||b.englishCourseName||l,k=b.attendClassTeacher||"";(b.timeAndPlaceList||[]).forEach(B=>{let z=Number(B.classDay)||0,D=z===7?0:z,J=Number(B.classSessions)||1,j=Math.max(1,Number(B.continuingSession)||1),R=[B.campusName,B.teachingBuildingName,B.classroomName].filter(Boolean).join(""),F=B.weekDescription||b.skzcs||"",K=Dn(B.classWeek,r)||r&&F.indexOf(String(r))>=0;e.push({name:String(m).trim(),teacher:String(k).trim(),place:String(R).trim(),week:String(F).trim(),classWeek:String(B.classWeek||""),day:D,section:J,span:j,thisWeek:!!K,color:On(m)})})})});let s=new Set;return e.filter(i=>{let l=[i.day,i.section,i.span,i.name,i.place,i.week].join("|");return s.has(l)?!1:(s.add(l),!0)})}a(fl,"parseScheduleFromJson");async function xl(){try{let t=await Vt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let s=Number(r&&(r.jxzc||r.zc||r.currentWeek));s>=1&&s<=30&&(nt._termWeek=Math.max(nt._termWeek||0,s),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=fl(r)}catch{e=Za(Hr(t))}e.length||(e=Za(document));let o=r?Pn(r,er(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=Za(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(xl,"loadSchedule");function yl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),s=r.match(o);if(s&&s[1])return s[1];let i=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(i);return l?l[1]:""}a(yl,"extractScoreCallback");function vl(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let s=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",i=[];(o.cjList||[]).forEach(l=>{let b=l.courseName||l.englishCourseName||"";if(!b)return;let m=l.cj!=null&&l.cj!==""?String(l.cj):"";!m&&l.courseScore!=null&&(m=String(l.courseScore)),!m&&l.gradeName&&(m=String(l.gradeName)),!m&&l.zscj!=null&&(m=String(l.zscj));let k=l.courseAttributeName||l.xkcsxmc||"",$=parseFloat(l.credit)||0,B=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",D=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ie(m)||ie(l.gradeName)||D!=null&&D<0,j=J?"未评估":m;i.push({code:B,seq:String(z||""),name:b,attr:k,credit:$,score:j,unevaluated:J,required:xn(k),officialGpa:jr(D)?D:null,evalUrl:""})}),i.length&&e.push({title:String(s).slice(0,100),courses:i,summary:re(i),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(vl,"parseScoreJson");async function Hn(t,e){let r=await Vt(t),o=Rn(Hr(r));if(o.length)return o;let s=yl(r,e);if(!s)return[];let i=await Vt(s);try{let l=JSON.parse(i);o=vl(l).map(b=>(b.summary=re(b.courses),b))}catch{o=Rn(Hr(i))}return o}a(Hn,"loadScoreByIndex");function Rn(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map($=>($.textContent||"").replace(/\s+/g,""));if(!o.length)return;let s=o.join("|");if(!/课程名/.test(s)||!/成绩/.test(s))return;let i={code:o.findIndex($=>$==="课程号"),name:o.findIndex($=>$==="课程名"),attr:o.findIndex($=>/课程属性|属性/.test($)),credit:o.findIndex($=>$==="学分"),score:o.findIndex($=>$==="成绩")};if(i.name<0||i.score<0)return;let l="成绩",b=r.previousElementSibling;for(let $=0;$<8&&b;$++,b=b.previousElementSibling)if(/^H[1-4]$/.test(b.tagName)||b.classList&&b.classList.contains("header")){l=(b.textContent||"").replace(/\s+/g," ").trim();break}let m=[],k=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(k).forEach($=>{let B=Array.from($.cells||$.querySelectorAll("td"));if(B.length<4)return;let z=a(F=>F>=0&&B[F]?(B[F].textContent||"").replace(/\s+/g," ").trim():"","get"),D=z(i.name),J=z(i.score);if(!D||!J||/课程名|序号/.test(D))return;let j=z(i.attr),R=ie(J);m.push({code:z(i.code),name:D,attr:j,credit:parseFloat(z(i.credit))||0,score:R?"未评估":J,unevaluated:R,required:xn(j),officialGpa:null,evalUrl:""})}),m.length&&e.push({title:l.slice(0,100),courses:m,summary:re(m)})}),e}a(Rn,"parseScoreTables");function fr(t){return Je(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(fr,"schemePlanName");function Un(t,e){if(!t||!t.length)return 0;let r=Je(e),o=t.findIndex(l=>{let b=fr(l);return/培养方案/.test(b)&&!/微专业|辅修|双学位/.test(b)});if(o>=0&&(!r||fr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let b=fr(l);return b.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(b.slice(0,4))||b.includes(r.slice(0,4))}),o>=0))return o;let s=0,i=-1;return t.forEach((l,b)=>{if(/微专业|辅修/.test(fr(l)))return;let m=(l.courses||[]).length;m>i&&(i=m,s=b)}),s}a(Un,"pickMajorSchemeIndex");async function wl(){let t={};try{let e=await Vt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(s=>{let i=String(s.KCH||"").trim();if(!i)return;let l=String(s.SFPG)==="1",b=String(s.KTID||"").trim();if(!t[i]){t[i]={ktid:b,kxh:String(s.KXH||""),kcm:s.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&b?"/student/teachingEvaluation/newEvaluation/evaluation/"+b:"/student/teachingEvaluation/newEvaluation/index"};return}t[i].total+=1,l||(t[i].pending+=1,t[i].done=!1,b&&(t[i].ktid=b,t[i].url="/student/teachingEvaluation/newEvaluation/evaluation/"+b))}),Object.keys(t).forEach(s=>{let i=t[s];i.done=!(i.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(wl,"loadEvaluationMap");function kl(t){if(!t)return!1;if(t.officialGpa!=null&&jr(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ie(e)?!1:We(e)!=null||Ue(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(kl,"hasDisplayableScore");function Al(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(s=>{if(!s||!s.code)return;let i=e[s.code];if(i){if(kl(s)){s.unevaluated=!1,i.done?s.evalUrl=s.evalUrl||"":s.evalUrl=i.url||"/student/teachingEvaluation/newEvaluation/index";return}i.done||(s.unevaluated=!0,s.evalUrl=i.url||"/student/teachingEvaluation/newEvaluation/index",(!s.score||s.score===""||ie(s.score))&&(s.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(Al,"attachEvaluationLinks");function Wn(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=re(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=re(e.courses),e)),t)}a(Wn,"refreshScoreSummaries");async function Sl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await wl();return Al(t,e),t.evalMap=e,t.evaluationReady=!0,Wn(t)}finally{t.evaluationLoading=!1}}a(Sl,"enrichScoresWithEvaluation");function _l(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=Un(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let s=fr(o),i=Je(nt.profile.majorPlan);/培养方案|教学计划/.test(s)&&(!/培养方案|教学计划/.test(i)||i==="主修方案")&&(nt.profile.majorPlan=s);let l=o.summary||{},b=Number(l.requiredCredit),m=Number(l.requiredGpa),k=Number(nt.profile.majorGpa);b>0&&Number.isFinite(m)&&m>=0&&m<=5&&(!Number.isFinite(k)||k<=0)&&(nt.profile.majorGpa=String(Ee(m)))}a(_l,"reconcileProfileAndScores");let Qe=null;async function Gn(t){return t&&(Qe=null),Qe&&!Qe.error||(Qe=await El()),Qe}a(Gn,"loadScores");async function El(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([Hn("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),Hn("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(s=>s.courses.forEach(i=>{o.push(Object.assign({term:s.title},i))})),t.passing=[{title:"全部及格成绩",courses:o,summary:re(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:re(o)}]),Wn(t),t.majorIdx=Un(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(El,"loadScoresImpl");function ze(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(ze,"parseJsonArrayLoose");function Jn(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let s=0;for(let i=o;i<t.length&&i<o+3e5;i++){let l=t[i];if(l==="[")s++;else if(l==="]"&&(s--,s===0))return t.slice(o,i+1)}return""}a(Jn,"extractBalancedArray");async function Cl(){let t=await Vt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let i=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(i&&(e=ze(i)),l&&(r=ze(l)),!e.length){let b=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);b&&(e=ze(b[1]))}if(!r.length){let b=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);b&&(r=ze(b[1]))}if(!r.length){let b=Jn(t,"teachingBuildingName");b&&(r=ze(b))}if(!e.length){let b=Jn(t,"campusName");b&&(e=ze(b))}}catch(i){console.warn("[URP++] classroom json parse",i)}if(!r.length){let i=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=i;let l=[];for(let b of i)try{let m=await Vt("/student/teachingResources/classroomCurriculum/"+b.campusNumber+"/teachingBuildingJson");ze(m).forEach($=>{l.push({id:{campusNumber:b.campusNumber,teachingBuildingNumber:String($.id&&$.id.teachingBuildingNumber||$.teachingBuildingNumber||"")},teachingBuildingName:$.teachingBuildingName||$.name||""})})}catch(m){console.warn("[URP++] building json",b.campusNumber,m)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(i=>({campus:i.campusName||i.campusNumber,campusNumber:String(i.campusNumber||i.id&&i.id.campusNumber||""),buildings:[]}));r.forEach(i=>{let l=String(i.id&&i.id.campusNumber||i.campusNumber||""),b=String(i.id&&i.id.teachingBuildingNumber||i.teachingBuildingNumber||""),m=i.teachingBuildingName||i.name||b;if(!l||!b||!m)return;let k=o.find(B=>B.campusNumber===l);k||(k={campus:l,campusNumber:l,buildings:[]},o.push(k));let $="/student/teachingResources/classroomUseStatus/"+l+"/"+b+"/"+encodeURI(encodeURI(k.campus||l))+"/"+encodeURI(encodeURI(m));k.buildings.push({name:m,path:$,campusNumber:l,buildingNumber:b})});let s=o.filter(i=>i.buildings.length);if(!s.length)throw new Error("未解析到教学楼，请刷新后重试");return s}a(Cl,"loadClassroomCatalog");function xr(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(xr,"occupancyTypeLabel");function Pl(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return xr(t)}a(Pl,"occupancyReason");async function zl(t,e,r,o){let s=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),i=await Vt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+s.toString());try{let l=JSON.parse(i);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(b=>b&&typeof b=="object"&&(b.kcm||b.id&&b.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(zl,"fetchClassroomCurriculum");function Ll(t,e,r){let o=t||[],s=Number(e.xq)||0,i=Number(e.start)||0,l=Number(r)||0,b=[];return o.forEach(m=>{let k=m.id||{},$=Number(k.skxq!=null?k.skxq:m.skxq)||0,B=Number(k.skjc!=null?k.skjc:m.skjc)||0,z=Math.max(1,Number(m.cxjc)||1),D=k.skzc||m.skzc||"";s&&$&&s!==$||i&&(i<B||i>=B+z)||l&&D&&!Ha(D,l)||b.push(m)}),b.length?(b.sort((m,k)=>{let $=Ha(m.id&&m.id.skzc||m.skzc,l)?0:1,B=Ha(k.id&&k.id.skzc||k.skzc,l)?0:1;return $-B}),b[0]):null}a(Ll,"matchCurriculumCourse");async function ql(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),s=String(e.buildingNumber||""),i=r||t.planNumber||"";if(!o||!s||!i)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(D=>D.busy)),b={},m=a(async z=>{if(b[z])return b[z];try{b[z]=await zl(i,o,s,z)}catch{b[z]=[]}return b[z]},"queue"),k=4,$=0,B=new Array(Math.min(k,Math.max(l.length,1))).fill(0).map(async()=>{for(;$<l.length;){let z=$++,D=l[z],J=await m(D.name);(D.slots||[]).forEach(j=>{if(!j.busy)return;let R={xq:j.detail&&j.detail.xq||j.xq||0,start:j.section,week:t.jxzc};j.detail&&j.detail.xq!=null&&(R.xq=j.detail.xq);let F=Ll(J,R,t.jxzc);if(F&&F.kcm){let K=String(F.kcm).trim();j.contentName=K,j.reason=K,j.displayChar=Or(K),j.detail&&(j.detail.contentName=K,j.detail.reason=K,j.detail.teacher=F.jsm||"",j.detail.weeks=F.zcsm||"",j.detail.courseNo=F.id&&F.id.kch||"",j.detail.typeLabel=xr({occupancymoduleId:j.module}))}else j.displayChar=Or(j.reason||"占用"),j.detail&&(j.detail.typeLabel=xr({occupancymoduleId:j.module}))})}});return await Promise.all(B),t}a(ql,"enrichOccupancyWithCurriculum");function Tl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(Tl,"occupancyKindClass");async function $l(t){let e="",r="",o="",s="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",s=t.path||"";else{s=String(t||"");let F=s.match(/classroomUseStatus\/(\d+)\/(\d+)\//);F&&(e=F[1],r=F[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let i=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=Ml(Vn(new Date,i)),b="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),m=await new Promise((F,K)=>{let ut=Ra("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:b,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?F(vt.responseText||""):K(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:b}).then(vt=>vt.text()).then(F).catch(K)}),k;try{k=JSON.parse(m)}catch{throw new Error("jasInfo 非 JSON")}let $=(k.classrooms||[]).map(F=>{let K=F.classroomName||F.id&&F.id.classroomNumber||"",ut=F.placeNum||"",vt=F.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:K,seats:ut,type:vt,slots:Et,map:{}}}),B={};$.forEach(F=>{B[F.name]=F}),(k.classroomTime||[]).forEach(F=>{let K=F.id||{},ut=K.classroomNumber||"",vt=Number(K.sessionstart)||1,Et=Math.max(1,Number(F.continuingsession)||1),Lt=B[ut];if(!Lt)return;let qt=xr(F),Ot=Pl(F);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let $t=Lt.slots.find(ae=>ae.section===Ht);$t&&($t.busy=!0,$t.kind=F.timestatenumber||F.occupancymoduleId||"",$t.module=F.occupancymoduleId||"",$t.reason=Ot,$t.typeLabel=qt,$t.displayChar=Or(Ot),$t.xq=K.xq,$t.weekBitmap=K.week||"",$t.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:K.week||"",xq:K.xq||"",state:F.timestatenumber||"",module:F.occupancymoduleId||""})}});let z="";try{let F=k.jhZxjxjhb;typeof F=="string"&&/\d{4}-\d{4}-\d-\d/.test(F)?z=F:F&&typeof F=="object"&&(z=String(F.zxjxjhh||F.jhxnxq||F.executiveEducationPlanNumber||F.planNumber||""))}catch{}if(!z&&k.classrooms&&k.classrooms[0]&&k.classrooms[0].id&&(z=k.classrooms[0].id.executiveEducationPlanNumber||""),k.jxzc!=null&&Number(k.jxzc)>=1){let F=Number(k.jxzc);nt._termWeek=Math.max(nt._termWeek||0,F),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let D=["日","一","二","三","四","五","六"],J=Il(k.date||l)||Vn(new Date,i),j=k.week!=null?Number(k.week):J.getDay(),R=i===1?"明天":i===2?"后天":"今天";return{rooms:$,dateLabel:(k.date||l)+"（周"+(D[j]||j)+" · "+R+"）",jxzc:k.jxzc,planNumber:z,week:k.week!=null?k.week:j,searchDate:k.date||l,dateOffset:i}}a($l,"loadBuildingOccupancy");function Vn(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(Vn,"addDays");function Ml(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(Ml,"formatLocalDate");function Il(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(Il,"parseLocalDate");let Yn={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function Qn(t){return Yn[t]||Yn.more}a(Qn,"ico");let nt=pi();function Nl(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=ri,(document.head||document.documentElement).appendChild(t)}a(Nl,"ensureStyle");let Bl=pa({deps:{scoreToNumber:We,scoreToGpa:Ue}}),{metricHtml:Fl,occupancyHtml:Dl,render:Xe,renderScheduleBoard:Mc,roomPickerHtml:jl,scheduleRender:Ol}=xi({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:Mn,analyzeScores:a(t=>Bl.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Yt,bandsChartSvg:sa,bindUI:a(t=>Rl(t),"bindUI"),classifyPrivacyLabel:Rr,courseColor:On,ensureRoot:a(()=>Kn(),"ensureRoot"),escapeHtml:at,firstContentChar:Or,getViewWeekNumber:Fn,ico:Qn,isCleanAnalysisDirect:ua,occupancyKindClass:Tl,occupancyTypeLabel:xr,personalizedProfile:Us,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:We,summarizeCourses:re,trendChartSvg:ia,weekBitActive:Dn,calVacation:gr,setCalendarPhase:Bn}}),{ensureRoomCatalogLoaded:Xn,loadAll:Hl}=si({state:nt,deps:{ensureTermWeekResolved:bl,enrichScoresWithEvaluation:Sl,getCurrentWeekNumber:Pe,loadClassroomCatalog:Cl,loadProfile:$n,loadSchedule:xl,loadScores:Gn,readRememberedTermWeek:hr,reconcileProfileAndScores:_l,render:Xe,scheduleRender:Ol}}),{bindUI:Rl,closeModal:Ul,getRoomHost:Ic,openModal:Nc,openRoomModal:Bc,openScoreModal:Fc,showBuilding:Dc}=yi({state:nt,deps:{DAY_NAMES:Mn,applyPersonalDisplay:Yt,bindScheduleExportHosts:ll,closeCleanMode:a(()=>Gl(),"closeCleanMode"),ensureRoomCatalogLoaded:Xn,enrichOccupancyWithCurriculum:ql,ensureRoot:a(()=>Kn(),"ensureRoot"),escapeHtml:at,fetchText:Vt,getCurrentWeekNumber:Pe,getViewWeekNumber:Fn,inferMaxWeek:gl,isUnevaluatedScore:ie,isValidOfficialGpa:jr,loadBuildingOccupancy:$l,metricHtml:Fl,occupancyHtml:Dl,render:Xe,rootEl:a(()=>Jl(),"rootEl"),roomPickerHtml:jl,scoreToGpa:Ue,scoreToNumber:We,summarizeCourses:re,summarizeCoursesPreferOfficial:re}}),{cleanModeApi:Wl,closeCleanMode:Gl,ensureRoot:Kn,injectCleanEntry:jc,openCleanMode:Oc,rootEl:Jl}=vi({state:nt,deps:{CLEAN_FLAG:Ps,applySkinAttr:ee,closeModal:Ul,ensureRoomCatalogLoaded:Xn,ensureStyle:Nl,getCurrentWeekNumber:Pe,getSkin:Zt,handleThemeDotClick:ct,ico:Qn,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:Ao,loadAll:Hl,openSettingsPanel:Ko,readRememberedTermWeek:hr,refreshCleanPersonalDisplay:Wa,render:Xe,scoreToGpa:Ue,summarizeCourses:re,syncNavbarThemeUI:ft,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=Wl;function to(){if(!document.body){setTimeout(to,10);return}if(So(),Wt(Jt()),setTimeout(()=>{try{Ae().then(e=>Oe(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],s=r.parentElement;for(;s;){let i=s.scrollTop,l=s.scrollLeft;(i||l||s.scrollHeight>s.clientHeight||s.scrollWidth>s.clientWidth)&&o.push({el:s,top:i,left:l}),s=s.parentElement}requestAnimationFrame(()=>{o.forEach(i=>{i.el.scrollTop=i.top,i.el.scrollLeft=i.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))Lo();else{ts();try{yn()}catch{}try{Gr()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Yt(document)}catch{}try{Nn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{Gr()}catch{}try{Yt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{da()&&Ao()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(to,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(_e,50)}),window.addEventListener("load",()=>{_e(),Re(),setTimeout(_e,100),setTimeout(_e,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Re,0),setTimeout(Re,50),setTimeout(Re,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Re,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function Zn(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let s=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),i=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));s&&!i&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){_e(),fn(),st(),_e();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(i=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},i)),Sa(),Vo(),Yo(),jo(),Qo(),Jo(),Ho(),document.querySelectorAll(".page-content, #page-content-template").forEach(i=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);i.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),i.style.setProperty("box-sizing","border-box","important")}),$r(),Nr(),Fe(),setTimeout(Fe,300),setTimeout(Fe,1e3),Mo(),be(),ir(),Bo(),setTimeout(ir,300),sr(),setTimeout(()=>sr(),500),Tr(),No();try{Gr()}catch{}try{Yt(document)}catch{}setTimeout(()=>{try{Gr()}catch{}try{Yt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...s){let i=r.apply(this,s);return e(),i},history.replaceState=function(...s){let i=o.apply(this,s);return e(),i}}a(Zn,"watchRouteChanges");let Ke=typeof unsafeWindow<"u"?unsafeWindow:window;Ke.__urpppDebug=Ke.__urpppDebug||{},Ke.__urpppDebug.setCalendarPhase=t=>Bn(t),Ke.__urpppDebug.getCalendarPhase=()=>hl(),Ke.__urpppDebug.calVacation=t=>gr(t),Ke.urppp={version:p,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Wt(t)},"apply"),setAccent:$i,getAccent:Qt,getCurrent:Jt,list:a(()=>Object.entries(Ct).map(([t,e])=>({name:t,displayName:e.name,current:t===Jt()})),"list")},update:{check:ja,auto:Da,showToast:Fa},privacy:{get:we,set(t){return ha(t),Yt(document),we()},apply:a(()=>Yt(document),"apply"),identity:{get:Me,set(t){return vo(t),Yt(document),Wa(),Me()}}},scheduleExport:{load:a(()=>En("api"),"load"),run:a(t=>tl(t,"api",null,null),"run"),patch:Xa,image:{theme:zn,build:a((t,e)=>Ln(t,e),"build")},jsonFormat:{get:Lr,set:ko,validate:qe,build(t,e){let r=Xr(t);if(e)return Zr(r,qe(e));let o=Lr();return o.enabled?Zr(r,o.mapping):Kr(r)},buildDefault(t){return Kr(Xr(t))}}}};function tp(){setTimeout(()=>{try{Da()}catch{}},1800)}a(tp,"scheduleAutoUpdateCheck");try{So()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{to(),Zn(),tp()}):(to(),Zn(),tp())})();})();
