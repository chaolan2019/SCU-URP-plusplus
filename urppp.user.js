...
`;function Qc(n){n.querySelectorAll("td, th").forEach(p=>{p.style.removeProperty("background"),p.style.removeProperty("background-color")}),n.querySelectorAll("th[rowspan]").forEach(p=>{p.style.removeProperty("width"),p.style.setProperty("white-space","nowrap"),p.style.setProperty("text-align","center")}),n.querySelectorAll("table").forEach(p=>{p.style.setProperty("background","#ffffff","important"),p.style.setProperty("background-color","#ffffff","important"),p.style.setProperty("border","none","important"),p.style.setProperty("color","#000000","important")}),n.querySelectorAll("th").forEach(p=>{if(p.style.setProperty("color","#000000","important"),p.style.setProperty("border","1px solid #dddddd","important"),p.style.setProperty("font-weight","normal","important"),p.childNodes.length===1&&p.firstChild&&p.firstChild.nodeType===3){let l=document.createElement("span");l.textContent=p.textContent,p.textContent="",p.appendChild(l)}}),n.querySelectorAll("thead th").forEach(p=>{p.style.setProperty("background","#dddddd","important"),p.style.setProperty("background-color","#dddddd","important")}),n.querySelectorAll("tbody th").forEach(p=>{p.style.setProperty("background","transparent","important"),p.style.setProperty("background-color","transparent","important")}),n.querySelectorAll("td").forEach(p=>{p.style.setProperty("background","transparent","important"),p.style.setProperty("background-color","transparent","important"),p.style.setProperty("color","#000000","important"),p.style.setProperty("border","1px solid #dddddd","important")})}a(Qc,"normalizeNativePdfStage");function ci(n){let p=Vc(),l=document.createElement("div");l.id="urppp-pdf-stage",l.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(p||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=n.cloneNode(!0);Gc(u),Jc(u),d.appendChild(u),l.appendChild(d),Qc(u);let k=document.createElement("style");k.id="urppp-pdf-reset-style",k.textContent=Yc,document.head.appendChild(k),document.body.appendChild(l);let P=l.querySelector("#urppp-pdf-mycoursetable"),A=l.querySelector("#urppp-pdf-page")||l;if(!P)throw l.remove(),new Error("无法建立原生课表捕获节点");return{stage:l,target:P,page:A,sourceHost:n}}a(ci,"cloneNativePdfStage");var ua=0;function he(){return ua>0}a(he,"isNativePdfIsolationActive");function Xc(n){return!n||n.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(n.id||"")||n.hasAttribute("data-urppp-style")?!0:(n.textContent||"").includes("urppp-")}a(Xc,"isUrpppOwnedStyle");function di(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(di,"defaultPage");function ui(n,p){let l=n&&typeof n.requestAnimationFrame=="function"?n.requestAnimationFrame.bind(n):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return l?l(p):setTimeout(p,0)}a(ui,"scheduleFrame");function Kc(n={}){let p=n.document||(typeof document<"u"?document:null),l=n.page||di();if(!p)throw new Error("原生 PDF 隔离缺少 document");let d=p.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");ua+=1;let u=[d,...d.querySelectorAll("*")],k=[],P=p.getElementById("soliderbox");P&&k.push(P);let A=d.parentElement;for(;A&&A!==p.documentElement;){let x=A.classList;(A.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&k.push(A),A=A.parentElement}let y=p.getElementById("page-content-template")||p.querySelector(".page-content");y&&!k.includes(y)&&k.push(y);let S=[...u,...k],g=S.map(x=>({element:x,style:x.getAttribute("style")})),v=Array.from(p.querySelectorAll("style")).filter(Xc).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),q=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=l&&l.divBuild,f=l&&l.__urpppOriginalDivBuild,m=!1,w=a(()=>{m||(m=!0,l&&l.divBuild===f&&typeof C=="function"&&(l.divBuild=C),g.forEach(({element:x,style:E})=>{x.isConnected&&(E===null?x.removeAttribute("style"):x.setAttribute("style",E))}),q.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),v.forEach(({style:x,disabled:E,media:z})=>{try{z===null?x.removeAttribute("media"):x.setAttribute("media",z),x.sheet&&(x.sheet.disabled=E)}catch{}}),ua=Math.max(0,ua-1),ui(l,()=>{try{typeof n.onAfterRestore=="function"&&n.onAfterRestore()}catch{}}))},"restore");try{return v.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),S.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(E=>{x.style.getPropertyPriority(E)==="important"&&(E==="height"&&x.matches("td, th")||x.style.removeProperty(E))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),q.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),l&&typeof f=="function"&&(l.divBuild=f),w}catch(x){throw w(),x}}a(Kc,"isolateScheduleForNativeExport");function mi(n,p={}){return new Promise((l,d)=>{let u=p.page||di(),k=u&&u.back,P=u&&u.html2canvas;if(!n||typeof k!="function"){d(new Error("教务原生导出依赖未就绪"));return}let A=null;try{A=Kc(p)}catch(f){d(f);return}let y=0,S=!1,g=null,v=null,q=a(f=>{if(!S){S=!0,y&&clearTimeout(y),u&&g&&u.back===g&&(u.back=k),v&&u.html2canvas===v&&(u.html2canvas=P);try{A&&A()}catch{}f?d(f):l()}},"settle"),C=a(f=>q(f instanceof Error?f:new Error(String(f))),"fail");typeof P=="function"&&(v=a(function(){let f=P.apply(this,arguments);return f&&typeof f.catch=="function"&&f.catch(C),f},"scopedCanvas"),u.html2canvas=v),g=a(function(){try{return k.apply(this,arguments)}finally{setTimeout(()=>q(),0)}},"wrappedBack"),u.back=g,y=setTimeout(()=>{try{k.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},p.timeoutMs||60*1e3),ui(u,()=>{try{n.click()}catch(f){C(f)}})})}a(mi,"exportNativePdfIsolated");var bi=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
`;var fi=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var gi=`.urppp-export-wrap{position:relative!important;display:inline-flex!important;align-items:center!important;flex:0 0 auto!important;margin-left:7px!important;font-weight:400!important;vertical-align:middle!important;white-space:nowrap!important}
...
/* Apple / Editorial 内置主题卡片样式（builtin，保留） */
...
`;var yi=`      /* 表格美化：业务表格、分页、公告卡片（table-beautify） */
...
`;var vi=`      /* 导航：顶栏、侧栏、面包屑（navigation） */
      /* 顶栏 —— 基于真实 DOM */
...
`;var wi=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function _i(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(_i,"createCleanModeState");function Ei(n){n.profile=null,n.schedule=null,n.scores=null,n.catalog=null,n.occupancy=null,n._termWeekResolved=!1,n._schemeUserSelected=!1,n._schemeInited=!1}a(Ei,"resetCleanModeData");function Ci({state:n,deps:p}){async function l(u){if(!u&&n.catalog&&n.catalog.length||n.loading.room)return n.catalog;n.loading.room=!0;try{p.render()}catch{}try{n.catalog=await p.loadClassroomCatalog(),n.roomError=""}catch(k){n.catalog=n.catalog||[],n.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{n.loading.room=!1;try{p.scheduleRender()}catch{}}return n.catalog}a(l,"ensureRoomCatalogLoaded");async function d(u){u&&Ei(n),n.loading.profile=n.loading.schedule=n.loading.scores=!0;try{let k=await p.ensureTermWeekResolved();!n.weekLocked&&k>=1&&(n.viewWeek=k)}catch{}if(p.render(),await Promise.all([(async()=>{try{n.profile&&!u||(n.profile=await p.loadProfile()),p.reconcileProfileAndScores()}catch(k){n.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{n.loading.profile=!1,p.scheduleRender()}})(),(async()=>{try{n.schedule&&!u||(n.schedule=await p.loadSchedule())}catch(k){n.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(n.loading.schedule=!1,!n.weekLocked){let k=p.getCurrentWeekNumber()||p.readRememberedTermWeek();k>=1&&(n.viewWeek=k)}p.scheduleRender()}})(),(async()=>{let k=null;try{n.scores&&!u||(n.scores=await p.loadScores(u)),k=n.scores,p.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&p.enrichScoresWithEvaluation(k).then(()=>{n.scores===k&&(p.reconcileProfileAndScores(),p.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){n.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{n.loading.scores=!1,p.scheduleRender()}})()]),p.reconcileProfileAndScores(),!n.weekLocked){let k=p.getCurrentWeekNumber()||p.readRememberedTermWeek();k>=1&&(n.viewWeek=k)}p.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:l,loadAll:d}}a(Ci,"createCleanModeDataLoader");var lr={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},Zc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Mr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function zi(){let n=new Date,p=a(l=>String(l).padStart(2,"0"),"p");return`${n.getFullYear()}-${p(n.getMonth()+1)}-${p(n.getDate())}`}a(zi,"calToday");function _o(n,p){return Math.round((Date.parse(p)-Date.parse(n))/864e5)}a(_o,"calDayDiff");function Eo(n,p){let l=_o(lr[n].start,p);return l<0?0:Math.floor(l/7)+1}a(Eo,"calWeekNo");function Ao(n){return Zc[n]||""}a(Ao,"calLunar");function Pi(n){return String(n||"").slice(5)}a(Pi,"calYY");function td(n){let p=n||zi(),[l,d]=p.split("-").map(Number);return d===8&&p>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(td,"calActiveTerm");function Co(n,p){let l=n&&lr[n]?n:"autumn",d=lr[l],u=p||zi(),k=d.events.map(g=>({e:g,d:_o(u,g.start)})).filter(g=>g.d>=-0).sort((g,v)=>g.d-v.d)[0],P=k?_o(u,k.e.start):null,A=Eo(l,u),y=Math.max(0,Math.min(100,A/d.weeks*100)),S=u>=d.start;return{term:d,termId:l,next:k,daysLeft:P,weekNo:A,progress:y,started:S,today:u}}a(Co,"calStatus");function qi(n,p){let l=Co(n,p),d=l.next?Mr[l.next.e.t].color:"#c9cdd4",u=l.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(qi,"calendarSummaryHtml");function Ti(n,p){let l=Co(n,p);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(Ti,"calendarSummaryCompactHtml");function Li(n,p){let l=Co(n,p),d=l.next?Mr[l.next.e.t].color:"#c9cdd4",u=l.term,k=Object.keys(lr).map(v=>`<button type="button" class="cal-term${v===l.termId?" ac":""}" data-cal-term="${v}">${lr[v].name}</button>`).join(""),P=`<div class="cal-widget">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[v].map(C=>{let f=Mr[C.t].color,m=C.end&&C.end!==C.start?"~"+Pi(C.end):"",w=Eo(l.termId,C.start)>0?`第 ${Eo(l.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
          <span class="cal-ev-dot" style="background:${f}"></span>
          <span class="cal-ev-date">${Pi(C.start)}${m||""}<em>${Ao(C.start)||"&nbsp;"}</em></span>
  ...
  </div>`}a(Li,"calendarModalHtml");function Mi(n,p){let l=typeof document<"u"?document:null;if(!l)return;So();let d=n&&lr[n]?n:td(p),u=l.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${Li(d,p)}</div></div>`,l.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>So()),u.addEventListener("click",k=>{let P=k.target;if(P&&P.closest&&P.closest(".cal-close")){So();return}let A=P&&P.closest?P.closest("[data-cal-term]"):null;if(A){let y=u.querySelector(".cal-body");y&&(y.innerHTML=Li(A.dataset.calTerm,p)),u.querySelectorAll("[data-cal-term]").forEach(S=>S.classList.toggle("ac",S.dataset.calTerm===A.dataset.calTerm))}})}a(Mi,"openCalendarModal");function So(){let n=typeof document<"u"?document:null;if(!n)return;let p=n.getElementById("urppp-cal-modal");p&&(p.classList.remove("open"),p.classList.add("closing"),setTimeout(()=>{p.remove()},200))}a(So,"closeCalendarModal");function $i(n,p){let l=n||(typeof document<"u"?document:null);l&&l.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),Mi())})}a($i,"bindCalendarOpen");var ma=!1;function Po(){let n=typeof document<"u"?document:null;if(!n||ma)return ma;try{let p=n.createElement("style");if(p&&p.id!==void 0){p.id="urppp-cal-style",p.textContent=`
  ...
  `,p.id="urppp-cal-style";let l=n.head||n.documentElement;l&&l.appendChild(p),ma=!0}}catch{}return ma}a(Po,"ensureCalendarStyle");function Ii(){let n=typeof document<"u"?document:null;if(!n)return;let p=n.getElementById("urppp-nav-theme")||n.querySelector("#navbar .navbar-header")||n.getElementById("navbar"),l=n.getElementById("urppp-nav-clean"),d=n.getElementById("urppp-nav-cal");if(!p&&!l)return;let u=l&&l.parentElement||p;d&&d.parentElement===u||(d&&d.remove(),d=n.createElement("button"),d.type="button",d.id="urppp-nav-cal",d.title="校历时间线",d.setAttribute("aria-label","校历时间线"),d.innerHTML='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3.5" y="5" width="17" height="15.5" rx="2.5"/><path d="M3.5 9.5h17"/><path d="M8 3v3M16 3v3"/><circle cx="12" cy="15" r="1.2" fill="currentColor" stroke="none"/></svg><span>校历</span>',Object.entries({display:"inline-flex","align-items":"center",height:"28px","min-height":"28px",padding:"0 12px","font-size":"12px",gap:"6px",width:"auto",float:"none",margin:"0 0 0 8px","vertical-align":"middle"}).forEach(([k,P])=>d.style.setProperty(k,P,"important")),d.addEventListener("click",k=>{k.preventDefault(),k.stopPropagation(),Mi()}),l&&l.parentElement?l.after(d):u&&u.appendChild(d))}a(Ii,"mountCalendarButton");function Ni(){let n=typeof document<"u"?document:null;if(!n)return;let p=n.getElementById("urppp-nav-cal");p&&p.remove()}a(Ni,"removeCalendarButton");function Bi({state:n,deps:p}){let l=0,d={gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)"};function u(x,E){let z=x||p.summarizeCourses([]);return`<div class="uc-metrics">${[["TotalCredit","总学分",z.totalCredit],["AvgScore","平均成绩",z.avgScore],["AvgGpa","平均绩点",z.avgGpa],["RequiredCredit","必修学分",z.requiredCredit],["RequiredAvg","必修平均",z.requiredAvg],["RequiredGpa","必修绩点",z.requiredGpa]].map(([T,j,I])=>{let H=p.classifyPrivacyLabel(j)||"grade",G=E&&p.DIRECT_EDIT_LABELS[E+T]?` data-urppp-edit-key="${E+T}"`:"";return`<div class="uc-metric"><em>${j}</em><b data-urppp-private="${H}"${G}>${I}</b></div>`}).join("")}</div>`}a(u,"metricHtml");function k(){let x=n.scores;if(!x||x.error)return`<div class="uc-sa-empty">${p.escapeHtml(x&&x.error||"暂无成绩数据")}</div>`;let E=null;try{E=p.analyzeScores({scorePack:x,profile:n.profile})}catch{}if(!E||E.empty)return'<div class="uc-sa-empty">暂无可用成绩数据，请先查询成绩后再试。</div>';let z=typeof p.scoreChartLayout=="function"?p.scoreChartLayout():null;return`<div class="uc-sa-charts">
      <div class="uc-sa-chart-card"><h5>学期趋势</h5><div class="uc-sa-chart-scroll">${p.trendChartSvg({trend:E.trend,palette:p.scoreChartPalette||d,layout:z})}</div></div>
      <div class="uc-sa-chart-card"><h5>成绩分段分布</h5><div class="uc-sa-chart-scroll">${p.bandsChartSvg({bands:E.bands,palette:p.scoreChartPalette||d,layout:z})}</div></div>
    </div>
    <div class="uc-sa-more-row"><a class="uc-sa-more" data-href="/student/integratedQuery/scoreQuery/allPassingScores/index?urppp=sa">点击此处跳转到详细分析界面 →</a></div>`}a(k,"analysisHtml");function P(x){let E=!!p.isCleanAnalysisDirect(),z=n.scoreAnalysisTab==="analysis";return E?`<div class="uc-hd"><span>成绩总览</span><span class="uc-sub">点击查看明细</span></div>
  <div class="uc-bd">
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${z?"":" hidden"}>${k()}</div>
  </div>`}a(P,"scoreSectionHtml");function A(){try{if(window.matchMedia&&window.matchMedia("(max-width:900px)").matches)return 40}catch{}return 56}a(A,"getScheduleRowHeight");function y(x){let E=p.getViewWeekNumber(),z=A(),$=Math.max(z-4,28),T=(x||[]).map(H=>Object.assign({},H,{thisWeek:p.weekBitActive(H.classWeek,E)||!H.classWeek&&String(H.week||"").indexOf(String(E))>=0,span:Math.max(1,H.span||1),color:H.color||p.courseColor(H.name)})),j={};T.forEach(H=>{let G=H.day+"_"+H.section;(j[G]||(j[G]=[])).push(H)});let I=`<div class="uc-week" data-urppp-private="schedule" data-week="${E}" data-row="${z}">`;I+='<div class="uc-week-head"><div class="h"></div>';for(let H=0;H<7;H++)I+=`<div class="h">${p.DAY_NAMES[H]}</div>`;I+='</div><div class="uc-week-body">',I+='<div class="uc-sec-col">';for(let H=1;H<=12;H++)I+=`<div class="s" style="height:${z}px">${H}</div>`;I+="</div>";for(let H=0;H<7;H++){I+=`<div class="uc-day-col" data-day="${H}" style="height:${z*12}px">`;for(let G=1;G<=12;G++)I+=`<div class="uc-grid-cell" data-sec="${G}" style="top:${(G-1)*z}px;height:${$}px"></div>`;I+=`<div class="uc-part-line" style="top:${4*z-2}px"></div>`,I+=`<div class="uc-part-line" style="top:${9*z-2}px"></div>`;for(let G=1;G<=12;G++){let U=(j[H+"_"+G]||[]).slice().sort((xt,Z)=>xt.thisWeek!==Z.thisWeek?(Z.thisWeek?1:0)-(xt.thisWeek?1:0):(Z.span||1)-(xt.span||1));if(!U.length)continue;let it=U.filter(xt=>xt.thisWeek)[0]||U[0],bt=U.filter(xt=>xt!==it),V=it.span,Q=(G-1)*z+1,ot=V*z-6,X=it.thisWeek?8:2,ct=it.thisWeek?`--uc-course-color:${it.color};top:${Q}px;height:${ot}px;z-index:${X};background:${it.color}26;border-color:${it.color}80`:`--uc-course-color:${it.color};top:${Q}px;height:${ot}px;z-index:${X};background:color-mix(in srgb,${it.color} 8%,var(--input-bg));border-color:var(--border);opacity:.48`,rt=bt.length?`<span class="uc-badge">+${bt.length}</span>`:"",st=p.escapeHtml(JSON.stringify({name:it.name,teacher:it.teacher,place:it.place,week:it.week,day:it.day,section:it.section,span:it.span,thisWeek:it.thisWeek,others:bt.map(xt=>({name:xt.name,teacher:xt.teacher,place:xt.place,week:xt.week,thisWeek:xt.thisWeek,section:xt.section,span:xt.span}))}));I+=`<div class="uc-lesson${it.thisWeek?"":" is-fade"}" style="${ct}" data-course='${st}'>
      ...
      </button>`).join("")}</div>`}a(g,"servicesHtml");function v(){let x=p.personalizedProfile(n.profile||{}),E=n.schedule&&n.schedule.courses||[],z=n.scores&&n.scores.passing&&n.scores.passing[0]||{summary:p.summarizeCourses([])},$=n.scores&&n.scores.schemes||[];n.scores&&n.scores.majorIdx!=null&&n._schemeInited!==!0&&(n.activeSchemeIdx=n.scores.majorIdx||0,n._schemeInited=!0);let T=$[n.activeSchemeIdx]||$[0]||{summary:p.summarizeCourses([]),title:"方案成绩"},j=x.avatar?`<img src="${p.escapeHtml(x.avatar)}" alt="">`:`<span>${p.escapeHtml((x.name||"同")[0])}</span>`,I=n.loading.scores?'<div class="uc-loading">成绩加载中</div>':n.scores&&n.scores.error?`<div class="uc-empty">${p.escapeHtml(n.scores.error)}</div>`:`<div class="uc-score-grid">
    ...
    </div>`}a(v,"renderDesktop");function q(){let x=p.personalizedProfile(n.profile||{}),E=n.schedule&&n.schedule.courses||[],z=n.scores&&n.scores.passing&&n.scores.passing[0]||{summary:p.summarizeCourses([])},$=(n.scores&&n.scores.schemes||[])[n.activeSchemeIdx]||{summary:p.summarizeCourses([])},T=x.avatar?`<img src="${p.escapeHtml(x.avatar)}" alt="">`:`<span>${p.escapeHtml((x.name||"同")[0])}</span>`;if(n.mobileTab==="scores"){let j=`<div class="uc-score-grid uc-score-grid-mobile">
      ...
      <div class="uc-occ"><table class="uc-occ-table">${z}${$}</table></div>`}a(f,"occupancyHtml");function m(){let x=p.ensureRoot(),E=x.querySelector("#uc-body");p.getViewWeekNumber();let z=typeof window<"u"&&window.matchMedia?window.matchMedia:null,$=z&&z("(max-width:900px)").matches,T=!n.uiReady;E.innerHTML=$?q():v(),T?(n.uiReady=!0,x.classList.remove("uc-settled"),clearTimeout(x.__ucSettleTimer),x.__ucSettleTimer=setTimeout(()=>{n.open&&x.classList.add("uc-settled")},480)):x.classList.add("uc-settled"),p.bindUI(E),p.applyPersonalDisplay(E)}a(m,"render");function w(){if(!n.open||l)return;let x=a(()=>{l=0,n.open&&m()},"run"),E=typeof requestAnimationFrame=="function"?requestAnimationFrame:null;l=E?E(x):setTimeout(x,0)}return a(w,"scheduleRender"),{analysisHtml:k,metricHtml:u,occupancyHtml:f,render:m,renderScheduleBoard:y,roomPickerHtml:C,scheduleRender:w,scoreSectionHtml:P}}a(Bi,"createCleanModeRenderer");function Fi({state:n,deps:p}){function l(v,q){return!v||(v.__urpppCleanUiBindings||(v.__urpppCleanUiBindings=new Set),v.__urpppCleanUiBindings.has(q))?!1:(v.__urpppCleanUiBindings.add(q),!0)}a(l,"markCleanUiBound");function d(v){if(!v)return;try{p.bindScheduleExportHosts(v)}catch(C){console.warn("[URP++] schedule export menu",C)}v.querySelectorAll("[data-score]").forEach(C=>{l(C,"score")&&C.addEventListener("click",()=>A(C.getAttribute("data-score")))}),v.querySelectorAll("[data-sa-tab]").forEach(C=>{l(C,"saTab")&&C.addEventListener("click",()=>{n.scoreAnalysisTab=C.getAttribute("data-sa-tab")==="analysis"?"analysis":"overview",p.render()})}),v.querySelectorAll("[data-href]").forEach(C=>{l(C,"href")&&C.addEventListener("click",f=>{let m=C.getAttribute("data-href");m&&(f.preventDefault(),p.closeCleanMode(),location.href=m)})}),v.querySelectorAll("[data-eval-url]").forEach(C=>{l(C,"eval")&&C.addEventListener("click",f=>{let m=C.getAttribute("data-eval-url");m&&(f.preventDefault(),f.stopPropagation(),p.closeCleanMode(),location.href=m)})}),v.querySelectorAll('[data-action="room"]').forEach(C=>{l(C,"room")&&C.addEventListener("click",()=>y())}),v.querySelectorAll("[data-room-reload]").forEach(C=>{l(C,"roomReload")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),p.ensureRoomCatalogLoaded(!0)})}),v.querySelectorAll("[data-build-path]").forEach(C=>{l(C,"building")&&C.addEventListener("click",async()=>{let f=C.getAttribute("data-build-path"),m=(C.textContent||"").trim(),w=C.getAttribute("data-cn")||"",x=C.getAttribute("data-bn")||"",E=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;n.roomDateOffset=0,await g({path:f,name:m,campusNumber:w,buildingNumber:x,dateOffset:0},m,E)})}),v.querySelectorAll("[data-room-day]").forEach(C=>{l(C,"roomDay")&&C.addEventListener("click",async f=>{f.preventDefault(),f.stopPropagation();let m=parseInt(C.getAttribute("data-room-day")||"0",10)||0;if(!n.currentBuilding)return;n.roomDateOffset=m;let w=Object.assign({},n.currentBuilding,{dateOffset:m}),x=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;await g(w,w.name||"",x)})});let q=v.querySelector("#uc-room-back");q&&(q.onclick=()=>{n.occupancy=null,n.currentBuilding=null;let C=q.closest("#uc-room-panel")||document.querySelector("#uc-room-panel")||document.querySelector("#uc-modal-body");C&&C.id==="uc-modal-body"||C&&C.id==="uc-room-panel"?(C.innerHTML=p.roomPickerHtml(),d(C)):p.render()}),v.querySelectorAll(".uc-slot.busy[data-occ]").forEach(C=>{l(C,"occupancy")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();try{let m=JSON.parse(C.getAttribute("data-occ")||"{}");k("占用详情",`
            <div class="uc-occ-detail">
              <div class="uc-name">${p.escapeHtml(m.room||"")}</div>
              <div class="uc-sub" style="margin-top:8px">节次：第${p.escapeHtml(String(m.section||m.start||""))}${m.span>1?"-"+(Number(m.start||m.section)+Number(m.span)-1):""}节</div>
              <div class="uc-sub">占用类型：${p.escapeHtml(m.typeLabel||m.reason||"占用")}</div>
              <div class="uc-sub">具体内容：${p.escapeHtml(m.contentName||m.reason||"—")}</div>
              ${m.teacher?`<div class="uc-sub">教师：${p.escapeHtml(m.teacher)}</div>`:""}
              ${m.weeks?`<div class="uc-sub">周次：${p.escapeHtml(m.weeks)}</div>`:""}
              ${m.courseNo?`<div class="uc-sub">课程号：${p.escapeHtml(m.courseNo)}</div>`:""}
            </div>
          `,"",{stack:!0})}catch{}})}),v.querySelectorAll(".uc-lesson[data-course]").forEach(C=>{l(C,"course")&&C.addEventListener("click",f=>{f.stopPropagation();try{let m=JSON.parse(C.getAttribute("data-course")||"{}"),w=`第${m.section||"?"}${m.span>1?"-"+(Number(m.section)+Number(m.span)-1):""}节`,x=(m.others||[]).map(E=>`<div class="uc-course-sub ${E.thisWeek?"":"is-fade"}">
            ...
            <div class="uc-course-detail">
              <div class="uc-cd-name">${p.escapeHtml(m.name||"")}</div>
              <div class="uc-cd-meta">${p.escapeHtml([m.place,m.teacher,m.week].filter(Boolean).join(" · "))||"—"}</div>
              <div class="uc-cd-chip">${m.thisWeek?"当前周有课":"当前周无课"} · ${p.escapeHtml(w)} · ${p.escapeHtml(p.DAY_NAMES[m.day]||"")}</div>
            </div>
            ${x?'<div class="uc-hd" style="border:0;padding:14px 0 6px">同时段其他课程</div>'+x:""}
          `,"")}catch{}})}),v.querySelectorAll("[data-week-delta]").forEach(C=>{l(C,"weekDelta")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();let m=parseInt(C.getAttribute("data-week-delta")||"0",10)||0,w=n.schedule&&n.schedule.courses||[],x=p.inferMaxWeek(w),E=p.getViewWeekNumber();n.weekLocked=!0,n.viewWeek=Math.min(x,Math.max(1,E+m)),p.render();let z=document.querySelector("#urppp-clean-root .uc-week-label");z&&(z.classList.remove("uc-pop"),z.offsetWidth,z.classList.add("uc-pop"))})}),v.querySelectorAll("[data-week-reset]").forEach(C=>{l(C,"weekReset")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),n.weekLocked=!1;let m=p.getCurrentWeekNumber()||n._termWeek||1;n.viewWeek=m,p.render();let w=document.querySelector("#urppp-clean-root .uc-week-label");w&&(w.classList.remove("uc-pop"),w.offsetWidth,w.classList.add("uc-pop"))})})}a(d,"bindUI");let u=[];function k(v,q,C,f){f=f||{};let m=p.ensureRoot(),w=m.querySelector("#uc-mask"),x=m.querySelector("#uc-modal");f.stack&&x.classList.contains("open")?u.push({title:m.querySelector("#uc-modal-title").textContent,body:m.querySelector("#uc-modal-body").innerHTML,ft:m.querySelector("#uc-modal-ft").innerHTML}):f.stack||(u.length=0),w.classList.add("open"),x.classList.add("open"),m.querySelector("#uc-modal-title").textContent=v,m.querySelector("#uc-modal-body").innerHTML=q,m.querySelector("#uc-modal-ft").innerHTML=C||"",d(m.querySelector("#uc-modal-body")),d(m.querySelector("#uc-modal-ft")),p.applyPersonalDisplay(m.querySelector("#uc-modal"))}a(k,"openModal");function P(){let v=p.rootEl();if(v){if(u.length){let q=u.pop();v.querySelector("#uc-modal-title").textContent=q.title,v.querySelector("#uc-modal-body").innerHTML=q.body,v.querySelector("#uc-modal-ft").innerHTML=q.ft||"",d(v.querySelector("#uc-modal-body")),d(v.querySelector("#uc-modal-ft"));return}v.querySelector("#uc-mask").classList.remove("open"),v.querySelector("#uc-modal").classList.remove("open")}}a(P,"closeModal");function A(v){let q=n.scores&&n.scores.passing&&n.scores.passing[0]||{courses:[],summary:p.summarizeCourses([])},C=n.scores&&n.scores.schemes||[];v==="scheme"&&n.scores&&n.scores.majorIdx!=null&&n._schemeInited!==!0&&(n.activeSchemeIdx=n.scores.majorIdx||0,n._schemeInited=!0);let f=C[n.activeSchemeIdx]||C[0]||{courses:[],summary:p.summarizeCourses([]),title:"方案成绩"},m=v==="scheme"?f:q,w=v==="scheme"?"scheme":"passing";n.selected[w]||(n.selected[w]=new Set);let x=v==="scheme"&&C.length>1?`<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">${C.map((Z,dt)=>`<button type="button" class="uc-btn ${dt===n.activeSchemeIdx?"primary":""}" data-scheme-idx="${dt}"><span data-urppp-private="organization">${p.escapeHtml((Z.title||"方案").slice(0,28))}</span></button>`).join("")}</div>`:"",E=a(Z=>{let dt=!!(Z&&(Z.unevaluated||p.isUnevaluatedScore(Z.score))),At=p.scoreToNumber(Z&&Z.score),kt="";dt?kt=At!=null&&At<60?"uneval-fail":"uneval":At!=null?kt=At>=60?"pass":"fail":/不及格|不合格|不通过/.test(String(Z&&Z.score||""))?kt="fail":Z&&Z.score&&(kt="pass");let Pt=p.escapeHtml(Z&&Z.score||"—"),B=dt?Z.evalUrl||"/student/teachingEvaluation/newEvaluation/index":"";return B?`<span class="uc-score-cell ${kt}" data-eval-url="${p.escapeHtml(B)}" title="未评教，点击前往评教">${Pt}</span>`:`<span class="uc-score-cell ${kt}">${Pt}</span>`},"scoreCellHtml"),z=(m.courses||[]).map((Z,dt)=>{let At=n.selected[w].has(dt),kt=p.isValidOfficialGpa(Z.officialGpa)?Z.officialGpa:p.scoreToGpa(Z.score),Pt=!!(Z.unevaluated||p.isUnevaluatedScore(Z.score));return`<tr class="${At?"is-on":""}${Pt?" is-uneval":""}" data-idx="${dt}">
      ...
      ${x}${p.metricHtml(m.summary,v==="scheme"?"scheme":"passing")}
    ...
    `,P.appendChild(g);let v=P.querySelector("#warningInfo");v&&document.body.appendChild(v),A.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let q=g.querySelector("#urppp-stats"),C=Math.max(S.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',q.appendChild(E)}function f(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&(q.innerHTML="",x.forEach(E=>{let z=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),$=z[0]||"",T=z.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),I=/[\u4e00-\u9fa5]/.test($)||$.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=n.statCardPrivacyMarkup($,T);G.innerHTML=`<div class="${I}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,q.appendChild(G)}))}if(a(f,"updateStats"),f(),y){let x=new MutationObserver(()=>f());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let m=g.querySelector("#urppp-left"),w=g.querySelector("#urppp-right");u(A[5],m,"我的日程安排"),u(A[0],w,"通知公告"),u(A[1],w,"我的待办任务"),u(A[2],w,"可申请业务"),u(A[3],w,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(k,"rebuildDashboard"),{rebuildDashboard:k,refreshHomeFullCalendar:l,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(ji,"createDashboardController");function _e(n){return Math.round((Number(n)||0)*100)/100}a(_e,"round2");var ed=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],Oi={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},rd=[{key:"required",label:"必修",test:a(n=>/必修/.test(n),"test")},{key:"elective",label:"任选",test:a(n=>/任选/.test(n),"test")},{key:"optional",label:"选修",test:a(n=>/选修/.test(n),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function Hi(n){let p=String(n||"").match(/^(\d{4})-(\d{4})-(\d+)/);return p?`${p[1].slice(2)}-${p[2].slice(2)}-${p[3]}`:String(n||"")}a(Hi,"shortTerm");function ba({deps:n}){let p=n.scoreToNumber,l=n.scoreToGpa;function d(f){let m=p(f);if(m!=null)return m;let w=String(f||"").trim().toUpperCase();return Oi[w]!=null?Oi[w]:null}a(d,"scoreToNumberWithLevels");function u(f){return!f||f.unevaluated?!1:d(f.score)!=null}a(u,"hasScore");function k(f){let m=String(f||"").match(/^(\d{4})-(\d{4})-(\d+)/);return m?[Number(m[1]),Number(m[3])]:[9999,9999]}a(k,"termOrderKey");function P(f){let m=f&&f.passing&&f.passing[0];return m&&m.courses||[]}a(P,"allCourses");function A(f){let m=f&&f.officialGpa,w=Number(m);return m!=null&&Number.isFinite(w)&&w>=0&&w<=5?w:null}a(A,"officialGpa");function y(f){let m=A(f);return m??l(f.score)}a(y,"courseGpa");function S({scorePack:f,profile:m}){let w=P(f),x=m&&m.majorGpa?String(m.majorGpa).trim():"",E=0,z=0,$=0,T=0,j=0,I=0;return w.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,z+=U*G;let et=y(H);et!=null&&($+=et*G,T+=G,H.required&&(j+=et*G,I+=G))}),{majorGpa:x,requiredGpa:_e(I?j/I:0),avgGpa:_e(T?$/T:0),avgScore:_e(E?z/E:0),totalCredit:_e(E),courseCount:w.length}}a(S,"computeMetrics");function g(f){let m=new Map;return(f||[]).forEach(w=>{if(!u(w))return;let x=w.term||"未分组",E=m.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},m.set(x,E));let z=Number(w.credit)||0,$=d(w.score);if($==null||(E.count+=1,z<=0))return;E.credit+=z,E.scoreW+=$*z;let T=y(w);T!=null&&(E.gpaW+=T*z,E.gpaCredit+=z)}),Array.from(m.values()).map(w=>({term:w.term,label:Hi(w.term),count:w.count,credit:_e(w.credit),avgScore:_e(w.credit?w.scoreW/w.credit:0),avgGpa:_e(w.gpaCredit?w.gpaW/w.gpaCredit:0)})).sort((w,x)=>{let E=k(w.term),z=k(x.term);return E[0]-z[0]||E[1]-z[1]})}a(g,"computeTrend");function v(f){let m=ed.map(x=>({...x,count:0,credit:0}));(f||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let z=m.find($=>E>=$.min&&E<=$.max);z&&(z.count+=1,z.credit+=Number(x.credit)||0)});let w=m.reduce((x,E)=>Math.max(x,E.count),1);return m.map(x=>({...x,ratio:Math.round(x.count/w*100)}))}a(v,"computeBands");function q(f){let m=rd.map(z=>({...z,credit:0,count:0}));(f||[]).forEach(z=>{if(!u(z))return;let $=String(z.attr||""),T=m.find(j=>j.test($));T&&(T.credit+=Number(z.credit)||0,T.count+=1)});let w=m.reduce((z,$)=>z+$.credit,0)||1,x=m.filter(z=>z.count>0).map(z=>({key:z.key,label:z.label,credit:_e(z.credit),count:z.count,ratio:Math.round(z.credit/w*100)})),E=x.find(z=>z.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a(q,"computeShare");function C({scorePack:f,profile:m}){let w=P(f);return{metrics:S({scorePack:f,profile:m}),trend:g(w),bands:v(w),share:q(w),empty:w.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:A,scoreToNumberWithLevels:d,shortTerm:Hi}}a(ba,"createScoreAnalysisData");var le="var(--text-secondary)",zo="var(--border)";function ce(n){return at(String(n??""))}a(ce,"escapeLabel");function Ri(n,p,l){let d=!!(n&&n.variant==="mobile");if(p==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},A=Math.max(56,Number(n&&n.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,l)*A),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},k=Math.max(44,Number(n&&n.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,l)*k),height:236,pad:u}}a(Ri,"resolveChartLayout");function Lo({width:n,height:p,mobile:l,kind:d,label:u}){let k=l?` data-urppp-chart-layout="mobile" style="width:max(100%,${n}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${n} ${p}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${k}>`}a(Lo,"openSvg");function ha({trend:n,palette:p,layout:l}){let d=(n||[]).filter(rt=>rt&&rt.avgScore!=null),u=Ri(l,"trend",d.length),{width:k,height:P,pad:A,mobile:y}=u,S=k-A.left-A.right,g=P-A.top-A.bottom;if(!d.length)return`${Lo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let v=d.length,q=a(rt=>A.left+(rt+.5)*(S/v),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),f=d.map(rt=>Number(rt.avgScore)||0),m=d.map(rt=>Number(rt.credit)||0),w=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...f)-4),z=Math.min(100,Math.max(...f)+4),$=Math.max(1,...m),T=x-w||1,j=z-E||1,I=a(rt=>A.top+g-(rt-w)/T*g,"yGpa"),H=a(rt=>A.top+g-(rt-E)/j*g,"yScore"),G=a(rt=>A.top+g-rt/$*g*.9,"yCredit"),U=d.map((rt,st)=>`${q(st)},${I(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${q(st)},${H(rt.avgScore)}`).join(" "),it=[0,.25,.5,.75,1].map(rt=>{let st=A.top+g-rt*g;return`<line x1="${A.left}" y1="${st.toFixed(1)}" x2="${k-A.right}" y2="${st.toFixed(1)}" stroke="${zo}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),bt=d.map((rt,st)=>{let xt=q(st),Z=y?Math.min(30,S/v*.42):Math.min(26,S/v*.32),dt=G(rt.credit);return`<rect x="${(xt-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(A.top+g-dt).toFixed(1)}" rx="3" fill="${p.credit}" opacity="0.55"/>
<text x="${xt.toFixed(1)}" y="${(dt-4).toFixed(1)}" text-anchor="middle" font-size="12" fill="${le}">${ce(rt.credit)}</text>`}).join(""),V=d.map((rt,st)=>`<text x="${q(st).toFixed(1)}" y="${P-16}" text-anchor="middle" font-size="12" fill="${le}">${ce(rt.label)}</text>`).join(""),Q=d.map((rt,st)=>{let xt=S/v,Z=q(st)-xt/2,dt=[`学期 ${rt.label}`,`课程 ${rt.count} 门`,`修读学分 ${rt.credit}`,`加权均分 ${rt.avgScore}`,`平均绩点 ${rt.avgGpa}`].join(`
...
</svg>`}a(Ui,"donutSvg");var ad=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),od='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',nd='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function Wi({deps:n}){let p=n&&n.palette||ad;function l(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
...
<div class="urppp-sa-grid">
  <section class="urppp-sa-card urppp-sa-trend">
    ...
    <div class="urppp-sa-chart-scroll">${ha({trend:S.trend,palette:p,layout:q})}</div>
  </section>
  <section class="urppp-sa-card urppp-sa-share">
    <h5 class="urppp-sa-card-title">课程类型构成</h5>
    <div class="urppp-sa-share-body">
      <div class="urppp-sa-donut">${Ui({items:v.items,requiredRatio:v.requiredRatio,palette:p})}</div>
...
<div class="urppp-sa-grid">
  ...
  `;function A(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(A,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function g(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=A("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=A("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(g,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{g(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let v="urppp_theme_v3",q="urppp_accent_v1",C="urppp_accent_presets_v1",f="urppp_scheme_v1",m="urppp_theme_follow_system_v1",w="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",z="urppp_follow_use_dynamic_v1",$="urppp_brutal_palette_v1",T="urppp_brutal_active_palette_v1",j="urppp_privacy_v1",I="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],bt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:xt,syncThemeDotGroup:Z}=Xi({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:bt,applyTheme:Gt,buildSchemePreview:Zt,getAccent:Xt,getBrutalActivePalette:Do,getBrutalPaletteById:dr,getBrutalSelectedPalette:Fo,getCurrent:Vt,getScheme:Fe,getSkin:te,isThemeModeAvailable:cr,setBrutalPalette:jo,skinSupportsDark:je,skinSupportsDynamic:Oe,skinSupportsFixedPalettes:Bo},settings:{ensureSettingsPanel:bn,openSettingsPanel:dn,syncSettingsPanelUI:jt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let O=document.createElement("li");O.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",O.appendChild(o),r.appendChild(O)}let c=o.closest("li")||o.parentElement,h=Array.from(r.children).find(O=>{let R=O.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),b=Array.from(r.children).find(O=>O.classList.contains("light-blue")),_=h||b||null;_&&c&&_!==c&&((c.compareDocumentPosition(_)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(c,_)),c&&!c.classList.contains("urppp-search-item")&&c.classList.add("urppp-search-item");let M=c;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),M&&s.parentElement!==M&&M.appendChild(s),M&&M.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let N=s.querySelector("#search-input"),L=s.querySelector("form");if(!N||!L)return;L.style.setProperty("display","block","important"),L.style.setProperty("margin","0","important"),L.style.setProperty("padding","10px","important");let D=s.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),N.style.setProperty("display","block","important"),N.style.setProperty("width","100%","important"),N.style.setProperty("height","36px","important"),N.style.setProperty("box-sizing","border-box","important"),N.style.setProperty("padding","0 12px","important"),N.style.setProperty("border","1px solid var(--border)","important"),N.style.setProperty("border-radius","var(--radius-sm)","important"),N.style.setProperty("background","var(--input-bg)","important"),N.style.setProperty("color","var(--text)","important");let J=a(O=>{s.dataset.open=O?"1":"0",s.style.setProperty("width",O?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",O?"1":"0","important"),s.style.setProperty("pointer-events",O?"auto":"none","important"),i.setAttribute("aria-expanded",O?"true":"false"),O&&setTimeout(()=>N.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",O=>{O.preventDefault(),O.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",O=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(O.target)||F?.contains(O.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function At(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(At,"ensureBootLoader");function kt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(kt,"hideBootLoader");try{At()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{kt()}catch{}},2500));let Pt={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function B(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,c=0,h=(o+i)/2;if(o!==i){let b=o-i;switch(c=h>.5?b/(2-o-i):b/(o+i),o){case t:s=(e-r)/b+(e<r?6:0);break;case e:s=(r-t)/b+2;break;default:s=(t-e)/b+4;break}s/=6}return{h:s*360,s:c,l:h}}a(B,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,i=o*(1-Math.abs(t/60%2-1)),s=r-o/2,c=0,h=0,b=0;return t<60?(c=o,h=i):t<120?(c=i,h=o):t<180?(h=o,b=i):t<240?(h=i,b=o):t<300?(c=i,b=o):(c=o,b=i),{r:Math.round((c+s)*255),g:Math.round((h+s)*255),b:Math.round((b+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:i,b:s}=Y(t,e,r);return _r(o,i,s)}a(tt,"hslHex");function ft(t){let{r:e,g:r,b:o}=or(Jt(t)||bt),i=B(e,r,o);return i.s<.12&&(i.s=.18),i}a(ft,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,i=Math.max(0,Math.min(.95,e));return tt(t,i,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function vt(t,e){let r=Jt(t)||bt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Ft("#FFFFFF",r,o)}a(vt,"tintFromHex");function Dt(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Dt,"companionHue");function Lt(t){let e=Jt(t)||bt,{h:r,s:o}=ft(e),i=Dt(r),s=Math.min(.72,Math.max(.28,o*.78));return ht(i,s,42)}a(Lt,"companionColor");function Nt(t,e){let r=Jt(t)||bt,{h:o,s:i}=ft(r),c=zt(e||ot),h=Math.min(.92,Math.max(.35,i*c.chroma)),b=Lt(r),{h:_}=ft(b),M=ht(o,h,c.primaryTone),N=ht(o,h,Math.max(24,c.primaryTone-10)),L=Ft("#FFFFFF",r,.18),D,J,O;c.whiteCard?(D=Ft("#F1F5F9",Ft("#FFFFFF",r,.08),.5),J="#FFFFFF",O="#E5E7EB"):c.duo?(D=Ft(vt(b,c.bgSeed+.04),"#EEF1F4",.1),J=Ft(vt(r,c.surfaceSeed),"#FFFFFF",.1),O=Ft("#E5E7EB",b,.16)):(D=Ft(vt(r,c.bgSeed),"#E8EBEF",.12),J=Ft(vt(r,c.surfaceSeed),"#FFFFFF",.12),O=Ft("#E5E7EB",r,Math.max(.08,c.borderSeed*.7)));let R=c.whiteCard?"#F8FAFC":Ft(J,vt(c.duo?b:r,Math.max(.05,(c.surfaceSeed||.1)*.55)),.35),F=ht(o,Math.min(.45,h*.55),14),K=Se(ht(o,h*.3,34),.88),ut=Se(ht(o,h*.22,46),.76),wt=Se(M,.18),Ct="0 4px 12px "+Se(M,.1)+", 0 1px 2px "+Se(M,.05);return{"--bg":D,"--surface":J,"--text":F,"--text-secondary":K,"--text-muted":ut,"--border":O,"--border-focus":M,"--input-bg":R,"--primary":M,"--primary-hover":N,"--ring":wt,"--shadow":Ct,"--radius":"18px","--radius-sm":"12px","--primary-container":L,"--secondary":b}}a(Nt,"buildMaterialSchemeVars");function Zt(t,e){let r=Nt(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Zt,"buildSchemePreview");function Be(t){let e=Jt(t)||Xt()||bt;return X.map(r=>Object.assign({},r,Zt(e,r.id)))}a(Be,"listSchemePreviews");function fe(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(fe,"clearInlinePrimaryOverrides");function Xt(){return Jt(GM_getValue(q,""))||""}a(Xt,"getAccent");function Fe(){let t=String(GM_getValue(f,ot)||ot);return X.some(e=>e.id===t)?t:ot}a(Fe,"getScheme");function ga(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(f,e),e}a(ga,"setScheme");function Ki(t,e){if(!t)return;let r=Jt(t);if(r){if(GM_setValue(q,r),e&&e.scheme&&ga(e.scheme),e&&e.skipTheme){let o=lo(r,.15),i=Se(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",i);try{xt()}catch{}try{jt()}catch{}return}Gt("scu-red");try{xt()}catch{}try{jt()}catch{}}}a(Ki,"applyAccent");function xa(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(xa,"getAccentPresets");function Zi(t){let e=Jt(t||Xt()||bt);if(!e)return xa();let r=xa();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(Zi,"saveAccentPreset");function Kt(){try{return!!GM_getValue(m,!1)}catch{return!1}}a(Kt,"isThemeFollowSystem");function $r(t){return GM_setValue(m,!!t),!!t}a($r,"setThemeFollowSystem");function ya(){try{return!!GM_getValue(w,!1)}catch{return!1}}a(ya,"isCleanDefault");function ts(t){return GM_setValue(w,!!t),!!t}a(ts,"setCleanDefault");function va(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(va,"isCleanAnalysisDirect");function es(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(es,"setCleanAnalysis");function Ee(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(Ee,"isAppleEdgeLine");function rs(t){return GM_setValue(E,!!t),!!t}a(rs,"setAppleEdgeLine");function wa(){try{return!!GM_getValue(l,!1)}catch{return!1}}a(wa,"isAutoUpdateCheck");function as(t){return GM_setValue(l,!!t),!!t}a(as,"setAutoUpdateCheck");function Ir(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(Ir,"readJsonSetting");function Nr(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(Nr,"writeJsonSetting");function Ce(){return vo(Ir(j,null))}a(Ce,"getPrivacySettings");function ka(t){return Nr(j,vo(t))}a(ka,"setPrivacySettings");function De(){return Tr(Ir(I,null))}a(De,"getCustomIdentity");function qo(t){return Nr(I,Tr(t))}a(qo,"setCustomIdentity");function Aa(){let t=Ir(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(Aa,"getScheduleFirstMondayMap");function To(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=Aa();r[String(t)]=String(e),Nr(H,r)}a(To,"rememberScheduleFirstMonday");function Br(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=Ir(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},i={enabled:!!o.enabled,mapping:Ne(o.mapping||Lr)};return et="",i}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:Ne(Lr)}}}a(Br,"getScheduleJsonFormatSettings");function Mo(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:Ne(e.mapping||Lr)};return et="",Nr(G,r)}a(Mo,"setScheduleJsonFormatSettings");function $o(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a($o,"isHomePage");function Fr(){try{return!!GM_getValue(z,!1)}catch{return!1}}a(Fr,"isFollowUseDynamic");function Sa(t){return GM_setValue(z,!!t),!!t}a(Sa,"setFollowUseDynamic");function os(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(os,"systemPrefersDark");function ge(){return os()&&je()?"dark":Fr()&&Oe()?"scu-red":"default"}a(ge,"resolveFollowThemeName");function cr(t,e){return t==="dark"?je(e):t==="scu-red"?Oe(e):t==="default"}a(cr,"isThemeModeAvailable");function Gt(t,e){e=e||{},!je()&&Kt()&&$r(!1),!Oe()&&Fr()&&Sa(!1),e.manual&&$r(!1);let r;e.system||Kt()&&!e.manual?r=ge():(r=Pt[t]?t:Vt()||"default",Pt[r]||(r="default")),cr(r)||(r="default");let o=Pt[r]||Pt.default;e.skipPersist||GM_setValue(v,r),fe();let i=document.getElementById("urppp-theme-vars")||(()=>{let _=document.createElement("style");return _.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(_),_})(),s=Xt(),c=Object.assign({},o.vars);if(r==="scu-red"){let _=s||bt,M=Fe();c=Object.assign(c,Nt(_,M));let N=c["--primary"]||_,L=c["--primary-hover"]||lo(N,.12);document.documentElement.style.setProperty("--urppp-accent",N),document.documentElement.style.setProperty("--urppp-accent-hover",L),document.documentElement.style.setProperty("--urppp-accent-ring",c["--ring"]||Se(N,.15)),document.documentElement.style.setProperty("--urppp-seed",_),document.documentElement.style.setProperty("--urppp-scheme",M)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let h=":root {";for(let[_,M]of Object.entries(c))h+=`${_}:${M};`;h+="}",i.textContent=h,document.body&&(document.body.style.fontFamily=o.font);try{let _=document.documentElement;_.dataset.urpppTheme=r,_.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),_.classList.add("urppp-theme-"+r),_.classList.toggle("urppp-theme-follow",Kt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Kt()))}catch{}try{re()}catch{}try{xt()}catch{}try{jt()}catch{}try{rn()}catch{}try{bs()}catch{}let b=document.getElementById("urppp-boot-loader");b&&(b.style.fontFamily=o.font)}a(Gt,"applyTheme");function Vt(){return GM_getValue(v,"default")}a(Vt,"getCurrent");function xe(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(xe,"themeDownloaded");function ye(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(ye,"localThemes");function Io(t,e){try{let r=ye();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Io,"saveLocalTheme");function ns(t){try{let e=ye();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(ns,"removeLocalTheme");function ps(){try{if(typeof GM_listValues!="function")return;let t=ye(),e=!1;GM_listValues().forEach(r=>{let o=/^urppp_theme_css_(.+)$/.exec(r);if(!o)return;let i=o[1];u.some(s=>s.id===i)||t[i]||(t[i]={name:i,desc:"下载主题",author:"",version:"1.0.0"},e=!0)}),e&&GM_setValue("urppp_local_themes",JSON.stringify(t))}catch{}}a(ps,"migrateDownloadedThemes");function _a(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(_a,"storeThemeStyleEl");function is(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(is,"removeStoreThemeStyle");function No(){ps();let t=new Set,e=a(r=>{if(t.has(r))return;t.add(r);let o="";try{o=GM_getValue("urppp_theme_css_"+r,"")||""}catch{}o&&(_a(r).textContent=o);let i="";try{i=GM_getValue("urppp_card_css_"+r,"")||""}catch{}i&&Pe([{id:r,cardCss:i}])},"injectOne");u.forEach(r=>e(r.id)),Object.keys(ye()).forEach(r=>e(r));try{re()}catch{}}a(No,"injectAllStoreThemeStyles");function te(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||xe(e.id))||ye()[t]&&xe(t)?t:"apple"}a(te,"getSkin");function Ea(t,e){let r=t||te(),o=u.find(i=>i.id===r);return!!(o&&o[e])}a(Ea,"getSkinCapability");function je(t){return Ea(t,"dark")}a(je,"skinSupportsDark");function Oe(t){return Ea(t,"dynamic")}a(Oe,"skinSupportsDynamic");function Bo(t){return Ea(t,"palettes")}a(Bo,"skinSupportsFixedPalettes");function dr(t){return Q.find(e=>e.id===t)||Q[0]}a(dr,"getBrutalPaletteById");function Fo(){let t=String(GM_getValue($,"acid")||"acid"),e=dr(t);return e.id===V?dr("acid"):e}a(Fo,"getBrutalSelectedPalette");function Do(){let t=String(GM_getValue(T,V)||V);return dr(t)}a(Do,"getBrutalActivePalette");function jo(t,e){let r=e||{},o=dr(t);r.select&&o.id!==V&&GM_setValue($,o.id),GM_setValue(T,o.id);try{re()}catch{}try{xt()}catch{}try{jt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}}a(jo,"setBrutalPalette");function ss(t){let e=t||te();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&Ee()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&Ee()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(ss,"getSkinShapeOverrides");function He(){try{let t=te();if(t==="apple")return Ee()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(He,"urpppCardBorderValue");function re(){let t=te();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&Ee();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=ss(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=Do();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=Ee(),c=s?"1px solid rgba(0,0,0,0.08)":"none",h=s?"1px solid rgba(255,255,255,0.10)":"none",b=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+c+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+h+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+c+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+b+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let i=document.head||document.documentElement;e.parentNode===i&&i.lastElementChild!==e&&i.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Qt(document)}catch{}},0)}a(re,"applySkinAttr");function Oo(t){let e=u.find(i=>i.id===t&&i.ready&&(i.installed!==!1||xe(i.id))),r=!e&&ye()[t]&&xe(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||Sa(!1),!o.dark&&Kt()&&$r(!1);let i=Kt(),s=i?ge():Vt(),c=cr(s,e.id)?s:"default";re(),Gt(c,{system:i})}catch{try{re()}catch{}}try{jt()}catch{}try{xt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}return!0}a(Oo,"setSkin");function ls(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Kt())try{Gt(ge(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(ls,"bindSystemThemeListener");try{Kt()?Gt(ge(),{system:!0}):Gt(Vt())}catch{}try{re()}catch{}try{ls()}catch{}function cs(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let i=e.match(o);if(i)return i[0].trim()}return""}a(cs,"extractLoginErrorMessage");function Ho(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(Ho,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=cs(e),i=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),c=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let h=location.pathname==="/loginEn",b=a((R,F)=>h?F:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      ${i}
    </div>`}a(Cs,"themeStoreCard");async function ja(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await we()).filter(o=>o.type==="theme"&&!xe(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Pe(r),e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>Cs(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>Ps(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(ja,"fetchCatalogThemes");async function Ps(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await we()).find(c=>c.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o=await xn(r);if(o==="fail"){Ge("签名校验失败：该条目可能被篡改，已停止下载","error"),e.disabled=!1,e.textContent="下载";return}if(o==="unknown"&&r._srcPub&&!await gn("该源无有效签名校验，可能被篡改。是否自担风险继续下载？")){e.disabled=!1,e.textContent="下载";return}let i="";for(let c of r.entry)try{let h=await fetch(c,{cache:"no-store"});if(h.ok){i=await h.text();break}}catch{}if(!i){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,i)}catch{}if(u.some(c=>c.id===t)||Io(t,{name:r.name||t,desc:r.desc||"下载主题",author:r.author||"",version:r.version||"1.0.0"}),r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{_a(t).textContent=i}catch{}try{Pe([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;let s=e.closest&&e.closest(".urppp-store-inline");if(s){try{let c=s.querySelector("#urppp-theme-manage");c&&await fr(c)}catch{}try{ja(s)}catch{}}try{jt()}catch{}}a(Ps,"downloadStoreTheme");function Ls(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,i=e&&e.repo||t.repo,s=i?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(i)}">仓库</button>`:"",c=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"",h=te()===t.id;return`<div class="urppp-skin-card${h?" is-active":""}" data-skin="${at(t.id)}">
      ...
      ${o}${s}
    </div>`}a(Ls,"themeManageCardHtml");async function fr(t){if(!t)return;let e=pe||[],r=ye(),o=Object.keys(r).map(s=>({id:s,name:r[s].name||s,desc:r[s].desc||"本地主题",version:r[s].version||"1.0.0",author:r[s].author||"本地",installed:!1})),i=u.filter(s=>s.installed!==!1||xe(s.id)).concat(o.filter(s=>!u.some(c=>c.id===s.id)));if(!i.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}if(Pe(i.map(s=>{let c="";try{c=GM_getValue("urppp_card_css_"+s.id,"")||""}catch{}return{id:s.id,cardCss:c||(e.find(h=>h.id===s.id)||{}).cardCss||""}})),t.innerHTML=`<div class="urppp-store-theme-grid">${i.map(s=>Ls(s,e.find(c=>c.id===s.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(s=>s.addEventListener("click",()=>{if(Oo(s.dataset.themeUse)){try{jt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(c=>{let h=c.dataset.skin,b=c.querySelector(".urppp-skin-apply"),_=te()===h;c.classList.toggle("is-active",_),b&&(b.classList.toggle("is-current",_),b.disabled=_,b.textContent=_?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(s=>s.addEventListener("click",()=>{let c=s.dataset.themeDel,h=te()===c;try{GM_setValue("urppp_theme_css_"+c,"")}catch{}try{GM_setValue("urppp_card_css_"+c,"")}catch{}ns(c),is(c);try{if(h){GM_setValue(d,"apple");try{document.documentElement.removeAttribute("data-urppp-skin")}catch{}try{document.body&&document.body.removeAttribute("data-urppp-skin")}catch{}re();let _=Kt(),M=_?ge():Vt();Gt(M,{system:_})}}catch{}try{jt()}catch{}let b=t.closest(".urppp-store-inline");if(b){try{fr(t)}catch{}try{ja(b)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(s=>s.addEventListener("click",()=>{try{window.open(s.dataset.repo,"_blank","noopener")}catch{}})),!pe)try{we(!0).then(s=>{if(pe=s,document.body.contains(t))try{fr(t)}catch{}})}catch{}}a(fr,"fetchThemeManage");function fn(){return`<div class="urppp-store-settings">
      ...
      </div>`,hn(t),wn(t),Is(t),An(t),ja(t),fr(t.querySelector("#urppp-theme-manage"))}a($s,"renderThemeStoreBody");function kn(){let t=gr();return`<div class="urppp-src-manage">
    ...
    </div>`}a(kn,"storeSourcesHtml");function An(t){let e=t.querySelector("[data-src-add]");if(e){let r=t.querySelector("[data-src-url]"),o=t.querySelector("[data-src-name]");e.addEventListener("click",async()=>{let i=(r.value||"").trim();if(!i)return;e.disabled=!0;let s=e.textContent;e.textContent="验证中…";try{let c=await fetch(i,{cache:"no-store"});if(!(c&&c.ok))throw new Error("无法访问");let h=await c.json();if(!(h&&Array.isArray(h.items)))throw new Error("不是合法 catalog（无 items）");let b=gr();if(b.some(_=>_.url===i)){Ge("该源已存在");return}b.push({name:(o.value||"").trim()||i,url:i,enabled:!0}),Oa(b),pe=null,Ha(t)}catch(c){Ge("添加失败："+(c&&c.message?c.message:c),"error")}finally{e.disabled=!1,e.textContent=s}})}t.querySelectorAll("[data-src-toggle]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcToggle),i=gr();i[o]&&(i[o].enabled=i[o].enabled===!1,Oa(i),Ha(t))})),t.querySelectorAll("[data-src-del]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcDel),i=gr();i[o]&&(i.splice(o,1),Oa(i),Ha(t))}))}a(An,"bindStoreSources");function Ha(t){let e=t.querySelector('[data-pane="sources"]');if(e){let r=t;e.innerHTML=kn(),An(r)}}a(Ha,"refreshStoreSources");function Is(t){let e=t.querySelector("[data-add-local-theme]"),r=t.querySelector("[data-local-theme-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text(),s=i.match(/html\[data-urppp-skin="([\w-]+)"\]/);if(!s){Ge('未能从 CSS 中识别主题 id（需要 html[data-urppp-skin="…"]）',"error"),r.value="";return}let c=s[1];try{GM_setValue("urppp_theme_css_"+c,i)}catch{}Io(c,{name:c,desc:"本地主题",author:"本地",version:"1.0.0"});try{_a(c).textContent=i}catch{}r.value="";try{fr(t.querySelector("#urppp-theme-manage"))}catch{}}))}a(Is,"bindLocalThemeImport");function Ns(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
...
`),i=[],s=!1,c=a(()=>{s&&(i.push("</ul>"),s=!1)},"closeList");for(let h=0;h<o.length;h++){let _=o[h].replace(/\s+$/,"");if(!_.trim()){c();continue}let M=_.match(/^(#{2,3})\s+(.+)$/);if(M){c();let L=M[1].length,D=M[2];i.push(L===2?`<h2>${r(D)}</h2>`:`<h3>${r(D)}</h3>`);continue}let N=_.match(/^[-*]\s+(.+)$/);if(N){s||(i.push("<ul>"),s=!0),i.push(`<li>${r(N[1])}</li>`);continue}c(),i.push(`<p>${r(_)}</p>`)}return c(),i.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(Rs,"renderChangelogMarkdown");function Pn(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(Pn,"hideUpdateToast");function Us(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="background-color"&&i.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(Us,"hideChangelogModal");function Ln(t,e){Cn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>Pn(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let i=o.getAttribute("data-act"),s=e.__pack||{};if(i==="later"){Pn(e);return}if(i==="go"){let c=s.updateUrl||p.mainRaw;try{window.open(c,"_blank","noopener,noreferrer")}catch{location.href=c}return}if(i==="log"){o.disabled=!0,o.textContent="加载中…";try{let c=s.changelogMd;c||(c=await Ua(p.sourceUrls("CHANGELOG.md")),s.changelogMd=c);let h=En(c,s.local,s.remote),b=h?Rs(h):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+p.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';Ln("更新日志 "+s.local+" → "+s.remote,b)}catch(c){Ln("更新日志","<p>加载失败："+at(c&&c.message||c)+'</p><p><a href="'+p.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(Ga,"showUpdateToast");async function Ja(){if(wa()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await Wa();t&&t.status==="update"&&Ga(t);let e=await Ws();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Ja,"maybeAutoCheckUpdate");function Ws(){let t=(window.__urpppUpdateCheckers||Je||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?Et.update("assist"):null).catch(()=>null)}a(Ws,"hotUpdateAssist");async function Va(){if(Ra)return;Ra=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Le("正在从多源检查更新…");try{let e=[Wa()];(Je||[]).forEach(b=>{b&&typeof b.check=="function"&&e.push(Promise.resolve().then(()=>b.check()).then(_=>_||{id:b.id||"extra",name:b.name||"扩展",status:"err",message:"无结果"}).catch(_=>({id:b.id||"extra",name:b.name||"扩展",status:"err",message:String(_&&_.message||_)})))});let r=await Promise.all(e),o=r.map(b=>{if(!b)return"";if(b.status==="err")return`• <b>${at(b.name||b.id)}</b>：检查失败（${at(b.message||"unknown")}）`;if(b.status==="update"){let _="";if(b.id==="assist"&&Et&&Et.loaded("assist"))_=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let M=b.updateUrl?` <a href="${at(b.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",N=b.pageUrl?` <a href="${at(b.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";_=M+N}return`• <b>${at(b.name)}</b>：发现新版本 <b>${at(b.remote)}</b>（当前 ${at(b.local)}）${_}`}return b.status==="ahead"?`• <b>${at(b.name)}</b>：本地 ${at(b.local)} 新于远程 ${at(b.remote)}`:`• <b>${at(b.name)}</b>：已是最新（${at(b.local)}）`}).filter(Boolean),i=r.some(b=>b&&b.status==="update"),s=r.some(b=>b&&b.status==="err");Le(`${i?"检查完成：发现更新":s?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${p.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,s?"err":"ok");let h=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');h&&h.addEventListener("click",()=>{try{Le("正在重新装载辅助插件…",""),Et.install("assist").then(()=>{Le("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(b=>{Le("重新装载失败："+(b&&b.message?b.message:b),"err")})}catch(b){Le("重新装载失败："+(b&&b.message?b.message:b),"err")}})}catch(e){Le("检查失败："+at(e&&e.message||e),"err")}finally{Ra=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(Va,"checkForUpdates");function zn(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+n,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(zn,"refreshUpdateStatusHint");function Gs(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=Je.findIndex(i=>i&&i.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?Je[r]=o:Je.push(o);try{let i=document.getElementById("urppp-set-update-status");i&&o.localVersion&&e==="assist"&&i.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{zn()}catch{}return!0}a(Gs,"registerUpdateChecker");function Js(){let t={version:n,urls:p,check:Va,checkMain:Wa,registerChecker:Gs,compareVersions:Er,parseUserscriptVersion:uo,extractChangelogRange:En,showUpdateToast:Ga,maybeAutoCheckUpdate:Ja,listCheckers:a(()=>Je.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(Js,"publishUpdateApi"),Js();let{rebuildSidebarCompletely:qn,syncMobileContentOffset:Ve,syncSidebarUnderNavbar:ze}=Qi({}),{rebuildDashboard:Vs}=ji({deps:{statCardPrivacyMarkup:Zs}}),Ys="urppp-clean-open",Ya={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function de(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(de,"isUnevaluatedScore");function Vr(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Vr,"isValidOfficialGpa");function Yr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Yr,"firstContentChar");function Qa(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Qa,"weekBitmapActive");function Ye(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||de(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Ya[o]!=null?Ya[o]:Ya[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ye,"scoreToGpa");function Qe(t){let e=String(t||"").trim();if(!e||de(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(Qe,"scoreToNumber");function qe(t){return Math.round((Number(t)||0)*100)/100}a(qe,"round2");function Tn(t){return/必修/.test(String(t||""))}a(Tn,"isRequiredAttr");function ae(t){let e=0,r=0,o=0,i=0,s=0,c=0,h=0,b=0;return(t||[]).forEach(_=>{if(_&&(_.unevaluated||de(_.score)))return;let M=Number(_.credit)||0,N=Qe(_.score),L=Vr(_.officialGpa)?Number(_.officialGpa):Ye(_.score);N==null||M<=0||(e+=M,r+=N*M,L!=null&&(o+=L*M,i+=M),_.required&&(s+=M,c+=N*M,L!=null&&(h+=L*M,b+=M)))}),{totalCredit:qe(e),avgScore:qe(e?r/e:0),avgGpa:qe(i?o/i:0),requiredCredit:qe(s),requiredGpa:qe(b?h/b:0),requiredAvg:qe(s?c/s:0),count:(t||[]).length}}a(ae,"summarizeCourses");function Xa(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Xa,"absUrl");function Yt(t,e){let r=Xa(t),o=e&&e.method||"GET",i=e&&e.data||null;return new Promise((s,c)=>{let h=a((b,_)=>b?s(_):c(new Error(_||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:i||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(b=>{b.status>=200&&b.status<400?h(!0,b.responseText||""):h(!1,"HTTP "+b.status)},"onload"),onerror:a(()=>h(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:i||void 0}).then(b=>{if(!b.ok)throw new Error("HTTP "+b.status);return b.text()}).then(b=>h(!0,b)).catch(b=>h(!1,b&&b.message))})}a(Yt,"fetchText");function Qr(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Qr,"parseHtml");function Mn(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=bi,(document.head||document.documentElement).appendChild(t)}a(Mn,"ensureFeatureStyles");function Qs(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=gi,(document.head||document.documentElement).appendChild(t)}a(Qs,"ensureScheduleExportStyles");function Xs(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=xi,(document.head||document.documentElement).appendChild(t)}a(Xs,"ensureSettingsStyles");function $n(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let i=r.cloneNode(!0);i.querySelectorAll("small, i, img, b, .badge").forEach(h=>h.remove());let s=(i.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(h=>{h.nodeType===Node.TEXT_NODE&&h.textContent.trim()&&h.remove()});let c=document.createElement("span");return c.className="urppp-user-name-value",c.textContent=s||"同学",c.__urpppOriginalText=c.textContent,r.appendChild(c),c}a($n,"ensureNavNameTarget");function Xr(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Xr,"classifyPrivacyLabel");function Ks(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(Ks,"classifyHomeDataKey");function Kr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Kr,"homePrivateValueSpan");function Zs(t,e){let r=at(t),o=at(e),i=Ks(t,e),c={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[i]||Xr(String(t||"")+" "+String(e||""));if(c==="organization")return e?{valueHtml:r,labelHtml:Kr("organization",i,o)}:{valueHtml:Kr("organization",i,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(c))return{valueHtml:r,labelHtml:o};let h=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&h){let _=h.index||0,M=String(e).slice(0,_),N=String(e).slice(_+h[0].length);return{valueHtml:r,labelHtml:`${at(M)}${Kr(c,i,at(h[0]))}${at(N)}`}}return{valueHtml:Kr(c,i,r),labelHtml:o}}a(Zs,"statCardPrivacyMarkup");function Te(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||qr;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||qr)}a(Te,"privacyReplacement");function xr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(xr,"markPrivateText");function In(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||qr);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(In,"markPrivateAvatar");function tl(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(tl,"markPrivateBlock");function el(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(el,"markDirectEditable");let ke=null;function Nn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;ke&&ke.__finish&&ke.__finish(!1);let r=Ce();if(r.mode!=="custom"||!r.directEdit.enabled)return;let i=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),s=t.getBoundingClientRect(),c=t.parentElement?.getBoundingClientRect(),h=s.height>=8||!c?s:{left:s.left,top:c.top,width:Math.max(s.width,40),height:c.height},b=document.createElement("input"),_=getComputedStyle(t),M=Math.min(Math.max(h.width+64,140),Math.max(140,window.innerWidth-24)),N=Math.min(Math.max(12,h.left),Math.max(12,window.innerWidth-M-12)),L=Math.min(Math.max(12,h.top+(h.height-36)/2),Math.max(12,window.innerHeight-48));b.type="text",b.maxLength=80,b.className="urppp-direct-edit-input",b.value=i,b.setAttribute("aria-label","修改"+U[e]+"显示值"),b.style.left=N+"px",b.style.top=L+"px",b.style.setProperty("--urppp-direct-edit-width",M+"px"),b.style.fontFamily=_.fontFamily,b.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(_.fontSize)||14)))+"px";let D=!1,J=a(O=>{if(D||(D=!0,b.remove(),ke===b&&(ke=null),O))return;let R=Ce();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(b.value||"").trim().slice(0,80),ka(R),Qt(document),ro(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");b.__finish=J,b.addEventListener("click",O=>O.stopPropagation()),b.addEventListener("blur",()=>J(!1)),b.addEventListener("keydown",O=>{O.key==="Enter"&&(O.preventDefault(),J(!1)),O.key==="Escape"&&(O.preventDefault(),J(!0))}),document.documentElement.appendChild(b),ke=b,b.focus(),b.select()}a(Nn,"openDirectEditInput");function rl(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Nn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Nn(e))},!0))}a(rl,"bindDirectEditInteraction");function al(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(al,"clearPrivacyDisplay");function Bn(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(Bn,"applyCustomText");function ol(t){let e=t&&t.querySelectorAll?t:document,r=De(),i=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?$n(e):null);Bn(i,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(h=>{let b=h.querySelector(".profile-info-name"),_=h.querySelector(".profile-info-value");!b||!_||String(b.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||Bn(_,r.nameEnabled,r.name)});let s=sr(r.avatar),c=r.avatarEnabled&&!!s;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(h=>{let b=h.getAttribute("src")||"";b&&b!==h.__urpppAppliedCustomSrc&&(h.__urpppOriginalSrc=b),c?(h.__urpppOriginalSrc==null&&(h.__urpppOriginalSrc=b),b!==s&&h.setAttribute("src",s),h.__urpppAppliedCustomSrc=s):h.__urpppAppliedCustomSrc!=null&&(h.__urpppOriginalSrc&&h.setAttribute("src",h.__urpppOriginalSrc),delete h.__urpppAppliedCustomSrc)})}a(ol,"applyCustomIdentityDisplay");function nl(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),i=r.querySelector(".profile-info-value, td:last-child");if(!o||!i||o===i)return;let s=Xr(o.textContent),c=Te(e,s);c&&xr(i,c)})}a(nl,"applyProfilePrivacy");function pl(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let i=o.map(s=>{let c=Xr(s.textContent);return["grade","gpa","credit"].includes(c)?c:""});i.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(s=>{let c=s.querySelectorAll("td");i.forEach((h,b)=>{let _=Te(e,h);h&&_&&xr(c[b],_)})})})}a(pl,"applyScoreTablePrivacy");function il(t){let e=t&&t.querySelectorAll?t:document,r=Ce();if(r.mode==="off")return;let o=Te(r,"name"),i=Te(r,"avatar"),s=Te(r,"schedule"),c=o?$n(e):e.querySelector?.(".urppp-user-name-value");o&&xr(c,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([_,M])=>{let N=Te(r,M);N&&e.querySelectorAll(_).forEach(L=>xr(L,N))}),pl(e,r);let b=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(_=>{let M=_.getAttribute("data-urppp-private"),N=_.getAttribute("data-urppp-edit-key"),D=(b&&N?String(r.directEdit.values[N]||"").trim():"")||Te(r,M);!["avatar","schedule"].includes(M)&&D&&xr(_,D),b&&N&&el(_,N)}),b&&rl(),nl(e,r),i&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(_=>{let M=_.matches("img")?_:_.querySelector("img");M?In(M,i):(_.classList.add("urppp-private-avatar-block"),_.setAttribute("data-urppp-private-mask",i))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(_=>In(_,i))),s){let _=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));_.filter(M=>!_.some(N=>N!==M&&N.contains(M))).forEach(M=>tl(M,s))}}a(il,"applyPrivacyDisplay");let Ka=0,ue=[];function Fn(){let t=Ce(),e=De();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(Fn,"personalDisplayIsEnabled");function sl(){ue=ue.filter(({root:t})=>t&&t.isConnected),ue.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(sl,"resumePersonalDisplayObservers");function Qt(t){let e=t||document;ue.forEach(({observer:r})=>r.disconnect());try{Mn()}catch{}try{al(e)}catch{}try{ol(e)}catch(r){console.warn("[URP++] custom identity",r)}try{il(e)}catch(r){console.warn("[URP++] privacy",r)}Fn()?(sl(),cl()):(clearTimeout(Ka),ue=[])}a(Qt,"applyPersonalDisplay");function ll(t){clearTimeout(Ka),Ka=setTimeout(()=>Qt(t||document),140)}a(ll,"schedulePersonalDisplay");function Za(){try{nt&&nt.open&&rr()}catch{}}a(Za,"refreshCleanPersonalDisplay");function cl(){if(!Fn()){ue.forEach(({observer:t})=>t.disconnect()),ue=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(ue.some(r=>r.root===t))return;let e=new MutationObserver(()=>ll(document));ue.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(cl,"bindPersonalDisplayObservers");function dl(t){let e=Object.assign({},t||{}),r=De();r.nameEnabled&&r.name&&(e.name=r.name);let o=sr(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(dl,"personalizedProfile");let Dn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",ul="/student/courseSelect/thisSemesterCurriculum/callback",ml="/student/courseSelect/thisSemesterCurriculum/index";async function bl(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Yt(ul),r=JSON.parse(e),o=ir(r);if(o)return o}catch{}return""}a(bl,"resolveSchedulePlanCode");async function jn(t){let e=await bl(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Yt(Dn,r),i;try{i=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=ir(i)),(!i.jcsjbs||!i.jcsjbs.length)&&e&&(i=JSON.parse(await Yt(Dn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let s=Hn(i,e,t);if(!s.courses.length)throw new Error("没有读取到可导出的课表数据");return s}a(jn,"loadScheduleExportData");function to(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(to,"safeScheduleFilename");function eo(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(eo,"downloadBlob");function hl(t){let e=na(t),r=Br(),o=r.enabled?ia(e,r.mapping):pa(e),i=JSON.stringify(o,null,2)+`
`;return eo(new Blob([i],{type:"application/json;charset=utf-8"}),to(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(hl,"exportScheduleJson");function On(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(c=>c.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let i=Number(r[4]);if(i<1||i>30)return"";let s=xo(new Date);return s.setDate(s.getDate()-(i-1)*7),zr(s)}a(On,"deriveCurrentSemesterMonday");function Hn(t,e,r){let o=e||ir(t),i=On(o)||Aa()[o]||"";return $p(t,o,r,{firstMonday:i})}a(Hn,"normalizeScheduleDataForPage");function fl(t){let e=t.semester.planCode,r=Aa()[e],o=On(e);return o?(To(e,o),Promise.resolve(o)):pr(r)?Promise.resolve(r):new Promise((i,s)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let c=document.createElement("div");c.className="urppp-dialog-mask",c.dataset.dialog="schedule-date",c.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||Lp(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(c);let h=a((b,_)=>{c.remove(),b?s(b):i(_)},"close");c.querySelector('[data-action="cancel"]').addEventListener("click",()=>h(new Error("已取消导出"))),c.querySelector('[data-action="ok"]').addEventListener("click",()=>{let b=c.querySelector("input").value;pr(b)&&(To(e,b),h(null,b))}),c.addEventListener("click",b=>{b.target===c&&h(new Error("已取消导出"))})})}a(fl,"requestScheduleFirstMonday");async function gl(t){let e=await fl(t),r=qp(t,e);return eo(new Blob([r],{type:"text/calendar;charset=utf-8"}),to(t.semester.label)+".ics"),Tp(t)}a(gl,"exportScheduleIcs");let xl={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function me(t,e,r){if(typeof document>"u")return Jt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let i=getComputedStyle(o).color;o.remove();let s=String(i||"").match(/[\d.]+/g)?.map(Number)||[];if(s.length>=3){let c=_r(s[0],s[1],s[2]),h=s.length>3?Math.max(0,Math.min(1,s[3])):1;return h<1?Ft(r||e,c,h):c}return Jt(i)||Jt(e)||"#000000"}a(me,"resolvedScheduleImageColor");function Rn(){let t=Vt(),e=te(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},i={bg:me("--bg",o.bg),surface:me(e==="neu"?"--neu-base":"--surface",o.surface),input:me("--input-bg",o.input),text:me("--text",o.text),secondary:me("--text-secondary",o.secondary),muted:me("--text-muted",o.muted),border:me("--border",o.border,me(e==="neu"?"--neu-base":"--surface",o.surface)),primary:me("--primary",o.primary)},s={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(xl[e]||e)+" · "+(Pt[t]&&Pt[t].name||t),colors:i,shape:s[e]||s.apple}}a(Rn,"currentScheduleImageTheme");function Un(t,e){return Rp(t,e||Rn())}a(Un,"buildScheduleSvg");function yl(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),i=URL.createObjectURL(o),s=new Image;s.onload=()=>{try{let h=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),b=document.createElement("canvas");b.width=Math.floor(t.width*h),b.height=Math.floor(t.height*h);let _=b.getContext("2d");_.scale(b.width/t.width,b.height/t.height),_.fillStyle=t.background||"#F8FAFC",_.fillRect(0,0,t.width,t.height),_.drawImage(s,0,0,t.width,t.height),b.toBlob(M=>M?e(M):r(new Error("无法生成课表图片")),"image/png")}catch(c){r(c)}finally{URL.revokeObjectURL(i)}},s.onerror=()=>{URL.revokeObjectURL(i),r(new Error("课表图片渲染失败"))},s.src=i})}a(yl,"svgToPngBlob");async function vl(t){let e=await yl(Un(t));eo(e,to(t.semester.label)+".png")}a(vl,"exportSchedulePng");function ro(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(ro,"showFeatureToast");let ao=Up({document,window,ensureStyles:Qs,loadData:jn,exportJson:hl,exportIcs:gl,exportPng:vl,showToast:ro,nativePageUrl:ml,navigate:a(t=>{location.href=t},"navigate"),logger:console});function wl(t,e,r,o){return ao.run(t,e,r,o)}a(wl,"runScheduleExport");function kl(t){return ao.createMenu(t)}a(kl,"createScheduleExportMenu");function Al(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(Al,"disposeNativePdfCapture");function Sl(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let i=ci(e);t.stage="ok",t.stageCards=i.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=i.target.querySelector("table")?i.target.querySelector("table").id:"none",Al(i)}catch(i){t.stage="failed",t.stageError=i&&i.message||String(i)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(Sl,"bindNativePdfDiagnose");function _l(t){return t?(Sl(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await mi(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:br})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),ro("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(_l,"pagePdfExportHandler");function oo(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(oo,"isPersonalSchedulePage");function El(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(El,"isScoreQueryPage");function no(){if(!oo())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(c=>[c.textContent,c.getAttribute("title"),c.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(c=>{/打印.*课表|\bdy\s*\(/i.test(o(c))&&c.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let i=r.find(c=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(c))),s=kl({source:"native",pdfHandler:_l(i)});if(s.id="urppp-native-schedule-export",i&&i.parentElement){i.__urpppNativeExportState||(i.__urpppNativeExportState={display:i.style.getPropertyValue("display"),displayPriority:i.style.getPropertyPriority("display"),ariaHidden:i.getAttribute("aria-hidden"),tabIndex:i.getAttribute("tabindex")}),i.setAttribute("data-urppp-native-export-source","1"),i.style.setProperty("display","none","important"),i.setAttribute("aria-hidden","true"),i.setAttribute("tabindex","-1"),i.parentElement.insertBefore(s,i.nextSibling);return}if(e)e.appendChild(s);else if(t)t.appendChild(s);else{let c=document.getElementById("page-content-template")||document.querySelector(".page-content");if(c){let h=document.createElement("div");h.className="urppp-export-fallback",h.appendChild(s),c.prepend(h)}}}a(no,"patchNativeScheduleExport");let Xe=null,Zr=0;function po(){clearTimeout(Zr),Zr=0,Xe&&Xe.observer.disconnect(),Xe=null}a(po,"disconnectNativeScheduleExportObserver");function Cl(){if(!oo()){po();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Xe&&Xe.root===t&&t.isConnected)return;po();let e=new MutationObserver(()=>{clearTimeout(Zr),Zr=setTimeout(()=>no(),80)});e.observe(t,{childList:!0,subtree:!0}),Xe={root:t,observer:e}}a(Cl,"bindNativeScheduleExportObserver");function Wn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(Wn,"restoreOptionalAttribute");function Pl(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let i=o.__urpppNativeExportState;i&&(i.display?o.style.setProperty("display",i.display,i.displayPriority):o.style.removeProperty("display"),Wn(o,"aria-hidden",i.ariaHidden),Wn(o,"tabindex",i.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(Pl,"removeNativeScheduleExport");let Gn=Vi({deps:{styles:Ai,loadScores:pp,loadProfile:Jn,scoreToNumber:Qe,scoreToGpa:Ye,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),Ll=gp([aa({id:"schedule-export",matches:a(t=>oo(t.location),"matches"),mount:a(()=>{no(),Cl()},"mount"),unmount:a(t=>{po(),Pl(t?.lifecycleKey)},"unmount")}),aa({id:"score-analysis",matches:a(t=>El(t.location),"matches"),mount:a(()=>{try{Gn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Gn.unmount()}catch{}},"unmount")})]);function ta(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return Ll.refresh({document,location,window,lifecycleKey:t})}a(ta,"refreshRouteFeatures");function zl(t){ao.bindHosts(t)}a(zl,"bindScheduleExportHosts");function yr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(yr,"normalizeProfileValue");function ea(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(i=>yr(i).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let i=0;i<o.length;i++){let s=o[i],c=s.querySelector(".profile-info-name, th, label"),h=s.querySelector(".profile-info-value, td:last-child");if(!c||!h||c===h)continue;let b=yr(c.textContent).replace(/[：:]/g,"");if(!r.some(M=>b===M||b.endsWith(M)))continue;let _=yr(h.textContent);if(_&&_!=="—"&&_!=="-")return _}return""}a(ea,"readLabeledProfileValue");function Ke(t){return yr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Ke,"cleanMajorPlanName");function ql(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),i=yr(o);if(/主修必修GPA/.test(i)){let s=i.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||i.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(s){let c=Number(s[1]),h=Number(e.majorGpa);Number.isFinite(c)&&c>=0&&c<=5&&(!e.majorGpa||h===0||c>0)&&(e.majorGpa=s[1])}}if(/主修为|培养方案/.test(i)){let s=i.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||i.match(/^(.{2,60}?)\s*主修为/)||i.match(/主修为\s*(.{2,60})$/),c=Ke(s&&s[1]);if(c&&!/GPA|已修读|尚不及格|本学期/.test(c)){let h=/培养方案|教学计划/.test(c);(!e.majorPlan||h)&&(e.majorPlan=c)}}}),e}a(ql,"extractAcademicOverview");async function Jn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let s=r.querySelector(".urppp-user-name-value"),c=s&&s.__urpppOriginalText;c&&(t.name=String(c).trim());let h=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),b=t.name?null:h.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!b){let _=r.cloneNode(!0);_.querySelectorAll("small, i, img, b, .badge").forEach(N=>N.remove());let M=(_.textContent||"").replace(/\s+/g," ").trim();M=M.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),b=M.match(/([\u4e00-\u9fa5·]{2,12})/)}b&&b[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(b[1])&&(t.name=b[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let i=ql(document);t.majorPlan=i.majorPlan,t.majorGpa=i.majorGpa}catch{}try{let r=await Yt("/student/rollManagement/rollInfo/index"),o=Qr(r),i=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=ea(o,["姓名"]),!t.name)){let b=i.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);b&&(t.name=b[1].trim())}let s=ea(o,["主修方案名称"]),c=ea(o,["专业"]);t.studentId=ea(o,["学号"]),s?t.majorPlan=Ke(s):!t.majorPlan&&c&&(t.majorPlan=Ke(c));let h=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(h&&h.getAttribute("src")&&!t.avatar){let b=h.getAttribute("src");t.avatar=/^https?:/i.test(b)?b:Xa(b)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(Jn,"loadProfile");let Vn=["周日","周一","周二","周三","周四","周五","周六"];function io(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(i=>{let s=String(i.id||"").match(/^(\d+)_(\d+)$/);if(!s)return;let c=parseInt(s[1],10),h=parseInt(s[2],10),b=c===7?0:c,_=i.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),M=_.length?_:[];if(!M.length&&(i.textContent||"").trim()){let N=(i.textContent||"").replace(/\s+/g," ").trim();N&&e.push({name:N.slice(0,40),teacher:"",place:"",week:"",day:b,section:h});return}M.forEach(N=>{let L=Array.from(N.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),D=(N.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||L[0]||"",J=(N.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",O=L.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=L.find(K=>/周/.test(K))||"",F=String(D).replace(/_\d+\s*$/,"").trim();!F||F.length<2||e.push({name:F,teacher:String(O).trim(),place:String(J||"").trim(),week:String(R).trim(),day:b,section:h})})});let o=new Set;return e.filter(i=>{let s=[i.day,i.section,i.name,i.place].join("|");return o.has(s)?!1:(o.add(s),!0)})}a(io,"parseScheduleFromDoc");let Yn="urppp_term_week_v1";function Ze(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(Yn,e)}catch{}return e}a(Ze,"rememberTermWeek");function vr(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(Yn,0))||0;if(t>=1&&t<=30)return Ze(t)}catch{}return 0}a(vr,"readRememberedTermWeek");function wr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let i=e.match(r[o]);if(i){let s=parseInt(i[1],10);if(s>=1&&s<=30)return s}}return 0}a(wr,"extractTermWeekFromText");function Me(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let c=0;c<t.length;c++){let h=t[c],b=wr(h.innerText||h.textContent||"")||wr(h.innerHTML||"");if(b)return Ze(b)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=wr(e);if(r)return Ze(r);let o=document.body&&document.body.innerText||"",i=wr(o);if(i)return Ze(i);let s=vr();if(s)return s}catch{}return 0}a(Me,"getCurrentWeekNumber");let tr=null;function Tl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(Tl,"calTodayStr");function Ml(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(i=>String(i).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(Ml,"calAddDays");function kr(t){if(tr)return tr;let e=t||Tl();return e>="2027-02-06"&&e<=Ml("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(kr,"calVacation");function $l(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a($l,"festiveDecorHtml");function Qn(){let t=typeof document<"u"?document:null;if(!t)return;let e=kr()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",$l()):!e&&r&&r.remove()}a(Qn,"syncFestiveDecor");function Xn(t){tr=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,tr&&tr!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{Qn()}catch{}try{typeof rr=="function"&&rr()}catch{}return tr}a(Xn,"setCalendarPhase");function Il(){return kr()}a(Il,"getCalendarPhase");function Kn(){if(kr()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=Me()||vr()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(Kn,"getViewWeekNumber");async function Nl(){let t=Me();if(t>=1)return t;try{let e=await Yt("/index");if(t=wr(e),t)return Ze(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),i=await Yt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),s=JSON.parse(i),c=Number(s&&s.jxzc);if(c>=1&&c<=30)return Ze(c)}catch{}return vr()||0}a(Nl,"ensureTermWeekResolved");function Bl(t){let e=Me()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let i=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);i&&(e=Math.max(e,parseInt(i[2],10)||0));let s=String(r.week||"").match(/\d{1,2}/g);s&&s.forEach(c=>{e=Math.max(e,parseInt(c,10)||0)})}),Math.min(Math.max(e,1),30)}a(Bl,"inferMaxWeek");function Zn(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Zn,"weekBitActive");let tp=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function ep(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return tp[e%tp.length]}a(ep,"courseColor");function Fl(t){let e=[],r=Me();(t&&t.xkxx||[]).forEach(s=>{Object.keys(s||{}).forEach(c=>{let h=s[c];if(!h)return;let b=h.courseName||h.englishCourseName||c,_=h.attendClassTeacher||"";(h.timeAndPlaceList||[]).forEach(N=>{let L=Number(N.classDay)||0,D=L===7?0:L,J=Number(N.classSessions)||1,O=Math.max(1,Number(N.continuingSession)||1),R=[N.campusName,N.teachingBuildingName,N.classroomName].filter(Boolean).join(""),F=N.weekDescription||h.skzcs||"",K=Zn(N.classWeek,r)||r&&F.indexOf(String(r))>=0;e.push({name:String(b).trim(),teacher:String(_).trim(),place:String(R).trim(),week:String(F).trim(),classWeek:String(N.classWeek||""),day:D,section:J,span:O,thisWeek:!!K,color:ep(b)})})})});let i=new Set;return e.filter(s=>{let c=[s.day,s.section,s.span,s.name,s.place,s.week].join("|");return i.has(c)?!1:(i.add(c),!0)})}a(Fl,"parseScheduleFromJson");async function Dl(){try{let t=await Yt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let i=Number(r&&(r.jxzc||r.zc||r.currentWeek));i>=1&&i<=30&&(nt._termWeek=Math.max(nt._termWeek||0,i),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=Fl(r)}catch{e=io(Qr(t))}e.length||(e=io(document));let o=r?Hn(r,ir(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=io(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(Dl,"loadSchedule");function jl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),i=r.match(o);if(i&&i[1])return i[1];let s=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),c=r.match(s);return c?c[1]:""}a(jl,"extractScoreCallback");function Ol(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let i=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",s=[];(o.cjList||[]).forEach(c=>{let h=c.courseName||c.englishCourseName||"";if(!h)return;let b=c.cj!=null&&c.cj!==""?String(c.cj):"";!b&&c.courseScore!=null&&(b=String(c.courseScore)),!b&&c.gradeName&&(b=String(c.gradeName)),!b&&c.zscj!=null&&(b=String(c.zscj));let _=c.courseAttributeName||c.xkcsxmc||"",M=parseFloat(c.credit)||0,N=c.id&&(c.id.courseNumber||c.id.kch_zj)||"",L=c.id&&(c.id.coureSequenceNumber||c.id.courseSequenceNumber||c.id.kxh)||c.classNo||"",D=c.gradePointScore!=null?Number(c.gradePointScore):null,J=de(b)||de(c.gradeName)||D!=null&&D<0,O=J?"未评估":b;s.push({code:N,seq:String(L||""),name:h,attr:_,credit:M,score:O,unevaluated:J,required:Tn(_),officialGpa:Vr(D)?D:null,evalUrl:""})}),s.length&&e.push({title:String(i).slice(0,100),courses:s,summary:ae(s),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(Ol,"parseScoreJson");async function rp(t,e){let r=await Yt(t),o=ap(Qr(r));if(o.length)return o;let i=jl(r,e);if(!i)return[];let s=await Yt(i);try{let c=JSON.parse(s);o=Ol(c).map(h=>(h.summary=ae(h.courses),h))}catch{o=ap(Qr(s))}return o}a(rp,"loadScoreByIndex");function ap(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map(M=>(M.textContent||"").replace(/\s+/g,""));if(!o.length)return;let i=o.join("|");if(!/课程名/.test(i)||!/成绩/.test(i))return;let s={code:o.findIndex(M=>M==="课程号"),name:o.findIndex(M=>M==="课程名"),attr:o.findIndex(M=>/课程属性|属性/.test(M)),credit:o.findIndex(M=>M==="学分"),score:o.findIndex(M=>M==="成绩")};if(s.name<0||s.score<0)return;let c="成绩",h=r.previousElementSibling;for(let M=0;M<8&&h;M++,h=h.previousElementSibling)if(/^H[1-4]$/.test(h.tagName)||h.classList&&h.classList.contains("header")){c=(h.textContent||"").replace(/\s+/g," ").trim();break}let b=[],_=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(_).forEach(M=>{let N=Array.from(M.cells||M.querySelectorAll("td"));if(N.length<4)return;let L=a(F=>F>=0&&N[F]?(N[F].textContent||"").replace(/\s+/g," ").trim():"","get"),D=L(s.name),J=L(s.score);if(!D||!J||/课程名|序号/.test(D))return;let O=L(s.attr),R=de(J);b.push({code:L(s.code),name:D,attr:O,credit:parseFloat(L(s.credit))||0,score:R?"未评估":J,unevaluated:R,required:Tn(O),officialGpa:null,evalUrl:""})}),b.length&&e.push({title:c.slice(0,100),courses:b,summary:ae(b)})}),e}a(ap,"parseScoreTables");function Ar(t){return Ke(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(Ar,"schemePlanName");function op(t,e){if(!t||!t.length)return 0;let r=Ke(e),o=t.findIndex(c=>{let h=Ar(c);return/培养方案/.test(h)&&!/微专业|辅修|双学位/.test(h)});if(o>=0&&(!r||Ar(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(c=>{let h=Ar(c);return h.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(h.slice(0,4))||h.includes(r.slice(0,4))}),o>=0))return o;let i=0,s=-1;return t.forEach((c,h)=>{if(/微专业|辅修/.test(Ar(c)))return;let b=(c.courses||[]).length;b>s&&(s=b,i=h)}),i}a(op,"pickMajorSchemeIndex");async function Hl(){let t={};try{let e=await Yt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(i=>{let s=String(i.KCH||"").trim();if(!s)return;let c=String(i.SFPG)==="1",h=String(i.KTID||"").trim();if(!t[s]){t[s]={ktid:h,kxh:String(i.KXH||""),kcm:i.KCM||"",done:c,pending:c?0:1,total:1,url:!c&&h?"/student/teachingEvaluation/newEvaluation/evaluation/"+h:"/student/teachingEvaluation/newEvaluation/index"};return}t[s].total+=1,c||(t[s].pending+=1,t[s].done=!1,h&&(t[s].ktid=h,t[s].url="/student/teachingEvaluation/newEvaluation/evaluation/"+h))}),Object.keys(t).forEach(i=>{let s=t[i];s.done=!(s.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(Hl,"loadEvaluationMap");function Rl(t){if(!t)return!1;if(t.officialGpa!=null&&Vr(t.officialGpa))return!0;let e=t.score;return e==null||e===""||de(e)?!1:Qe(e)!=null||Ye(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(Rl,"hasDisplayableScore");function Ul(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(i=>{if(!i||!i.code)return;let s=e[i.code];if(s){if(Rl(i)){i.unevaluated=!1,s.done?i.evalUrl=i.evalUrl||"":i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index";return}s.done||(i.unevaluated=!0,i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index",(!i.score||i.score===""||de(i.score))&&(i.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(Ul,"attachEvaluationLinks");function np(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=ae(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=ae(e.courses),e)),t)}a(np,"refreshScoreSummaries");async function Wl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await Hl();return Ul(t,e),t.evalMap=e,t.evaluationReady=!0,np(t)}finally{t.evaluationLoading=!1}}a(Wl,"enrichScoresWithEvaluation");function Gl(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=op(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let i=Ar(o),s=Ke(nt.profile.majorPlan);/培养方案|教学计划/.test(i)&&(!/培养方案|教学计划/.test(s)||s==="主修方案")&&(nt.profile.majorPlan=i);let c=o.summary||{},h=Number(c.requiredCredit),b=Number(c.requiredGpa),_=Number(nt.profile.majorGpa);h>0&&Number.isFinite(b)&&b>=0&&b<=5&&(!Number.isFinite(_)||_<=0)&&(nt.profile.majorGpa=String(qe(b)))}a(Gl,"reconcileProfileAndScores");let er=null;async function pp(t){return t&&(er=null),er&&!er.error||(er=await Jl()),er}a(pp,"loadScores");async function Jl(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([rp("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),rp("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(i=>i.courses.forEach(s=>{o.push(Object.assign({term:i.title},s))})),t.passing=[{title:"全部及格成绩",courses:o,summary:ae(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:ae(o)}]),np(t),t.majorIdx=op(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(Jl,"loadScoresImpl");function $e(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a($e,"parseJsonArrayLoose");function ip(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let i=0;for(let s=o;s<t.length&&s<o+3e5;s++){let c=t[s];if(c==="[")i++;else if(c==="]"&&(i--,i===0))return t.slice(o,s+1)}return""}a(ip,"extractBalancedArray");async function Vl(){let t=await Yt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let s=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],c=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(s&&(e=$e(s)),c&&(r=$e(c)),!e.length){let h=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(e=$e(h[1]))}if(!r.length){let h=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(r=$e(h[1]))}if(!r.length){let h=ip(t,"teachingBuildingName");h&&(r=$e(h))}if(!e.length){let h=ip(t,"campusName");h&&(e=$e(h))}}catch(s){console.warn("[URP++] classroom json parse",s)}if(!r.length){let s=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=s;let c=[];for(let h of s)try{let b=await Yt("/student/teachingResources/classroomCurriculum/"+h.campusNumber+"/teachingBuildingJson");$e(b).forEach(M=>{c.push({id:{campusNumber:h.campusNumber,teachingBuildingNumber:String(M.id&&M.id.teachingBuildingNumber||M.teachingBuildingNumber||"")},teachingBuildingName:M.teachingBuildingName||M.name||""})})}catch(b){console.warn("[URP++] building json",h.campusNumber,b)}r=c}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(s=>({campus:s.campusName||s.campusNumber,campusNumber:String(s.campusNumber||s.id&&s.id.campusNumber||""),buildings:[]}));r.forEach(s=>{let c=String(s.id&&s.id.campusNumber||s.campusNumber||""),h=String(s.id&&s.id.teachingBuildingNumber||s.teachingBuildingNumber||""),b=s.teachingBuildingName||s.name||h;if(!c||!h||!b)return;let _=o.find(N=>N.campusNumber===c);_||(_={campus:c,campusNumber:c,buildings:[]},o.push(_));let M="/student/teachingResources/classroomUseStatus/"+c+"/"+h+"/"+encodeURI(encodeURI(_.campus||c))+"/"+encodeURI(encodeURI(b));_.buildings.push({name:b,path:M,campusNumber:c,buildingNumber:h})});let i=o.filter(s=>s.buildings.length);if(!i.length)throw new Error("未解析到教学楼，请刷新后重试");return i}a(Vl,"loadClassroomCatalog");function Sr(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(Sr,"occupancyTypeLabel");function Yl(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return Sr(t)}a(Yl,"occupancyReason");async function Ql(t,e,r,o){let i=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),s=await Yt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+i.toString());try{let c=JSON.parse(s);return Array.isArray(c)?c.length&&Array.isArray(c[0])?c[0]:c.filter(h=>h&&typeof h=="object"&&(h.kcm||h.id&&h.id.kch)):c&&Array.isArray(c.list)?c.list:[]}catch{return[]}}a(Ql,"fetchClassroomCurriculum");function Xl(t,e,r){let o=t||[],i=Number(e.xq)||0,s=Number(e.start)||0,c=Number(r)||0,h=[];return o.forEach(b=>{let _=b.id||{},M=Number(_.skxq!=null?_.skxq:b.skxq)||0,N=Number(_.skjc!=null?_.skjc:b.skjc)||0,L=Math.max(1,Number(b.cxjc)||1),D=_.skzc||b.skzc||"";i&&M&&i!==M||s&&(s<N||s>=N+L)||c&&D&&!Qa(D,c)||h.push(b)}),h.length?(h.sort((b,_)=>{let M=Qa(b.id&&b.id.skzc||b.skzc,c)?0:1,N=Qa(_.id&&_.id.skzc||_.skzc,c)?0:1;return M-N}),h[0]):null}a(Xl,"matchCurriculumCourse");async function Kl(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),i=String(e.buildingNumber||""),s=r||t.planNumber||"";if(!o||!i||!s)return t;let c=t.rooms.filter(L=>(L.slots||[]).some(D=>D.busy)),h={},b=a(async L=>{if(h[L])return h[L];try{h[L]=await Ql(s,o,i,L)}catch{h[L]=[]}return h[L]},"queue"),_=4,M=0,N=new Array(Math.min(_,Math.max(c.length,1))).fill(0).map(async()=>{for(;M<c.length;){let L=M++,D=c[L],J=await b(D.name);(D.slots||[]).forEach(O=>{if(!O.busy)return;let R={xq:O.detail&&O.detail.xq||O.xq||0,start:O.section,week:t.jxzc};O.detail&&O.detail.xq!=null&&(R.xq=O.detail.xq);let F=Xl(J,R,t.jxzc);if(F&&F.kcm){let K=String(F.kcm).trim();O.contentName=K,O.reason=K,O.displayChar=Yr(K),O.detail&&(O.detail.contentName=K,O.detail.reason=K,O.detail.teacher=F.jsm||"",O.detail.weeks=F.zcsm||"",O.detail.courseNo=F.id&&F.id.kch||"",O.detail.typeLabel=Sr({occupancymoduleId:O.module}))}else O.displayChar=Yr(O.reason||"占用"),O.detail&&(O.detail.typeLabel=Sr({occupancymoduleId:O.module}))})}});return await Promise.all(N),t}a(Kl,"enrichOccupancyWithCurriculum");function Zl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(Zl,"occupancyKindClass");async function tc(t){let e="",r="",o="",i="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",i=t.path||"";else{i=String(t||"");let F=i.match(/classroomUseStatus\/(\d+)\/(\d+)\//);F&&(e=F[1],r=F[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let s=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,c=ec(sp(new Date,s)),h="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(c),b=await new Promise((F,K)=>{let ut=Xa("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:h,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(wt=>wt.status>=200&&wt.status<400?F(wt.responseText||""):K(new Error("HTTP "+wt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:h}).then(wt=>wt.text()).then(F).catch(K)}),_;try{_=JSON.parse(b)}catch{throw new Error("jasInfo 非 JSON")}let M=(_.classrooms||[]).map(F=>{let K=F.classroomName||F.id&&F.id.classroomNumber||"",ut=F.placeNum||"",wt=F.remark||"",Ct=[];for(let qt=1;qt<=12;qt++)Ct.push({section:qt,busy:!1});return{name:K,seats:ut,type:wt,slots:Ct,map:{}}}),N={};M.forEach(F=>{N[F.name]=F}),(_.classroomTime||[]).forEach(F=>{let K=F.id||{},ut=K.classroomNumber||"",wt=Number(K.sessionstart)||1,Ct=Math.max(1,Number(F.continuingsession)||1),qt=N[ut];if(!qt)return;let Tt=Sr(F),Ht=Yl(F);for(let Rt=wt;Rt<wt+Ct&&Rt<=12;Rt++){let $t=qt.slots.find(oe=>oe.section===Rt);$t&&($t.busy=!0,$t.kind=F.timestatenumber||F.occupancymoduleId||"",$t.module=F.occupancymoduleId||"",$t.reason=Ht,$t.typeLabel=Tt,$t.displayChar=Yr(Ht),$t.xq=K.xq,$t.weekBitmap=K.week||"",$t.detail={room:ut,section:Rt,start:wt,span:Ct,reason:Ht,typeLabel:Tt,week:K.week||"",xq:K.xq||"",state:F.timestatenumber||"",module:F.occupancymoduleId||""})}});let L="";try{let F=_.jhZxjxjhb;typeof F=="string"&&/\d{4}-\d{4}-\d-\d/.test(F)?L=F:F&&typeof F=="object"&&(L=String(F.zxjxjhh||F.jhxnxq||F.executiveEducationPlanNumber||F.planNumber||""))}catch{}if(!L&&_.classrooms&&_.classrooms[0]&&_.classrooms[0].id&&(L=_.classrooms[0].id.executiveEducationPlanNumber||""),_.jxzc!=null&&Number(_.jxzc)>=1){let F=Number(_.jxzc);nt._termWeek=Math.max(nt._termWeek||0,F),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let D=["日","一","二","三","四","五","六"],J=rc(_.date||c)||sp(new Date,s),O=_.week!=null?Number(_.week):J.getDay(),R=s===1?"明天":s===2?"后天":"今天";return{rooms:M,dateLabel:(_.date||c)+"（周"+(D[O]||O)+" · "+R+"）",jxzc:_.jxzc,planNumber:L,week:_.week!=null?_.week:O,searchDate:_.date||c,dateOffset:s}}a(tc,"loadBuildingOccupancy");function sp(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(sp,"addDays");function ec(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(ec,"formatLocalDate");function rc(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(rc,"parseLocalDate");let lp={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function cp(t){return lp[t]||lp.more}a(cp,"ico");let nt=_i();function ac(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=wi,(document.head||document.documentElement).appendChild(t)}a(ac,"ensureStyle");let oc=ba({deps:{scoreToNumber:Qe,scoreToGpa:Ye}}),{metricHtml:nc,occupancyHtml:pc,render:rr,renderScheduleBoard:ld,roomPickerHtml:ic,scheduleRender:sc}=Bi({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:Vn,analyzeScores:a(t=>oc.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Qt,bandsChartSvg:fa,bindUI:a(t=>cc(t),"bindUI"),classifyPrivacyLabel:Xr,courseColor:ep,ensureRoot:a(()=>up(),"ensureRoot"),escapeHtml:at,firstContentChar:Yr,getViewWeekNumber:Kn,ico:cp,isCleanAnalysisDirect:va,occupancyKindClass:Zl,occupancyTypeLabel:Sr,personalizedProfile:dl,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Qe,summarizeCourses:ae,trendChartSvg:ha,weekBitActive:Zn,calVacation:kr,setCalendarPhase:Xn}}),{ensureRoomCatalogLoaded:dp,loadAll:lc}=Ci({state:nt,deps:{ensureTermWeekResolved:Nl,enrichScoresWithEvaluation:Wl,getCurrentWeekNumber:Me,loadClassroomCatalog:Vl,loadProfile:Jn,loadSchedule:Dl,loadScores:pp,readRememberedTermWeek:vr,reconcileProfileAndScores:Gl,render:rr,scheduleRender:sc}}),{bindUI:cc,closeModal:dc,getRoomHost:cd,openModal:dd,openRoomModal:ud,openScoreModal:md,showBuilding:bd}=Fi({state:nt,deps:{DAY_NAMES:Vn,applyPersonalDisplay:Qt,bindScheduleExportHosts:zl,closeCleanMode:a(()=>mc(),"closeCleanMode"),ensureRoomCatalogLoaded:dp,enrichOccupancyWithCurriculum:Kl,ensureRoot:a(()=>up(),"ensureRoot"),escapeHtml:at,fetchText:Yt,getCurrentWeekNumber:Me,getViewWeekNumber:Kn,inferMaxWeek:Bl,isUnevaluatedScore:de,isValidOfficialGpa:Vr,loadBuildingOccupancy:tc,metricHtml:nc,occupancyHtml:pc,render:rr,rootEl:a(()=>bc(),"rootEl"),roomPickerHtml:ic,scoreToGpa:Ye,scoreToNumber:Qe,summarizeCourses:ae,summarizeCoursesPreferOfficial:ae}}),{cleanModeApi:uc,closeCleanMode:mc,ensureRoot:up,injectCleanEntry:hd,openCleanMode:fd,rootEl:bc}=Di({state:nt,deps:{CLEAN_FLAG:Ys,applySkinAttr:re,closeModal:dc,ensureRoomCatalogLoaded:dp,ensureStyle:ac,getCurrentWeekNumber:Me,getSkin:te,handleThemeDotClick:ct,ico:cp,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:$o,loadAll:lc,openSettingsPanel:dn,readRememberedTermWeek:vr,refreshCleanPersonalDisplay:Za,render:rr,scoreToGpa:Ye,summarizeCourses:ae,syncNavbarThemeUI:xt,syncSettingsPanelUI:jt,syncThemeDotGroup:Z}});window.__urpppCleanMode=uc;function so(){if(!document.body){setTimeout(so,10);return}if(No(),Gt(Vt()),setTimeout(()=>{try{we().then(e=>Pe(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],i=r.parentElement;for(;i;){let s=i.scrollTop,c=i.scrollLeft;(s||c||i.scrollHeight>i.clientHeight||i.scrollWidth>i.clientWidth)&&o.push({el:i,top:s,left:c}),i=i.parentElement}requestAnimationFrame(()=>{o.forEach(s=>{s.el.scrollTop=s.top,s.el.scrollLeft=s.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))Ho();else{ys();try{Mn()}catch{}try{ta()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Qt(document)}catch{}try{Qn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{ta()}catch{}try{Qt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{ya()&&$o()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(so,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(ze,50)}),window.addEventListener("load",()=>{ze(),Ve(),setTimeout(ze,100),setTimeout(ze,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Ve,0),setTimeout(Ve,50),setTimeout(Ve,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Ve,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function mp(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let i=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),s=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));i&&!s&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){ze(),qn(),st(),ze();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(s=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},s)),Ta(),pn(),sn(),Ko(),ln(),nn(),tn(),document.querySelectorAll(".page-content, #page-content-template").forEach(s=>{let c=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);s.style.setProperty("padding",c?"8px 8px 24px":"16px 64px 40px","important"),s.style.setProperty("box-sizing","border-box","important")}),jr(),Rr(),Re(),setTimeout(Re,300),setTimeout(Re,1e3),Go(),ve(),ur(),Yo(),setTimeout(ur,300),mr(),setTimeout(()=>mr(),500),Dr(),Vo();try{ta()}catch{}try{Qt(document)}catch{}setTimeout(()=>{try{ta()}catch{}try{Qt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...i){let s=r.apply(this,i);return e(),s},history.replaceState=function(...i){let s=o.apply(this,i);return e(),s}}a(mp,"watchRouteChanges");let ar=typeof unsafeWindow<"u"?unsafeWindow:window;ar.__urpppDebug=ar.__urpppDebug||{},ar.__urpppDebug.setCalendarPhase=t=>Xn(t),ar.__urpppDebug.getCalendarPhase=()=>Il(),ar.__urpppDebug.calVacation=t=>kr(t),ar.urppp={version:n,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Gt(t)},"apply"),setAccent:Ki,getAccent:Xt,getCurrent:Vt,list:a(()=>Object.entries(Pt).map(([t,e])=>({name:t,displayName:e.name,current:t===Vt()})),"list")},update:{check:Va,auto:Ja,showToast:Ga},privacy:{get:Ce,set(t){return ka(t),Qt(document),Ce()},apply:a(()=>Qt(document),"apply"),identity:{get:De,set(t){return qo(t),Qt(document),Za(),De()}}},scheduleExport:{load:a(()=>jn("api"),"load"),run:a(t=>wl(t,"api",null,null),"run"),patch:no,image:{theme:Rn,build:a((t,e)=>Un(t,e),"build")},jsonFormat:{get:Br,set:Mo,validate:Ne,build(t,e){let r=na(t);if(e)return ia(r,Ne(e));let o=Br();return o.enabled?ia(r,o.mapping):pa(r)},buildDefault(t){return pa(na(t))}}}};function bp(){setTimeout(()=>{try{Ja()}catch{}},1800)}a(bp,"scheduleAutoUpdateCheck");try{No()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{so(),mp(),bp()}):(so(),mp(),bp())})();})();
