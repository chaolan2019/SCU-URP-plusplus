...
`;var Gp=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var Qp=`      /* 导航：顶栏、侧栏、面包屑（navigation） */
      /* 顶栏 —— 基于真实 DOM */
...
`;var Xp=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function ei(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(ei,"createCleanModeState");function ri(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(ri,"resetCleanModeData");function ai({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(k){p.catalog=p.catalog||[],p.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&ri(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let k=await n.ensureTermWeekResolved();!p.weekLocked&&k>=1&&(p.viewWeek=k)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(k){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(k){p.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}})(),(async()=>{let k=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),k=p.scores,n.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&n.enrichScoresWithEvaluation(k).then(()=>{p.scores===k&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(ai,"createCleanModeDataLoader");var ar={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},yc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},_r={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function pi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(pi,"calToday");function co(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(co,"calDayDiff");function uo(p,n){let c=co(ar[p].start,n);return c<0?0:Math.floor(c/7)+1}a(uo,"calWeekNo");function so(p){return yc[p]||""}a(so,"calLunar");function oi(p){return String(p||"").slice(5)}a(oi,"calYY");function vc(p){let n=p||pi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(vc,"calActiveTerm");function mo(p,n){let c=p&&ar[p]?p:"autumn",d=ar[c],u=n||pi(),k=d.events.map(f=>({e:f,d:co(u,f.start)})).filter(f=>f.d>=-0).sort((f,w)=>f.d-w.d)[0],P=k?co(u,k.e.start):null,S=uo(c,u),y=Math.max(0,Math.min(100,S/d.weeks*100)),A=u>=d.start;return{term:d,termId:c,next:k,daysLeft:P,weekNo:S,progress:y,started:A,today:u}}a(mo,"calStatus");function ii(p,n){let c=mo(p,n),d=c.next?_r[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(ii,"calendarSummaryHtml");function si(p,n){let c=mo(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(si,"calendarSummaryCompactHtml");function ni(p,n){let c=mo(p,n),d=c.next?_r[c.next.e.t].color:"#c9cdd4",u=c.term,k=Object.keys(ar).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${ar[w].name}</button>`).join(""),P=`<div class="cal-widget">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[w].map(C=>{let b=_r[C.t].color,m=C.end&&C.end!==C.start?"~"+oi(C.end):"",v=uo(c.termId,C.start)>0?`第 ${uo(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${A(C.start)}">
          <span class="cal-ev-dot" style="background:${b}"></span>
          <span class="cal-ev-date">${oi(C.start)}${m||""}<em>${so(C.start)||"&nbsp;"}</em></span>
  ...
  </div>`}a(ni,"calendarModalHtml");function li(p,n){let c=typeof document<"u"?document:null;if(!c)return;lo();let d=p&&ar[p]?p:vc(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${ni(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>lo()),u.addEventListener("click",k=>{let P=k.target;if(P&&P.closest&&P.closest(".cal-close")){lo();return}let S=P&&P.closest?P.closest("[data-cal-term]"):null;if(S){let y=u.querySelector(".cal-body");y&&(y.innerHTML=ni(S.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(A=>A.classList.toggle("ac",A.dataset.calTerm===S.dataset.calTerm))}})}a(li,"openCalendarModal");function lo(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(lo,"closeCalendarModal");function ci(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),li())})}a(ci,"bindCalendarOpen");var oa=!1;function ho(){let p=typeof document<"u"?document:null;if(!p||oa)return oa;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${q?"":" hidden"}>${k()}</div>
      ...
      </div>${(()=>{try{return si()}catch{return""}})()}</div></div>
    ...
    `,P.appendChild(f);let w=P.querySelector("#warningInfo");w&&document.body.appendChild(w),S.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let T=f.querySelector("#urppp-stats"),C=Math.max(A.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',T.appendChild(E)}function b(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&(T.innerHTML="",x.forEach(E=>{let q=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),I=q[0]||"",L=q.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),M=/[\u4e00-\u9fa5]/.test(I)||I.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=p.statCardPrivacyMarkup(I,L);G.innerHTML=`<div class="${M}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,T.appendChild(G)}))}if(a(b,"updateStats"),b(),y){let x=new MutationObserver(()=>b());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let m=f.querySelector("#urppp-left"),v=f.querySelector("#urppp-right");u(S[5],m,"我的日程安排"),u(S[0],v,"通知公告"),u(S[1],v,"我的待办任务"),u(S[2],v,"可申请业务"),u(S[3],v,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(k,"rebuildDashboard"),{rebuildDashboard:k,refreshHomeFullCalendar:c,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(gi,"createDashboardController");function ye(p){return Math.round((Number(p)||0)*100)/100}a(ye,"round2");var wc=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],fi={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},kc=[{key:"required",label:"必修",test:a(p=>/必修/.test(p),"test")},{key:"elective",label:"任选",test:a(p=>/任选/.test(p),"test")},{key:"optional",label:"选修",test:a(p=>/选修/.test(p),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function xi(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d+)/);return n?`${n[1].slice(2)}-${n[2].slice(2)}-${n[3]}`:String(p||"")}a(xi,"shortTerm");function na({deps:p}){let n=p.scoreToNumber,c=p.scoreToGpa;function d(b){let m=n(b);if(m!=null)return m;let v=String(b||"").trim().toUpperCase();return fi[v]!=null?fi[v]:null}a(d,"scoreToNumberWithLevels");function u(b){return!b||b.unevaluated?!1:d(b.score)!=null}a(u,"hasScore");function k(b){let m=String(b||"").match(/^(\d{4})-(\d{4})-(\d+)/);return m?[Number(m[1]),Number(m[3])]:[9999,9999]}a(k,"termOrderKey");function P(b){let m=b&&b.passing&&b.passing[0];return m&&m.courses||[]}a(P,"allCourses");function S(b){let m=b&&b.officialGpa,v=Number(m);return m!=null&&Number.isFinite(v)&&v>=0&&v<=5?v:null}a(S,"officialGpa");function y(b){let m=S(b);return m??c(b.score)}a(y,"courseGpa");function A({scorePack:b,profile:m}){let v=P(b),x=m&&m.majorGpa?String(m.majorGpa).trim():"",E=0,q=0,I=0,L=0,O=0,M=0;return v.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,q+=U*G;let et=y(H);et!=null&&(I+=et*G,L+=G,H.required&&(O+=et*G,M+=G))}),{majorGpa:x,requiredGpa:ye(M?O/M:0),avgGpa:ye(L?I/L:0),avgScore:ye(E?q/E:0),totalCredit:ye(E),courseCount:v.length}}a(A,"computeMetrics");function f(b){let m=new Map;return(b||[]).forEach(v=>{if(!u(v))return;let x=v.term||"未分组",E=m.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},m.set(x,E));let q=Number(v.credit)||0,I=d(v.score);if(I==null||(E.count+=1,q<=0))return;E.credit+=q,E.scoreW+=I*q;let L=y(v);L!=null&&(E.gpaW+=L*q,E.gpaCredit+=q)}),Array.from(m.values()).map(v=>({term:v.term,label:xi(v.term),count:v.count,credit:ye(v.credit),avgScore:ye(v.credit?v.scoreW/v.credit:0),avgGpa:ye(v.gpaCredit?v.gpaW/v.gpaCredit:0)})).sort((v,x)=>{let E=k(v.term),q=k(x.term);return E[0]-q[0]||E[1]-q[1]})}a(f,"computeTrend");function w(b){let m=wc.map(x=>({...x,count:0,credit:0}));(b||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let q=m.find(I=>E>=I.min&&E<=I.max);q&&(q.count+=1,q.credit+=Number(x.credit)||0)});let v=m.reduce((x,E)=>Math.max(x,E.count),1);return m.map(x=>({...x,ratio:Math.round(x.count/v*100)}))}a(w,"computeBands");function T(b){let m=kc.map(q=>({...q,credit:0,count:0}));(b||[]).forEach(q=>{if(!u(q))return;let I=String(q.attr||""),L=m.find(O=>O.test(I));L&&(L.credit+=Number(q.credit)||0,L.count+=1)});let v=m.reduce((q,I)=>q+I.credit,0)||1,x=m.filter(q=>q.count>0).map(q=>({key:q.key,label:q.label,credit:ye(q.credit),count:q.count,ratio:Math.round(q.credit/v*100)})),E=x.find(q=>q.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a(T,"computeShare");function C({scorePack:b,profile:m}){let v=P(b);return{metrics:A({scorePack:b,profile:m}),trend:f(v),bands:w(v),share:T(v),empty:v.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:S,scoreToNumberWithLevels:d,shortTerm:xi}}a(na,"createScoreAnalysisData");var ne="var(--text-secondary)",go="var(--border)";function pe(p){return at(String(p??""))}a(pe,"escapeLabel");function yi(p,n,c){let d=!!(p&&p.variant==="mobile");if(n==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},S=Math.max(56,Number(p&&p.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,c)*S),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},k=Math.max(44,Number(p&&p.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,c)*k),height:236,pad:u}}a(yi,"resolveChartLayout");function bo({width:p,height:n,mobile:c,kind:d,label:u}){let k=c?` data-urppp-chart-layout="mobile" style="width:max(100%,${p}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${p} ${n}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${k}>`}a(bo,"openSvg");function pa({trend:p,palette:n,layout:c}){let d=(p||[]).filter(rt=>rt&&rt.avgScore!=null),u=yi(c,"trend",d.length),{width:k,height:P,pad:S,mobile:y}=u,A=k-S.left-S.right,f=P-S.top-S.bottom;if(!d.length)return`${bo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let w=d.length,T=a(rt=>S.left+(rt+.5)*(A/w),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),b=d.map(rt=>Number(rt.avgScore)||0),m=d.map(rt=>Number(rt.credit)||0),v=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...b)-4),q=Math.min(100,Math.max(...b)+4),I=Math.max(1,...m),L=x-v||1,O=q-E||1,M=a(rt=>S.top+f-(rt-v)/L*f,"yGpa"),H=a(rt=>S.top+f-(rt-E)/O*f,"yScore"),G=a(rt=>S.top+f-rt/I*f*.9,"yCredit"),U=d.map((rt,st)=>`${T(st)},${M(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${T(st)},${H(rt.avgScore)}`).join(" "),it=[0,.25,.5,.75,1].map(rt=>{let st=S.top+f-rt*f;return`<line x1="${S.left}" y1="${st.toFixed(1)}" x2="${k-S.right}" y2="${st.toFixed(1)}" stroke="${go}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),mt=d.map((rt,st)=>{let ft=T(st),Z=y?Math.min(30,A/w*.42):Math.min(26,A/w*.32),dt=G(rt.credit);return`<rect x="${(ft-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(S.top+f-dt).toFixed(1)}" rx="3" fill="${n.credit}" opacity="0.55"/>
...
<g>${V}</g>
${ct}
</svg>`}a(pa,"trendChartSvg");function ia({bands:p,palette:n,layout:c}){let d=p||[],u=yi(c,"bands",d.length),{width:k,height:P,pad:S,mobile:y}=u,A=k-S.left-S.right,f=P-S.top-S.bottom,w=d.length||1,T=Math.max(1,...d.map(m=>m.count)),C=y?Math.min(32,A/w*.62):Math.min(40,A/w*.52),b=d.map((m,v)=>{let x=S.left+(v+.5)*(A/w),E=m.count?Math.max(8,m.count/T*f):0,q=S.top+f-E,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=m.range||(m.min===0?"<60":`${m.min}-${m.max===100?"100":m.max}`),O=[`${m.level||""}（绩点 ${m.gpa}）`,`百分制 ${L}`,`课程 ${m.count} 门`].join(`
...
<text x="75" y="91" text-anchor="middle" font-size="11.5" fill="${ne}">必修学分占比</text>
</svg>`}a(vi,"donutSvg");var Ac=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),Sc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',_c='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function wi({deps:p}){let n=p&&p.palette||Ac;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
  <button type="button" class="urppp-sa-toggle" aria-expanded="false">
    ...
    <span class="urppp-sa-chevron">${_c}</span>
  </button>
...
<div class="urppp-sa-grid">
  ...
  <section class="urppp-sa-card urppp-sa-share">
    ...
    <div class="urppp-sa-share-body">
      <div class="urppp-sa-donut">${vi({items:w.items,requiredRatio:w.requiredRatio,palette:n})}</div>
...
<div class="urppp-sa-grid">
  ...
  `;function S(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(S,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function A(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(A,"cleanupPageLoadingOverlays");function f(t){try{let e=t&&t.querySelectorAll?t:document;A(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let s=S("");s.style.minHeight="0",s.style.padding="0",r.parentElement&&r.parentElement.replaceChild(s,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=S("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(f,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{f(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",b="urppp_scheme_v1",m="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",M="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:ft,syncThemeDotGroup:Z}=Ci({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Kt,getAccent:Qt,getBrutalActivePalette:So,getBrutalPaletteById:pr,getBrutalSelectedPalette:Ao,getCurrent:Jt,getScheme:Me,getSkin:Zt,isThemeModeAvailable:or,setBrutalPalette:_o,skinSupportsDark:Ie,skinSupportsDynamic:Ne,skinSupportsFixedPalettes:ko},settings:{ensureSettingsPanel:Ko,openSettingsPanel:Yo,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),s=document.getElementById("clickdiv"),i=document.getElementById("form-search");if(!o){let D=document.createElement("li");D.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",D.appendChild(o),r.appendChild(D)}let l=o.closest("li")||o.parentElement,g=Array.from(r.children).find(D=>{let R=D.querySelector(":scope > a");if(!R)return!1;let B=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return B.includes("customerServiceCenter")||/help|service|support/i.test(B)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),h=Array.from(r.children).find(D=>D.classList.contains("light-blue")),_=g||h||null;_&&l&&_!==l&&((l.compareDocumentPosition(_)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,_)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let $=l;s?(s.removeAttribute("onclick"),s.setAttribute("role","button"),s.setAttribute("aria-label","搜索功能")):(s=document.createElement("button"),s.type="button",s.id="clickdiv",s.setAttribute("aria-label","搜索功能"),s.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(s)),s.style.setProperty("left","8px","important"),s.style.setProperty("position","relative","important"),s.style.setProperty("z-index","31","important"),i||(i=document.createElement("div"),i.id="form-search",i.className="nav-search",i.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),$&&i.parentElement!==$&&$.appendChild(i),$&&$.style.setProperty("position","relative","important"),i.classList.add("urppp-desktop-search"),i.style.setProperty("position","absolute","important"),i.style.setProperty("top","50%","important"),i.style.setProperty("right","24px","important"),i.style.setProperty("left","auto","important"),i.style.setProperty("transform","translateY(-50%)","important"),i.style.setProperty("width",i.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),i.style.setProperty("max-width","calc(100vw - 24px)","important"),i.style.setProperty("opacity",i.dataset.open==="1"?"1":"0","important"),i.style.setProperty("pointer-events",i.dataset.open==="1"?"auto":"none","important"),i.style.setProperty("z-index","1200","important"),i.style.setProperty("margin","0","important"),i.style.setProperty("background","transparent","important"),i.style.setProperty("border","0 solid transparent","important"),i.style.setProperty("box-shadow","none","important"),i.style.setProperty("overflow","visible","important"),i.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let j=i.querySelector("#search-input"),z=i.querySelector("form");if(!j||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let F=i.querySelector(".input-icon");F&&(F.style.setProperty("display","block","important"),F.style.setProperty("position","relative","important")),j.style.setProperty("display","block","important"),j.style.setProperty("width","100%","important"),j.style.setProperty("height","36px","important"),j.style.setProperty("box-sizing","border-box","important"),j.style.setProperty("padding","0 12px","important"),j.style.setProperty("border","1px solid var(--border)","important"),j.style.setProperty("border-radius","var(--radius-sm)","important"),j.style.setProperty("background","var(--input-bg)","important"),j.style.setProperty("color","var(--text)","important");let J=a(D=>{i.dataset.open=D?"1":"0",i.style.setProperty("width",D?"min(240px, calc(100vw - 24px))":"0px","important"),i.style.setProperty("opacity",D?"1":"0","important"),i.style.setProperty("pointer-events",D?"auto":"none","important"),s.setAttribute("aria-expanded",D?"true":"false"),D&&setTimeout(()=>j.focus(),30)},"setOpen");s.__urpppSearchBound||(s.__urpppSearchBound=!0,s.addEventListener("click",D=>{D.preventDefault(),D.stopImmediatePropagation(),J(i.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",D=>{let R=document.getElementById("form-search"),B=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(D.target)||B?.contains(D.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function N(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),s=Math.min(t,e,r),i=0,l=0,g=(o+s)/2;if(o!==s){let h=o-s;switch(l=g>.5?h/(2-o-s):h/(o+s),o){case t:i=(e-r)/h+(e<r?6:0);break;case e:i=(r-t)/h+2;break;default:i=(t-e)/h+4;break}i/=6}return{h:i*360,s:l,l:g}}a(N,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,s=o*(1-Math.abs(t/60%2-1)),i=r-o/2,l=0,g=0,h=0;return t<60?(l=o,g=s):t<120?(l=s,g=o):t<180?(g=o,h=s):t<240?(g=s,h=o):t<300?(l=s,h=o):(l=o,h=s),{r:Math.round((l+i)*255),g:Math.round((g+i)*255),b:Math.round((h+i)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:s,b:i}=Y(t,e,r);return xr(o,s,i)}a(tt,"hslHex");function bt(t){let{r:e,g:r,b:o}=Ze(Gt(t)||mt),s=N(e,r,o);return s.s<.12&&(s.s=.18),s}a(bt,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,s=Math.max(0,Math.min(.95,e));return tt(t,s,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Gt(t)||mt,{h:r,s:o}=bt(e),s=Ft(r),i=Math.min(.72,Math.max(.28,o*.78));return ht(s,i,42)}a(Pt,"companionColor");function It(t,e){let r=Gt(t)||mt,{h:o,s}=bt(r),l=zt(e||ot),g=Math.min(.92,Math.max(.35,s*l.chroma)),h=Pt(r),{h:_}=bt(h),$=ht(o,g,l.primaryTone),j=ht(o,g,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),F,J,D;l.whiteCard?(F=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",D="#E5E7EB"):l.duo?(F=Bt(yt(h,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),D=Bt("#E5E7EB",h,.16)):(F=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),D=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?h:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),B=ht(o,Math.min(.45,g*.55),14),K=xe(ht(o,g*.3,34),.88),ut=xe(ht(o,g*.22,46),.76),vt=xe($,.18),Et="0 4px 12px "+xe($,.1)+", 0 1px 2px "+xe($,.05);return{"--bg":F,"--surface":J,"--text":B,"--text-secondary":K,"--text-muted":ut,"--border":D,"--border-focus":$,"--input-bg":R,"--primary":$,"--primary-hover":j,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":h}}a(It,"buildMaterialSchemeVars");function Kt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Kt,"buildSchemePreview");function Te(t){let e=Gt(t)||Qt()||mt;return X.map(r=>Object.assign({},r,Kt(e,r.id)))}a(Te,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Qt(){return Gt(GM_getValue(T,""))||""}a(Qt,"getAccent");function Me(){let t=String(GM_getValue(b,ot)||ot);return X.some(e=>e.id===t)?t:ot}a(Me,"getScheme");function sa(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(b,e),e}a(sa,"setScheme");function Pi(t,e){if(!t)return;let r=Gt(t);if(r){if(GM_setValue(T,r),e&&e.scheme&&sa(e.scheme),e&&e.skipTheme){let o=Ka(r,.15),s=xe(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",s);try{ft()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{ft()}catch{}try{Dt()}catch{}}}a(Pi,"applyAccent");function la(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(la,"getAccentPresets");function zi(t){let e=Gt(t||Qt()||mt);if(!e)return la();let r=la();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(zi,"saveAccentPreset");function Xt(){try{return!!GM_getValue(m,!1)}catch{return!1}}a(Xt,"isThemeFollowSystem");function Er(t){return GM_setValue(m,!!t),!!t}a(Er,"setThemeFollowSystem");function ca(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(ca,"isCleanDefault");function Li(t){return GM_setValue(v,!!t),!!t}a(Li,"setCleanDefault");function da(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(da,"isCleanAnalysisDirect");function qi(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(qi,"setCleanAnalysis");function ve(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(ve,"isAppleEdgeLine");function Ti(t){return GM_setValue(E,!!t),!!t}a(Ti,"setAppleEdgeLine");function ua(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(ua,"isAutoUpdateCheck");function Mi(t){return GM_setValue(c,!!t),!!t}a(Mi,"setAutoUpdateCheck");function Cr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(Cr,"readJsonSetting");function Pr(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(Pr,"writeJsonSetting");function we(){return no(Cr(O,null))}a(we,"getPrivacySettings");function ma(t){return Pr(O,no(t))}a(ma,"setPrivacySettings");function $e(){return Sr(Cr(M,null))}a($e,"getCustomIdentity");function fo(t){return Pr(M,Sr(t))}a(fo,"setCustomIdentity");function ha(){let t=Cr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ha,"getScheduleFirstMondayMap");function xo(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ha();r[String(t)]=String(e),Pr(H,r)}a(xo,"rememberScheduleFirstMonday");function zr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=Cr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},s={enabled:!!o.enabled,mapping:qe(o.mapping||wr)};return et="",s}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:qe(wr)}}}a(zr,"getScheduleJsonFormatSettings");function yo(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:qe(e.mapping||wr)};return et="",Pr(G,r)}a(yo,"setScheduleJsonFormatSettings");function vo(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(vo,"isHomePage");function Lr(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(Lr,"isFollowUseDynamic");function ba(t){return GM_setValue(q,!!t),!!t}a(ba,"setFollowUseDynamic");function $i(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a($i,"systemPrefersDark");function me(){return $i()&&Ie()?"dark":Lr()&&Ne()?"scu-red":"default"}a(me,"resolveFollowThemeName");function or(t,e){return t==="dark"?Ie(e):t==="scu-red"?Ne(e):t==="default"}a(or,"isThemeModeAvailable");function Wt(t,e){e=e||{},!Ie()&&Xt()&&Er(!1),!Ne()&&Lr()&&ba(!1),e.manual&&Er(!1);let r;e.system||Xt()&&!e.manual?r=me():(r=Ct[t]?t:Jt()||"default",Ct[r]||(r="default")),or(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(w,r),ue();let s=document.getElementById("urppp-theme-vars")||(()=>{let _=document.createElement("style");return _.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(_),_})(),i=Qt(),l=Object.assign({},o.vars);if(r==="scu-red"){let _=i||mt,$=Me();l=Object.assign(l,It(_,$));let j=l["--primary"]||_,z=l["--primary-hover"]||Ka(j,.12);document.documentElement.style.setProperty("--urppp-accent",j),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||xe(j,.15)),document.documentElement.style.setProperty("--urppp-seed",_),document.documentElement.style.setProperty("--urppp-scheme",$)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let g=":root {";for(let[_,$]of Object.entries(l))g+=`${_}:${$};`;g+="}",s.textContent=g,document.body&&(document.body.style.fontFamily=o.font);try{let _=document.documentElement;_.dataset.urpppTheme=r,_.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),_.classList.add("urppp-theme-"+r),_.classList.toggle("urppp-theme-follow",Xt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Xt()))}catch{}try{ee()}catch{}try{ft()}catch{}try{Dt()}catch{}try{Oo()}catch{}try{Ui()}catch{}let h=document.getElementById("urppp-boot-loader");h&&(h.style.fontFamily=o.font)}a(Wt,"applyTheme");function Jt(){return GM_getValue(w,"default")}a(Jt,"getCurrent");function he(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(he,"themeDownloaded");function nr(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(nr,"localThemes");function Ii(t,e){try{let r=nr();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Ii,"saveLocalTheme");function Ni(t){try{let e=nr();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(Ni,"removeLocalTheme");function ga(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(ga,"storeThemeStyleEl");function Bi(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(Bi,"removeStoreThemeStyle");function wo(){u.forEach(t=>{let e="urppp_theme_css_"+t.id,r="";try{r=GM_getValue(e,"")||""}catch{}r&&(ga(t.id).textContent=r);let o="";try{o=GM_getValue("urppp_card_css_"+t.id,"")||""}catch{}o&&Oe([{id:t.id,cardCss:o}])});try{ee()}catch{}}a(wo,"injectAllStoreThemeStyles");function Zt(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||he(e.id))||nr()[t]&&he(t)?t:"apple"}a(Zt,"getSkin");function fa(t,e){let r=t||Zt(),o=u.find(s=>s.id===r);return!!(o&&o[e])}a(fa,"getSkinCapability");function Ie(t){return fa(t,"dark")}a(Ie,"skinSupportsDark");function Ne(t){return fa(t,"dynamic")}a(Ne,"skinSupportsDynamic");function ko(t){return fa(t,"palettes")}a(ko,"skinSupportsFixedPalettes");function pr(t){return Q.find(e=>e.id===t)||Q[0]}a(pr,"getBrutalPaletteById");function Ao(){let t=String(GM_getValue(I,"acid")||"acid"),e=pr(t);return e.id===V?pr("acid"):e}a(Ao,"getBrutalSelectedPalette");function So(){let t=String(GM_getValue(L,V)||V);return pr(t)}a(So,"getBrutalActivePalette");function _o(t,e){let r=e||{},o=pr(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{ee()}catch{}try{ft()}catch{}try{Dt()}catch{}try{let s=document.getElementById("urppp-clean-root");s&&typeof s.__syncCleanThemeDots=="function"&&s.__syncCleanThemeDots()}catch{}}a(_o,"setBrutalPalette");function Fi(t){let e=t||Zt();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&ve()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&ve()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Fi,"getSkinShapeOverrides");function Be(){try{let t=Zt();if(t==="apple")return ve()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Be,"urpppCardBorderValue");function ee(){let t=Zt();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&ve();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let i=document.createElement("style");return i.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(i),i})(),r=Fi(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(i=>{o+=i+":"+r[i]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let i=So();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+i.accent+";--brutal-secondary:"+i.secondary+";--brutal-info:"+i.info+";--brutal-warning:"+i.warning+";}"}e.textContent=o;return}if(t==="apple"){let i=ve(),l=i?"1px solid rgba(0,0,0,0.08)":"none",g=i?"1px solid rgba(255,255,255,0.10)":"none",h=i?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(i?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(i?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+g+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(i?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+h+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let s=document.head||document.documentElement;e.parentNode===s&&s.lastElementChild!==e&&s.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Yt(document)}catch{}},0)}a(ee,"applySkinAttr");function Eo(t){let e=u.find(s=>s.id===t&&s.ready&&(s.installed!==!1||he(s.id))),r=!e&&nr()[t]&&he(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||ba(!1),!o.dark&&Xt()&&Er(!1);let s=Xt(),i=s?me():Jt(),l=or(i,e.id)?i:"default";ee(),Wt(l,{system:s})}catch{try{ee()}catch{}}try{Dt()}catch{}try{ft()}catch{}try{let s=document.getElementById("urppp-clean-root");s&&typeof s.__syncCleanThemeDots=="function"&&s.__syncCleanThemeDots()}catch{}return!0}a(Eo,"setSkin");function Di(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Xt())try{Wt(me(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(Di,"bindSystemThemeListener");try{Xt()?Wt(me(),{system:!0}):Wt(Jt())}catch{}try{ee()}catch{}try{Di()}catch{}function ji(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let s=e.match(o);if(s)return s[0].trim()}return""}a(ji,"extractLoginErrorMessage");function Co(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(Co,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=ji(e),s=r.querySelector('a[onclick*="toModifyPwd"]'),i=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let g=location.pathname==="/loginEn",h=a((R,B)=>g?B:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      </div>`,Zo(t),an(t),ls(t),qa(t),Fr(t.querySelector("#urppp-theme-manage"))}a(ss,"renderThemeStoreBody");function ls(t){let e=t.querySelector("[data-add-local-theme]"),r=t.querySelector("[data-local-theme-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let s=await o.text(),i=s.match(/html\[data-urppp-skin="([\w-]+)"\]/);if(!i){alert('未能从 CSS 中识别主题 id（需要 html[data-urppp-skin="…"]）'),r.value="";return}let l=i[1];try{GM_setValue("urppp_theme_css_"+l,s)}catch{}Ii(l,{name:l,desc:"本地主题",author:"本地",version:"1.0.0"});try{ga(l).textContent=s}catch{}r.value="";try{Fr(t.querySelector("#urppp-theme-manage"))}catch{}}))}a(ls,"bindLocalThemeImport");function cs(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
...
`).trim()}a(pn,"extractChangelogRange");function sn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(sn,"ensureUpdateToastStyles");function fs(t){let e=String(t||"").replace(/\r\n/g,`
...
`),s=[],i=!1,l=a(()=>{i&&(s.push("</ul>"),i=!1)},"closeList");for(let g=0;g<o.length;g++){let _=o[g].replace(/\s+$/,"");if(!_.trim()){l();continue}let $=_.match(/^(#{2,3})\s+(.+)$/);if($){l();let z=$[1].length,F=$[2];s.push(z===2?`<h2>${r(F)}</h2>`:`<h3>${r(F)}</h3>`);continue}let j=_.match(/^[-*]\s+(.+)$/);if(j){i||(s.push("<ul>"),i=!0),s.push(`<li>${r(j[1])}</li>`);continue}l(),s.push(`<p>${r(_)}</p>`)}return l(),s.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(fs,"renderChangelogMarkdown");function ln(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(s=>{s&&s.target!==e||s&&s.propertyName&&s.propertyName!=="opacity"&&s.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(ln,"hideUpdateToast");function xs(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(s=>{s&&s.target!==e||s&&s.propertyName&&s.propertyName!=="opacity"&&s.propertyName!=="background-color"&&s.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(xs,"hideChangelogModal");function cn(t,e){sn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,r.addEventListener("click",o=>{(o.target===r||o.target&&o.target.getAttribute&&o.target.getAttribute("data-close")==="1")&&xs(r)}),document.documentElement.appendChild(r)),r.querySelector("h3").textContent=t||"更新日志",r.querySelector(".uuc-body").innerHTML=e||'<p class="uuc-meta">暂无更新日志</p>',r.__closing=!1,r.classList.remove("open","closing"),r.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add("open"))})}a(cn,"openChangelogModal");function Ia(t){sn();let e=document.getElementById("urppp-update-toast");e||(e=document.createElement("div"),e.id="urppp-update-toast",e.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>ln(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let s=o.getAttribute("data-act"),i=e.__pack||{};if(s==="later"){ln(e);return}if(s==="go"){let l=i.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(s==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=i.changelogMd;l||(l=await Ma(n.sourceUrls("CHANGELOG.md")),i.changelogMd=l);let g=pn(l,i.local,i.remote),h=g?fs(g):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';cn("更新日志 "+i.local+" → "+i.remote,h)}catch(l){cn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(Ia,"showUpdateToast");async function Na(){if(ua()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await $a();t&&t.status==="update"&&Ia(t);let e=await ys();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Na,"maybeAutoCheckUpdate");function ys(){let t=(window.__urpppUpdateCheckers||He||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?_t.update("assist"):null).catch(()=>null)}a(ys,"hotUpdateAssist");async function Ba(){if(Ta)return;Ta=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Se("正在从多源检查更新…");try{let e=[$a()];(He||[]).forEach(h=>{h&&typeof h.check=="function"&&e.push(Promise.resolve().then(()=>h.check()).then(_=>_||{id:h.id||"extra",name:h.name||"扩展",status:"err",message:"无结果"}).catch(_=>({id:h.id||"extra",name:h.name||"扩展",status:"err",message:String(_&&_.message||_)})))});let r=await Promise.all(e),o=r.map(h=>{if(!h)return"";if(h.status==="err")return`• <b>${at(h.name||h.id)}</b>：检查失败（${at(h.message||"unknown")}）`;if(h.status==="update"){let _="";if(h.id==="assist"&&_t&&_t.loaded("assist"))_=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let $=h.updateUrl?` <a href="${at(h.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",j=h.pageUrl?` <a href="${at(h.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";_=$+j}return`• <b>${at(h.name)}</b>：发现新版本 <b>${at(h.remote)}</b>（当前 ${at(h.local)}）${_}`}return h.status==="ahead"?`• <b>${at(h.name)}</b>：本地 ${at(h.local)} 新于远程 ${at(h.remote)}`:`• <b>${at(h.name)}</b>：已是最新（${at(h.local)}）`}).filter(Boolean),s=r.some(h=>h&&h.status==="update"),i=r.some(h=>h&&h.status==="err");Se(`${s?"检查完成：发现更新":i?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,i?"err":"ok");let g=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');g&&g.addEventListener("click",()=>{try{Se("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{Se("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(h=>{Se("重新装载失败："+(h&&h.message?h.message:h),"err")})}catch(h){Se("重新装载失败："+(h&&h.message?h.message:h),"err")}})}catch(e){Se("检查失败："+at(e&&e.message||e),"err")}finally{Ta=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(Ba,"checkForUpdates");function dn(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+p,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(dn,"refreshUpdateStatusHint");function vs(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=He.findIndex(s=>s&&s.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?He[r]=o:He.push(o);try{let s=document.getElementById("urppp-set-update-status");s&&o.localVersion&&e==="assist"&&s.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{dn()}catch{}return!0}a(vs,"registerUpdateChecker");function ws(){let t={version:p,urls:n,check:Ba,checkMain:$a,registerChecker:vs,compareVersions:yr,parseUserscriptVersion:to,extractChangelogRange:pn,showUpdateToast:Ia,maybeAutoCheckUpdate:Na,listCheckers:a(()=>He.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(ws,"publishUpdateApi"),ws();let{rebuildSidebarCompletely:un,syncMobileContentOffset:Re,syncSidebarUnderNavbar:_e}=Ei({}),{rebuildDashboard:ks}=gi({deps:{statCardPrivacyMarkup:Cs}}),As="urppp-clean-open",Fa={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ie(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ie,"isUnevaluatedScore");function Dr(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Dr,"isValidOfficialGpa");function jr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(jr,"firstContentChar");function Da(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Da,"weekBitmapActive");function Ue(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ie(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Fa[o]!=null?Fa[o]:Fa[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ue,"scoreToGpa");function We(t){let e=String(t||"").trim();if(!e||ie(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(We,"scoreToNumber");function Ee(t){return Math.round((Number(t)||0)*100)/100}a(Ee,"round2");function mn(t){return/必修/.test(String(t||""))}a(mn,"isRequiredAttr");function re(t){let e=0,r=0,o=0,s=0,i=0,l=0,g=0,h=0;return(t||[]).forEach(_=>{if(_&&(_.unevaluated||ie(_.score)))return;let $=Number(_.credit)||0,j=We(_.score),z=Dr(_.officialGpa)?Number(_.officialGpa):Ue(_.score);j==null||$<=0||(e+=$,r+=j*$,z!=null&&(o+=z*$,s+=$),_.required&&(i+=$,l+=j*$,z!=null&&(g+=z*$,h+=$)))}),{totalCredit:Ee(e),avgScore:Ee(e?r/e:0),avgGpa:Ee(s?o/s:0),requiredCredit:Ee(i),requiredGpa:Ee(h?g/h:0),requiredAvg:Ee(i?l/i:0),count:(t||[]).length}}a(re,"summarizeCourses");function ja(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(ja,"absUrl");function Vt(t,e){let r=ja(t),o=e&&e.method||"GET",s=e&&e.data||null;return new Promise((i,l)=>{let g=a((h,_)=>h?i(_):l(new Error(_||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:s||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(h=>{h.status>=200&&h.status<400?g(!0,h.responseText||""):g(!1,"HTTP "+h.status)},"onload"),onerror:a(()=>g(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:s||void 0}).then(h=>{if(!h.ok)throw new Error("HTTP "+h.status);return h.text()}).then(h=>g(!0,h)).catch(h=>g(!1,h&&h.message))})}a(Vt,"fetchText");function Or(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Or,"parseHtml");function hn(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=Up,(document.head||document.documentElement).appendChild(t)}a(hn,"ensureFeatureStyles");function Ss(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=Jp,(document.head||document.documentElement).appendChild(t)}a(Ss,"ensureScheduleExportStyles");function _s(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=Vp,(document.head||document.documentElement).appendChild(t)}a(_s,"ensureSettingsStyles");function bn(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let s=r.cloneNode(!0);s.querySelectorAll("small, i, img, b, .badge").forEach(g=>g.remove());let i=(s.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(g=>{g.nodeType===Node.TEXT_NODE&&g.textContent.trim()&&g.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=i||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(bn,"ensureNavNameTarget");function Hr(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Hr,"classifyPrivacyLabel");function Es(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(Es,"classifyHomeDataKey");function Rr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Rr,"homePrivateValueSpan");function Cs(t,e){let r=at(t),o=at(e),s=Es(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[s]||Hr(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:Rr("organization",s,o)}:{valueHtml:Rr("organization",s,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let g=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&g){let _=g.index||0,$=String(e).slice(0,_),j=String(e).slice(_+g[0].length);return{valueHtml:r,labelHtml:`${at($)}${Rr(l,s,at(g[0]))}${at(j)}`}}return{valueHtml:Rr(l,s,r),labelHtml:o}}a(Cs,"statCardPrivacyMarkup");function Ce(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||Ar;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||Ar)}a(Ce,"privacyReplacement");function dr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(dr,"markPrivateText");function gn(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||Ar);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(gn,"markPrivateAvatar");function Ps(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(Ps,"markPrivateBlock");function zs(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(zs,"markDirectEditable");let ge=null;function fn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;ge&&ge.__finish&&ge.__finish(!1);let r=we();if(r.mode!=="custom"||!r.directEdit.enabled)return;let s=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),i=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),g=i.height>=8||!l?i:{left:i.left,top:l.top,width:Math.max(i.width,40),height:l.height},h=document.createElement("input"),_=getComputedStyle(t),$=Math.min(Math.max(g.width+64,140),Math.max(140,window.innerWidth-24)),j=Math.min(Math.max(12,g.left),Math.max(12,window.innerWidth-$-12)),z=Math.min(Math.max(12,g.top+(g.height-36)/2),Math.max(12,window.innerHeight-48));h.type="text",h.maxLength=80,h.className="urppp-direct-edit-input",h.value=s,h.setAttribute("aria-label","修改"+U[e]+"显示值"),h.style.left=j+"px",h.style.top=z+"px",h.style.setProperty("--urppp-direct-edit-width",$+"px"),h.style.fontFamily=_.fontFamily,h.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(_.fontSize)||14)))+"px";let F=!1,J=a(D=>{if(F||(F=!0,h.remove(),ge===h&&(ge=null),D))return;let R=we();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(h.value||"").trim().slice(0,80),ma(R),Yt(document),Wa(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");h.__finish=J,h.addEventListener("click",D=>D.stopPropagation()),h.addEventListener("blur",()=>J(!1)),h.addEventListener("keydown",D=>{D.key==="Enter"&&(D.preventDefault(),J(!1)),D.key==="Escape"&&(D.preventDefault(),J(!0))}),document.documentElement.appendChild(h),ge=h,h.focus(),h.select()}a(fn,"openDirectEditInput");function Ls(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),fn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),fn(e))},!0))}a(Ls,"bindDirectEditInteraction");function qs(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(qs,"clearPrivacyDisplay");function xn(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(xn,"applyCustomText");function Ts(t){let e=t&&t.querySelectorAll?t:document,r=$e(),s=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?bn(e):null);xn(s,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(g=>{let h=g.querySelector(".profile-info-name"),_=g.querySelector(".profile-info-value");!h||!_||String(h.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||xn(_,r.nameEnabled,r.name)});let i=rr(r.avatar),l=r.avatarEnabled&&!!i;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(g=>{let h=g.getAttribute("src")||"";h&&h!==g.__urpppAppliedCustomSrc&&(g.__urpppOriginalSrc=h),l?(g.__urpppOriginalSrc==null&&(g.__urpppOriginalSrc=h),h!==i&&g.setAttribute("src",i),g.__urpppAppliedCustomSrc=i):g.__urpppAppliedCustomSrc!=null&&(g.__urpppOriginalSrc&&g.setAttribute("src",g.__urpppOriginalSrc),delete g.__urpppAppliedCustomSrc)})}a(Ts,"applyCustomIdentityDisplay");function Ms(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),s=r.querySelector(".profile-info-value, td:last-child");if(!o||!s||o===s)return;let i=Hr(o.textContent),l=Ce(e,i);l&&dr(s,l)})}a(Ms,"applyProfilePrivacy");function $s(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let s=o.map(i=>{let l=Hr(i.textContent);return["grade","gpa","credit"].includes(l)?l:""});s.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(i=>{let l=i.querySelectorAll("td");s.forEach((g,h)=>{let _=Ce(e,g);g&&_&&dr(l[h],_)})})})}a($s,"applyScoreTablePrivacy");function Is(t){let e=t&&t.querySelectorAll?t:document,r=we();if(r.mode==="off")return;let o=Ce(r,"name"),s=Ce(r,"avatar"),i=Ce(r,"schedule"),l=o?bn(e):e.querySelector?.(".urppp-user-name-value");o&&dr(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([_,$])=>{let j=Ce(r,$);j&&e.querySelectorAll(_).forEach(z=>dr(z,j))}),$s(e,r);let h=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(_=>{let $=_.getAttribute("data-urppp-private"),j=_.getAttribute("data-urppp-edit-key"),F=(h&&j?String(r.directEdit.values[j]||"").trim():"")||Ce(r,$);!["avatar","schedule"].includes($)&&F&&dr(_,F),h&&j&&zs(_,j)}),h&&Ls(),Ms(e,r),s&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(_=>{let $=_.matches("img")?_:_.querySelector("img");$?gn($,s):(_.classList.add("urppp-private-avatar-block"),_.setAttribute("data-urppp-private-mask",s))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(_=>gn(_,s))),i){let _=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));_.filter($=>!_.some(j=>j!==$&&j.contains($))).forEach($=>Ps($,i))}}a(Is,"applyPrivacyDisplay");let Oa=0,se=[];function yn(){let t=we(),e=$e();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(yn,"personalDisplayIsEnabled");function Ns(){se=se.filter(({root:t})=>t&&t.isConnected),se.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(Ns,"resumePersonalDisplayObservers");function Yt(t){let e=t||document;se.forEach(({observer:r})=>r.disconnect());try{hn()}catch{}try{qs(e)}catch{}try{Ts(e)}catch(r){console.warn("[URP++] custom identity",r)}try{Is(e)}catch(r){console.warn("[URP++] privacy",r)}yn()?(Ns(),Fs()):(clearTimeout(Oa),se=[])}a(Yt,"applyPersonalDisplay");function Bs(t){clearTimeout(Oa),Oa=setTimeout(()=>Yt(t||document),140)}a(Bs,"schedulePersonalDisplay");function Ha(){try{nt&&nt.open&&Xe()}catch{}}a(Ha,"refreshCleanPersonalDisplay");function Fs(){if(!yn()){se.forEach(({observer:t})=>t.disconnect()),se=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(se.some(r=>r.root===t))return;let e=new MutationObserver(()=>Bs(document));se.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(Fs,"bindPersonalDisplayObservers");function Ds(t){let e=Object.assign({},t||{}),r=$e();r.nameEnabled&&r.name&&(e.name=r.name);let o=rr(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(Ds,"personalizedProfile");let vn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",js="/student/courseSelect/thisSemesterCurriculum/callback",Os="/student/courseSelect/thisSemesterCurriculum/index";async function Hs(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Vt(js),r=JSON.parse(e),o=er(r);if(o)return o}catch{}return""}a(Hs,"resolveSchedulePlanCode");async function wn(t){let e=await Hs(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Vt(vn,r),s;try{s=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=er(s)),(!s.jcsjbs||!s.jcsjbs.length)&&e&&(s=JSON.parse(await Vt(vn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let i=An(s,e,t);if(!i.courses.length)throw new Error("没有读取到可导出的课表数据");return i}a(wn,"loadScheduleExportData");function Ra(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(Ra,"safeScheduleFilename");function Ua(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(Ua,"downloadBlob");function Rs(t){let e=Qr(t),r=zr(),o=r.enabled?Kr(e,r.mapping):Xr(e),s=JSON.stringify(o,null,2)+`
`;return Ua(new Blob([s],{type:"application/json;charset=utf-8"}),Ra(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(Rs,"exportScheduleJson");function kn(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let s=Number(r[4]);if(s<1||s>30)return"";let i=ao(new Date);return i.setDate(i.getDate()-(s-1)*7),kr(i)}a(kn,"deriveCurrentSemesterMonday");function An(t,e,r){let o=e||er(t),s=kn(o)||ha()[o]||"";return cp(t,o,r,{firstMonday:s})}a(An,"normalizeScheduleDataForPage");function Us(t){let e=t.semester.planCode,r=ha()[e],o=kn(e);return o?(xo(e,o),Promise.resolve(o)):tr(r)?Promise.resolve(r):new Promise((s,i)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||np(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let g=a((h,_)=>{l.remove(),h?i(h):s(_)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>g(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let h=l.querySelector("input").value;tr(h)&&(xo(e,h),g(null,h))}),l.addEventListener("click",h=>{h.target===l&&g(new Error("已取消导出"))})})}a(Us,"requestScheduleFirstMonday");async function Ws(t){let e=await Us(t),r=ip(t,e);return Ua(new Blob([r],{type:"text/calendar;charset=utf-8"}),Ra(t.semester.label)+".ics"),sp(t)}a(Ws,"exportScheduleIcs");let Gs={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function le(t,e,r){if(typeof document>"u")return Gt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let s=getComputedStyle(o).color;o.remove();let i=String(s||"").match(/[\d.]+/g)?.map(Number)||[];if(i.length>=3){let l=xr(i[0],i[1],i[2]),g=i.length>3?Math.max(0,Math.min(1,i[3])):1;return g<1?Bt(r||e,l,g):l}return Gt(s)||Gt(e)||"#000000"}a(le,"resolvedScheduleImageColor");function Sn(){let t=Jt(),e=Zt(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},s={bg:le("--bg",o.bg),surface:le(e==="neu"?"--neu-base":"--surface",o.surface),input:le("--input-bg",o.input),text:le("--text",o.text),secondary:le("--text-secondary",o.secondary),muted:le("--text-muted",o.muted),border:le("--border",o.border,le(e==="neu"?"--neu-base":"--surface",o.surface)),primary:le("--primary",o.primary)},i={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(Gs[e]||e)+" · "+(Ct[t]&&Ct[t].name||t),colors:s,shape:i[e]||i.apple}}a(Sn,"currentScheduleImageTheme");function _n(t,e){return yp(t,e||Sn())}a(_n,"buildScheduleSvg");function Js(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),s=URL.createObjectURL(o),i=new Image;i.onload=()=>{try{let g=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),h=document.createElement("canvas");h.width=Math.floor(t.width*g),h.height=Math.floor(t.height*g);let _=h.getContext("2d");_.scale(h.width/t.width,h.height/t.height),_.fillStyle=t.background||"#F8FAFC",_.fillRect(0,0,t.width,t.height),_.drawImage(i,0,0,t.width,t.height),h.toBlob($=>$?e($):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(s)}},i.onerror=()=>{URL.revokeObjectURL(s),r(new Error("课表图片渲染失败"))},i.src=s})}a(Js,"svgToPngBlob");async function Vs(t){let e=await Js(_n(t));Ua(e,Ra(t.semester.label)+".png")}a(Vs,"exportSchedulePng");function Wa(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(Wa,"showFeatureToast");let Ga=vp({document,window,ensureStyles:Ss,loadData:wn,exportJson:Rs,exportIcs:Ws,exportPng:Vs,showToast:Wa,nativePageUrl:Os,navigate:a(t=>{location.href=t},"navigate"),logger:console});function Ys(t,e,r,o){return Ga.run(t,e,r,o)}a(Ys,"runScheduleExport");function Qs(t){return Ga.createMenu(t)}a(Qs,"createScheduleExportMenu");function Xs(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(Xs,"disposeNativePdfCapture");function Ks(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let s=jp(e);t.stage="ok",t.stageCards=s.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=s.target.querySelector("table")?s.target.querySelector("table").id:"none",Xs(s)}catch(s){t.stage="failed",t.stageError=s&&s.message||String(s)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(Ks,"bindNativePdfDiagnose");function Zs(t){return t?(Ks(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await Rp(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:lr})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Wa("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(Zs,"pagePdfExportHandler");function Ja(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Ja,"isPersonalSchedulePage");function tl(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(tl,"isScoreQueryPage");function Va(){if(!Ja())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let s=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),i=Qs({source:"native",pdfHandler:Zs(s)});if(i.id="urppp-native-schedule-export",s&&s.parentElement){s.__urpppNativeExportState||(s.__urpppNativeExportState={display:s.style.getPropertyValue("display"),displayPriority:s.style.getPropertyPriority("display"),ariaHidden:s.getAttribute("aria-hidden"),tabIndex:s.getAttribute("tabindex")}),s.setAttribute("data-urppp-native-export-source","1"),s.style.setProperty("display","none","important"),s.setAttribute("aria-hidden","true"),s.setAttribute("tabindex","-1"),s.parentElement.insertBefore(i,s.nextSibling);return}if(e)e.appendChild(i);else if(t)t.appendChild(i);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let g=document.createElement("div");g.className="urppp-export-fallback",g.appendChild(i),l.prepend(g)}}}a(Va,"patchNativeScheduleExport");let Ge=null,Ur=0;function Ya(){clearTimeout(Ur),Ur=0,Ge&&Ge.observer.disconnect(),Ge=null}a(Ya,"disconnectNativeScheduleExportObserver");function el(){if(!Ja()){Ya();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ge&&Ge.root===t&&t.isConnected)return;Ya();let e=new MutationObserver(()=>{clearTimeout(Ur),Ur=setTimeout(()=>Va(),80)});e.observe(t,{childList:!0,subtree:!0}),Ge={root:t,observer:e}}a(el,"bindNativeScheduleExportObserver");function En(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(En,"restoreOptionalAttribute");function rl(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let s=o.__urpppNativeExportState;s&&(s.display?o.style.setProperty("display",s.display,s.displayPriority):o.style.removeProperty("display"),En(o,"aria-hidden",s.ariaHidden),En(o,"tabindex",s.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(rl,"removeNativeScheduleExport");let Cn=Si({deps:{styles:Zp,loadScores:On,loadProfile:Pn,scoreToNumber:We,scoreToGpa:Ue,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),al=Kn([Vr({id:"schedule-export",matches:a(t=>Ja(t.location),"matches"),mount:a(()=>{Va(),el()},"mount"),unmount:a(t=>{Ya(),rl(t?.lifecycleKey)},"unmount")}),Vr({id:"score-analysis",matches:a(t=>tl(t.location),"matches"),mount:a(()=>{try{Cn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Cn.unmount()}catch{}},"unmount")})]);function Wr(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return al.refresh({document,location,window,lifecycleKey:t})}a(Wr,"refreshRouteFeatures");function ol(t){Ga.bindHosts(t)}a(ol,"bindScheduleExportHosts");function ur(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(ur,"normalizeProfileValue");function Gr(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(s=>ur(s).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let s=0;s<o.length;s++){let i=o[s],l=i.querySelector(".profile-info-name, th, label"),g=i.querySelector(".profile-info-value, td:last-child");if(!l||!g||l===g)continue;let h=ur(l.textContent).replace(/[：:]/g,"");if(!r.some($=>h===$||h.endsWith($)))continue;let _=ur(g.textContent);if(_&&_!=="—"&&_!=="-")return _}return""}a(Gr,"readLabeledProfileValue");function Je(t){return ur(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Je,"cleanMajorPlanName");function nl(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),s=ur(o);if(/主修必修GPA/.test(s)){let i=s.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||s.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(i){let l=Number(i[1]),g=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||g===0||l>0)&&(e.majorGpa=i[1])}}if(/主修为|培养方案/.test(s)){let i=s.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||s.match(/^(.{2,60}?)\s*主修为/)||s.match(/主修为\s*(.{2,60})$/),l=Je(i&&i[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let g=/培养方案|教学计划/.test(l);(!e.majorPlan||g)&&(e.majorPlan=l)}}}),e}a(nl,"extractAcademicOverview");async function Pn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let i=r.querySelector(".urppp-user-name-value"),l=i&&i.__urpppOriginalText;l&&(t.name=String(l).trim());let g=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),h=t.name?null:g.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!h){let _=r.cloneNode(!0);_.querySelectorAll("small, i, img, b, .badge").forEach(j=>j.remove());let $=(_.textContent||"").replace(/\s+/g," ").trim();$=$.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),h=$.match(/([\u4e00-\u9fa5·]{2,12})/)}h&&h[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(h[1])&&(t.name=h[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let s=nl(document);t.majorPlan=s.majorPlan,t.majorGpa=s.majorGpa}catch{}try{let r=await Vt("/student/rollManagement/rollInfo/index"),o=Or(r),s=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Gr(o,["姓名"]),!t.name)){let h=s.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);h&&(t.name=h[1].trim())}let i=Gr(o,["主修方案名称"]),l=Gr(o,["专业"]);t.studentId=Gr(o,["学号"]),i?t.majorPlan=Je(i):!t.majorPlan&&l&&(t.majorPlan=Je(l));let g=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(g&&g.getAttribute("src")&&!t.avatar){let h=g.getAttribute("src");t.avatar=/^https?:/i.test(h)?h:ja(h)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(Pn,"loadProfile");let zn=["周日","周一","周二","周三","周四","周五","周六"];function Qa(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(s=>{let i=String(s.id||"").match(/^(\d+)_(\d+)$/);if(!i)return;let l=parseInt(i[1],10),g=parseInt(i[2],10),h=l===7?0:l,_=s.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),$=_.length?_:[];if(!$.length&&(s.textContent||"").trim()){let j=(s.textContent||"").replace(/\s+/g," ").trim();j&&e.push({name:j.slice(0,40),teacher:"",place:"",week:"",day:h,section:g});return}$.forEach(j=>{let z=Array.from(j.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),F=(j.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(j.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",D=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=z.find(K=>/周/.test(K))||"",B=String(F).replace(/_\d+\s*$/,"").trim();!B||B.length<2||e.push({name:B,teacher:String(D).trim(),place:String(J||"").trim(),week:String(R).trim(),day:h,section:g})})});let o=new Set;return e.filter(s=>{let i=[s.day,s.section,s.name,s.place].join("|");return o.has(i)?!1:(o.add(i),!0)})}a(Qa,"parseScheduleFromDoc");let Ln="urppp_term_week_v1";function Ve(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(Ln,e)}catch{}return e}a(Ve,"rememberTermWeek");function mr(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(Ln,0))||0;if(t>=1&&t<=30)return Ve(t)}catch{}return 0}a(mr,"readRememberedTermWeek");function hr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let s=e.match(r[o]);if(s){let i=parseInt(s[1],10);if(i>=1&&i<=30)return i}}return 0}a(hr,"extractTermWeekFromText");function Pe(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let g=t[l],h=hr(g.innerText||g.textContent||"")||hr(g.innerHTML||"");if(h)return Ve(h)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=hr(e);if(r)return Ve(r);let o=document.body&&document.body.innerText||"",s=hr(o);if(s)return Ve(s);let i=mr();if(i)return i}catch{}return 0}a(Pe,"getCurrentWeekNumber");let Ye=null;function pl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(pl,"calTodayStr");function il(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(s=>String(s).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(il,"calAddDays");function br(t){if(Ye)return Ye;let e=t||pl();return e>="2027-02-06"&&e<=il("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(br,"calVacation");function sl(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(sl,"festiveDecorHtml");function qn(){let t=typeof document<"u"?document:null;if(!t)return;let e=br()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",sl()):!e&&r&&r.remove()}a(qn,"syncFestiveDecor");function Tn(t){Ye=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Ye&&Ye!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{qn()}catch{}try{typeof Xe=="function"&&Xe()}catch{}return Ye}a(Tn,"setCalendarPhase");function ll(){return br()}a(ll,"getCalendarPhase");function Mn(){if(br()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=Pe()||mr()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(Mn,"getViewWeekNumber");async function cl(){let t=Pe();if(t>=1)return t;try{let e=await Vt("/index");if(t=hr(e),t)return Ve(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),s=await Vt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),i=JSON.parse(s),l=Number(i&&i.jxzc);if(l>=1&&l<=30)return Ve(l)}catch{}return mr()||0}a(cl,"ensureTermWeekResolved");function dl(t){let e=Pe()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let s=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);s&&(e=Math.max(e,parseInt(s[2],10)||0));let i=String(r.week||"").match(/\d{1,2}/g);i&&i.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(dl,"inferMaxWeek");function $n(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a($n,"weekBitActive");let In=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function Nn(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return In[e%In.length]}a(Nn,"courseColor");function ul(t){let e=[],r=Pe();(t&&t.xkxx||[]).forEach(i=>{Object.keys(i||{}).forEach(l=>{let g=i[l];if(!g)return;let h=g.courseName||g.englishCourseName||l,_=g.attendClassTeacher||"";(g.timeAndPlaceList||[]).forEach(j=>{let z=Number(j.classDay)||0,F=z===7?0:z,J=Number(j.classSessions)||1,D=Math.max(1,Number(j.continuingSession)||1),R=[j.campusName,j.teachingBuildingName,j.classroomName].filter(Boolean).join(""),B=j.weekDescription||g.skzcs||"",K=$n(j.classWeek,r)||r&&B.indexOf(String(r))>=0;e.push({name:String(h).trim(),teacher:String(_).trim(),place:String(R).trim(),week:String(B).trim(),classWeek:String(j.classWeek||""),day:F,section:J,span:D,thisWeek:!!K,color:Nn(h)})})})});let s=new Set;return e.filter(i=>{let l=[i.day,i.section,i.span,i.name,i.place,i.week].join("|");return s.has(l)?!1:(s.add(l),!0)})}a(ul,"parseScheduleFromJson");async function ml(){try{let t=await Vt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let s=Number(r&&(r.jxzc||r.zc||r.currentWeek));s>=1&&s<=30&&(nt._termWeek=Math.max(nt._termWeek||0,s),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=ul(r)}catch{e=Qa(Or(t))}e.length||(e=Qa(document));let o=r?An(r,er(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=Qa(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(ml,"loadSchedule");function hl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),s=r.match(o);if(s&&s[1])return s[1];let i=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(i);return l?l[1]:""}a(hl,"extractScoreCallback");function bl(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let s=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",i=[];(o.cjList||[]).forEach(l=>{let g=l.courseName||l.englishCourseName||"";if(!g)return;let h=l.cj!=null&&l.cj!==""?String(l.cj):"";!h&&l.courseScore!=null&&(h=String(l.courseScore)),!h&&l.gradeName&&(h=String(l.gradeName)),!h&&l.zscj!=null&&(h=String(l.zscj));let _=l.courseAttributeName||l.xkcsxmc||"",$=parseFloat(l.credit)||0,j=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",F=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ie(h)||ie(l.gradeName)||F!=null&&F<0,D=J?"未评估":h;i.push({code:j,seq:String(z||""),name:g,attr:_,credit:$,score:D,unevaluated:J,required:mn(_),officialGpa:Dr(F)?F:null,evalUrl:""})}),i.length&&e.push({title:String(s).slice(0,100),courses:i,summary:re(i),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(bl,"parseScoreJson");async function Bn(t,e){let r=await Vt(t),o=Fn(Or(r));if(o.length)return o;let s=hl(r,e);if(!s)return[];let i=await Vt(s);try{let l=JSON.parse(i);o=bl(l).map(g=>(g.summary=re(g.courses),g))}catch{o=Fn(Or(i))}return o}a(Bn,"loadScoreByIndex");function Fn(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map($=>($.textContent||"").replace(/\s+/g,""));if(!o.length)return;let s=o.join("|");if(!/课程名/.test(s)||!/成绩/.test(s))return;let i={code:o.findIndex($=>$==="课程号"),name:o.findIndex($=>$==="课程名"),attr:o.findIndex($=>/课程属性|属性/.test($)),credit:o.findIndex($=>$==="学分"),score:o.findIndex($=>$==="成绩")};if(i.name<0||i.score<0)return;let l="成绩",g=r.previousElementSibling;for(let $=0;$<8&&g;$++,g=g.previousElementSibling)if(/^H[1-4]$/.test(g.tagName)||g.classList&&g.classList.contains("header")){l=(g.textContent||"").replace(/\s+/g," ").trim();break}let h=[],_=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(_).forEach($=>{let j=Array.from($.cells||$.querySelectorAll("td"));if(j.length<4)return;let z=a(B=>B>=0&&j[B]?(j[B].textContent||"").replace(/\s+/g," ").trim():"","get"),F=z(i.name),J=z(i.score);if(!F||!J||/课程名|序号/.test(F))return;let D=z(i.attr),R=ie(J);h.push({code:z(i.code),name:F,attr:D,credit:parseFloat(z(i.credit))||0,score:R?"未评估":J,unevaluated:R,required:mn(D),officialGpa:null,evalUrl:""})}),h.length&&e.push({title:l.slice(0,100),courses:h,summary:re(h)})}),e}a(Fn,"parseScoreTables");function gr(t){return Je(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(gr,"schemePlanName");function Dn(t,e){if(!t||!t.length)return 0;let r=Je(e),o=t.findIndex(l=>{let g=gr(l);return/培养方案/.test(g)&&!/微专业|辅修|双学位/.test(g)});if(o>=0&&(!r||gr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let g=gr(l);return g.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(g.slice(0,4))||g.includes(r.slice(0,4))}),o>=0))return o;let s=0,i=-1;return t.forEach((l,g)=>{if(/微专业|辅修/.test(gr(l)))return;let h=(l.courses||[]).length;h>i&&(i=h,s=g)}),s}a(Dn,"pickMajorSchemeIndex");async function gl(){let t={};try{let e=await Vt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(s=>{let i=String(s.KCH||"").trim();if(!i)return;let l=String(s.SFPG)==="1",g=String(s.KTID||"").trim();if(!t[i]){t[i]={ktid:g,kxh:String(s.KXH||""),kcm:s.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&g?"/student/teachingEvaluation/newEvaluation/evaluation/"+g:"/student/teachingEvaluation/newEvaluation/index"};return}t[i].total+=1,l||(t[i].pending+=1,t[i].done=!1,g&&(t[i].ktid=g,t[i].url="/student/teachingEvaluation/newEvaluation/evaluation/"+g))}),Object.keys(t).forEach(s=>{let i=t[s];i.done=!(i.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(gl,"loadEvaluationMap");function fl(t){if(!t)return!1;if(t.officialGpa!=null&&Dr(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ie(e)?!1:We(e)!=null||Ue(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(fl,"hasDisplayableScore");function xl(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(s=>{if(!s||!s.code)return;let i=e[s.code];if(i){if(fl(s)){s.unevaluated=!1,i.done?s.evalUrl=s.evalUrl||"":s.evalUrl=i.url||"/student/teachingEvaluation/newEvaluation/index";return}i.done||(s.unevaluated=!0,s.evalUrl=i.url||"/student/teachingEvaluation/newEvaluation/index",(!s.score||s.score===""||ie(s.score))&&(s.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(xl,"attachEvaluationLinks");function jn(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=re(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=re(e.courses),e)),t)}a(jn,"refreshScoreSummaries");async function yl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await gl();return xl(t,e),t.evalMap=e,t.evaluationReady=!0,jn(t)}finally{t.evaluationLoading=!1}}a(yl,"enrichScoresWithEvaluation");function vl(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=Dn(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let s=gr(o),i=Je(nt.profile.majorPlan);/培养方案|教学计划/.test(s)&&(!/培养方案|教学计划/.test(i)||i==="主修方案")&&(nt.profile.majorPlan=s);let l=o.summary||{},g=Number(l.requiredCredit),h=Number(l.requiredGpa),_=Number(nt.profile.majorGpa);g>0&&Number.isFinite(h)&&h>=0&&h<=5&&(!Number.isFinite(_)||_<=0)&&(nt.profile.majorGpa=String(Ee(h)))}a(vl,"reconcileProfileAndScores");let Qe=null;async function On(t){return t&&(Qe=null),Qe&&!Qe.error||(Qe=await wl()),Qe}a(On,"loadScores");async function wl(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([Bn("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),Bn("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(s=>s.courses.forEach(i=>{o.push(Object.assign({term:s.title},i))})),t.passing=[{title:"全部及格成绩",courses:o,summary:re(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:re(o)}]),jn(t),t.majorIdx=Dn(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(wl,"loadScoresImpl");function ze(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(ze,"parseJsonArrayLoose");function Hn(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let s=0;for(let i=o;i<t.length&&i<o+3e5;i++){let l=t[i];if(l==="[")s++;else if(l==="]"&&(s--,s===0))return t.slice(o,i+1)}return""}a(Hn,"extractBalancedArray");async function kl(){let t=await Vt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let i=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(i&&(e=ze(i)),l&&(r=ze(l)),!e.length){let g=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);g&&(e=ze(g[1]))}if(!r.length){let g=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);g&&(r=ze(g[1]))}if(!r.length){let g=Hn(t,"teachingBuildingName");g&&(r=ze(g))}if(!e.length){let g=Hn(t,"campusName");g&&(e=ze(g))}}catch(i){console.warn("[URP++] classroom json parse",i)}if(!r.length){let i=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=i;let l=[];for(let g of i)try{let h=await Vt("/student/teachingResources/classroomCurriculum/"+g.campusNumber+"/teachingBuildingJson");ze(h).forEach($=>{l.push({id:{campusNumber:g.campusNumber,teachingBuildingNumber:String($.id&&$.id.teachingBuildingNumber||$.teachingBuildingNumber||"")},teachingBuildingName:$.teachingBuildingName||$.name||""})})}catch(h){console.warn("[URP++] building json",g.campusNumber,h)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(i=>({campus:i.campusName||i.campusNumber,campusNumber:String(i.campusNumber||i.id&&i.id.campusNumber||""),buildings:[]}));r.forEach(i=>{let l=String(i.id&&i.id.campusNumber||i.campusNumber||""),g=String(i.id&&i.id.teachingBuildingNumber||i.teachingBuildingNumber||""),h=i.teachingBuildingName||i.name||g;if(!l||!g||!h)return;let _=o.find(j=>j.campusNumber===l);_||(_={campus:l,campusNumber:l,buildings:[]},o.push(_));let $="/student/teachingResources/classroomUseStatus/"+l+"/"+g+"/"+encodeURI(encodeURI(_.campus||l))+"/"+encodeURI(encodeURI(h));_.buildings.push({name:h,path:$,campusNumber:l,buildingNumber:g})});let s=o.filter(i=>i.buildings.length);if(!s.length)throw new Error("未解析到教学楼，请刷新后重试");return s}a(kl,"loadClassroomCatalog");function fr(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(fr,"occupancyTypeLabel");function Al(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return fr(t)}a(Al,"occupancyReason");async function Sl(t,e,r,o){let s=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),i=await Vt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+s.toString());try{let l=JSON.parse(i);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(g=>g&&typeof g=="object"&&(g.kcm||g.id&&g.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(Sl,"fetchClassroomCurriculum");function _l(t,e,r){let o=t||[],s=Number(e.xq)||0,i=Number(e.start)||0,l=Number(r)||0,g=[];return o.forEach(h=>{let _=h.id||{},$=Number(_.skxq!=null?_.skxq:h.skxq)||0,j=Number(_.skjc!=null?_.skjc:h.skjc)||0,z=Math.max(1,Number(h.cxjc)||1),F=_.skzc||h.skzc||"";s&&$&&s!==$||i&&(i<j||i>=j+z)||l&&F&&!Da(F,l)||g.push(h)}),g.length?(g.sort((h,_)=>{let $=Da(h.id&&h.id.skzc||h.skzc,l)?0:1,j=Da(_.id&&_.id.skzc||_.skzc,l)?0:1;return $-j}),g[0]):null}a(_l,"matchCurriculumCourse");async function El(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),s=String(e.buildingNumber||""),i=r||t.planNumber||"";if(!o||!s||!i)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(F=>F.busy)),g={},h=a(async z=>{if(g[z])return g[z];try{g[z]=await Sl(i,o,s,z)}catch{g[z]=[]}return g[z]},"queue"),_=4,$=0,j=new Array(Math.min(_,Math.max(l.length,1))).fill(0).map(async()=>{for(;$<l.length;){let z=$++,F=l[z],J=await h(F.name);(F.slots||[]).forEach(D=>{if(!D.busy)return;let R={xq:D.detail&&D.detail.xq||D.xq||0,start:D.section,week:t.jxzc};D.detail&&D.detail.xq!=null&&(R.xq=D.detail.xq);let B=_l(J,R,t.jxzc);if(B&&B.kcm){let K=String(B.kcm).trim();D.contentName=K,D.reason=K,D.displayChar=jr(K),D.detail&&(D.detail.contentName=K,D.detail.reason=K,D.detail.teacher=B.jsm||"",D.detail.weeks=B.zcsm||"",D.detail.courseNo=B.id&&B.id.kch||"",D.detail.typeLabel=fr({occupancymoduleId:D.module}))}else D.displayChar=jr(D.reason||"占用"),D.detail&&(D.detail.typeLabel=fr({occupancymoduleId:D.module}))})}});return await Promise.all(j),t}a(El,"enrichOccupancyWithCurriculum");function Cl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(Cl,"occupancyKindClass");async function Pl(t){let e="",r="",o="",s="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",s=t.path||"";else{s=String(t||"");let B=s.match(/classroomUseStatus\/(\d+)\/(\d+)\//);B&&(e=B[1],r=B[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let i=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=zl(Rn(new Date,i)),g="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),h=await new Promise((B,K)=>{let ut=ja("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:g,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?B(vt.responseText||""):K(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:g}).then(vt=>vt.text()).then(B).catch(K)}),_;try{_=JSON.parse(h)}catch{throw new Error("jasInfo 非 JSON")}let $=(_.classrooms||[]).map(B=>{let K=B.classroomName||B.id&&B.id.classroomNumber||"",ut=B.placeNum||"",vt=B.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:K,seats:ut,type:vt,slots:Et,map:{}}}),j={};$.forEach(B=>{j[B.name]=B}),(_.classroomTime||[]).forEach(B=>{let K=B.id||{},ut=K.classroomNumber||"",vt=Number(K.sessionstart)||1,Et=Math.max(1,Number(B.continuingsession)||1),Lt=j[ut];if(!Lt)return;let qt=fr(B),Ot=Al(B);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let Mt=Lt.slots.find(ae=>ae.section===Ht);Mt&&(Mt.busy=!0,Mt.kind=B.timestatenumber||B.occupancymoduleId||"",Mt.module=B.occupancymoduleId||"",Mt.reason=Ot,Mt.typeLabel=qt,Mt.displayChar=jr(Ot),Mt.xq=K.xq,Mt.weekBitmap=K.week||"",Mt.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:K.week||"",xq:K.xq||"",state:B.timestatenumber||"",module:B.occupancymoduleId||""})}});let z="";try{let B=_.jhZxjxjhb;typeof B=="string"&&/\d{4}-\d{4}-\d-\d/.test(B)?z=B:B&&typeof B=="object"&&(z=String(B.zxjxjhh||B.jhxnxq||B.executiveEducationPlanNumber||B.planNumber||""))}catch{}if(!z&&_.classrooms&&_.classrooms[0]&&_.classrooms[0].id&&(z=_.classrooms[0].id.executiveEducationPlanNumber||""),_.jxzc!=null&&Number(_.jxzc)>=1){let B=Number(_.jxzc);nt._termWeek=Math.max(nt._termWeek||0,B),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let F=["日","一","二","三","四","五","六"],J=Ll(_.date||l)||Rn(new Date,i),D=_.week!=null?Number(_.week):J.getDay(),R=i===1?"明天":i===2?"后天":"今天";return{rooms:$,dateLabel:(_.date||l)+"（周"+(F[D]||D)+" · "+R+"）",jxzc:_.jxzc,planNumber:z,week:_.week!=null?_.week:D,searchDate:_.date||l,dateOffset:i}}a(Pl,"loadBuildingOccupancy");function Rn(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(Rn,"addDays");function zl(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(zl,"formatLocalDate");function Ll(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(Ll,"parseLocalDate");let Un={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function Wn(t){return Un[t]||Un.more}a(Wn,"ico");let nt=ei();function ql(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=Xp,(document.head||document.documentElement).appendChild(t)}a(ql,"ensureStyle");let Tl=na({deps:{scoreToNumber:We,scoreToGpa:Ue}}),{metricHtml:Ml,occupancyHtml:$l,render:Xe,renderScheduleBoard:zc,roomPickerHtml:Il,scheduleRender:Nl}=mi({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:zn,analyzeScores:a(t=>Tl.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Yt,bandsChartSvg:ia,bindUI:a(t=>Fl(t),"bindUI"),classifyPrivacyLabel:Hr,courseColor:Nn,ensureRoot:a(()=>Jn(),"ensureRoot"),escapeHtml:at,firstContentChar:jr,getViewWeekNumber:Mn,ico:Wn,isCleanAnalysisDirect:da,occupancyKindClass:Cl,occupancyTypeLabel:fr,personalizedProfile:Ds,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:We,summarizeCourses:re,trendChartSvg:pa,weekBitActive:$n,calVacation:br,setCalendarPhase:Tn}}),{ensureRoomCatalogLoaded:Gn,loadAll:Bl}=ai({state:nt,deps:{ensureTermWeekResolved:cl,enrichScoresWithEvaluation:yl,getCurrentWeekNumber:Pe,loadClassroomCatalog:kl,loadProfile:Pn,loadSchedule:ml,loadScores:On,readRememberedTermWeek:mr,reconcileProfileAndScores:vl,render:Xe,scheduleRender:Nl}}),{bindUI:Fl,closeModal:Dl,getRoomHost:Lc,openModal:qc,openRoomModal:Tc,openScoreModal:Mc,showBuilding:$c}=hi({state:nt,deps:{DAY_NAMES:zn,applyPersonalDisplay:Yt,bindScheduleExportHosts:ol,closeCleanMode:a(()=>Ol(),"closeCleanMode"),ensureRoomCatalogLoaded:Gn,enrichOccupancyWithCurriculum:El,ensureRoot:a(()=>Jn(),"ensureRoot"),escapeHtml:at,fetchText:Vt,getCurrentWeekNumber:Pe,getViewWeekNumber:Mn,inferMaxWeek:dl,isUnevaluatedScore:ie,isValidOfficialGpa:Dr,loadBuildingOccupancy:Pl,metricHtml:Ml,occupancyHtml:$l,render:Xe,rootEl:a(()=>Hl(),"rootEl"),roomPickerHtml:Il,scoreToGpa:Ue,scoreToNumber:We,summarizeCourses:re,summarizeCoursesPreferOfficial:re}}),{cleanModeApi:jl,closeCleanMode:Ol,ensureRoot:Jn,injectCleanEntry:Ic,openCleanMode:Nc,rootEl:Hl}=bi({state:nt,deps:{CLEAN_FLAG:As,applySkinAttr:ee,closeModal:Dl,ensureRoomCatalogLoaded:Gn,ensureStyle:ql,getCurrentWeekNumber:Pe,getSkin:Zt,handleThemeDotClick:ct,ico:Wn,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:vo,loadAll:Bl,openSettingsPanel:Yo,readRememberedTermWeek:mr,refreshCleanPersonalDisplay:Ha,render:Xe,scoreToGpa:Ue,summarizeCourses:re,syncNavbarThemeUI:ft,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=jl;function Xa(){if(!document.body){setTimeout(Xa,10);return}if(wo(),Wt(Jt()),setTimeout(()=>{try{Ae().then(e=>Oe(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],s=r.parentElement;for(;s;){let i=s.scrollTop,l=s.scrollLeft;(i||l||s.scrollHeight>s.clientHeight||s.scrollWidth>s.clientWidth)&&o.push({el:s,top:i,left:l}),s=s.parentElement}requestAnimationFrame(()=>{o.forEach(i=>{i.el.scrollTop=i.top,i.el.scrollLeft=i.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))Co();else{Yi();try{hn()}catch{}try{Wr()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Yt(document)}catch{}try{qn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{Wr()}catch{}try{Yt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{ca()&&vo()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(Xa,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(_e,50)}),window.addEventListener("load",()=>{_e(),Re(),setTimeout(_e,100),setTimeout(_e,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Re,0),setTimeout(Re,50),setTimeout(Re,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Re,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function Vn(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let s=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),i=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));s&&!i&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){_e(),un(),st(),_e();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(i=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},i)),Aa(),Wo(),Go(),Bo(),Jo(),Uo(),Do(),document.querySelectorAll(".page-content, #page-content-template").forEach(i=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);i.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),i.style.setProperty("box-sizing","border-box","important")}),Tr(),Ir(),Fe(),setTimeout(Fe,300),setTimeout(Fe,1e3),qo(),be(),ir(),$o(),setTimeout(ir,300),sr(),setTimeout(()=>sr(),500),qr(),Mo();try{Wr()}catch{}try{Yt(document)}catch{}setTimeout(()=>{try{Wr()}catch{}try{Yt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...s){let i=r.apply(this,s);return e(),i},history.replaceState=function(...s){let i=o.apply(this,s);return e(),i}}a(Vn,"watchRouteChanges");let Ke=typeof unsafeWindow<"u"?unsafeWindow:window;Ke.__urpppDebug=Ke.__urpppDebug||{},Ke.__urpppDebug.setCalendarPhase=t=>Tn(t),Ke.__urpppDebug.getCalendarPhase=()=>ll(),Ke.__urpppDebug.calVacation=t=>br(t),Ke.urppp={version:p,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Wt(t)},"apply"),setAccent:Pi,getAccent:Qt,getCurrent:Jt,list:a(()=>Object.entries(Ct).map(([t,e])=>({name:t,displayName:e.name,current:t===Jt()})),"list")},update:{check:Ba,auto:Na,showToast:Ia},privacy:{get:we,set(t){return ma(t),Yt(document),we()},apply:a(()=>Yt(document),"apply"),identity:{get:$e,set(t){return fo(t),Yt(document),Ha(),$e()}}},scheduleExport:{load:a(()=>wn("api"),"load"),run:a(t=>Ys(t,"api",null,null),"run"),patch:Va,image:{theme:Sn,build:a((t,e)=>_n(t,e),"build")},jsonFormat:{get:zr,set:yo,validate:qe,build(t,e){let r=Qr(t);if(e)return Kr(r,qe(e));let o=zr();return o.enabled?Kr(r,o.mapping):Xr(r)},buildDefault(t){return Xr(Qr(t))}}}};function Yn(){setTimeout(()=>{try{Na()}catch{}},1800)}a(Yn,"scheduleAutoUpdateCheck");try{wo()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Xa(),Vn(),Yn()}):(Xa(),Vn(),Yn())})();})();
