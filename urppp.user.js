...
`;function zc(p){p.querySelectorAll("td, th").forEach(n=>{n.style.removeProperty("background"),n.style.removeProperty("background-color")}),p.querySelectorAll("th[rowspan]").forEach(n=>{n.style.removeProperty("width"),n.style.setProperty("white-space","nowrap"),n.style.setProperty("text-align","center")}),p.querySelectorAll("table").forEach(n=>{n.style.setProperty("background","#ffffff","important"),n.style.setProperty("background-color","#ffffff","important"),n.style.setProperty("border","none","important"),n.style.setProperty("color","#000000","important")}),p.querySelectorAll("th").forEach(n=>{if(n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important"),n.style.setProperty("font-weight","normal","important"),n.childNodes.length===1&&n.firstChild&&n.firstChild.nodeType===3){let c=document.createElement("span");c.textContent=n.textContent,n.textContent="",n.appendChild(c)}}),p.querySelectorAll("thead th").forEach(n=>{n.style.setProperty("background","#dddddd","important"),n.style.setProperty("background-color","#dddddd","important")}),p.querySelectorAll("tbody th").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important")}),p.querySelectorAll("td").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important"),n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important")})}a(zc,"normalizeNativePdfStage");function Kp(p){let n=Cc(),c=document.createElement("div");c.id="urppp-pdf-stage",c.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(n||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=p.cloneNode(!0);_c(u),Ec(u),d.appendChild(u),c.appendChild(d),zc(u);let k=document.createElement("style");k.id="urppp-pdf-reset-style",k.textContent=Pc,document.head.appendChild(k),document.body.appendChild(c);let P=c.querySelector("#urppp-pdf-mycoursetable"),_=c.querySelector("#urppp-pdf-page")||c;if(!P)throw c.remove(),new Error("无法建立原生课表捕获节点");return{stage:c,target:P,page:_,sourceHost:p}}a(Kp,"cloneNativePdfStage");var pa=0;function de(){return pa>0}a(de,"isNativePdfIsolationActive");function Lc(p){return!p||p.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(p.id||"")||p.hasAttribute("data-urppp-style")?!0:(p.textContent||"").includes("urppp-")}a(Lc,"isUrpppOwnedStyle");function Zp(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(Zp,"defaultPage");function ti(p,n){let c=p&&typeof p.requestAnimationFrame=="function"?p.requestAnimationFrame.bind(p):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return c?c(n):setTimeout(n,0)}a(ti,"scheduleFrame");function qc(p={}){let n=p.document||(typeof document<"u"?document:null),c=p.page||Zp();if(!n)throw new Error("原生 PDF 隔离缺少 document");let d=n.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");pa+=1;let u=[d,...d.querySelectorAll("*")],k=[],P=n.getElementById("soliderbox");P&&k.push(P);let _=d.parentElement;for(;_&&_!==n.documentElement;){let x=_.classList;(_.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&k.push(_),_=_.parentElement}let y=n.getElementById("page-content-template")||n.querySelector(".page-content");y&&!k.includes(y)&&k.push(y);let S=[...u,...k],g=S.map(x=>({element:x,style:x.getAttribute("style")})),w=Array.from(n.querySelectorAll("style")).filter(Lc).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),M=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=c&&c.divBuild,f=c&&c.__urpppOriginalDivBuild,b=!1,v=a(()=>{b||(b=!0,c&&c.divBuild===f&&typeof C=="function"&&(c.divBuild=C),g.forEach(({element:x,style:E})=>{x.isConnected&&(E===null?x.removeAttribute("style"):x.setAttribute("style",E))}),M.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),w.forEach(({style:x,disabled:E,media:T})=>{try{T===null?x.removeAttribute("media"):x.setAttribute("media",T),x.sheet&&(x.sheet.disabled=E)}catch{}}),pa=Math.max(0,pa-1),ti(c,()=>{try{typeof p.onAfterRestore=="function"&&p.onAfterRestore()}catch{}}))},"restore");try{return w.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),S.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(E=>{x.style.getPropertyPriority(E)==="important"&&(E==="height"&&x.matches("td, th")||x.style.removeProperty(E))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),M.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),c&&typeof f=="function"&&(c.divBuild=f),v}catch(x){throw v(),x}}a(qc,"isolateScheduleForNativeExport");function ei(p,n={}){return new Promise((c,d)=>{let u=n.page||Zp(),k=u&&u.back,P=u&&u.html2canvas;if(!p||typeof k!="function"){d(new Error("教务原生导出依赖未就绪"));return}let _=null;try{_=qc(n)}catch(f){d(f);return}let y=0,S=!1,g=null,w=null,M=a(f=>{if(!S){S=!0,y&&clearTimeout(y),u&&g&&u.back===g&&(u.back=k),w&&u.html2canvas===w&&(u.html2canvas=P);try{_&&_()}catch{}f?d(f):c()}},"settle"),C=a(f=>M(f instanceof Error?f:new Error(String(f))),"fail");typeof P=="function"&&(w=a(function(){let f=P.apply(this,arguments);return f&&typeof f.catch=="function"&&f.catch(C),f},"scopedCanvas"),u.html2canvas=w),g=a(function(){try{return k.apply(this,arguments)}finally{setTimeout(()=>M(),0)}},"wrappedBack"),u.back=g,y=setTimeout(()=>{try{k.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},n.timeoutMs||60*1e3),ti(u,()=>{try{p.click()}catch(f){C(f)}})})}a(ei,"exportNativePdfIsolated");var ri=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
`;function mi(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(mi,"createCleanModeState");function hi(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(hi,"resetCleanModeData");function bi({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(k){p.catalog=p.catalog||[],p.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&hi(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let k=await n.ensureTermWeekResolved();!p.weekLocked&&k>=1&&(p.viewWeek=k)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(k){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(k){p.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}})(),(async()=>{let k=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),k=p.scores,n.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&n.enrichScoresWithEvaluation(k).then(()=>{p.scores===k&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(bi,"createCleanModeDataLoader");var nr={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},Tc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Cr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function xi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(xi,"calToday");function go(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(go,"calDayDiff");function xo(p,n){let c=go(nr[p].start,n);return c<0?0:Math.floor(c/7)+1}a(xo,"calWeekNo");function bo(p){return Tc[p]||""}a(bo,"calLunar");function fi(p){return String(p||"").slice(5)}a(fi,"calYY");function Mc(p){let n=p||xi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(Mc,"calActiveTerm");function yo(p,n){let c=p&&nr[p]?p:"autumn",d=nr[c],u=n||xi(),k=d.events.map(g=>({e:g,d:go(u,g.start)})).filter(g=>g.d>=-0).sort((g,w)=>g.d-w.d)[0],P=k?go(u,k.e.start):null,_=xo(c,u),y=Math.max(0,Math.min(100,_/d.weeks*100)),S=u>=d.start;return{term:d,termId:c,next:k,daysLeft:P,weekNo:_,progress:y,started:S,today:u}}a(yo,"calStatus");function yi(p,n){let c=yo(p,n),d=c.next?Cr[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(vi,"calendarSummaryCompactHtml");function gi(p,n){let c=yo(p,n),d=c.next?Cr[c.next.e.t].color:"#c9cdd4",u=c.term,k=Object.keys(nr).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${nr[w].name}</button>`).join(""),P=`<div class="cal-widget">
  ...
  </div>`,_=u.events.slice().sort((w,M)=>w.start<M.start?-1:1),y={};_.forEach(w=>{(y[w.start.slice(0,7)]=y[w.start.slice(0,7)]||[]).push(w)});let S=a(w=>w===c.today?" cal-today":"","todayFlag"),g=Object.keys(y).map(w=>{let[,M]=w.split("-");return`<div class="cal-mon">
      <div class="cal-mon-label">${Number(M)} 月</div>
      <div class="cal-mon-items">${y[w].map(C=>{let f=Cr[C.t].color,b=C.end&&C.end!==C.start?"~"+fi(C.end):"",v=xo(c.termId,C.start)>0?`第 ${xo(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
  ...
  `,n.id="urppp-cal-style";let c=p.head||p.documentElement;c&&c.appendChild(n),ia=!0}}catch{}return ia}a(vo,"ensureCalendarStyle");function Ai(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-nav-theme")||p.querySelector("#navbar .navbar-header")||p.getElementById("navbar"),c=p.getElementById("urppp-nav-clean"),d=p.getElementById("urppp-nav-cal");if(!n&&!c)return;let u=c&&c.parentElement||n;d&&d.parentElement===u||(d&&d.remove(),d=p.createElement("button"),d.type="button",d.id="urppp-nav-cal",d.title="校历时间线",d.setAttribute("aria-label","校历时间线"),d.innerHTML='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3.5" y="5" width="17" height="15.5" rx="2.5"/><path d="M3.5 9.5h17"/><path d="M8 3v3M16 3v3"/><circle cx="12" cy="15" r="1.2" fill="currentColor" stroke="none"/></svg><span>校历</span>',Object.entries({display:"inline-flex","align-items":"center",height:"28px","min-height":"28px",padding:"0 12px","font-size":"12px",gap:"6px",width:"auto",float:"none",margin:"0 0 0 8px","vertical-align":"middle"}).forEach(([k,P])=>d.style.setProperty(k,P,"important")),d.addEventListener("click",k=>{k.preventDefault(),k.stopPropagation(),wi()}),c&&c.parentElement?c.after(d):u&&u.appendChild(d))}a(Ai,"mountCalendarButton");function Si(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-nav-cal");n&&n.remove()}a(Si,"removeCalendarButton");function _i({state:p,deps:n}){let c=0,d={gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)"};function u(x,E){let T=x||n.summarizeCourses([]);return`<div class="uc-metrics">${[["TotalCredit","总学分",T.totalCredit],["AvgScore","平均成绩",T.avgScore],["AvgGpa","平均绩点",T.avgGpa],["RequiredCredit","必修学分",T.requiredCredit],["RequiredAvg","必修平均",T.requiredAvg],["RequiredGpa","必修绩点",T.requiredGpa]].map(([L,O,$])=>{let H=n.classifyPrivacyLabel(O)||"grade",G=E&&n.DIRECT_EDIT_LABELS[E+L]?` data-urppp-edit-key="${E+L}"`:"";return`<div class="uc-metric"><em>${O}</em><b data-urppp-private="${H}"${G}>${$}</b></div>`}).join("")}</div>`}a(u,"metricHtml");function k(){let x=p.scores;if(!x||x.error)return`<div class="uc-sa-empty">${n.escapeHtml(x&&x.error||"暂无成绩数据")}</div>`;let E=null;try{E=n.analyzeScores({scorePack:x,profile:p.profile})}catch{}if(!E||E.empty)return'<div class="uc-sa-empty">暂无可用成绩数据，请先查询成绩后再试。</div>';let T=typeof n.scoreChartLayout=="function"?n.scoreChartLayout():null;return`<div class="uc-sa-charts">
      <div class="uc-sa-chart-card"><h5>学期趋势</h5><div class="uc-sa-chart-scroll">${n.trendChartSvg({trend:E.trend,palette:n.scoreChartPalette||d,layout:T})}</div></div>
      <div class="uc-sa-chart-card"><h5>成绩分段分布</h5><div class="uc-sa-chart-scroll">${n.bandsChartSvg({bands:E.bands,palette:n.scoreChartPalette||d,layout:T})}</div></div>
    </div>
    <div class="uc-sa-more-row"><a class="uc-sa-more" data-href="/student/integratedQuery/scoreQuery/allPassingScores/index?urppp=sa">点击此处跳转到详细分析界面 →</a></div>`}a(k,"analysisHtml");function P(x){let E=!!n.isCleanAnalysisDirect(),T=p.scoreAnalysisTab==="analysis";return E?`<div class="uc-hd"><span>成绩总览</span><span class="uc-sub">点击查看明细</span></div>
  <div class="uc-bd">
    <div class="uc-sa-pane">${x}</div>
    <div class="uc-sa-pane uc-sa-pane-analysis">${k()}</div>
  </div>`:`<div class="uc-hd uc-hd-tabs" role="tablist">
    <button type="button" class="uc-sa-tab${T?"":" ac"}" data-sa-tab="overview">成绩总览</button>
    <button type="button" class="uc-sa-tab${T?" ac":""}" data-sa-tab="analysis">成绩分析</button>
  </div>
  <div class="uc-bd">
    <div class="uc-sa-pane"${T?" hidden":""}>${x}</div>
    <div class="uc-sa-pane uc-sa-pane-analysis"${T?"":" hidden"}>${k()}</div>
  </div>`}a(P,"scoreSectionHtml");function _(){try{if(window.matchMedia&&window.matchMedia("(max-width:900px)").matches)return 40}catch{}return 56}a(_,"getScheduleRowHeight");function y(x){let E=n.getViewWeekNumber(),T=_(),I=Math.max(T-4,28),L=(x||[]).map(H=>Object.assign({},H,{thisWeek:n.weekBitActive(H.classWeek,E)||!H.classWeek&&String(H.week||"").indexOf(String(E))>=0,span:Math.max(1,H.span||1),color:H.color||n.courseColor(H.name)})),O={};L.forEach(H=>{let G=H.day+"_"+H.section;(O[G]||(O[G]=[])).push(H)});let $=`<div class="uc-week" data-urppp-private="schedule" data-week="${E}" data-row="${T}">`;$+='<div class="uc-week-head"><div class="h"></div>';for(let H=0;H<7;H++)$+=`<div class="h">${n.DAY_NAMES[H]}</div>`;$+='</div><div class="uc-week-body">',$+='<div class="uc-sec-col">';for(let H=1;H<=12;H++)$+=`<div class="s" style="height:${T}px">${H}</div>`;$+="</div>";for(let H=0;H<7;H++){$+=`<div class="uc-day-col" data-day="${H}" style="height:${T*12}px">`;for(let G=1;G<=12;G++)$+=`<div class="uc-grid-cell" data-sec="${G}" style="top:${(G-1)*T}px;height:${I}px"></div>`;$+=`<div class="uc-part-line" style="top:${4*T-2}px"></div>`,$+=`<div class="uc-part-line" style="top:${9*T-2}px"></div>`;for(let G=1;G<=12;G++){let U=(O[H+"_"+G]||[]).slice().sort((gt,Z)=>gt.thisWeek!==Z.thisWeek?(Z.thisWeek?1:0)-(gt.thisWeek?1:0):(Z.span||1)-(gt.span||1));if(!U.length)continue;let it=U.filter(gt=>gt.thisWeek)[0]||U[0],mt=U.filter(gt=>gt!==it),V=it.span,Q=(G-1)*T+1,ot=V*T-6,X=it.thisWeek?8:2,ct=it.thisWeek?`--uc-course-color:${it.color};top:${Q}px;height:${ot}px;z-index:${X};background:${it.color}26;border-color:${it.color}80`:`--uc-course-color:${it.color};top:${Q}px;height:${ot}px;z-index:${X};background:color-mix(in srgb,${it.color} 8%,var(--input-bg));border-color:var(--border);opacity:.48`,rt=mt.length?`<span class="uc-badge">+${mt.length}</span>`:"",st=n.escapeHtml(JSON.stringify({name:it.name,teacher:it.teacher,place:it.place,week:it.week,day:it.day,section:it.section,span:it.span,thisWeek:it.thisWeek,others:mt.map(gt=>({name:gt.name,teacher:gt.teacher,place:gt.place,week:gt.week,thisWeek:gt.thisWeek,section:gt.section,span:gt.span}))}));$+=`<div class="uc-lesson${it.thisWeek?"":" is-fade"}" style="${ct}" data-course='${st}'>
    ...
    </div>`}a(w,"renderDesktop");function M(){let x=n.personalizedProfile(p.profile||{}),E=p.schedule&&p.schedule.courses||[],T=p.scores&&p.scores.passing&&p.scores.passing[0]||{summary:n.summarizeCourses([])},I=(p.scores&&p.scores.schemes||[])[p.activeSchemeIdx]||{summary:n.summarizeCourses([])},L=x.avatar?`<img src="${n.escapeHtml(x.avatar)}" alt="">`:`<span>${n.escapeHtml((x.name||"同")[0])}</span>`;if(p.mobileTab==="scores"){let O=`<div class="uc-score-grid uc-score-grid-mobile">
        <div class="uc-score-pane" data-score="passing" style="margin-bottom:12px"><h5>全部及格成绩</h5>${u(T.summary,"passing")}</div>
      ...
      <div class="uc-occ"><table class="uc-occ-table">${T}${I}</table></div>`}a(f,"occupancyHtml");function b(){let x=n.ensureRoot(),E=x.querySelector("#uc-body");n.getViewWeekNumber();let T=typeof window<"u"&&window.matchMedia?window.matchMedia:null,I=T&&T("(max-width:900px)").matches,L=!p.uiReady;E.innerHTML=I?M():w(),L?(p.uiReady=!0,x.classList.remove("uc-settled"),clearTimeout(x.__ucSettleTimer),x.__ucSettleTimer=setTimeout(()=>{p.open&&x.classList.add("uc-settled")},480)):x.classList.add("uc-settled"),n.bindUI(E),n.applyPersonalDisplay(E)}a(b,"render");function v(){if(!p.open||c)return;let x=a(()=>{c=0,p.open&&b()},"run"),E=typeof requestAnimationFrame=="function"?requestAnimationFrame:null;c=E?E(x):setTimeout(x,0)}return a(v,"scheduleRender"),{analysisHtml:k,metricHtml:u,occupancyHtml:f,render:b,renderScheduleBoard:y,roomPickerHtml:C,scheduleRender:v,scoreSectionHtml:P}}a(_i,"createCleanModeRenderer");function Ei({state:p,deps:n}){function c(w,M){return!w||(w.__urpppCleanUiBindings||(w.__urpppCleanUiBindings=new Set),w.__urpppCleanUiBindings.has(M))?!1:(w.__urpppCleanUiBindings.add(M),!0)}a(c,"markCleanUiBound");function d(w){if(!w)return;try{n.bindScheduleExportHosts(w)}catch(C){console.warn("[URP++] schedule export menu",C)}w.querySelectorAll("[data-score]").forEach(C=>{c(C,"score")&&C.addEventListener("click",()=>_(C.getAttribute("data-score")))}),w.querySelectorAll("[data-sa-tab]").forEach(C=>{c(C,"saTab")&&C.addEventListener("click",()=>{p.scoreAnalysisTab=C.getAttribute("data-sa-tab")==="analysis"?"analysis":"overview",n.render()})}),w.querySelectorAll("[data-href]").forEach(C=>{c(C,"href")&&C.addEventListener("click",f=>{let b=C.getAttribute("data-href");b&&(f.preventDefault(),n.closeCleanMode(),location.href=b)})}),w.querySelectorAll("[data-eval-url]").forEach(C=>{c(C,"eval")&&C.addEventListener("click",f=>{let b=C.getAttribute("data-eval-url");b&&(f.preventDefault(),f.stopPropagation(),n.closeCleanMode(),location.href=b)})}),w.querySelectorAll('[data-action="room"]').forEach(C=>{c(C,"room")&&C.addEventListener("click",()=>y())}),w.querySelectorAll("[data-room-reload]").forEach(C=>{c(C,"roomReload")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),n.ensureRoomCatalogLoaded(!0)})}),w.querySelectorAll("[data-build-path]").forEach(C=>{c(C,"building")&&C.addEventListener("click",async()=>{let f=C.getAttribute("data-build-path"),b=(C.textContent||"").trim(),v=C.getAttribute("data-cn")||"",x=C.getAttribute("data-bn")||"",E=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;p.roomDateOffset=0,await g({path:f,name:b,campusNumber:v,buildingNumber:x,dateOffset:0},b,E)})}),w.querySelectorAll("[data-room-day]").forEach(C=>{c(C,"roomDay")&&C.addEventListener("click",async f=>{f.preventDefault(),f.stopPropagation();let b=parseInt(C.getAttribute("data-room-day")||"0",10)||0;if(!p.currentBuilding)return;p.roomDateOffset=b;let v=Object.assign({},p.currentBuilding,{dateOffset:b}),x=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;await g(v,v.name||"",x)})});let M=w.querySelector("#uc-room-back");M&&(M.onclick=()=>{p.occupancy=null,p.currentBuilding=null;let C=M.closest("#uc-room-panel")||document.querySelector("#uc-room-panel")||document.querySelector("#uc-modal-body");C&&C.id==="uc-modal-body"||C&&C.id==="uc-room-panel"?(C.innerHTML=n.roomPickerHtml(),d(C)):n.render()}),w.querySelectorAll(".uc-slot.busy[data-occ]").forEach(C=>{c(C,"occupancy")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();try{let b=JSON.parse(C.getAttribute("data-occ")||"{}");k("占用详情",`
          ...
          `,"",{stack:!0})}catch{}})}),w.querySelectorAll(".uc-lesson[data-course]").forEach(C=>{c(C,"course")&&C.addEventListener("click",f=>{f.stopPropagation();try{let b=JSON.parse(C.getAttribute("data-course")||"{}"),v=`第${b.section||"?"}${b.span>1?"-"+(Number(b.section)+Number(b.span)-1):""}节`,x=(b.others||[]).map(E=>`<div class="uc-course-sub ${E.thisWeek?"":"is-fade"}">
          ...
          `,"")}catch{}})}),w.querySelectorAll("[data-week-delta]").forEach(C=>{c(C,"weekDelta")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();let b=parseInt(C.getAttribute("data-week-delta")||"0",10)||0,v=p.schedule&&p.schedule.courses||[],x=n.inferMaxWeek(v),E=n.getViewWeekNumber();p.weekLocked=!0,p.viewWeek=Math.min(x,Math.max(1,E+b)),n.render();let T=document.querySelector("#urppp-clean-root .uc-week-label");T&&(T.classList.remove("uc-pop"),T.offsetWidth,T.classList.add("uc-pop"))})}),w.querySelectorAll("[data-week-reset]").forEach(C=>{c(C,"weekReset")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),p.weekLocked=!1;let b=n.getCurrentWeekNumber()||p._termWeek||1;p.viewWeek=b,n.render();let v=document.querySelector("#urppp-clean-root .uc-week-label");v&&(v.classList.remove("uc-pop"),v.offsetWidth,v.classList.add("uc-pop"))})})}a(d,"bindUI");let u=[];function k(w,M,C,f){f=f||{};let b=n.ensureRoot(),v=b.querySelector("#uc-mask"),x=b.querySelector("#uc-modal");f.stack&&x.classList.contains("open")?u.push({title:b.querySelector("#uc-modal-title").textContent,body:b.querySelector("#uc-modal-body").innerHTML,ft:b.querySelector("#uc-modal-ft").innerHTML}):f.stack||(u.length=0),v.classList.add("open"),x.classList.add("open"),b.querySelector("#uc-modal-title").textContent=w,b.querySelector("#uc-modal-body").innerHTML=M,b.querySelector("#uc-modal-ft").innerHTML=C||"",d(b.querySelector("#uc-modal-body")),d(b.querySelector("#uc-modal-ft")),n.applyPersonalDisplay(b.querySelector("#uc-modal"))}a(k,"openModal");function P(){let w=n.rootEl();if(w){if(u.length){let M=u.pop();w.querySelector("#uc-modal-title").textContent=M.title,w.querySelector("#uc-modal-body").innerHTML=M.body,w.querySelector("#uc-modal-ft").innerHTML=M.ft||"",d(w.querySelector("#uc-modal-body")),d(w.querySelector("#uc-modal-ft"));return}w.querySelector("#uc-mask").classList.remove("open"),w.querySelector("#uc-modal").classList.remove("open")}}a(P,"closeModal");function _(w){let M=p.scores&&p.scores.passing&&p.scores.passing[0]||{courses:[],summary:n.summarizeCourses([])},C=p.scores&&p.scores.schemes||[];w==="scheme"&&p.scores&&p.scores.majorIdx!=null&&p._schemeInited!==!0&&(p.activeSchemeIdx=p.scores.majorIdx||0,p._schemeInited=!0);let f=C[p.activeSchemeIdx]||C[0]||{courses:[],summary:n.summarizeCourses([]),title:"方案成绩"},b=w==="scheme"?f:M,v=w==="scheme"?"scheme":"passing";p.selected[v]||(p.selected[v]=new Set);let x=w==="scheme"&&C.length>1?`<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">${C.map((Z,dt)=>`<button type="button" class="uc-btn ${dt===p.activeSchemeIdx?"primary":""}" data-scheme-idx="${dt}"><span data-urppp-private="organization">${n.escapeHtml((Z.title||"方案").slice(0,28))}</span></button>`).join("")}</div>`:"",E=a(Z=>{let dt=!!(Z&&(Z.unevaluated||n.isUnevaluatedScore(Z.score))),kt=n.scoreToNumber(Z&&Z.score),wt="";dt?wt=kt!=null&&kt<60?"uneval-fail":"uneval":kt!=null?wt=kt>=60?"pass":"fail":/不及格|不合格|不通过/.test(String(Z&&Z.score||""))?wt="fail":Z&&Z.score&&(wt="pass");let Ct=n.escapeHtml(Z&&Z.score||"—"),B=dt?Z.evalUrl||"/student/teachingEvaluation/newEvaluation/index":"";return B?`<span class="uc-score-cell ${wt}" data-eval-url="${n.escapeHtml(B)}" title="未评教，点击前往评教">${Ct}</span>`:`<span class="uc-score-cell ${wt}">${Ct}</span>`},"scoreCellHtml"),T=(b.courses||[]).map((Z,dt)=>{let kt=p.selected[v].has(dt),wt=n.isValidOfficialGpa(Z.officialGpa)?Z.officialGpa:n.scoreToGpa(Z.score),Ct=!!(Z.unevaluated||n.isUnevaluatedScore(Z.score));return`<tr class="${kt?"is-on":""}${Ct?" is-uneval":""}" data-idx="${dt}">
      ...
      </tr>`}).join("");k(w==="scheme"?"方案成绩 · "+(f.title||""):"全部及格成绩",`
      ${x}${n.metricHtml(b.summary,w==="scheme"?"scheme":"passing")}
      <div id="uc-score-wrap">
        ...
        <tbody>${T||'<tr><td colspan="5">暂无数据</td></tr>'}</tbody></table>
        <div class="uc-select-box" id="uc-select-box"></div>
      </div>`,'<div id="uc-calc">已选 0 门</div><button type="button" class="uc-btn" id="uc-clear">清空</button>');let I=document.querySelector("#uc-modal-title");I&&(w==="scheme"?I.setAttribute("data-urppp-private","organization"):I.removeAttribute("data-urppp-private"),n.applyPersonalDisplay(I.parentElement||I));let L=document.querySelector("#uc-modal-body"),O=document.getElementById("uc-calc"),$=document.getElementById("uc-score-table"),H=document.getElementById("uc-score-wrap"),G=document.getElementById("uc-select-box"),U=a(()=>{$.querySelectorAll("tbody tr[data-idx]").forEach(kt=>{let wt=parseInt(kt.getAttribute("data-idx"),10),Ct=p.selected[v].has(wt);kt.classList.toggle("is-on",Ct);let B=kt.querySelector(".uc-selmark");B&&(B.textContent=Ct?"✓":"")});let Z=[];p.selected[v].forEach(kt=>{b.courses[kt]&&Z.push(b.courses[kt])});let dt=n.summarizeCoursesPreferOfficial(Z);O&&(O.className="uc-calc",O.innerHTML=Z.length?`已选 <b>${Z.length}</b> 门 · 学分 <b data-urppp-private="credit">${dt.totalCredit}</b> · 均分 <b data-urppp-private="grade">${dt.avgScore}</b> · 绩点 <b data-urppp-private="gpa">${dt.avgGpa}</b>`:"已选 0 门")},"paint"),et=a((Z,dt)=>{dt===!0?p.selected[v].add(Z):dt===!1||p.selected[v].has(Z)?p.selected[v].delete(Z):p.selected[v].add(Z)},"toggleIdx"),it=!1;$.querySelectorAll("tbody tr[data-idx]").forEach(Z=>{Z.addEventListener("click",dt=>{if(it){it=!1;return}let kt=parseInt(Z.getAttribute("data-idx"),10);et(kt),U()})});let mt=!1,V=0,Q=0,ot=null,X=a(()=>Array.from($.querySelectorAll("tbody tr[data-idx]")),"rowsEls"),ct=a((Z,dt)=>{if(!G||!H)return{left:0,top:0,right:0,bottom:0,w:0,h:0};let kt=H.getBoundingClientRect(),wt=Math.min(V,Z),Ct=Math.min(Q,dt),B=Math.max(V,Z),Y=Math.max(Q,dt),tt=B-wt,bt=Y-Ct,ht=wt-kt.left+H.scrollLeft,zt=Ct-kt.top+H.scrollTop;return G.style.display=tt>3||bt>3?"block":"none",G.style.left=ht+"px",G.style.top=zt+"px",G.style.width=tt+"px",G.style.height=bt+"px",{left:wt,top:Ct,right:B,bottom:Y,w:tt,h:bt}},"placeBox"),rt=a(Z=>{if(!mt)return;Z.preventDefault();let dt=ct(Z.clientX,Z.clientY);dt.w<=3&&dt.h<=3||(p.selected[v]=new Set(ot),X().forEach(kt=>{let wt=kt.getBoundingClientRect();if(!!(wt.right<dt.left||wt.left>dt.right||wt.bottom<dt.top||wt.top>dt.bottom))return;let B=parseInt(kt.getAttribute("data-idx"),10);ot.has(B)?p.selected[v].delete(B):p.selected[v].add(B)}),U())},"onMoveSel"),st=a(Z=>{let dt=Math.abs(Z.clientX-V)>3||Math.abs(Z.clientY-Q)>3;mt=!1,G&&(G.style.display="none"),document.removeEventListener("mousemove",rt,!0),document.removeEventListener("mouseup",st,!0),dt&&(it=!0),U()},"onUpSel");H.addEventListener("mousedown",Z=>{Z.button===0&&(mt=!0,V=Z.clientX,Q=Z.clientY,ot=new Set(p.selected[v]),ct(V,Q),document.addEventListener("mousemove",rt,!0),document.addEventListener("mouseup",st,!0))}),L.querySelectorAll("[data-scheme-idx]").forEach(Z=>Z.addEventListener("click",()=>{p.activeSchemeIdx=parseInt(Z.getAttribute("data-scheme-idx"),10)||0,p._schemeUserSelected=!0,_("scheme")}));let gt=document.getElementById("uc-clear");gt&&(gt.onclick=()=>{p.selected[v]=new Set,U()}),U()}a(_,"openScoreModal");async function y(){k("空闲教室",'<div class="uc-loading">加载教学楼</div>',"");try{await n.ensureRoomCatalogLoaded(!1),k("空闲教室",n.roomPickerHtml(),'<span class="uc-sub">选择楼栋查看教室×节次占用（对齐教室使用状况）</span>')}catch(w){k("空闲教室",`<div class="uc-empty">${n.escapeHtml(w&&w.message||w)}</div>`,"")}}a(y,"openRoomModal");function S(w){if(w&&w.isConnected)return w;let M=document.querySelector("#uc-room-panel");if(M&&M.offsetParent!==null||M&&p.mobileTab==="room")return M;let C=document.querySelector("#uc-modal-body"),f=document.querySelector("#uc-modal");return f&&f.classList.contains("open")&&C?C:M||C||null}a(S,"getRoomHost");async function g(w,M,C){let f=S(C);if(!f){console.warn("[URP++] no room host");return}f.innerHTML='<div class="uc-loading">加载占用网格</div>';try{let b=await n.loadBuildingOccupancy(w);f.innerHTML='<div class="uc-loading">匹配课程名称</div>';let v=b.planNumber||"";if(!v)try{let T=await n.fetchText("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),I=JSON.parse(T);if(v=I&&(I.zxjxjhh||I.xnxq||I.dateList&&I.dateList[0]&&I.dateList[0].zxjxjhh)||"",!v&&I&&I.xkxx&&I.xkxx[0]){let L=Object.keys(I.xkxx[0]||{}),O=L.length?I.xkxx[0][L[0]]:null;v=O&&(O.zxjxjhh||O.executiveEducationPlanNumber)||""}}catch{}v||(v="2025-2026-2-1"),b.planNumber=v;try{b=await n.enrichOccupancyWithCurriculum(b,typeof w=="object"?w:{},v)}catch(T){console.warn("[URP++] enrich occupancy",T)}p.occupancy=b,p.roomDateOffset=Number(b.dateOffset!=null?b.dateOffset:p.roomDateOffset)||0;let x=typeof w=="object"?w:{path:w,name:M};p.currentBuilding=Object.assign({},x,{name:M||x.name||"",dateOffset:p.roomDateOffset}),M=M||w&&w.name||"";let E=S(f)||f;E.innerHTML=n.occupancyHtml(b,M),d(E)}catch(b){let v=S(f)||f;v&&(v.innerHTML=`<div class="uc-empty">${n.escapeHtml(b&&b.message||b)}</div>`)}}return a(g,"showBuilding"),{bindUI:d,closeModal:P,getRoomHost:S,openModal:k,openRoomModal:y,openScoreModal:_,showBuilding:g}}a(Ei,"createCleanModeUI");function Ci({state:p,deps:n}){function c(){return document.getElementById("urppp-clean-root")}a(c,"rootEl");function d(){n.ensureStyle();let y=c();if(y)return y;y=document.createElement("div"),y.id="urppp-clean-root",y.innerHTML=`
      <div class="uc-top">
      ...
      </div>`,document.documentElement.appendChild(y),y.querySelector("#uc-exit").onclick=k,y.querySelector("#uc-refresh").onclick=()=>u(!0),y.querySelector("#uc-mask").onclick=n.closeModal,y.querySelector("#uc-modal-close").onclick=n.closeModal;let S=a(()=>{n.syncThemeDotGroup(y.querySelector("#uc-top-theme"))},"syncCleanThemeDots");y.querySelectorAll("#uc-top-theme .urppp-nav-dot[data-theme]").forEach(v=>{v.addEventListener("click",()=>{n.handleThemeDotClick(v.dataset.theme),S();try{n.syncNavbarThemeUI()}catch{}try{n.syncSettingsPanelUI()}catch{}})});let g=y.querySelector("#uc-settings");g&&g.addEventListener("click",v=>{v.preventDefault(),v.stopPropagation();try{n.openSettingsPanel()}catch{}});let w=y.querySelector("#uc-menu-toggle"),M=a(v=>{v.classList.remove("urppp-clean-sidebar");let x=v.__urpppCleanInline;if(x){let T=v.style,I=a((L,O)=>{let $=x[O];$&&$.v?T.setProperty(L,$.v,$.p||""):T.removeProperty(L)},"restore");I("top","top"),I("height","height"),I("z-index","z"),I("position","pos"),I("transform","transform"),I("visibility","vis"),I("pointer-events","pe"),I("transition","transition"),delete v.__urpppCleanInline}let E=v.__urpppCleanOrigin;E&&E.parent&&v.parentElement!==E.parent&&(E.next&&E.next.parentElement===E.parent?E.parent.insertBefore(v,E.next):E.parent.appendChild(v)),delete v.__urpppCleanOrigin},"restoreCleanSidebarInline"),C=a(()=>{let v=document.getElementById("sidebar");if(v)if(p.open){if(v.classList.add("urppp-clean-sidebar"),!v.__urpppCleanInline){let O=v.style,$=a(H=>({v:O.getPropertyValue(H),p:O.getPropertyPriority(H)}),"grab");v.__urpppCleanInline={top:$("top"),height:$("height"),z:$("z-index"),pos:$("position"),transform:$("transform"),vis:$("visibility"),pe:$("pointer-events"),transition:$("transition")},v.__urpppCleanOrigin={parent:v.parentElement,next:v.nextSibling}}if(v.parentElement!==y){let O=y.querySelector(".uc-shell");y.insertBefore(v,O||null)}let x=y.getBoundingClientRect(),E=y.querySelector(".uc-top"),T=E?E.getBoundingClientRect():null,I=Math.max(44,Math.round(T?T.bottom-x.top:60)),L=Math.max(0,Math.round(x.height-I));v.style.setProperty("top",I+"px","important"),v.style.setProperty("height",L+"px","important"),v.style.setProperty("z-index","12030","important"),v.style.setProperty("position","fixed","important")}else M(v)},"syncCleanSidebarZ"),f=a(()=>{let v=document.getElementById("sidebar");if(!v)return;try{n.stopDrawerAnimation(v)}catch{}v.classList.remove("display","urppp-drawer-closing"),M(v),w&&(w.setAttribute("aria-expanded","false"),w.setAttribute("aria-label","打开菜单"));let x=document.getElementById("urppp-mobile-menu-button");x&&(x.setAttribute("aria-expanded","false"),x.setAttribute("aria-label","打开菜单"))},"closeCleanSidebar");w&&w.addEventListener("click",v=>{v.preventDefault(),v.stopImmediatePropagation();let x=document.getElementById("sidebar");if(!x)return;x.__urpppCleanMenuBound||(x.__urpppCleanMenuBound=!0,x.addEventListener("click",I=>{if(!p.open)return;let L=I.target&&I.target.closest?I.target.closest("a[href]"):null;if(!L||L.closest("#urppp-mobile-search-panel"))return;let O=String(L.getAttribute("href")||"").trim();if(L.closest("#urppp-mobile-quick, #urppp-mobile-user")){if(!O||O==="#"||O.startsWith("javascript")||L.target==="_blank"||/^https?:\/\//i.test(O))return;k();return}!O||O==="#"||O.startsWith("javascript")||L.target==="_blank"||/^https?:\/\//i.test(O)||k()},!0));let E=!x.classList.contains("display");C(),n.setDrawerOpen(x,w,E);let T=document.getElementById("urppp-mobile-menu-button");T&&(T.setAttribute("aria-expanded",E?"true":"false"),T.setAttribute("aria-label",E?"关闭菜单":"打开菜单"))}),y.__closeCleanDrawer=f,y.__syncCleanSidebarZ=C,y.__syncCleanThemeDots=S;let b=globalThis.ResizeObserver;if(typeof b=="function"){let v=new b(()=>{p.open&&C()});v.observe(y);let x=y.querySelector(".uc-top");x&&v.observe(x),y.__cleanSidebarResizeObserver=v}try{let v=window.matchMedia&&window.matchMedia("(max-width: 900px)");if(v){let x=a(()=>{p.open&&(C(),n.render())},"onLayoutChange");typeof v.addEventListener=="function"?v.addEventListener("change",x):typeof v.addListener=="function"&&v.addListener(x),y.__scoreLayoutMedia=v,y.__scoreLayoutChange=x}}catch{}try{n.applySkinAttr()}catch{}return S(),y.querySelectorAll("#uc-tabbar button").forEach(v=>{v.onclick=()=>{p.mobileTab=v.dataset.tab,y.querySelectorAll("#uc-tabbar button").forEach(x=>x.classList.toggle("ac",x===v)),n.render(),p.mobileTab==="room"&&n.ensureRoomCatalogLoaded()}}),vo(),ki(y),y}a(d,"ensureRoot");function u(y){d();let S=p.open;p.open=!0,p.uiReady=!1,p.weekLocked=!1;let g=n.getCurrentWeekNumber()||n.readRememberedTermWeek();p.viewWeek=g>=1?g:p.viewWeek>=1?p.viewWeek:0,document.documentElement.classList.add("urppp-clean-lock",n.CLEAN_FLAG);let w=c();w.classList.remove("closing"),S||(w.classList.remove("uc-settled","open"),w.offsetWidth,w.classList.add("open"));try{n.stopDrawerAnimation(document.getElementById("sidebar"))}catch{}try{w.__syncCleanThemeDots&&w.__syncCleanThemeDots()}catch{}try{w.__syncCleanSidebarZ&&w.__syncCleanSidebarZ()}catch{}try{n.injectCleanSidebarSections(document.getElementById("sidebar"))}catch{}n.loadAll(!!y);try{n.ensureRoomCatalogLoaded()}catch{}}a(u,"openCleanMode");function k(){p.open=!1,p.uiReady=!1,n.closeModal(),document.documentElement.classList.remove("urppp-clean-lock",n.CLEAN_FLAG);let y=c();if(y){y.classList.remove("open","uc-settled","uc-drawer-open"),y.classList.add("closing"),clearTimeout(y.__ucSettleTimer);try{y.__closeCleanDrawer&&y.__closeCleanDrawer()}catch{}setTimeout(()=>{y.classList.remove("closing")},360)}try{n.refreshMobileNavbar()}catch{}}a(k,"closeCleanMode");function P(){try{n.ensureStyle();let y=document.getElementById("urppp-nav-clean");if(!n.isHomePage()){y&&y.remove(),Si();return}let S=document.getElementById("urppp-nav-theme")||document.querySelector("#navbar .navbar-header")||document.querySelector("#navbar");if(!S)return;y||(y=document.createElement("button"),y.type="button",y.id="urppp-nav-clean",y.title="清爽模式",y.innerHTML=`${n.ico("clean")}<span>清爽</span>`,y.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation(),u(!1)}),S.appendChild(y)),Object.entries({display:"inline-flex","align-items":"center",height:"28px","min-height":"28px",padding:"0 12px","font-size":"12px",gap:"6px",width:"auto",float:"none"}).forEach(([g,w])=>y.style.setProperty(g,w,"important")),vo();try{Ai()}catch{}}catch(y){console.warn("[URP++] clean entry",y)}}return a(P,"injectCleanEntry"),{cleanModeApi:{open:u,close:k,inject:P,refresh:n.refreshCleanPersonalDisplay,refreshRender:a(()=>{try{n.render()}catch{}},"refreshRender"),scoreToGpa:n.scoreToGpa,summarizeCourses:n.summarizeCourses},closeCleanMode:k,ensureRoot:d,injectCleanEntry:P,openCleanMode:u,rootEl:c}}a(Ci,"createCleanModeController");function Pi({deps:p}){function n(){if(window.__urpppScheduleHoverNear)return;window.__urpppScheduleHoverNear=!0;let P=12,_=16,y=0,S=0,g=!1,w=0,M=a(()=>document.getElementById("schedule-hover"),"hoverEl"),C=a(v=>{if(!v||v.style&&v.style.display==="none")return!1;let x=window.getComputedStyle(v);return x.display!=="none"&&x.visibility!=="hidden"},"isShown"),f=a(()=>{let v=M();if(!v||!C(v)){g=!1;return}g=!0;let x=window.innerWidth||1200,E=window.innerHeight||800,T=y+P,I=S+_,L=Math.min(320,v.offsetWidth||280),O=Math.min(220,v.offsetHeight||160);T+L>x-8&&(T=x-L-8),I+O>E-8&&(I=E-O-8),T<8&&(T=8),I<8&&(I=8),v.style.setProperty("position","fixed","important"),v.style.setProperty("left",Math.round(T)+"px","important"),v.style.setProperty("top",Math.round(I)+"px","important"),v.style.setProperty("right","auto","important"),v.style.setProperty("bottom","auto","important"),v.style.setProperty("margin","0","important"),v.style.setProperty("z-index","3000","important"),v.style.setProperty("pointer-events","none","important")},"place"),b=a(()=>{w||(w=requestAnimationFrame(()=>{w=0,f()}))},"schedulePlace");document.addEventListener("mousemove",v=>{if(y=v.clientX,S=v.clientY,!g){let x=M();x&&x.style&&x.style.display&&x.style.display!=="none"&&(g=!0)}g&&b()},!0),document.addEventListener("mouseover",v=>{v.target&&v.target.closest&&v.target.closest(".fc-event, .fc-time-grid-event")&&(y=v.clientX,S=v.clientY,setTimeout(()=>{g=!0,f()},0),setTimeout(f,40))},!0),document.addEventListener("mouseout",v=>{v.target&&v.target.closest&&v.target.closest(".fc-event, .fc-time-grid-event")&&setTimeout(()=>{let E=M();C(E)||(g=!1)},50)},!0)}a(n,"bindScheduleHoverNearCursor");function c(P){try{let _=!!(P&&P.force),y=typeof unsafeWindow<"u"&&unsafeWindow.jQuery?unsafeWindow.jQuery:window.jQuery||null;if(!y||!y.fn||!y.fn.fullCalendar)return!1;let S=document.getElementById("main-calendar")||document.querySelector("#urppp-left .fc, #urppp-dashboard .fc");if(!S)return!1;if(!_&&S.dataset.urpppFcSized==="1")return!0;let g=y(S);if(!(g.data("fullCalendar")||g.hasClass("fc")))return!1;let M=Array.from(S.querySelectorAll(".fc-scroller")).map(f=>({el:f,top:f.scrollTop,left:f.scrollLeft}));if(_||S.dataset.urpppFcRendered!=="1"){try{g.fullCalendar("render")}catch{}S.dataset.urpppFcRendered="1"}else try{g.fullCalendar("updateSize")}catch{}return requestAnimationFrame(()=>{M.forEach(f=>{try{f.el.scrollTop=f.top,f.el.scrollLeft=f.left}catch{}})}),(S.getBoundingClientRect().height||0)>=300&&(S.dataset.urpppFcSized="1"),!0}catch(_){return console.warn("[URP++] fullCalendar refresh failed",_),!1}}a(c,"refreshHomeFullCalendar");function d(){window.__urpppFcRefreshBound||(window.__urpppFcRefreshBound=!0,setTimeout(()=>c({force:!0}),0),setTimeout(()=>c({force:!1}),300))}a(d,"scheduleHomeFullCalendarRefresh");function u(P,_,y){let S=P.querySelector(".widget-header"),g=S?S.querySelector(".widget-toolbar"):null,w=document.createElement("div");w.className="urppp-card",w.innerHTML=`
      <div class="urppp-card-header">
        <h4>${y}</h4>
        <div class="urppp-card-tools"></div>
      </div>
      <div class="urppp-card-body"></div>
    `,g&&(g.style.display="inline-block",w.querySelector(".urppp-card-tools").appendChild(g)),w.querySelector(".urppp-card-body").appendChild(P),_.appendChild(w)}a(u,"wrapWidget");function k(){try{n()}catch{}if(document.getElementById("urppp-dashboard"))return;let P=document.querySelector(".page-content");if(!P)return;let _=Array.from(P.querySelectorAll(".widget-box"));if(_.length<6)return;let y=_[4],S=y?Array.from(y.querySelectorAll(".infobox")):[],g=document.createElement("div");g.id="urppp-dashboard",g.innerHTML=`
    ...
    `,P.appendChild(g);let w=P.querySelector("#warningInfo");w&&document.body.appendChild(w),_.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let M=g.querySelector("#urppp-stats"),C=Math.max(S.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',M.appendChild(E)}function f(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&(M.innerHTML="",x.forEach(E=>{let T=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),I=T[0]||"",L=T.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),$=/[\u4e00-\u9fa5]/.test(I)||I.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=p.statCardPrivacyMarkup(I,L);G.innerHTML=`<div class="${$}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,M.appendChild(G)}))}if(a(f,"updateStats"),f(),y){let x=new MutationObserver(()=>f());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let b=g.querySelector("#urppp-left"),v=g.querySelector("#urppp-right");u(_[5],b,"我的日程安排"),u(_[0],v,"通知公告"),u(_[1],v,"我的待办任务"),u(_[2],v,"可申请业务"),u(_[3],v,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(k,"rebuildDashboard"),{rebuildDashboard:k,refreshHomeFullCalendar:c,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(Pi,"createDashboardController");function we(p){return Math.round((Number(p)||0)*100)/100}a(we,"round2");var $c=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],zi={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},Ic=[{key:"required",label:"必修",test:a(p=>/必修/.test(p),"test")},{key:"elective",label:"任选",test:a(p=>/任选/.test(p),"test")},{key:"optional",label:"选修",test:a(p=>/选修/.test(p),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function Li(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d+)/);return n?`${n[1].slice(2)}-${n[2].slice(2)}-${n[3]}`:String(p||"")}a(Li,"shortTerm");function sa({deps:p}){let n=p.scoreToNumber,c=p.scoreToGpa;function d(f){let b=n(f);if(b!=null)return b;let v=String(f||"").trim().toUpperCase();return zi[v]!=null?zi[v]:null}a(d,"scoreToNumberWithLevels");function u(f){return!f||f.unevaluated?!1:d(f.score)!=null}a(u,"hasScore");function k(f){let b=String(f||"").match(/^(\d{4})-(\d{4})-(\d+)/);return b?[Number(b[1]),Number(b[3])]:[9999,9999]}a(k,"termOrderKey");function P(f){let b=f&&f.passing&&f.passing[0];return b&&b.courses||[]}a(P,"allCourses");function _(f){let b=f&&f.officialGpa,v=Number(b);return b!=null&&Number.isFinite(v)&&v>=0&&v<=5?v:null}a(_,"officialGpa");function y(f){let b=_(f);return b??c(f.score)}a(y,"courseGpa");function S({scorePack:f,profile:b}){let v=P(f),x=b&&b.majorGpa?String(b.majorGpa).trim():"",E=0,T=0,I=0,L=0,O=0,$=0;return v.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,T+=U*G;let et=y(H);et!=null&&(I+=et*G,L+=G,H.required&&(O+=et*G,$+=G))}),{majorGpa:x,requiredGpa:we($?O/$:0),avgGpa:we(L?I/L:0),avgScore:we(E?T/E:0),totalCredit:we(E),courseCount:v.length}}a(S,"computeMetrics");function g(f){let b=new Map;return(f||[]).forEach(v=>{if(!u(v))return;let x=v.term||"未分组",E=b.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},b.set(x,E));let T=Number(v.credit)||0,I=d(v.score);if(I==null||(E.count+=1,T<=0))return;E.credit+=T,E.scoreW+=I*T;let L=y(v);L!=null&&(E.gpaW+=L*T,E.gpaCredit+=T)}),Array.from(b.values()).map(v=>({term:v.term,label:Li(v.term),count:v.count,credit:we(v.credit),avgScore:we(v.credit?v.scoreW/v.credit:0),avgGpa:we(v.gpaCredit?v.gpaW/v.gpaCredit:0)})).sort((v,x)=>{let E=k(v.term),T=k(x.term);return E[0]-T[0]||E[1]-T[1]})}a(g,"computeTrend");function w(f){let b=$c.map(x=>({...x,count:0,credit:0}));(f||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let T=b.find(I=>E>=I.min&&E<=I.max);T&&(T.count+=1,T.credit+=Number(x.credit)||0)});let v=b.reduce((x,E)=>Math.max(x,E.count),1);return b.map(x=>({...x,ratio:Math.round(x.count/v*100)}))}a(w,"computeBands");function M(f){let b=Ic.map(T=>({...T,credit:0,count:0}));(f||[]).forEach(T=>{if(!u(T))return;let I=String(T.attr||""),L=b.find(O=>O.test(I));L&&(L.credit+=Number(T.credit)||0,L.count+=1)});let v=b.reduce((T,I)=>T+I.credit,0)||1,x=b.filter(T=>T.count>0).map(T=>({key:T.key,label:T.label,credit:we(T.credit),count:T.count,ratio:Math.round(T.credit/v*100)})),E=x.find(T=>T.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a(M,"computeShare");function C({scorePack:f,profile:b}){let v=P(f);return{metrics:S({scorePack:f,profile:b}),trend:g(v),bands:w(v),share:M(v),empty:v.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:_,scoreToNumberWithLevels:d,shortTerm:Li}}a(sa,"createScoreAnalysisData");var ne="var(--text-secondary)",ko="var(--border)";function pe(p){return at(String(p??""))}a(pe,"escapeLabel");function qi(p,n,c){let d=!!(p&&p.variant==="mobile");if(n==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},_=Math.max(56,Number(p&&p.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,c)*_),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},k=Math.max(44,Number(p&&p.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,c)*k),height:236,pad:u}}a(qi,"resolveChartLayout");function wo({width:p,height:n,mobile:c,kind:d,label:u}){let k=c?` data-urppp-chart-layout="mobile" style="width:max(100%,${p}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${p} ${n}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${k}>`}a(wo,"openSvg");function la({trend:p,palette:n,layout:c}){let d=(p||[]).filter(rt=>rt&&rt.avgScore!=null),u=qi(c,"trend",d.length),{width:k,height:P,pad:_,mobile:y}=u,S=k-_.left-_.right,g=P-_.top-_.bottom;if(!d.length)return`${wo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let w=d.length,M=a(rt=>_.left+(rt+.5)*(S/w),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),f=d.map(rt=>Number(rt.avgScore)||0),b=d.map(rt=>Number(rt.credit)||0),v=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...f)-4),T=Math.min(100,Math.max(...f)+4),I=Math.max(1,...b),L=x-v||1,O=T-E||1,$=a(rt=>_.top+g-(rt-v)/L*g,"yGpa"),H=a(rt=>_.top+g-(rt-E)/O*g,"yScore"),G=a(rt=>_.top+g-rt/I*g*.9,"yCredit"),U=d.map((rt,st)=>`${M(st)},${$(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${M(st)},${H(rt.avgScore)}`).join(" "),it=[0,.25,.5,.75,1].map(rt=>{let st=_.top+g-rt*g;return`<line x1="${_.left}" y1="${st.toFixed(1)}" x2="${k-_.right}" y2="${st.toFixed(1)}" stroke="${ko}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),mt=d.map((rt,st)=>{let gt=M(st),Z=y?Math.min(30,S/w*.42):Math.min(26,S/w*.32),dt=G(rt.credit);return`<rect x="${(gt-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(_.top+g-dt).toFixed(1)}" rx="3" fill="${n.credit}" opacity="0.55"/>
<text x="${gt.toFixed(1)}" y="${(dt-4).toFixed(1)}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.credit)}</text>`}).join(""),V=d.map((rt,st)=>`<text x="${M(st).toFixed(1)}" y="${P-16}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.label)}</text>`).join(""),Q=d.map((rt,st)=>{let gt=S/w,Z=M(st)-gt/2,dt=[`学期 ${rt.label}`,`课程 ${rt.count} 门`,`修读学分 ${rt.credit}`,`加权均分 ${rt.avgScore}`,`平均绩点 ${rt.avgGpa}`].join(`
`);return`<rect class="urppp-sa-hover" x="${Z.toFixed(1)}" y="${_.top}" width="${gt.toFixed(1)}" height="${g.toFixed(1)}" fill="transparent"><title>${pe(dt)}</title></rect>`}).join(""),ot=d.map((rt,st)=>`<circle cx="${M(st).toFixed(1)}" cy="${$(rt.avgGpa).toFixed(1)}" r="3.5" fill="${n.gpaLine}"/><text x="${M(st).toFixed(1)}" y="${($(rt.avgGpa)-9).toFixed(1)}" text-anchor="middle" font-size="11.5" font-weight="600" fill="${n.gpaLine}">${pe(rt.avgGpa)}</text>`).join(""),X=d.map((rt,st)=>`<circle cx="${M(st).toFixed(1)}" cy="${H(rt.avgScore).toFixed(1)}" r="3" fill="${n.scoreLine}"/><text x="${M(st).toFixed(1)}" y="${(H(rt.avgScore)+17).toFixed(1)}" text-anchor="middle" font-size="11.5" fill="${n.scoreLine}">${pe(rt.avgScore)}</text>`).join(""),ct=y?`<g font-size="12">
  ...
  <rect x="${k-_.right-176}" y="8" width="12" height="12" rx="3" fill="${n.gpaLine}"/><text x="${k-_.right-158}" y="18" fill="${ne}">学期平均绩点</text>
  <rect x="${k-_.right-82}" y="8" width="12" height="12" rx="3" fill="${n.scoreLine}"/><text x="${k-_.right-64}" y="18" fill="${ne}">加权均分</text>
...
<g>${V}</g>
${ct}
</svg>`}a(la,"trendChartSvg");function ca({bands:p,palette:n,layout:c}){let d=p||[],u=qi(c,"bands",d.length),{width:k,height:P,pad:_,mobile:y}=u,S=k-_.left-_.right,g=P-_.top-_.bottom,w=d.length||1,M=Math.max(1,...d.map(b=>b.count)),C=y?Math.min(32,S/w*.62):Math.min(40,S/w*.52),f=d.map((b,v)=>{let x=_.left+(v+.5)*(S/w),E=b.count?Math.max(8,b.count/M*g):0,T=_.top+g-E,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=b.range||(b.min===0?"<60":`${b.min}-${b.max===100?"100":b.max}`),O=[`${b.level||""}（绩点 ${b.gpa}）`,`百分制 ${L}`,`课程 ${b.count} 门`].join(`
`);return`<rect class="urppp-sa-band" x="${(x-C/2).toFixed(1)}" y="${T.toFixed(1)}" width="${C.toFixed(1)}" height="${E.toFixed(1)}" rx="4" fill="${n.primary}" opacity="${I}"><title>${pe(O)}</title></rect>
<text x="${x.toFixed(1)}" y="${(T-6).toFixed(1)}" text-anchor="middle" font-size="12.5" font-weight="600" fill="var(--text)">${pe(b.count)}</text>
...
<line x1="${_.left}" y1="${(_.top+g).toFixed(1)}" x2="${k-_.right}" y2="${(_.top+g).toFixed(1)}" stroke="${ko}" stroke-width="1"/>
${f}
</svg>`}a(ca,"bandsChartSvg");function Ti({items:p,requiredRatio:n,palette:c}){let _=2*Math.PI*56,y=(p||[]).filter(M=>M&&M.ratio>0),S=Math.max(0,Math.min(100,Math.round(Number(n)||0)));if(!y.length)return'<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成"></svg>';let g=-90,w=y.map(M=>{let C=M.ratio/100*_,b=`<circle cx="75" cy="75" r="56" fill="none" stroke="${c.share&&c.share[M.key]||c.required}" stroke-width="24"
  stroke-dasharray="${C.toFixed(2)} ${_.toFixed(2)}"
  stroke-linecap="butt" transform="rotate(${g.toFixed(2)} 75 75)"/>`;return g+=M.ratio/100*360,b}).join("");return`<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成">
...
</svg>`}a(Ti,"donutSvg");var Nc=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),Bc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',Fc='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function Mi({deps:p}){let n=p&&p.palette||Nc;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
  <button type="button" class="urppp-sa-toggle" aria-expanded="false">
    <span class="urppp-sa-icon">${Bc}</span>
    <span class="urppp-sa-title">成绩分析</span>
    <span class="urppp-sa-summary" data-urppp-sa-summary>点击展开，查看成绩指标与学期变化</span>
    <span class="urppp-sa-chevron">${Fc}</span>
  </button>
...
<div class="urppp-sa-grid">
  <section class="urppp-sa-card urppp-sa-bands">
    ...
    <div class="urppp-sa-chart-scroll">${ca({bands:S.bands,palette:n,layout:M})}</div>
  </section>
  <section class="urppp-sa-card urppp-sa-detail">
    <h5 class="urppp-sa-card-title">各学期明细</h5>
    ${P(S.trend)}
  </section>
</div>`}return a(y,"analysisHtml"),{panelShellHtml:c,loadingHtml:d,errorHtml:u,analysisHtml:y,palette:n}}a(Mi,"createScoreAnalysisRenderer");function $i(){function p(n,c){let d=n.querySelector(".urppp-sa-toggle"),u=n.querySelector("[data-urppp-sa-body]");if(!d||!u)return{isExpanded:a(()=>!1,"isExpanded"),setExpanded:a(()=>{},"setExpanded"),syncShareLayout:a(()=>{},"syncShareLayout")};let k=a(_=>{let y=_?"expanded":"collapsed";n.dataset.urpppSaState=y,d.setAttribute("aria-expanded",String(_)),u.hidden=!_,_&&typeof c.onExpand=="function"&&c.onExpand()},"setExpanded");d.addEventListener("click",()=>{let _=d.getAttribute("aria-expanded")==="true";k(!_)}),u.addEventListener("click",_=>{let y=_.target;y&&y.closest&&y.closest("[data-urppp-sa-retry]")&&typeof c.onRetry=="function"&&c.onRetry()});function P(){let _=n.querySelector(".urppp-sa-donut"),y=n.querySelector(".urppp-sa-legend"),S=!!(_&&y&&y.getBoundingClientRect().top>=_.getBoundingClientRect().bottom);n.classList.toggle("urppp-sa-share-stacked",S)}return a(P,"syncShareLayout"),{setExpanded:k,syncShareLayout:P,isExpanded:a(()=>d.getAttribute("aria-expanded")==="true","isExpanded")}}return a(p,"bindPanel"),{bindPanel:p}}a($i,"createScoreAnalysisUI");var Ii="urppp-score-analysis";function Ni({deps:p}){let n=sa({deps:p}),c=Mi({deps:p}),d=$i(),u=null,k="idle",P=null,_=null,y=null,S=!1,g=0,w="desktop";function M(){if(!p.styles||document.getElementById("urppp-score-analysis-style"))return;let U=document.createElement("style");U.id="urppp-score-analysis-style",U.textContent=p.styles,(document.head||document.documentElement).appendChild(U)}a(M,"ensureStyle");function C(){if(typeof p.getInsertHost=="function"){let U=p.getInsertHost();if(U)return U}return document.querySelector(".page-content")||document.getElementById("page-content-template")||document.body}a(C,"findHost");function f(){return u&&u.querySelector("[data-urppp-sa-content]")}a(f,"contentEl");function b(){return P||(k="loading",P=(async()=>{try{let[U,et]=await Promise.all([p.loadScores(),p.loadProfile()]);if(U&&U.error)throw new Error(U.error);let it=n.analyzeScores({scorePack:U,profile:et});return _=it,k="ready",it}catch(U){throw k="error",U}finally{P=null}})(),P)}a(b,"startLoad");function v(){k==="idle"&&b().catch(()=>{})}a(v,"warmup");function x(){if(y&&typeof y.syncShareLayout=="function")try{y.syncShareLayout()}catch{}}a(x,"syncShareLayout");function E(){try{if(window.matchMedia&&window.matchMedia("(max-width: 720px)").matches)return{variant:"mobile"}}catch{}return null}a(E,"currentChartLayout");function T(){let U=f();if(!U||!_)return;let et=E();w=et?et.variant:"desktop",U.innerHTML=c.analysisHtml(_,{chartLayout:et}),x()}a(T,"renderReadyAnalysis");function I(){clearTimeout(g),g=setTimeout(()=>{if(x(),!_||!y||!y.isExpanded())return;let U=E();(U?U.variant:"desktop")!==w&&T()},120)}a(I,"handleResize");function L(){S||(S=!0,window.addEventListener("resize",I))}a(L,"bindResize");function O(){S&&(S=!1,clearTimeout(g),g=0,window.removeEventListener("resize",I))}a(O,"unbindResize");async function $(){let U=f();if(U){if(k==="ready"&&_){T();return}U.innerHTML=c.loadingHtml();try{await b(),T()}catch(et){U.innerHTML=c.errorHtml(et&&et.message||String(et))}}}a($,"handleExpand");function H(){if(M(),u&&u.isConnected)return u;if(document.getElementById(Ii))return document.getElementById(Ii);let U=C();if(!U)return null;let et=document.createElement("div");return et.innerHTML=c.panelShellHtml(),u=et.firstElementChild,U.insertBefore(u,U.firstChild),y=d.bindPanel(u,{onExpand:$,onRetry:$}),L(),v(),p.shouldAutoExpand&&p.shouldAutoExpand()&&(typeof requestAnimationFrame=="function"?requestAnimationFrame:mt=>setTimeout(mt,0))(()=>{try{y.setExpanded(!0)}catch{}}),u}a(H,"mount");function G(){O(),u&&u.isConnected&&u.remove(),u=null,y=null,k="idle",P=null,_=null,w="desktop"}return a(G,"unmount"),{mount:H,unmount:G,getPanel:a(()=>u,"getPanel"),reset:G}}a(Ni,"createScoreAnalysisController");function Bi({documentRef:p=document,locationRef:n=location,windowRef:c=window}){function d(S){return String(S||"").replace(/[\u00a0\s]+/g," ").replace(/^[>\u25b8\u203a·•\u00bb]+/,"").replace(/^\s*[\u25b8>]\s*/,"").trim()}a(d,"cleanMenuLabel");function u(S){if(!S)return"";let g=S.querySelector(":scope > a");if(!g)return"";let w=g.querySelector(".menu-text, .urppp-nav-text");if(w)return d(w.textContent);let M=g.cloneNode(!0);return M.querySelectorAll("i, b, .badge, .arrow, .menu-icon, .urppp-nav-arrow").forEach(C=>C.remove()),d(M.textContent)}a(u,"getMenuLiLabel");function k(S){let g=[],w=S,M=p.getElementById("menus")||p.getElementById("urppp-menus");for(;w&&w!==M;){if(w.tagName==="LI"){let C=u(w);C&&!/^(首页|一级菜单|二级菜单|三级菜单)$/.test(C)&&g.unshift(C)}w=w.parentElement}return g.filter((C,f)=>C&&C!==g[f-1])}a(k,"walkMenuAncestors");function P(){let S=n.pathname.replace(/\/+$/,"")||"/",g=n.search||"",w=[];return[p.getElementById("menus"),p.getElementById("urppp-menus")].filter(Boolean).forEach(C=>{C.querySelectorAll("a[href]").forEach(f=>{let b=f.getAttribute("href")||"";if(!(!b||b==="#"||b.startsWith("javascript")))try{let v=new URL(b,n.origin),x=v.pathname.replace(/\/+$/,"")||"/";if(x==="/"&&S!=="/")return;let E=0;S===x?E=1e3+x.length:S.startsWith(x+"/")?E=500+x.length:S.includes(x)&&x.length>8&&(E=200+x.length),E&&g&&v.search&&g.indexOf(v.search.slice(1))>=0&&(E+=50),E>0&&w.push({score:E,li:f.closest("li")})}catch{}})}),w.sort((C,f)=>f.score-C.score),w.length?w[0].li:null}a(P,"findMenuLiByPath");function _(){let S=P();if(S){let b=k(S);if(b.length)return b}let g="";try{let b=p.cookie.match(/(?:^|;\s*)selectionBar=([^;]+)/);b&&(g=decodeURIComponent(b[1]))}catch{}if(g&&g!=="0"){let b=p.getElementById(g);if(b){let v=k(b);if(v.length)return v}}let w=null,M=Array.from(p.querySelectorAll("#menus li.active"));if(M.length){w=M[M.length-1];for(let b=M.length-1;b>=0;b--)if(!M[b].querySelector("li.active")){w=M[b];break}}if(!w){let b=Array.from(p.querySelectorAll("#urppp-menus .urppp-nav-item.active"));if(b.length){w=b[b.length-1];for(let v=b.length-1;v>=0;v--)if(!b[v].querySelector(".urppp-nav-item.active")){w=b[v];break}}}if(w){let b=k(w);if(b.length)return b}let C=p.getElementById("breadcrumbs")||p.querySelector(".breadcrumbs"),f=C&&(C.querySelector("ul.breadcrumb")||C.querySelector(".breadcrumb"));if(f){let b=[];if(Array.from(f.children).forEach((v,x)=>{if(x===0)return;let E=d(v.textContent);!E||/^(首页|一级菜单|二级菜单|三级菜单)$/.test(E)||b[b.length-1]!==E&&b.push(E)}),b.length)return b}return[]}a(_,"getBreadcrumbTrail");function y(){let S=p.getElementById("breadcrumbs")||p.querySelector(".breadcrumbs");if(!S)return;S.classList.remove("hide"),S.style.removeProperty("display"),S.style.setProperty("display","flex","important");let g=S.querySelector("ul.breadcrumb")||S.querySelector(".breadcrumb");g||(g=p.createElement("ul"),g.className="breadcrumb",S.appendChild(g));let w=_();if(!w.length&&Array.from(g.children).map(b=>d(b.textContent)).filter(Boolean).some(b=>b!=="首页"&&!/^(一级菜单|二级菜单|三级菜单)$/.test(b)))return;g.innerHTML="";let M=p.createElement("li");M.style.cursor="pointer",M.innerHTML='<span class="urppp-bc-label"><i class="ace-icon fa fa-home home-icon"></i>首页</span>',M.addEventListener("click",()=>{c.location.href="/"}),g.appendChild(M),w.forEach((C,f)=>{let b=p.createElement("li");f===w.length-1&&b.classList.add("active");let v=p.createElement("span");v.className="urppp-bc-label",v.textContent=C,b.appendChild(v),g.appendChild(b)})}return a(y,"beautifyBreadcrumbs"),{beautifyBreadcrumbs:y}}a(Bi,"createBreadcrumbController");function Fi({documentRef:p=document,windowRef:n=window,MutationObserverRef:c=MutationObserver,nodeTypeRef:d=Node}){function u(){try{let _=p.getElementById("sidebar"),y=p.querySelectorAll(".main-content");if(!y.length)return;let S=n.matchMedia&&n.matchMedia("(max-width: 991px)").matches,g="260px";S?g="0px":_&&(g=_.classList.contains("menu-min")?"50px":"260px"),y.forEach(w=>w.style.setProperty("margin-left",g,"important"))}catch{}}a(u,"syncMobileContentOffset");function k(){try{let _=p.getElementById("sidebar"),y=p.querySelector("#navbar, .navbar.navbar-default, .navbar-fixed-top");if(!_||!y||_.classList.contains("urppp-clean-sidebar"))return;let S=y.getBoundingClientRect(),g=Math.max(45,Math.round(S.height||y.offsetHeight||45));p.documentElement.style.setProperty("--urppp-navbar-height",g+"px"),_.style.setProperty("top",g+"px","important"),_.style.setProperty("height","calc(100vh - "+g+"px)","important"),_.style.setProperty("margin-top","0","important"),y.style.setProperty("z-index","1100","important"),_.style.setProperty("z-index","1030","important"),u()}catch{}}a(k,"syncSidebarUnderNavbar");function P(){let _=p.getElementById("sidebar"),y=p.getElementById("menus");if(!_||!y)return;if(n.__urpppSidebarMenuObserver){try{n.__urpppSidebarMenuObserver.disconnect()}catch{}n.__urpppSidebarMenuObserver=null}let S=p.getElementById("urppp-menus"),g=_.querySelector(".urppp-sidebar-header");S&&S.remove(),g&&g.remove(),k();let w=new Set;y.querySelectorAll("li.active").forEach($=>{$.id&&w.add($.id)});function M($){return Array.from($.children).filter(H=>H.tagName==="LI").map(H=>{let G=H.querySelector(":scope > a"),U=G?.querySelector(".menu-text"),et=U?U.textContent.trim():G?Array.from(G.childNodes).filter(st=>st.nodeType===d.TEXT_NODE).map(st=>st.textContent).join("").trim():"",it=G?.querySelector(".menu-icon"),mt=it?Array.from(it.classList).filter(st=>st!=="menu-icon").join(" "):"",V=H.querySelector(":scope > .submenu"),Q=V?M(V):[];Q=Q.filter(st=>st.text&&(st.text.trim()||st.href&&st.href!=="#"));let ot=G?.getAttribute("href")||"#",X=G?.getAttribute("target")||"",ct=H.getAttribute("onclick")||G?.getAttribute("onclick")||"",rt=H.id;return ot!=="#"&&!ot.startsWith("javascript")?{id:rt,text:et,iconClass:mt,children:[],href:ot,target:X,onclick:ct}:Q.length===1&&Q[0].children.length===0?{id:rt||Q[0].id,text:et,iconClass:mt||Q[0].iconClass,children:[],href:Q[0].href||ot,target:Q[0].target||X,onclick:Q[0].onclick||ct}:{id:rt,text:et,iconClass:mt,children:Q,href:ot,target:X,onclick:ct}})}a(M,"parseMenu");let C=M(y);y.style.display="none";let f=p.createElement("div");f.className="urppp-sidebar-header",f.style.cssText="position:absolute;top:0;left:0;right:0;z-index:100;display:flex;align-items:center;justify-content:flex-end;padding:14px 14px 12px;border-bottom:1px solid var(--border);background:var(--surface)";let b=p.createElement("button");b.type="button",b.className="urppp-sidebar-toggle",b.innerHTML='<i class="fa fa-angle-left" aria-hidden="true"></i>',b.title="收起侧边栏",typeof b.setAttribute=="function"&&b.setAttribute("aria-label","收起侧边栏");let v=a(()=>!!(n.matchMedia&&n.matchMedia("(max-width: 991px)").matches),"isNarrow"),x=a($=>{if($&&($.preventDefault(),$.stopPropagation()),v()){_.classList.remove("display"),u();return}let H=p.getElementById("sidebar-collapse");H&&H.click()},"doToggle");b.addEventListener("click",x),f.appendChild(b);let E=a(()=>{let $=v(),H=p.body.classList.contains("menu-min")||_.classList.contains("menu-min"),G=$?"关闭菜单":H?"展开侧边栏":"收起侧边栏";b.innerHTML=$?'<i class="fa fa-times" aria-hidden="true"></i>':H?'<i class="fa fa-angle-right" aria-hidden="true"></i>':'<i class="fa fa-angle-left" aria-hidden="true"></i>',b.title=G,typeof b.setAttribute=="function"&&b.setAttribute("aria-label",G),!$&&H?(f.style.justifyContent="center",f.style.padding="12px 0"):(f.style.justifyContent="flex-end",f.style.padding="")},"syncToggle"),T=new c(E);T.observe(p.body,{attributes:!0,attributeFilter:["class"]}),T.observe(_,{attributes:!0,attributeFilter:["class"]}),n.__urpppSidebarMenuObserver=T,E();let I=p.createElement("ul");I.id="urppp-menus",I.style.cssText="margin-top:50px;list-style:none;padding:10px 12px 24px;overflow-y:auto;max-height:calc(100vh - 64px)";function L($){p.querySelectorAll("#urppp-menus .urppp-nav-item").forEach(G=>G.classList.remove("active"));let H=$;for(;H&&H.id!=="urppp-menus";)H.classList.contains("urppp-nav-item")&&H.classList.add("active"),H=H.parentElement}a(L,"setActiveBranch");function O($,H){let G=p.createElement("li");G.className="urppp-nav-item",$.id&&(G.id=$.id);let U=$.children.length>0,et=$.href||"#",it=et!=="#"&&!et.startsWith("javascript"),mt=p.createElement("a");if(mt.className="urppp-nav-link",mt.href=it?et:"javascript:void(0)",$.target&&mt.setAttribute("target",$.target),$.iconClass){let Q=p.createElement("i");$.iconClass.split(" ").forEach(ot=>{ot&&Q.classList.add(ot)}),mt.appendChild(Q)}let V=p.createElement("span");if(V.className="urppp-nav-text",V.textContent=$.text,V.title=$.text,mt.appendChild(V),U){let Q=p.createElement("i");Q.className="urppp-nav-arrow fa fa-angle-down",Q.addEventListener("click",ot=>{ot.preventDefault(),ot.stopPropagation(),G.classList.toggle("open")}),mt.appendChild(Q)}if(G.appendChild(mt),mt.addEventListener("click",Q=>{if(L(G),!it&&U)Q.preventDefault(),G.classList.toggle("open");else if(it)return}),U){let Q=p.createElement("ul");Q.className="urppp-nav-submenu",$.children.forEach(ot=>O(ot,Q)),G.appendChild(Q)}$.id&&w.has($.id)&&G.classList.add("active"),H.appendChild(G)}a(O,"buildItem"),C.forEach($=>O($,I)),I.querySelectorAll(".urppp-nav-item.open").forEach($=>$.classList.remove("open")),_.insertBefore(f,_.firstChild),_.appendChild(I)}return a(P,"rebuildSidebarCompletely"),{rebuildSidebarCompletely:P,syncMobileContentOffset:u,syncSidebarUnderNavbar:k}}a(Fi,"createSidebarController");function Di({theme:p,settings:n,documentRef:c=document,windowRef:d=window}){function u(S){if(!S)return;let g=p.getSkin(),w=p.skinSupportsFixedPalettes(g),M=p.getCurrent(),C=w?p.getBrutalActivePalette():null,f=w?p.getBrutalSelectedPalette():null;S.querySelectorAll(".urppp-nav-dot[data-theme]").forEach(b=>{let v=b.dataset.theme,x=v==="dark",E=v==="scu-red",T=x&&!p.skinSupportsDark(g)||E&&!p.skinSupportsDynamic(g)&&!w,I=v===M;if(w&&(I=v==="default"&&C.id===p.BRUTAL_DEFAULT_PALETTE||E&&C.id!==p.BRUTAL_DEFAULT_PALETTE),b.disabled=T,b.classList.toggle("urppp-theme-disabled",T),b.classList.toggle("ac",I&&!T),b.setAttribute("aria-disabled",T?"true":"false"),v==="default")b.style.background=w?p.getBrutalPaletteById(p.BRUTAL_DEFAULT_PALETTE).accent:"#F1F3F5",b.title=w?"默认高能粉":"简约白";else if(x)b.style.background=T?"#A7A7A7":"#0B0F14",b.title=T?"当前界面风格不支持暗色模式":"深邃暗";else if(E)if(T)b.style.background="#A7A7A7",b.title="当前界面风格不支持动态配色";else if(w)b.style.background=f.accent,b.title="高对比配色："+f.name;else{let L=p.getAccent()||p.DEFAULT_SEED;try{let O=p.buildSchemePreview(L,p.getScheme());b.style.background="linear-gradient(135deg, "+O.primary+" 0 55%, "+O.surface+" 55% 100%)"}catch{b.style.background=L}b.title="动态配色"}})}a(u,"syncThemeDotGroup");function k(S){let g=p.getSkin();if(p.skinSupportsFixedPalettes(g)){if(S==="dark")return;p.getCurrent()!=="default"&&p.applyTheme("default",{manual:!0}),S==="default"&&p.setBrutalPalette(p.BRUTAL_DEFAULT_PALETTE),S==="scu-red"&&p.setBrutalPalette(p.getBrutalSelectedPalette().id);return}p.isThemeModeAvailable(S,g)&&p.applyTheme(S,{manual:!0})}a(k,"handleThemeDotClick");function P(){u(c.getElementById("urppp-nav-theme"))}a(P,"syncNavbarThemeUI");function _(){try{let S=c.getElementById("navbar")||c.querySelector(".navbar");if(!S)return;if(c.getElementById("urppp-nav-theme")){P();return}let g=S.querySelector(".navbar-header .navbar-brand")||S.querySelector(".navbar-brand")||S.querySelector(".navbar-header");if(!g)return;let w=c.createElement("div");w.id="urppp-nav-theme",w.innerHTML=['<button type="button" class="urppp-nav-dot" data-theme="default" title="简约白" style="background:#F1F5F9"></button>','<button type="button" class="urppp-nav-dot" data-theme="dark" title="深邃暗" style="background:#0B0F17"></button>','<button type="button" class="urppp-nav-dot" data-theme="scu-red" title="动态配色" style="background:#B53434"></button>','<button type="button" class="urppp-nav-settings" id="urppp-nav-settings" title="设置" aria-label="设置">','  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">','    <circle cx="12" cy="12" r="3"></circle>','    <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"></path>',"  </svg>","</button>"].join(""),g.parentElement?(g.parentElement.style.setProperty("display","flex","important"),g.parentElement.style.setProperty("align-items","center","important"),g.nextSibling?g.parentElement.insertBefore(w,g.nextSibling):g.parentElement.appendChild(w)):g.appendChild(w),w.style.setProperty("display","inline-flex","important"),w.style.setProperty("align-items","center","important"),w.style.setProperty("height","36px","important"),w.querySelectorAll(".urppp-nav-dot[data-theme]").forEach(M=>{M.addEventListener("click",()=>{k(M.dataset.theme),P();try{n.syncSettingsPanelUI()}catch{}})}),w.querySelector("#urppp-nav-settings").addEventListener("click",M=>{M.preventDefault(),M.stopPropagation(),n.openSettingsPanel()}),n.ensureSettingsPanel(),P();try{d.__urpppCleanMode&&d.__urpppCleanMode.inject()}catch{}}catch(S){console.warn("[URP++] navbar theme switch inject failed",S)}}a(_,"injectNavbarThemeSwitch");function y(){let g=c.getElementById("navbar")?.querySelector(".ace-nav");try{_()}catch{}if(!g)return;function w(E,T){Object.entries(T).forEach(([I,L])=>E.style.setProperty(I,L,"important"))}a(w,"force"),Array.from(g.childNodes).forEach(E=>{E.nodeType===Node.TEXT_NODE&&!E.textContent.trim()&&E.remove()}),g.querySelectorAll(":scope > li").forEach(E=>{w(E,{display:"inline-flex","align-items":"center","vertical-align":"middle",margin:"0",padding:"0","text-align":"left"})}),g.querySelectorAll(":scope > li > a").forEach(E=>{w(E,{display:"inline-flex","align-items":"center","justify-content":"center",height:"36px",padding:"0 4px","flex-wrap":"nowrap","vertical-align":"middle","text-decoration":"none"}),E.style.lineHeight="1"}),g.querySelectorAll(":scope > li > a > .ace-icon, :scope > li > a > .glyphicon, :scope > li > a > .fa").forEach(E=>{w(E,{top:"auto","vertical-align":"middle","line-height":"1","margin-top":"0"})});let M=g.querySelector(':scope > li > a[href*="customerServiceCenter"]');M&&(w(M,{width:"28px","justify-content":"center"}),M.style.padding="0 4px");let C=c.getElementById("clickdiv"),f=c.getElementById("form-search"),b=c.getElementById("search-input"),v=c.getElementById("intellegenceUDiv");if(v&&(v.style.setProperty("position","relative","important"),v.style.setProperty("z-index","30","important"),v.style.setProperty("display","inline-flex","important"),v.style.setProperty("align-items","center","important"),v.style.setProperty("justify-content","center","important"),v.style.setProperty("width","32px","important"),v.style.setProperty("height","36px","important"),v.style.setProperty("vertical-align","middle","important"),v.style.setProperty("margin","0","important"),v.style.setProperty("padding","0","important")),C&&f){C.removeAttribute("onclick"),w(C,{"background-color":"transparent",position:"relative",display:"inline-flex","align-items":"center","justify-content":"center",width:"32px",height:"32px","border-radius":"8px","line-height":"1","z-index":"30"});let E=c.getElementById("clicki");E&&w(E,{color:"var(--text-secondary)","margin-top":"0"}),C.__urpppNavbarClickBound||(C.__urpppNavbarClickBound=!0,C.addEventListener("mouseenter",()=>C.style.setProperty("background-color","var(--input-bg)","important")),C.addEventListener("mouseleave",()=>C.style.setProperty("background-color","transparent","important")),C.addEventListener("click",L=>{L.preventDefault(),L.stopPropagation(),f.dataset.open==="1"?(f.style.width="0px",f.style.opacity="0",f.dataset.open="0"):(f.style.width="180px",f.style.opacity="1",f.dataset.open="1",b&&setTimeout(()=>b.focus(),50))})),d.__urpppNavbarOutsideClickBound||(d.__urpppNavbarOutsideClickBound=!0,c.addEventListener("click",L=>{let O=c.getElementById("clickdiv"),$=c.getElementById("form-search");!O||!$||$.dataset.open!=="1"||!O.contains(L.target)&&!$.contains(L.target)&&($.style.width="0px",$.style.opacity="0",$.dataset.open="0")})),w(f,{position:"absolute",right:"34px",top:"50%",transform:"translateY(-50%)",left:"auto",margin:"0","z-index":"10",background:"transparent",border:"none","box-shadow":"none",overflow:"hidden",padding:"0",transition:"width .2s ease, opacity .2s ease"});let T=f.dataset.open==="1"?"160px":"0px";f.style.width!==T&&(f.style.width=T,f.style.opacity=f.dataset.open==="1"?"1":"0"),b&&w(b,{"background-color":"var(--input-bg)",border:"1px solid var(--border)",color:"var(--text)","border-radius":"8px",height:"32px",padding:"0 12px","line-height":"32px",width:"100%"});let I=f.querySelector(".input-icon > .ace-icon.fa-search");I&&(I.style.display="none")}let x=g.querySelector(":scope > li.light-blue > a");if(x){w(x,{display:"inline-flex","align-items":"center",gap:"6px"});let E=x.querySelector(".user-info");E&&(w(E,{display:"inline-flex","align-items":"center",gap:"4px","max-width":"none","white-space":"nowrap","vertical-align":"middle","line-height":"1","margin-top":"-12px"}),Array.from(E.childNodes).forEach(I=>{I.nodeType===Node.TEXT_NODE&&(I.textContent=I.textContent.replace(/\s+/g,"").trim())}),Array.from(E.children).forEach(I=>{w(I,{display:"inline","white-space":"nowrap","vertical-align":"middle","line-height":"1",margin:"0",padding:"0"}),I.tagName==="SMALL"&&I.style.setProperty("font-size","inherit","important")}));let T=x.querySelector(".nav-user-photo");T&&(T.alt=(T.alt||"").replace(/\s+/g,"").trim(),w(T,{"vertical-align":"middle",display:"inline-block",width:"30px",height:"30px"}))}}return a(y,"rebuildNavbar"),{handleThemeDotClick:k,injectNavbarThemeSwitch:_,rebuildNavbar:y,syncNavbarThemeUI:P,syncThemeDotGroup:u}}a(Di,"createNavbarController");(function(){"use strict";try{let t=typeof navigator<"u"&&navigator.userAgent||"";if(/Android|iPhone|iPad|iPod|Mobile/i.test(t)){document.documentElement&&document.documentElement.classList.add("urppp-mobile");let e=document.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",e.content="width=device-width, initial-scale=1",(document.head||document.documentElement||document).appendChild(e))}}catch{}let p="1.9.5";if(/^id\./i.test(String(location.hostname||""))){try{let t=co({GM:{getValue:typeof GM_getValue=="function"?GM_getValue:null,setValue:typeof GM_setValue=="function"?GM_setValue:null,xmlHttp:typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:null,addStyle:typeof GM_addStyle=="function"?GM_addStyle:null},doc:document,hostInfo:{version:p},uiDeps:{openSubpanel:a(()=>{},"openSubpanel")}}),e=a(()=>{try{t.bootFromCache("assist")}catch{}},"boot");document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}catch{}return}let n={mainRaw:"https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/urppp.user.js",assistRaw:"https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/urpppp.user.js",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",changelogPage:"https://github.com/chaolan2019/SCU-URP-plusplus/blob/main/CHANGELOG.md",greasySearch:"https://greasyfork.org/zh-CN/scripts?q=SCU+URP%2B%2B",versionJson:"version.json",sourceUrls:a(t=>[`https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/${t}`,`https://cdn.jsdelivr.net/gh/chaolan2019/SCU-URP-plusplus@main/${t}`,`https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/${t}`],"sourceUrls")},c="urppp_auto_update_check_v1",d="urppp_skin_v1",u=[{id:"apple",name:"类Apple风格",desc:"系统灰底、链接蓝、大圆角与轻阴影，默认精修方向。",ready:!0,dark:!0,dynamic:!0,installed:!0,builtin:!0,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"editorial",name:"编辑杂志",desc:"衬线标题、无框版面与淡分割线。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!0,builtin:!0,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"flat",name:"极简扁平",desc:"无阴影、硬边与纯色层次，冷硬清晰。",ready:!0,dark:!0,dynamic:!0,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"organic",name:"自然有机",desc:"奶油底与大地色，温暖圆角。不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"brutal",name:"新野兽派",desc:"高对比画布、粗边框与硬阴影。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,palettes:!0,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"neu",name:"新拟物",desc:"同色双阴影凸起/内凹，立体柔和。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}}],k=GM_addStyle(`
  ...
  `;function _(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(_,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function g(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=_("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=_("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(g,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{g(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",M="urppp_accent_v1",C="urppp_accent_presets_v1",f="urppp_scheme_v1",b="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",T="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",$="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:gt,syncThemeDotGroup:Z}=Di({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Kt,getAccent:Qt,getBrutalActivePalette:qo,getBrutalPaletteById:ir,getBrutalSelectedPalette:Lo,getCurrent:Jt,getScheme:Ie,getSkin:Zt,isThemeModeAvailable:pr,setBrutalPalette:To,skinSupportsDark:Be,skinSupportsDynamic:Fe,skinSupportsFixedPalettes:zo},settings:{ensureSettingsPanel:nn,openSettingsPanel:rn,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let j=document.createElement("li");j.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",j.appendChild(o),r.appendChild(j)}let l=o.closest("li")||o.parentElement,h=Array.from(r.children).find(j=>{let R=j.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),m=Array.from(r.children).find(j=>j.classList.contains("light-blue")),A=h||m||null;A&&l&&A!==l&&((l.compareDocumentPosition(A)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,A)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let q=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),q&&s.parentElement!==q&&q.appendChild(s),q&&q.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let N=s.querySelector("#search-input"),z=s.querySelector("form");if(!N||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let D=s.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),N.style.setProperty("display","block","important"),N.style.setProperty("width","100%","important"),N.style.setProperty("height","36px","important"),N.style.setProperty("box-sizing","border-box","important"),N.style.setProperty("padding","0 12px","important"),N.style.setProperty("border","1px solid var(--border)","important"),N.style.setProperty("border-radius","var(--radius-sm)","important"),N.style.setProperty("background","var(--input-bg)","important"),N.style.setProperty("color","var(--text)","important");let J=a(j=>{s.dataset.open=j?"1":"0",s.style.setProperty("width",j?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",j?"1":"0","important"),s.style.setProperty("pointer-events",j?"auto":"none","important"),i.setAttribute("aria-expanded",j?"true":"false"),j&&setTimeout(()=>N.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",j=>{j.preventDefault(),j.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",j=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(j.target)||F?.contains(j.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function B(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,l=0,h=(o+i)/2;if(o!==i){let m=o-i;switch(l=h>.5?m/(2-o-i):m/(o+i),o){case t:s=(e-r)/m+(e<r?6:0);break;case e:s=(r-t)/m+2;break;default:s=(t-e)/m+4;break}s/=6}return{h:s*360,s:l,l:h}}a(B,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,i=o*(1-Math.abs(t/60%2-1)),s=r-o/2,l=0,h=0,m=0;return t<60?(l=o,h=i):t<120?(l=i,h=o):t<180?(h=o,m=i):t<240?(h=i,m=o):t<300?(l=i,m=o):(l=o,m=i),{r:Math.round((l+s)*255),g:Math.round((h+s)*255),b:Math.round((m+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:i,b:s}=Y(t,e,r);return vr(o,i,s)}a(tt,"hslHex");function bt(t){let{r:e,g:r,b:o}=er(Gt(t)||mt),i=B(e,r,o);return i.s<.12&&(i.s=.18),i}a(bt,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,i=Math.max(0,Math.min(.95,e));return tt(t,i,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Gt(t)||mt,{h:r,s:o}=bt(e),i=Ft(r),s=Math.min(.72,Math.max(.28,o*.78));return ht(i,s,42)}a(Pt,"companionColor");function It(t,e){let r=Gt(t)||mt,{h:o,s:i}=bt(r),l=zt(e||ot),h=Math.min(.92,Math.max(.35,i*l.chroma)),m=Pt(r),{h:A}=bt(m),q=ht(o,h,l.primaryTone),N=ht(o,h,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),D,J,j;l.whiteCard?(D=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",j="#E5E7EB"):l.duo?(D=Bt(yt(m,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),j=Bt("#E5E7EB",m,.16)):(D=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),j=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?m:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),F=ht(o,Math.min(.45,h*.55),14),K=ve(ht(o,h*.3,34),.88),ut=ve(ht(o,h*.22,46),.76),vt=ve(q,.18),Et="0 4px 12px "+ve(q,.1)+", 0 1px 2px "+ve(q,.05);return{"--bg":D,"--surface":J,"--text":F,"--text-secondary":K,"--text-muted":ut,"--border":j,"--border-focus":q,"--input-bg":R,"--primary":q,"--primary-hover":N,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":m}}a(It,"buildMaterialSchemeVars");function Kt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Kt,"buildSchemePreview");function $e(t){let e=Gt(t)||Qt()||mt;return X.map(r=>Object.assign({},r,Kt(e,r.id)))}a($e,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Qt(){return Gt(GM_getValue(M,""))||""}a(Qt,"getAccent");function Ie(){let t=String(GM_getValue(f,ot)||ot);return X.some(e=>e.id===t)?t:ot}a(Ie,"getScheme");function da(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(f,e),e}a(da,"setScheme");function ji(t,e){if(!t)return;let r=Gt(t);if(r){if(GM_setValue(M,r),e&&e.scheme&&da(e.scheme),e&&e.skipTheme){let o=oo(r,.15),i=ve(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",i);try{gt()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{gt()}catch{}try{Dt()}catch{}}}a(ji,"applyAccent");function ua(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(ua,"getAccentPresets");function Oi(t){let e=Gt(t||Qt()||mt);if(!e)return ua();let r=ua();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(Oi,"saveAccentPreset");function Xt(){try{return!!GM_getValue(b,!1)}catch{return!1}}a(Xt,"isThemeFollowSystem");function Pr(t){return GM_setValue(b,!!t),!!t}a(Pr,"setThemeFollowSystem");function ma(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(ma,"isCleanDefault");function Hi(t){return GM_setValue(v,!!t),!!t}a(Hi,"setCleanDefault");function ha(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(ha,"isCleanAnalysisDirect");function Ri(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(Ri,"setCleanAnalysis");function ke(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(ke,"isAppleEdgeLine");function Ui(t){return GM_setValue(E,!!t),!!t}a(Ui,"setAppleEdgeLine");function ba(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(ba,"isAutoUpdateCheck");function Wi(t){return GM_setValue(c,!!t),!!t}a(Wi,"setAutoUpdateCheck");function zr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(zr,"readJsonSetting");function Lr(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(Lr,"writeJsonSetting");function Ae(){return uo(zr(O,null))}a(Ae,"getPrivacySettings");function fa(t){return Lr(O,uo(t))}a(fa,"setPrivacySettings");function Ne(){return Er(zr($,null))}a(Ne,"getCustomIdentity");function Ao(t){return Lr($,Er(t))}a(Ao,"setCustomIdentity");function ga(){let t=zr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ga,"getScheduleFirstMondayMap");function So(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ga();r[String(t)]=String(e),Lr(H,r)}a(So,"rememberScheduleFirstMonday");function qr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=zr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},i={enabled:!!o.enabled,mapping:Me(o.mapping||Ar)};return et="",i}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:Me(Ar)}}}a(qr,"getScheduleJsonFormatSettings");function _o(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:Me(e.mapping||Ar)};return et="",Lr(G,r)}a(_o,"setScheduleJsonFormatSettings");function Eo(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(Eo,"isHomePage");function Tr(){try{return!!GM_getValue(T,!1)}catch{return!1}}a(Tr,"isFollowUseDynamic");function xa(t){return GM_setValue(T,!!t),!!t}a(xa,"setFollowUseDynamic");function Gi(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Gi,"systemPrefersDark");function me(){return Gi()&&Be()?"dark":Tr()&&Fe()?"scu-red":"default"}a(me,"resolveFollowThemeName");function pr(t,e){return t==="dark"?Be(e):t==="scu-red"?Fe(e):t==="default"}a(pr,"isThemeModeAvailable");function Wt(t,e){e=e||{},!Be()&&Xt()&&Pr(!1),!Fe()&&Tr()&&xa(!1),e.manual&&Pr(!1);let r;e.system||Xt()&&!e.manual?r=me():(r=Ct[t]?t:Jt()||"default",Ct[r]||(r="default")),pr(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(w,r),ue();let i=document.getElementById("urppp-theme-vars")||(()=>{let A=document.createElement("style");return A.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(A),A})(),s=Qt(),l=Object.assign({},o.vars);if(r==="scu-red"){let A=s||mt,q=Ie();l=Object.assign(l,It(A,q));let N=l["--primary"]||A,z=l["--primary-hover"]||oo(N,.12);document.documentElement.style.setProperty("--urppp-accent",N),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||ve(N,.15)),document.documentElement.style.setProperty("--urppp-seed",A),document.documentElement.style.setProperty("--urppp-scheme",q)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let h=":root {";for(let[A,q]of Object.entries(l))h+=`${A}:${q};`;h+="}",i.textContent=h,document.body&&(document.body.style.fontFamily=o.font);try{let A=document.documentElement;A.dataset.urpppTheme=r,A.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),A.classList.add("urppp-theme-"+r),A.classList.toggle("urppp-theme-follow",Xt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Xt()))}catch{}try{ee()}catch{}try{gt()}catch{}try{Dt()}catch{}try{Vo()}catch{}try{rs()}catch{}let m=document.getElementById("urppp-boot-loader");m&&(m.style.fontFamily=o.font)}a(Wt,"applyTheme");function Jt(){return GM_getValue(w,"default")}a(Jt,"getCurrent");function he(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(he,"themeDownloaded");function be(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(be,"localThemes");function Co(t,e){try{let r=be();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Co,"saveLocalTheme");function Ji(t){try{let e=be();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(Ji,"removeLocalTheme");function Vi(){try{if(typeof GM_listValues!="function")return;let t=be(),e=!1;GM_listValues().forEach(r=>{let o=/^urppp_theme_css_(.+)$/.exec(r);if(!o)return;let i=o[1];u.some(s=>s.id===i)||t[i]||(t[i]={name:i,desc:"下载主题",author:"",version:"1.0.0"},e=!0)}),e&&GM_setValue("urppp_local_themes",JSON.stringify(t))}catch{}}a(Vi,"migrateDownloadedThemes");function ya(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(ya,"storeThemeStyleEl");function Yi(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(Yi,"removeStoreThemeStyle");function Po(){Vi();let t=new Set,e=a(r=>{if(t.has(r))return;t.add(r);let o="";try{o=GM_getValue("urppp_theme_css_"+r,"")||""}catch{}o&&(ya(r).textContent=o);let i="";try{i=GM_getValue("urppp_card_css_"+r,"")||""}catch{}i&&Se([{id:r,cardCss:i}])},"injectOne");u.forEach(r=>e(r.id)),Object.keys(be()).forEach(r=>e(r));try{ee()}catch{}}a(Po,"injectAllStoreThemeStyles");function Zt(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||he(e.id))||be()[t]&&he(t)?t:"apple"}a(Zt,"getSkin");function va(t,e){let r=t||Zt(),o=u.find(i=>i.id===r);return!!(o&&o[e])}a(va,"getSkinCapability");function Be(t){return va(t,"dark")}a(Be,"skinSupportsDark");function Fe(t){return va(t,"dynamic")}a(Fe,"skinSupportsDynamic");function zo(t){return va(t,"palettes")}a(zo,"skinSupportsFixedPalettes");function ir(t){return Q.find(e=>e.id===t)||Q[0]}a(ir,"getBrutalPaletteById");function Lo(){let t=String(GM_getValue(I,"acid")||"acid"),e=ir(t);return e.id===V?ir("acid"):e}a(Lo,"getBrutalSelectedPalette");function qo(){let t=String(GM_getValue(L,V)||V);return ir(t)}a(qo,"getBrutalActivePalette");function To(t,e){let r=e||{},o=ir(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{ee()}catch{}try{gt()}catch{}try{Dt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}}a(To,"setBrutalPalette");function Qi(t){let e=t||Zt();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&ke()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&ke()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Qi,"getSkinShapeOverrides");function De(){try{let t=Zt();if(t==="apple")return ke()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(De,"urpppCardBorderValue");function ee(){let t=Zt();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&ke();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=Qi(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=qo();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=ke(),l=s?"1px solid rgba(0,0,0,0.08)":"none",h=s?"1px solid rgba(255,255,255,0.10)":"none",m=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+h+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+m+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let i=document.head||document.documentElement;e.parentNode===i&&i.lastElementChild!==e&&i.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Yt(document)}catch{}},0)}a(ee,"applySkinAttr");function Mo(t){let e=u.find(i=>i.id===t&&i.ready&&(i.installed!==!1||he(i.id))),r=!e&&be()[t]&&he(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||xa(!1),!o.dark&&Xt()&&Pr(!1);let i=Xt(),s=i?me():Jt(),l=pr(s,e.id)?s:"default";ee(),Wt(l,{system:i})}catch{try{ee()}catch{}}try{Dt()}catch{}try{gt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}return!0}a(Mo,"setSkin");function Xi(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Xt())try{Wt(me(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(Xi,"bindSystemThemeListener");try{Xt()?Wt(me(),{system:!0}):Wt(Jt())}catch{}try{ee()}catch{}try{Xi()}catch{}function Ki(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let i=e.match(o);if(i)return i[0].trim()}return""}a(Ki,"extractLoginErrorMessage");function $o(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout($o,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=Ki(e),i=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let h=location.pathname==="/loginEn",m=a((R,F)=>h?F:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      ${i}
    </div>`}a(bs,"themeStoreCard");async function $a(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await ge()).filter(o=>o.type==="theme"&&!he(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Se(r),e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>bs(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>fs(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a($a,"fetchCatalogThemes");async function fs(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await ge()).find(l=>l.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o=await dn(r);if(o==="fail"){Re("签名校验失败：该条目可能被篡改，已停止下载","error"),e.disabled=!1,e.textContent="下载";return}if(o==="unknown"&&r._srcPub&&!await cn("该源无有效签名校验，可能被篡改。是否自担风险继续下载？")){e.disabled=!1,e.textContent="下载";return}let i="";for(let l of r.entry)try{let h=await fetch(l,{cache:"no-store"});if(h.ok){i=await h.text();break}}catch{}if(!i){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,i)}catch{}if(u.some(l=>l.id===t)||Co(t,{name:r.name||t,desc:r.desc||"下载主题",author:r.author||"",version:r.version||"1.0.0"}),r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{ya(t).textContent=i}catch{}try{Se([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;let s=e.closest&&e.closest(".urppp-store-inline");if(s){try{let l=s.querySelector("#urppp-theme-manage");l&&await jr(l)}catch{}try{$a(s)}catch{}}try{Dt()}catch{}}a(fs,"downloadStoreTheme");function gs(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,i=e&&e.repo||t.repo,s=i?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(i)}">仓库</button>`:"",l=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"",h=Zt()===t.id;return`<div class="urppp-skin-card${h?" is-active":""}" data-skin="${at(t.id)}">
      ...
      ${o}${s}
    </div>`}a(gs,"themeManageCardHtml");async function jr(t){if(!t)return;let e=[];try{e=await ge()}catch{}let r=be(),o=Object.keys(r).map(s=>({id:s,name:r[s].name||s,desc:r[s].desc||"本地主题",version:r[s].version||"1.0.0",author:r[s].author||"本地",installed:!1})),i=u.filter(s=>s.installed!==!1||he(s.id)).concat(o.filter(s=>!u.some(l=>l.id===s.id)));if(!i.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}Se(i.map(s=>e.find(l=>l.id===s.id))),t.innerHTML=`<div class="urppp-store-theme-grid">${i.map(s=>gs(s,e.find(l=>l.id===s.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(s=>s.addEventListener("click",()=>{if(Mo(s.dataset.themeUse)){try{Dt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(l=>{let h=l.dataset.skin,m=l.querySelector(".urppp-skin-apply"),A=Zt()===h;l.classList.toggle("is-active",A),m&&(m.classList.toggle("is-current",A),m.disabled=A,m.textContent=A?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(s=>s.addEventListener("click",()=>{let l=s.dataset.themeDel,h=Zt()===l;try{GM_setValue("urppp_theme_css_"+l,"")}catch{}try{GM_setValue("urppp_card_css_"+l,"")}catch{}Ji(l),Yi(l);try{if(h){GM_setValue(d,"apple");try{document.documentElement.removeAttribute("data-urppp-skin")}catch{}try{document.body&&document.body.removeAttribute("data-urppp-skin")}catch{}ee();let A=Xt(),q=A?me():Jt();Wt(q,{system:A})}}catch{}try{Dt()}catch{}let m=t.closest(".urppp-store-inline");if(m){try{jr(t)}catch{}try{$a(m)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(s=>s.addEventListener("click",()=>{try{window.open(s.dataset.repo,"_blank","noopener")}catch{}}))}a(jr,"fetchThemeManage");function sn(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(sn,"storeManageSettingsHtml");let xs=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];function ur(){try{let t=JSON.parse(GM_getValue("urppp_store_sources","[]"));return Array.isArray(t)?t:[]}catch{return[]}}a(ur,"getCustomSources");function Ia(t){try{GM_setValue("urppp_store_sources",JSON.stringify(t))}catch{}}a(Ia,"saveCustomSources");let _e=null;async function ge(t){if(_e&&!t)return _e;let e=a((q,N)=>Promise.race([q,new Promise((z,D)=>setTimeout(()=>D(new Error("timeout")),N))]),"withTimeout"),r=a(async q=>{try{let N=await e(fetch(q,{cache:"no-store"}),5e3);if(!(N&&N.ok))return null;let z=await N.json();return z&&Array.isArray(z.items)?z:null}catch{return null}},"fetchCatalogDoc"),o=await Promise.allSettled(xs.map(q=>r(q))),i=null;for(let q of o){if(!(q.status==="fulfilled"&&q.value&&Array.isArray(q.value.items)))continue;let N=q.value.items.some(z=>z.type==="theme"&&z.cardCss);(!i||N&&!i.items.some(z=>z.type==="theme"&&z.cardCss))&&(i=q.value)}let s=i&&i.items||[],l=ur().filter(q=>q&&q.url&&q.enabled!==!1),h=await Promise.allSettled(l.map(async q=>{let N=await r(q.url);return{doc:N,pubkey:N?N.pubkey:""}})),m=[...s],A=new Set(m.map(q=>q&&q.id).filter(Boolean));for(let q of h){if(!(q.status==="fulfilled"&&q.value&&q.value.doc))continue;let N=q.value.pubkey||"";for(let z of q.value.doc.items)!z||!z.id||A.has(z.id)||(A.add(z.id),N&&(z._srcPub=N),m.push(z))}return _e=m,m}a(ge,"fetchCatalogList");let Or=(function(){try{if(typeof crypto<"u"&&crypto&&crypto.subtle)return crypto.subtle;let t=typeof unsafeWindow<"u"&&unsafeWindow?unsafeWindow:typeof window<"u"?window:null;if(t&&t.crypto&&t.crypto.subtle)return t.crypto.subtle}catch{}return null})();function Na(t){if(Array.isArray(t))return t.map(Na);if(t&&typeof t=="object"){let e={};for(let r of Object.keys(t).filter(o=>o!=="signature"&&o!=="_srcPub").sort())e[r]=Na(t[r]);return e}return t}a(Na,"normalizeEntry");function ln(t){try{let e=atob(t),r=new Uint8Array(e.length);for(let o=0;o<e.length;o+=1)r[o]=e.charCodeAt(o);return r}catch{return null}}a(ln,"b64ToU8");async function ys(t,e){if(!Or)return null;if(!e||!t||!t.signature)return!1;try{let r=ln(e);if(!r)return null;let o=await Or.importKey("raw",r,{name:"Ed25519"},!1,["verify"]),i=ln(t.signature);if(!i)return!1;let s=JSON.stringify(Na(t)),l=await Or.digest("SHA-256",new TextEncoder().encode(s)),h=new Uint8Array(l);return await Or.verify({name:"Ed25519"},o,i,h)}catch{return null}}a(ys,"verifyEntrySignature");function Re(t,e){try{let r=document.getElementById("urppp-toast");r||(r=document.createElement("div"),r.id="urppp-toast",r.className="urppp-toast",(document.body||document.documentElement).appendChild(r)),r.textContent=t,r.className="urppp-toast show"+(e==="error"?" error":""),clearTimeout(r._t),r._t=setTimeout(()=>{r.className="urppp-toast"},3200)}catch{try{window.alert(t)}catch{}}}a(Re,"toast");function cn(t){return new Promise(e=>{try{let r=document.getElementById("urppp-confirm");r||(r=document.createElement("div"),r.id="urppp-confirm",r.className="urppp-confirm",r.innerHTML='<div class="urppp-confirm-txt"></div><div class="urppp-confirm-ops"><button type="button" class="urppp-set-btn ghost" data-cac>取消</button><button type="button" class="urppp-set-btn" data-ok>继续</button></div>',(document.body||document.documentElement).appendChild(r)),r.querySelector(".urppp-confirm-txt").textContent=t,r.classList.add("show");let o=a(i=>{r.classList.remove("show"),r.querySelector("[data-ok]").onclick=r.querySelector("[data-cac]").onclick=null,e(i)},"done");r.querySelector("[data-ok]").onclick=()=>o(!0),r.querySelector("[data-cac]").onclick=()=>o(!1)}catch{try{e(window.confirm(t))}catch{e(!1)}}})}a(cn,"confirmBottom");async function dn(t){let e=t&&t._srcPub;if(!e)return"trust";let r=await ys(t,e);return r===!0?"ok":r===!1?"fail":"unknown"}a(dn,"guardEntrySignature");function un(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let i=0;i<Math.max(r.length,o.length);i+=1){let s=r[i]||0,l=o[i]||0;if(s!==l)return s>l}return!1}a(un,"versionGt");function vs(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let i=t.querySelector('[data-theme-use="'+o.id+'"]');i&&un(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(mn(i.closest(".urppp-skin-card"),"主题"),r+=1);let s=t.querySelector('[data-plugin-id="'+o.id+'"]');if(s){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&un(o.version,l.version)&&(mn(s.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(vs,"applyStoreUpdateBadges");function mn(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(mn,"addUpdateBadge");function hn(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),i=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");i(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),i()}),r.addEventListener("click",async()=>{r.disabled=!0;let s=r.textContent;r.textContent="检查中…";try{let l=await ge(),h=vs(t,l);r.textContent=h?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=s,r.disabled=!1},1600)})}a(hn,"bindStoreManageSettings");function ws(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
      ...
      </div>`,pn(t),hn(t),ks(t),fn(t),$a(t),jr(t.querySelector("#urppp-theme-manage"))}a(ws,"renderThemeStoreBody");function bn(){let t=ur();return`<div class="urppp-src-manage">
    ...
    </div>`}a(As,"pluginStoreCard");async function Ss(t){if(!t)return;let e=[];try{e=(await ge()).filter(r=>r.type==="plugin"&&!(_t&&_t.api&&_t.api.isEnabled&&_t.api.isEnabled(r.id)))}catch{}if(!e.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载插件</p><p class="urppp-store-sub">已安装的插件不会再显示在这里。</p></div>';return}t.innerHTML=`<div class="urppp-store-theme-grid">${e.map(r=>As(r)).join("")}</div>`,t.querySelectorAll("[data-plugin-apply]").forEach(r=>r.addEventListener("click",async()=>{r.disabled=!0;let o=r.textContent;r.textContent="下载中…";try{let i=(await ge()).find(l=>l.id===r.dataset.pluginApply),s=i?await dn(i):"trust";if(s==="fail"){Re("签名校验失败：该插件可能被篡改，已停止装载","error"),r.textContent="下载",r.disabled=!1;return}if(s==="unknown"&&i&&i._srcPub&&!await cn("该源无有效签名校验，可能被篡改。是否自担风险继续装载？")){r.textContent="下载",r.disabled=!1;return}_t&&_t.api&&_t.api.install&&await _t.api.install(r.dataset.pluginApply,null),r.textContent="已安装";try{Dt()}catch{}}catch{r.textContent="失败"}setTimeout(()=>{r.textContent=o,r.disabled=!1},1200)})),t.querySelectorAll("[data-repo]").forEach(r=>r.addEventListener("click",()=>{try{window.open(r.dataset.repo,"_blank","noopener")}catch{}}))}a(Ss,"fetchCatalogPlugins");async function gn(t){if(!t)return;let e=[];try{e=await ge()}catch{}let r=_t&&_t.api&&_t.api.list&&_t.api.list()||[];if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}t.innerHTML=r.map(o=>{let i=e.find(h=>h.id===o.id),s=i&&i.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(i.downloads))}</span>`:"",l=o.repo||i&&i.repo?`<button type="button" class="urppp-set-btn ghost" data-repo="${at(o.repo||i.repo)}">仓库</button>`:"";return`<div class="urppp-store-item">
      ...
      </div>`,pn(t),hn(t),_s(t),Ss(t.querySelector('[data-pane="download"]')),gn(t.querySelector("#urppp-plugin-manage"))}a(xn,"renderPluginStoreBody");function _s(t){let e=t.querySelector("[data-add-local-plugin]"),r=t.querySelector("[data-local-plugin-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text();r.value="";try{new Function(i)()}catch(s){Re("本地插件加载失败："+(s&&s.message?s.message:s),"error")}try{gn(t.querySelector("#urppp-plugin-manage"))}catch{}}))}a(_s,"bindLocalPluginImport");function Es(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>Ma("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=Zt();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}let i=be();u.filter(l=>l.installed!==!1||he(l.id)).concat(Object.keys(i).filter(l=>!u.some(h=>h.id===l)).map(l=>({id:l,name:i[l].name||l,desc:i[l].desc||"本地主题",version:i[l].version||"1.0.0",installed:!1}))).forEach(l=>{let h=!!i[l.id],m=document.createElement("div");m.className="urppp-skin-card"+(l.id===o?" is-active":""),m.dataset.skin=l.id;let A=document.createElement("button");A.type="button",A.className="urppp-skin-apply";let q=l.installed!==!1||he(l.id)||h;if(q?l.id===o&&(l.ready||h)?(A.classList.add("is-current"),A.textContent="使用中",A.disabled=!0):A.textContent="应用主题":(A.classList.add("is-disabled"),A.textContent="去下载"),A.addEventListener("click",N=>{if(N.preventDefault(),N.stopPropagation(),!q){Ma("theme");return}if(!(l.id===o&&l.ready)&&Mo(l.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),m.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),m.querySelector(".urppp-skin-name").textContent=l.name,m.querySelector(".urppp-skin-desc").textContent=l.desc,m.appendChild(A),r.appendChild(m),h)try{let N="";try{N=GM_getValue("urppp_card_css_"+l.id,"")||""}catch{}N&&Se([{id:l.id,cardCss:N}])}catch{}})}a(Es,"renderSkinCards");let Ue=[],Fa=!1;function Cs(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,i=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(s=>{if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).finally(()=>{i&&clearTimeout(i)})}a(Cs,"fetchWithTimeout");function Ps(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(i=>{i.status>=200&&i.status<400?r(i.responseText||""):o(new Error("HTTP "+i.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(i){o(i)}})}a(Ps,"gmRequestForUpdate");function zs(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),Cs(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return Ps(t,r);throw o})}a(zs,"fetchTextForUpdate");async function Da(t,e,r=1e3){let o=[],i=t[0],s=t.slice(1),l=a(z=>zs(z,e).then(D=>({url:z,text:D})).catch(D=>(o.push((z.split("/")[2]||z)+": "+(D&&D.message||D)),null)),"grab"),h=l(i),m=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),A=await Promise.race([h,m]);if(A!=="__TIMEOUT__"){if(A&&A.text&&A.text.length>0)return A.text;let D=(await Promise.all(s.map(l))).find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let q=Promise.all(s.map(l)).then(z=>{let D=z.find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),N=h.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([N,q])}a(Da,"fetchFirstAvailable");function Ee(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(Ee,"setUpdateStatus");async function ja(){let t=p,e="",r=!1,o="";try{let s=await Da(n.sourceUrls(n.versionJson)),l=JSON.parse(s);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let s=await Da(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=po(s)}if(!e)throw new Error("无法解析远程主插件版本");let i=wr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:i>0?"update":i===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:r?o:""}}a(ja,"checkMainUpdate");function yn(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let i=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,s=[],l;for(;(l=i.exec(o))!==null;)s.push({ver:l[1],index:l.index,headEnd:i.lastIndex});if(!s.length)return"";for(let m=0;m<s.length;m++){let A=m+1<s.length?s[m+1].index:o.length;s[m].body=o.slice(s[m].index,A).trim()}let h=[];for(let m of s)wr(m.ver,r)>0||wr(m.ver,e)<=0||h.push(m.body);return h.join(`
...
`).trim()}a(yn,"extractChangelogRange");function vn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
    ...
    `,document.documentElement.appendChild(e)}a(vn,"ensureUpdateToastStyles");function Ls(t){let e=String(t||"").replace(/\r\n/g,`
`).trim();if(!e)return'<p class="uuc-meta">暂无更新日志</p>';let r=a(h=>{let m=at(h);return m=m.replace(/`([^`]+)`/g,"<code>$1</code>"),m=m.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),m=m.replace(/\[([^\]]+)\]\((https?:\/\/[^)\s]+)\)/g,'<a href="$2" target="_blank" rel="noopener noreferrer">$1</a>'),m=m.replace(/(^|[^"'>])(https?:\/\/[^\s<]+)/g,'$1<a href="$2" target="_blank" rel="noopener noreferrer">$2</a>'),m},"inline"),o=e.split(`
`),i=[],s=!1,l=a(()=>{s&&(i.push("</ul>"),s=!1)},"closeList");for(let h=0;h<o.length;h++){let A=o[h].replace(/\s+$/,"");if(!A.trim()){l();continue}let q=A.match(/^(#{2,3})\s+(.+)$/);if(q){l();let z=q[1].length,D=q[2];i.push(z===2?`<h2>${r(D)}</h2>`:`<h3>${r(D)}</h3>`);continue}let N=A.match(/^[-*]\s+(.+)$/);if(N){s||(i.push("<ul>"),s=!0),i.push(`<li>${r(N[1])}</li>`);continue}l(),i.push(`<p>${r(A)}</p>`)}return l(),i.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(Ls,"renderChangelogMarkdown");function wn(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(wn,"hideUpdateToast");function qs(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="background-color"&&i.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(qs,"hideChangelogModal");function kn(t,e){vn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,r.addEventListener("click",o=>{(o.target===r||o.target&&o.target.getAttribute&&o.target.getAttribute("data-close")==="1")&&qs(r)}),document.documentElement.appendChild(r)),r.querySelector("h3").textContent=t||"更新日志",r.querySelector(".uuc-body").innerHTML=e||'<p class="uuc-meta">暂无更新日志</p>',r.__closing=!1,r.classList.remove("open","closing"),r.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add("open"))})}a(kn,"openChangelogModal");function Oa(t){vn();let e=document.getElementById("urppp-update-toast");e||(e=document.createElement("div"),e.id="urppp-update-toast",e.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>wn(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let i=o.getAttribute("data-act"),s=e.__pack||{};if(i==="later"){wn(e);return}if(i==="go"){let l=s.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(i==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=s.changelogMd;l||(l=await Da(n.sourceUrls("CHANGELOG.md")),s.changelogMd=l);let h=yn(l,s.local,s.remote),m=h?Ls(h):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';kn("更新日志 "+s.local+" → "+s.remote,m)}catch(l){kn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(Oa,"showUpdateToast");async function Ha(){if(ba()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await ja();t&&t.status==="update"&&Oa(t);let e=await Ts();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Ha,"maybeAutoCheckUpdate");function Ts(){let t=(window.__urpppUpdateCheckers||Ue||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?_t.update("assist"):null).catch(()=>null)}a(Ts,"hotUpdateAssist");async function Ra(){if(Fa)return;Fa=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Ee("正在从多源检查更新…");try{let e=[ja()];(Ue||[]).forEach(m=>{m&&typeof m.check=="function"&&e.push(Promise.resolve().then(()=>m.check()).then(A=>A||{id:m.id||"extra",name:m.name||"扩展",status:"err",message:"无结果"}).catch(A=>({id:m.id||"extra",name:m.name||"扩展",status:"err",message:String(A&&A.message||A)})))});let r=await Promise.all(e),o=r.map(m=>{if(!m)return"";if(m.status==="err")return`• <b>${at(m.name||m.id)}</b>：检查失败（${at(m.message||"unknown")}）`;if(m.status==="update"){let A="";if(m.id==="assist"&&_t&&_t.loaded("assist"))A=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let q=m.updateUrl?` <a href="${at(m.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",N=m.pageUrl?` <a href="${at(m.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";A=q+N}return`• <b>${at(m.name)}</b>：发现新版本 <b>${at(m.remote)}</b>（当前 ${at(m.local)}）${A}`}return m.status==="ahead"?`• <b>${at(m.name)}</b>：本地 ${at(m.local)} 新于远程 ${at(m.remote)}`:`• <b>${at(m.name)}</b>：已是最新（${at(m.local)}）`}).filter(Boolean),i=r.some(m=>m&&m.status==="update"),s=r.some(m=>m&&m.status==="err");Ee(`${i?"检查完成：发现更新":s?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,s?"err":"ok");let h=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');h&&h.addEventListener("click",()=>{try{Ee("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{Ee("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(m=>{Ee("重新装载失败："+(m&&m.message?m.message:m),"err")})}catch(m){Ee("重新装载失败："+(m&&m.message?m.message:m),"err")}})}catch(e){Ee("检查失败："+at(e&&e.message||e),"err")}finally{Fa=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(Ra,"checkForUpdates");function An(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+p,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(An,"refreshUpdateStatusHint");function Ms(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=Ue.findIndex(i=>i&&i.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?Ue[r]=o:Ue.push(o);try{let i=document.getElementById("urppp-set-update-status");i&&o.localVersion&&e==="assist"&&i.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{An()}catch{}return!0}a(Ms,"registerUpdateChecker");function $s(){let t={version:p,urls:n,check:Ra,checkMain:ja,registerChecker:Ms,compareVersions:wr,parseUserscriptVersion:po,extractChangelogRange:yn,showUpdateToast:Oa,maybeAutoCheckUpdate:Ha,listCheckers:a(()=>Ue.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a($s,"publishUpdateApi"),$s();let{rebuildSidebarCompletely:Sn,syncMobileContentOffset:We,syncSidebarUnderNavbar:Ce}=Fi({}),{rebuildDashboard:Is}=Pi({deps:{statCardPrivacyMarkup:js}}),Ns="urppp-clean-open",Ua={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ie(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ie,"isUnevaluatedScore");function Hr(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Hr,"isValidOfficialGpa");function Rr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Rr,"firstContentChar");function Wa(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Wa,"weekBitmapActive");function Ge(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ie(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Ua[o]!=null?Ua[o]:Ua[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ge,"scoreToGpa");function Je(t){let e=String(t||"").trim();if(!e||ie(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(Je,"scoreToNumber");function Pe(t){return Math.round((Number(t)||0)*100)/100}a(Pe,"round2");function _n(t){return/必修/.test(String(t||""))}a(_n,"isRequiredAttr");function re(t){let e=0,r=0,o=0,i=0,s=0,l=0,h=0,m=0;return(t||[]).forEach(A=>{if(A&&(A.unevaluated||ie(A.score)))return;let q=Number(A.credit)||0,N=Je(A.score),z=Hr(A.officialGpa)?Number(A.officialGpa):Ge(A.score);N==null||q<=0||(e+=q,r+=N*q,z!=null&&(o+=z*q,i+=q),A.required&&(s+=q,l+=N*q,z!=null&&(h+=z*q,m+=q)))}),{totalCredit:Pe(e),avgScore:Pe(e?r/e:0),avgGpa:Pe(i?o/i:0),requiredCredit:Pe(s),requiredGpa:Pe(m?h/m:0),requiredAvg:Pe(s?l/s:0),count:(t||[]).length}}a(re,"summarizeCourses");function Ga(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Ga,"absUrl");function Vt(t,e){let r=Ga(t),o=e&&e.method||"GET",i=e&&e.data||null;return new Promise((s,l)=>{let h=a((m,A)=>m?s(A):l(new Error(A||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:i||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(m=>{m.status>=200&&m.status<400?h(!0,m.responseText||""):h(!1,"HTTP "+m.status)},"onload"),onerror:a(()=>h(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:i||void 0}).then(m=>{if(!m.ok)throw new Error("HTTP "+m.status);return m.text()}).then(m=>h(!0,m)).catch(m=>h(!1,m&&m.message))})}a(Vt,"fetchText");function Ur(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Ur,"parseHtml");function En(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=ri,(document.head||document.documentElement).appendChild(t)}a(En,"ensureFeatureStyles");function Bs(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=ni,(document.head||document.documentElement).appendChild(t)}a(Bs,"ensureScheduleExportStyles");function Fs(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=pi,(document.head||document.documentElement).appendChild(t)}a(Fs,"ensureSettingsStyles");function Cn(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let i=r.cloneNode(!0);i.querySelectorAll("small, i, img, b, .badge").forEach(h=>h.remove());let s=(i.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(h=>{h.nodeType===Node.TEXT_NODE&&h.textContent.trim()&&h.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=s||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(Cn,"ensureNavNameTarget");function Wr(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Wr,"classifyPrivacyLabel");function Ds(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(Ds,"classifyHomeDataKey");function Gr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Gr,"homePrivateValueSpan");function js(t,e){let r=at(t),o=at(e),i=Ds(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[i]||Wr(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:Gr("organization",i,o)}:{valueHtml:Gr("organization",i,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let h=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&h){let A=h.index||0,q=String(e).slice(0,A),N=String(e).slice(A+h[0].length);return{valueHtml:r,labelHtml:`${at(q)}${Gr(l,i,at(h[0]))}${at(N)}`}}return{valueHtml:Gr(l,i,r),labelHtml:o}}a(js,"statCardPrivacyMarkup");function ze(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||_r;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||_r)}a(ze,"privacyReplacement");function mr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(mr,"markPrivateText");function Pn(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||_r);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(Pn,"markPrivateAvatar");function Os(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(Os,"markPrivateBlock");function Hs(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(Hs,"markDirectEditable");let xe=null;function zn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;xe&&xe.__finish&&xe.__finish(!1);let r=Ae();if(r.mode!=="custom"||!r.directEdit.enabled)return;let i=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),s=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),h=s.height>=8||!l?s:{left:s.left,top:l.top,width:Math.max(s.width,40),height:l.height},m=document.createElement("input"),A=getComputedStyle(t),q=Math.min(Math.max(h.width+64,140),Math.max(140,window.innerWidth-24)),N=Math.min(Math.max(12,h.left),Math.max(12,window.innerWidth-q-12)),z=Math.min(Math.max(12,h.top+(h.height-36)/2),Math.max(12,window.innerHeight-48));m.type="text",m.maxLength=80,m.className="urppp-direct-edit-input",m.value=i,m.setAttribute("aria-label","修改"+U[e]+"显示值"),m.style.left=N+"px",m.style.top=z+"px",m.style.setProperty("--urppp-direct-edit-width",q+"px"),m.style.fontFamily=A.fontFamily,m.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(A.fontSize)||14)))+"px";let D=!1,J=a(j=>{if(D||(D=!0,m.remove(),xe===m&&(xe=null),j))return;let R=Ae();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(m.value||"").trim().slice(0,80),fa(R),Yt(document),Xa(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");m.__finish=J,m.addEventListener("click",j=>j.stopPropagation()),m.addEventListener("blur",()=>J(!1)),m.addEventListener("keydown",j=>{j.key==="Enter"&&(j.preventDefault(),J(!1)),j.key==="Escape"&&(j.preventDefault(),J(!0))}),document.documentElement.appendChild(m),xe=m,m.focus(),m.select()}a(zn,"openDirectEditInput");function Rs(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),zn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),zn(e))},!0))}a(Rs,"bindDirectEditInteraction");function Us(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(Us,"clearPrivacyDisplay");function Ln(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(Ln,"applyCustomText");function Ws(t){let e=t&&t.querySelectorAll?t:document,r=Ne(),i=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?Cn(e):null);Ln(i,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(h=>{let m=h.querySelector(".profile-info-name"),A=h.querySelector(".profile-info-value");!m||!A||String(m.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||Ln(A,r.nameEnabled,r.name)});let s=or(r.avatar),l=r.avatarEnabled&&!!s;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(h=>{let m=h.getAttribute("src")||"";m&&m!==h.__urpppAppliedCustomSrc&&(h.__urpppOriginalSrc=m),l?(h.__urpppOriginalSrc==null&&(h.__urpppOriginalSrc=m),m!==s&&h.setAttribute("src",s),h.__urpppAppliedCustomSrc=s):h.__urpppAppliedCustomSrc!=null&&(h.__urpppOriginalSrc&&h.setAttribute("src",h.__urpppOriginalSrc),delete h.__urpppAppliedCustomSrc)})}a(Ws,"applyCustomIdentityDisplay");function Gs(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),i=r.querySelector(".profile-info-value, td:last-child");if(!o||!i||o===i)return;let s=Wr(o.textContent),l=ze(e,s);l&&mr(i,l)})}a(Gs,"applyProfilePrivacy");function Js(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let i=o.map(s=>{let l=Wr(s.textContent);return["grade","gpa","credit"].includes(l)?l:""});i.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(s=>{let l=s.querySelectorAll("td");i.forEach((h,m)=>{let A=ze(e,h);h&&A&&mr(l[m],A)})})})}a(Js,"applyScoreTablePrivacy");function Vs(t){let e=t&&t.querySelectorAll?t:document,r=Ae();if(r.mode==="off")return;let o=ze(r,"name"),i=ze(r,"avatar"),s=ze(r,"schedule"),l=o?Cn(e):e.querySelector?.(".urppp-user-name-value");o&&mr(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([A,q])=>{let N=ze(r,q);N&&e.querySelectorAll(A).forEach(z=>mr(z,N))}),Js(e,r);let m=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(A=>{let q=A.getAttribute("data-urppp-private"),N=A.getAttribute("data-urppp-edit-key"),D=(m&&N?String(r.directEdit.values[N]||"").trim():"")||ze(r,q);!["avatar","schedule"].includes(q)&&D&&mr(A,D),m&&N&&Hs(A,N)}),m&&Rs(),Gs(e,r),i&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(A=>{let q=A.matches("img")?A:A.querySelector("img");q?Pn(q,i):(A.classList.add("urppp-private-avatar-block"),A.setAttribute("data-urppp-private-mask",i))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(A=>Pn(A,i))),s){let A=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));A.filter(q=>!A.some(N=>N!==q&&N.contains(q))).forEach(q=>Os(q,s))}}a(Vs,"applyPrivacyDisplay");let Ja=0,se=[];function qn(){let t=Ae(),e=Ne();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(qn,"personalDisplayIsEnabled");function Ys(){se=se.filter(({root:t})=>t&&t.isConnected),se.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(Ys,"resumePersonalDisplayObservers");function Yt(t){let e=t||document;se.forEach(({observer:r})=>r.disconnect());try{En()}catch{}try{Us(e)}catch{}try{Ws(e)}catch(r){console.warn("[URP++] custom identity",r)}try{Vs(e)}catch(r){console.warn("[URP++] privacy",r)}qn()?(Ys(),Xs()):(clearTimeout(Ja),se=[])}a(Yt,"applyPersonalDisplay");function Qs(t){clearTimeout(Ja),Ja=setTimeout(()=>Yt(t||document),140)}a(Qs,"schedulePersonalDisplay");function Va(){try{nt&&nt.open&&Ze()}catch{}}a(Va,"refreshCleanPersonalDisplay");function Xs(){if(!qn()){se.forEach(({observer:t})=>t.disconnect()),se=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(se.some(r=>r.root===t))return;let e=new MutationObserver(()=>Qs(document));se.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(Xs,"bindPersonalDisplayObservers");function Ks(t){let e=Object.assign({},t||{}),r=Ne();r.nameEnabled&&r.name&&(e.name=r.name);let o=or(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(Ks,"personalizedProfile");let Tn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",Zs="/student/courseSelect/thisSemesterCurriculum/callback",tl="/student/courseSelect/thisSemesterCurriculum/index";async function el(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Vt(Zs),r=JSON.parse(e),o=ar(r);if(o)return o}catch{}return""}a(el,"resolveSchedulePlanCode");async function Mn(t){let e=await el(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Vt(Tn,r),i;try{i=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=ar(i)),(!i.jcsjbs||!i.jcsjbs.length)&&e&&(i=JSON.parse(await Vt(Tn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let s=In(i,e,t);if(!s.courses.length)throw new Error("没有读取到可导出的课表数据");return s}a(Mn,"loadScheduleExportData");function Ya(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(Ya,"safeScheduleFilename");function Qa(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(Qa,"downloadBlob");function rl(t){let e=Zr(t),r=qr(),o=r.enabled?ea(e,r.mapping):ta(e),i=JSON.stringify(o,null,2)+`
`;return Qa(new Blob([i],{type:"application/json;charset=utf-8"}),Ya(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(rl,"exportScheduleJson");function $n(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let i=Number(r[4]);if(i<1||i>30)return"";let s=lo(new Date);return s.setDate(s.getDate()-(i-1)*7),Sr(s)}a($n,"deriveCurrentSemesterMonday");function In(t,e,r){let o=e||ar(t),i=$n(o)||ga()[o]||"";return kp(t,o,r,{firstMonday:i})}a(In,"normalizeScheduleDataForPage");function al(t){let e=t.semester.planCode,r=ga()[e],o=$n(e);return o?(So(e,o),Promise.resolve(o)):rr(r)?Promise.resolve(r):new Promise((i,s)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||gp(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let h=a((m,A)=>{l.remove(),m?s(m):i(A)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>h(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let m=l.querySelector("input").value;rr(m)&&(So(e,m),h(null,m))}),l.addEventListener("click",m=>{m.target===l&&h(new Error("已取消导出"))})})}a(al,"requestScheduleFirstMonday");async function ol(t){let e=await al(t),r=yp(t,e);return Qa(new Blob([r],{type:"text/calendar;charset=utf-8"}),Ya(t.semester.label)+".ics"),vp(t)}a(ol,"exportScheduleIcs");let nl={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function le(t,e,r){if(typeof document>"u")return Gt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let i=getComputedStyle(o).color;o.remove();let s=String(i||"").match(/[\d.]+/g)?.map(Number)||[];if(s.length>=3){let l=vr(s[0],s[1],s[2]),h=s.length>3?Math.max(0,Math.min(1,s[3])):1;return h<1?Bt(r||e,l,h):l}return Gt(i)||Gt(e)||"#000000"}a(le,"resolvedScheduleImageColor");function Nn(){let t=Jt(),e=Zt(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},i={bg:le("--bg",o.bg),surface:le(e==="neu"?"--neu-base":"--surface",o.surface),input:le("--input-bg",o.input),text:le("--text",o.text),secondary:le("--text-secondary",o.secondary),muted:le("--text-muted",o.muted),border:le("--border",o.border,le(e==="neu"?"--neu-base":"--surface",o.surface)),primary:le("--primary",o.primary)},s={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(nl[e]||e)+" · "+(Ct[t]&&Ct[t].name||t),colors:i,shape:s[e]||s.apple}}a(Nn,"currentScheduleImageTheme");function Bn(t,e){return qp(t,e||Nn())}a(Bn,"buildScheduleSvg");function pl(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),i=URL.createObjectURL(o),s=new Image;s.onload=()=>{try{let h=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),m=document.createElement("canvas");m.width=Math.floor(t.width*h),m.height=Math.floor(t.height*h);let A=m.getContext("2d");A.scale(m.width/t.width,m.height/t.height),A.fillStyle=t.background||"#F8FAFC",A.fillRect(0,0,t.width,t.height),A.drawImage(s,0,0,t.width,t.height),m.toBlob(q=>q?e(q):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(i)}},s.onerror=()=>{URL.revokeObjectURL(i),r(new Error("课表图片渲染失败"))},s.src=i})}a(pl,"svgToPngBlob");async function il(t){let e=await pl(Bn(t));Qa(e,Ya(t.semester.label)+".png")}a(il,"exportSchedulePng");function Xa(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(Xa,"showFeatureToast");let Ka=Tp({document,window,ensureStyles:Bs,loadData:Mn,exportJson:rl,exportIcs:ol,exportPng:il,showToast:Xa,nativePageUrl:tl,navigate:a(t=>{location.href=t},"navigate"),logger:console});function sl(t,e,r,o){return Ka.run(t,e,r,o)}a(sl,"runScheduleExport");function ll(t){return Ka.createMenu(t)}a(ll,"createScheduleExportMenu");function cl(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(cl,"disposeNativePdfCapture");function dl(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let i=Kp(e);t.stage="ok",t.stageCards=i.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=i.target.querySelector("table")?i.target.querySelector("table").id:"none",cl(i)}catch(i){t.stage="failed",t.stageError=i&&i.message||String(i)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(dl,"bindNativePdfDiagnose");function ul(t){return t?(dl(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await ei(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:cr})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Xa("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(ul,"pagePdfExportHandler");function Za(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Za,"isPersonalSchedulePage");function ml(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(ml,"isScoreQueryPage");function to(){if(!Za())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let i=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),s=ll({source:"native",pdfHandler:ul(i)});if(s.id="urppp-native-schedule-export",i&&i.parentElement){i.__urpppNativeExportState||(i.__urpppNativeExportState={display:i.style.getPropertyValue("display"),displayPriority:i.style.getPropertyPriority("display"),ariaHidden:i.getAttribute("aria-hidden"),tabIndex:i.getAttribute("tabindex")}),i.setAttribute("data-urppp-native-export-source","1"),i.style.setProperty("display","none","important"),i.setAttribute("aria-hidden","true"),i.setAttribute("tabindex","-1"),i.parentElement.insertBefore(s,i.nextSibling);return}if(e)e.appendChild(s);else if(t)t.appendChild(s);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let h=document.createElement("div");h.className="urppp-export-fallback",h.appendChild(s),l.prepend(h)}}}a(to,"patchNativeScheduleExport");let Ve=null,Jr=0;function eo(){clearTimeout(Jr),Jr=0,Ve&&Ve.observer.disconnect(),Ve=null}a(eo,"disconnectNativeScheduleExportObserver");function hl(){if(!Za()){eo();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ve&&Ve.root===t&&t.isConnected)return;eo();let e=new MutationObserver(()=>{clearTimeout(Jr),Jr=setTimeout(()=>to(),80)});e.observe(t,{childList:!0,subtree:!0}),Ve={root:t,observer:e}}a(hl,"bindNativeScheduleExportObserver");function Fn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(Fn,"restoreOptionalAttribute");function bl(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let i=o.__urpppNativeExportState;i&&(i.display?o.style.setProperty("display",i.display,i.displayPriority):o.style.removeProperty("display"),Fn(o,"aria-hidden",i.ariaHidden),Fn(o,"tabindex",i.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(bl,"removeNativeScheduleExport");let Dn=Ni({deps:{styles:di,loadScores:Zn,loadProfile:jn,scoreToNumber:Je,scoreToGpa:Ge,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),fl=cp([Xr({id:"schedule-export",matches:a(t=>Za(t.location),"matches"),mount:a(()=>{to(),hl()},"mount"),unmount:a(t=>{eo(),bl(t?.lifecycleKey)},"unmount")}),Xr({id:"score-analysis",matches:a(t=>ml(t.location),"matches"),mount:a(()=>{try{Dn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Dn.unmount()}catch{}},"unmount")})]);function Vr(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return fl.refresh({document,location,window,lifecycleKey:t})}a(Vr,"refreshRouteFeatures");function gl(t){Ka.bindHosts(t)}a(gl,"bindScheduleExportHosts");function hr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(hr,"normalizeProfileValue");function Yr(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(i=>hr(i).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let i=0;i<o.length;i++){let s=o[i],l=s.querySelector(".profile-info-name, th, label"),h=s.querySelector(".profile-info-value, td:last-child");if(!l||!h||l===h)continue;let m=hr(l.textContent).replace(/[：:]/g,"");if(!r.some(q=>m===q||m.endsWith(q)))continue;let A=hr(h.textContent);if(A&&A!=="—"&&A!=="-")return A}return""}a(Yr,"readLabeledProfileValue");function Ye(t){return hr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Ye,"cleanMajorPlanName");function xl(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),i=hr(o);if(/主修必修GPA/.test(i)){let s=i.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||i.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(s){let l=Number(s[1]),h=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||h===0||l>0)&&(e.majorGpa=s[1])}}if(/主修为|培养方案/.test(i)){let s=i.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||i.match(/^(.{2,60}?)\s*主修为/)||i.match(/主修为\s*(.{2,60})$/),l=Ye(s&&s[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let h=/培养方案|教学计划/.test(l);(!e.majorPlan||h)&&(e.majorPlan=l)}}}),e}a(xl,"extractAcademicOverview");async function jn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let s=r.querySelector(".urppp-user-name-value"),l=s&&s.__urpppOriginalText;l&&(t.name=String(l).trim());let h=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),m=t.name?null:h.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!m){let A=r.cloneNode(!0);A.querySelectorAll("small, i, img, b, .badge").forEach(N=>N.remove());let q=(A.textContent||"").replace(/\s+/g," ").trim();q=q.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),m=q.match(/([\u4e00-\u9fa5·]{2,12})/)}m&&m[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(m[1])&&(t.name=m[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let i=xl(document);t.majorPlan=i.majorPlan,t.majorGpa=i.majorGpa}catch{}try{let r=await Vt("/student/rollManagement/rollInfo/index"),o=Ur(r),i=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Yr(o,["姓名"]),!t.name)){let m=i.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);m&&(t.name=m[1].trim())}let s=Yr(o,["主修方案名称"]),l=Yr(o,["专业"]);t.studentId=Yr(o,["学号"]),s?t.majorPlan=Ye(s):!t.majorPlan&&l&&(t.majorPlan=Ye(l));let h=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(h&&h.getAttribute("src")&&!t.avatar){let m=h.getAttribute("src");t.avatar=/^https?:/i.test(m)?m:Ga(m)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(jn,"loadProfile");let On=["周日","周一","周二","周三","周四","周五","周六"];function ro(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(i=>{let s=String(i.id||"").match(/^(\d+)_(\d+)$/);if(!s)return;let l=parseInt(s[1],10),h=parseInt(s[2],10),m=l===7?0:l,A=i.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),q=A.length?A:[];if(!q.length&&(i.textContent||"").trim()){let N=(i.textContent||"").replace(/\s+/g," ").trim();N&&e.push({name:N.slice(0,40),teacher:"",place:"",week:"",day:m,section:h});return}q.forEach(N=>{let z=Array.from(N.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),D=(N.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(N.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",j=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=z.find(K=>/周/.test(K))||"",F=String(D).replace(/_\d+\s*$/,"").trim();!F||F.length<2||e.push({name:F,teacher:String(j).trim(),place:String(J||"").trim(),week:String(R).trim(),day:m,section:h})})});let o=new Set;return e.filter(i=>{let s=[i.day,i.section,i.name,i.place].join("|");return o.has(s)?!1:(o.add(s),!0)})}a(ro,"parseScheduleFromDoc");let Hn="urppp_term_week_v1";function Qe(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(Hn,e)}catch{}return e}a(Qe,"rememberTermWeek");function br(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(Hn,0))||0;if(t>=1&&t<=30)return Qe(t)}catch{}return 0}a(br,"readRememberedTermWeek");function fr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let i=e.match(r[o]);if(i){let s=parseInt(i[1],10);if(s>=1&&s<=30)return s}}return 0}a(fr,"extractTermWeekFromText");function Le(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let h=t[l],m=fr(h.innerText||h.textContent||"")||fr(h.innerHTML||"");if(m)return Qe(m)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=fr(e);if(r)return Qe(r);let o=document.body&&document.body.innerText||"",i=fr(o);if(i)return Qe(i);let s=br();if(s)return s}catch{}return 0}a(Le,"getCurrentWeekNumber");let Xe=null;function yl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(yl,"calTodayStr");function vl(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(i=>String(i).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(vl,"calAddDays");function gr(t){if(Xe)return Xe;let e=t||yl();return e>="2027-02-06"&&e<=vl("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(gr,"calVacation");function wl(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(wl,"festiveDecorHtml");function Rn(){let t=typeof document<"u"?document:null;if(!t)return;let e=gr()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",wl()):!e&&r&&r.remove()}a(Rn,"syncFestiveDecor");function Un(t){Xe=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Xe&&Xe!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{Rn()}catch{}try{typeof Ze=="function"&&Ze()}catch{}return Xe}a(Un,"setCalendarPhase");function kl(){return gr()}a(kl,"getCalendarPhase");function Wn(){if(gr()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=Le()||br()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(Wn,"getViewWeekNumber");async function Al(){let t=Le();if(t>=1)return t;try{let e=await Vt("/index");if(t=fr(e),t)return Qe(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),i=await Vt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),s=JSON.parse(i),l=Number(s&&s.jxzc);if(l>=1&&l<=30)return Qe(l)}catch{}return br()||0}a(Al,"ensureTermWeekResolved");function Sl(t){let e=Le()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let i=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);i&&(e=Math.max(e,parseInt(i[2],10)||0));let s=String(r.week||"").match(/\d{1,2}/g);s&&s.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(Sl,"inferMaxWeek");function Gn(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Gn,"weekBitActive");let Jn=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function Vn(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return Jn[e%Jn.length]}a(Vn,"courseColor");function _l(t){let e=[],r=Le();(t&&t.xkxx||[]).forEach(s=>{Object.keys(s||{}).forEach(l=>{let h=s[l];if(!h)return;let m=h.courseName||h.englishCourseName||l,A=h.attendClassTeacher||"";(h.timeAndPlaceList||[]).forEach(N=>{let z=Number(N.classDay)||0,D=z===7?0:z,J=Number(N.classSessions)||1,j=Math.max(1,Number(N.continuingSession)||1),R=[N.campusName,N.teachingBuildingName,N.classroomName].filter(Boolean).join(""),F=N.weekDescription||h.skzcs||"",K=Gn(N.classWeek,r)||r&&F.indexOf(String(r))>=0;e.push({name:String(m).trim(),teacher:String(A).trim(),place:String(R).trim(),week:String(F).trim(),classWeek:String(N.classWeek||""),day:D,section:J,span:j,thisWeek:!!K,color:Vn(m)})})})});let i=new Set;return e.filter(s=>{let l=[s.day,s.section,s.span,s.name,s.place,s.week].join("|");return i.has(l)?!1:(i.add(l),!0)})}a(_l,"parseScheduleFromJson");async function El(){try{let t=await Vt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let i=Number(r&&(r.jxzc||r.zc||r.currentWeek));i>=1&&i<=30&&(nt._termWeek=Math.max(nt._termWeek||0,i),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=_l(r)}catch{e=ro(Ur(t))}e.length||(e=ro(document));let o=r?In(r,ar(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=ro(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(El,"loadSchedule");function Cl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),i=r.match(o);if(i&&i[1])return i[1];let s=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(s);return l?l[1]:""}a(Cl,"extractScoreCallback");function Pl(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let i=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",s=[];(o.cjList||[]).forEach(l=>{let h=l.courseName||l.englishCourseName||"";if(!h)return;let m=l.cj!=null&&l.cj!==""?String(l.cj):"";!m&&l.courseScore!=null&&(m=String(l.courseScore)),!m&&l.gradeName&&(m=String(l.gradeName)),!m&&l.zscj!=null&&(m=String(l.zscj));let A=l.courseAttributeName||l.xkcsxmc||"",q=parseFloat(l.credit)||0,N=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",D=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ie(m)||ie(l.gradeName)||D!=null&&D<0,j=J?"未评估":m;s.push({code:N,seq:String(z||""),name:h,attr:A,credit:q,score:j,unevaluated:J,required:_n(A),officialGpa:Hr(D)?D:null,evalUrl:""})}),s.length&&e.push({title:String(i).slice(0,100),courses:s,summary:re(s),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(Pl,"parseScoreJson");async function Yn(t,e){let r=await Vt(t),o=Qn(Ur(r));if(o.length)return o;let i=Cl(r,e);if(!i)return[];let s=await Vt(i);try{let l=JSON.parse(s);o=Pl(l).map(h=>(h.summary=re(h.courses),h))}catch{o=Qn(Ur(s))}return o}a(Yn,"loadScoreByIndex");function Qn(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map(q=>(q.textContent||"").replace(/\s+/g,""));if(!o.length)return;let i=o.join("|");if(!/课程名/.test(i)||!/成绩/.test(i))return;let s={code:o.findIndex(q=>q==="课程号"),name:o.findIndex(q=>q==="课程名"),attr:o.findIndex(q=>/课程属性|属性/.test(q)),credit:o.findIndex(q=>q==="学分"),score:o.findIndex(q=>q==="成绩")};if(s.name<0||s.score<0)return;let l="成绩",h=r.previousElementSibling;for(let q=0;q<8&&h;q++,h=h.previousElementSibling)if(/^H[1-4]$/.test(h.tagName)||h.classList&&h.classList.contains("header")){l=(h.textContent||"").replace(/\s+/g," ").trim();break}let m=[],A=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(A).forEach(q=>{let N=Array.from(q.cells||q.querySelectorAll("td"));if(N.length<4)return;let z=a(F=>F>=0&&N[F]?(N[F].textContent||"").replace(/\s+/g," ").trim():"","get"),D=z(s.name),J=z(s.score);if(!D||!J||/课程名|序号/.test(D))return;let j=z(s.attr),R=ie(J);m.push({code:z(s.code),name:D,attr:j,credit:parseFloat(z(s.credit))||0,score:R?"未评估":J,unevaluated:R,required:_n(j),officialGpa:null,evalUrl:""})}),m.length&&e.push({title:l.slice(0,100),courses:m,summary:re(m)})}),e}a(Qn,"parseScoreTables");function xr(t){return Ye(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(xr,"schemePlanName");function Xn(t,e){if(!t||!t.length)return 0;let r=Ye(e),o=t.findIndex(l=>{let h=xr(l);return/培养方案/.test(h)&&!/微专业|辅修|双学位/.test(h)});if(o>=0&&(!r||xr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let h=xr(l);return h.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(h.slice(0,4))||h.includes(r.slice(0,4))}),o>=0))return o;let i=0,s=-1;return t.forEach((l,h)=>{if(/微专业|辅修/.test(xr(l)))return;let m=(l.courses||[]).length;m>s&&(s=m,i=h)}),i}a(Xn,"pickMajorSchemeIndex");async function zl(){let t={};try{let e=await Vt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(i=>{let s=String(i.KCH||"").trim();if(!s)return;let l=String(i.SFPG)==="1",h=String(i.KTID||"").trim();if(!t[s]){t[s]={ktid:h,kxh:String(i.KXH||""),kcm:i.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&h?"/student/teachingEvaluation/newEvaluation/evaluation/"+h:"/student/teachingEvaluation/newEvaluation/index"};return}t[s].total+=1,l||(t[s].pending+=1,t[s].done=!1,h&&(t[s].ktid=h,t[s].url="/student/teachingEvaluation/newEvaluation/evaluation/"+h))}),Object.keys(t).forEach(i=>{let s=t[i];s.done=!(s.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(zl,"loadEvaluationMap");function Ll(t){if(!t)return!1;if(t.officialGpa!=null&&Hr(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ie(e)?!1:Je(e)!=null||Ge(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(Ll,"hasDisplayableScore");function ql(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(i=>{if(!i||!i.code)return;let s=e[i.code];if(s){if(Ll(i)){i.unevaluated=!1,s.done?i.evalUrl=i.evalUrl||"":i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index";return}s.done||(i.unevaluated=!0,i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index",(!i.score||i.score===""||ie(i.score))&&(i.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(ql,"attachEvaluationLinks");function Kn(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=re(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=re(e.courses),e)),t)}a(Kn,"refreshScoreSummaries");async function Tl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await zl();return ql(t,e),t.evalMap=e,t.evaluationReady=!0,Kn(t)}finally{t.evaluationLoading=!1}}a(Tl,"enrichScoresWithEvaluation");function Ml(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=Xn(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let i=xr(o),s=Ye(nt.profile.majorPlan);/培养方案|教学计划/.test(i)&&(!/培养方案|教学计划/.test(s)||s==="主修方案")&&(nt.profile.majorPlan=i);let l=o.summary||{},h=Number(l.requiredCredit),m=Number(l.requiredGpa),A=Number(nt.profile.majorGpa);h>0&&Number.isFinite(m)&&m>=0&&m<=5&&(!Number.isFinite(A)||A<=0)&&(nt.profile.majorGpa=String(Pe(m)))}a(Ml,"reconcileProfileAndScores");let Ke=null;async function Zn(t){return t&&(Ke=null),Ke&&!Ke.error||(Ke=await $l()),Ke}a(Zn,"loadScores");async function $l(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([Yn("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),Yn("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(i=>i.courses.forEach(s=>{o.push(Object.assign({term:i.title},s))})),t.passing=[{title:"全部及格成绩",courses:o,summary:re(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:re(o)}]),Kn(t),t.majorIdx=Xn(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a($l,"loadScoresImpl");function qe(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(qe,"parseJsonArrayLoose");function tp(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let i=0;for(let s=o;s<t.length&&s<o+3e5;s++){let l=t[s];if(l==="[")i++;else if(l==="]"&&(i--,i===0))return t.slice(o,s+1)}return""}a(tp,"extractBalancedArray");async function Il(){let t=await Vt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let s=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(s&&(e=qe(s)),l&&(r=qe(l)),!e.length){let h=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(e=qe(h[1]))}if(!r.length){let h=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(r=qe(h[1]))}if(!r.length){let h=tp(t,"teachingBuildingName");h&&(r=qe(h))}if(!e.length){let h=tp(t,"campusName");h&&(e=qe(h))}}catch(s){console.warn("[URP++] classroom json parse",s)}if(!r.length){let s=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=s;let l=[];for(let h of s)try{let m=await Vt("/student/teachingResources/classroomCurriculum/"+h.campusNumber+"/teachingBuildingJson");qe(m).forEach(q=>{l.push({id:{campusNumber:h.campusNumber,teachingBuildingNumber:String(q.id&&q.id.teachingBuildingNumber||q.teachingBuildingNumber||"")},teachingBuildingName:q.teachingBuildingName||q.name||""})})}catch(m){console.warn("[URP++] building json",h.campusNumber,m)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(s=>({campus:s.campusName||s.campusNumber,campusNumber:String(s.campusNumber||s.id&&s.id.campusNumber||""),buildings:[]}));r.forEach(s=>{let l=String(s.id&&s.id.campusNumber||s.campusNumber||""),h=String(s.id&&s.id.teachingBuildingNumber||s.teachingBuildingNumber||""),m=s.teachingBuildingName||s.name||h;if(!l||!h||!m)return;let A=o.find(N=>N.campusNumber===l);A||(A={campus:l,campusNumber:l,buildings:[]},o.push(A));let q="/student/teachingResources/classroomUseStatus/"+l+"/"+h+"/"+encodeURI(encodeURI(A.campus||l))+"/"+encodeURI(encodeURI(m));A.buildings.push({name:m,path:q,campusNumber:l,buildingNumber:h})});let i=o.filter(s=>s.buildings.length);if(!i.length)throw new Error("未解析到教学楼，请刷新后重试");return i}a(Il,"loadClassroomCatalog");function yr(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(yr,"occupancyTypeLabel");function Nl(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return yr(t)}a(Nl,"occupancyReason");async function Bl(t,e,r,o){let i=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),s=await Vt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+i.toString());try{let l=JSON.parse(s);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(h=>h&&typeof h=="object"&&(h.kcm||h.id&&h.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(Bl,"fetchClassroomCurriculum");function Fl(t,e,r){let o=t||[],i=Number(e.xq)||0,s=Number(e.start)||0,l=Number(r)||0,h=[];return o.forEach(m=>{let A=m.id||{},q=Number(A.skxq!=null?A.skxq:m.skxq)||0,N=Number(A.skjc!=null?A.skjc:m.skjc)||0,z=Math.max(1,Number(m.cxjc)||1),D=A.skzc||m.skzc||"";i&&q&&i!==q||s&&(s<N||s>=N+z)||l&&D&&!Wa(D,l)||h.push(m)}),h.length?(h.sort((m,A)=>{let q=Wa(m.id&&m.id.skzc||m.skzc,l)?0:1,N=Wa(A.id&&A.id.skzc||A.skzc,l)?0:1;return q-N}),h[0]):null}a(Fl,"matchCurriculumCourse");async function Dl(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),i=String(e.buildingNumber||""),s=r||t.planNumber||"";if(!o||!i||!s)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(D=>D.busy)),h={},m=a(async z=>{if(h[z])return h[z];try{h[z]=await Bl(s,o,i,z)}catch{h[z]=[]}return h[z]},"queue"),A=4,q=0,N=new Array(Math.min(A,Math.max(l.length,1))).fill(0).map(async()=>{for(;q<l.length;){let z=q++,D=l[z],J=await m(D.name);(D.slots||[]).forEach(j=>{if(!j.busy)return;let R={xq:j.detail&&j.detail.xq||j.xq||0,start:j.section,week:t.jxzc};j.detail&&j.detail.xq!=null&&(R.xq=j.detail.xq);let F=Fl(J,R,t.jxzc);if(F&&F.kcm){let K=String(F.kcm).trim();j.contentName=K,j.reason=K,j.displayChar=Rr(K),j.detail&&(j.detail.contentName=K,j.detail.reason=K,j.detail.teacher=F.jsm||"",j.detail.weeks=F.zcsm||"",j.detail.courseNo=F.id&&F.id.kch||"",j.detail.typeLabel=yr({occupancymoduleId:j.module}))}else j.displayChar=Rr(j.reason||"占用"),j.detail&&(j.detail.typeLabel=yr({occupancymoduleId:j.module}))})}});return await Promise.all(N),t}a(Dl,"enrichOccupancyWithCurriculum");function jl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(jl,"occupancyKindClass");async function Ol(t){let e="",r="",o="",i="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",i=t.path||"";else{i=String(t||"");let F=i.match(/classroomUseStatus\/(\d+)\/(\d+)\//);F&&(e=F[1],r=F[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let s=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=Hl(ep(new Date,s)),h="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),m=await new Promise((F,K)=>{let ut=Ga("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:h,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?F(vt.responseText||""):K(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:h}).then(vt=>vt.text()).then(F).catch(K)}),A;try{A=JSON.parse(m)}catch{throw new Error("jasInfo 非 JSON")}let q=(A.classrooms||[]).map(F=>{let K=F.classroomName||F.id&&F.id.classroomNumber||"",ut=F.placeNum||"",vt=F.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:K,seats:ut,type:vt,slots:Et,map:{}}}),N={};q.forEach(F=>{N[F.name]=F}),(A.classroomTime||[]).forEach(F=>{let K=F.id||{},ut=K.classroomNumber||"",vt=Number(K.sessionstart)||1,Et=Math.max(1,Number(F.continuingsession)||1),Lt=N[ut];if(!Lt)return;let qt=yr(F),Ot=Nl(F);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let Mt=Lt.slots.find(ae=>ae.section===Ht);Mt&&(Mt.busy=!0,Mt.kind=F.timestatenumber||F.occupancymoduleId||"",Mt.module=F.occupancymoduleId||"",Mt.reason=Ot,Mt.typeLabel=qt,Mt.displayChar=Rr(Ot),Mt.xq=K.xq,Mt.weekBitmap=K.week||"",Mt.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:K.week||"",xq:K.xq||"",state:F.timestatenumber||"",module:F.occupancymoduleId||""})}});let z="";try{let F=A.jhZxjxjhb;typeof F=="string"&&/\d{4}-\d{4}-\d-\d/.test(F)?z=F:F&&typeof F=="object"&&(z=String(F.zxjxjhh||F.jhxnxq||F.executiveEducationPlanNumber||F.planNumber||""))}catch{}if(!z&&A.classrooms&&A.classrooms[0]&&A.classrooms[0].id&&(z=A.classrooms[0].id.executiveEducationPlanNumber||""),A.jxzc!=null&&Number(A.jxzc)>=1){let F=Number(A.jxzc);nt._termWeek=Math.max(nt._termWeek||0,F),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let D=["日","一","二","三","四","五","六"],J=Rl(A.date||l)||ep(new Date,s),j=A.week!=null?Number(A.week):J.getDay(),R=s===1?"明天":s===2?"后天":"今天";return{rooms:q,dateLabel:(A.date||l)+"（周"+(D[j]||j)+" · "+R+"）",jxzc:A.jxzc,planNumber:z,week:A.week!=null?A.week:j,searchDate:A.date||l,dateOffset:s}}a(Ol,"loadBuildingOccupancy");function ep(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(ep,"addDays");function Hl(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(Hl,"formatLocalDate");function Rl(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(Rl,"parseLocalDate");let rp={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function ap(t){return rp[t]||rp.more}a(ap,"ico");let nt=mi();function Ul(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=li,(document.head||document.documentElement).appendChild(t)}a(Ul,"ensureStyle");let Wl=sa({deps:{scoreToNumber:Je,scoreToGpa:Ge}}),{metricHtml:Gl,occupancyHtml:Jl,render:Ze,renderScheduleBoard:Hc,roomPickerHtml:Vl,scheduleRender:Yl}=_i({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:On,analyzeScores:a(t=>Wl.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Yt,bandsChartSvg:ca,bindUI:a(t=>Xl(t),"bindUI"),classifyPrivacyLabel:Wr,courseColor:Vn,ensureRoot:a(()=>np(),"ensureRoot"),escapeHtml:at,firstContentChar:Rr,getViewWeekNumber:Wn,ico:ap,isCleanAnalysisDirect:ha,occupancyKindClass:jl,occupancyTypeLabel:yr,personalizedProfile:Ks,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Je,summarizeCourses:re,trendChartSvg:la,weekBitActive:Gn,calVacation:gr,setCalendarPhase:Un}}),{ensureRoomCatalogLoaded:op,loadAll:Ql}=bi({state:nt,deps:{ensureTermWeekResolved:Al,enrichScoresWithEvaluation:Tl,getCurrentWeekNumber:Le,loadClassroomCatalog:Il,loadProfile:jn,loadSchedule:El,loadScores:Zn,readRememberedTermWeek:br,reconcileProfileAndScores:Ml,render:Ze,scheduleRender:Yl}}),{bindUI:Xl,closeModal:Kl,getRoomHost:Rc,openModal:Uc,openRoomModal:Wc,openScoreModal:Gc,showBuilding:Jc}=Ei({state:nt,deps:{DAY_NAMES:On,applyPersonalDisplay:Yt,bindScheduleExportHosts:gl,closeCleanMode:a(()=>tc(),"closeCleanMode"),ensureRoomCatalogLoaded:op,enrichOccupancyWithCurriculum:Dl,ensureRoot:a(()=>np(),"ensureRoot"),escapeHtml:at,fetchText:Vt,getCurrentWeekNumber:Le,getViewWeekNumber:Wn,inferMaxWeek:Sl,isUnevaluatedScore:ie,isValidOfficialGpa:Hr,loadBuildingOccupancy:Ol,metricHtml:Gl,occupancyHtml:Jl,render:Ze,rootEl:a(()=>ec(),"rootEl"),roomPickerHtml:Vl,scoreToGpa:Ge,scoreToNumber:Je,summarizeCourses:re,summarizeCoursesPreferOfficial:re}}),{cleanModeApi:Zl,closeCleanMode:tc,ensureRoot:np,injectCleanEntry:Vc,openCleanMode:Yc,rootEl:ec}=Ci({state:nt,deps:{CLEAN_FLAG:Ns,applySkinAttr:ee,closeModal:Kl,ensureRoomCatalogLoaded:op,ensureStyle:Ul,getCurrentWeekNumber:Le,getSkin:Zt,handleThemeDotClick:ct,ico:ap,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:Eo,loadAll:Ql,openSettingsPanel:rn,readRememberedTermWeek:br,refreshCleanPersonalDisplay:Va,render:Ze,scoreToGpa:Ge,summarizeCourses:re,syncNavbarThemeUI:gt,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=Zl;function ao(){if(!document.body){setTimeout(ao,10);return}if(Po(),Wt(Jt()),setTimeout(()=>{try{ge().then(e=>Se(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],i=r.parentElement;for(;i;){let s=i.scrollTop,l=i.scrollLeft;(s||l||i.scrollHeight>i.clientHeight||i.scrollWidth>i.clientWidth)&&o.push({el:i,top:s,left:l}),i=i.parentElement}requestAnimationFrame(()=>{o.forEach(s=>{s.el.scrollTop=s.top,s.el.scrollLeft=s.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))$o();else{is();try{En()}catch{}try{Vr()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Yt(document)}catch{}try{Rn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{Vr()}catch{}try{Yt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{ma()&&Eo()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(ao,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(Ce,50)}),window.addEventListener("load",()=>{Ce(),We(),setTimeout(Ce,100),setTimeout(Ce,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(We,0),setTimeout(We,50),setTimeout(We,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(We,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function pp(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let i=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),s=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));i&&!s&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){Ce(),Sn(),st(),Ce();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(s=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},s)),Ea(),Ko(),Zo(),Uo(),tn(),Xo(),Go(),document.querySelectorAll(".page-content, #page-content-template").forEach(s=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);s.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),s.style.setProperty("box-sizing","border-box","important")}),$r(),Br(),je(),setTimeout(je,300),setTimeout(je,1e3),Fo(),fe(),sr(),Oo(),setTimeout(sr,300),lr(),setTimeout(()=>lr(),500),Mr(),jo();try{Vr()}catch{}try{Yt(document)}catch{}setTimeout(()=>{try{Vr()}catch{}try{Yt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...i){let s=r.apply(this,i);return e(),s},history.replaceState=function(...i){let s=o.apply(this,i);return e(),s}}a(pp,"watchRouteChanges");let tr=typeof unsafeWindow<"u"?unsafeWindow:window;tr.__urpppDebug=tr.__urpppDebug||{},tr.__urpppDebug.setCalendarPhase=t=>Un(t),tr.__urpppDebug.getCalendarPhase=()=>kl(),tr.__urpppDebug.calVacation=t=>gr(t),tr.urppp={version:p,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Wt(t)},"apply"),setAccent:ji,getAccent:Qt,getCurrent:Jt,list:a(()=>Object.entries(Ct).map(([t,e])=>({name:t,displayName:e.name,current:t===Jt()})),"list")},update:{check:Ra,auto:Ha,showToast:Oa},privacy:{get:Ae,set(t){return fa(t),Yt(document),Ae()},apply:a(()=>Yt(document),"apply"),identity:{get:Ne,set(t){return Ao(t),Yt(document),Va(),Ne()}}},scheduleExport:{load:a(()=>Mn("api"),"load"),run:a(t=>sl(t,"api",null,null),"run"),patch:to,image:{theme:Nn,build:a((t,e)=>Bn(t,e),"build")},jsonFormat:{get:qr,set:_o,validate:Me,build(t,e){let r=Zr(t);if(e)return ea(r,Me(e));let o=qr();return o.enabled?ea(r,o.mapping):ta(r)},buildDefault(t){return ta(Zr(t))}}}};function ip(){setTimeout(()=>{try{Ha()}catch{}},1800)}a(ip,"scheduleAutoUpdateCheck");try{Po()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{ao(),pp(),ip()}):(ao(),pp(),ip())})();})();
