...
#urppp-toast{position:fixed;left:50%;bottom:24px;transform:translateX(-50%) translateY(16px);z-index:99999;max-width:min(560px,90vw);padding:10px 18px;border-radius:var(--radius,10px);background:var(--nav-bg,#2b2f36);color:var(--accent-contrast,#fff);font-size:13px;opacity:0;pointer-events:none;transition:.22s;box-shadow:0 8px 28px rgba(0,0,0,.24)}
#urppp-toast.show{opacity:1;transform:translateX(-50%) translateY(0);pointer-events:auto}
#urppp-toast.error{background:#b2392f}
#urppp-confirm{position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;padding:18px;background:rgba(15,23,42,.44);opacity:0;pointer-events:none;transition:.2s}
#urppp-confirm.show{opacity:1;pointer-events:auto}
#urppp-confirm .urppp-confirm-card{width:min(420px,100%);padding:16px 18px;border-radius:var(--radius,12px);background:var(--bg-card,#fff);border:1px solid var(--border,#e6e8ec);box-shadow:0 22px 60px rgba(15,23,42,.24)}
...
#urppp-confirm .urppp-confirm-ops button{flex:1;min-height:32px;padding:6px 12px;font-size:13px;border-radius:var(--radius,6px);border:1px solid var(--border,#e6e8ec);background:var(--bg-input,#fff);color:var(--text,#16181d);cursor:pointer;transition:.15s}
#urppp-confirm .urppp-confirm-ops button:hover{background:var(--hover-bg,#f0f1f3)}
#urppp-confirm .urppp-confirm-ops button[data-ok]{border-color:var(--accent,var(--link,#4a7bfa));background:var(--accent,var(--link,#4a7bfa));color:var(--accent-contrast,#fff)}
html.urppp-theme-dark #urppp-confirm .urppp-confirm-ops button{background:#2a2c30;border-color:#3a3d42;color:#e8e8ea}
html.urppp-theme-dark #urppp-confirm .urppp-confirm-ops button[data-ok]{background:var(--accent,var(--link,#4a7bfa));border-color:var(--accent,var(--link,#4a7bfa));color:var(--accent-contrast,#fff)}
