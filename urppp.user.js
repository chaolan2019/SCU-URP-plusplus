...
`;function pc(p){p.querySelectorAll("td, th").forEach(n=>{n.style.removeProperty("background"),n.style.removeProperty("background-color")}),p.querySelectorAll("th[rowspan]").forEach(n=>{n.style.removeProperty("width"),n.style.setProperty("white-space","nowrap"),n.style.setProperty("text-align","center")}),p.querySelectorAll("table").forEach(n=>{n.style.setProperty("background","#ffffff","important"),n.style.setProperty("background-color","#ffffff","important"),n.style.setProperty("border","none","important"),n.style.setProperty("color","#000000","important")}),p.querySelectorAll("th").forEach(n=>{if(n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important"),n.style.setProperty("font-weight","normal","important"),n.childNodes.length===1&&n.firstChild&&n.firstChild.nodeType===3){let c=document.createElement("span");c.textContent=n.textContent,n.textContent="",n.appendChild(c)}}),p.querySelectorAll("thead th").forEach(n=>{n.style.setProperty("background","#dddddd","important"),n.style.setProperty("background-color","#dddddd","important")}),p.querySelectorAll("tbody th").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important")}),p.querySelectorAll("td").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important"),n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important")})}a(pc,"normalizeNativePdfStage");function $p(p){let n=oc(),c=document.createElement("div");c.id="urppp-pdf-stage",c.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(n||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=p.cloneNode(!0);rc(u),ac(u),d.appendChild(u),c.appendChild(d),pc(u);let k=document.createElement("style");k.id="urppp-pdf-reset-style",k.textContent=nc,document.head.appendChild(k),document.body.appendChild(c);let P=c.querySelector("#urppp-pdf-mycoursetable"),S=c.querySelector("#urppp-pdf-page")||c;if(!P)throw c.remove(),new Error("无法建立原生课表捕获节点");return{stage:c,target:P,page:S,sourceHost:p}}a($p,"cloneNativePdfStage");var Zr=0;function de(){return Zr>0}a(de,"isNativePdfIsolationActive");function ic(p){return!p||p.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(p.id||"")||p.hasAttribute("data-urppp-style")?!0:(p.textContent||"").includes("urppp-")}a(ic,"isUrpppOwnedStyle");function Mp(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(Mp,"defaultPage");function Ip(p,n){let c=p&&typeof p.requestAnimationFrame=="function"?p.requestAnimationFrame.bind(p):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return c?c(n):setTimeout(n,0)}a(Ip,"scheduleFrame");function sc(p={}){let n=p.document||(typeof document<"u"?document:null),c=p.page||Mp();if(!n)throw new Error("原生 PDF 隔离缺少 document");let d=n.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");Zr+=1;let u=[d,...d.querySelectorAll("*")],k=[],P=n.getElementById("soliderbox");P&&k.push(P);let S=d.parentElement;for(;S&&S!==n.documentElement;){let x=S.classList;(S.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&k.push(S),S=S.parentElement}let y=n.getElementById("page-content-template")||n.querySelector(".page-content");y&&!k.includes(y)&&k.push(y);let A=[...u,...k],f=A.map(x=>({element:x,style:x.getAttribute("style")})),w=Array.from(n.querySelectorAll("style")).filter(ic).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),T=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=c&&c.divBuild,b=c&&c.__urpppOriginalDivBuild,m=!1,v=a(()=>{m||(m=!0,c&&c.divBuild===b&&typeof C=="function"&&(c.divBuild=C),f.forEach(({element:x,style:_})=>{x.isConnected&&(_===null?x.removeAttribute("style"):x.setAttribute("style",_))}),T.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),w.forEach(({style:x,disabled:_,media:q})=>{try{q===null?x.removeAttribute("media"):x.setAttribute("media",q),x.sheet&&(x.sheet.disabled=_)}catch{}}),Zr=Math.max(0,Zr-1),Ip(c,()=>{try{typeof p.onAfterRestore=="function"&&p.onAfterRestore()}catch{}}))},"restore");try{return w.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),A.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(_=>{x.style.getPropertyPriority(_)==="important"&&(_==="height"&&x.matches("td, th")||x.style.removeProperty(_))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),T.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),c&&typeof b=="function"&&(c.divBuild=b),v}catch(x){throw v(),x}}a(sc,"isolateScheduleForNativeExport");function Np(p,n={}){return new Promise((c,d)=>{let u=n.page||Mp(),k=u&&u.back,P=u&&u.html2canvas;if(!p||typeof k!="function"){d(new Error("教务原生导出依赖未就绪"));return}let S=null;try{S=sc(n)}catch(b){d(b);return}let y=0,A=!1,f=null,w=null,T=a(b=>{if(!A){A=!0,y&&clearTimeout(y),u&&f&&u.back===f&&(u.back=k),w&&u.html2canvas===w&&(u.html2canvas=P);try{S&&S()}catch{}b?d(b):c()}},"settle"),C=a(b=>T(b instanceof Error?b:new Error(String(b))),"fail");typeof P=="function"&&(w=a(function(){let b=P.apply(this,arguments);return b&&typeof b.catch=="function"&&b.catch(C),b},"scopedCanvas"),u.html2canvas=w),f=a(function(){try{return k.apply(this,arguments)}finally{setTimeout(()=>T(),0)}},"wrappedBack"),u.back=f,y=setTimeout(()=>{try{k.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},n.timeoutMs||60*1e3),Ip(u,()=>{try{p.click()}catch(b){C(b)}})})}a(Np,"exportNativePdfIsolated");var Bp=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
`;function Vp(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(Vp,"createCleanModeState");function Yp(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(Yp,"resetCleanModeData");function Qp({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(k){p.catalog=p.catalog||[],p.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&Yp(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let k=await n.ensureTermWeekResolved();!p.weekLocked&&k>=1&&(p.viewWeek=k)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(k){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(k){p.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}})(),(async()=>{let k=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),k=p.scores,n.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&n.enrichScoresWithEvaluation(k).then(()=>{p.scores===k&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(Qp,"createCleanModeDataLoader");var er={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},lc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},kr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function Zp(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(Zp,"calToday");function oo(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(oo,"calDayDiff");function no(p,n){let c=oo(er[p].start,n);return c<0?0:Math.floor(c/7)+1}a(no,"calWeekNo");function ro(p){return lc[p]||""}a(ro,"calLunar");function Xp(p){return String(p||"").slice(5)}a(Xp,"calYY");function cc(p){let n=p||Zp(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(cc,"calActiveTerm");function po(p,n){let c=p&&er[p]?p:"autumn",d=er[c],u=n||Zp(),k=d.events.map(f=>({e:f,d:oo(u,f.start)})).filter(f=>f.d>=-0).sort((f,w)=>f.d-w.d)[0],P=k?oo(u,k.e.start):null,S=no(c,u),y=Math.max(0,Math.min(100,S/d.weeks*100)),A=u>=d.start;return{term:d,termId:c,next:k,daysLeft:P,weekNo:S,progress:y,started:A,today:u}}a(po,"calStatus");function ti(p,n){let c=po(p,n),d=c.next?kr[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(ti,"calendarSummaryHtml");function ei(p,n){let c=po(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(ei,"calendarSummaryCompactHtml");function Kp(p,n){let c=po(p,n),d=c.next?kr[c.next.e.t].color:"#c9cdd4",u=c.term,k=Object.keys(er).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${er[w].name}</button>`).join(""),P=`<div class="cal-widget">
    <div class="cal-w-left">
      ...
      <div class="cal-w-sub">${c.next?c.next.e.start+(c.next.e.end&&c.next.e.end!==c.next.e.start?" ~ "+c.next.e.end:""):""}${c.next&&ro(c.next.e.start)?" · "+ro(c.next.e.start):""}</div>
    </div>
    <div class="cal-w-mid">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[w].map(C=>{let b=kr[C.t].color,m=C.end&&C.end!==C.start?"~"+Xp(C.end):"",v=no(c.termId,C.start)>0?`第 ${no(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${A(C.start)}">
          <span class="cal-ev-dot" style="background:${b}"></span>
          <span class="cal-ev-date">${Xp(C.start)}${m||""}<em>${ro(C.start)||"&nbsp;"}</em></span>
  ...
  </div>`}a(Kp,"calendarModalHtml");function ri(p,n){let c=typeof document<"u"?document:null;if(!c)return;ao();let d=p&&er[p]?p:cc(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${Kp(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>ao()),u.addEventListener("click",k=>{let P=k.target;if(P&&P.closest&&P.closest(".cal-close")){ao();return}let S=P&&P.closest?P.closest("[data-cal-term]"):null;if(S){let y=u.querySelector(".cal-body");y&&(y.innerHTML=Kp(S.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(A=>A.classList.toggle("ac",A.dataset.calTerm===S.dataset.calTerm))}})}a(ri,"openCalendarModal");function ao(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(ao,"closeCalendarModal");function ai(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),ri())})}a(ai,"bindCalendarOpen");var ta=!1;function io(){let p=typeof document<"u"?document:null;if(!p||ta)return ta;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${q?"":" hidden"}>${k()}</div>
      ...
      </div>${(()=>{try{return ei()}catch{return""}})()}</div></div>
...
<g>${V}</g>
${ct}
</svg>`}a(ra,"trendChartSvg");function aa({bands:p,palette:n,layout:c}){let d=p||[],u=ui(c,"bands",d.length),{width:k,height:P,pad:S,mobile:y}=u,A=k-S.left-S.right,f=P-S.top-S.bottom,w=d.length||1,T=Math.max(1,...d.map(m=>m.count)),C=y?Math.min(32,A/w*.62):Math.min(40,A/w*.52),b=d.map((m,v)=>{let x=S.left+(v+.5)*(A/w),_=m.count?Math.max(8,m.count/T*f):0,q=S.top+f-_,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=m.range||(m.min===0?"<60":`${m.min}-${m.max===100?"100":m.max}`),O=[`${m.level||""}（绩点 ${m.gpa}）`,`百分制 ${L}`,`课程 ${m.count} 门`].join(`
`);return`<rect class="urppp-sa-band" x="${(x-C/2).toFixed(1)}" y="${q.toFixed(1)}" width="${C.toFixed(1)}" height="${_.toFixed(1)}" rx="4" fill="${n.primary}" opacity="${I}"><title>${oe(O)}</title></rect>
<text x="${x.toFixed(1)}" y="${(q-6).toFixed(1)}" text-anchor="middle" font-size="12.5" font-weight="600" fill="var(--text)">${oe(m.count)}</text>
<text x="${x.toFixed(1)}" y="${P-26}" text-anchor="middle" font-size="11" font-weight="600" fill="${ae}">${oe(L)}</text>
<text x="${x.toFixed(1)}" y="${P-12}" text-anchor="middle" font-size="12" fill="${ae}">${oe(m.gpa)}</text>`}).join("");return`${so({...u,kind:"bands",label:"成绩分段分布"})}
<line x1="${S.left}" y1="${(S.top+f).toFixed(1)}" x2="${k-S.right}" y2="${(S.top+f).toFixed(1)}" stroke="${lo}" stroke-width="1"/>
${b}
...
${w}
<text x="75" y="69" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text)">${oe(A)}%</text>
<text x="75" y="91" text-anchor="middle" font-size="11.5" fill="${ae}">必修学分占比</text>
</svg>`}a(mi,"donutSvg");var mc=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),bc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',hc='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function bi({deps:p}){let n=p&&p.palette||mc;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
  <button type="button" class="urppp-sa-toggle" aria-expanded="false">
    ...
    <span class="urppp-sa-chevron">${hc}</span>
  </button>
...
<div class="urppp-sa-grid">
  ...
  `;function S(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(S,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function A(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(A,"cleanupPageLoadingOverlays");function f(t){try{let e=t&&t.querySelectorAll?t:document;A(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=S("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=S("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(f,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{f(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",b="urppp_scheme_v1",m="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",_="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",$="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:ft,syncThemeDotGroup:Z}=vi({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Gt,buildSchemePreview:Xt,getAccent:Yt,getBrutalActivePalette:fo,getBrutalPaletteById:ar,getBrutalSelectedPalette:go,getCurrent:Qt,getScheme:Le,getSkin:ne,isThemeModeAvailable:rr,setBrutalPalette:xo,skinSupportsDark:$e,skinSupportsDynamic:Me,skinSupportsFixedPalettes:ho},settings:{ensureSettingsPanel:Wo,openSettingsPanel:Ho,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let D=document.createElement("li");D.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",D.appendChild(o),r.appendChild(D)}let l=o.closest("li")||o.parentElement,g=Array.from(r.children).find(D=>{let R=D.querySelector(":scope > a");if(!R)return!1;let B=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return B.includes("customerServiceCenter")||/help|service|support/i.test(B)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),h=Array.from(r.children).find(D=>D.classList.contains("light-blue")),E=g||h||null;E&&l&&E!==l&&((l.compareDocumentPosition(E)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,E)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let M=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),M&&s.parentElement!==M&&M.appendChild(s),M&&M.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let j=s.querySelector("#search-input"),z=s.querySelector("form");if(!j||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let F=s.querySelector(".input-icon");F&&(F.style.setProperty("display","block","important"),F.style.setProperty("position","relative","important")),j.style.setProperty("display","block","important"),j.style.setProperty("width","100%","important"),j.style.setProperty("height","36px","important"),j.style.setProperty("box-sizing","border-box","important"),j.style.setProperty("padding","0 12px","important"),j.style.setProperty("border","1px solid var(--border)","important"),j.style.setProperty("border-radius","var(--radius-sm)","important"),j.style.setProperty("background","var(--input-bg)","important"),j.style.setProperty("color","var(--text)","important");let J=a(D=>{s.dataset.open=D?"1":"0",s.style.setProperty("width",D?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",D?"1":"0","important"),s.style.setProperty("pointer-events",D?"auto":"none","important"),i.setAttribute("aria-expanded",D?"true":"false"),D&&setTimeout(()=>j.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",D=>{D.preventDefault(),D.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",D=>{let R=document.getElementById("form-search"),B=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(D.target)||B?.contains(D.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function N(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,l=0,g=(o+i)/2;if(o!==i){let h=o-i;switch(l=g>.5?h/(2-o-i):h/(o+i),o){case t:s=(e-r)/h+(e<r?6:0);break;case e:s=(r-t)/h+2;break;default:s=(t-e)/h+4;break}s/=6}return{h:s*360,s:l,l:g}}a(N,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,i=o*(1-Math.abs(t/60%2-1)),s=r-o/2,l=0,g=0,h=0;return t<60?(l=o,g=i):t<120?(l=i,g=o):t<180?(g=o,h=i):t<240?(g=i,h=o):t<300?(l=i,h=o):(l=o,h=i),{r:Math.round((l+s)*255),g:Math.round((g+s)*255),b:Math.round((h+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:i,b:s}=Y(t,e,r);return hr(o,i,s)}a(tt,"hslHex");function ht(t){let{r:e,g:r,b:o}=Xe(Wt(t)||mt),i=N(e,r,o);return i.s<.12&&(i.s=.18),i}a(ht,"seedHsl");function bt(t,e,r){let o=Math.max(0,Math.min(100,r))/100,i=Math.max(0,Math.min(.95,e));return tt(t,i,o)}a(bt,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Wt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Wt(t)||mt,{h:r,s:o}=ht(e),i=Ft(r),s=Math.min(.72,Math.max(.28,o*.78));return bt(i,s,42)}a(Pt,"companionColor");function It(t,e){let r=Wt(t)||mt,{h:o,s:i}=ht(r),l=zt(e||ot),g=Math.min(.92,Math.max(.35,i*l.chroma)),h=Pt(r),{h:E}=ht(h),M=bt(o,g,l.primaryTone),j=bt(o,g,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),F,J,D;l.whiteCard?(F=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",D="#E5E7EB"):l.duo?(F=Bt(yt(h,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),D=Bt("#E5E7EB",h,.16)):(F=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),D=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?h:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),B=bt(o,Math.min(.45,g*.55),14),K=ge(bt(o,g*.3,34),.88),ut=ge(bt(o,g*.22,46),.76),vt=ge(M,.18),Et="0 4px 12px "+ge(M,.1)+", 0 1px 2px "+ge(M,.05);return{"--bg":F,"--surface":J,"--text":B,"--text-secondary":K,"--text-muted":ut,"--border":D,"--border-focus":M,"--input-bg":R,"--primary":M,"--primary-hover":j,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":h}}a(It,"buildMaterialSchemeVars");function Xt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Xt,"buildSchemePreview");function ze(t){let e=Wt(t)||Yt()||mt;return X.map(r=>Object.assign({},r,Xt(e,r.id)))}a(ze,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Yt(){return Wt(GM_getValue(T,""))||""}a(Yt,"getAccent");function Le(){let t=String(GM_getValue(b,ot)||ot);return X.some(e=>e.id===t)?t:ot}a(Le,"getScheme");function oa(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(b,e),e}a(oa,"setScheme");function wi(t,e){if(!t)return;let r=Wt(t);if(r){if(GM_setValue(T,r),e&&e.scheme&&oa(e.scheme),e&&e.skipTheme){let o=Ga(r,.15),i=ge(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",i);try{ft()}catch{}try{Dt()}catch{}return}Gt("scu-red");try{ft()}catch{}try{Dt()}catch{}}}a(wi,"applyAccent");function na(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(na,"getAccentPresets");function ki(t){let e=Wt(t||Yt()||mt);if(!e)return na();let r=na();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(ki,"saveAccentPreset");function Kt(){try{return!!GM_getValue(m,!1)}catch{return!1}}a(Kt,"isThemeFollowSystem");function Ar(t){return GM_setValue(m,!!t),!!t}a(Ar,"setThemeFollowSystem");function pa(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(pa,"isCleanDefault");function Ai(t){return GM_setValue(v,!!t),!!t}a(Ai,"setCleanDefault");function ia(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(ia,"isCleanAnalysisDirect");function Si(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(Si,"setCleanAnalysis");function xe(){try{let t=GM_getValue(_,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(xe,"isAppleEdgeLine");function _i(t){return GM_setValue(_,!!t),!!t}a(_i,"setAppleEdgeLine");function sa(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(sa,"isAutoUpdateCheck");function Ei(t){return GM_setValue(c,!!t),!!t}a(Ei,"setAutoUpdateCheck");function Sr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(Sr,"readJsonSetting");function _r(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(_r,"writeJsonSetting");function ye(){return Za(Sr(O,null))}a(ye,"getPrivacySettings");function la(t){return _r(O,Za(t))}a(la,"setPrivacySettings");function qe(){return wr(Sr($,null))}a(qe,"getCustomIdentity");function co(t){return _r($,wr(t))}a(co,"setCustomIdentity");function ca(){let t=Sr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ca,"getScheduleFirstMondayMap");function uo(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ca();r[String(t)]=String(e),_r(H,r)}a(uo,"rememberScheduleFirstMonday");function Er(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=Sr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},i={enabled:!!o.enabled,mapping:Pe(o.mapping||xr)};return et="",i}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:Pe(xr)}}}a(Er,"getScheduleJsonFormatSettings");function mo(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:Pe(e.mapping||xr)};return et="",_r(G,r)}a(mo,"setScheduleJsonFormatSettings");function bo(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(bo,"isHomePage");function Cr(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(Cr,"isFollowUseDynamic");function da(t){return GM_setValue(q,!!t),!!t}a(da,"setFollowUseDynamic");function Ci(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Ci,"systemPrefersDark");function ve(){return Ci()&&$e()?"dark":Cr()&&Me()?"scu-red":"default"}a(ve,"resolveFollowThemeName");function rr(t,e){return t==="dark"?$e(e):t==="scu-red"?Me(e):t==="default"}a(rr,"isThemeModeAvailable");function Gt(t,e){e=e||{},!$e()&&Kt()&&Ar(!1),!Me()&&Cr()&&da(!1),e.manual&&Ar(!1);let r;e.system||Kt()&&!e.manual?r=ve():(r=Ct[t]?t:Qt()||"default",Ct[r]||(r="default")),rr(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(w,r),ue();let i=document.getElementById("urppp-theme-vars")||(()=>{let E=document.createElement("style");return E.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(E),E})(),s=Yt(),l=Object.assign({},o.vars);if(r==="scu-red"){let E=s||mt,M=Le();l=Object.assign(l,It(E,M));let j=l["--primary"]||E,z=l["--primary-hover"]||Ga(j,.12);document.documentElement.style.setProperty("--urppp-accent",j),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||ge(j,.15)),document.documentElement.style.setProperty("--urppp-seed",E),document.documentElement.style.setProperty("--urppp-scheme",M)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let g=":root {";for(let[E,M]of Object.entries(l))g+=`${E}:${M};`;g+="}",i.textContent=g,document.body&&(document.body.style.fontFamily=o.font);try{let E=document.documentElement;E.dataset.urpppTheme=r,E.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),E.classList.add("urppp-theme-"+r),E.classList.toggle("urppp-theme-follow",Kt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Kt()))}catch{}try{pe()}catch{}try{ft()}catch{}try{Dt()}catch{}try{Mo()}catch{}try{Mi()}catch{}let h=document.getElementById("urppp-boot-loader");h&&(h.style.fontFamily=o.font)}a(Gt,"applyTheme");function Qt(){return GM_getValue(w,"default")}a(Qt,"getCurrent");function Te(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(Te,"themeDownloaded");function ne(){let t=GM_getValue(d,"apple"),e=u.find(r=>r.id===t);return e&&e.ready&&(e.installed!==!1||Te(e.id))?t:"apple"}a(ne,"getSkin");function ua(t,e){let r=t||ne(),o=u.find(i=>i.id===r);return!!(o&&o[e])}a(ua,"getSkinCapability");function $e(t){return ua(t,"dark")}a($e,"skinSupportsDark");function Me(t){return ua(t,"dynamic")}a(Me,"skinSupportsDynamic");function ho(t){return ua(t,"palettes")}a(ho,"skinSupportsFixedPalettes");function ar(t){return Q.find(e=>e.id===t)||Q[0]}a(ar,"getBrutalPaletteById");function go(){let t=String(GM_getValue(I,"acid")||"acid"),e=ar(t);return e.id===V?ar("acid"):e}a(go,"getBrutalSelectedPalette");function fo(){let t=String(GM_getValue(L,V)||V);return ar(t)}a(fo,"getBrutalActivePalette");function xo(t,e){let r=e||{},o=ar(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{pe()}catch{}try{ft()}catch{}try{Dt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}}a(xo,"setBrutalPalette");function Pi(t){let e=t||ne();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&xe()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&xe()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Pi,"getSkinShapeOverrides");function Ie(){try{let t=ne();if(t==="apple")return xe()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Ie,"urpppCardBorderValue");function pe(){let t=ne();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&xe();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=Pi(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=fo();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=xe(),l=s?"1px solid rgba(0,0,0,0.08)":"none",g=s?"1px solid rgba(255,255,255,0.10)":"none",h=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+g+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+h+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let i=document.head||document.documentElement;e.parentNode===i&&i.lastElementChild!==e&&i.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Vt(document)}catch{}},0)}a(pe,"applySkinAttr");function yo(t){let e=u.find(r=>r.id===t&&r.ready&&(r.installed!==!1||Te(r.id)));if(!e)return!1;GM_setValue(d,e.id);try{e.dynamic||da(!1),!e.dark&&Kt()&&Ar(!1);let r=Kt(),o=r?ve():Qt(),i=rr(o,e.id)?o:"default";pe(),Gt(i,{system:r})}catch{try{pe()}catch{}}try{Dt()}catch{}try{ft()}catch{}try{let r=document.getElementById("urppp-clean-root");r&&typeof r.__syncCleanThemeDots=="function"&&r.__syncCleanThemeDots()}catch{}return!0}a(yo,"setSkin");function zi(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Kt())try{Gt(ve(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(zi,"bindSystemThemeListener");try{Kt()?Gt(ve(),{system:!0}):Gt(Qt())}catch{}try{pe()}catch{}try{zi()}catch{}function Li(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let i=e.match(o);if(i)return i[0].trim()}return""}a(Li,"extractLoginErrorMessage");function vo(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(vo,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=Li(e),i=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let g=location.pathname==="/loginEn",h=a((R,B)=>g?B:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      <div class="uc">
        ...
        <div class="urppp-store-sub-body" id="urppp-store-sub-body"></div>`,e.appendChild(r),r.querySelector("#urppp-store-sub-back").onclick=Gi);let o=r.querySelector("#urppp-store-sub-title"),i=r.querySelector("#urppp-store-sub-body");o.textContent=t==="theme"?"主题商店":"插件商店",i.innerHTML="",t==="theme"?Xo(i):Ko(i),r.classList.add("open")}a(_a,"openStoreSubPanel");function Gi(){let t=document.getElementById("urppp-store-subpanel");if(!t)return;t.classList.remove("open");let e=t.querySelector("#urppp-store-sub-body");e&&(e.innerHTML="")}a(Gi,"closeStoreSubPanel");function Go(t){t.querySelectorAll(".urppp-store-tab").forEach(e=>{e.addEventListener("click",()=>{t.querySelectorAll(".urppp-store-tab").forEach(o=>o.className="urppp-store-tab"),e.className="urppp-store-tab ac",t.querySelectorAll(".urppp-store-pane").forEach(o=>o.style.display="none");let r=t.querySelector('.urppp-store-pane[data-pane="'+e.dataset.tab+'"]');r&&(r.style.display="")})})}a(Go,"bindStoreTabs");function Ji(t,e){let r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-skin="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
      <div class="urppp-skin-meta">${at(t.author||"")}${t.author&&t.version?" · ":""}v${at(t.version||"")}${r?" · "+r:""}</div>
    ...
    </div>`}a(Ji,"themeStoreCard");async function Vi(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await De()).filter(o=>o.type==="theme"&&!Te(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>Ji(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>Yi(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(Vi,"fetchCatalogThemes");async function Yi(t,e){if(!e||e.disabled)return;let r=(await De()).find(i=>i.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length)return;e.disabled=!0,e.textContent="下载中…";let o="";for(let i of r.entry)try{let s=await fetch(i,{cache:"no-store"});if(s.ok){o=await s.text();break}}catch{}if(!o){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,o)}catch{}try{typeof GM_addStyle=="function"&&GM_addStyle(o)}catch{}e.textContent="已安装",e.disabled=!0;try{Dt()}catch{}}a(Yi,"downloadStoreTheme");function Qi(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-set-btn ghost" data-theme-del="${at(t.id)}">删除</button>`,i=e&&e.repo||t.repo?`<button type="button" class="urppp-set-btn ghost" data-repo="${at(e&&e.repo||t.repo)}">仓库</button>`:"",s=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"";return`<div class="urppp-skin-card" data-skin="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name)}</div>
      <div class="urppp-skin-meta">${at(e&&e.author||"")}${e&&e.author&&t.version?" · ":""}v${at(t.version||"")}${s?" · "+s:""}</div>
      <p class="urppp-skin-desc">${at(t.desc||"")}</p>
      <div class="urppp-store-ops" style="position:absolute;right:12px;bottom:12px">
        <button type="button" class="urppp-skin-apply" data-theme-use="${at(t.id)}">使用</button>${o}${i}
      </div>
    </div>`}a(Qi,"themeManageCardHtml");async function Xi(t){if(!t)return;let e=[];try{e=await De()}catch{}let r=u.filter(o=>o.installed!==!1||Te(o.id));if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}t.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>Qi(o,e.find(i=>i.id===o.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(o=>o.addEventListener("click",()=>{yo(o.dataset.themeUse)&&Dt()})),t.querySelectorAll("[data-theme-del]").forEach(o=>o.addEventListener("click",()=>{try{GM_setValue("urppp_theme_css_"+o.dataset.themeDel,"")}catch{}try{Dt()}catch{}let i=t.closest(".urppp-store-inline");try{Xo(i)}catch{}})),t.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(Xi,"fetchThemeManage");function Jo(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(Jo,"storeManageSettingsHtml");let Ki=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];async function De(){for(let t of Ki)try{let e=await fetch(t,{cache:"no-store"});if(e.ok){let r=await e.json();if(r&&Array.isArray(r.items))return r.items}}catch{}return[]}a(De,"fetchCatalogList");function Vo(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let i=0;i<Math.max(r.length,o.length);i+=1){let s=r[i]||0,l=o[i]||0;if(s!==l)return s>l}return!1}a(Vo,"versionGt");function Zi(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let i=t.querySelector('[data-theme-use="'+o.id+'"]');i&&Vo(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(Yo(i.closest(".urppp-store-item"),"主题"),r+=1);let s=t.querySelector('[data-plugin-id="'+o.id+'"]');if(s){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&Vo(o.version,l.version)&&(Yo(s.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(Zi,"applyStoreUpdateBadges");function Yo(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(Yo,"addUpdateBadge");function Qo(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),i=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");i(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),i()}),r.addEventListener("click",async()=>{r.disabled=!0;let s=r.textContent;r.textContent="检查中…";try{let l=await De(),g=Zi(t,l);r.textContent=g?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=s,r.disabled=!1},1600)})}a(Qo,"bindStoreManageSettings");function Xo(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${Jo()}<div class="urppp-store-empty"><p>加载中…</p></div></div>
        </div>
      </div>`,Go(t),Qo(t),Vi(t),Xi(t.querySelector('[data-pane="manage"]'))}a(Xo,"renderThemeStoreBody");function ts(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
    ...
    </div>`}a(ts,"pluginStoreCard");async function es(t){if(!t)return;let e=[];try{e=(await De()).filter(r=>r.type==="plugin"&&!(_t&&_t.api&&_t.api.isEnabled&&_t.api.isEnabled(r.id)))}catch{}if(!e.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载插件</p><p class="urppp-store-sub">已安装的插件不会再显示在这里。</p></div>';return}t.innerHTML=`<div class="urppp-store-theme-grid">${e.map(r=>ts(r)).join("")}</div>`,t.querySelectorAll("[data-plugin-apply]").forEach(r=>r.addEventListener("click",async()=>{r.disabled=!0;let o=r.textContent;r.textContent="下载中…";try{_t&&_t.api&&_t.api.install&&await _t.api.install(r.dataset.pluginApply,null),r.textContent="已安装";try{Dt()}catch{}}catch{r.textContent="失败"}setTimeout(()=>{r.textContent=o,r.disabled=!1},1200)})),t.querySelectorAll("[data-repo]").forEach(r=>r.addEventListener("click",()=>{try{window.open(r.dataset.repo,"_blank","noopener")}catch{}}))}a(es,"fetchCatalogPlugins");async function rs(t){if(!t)return;let e=[];try{e=await De()}catch{}let r=_t&&_t.api&&_t.api.list&&_t.api.list()||[];if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}t.innerHTML=r.map(o=>{let i=e.find(g=>g.id===o.id),s=i&&i.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(i.downloads))}</span>`:"",l=o.repo||i&&i.repo?`<button type="button" class="urppp-set-btn ghost" data-repo="${at(o.repo||i.repo)}">仓库</button>`:"";return`<div class="urppp-store-item">
      ...
      <div class="urppp-store-inline">
        ...
        <div class="urppp-store-body">
          <div class="urppp-store-pane" data-pane="download"><div class="urppp-store-empty"><p class="urppp-store-empty-title">加载中…</p></div></div>
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${Jo()}<div class="urppp-store-bd" id="urppp-plugin-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div>
        </div>
      </div>`,Go(t),Qo(t),es(t.querySelector('[data-pane="download"]')),rs(t.querySelector("#urppp-plugin-manage"))}a(Ko,"renderPluginStoreBody");function as(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>_a("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=ne();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}u.filter(i=>i.installed!==!1||Te(i.id)).forEach(i=>{let s=document.createElement("div");s.className="urppp-skin-card"+(i.id===o?" is-active":""),s.dataset.skin=i.id;let l=document.createElement("button");l.type="button",l.className="urppp-skin-apply";let g=i.installed!==!1||Te(i.id);g?i.id===o&&i.ready?(l.classList.add("is-current"),l.textContent="使用中",l.disabled=!0):l.textContent="应用主题":(l.classList.add("is-disabled"),l.textContent="去下载"),l.addEventListener("click",h=>{if(h.preventDefault(),h.stopPropagation(),!g){_a("theme");return}if(!(i.id===o&&i.ready)&&yo(i.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),s.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),s.querySelector(".urppp-skin-name").textContent=i.name,s.querySelector(".urppp-skin-desc").textContent=i.desc,s.appendChild(l),r.appendChild(s)})}a(as,"renderSkinCards");let je=[],Ea=!1;function os(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,i=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(s=>{if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).finally(()=>{i&&clearTimeout(i)})}a(os,"fetchWithTimeout");function ns(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(i=>{i.status>=200&&i.status<400?r(i.responseText||""):o(new Error("HTTP "+i.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(i){o(i)}})}a(ns,"gmRequestForUpdate");function ps(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),os(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return ns(t,r);throw o})}a(ps,"fetchTextForUpdate");async function Ca(t,e,r=1e3){let o=[],i=t[0],s=t.slice(1),l=a(z=>ps(z,e).then(F=>({url:z,text:F})).catch(F=>(o.push((z.split("/")[2]||z)+": "+(F&&F.message||F)),null)),"grab"),g=l(i),h=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),E=await Promise.race([g,h]);if(E!=="__TIMEOUT__"){if(E&&E.text&&E.text.length>0)return E.text;let F=(await Promise.all(s.map(l))).find(J=>J&&J.text&&J.text.length>0);if(F)return F.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let M=Promise.all(s.map(l)).then(z=>{let F=z.find(J=>J&&J.text&&J.text.length>0);if(F)return F.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),j=g.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([j,M])}a(Ca,"fetchFirstAvailable");function we(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(we,"setUpdateStatus");async function Pa(){let t=p,e="",r=!1,o="";try{let s=await Ca(n.sourceUrls(n.versionJson)),l=JSON.parse(s);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let s=await Ca(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=Va(s)}if(!e)throw new Error("无法解析远程主插件版本");let i=gr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:i>0?"update":i===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:r?o:""}}a(Pa,"checkMainUpdate");function Zo(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let i=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,s=[],l;for(;(l=i.exec(o))!==null;)s.push({ver:l[1],index:l.index,headEnd:i.lastIndex});if(!s.length)return"";for(let h=0;h<s.length;h++){let E=h+1<s.length?s[h+1].index:o.length;s[h].body=o.slice(s[h].index,E).trim()}let g=[];for(let h of s)gr(h.ver,r)>0||gr(h.ver,e)<=0||g.push(h.body);return g.join(`

`).trim()}a(Zo,"extractChangelogRange");function tn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(tn,"ensureUpdateToastStyles");function is(t){let e=String(t||"").replace(/\r\n/g,`
...
`),i=[],s=!1,l=a(()=>{s&&(i.push("</ul>"),s=!1)},"closeList");for(let g=0;g<o.length;g++){let E=o[g].replace(/\s+$/,"");if(!E.trim()){l();continue}let M=E.match(/^(#{2,3})\s+(.+)$/);if(M){l();let z=M[1].length,F=M[2];i.push(z===2?`<h2>${r(F)}</h2>`:`<h3>${r(F)}</h3>`);continue}let j=E.match(/^[-*]\s+(.+)$/);if(j){s||(i.push("<ul>"),s=!0),i.push(`<li>${r(j[1])}</li>`);continue}l(),i.push(`<p>${r(E)}</p>`)}return l(),i.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(is,"renderChangelogMarkdown");function en(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(en,"hideUpdateToast");function ss(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="background-color"&&i.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(ss,"hideChangelogModal");function rn(t,e){tn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,r.addEventListener("click",o=>{(o.target===r||o.target&&o.target.getAttribute&&o.target.getAttribute("data-close")==="1")&&ss(r)}),document.documentElement.appendChild(r)),r.querySelector("h3").textContent=t||"更新日志",r.querySelector(".uuc-body").innerHTML=e||'<p class="uuc-meta">暂无更新日志</p>',r.__closing=!1,r.classList.remove("open","closing"),r.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add("open"))})}a(rn,"openChangelogModal");function za(t){tn();let e=document.getElementById("urppp-update-toast");e||(e=document.createElement("div"),e.id="urppp-update-toast",e.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>en(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let i=o.getAttribute("data-act"),s=e.__pack||{};if(i==="later"){en(e);return}if(i==="go"){let l=s.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(i==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=s.changelogMd;l||(l=await Ca(n.sourceUrls("CHANGELOG.md")),s.changelogMd=l);let g=Zo(l,s.local,s.remote),h=g?is(g):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';rn("更新日志 "+s.local+" → "+s.remote,h)}catch(l){rn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(za,"showUpdateToast");async function La(){if(sa()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await Pa();t&&t.status==="update"&&za(t);let e=await ls();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(La,"maybeAutoCheckUpdate");function ls(){let t=(window.__urpppUpdateCheckers||je||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?_t.update("assist"):null).catch(()=>null)}a(ls,"hotUpdateAssist");async function qa(){if(Ea)return;Ea=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),we("正在从多源检查更新…");try{let e=[Pa()];(je||[]).forEach(h=>{h&&typeof h.check=="function"&&e.push(Promise.resolve().then(()=>h.check()).then(E=>E||{id:h.id||"extra",name:h.name||"扩展",status:"err",message:"无结果"}).catch(E=>({id:h.id||"extra",name:h.name||"扩展",status:"err",message:String(E&&E.message||E)})))});let r=await Promise.all(e),o=r.map(h=>{if(!h)return"";if(h.status==="err")return`• <b>${at(h.name||h.id)}</b>：检查失败（${at(h.message||"unknown")}）`;if(h.status==="update"){let E="";if(h.id==="assist"&&_t&&_t.loaded("assist"))E=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let M=h.updateUrl?` <a href="${at(h.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",j=h.pageUrl?` <a href="${at(h.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";E=M+j}return`• <b>${at(h.name)}</b>：发现新版本 <b>${at(h.remote)}</b>（当前 ${at(h.local)}）${E}`}return h.status==="ahead"?`• <b>${at(h.name)}</b>：本地 ${at(h.local)} 新于远程 ${at(h.remote)}`:`• <b>${at(h.name)}</b>：已是最新（${at(h.local)}）`}).filter(Boolean),i=r.some(h=>h&&h.status==="update"),s=r.some(h=>h&&h.status==="err");we(`${i?"检查完成：发现更新":s?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,s?"err":"ok");let g=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');g&&g.addEventListener("click",()=>{try{we("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{we("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(h=>{we("重新装载失败："+(h&&h.message?h.message:h),"err")})}catch(h){we("重新装载失败："+(h&&h.message?h.message:h),"err")}})}catch(e){we("检查失败："+at(e&&e.message||e),"err")}finally{Ea=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(qa,"checkForUpdates");function an(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+p,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(an,"refreshUpdateStatusHint");function cs(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=je.findIndex(i=>i&&i.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?je[r]=o:je.push(o);try{let i=document.getElementById("urppp-set-update-status");i&&o.localVersion&&e==="assist"&&i.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{an()}catch{}return!0}a(cs,"registerUpdateChecker");function ds(){let t={version:p,urls:n,check:qa,checkMain:Pa,registerChecker:cs,compareVersions:gr,parseUserscriptVersion:Va,extractChangelogRange:Zo,showUpdateToast:za,maybeAutoCheckUpdate:La,listCheckers:a(()=>je.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(ds,"publishUpdateApi"),ds();let{rebuildSidebarCompletely:on,syncMobileContentOffset:Oe,syncSidebarUnderNavbar:ke}=yi({}),{rebuildDashboard:us}=li({deps:{statCardPrivacyMarkup:fs}}),ms="urppp-clean-open",Ta={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ie(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ie,"isUnevaluatedScore");function Ir(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Ir,"isValidOfficialGpa");function Nr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Nr,"firstContentChar");function $a(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a($a,"weekBitmapActive");function He(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ie(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Ta[o]!=null?Ta[o]:Ta[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(He,"scoreToGpa");function Re(t){let e=String(t||"").trim();if(!e||ie(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(Re,"scoreToNumber");function Ae(t){return Math.round((Number(t)||0)*100)/100}a(Ae,"round2");function nn(t){return/必修/.test(String(t||""))}a(nn,"isRequiredAttr");function te(t){let e=0,r=0,o=0,i=0,s=0,l=0,g=0,h=0;return(t||[]).forEach(E=>{if(E&&(E.unevaluated||ie(E.score)))return;let M=Number(E.credit)||0,j=Re(E.score),z=Ir(E.officialGpa)?Number(E.officialGpa):He(E.score);j==null||M<=0||(e+=M,r+=j*M,z!=null&&(o+=z*M,i+=M),E.required&&(s+=M,l+=j*M,z!=null&&(g+=z*M,h+=M)))}),{totalCredit:Ae(e),avgScore:Ae(e?r/e:0),avgGpa:Ae(i?o/i:0),requiredCredit:Ae(s),requiredGpa:Ae(h?g/h:0),requiredAvg:Ae(s?l/s:0),count:(t||[]).length}}a(te,"summarizeCourses");function Ma(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Ma,"absUrl");function Jt(t,e){let r=Ma(t),o=e&&e.method||"GET",i=e&&e.data||null;return new Promise((s,l)=>{let g=a((h,E)=>h?s(E):l(new Error(E||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:i||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(h=>{h.status>=200&&h.status<400?g(!0,h.responseText||""):g(!1,"HTTP "+h.status)},"onload"),onerror:a(()=>g(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:i||void 0}).then(h=>{if(!h.ok)throw new Error("HTTP "+h.status);return h.text()}).then(h=>g(!0,h)).catch(h=>g(!1,h&&h.message))})}a(Jt,"fetchText");function Br(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Br,"parseHtml");function pn(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=Bp,(document.head||document.documentElement).appendChild(t)}a(pn,"ensureFeatureStyles");function bs(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=jp,(document.head||document.documentElement).appendChild(t)}a(bs,"ensureScheduleExportStyles");function hs(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=Op,(document.head||document.documentElement).appendChild(t)}a(hs,"ensureSettingsStyles");function sn(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let i=r.cloneNode(!0);i.querySelectorAll("small, i, img, b, .badge").forEach(g=>g.remove());let s=(i.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(g=>{g.nodeType===Node.TEXT_NODE&&g.textContent.trim()&&g.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=s||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(sn,"ensureNavNameTarget");function Fr(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Fr,"classifyPrivacyLabel");function gs(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(gs,"classifyHomeDataKey");function Dr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Dr,"homePrivateValueSpan");function fs(t,e){let r=at(t),o=at(e),i=gs(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[i]||Fr(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:Dr("organization",i,o)}:{valueHtml:Dr("organization",i,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let g=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&g){let E=g.index||0,M=String(e).slice(0,E),j=String(e).slice(E+g[0].length);return{valueHtml:r,labelHtml:`${at(M)}${Dr(l,i,at(g[0]))}${at(j)}`}}return{valueHtml:Dr(l,i,r),labelHtml:o}}a(fs,"statCardPrivacyMarkup");function Se(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||vr;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||vr)}a(Se,"privacyReplacement");function sr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(sr,"markPrivateText");function ln(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||vr);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(ln,"markPrivateAvatar");function xs(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(xs,"markPrivateBlock");function ys(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(ys,"markDirectEditable");let be=null;function cn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;be&&be.__finish&&be.__finish(!1);let r=ye();if(r.mode!=="custom"||!r.directEdit.enabled)return;let i=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),s=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),g=s.height>=8||!l?s:{left:s.left,top:l.top,width:Math.max(s.width,40),height:l.height},h=document.createElement("input"),E=getComputedStyle(t),M=Math.min(Math.max(g.width+64,140),Math.max(140,window.innerWidth-24)),j=Math.min(Math.max(12,g.left),Math.max(12,window.innerWidth-M-12)),z=Math.min(Math.max(12,g.top+(g.height-36)/2),Math.max(12,window.innerHeight-48));h.type="text",h.maxLength=80,h.className="urppp-direct-edit-input",h.value=i,h.setAttribute("aria-label","修改"+U[e]+"显示值"),h.style.left=j+"px",h.style.top=z+"px",h.style.setProperty("--urppp-direct-edit-width",M+"px"),h.style.fontFamily=E.fontFamily,h.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(E.fontSize)||14)))+"px";let F=!1,J=a(D=>{if(F||(F=!0,h.remove(),be===h&&(be=null),D))return;let R=ye();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(h.value||"").trim().slice(0,80),la(R),Vt(document),Da(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");h.__finish=J,h.addEventListener("click",D=>D.stopPropagation()),h.addEventListener("blur",()=>J(!1)),h.addEventListener("keydown",D=>{D.key==="Enter"&&(D.preventDefault(),J(!1)),D.key==="Escape"&&(D.preventDefault(),J(!0))}),document.documentElement.appendChild(h),be=h,h.focus(),h.select()}a(cn,"openDirectEditInput");function vs(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),cn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),cn(e))},!0))}a(vs,"bindDirectEditInteraction");function ws(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(ws,"clearPrivacyDisplay");function dn(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(dn,"applyCustomText");function ks(t){let e=t&&t.querySelectorAll?t:document,r=qe(),i=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?sn(e):null);dn(i,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(g=>{let h=g.querySelector(".profile-info-name"),E=g.querySelector(".profile-info-value");!h||!E||String(h.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||dn(E,r.nameEnabled,r.name)});let s=tr(r.avatar),l=r.avatarEnabled&&!!s;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(g=>{let h=g.getAttribute("src")||"";h&&h!==g.__urpppAppliedCustomSrc&&(g.__urpppOriginalSrc=h),l?(g.__urpppOriginalSrc==null&&(g.__urpppOriginalSrc=h),h!==s&&g.setAttribute("src",s),g.__urpppAppliedCustomSrc=s):g.__urpppAppliedCustomSrc!=null&&(g.__urpppOriginalSrc&&g.setAttribute("src",g.__urpppOriginalSrc),delete g.__urpppAppliedCustomSrc)})}a(ks,"applyCustomIdentityDisplay");function As(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),i=r.querySelector(".profile-info-value, td:last-child");if(!o||!i||o===i)return;let s=Fr(o.textContent),l=Se(e,s);l&&sr(i,l)})}a(As,"applyProfilePrivacy");function Ss(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let i=o.map(s=>{let l=Fr(s.textContent);return["grade","gpa","credit"].includes(l)?l:""});i.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(s=>{let l=s.querySelectorAll("td");i.forEach((g,h)=>{let E=Se(e,g);g&&E&&sr(l[h],E)})})})}a(Ss,"applyScoreTablePrivacy");function _s(t){let e=t&&t.querySelectorAll?t:document,r=ye();if(r.mode==="off")return;let o=Se(r,"name"),i=Se(r,"avatar"),s=Se(r,"schedule"),l=o?sn(e):e.querySelector?.(".urppp-user-name-value");o&&sr(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([E,M])=>{let j=Se(r,M);j&&e.querySelectorAll(E).forEach(z=>sr(z,j))}),Ss(e,r);let h=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(E=>{let M=E.getAttribute("data-urppp-private"),j=E.getAttribute("data-urppp-edit-key"),F=(h&&j?String(r.directEdit.values[j]||"").trim():"")||Se(r,M);!["avatar","schedule"].includes(M)&&F&&sr(E,F),h&&j&&ys(E,j)}),h&&vs(),As(e,r),i&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(E=>{let M=E.matches("img")?E:E.querySelector("img");M?ln(M,i):(E.classList.add("urppp-private-avatar-block"),E.setAttribute("data-urppp-private-mask",i))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(E=>ln(E,i))),s){let E=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));E.filter(M=>!E.some(j=>j!==M&&j.contains(M))).forEach(M=>xs(M,s))}}a(_s,"applyPrivacyDisplay");let Ia=0,se=[];function un(){let t=ye(),e=qe();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(un,"personalDisplayIsEnabled");function Es(){se=se.filter(({root:t})=>t&&t.isConnected),se.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(Es,"resumePersonalDisplayObservers");function Vt(t){let e=t||document;se.forEach(({observer:r})=>r.disconnect());try{pn()}catch{}try{ws(e)}catch{}try{ks(e)}catch(r){console.warn("[URP++] custom identity",r)}try{_s(e)}catch(r){console.warn("[URP++] privacy",r)}un()?(Es(),Ps()):(clearTimeout(Ia),se=[])}a(Vt,"applyPersonalDisplay");function Cs(t){clearTimeout(Ia),Ia=setTimeout(()=>Vt(t||document),140)}a(Cs,"schedulePersonalDisplay");function Na(){try{nt&&nt.open&&Ye()}catch{}}a(Na,"refreshCleanPersonalDisplay");function Ps(){if(!un()){se.forEach(({observer:t})=>t.disconnect()),se=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(se.some(r=>r.root===t))return;let e=new MutationObserver(()=>Cs(document));se.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(Ps,"bindPersonalDisplayObservers");function zs(t){let e=Object.assign({},t||{}),r=qe();r.nameEnabled&&r.name&&(e.name=r.name);let o=tr(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(zs,"personalizedProfile");let mn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",Ls="/student/courseSelect/thisSemesterCurriculum/callback",qs="/student/courseSelect/thisSemesterCurriculum/index";async function Ts(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Jt(Ls),r=JSON.parse(e),o=Ze(r);if(o)return o}catch{}return""}a(Ts,"resolveSchedulePlanCode");async function bn(t){let e=await Ts(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Jt(mn,r),i;try{i=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=Ze(i)),(!i.jcsjbs||!i.jcsjbs.length)&&e&&(i=JSON.parse(await Jt(mn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let s=gn(i,e,t);if(!s.courses.length)throw new Error("没有读取到可导出的课表数据");return s}a(bn,"loadScheduleExportData");function Ba(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(Ba,"safeScheduleFilename");function Fa(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(Fa,"downloadBlob");function $s(t){let e=Gr(t),r=Er(),o=r.enabled?Vr(e,r.mapping):Jr(e),i=JSON.stringify(o,null,2)+`
`;return Fa(new Blob([i],{type:"application/json;charset=utf-8"}),Ba(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a($s,"exportScheduleJson");function hn(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let i=Number(r[4]);if(i<1||i>30)return"";let s=Xa(new Date);return s.setDate(s.getDate()-(i-1)*7),yr(s)}a(hn,"deriveCurrentSemesterMonday");function gn(t,e,r){let o=e||Ze(t),i=hn(o)||ca()[o]||"";return ap(t,o,r,{firstMonday:i})}a(gn,"normalizeScheduleDataForPage");function Ms(t){let e=t.semester.planCode,r=ca()[e],o=hn(e);return o?(uo(e,o),Promise.resolve(o)):Ke(r)?Promise.resolve(r):new Promise((i,s)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||Kn(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let g=a((h,E)=>{l.remove(),h?s(h):i(E)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>g(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let h=l.querySelector("input").value;Ke(h)&&(uo(e,h),g(null,h))}),l.addEventListener("click",h=>{h.target===l&&g(new Error("已取消导出"))})})}a(Ms,"requestScheduleFirstMonday");async function Is(t){let e=await Ms(t),r=tp(t,e);return Fa(new Blob([r],{type:"text/calendar;charset=utf-8"}),Ba(t.semester.label)+".ics"),ep(t)}a(Is,"exportScheduleIcs");let Ns={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function le(t,e,r){if(typeof document>"u")return Wt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let i=getComputedStyle(o).color;o.remove();let s=String(i||"").match(/[\d.]+/g)?.map(Number)||[];if(s.length>=3){let l=hr(s[0],s[1],s[2]),g=s.length>3?Math.max(0,Math.min(1,s[3])):1;return g<1?Bt(r||e,l,g):l}return Wt(i)||Wt(e)||"#000000"}a(le,"resolvedScheduleImageColor");function fn(){let t=Qt(),e=ne(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},i={bg:le("--bg",o.bg),surface:le(e==="neu"?"--neu-base":"--surface",o.surface),input:le("--input-bg",o.input),text:le("--text",o.text),secondary:le("--text-secondary",o.secondary),muted:le("--text-muted",o.muted),border:le("--border",o.border,le(e==="neu"?"--neu-base":"--surface",o.surface)),primary:le("--primary",o.primary)},s={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(Ns[e]||e)+" · "+(Ct[t]&&Ct[t].name||t),colors:i,shape:s[e]||s.apple}}a(fn,"currentScheduleImageTheme");function xn(t,e){return up(t,e||fn())}a(xn,"buildScheduleSvg");function Bs(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),i=URL.createObjectURL(o),s=new Image;s.onload=()=>{try{let g=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),h=document.createElement("canvas");h.width=Math.floor(t.width*g),h.height=Math.floor(t.height*g);let E=h.getContext("2d");E.scale(h.width/t.width,h.height/t.height),E.fillStyle=t.background||"#F8FAFC",E.fillRect(0,0,t.width,t.height),E.drawImage(s,0,0,t.width,t.height),h.toBlob(M=>M?e(M):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(i)}},s.onerror=()=>{URL.revokeObjectURL(i),r(new Error("课表图片渲染失败"))},s.src=i})}a(Bs,"svgToPngBlob");async function Fs(t){let e=await Bs(xn(t));Fa(e,Ba(t.semester.label)+".png")}a(Fs,"exportSchedulePng");function Da(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(Da,"showFeatureToast");let ja=mp({document,window,ensureStyles:bs,loadData:bn,exportJson:$s,exportIcs:Is,exportPng:Fs,showToast:Da,nativePageUrl:qs,navigate:a(t=>{location.href=t},"navigate"),logger:console});function Ds(t,e,r,o){return ja.run(t,e,r,o)}a(Ds,"runScheduleExport");function js(t){return ja.createMenu(t)}a(js,"createScheduleExportMenu");function Os(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(Os,"disposeNativePdfCapture");function Hs(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let i=$p(e);t.stage="ok",t.stageCards=i.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=i.target.querySelector("table")?i.target.querySelector("table").id:"none",Os(i)}catch(i){t.stage="failed",t.stageError=i&&i.message||String(i)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(Hs,"bindNativePdfDiagnose");function Rs(t){return t?(Hs(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await Np(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:pr})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Da("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(Rs,"pagePdfExportHandler");function Oa(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Oa,"isPersonalSchedulePage");function Us(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(Us,"isScoreQueryPage");function Ha(){if(!Oa())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let i=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),s=js({source:"native",pdfHandler:Rs(i)});if(s.id="urppp-native-schedule-export",i&&i.parentElement){i.__urpppNativeExportState||(i.__urpppNativeExportState={display:i.style.getPropertyValue("display"),displayPriority:i.style.getPropertyPriority("display"),ariaHidden:i.getAttribute("aria-hidden"),tabIndex:i.getAttribute("tabindex")}),i.setAttribute("data-urppp-native-export-source","1"),i.style.setProperty("display","none","important"),i.setAttribute("aria-hidden","true"),i.setAttribute("tabindex","-1"),i.parentElement.insertBefore(s,i.nextSibling);return}if(e)e.appendChild(s);else if(t)t.appendChild(s);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let g=document.createElement("div");g.className="urppp-export-fallback",g.appendChild(s),l.prepend(g)}}}a(Ha,"patchNativeScheduleExport");let Ue=null,jr=0;function Ra(){clearTimeout(jr),jr=0,Ue&&Ue.observer.disconnect(),Ue=null}a(Ra,"disconnectNativeScheduleExportObserver");function Ws(){if(!Oa()){Ra();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ue&&Ue.root===t&&t.isConnected)return;Ra();let e=new MutationObserver(()=>{clearTimeout(jr),jr=setTimeout(()=>Ha(),80)});e.observe(t,{childList:!0,subtree:!0}),Ue={root:t,observer:e}}a(Ws,"bindNativeScheduleExportObserver");function yn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(yn,"restoreOptionalAttribute");function Gs(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let i=o.__urpppNativeExportState;i&&(i.display?o.style.setProperty("display",i.display,i.displayPriority):o.style.removeProperty("display"),yn(o,"aria-hidden",i.ariaHidden),yn(o,"tabindex",i.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(Gs,"removeNativeScheduleExport");let vn=fi({deps:{styles:Gp,loadScores:Mn,loadProfile:wn,scoreToNumber:Re,scoreToGpa:He,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),Js=Wn([Ur({id:"schedule-export",matches:a(t=>Oa(t.location),"matches"),mount:a(()=>{Ha(),Ws()},"mount"),unmount:a(t=>{Ra(),Gs(t?.lifecycleKey)},"unmount")}),Ur({id:"score-analysis",matches:a(t=>Us(t.location),"matches"),mount:a(()=>{try{vn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{vn.unmount()}catch{}},"unmount")})]);function Or(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return Js.refresh({document,location,window,lifecycleKey:t})}a(Or,"refreshRouteFeatures");function Vs(t){ja.bindHosts(t)}a(Vs,"bindScheduleExportHosts");function lr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(lr,"normalizeProfileValue");function Hr(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(i=>lr(i).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let i=0;i<o.length;i++){let s=o[i],l=s.querySelector(".profile-info-name, th, label"),g=s.querySelector(".profile-info-value, td:last-child");if(!l||!g||l===g)continue;let h=lr(l.textContent).replace(/[：:]/g,"");if(!r.some(M=>h===M||h.endsWith(M)))continue;let E=lr(g.textContent);if(E&&E!=="—"&&E!=="-")return E}return""}a(Hr,"readLabeledProfileValue");function We(t){return lr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(We,"cleanMajorPlanName");function Ys(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),i=lr(o);if(/主修必修GPA/.test(i)){let s=i.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||i.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(s){let l=Number(s[1]),g=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||g===0||l>0)&&(e.majorGpa=s[1])}}if(/主修为|培养方案/.test(i)){let s=i.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||i.match(/^(.{2,60}?)\s*主修为/)||i.match(/主修为\s*(.{2,60})$/),l=We(s&&s[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let g=/培养方案|教学计划/.test(l);(!e.majorPlan||g)&&(e.majorPlan=l)}}}),e}a(Ys,"extractAcademicOverview");async function wn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let s=r.querySelector(".urppp-user-name-value"),l=s&&s.__urpppOriginalText;l&&(t.name=String(l).trim());let g=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),h=t.name?null:g.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!h){let E=r.cloneNode(!0);E.querySelectorAll("small, i, img, b, .badge").forEach(j=>j.remove());let M=(E.textContent||"").replace(/\s+/g," ").trim();M=M.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),h=M.match(/([\u4e00-\u9fa5·]{2,12})/)}h&&h[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(h[1])&&(t.name=h[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let i=Ys(document);t.majorPlan=i.majorPlan,t.majorGpa=i.majorGpa}catch{}try{let r=await Jt("/student/rollManagement/rollInfo/index"),o=Br(r),i=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Hr(o,["姓名"]),!t.name)){let h=i.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);h&&(t.name=h[1].trim())}let s=Hr(o,["主修方案名称"]),l=Hr(o,["专业"]);t.studentId=Hr(o,["学号"]),s?t.majorPlan=We(s):!t.majorPlan&&l&&(t.majorPlan=We(l));let g=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(g&&g.getAttribute("src")&&!t.avatar){let h=g.getAttribute("src");t.avatar=/^https?:/i.test(h)?h:Ma(h)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(wn,"loadProfile");let kn=["周日","周一","周二","周三","周四","周五","周六"];function Ua(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(i=>{let s=String(i.id||"").match(/^(\d+)_(\d+)$/);if(!s)return;let l=parseInt(s[1],10),g=parseInt(s[2],10),h=l===7?0:l,E=i.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),M=E.length?E:[];if(!M.length&&(i.textContent||"").trim()){let j=(i.textContent||"").replace(/\s+/g," ").trim();j&&e.push({name:j.slice(0,40),teacher:"",place:"",week:"",day:h,section:g});return}M.forEach(j=>{let z=Array.from(j.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),F=(j.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(j.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",D=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=z.find(K=>/周/.test(K))||"",B=String(F).replace(/_\d+\s*$/,"").trim();!B||B.length<2||e.push({name:B,teacher:String(D).trim(),place:String(J||"").trim(),week:String(R).trim(),day:h,section:g})})});let o=new Set;return e.filter(i=>{let s=[i.day,i.section,i.name,i.place].join("|");return o.has(s)?!1:(o.add(s),!0)})}a(Ua,"parseScheduleFromDoc");let An="urppp_term_week_v1";function Ge(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(An,e)}catch{}return e}a(Ge,"rememberTermWeek");function cr(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(An,0))||0;if(t>=1&&t<=30)return Ge(t)}catch{}return 0}a(cr,"readRememberedTermWeek");function dr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let i=e.match(r[o]);if(i){let s=parseInt(i[1],10);if(s>=1&&s<=30)return s}}return 0}a(dr,"extractTermWeekFromText");function _e(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let g=t[l],h=dr(g.innerText||g.textContent||"")||dr(g.innerHTML||"");if(h)return Ge(h)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=dr(e);if(r)return Ge(r);let o=document.body&&document.body.innerText||"",i=dr(o);if(i)return Ge(i);let s=cr();if(s)return s}catch{}return 0}a(_e,"getCurrentWeekNumber");let Je=null;function Qs(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(Qs,"calTodayStr");function Xs(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(i=>String(i).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(Xs,"calAddDays");function ur(t){if(Je)return Je;let e=t||Qs();return e>="2027-02-06"&&e<=Xs("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(ur,"calVacation");function Ks(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(Ks,"festiveDecorHtml");function Sn(){let t=typeof document<"u"?document:null;if(!t)return;let e=ur()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",Ks()):!e&&r&&r.remove()}a(Sn,"syncFestiveDecor");function _n(t){Je=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Je&&Je!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{Sn()}catch{}try{typeof Ye=="function"&&Ye()}catch{}return Je}a(_n,"setCalendarPhase");function Zs(){return ur()}a(Zs,"getCalendarPhase");function En(){if(ur()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=_e()||cr()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(En,"getViewWeekNumber");async function tl(){let t=_e();if(t>=1)return t;try{let e=await Jt("/index");if(t=dr(e),t)return Ge(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),i=await Jt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),s=JSON.parse(i),l=Number(s&&s.jxzc);if(l>=1&&l<=30)return Ge(l)}catch{}return cr()||0}a(tl,"ensureTermWeekResolved");function el(t){let e=_e()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let i=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);i&&(e=Math.max(e,parseInt(i[2],10)||0));let s=String(r.week||"").match(/\d{1,2}/g);s&&s.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(el,"inferMaxWeek");function Cn(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Cn,"weekBitActive");let Pn=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function zn(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return Pn[e%Pn.length]}a(zn,"courseColor");function rl(t){let e=[],r=_e();(t&&t.xkxx||[]).forEach(s=>{Object.keys(s||{}).forEach(l=>{let g=s[l];if(!g)return;let h=g.courseName||g.englishCourseName||l,E=g.attendClassTeacher||"";(g.timeAndPlaceList||[]).forEach(j=>{let z=Number(j.classDay)||0,F=z===7?0:z,J=Number(j.classSessions)||1,D=Math.max(1,Number(j.continuingSession)||1),R=[j.campusName,j.teachingBuildingName,j.classroomName].filter(Boolean).join(""),B=j.weekDescription||g.skzcs||"",K=Cn(j.classWeek,r)||r&&B.indexOf(String(r))>=0;e.push({name:String(h).trim(),teacher:String(E).trim(),place:String(R).trim(),week:String(B).trim(),classWeek:String(j.classWeek||""),day:F,section:J,span:D,thisWeek:!!K,color:zn(h)})})})});let i=new Set;return e.filter(s=>{let l=[s.day,s.section,s.span,s.name,s.place,s.week].join("|");return i.has(l)?!1:(i.add(l),!0)})}a(rl,"parseScheduleFromJson");async function al(){try{let t=await Jt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let i=Number(r&&(r.jxzc||r.zc||r.currentWeek));i>=1&&i<=30&&(nt._termWeek=Math.max(nt._termWeek||0,i),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=rl(r)}catch{e=Ua(Br(t))}e.length||(e=Ua(document));let o=r?gn(r,Ze(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=Ua(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(al,"loadSchedule");function ol(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),i=r.match(o);if(i&&i[1])return i[1];let s=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(s);return l?l[1]:""}a(ol,"extractScoreCallback");function nl(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let i=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",s=[];(o.cjList||[]).forEach(l=>{let g=l.courseName||l.englishCourseName||"";if(!g)return;let h=l.cj!=null&&l.cj!==""?String(l.cj):"";!h&&l.courseScore!=null&&(h=String(l.courseScore)),!h&&l.gradeName&&(h=String(l.gradeName)),!h&&l.zscj!=null&&(h=String(l.zscj));let E=l.courseAttributeName||l.xkcsxmc||"",M=parseFloat(l.credit)||0,j=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",F=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ie(h)||ie(l.gradeName)||F!=null&&F<0,D=J?"未评估":h;s.push({code:j,seq:String(z||""),name:g,attr:E,credit:M,score:D,unevaluated:J,required:nn(E),officialGpa:Ir(F)?F:null,evalUrl:""})}),s.length&&e.push({title:String(i).slice(0,100),courses:s,summary:te(s),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(nl,"parseScoreJson");async function Ln(t,e){let r=await Jt(t),o=qn(Br(r));if(o.length)return o;let i=ol(r,e);if(!i)return[];let s=await Jt(i);try{let l=JSON.parse(s);o=nl(l).map(g=>(g.summary=te(g.courses),g))}catch{o=qn(Br(s))}return o}a(Ln,"loadScoreByIndex");function qn(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map(M=>(M.textContent||"").replace(/\s+/g,""));if(!o.length)return;let i=o.join("|");if(!/课程名/.test(i)||!/成绩/.test(i))return;let s={code:o.findIndex(M=>M==="课程号"),name:o.findIndex(M=>M==="课程名"),attr:o.findIndex(M=>/课程属性|属性/.test(M)),credit:o.findIndex(M=>M==="学分"),score:o.findIndex(M=>M==="成绩")};if(s.name<0||s.score<0)return;let l="成绩",g=r.previousElementSibling;for(let M=0;M<8&&g;M++,g=g.previousElementSibling)if(/^H[1-4]$/.test(g.tagName)||g.classList&&g.classList.contains("header")){l=(g.textContent||"").replace(/\s+/g," ").trim();break}let h=[],E=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(E).forEach(M=>{let j=Array.from(M.cells||M.querySelectorAll("td"));if(j.length<4)return;let z=a(B=>B>=0&&j[B]?(j[B].textContent||"").replace(/\s+/g," ").trim():"","get"),F=z(s.name),J=z(s.score);if(!F||!J||/课程名|序号/.test(F))return;let D=z(s.attr),R=ie(J);h.push({code:z(s.code),name:F,attr:D,credit:parseFloat(z(s.credit))||0,score:R?"未评估":J,unevaluated:R,required:nn(D),officialGpa:null,evalUrl:""})}),h.length&&e.push({title:l.slice(0,100),courses:h,summary:te(h)})}),e}a(qn,"parseScoreTables");function mr(t){return We(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(mr,"schemePlanName");function Tn(t,e){if(!t||!t.length)return 0;let r=We(e),o=t.findIndex(l=>{let g=mr(l);return/培养方案/.test(g)&&!/微专业|辅修|双学位/.test(g)});if(o>=0&&(!r||mr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let g=mr(l);return g.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(g.slice(0,4))||g.includes(r.slice(0,4))}),o>=0))return o;let i=0,s=-1;return t.forEach((l,g)=>{if(/微专业|辅修/.test(mr(l)))return;let h=(l.courses||[]).length;h>s&&(s=h,i=g)}),i}a(Tn,"pickMajorSchemeIndex");async function pl(){let t={};try{let e=await Jt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(i=>{let s=String(i.KCH||"").trim();if(!s)return;let l=String(i.SFPG)==="1",g=String(i.KTID||"").trim();if(!t[s]){t[s]={ktid:g,kxh:String(i.KXH||""),kcm:i.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&g?"/student/teachingEvaluation/newEvaluation/evaluation/"+g:"/student/teachingEvaluation/newEvaluation/index"};return}t[s].total+=1,l||(t[s].pending+=1,t[s].done=!1,g&&(t[s].ktid=g,t[s].url="/student/teachingEvaluation/newEvaluation/evaluation/"+g))}),Object.keys(t).forEach(i=>{let s=t[i];s.done=!(s.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(pl,"loadEvaluationMap");function il(t){if(!t)return!1;if(t.officialGpa!=null&&Ir(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ie(e)?!1:Re(e)!=null||He(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(il,"hasDisplayableScore");function sl(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(i=>{if(!i||!i.code)return;let s=e[i.code];if(s){if(il(i)){i.unevaluated=!1,s.done?i.evalUrl=i.evalUrl||"":i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index";return}s.done||(i.unevaluated=!0,i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index",(!i.score||i.score===""||ie(i.score))&&(i.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(sl,"attachEvaluationLinks");function $n(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=te(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=te(e.courses),e)),t)}a($n,"refreshScoreSummaries");async function ll(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await pl();return sl(t,e),t.evalMap=e,t.evaluationReady=!0,$n(t)}finally{t.evaluationLoading=!1}}a(ll,"enrichScoresWithEvaluation");function cl(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=Tn(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let i=mr(o),s=We(nt.profile.majorPlan);/培养方案|教学计划/.test(i)&&(!/培养方案|教学计划/.test(s)||s==="主修方案")&&(nt.profile.majorPlan=i);let l=o.summary||{},g=Number(l.requiredCredit),h=Number(l.requiredGpa),E=Number(nt.profile.majorGpa);g>0&&Number.isFinite(h)&&h>=0&&h<=5&&(!Number.isFinite(E)||E<=0)&&(nt.profile.majorGpa=String(Ae(h)))}a(cl,"reconcileProfileAndScores");let Ve=null;async function Mn(t){return t&&(Ve=null),Ve&&!Ve.error||(Ve=await dl()),Ve}a(Mn,"loadScores");async function dl(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([Ln("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),Ln("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(i=>i.courses.forEach(s=>{o.push(Object.assign({term:i.title},s))})),t.passing=[{title:"全部及格成绩",courses:o,summary:te(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:te(o)}]),$n(t),t.majorIdx=Tn(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(dl,"loadScoresImpl");function Ee(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(Ee,"parseJsonArrayLoose");function In(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let i=0;for(let s=o;s<t.length&&s<o+3e5;s++){let l=t[s];if(l==="[")i++;else if(l==="]"&&(i--,i===0))return t.slice(o,s+1)}return""}a(In,"extractBalancedArray");async function ul(){let t=await Jt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let s=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(s&&(e=Ee(s)),l&&(r=Ee(l)),!e.length){let g=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);g&&(e=Ee(g[1]))}if(!r.length){let g=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);g&&(r=Ee(g[1]))}if(!r.length){let g=In(t,"teachingBuildingName");g&&(r=Ee(g))}if(!e.length){let g=In(t,"campusName");g&&(e=Ee(g))}}catch(s){console.warn("[URP++] classroom json parse",s)}if(!r.length){let s=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=s;let l=[];for(let g of s)try{let h=await Jt("/student/teachingResources/classroomCurriculum/"+g.campusNumber+"/teachingBuildingJson");Ee(h).forEach(M=>{l.push({id:{campusNumber:g.campusNumber,teachingBuildingNumber:String(M.id&&M.id.teachingBuildingNumber||M.teachingBuildingNumber||"")},teachingBuildingName:M.teachingBuildingName||M.name||""})})}catch(h){console.warn("[URP++] building json",g.campusNumber,h)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(s=>({campus:s.campusName||s.campusNumber,campusNumber:String(s.campusNumber||s.id&&s.id.campusNumber||""),buildings:[]}));r.forEach(s=>{let l=String(s.id&&s.id.campusNumber||s.campusNumber||""),g=String(s.id&&s.id.teachingBuildingNumber||s.teachingBuildingNumber||""),h=s.teachingBuildingName||s.name||g;if(!l||!g||!h)return;let E=o.find(j=>j.campusNumber===l);E||(E={campus:l,campusNumber:l,buildings:[]},o.push(E));let M="/student/teachingResources/classroomUseStatus/"+l+"/"+g+"/"+encodeURI(encodeURI(E.campus||l))+"/"+encodeURI(encodeURI(h));E.buildings.push({name:h,path:M,campusNumber:l,buildingNumber:g})});let i=o.filter(s=>s.buildings.length);if(!i.length)throw new Error("未解析到教学楼，请刷新后重试");return i}a(ul,"loadClassroomCatalog");function br(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(br,"occupancyTypeLabel");function ml(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return br(t)}a(ml,"occupancyReason");async function bl(t,e,r,o){let i=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),s=await Jt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+i.toString());try{let l=JSON.parse(s);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(g=>g&&typeof g=="object"&&(g.kcm||g.id&&g.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(bl,"fetchClassroomCurriculum");function hl(t,e,r){let o=t||[],i=Number(e.xq)||0,s=Number(e.start)||0,l=Number(r)||0,g=[];return o.forEach(h=>{let E=h.id||{},M=Number(E.skxq!=null?E.skxq:h.skxq)||0,j=Number(E.skjc!=null?E.skjc:h.skjc)||0,z=Math.max(1,Number(h.cxjc)||1),F=E.skzc||h.skzc||"";i&&M&&i!==M||s&&(s<j||s>=j+z)||l&&F&&!$a(F,l)||g.push(h)}),g.length?(g.sort((h,E)=>{let M=$a(h.id&&h.id.skzc||h.skzc,l)?0:1,j=$a(E.id&&E.id.skzc||E.skzc,l)?0:1;return M-j}),g[0]):null}a(hl,"matchCurriculumCourse");async function gl(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),i=String(e.buildingNumber||""),s=r||t.planNumber||"";if(!o||!i||!s)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(F=>F.busy)),g={},h=a(async z=>{if(g[z])return g[z];try{g[z]=await bl(s,o,i,z)}catch{g[z]=[]}return g[z]},"queue"),E=4,M=0,j=new Array(Math.min(E,Math.max(l.length,1))).fill(0).map(async()=>{for(;M<l.length;){let z=M++,F=l[z],J=await h(F.name);(F.slots||[]).forEach(D=>{if(!D.busy)return;let R={xq:D.detail&&D.detail.xq||D.xq||0,start:D.section,week:t.jxzc};D.detail&&D.detail.xq!=null&&(R.xq=D.detail.xq);let B=hl(J,R,t.jxzc);if(B&&B.kcm){let K=String(B.kcm).trim();D.contentName=K,D.reason=K,D.displayChar=Nr(K),D.detail&&(D.detail.contentName=K,D.detail.reason=K,D.detail.teacher=B.jsm||"",D.detail.weeks=B.zcsm||"",D.detail.courseNo=B.id&&B.id.kch||"",D.detail.typeLabel=br({occupancymoduleId:D.module}))}else D.displayChar=Nr(D.reason||"占用"),D.detail&&(D.detail.typeLabel=br({occupancymoduleId:D.module}))})}});return await Promise.all(j),t}a(gl,"enrichOccupancyWithCurriculum");function fl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(fl,"occupancyKindClass");async function xl(t){let e="",r="",o="",i="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",i=t.path||"";else{i=String(t||"");let B=i.match(/classroomUseStatus\/(\d+)\/(\d+)\//);B&&(e=B[1],r=B[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let s=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=yl(Nn(new Date,s)),g="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),h=await new Promise((B,K)=>{let ut=Ma("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:g,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?B(vt.responseText||""):K(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:g}).then(vt=>vt.text()).then(B).catch(K)}),E;try{E=JSON.parse(h)}catch{throw new Error("jasInfo 非 JSON")}let M=(E.classrooms||[]).map(B=>{let K=B.classroomName||B.id&&B.id.classroomNumber||"",ut=B.placeNum||"",vt=B.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:K,seats:ut,type:vt,slots:Et,map:{}}}),j={};M.forEach(B=>{j[B.name]=B}),(E.classroomTime||[]).forEach(B=>{let K=B.id||{},ut=K.classroomNumber||"",vt=Number(K.sessionstart)||1,Et=Math.max(1,Number(B.continuingsession)||1),Lt=j[ut];if(!Lt)return;let qt=br(B),Ot=ml(B);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let $t=Lt.slots.find(ee=>ee.section===Ht);$t&&($t.busy=!0,$t.kind=B.timestatenumber||B.occupancymoduleId||"",$t.module=B.occupancymoduleId||"",$t.reason=Ot,$t.typeLabel=qt,$t.displayChar=Nr(Ot),$t.xq=K.xq,$t.weekBitmap=K.week||"",$t.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:K.week||"",xq:K.xq||"",state:B.timestatenumber||"",module:B.occupancymoduleId||""})}});let z="";try{let B=E.jhZxjxjhb;typeof B=="string"&&/\d{4}-\d{4}-\d-\d/.test(B)?z=B:B&&typeof B=="object"&&(z=String(B.zxjxjhh||B.jhxnxq||B.executiveEducationPlanNumber||B.planNumber||""))}catch{}if(!z&&E.classrooms&&E.classrooms[0]&&E.classrooms[0].id&&(z=E.classrooms[0].id.executiveEducationPlanNumber||""),E.jxzc!=null&&Number(E.jxzc)>=1){let B=Number(E.jxzc);nt._termWeek=Math.max(nt._termWeek||0,B),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let F=["日","一","二","三","四","五","六"],J=vl(E.date||l)||Nn(new Date,s),D=E.week!=null?Number(E.week):J.getDay(),R=s===1?"明天":s===2?"后天":"今天";return{rooms:M,dateLabel:(E.date||l)+"（周"+(F[D]||D)+" · "+R+"）",jxzc:E.jxzc,planNumber:z,week:E.week!=null?E.week:D,searchDate:E.date||l,dateOffset:s}}a(xl,"loadBuildingOccupancy");function Nn(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(Nn,"addDays");function yl(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(yl,"formatLocalDate");function vl(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(vl,"parseLocalDate");let Bn={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function Fn(t){return Bn[t]||Bn.more}a(Fn,"ico");let nt=Vp();function wl(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=Up,(document.head||document.documentElement).appendChild(t)}a(wl,"ensureStyle");let kl=ea({deps:{scoreToNumber:Re,scoreToGpa:He}}),{metricHtml:Al,occupancyHtml:Sl,render:Ye,renderScheduleBoard:yc,roomPickerHtml:_l,scheduleRender:El}=pi({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:kn,analyzeScores:a(t=>kl.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Vt,bandsChartSvg:aa,bindUI:a(t=>Pl(t),"bindUI"),classifyPrivacyLabel:Fr,courseColor:zn,ensureRoot:a(()=>jn(),"ensureRoot"),escapeHtml:at,firstContentChar:Nr,getViewWeekNumber:En,ico:Fn,isCleanAnalysisDirect:ia,occupancyKindClass:fl,occupancyTypeLabel:br,personalizedProfile:zs,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Re,summarizeCourses:te,trendChartSvg:ra,weekBitActive:Cn,calVacation:ur,setCalendarPhase:_n}}),{ensureRoomCatalogLoaded:Dn,loadAll:Cl}=Qp({state:nt,deps:{ensureTermWeekResolved:tl,enrichScoresWithEvaluation:ll,getCurrentWeekNumber:_e,loadClassroomCatalog:ul,loadProfile:wn,loadSchedule:al,loadScores:Mn,readRememberedTermWeek:cr,reconcileProfileAndScores:cl,render:Ye,scheduleRender:El}}),{bindUI:Pl,closeModal:zl,getRoomHost:vc,openModal:wc,openRoomModal:kc,openScoreModal:Ac,showBuilding:Sc}=ii({state:nt,deps:{DAY_NAMES:kn,applyPersonalDisplay:Vt,bindScheduleExportHosts:Vs,closeCleanMode:a(()=>ql(),"closeCleanMode"),ensureRoomCatalogLoaded:Dn,enrichOccupancyWithCurriculum:gl,ensureRoot:a(()=>jn(),"ensureRoot"),escapeHtml:at,fetchText:Jt,getCurrentWeekNumber:_e,getViewWeekNumber:En,inferMaxWeek:el,isUnevaluatedScore:ie,isValidOfficialGpa:Ir,loadBuildingOccupancy:xl,metricHtml:Al,occupancyHtml:Sl,render:Ye,rootEl:a(()=>Tl(),"rootEl"),roomPickerHtml:_l,scoreToGpa:He,scoreToNumber:Re,summarizeCourses:te,summarizeCoursesPreferOfficial:te}}),{cleanModeApi:Ll,closeCleanMode:ql,ensureRoot:jn,injectCleanEntry:_c,openCleanMode:Ec,rootEl:Tl}=si({state:nt,deps:{CLEAN_FLAG:ms,applySkinAttr:pe,closeModal:zl,ensureRoomCatalogLoaded:Dn,ensureStyle:wl,getCurrentWeekNumber:_e,getSkin:ne,handleThemeDotClick:ct,ico:Fn,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:bo,loadAll:Cl,openSettingsPanel:Ho,readRememberedTermWeek:cr,refreshCleanPersonalDisplay:Na,render:Ye,scoreToGpa:He,summarizeCourses:te,syncNavbarThemeUI:ft,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=Ll;function Wa(){if(!document.body){setTimeout(Wa,10);return}if(Gt(Qt()),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],i=r.parentElement;for(;i;){let s=i.scrollTop,l=i.scrollLeft;(s||l||i.scrollHeight>i.clientHeight||i.scrollWidth>i.clientWidth)&&o.push({el:i,top:s,left:l}),i=i.parentElement}requestAnimationFrame(()=>{o.forEach(s=>{s.el.scrollTop=s.top,s.el.scrollLeft=s.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))vo();else{Di();try{pn()}catch{}try{Or()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Vt(document)}catch{}try{Sn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{Or()}catch{}try{Vt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{pa()&&bo()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(Wa,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(ke,50)}),window.addEventListener("load",()=>{ke(),Oe(),setTimeout(ke,100),setTimeout(ke,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Oe,0),setTimeout(Oe,50),setTimeout(Oe,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Oe,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function On(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let i=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),s=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));i&&!s&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){ke(),on(),st(),ke();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(s=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},s)),xa(),Fo(),Do(),Lo(),jo(),Bo(),To(),document.querySelectorAll(".page-content, #page-content-template").forEach(s=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);s.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),s.style.setProperty("box-sizing","border-box","important")}),zr(),Tr(),Ne(),setTimeout(Ne,300),setTimeout(Ne,1e3),So(),me(),or(),Co(),setTimeout(or,300),nr(),setTimeout(()=>nr(),500),Pr(),Eo();try{Or()}catch{}try{Vt(document)}catch{}setTimeout(()=>{try{Or()}catch{}try{Vt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...i){let s=r.apply(this,i);return e(),s},history.replaceState=function(...i){let s=o.apply(this,i);return e(),s}}a(On,"watchRouteChanges");let Qe=typeof unsafeWindow<"u"?unsafeWindow:window;Qe.__urpppDebug=Qe.__urpppDebug||{},Qe.__urpppDebug.setCalendarPhase=t=>_n(t),Qe.__urpppDebug.getCalendarPhase=()=>Zs(),Qe.__urpppDebug.calVacation=t=>ur(t),Qe.urppp={version:p,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Gt(t)},"apply"),setAccent:wi,getAccent:Yt,getCurrent:Qt,list:a(()=>Object.entries(Ct).map(([t,e])=>({name:t,displayName:e.name,current:t===Qt()})),"list")},update:{check:qa,auto:La,showToast:za},privacy:{get:ye,set(t){return la(t),Vt(document),ye()},apply:a(()=>Vt(document),"apply"),identity:{get:qe,set(t){return co(t),Vt(document),Na(),qe()}}},scheduleExport:{load:a(()=>bn("api"),"load"),run:a(t=>Ds(t,"api",null,null),"run"),patch:Ha,image:{theme:fn,build:a((t,e)=>xn(t,e),"build")},jsonFormat:{get:Er,set:mo,validate:Pe,build(t,e){let r=Gr(t);if(e)return Vr(r,Pe(e));let o=Er();return o.enabled?Vr(r,o.mapping):Jr(r)},buildDefault(t){return Jr(Gr(t))}}}};function Hn(){setTimeout(()=>{try{La()}catch{}},1800)}a(Hn,"scheduleAutoUpdateCheck"),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Wa(),On(),Hn()}):(Wa(),On(),Hn())})();})();
