...
#urppp-settings-panel .urppp-skin-card[data-skin="apple"] .urppp-set-btn.ghost:hover { background: #0071e3 !important; color: #fff !important; }
...
#urppp-settings-panel .urppp-skin-card[data-skin="apple"] .urppp-set-btn.ghost { color:#0071e3!important; border:1px solid rgba(0,113,227,.4)!important; border-radius:999px!important; background:transparent!important; box-shadow:none!important; }
#urppp-settings-panel .urppp-skin-card[data-skin="editorial"] .urppp-set-btn.ghost { color:#1c1c1c!important; border:none!important; background:transparent!important; border-radius:0!important; box-shadow:none!important; }
#urppp-settings-panel .urppp-skin-card[data-skin="editorial"] .urppp-set-btn.ghost:hover { text-decoration-line:underline!important; text-underline-offset:3px!important; }
html.urppp-theme-dark #urppp-settings-panel .urppp-skin-card[data-skin="editorial"] .urppp-set-btn.ghost:hover { text-decoration-line:underline!important; }
#urppp-settings-panel .urppp-skin-card[data-skin="flat"] .urppp-set-btn.ghost { color:#000!important; border:1px solid rgba(0,0,0,.5)!important; background:transparent!important; border-radius:0!important; box-shadow:none!important; }
#urppp-settings-panel .urppp-skin-card[data-skin="organic"] .urppp-set-btn.ghost { color:#5c4033!important; border:1px solid rgba(92,64,51,.35)!important; background:transparent!important; border-radius:999px!important; box-shadow:none!important; }
#urppp-settings-panel .urppp-skin-card[data-skin="brutal"] .urppp-set-btn.ghost { color:#000!important; border:1px solid rgba(0,0,0,.55)!important; background:transparent!important; border-radius:0!important; box-shadow:none!important; }
#urppp-settings-panel .urppp-skin-card[data-skin="neu"] .urppp-set-btn.ghost { color:#4f5258!important; background:#e0e5ec!important; border:none!important; border-radius:12px!important; box-shadow:3px 3px 6px #bec3ca,-3px -3px 6px #f7f9fc!important; }
/* 暗色下同样随卡片主题色（克制，background 必须透明，否则继承全局 --input-bg 变黑块） */
html.urppp-theme-dark #urppp-settings-panel .urppp-skin-card[data-skin="apple"] .urppp-set-btn.ghost { color:#7aa2ff!important; border-color:rgba(122,162,255,.4)!important; background:transparent!important; box-shadow:none!important; }
html.urppp-theme-dark #urppp-settings-panel .urppp-skin-card[data-skin="editorial"] .urppp-set-btn.ghost { color:#e8e8e4!important; border:none!important; background:transparent!important; box-shadow:none!important; }
html.urppp-theme-dark #urppp-settings-panel .urppp-skin-card[data-skin="flat"] .urppp-set-btn.ghost { color:#fff!important; border-color:rgba(255,255,255,.4)!important; background:transparent!important; box-shadow:none!important; }
html.urppp-theme-dark #urppp-settings-panel .urppp-skin-card[data-skin="organic"] .urppp-set-btn.ghost { color:#eadbc8!important; border-color:rgba(234,219,200,.35)!important; background:transparent!important; box-shadow:none!important; }
html.urppp-theme-dark #urppp-settings-panel .urppp-skin-card[data-skin="brutal"] .urppp-set-btn.ghost { color:#fff!important; border-color:rgba(255,255,255,.4)!important; background:transparent!important; box-shadow:none!important; }
html.urppp-theme-dark #urppp-settings-panel .urppp-skin-card[data-skin="neu"] .urppp-set-btn.ghost { color:#dfe3e9!important; background:#2a2f36!important; border:none!important; box-shadow:3px 3px 6px #1e2228,-3px -3px 6px #363d47!important; }
