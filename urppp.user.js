...
`;function mc(p){p.querySelectorAll("td, th").forEach(n=>{n.style.removeProperty("background"),n.style.removeProperty("background-color")}),p.querySelectorAll("th[rowspan]").forEach(n=>{n.style.removeProperty("width"),n.style.setProperty("white-space","nowrap"),n.style.setProperty("text-align","center")}),p.querySelectorAll("table").forEach(n=>{n.style.setProperty("background","#ffffff","important"),n.style.setProperty("background-color","#ffffff","important"),n.style.setProperty("border","none","important"),n.style.setProperty("color","#000000","important")}),p.querySelectorAll("th").forEach(n=>{if(n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important"),n.style.setProperty("font-weight","normal","important"),n.childNodes.length===1&&n.firstChild&&n.firstChild.nodeType===3){let c=document.createElement("span");c.textContent=n.textContent,n.textContent="",n.appendChild(c)}}),p.querySelectorAll("thead th").forEach(n=>{n.style.setProperty("background","#dddddd","important"),n.style.setProperty("background-color","#dddddd","important")}),p.querySelectorAll("tbody th").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important")}),p.querySelectorAll("td").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important"),n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important")})}a(mc,"normalizeNativePdfStage");function Fp(p){let n=dc(),c=document.createElement("div");c.id="urppp-pdf-stage",c.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(n||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=p.cloneNode(!0);lc(u),cc(u),d.appendChild(u),c.appendChild(d),mc(u);let k=document.createElement("style");k.id="urppp-pdf-reset-style",k.textContent=uc,document.head.appendChild(k),document.body.appendChild(c);let P=c.querySelector("#urppp-pdf-mycoursetable"),S=c.querySelector("#urppp-pdf-page")||c;if(!P)throw c.remove(),new Error("无法建立原生课表捕获节点");return{stage:c,target:P,page:S,sourceHost:p}}a(Fp,"cloneNativePdfStage");var ta=0;function dr(){return ta>0}a(dr,"isNativePdfIsolationActive");function bc(p){return!p||p.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(p.id||"")||p.hasAttribute("data-urppp-style")?!0:(p.textContent||"").includes("urppp-")}a(bc,"isUrpppOwnedStyle");function Dp(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(Dp,"defaultPage");function jp(p,n){let c=p&&typeof p.requestAnimationFrame=="function"?p.requestAnimationFrame.bind(p):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return c?c(n):setTimeout(n,0)}a(jp,"scheduleFrame");function hc(p={}){let n=p.document||(typeof document<"u"?document:null),c=p.page||Dp();if(!n)throw new Error("原生 PDF 隔离缺少 document");let d=n.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");ta+=1;let u=[d,...d.querySelectorAll("*")],k=[],P=n.getElementById("soliderbox");P&&k.push(P);let S=d.parentElement;for(;S&&S!==n.documentElement;){let x=S.classList;(S.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&k.push(S),S=S.parentElement}let y=n.getElementById("page-content-template")||n.querySelector(".page-content");y&&!k.includes(y)&&k.push(y);let A=[...u,...k],f=A.map(x=>({element:x,style:x.getAttribute("style")})),w=Array.from(n.querySelectorAll("style")).filter(bc).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),T=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=c&&c.divBuild,b=c&&c.__urpppOriginalDivBuild,m=!1,v=a(()=>{m||(m=!0,c&&c.divBuild===b&&typeof C=="function"&&(c.divBuild=C),f.forEach(({element:x,style:_})=>{x.isConnected&&(_===null?x.removeAttribute("style"):x.setAttribute("style",_))}),T.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),w.forEach(({style:x,disabled:_,media:q})=>{try{q===null?x.removeAttribute("media"):x.setAttribute("media",q),x.sheet&&(x.sheet.disabled=_)}catch{}}),ta=Math.max(0,ta-1),jp(c,()=>{try{typeof p.onAfterRestore=="function"&&p.onAfterRestore()}catch{}}))},"restore");try{return w.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),A.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(_=>{x.style.getPropertyPriority(_)==="important"&&(_==="height"&&x.matches("td, th")||x.style.removeProperty(_))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),T.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),c&&typeof b=="function"&&(c.divBuild=b),v}catch(x){throw v(),x}}a(hc,"isolateScheduleForNativeExport");function Op(p,n={}){return new Promise((c,d)=>{let u=n.page||Dp(),k=u&&u.back,P=u&&u.html2canvas;if(!p||typeof k!="function"){d(new Error("教务原生导出依赖未就绪"));return}let S=null;try{S=hc(n)}catch(b){d(b);return}let y=0,A=!1,f=null,w=null,T=a(b=>{if(!A){A=!0,y&&clearTimeout(y),u&&f&&u.back===f&&(u.back=k),w&&u.html2canvas===w&&(u.html2canvas=P);try{S&&S()}catch{}b?d(b):c()}},"settle"),C=a(b=>T(b instanceof Error?b:new Error(String(b))),"fail");typeof P=="function"&&(w=a(function(){let b=P.apply(this,arguments);return b&&typeof b.catch=="function"&&b.catch(C),b},"scopedCanvas"),u.html2canvas=w),f=a(function(){try{return k.apply(this,arguments)}finally{setTimeout(()=>T(),0)}},"wrappedBack"),u.back=f,y=setTimeout(()=>{try{k.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},n.timeoutMs||60*1e3),jp(u,()=>{try{p.click()}catch(b){C(b)}})})}a(Op,"exportNativePdfIsolated");var Hp=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
`;var Up=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var Wp=`.urppp-export-wrap{position:relative!important;display:inline-flex!important;align-items:center!important;flex:0 0 auto!important;margin-left:7px!important;font-weight:400!important;vertical-align:middle!important;white-space:nowrap!important}
...
`;var Jp=`      /* 表格美化：业务表格、分页、公告卡片（table-beautify） */
...
`;var Yp=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function Zp(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(Zp,"createCleanModeState");function ti(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(ti,"resetCleanModeData");function ri({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(k){p.catalog=p.catalog||[],p.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&ti(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let k=await n.ensureTermWeekResolved();!p.weekLocked&&k>=1&&(p.viewWeek=k)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(k){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(k){p.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}})(),(async()=>{let k=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),k=p.scores,n.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&n.enrichScoresWithEvaluation(k).then(()=>{p.scores===k&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(ri,"createCleanModeDataLoader");var re={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},gc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},ke={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function oi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(oi,"calToday");function io(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(io,"calDayDiff");function so(p,n){let c=io(re[p].start,n);return c<0?0:Math.floor(c/7)+1}a(so,"calWeekNo");function no(p){return gc[p]||""}a(no,"calLunar");function ei(p){return String(p||"").slice(5)}a(ei,"calYY");function fc(p){let n=p||oi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(fc,"calActiveTerm");function lo(p,n){let c=p&&re[p]?p:"autumn",d=re[c],u=n||oi(),k=d.events.map(f=>({e:f,d:io(u,f.start)})).filter(f=>f.d>=-0).sort((f,w)=>f.d-w.d)[0],P=k?io(u,k.e.start):null,S=so(c,u),y=Math.max(0,Math.min(100,S/d.weeks*100)),A=u>=d.start;return{term:d,termId:c,next:k,daysLeft:P,weekNo:S,progress:y,started:A,today:u}}a(lo,"calStatus");function ni(p,n){let c=lo(p,n),d=c.next?ke[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(ni,"calendarSummaryHtml");function pi(p,n){let c=lo(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(pi,"calendarSummaryCompactHtml");function ai(p,n){let c=lo(p,n),d=c.next?ke[c.next.e.t].color:"#c9cdd4",u=c.term,k=Object.keys(re).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${re[w].name}</button>`).join(""),P=`<div class="cal-widget">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[w].map(C=>{let b=ke[C.t].color,m=C.end&&C.end!==C.start?"~"+ei(C.end):"",v=so(c.termId,C.start)>0?`第 ${so(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${A(C.start)}">
          <span class="cal-ev-dot" style="background:${b}"></span>
          <span class="cal-ev-date">${ei(C.start)}${m||""}<em>${no(C.start)||"&nbsp;"}</em></span>
  ...
  </div>`}a(ai,"calendarModalHtml");function ii(p,n){let c=typeof document<"u"?document:null;if(!c)return;po();let d=p&&re[p]?p:fc(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${ai(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>po()),u.addEventListener("click",k=>{let P=k.target;if(P&&P.closest&&P.closest(".cal-close")){po();return}let S=P&&P.closest?P.closest("[data-cal-term]"):null;if(S){let y=u.querySelector(".cal-body");y&&(y.innerHTML=ai(S.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(A=>A.classList.toggle("ac",A.dataset.calTerm===S.dataset.calTerm))}})}a(ii,"openCalendarModal");function po(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(po,"closeCalendarModal");function si(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),ii())})}a(si,"bindCalendarOpen");var ra=!1;function co(){let p=typeof document<"u"?document:null;if(!p||ra)return ra;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
...
</g>`;return`${uo({...u,kind:"trend",label:"学期成绩趋势"})}
${it}
${mt}
<g>${Q}</g>
...
<g>${V}</g>
${ct}
</svg>`}a(aa,"trendChartSvg");function oa({bands:p,palette:n,layout:c}){let d=p||[],u=fi(c,"bands",d.length),{width:k,height:P,pad:S,mobile:y}=u,A=k-S.left-S.right,f=P-S.top-S.bottom,w=d.length||1,T=Math.max(1,...d.map(m=>m.count)),C=y?Math.min(32,A/w*.62):Math.min(40,A/w*.52),b=d.map((m,v)=>{let x=S.left+(v+.5)*(A/w),_=m.count?Math.max(8,m.count/T*f):0,q=S.top+f-_,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=m.range||(m.min===0?"<60":`${m.min}-${m.max===100?"100":m.max}`),O=[`${m.level||""}（绩点 ${m.gpa}）`,`百分制 ${L}`,`课程 ${m.count} 门`].join(`
...
<circle cx="75" cy="75" r="56" fill="none" stroke="${mo}" stroke-width="24"/>
${w}
...
</svg>`}a(xi,"donutSvg");var vc=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),wc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',kc='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function yi({deps:p}){let n=p&&p.palette||vc;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
  <button type="button" class="urppp-sa-toggle" aria-expanded="false">
    <span class="urppp-sa-icon">${wc}</span>
    <span class="urppp-sa-title">成绩分析</span>
    <span class="urppp-sa-summary" data-urppp-sa-summary>点击展开，查看成绩指标与学期变化</span>
    <span class="urppp-sa-chevron">${kc}</span>
  </button>
...
<div class="urppp-sa-grid">
  ...
  <section class="urppp-sa-card urppp-sa-share">
    ...
    <div class="urppp-sa-share-body">
      <div class="urppp-sa-donut">${xi({items:w.items,requiredRatio:w.requiredRatio,palette:n})}</div>
...
<div class="urppp-sa-grid">
  ...
  `;function S(t){let r=document.createElement("div");return r.className="urppp-inline-loader",r.innerHTML=P+(t?`<div>${t}</div>`:""),r}a(S,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function A(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(e=>{e.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),e.classList.remove("urppp-loading-active")})}catch{}}a(A,"cleanupPageLoadingOverlays");function f(t){try{let r=t&&t.querySelectorAll?t:document;A(r),r.querySelectorAll("img").forEach(e=>{try{if(!e||e.dataset.urpppReplaced==="1"||y(e))return;let o=(e.getAttribute("src")||e.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;e.dataset.urpppReplaced="1";let s=S("");s.style.minHeight="0",s.style.padding="0",e.parentElement&&e.parentElement.replaceChild(s,e)}catch{}}),r.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(e=>{try{if(!e||e.dataset.urpppReplaced==="1")return;if(e.dataset.urpppReplaced="1",e.style.setProperty("background","transparent","important"),e.style.setProperty("background-image","none","important"),!e.querySelector(".urppp-inline-loader")){let o=S("");o.style.minHeight="0",o.style.padding="0",e.appendChild(o)}}catch{}})}catch{}}if(a(f,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,r=a(()=>{if(!t){t=!0;try{f(document)}catch{}t=!1}},"run");document.body&&setTimeout(r,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(r,0),{once:!0});let e=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(r,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?e():document.addEventListener("DOMContentLoaded",e,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",b="urppp_scheme_v1",m="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",_="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",$="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},rt="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:et,rebuildNavbar:st,syncNavbarThemeUI:ft,syncThemeDotGroup:Z}=_i({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Xt,getAccent:Yt,getBrutalActivePalette:ko,getBrutalPaletteById:ae,getBrutalSelectedPalette:wo,getCurrent:Qt,getScheme:Lr,getSkin:Zt,isThemeModeAvailable:ee,setBrutalPalette:Ao,skinSupportsDark:$r,skinSupportsDynamic:Mr,skinSupportsFixedPalettes:vo},settings:{ensureSettingsPanel:Qo,openSettingsPanel:Jo,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let r=document.getElementById("navbar"),e=r?.querySelector(".ace-nav");if(!r||!e)return;let o=document.getElementById("intellegenceUDiv"),s=document.getElementById("clickdiv"),i=document.getElementById("form-search");if(!o){let D=document.createElement("li");D.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",D.appendChild(o),e.appendChild(D)}let l=o.closest("li")||o.parentElement,h=Array.from(e.children).find(D=>{let R=D.querySelector(":scope > a");if(!R)return!1;let B=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return B.includes("customerServiceCenter")||/help|service|support/i.test(B)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),g=Array.from(e.children).find(D=>D.classList.contains("light-blue")),E=h||g||null;E&&l&&E!==l&&((l.compareDocumentPosition(E)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||e.insertBefore(l,E)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let M=l;s?(s.removeAttribute("onclick"),s.setAttribute("role","button"),s.setAttribute("aria-label","搜索功能")):(s=document.createElement("button"),s.type="button",s.id="clickdiv",s.setAttribute("aria-label","搜索功能"),s.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(s)),s.style.setProperty("left","8px","important"),s.style.setProperty("position","relative","important"),s.style.setProperty("z-index","31","important"),i||(i=document.createElement("div"),i.id="form-search",i.className="nav-search",i.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),M&&i.parentElement!==M&&M.appendChild(i),M&&M.style.setProperty("position","relative","important"),i.classList.add("urppp-desktop-search"),i.style.setProperty("position","absolute","important"),i.style.setProperty("top","50%","important"),i.style.setProperty("right","24px","important"),i.style.setProperty("left","auto","important"),i.style.setProperty("transform","translateY(-50%)","important"),i.style.setProperty("width",i.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),i.style.setProperty("max-width","calc(100vw - 24px)","important"),i.style.setProperty("opacity",i.dataset.open==="1"?"1":"0","important"),i.style.setProperty("pointer-events",i.dataset.open==="1"?"auto":"none","important"),i.style.setProperty("z-index","1200","important"),i.style.setProperty("margin","0","important"),i.style.setProperty("background","transparent","important"),i.style.setProperty("border","0 solid transparent","important"),i.style.setProperty("box-shadow","none","important"),i.style.setProperty("overflow","visible","important"),i.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let j=i.querySelector("#search-input"),z=i.querySelector("form");if(!j||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let F=i.querySelector(".input-icon");F&&(F.style.setProperty("display","block","important"),F.style.setProperty("position","relative","important")),j.style.setProperty("display","block","important"),j.style.setProperty("width","100%","important"),j.style.setProperty("height","36px","important"),j.style.setProperty("box-sizing","border-box","important"),j.style.setProperty("padding","0 12px","important"),j.style.setProperty("border","1px solid var(--border)","important"),j.style.setProperty("border-radius","var(--radius-sm)","important"),j.style.setProperty("background","var(--input-bg)","important"),j.style.setProperty("color","var(--text)","important");let J=a(D=>{i.dataset.open=D?"1":"0",i.style.setProperty("width",D?"min(240px, calc(100vw - 24px))":"0px","important"),i.style.setProperty("opacity",D?"1":"0","important"),i.style.setProperty("pointer-events",D?"auto":"none","important"),s.setAttribute("aria-expanded",D?"true":"false"),D&&setTimeout(()=>j.focus(),30)},"setOpen");s.__urpppSearchBound||(s.__urpppSearchBound=!0,s.addEventListener("click",D=>{D.preventDefault(),D.stopImmediatePropagation(),J(i.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",D=>{let R=document.getElementById("form-search"),B=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(D.target)||B?.contains(D.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let r=document.documentElement||document.body;r&&r.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function N(t,r,e){t/=255,r/=255,e/=255;let o=Math.max(t,r,e),s=Math.min(t,r,e),i=0,l=0,h=(o+s)/2;if(o!==s){let g=o-s;switch(l=h>.5?g/(2-o-s):g/(o+s),o){case t:i=(r-e)/g+(r<e?6:0);break;case r:i=(e-t)/g+2;break;default:i=(t-r)/g+4;break}i/=6}return{h:i*360,s:l,l:h}}a(N,"rgbToHsl");function Y(t,r,e){t=(t%360+360)%360,r=Math.max(0,Math.min(1,r)),e=Math.max(0,Math.min(1,e));let o=(1-Math.abs(2*e-1))*r,s=o*(1-Math.abs(t/60%2-1)),i=e-o/2,l=0,h=0,g=0;return t<60?(l=o,h=s):t<120?(l=s,h=o):t<180?(h=o,g=s):t<240?(h=s,g=o):t<300?(l=s,g=o):(l=o,g=s),{r:Math.round((l+i)*255),g:Math.round((h+i)*255),b:Math.round((g+i)*255)}}a(Y,"hslToRgb");function tt(t,r,e){let{r:o,g:s,b:i}=Y(t,r,e);return he(o,s,i)}a(tt,"hslHex");function ht(t){let{r,g:e,b:o}=Xr(Gt(t)||mt),s=N(r,e,o);return s.s<.12&&(s.s=.18),s}a(ht,"seedHsl");function bt(t,r,e){let o=Math.max(0,Math.min(100,e))/100,s=Math.max(0,Math.min(.95,r));return tt(t,s,o)}a(bt,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,r){let e=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(r)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",e,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let r=Gt(t)||mt,{h:e,s:o}=ht(r),s=Ft(e),i=Math.min(.72,Math.max(.28,o*.78));return bt(s,i,42)}a(Pt,"companionColor");function It(t,r){let e=Gt(t)||mt,{h:o,s}=ht(e),l=zt(r||ot),h=Math.min(.92,Math.max(.35,s*l.chroma)),g=Pt(e),{h:E}=ht(g),M=bt(o,h,l.primaryTone),j=bt(o,h,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",e,.18),F,J,D;l.whiteCard?(F=Bt("#F1F5F9",Bt("#FFFFFF",e,.08),.5),J="#FFFFFF",D="#E5E7EB"):l.duo?(F=Bt(yt(g,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(e,l.surfaceSeed),"#FFFFFF",.1),D=Bt("#E5E7EB",g,.16)):(F=Bt(yt(e,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(e,l.surfaceSeed),"#FFFFFF",.12),D=Bt("#E5E7EB",e,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?g:e,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),B=bt(o,Math.min(.45,h*.55),14),K=gr(bt(o,h*.3,34),.88),ut=gr(bt(o,h*.22,46),.76),vt=gr(M,.18),Et="0 4px 12px "+gr(M,.1)+", 0 1px 2px "+gr(M,.05);return{"--bg":F,"--surface":J,"--text":B,"--text-secondary":K,"--text-muted":ut,"--border":D,"--border-focus":M,"--input-bg":R,"--primary":M,"--primary-hover":j,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":g}}a(It,"buildMaterialSchemeVars");function Xt(t,r){let e=It(t,r);return{id:r,primary:e["--primary"],bg:e["--bg"],surface:e["--surface"],border:e["--border"],text:e["--text"]}}a(Xt,"buildSchemePreview");function zr(t){let r=Gt(t)||Yt()||mt;return X.map(e=>Object.assign({},e,Xt(r,e.id)))}a(zr,"listSchemePreviews");function ur(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(r=>t.style.removeProperty(r))}a(ur,"clearInlinePrimaryOverrides");function Yt(){return Gt(GM_getValue(T,""))||""}a(Yt,"getAccent");function Lr(){let t=String(GM_getValue(b,ot)||ot);return X.some(r=>r.id===t)?t:ot}a(Lr,"getScheme");function na(t){let r=X.some(e=>e.id===t)?t:ot;return GM_setValue(b,r),r}a(na,"setScheme");function Ei(t,r){if(!t)return;let e=Gt(t);if(e){if(GM_setValue(T,e),r&&r.scheme&&na(r.scheme),r&&r.skipTheme){let o=Ya(e,.15),s=gr(e,.15);document.documentElement.style.setProperty("--urppp-accent",e),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",s);try{ft()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{ft()}catch{}try{Dt()}catch{}}}a(Ei,"applyAccent");function pa(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let r=JSON.parse(t);return Array.isArray(r)?r.filter(e=>typeof e=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(e.replace("#",""))).map(e=>e.startsWith("#")?e.toUpperCase():"#"+e.toUpperCase()):it.slice()}catch{return it.slice()}}a(pa,"getAccentPresets");function Ci(t){let r=Gt(t||Yt()||mt);if(!r)return pa();let e=pa();return e=[r].concat(e.filter(o=>o.toLowerCase()!==r.toLowerCase())),e=e.slice(0,12),GM_setValue(C,JSON.stringify(e)),e}a(Ci,"saveAccentPreset");function Kt(){try{return!!GM_getValue(m,!1)}catch{return!1}}a(Kt,"isThemeFollowSystem");function Ae(t){return GM_setValue(m,!!t),!!t}a(Ae,"setThemeFollowSystem");function ia(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(ia,"isCleanDefault");function Pi(t){return GM_setValue(v,!!t),!!t}a(Pi,"setCleanDefault");function sa(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(sa,"isCleanAnalysisDirect");function zi(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(zi,"setCleanAnalysis");function xr(){try{let t=GM_getValue(_,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(xr,"isAppleEdgeLine");function Li(t){return GM_setValue(_,!!t),!!t}a(Li,"setAppleEdgeLine");function la(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(la,"isAutoUpdateCheck");function qi(t){return GM_setValue(c,!!t),!!t}a(qi,"setAutoUpdateCheck");function Se(t,r){try{let e=GM_getValue(t,"");if(e&&typeof e=="object")return e;if(typeof e=="string"&&e.trim())return JSON.parse(e)}catch{}return r}a(Se,"readJsonSetting");function _e(t,r){return GM_setValue(t,JSON.stringify(r)),r}a(_e,"writeJsonSetting");function yr(){return eo(Se(O,null))}a(yr,"getPrivacySettings");function ca(t){return _e(O,eo(t))}a(ca,"setPrivacySettings");function qr(){return we(Se($,null))}a(qr,"getCustomIdentity");function bo(t){return _e($,we(t))}a(bo,"setCustomIdentity");function da(){let t=Se(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(da,"getScheduleFirstMondayMap");function ho(t,r){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(r||"")))return;let e=da();e[String(t)]=String(r),_e(H,e)}a(ho,"rememberScheduleFirstMonday");function Ee(){let t="";try{t=GM_getValue(G,"")}catch{}let r=!!(t&&(typeof t!="string"||t.trim())),e=Se(G,null);try{if(r&&(!e||typeof e!="object"||Array.isArray(e)))throw new Error("配置不是 JSON 对象");let o=e&&typeof e=="object"?e:{},s={enabled:!!o.enabled,mapping:Pr(o.mapping||xe)};return rt="",s}catch{return rt=r?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:Pr(xe)}}}a(Ee,"getScheduleJsonFormatSettings");function go(t){let r=t&&typeof t=="object"?t:{},e={enabled:!!r.enabled,mapping:Pr(r.mapping||xe)};return rt="",_e(G,e)}a(go,"setScheduleJsonFormatSettings");function fo(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(fo,"isHomePage");function Ce(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(Ce,"isFollowUseDynamic");function ua(t){return GM_setValue(q,!!t),!!t}a(ua,"setFollowUseDynamic");function Ti(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Ti,"systemPrefersDark");function vr(){return Ti()&&$r()?"dark":Ce()&&Mr()?"scu-red":"default"}a(vr,"resolveFollowThemeName");function ee(t,r){return t==="dark"?$r(r):t==="scu-red"?Mr(r):t==="default"}a(ee,"isThemeModeAvailable");function Wt(t,r){r=r||{},!$r()&&Kt()&&Ae(!1),!Mr()&&Ce()&&ua(!1),r.manual&&Ae(!1);let e;r.system||Kt()&&!r.manual?e=vr():(e=Ct[t]?t:Qt()||"default",Ct[e]||(e="default")),ee(e)||(e="default");let o=Ct[e]||Ct.default;r.skipPersist||GM_setValue(w,e),ur();let s=document.getElementById("urppp-theme-vars")||(()=>{let E=document.createElement("style");return E.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(E),E})(),i=Yt(),l=Object.assign({},o.vars);if(e==="scu-red"){let E=i||mt,M=Lr();l=Object.assign(l,It(E,M));let j=l["--primary"]||E,z=l["--primary-hover"]||Ya(j,.12);document.documentElement.style.setProperty("--urppp-accent",j),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||gr(j,.15)),document.documentElement.style.setProperty("--urppp-seed",E),document.documentElement.style.setProperty("--urppp-scheme",M)}else e==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let h=":root {";for(let[E,M]of Object.entries(l))h+=`${E}:${M};`;h+="}",s.textContent=h,document.body&&(document.body.style.fontFamily=o.font);try{let E=document.documentElement;E.dataset.urpppTheme=e,E.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),E.classList.add("urppp-theme-"+e),E.classList.toggle("urppp-theme-follow",Kt()),document.body&&(document.body.dataset.urpppTheme=e,document.body.classList.toggle("urppp-dark",e==="dark"),document.body.classList.toggle("urppp-theme-follow",Kt()))}catch{}try{rr()}catch{}try{ft()}catch{}try{Dt()}catch{}try{Do()}catch{}try{ji()}catch{}let g=document.getElementById("urppp-boot-loader");g&&(g.style.fontFamily=o.font)}a(Wt,"applyTheme");function Qt(){return GM_getValue(w,"default")}a(Qt,"getCurrent");function Tr(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(Tr,"themeDownloaded");function xo(t){let r=document.getElementById("urppp-store-theme-"+t);return r||(r=document.createElement("style"),r.id="urppp-store-theme-"+t,r.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(r)),r}a(xo,"storeThemeStyleEl");function $i(t){let r=document.getElementById("urppp-store-theme-"+t);r&&r.remove()}a($i,"removeStoreThemeStyle");function yo(){u.forEach(t=>{let r="urppp_theme_css_"+t.id,e="";try{e=GM_getValue(r,"")||""}catch{}e&&(xo(t.id).textContent=e)});try{rr()}catch{}}a(yo,"injectAllStoreThemeStyles");function Zt(){let t=GM_getValue(d,"apple"),r=u.find(e=>e.id===t);return r&&r.ready&&(r.installed!==!1||Tr(r.id))?t:"apple"}a(Zt,"getSkin");function ma(t,r){let e=t||Zt(),o=u.find(s=>s.id===e);return!!(o&&o[r])}a(ma,"getSkinCapability");function $r(t){return ma(t,"dark")}a($r,"skinSupportsDark");function Mr(t){return ma(t,"dynamic")}a(Mr,"skinSupportsDynamic");function vo(t){return ma(t,"palettes")}a(vo,"skinSupportsFixedPalettes");function ae(t){return Q.find(r=>r.id===t)||Q[0]}a(ae,"getBrutalPaletteById");function wo(){let t=String(GM_getValue(I,"acid")||"acid"),r=ae(t);return r.id===V?ae("acid"):r}a(wo,"getBrutalSelectedPalette");function ko(){let t=String(GM_getValue(L,V)||V);return ae(t)}a(ko,"getBrutalActivePalette");function Ao(t,r){let e=r||{},o=ae(t);e.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{rr()}catch{}try{ft()}catch{}try{Dt()}catch{}try{let s=document.getElementById("urppp-clean-root");s&&typeof s.__syncCleanThemeDots=="function"&&s.__syncCleanThemeDots()}catch{}}a(Ao,"setBrutalPalette");function Mi(t){let r=t||Zt();return r==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:r==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:r==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:r==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:r==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":r==="apple"&&xr()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":r==="apple"&&xr()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Mi,"getSkinShapeOverrides");function Ir(){try{let t=Zt();if(t==="apple")return xr()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Ir,"urpppCardBorderValue");function rr(){let t=Zt();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let r=t==="apple"&&xr();document.documentElement.setAttribute("data-urppp-apple-edge",r?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",r?"1":"0")}catch{}try{let r=document.getElementById("urppp-skin-vars")||(()=>{let i=document.createElement("style");return i.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(i),i})(),e=Mi(t),o=":root, html[data-urppp-skin] {";if(Object.keys(e).forEach(i=>{o+=i+":"+e[i]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let i=ko();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+i.accent+";--brutal-secondary:"+i.secondary+";--brutal-info:"+i.info+";--brutal-warning:"+i.warning+";}"}r.textContent=o;return}if(t==="apple"){let i=xr(),l=i?"1px solid rgba(0,0,0,0.08)":"none",h=i?"1px solid rgba(255,255,255,0.10)":"none",g=i?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(i?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(i?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+h+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(i?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+g+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);r.textContent=o;let s=document.head||document.documentElement;r.parentNode===s&&s.lastElementChild!==r&&s.appendChild(r)}catch(r){try{console.warn("[URP++] applySkinAttr",r)}catch{}}setTimeout(()=>{try{Vt(document)}catch{}},0)}a(rr,"applySkinAttr");function So(t){let r=u.find(e=>e.id===t&&e.ready&&(e.installed!==!1||Tr(e.id)));if(!r)return!1;GM_setValue(d,r.id);try{r.dynamic||ua(!1),!r.dark&&Kt()&&Ae(!1);let e=Kt(),o=e?vr():Qt(),s=ee(o,r.id)?o:"default";rr(),Wt(s,{system:e})}catch{try{rr()}catch{}}try{Dt()}catch{}try{ft()}catch{}try{let e=document.getElementById("urppp-clean-root");e&&typeof e.__syncCleanThemeDots=="function"&&e.__syncCleanThemeDots()}catch{}return!0}a(So,"setSkin");function Ii(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),r=a(()=>{if(Kt())try{Wt(vr(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",r):t.addListener&&t.addListener(r)}catch{}}}a(Ii,"bindSystemThemeListener");try{Kt()?Wt(vr(),{system:!0}):Wt(Qt())}catch{}try{rr()}catch{}try{Ii()}catch{}function Ni(t){let r=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),e=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of e){let s=r.match(o);if(s)return s[0].trim()}return""}a(Ni,"extractLoginErrorMessage");function _o(){let t=location.pathname,r=document.getElementById("formContent"),e=document.querySelector(".form-signin");if(!r||!e){setTimeout(_o,50);return}if(r.querySelector(":scope > #urppp-root"))return;let o=Ni(r),s=e.querySelector('a[onclick*="toModifyPwd"]'),i=(()=>{let R=r.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of r.children)R.style.display="none";r.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let h=location.pathname==="/loginEn",g=a((R,B)=>h?B:R,"t");r.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      <div class="uc">
        ...
        <div class="urppp-store-sub-body" id="urppp-store-sub-body"></div>`,r.appendChild(e),e.querySelector("#urppp-store-sub-back").onclick=Ki);let o=e.querySelector("#urppp-store-sub-title"),s=e.querySelector("#urppp-store-sub-body");o.textContent=t==="theme"?"主题商店":"插件商店",s.innerHTML="",t==="theme"?ps(s):an(s),e.classList.add("open")}a(Ea,"openStoreSubPanel");function Ki(){let t=document.getElementById("urppp-store-subpanel");if(!t)return;t.classList.remove("open");let r=t.querySelector("#urppp-store-sub-body");r&&(r.innerHTML="")}a(Ki,"closeStoreSubPanel");function Xo(t){t.querySelectorAll(".urppp-store-tab").forEach(r=>{r.addEventListener("click",()=>{t.querySelectorAll(".urppp-store-tab").forEach(o=>o.className="urppp-store-tab"),r.className="urppp-store-tab ac",t.querySelectorAll(".urppp-store-pane").forEach(o=>o.style.display="none");let e=t.querySelector('.urppp-store-pane[data-pane="'+r.dataset.tab+'"]');e&&(e.style.display="")})})}a(Xo,"bindStoreTabs");function Ko(t){Array.isArray(t)&&t.forEach(r=>{if(!r||!r.cardCss||!r.id)return;let e=document.getElementById("urppp-store-card-css-"+r.id);e||(e=document.createElement("style"),e.id="urppp-store-card-css-"+r.id,(document.head||document.documentElement).appendChild(e)),e.textContent!==r.cardCss&&(e.textContent=r.cardCss)})}a(Ko,"ensureStoreCardStyles");function Zi(t,r){let e=(u.find(i=>i.id===t.id)||{}).repo,o=t.repo||e,s=o?`<button type="button" class="urppp-set-btn ghost" style="position:absolute;left:12px;bottom:12px" data-repo="${at(o)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-skin="${at(t.id)}">
      ...
      ${s}
    </div>`}a(Zi,"themeStoreCard");async function Ca(t){let r=t.querySelector('[data-pane="download"]');if(!r)return;let e=[];try{e=(await Dr()).filter(o=>o.type==="theme"&&!Tr(o.id))}catch{}if(!e.length){r.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Ko(e),r.innerHTML=`<div class="urppp-store-theme-grid">${e.map(o=>Zi(o,!1)).join("")}</div>`,r.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>ts(o.dataset.storeTheme,o))}),r.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}})),Ie(r)}a(Ca,"fetchCatalogThemes");async function ts(t,r){if(!r||r.disabled)return;let e=(await Dr()).find(i=>i.id===t);if(!e||!Array.isArray(e.entry)||!e.entry.length)return;r.disabled=!0,r.textContent="下载中…";let o="";for(let i of e.entry)try{let l=await fetch(i,{cache:"no-store"});if(l.ok){o=await l.text();break}}catch{}if(!o){r.textContent="下载失败",setTimeout(()=>{r.textContent="下载",r.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,o)}catch{}try{xo(t).textContent=o}catch{}r.textContent="已安装",r.disabled=!0;let s=r.closest&&r.closest(".urppp-store-inline");if(s){try{let i=s.querySelector("#urppp-theme-manage");i&&await Pa(i)}catch{}try{Ca(s)}catch{}}try{Dt()}catch{}}a(ts,"downloadStoreTheme");function rs(t,r){let o=t.installed!==!1?"":`<button type="button" class="urppp-set-btn ghost" style="position:absolute;right:96px;bottom:12px" data-theme-del="${at(t.id)}">删除</button>`,s=r&&r.repo||t.repo,i=s?`<button type="button" class="urppp-set-btn ghost" style="position:absolute;left:12px;bottom:12px" data-repo="${at(s)}">仓库</button>`:"",l=r&&r.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(r.downloads))}</span>`:"",h=Zt()===t.id;return`<div class="urppp-skin-card${h?" is-active":""}" data-skin="${at(t.id)}">
      ...
      ${o}${i}
    </div>`}a(rs,"themeManageCardHtml");async function Pa(t){if(!t)return;let r=[];try{r=await Dr()}catch{}let e=u.filter(o=>o.installed!==!1||Tr(o.id));if(!e.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}Ko(e.map(o=>r.find(s=>s.id===o.id))),t.innerHTML=`<div class="urppp-store-theme-grid">${e.map(o=>rs(o,r.find(s=>s.id===o.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(o=>o.addEventListener("click",()=>{if(So(o.dataset.themeUse)){try{Dt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(s=>{let i=s.dataset.skin,l=s.querySelector(".urppp-skin-apply"),h=Zt()===i;s.classList.toggle("is-active",h),l&&(l.classList.toggle("is-current",h),l.disabled=h,l.textContent=h?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(o=>o.addEventListener("click",()=>{let s=o.dataset.themeDel;try{GM_setValue("urppp_theme_css_"+s,"")}catch{}$i(s);try{Zt()===s&&(GM_setValue(d,"apple"),rr(),Wt("default",{manual:!0}))}catch{}try{Dt()}catch{}let i=t.closest(".urppp-store-inline");if(i){try{Pa(t)}catch{}try{Ca(i)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}})),Ie(t)}a(Pa,"fetchThemeManage");let es={apple:{color:"#0071e3",border:"1px solid rgba(0,113,227,.4)",radius:"999px",colorDark:"#7aa2ff",borderDark:"1px solid rgba(122,162,255,.4)"},editorial:{color:"#1c1c1c",border:"none",radius:"0",colorDark:"#e8e8e4"},flat:{color:"#000",border:"1px solid rgba(0,0,0,.5)",radius:"0",colorDark:"#fff",borderDark:"1px solid rgba(255,255,255,.4)"},organic:{color:"#5c4033",border:"1px solid rgba(92,64,51,.35)",radius:"999px",colorDark:"#eadbc8",borderDark:"1px solid rgba(234,219,200,.35)"},brutal:{color:"#000",border:"1px solid rgba(0,0,0,.55)",radius:"0",colorDark:"#fff",borderDark:"1px solid rgba(255,255,255,.4)"},neu:{color:"#4f5258",border:"none",radius:"12px",bg:"#e0e5ec",colorDark:"#dfe3e9",bgDark:"#2a2f36"}};function as(){try{return!!(document.querySelector("html.urppp-theme-dark")||document.body&&document.body.classList.contains("urppp-dark"))}catch{return!1}}a(as,"isDarkMode");function Ie(t){if(!t)return;let r=as();t.querySelectorAll(".urppp-set-btn.ghost").forEach(e=>{let o=e.closest(".urppp-skin-card"),s=o&&o.dataset.skin,i=es[s]||{},l=e.style;l.setProperty("background",(r?i.bgDark:i.bg)||"transparent","important"),l.setProperty("box-shadow","none","important"),l.setProperty("transform","none","important"),l.setProperty("color",(r?i.colorDark:i.color)||"inherit","important"),l.setProperty("border",(r?i.borderDark:i.border)||"1px solid rgba(128,128,128,.4)","important"),l.setProperty("border-radius",i.radius||"6px","important")})}a(Ie,"styleStoreGhostBtns");function Zo(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(Zo,"storeManageSettingsHtml");let os=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];async function Dr(){let t=a((e,o)=>Promise.race([e,new Promise((s,i)=>setTimeout(()=>i(new Error("timeout")),o))]),"withTimeout"),r=await Promise.allSettled(os.map(e=>t(fetch(e,{cache:"no-store"}),5e3)));for(let e of r)if(e.status==="fulfilled"&&e.value&&e.value.ok)try{let o=await e.value.json();if(o&&Array.isArray(o.items))return o.items}catch{}return[]}a(Dr,"fetchCatalogList");function tn(t,r){let e=String(t||"0").split(".").map(Number),o=String(r||"0").split(".").map(Number);for(let s=0;s<Math.max(e.length,o.length);s+=1){let i=e[s]||0,l=o[s]||0;if(i!==l)return i>l}return!1}a(tn,"versionGt");function ns(t,r){let e=0;return r.forEach(o=>{if(!o.id)return;let s=t.querySelector('[data-theme-use="'+o.id+'"]');s&&tn(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(rn(s.closest(".urppp-skin-card"),"主题"),e+=1);let i=t.querySelector('[data-plugin-id="'+o.id+'"]');if(i){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&tn(o.version,l.version)&&(rn(i.closest(".urppp-store-item"),"插件"),e+=1)}}),e}a(ns,"applyStoreUpdateBadges");function rn(t,r){if(!t||t.querySelector(".urppp-store-update"))return;let e=t.querySelector(".urppp-store-ops");if(!e)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),e.appendChild(o)}a(rn,"addUpdateBadge");function en(t){let r=t.querySelector("[data-store-auto-update]"),e=t.querySelector("[data-store-check-update]");if(!r||!e)return;let o=GM_getValue("urppp_store_auto_update",!1),s=a(()=>{r.textContent="自动检测更新："+(o?"开":"关")},"sync");s(),r.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),s()}),e.addEventListener("click",async()=>{e.disabled=!0;let i=e.textContent;e.textContent="检查中…";try{let l=await Dr(),h=ns(t,l);e.textContent=h?"发现更新":"已是最新"}catch{e.textContent="检查失败"}setTimeout(()=>{e.textContent=i,e.disabled=!1},1600)})}a(en,"bindStoreManageSettings");function ps(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${Zo()}<div class="urppp-store-bd"><div id="urppp-theme-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div></div>
        </div>
      </div>`,Xo(t),en(t),Ca(t),Pa(t.querySelector("#urppp-theme-manage"))}a(ps,"renderThemeStoreBody");function is(t){let r=t.downloads!=null?`${at(String(t.downloads))}`:"",e=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
    ...
    </div>`}a(is,"pluginStoreCard");async function ss(t){if(!t)return;let r=[];try{r=(await Dr()).filter(e=>e.type==="plugin"&&!(_t&&_t.api&&_t.api.isEnabled&&_t.api.isEnabled(e.id)))}catch{}if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载插件</p><p class="urppp-store-sub">已安装的插件不会再显示在这里。</p></div>';return}t.innerHTML=`<div class="urppp-store-theme-grid">${r.map(e=>is(e)).join("")}</div>`,t.querySelectorAll("[data-plugin-apply]").forEach(e=>e.addEventListener("click",async()=>{e.disabled=!0;let o=e.textContent;e.textContent="下载中…";try{_t&&_t.api&&_t.api.install&&await _t.api.install(e.dataset.pluginApply,null),e.textContent="已安装";try{Dt()}catch{}}catch{e.textContent="失败"}setTimeout(()=>{e.textContent=o,e.disabled=!1},1200)})),t.querySelectorAll("[data-repo]").forEach(e=>e.addEventListener("click",()=>{try{window.open(e.dataset.repo,"_blank","noopener")}catch{}})),Ie(t)}a(ss,"fetchCatalogPlugins");async function ls(t){if(!t)return;let r=[];try{r=await Dr()}catch{}let e=_t&&_t.api&&_t.api.list&&_t.api.list()||[];if(!e.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}t.innerHTML=e.map(o=>{let s=r.find(h=>h.id===o.id),i=s&&s.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(s.downloads))}</span>`:"",l=o.repo||s&&s.repo?`<button type="button" class="urppp-set-btn ghost" data-repo="${at(o.repo||s.repo)}">仓库</button>`:"";return`<div class="urppp-store-item">
      ...
      <div class="urppp-store-inline">
        ...
        <div class="urppp-store-body">
          <div class="urppp-store-pane" data-pane="download"><div class="urppp-store-empty"><p class="urppp-store-empty-title">加载中…</p></div></div>
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${Zo()}<div class="urppp-store-bd" id="urppp-plugin-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div>
        </div>
      </div>`,Xo(t),en(t),ss(t.querySelector('[data-pane="download"]')),ls(t.querySelector("#urppp-plugin-manage"))}a(an,"renderPluginStoreBody");function cs(t){if(!t)return;let r=t.querySelector("#urppp-theme-store");r&&!r.dataset.bound&&(r.dataset.bound="1",r.addEventListener("click",()=>Ea("theme")));let e=t.querySelector("#urppp-skin-list");if(!e)return;let o=Zt();if(e.innerHTML="",!u||!u.length){e.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}u.filter(s=>s.installed!==!1||Tr(s.id)).forEach(s=>{let i=document.createElement("div");i.className="urppp-skin-card"+(s.id===o?" is-active":""),i.dataset.skin=s.id;let l=document.createElement("button");l.type="button",l.className="urppp-skin-apply";let h=s.installed!==!1||Tr(s.id);h?s.id===o&&s.ready?(l.classList.add("is-current"),l.textContent="使用中",l.disabled=!0):l.textContent="应用主题":(l.classList.add("is-disabled"),l.textContent="去下载"),l.addEventListener("click",g=>{if(g.preventDefault(),g.stopPropagation(),!h){Ea("theme");return}if(!(s.id===o&&s.ready)&&So(s.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),i.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),i.querySelector(".urppp-skin-name").textContent=s.name,i.querySelector(".urppp-skin-desc").textContent=s.desc,i.appendChild(l),e.appendChild(i)})}a(cs,"renderSkinCards");let jr=[],za=!1;function ds(t,r,e){let o=typeof AbortController=="function"?new AbortController:null,s=o?setTimeout(()=>o.abort(),e):null;return fetch(t,{cache:"no-store",headers:r,signal:o?o.signal:void 0}).then(i=>{if(!i.ok)throw new Error("HTTP "+i.status);return i.text()}).finally(()=>{s&&clearTimeout(s)})}a(ds,"fetchWithTimeout");function us(t,r){return new Promise((e,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:r,onload:a(s=>{s.status>=200&&s.status<400?e(s.responseText||""):o(new Error("HTTP "+s.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(s){o(s)}})}a(us,"gmRequestForUpdate");function ms(t,r){let e={"Cache-Control":"no-cache"};return r&&r.range&&(e.Range=r.range),ds(t,e,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return us(t,e);throw o})}a(ms,"fetchTextForUpdate");async function La(t,r,e=1e3){let o=[],s=t[0],i=t.slice(1),l=a(z=>ms(z,r).then(F=>({url:z,text:F})).catch(F=>(o.push((z.split("/")[2]||z)+": "+(F&&F.message||F)),null)),"grab"),h=l(s),g=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),e)),E=await Promise.race([h,g]);if(E!=="__TIMEOUT__"){if(E&&E.text&&E.text.length>0)return E.text;let F=(await Promise.all(i.map(l))).find(J=>J&&J.text&&J.text.length>0);if(F)return F.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let M=Promise.all(i.map(l)).then(z=>{let F=z.find(J=>J&&J.text&&J.text.length>0);if(F)return F.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),j=h.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([j,M])}a(La,"fetchFirstAvailable");function wr(t,r){let e=document.getElementById("urppp-set-update-status");e&&(e.dataset.locked=t?"1":"",e.innerHTML=t||"",e.style.color=r==="err"?"#b91c1c":r==="ok"?"#15803d":"var(--text-muted)")}a(wr,"setUpdateStatus");async function qa(){let t=p,r="",e=!1,o="";try{let i=await La(n.sourceUrls(n.versionJson)),l=JSON.parse(i);r=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(e=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!r){let i=await La(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});r=Xa(i)}if(!r)throw new Error("无法解析远程主插件版本");let s=ge(r,t);return{id:"main",name:"主插件",local:t,remote:r,status:s>0?"update":s===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:e?o:""}}a(qa,"checkMainUpdate");function on(t,r,e){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let s=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,i=[],l;for(;(l=s.exec(o))!==null;)i.push({ver:l[1],index:l.index,headEnd:s.lastIndex});if(!i.length)return"";for(let g=0;g<i.length;g++){let E=g+1<i.length?i[g+1].index:o.length;i[g].body=o.slice(i[g].index,E).trim()}let h=[];for(let g of i)ge(g.ver,e)>0||ge(g.ver,r)<=0||h.push(g.body);return h.join(`

`).trim()}a(on,"extractChangelogRange");function nn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let r=document.createElement("style");r.id="urppp-update-toast-style",r.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(r)}a(nn,"ensureUpdateToastStyles");function bs(t){let r=String(t||"").replace(/\r\n/g,`
...
`),s=[],i=!1,l=a(()=>{i&&(s.push("</ul>"),i=!1)},"closeList");for(let h=0;h<o.length;h++){let E=o[h].replace(/\s+$/,"");if(!E.trim()){l();continue}let M=E.match(/^(#{2,3})\s+(.+)$/);if(M){l();let z=M[1].length,F=M[2];s.push(z===2?`<h2>${e(F)}</h2>`:`<h3>${e(F)}</h3>`);continue}let j=E.match(/^[-*]\s+(.+)$/);if(j){i||(s.push("<ul>"),i=!0),s.push(`<li>${e(j[1])}</li>`);continue}l(),s.push(`<p>${e(E)}</p>`)}return l(),s.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(bs,"renderChangelogMarkdown");function pn(t){let r=t||document.getElementById("urppp-update-toast");if(!r||!r.classList.contains("open")){r&&r.classList.remove("open","closing");return}if(r.__closing)return;r.__closing=!0,r.classList.add("closing"),r.classList.remove("open");let e=a(()=>{r.classList.remove("closing"),r.__closing=!1,r.removeEventListener("transitionend",o)},"done"),o=a(s=>{s&&s.target!==r||s&&s.propertyName&&s.propertyName!=="opacity"&&s.propertyName!=="transform"||e()},"onEnd");r.addEventListener("transitionend",o),setTimeout(e,380)}a(pn,"hideUpdateToast");function hs(t){let r=t||document.getElementById("urppp-update-changelog");if(!r||!r.classList.contains("open")&&!r.classList.contains("closing")||r.__closing)return;r.__closing=!0,r.classList.add("closing"),r.classList.remove("open");let e=a(()=>{r.classList.remove("closing"),r.__closing=!1,r.removeEventListener("transitionend",o)},"done"),o=a(s=>{s&&s.target!==r||s&&s.propertyName&&s.propertyName!=="opacity"&&s.propertyName!=="background-color"&&s.propertyName!=="background"||e()},"onEnd");r.addEventListener("transitionend",o),setTimeout(e,360)}a(hs,"hideChangelogModal");function sn(t,r){nn();let e=document.getElementById("urppp-update-changelog");e||(e=document.createElement("div"),e.id="urppp-update-changelog",e.innerHTML=`
        ...
        </div>`,e.addEventListener("click",o=>{(o.target===e||o.target&&o.target.getAttribute&&o.target.getAttribute("data-close")==="1")&&hs(e)}),document.documentElement.appendChild(e)),e.querySelector("h3").textContent=t||"更新日志",e.querySelector(".uuc-body").innerHTML=r||'<p class="uuc-meta">暂无更新日志</p>',e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(sn,"openChangelogModal");function Ta(t){nn();let r=document.getElementById("urppp-update-toast");r||(r=document.createElement("div"),r.id="urppp-update-toast",r.innerHTML=`
        ...
        </div>`,r.querySelector(".uut-close").addEventListener("click",()=>pn(r)),r.addEventListener("click",async e=>{let o=e.target&&e.target.closest?e.target.closest("[data-act]"):null;if(!o)return;let s=o.getAttribute("data-act"),i=r.__pack||{};if(s==="later"){pn(r);return}if(s==="go"){let l=i.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(s==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=i.changelogMd;l||(l=await La(n.sourceUrls("CHANGELOG.md")),i.changelogMd=l);let h=on(l,i.local,i.remote),g=h?bs(h):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';sn("更新日志 "+i.local+" → "+i.remote,g)}catch(l){sn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(r)),r.__pack=t||{},r.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),r.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",r.__closing=!1,r.classList.remove("open","closing"),r.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add("open"))})}a(Ta,"showUpdateToast");async function $a(){if(la()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await qa();t&&t.status==="update"&&Ta(t);let r=await gs();if(r)try{console.log("[URP++] 辅助插件热更新到",r.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a($a,"maybeAutoCheckUpdate");function gs(){let t=(window.__urpppUpdateCheckers||jr||[]).find(r=>r&&r.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(r=>r&&r.status==="update"?_t.update("assist"):null).catch(()=>null)}a(gs,"hotUpdateAssist");async function Ma(){if(za)return;za=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),wr("正在从多源检查更新…");try{let r=[qa()];(jr||[]).forEach(g=>{g&&typeof g.check=="function"&&r.push(Promise.resolve().then(()=>g.check()).then(E=>E||{id:g.id||"extra",name:g.name||"扩展",status:"err",message:"无结果"}).catch(E=>({id:g.id||"extra",name:g.name||"扩展",status:"err",message:String(E&&E.message||E)})))});let e=await Promise.all(r),o=e.map(g=>{if(!g)return"";if(g.status==="err")return`• <b>${at(g.name||g.id)}</b>：检查失败（${at(g.message||"unknown")}）`;if(g.status==="update"){let E="";if(g.id==="assist"&&_t&&_t.loaded("assist"))E=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let M=g.updateUrl?` <a href="${at(g.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",j=g.pageUrl?` <a href="${at(g.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";E=M+j}return`• <b>${at(g.name)}</b>：发现新版本 <b>${at(g.remote)}</b>（当前 ${at(g.local)}）${E}`}return g.status==="ahead"?`• <b>${at(g.name)}</b>：本地 ${at(g.local)} 新于远程 ${at(g.remote)}`:`• <b>${at(g.name)}</b>：已是最新（${at(g.local)}）`}).filter(Boolean),s=e.some(g=>g&&g.status==="update"),i=e.some(g=>g&&g.status==="err");wr(`${s?"检查完成：发现更新":i?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,i?"err":"ok");let h=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');h&&h.addEventListener("click",()=>{try{wr("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{wr("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(g=>{wr("重新装载失败："+(g&&g.message?g.message:g),"err")})}catch(g){wr("重新装载失败："+(g&&g.message?g.message:g),"err")}})}catch(r){wr("检查失败："+at(r&&r.message||r),"err")}finally{za=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(Ma,"checkForUpdates");function ln(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let r="当前主插件："+p,e=t.getAttribute("data-assist-version")||"";e&&(r+="；辅助插件："+e),t.textContent=r,t.style.color="var(--text-muted)"}a(ln,"refreshUpdateStatusHint");function fs(t){if(!t||typeof t.check!="function")return!1;let r=String(t.id||t.name||"").trim();if(!r)return!1;let e=jr.findIndex(s=>s&&s.id===r),o={id:r,name:t.name||r,check:t.check,localVersion:t.localVersion||""};e>=0?jr[e]=o:jr.push(o);try{let s=document.getElementById("urppp-set-update-status");s&&o.localVersion&&r==="assist"&&s.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{ln()}catch{}return!0}a(fs,"registerUpdateChecker");function xs(){let t={version:p,urls:n,check:Ma,checkMain:qa,registerChecker:fs,compareVersions:ge,parseUserscriptVersion:Xa,extractChangelogRange:on,showUpdateToast:Ta,maybeAutoCheckUpdate:$a,listCheckers:a(()=>jr.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(xs,"publishUpdateApi"),xs();let{rebuildSidebarCompletely:cn,syncMobileContentOffset:Or,syncSidebarUnderNavbar:kr}=Si({}),{rebuildDashboard:ys}=bi({deps:{statCardPrivacyMarkup:Ss}}),vs="urppp-clean-open",Ia={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ir(t){if(t==null||t==="")return!1;let r=String(t).trim();if(!r)return!1;if(/未评估|未评教|待评估|待评教/.test(r))return!0;let e=Number(r);return!Number.isNaN(e)&&e<0}a(ir,"isUnevaluatedScore");function Ne(t){if(t==null||t==="")return!1;let r=Number(t);return!Number.isNaN(r)&&r>=0&&r<=5}a(Ne,"isValidOfficialGpa");function Be(t){let r=String(t||"").trim();if(!r)return"";let e=r.match(/[\u4e00-\u9fffA-Za-z0-9]/);return e?e[0]:r.charAt(0)}a(Be,"firstContentChar");function Na(t,r){let e=String(t||""),o=Number(r)||0;return!e||o<=0||o>e.length?!1:e.charAt(o-1)==="1"}a(Na,"weekBitmapActive");function Hr(t){if(t==null||t==="")return null;let r=String(t).trim();if(!r||ir(r)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(r))return null;if(/^A\+$/i.test(r)||/^A$/i.test(r))return 4;if(/^A-$/i.test(r))return 3.7;if(/^B\+$/i.test(r))return 3.3;if(/^B$/i.test(r))return 3;if(/^B-$/i.test(r))return 2.7;if(/^C\+$/i.test(r))return 2.3;if(/^C$/i.test(r))return 2;if(/^C-$/i.test(r))return 1.7;if(/^D$/i.test(r))return 1.3;if(/^F$/i.test(r))return 0;if(/优秀/.test(r))return 4;if(/良好/.test(r))return 3;if(/中等/.test(r))return 2;if(/及格/.test(r)&&!/不及格/.test(r))return 1;if(/不及格|不合格|不通过/.test(r))return 0;if(/合格/.test(r))return 1;let e=parseFloat(r.replace(/[^\d.]/g,""));if(Number.isNaN(e)||e<0)return null;let o=Math.round(e);return o<60?0:o>100?4:Ia[o]!=null?Ia[o]:Ia[Math.max(60,Math.min(100,Math.floor(e)))]||0}a(Hr,"scoreToGpa");function Rr(t){let r=String(t||"").trim();if(!r||ir(r))return null;if(/优秀/.test(r))return 95;if(/良好/.test(r))return 85;if(/中等/.test(r))return 75;if(/及格/.test(r)&&!/不及格/.test(r))return 65;if(/不及格|不合格|不通过/.test(r))return 0;if(/合格/.test(r))return 70;if(/^A/i.test(r))return 95;if(/^B/i.test(r))return 85;if(/^C/i.test(r))return 75;if(/^D/i.test(r))return 65;if(/^F/i.test(r))return 0;let e=parseFloat(r.replace(/[^\d.]/g,""));return Number.isNaN(e)||e<0?null:e}a(Rr,"scoreToNumber");function Ar(t){return Math.round((Number(t)||0)*100)/100}a(Ar,"round2");function dn(t){return/必修/.test(String(t||""))}a(dn,"isRequiredAttr");function er(t){let r=0,e=0,o=0,s=0,i=0,l=0,h=0,g=0;return(t||[]).forEach(E=>{if(E&&(E.unevaluated||ir(E.score)))return;let M=Number(E.credit)||0,j=Rr(E.score),z=Ne(E.officialGpa)?Number(E.officialGpa):Hr(E.score);j==null||M<=0||(r+=M,e+=j*M,z!=null&&(o+=z*M,s+=M),E.required&&(i+=M,l+=j*M,z!=null&&(h+=z*M,g+=M)))}),{totalCredit:Ar(r),avgScore:Ar(r?e/r:0),avgGpa:Ar(s?o/s:0),requiredCredit:Ar(i),requiredGpa:Ar(g?h/g:0),requiredAvg:Ar(i?l/i:0),count:(t||[]).length}}a(er,"summarizeCourses");function Ba(t){let r=String(t||"");return/^https?:\/\//i.test(r)?r:r.startsWith("//")?location.protocol+r:r.startsWith("/")?location.origin+r:location.origin+"/"+r.replace(/^\.\//,"")}a(Ba,"absUrl");function Jt(t,r){let e=Ba(t),o=r&&r.method||"GET",s=r&&r.data||null;return new Promise((i,l)=>{let h=a((g,E)=>g?i(E):l(new Error(E||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:e,data:s||void 0,headers:r&&r.headers?r.headers:{},withCredentials:!0,onload:a(g=>{g.status>=200&&g.status<400?h(!0,g.responseText||""):h(!1,"HTTP "+g.status)},"onload"),onerror:a(()=>h(!1,"network error"),"onerror")});return}}catch{}fetch(e,{method:o,credentials:"include",cache:"no-store",headers:r&&r.headers?r.headers:{},body:s||void 0}).then(g=>{if(!g.ok)throw new Error("HTTP "+g.status);return g.text()}).then(g=>h(!0,g)).catch(g=>h(!1,g&&g.message))})}a(Jt,"fetchText");function Fe(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Fe,"parseHtml");function un(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=Hp,(document.head||document.documentElement).appendChild(t)}a(un,"ensureFeatureStyles");function ws(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=Wp,(document.head||document.documentElement).appendChild(t)}a(ws,"ensureScheduleExportStyles");function ks(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=Gp,(document.head||document.documentElement).appendChild(t)}a(ks,"ensureSettingsStyles");function mn(t){let e=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!e)return null;let o=e.querySelector(".urppp-user-name-value");if(o)return o;let s=e.cloneNode(!0);s.querySelectorAll("small, i, img, b, .badge").forEach(h=>h.remove());let i=(s.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(e.childNodes).forEach(h=>{h.nodeType===Node.TEXT_NODE&&h.textContent.trim()&&h.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=i||"同学",l.__urpppOriginalText=l.textContent,e.appendChild(l),l}a(mn,"ensureNavNameTarget");function De(t){let r=String(t||"").replace(/[\s:：]/g,"");return r?/姓名|英文姓名|姓名拼音/.test(r)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(r)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(r)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(r)?"contact":/绩点|GPA/.test(r)?"gpa":/学分/.test(r)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(r)?"grade":/课表|日程安排/.test(r)?"schedule":"":""}a(De,"classifyPrivacyLabel");function As(t,r){let e=String(t||"")+" "+String(r||"");return/绩点|GPA/.test(e)?"majorGpa":/主修为|培养方案|方案/.test(e)?"majorPlan":/尚不及格|未及格/.test(e)?"failedCourses":/待修读课程/.test(e)?"remainingCourses":/已修读课程/.test(e)?"completedCourses":""}a(As,"classifyHomeDataKey");function je(t,r,e){let o=r?` data-urppp-edit-key="${r}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${e}</span>`}a(je,"homePrivateValueSpan");function Ss(t,r){let e=at(t),o=at(r),s=As(t,r),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[s]||De(String(t||"")+" "+String(r||""));if(l==="organization")return r?{valueHtml:e,labelHtml:je("organization",s,o)}:{valueHtml:je("organization",s,e),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:e,labelHtml:o};let h=String(r||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&h){let E=h.index||0,M=String(r).slice(0,E),j=String(r).slice(E+h[0].length);return{valueHtml:e,labelHtml:`${at(M)}${je(l,s,at(h[0]))}${at(j)}`}}return{valueHtml:je(l,s,e),labelHtml:o}}a(Ss,"statCardPrivacyMarkup");function Sr(t,r){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||ve;if(r==="name")return"";let e=t.fields&&t.fields[r];return!e||!e.enabled?"":String(e.replacement||t.mask||ve)}a(Sr,"privacyReplacement");function se(t,r){if(!(!t||!r)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let e=getComputedStyle(t).fontSize;e&&e!=="0px"&&t.style.setProperty("--urppp-private-font-size",e)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",r)}}a(se,"markPrivateText");function bn(t,r){if(!t||!t.parentElement)return;let e=t.parentElement;t.classList.add("urppp-private-avatar"),e.classList.add("urppp-private-avatar-host"),e.setAttribute("data-urppp-private-mask",r||ve);let o=t.getBoundingClientRect();e.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),e.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),e.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),e.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),e.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(bn,"markPrivateAvatar");function _s(t,r){if(!t||!r)return;let e=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;e.classList.add("urppp-private-block"),e.setAttribute("data-urppp-private-mask",r)}a(_s,"markPrivateBlock");function Es(t,r){if(!(!t||!U[r])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let e=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",e??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",r),t.setAttribute("aria-label","修改"+U[r]+"显示值"),t.title="点击修改显示值"}}a(Es,"markDirectEditable");let br=null;function hn(t){let r=t&&t.getAttribute("data-urppp-edit-key");if(!r||!U[r])return;br&&br.__finish&&br.__finish(!1);let e=yr();if(e.mode!=="custom"||!e.directEdit.enabled)return;let s=String(e.directEdit.values[r]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),i=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),h=i.height>=8||!l?i:{left:i.left,top:l.top,width:Math.max(i.width,40),height:l.height},g=document.createElement("input"),E=getComputedStyle(t),M=Math.min(Math.max(h.width+64,140),Math.max(140,window.innerWidth-24)),j=Math.min(Math.max(12,h.left),Math.max(12,window.innerWidth-M-12)),z=Math.min(Math.max(12,h.top+(h.height-36)/2),Math.max(12,window.innerHeight-48));g.type="text",g.maxLength=80,g.className="urppp-direct-edit-input",g.value=s,g.setAttribute("aria-label","修改"+U[r]+"显示值"),g.style.left=j+"px",g.style.top=z+"px",g.style.setProperty("--urppp-direct-edit-width",M+"px"),g.style.fontFamily=E.fontFamily,g.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(E.fontSize)||14)))+"px";let F=!1,J=a(D=>{if(F||(F=!0,g.remove(),br===g&&(br=null),D))return;let R=yr();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[r]=String(g.value||"").trim().slice(0,80),ca(R),Vt(document),Ha(R.directEdit.values[r]?"显示值已更新":"已恢复分类设置"))},"finish");g.__finish=J,g.addEventListener("click",D=>D.stopPropagation()),g.addEventListener("blur",()=>J(!1)),g.addEventListener("keydown",D=>{D.key==="Enter"&&(D.preventDefault(),J(!1)),D.key==="Escape"&&(D.preventDefault(),J(!0))}),document.documentElement.appendChild(g),br=g,g.focus(),g.select()}a(hn,"openDirectEditInput");function Cs(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let r=t.target?.closest?.(".urppp-direct-editable");r&&(t.preventDefault(),t.stopPropagation(),hn(r))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let r=t.target?.closest?.(".urppp-direct-editable");r&&(t.preventDefault(),t.stopPropagation(),hn(r))},!0))}a(Cs,"bindDirectEditInteraction");function Ps(t){let r=t&&t.querySelectorAll?t:document;r.querySelectorAll(".urppp-direct-editable").forEach(e=>{let o=e.getAttribute("data-urppp-direct-tabindex");e.classList.remove("urppp-direct-editable"),e.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?e.removeAttribute("tabindex"):o!=null&&e.setAttribute("tabindex",o),e.__urpppDirectTitle==null?e.removeAttribute("title"):e.setAttribute("title",e.__urpppDirectTitle),e.__urpppDirectAriaLabel==null?e.removeAttribute("aria-label"):e.setAttribute("aria-label",e.__urpppDirectAriaLabel),delete e.__urpppDirectTitle,delete e.__urpppDirectAriaLabel}),r.querySelectorAll(".urppp-private-text").forEach(e=>{e.classList.remove("urppp-private-text"),e.removeAttribute("data-urppp-private-mask"),e.style.removeProperty("--urppp-private-font-size")}),r.querySelectorAll(".urppp-private-avatar").forEach(e=>e.classList.remove("urppp-private-avatar")),r.querySelectorAll(".urppp-private-avatar-host").forEach(e=>{e.classList.remove("urppp-private-avatar-host"),e.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>e.style.removeProperty(o))}),r.querySelectorAll(".urppp-private-avatar-block").forEach(e=>{e.classList.remove("urppp-private-avatar-block"),e.removeAttribute("data-urppp-private-mask")}),r.querySelectorAll(".urppp-private-block").forEach(e=>{e.classList.remove("urppp-private-block"),e.removeAttribute("data-urppp-private-mask")})}a(Ps,"clearPrivacyDisplay");function gn(t,r,e){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!r)return;t.__urpppOriginalText=t.textContent||""}let o=r&&e?e:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(gn,"applyCustomText");function zs(t){let r=t&&t.querySelectorAll?t:document,e=qr(),s=r.querySelector?.(".urppp-user-name-value")||(e.nameEnabled?mn(r):null);gn(s,e.nameEnabled,e.name),r.querySelectorAll(".profile-info-row").forEach(h=>{let g=h.querySelector(".profile-info-name"),E=h.querySelector(".profile-info-value");!g||!E||String(g.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||gn(E,e.nameEnabled,e.name)});let i=te(e.avatar),l=e.avatarEnabled&&!!i;r.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(h=>{let g=h.getAttribute("src")||"";g&&g!==h.__urpppAppliedCustomSrc&&(h.__urpppOriginalSrc=g),l?(h.__urpppOriginalSrc==null&&(h.__urpppOriginalSrc=g),g!==i&&h.setAttribute("src",i),h.__urpppAppliedCustomSrc=i):h.__urpppAppliedCustomSrc!=null&&(h.__urpppOriginalSrc&&h.setAttribute("src",h.__urpppOriginalSrc),delete h.__urpppAppliedCustomSrc)})}a(zs,"applyCustomIdentityDisplay");function Ls(t,r){t.querySelectorAll(".profile-info-row").forEach(e=>{let o=e.querySelector(".profile-info-name, th, label"),s=e.querySelector(".profile-info-value, td:last-child");if(!o||!s||o===s)return;let i=De(o.textContent),l=Sr(r,i);l&&se(s,l)})}a(Ls,"applyProfilePrivacy");function qs(t,r){t.querySelectorAll("table").forEach(e=>{let o=Array.from(e.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let s=o.map(i=>{let l=De(i.textContent);return["grade","gpa","credit"].includes(l)?l:""});s.some(Boolean)&&e.querySelectorAll("tbody tr").forEach(i=>{let l=i.querySelectorAll("td");s.forEach((h,g)=>{let E=Sr(r,h);h&&E&&se(l[g],E)})})})}a(qs,"applyScoreTablePrivacy");function Ts(t){let r=t&&t.querySelectorAll?t:document,e=yr();if(e.mode==="off")return;let o=Sr(e,"name"),s=Sr(e,"avatar"),i=Sr(e,"schedule"),l=o?mn(r):r.querySelector?.(".urppp-user-name-value");o&&se(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([E,M])=>{let j=Sr(e,M);j&&r.querySelectorAll(E).forEach(z=>se(z,j))}),qs(r,e);let g=e.mode==="custom"&&e.directEdit.enabled;if(r.querySelectorAll("[data-urppp-private]").forEach(E=>{let M=E.getAttribute("data-urppp-private"),j=E.getAttribute("data-urppp-edit-key"),F=(g&&j?String(e.directEdit.values[j]||"").trim():"")||Sr(e,M);!["avatar","schedule"].includes(M)&&F&&se(E,F),g&&j&&Es(E,j)}),g&&Cs(),Ls(r,e),s&&(r.querySelectorAll('[data-urppp-private="avatar"]').forEach(E=>{let M=E.matches("img")?E:E.querySelector("img");M?bn(M,s):(E.classList.add("urppp-private-avatar-block"),E.setAttribute("data-urppp-private-mask",s))}),r.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(E=>bn(E,s))),i){let E=Array.from(r.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));E.filter(M=>!E.some(j=>j!==M&&j.contains(M))).forEach(M=>_s(M,i))}}a(Ts,"applyPrivacyDisplay");let Fa=0,sr=[];function fn(){let t=yr(),r=qr();return t.mode!=="off"||r.nameEnabled||r.avatarEnabled}a(fn,"personalDisplayIsEnabled");function $s(){sr=sr.filter(({root:t})=>t&&t.isConnected),sr.forEach(({root:t,observer:r})=>r.observe(t,{childList:!0,subtree:!0}))}a($s,"resumePersonalDisplayObservers");function Vt(t){let r=t||document;sr.forEach(({observer:e})=>e.disconnect());try{un()}catch{}try{Ps(r)}catch{}try{zs(r)}catch(e){console.warn("[URP++] custom identity",e)}try{Ts(r)}catch(e){console.warn("[URP++] privacy",e)}fn()?($s(),Is()):(clearTimeout(Fa),sr=[])}a(Vt,"applyPersonalDisplay");function Ms(t){clearTimeout(Fa),Fa=setTimeout(()=>Vt(t||document),140)}a(Ms,"schedulePersonalDisplay");function Da(){try{nt&&nt.open&&Yr()}catch{}}a(Da,"refreshCleanPersonalDisplay");function Is(){if(!fn()){sr.forEach(({observer:t})=>t.disconnect()),sr=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(sr.some(e=>e.root===t))return;let r=new MutationObserver(()=>Ms(document));sr.push({root:t,observer:r}),r.observe(t,{childList:!0,subtree:!0})})}a(Is,"bindPersonalDisplayObservers");function Ns(t){let r=Object.assign({},t||{}),e=qr();e.nameEnabled&&e.name&&(r.name=e.name);let o=te(e.avatar);return e.avatarEnabled&&o&&(r.avatar=o),r}a(Ns,"personalizedProfile");let xn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",Bs="/student/courseSelect/thisSemesterCurriculum/callback",Fs="/student/courseSelect/thisSemesterCurriculum/index";async function Ds(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let r=new URLSearchParams(location.search),e=r.get("planCode")||r.get("zxjxjhh");if(e)return e}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let r=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(r)return r}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let r=await Jt(Bs),e=JSON.parse(r),o=Zr(e);if(o)return o}catch{}return""}a(Ds,"resolveSchedulePlanCode");async function yn(t){let r=await Ds(),e=r?{method:"POST",data:"planCode="+encodeURIComponent(r),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Jt(xn,e),s;try{s=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}r||(r=Zr(s)),(!s.jcsjbs||!s.jcsjbs.length)&&r&&(s=JSON.parse(await Jt(xn,{method:"POST",data:"planCode="+encodeURIComponent(r),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let i=wn(s,r,t);if(!i.courses.length)throw new Error("没有读取到可导出的课表数据");return i}a(yn,"loadScheduleExportData");function ja(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(ja,"safeScheduleFilename");function Oa(t,r){let e=URL.createObjectURL(t),o=document.createElement("a");o.href=e,o.download=r,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(e),1200)}a(Oa,"downloadBlob");function js(t){let r=Je(t),e=Ee(),o=e.enabled?Ye(r,e.mapping):Ve(r),s=JSON.stringify(o,null,2)+`
`;return Oa(new Blob([s],{type:"application/json;charset=utf-8"}),ja(t.semester.label)+".json"),Object.assign({customFormat:e.enabled},r.stats)}a(js,"exportScheduleJson");function vn(t){let e=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!e)return"";let o=e[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(e[1]+"-"+e[2]+"-"+o))return"";let s=Number(e[4]);if(s<1||s>30)return"";let i=to(new Date);return i.setDate(i.getDate()-(s-1)*7),ye(i)}a(vn,"deriveCurrentSemesterMonday");function wn(t,r,e){let o=r||Zr(t),s=vn(o)||da()[o]||"";return sp(t,o,e,{firstMonday:s})}a(wn,"normalizeScheduleDataForPage");function Os(t){let r=t.semester.planCode,e=da()[r],o=vn(r);return o?(ho(r,o),Promise.resolve(o)):Kr(e)?Promise.resolve(e):new Promise((s,i)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(e||ap(r))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let h=a((g,E)=>{l.remove(),g?i(g):s(E)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>h(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let g=l.querySelector("input").value;Kr(g)&&(ho(r,g),h(null,g))}),l.addEventListener("click",g=>{g.target===l&&h(new Error("已取消导出"))})})}a(Os,"requestScheduleFirstMonday");async function Hs(t){let r=await Os(t),e=np(t,r);return Oa(new Blob([e],{type:"text/calendar;charset=utf-8"}),ja(t.semester.label)+".ics"),pp(t)}a(Hs,"exportScheduleIcs");let Rs={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function lr(t,r,e){if(typeof document>"u")return Gt(r)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+r+")",(document.body||document.documentElement).appendChild(o);let s=getComputedStyle(o).color;o.remove();let i=String(s||"").match(/[\d.]+/g)?.map(Number)||[];if(i.length>=3){let l=he(i[0],i[1],i[2]),h=i.length>3?Math.max(0,Math.min(1,i[3])):1;return h<1?Bt(e||r,l,h):l}return Gt(s)||Gt(r)||"#000000"}a(lr,"resolvedScheduleImageColor");function kn(){let t=Qt(),r=Zt(),e=t==="dark",o=e?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},s={bg:lr("--bg",o.bg),surface:lr(r==="neu"?"--neu-base":"--surface",o.surface),input:lr("--input-bg",o.input),text:lr("--text",o.text),secondary:lr("--text-secondary",o.secondary),muted:lr("--text-muted",o.muted),border:lr("--border",o.border,lr(r==="neu"?"--neu-base":"--surface",o.surface)),primary:lr("--primary",o.primary)},i={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:r,dark:e,label:(Rs[r]||r)+" · "+(Ct[t]&&Ct[t].name||t),colors:s,shape:i[r]||i.apple}}a(kn,"currentScheduleImageTheme");function An(t,r){return fp(t,r||kn())}a(An,"buildScheduleSvg");function Us(t){return new Promise((r,e)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),s=URL.createObjectURL(o),i=new Image;i.onload=()=>{try{let h=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),g=document.createElement("canvas");g.width=Math.floor(t.width*h),g.height=Math.floor(t.height*h);let E=g.getContext("2d");E.scale(g.width/t.width,g.height/t.height),E.fillStyle=t.background||"#F8FAFC",E.fillRect(0,0,t.width,t.height),E.drawImage(i,0,0,t.width,t.height),g.toBlob(M=>M?r(M):e(new Error("无法生成课表图片")),"image/png")}catch(l){e(l)}finally{URL.revokeObjectURL(s)}},i.onerror=()=>{URL.revokeObjectURL(s),e(new Error("课表图片渲染失败"))},i.src=s})}a(Us,"svgToPngBlob");async function Ws(t){let r=await Us(An(t));Oa(r,ja(t.semester.label)+".png")}a(Ws,"exportSchedulePng");function Ha(t,r){document.getElementById("urppp-feature-toast")?.remove();let e=document.createElement("div");e.id="urppp-feature-toast",e.textContent=String(t||""),e.className=r?"error":"",document.documentElement.appendChild(e),requestAnimationFrame(()=>e.classList.add("open")),setTimeout(()=>{e.classList.remove("open"),setTimeout(()=>e.remove(),220)},r?4200:2400)}a(Ha,"showFeatureToast");let Ra=xp({document,window,ensureStyles:ws,loadData:yn,exportJson:js,exportIcs:Hs,exportPng:Ws,showToast:Ha,nativePageUrl:Fs,navigate:a(t=>{location.href=t},"navigate"),logger:console});function Gs(t,r,e,o){return Ra.run(t,r,e,o)}a(Gs,"runScheduleExport");function Js(t){return Ra.createMenu(t)}a(Js,"createScheduleExportMenu");function Vs(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(Vs,"disposeNativePdfCapture");function Ys(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},r=document.getElementById("mycoursetable"),e=document.getElementById("page-content-template");t.host=!!r,t.pageSource=!!e,t.hostCards=r?r.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=r?!!r.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=r?!!r.querySelector("#courseTableBody"):!1,t.hostTableId=r&&r.querySelector("table")?r.querySelector("table").id:"none";try{let s=Fp(r);t.stage="ok",t.stageCards=s.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=s.target.querySelector("table")?s.target.querySelector("table").id:"none",Vs(s)}catch(s){t.stage="failed",t.stageError=s&&s.message||String(s)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(Ys,"bindNativePdfDiagnose");function Qs(t){return t?(Ys(),async()=>{let r=document.getElementById("urppp-settings-panel"),e=document.getElementById("urppp-settings-mask");r&&r.classList.contains("open")&&r.classList.remove("open"),e&&e.classList.contains("open")&&e.classList.remove("open");try{await Op(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:pe})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Ha("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(Qs,"pagePdfExportHandler");function Ua(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Ua,"isPersonalSchedulePage");function Xs(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(Xs,"isScoreQueryPage");function Wa(){if(!Ua())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),r=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),e=Array.from((r||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(e.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let s=e.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),i=Js({source:"native",pdfHandler:Qs(s)});if(i.id="urppp-native-schedule-export",s&&s.parentElement){s.__urpppNativeExportState||(s.__urpppNativeExportState={display:s.style.getPropertyValue("display"),displayPriority:s.style.getPropertyPriority("display"),ariaHidden:s.getAttribute("aria-hidden"),tabIndex:s.getAttribute("tabindex")}),s.setAttribute("data-urppp-native-export-source","1"),s.style.setProperty("display","none","important"),s.setAttribute("aria-hidden","true"),s.setAttribute("tabindex","-1"),s.parentElement.insertBefore(i,s.nextSibling);return}if(r)r.appendChild(i);else if(t)t.appendChild(i);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let h=document.createElement("div");h.className="urppp-export-fallback",h.appendChild(i),l.prepend(h)}}}a(Wa,"patchNativeScheduleExport");let Ur=null,Oe=0;function Ga(){clearTimeout(Oe),Oe=0,Ur&&Ur.observer.disconnect(),Ur=null}a(Ga,"disconnectNativeScheduleExportObserver");function Ks(){if(!Ua()){Ga();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ur&&Ur.root===t&&t.isConnected)return;Ga();let r=new MutationObserver(()=>{clearTimeout(Oe),Oe=setTimeout(()=>Wa(),80)});r.observe(t,{childList:!0,subtree:!0}),Ur={root:t,observer:r}}a(Ks,"bindNativeScheduleExportObserver");function Sn(t,r,e){e===null?t.removeAttribute(r):t.setAttribute(r,e)}a(Sn,"restoreOptionalAttribute");function Zs(t=document){let r=t&&t.querySelectorAll?t:document,e=r.matches?.("#urppp-native-schedule-export")?r:r.querySelector("#urppp-native-schedule-export");if(e){let o=e.closest(".urppp-export-fallback");e.remove(),o&&!o.children.length&&o.remove()}r.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let s=o.__urpppNativeExportState;s&&(s.display?o.style.setProperty("display",s.display,s.displayPriority):o.style.removeProperty("display"),Sn(o,"aria-hidden",s.ariaHidden),Sn(o,"tabindex",s.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),r.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(Zs,"removeNativeScheduleExport");let _n=ki({deps:{styles:Xp,loadScores:Dn,loadProfile:En,scoreToNumber:Rr,scoreToGpa:Hr,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),tl=Qn([We({id:"schedule-export",matches:a(t=>Ua(t.location),"matches"),mount:a(()=>{Wa(),Ks()},"mount"),unmount:a(t=>{Ga(),Zs(t?.lifecycleKey)},"unmount")}),We({id:"score-analysis",matches:a(t=>Xs(t.location),"matches"),mount:a(()=>{try{_n.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{_n.unmount()}catch{}},"unmount")})]);function He(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return tl.refresh({document,location,window,lifecycleKey:t})}a(He,"refreshRouteFeatures");function rl(t){Ra.bindHosts(t)}a(rl,"bindScheduleExportHosts");function le(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(le,"normalizeProfileValue");function Re(t,r){if(!t||!t.querySelectorAll)return"";let e=(r||[]).map(s=>le(s).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let s=0;s<o.length;s++){let i=o[s],l=i.querySelector(".profile-info-name, th, label"),h=i.querySelector(".profile-info-value, td:last-child");if(!l||!h||l===h)continue;let g=le(l.textContent).replace(/[：:]/g,"");if(!e.some(M=>g===M||g.endsWith(M)))continue;let E=le(h.textContent);if(E&&E!=="—"&&E!=="-")return E}return""}a(Re,"readLabeledProfileValue");function Wr(t){return le(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Wr,"cleanMajorPlanName");function el(t){let r={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(e=>{let o=(e.innerText||e.textContent||"").trim(),s=le(o);if(/主修必修GPA/.test(s)){let i=s.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||s.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(i){let l=Number(i[1]),h=Number(r.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!r.majorGpa||h===0||l>0)&&(r.majorGpa=i[1])}}if(/主修为|培养方案/.test(s)){let i=s.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||s.match(/^(.{2,60}?)\s*主修为/)||s.match(/主修为\s*(.{2,60})$/),l=Wr(i&&i[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let h=/培养方案|教学计划/.test(l);(!r.majorPlan||h)&&(r.majorPlan=l)}}}),r}a(el,"extractAcademicOverview");async function En(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let e=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(e){let i=e.querySelector(".urppp-user-name-value"),l=i&&i.__urpppOriginalText;l&&(t.name=String(l).trim());let h=(e.innerText||e.textContent||"").replace(/\s+/g," ").trim(),g=t.name?null:h.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!g){let E=e.cloneNode(!0);E.querySelectorAll("small, i, img, b, .badge").forEach(j=>j.remove());let M=(E.textContent||"").replace(/\s+/g," ").trim();M=M.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),g=M.match(/([\u4e00-\u9fa5·]{2,12})/)}g&&g[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(g[1])&&(t.name=g[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let s=el(document);t.majorPlan=s.majorPlan,t.majorGpa=s.majorGpa}catch{}try{let e=await Jt("/student/rollManagement/rollInfo/index"),o=Fe(e),s=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Re(o,["姓名"]),!t.name)){let g=s.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);g&&(t.name=g[1].trim())}let i=Re(o,["主修方案名称"]),l=Re(o,["专业"]);t.studentId=Re(o,["学号"]),i?t.majorPlan=Wr(i):!t.majorPlan&&l&&(t.majorPlan=Wr(l));let h=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(h&&h.getAttribute("src")&&!t.avatar){let g=h.getAttribute("src");t.avatar=/^https?:/i.test(g)?g:Ba(g)}}catch{}let r=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(r)||r<=0||r>5)&&(t.majorGpa="—"),t}a(En,"loadProfile");let Cn=["周日","周一","周二","周三","周四","周五","周六"];function Ja(t){let r=[],e=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!e)return r;e.querySelectorAll("td[id]").forEach(s=>{let i=String(s.id||"").match(/^(\d+)_(\d+)$/);if(!i)return;let l=parseInt(i[1],10),h=parseInt(i[2],10),g=l===7?0:l,E=s.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),M=E.length?E:[];if(!M.length&&(s.textContent||"").trim()){let j=(s.textContent||"").replace(/\s+/g," ").trim();j&&r.push({name:j.slice(0,40),teacher:"",place:"",week:"",day:g,section:h});return}M.forEach(j=>{let z=Array.from(j.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),F=(j.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(j.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",D=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=z.find(K=>/周/.test(K))||"",B=String(F).replace(/_\d+\s*$/,"").trim();!B||B.length<2||r.push({name:B,teacher:String(D).trim(),place:String(J||"").trim(),week:String(R).trim(),day:g,section:h})})});let o=new Set;return r.filter(s=>{let i=[s.day,s.section,s.name,s.place].join("|");return o.has(i)?!1:(o.add(i),!0)})}a(Ja,"parseScheduleFromDoc");let Pn="urppp_term_week_v1";function Gr(t){let r=Number(t)||0;if(r<1||r>30)return 0;nt._termWeek=r,nt._termWeekResolved=!0;try{GM_setValue(Pn,r)}catch{}return r}a(Gr,"rememberTermWeek");function ce(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(Pn,0))||0;if(t>=1&&t<=30)return Gr(t)}catch{}return 0}a(ce,"readRememberedTermWeek");function de(t){let r=String(t||"").replace(/\s+/g," ");if(!r)return 0;let e=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<e.length;o++){let s=r.match(e[o]);if(s){let i=parseInt(s[1],10);if(i>=1&&i<=30)return i}}return 0}a(de,"extractTermWeekFromText");function _r(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let h=t[l],g=de(h.innerText||h.textContent||"")||de(h.innerHTML||"");if(g)return Gr(g)}let r=document.documentElement&&document.documentElement.innerHTML||"",e=de(r);if(e)return Gr(e);let o=document.body&&document.body.innerText||"",s=de(o);if(s)return Gr(s);let i=ce();if(i)return i}catch{}return 0}a(_r,"getCurrentWeekNumber");let Jr=null;function al(){let t=new Date,r=a(e=>String(e).padStart(2,"0"),"p");return`${t.getFullYear()}-${r(t.getMonth()+1)}-${r(t.getDate())}`}a(al,"calTodayStr");function ol(t,r){let e=new Date(`${t}T00:00:00`);e.setDate(e.getDate()+r);let o=a(s=>String(s).padStart(2,"0"),"p");return`${e.getFullYear()}-${o(e.getMonth()+1)}-${o(e.getDate())}`}a(ol,"calAddDays");function ue(t){if(Jr)return Jr;let r=t||al();return r>="2027-02-06"&&r<=ol("2027-02-06",6)?"springfestival":r>="2027-01-18"&&r<"2027-03-01"?"winter":r>="2027-07-04"&&r<"2027-08-31"||r>="2026-07-04"&&r<"2026-08-31"?"summer":"term"}a(ue,"calVacation");function nl(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(nl,"festiveDecorHtml");function zn(){let t=typeof document<"u"?document:null;if(!t)return;let r=ue()==="springfestival",e=t.getElementById("urppp-festive-decor");r&&!e?t.documentElement.insertAdjacentHTML("beforeend",nl()):!r&&e&&e.remove()}a(zn,"syncFestiveDecor");function Ln(t){Jr=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Jr&&Jr!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{zn()}catch{}try{typeof Yr=="function"&&Yr()}catch{}return Jr}a(Ln,"setCalendarPhase");function pl(){return ue()}a(pl,"getCalendarPhase");function qn(){if(ue()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=_r()||ce()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(qn,"getViewWeekNumber");async function il(){let t=_r();if(t>=1)return t;try{let r=await Jt("/index");if(t=de(r),t)return Gr(t)}catch{}try{let r=new Date,e=r.getFullYear()+"-"+String(r.getMonth()+1).padStart(2,"0")+"-"+String(r.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(e),s=await Jt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),i=JSON.parse(s),l=Number(i&&i.jxzc);if(l>=1&&l<=30)return Gr(l)}catch{}return ce()||0}a(il,"ensureTermWeekResolved");function sl(t){let r=_r()||20;return(t||[]).forEach(e=>{let o=String(e.classWeek||"");o.length>r&&(r=o.length);let s=String(e.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);s&&(r=Math.max(r,parseInt(s[2],10)||0));let i=String(e.week||"").match(/\d{1,2}/g);i&&i.forEach(l=>{r=Math.max(r,parseInt(l,10)||0)})}),Math.min(Math.max(r,1),30)}a(sl,"inferMaxWeek");function Tn(t,r){if(!r||!t)return!1;let e=String(t);return e.length>=r?e.charAt(r-1)==="1":!1}a(Tn,"weekBitActive");let $n=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function Mn(t){let r=0,e=String(t||"");for(let o=0;o<e.length;o++)r=r*31+e.charCodeAt(o)>>>0;return $n[r%$n.length]}a(Mn,"courseColor");function ll(t){let r=[],e=_r();(t&&t.xkxx||[]).forEach(i=>{Object.keys(i||{}).forEach(l=>{let h=i[l];if(!h)return;let g=h.courseName||h.englishCourseName||l,E=h.attendClassTeacher||"";(h.timeAndPlaceList||[]).forEach(j=>{let z=Number(j.classDay)||0,F=z===7?0:z,J=Number(j.classSessions)||1,D=Math.max(1,Number(j.continuingSession)||1),R=[j.campusName,j.teachingBuildingName,j.classroomName].filter(Boolean).join(""),B=j.weekDescription||h.skzcs||"",K=Tn(j.classWeek,e)||e&&B.indexOf(String(e))>=0;r.push({name:String(g).trim(),teacher:String(E).trim(),place:String(R).trim(),week:String(B).trim(),classWeek:String(j.classWeek||""),day:F,section:J,span:D,thisWeek:!!K,color:Mn(g)})})})});let s=new Set;return r.filter(i=>{let l=[i.day,i.section,i.span,i.name,i.place,i.week].join("|");return s.has(l)?!1:(s.add(l),!0)})}a(ll,"parseScheduleFromJson");async function cl(){try{let t=await Jt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),r=[],e=null;try{e=JSON.parse(t);let s=Number(e&&(e.jxzc||e.zc||e.currentWeek));s>=1&&s<=30&&(nt._termWeek=Math.max(nt._termWeek||0,s),nt.weekLocked||(nt.viewWeek=nt._termWeek)),r=ll(e)}catch{r=Ja(Fe(t))}r.length||(r=Ja(document));let o=e?wn(e,Zr(e),"clean"):null;return{courses:r,exportData:o,rawOk:r.length>0,error:r.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let r=Ja(document);if(r.length)return{courses:r,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(cl,"loadSchedule");function dl(t,r){let e=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+r+`[^"']*)["']`,"i"),s=e.match(o);if(s&&s[1])return s[1];let i=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+r+")","i"),l=e.match(i);return l?l[1]:""}a(dl,"extractScoreCallback");function ul(t){let r=[];return(t&&t.lnList||[]).forEach(o=>{let s=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",i=[];(o.cjList||[]).forEach(l=>{let h=l.courseName||l.englishCourseName||"";if(!h)return;let g=l.cj!=null&&l.cj!==""?String(l.cj):"";!g&&l.courseScore!=null&&(g=String(l.courseScore)),!g&&l.gradeName&&(g=String(l.gradeName)),!g&&l.zscj!=null&&(g=String(l.zscj));let E=l.courseAttributeName||l.xkcsxmc||"",M=parseFloat(l.credit)||0,j=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",F=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ir(g)||ir(l.gradeName)||F!=null&&F<0,D=J?"未评估":g;i.push({code:j,seq:String(z||""),name:h,attr:E,credit:M,score:D,unevaluated:J,required:dn(E),officialGpa:Ne(F)?F:null,evalUrl:""})}),i.length&&r.push({title:String(s).slice(0,100),courses:i,summary:er(i),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),r}a(ul,"parseScoreJson");async function In(t,r){let e=await Jt(t),o=Nn(Fe(e));if(o.length)return o;let s=dl(e,r);if(!s)return[];let i=await Jt(s);try{let l=JSON.parse(i);o=ul(l).map(h=>(h.summary=er(h.courses),h))}catch{o=Nn(Fe(i))}return o}a(In,"loadScoreByIndex");function Nn(t){let r=[];return t.querySelectorAll("table").forEach(e=>{let o=Array.from(e.tHead&&e.tHead.rows[0]?e.tHead.rows[0].cells:e.rows[0]&&e.rows[0].cells||[]).map(M=>(M.textContent||"").replace(/\s+/g,""));if(!o.length)return;let s=o.join("|");if(!/课程名/.test(s)||!/成绩/.test(s))return;let i={code:o.findIndex(M=>M==="课程号"),name:o.findIndex(M=>M==="课程名"),attr:o.findIndex(M=>/课程属性|属性/.test(M)),credit:o.findIndex(M=>M==="学分"),score:o.findIndex(M=>M==="成绩")};if(i.name<0||i.score<0)return;let l="成绩",h=e.previousElementSibling;for(let M=0;M<8&&h;M++,h=h.previousElementSibling)if(/^H[1-4]$/.test(h.tagName)||h.classList&&h.classList.contains("header")){l=(h.textContent||"").replace(/\s+/g," ").trim();break}let g=[],E=e.tBodies.length?e.tBodies[0].rows:Array.from(e.rows).slice(1);Array.from(E).forEach(M=>{let j=Array.from(M.cells||M.querySelectorAll("td"));if(j.length<4)return;let z=a(B=>B>=0&&j[B]?(j[B].textContent||"").replace(/\s+/g," ").trim():"","get"),F=z(i.name),J=z(i.score);if(!F||!J||/课程名|序号/.test(F))return;let D=z(i.attr),R=ir(J);g.push({code:z(i.code),name:F,attr:D,credit:parseFloat(z(i.credit))||0,score:R?"未评估":J,unevaluated:R,required:dn(D),officialGpa:null,evalUrl:""})}),g.length&&r.push({title:l.slice(0,100),courses:g,summary:er(g)})}),r}a(Nn,"parseScoreTables");function me(t){return Wr(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(me,"schemePlanName");function Bn(t,r){if(!t||!t.length)return 0;let e=Wr(r),o=t.findIndex(l=>{let h=me(l);return/培养方案/.test(h)&&!/微专业|辅修|双学位/.test(h)});if(o>=0&&(!e||me(t[o]).includes(e.slice(0,4)))||e&&(o=t.findIndex(l=>{let h=me(l);return h.includes(e.replace(/培养方案.*/,"培养方案"))||e.includes(h.slice(0,4))||h.includes(e.slice(0,4))}),o>=0))return o;let s=0,i=-1;return t.forEach((l,h)=>{if(/微专业|辅修/.test(me(l)))return;let g=(l.courses||[]).length;g>i&&(i=g,s=h)}),s}a(Bn,"pickMajorSchemeIndex");async function ml(){let t={};try{let r=await Jt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),e;try{e=JSON.parse(r)}catch{e=null}(e&&e.data&&e.data.records||[]).forEach(s=>{let i=String(s.KCH||"").trim();if(!i)return;let l=String(s.SFPG)==="1",h=String(s.KTID||"").trim();if(!t[i]){t[i]={ktid:h,kxh:String(s.KXH||""),kcm:s.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&h?"/student/teachingEvaluation/newEvaluation/evaluation/"+h:"/student/teachingEvaluation/newEvaluation/index"};return}t[i].total+=1,l||(t[i].pending+=1,t[i].done=!1,h&&(t[i].ktid=h,t[i].url="/student/teachingEvaluation/newEvaluation/evaluation/"+h))}),Object.keys(t).forEach(s=>{let i=t[s];i.done=!(i.pending>0)})}catch(r){console.warn("[URP++] evaluation map",r)}return t}a(ml,"loadEvaluationMap");function bl(t){if(!t)return!1;if(t.officialGpa!=null&&Ne(t.officialGpa))return!0;let r=t.score;return r==null||r===""||ir(r)?!1:Rr(r)!=null||Hr(r)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(r))}a(bl,"hasDisplayableScore");function hl(t,r){if(!t||!r)return t;let e=a(o=>(o||[]).forEach(s=>{if(!s||!s.code)return;let i=r[s.code];if(i){if(bl(s)){s.unevaluated=!1,i.done?s.evalUrl=s.evalUrl||"":s.evalUrl=i.url||"/student/teachingEvaluation/newEvaluation/index";return}i.done||(s.unevaluated=!0,s.evalUrl=i.url||"/student/teachingEvaluation/newEvaluation/index",(!s.score||s.score===""||ir(s.score))&&(s.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>e(o.courses)),(t.schemes||[]).forEach(o=>e(o.courses)),t}a(hl,"attachEvaluationLinks");function Fn(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=er(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(r=>(r.summary=er(r.courses),r)),t)}a(Fn,"refreshScoreSummaries");async function gl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let r=await ml();return hl(t,r),t.evalMap=r,t.evaluationReady=!0,Fn(t)}finally{t.evaluationLoading=!1}}a(gl,"enrichScoresWithEvaluation");function fl(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,r=nt.profile&&nt.profile.majorPlan,e=Bn(t,r);nt.scores.majorIdx=e,nt._schemeUserSelected||(nt.activeSchemeIdx=e,nt._schemeInited=!0);let o=t[e];if(!o||!nt.profile)return;let s=me(o),i=Wr(nt.profile.majorPlan);/培养方案|教学计划/.test(s)&&(!/培养方案|教学计划/.test(i)||i==="主修方案")&&(nt.profile.majorPlan=s);let l=o.summary||{},h=Number(l.requiredCredit),g=Number(l.requiredGpa),E=Number(nt.profile.majorGpa);h>0&&Number.isFinite(g)&&g>=0&&g<=5&&(!Number.isFinite(E)||E<=0)&&(nt.profile.majorGpa=String(Ar(g)))}a(fl,"reconcileProfileAndScores");let Vr=null;async function Dn(t){return t&&(Vr=null),Vr&&!Vr.error||(Vr=await xl()),Vr}a(Dn,"loadScores");async function xl(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[r,e]=await Promise.all([In("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),In("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];r.forEach(s=>s.courses.forEach(i=>{o.push(Object.assign({term:s.title},i))})),t.passing=[{title:"全部及格成绩",courses:o,summary:er(o),groups:r}],t.schemes=e,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:er(o)}]),Fn(t),t.majorIdx=Bn(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(r){t.error=String(r&&r.message||r)}return t}a(xl,"loadScoresImpl");function Er(t){if(!t)return[];let r=String(t).trim();if(!r)return[];r=r.replace(/^['"]|['"]$/g,"");try{return JSON.parse(r)}catch{}try{return JSON.parse(r.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(Er,"parseJsonArrayLoose");function jn(t,r){let e=t.indexOf(r);if(e<0)return"";let o=t.indexOf("[",e);if(o<0)return"";let s=0;for(let i=o;i<t.length&&i<o+3e5;i++){let l=t[i];if(l==="[")s++;else if(l==="]"&&(s--,s===0))return t.slice(o,i+1)}return""}a(jn,"extractBalancedArray");async function yl(){let t=await Jt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let r=[],e=[];try{let i=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(i&&(r=Er(i)),l&&(e=Er(l)),!r.length){let h=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(r=Er(h[1]))}if(!e.length){let h=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(e=Er(h[1]))}if(!e.length){let h=jn(t,"teachingBuildingName");h&&(e=Er(h))}if(!r.length){let h=jn(t,"campusName");h&&(r=Er(h))}}catch(i){console.warn("[URP++] classroom json parse",i)}if(!e.length){let i=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];r=i;let l=[];for(let h of i)try{let g=await Jt("/student/teachingResources/classroomCurriculum/"+h.campusNumber+"/teachingBuildingJson");Er(g).forEach(M=>{l.push({id:{campusNumber:h.campusNumber,teachingBuildingNumber:String(M.id&&M.id.teachingBuildingNumber||M.teachingBuildingNumber||"")},teachingBuildingName:M.teachingBuildingName||M.name||""})})}catch(g){console.warn("[URP++] building json",h.campusNumber,g)}e=l}r.length||(r=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=r.map(i=>({campus:i.campusName||i.campusNumber,campusNumber:String(i.campusNumber||i.id&&i.id.campusNumber||""),buildings:[]}));e.forEach(i=>{let l=String(i.id&&i.id.campusNumber||i.campusNumber||""),h=String(i.id&&i.id.teachingBuildingNumber||i.teachingBuildingNumber||""),g=i.teachingBuildingName||i.name||h;if(!l||!h||!g)return;let E=o.find(j=>j.campusNumber===l);E||(E={campus:l,campusNumber:l,buildings:[]},o.push(E));let M="/student/teachingResources/classroomUseStatus/"+l+"/"+h+"/"+encodeURI(encodeURI(E.campus||l))+"/"+encodeURI(encodeURI(g));E.buildings.push({name:g,path:M,campusNumber:l,buildingNumber:h})});let s=o.filter(i=>i.buildings.length);if(!s.length)throw new Error("未解析到教学楼，请刷新后重试");return s}a(yl,"loadClassroomCatalog");function be(t){let r=String(t&&t.occupancymoduleId||""),e={"06":"有课","07":"考试",14:"实验",room:"借用"};if(e[r])return e[r];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(be,"occupancyTypeLabel");function vl(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let r=String(t.remark).trim();if(r)return r}return be(t)}a(vl,"occupancyReason");async function wl(t,r,e,o){let s=new URLSearchParams({planNumber:String(t||""),campusNumber:String(r||""),teachingBuildingNumber:String(e||""),classroomNumber:String(o||"")}),i=await Jt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+s.toString());try{let l=JSON.parse(i);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(h=>h&&typeof h=="object"&&(h.kcm||h.id&&h.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(wl,"fetchClassroomCurriculum");function kl(t,r,e){let o=t||[],s=Number(r.xq)||0,i=Number(r.start)||0,l=Number(e)||0,h=[];return o.forEach(g=>{let E=g.id||{},M=Number(E.skxq!=null?E.skxq:g.skxq)||0,j=Number(E.skjc!=null?E.skjc:g.skjc)||0,z=Math.max(1,Number(g.cxjc)||1),F=E.skzc||g.skzc||"";s&&M&&s!==M||i&&(i<j||i>=j+z)||l&&F&&!Na(F,l)||h.push(g)}),h.length?(h.sort((g,E)=>{let M=Na(g.id&&g.id.skzc||g.skzc,l)?0:1,j=Na(E.id&&E.id.skzc||E.skzc,l)?0:1;return M-j}),h[0]):null}a(kl,"matchCurriculumCourse");async function Al(t,r,e){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(r.campusNumber||""),s=String(r.buildingNumber||""),i=e||t.planNumber||"";if(!o||!s||!i)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(F=>F.busy)),h={},g=a(async z=>{if(h[z])return h[z];try{h[z]=await wl(i,o,s,z)}catch{h[z]=[]}return h[z]},"queue"),E=4,M=0,j=new Array(Math.min(E,Math.max(l.length,1))).fill(0).map(async()=>{for(;M<l.length;){let z=M++,F=l[z],J=await g(F.name);(F.slots||[]).forEach(D=>{if(!D.busy)return;let R={xq:D.detail&&D.detail.xq||D.xq||0,start:D.section,week:t.jxzc};D.detail&&D.detail.xq!=null&&(R.xq=D.detail.xq);let B=kl(J,R,t.jxzc);if(B&&B.kcm){let K=String(B.kcm).trim();D.contentName=K,D.reason=K,D.displayChar=Be(K),D.detail&&(D.detail.contentName=K,D.detail.reason=K,D.detail.teacher=B.jsm||"",D.detail.weeks=B.zcsm||"",D.detail.courseNo=B.id&&B.id.kch||"",D.detail.typeLabel=be({occupancymoduleId:D.module}))}else D.displayChar=Be(D.reason||"占用"),D.detail&&(D.detail.typeLabel=be({occupancymoduleId:D.module}))})}});return await Promise.all(j),t}a(Al,"enrichOccupancyWithCurriculum");function Sl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(Sl,"occupancyKindClass");async function _l(t){let r="",e="",o="",s="";if(t&&typeof t=="object")r=String(t.campusNumber||""),e=String(t.buildingNumber||""),o=t.name||"",s=t.path||"";else{s=String(t||"");let B=s.match(/classroomUseStatus\/(\d+)\/(\d+)\//);B&&(r=B[1],e=B[2])}if(!r||!e)throw new Error("缺少校区/楼栋编号");let i=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=El(On(new Date,i)),h="xqh="+encodeURIComponent(r)+"&jxlh="+encodeURIComponent(e)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),g=await new Promise((B,K)=>{let ut=Ba("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:h,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?B(vt.responseText||""):K(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:h}).then(vt=>vt.text()).then(B).catch(K)}),E;try{E=JSON.parse(g)}catch{throw new Error("jasInfo 非 JSON")}let M=(E.classrooms||[]).map(B=>{let K=B.classroomName||B.id&&B.id.classroomNumber||"",ut=B.placeNum||"",vt=B.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:K,seats:ut,type:vt,slots:Et,map:{}}}),j={};M.forEach(B=>{j[B.name]=B}),(E.classroomTime||[]).forEach(B=>{let K=B.id||{},ut=K.classroomNumber||"",vt=Number(K.sessionstart)||1,Et=Math.max(1,Number(B.continuingsession)||1),Lt=j[ut];if(!Lt)return;let qt=be(B),Ot=vl(B);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let $t=Lt.slots.find(ar=>ar.section===Ht);$t&&($t.busy=!0,$t.kind=B.timestatenumber||B.occupancymoduleId||"",$t.module=B.occupancymoduleId||"",$t.reason=Ot,$t.typeLabel=qt,$t.displayChar=Be(Ot),$t.xq=K.xq,$t.weekBitmap=K.week||"",$t.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:K.week||"",xq:K.xq||"",state:B.timestatenumber||"",module:B.occupancymoduleId||""})}});let z="";try{let B=E.jhZxjxjhb;typeof B=="string"&&/\d{4}-\d{4}-\d-\d/.test(B)?z=B:B&&typeof B=="object"&&(z=String(B.zxjxjhh||B.jhxnxq||B.executiveEducationPlanNumber||B.planNumber||""))}catch{}if(!z&&E.classrooms&&E.classrooms[0]&&E.classrooms[0].id&&(z=E.classrooms[0].id.executiveEducationPlanNumber||""),E.jxzc!=null&&Number(E.jxzc)>=1){let B=Number(E.jxzc);nt._termWeek=Math.max(nt._termWeek||0,B),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let F=["日","一","二","三","四","五","六"],J=Cl(E.date||l)||On(new Date,i),D=E.week!=null?Number(E.week):J.getDay(),R=i===1?"明天":i===2?"后天":"今天";return{rooms:M,dateLabel:(E.date||l)+"（周"+(F[D]||D)+" · "+R+"）",jxzc:E.jxzc,planNumber:z,week:E.week!=null?E.week:D,searchDate:E.date||l,dateOffset:i}}a(_l,"loadBuildingOccupancy");function On(t,r){let e=new Date(t.getFullYear(),t.getMonth(),t.getDate());return e.setDate(e.getDate()+(Number(r)||0)),e}a(On,"addDays");function El(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(El,"formatLocalDate");function Cl(t){let r=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return r?new Date(Number(r[1]),Number(r[2])-1,Number(r[3])):null}a(Cl,"parseLocalDate");let Hn={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function Rn(t){return Hn[t]||Hn.more}a(Rn,"ico");let nt=Zp();function Pl(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=Yp,(document.head||document.documentElement).appendChild(t)}a(Pl,"ensureStyle");let zl=ea({deps:{scoreToNumber:Rr,scoreToGpa:Hr}}),{metricHtml:Ll,occupancyHtml:ql,render:Yr,renderScheduleBoard:Ec,roomPickerHtml:Tl,scheduleRender:$l}=di({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:Cn,analyzeScores:a(t=>zl.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Vt,bandsChartSvg:oa,bindUI:a(t=>Il(t),"bindUI"),classifyPrivacyLabel:De,courseColor:Mn,ensureRoot:a(()=>Wn(),"ensureRoot"),escapeHtml:at,firstContentChar:Be,getViewWeekNumber:qn,ico:Rn,isCleanAnalysisDirect:sa,occupancyKindClass:Sl,occupancyTypeLabel:be,personalizedProfile:Ns,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Rr,summarizeCourses:er,trendChartSvg:aa,weekBitActive:Tn,calVacation:ue,setCalendarPhase:Ln}}),{ensureRoomCatalogLoaded:Un,loadAll:Ml}=ri({state:nt,deps:{ensureTermWeekResolved:il,enrichScoresWithEvaluation:gl,getCurrentWeekNumber:_r,loadClassroomCatalog:yl,loadProfile:En,loadSchedule:cl,loadScores:Dn,readRememberedTermWeek:ce,reconcileProfileAndScores:fl,render:Yr,scheduleRender:$l}}),{bindUI:Il,closeModal:Nl,getRoomHost:Cc,openModal:Pc,openRoomModal:zc,openScoreModal:Lc,showBuilding:qc}=ui({state:nt,deps:{DAY_NAMES:Cn,applyPersonalDisplay:Vt,bindScheduleExportHosts:rl,closeCleanMode:a(()=>Fl(),"closeCleanMode"),ensureRoomCatalogLoaded:Un,enrichOccupancyWithCurriculum:Al,ensureRoot:a(()=>Wn(),"ensureRoot"),escapeHtml:at,fetchText:Jt,getCurrentWeekNumber:_r,getViewWeekNumber:qn,inferMaxWeek:sl,isUnevaluatedScore:ir,isValidOfficialGpa:Ne,loadBuildingOccupancy:_l,metricHtml:Ll,occupancyHtml:ql,render:Yr,rootEl:a(()=>Dl(),"rootEl"),roomPickerHtml:Tl,scoreToGpa:Hr,scoreToNumber:Rr,summarizeCourses:er,summarizeCoursesPreferOfficial:er}}),{cleanModeApi:Bl,closeCleanMode:Fl,ensureRoot:Wn,injectCleanEntry:Tc,openCleanMode:$c,rootEl:Dl}=mi({state:nt,deps:{CLEAN_FLAG:vs,applySkinAttr:rr,closeModal:Nl,ensureRoomCatalogLoaded:Un,ensureStyle:Pl,getCurrentWeekNumber:_r,getSkin:Zt,handleThemeDotClick:ct,ico:Rn,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,r,e)=>{try{window.__urpppSetDrawerOpen?.(t,r,e)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:fo,loadAll:Ml,openSettingsPanel:Jo,readRememberedTermWeek:ce,refreshCleanPersonalDisplay:Da,render:Yr,scoreToGpa:Hr,summarizeCourses:er,syncNavbarThemeUI:ft,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=Bl;function Va(){if(!document.body){setTimeout(Va,10);return}if(yo(),Wt(Qt()),document.addEventListener("focusin",r=>{let e=r.target;if(!e||!e.matches||!e.matches(".chosen-search input"))return;let o=[],s=e.parentElement;for(;s;){let i=s.scrollTop,l=s.scrollLeft;(i||l||s.scrollHeight>s.clientHeight||s.scrollWidth>s.clientWidth)&&o.push({el:s,top:i,left:l}),s=s.parentElement}requestAnimationFrame(()=>{o.forEach(i=>{i.el.scrollTop=i.top,i.el.scrollLeft=i.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))_o();else{Wi();try{un()}catch{}try{He()}catch(r){console.warn("[URP++] route feature refresh",r)}try{Vt(document)}catch{}try{zn()}catch{}[350,900,1800].forEach(r=>setTimeout(()=>{try{He()}catch{}try{Vt(document)}catch{}},r));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(r=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},r));try{ia()&&fo()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(Va,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(kr,50)}),window.addEventListener("load",()=>{kr(),Or(),setTimeout(kr,100),setTimeout(kr,400)}),document.addEventListener("click",r=>{r.target&&r.target.closest&&r.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Or,0),setTimeout(Or,50),setTimeout(Or,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Or,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function Gn(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,r=a(()=>{try{let s=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),i=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));s&&!i&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){kr(),cn(),st(),kr();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(i=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},i)),ya(),Ro(),Uo(),Io(),Wo(),Ho(),Bo(),document.querySelectorAll(".page-content, #page-content-template").forEach(i=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);i.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),i.style.setProperty("box-sizing","border-box","important")}),ze(),Te(),Nr(),setTimeout(Nr,300),setTimeout(Nr,1e3),zo(),mr(),oe(),To(),setTimeout(oe,300),ne(),setTimeout(()=>ne(),500),Pe(),qo();try{He()}catch{}try{Vt(document)}catch{}setTimeout(()=>{try{He()}catch{}try{Vt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",r),window.addEventListener("hashchange",r);let e=history.pushState,o=history.replaceState;history.pushState=function(...s){let i=e.apply(this,s);return r(),i},history.replaceState=function(...s){let i=o.apply(this,s);return r(),i}}a(Gn,"watchRouteChanges");let Qr=typeof unsafeWindow<"u"?unsafeWindow:window;Qr.__urpppDebug=Qr.__urpppDebug||{},Qr.__urpppDebug.setCalendarPhase=t=>Ln(t),Qr.__urpppDebug.getCalendarPhase=()=>pl(),Qr.__urpppDebug.calVacation=t=>ue(t),Qr.urppp={version:p,showLogo(t){let r=document.querySelector("#urppp-brand .ub-logo");r&&r.classList.toggle("show",t)},theme:{apply:a(t=>{Wt(t)},"apply"),setAccent:Ei,getAccent:Yt,getCurrent:Qt,list:a(()=>Object.entries(Ct).map(([t,r])=>({name:t,displayName:r.name,current:t===Qt()})),"list")},update:{check:Ma,auto:$a,showToast:Ta},privacy:{get:yr,set(t){return ca(t),Vt(document),yr()},apply:a(()=>Vt(document),"apply"),identity:{get:qr,set(t){return bo(t),Vt(document),Da(),qr()}}},scheduleExport:{load:a(()=>yn("api"),"load"),run:a(t=>Gs(t,"api",null,null),"run"),patch:Wa,image:{theme:kn,build:a((t,r)=>An(t,r),"build")},jsonFormat:{get:Ee,set:go,validate:Pr,build(t,r){let e=Je(t);if(r)return Ye(e,Pr(r));let o=Ee();return o.enabled?Ye(e,o.mapping):Ve(e)},buildDefault(t){return Ve(Je(t))}}}};function Jn(){setTimeout(()=>{try{$a()}catch{}},1800)}a(Jn,"scheduleAutoUpdateCheck");try{yo()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Va(),Gn(),Jn()}):(Va(),Gn(),Jn())})();})();
