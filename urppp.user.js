...
半夜Vibe有点爽怎么回事。</p>`,"    </div>","  </div>","</div>"].join("")}a(Zp,"buildSettingsPanelHtml");var re="urppp_plugin_",Yc="1.0.0";function Eo({GM:n,doc:p,hostInfo:c,uiDeps:d}){let{getValue:u=a(()=>null,"getValue"),setValue:k=a(()=>{},"setValue"),xmlHttp:P,addStyle:A}=n||{},y=(typeof d=="function"?d:d&&d.openSubpanel)||null,S=new Map,g=new Map,v=new Map,q=[],C=null;function f(F,Y){let tt=v.get(F);tt&&tt.forEach(ft=>{try{ft(Y)}catch{}})}a(f,"emit");function h(F,Y){return v.has(F)||v.set(F,new Set),v.get(F).add(Y),()=>v.get(F).delete(Y)}a(h,"on");function w(F,Y){return u(`${re}${F}_${Y}`)}a(w,"storageGet");function x(F,Y,tt){k(`${re}${F}_${Y}`,tt)}a(x,"storageSet");function E(){return F=>({get:a(Y=>w(F,Y),"get"),set:a((Y,tt)=>x(F,Y,tt),"set"),remove:a(Y=>k(`${re}${F}_${Y}`,void 0),"remove")})}a(E,"storage");function L(F,Y={}){return new Promise((tt,ft)=>{if(typeof P!="function"){ft(new Error("GM_xmlhttpRequest 不可用（未授权跨域？）"));return}P({method:Y.method||"GET",url:F,headers:Y.headers||{},data:Y.data,timeout:Y.timeout||8e3,onload:a(ht=>ht.status>=200&&ht.status<300?tt(ht.responseText):ft(new Error(`HTTP ${ht.status}`)),"onload"),onerror:a(()=>ft(new Error("网络错误")),"onerror"),ontimeout:a(()=>ft(new Error("超时(8s)")),"ontimeout")})})}a(L,"request");async function $(F,Y){let tt=Array.isArray(F)?F:[F],ft=[];for(let ht=0;ht<tt.length;ht+=1){let Lt=tt[ht];Y&&Y({stage:"downloading",index:ht+1,total:tt.length,url:Lt});try{let vt=await L(Lt);return Y&&Y({stage:"downloaded",url:Lt,size:vt.length}),vt}catch(vt){ft.push(`源${ht+1}(${T(Lt)})失败: ${vt&&vt.message?vt.message:vt}`),Y&&Y({stage:"source_failed",index:ht+1,total:tt.length,error:vt&&vt.message?vt.message:vt})}}throw new Error("所有下载源失败 → "+ft.join(" ｜ "))}a($,"fetchWithFallback");function T(F){try{return new URL(F).host}catch{return F}}a(T,"shortHost");function j(F){let Y=String(F||"").match(/\/\/\s*==UserScript==[\s\S]*?\/\/\s*==\/UserScript==/);return Y?F.replace(Y[0],""):F}a(j,"stripMetadata");function I(F,Y){try{let tt=j(F),ft=["GM_getValue","GM_setValue","GM_xmlhttpRequest","GM_registerMenuCommand","GM_addStyle","unsafeWindow"],ht=[typeof GM_getValue=="function"?GM_getValue:void 0,typeof GM_setValue=="function"?GM_setValue:void 0,typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:void 0,typeof GM_registerMenuCommand=="function"?GM_registerMenuCommand:void 0,typeof GM_addStyle=="function"?GM_addStyle:void 0,typeof unsafeWindow<"u"?unsafeWindow:null];return new Function(...ft,tt)(...ht),!0}catch(tt){return console.warn("[URP++ plugin] 注入失败",Y,tt),!1}}a(I,"inject");function H(F,Y){let tt=g.get(F);return tt?(tt.enabled=!!Y,k(`${re}${F}_enabled`,tt.enabled),f(Y?"enabled":"disabled",F),!0):!1}a(H,"setEnabled");function G(F){let Y=g.get(F);return!!Y&&Y.enabled}a(G,"isEnabled");function U(F){if(!F||!F.id)return!1;if(S.has(F.id)&&S.get(F.id).__urpppRegistered)return!0;let Y=Object.assign({type:"plugin"},F);Y.__urpppRegistered=!0,S.set(F.id,Y);let tt=g.get(F.id)||{loaded:!1,enabled:!1,version:F.version||""};return tt.version=Y.version||tt.version,g.set(F.id,tt),f("registered",Y.id),!0}a(U,"register");function et(F){return S.get(F)||null}a(et,"get");function it(F){let Y=[];for(let tt of S.values())(!F||tt.type===F)&&Y.push(tt);return Y}a(it,"list");function bt(F){let Y=g.get(F);return!!Y&&Y.loaded}a(bt,"loaded");async function J(F,Y,tt){tt&&tt({stage:"start",id:F});let ft=Array.isArray(Y)?Y:Y?[Y]:rt(F),ht=await $(ft,tt);k(`${re}${F}_code`,ht),tt&&tt({stage:"injecting",id:F});let Lt=I(ht,F),vt=g.get(F)||{loaded:!1,enabled:!1,version:""};return vt.loaded=Lt,vt.enabled=Lt,vt.code=ht,vt.version=vt.version||Q(ht),g.set(F,vt),k(`${re}${F}_enabled`,Lt),f("loaded",F),Lt}a(J,"install");function Q(F){let Y=String(F||"").match(/@version\s+(\S+)/);return Y?Y[1]:""}a(Q,"detectVersion");async function ot(F,Y,tt){let ft=Array.isArray(Y)?Y:Y?[Y]:rt(F),ht=await $(ft,tt);k(`${re}${F}_code`,ht);let Lt=Q(ht),vt=g.get(F)||{loaded:!1,enabled:!1,version:""};return vt.version=Lt||vt.version,vt.code=ht,g.set(F,vt),f("updated",F),{ok:!0,version:Lt||vt.version}}a(ot,"update");function X(F){let Y=u(`${re}${F}_code`);if(!Y)return!1;let tt=g.get(F);if(tt&&tt.loaded)return!0;let ft=I(Y,F),ht=g.get(F)||{loaded:!1,enabled:!1,version:Q(Y)};return ht.loaded=ft,ht.enabled=ft&&u(`${re}${F}_enabled`)!==!1,ht.code=Y,g.set(F,ht),f("loaded",F),ft}a(X,"bootFromCache");function ct(F){let Y=S.get(F);return S.delete(F),g.delete(F),k(`${re}${F}_enabled`,!1),f("unregistered",F),!!Y}a(ct,"unregister");function rt(F){return F==="assist"?["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/plugins/urpppp.plugin.js","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/plugins/urpppp.plugin.js","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/plugins/urpppp.plugin.js"]:[]}a(rt,"pluginSource");let st={protocolVersion:Yc,register:U,unregister:ct,get:et,list:it,loaded:bt,isEnabled:G,enable:a((F,Y=!0)=>H(F,Y),"enable"),disable:a(F=>H(F,!1),"disable"),install:J,update:ot,bootFromCache:X,storage:a(()=>u&&{get:a(F=>u(F),"get"),set:a((F,Y)=>k(F,Y),"set")},"storage"),pluginStorage:a(F=>E()(F),"pluginStorage"),request:L,addStyle:a(F=>{try{A&&A(F)}catch{}},"addStyle"),log:a((...F)=>{console.log("[URP++ plugin]",...F)},"log"),on:h,emit:f,hostInfo:Object.assign({name:"SCU URP++"},c||{}),getSubpanel:a(()=>y,"getSubpanel")};try{window.__urpppPlugin=st}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppPlugin=st)}catch{}function xt(F){if(!F||!p||F.querySelector(".urppp-plugin-sec, .urpppp-entry-sec"))return;let Y=p.createElement("section");Y.className="urppp-set-sec urppp-plugin-sec",Y.id="urppp-plugin-sec",Y.innerHTML=`
    ...
    `,F.appendChild(Y);let tt=Y.querySelector("#urppp-plugin-status"),ft=Y.querySelector("#urppp-plugin-install"),ht=Y.querySelector("#urppp-plugin-store"),Lt=Y.querySelector("#urppp-plugin-panels"),vt=Y.querySelector("#urppp-plugin-tip");function Dt(){let zt=g.get("assist"),Nt=S.has("assist");zt&&zt.loaded||Nt?(tt.textContent=`辅助插件 v${zt&&zt.version?zt.version:et("assist")&&et("assist").version||""} 已装载`,tt.className="urppp-plugin-status ok",ft.textContent="重新装载",ft.dataset.state="loaded",vt.textContent="已装载。下方为扩展入口。"):(tt.textContent=C||"未装载",tt.className=C?"urppp-plugin-status err":"urppp-plugin-status",ft.textContent="装载辅助插件",ft.dataset.state="notloaded",vt.textContent=C?"装载失败，可就近重试或放回本地安装。下方为装载/商店入口。":"点击装载后，主插件会下载并注入辅助插件（登录助手/评教/会话保持/2FA），无需再单独安装。"),Lt.innerHTML="";let Zt=Pt();if(Zt&&Object.keys(Zt).length){let Fe=p.createElement("div");Fe.className="urppp-plugin-sub",Object.keys(Zt).forEach(ge=>{let Xt=p.createElement("button");Xt.type="button",Xt.className="urppp-set-btn ghost",Xt.textContent=Zt[ge].label||ge,Xt.addEventListener("click",()=>{try{Zt[ge]&&typeof Zt[ge].open=="function"?Zt[ge].open():y&&y(ge)}catch{}}),Fe.appendChild(Xt)}),Lt.appendChild(Fe)}}a(Dt,"refresh"),ft.addEventListener("click",async()=>{ft.disabled=!0,ft.textContent="装载中…",tt.className="urppp-plugin-status",tt.textContent="正在开始装载…";try{if(await J("assist",null,Nt=>{try{Nt.stage==="downloading"?tt.textContent=`下载中… 源${Nt.index}/${Nt.total}（${T(Nt.url)}）`:Nt.stage==="downloaded"?tt.textContent=`已下载（${Nt.size} 字节），注入中…`:Nt.stage==="source_failed"?tt.textContent=`源${Nt.index}失败（${Nt.error||""}），切换下一源…`:Nt.stage==="injecting"?tt.textContent="注入中…":Nt.stage==="start"&&(tt.textContent="正在开始装载…"),console.log("[URP++ plugin] assist 装载进度",Nt)}catch{}}))C=null,tt.textContent="辅助插件已装载 v"+(et("assist")&&et("assist").version||""),console.log("[URP++ plugin] assist 装载成功");else throw new Error("注入失败")}catch(zt){C="装载失败："+(zt&&zt.message?zt.message:zt),tt.textContent=C,tt.className="urppp-plugin-status err",console.warn("[URP++ plugin] assist 装载失败",zt)}finally{ft.disabled=!1,Dt()}}),ht.addEventListener("click",()=>{y&&y("plugin-store")}),h("loaded",zt=>{zt==="assist"&&Dt()}),h("registered",zt=>{zt==="assist"&&Dt()}),h("unregistered",zt=>{zt==="assist"&&Dt()}),Dt()}a(xt,"renderAssistUi");function Z(F){return String(F??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}a(Z,"escapeHtml");function dt(F){if(F){if(At(),F.dataset.rendered==="1"){F.style.display=F.style.display==="none"?"":"none";return}F.dataset.rendered="1",F.innerHTML=`
      ...
      </div>`,F.querySelectorAll(".urppp-store-tab").forEach(Y=>{Y.addEventListener("click",()=>{F.querySelectorAll(".urppp-store-tab").forEach(ft=>ft.className="urppp-store-tab"),Y.className="urppp-store-tab ac",F.querySelectorAll(".urppp-store-pane").forEach(ft=>ft.style.display="none");let tt=F.querySelector('.urppp-store-pane[data-pane="'+Y.dataset.tab+'"]');tt&&(tt.style.display="")})}),kt(F.querySelector("#urppp-store-manage-list")),F.style.display=""}}a(dt,"togglePluginStore");function At(){if(p.getElementById("urppp-store-style"))return;let F=p.createElement("style");F.id="urppp-store-style",F.textContent=`
...
`;function qi(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(qi,"createCleanModeState");function Ti(n){n.profile=null,n.schedule=null,n.scores=null,n.catalog=null,n.occupancy=null,n._termWeekResolved=!1,n._schemeUserSelected=!1,n._schemeInited=!1}a(Ti,"resetCleanModeData");function Mi({state:n,deps:p}){async function c(u){if(!u&&n.catalog&&n.catalog.length||n.loading.room)return n.catalog;n.loading.room=!0;try{p.render()}catch{}try{n.catalog=await p.loadClassroomCatalog(),n.roomError=""}catch(k){n.catalog=n.catalog||[],n.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{n.loading.room=!1;try{p.scheduleRender()}catch{}}return n.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&Ti(n),n.loading.profile=n.loading.schedule=n.loading.scores=!0;try{let k=await p.ensureTermWeekResolved();!n.weekLocked&&k>=1&&(n.viewWeek=k)}catch{}if(p.render(),await Promise.all([(async()=>{try{n.profile&&!u||(n.profile=await p.loadProfile()),p.reconcileProfileAndScores()}catch(k){n.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{n.loading.profile=!1,p.scheduleRender()}})(),(async()=>{try{n.schedule&&!u||(n.schedule=await p.loadSchedule())}catch(k){n.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(n.loading.schedule=!1,!n.weekLocked){let k=p.getCurrentWeekNumber()||p.readRememberedTermWeek();k>=1&&(n.viewWeek=k)}p.scheduleRender()}})(),(async()=>{let k=null;try{n.scores&&!u||(n.scores=await p.loadScores(u)),k=n.scores,p.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&p.enrichScoresWithEvaluation(k).then(()=>{n.scores===k&&(p.reconcileProfileAndScores(),p.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){n.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{n.loading.scores=!1,p.scheduleRender()}})()]),p.reconcileProfileAndScores(),!n.weekLocked){let k=p.getCurrentWeekNumber()||p.readRememberedTermWeek();k>=1&&(n.viewWeek=k)}p.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(Mi,"createCleanModeDataLoader");var lr={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},id={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},$r={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function Ni(){let n=new Date,p=a(c=>String(c).padStart(2,"0"),"p");return`${n.getFullYear()}-${p(n.getMonth()+1)}-${p(n.getDate())}`}a(Ni,"calToday");function To(n,p){return Math.round((Date.parse(p)-Date.parse(n))/864e5)}a(To,"calDayDiff");function Mo(n,p){let c=To(lr[n].start,p);return c<0?0:Math.floor(c/7)+1}a(Mo,"calWeekNo");function Lo(n){return id[n]||""}a(Lo,"calLunar");function $i(n){return String(n||"").slice(5)}a($i,"calYY");function sd(n){let p=n||Ni(),[c,d]=p.split("-").map(Number);return d===8&&p>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(sd,"calActiveTerm");function $o(n,p){let c=n&&lr[n]?n:"autumn",d=lr[c],u=p||Ni(),k=d.events.map(g=>({e:g,d:To(u,g.start)})).filter(g=>g.d>=-0).sort((g,v)=>g.d-v.d)[0],P=k?To(u,k.e.start):null,A=Mo(c,u),y=Math.max(0,Math.min(100,A/d.weeks*100)),S=u>=d.start;return{term:d,termId:c,next:k,daysLeft:P,weekNo:A,progress:y,started:S,today:u}}a($o,"calStatus");function Bi(n,p){let c=$o(n,p),d=c.next?$r[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(Bi,"calendarSummaryHtml");function Fi(n,p){let c=$o(n,p);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
    <span class="cal-c-dot" style="background:${c.next?$r[c.next.e.t].color:"#c9cdd4"}"></span>
  ...
  </button>`}a(Fi,"calendarSummaryCompactHtml");function Ii(n,p){let c=$o(n,p),d=c.next?$r[c.next.e.t].color:"#c9cdd4",u=c.term,k=Object.keys(lr).map(v=>`<button type="button" class="cal-term${v===c.termId?" ac":""}" data-cal-term="${v}">${lr[v].name}</button>`).join(""),P=`<div class="cal-widget">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[v].map(C=>{let f=$r[C.t].color,h=C.end&&C.end!==C.start?"~"+$i(C.end):"",w=Mo(c.termId,C.start)>0?`第 ${Mo(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
          <span class="cal-ev-dot" style="background:${f}"></span>
          <span class="cal-ev-date">${$i(C.start)}${h||""}<em>${Lo(C.start)||"&nbsp;"}</em></span>
          <span class="cal-ev-name">${C.name}</span>
          <span class="cal-ev-tag" style="color:${f};background:${f}1a">${$r[C.t].label}</span>
  ...
  </div>`}a(Ii,"calendarModalHtml");function Di(n,p){let c=typeof document<"u"?document:null;if(!c)return;qo();let d=n&&lr[n]?n:sd(p),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${Ii(d,p)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>qo()),u.addEventListener("click",k=>{let P=k.target;if(P&&P.closest&&P.closest(".cal-close")){qo();return}let A=P&&P.closest?P.closest("[data-cal-term]"):null;if(A){let y=u.querySelector(".cal-body");y&&(y.innerHTML=Ii(A.dataset.calTerm,p)),u.querySelectorAll("[data-cal-term]").forEach(S=>S.classList.toggle("ac",S.dataset.calTerm===A.dataset.calTerm))}})}a(Di,"openCalendarModal");function qo(){let n=typeof document<"u"?document:null;if(!n)return;let p=n.getElementById("urppp-cal-modal");p&&(p.classList.remove("open"),p.classList.add("closing"),setTimeout(()=>{p.remove()},200))}a(qo,"closeCalendarModal");function ji(n,p){let c=n||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),Di())})}a(ji,"bindCalendarOpen");var ga=!1;function Io(){let n=typeof document<"u"?document:null;if(!n||ga)return ga;try{let p=n.createElement("style");if(p&&p.id!==void 0){p.id="urppp-cal-style",p.textContent=`
...
</svg>`}a(Qi,"donutSvg");var dd=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),ud='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',md='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function Xi({deps:n}){let p=n&&n.palette||dd;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
...
<div class="urppp-sa-grid">
  <section class="urppp-sa-card urppp-sa-trend">
    ...
    <div class="urppp-sa-chart-scroll">${ya({trend:S.trend,palette:p,layout:q})}</div>
  </section>
  <section class="urppp-sa-card urppp-sa-share">
    <h5 class="urppp-sa-card-title">课程类型构成</h5>
    <div class="urppp-sa-share-body">
      <div class="urppp-sa-donut">${Qi({items:v.items,requiredRatio:v.requiredRatio,palette:p})}</div>
...
<div class="urppp-sa-grid">
  ...
  `;function A(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(A,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function g(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=A("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=A("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(g,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{g(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let v="urppp_theme_v3",q="urppp_accent_v1",C="urppp_accent_presets_v1",f="urppp_scheme_v1",h="urppp_theme_follow_system_v1",w="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",L="urppp_follow_use_dynamic_v1",$="urppp_brutal_palette_v1",T="urppp_brutal_active_palette_v1",j="urppp_privacy_v1",I="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],bt="#B53434",J="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:xt,syncThemeDotGroup:Z}=as({theme:{BRUTAL_DEFAULT_PALETTE:J,DEFAULT_SEED:bt,applyTheme:Gt,buildSchemePreview:Zt,getAccent:Xt,getBrutalActivePalette:Go,getBrutalPaletteById:dr,getBrutalSelectedPalette:Wo,getCurrent:Jt,getScheme:De,getSkin:te,isThemeModeAvailable:cr,setBrutalPalette:Vo,skinSupportsDark:Oe,skinSupportsDynamic:He,skinSupportsFixedPalettes:Uo},settings:{ensureSettingsPanel:wn,openSettingsPanel:xn,syncSettingsPanelUI:jt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let O=document.createElement("li");O.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",O.appendChild(o),r.appendChild(O)}let l=o.closest("li")||o.parentElement,b=Array.from(r.children).find(O=>{let R=O.querySelector(":scope > a");if(!R)return!1;let D=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return D.includes("customerServiceCenter")||/help|service|support/i.test(D)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),m=Array.from(r.children).find(O=>O.classList.contains("light-blue")),_=b||m||null;_&&l&&_!==l&&((l.compareDocumentPosition(_)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,_)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let M=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),M&&s.parentElement!==M&&M.appendChild(s),M&&M.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let N=s.querySelector("#search-input"),z=s.querySelector("form");if(!N||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let B=s.querySelector(".input-icon");B&&(B.style.setProperty("display","block","important"),B.style.setProperty("position","relative","important")),N.style.setProperty("display","block","important"),N.style.setProperty("width","100%","important"),N.style.setProperty("height","36px","important"),N.style.setProperty("box-sizing","border-box","important"),N.style.setProperty("padding","0 12px","important"),N.style.setProperty("border","1px solid var(--border)","important"),N.style.setProperty("border-radius","var(--radius-sm)","important"),N.style.setProperty("background","var(--input-bg)","important"),N.style.setProperty("color","var(--text)","important");let V=a(O=>{s.dataset.open=O?"1":"0",s.style.setProperty("width",O?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",O?"1":"0","important"),s.style.setProperty("pointer-events",O?"auto":"none","important"),i.setAttribute("aria-expanded",O?"true":"false"),O&&setTimeout(()=>N.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",O=>{O.preventDefault(),O.stopImmediatePropagation(),V(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",O=>{let R=document.getElementById("form-search"),D=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(O.target)||D?.contains(O.target)||V(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function At(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(At,"ensureBootLoader");function kt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(kt,"hideBootLoader");try{At()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{kt()}catch{}},2500));let Pt={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function F(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,l=0,b=(o+i)/2;if(o!==i){let m=o-i;switch(l=b>.5?m/(2-o-i):m/(o+i),o){case t:s=(e-r)/m+(e<r?6:0);break;case e:s=(r-t)/m+2;break;default:s=(t-e)/m+4;break}s/=6}return{h:s*360,s:l,l:b}}a(F,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,i=o*(1-Math.abs(t/60%2-1)),s=r-o/2,l=0,b=0,m=0;return t<60?(l=o,b=i):t<120?(l=i,b=o):t<180?(b=o,m=i):t<240?(b=i,m=o):t<300?(l=i,m=o):(l=o,m=i),{r:Math.round((l+s)*255),g:Math.round((b+s)*255),b:Math.round((m+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:i,b:s}=Y(t,e,r);return Er(o,i,s)}a(tt,"hslHex");function ft(t){let{r:e,g:r,b:o}=or(Vt(t)||bt),i=F(e,r,o);return i.s<.12&&(i.s=.18),i}a(ft,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,i=Math.max(0,Math.min(.95,e));return tt(t,i,o)}a(ht,"tone");function Lt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(Lt,"schemeProfile");function vt(t,e){let r=Vt(t)||bt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Ft("#FFFFFF",r,o)}a(vt,"tintFromHex");function Dt(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Dt,"companionHue");function zt(t){let e=Vt(t)||bt,{h:r,s:o}=ft(e),i=Dt(r),s=Math.min(.72,Math.max(.28,o*.78));return ht(i,s,42)}a(zt,"companionColor");function Nt(t,e){let r=Vt(t)||bt,{h:o,s:i}=ft(r),l=Lt(e||ot),b=Math.min(.92,Math.max(.35,i*l.chroma)),m=zt(r),{h:_}=ft(m),M=ht(o,b,l.primaryTone),N=ht(o,b,Math.max(24,l.primaryTone-10)),z=Ft("#FFFFFF",r,.18),B,V,O;l.whiteCard?(B=Ft("#F1F5F9",Ft("#FFFFFF",r,.08),.5),V="#FFFFFF",O="#E5E7EB"):l.duo?(B=Ft(vt(m,l.bgSeed+.04),"#EEF1F4",.1),V=Ft(vt(r,l.surfaceSeed),"#FFFFFF",.1),O=Ft("#E5E7EB",m,.16)):(B=Ft(vt(r,l.bgSeed),"#E8EBEF",.12),V=Ft(vt(r,l.surfaceSeed),"#FFFFFF",.12),O=Ft("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Ft(V,vt(l.duo?m:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),D=ht(o,Math.min(.45,b*.55),14),K=Se(ht(o,b*.3,34),.88),ut=Se(ht(o,b*.22,46),.76),wt=Se(M,.18),Ct="0 4px 12px "+Se(M,.1)+", 0 1px 2px "+Se(M,.05);return{"--bg":B,"--surface":V,"--text":D,"--text-secondary":K,"--text-muted":ut,"--border":O,"--border-focus":M,"--input-bg":R,"--primary":M,"--primary-hover":N,"--ring":wt,"--shadow":Ct,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":m}}a(Nt,"buildMaterialSchemeVars");function Zt(t,e){let r=Nt(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Zt,"buildSchemePreview");function Fe(t){let e=Vt(t)||Xt()||bt;return X.map(r=>Object.assign({},r,Zt(e,r.id)))}a(Fe,"listSchemePreviews");function ge(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ge,"clearInlinePrimaryOverrides");function Xt(){return Vt(GM_getValue(q,""))||""}a(Xt,"getAccent");function De(){let t=String(GM_getValue(f,ot)||ot);return X.some(e=>e.id===t)?t:ot}a(De,"getScheme");function wa(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(f,e),e}a(wa,"setScheme");function os(t,e){if(!t)return;let r=Vt(t);if(r){if(GM_setValue(q,r),e&&e.scheme&&wa(e.scheme),e&&e.skipTheme){let o=fo(r,.15),i=Se(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",i);try{xt()}catch{}try{jt()}catch{}return}Gt("scu-red");try{xt()}catch{}try{jt()}catch{}}}a(os,"applyAccent");function ka(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(ka,"getAccentPresets");function ns(t){let e=Vt(t||Xt()||bt);if(!e)return ka();let r=ka();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(ns,"saveAccentPreset");function Kt(){try{return!!GM_getValue(h,!1)}catch{return!1}}a(Kt,"isThemeFollowSystem");function Ir(t){return GM_setValue(h,!!t),!!t}a(Ir,"setThemeFollowSystem");function Aa(){try{return!!GM_getValue(w,!1)}catch{return!1}}a(Aa,"isCleanDefault");function ps(t){return GM_setValue(w,!!t),!!t}a(ps,"setCleanDefault");function Sa(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(Sa,"isCleanAnalysisDirect");function is(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(is,"setCleanAnalysis");function Ee(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(Ee,"isAppleEdgeLine");function ss(t){return GM_setValue(E,!!t),!!t}a(ss,"setAppleEdgeLine");function _a(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(_a,"isAutoUpdateCheck");function ls(t){return GM_setValue(c,!!t),!!t}a(ls,"setAutoUpdateCheck");function Nr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(Nr,"readJsonSetting");function Br(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(Br,"writeJsonSetting");function Ce(){return Co(Nr(j,null))}a(Ce,"getPrivacySettings");function Ea(t){return Br(j,Co(t))}a(Ea,"setPrivacySettings");function je(){return Mr(Nr(I,null))}a(je,"getCustomIdentity");function Fo(t){return Br(I,Mr(t))}a(Fo,"setCustomIdentity");function Ca(){let t=Nr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(Ca,"getScheduleFirstMondayMap");function Do(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=Ca();r[String(t)]=String(e),Br(H,r)}a(Do,"rememberScheduleFirstMonday");function Fr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=Nr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},i={enabled:!!o.enabled,mapping:Be(o.mapping||Lr)};return et="",i}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:Be(Lr)}}}a(Fr,"getScheduleJsonFormatSettings");function jo(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:Be(e.mapping||Lr)};return et="",Br(G,r)}a(jo,"setScheduleJsonFormatSettings");function Oo(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(Oo,"isHomePage");function Dr(){try{return!!GM_getValue(L,!1)}catch{return!1}}a(Dr,"isFollowUseDynamic");function Pa(t){return GM_setValue(L,!!t),!!t}a(Pa,"setFollowUseDynamic");function cs(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(cs,"systemPrefersDark");function xe(){return cs()&&Oe()?"dark":Dr()&&He()?"scu-red":"default"}a(xe,"resolveFollowThemeName");function cr(t,e){return t==="dark"?Oe(e):t==="scu-red"?He(e):t==="default"}a(cr,"isThemeModeAvailable");function Gt(t,e){e=e||{},!Oe()&&Kt()&&Ir(!1),!He()&&Dr()&&Pa(!1),e.manual&&Ir(!1);let r;e.system||Kt()&&!e.manual?r=xe():(r=Pt[t]?t:Jt()||"default",Pt[r]||(r="default")),cr(r)||(r="default");let o=Pt[r]||Pt.default;e.skipPersist||GM_setValue(v,r),ge();let i=document.getElementById("urppp-theme-vars")||(()=>{let _=document.createElement("style");return _.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(_),_})(),s=Xt(),l=Object.assign({},o.vars);if(r==="scu-red"){let _=s||bt,M=De();l=Object.assign(l,Nt(_,M));let N=l["--primary"]||_,z=l["--primary-hover"]||fo(N,.12);document.documentElement.style.setProperty("--urppp-accent",N),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||Se(N,.15)),document.documentElement.style.setProperty("--urppp-seed",_),document.documentElement.style.setProperty("--urppp-scheme",M)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let b=":root {";for(let[_,M]of Object.entries(l))b+=`${_}:${M};`;b+="}",i.textContent=b,document.body&&(document.body.style.fontFamily=o.font);try{let _=document.documentElement;_.dataset.urpppTheme=r,_.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),_.classList.add("urppp-theme-"+r),_.classList.toggle("urppp-theme-follow",Kt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Kt()))}catch{}try{ae()}catch{}try{xt()}catch{}try{jt()}catch{}try{cn()}catch{}try{vs()}catch{}let m=document.getElementById("urppp-boot-loader");m&&(m.style.fontFamily=o.font)}a(Gt,"applyTheme");function Jt(){return GM_getValue(v,"default")}a(Jt,"getCurrent");function de(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(de,"themeDownloaded");function ye(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(ye,"localThemes");function Ho(t,e){try{let r=ye();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Ho,"saveLocalTheme");function ds(t){try{let e=ye();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(ds,"removeLocalTheme");function us(){try{if(typeof GM_listValues!="function")return;let t=ye(),e=!1;GM_listValues().forEach(r=>{let o=/^urppp_theme_css_(.+)$/.exec(r);if(!o)return;let i=o[1],s="";try{s=GM_getValue(r,"")||""}catch{}s&&(u.some(l=>l.id===i)||t[i]||(t[i]={name:i,desc:"下载主题",author:"",version:"1.0.0"},e=!0))}),e&&GM_setValue("urppp_local_themes",JSON.stringify(t))}catch{}}a(us,"migrateDownloadedThemes");function za(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(za,"storeThemeStyleEl");function ms(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(ms,"removeStoreThemeStyle");function Ro(){us();let t=new Set,e=a(r=>{if(t.has(r))return;t.add(r);let o="";try{o=GM_getValue("urppp_theme_css_"+r,"")||""}catch{}o&&(za(r).textContent=o);let i="";try{i=GM_getValue("urppp_card_css_"+r,"")||""}catch{}i&&Pe([{id:r,cardCss:i}])},"injectOne");u.forEach(r=>e(r.id)),Object.keys(ye()).forEach(r=>e(r));try{ae()}catch{}}a(Ro,"injectAllStoreThemeStyles");function te(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||de(e.id))||ye()[t]&&de(t)?t:"apple"}a(te,"getSkin");function La(t,e){let r=t||te(),o=u.find(i=>i.id===r);return!!(o&&o[e])}a(La,"getSkinCapability");function Oe(t){return La(t,"dark")}a(Oe,"skinSupportsDark");function He(t){return La(t,"dynamic")}a(He,"skinSupportsDynamic");function Uo(t){return La(t,"palettes")}a(Uo,"skinSupportsFixedPalettes");function dr(t){return Q.find(e=>e.id===t)||Q[0]}a(dr,"getBrutalPaletteById");function Wo(){let t=String(GM_getValue($,"acid")||"acid"),e=dr(t);return e.id===J?dr("acid"):e}a(Wo,"getBrutalSelectedPalette");function Go(){let t=String(GM_getValue(T,J)||J);return dr(t)}a(Go,"getBrutalActivePalette");function Vo(t,e){let r=e||{},o=dr(t);r.select&&o.id!==J&&GM_setValue($,o.id),GM_setValue(T,o.id);try{ae()}catch{}try{xt()}catch{}try{jt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}}a(Vo,"setBrutalPalette");function bs(t){let e=t||te();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&Ee()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&Ee()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(bs,"getSkinShapeOverrides");function Re(){try{let t=te();if(t==="apple")return Ee()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Re,"urpppCardBorderValue");function ae(){let t=te();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&Ee();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=bs(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=Go();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=Ee(),l=s?"1px solid rgba(0,0,0,0.08)":"none",b=s?"1px solid rgba(255,255,255,0.10)":"none",m=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+b+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+m+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let i=document.head||document.documentElement;e.parentNode===i&&i.lastElementChild!==e&&i.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Qt(document)}catch{}},0)}a(ae,"applySkinAttr");function Jo(t){let e=u.find(i=>i.id===t&&i.ready&&(i.installed!==!1||de(i.id))),r=!e&&ye()[t]&&de(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||Pa(!1),!o.dark&&Kt()&&Ir(!1);let i=Kt(),s=i?xe():Jt(),l=cr(s,e.id)?s:"default";ae(),Gt(l,{system:i})}catch{try{ae()}catch{}}try{jt()}catch{}try{xt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}return!0}a(Jo,"setSkin");function hs(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Kt())try{Gt(xe(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(hs,"bindSystemThemeListener");try{Kt()?Gt(xe(),{system:!0}):Gt(Jt())}catch{}try{ae()}catch{}try{hs()}catch{}function fs(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let i=e.match(o);if(i)return i[0].trim()}return""}a(fs,"extractLoginErrorMessage");function Yo(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(Yo,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=fs(e),i=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let b=location.pathname==="/loginEn",m=a((R,D)=>b?D:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      ${i}
    </div>`}a(Ms,"themeStoreCard");async function Vr(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=a(o=>{if(!o.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Pe(o),e.innerHTML=`<div class="urppp-store-theme-grid">${o.map(i=>Ms(i,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(i=>{i.addEventListener("click",()=>$s(i.dataset.storeTheme,i))}),e.querySelectorAll("[data-repo]").forEach(i=>i.addEventListener("click",()=>{try{window.open(i.dataset.repo,"_blank","noopener")}catch{}}));try{xr(e)}catch{}},"render");r((ee||[]).filter(o=>o.type==="theme"&&!de(o.id)));try{let o=await ze(!0);ee=o,Wa(o),document.body.contains(e)&&r(o.filter(i=>i.type==="theme"&&!de(i.id)))}catch{}}a(Vr,"fetchCatalogThemes");async function $s(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await ze()).find(l=>l.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o=await En(r);if(o==="fail"&&!await Xr("签名校验失败：该条目可能被篡改。是否仍要安装？")){e.disabled=!1,e.textContent="下载";return}if(o==="unknown"&&r._srcPub&&!await Xr("该源无有效签名校验，可能被篡改。是否自担风险继续下载？")){e.disabled=!1,e.textContent="下载";return}let i="";for(let l of r.entry)try{let b=await Promise.race([fetch(l,{cache:"no-store"}),new Promise((m,_)=>setTimeout(()=>_(new Error("timeout")),6e3))]);if(b&&b.ok){i=await b.text();break}}catch{}if(!i){gr("下载失败：所有源均不可达（本地测试源已关/网络不通）","error"),e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,i)}catch{}if(u.some(l=>l.id===t)||Ho(t,{name:r.name||t,desc:r.desc||"下载主题",author:r.author||"",version:r.version||"1.0.0"}),r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{za(t).textContent=i}catch{}try{Pe([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;try{Sn(t)}catch{}let s=e.closest&&e.closest(".urppp-store-inline");if(s){try{let l=s.querySelector("#urppp-theme-manage");l&&await Jr(l)}catch{}try{Vr(s)}catch{}}try{jt()}catch{}}a($s,"downloadStoreTheme");function Is(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,i=e&&e.repo||t.repo,s=i?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(i)}">仓库</button>`:"",l=te()===t.id,b=e&&e.cardCss||"";if(!b)try{b=GM_getValue("urppp_card_css_"+t.id,"")||""}catch{}let m=b?`<style>${b}</style>`:"";return`<div class="urppp-skin-card${l?" is-active":""}" data-skin="${at(t.id)}">
      ${m}
      ...
      ${o}${s}
    </div>`}a(Is,"themeManageCardHtml");async function Jr(t){if(!t)return;let e=ee||[],r=ye(),o=Object.keys(r).map(s=>({id:s,name:r[s].name||s,desc:r[s].desc||"本地主题",version:r[s].version||"1.0.0",author:r[s].author||"本地",installed:!1})),i=u.filter(s=>s.installed!==!1||de(s.id)).concat(o.filter(s=>!u.some(l=>l.id===s.id)));if(!i.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}Pe(i.map(s=>{let l="";try{l=GM_getValue("urppp_card_css_"+s.id,"")||""}catch{}return{id:s.id,cardCss:l||(e.find(b=>b.id===s.id)||{}).cardCss||""}})),t.innerHTML=`<div class="urppp-store-theme-grid">${i.map(s=>Is(s,e.find(l=>l.id===s.id))).join("")}</div>`;try{xr(t)}catch{}t.querySelectorAll("[data-theme-use]").forEach(s=>s.addEventListener("click",()=>{if(Jo(s.dataset.themeUse)){try{jt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(l=>{let b=l.dataset.skin,m=l.querySelector(".urppp-skin-apply"),_=te()===b;l.classList.toggle("is-active",_),m&&(m.classList.toggle("is-current",_),m.disabled=_,m.textContent=_?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(s=>s.addEventListener("click",()=>{let l=s.dataset.themeDel,b=te()===l;try{GM_setValue("urppp_theme_css_"+l,"")}catch{}try{GM_setValue("urppp_card_css_"+l,"")}catch{}ds(l),ms(l);try{if(b){GM_setValue(d,"apple");try{document.documentElement.removeAttribute("data-urppp-skin")}catch{}try{document.body&&document.body.removeAttribute("data-urppp-skin")}catch{}ae();let _=Kt(),M=_?xe():Jt();Gt(M,{system:_})}}catch{}try{jt()}catch{}let m=t.closest(".urppp-store-inline");if(m){try{Jr(t)}catch{}try{Vr(m)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(s=>s.addEventListener("click",()=>{try{window.open(s.dataset.repo,"_blank","noopener")}catch{}}))}a(Jr,"fetchThemeManage");function An(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(An,"storeManageSettingsHtml");let Ns=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];function fr(){try{let t=JSON.parse(GM_getValue("urppp_store_sources","[]"));return Array.isArray(t)?t:[]}catch{return[]}}a(fr,"getCustomSources");function Ua(t){try{GM_setValue("urppp_store_sources",JSON.stringify(t))}catch{}}a(Ua,"saveCustomSources");function Bs(){try{let t=GM_getValue("urppp_catalog_cache","");return t&&JSON.parse(t)||null}catch{return null}}a(Bs,"catalogCacheRead");function Wa(t){try{Array.isArray(t)&&t.length&&GM_setValue("urppp_catalog_cache",JSON.stringify(t))}catch{}}a(Wa,"catalogCacheWrite");let ee=Bs();async function ze(t){if(ee&&!t)return ee;let e=a((M,N)=>Promise.race([M,new Promise((z,B)=>setTimeout(()=>B(new Error("timeout")),N))]),"withTimeout"),r=a(async M=>{try{let N="";if(typeof GM_xmlhttpRequest=="function")N=await new Promise(B=>{try{GM_xmlhttpRequest({method:"GET",url:M,timeout:5e3,onload:a(V=>B(V&&V.responseText||""),"onload"),onerror:a(()=>B(""),"onerror"),ontimeout:a(()=>B(""),"ontimeout")})}catch{B("")}});else{let B=await e(fetch(M,{cache:"no-store"}),5e3);if(!(B&&B.ok))return null;N=await B.text()}if(!N)return null;let z=JSON.parse(N);return z&&Array.isArray(z.items)?z:null}catch{return null}},"fetchCatalogDoc"),o=await Promise.allSettled(Ns.map(M=>r(M))),i=null;for(let M of o){if(!(M.status==="fulfilled"&&M.value&&Array.isArray(M.value.items)))continue;let N=M.value.items.some(z=>z.type==="theme"&&z.cardCss);(!i||N&&!i.items.some(z=>z.type==="theme"&&z.cardCss))&&(i=M.value)}let s=i&&i.items||[],l=fr().filter(M=>M&&M.url&&M.enabled!==!1),b=await Promise.allSettled(l.map(async M=>{let N=await r(M.url);return{doc:N,pubkey:N?N.pubkey:""}})),m=[...s],_=new Set(m.map(M=>M&&M.id).filter(Boolean));for(let M of b){if(!(M.status==="fulfilled"&&M.value&&M.value.doc))continue;let N=M.value.pubkey||"";for(let z of M.value.doc.items)!z||!z.id||_.has(z.id)||(_.add(z.id),N&&(z._srcPub=N),m.push(z))}return ee=m,Wa(m),m}a(ze,"fetchCatalogList");function Fs(){try{if(typeof crypto<"u"&&crypto&&crypto.subtle)return crypto.subtle;let t=typeof unsafeWindow<"u"&&unsafeWindow?unsafeWindow:typeof window<"u"?window:null;if(t&&t.crypto&&t.crypto.subtle)return t.crypto.subtle}catch{}return null}a(Fs,"getWebCrypto");function Yr(t){if(Array.isArray(t))return t.map(Yr);if(t&&typeof t=="object"){let e={};for(let r of Object.keys(t).filter(o=>o!=="signature"&&o!=="_srcPub").sort())e[r]=Yr(t[r]);return e}return t}a(Yr,"normalizeEntry");function Qr(t){try{let e=atob(t),r=new Uint8Array(e.length);for(let o=0;o<e.length;o+=1)r[o]=e.charCodeAt(o);return r}catch{return null}}a(Qr,"b64ToU8");async function Ds(t,e){let r=Fs();if(!r)try{if(!e||!t||!t.signature)return!1;let o=Qr(e),i=Qr(t.signature);if(!o||!i)return!1;let s=JSON.stringify(Yr(t));return zp(i,o,ko(s))}catch{return null}if(!e||!t||!t.signature)return!1;try{let o=Qr(e);if(!o)return null;let i=await r.importKey("raw",o,{name:"Ed25519"},!1,["verify"]),s=Qr(t.signature);if(!s)return!1;let l=JSON.stringify(Yr(t)),b=await r.digest("SHA-256",new TextEncoder().encode(l)),m=new Uint8Array(b);return await r.verify({name:"Ed25519"},i,s,m)}catch{return null}}a(Ds,"verifyEntrySignature");function gr(t,e){try{let r=document.getElementById("urppp-toast");r||(r=document.createElement("div"),r.id="urppp-toast",r.className="urppp-toast",(document.body||document.documentElement).appendChild(r)),r.textContent=t,r.className="urppp-toast"+(e==="error"?" error":""),r.style.display="",r.style.pointerEvents="auto",r.style.transition="opacity .22s, transform .22s",r.style.opacity="0",r.style.transform="translateY(14px)",requestAnimationFrame(()=>{r.style.opacity="1",r.style.transform="none"}),clearTimeout(r._t),r._t=setTimeout(()=>{r.style.pointerEvents="none",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>{r.style.display="none"},260)},3200)}catch{try{window.alert(t)}catch{}}}a(gr,"toast");function Xr(t){return new Promise(e=>{try{let r=document.getElementById("urppp-confirm");r||(r=document.createElement("div"),r.id="urppp-confirm",r.className="urppp-confirm",r.innerHTML='<div class="urppp-confirm-card"><div class="urppp-confirm-txt"></div><div class="urppp-confirm-ops"><button type="button" class="urppp-set-btn ghost" data-cac>取消</button><button type="button" class="urppp-set-btn" data-ok>继续</button></div></div>',(document.body||document.documentElement).appendChild(r)),r.style.display="",r.querySelector(".urppp-confirm-txt").textContent=t,r.style.pointerEvents="auto",r.style.transition="opacity .22s, transform .22s",r.style.opacity="0",r.style.transform="translateY(14px)",requestAnimationFrame(()=>{r.style.opacity="1",r.style.transform="none"});let o=a(i=>{r.querySelector("[data-ok]").onclick=r.querySelector("[data-cac]").onclick=null,r.style.pointerEvents="none",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>{r.style.display="none"},260),e(i)},"done");r.querySelector("[data-ok]").onclick=()=>o(!0),r.querySelector("[data-cac]").onclick=()=>o(!1)}catch{try{e(window.confirm(t))}catch{e(!1)}}})}a(Xr,"confirmBottom");let we="https://api.yanjiangrd.site";function js(){return new Promise(t=>{let e=!1,r=a(o=>{e||(e=!0,t(o))},"fin");try{let o=GM_getValue("urppp_downs_salt","");if(o)return r(o);if(!we||typeof GM_xmlhttpRequest!="function")return r("");GM_xmlhttpRequest({method:"GET",url:we+"/downs/salt",timeout:8e3,onload:a(i=>{try{let s=String((JSON.parse(i.responseText)||{}).salt||"");if(/^[0-9a-f]{16,128}$/.test(s)){try{GM_setValue("urppp_downs_salt",s)}catch{}r(s)}else r("")}catch{r("")}},"onload"),onerror:a(()=>r(""),"onerror"),ontimeout:a(()=>r(""),"ontimeout")}),setTimeout(()=>r(""),9500)}catch{r("")}})}a(js,"getDownsSalt");function Os(){try{let t=GM_getValue("urppp_downs_sid","");if(t&&/^\d{6,20}$/.test(t))return t;let e=document.getElementById("urppp-user");if(e&&/^\d{6,20}$/.test(String(e.value||"").trim())){let o=String(e.value).trim();try{GM_setValue("urppp_downs_sid",o)}catch{}return o}let r=String(location.search||"").match(/[?&](?:userAccount|sno)=(\d{6,20})/);if(r){try{GM_setValue("urppp_downs_sid",r[1])}catch{}return r[1]}}catch{}return""}a(Os,"getCurrentStudentId");async function Sn(t){try{if(!we||!t)return;let e=await js();if(!e)return;let r=Os();if(!r)return;let o=ko(new TextEncoder().encode(e+"|"+r+"|"+t)),i="";for(let l=0;l<16;l++)i+=o[l].toString(16).padStart(2,"0");let s=JSON.stringify({id:String(t),uid:i});try{await Promise.race([fetch(we+"/downs",{method:"POST",headers:{"Content-Type":"application/json"},body:s}),new Promise((l,b)=>setTimeout(()=>b(new Error("timeout")),6e3))]);return}catch{}try{typeof GM_xmlhttpRequest=="function"&&GM_xmlhttpRequest({method:"POST",url:we+"/downs",timeout:8e3,headers:{"Content-Type":"application/json"},data:s,onerror:a(()=>{},"onerror"),ontimeout:a(()=>{},"ontimeout")})}catch{}}catch{}}a(Sn,"reportStoreDownload");function _n(t){let e=we+"/downs?ids="+encodeURIComponent(t.join(",")),r=a(()=>new Promise(o=>{let i=!1,s=a(l=>{i||(i=!0,o(l||{}))},"fin");try{if(typeof GM_xmlhttpRequest!="function")return s({});GM_xmlhttpRequest({method:"GET",url:e,timeout:8e3,onload:a(l=>{try{s(JSON.parse(l.responseText)||{})}catch{s({})}},"onload"),onerror:a(()=>s({}),"onerror"),ontimeout:a(()=>s({}),"ontimeout")}),setTimeout(()=>s({}),9500)}catch{s({})}}),"gmFallback");return(async()=>{try{let o=await Promise.race([fetch(e,{cache:"no-store"}),new Promise((i,s)=>setTimeout(()=>s(new Error("timeout")),6e3))]);if(o&&o.ok)return await o.json()||{}}catch{}return r()})()}a(_n,"fetchStoreDowns");async function xr(t){let e=(typeof unsafeWindow<"u"?unsafeWindow:window).__urpppDownsLast={t:Date.now(),hasRoot:!!t,api:we||"(empty)"};try{if(!t||!we){e.stop="no-root-or-api";return}let r=t.querySelectorAll("[data-dows-id]");if(e.els=r.length,!r.length){e.stop="no-placeholders";return}let o=Array.from(new Set(Array.from(r).map(l=>l.dataset.dowsId)));e.ids=o;let i=await _n(o);if(e.map=i,!t.isConnected){e.stop="root-detached";return}let s=0;t.querySelectorAll("[data-dows-id]").forEach(l=>{let b=i[l.dataset.dowsId];typeof b=="number"&&b>=0&&(l.textContent=" · ↓"+(b>=1e4?(b/1e4).toFixed(1)+"w":String(b)),s++)}),e.filled=s;try{console.log("[URP++ downs]",JSON.stringify(e))}catch{}}catch(r){e.err=String(r);try{console.log("[URP++ downs] err",String(r))}catch{}}}a(xr,"refreshStoreDowns");try{let t=typeof unsafeWindow<"u"?unsafeWindow:window;t.__urpppDownsVer="v8",t.__urpppDownsTest=_n,t.__urpppDownsRefresh=xr,t.__urpppStoreTest=e=>Vr(e)}catch{}async function En(t){let e=t&&t._srcPub;if(!e)return"trust";let r=await Ds(t,e);return r===!0?"ok":r===!1?"fail":"unknown"}a(En,"guardEntrySignature");function Cn(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let i=0;i<Math.max(r.length,o.length);i+=1){let s=r[i]||0,l=o[i]||0;if(s!==l)return s>l}return!1}a(Cn,"versionGt");function Hs(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let i=t.querySelector('[data-theme-use="'+o.id+'"]');i&&Cn(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(Pn(i.closest(".urppp-skin-card"),"主题"),r+=1);let s=t.querySelector('[data-plugin-id="'+o.id+'"]');if(s){let l=Et&&Et.api&&Et.api.get&&Et.api.get(o.id);l&&Cn(o.version,l.version)&&(Pn(s.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(Hs,"applyStoreUpdateBadges");function Pn(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(Pn,"addUpdateBadge");function zn(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),i=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");i(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),i()}),r.addEventListener("click",async()=>{r.disabled=!0;let s=r.textContent;r.textContent="检查中…";try{let l=await ze(),b=Hs(t,l);r.textContent=b?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=s,r.disabled=!1},1600)})}a(zn,"bindStoreManageSettings");function Rs(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
      ...
      </div>`,kn(t),zn(t),Us(t),Va(t),Vr(t),setTimeout(()=>{try{xr(t)}catch{}},800),Jr(t.querySelector("#urppp-theme-manage"))}a(Rs,"renderThemeStoreBody");function Ga(){let t=fr();return`<div class="urppp-src-manage">
    ...
    </div>`}a(Ws,"pluginStoreCard");async function Gs(t){if(!t)return;let e=a(o=>{if(!o.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载插件</p><p class="urppp-store-sub">已安装的插件不会再显示在这里。</p></div>';return}t.innerHTML=`${o.map(i=>Ws(i)).join("")}`,t.querySelectorAll("[data-plugin-apply]").forEach(i=>i.addEventListener("click",async()=>{i.disabled=!0;let s=i.textContent;i.textContent="下载中…";try{let l=(await ze()).find(m=>m.id===i.dataset.pluginApply),b=l?await En(l):"trust";if(b==="fail"&&!await Xr("签名校验失败：该插件可能被篡改。是否仍要装载？")){i.textContent="下载",i.disabled=!1;return}if(b==="unknown"&&l&&l._srcPub&&!await Xr("该源无有效签名校验，可能被篡改。是否自担风险继续装载？")){i.textContent="下载",i.disabled=!1;return}Et&&Et.api&&Et.api.install&&await Et.api.install(i.dataset.pluginApply,null),i.textContent="已安装";try{jt()}catch{}try{Sn(i.dataset.pluginApply)}catch{}}catch{i.textContent="失败"}setTimeout(()=>{i.textContent=s,i.disabled=!1},1200)})),t.querySelectorAll("[data-repo]").forEach(i=>i.addEventListener("click",()=>{try{window.open(i.dataset.repo,"_blank","noopener")}catch{}}));try{xr(t)}catch{}},"render"),r=a(o=>(o||[]).filter(i=>i.type==="plugin"&&!(Et&&Et.api&&Et.api.isEnabled&&Et.api.isEnabled(i.id))),"filter");e(r(ee));try{let o=await ze(!0);ee=o,Wa(o),document.body.contains(t)&&e(r(o))}catch{}}a(Gs,"fetchCatalogPlugins");async function Ln(t){if(!t)return;let e=[];try{e=await ze()}catch{}let r=Et&&Et.api&&Et.api.list&&Et.api.list()||[];if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}t.innerHTML=r.map(o=>{let i=e.find(b=>b.id===o.id),s=i&&i.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(i.downloads))}</span>`:"",l=o.repo||i&&i.repo?`<button type="button" class="urppp-set-btn ghost" data-repo="${at(o.repo||i.repo)}">仓库</button>`:"";return`<div class="urppp-store-item">
      ...
      </div>`,kn(t),zn(t),Vs(t),Va(t),Gs(t.querySelector('[data-pane="download"]')),Ln(t.querySelector("#urppp-plugin-manage"))}a(qn,"renderPluginStoreBody");function Vs(t){let e=t.querySelector("[data-add-local-plugin]"),r=t.querySelector("[data-local-plugin-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text();r.value="";try{new Function(i)()}catch(s){gr("本地插件加载失败："+(s&&s.message?s.message:s),"error")}try{Ln(t.querySelector("#urppp-plugin-manage"))}catch{}}))}a(Vs,"bindLocalPluginImport");function Js(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>Ra("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=te();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}let i=ye(),s=u.filter(l=>l.installed!==!1||de(l.id)).concat(Object.keys(i).filter(l=>!u.some(b=>b.id===l)).map(l=>({id:l,name:i[l].name||l,desc:i[l].desc||"本地主题",version:i[l].version||"1.0.0",installed:!1})));s.forEach(l=>{let b=!!i[l.id],m=document.createElement("div");m.className="urppp-skin-card"+(l.id===o?" is-active":""),m.dataset.skin=l.id;let _=document.createElement("button");_.type="button",_.className="urppp-skin-apply";let M=l.installed!==!1||de(l.id)||b;M?l.id===o&&(l.ready||b)?(_.classList.add("is-current"),_.textContent="使用中",_.disabled=!0):_.textContent="应用主题":(_.classList.add("is-disabled"),_.textContent="去下载"),_.addEventListener("click",N=>{if(N.preventDefault(),N.stopPropagation(),!M){Ra("theme");return}if(!(l.id===o&&l.ready)&&Jo(l.id)){jt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),m.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),m.querySelector(".urppp-skin-name").textContent=l.name,m.querySelector(".urppp-skin-desc").textContent=l.desc,m.appendChild(_);try{let N="";try{N=GM_getValue("urppp_card_css_"+l.id,"")||""}catch{}if(N){let z=document.createElement("style");z.textContent=N,m.appendChild(z)}}catch{}r.appendChild(m)});try{let l=s.map(b=>{let m="";try{m=GM_getValue("urppp_card_css_"+b.id,"")||""}catch{}return{id:b.id,cardCss:m}});Pe(l)}catch{}}a(Js,"renderSkinCards");let Ve=[],Ya=!1;function Tn(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,i=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(s=>{if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).finally(()=>{i&&clearTimeout(i)})}a(Tn,"fetchWithTimeout");function Ys(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(i=>{i.status>=200&&i.status<400?r(i.responseText||""):o(new Error("HTTP "+i.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(i){o(i)}})}a(Ys,"gmRequestForUpdate");function Qs(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),typeof GM_xmlhttpRequest=="function"?Ys(t,r).catch(()=>Tn(t,r,12e3)):Tn(t,r,12e3)}a(Qs,"fetchTextForUpdate");async function Qa(t,e,r=1e3){let o=[],i=t[0],s=t.slice(1),l=a(z=>Qs(z,e).then(B=>({url:z,text:B})).catch(B=>(o.push((z.split("/")[2]||z)+": "+(B&&B.message||B)),null)),"grab"),b=l(i),m=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),_=await Promise.race([b,m]);if(_!=="__TIMEOUT__"){if(_&&_.text&&_.text.length>0)return _.text;let B=(await Promise.all(s.map(l))).find(V=>V&&V.text&&V.text.length>0);if(B)return B.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let M=Promise.all(s.map(l)).then(z=>{let B=z.find(V=>V&&V.text&&V.text.length>0);if(B)return B.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),N=b.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([N,M])}a(Qa,"fetchFirstAvailable");function Le(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(Le,"setUpdateStatus");async function Xa(){let t=n,e="",r=!1,o="";try{let s=await Qa(p.sourceUrls(p.versionJson)),l=JSON.parse(s);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let s=await Qa(p.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=xo(s)}if(!e)throw new Error("无法解析远程主插件版本");let i=Cr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:i>0?"update":i===0?"latest":"ahead",updateUrl:p.mainRaw,pageUrl:p.greasySearch,changelogMd:r?o:""}}a(Xa,"checkMainUpdate");function Mn(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let i=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,s=[],l;for(;(l=i.exec(o))!==null;)s.push({ver:l[1],index:l.index,headEnd:i.lastIndex});if(!s.length)return"";for(let m=0;m<s.length;m++){let _=m+1<s.length?s[m+1].index:o.length;s[m].body=o.slice(s[m].index,_).trim()}let b=[];for(let m of s)Cr(m.ver,r)>0||Cr(m.ver,e)<=0||b.push(m.body);return b.join(`

`).trim()}a(Mn,"extractChangelogRange");function $n(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a($n,"ensureUpdateToastStyles");function Xs(t){let e=String(t||"").replace(/\r\n/g,`
...
`),i=[],s=!1,l=a(()=>{s&&(i.push("</ul>"),s=!1)},"closeList");for(let b=0;b<o.length;b++){let _=o[b].replace(/\s+$/,"");if(!_.trim()){l();continue}let M=_.match(/^(#{2,3})\s+(.+)$/);if(M){l();let z=M[1].length,B=M[2];i.push(z===2?`<h2>${r(B)}</h2>`:`<h3>${r(B)}</h3>`);continue}let N=_.match(/^[-*]\s+(.+)$/);if(N){s||(i.push("<ul>"),s=!0),i.push(`<li>${r(N[1])}</li>`);continue}l(),i.push(`<p>${r(_)}</p>`)}return l(),i.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(Xs,"renderChangelogMarkdown");function In(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(In,"hideUpdateToast");function Ks(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="background-color"&&i.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(Ks,"hideChangelogModal");function Nn(t,e){$n();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>In(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let i=o.getAttribute("data-act"),s=e.__pack||{};if(i==="later"){In(e);return}if(i==="go"){let l=s.updateUrl||p.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(i==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=s.changelogMd;l||(l=await Qa(p.sourceUrls("CHANGELOG.md")),s.changelogMd=l);let b=Mn(l,s.local,s.remote),m=b?Xs(b):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+p.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';Nn("更新日志 "+s.local+" → "+s.remote,m)}catch(l){Nn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+p.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(Ka,"showUpdateToast");async function Za(){if(_a()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await Xa();t&&t.status==="update"&&Ka(t);let e=await Zs();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Za,"maybeAutoCheckUpdate");function Zs(){let t=(window.__urpppUpdateCheckers||Ve||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?Et.update("assist"):null).catch(()=>null)}a(Zs,"hotUpdateAssist");async function to(){if(Ya)return;Ya=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Le("正在从多源检查更新…");try{let e=[Xa()];(Ve||[]).forEach(m=>{m&&typeof m.check=="function"&&e.push(Promise.resolve().then(()=>m.check()).then(_=>_||{id:m.id||"extra",name:m.name||"扩展",status:"err",message:"无结果"}).catch(_=>({id:m.id||"extra",name:m.name||"扩展",status:"err",message:String(_&&_.message||_)})))});let r=await Promise.all(e),o=r.map(m=>{if(!m)return"";if(m.status==="err")return`• <b>${at(m.name||m.id)}</b>：检查失败（${at(m.message||"unknown")}）`;if(m.status==="update"){let _="";if(m.id==="assist"&&Et&&Et.loaded("assist"))_=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let M=m.updateUrl?` <a href="${at(m.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",N=m.pageUrl?` <a href="${at(m.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";_=M+N}return`• <b>${at(m.name)}</b>：发现新版本 <b>${at(m.remote)}</b>（当前 ${at(m.local)}）${_}`}return m.status==="ahead"?`• <b>${at(m.name)}</b>：本地 ${at(m.local)} 新于远程 ${at(m.remote)}`:`• <b>${at(m.name)}</b>：已是最新（${at(m.local)}）`}).filter(Boolean),i=r.some(m=>m&&m.status==="update"),s=r.some(m=>m&&m.status==="err");Le(`${i?"检查完成：发现更新":s?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${p.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,s?"err":"ok");let b=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');b&&b.addEventListener("click",()=>{try{Le("正在重新装载辅助插件…",""),Et.install("assist").then(()=>{Le("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(m=>{Le("重新装载失败："+(m&&m.message?m.message:m),"err")})}catch(m){Le("重新装载失败："+(m&&m.message?m.message:m),"err")}})}catch(e){Le("检查失败："+at(e&&e.message||e),"err")}finally{Ya=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(to,"checkForUpdates");function Bn(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+n,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(Bn,"refreshUpdateStatusHint");function tl(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=Ve.findIndex(i=>i&&i.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?Ve[r]=o:Ve.push(o);try{let i=document.getElementById("urppp-set-update-status");i&&o.localVersion&&e==="assist"&&i.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{Bn()}catch{}return!0}a(tl,"registerUpdateChecker");function el(){let t={version:n,urls:p,check:to,checkMain:Xa,registerChecker:tl,compareVersions:Cr,parseUserscriptVersion:xo,extractChangelogRange:Mn,showUpdateToast:Ka,maybeAutoCheckUpdate:Za,listCheckers:a(()=>Ve.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(el,"publishUpdateApi"),el();let{rebuildSidebarCompletely:Fn,syncMobileContentOffset:Je,syncSidebarUnderNavbar:qe}=rs({}),{rebuildDashboard:rl}=Gi({deps:{statCardPrivacyMarkup:il}}),al="urppp-clean-open",eo={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ue(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ue,"isUnevaluatedScore");function Kr(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Kr,"isValidOfficialGpa");function Zr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Zr,"firstContentChar");function ro(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(ro,"weekBitmapActive");function Ye(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ue(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:eo[o]!=null?eo[o]:eo[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ye,"scoreToGpa");function Qe(t){let e=String(t||"").trim();if(!e||ue(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(Qe,"scoreToNumber");function Te(t){return Math.round((Number(t)||0)*100)/100}a(Te,"round2");function Dn(t){return/必修/.test(String(t||""))}a(Dn,"isRequiredAttr");function oe(t){let e=0,r=0,o=0,i=0,s=0,l=0,b=0,m=0;return(t||[]).forEach(_=>{if(_&&(_.unevaluated||ue(_.score)))return;let M=Number(_.credit)||0,N=Qe(_.score),z=Kr(_.officialGpa)?Number(_.officialGpa):Ye(_.score);N==null||M<=0||(e+=M,r+=N*M,z!=null&&(o+=z*M,i+=M),_.required&&(s+=M,l+=N*M,z!=null&&(b+=z*M,m+=M)))}),{totalCredit:Te(e),avgScore:Te(e?r/e:0),avgGpa:Te(i?o/i:0),requiredCredit:Te(s),requiredGpa:Te(m?b/m:0),requiredAvg:Te(s?l/s:0),count:(t||[]).length}}a(oe,"summarizeCourses");function ao(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(ao,"absUrl");function Yt(t,e){let r=ao(t),o=e&&e.method||"GET",i=e&&e.data||null;return new Promise((s,l)=>{let b=a((m,_)=>m?s(_):l(new Error(_||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:i||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(m=>{m.status>=200&&m.status<400?b(!0,m.responseText||""):b(!1,"HTTP "+m.status)},"onload"),onerror:a(()=>b(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:i||void 0}).then(m=>{if(!m.ok)throw new Error("HTTP "+m.status);return m.text()}).then(m=>b(!0,m)).catch(m=>b(!1,m&&m.message))})}a(Yt,"fetchText");function ta(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(ta,"parseHtml");function jn(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=vi,(document.head||document.documentElement).appendChild(t)}a(jn,"ensureFeatureStyles");function ol(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=Ai,(document.head||document.documentElement).appendChild(t)}a(ol,"ensureScheduleExportStyles");function nl(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=Si,(document.head||document.documentElement).appendChild(t)}a(nl,"ensureSettingsStyles");function On(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let i=r.cloneNode(!0);i.querySelectorAll("small, i, img, b, .badge").forEach(b=>b.remove());let s=(i.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(b=>{b.nodeType===Node.TEXT_NODE&&b.textContent.trim()&&b.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=s||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(On,"ensureNavNameTarget");function ea(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(ea,"classifyPrivacyLabel");function pl(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(pl,"classifyHomeDataKey");function ra(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(ra,"homePrivateValueSpan");function il(t,e){let r=at(t),o=at(e),i=pl(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[i]||ea(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:ra("organization",i,o)}:{valueHtml:ra("organization",i,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let b=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&b){let _=b.index||0,M=String(e).slice(0,_),N=String(e).slice(_+b[0].length);return{valueHtml:r,labelHtml:`${at(M)}${ra(l,i,at(b[0]))}${at(N)}`}}return{valueHtml:ra(l,i,r),labelHtml:o}}a(il,"statCardPrivacyMarkup");function Me(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||Tr;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||Tr)}a(Me,"privacyReplacement");function yr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(yr,"markPrivateText");function Hn(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||Tr);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(Hn,"markPrivateAvatar");function sl(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(sl,"markPrivateBlock");function ll(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(ll,"markDirectEditable");let ke=null;function Rn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;ke&&ke.__finish&&ke.__finish(!1);let r=Ce();if(r.mode!=="custom"||!r.directEdit.enabled)return;let i=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),s=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),b=s.height>=8||!l?s:{left:s.left,top:l.top,width:Math.max(s.width,40),height:l.height},m=document.createElement("input"),_=getComputedStyle(t),M=Math.min(Math.max(b.width+64,140),Math.max(140,window.innerWidth-24)),N=Math.min(Math.max(12,b.left),Math.max(12,window.innerWidth-M-12)),z=Math.min(Math.max(12,b.top+(b.height-36)/2),Math.max(12,window.innerHeight-48));m.type="text",m.maxLength=80,m.className="urppp-direct-edit-input",m.value=i,m.setAttribute("aria-label","修改"+U[e]+"显示值"),m.style.left=N+"px",m.style.top=z+"px",m.style.setProperty("--urppp-direct-edit-width",M+"px"),m.style.fontFamily=_.fontFamily,m.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(_.fontSize)||14)))+"px";let B=!1,V=a(O=>{if(B||(B=!0,m.remove(),ke===m&&(ke=null),O))return;let R=Ce();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(m.value||"").trim().slice(0,80),Ea(R),Qt(document),so(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");m.__finish=V,m.addEventListener("click",O=>O.stopPropagation()),m.addEventListener("blur",()=>V(!1)),m.addEventListener("keydown",O=>{O.key==="Enter"&&(O.preventDefault(),V(!1)),O.key==="Escape"&&(O.preventDefault(),V(!0))}),document.documentElement.appendChild(m),ke=m,m.focus(),m.select()}a(Rn,"openDirectEditInput");function cl(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Rn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Rn(e))},!0))}a(cl,"bindDirectEditInteraction");function dl(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(dl,"clearPrivacyDisplay");function Un(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(Un,"applyCustomText");function ul(t){let e=t&&t.querySelectorAll?t:document,r=je(),i=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?On(e):null);Un(i,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(b=>{let m=b.querySelector(".profile-info-name"),_=b.querySelector(".profile-info-value");!m||!_||String(m.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||Un(_,r.nameEnabled,r.name)});let s=sr(r.avatar),l=r.avatarEnabled&&!!s;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(b=>{let m=b.getAttribute("src")||"";m&&m!==b.__urpppAppliedCustomSrc&&(b.__urpppOriginalSrc=m),l?(b.__urpppOriginalSrc==null&&(b.__urpppOriginalSrc=m),m!==s&&b.setAttribute("src",s),b.__urpppAppliedCustomSrc=s):b.__urpppAppliedCustomSrc!=null&&(b.__urpppOriginalSrc&&b.setAttribute("src",b.__urpppOriginalSrc),delete b.__urpppAppliedCustomSrc)})}a(ul,"applyCustomIdentityDisplay");function ml(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),i=r.querySelector(".profile-info-value, td:last-child");if(!o||!i||o===i)return;let s=ea(o.textContent),l=Me(e,s);l&&yr(i,l)})}a(ml,"applyProfilePrivacy");function bl(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let i=o.map(s=>{let l=ea(s.textContent);return["grade","gpa","credit"].includes(l)?l:""});i.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(s=>{let l=s.querySelectorAll("td");i.forEach((b,m)=>{let _=Me(e,b);b&&_&&yr(l[m],_)})})})}a(bl,"applyScoreTablePrivacy");function hl(t){let e=t&&t.querySelectorAll?t:document,r=Ce();if(r.mode==="off")return;let o=Me(r,"name"),i=Me(r,"avatar"),s=Me(r,"schedule"),l=o?On(e):e.querySelector?.(".urppp-user-name-value");o&&yr(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([_,M])=>{let N=Me(r,M);N&&e.querySelectorAll(_).forEach(z=>yr(z,N))}),bl(e,r);let m=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(_=>{let M=_.getAttribute("data-urppp-private"),N=_.getAttribute("data-urppp-edit-key"),B=(m&&N?String(r.directEdit.values[N]||"").trim():"")||Me(r,M);!["avatar","schedule"].includes(M)&&B&&yr(_,B),m&&N&&ll(_,N)}),m&&cl(),ml(e,r),i&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(_=>{let M=_.matches("img")?_:_.querySelector("img");M?Hn(M,i):(_.classList.add("urppp-private-avatar-block"),_.setAttribute("data-urppp-private-mask",i))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(_=>Hn(_,i))),s){let _=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));_.filter(M=>!_.some(N=>N!==M&&N.contains(M))).forEach(M=>sl(M,s))}}a(hl,"applyPrivacyDisplay");let oo=0,me=[];function Wn(){let t=Ce(),e=je();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(Wn,"personalDisplayIsEnabled");function fl(){me=me.filter(({root:t})=>t&&t.isConnected),me.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(fl,"resumePersonalDisplayObservers");function Qt(t){let e=t||document;me.forEach(({observer:r})=>r.disconnect());try{jn()}catch{}try{dl(e)}catch{}try{ul(e)}catch(r){console.warn("[URP++] custom identity",r)}try{hl(e)}catch(r){console.warn("[URP++] privacy",r)}Wn()?(fl(),xl()):(clearTimeout(oo),me=[])}a(Qt,"applyPersonalDisplay");function gl(t){clearTimeout(oo),oo=setTimeout(()=>Qt(t||document),140)}a(gl,"schedulePersonalDisplay");function no(){try{nt&&nt.open&&rr()}catch{}}a(no,"refreshCleanPersonalDisplay");function xl(){if(!Wn()){me.forEach(({observer:t})=>t.disconnect()),me=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(me.some(r=>r.root===t))return;let e=new MutationObserver(()=>gl(document));me.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(xl,"bindPersonalDisplayObservers");function yl(t){let e=Object.assign({},t||{}),r=je();r.nameEnabled&&r.name&&(e.name=r.name);let o=sr(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(yl,"personalizedProfile");let Gn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",vl="/student/courseSelect/thisSemesterCurriculum/callback",wl="/student/courseSelect/thisSemesterCurriculum/index";async function kl(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Yt(vl),r=JSON.parse(e),o=ir(r);if(o)return o}catch{}return""}a(kl,"resolveSchedulePlanCode");async function Vn(t){let e=await kl(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Yt(Gn,r),i;try{i=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=ir(i)),(!i.jcsjbs||!i.jcsjbs.length)&&e&&(i=JSON.parse(await Yt(Gn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let s=Yn(i,e,t);if(!s.courses.length)throw new Error("没有读取到可导出的课表数据");return s}a(Vn,"loadScheduleExportData");function po(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(po,"safeScheduleFilename");function io(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(io,"downloadBlob");function Al(t){let e=la(t),r=Fr(),o=r.enabled?da(e,r.mapping):ca(e),i=JSON.stringify(o,null,2)+`
`;return io(new Blob([i],{type:"application/json;charset=utf-8"}),po(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(Al,"exportScheduleJson");function Jn(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let i=Number(r[4]);if(i<1||i>30)return"";let s=_o(new Date);return s.setDate(s.getDate()-(i-1)*7),qr(s)}a(Jn,"deriveCurrentSemesterMonday");function Yn(t,e,r){let o=e||ir(t),i=Jn(o)||Ca()[o]||"";return jp(t,o,r,{firstMonday:i})}a(Yn,"normalizeScheduleDataForPage");function Sl(t){let e=t.semester.planCode,r=Ca()[e],o=Jn(e);return o?(Do(e,o),Promise.resolve(o)):pr(r)?Promise.resolve(r):new Promise((i,s)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||Ip(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let b=a((m,_)=>{l.remove(),m?s(m):i(_)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>b(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let m=l.querySelector("input").value;pr(m)&&(Do(e,m),b(null,m))}),l.addEventListener("click",m=>{m.target===l&&b(new Error("已取消导出"))})})}a(Sl,"requestScheduleFirstMonday");async function _l(t){let e=await Sl(t),r=Bp(t,e);return io(new Blob([r],{type:"text/calendar;charset=utf-8"}),po(t.semester.label)+".ics"),Fp(t)}a(_l,"exportScheduleIcs");let El={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function be(t,e,r){if(typeof document>"u")return Vt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let i=getComputedStyle(o).color;o.remove();let s=String(i||"").match(/[\d.]+/g)?.map(Number)||[];if(s.length>=3){let l=Er(s[0],s[1],s[2]),b=s.length>3?Math.max(0,Math.min(1,s[3])):1;return b<1?Ft(r||e,l,b):l}return Vt(i)||Vt(e)||"#000000"}a(be,"resolvedScheduleImageColor");function Qn(){let t=Jt(),e=te(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},i={bg:be("--bg",o.bg),surface:be(e==="neu"?"--neu-base":"--surface",o.surface),input:be("--input-bg",o.input),text:be("--text",o.text),secondary:be("--text-secondary",o.secondary),muted:be("--text-muted",o.muted),border:be("--border",o.border,be(e==="neu"?"--neu-base":"--surface",o.surface)),primary:be("--primary",o.primary)},s={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(El[e]||e)+" · "+(Pt[t]&&Pt[t].name||t),colors:i,shape:s[e]||s.apple}}a(Qn,"currentScheduleImageTheme");function Xn(t,e){return Yp(t,e||Qn())}a(Xn,"buildScheduleSvg");function Cl(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),i=URL.createObjectURL(o),s=new Image;s.onload=()=>{try{let b=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),m=document.createElement("canvas");m.width=Math.floor(t.width*b),m.height=Math.floor(t.height*b);let _=m.getContext("2d");_.scale(m.width/t.width,m.height/t.height),_.fillStyle=t.background||"#F8FAFC",_.fillRect(0,0,t.width,t.height),_.drawImage(s,0,0,t.width,t.height),m.toBlob(M=>M?e(M):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(i)}},s.onerror=()=>{URL.revokeObjectURL(i),r(new Error("课表图片渲染失败"))},s.src=i})}a(Cl,"svgToPngBlob");async function Pl(t){let e=await Cl(Xn(t));io(e,po(t.semester.label)+".png")}a(Pl,"exportSchedulePng");function so(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(so,"showFeatureToast");let lo=Qp({document,window,ensureStyles:ol,loadData:Vn,exportJson:Al,exportIcs:_l,exportPng:Pl,showToast:so,nativePageUrl:wl,navigate:a(t=>{location.href=t},"navigate"),logger:console});function zl(t,e,r,o){return lo.run(t,e,r,o)}a(zl,"runScheduleExport");function Ll(t){return lo.createMenu(t)}a(Ll,"createScheduleExportMenu");function ql(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(ql,"disposeNativePdfCapture");function Tl(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let i=fi(e);t.stage="ok",t.stageCards=i.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=i.target.querySelector("table")?i.target.querySelector("table").id:"none",ql(i)}catch(i){t.stage="failed",t.stageError=i&&i.message||String(i)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(Tl,"bindNativePdfDiagnose");function Ml(t){return t?(Tl(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await yi(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:br})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),so("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(Ml,"pagePdfExportHandler");function co(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(co,"isPersonalSchedulePage");function $l(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a($l,"isScoreQueryPage");function uo(){if(!co())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let i=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),s=Ll({source:"native",pdfHandler:Ml(i)});if(s.id="urppp-native-schedule-export",i&&i.parentElement){i.__urpppNativeExportState||(i.__urpppNativeExportState={display:i.style.getPropertyValue("display"),displayPriority:i.style.getPropertyPriority("display"),ariaHidden:i.getAttribute("aria-hidden"),tabIndex:i.getAttribute("tabindex")}),i.setAttribute("data-urppp-native-export-source","1"),i.style.setProperty("display","none","important"),i.setAttribute("aria-hidden","true"),i.setAttribute("tabindex","-1"),i.parentElement.insertBefore(s,i.nextSibling);return}if(e)e.appendChild(s);else if(t)t.appendChild(s);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let b=document.createElement("div");b.className="urppp-export-fallback",b.appendChild(s),l.prepend(b)}}}a(uo,"patchNativeScheduleExport");let Xe=null,aa=0;function mo(){clearTimeout(aa),aa=0,Xe&&Xe.observer.disconnect(),Xe=null}a(mo,"disconnectNativeScheduleExportObserver");function Il(){if(!co()){mo();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Xe&&Xe.root===t&&t.isConnected)return;mo();let e=new MutationObserver(()=>{clearTimeout(aa),aa=setTimeout(()=>uo(),80)});e.observe(t,{childList:!0,subtree:!0}),Xe={root:t,observer:e}}a(Il,"bindNativeScheduleExportObserver");function Kn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(Kn,"restoreOptionalAttribute");function Nl(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let i=o.__urpppNativeExportState;i&&(i.display?o.style.setProperty("display",i.display,i.displayPriority):o.style.removeProperty("display"),Kn(o,"aria-hidden",i.ariaHidden),Kn(o,"tabindex",i.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(Nl,"removeNativeScheduleExport");let Zn=ts({deps:{styles:zi,loadScores:mp,loadProfile:tp,scoreToNumber:Qe,scoreToGpa:Ye,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),Bl=Sp([ia({id:"schedule-export",matches:a(t=>co(t.location),"matches"),mount:a(()=>{uo(),Il()},"mount"),unmount:a(t=>{mo(),Nl(t?.lifecycleKey)},"unmount")}),ia({id:"score-analysis",matches:a(t=>$l(t.location),"matches"),mount:a(()=>{try{Zn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Zn.unmount()}catch{}},"unmount")})]);function oa(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return Bl.refresh({document,location,window,lifecycleKey:t})}a(oa,"refreshRouteFeatures");function Fl(t){lo.bindHosts(t)}a(Fl,"bindScheduleExportHosts");function vr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(vr,"normalizeProfileValue");function na(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(i=>vr(i).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let i=0;i<o.length;i++){let s=o[i],l=s.querySelector(".profile-info-name, th, label"),b=s.querySelector(".profile-info-value, td:last-child");if(!l||!b||l===b)continue;let m=vr(l.textContent).replace(/[：:]/g,"");if(!r.some(M=>m===M||m.endsWith(M)))continue;let _=vr(b.textContent);if(_&&_!=="—"&&_!=="-")return _}return""}a(na,"readLabeledProfileValue");function Ke(t){return vr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Ke,"cleanMajorPlanName");function Dl(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),i=vr(o);if(/主修必修GPA/.test(i)){let s=i.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||i.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(s){let l=Number(s[1]),b=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||b===0||l>0)&&(e.majorGpa=s[1])}}if(/主修为|培养方案/.test(i)){let s=i.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||i.match(/^(.{2,60}?)\s*主修为/)||i.match(/主修为\s*(.{2,60})$/),l=Ke(s&&s[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let b=/培养方案|教学计划/.test(l);(!e.majorPlan||b)&&(e.majorPlan=l)}}}),e}a(Dl,"extractAcademicOverview");async function tp(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let s=r.querySelector(".urppp-user-name-value"),l=s&&s.__urpppOriginalText;l&&(t.name=String(l).trim());let b=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),m=t.name?null:b.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!m){let _=r.cloneNode(!0);_.querySelectorAll("small, i, img, b, .badge").forEach(N=>N.remove());let M=(_.textContent||"").replace(/\s+/g," ").trim();M=M.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),m=M.match(/([\u4e00-\u9fa5·]{2,12})/)}m&&m[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(m[1])&&(t.name=m[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let i=Dl(document);t.majorPlan=i.majorPlan,t.majorGpa=i.majorGpa}catch{}try{let r=await Yt("/student/rollManagement/rollInfo/index"),o=ta(r),i=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=na(o,["姓名"]),!t.name)){let m=i.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);m&&(t.name=m[1].trim())}let s=na(o,["主修方案名称"]),l=na(o,["专业"]);if(t.studentId=na(o,["学号"]),t.studentId&&/^\d{6,20}$/.test(String(t.studentId)))try{GM_setValue("urppp_downs_sid",String(t.studentId))}catch{}s?t.majorPlan=Ke(s):!t.majorPlan&&l&&(t.majorPlan=Ke(l));let b=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(b&&b.getAttribute("src")&&!t.avatar){let m=b.getAttribute("src");t.avatar=/^https?:/i.test(m)?m:ao(m)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(tp,"loadProfile");let ep=["周日","周一","周二","周三","周四","周五","周六"];function bo(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(i=>{let s=String(i.id||"").match(/^(\d+)_(\d+)$/);if(!s)return;let l=parseInt(s[1],10),b=parseInt(s[2],10),m=l===7?0:l,_=i.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),M=_.length?_:[];if(!M.length&&(i.textContent||"").trim()){let N=(i.textContent||"").replace(/\s+/g," ").trim();N&&e.push({name:N.slice(0,40),teacher:"",place:"",week:"",day:m,section:b});return}M.forEach(N=>{let z=Array.from(N.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),B=(N.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",V=(N.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",O=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==V)||"",R=z.find(K=>/周/.test(K))||"",D=String(B).replace(/_\d+\s*$/,"").trim();!D||D.length<2||e.push({name:D,teacher:String(O).trim(),place:String(V||"").trim(),week:String(R).trim(),day:m,section:b})})});let o=new Set;return e.filter(i=>{let s=[i.day,i.section,i.name,i.place].join("|");return o.has(s)?!1:(o.add(s),!0)})}a(bo,"parseScheduleFromDoc");let rp="urppp_term_week_v1";function Ze(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(rp,e)}catch{}return e}a(Ze,"rememberTermWeek");function wr(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(rp,0))||0;if(t>=1&&t<=30)return Ze(t)}catch{}return 0}a(wr,"readRememberedTermWeek");function kr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let i=e.match(r[o]);if(i){let s=parseInt(i[1],10);if(s>=1&&s<=30)return s}}return 0}a(kr,"extractTermWeekFromText");function $e(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let b=t[l],m=kr(b.innerText||b.textContent||"")||kr(b.innerHTML||"");if(m)return Ze(m)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=kr(e);if(r)return Ze(r);let o=document.body&&document.body.innerText||"",i=kr(o);if(i)return Ze(i);let s=wr();if(s)return s}catch{}return 0}a($e,"getCurrentWeekNumber");let tr=null;function jl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(jl,"calTodayStr");function Ol(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(i=>String(i).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(Ol,"calAddDays");function Ar(t){if(tr)return tr;let e=t||jl();return e>="2027-02-06"&&e<=Ol("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(Ar,"calVacation");function Hl(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(Hl,"festiveDecorHtml");function ap(){let t=typeof document<"u"?document:null;if(!t)return;let e=Ar()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",Hl()):!e&&r&&r.remove()}a(ap,"syncFestiveDecor");function op(t){tr=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,tr&&tr!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{ap()}catch{}try{typeof rr=="function"&&rr()}catch{}return tr}a(op,"setCalendarPhase");function Rl(){return Ar()}a(Rl,"getCalendarPhase");function np(){if(Ar()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=$e()||wr()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(np,"getViewWeekNumber");async function Ul(){let t=$e();if(t>=1)return t;try{let e=await Yt("/index");if(t=kr(e),t)return Ze(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),i=await Yt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),s=JSON.parse(i),l=Number(s&&s.jxzc);if(l>=1&&l<=30)return Ze(l)}catch{}return wr()||0}a(Ul,"ensureTermWeekResolved");function Wl(t){let e=$e()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let i=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);i&&(e=Math.max(e,parseInt(i[2],10)||0));let s=String(r.week||"").match(/\d{1,2}/g);s&&s.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(Wl,"inferMaxWeek");function pp(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(pp,"weekBitActive");let ip=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function sp(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return ip[e%ip.length]}a(sp,"courseColor");function Gl(t){let e=[],r=$e();(t&&t.xkxx||[]).forEach(s=>{Object.keys(s||{}).forEach(l=>{let b=s[l];if(!b)return;let m=b.courseName||b.englishCourseName||l,_=b.attendClassTeacher||"";(b.timeAndPlaceList||[]).forEach(N=>{let z=Number(N.classDay)||0,B=z===7?0:z,V=Number(N.classSessions)||1,O=Math.max(1,Number(N.continuingSession)||1),R=[N.campusName,N.teachingBuildingName,N.classroomName].filter(Boolean).join(""),D=N.weekDescription||b.skzcs||"",K=pp(N.classWeek,r)||r&&D.indexOf(String(r))>=0;e.push({name:String(m).trim(),teacher:String(_).trim(),place:String(R).trim(),week:String(D).trim(),classWeek:String(N.classWeek||""),day:B,section:V,span:O,thisWeek:!!K,color:sp(m)})})})});let i=new Set;return e.filter(s=>{let l=[s.day,s.section,s.span,s.name,s.place,s.week].join("|");return i.has(l)?!1:(i.add(l),!0)})}a(Gl,"parseScheduleFromJson");async function Vl(){try{let t=await Yt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let i=Number(r&&(r.jxzc||r.zc||r.currentWeek));i>=1&&i<=30&&(nt._termWeek=Math.max(nt._termWeek||0,i),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=Gl(r)}catch{e=bo(ta(t))}e.length||(e=bo(document));let o=r?Yn(r,ir(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=bo(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(Vl,"loadSchedule");function Jl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),i=r.match(o);if(i&&i[1])return i[1];let s=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(s);return l?l[1]:""}a(Jl,"extractScoreCallback");function Yl(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let i=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",s=[];(o.cjList||[]).forEach(l=>{let b=l.courseName||l.englishCourseName||"";if(!b)return;let m=l.cj!=null&&l.cj!==""?String(l.cj):"";!m&&l.courseScore!=null&&(m=String(l.courseScore)),!m&&l.gradeName&&(m=String(l.gradeName)),!m&&l.zscj!=null&&(m=String(l.zscj));let _=l.courseAttributeName||l.xkcsxmc||"",M=parseFloat(l.credit)||0,N=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",B=l.gradePointScore!=null?Number(l.gradePointScore):null,V=ue(m)||ue(l.gradeName)||B!=null&&B<0,O=V?"未评估":m;s.push({code:N,seq:String(z||""),name:b,attr:_,credit:M,score:O,unevaluated:V,required:Dn(_),officialGpa:Kr(B)?B:null,evalUrl:""})}),s.length&&e.push({title:String(i).slice(0,100),courses:s,summary:oe(s),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(Yl,"parseScoreJson");async function lp(t,e){let r=await Yt(t),o=cp(ta(r));if(o.length)return o;let i=Jl(r,e);if(!i)return[];let s=await Yt(i);try{let l=JSON.parse(s);o=Yl(l).map(b=>(b.summary=oe(b.courses),b))}catch{o=cp(ta(s))}return o}a(lp,"loadScoreByIndex");function cp(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map(M=>(M.textContent||"").replace(/\s+/g,""));if(!o.length)return;let i=o.join("|");if(!/课程名/.test(i)||!/成绩/.test(i))return;let s={code:o.findIndex(M=>M==="课程号"),name:o.findIndex(M=>M==="课程名"),attr:o.findIndex(M=>/课程属性|属性/.test(M)),credit:o.findIndex(M=>M==="学分"),score:o.findIndex(M=>M==="成绩")};if(s.name<0||s.score<0)return;let l="成绩",b=r.previousElementSibling;for(let M=0;M<8&&b;M++,b=b.previousElementSibling)if(/^H[1-4]$/.test(b.tagName)||b.classList&&b.classList.contains("header")){l=(b.textContent||"").replace(/\s+/g," ").trim();break}let m=[],_=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(_).forEach(M=>{let N=Array.from(M.cells||M.querySelectorAll("td"));if(N.length<4)return;let z=a(D=>D>=0&&N[D]?(N[D].textContent||"").replace(/\s+/g," ").trim():"","get"),B=z(s.name),V=z(s.score);if(!B||!V||/课程名|序号/.test(B))return;let O=z(s.attr),R=ue(V);m.push({code:z(s.code),name:B,attr:O,credit:parseFloat(z(s.credit))||0,score:R?"未评估":V,unevaluated:R,required:Dn(O),officialGpa:null,evalUrl:""})}),m.length&&e.push({title:l.slice(0,100),courses:m,summary:oe(m)})}),e}a(cp,"parseScoreTables");function Sr(t){return Ke(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(Sr,"schemePlanName");function dp(t,e){if(!t||!t.length)return 0;let r=Ke(e),o=t.findIndex(l=>{let b=Sr(l);return/培养方案/.test(b)&&!/微专业|辅修|双学位/.test(b)});if(o>=0&&(!r||Sr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let b=Sr(l);return b.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(b.slice(0,4))||b.includes(r.slice(0,4))}),o>=0))return o;let i=0,s=-1;return t.forEach((l,b)=>{if(/微专业|辅修/.test(Sr(l)))return;let m=(l.courses||[]).length;m>s&&(s=m,i=b)}),i}a(dp,"pickMajorSchemeIndex");async function Ql(){let t={};try{let e=await Yt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(i=>{let s=String(i.KCH||"").trim();if(!s)return;let l=String(i.SFPG)==="1",b=String(i.KTID||"").trim();if(!t[s]){t[s]={ktid:b,kxh:String(i.KXH||""),kcm:i.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&b?"/student/teachingEvaluation/newEvaluation/evaluation/"+b:"/student/teachingEvaluation/newEvaluation/index"};return}t[s].total+=1,l||(t[s].pending+=1,t[s].done=!1,b&&(t[s].ktid=b,t[s].url="/student/teachingEvaluation/newEvaluation/evaluation/"+b))}),Object.keys(t).forEach(i=>{let s=t[i];s.done=!(s.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(Ql,"loadEvaluationMap");function Xl(t){if(!t)return!1;if(t.officialGpa!=null&&Kr(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ue(e)?!1:Qe(e)!=null||Ye(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(Xl,"hasDisplayableScore");function Kl(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(i=>{if(!i||!i.code)return;let s=e[i.code];if(s){if(Xl(i)){i.unevaluated=!1,s.done?i.evalUrl=i.evalUrl||"":i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index";return}s.done||(i.unevaluated=!0,i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index",(!i.score||i.score===""||ue(i.score))&&(i.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(Kl,"attachEvaluationLinks");function up(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=oe(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=oe(e.courses),e)),t)}a(up,"refreshScoreSummaries");async function Zl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await Ql();return Kl(t,e),t.evalMap=e,t.evaluationReady=!0,up(t)}finally{t.evaluationLoading=!1}}a(Zl,"enrichScoresWithEvaluation");function tc(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=dp(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let i=Sr(o),s=Ke(nt.profile.majorPlan);/培养方案|教学计划/.test(i)&&(!/培养方案|教学计划/.test(s)||s==="主修方案")&&(nt.profile.majorPlan=i);let l=o.summary||{},b=Number(l.requiredCredit),m=Number(l.requiredGpa),_=Number(nt.profile.majorGpa);b>0&&Number.isFinite(m)&&m>=0&&m<=5&&(!Number.isFinite(_)||_<=0)&&(nt.profile.majorGpa=String(Te(m)))}a(tc,"reconcileProfileAndScores");let er=null;async function mp(t){return t&&(er=null),er&&!er.error||(er=await ec()),er}a(mp,"loadScores");async function ec(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([lp("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),lp("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(i=>i.courses.forEach(s=>{o.push(Object.assign({term:i.title},s))})),t.passing=[{title:"全部及格成绩",courses:o,summary:oe(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:oe(o)}]),up(t),t.majorIdx=dp(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(ec,"loadScoresImpl");function Ie(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(Ie,"parseJsonArrayLoose");function bp(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let i=0;for(let s=o;s<t.length&&s<o+3e5;s++){let l=t[s];if(l==="[")i++;else if(l==="]"&&(i--,i===0))return t.slice(o,s+1)}return""}a(bp,"extractBalancedArray");async function rc(){let t=await Yt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let s=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(s&&(e=Ie(s)),l&&(r=Ie(l)),!e.length){let b=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);b&&(e=Ie(b[1]))}if(!r.length){let b=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);b&&(r=Ie(b[1]))}if(!r.length){let b=bp(t,"teachingBuildingName");b&&(r=Ie(b))}if(!e.length){let b=bp(t,"campusName");b&&(e=Ie(b))}}catch(s){console.warn("[URP++] classroom json parse",s)}if(!r.length){let s=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=s;let l=[];for(let b of s)try{let m=await Yt("/student/teachingResources/classroomCurriculum/"+b.campusNumber+"/teachingBuildingJson");Ie(m).forEach(M=>{l.push({id:{campusNumber:b.campusNumber,teachingBuildingNumber:String(M.id&&M.id.teachingBuildingNumber||M.teachingBuildingNumber||"")},teachingBuildingName:M.teachingBuildingName||M.name||""})})}catch(m){console.warn("[URP++] building json",b.campusNumber,m)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(s=>({campus:s.campusName||s.campusNumber,campusNumber:String(s.campusNumber||s.id&&s.id.campusNumber||""),buildings:[]}));r.forEach(s=>{let l=String(s.id&&s.id.campusNumber||s.campusNumber||""),b=String(s.id&&s.id.teachingBuildingNumber||s.teachingBuildingNumber||""),m=s.teachingBuildingName||s.name||b;if(!l||!b||!m)return;let _=o.find(N=>N.campusNumber===l);_||(_={campus:l,campusNumber:l,buildings:[]},o.push(_));let M="/student/teachingResources/classroomUseStatus/"+l+"/"+b+"/"+encodeURI(encodeURI(_.campus||l))+"/"+encodeURI(encodeURI(m));_.buildings.push({name:m,path:M,campusNumber:l,buildingNumber:b})});let i=o.filter(s=>s.buildings.length);if(!i.length)throw new Error("未解析到教学楼，请刷新后重试");return i}a(rc,"loadClassroomCatalog");function _r(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(_r,"occupancyTypeLabel");function ac(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return _r(t)}a(ac,"occupancyReason");async function oc(t,e,r,o){let i=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),s=await Yt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+i.toString());try{let l=JSON.parse(s);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(b=>b&&typeof b=="object"&&(b.kcm||b.id&&b.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(oc,"fetchClassroomCurriculum");function nc(t,e,r){let o=t||[],i=Number(e.xq)||0,s=Number(e.start)||0,l=Number(r)||0,b=[];return o.forEach(m=>{let _=m.id||{},M=Number(_.skxq!=null?_.skxq:m.skxq)||0,N=Number(_.skjc!=null?_.skjc:m.skjc)||0,z=Math.max(1,Number(m.cxjc)||1),B=_.skzc||m.skzc||"";i&&M&&i!==M||s&&(s<N||s>=N+z)||l&&B&&!ro(B,l)||b.push(m)}),b.length?(b.sort((m,_)=>{let M=ro(m.id&&m.id.skzc||m.skzc,l)?0:1,N=ro(_.id&&_.id.skzc||_.skzc,l)?0:1;return M-N}),b[0]):null}a(nc,"matchCurriculumCourse");async function pc(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),i=String(e.buildingNumber||""),s=r||t.planNumber||"";if(!o||!i||!s)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(B=>B.busy)),b={},m=a(async z=>{if(b[z])return b[z];try{b[z]=await oc(s,o,i,z)}catch{b[z]=[]}return b[z]},"queue"),_=4,M=0,N=new Array(Math.min(_,Math.max(l.length,1))).fill(0).map(async()=>{for(;M<l.length;){let z=M++,B=l[z],V=await m(B.name);(B.slots||[]).forEach(O=>{if(!O.busy)return;let R={xq:O.detail&&O.detail.xq||O.xq||0,start:O.section,week:t.jxzc};O.detail&&O.detail.xq!=null&&(R.xq=O.detail.xq);let D=nc(V,R,t.jxzc);if(D&&D.kcm){let K=String(D.kcm).trim();O.contentName=K,O.reason=K,O.displayChar=Zr(K),O.detail&&(O.detail.contentName=K,O.detail.reason=K,O.detail.teacher=D.jsm||"",O.detail.weeks=D.zcsm||"",O.detail.courseNo=D.id&&D.id.kch||"",O.detail.typeLabel=_r({occupancymoduleId:O.module}))}else O.displayChar=Zr(O.reason||"占用"),O.detail&&(O.detail.typeLabel=_r({occupancymoduleId:O.module}))})}});return await Promise.all(N),t}a(pc,"enrichOccupancyWithCurriculum");function ic(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(ic,"occupancyKindClass");async function sc(t){let e="",r="",o="",i="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",i=t.path||"";else{i=String(t||"");let D=i.match(/classroomUseStatus\/(\d+)\/(\d+)\//);D&&(e=D[1],r=D[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let s=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=lc(hp(new Date,s)),b="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),m=await new Promise((D,K)=>{let ut=ao("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:b,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(wt=>wt.status>=200&&wt.status<400?D(wt.responseText||""):K(new Error("HTTP "+wt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:b}).then(wt=>wt.text()).then(D).catch(K)}),_;try{_=JSON.parse(m)}catch{throw new Error("jasInfo 非 JSON")}let M=(_.classrooms||[]).map(D=>{let K=D.classroomName||D.id&&D.id.classroomNumber||"",ut=D.placeNum||"",wt=D.remark||"",Ct=[];for(let qt=1;qt<=12;qt++)Ct.push({section:qt,busy:!1});return{name:K,seats:ut,type:wt,slots:Ct,map:{}}}),N={};M.forEach(D=>{N[D.name]=D}),(_.classroomTime||[]).forEach(D=>{let K=D.id||{},ut=K.classroomNumber||"",wt=Number(K.sessionstart)||1,Ct=Math.max(1,Number(D.continuingsession)||1),qt=N[ut];if(!qt)return;let Tt=_r(D),Ht=ac(D);for(let Rt=wt;Rt<wt+Ct&&Rt<=12;Rt++){let $t=qt.slots.find(ne=>ne.section===Rt);$t&&($t.busy=!0,$t.kind=D.timestatenumber||D.occupancymoduleId||"",$t.module=D.occupancymoduleId||"",$t.reason=Ht,$t.typeLabel=Tt,$t.displayChar=Zr(Ht),$t.xq=K.xq,$t.weekBitmap=K.week||"",$t.detail={room:ut,section:Rt,start:wt,span:Ct,reason:Ht,typeLabel:Tt,week:K.week||"",xq:K.xq||"",state:D.timestatenumber||"",module:D.occupancymoduleId||""})}});let z="";try{let D=_.jhZxjxjhb;typeof D=="string"&&/\d{4}-\d{4}-\d-\d/.test(D)?z=D:D&&typeof D=="object"&&(z=String(D.zxjxjhh||D.jhxnxq||D.executiveEducationPlanNumber||D.planNumber||""))}catch{}if(!z&&_.classrooms&&_.classrooms[0]&&_.classrooms[0].id&&(z=_.classrooms[0].id.executiveEducationPlanNumber||""),_.jxzc!=null&&Number(_.jxzc)>=1){let D=Number(_.jxzc);nt._termWeek=Math.max(nt._termWeek||0,D),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let B=["日","一","二","三","四","五","六"],V=cc(_.date||l)||hp(new Date,s),O=_.week!=null?Number(_.week):V.getDay(),R=s===1?"明天":s===2?"后天":"今天";return{rooms:M,dateLabel:(_.date||l)+"（周"+(B[O]||O)+" · "+R+"）",jxzc:_.jxzc,planNumber:z,week:_.week!=null?_.week:O,searchDate:_.date||l,dateOffset:s}}a(sc,"loadBuildingOccupancy");function hp(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(hp,"addDays");function lc(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(lc,"formatLocalDate");function cc(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(cc,"parseLocalDate");let fp={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function gp(t){return fp[t]||fp.more}a(gp,"ico");let nt=qi();function dc(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=Ci,(document.head||document.documentElement).appendChild(t)}a(dc,"ensureStyle");let uc=xa({deps:{scoreToNumber:Qe,scoreToGpa:Ye}}),{metricHtml:mc,occupancyHtml:bc,render:rr,renderScheduleBoard:gd,roomPickerHtml:hc,scheduleRender:fc}=Ri({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:ep,analyzeScores:a(t=>uc.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Qt,bandsChartSvg:va,bindUI:a(t=>xc(t),"bindUI"),classifyPrivacyLabel:ea,courseColor:sp,ensureRoot:a(()=>yp(),"ensureRoot"),escapeHtml:at,firstContentChar:Zr,getViewWeekNumber:np,ico:gp,isCleanAnalysisDirect:Sa,occupancyKindClass:ic,occupancyTypeLabel:_r,personalizedProfile:yl,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Qe,summarizeCourses:oe,trendChartSvg:ya,weekBitActive:pp,calVacation:Ar,setCalendarPhase:op}}),{ensureRoomCatalogLoaded:xp,loadAll:gc}=Mi({state:nt,deps:{ensureTermWeekResolved:Ul,enrichScoresWithEvaluation:Zl,getCurrentWeekNumber:$e,loadClassroomCatalog:rc,loadProfile:tp,loadSchedule:Vl,loadScores:mp,readRememberedTermWeek:wr,reconcileProfileAndScores:tc,render:rr,scheduleRender:fc}}),{bindUI:xc,closeModal:yc,getRoomHost:xd,openModal:yd,openRoomModal:vd,openScoreModal:wd,showBuilding:kd}=Ui({state:nt,deps:{DAY_NAMES:ep,applyPersonalDisplay:Qt,bindScheduleExportHosts:Fl,closeCleanMode:a(()=>wc(),"closeCleanMode"),ensureRoomCatalogLoaded:xp,enrichOccupancyWithCurriculum:pc,ensureRoot:a(()=>yp(),"ensureRoot"),escapeHtml:at,fetchText:Yt,getCurrentWeekNumber:$e,getViewWeekNumber:np,inferMaxWeek:Wl,isUnevaluatedScore:ue,isValidOfficialGpa:Kr,loadBuildingOccupancy:sc,metricHtml:mc,occupancyHtml:bc,render:rr,rootEl:a(()=>kc(),"rootEl"),roomPickerHtml:hc,scoreToGpa:Ye,scoreToNumber:Qe,summarizeCourses:oe,summarizeCoursesPreferOfficial:oe}}),{cleanModeApi:vc,closeCleanMode:wc,ensureRoot:yp,injectCleanEntry:Ad,openCleanMode:Sd,rootEl:kc}=Wi({state:nt,deps:{CLEAN_FLAG:al,applySkinAttr:ae,closeModal:yc,ensureRoomCatalogLoaded:xp,ensureStyle:dc,getCurrentWeekNumber:$e,getSkin:te,handleThemeDotClick:ct,ico:gp,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:Oo,loadAll:gc,openSettingsPanel:xn,readRememberedTermWeek:wr,refreshCleanPersonalDisplay:no,render:rr,scoreToGpa:Ye,summarizeCourses:oe,syncNavbarThemeUI:xt,syncSettingsPanelUI:jt,syncThemeDotGroup:Z}});window.__urpppCleanMode=vc;function ho(){if(!document.body){setTimeout(ho,10);return}if(Ro(),Gt(Jt()),setTimeout(()=>{try{ze().then(e=>Pe(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],i=r.parentElement;for(;i;){let s=i.scrollTop,l=i.scrollLeft;(s||l||i.scrollHeight>i.clientHeight||i.scrollWidth>i.clientWidth)&&o.push({el:i,top:s,left:l}),i=i.parentElement}requestAnimationFrame(()=>{o.forEach(s=>{s.el.scrollTop=s.top,s.el.scrollLeft=s.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))Yo();else{_s();try{jn()}catch{}try{oa()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Qt(document)}catch{}try{ap()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{oa()}catch{}try{Qt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{Aa()&&Oo()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(ho,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(qe,50)}),window.addEventListener("load",()=>{qe(),Je(),setTimeout(qe,100),setTimeout(qe,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Je,0),setTimeout(Je,50),setTimeout(Je,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Je,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function vp(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let i=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),s=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));i&&!s&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){qe(),Fn(),st(),qe();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(s=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},s)),Na(),bn(),hn(),nn(),fn(),mn(),sn(),document.querySelectorAll(".page-content, #page-content-template").forEach(s=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);s.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),s.style.setProperty("box-sizing","border-box","important")}),Or(),Ur(),Ue(),setTimeout(Ue,300),setTimeout(Ue,1e3),Zo(),ve(),ur(),rn(),setTimeout(ur,300),mr(),setTimeout(()=>mr(),500),jr(),en();try{oa()}catch{}try{Qt(document)}catch{}setTimeout(()=>{try{oa()}catch{}try{Qt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...i){let s=r.apply(this,i);return e(),s},history.replaceState=function(...i){let s=o.apply(this,i);return e(),s}}a(vp,"watchRouteChanges");let ar=typeof unsafeWindow<"u"?unsafeWindow:window;ar.__urpppDebug=ar.__urpppDebug||{},ar.__urpppDebug.setCalendarPhase=t=>op(t),ar.__urpppDebug.getCalendarPhase=()=>Rl(),ar.__urpppDebug.calVacation=t=>Ar(t),ar.urppp={version:n,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Gt(t)},"apply"),setAccent:os,getAccent:Xt,getCurrent:Jt,list:a(()=>Object.entries(Pt).map(([t,e])=>({name:t,displayName:e.name,current:t===Jt()})),"list")},update:{check:to,auto:Za,showToast:Ka},privacy:{get:Ce,set(t){return Ea(t),Qt(document),Ce()},apply:a(()=>Qt(document),"apply"),identity:{get:je,set(t){return Fo(t),Qt(document),no(),je()}}},scheduleExport:{load:a(()=>Vn("api"),"load"),run:a(t=>zl(t,"api",null,null),"run"),patch:uo,image:{theme:Qn,build:a((t,e)=>Xn(t,e),"build")},jsonFormat:{get:Fr,set:jo,validate:Be,build(t,e){let r=la(t);if(e)return da(r,Be(e));let o=Fr();return o.enabled?da(r,o.mapping):ca(r)},buildDefault(t){return ca(la(t))}}}};function wp(){setTimeout(()=>{try{Za()}catch{}},1800)}a(wp,"scheduleAutoUpdateCheck");try{Ro()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{ho(),vp(),wp()}):(ho(),vp(),wp())})();})();
