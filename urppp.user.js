...
#urppp-settings-panel .urppp-store-repo{font-size:11px;color:var(--primary,#2563eb);text-decoration:none;cursor:pointer}
#urppp-settings-panel .urppp-store-repo:hover{text-decoration:underline}
#urppp-settings-panel .urppp-skin-meta .urppp-store-repo{font-size:11px}
    ...
    <div id="urppp-root">
      ...
      <div class="urppp-store-inline">
        ...
        <div class="urppp-store-item">
          <div class="urppp-store-info"><strong>${pt(o.name||o.id)}</strong>${o.author?`<span class="urppp-store-author">${pt(o.author)}</span>`:""}<span class="urppp-store-ver">${o.version?"v"+pt(o.version):""}</span><span class="urppp-store-state ok">已装</span>${o.repo?`<a class="urppp-store-repo" href="${pt(o.repo)}" target="_blank" rel="noopener noreferrer nofollow">仓库</a>`:""}</div>
