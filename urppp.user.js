...
`;var ai=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var oi=`.urppp-export-wrap{position:relative!important;display:inline-flex!important;align-items:center!important;flex:0 0 auto!important;margin-left:7px!important;font-weight:400!important;vertical-align:middle!important;white-space:nowrap!important}
...
`;var pi=`      /* 表格美化：业务表格、分页、公告卡片（table-beautify） */
...
`;var ii=`      /* 导航：顶栏、侧栏、面包屑（navigation） */
      /* 顶栏 —— 基于真实 DOM */
...
`;var si=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function ui(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(ui,"createCleanModeState");function mi(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(mi,"resetCleanModeData");function hi({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(k){p.catalog=p.catalog||[],p.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&mi(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let k=await n.ensureTermWeekResolved();!p.weekLocked&&k>=1&&(p.viewWeek=k)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(k){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(k){p.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}})(),(async()=>{let k=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),k=p.scores,n.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&n.enrichScoresWithEvaluation(k).then(()=>{p.scores===k&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(hi,"createCleanModeDataLoader");var nr={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},Tc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Cr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function gi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(gi,"calToday");function fo(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(fo,"calDayDiff");function go(p,n){let c=fo(nr[p].start,n);return c<0?0:Math.floor(c/7)+1}a(go,"calWeekNo");function ho(p){return Tc[p]||""}a(ho,"calLunar");function bi(p){return String(p||"").slice(5)}a(bi,"calYY");function $c(p){let n=p||gi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a($c,"calActiveTerm");function xo(p,n){let c=p&&nr[p]?p:"autumn",d=nr[c],u=n||gi(),k=d.events.map(g=>({e:g,d:fo(u,g.start)})).filter(g=>g.d>=-0).sort((g,w)=>g.d-w.d)[0],P=k?fo(u,k.e.start):null,_=go(c,u),y=Math.max(0,Math.min(100,_/d.weeks*100)),S=u>=d.start;return{term:d,termId:c,next:k,daysLeft:P,weekNo:_,progress:y,started:S,today:u}}a(xo,"calStatus");function xi(p,n){let c=xo(p,n),d=c.next?Cr[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(xi,"calendarSummaryHtml");function yi(p,n){let c=xo(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(yi,"calendarSummaryCompactHtml");function fi(p,n){let c=xo(p,n),d=c.next?Cr[c.next.e.t].color:"#c9cdd4",u=c.term,k=Object.keys(nr).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${nr[w].name}</button>`).join(""),P=`<div class="cal-widget">
    <div class="cal-w-left">
      ...
      <div class="cal-w-sub">${c.next?c.next.e.start+(c.next.e.end&&c.next.e.end!==c.next.e.start?" ~ "+c.next.e.end:""):""}${c.next&&ho(c.next.e.start)?" · "+ho(c.next.e.start):""}</div>
    </div>
    <div class="cal-w-mid">
  ...
  </div>`,_=u.events.slice().sort((w,$)=>w.start<$.start?-1:1),y={};_.forEach(w=>{(y[w.start.slice(0,7)]=y[w.start.slice(0,7)]||[]).push(w)});let S=a(w=>w===c.today?" cal-today":"","todayFlag"),g=Object.keys(y).map(w=>{let[,$]=w.split("-");return`<div class="cal-mon">
      <div class="cal-mon-label">${Number($)} 月</div>
      <div class="cal-mon-items">${y[w].map(C=>{let f=Cr[C.t].color,b=C.end&&C.end!==C.start?"~"+bi(C.end):"",v=go(c.termId,C.start)>0?`第 ${go(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
          <span class="cal-ev-dot" style="background:${f}"></span>
          <span class="cal-ev-date">${bi(C.start)}${b||""}<em>${ho(C.start)||"&nbsp;"}</em></span>
  ...
  </div>`}a(fi,"calendarModalHtml");function vi(p,n){let c=typeof document<"u"?document:null;if(!c)return;bo();let d=p&&nr[p]?p:$c(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${fi(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>bo()),u.addEventListener("click",k=>{let P=k.target;if(P&&P.closest&&P.closest(".cal-close")){bo();return}let _=P&&P.closest?P.closest("[data-cal-term]"):null;if(_){let y=u.querySelector(".cal-body");y&&(y.innerHTML=fi(_.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(S=>S.classList.toggle("ac",S.dataset.calTerm===_.dataset.calTerm))}})}a(vi,"openCalendarModal");function bo(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(bo,"closeCalendarModal");function wi(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),vi())})}a(wi,"bindCalendarOpen");var pa=!1;function yo(){let p=typeof document<"u"?document:null;if(!p||pa)return pa;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
  ...
  <div class="uc-bd">
    ...
    </div>`}a(w,"renderDesktop");function $(){let x=n.personalizedProfile(p.profile||{}),E=p.schedule&&p.schedule.courses||[],T=p.scores&&p.scores.passing&&p.scores.passing[0]||{summary:n.summarizeCourses([])},I=(p.scores&&p.scores.schemes||[])[p.activeSchemeIdx]||{summary:n.summarizeCourses([])},L=x.avatar?`<img src="${n.escapeHtml(x.avatar)}" alt="">`:`<span>${n.escapeHtml((x.name||"同")[0])}</span>`;if(p.mobileTab==="scores"){let O=`<div class="uc-score-grid uc-score-grid-mobile">
    ...
    </div>`}a($,"renderMobile");function C(){if(p.loading.room)return'<div class="uc-loading">教学楼加载中</div>';let x=p.catalog||[];return x.length?x.slice().sort((T,I)=>(/江安/.test(T.campus)?-1:0)-(/江安/.test(I.campus)?-1:0)).map(T=>`
    ...
    `,P.appendChild(g);let w=P.querySelector("#warningInfo");w&&document.body.appendChild(w),_.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let $=g.querySelector("#urppp-stats"),C=Math.max(S.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',$.appendChild(E)}function f(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&($.innerHTML="",x.forEach(E=>{let T=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),I=T[0]||"",L=T.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),M=/[\u4e00-\u9fa5]/.test(I)||I.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=p.statCardPrivacyMarkup(I,L);G.innerHTML=`<div class="${M}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,$.appendChild(G)}))}if(a(f,"updateStats"),f(),y){let x=new MutationObserver(()=>f());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let b=g.querySelector("#urppp-left"),v=g.querySelector("#urppp-right");u(_[5],b,"我的日程安排"),u(_[0],v,"通知公告"),u(_[1],v,"我的待办任务"),u(_[2],v,"可申请业务"),u(_[3],v,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(k,"rebuildDashboard"),{rebuildDashboard:k,refreshHomeFullCalendar:c,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(Ci,"createDashboardController");function we(p){return Math.round((Number(p)||0)*100)/100}a(we,"round2");var Mc=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],Pi={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},Ic=[{key:"required",label:"必修",test:a(p=>/必修/.test(p),"test")},{key:"elective",label:"任选",test:a(p=>/任选/.test(p),"test")},{key:"optional",label:"选修",test:a(p=>/选修/.test(p),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function zi(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d+)/);return n?`${n[1].slice(2)}-${n[2].slice(2)}-${n[3]}`:String(p||"")}a(zi,"shortTerm");function ia({deps:p}){let n=p.scoreToNumber,c=p.scoreToGpa;function d(f){let b=n(f);if(b!=null)return b;let v=String(f||"").trim().toUpperCase();return Pi[v]!=null?Pi[v]:null}a(d,"scoreToNumberWithLevels");function u(f){return!f||f.unevaluated?!1:d(f.score)!=null}a(u,"hasScore");function k(f){let b=String(f||"").match(/^(\d{4})-(\d{4})-(\d+)/);return b?[Number(b[1]),Number(b[3])]:[9999,9999]}a(k,"termOrderKey");function P(f){let b=f&&f.passing&&f.passing[0];return b&&b.courses||[]}a(P,"allCourses");function _(f){let b=f&&f.officialGpa,v=Number(b);return b!=null&&Number.isFinite(v)&&v>=0&&v<=5?v:null}a(_,"officialGpa");function y(f){let b=_(f);return b??c(f.score)}a(y,"courseGpa");function S({scorePack:f,profile:b}){let v=P(f),x=b&&b.majorGpa?String(b.majorGpa).trim():"",E=0,T=0,I=0,L=0,O=0,M=0;return v.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,T+=U*G;let et=y(H);et!=null&&(I+=et*G,L+=G,H.required&&(O+=et*G,M+=G))}),{majorGpa:x,requiredGpa:we(M?O/M:0),avgGpa:we(L?I/L:0),avgScore:we(E?T/E:0),totalCredit:we(E),courseCount:v.length}}a(S,"computeMetrics");function g(f){let b=new Map;return(f||[]).forEach(v=>{if(!u(v))return;let x=v.term||"未分组",E=b.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},b.set(x,E));let T=Number(v.credit)||0,I=d(v.score);if(I==null||(E.count+=1,T<=0))return;E.credit+=T,E.scoreW+=I*T;let L=y(v);L!=null&&(E.gpaW+=L*T,E.gpaCredit+=T)}),Array.from(b.values()).map(v=>({term:v.term,label:zi(v.term),count:v.count,credit:we(v.credit),avgScore:we(v.credit?v.scoreW/v.credit:0),avgGpa:we(v.gpaCredit?v.gpaW/v.gpaCredit:0)})).sort((v,x)=>{let E=k(v.term),T=k(x.term);return E[0]-T[0]||E[1]-T[1]})}a(g,"computeTrend");function w(f){let b=Mc.map(x=>({...x,count:0,credit:0}));(f||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let T=b.find(I=>E>=I.min&&E<=I.max);T&&(T.count+=1,T.credit+=Number(x.credit)||0)});let v=b.reduce((x,E)=>Math.max(x,E.count),1);return b.map(x=>({...x,ratio:Math.round(x.count/v*100)}))}a(w,"computeBands");function $(f){let b=Ic.map(T=>({...T,credit:0,count:0}));(f||[]).forEach(T=>{if(!u(T))return;let I=String(T.attr||""),L=b.find(O=>O.test(I));L&&(L.credit+=Number(T.credit)||0,L.count+=1)});let v=b.reduce((T,I)=>T+I.credit,0)||1,x=b.filter(T=>T.count>0).map(T=>({key:T.key,label:T.label,credit:we(T.credit),count:T.count,ratio:Math.round(T.credit/v*100)})),E=x.find(T=>T.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a($,"computeShare");function C({scorePack:f,profile:b}){let v=P(f);return{metrics:S({scorePack:f,profile:b}),trend:g(v),bands:w(v),share:$(v),empty:v.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:_,scoreToNumberWithLevels:d,shortTerm:zi}}a(ia,"createScoreAnalysisData");var ne="var(--text-secondary)",wo="var(--border)";function pe(p){return at(String(p??""))}a(pe,"escapeLabel");function Li(p,n,c){let d=!!(p&&p.variant==="mobile");if(n==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},_=Math.max(56,Number(p&&p.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,c)*_),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},k=Math.max(44,Number(p&&p.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,c)*k),height:236,pad:u}}a(Li,"resolveChartLayout");function vo({width:p,height:n,mobile:c,kind:d,label:u}){let k=c?` data-urppp-chart-layout="mobile" style="width:max(100%,${p}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${p} ${n}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${k}>`}a(vo,"openSvg");function sa({trend:p,palette:n,layout:c}){let d=(p||[]).filter(rt=>rt&&rt.avgScore!=null),u=Li(c,"trend",d.length),{width:k,height:P,pad:_,mobile:y}=u,S=k-_.left-_.right,g=P-_.top-_.bottom;if(!d.length)return`${vo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let w=d.length,$=a(rt=>_.left+(rt+.5)*(S/w),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),f=d.map(rt=>Number(rt.avgScore)||0),b=d.map(rt=>Number(rt.credit)||0),v=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...f)-4),T=Math.min(100,Math.max(...f)+4),I=Math.max(1,...b),L=x-v||1,O=T-E||1,M=a(rt=>_.top+g-(rt-v)/L*g,"yGpa"),H=a(rt=>_.top+g-(rt-E)/O*g,"yScore"),G=a(rt=>_.top+g-rt/I*g*.9,"yCredit"),U=d.map((rt,st)=>`${$(st)},${M(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${$(st)},${H(rt.avgScore)}`).join(" "),it=[0,.25,.5,.75,1].map(rt=>{let st=_.top+g-rt*g;return`<line x1="${_.left}" y1="${st.toFixed(1)}" x2="${k-_.right}" y2="${st.toFixed(1)}" stroke="${wo}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),mt=d.map((rt,st)=>{let gt=$(st),Z=y?Math.min(30,S/w*.42):Math.min(26,S/w*.32),dt=G(rt.credit);return`<rect x="${(gt-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(_.top+g-dt).toFixed(1)}" rx="3" fill="${n.credit}" opacity="0.55"/>
<text x="${gt.toFixed(1)}" y="${(dt-4).toFixed(1)}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.credit)}</text>`}).join(""),V=d.map((rt,st)=>`<text x="${$(st).toFixed(1)}" y="${P-16}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.label)}</text>`).join(""),Q=d.map((rt,st)=>{let gt=S/w,Z=$(st)-gt/2,dt=[`学期 ${rt.label}`,`课程 ${rt.count} 门`,`修读学分 ${rt.credit}`,`加权均分 ${rt.avgScore}`,`平均绩点 ${rt.avgGpa}`].join(`
`);return`<rect class="urppp-sa-hover" x="${Z.toFixed(1)}" y="${_.top}" width="${gt.toFixed(1)}" height="${g.toFixed(1)}" fill="transparent"><title>${pe(dt)}</title></rect>`}).join(""),ot=d.map((rt,st)=>`<circle cx="${$(st).toFixed(1)}" cy="${M(rt.avgGpa).toFixed(1)}" r="3.5" fill="${n.gpaLine}"/><text x="${$(st).toFixed(1)}" y="${(M(rt.avgGpa)-9).toFixed(1)}" text-anchor="middle" font-size="11.5" font-weight="600" fill="${n.gpaLine}">${pe(rt.avgGpa)}</text>`).join(""),X=d.map((rt,st)=>`<circle cx="${$(st).toFixed(1)}" cy="${H(rt.avgScore).toFixed(1)}" r="3" fill="${n.scoreLine}"/><text x="${$(st).toFixed(1)}" y="${(H(rt.avgScore)+17).toFixed(1)}" text-anchor="middle" font-size="11.5" fill="${n.scoreLine}">${pe(rt.avgScore)}</text>`).join(""),ct=y?`<g font-size="12">
...
</g>`;return`${vo({...u,kind:"trend",label:"学期成绩趋势"})}
${it}
${mt}
<g>${Q}</g>
...
<g>${V}</g>
${ct}
</svg>`}a(sa,"trendChartSvg");function la({bands:p,palette:n,layout:c}){let d=p||[],u=Li(c,"bands",d.length),{width:k,height:P,pad:_,mobile:y}=u,S=k-_.left-_.right,g=P-_.top-_.bottom,w=d.length||1,$=Math.max(1,...d.map(b=>b.count)),C=y?Math.min(32,S/w*.62):Math.min(40,S/w*.52),f=d.map((b,v)=>{let x=_.left+(v+.5)*(S/w),E=b.count?Math.max(8,b.count/$*g):0,T=_.top+g-E,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=b.range||(b.min===0?"<60":`${b.min}-${b.max===100?"100":b.max}`),O=[`${b.level||""}（绩点 ${b.gpa}）`,`百分制 ${L}`,`课程 ${b.count} 门`].join(`
...
<text x="${x.toFixed(1)}" y="${P-12}" text-anchor="middle" font-size="12" fill="${ne}">${pe(b.gpa)}</text>`}).join("");return`${vo({...u,kind:"bands",label:"成绩分段分布"})}
<line x1="${_.left}" y1="${(_.top+g).toFixed(1)}" x2="${k-_.right}" y2="${(_.top+g).toFixed(1)}" stroke="${wo}" stroke-width="1"/>
${f}
</svg>`}a(la,"bandsChartSvg");function qi({items:p,requiredRatio:n,palette:c}){let _=2*Math.PI*56,y=(p||[]).filter($=>$&&$.ratio>0),S=Math.max(0,Math.min(100,Math.round(Number(n)||0)));if(!y.length)return'<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成"></svg>';let g=-90,w=y.map($=>{let C=$.ratio/100*_,b=`<circle cx="75" cy="75" r="56" fill="none" stroke="${c.share&&c.share[$.key]||c.required}" stroke-width="24"
  stroke-dasharray="${C.toFixed(2)} ${_.toFixed(2)}"
  stroke-linecap="butt" transform="rotate(${g.toFixed(2)} 75 75)"/>`;return g+=$.ratio/100*360,b}).join("");return`<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成">
<circle cx="75" cy="75" r="56" fill="none" stroke="${wo}" stroke-width="24"/>
${w}
...
</svg>`}a(qi,"donutSvg");var Nc=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),Bc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',Fc='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function Ti({deps:p}){let n=p&&p.palette||Nc;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
...
<div class="urppp-sa-grid">
  ...
  `;function _(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(_,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function g(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=_("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=_("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(g,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{g(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",$="urppp_accent_v1",C="urppp_accent_presets_v1",f="urppp_scheme_v1",b="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",T="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",M="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:gt,syncThemeDotGroup:Z}=Fi({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Kt,getAccent:Qt,getBrutalActivePalette:Lo,getBrutalPaletteById:ir,getBrutalSelectedPalette:zo,getCurrent:Jt,getScheme:Ie,getSkin:Zt,isThemeModeAvailable:pr,setBrutalPalette:qo,skinSupportsDark:Be,skinSupportsDynamic:Fe,skinSupportsFixedPalettes:Po},settings:{ensureSettingsPanel:on,openSettingsPanel:en,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let j=document.createElement("li");j.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",j.appendChild(o),r.appendChild(j)}let l=o.closest("li")||o.parentElement,h=Array.from(r.children).find(j=>{let R=j.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),m=Array.from(r.children).find(j=>j.classList.contains("light-blue")),A=h||m||null;A&&l&&A!==l&&((l.compareDocumentPosition(A)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,A)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let q=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),q&&s.parentElement!==q&&q.appendChild(s),q&&q.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let N=s.querySelector("#search-input"),z=s.querySelector("form");if(!N||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let D=s.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),N.style.setProperty("display","block","important"),N.style.setProperty("width","100%","important"),N.style.setProperty("height","36px","important"),N.style.setProperty("box-sizing","border-box","important"),N.style.setProperty("padding","0 12px","important"),N.style.setProperty("border","1px solid var(--border)","important"),N.style.setProperty("border-radius","var(--radius-sm)","important"),N.style.setProperty("background","var(--input-bg)","important"),N.style.setProperty("color","var(--text)","important");let J=a(j=>{s.dataset.open=j?"1":"0",s.style.setProperty("width",j?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",j?"1":"0","important"),s.style.setProperty("pointer-events",j?"auto":"none","important"),i.setAttribute("aria-expanded",j?"true":"false"),j&&setTimeout(()=>N.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",j=>{j.preventDefault(),j.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",j=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(j.target)||F?.contains(j.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    <div id="urppp-root">
    ...
    </div>`}a(pn,"storeManageSettingsHtml");let gs=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];function ur(){try{let t=JSON.parse(GM_getValue("urppp_store_sources","[]"));return Array.isArray(t)?t:[]}catch{return[]}}a(ur,"getCustomSources");function Ma(t){try{GM_setValue("urppp_store_sources",JSON.stringify(t))}catch{}}a(Ma,"saveCustomSources");let _e=null;async function ge(t){if(_e&&!t)return _e;let e=a((q,N)=>Promise.race([q,new Promise((z,D)=>setTimeout(()=>D(new Error("timeout")),N))]),"withTimeout"),r=a(async q=>{try{let N=await e(fetch(q,{cache:"no-store"}),5e3);if(!(N&&N.ok))return null;let z=await N.json();return z&&Array.isArray(z.items)?z:null}catch{return null}},"fetchCatalogDoc"),o=await Promise.allSettled(gs.map(q=>r(q))),i=null;for(let q of o){if(!(q.status==="fulfilled"&&q.value&&Array.isArray(q.value.items)))continue;let N=q.value.items.some(z=>z.type==="theme"&&z.cardCss);(!i||N&&!i.items.some(z=>z.type==="theme"&&z.cardCss))&&(i=q.value)}let s=i&&i.items||[],l=ur().filter(q=>q&&q.url&&q.enabled!==!1),h=await Promise.allSettled(l.map(async q=>{let N=await r(q.url);return{doc:N,pubkey:N?N.pubkey:""}})),m=[...s],A=new Set(m.map(q=>q&&q.id).filter(Boolean));for(let q of h){if(!(q.status==="fulfilled"&&q.value&&q.value.doc))continue;let N=q.value.pubkey||"";for(let z of q.value.doc.items)!z||!z.id||A.has(z.id)||(A.add(z.id),N&&(z._srcPub=N),m.push(z))}return _e=m,m}a(ge,"fetchCatalogList");function xs(){try{if(typeof crypto<"u"&&crypto&&crypto.subtle)return crypto.subtle;let t=typeof unsafeWindow<"u"&&unsafeWindow?unsafeWindow:typeof window<"u"?window:null;if(t&&t.crypto&&t.crypto.subtle)return t.crypto.subtle}catch{}return null}a(xs,"getWebCrypto");function Ia(t){if(Array.isArray(t))return t.map(Ia);if(t&&typeof t=="object"){let e={};for(let r of Object.keys(t).filter(o=>o!=="signature"&&o!=="_srcPub").sort())e[r]=Ia(t[r]);return e}return t}a(Ia,"normalizeEntry");function sn(t){try{let e=atob(t),r=new Uint8Array(e.length);for(let o=0;o<e.length;o+=1)r[o]=e.charCodeAt(o);return r}catch{return null}}a(sn,"b64ToU8");async function ys(t,e){let r=xs();if(!r)return null;if(!e||!t||!t.signature)return!1;try{let o=sn(e);if(!o)return null;let i=await r.importKey("raw",o,{name:"Ed25519"},!1,["verify"]),s=sn(t.signature);if(!s)return!1;let l=JSON.stringify(Ia(t)),h=await r.digest("SHA-256",new TextEncoder().encode(l)),m=new Uint8Array(h);return await r.verify({name:"Ed25519"},i,s,m)}catch{return null}}a(ys,"verifyEntrySignature");function Re(t,e){try{let r=document.getElementById("urppp-toast");r||(r=document.createElement("div"),r.id="urppp-toast",r.className="urppp-toast",(document.body||document.documentElement).appendChild(r)),r.textContent=t,r.className="urppp-toast show"+(e==="error"?" error":""),clearTimeout(r._t),r._t=setTimeout(()=>{r.className="urppp-toast"},3200)}catch{try{window.alert(t)}catch{}}}a(Re,"toast");function ln(t){return new Promise(e=>{try{let r=document.getElementById("urppp-confirm");r||(r=document.createElement("div"),r.id="urppp-confirm",r.className="urppp-confirm",r.innerHTML='<div class="urppp-confirm-txt"></div><div class="urppp-confirm-ops"><button type="button" class="urppp-set-btn ghost" data-cac>取消</button><button type="button" class="urppp-set-btn" data-ok>继续</button></div>',(document.body||document.documentElement).appendChild(r)),r.querySelector(".urppp-confirm-txt").textContent=t,r.classList.add("show");let o=a(i=>{r.classList.remove("show"),r.querySelector("[data-ok]").onclick=r.querySelector("[data-cac]").onclick=null,e(i)},"done");r.querySelector("[data-ok]").onclick=()=>o(!0),r.querySelector("[data-cac]").onclick=()=>o(!1)}catch{try{e(window.confirm(t))}catch{e(!1)}}})}a(ln,"confirmBottom");async function cn(t){let e=t&&t._srcPub;if(!e)return"trust";let r=await ys(t,e);return r===!0?"ok":r===!1?"fail":"unknown"}a(cn,"guardEntrySignature");function dn(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let i=0;i<Math.max(r.length,o.length);i+=1){let s=r[i]||0,l=o[i]||0;if(s!==l)return s>l}return!1}a(dn,"versionGt");function vs(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let i=t.querySelector('[data-theme-use="'+o.id+'"]');i&&dn(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(un(i.closest(".urppp-skin-card"),"主题"),r+=1);let s=t.querySelector('[data-plugin-id="'+o.id+'"]');if(s){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&dn(o.version,l.version)&&(un(s.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(vs,"applyStoreUpdateBadges");function un(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(un,"addUpdateBadge");function mn(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),i=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");i(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),i()}),r.addEventListener("click",async()=>{r.disabled=!0;let s=r.textContent;r.textContent="检查中…";try{let l=await ge(),h=vs(t,l);r.textContent=h?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=s,r.disabled=!1},1600)})}a(mn,"bindStoreManageSettings");function ws(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${pn()}<button type="button" class="urppp-set-btn ghost" data-add-local-theme style="width:100%;margin:0 0 10px">＋ 添加本地主题</button><input type="file" accept=".css,.txt" data-local-theme-file style="display:none"><div class="urppp-store-bd"><div id="urppp-theme-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div></div>
          <div class="urppp-store-pane" data-pane="sources" style="display:none">${hn()}</div>
        </div>
      </div>`,nn(t),mn(t),ks(t),bn(t),$a(t),jr(t.querySelector("#urppp-theme-manage"))}a(ws,"renderThemeStoreBody");function hn(){let t=ur();return`<div class="urppp-src-manage">
    ...
    </div>`}a(hn,"storeSourcesHtml");function bn(t){let e=t.querySelector("[data-src-add]");if(e){let r=t.querySelector("[data-src-url]"),o=t.querySelector("[data-src-name]");e.addEventListener("click",async()=>{let i=(r.value||"").trim();if(!i)return;e.disabled=!0;let s=e.textContent;e.textContent="验证中…";try{let l=await fetch(i,{cache:"no-store"});if(!(l&&l.ok))throw new Error("无法访问");let h=await l.json();if(!(h&&Array.isArray(h.items)))throw new Error("不是合法 catalog（无 items）");let m=ur();if(m.some(A=>A.url===i)){Re("该源已存在");return}m.push({name:(o.value||"").trim()||i,url:i,enabled:!0}),Ma(m),_e=null,Na(t)}catch(l){Re("添加失败："+(l&&l.message?l.message:l),"error")}finally{e.disabled=!1,e.textContent=s}})}t.querySelectorAll("[data-src-toggle]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcToggle),i=ur();i[o]&&(i[o].enabled=i[o].enabled===!1,Ma(i),Na(t))})),t.querySelectorAll("[data-src-del]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcDel),i=ur();i[o]&&(i.splice(o,1),Ma(i),Na(t))}))}a(bn,"bindStoreSources");function Na(t){let e=t.querySelector('[data-pane="sources"]');if(e){let r=t;e.innerHTML=hn(),bn(r)}}a(Na,"refreshStoreSources");function ks(t){let e=t.querySelector("[data-add-local-theme]"),r=t.querySelector("[data-local-theme-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text(),s=i.match(/html\[data-urppp-skin="([\w-]+)"\]/);if(!s){Re('未能从 CSS 中识别主题 id（需要 html[data-urppp-skin="…"]）',"error"),r.value="";return}let l=s[1];try{GM_setValue("urppp_theme_css_"+l,i)}catch{}Eo(l,{name:l,desc:"本地主题",author:"本地",version:"1.0.0"});try{xa(l).textContent=i}catch{}r.value="";try{jr(t.querySelector("#urppp-theme-manage"))}catch{}}))}a(ks,"bindLocalThemeImport");function As(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
      ...
      <div class="urppp-store-inline">
        ...
        <div class="urppp-store-body">
          <div class="urppp-store-pane" data-pane="download"><div class="urppp-store-empty"><p class="urppp-store-empty-title">加载中…</p></div></div>
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${pn()}<button type="button" class="urppp-set-btn ghost" data-add-local-plugin style="width:100%;margin:0 0 10px">＋ 添加本地插件</button><input type="file" accept=".js,.txt" data-local-plugin-file style="display:none"><div class="urppp-store-bd" id="urppp-plugin-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div>
        </div>
      </div>`,nn(t),mn(t),_s(t),Ss(t.querySelector('[data-pane="download"]')),fn(t.querySelector("#urppp-plugin-manage"))}a(gn,"renderPluginStoreBody");function _s(t){let e=t.querySelector("[data-add-local-plugin]"),r=t.querySelector("[data-local-plugin-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text();r.value="";try{new Function(i)()}catch(s){Re("本地插件加载失败："+(s&&s.message?s.message:s),"error")}try{fn(t.querySelector("#urppp-plugin-manage"))}catch{}}))}a(_s,"bindLocalPluginImport");function Es(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>Ta("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=Zt();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}let i=be(),s=u.filter(l=>l.installed!==!1||he(l.id)).concat(Object.keys(i).filter(l=>!u.some(h=>h.id===l)).map(l=>({id:l,name:i[l].name||l,desc:i[l].desc||"本地主题",version:i[l].version||"1.0.0",installed:!1})));s.forEach(l=>{let h=!!i[l.id],m=document.createElement("div");m.className="urppp-skin-card"+(l.id===o?" is-active":""),m.dataset.skin=l.id;let A=document.createElement("button");A.type="button",A.className="urppp-skin-apply";let q=l.installed!==!1||he(l.id)||h;q?l.id===o&&(l.ready||h)?(A.classList.add("is-current"),A.textContent="使用中",A.disabled=!0):A.textContent="应用主题":(A.classList.add("is-disabled"),A.textContent="去下载"),A.addEventListener("click",N=>{if(N.preventDefault(),N.stopPropagation(),!q){Ta("theme");return}if(!(l.id===o&&l.ready)&&To(l.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),m.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),m.querySelector(".urppp-skin-name").textContent=l.name,m.querySelector(".urppp-skin-desc").textContent=l.desc,m.appendChild(A),r.appendChild(m)});try{let l=s.map(h=>{let m="";try{m=GM_getValue("urppp_card_css_"+h.id,"")||""}catch{}return{id:h.id,cardCss:m}});Se(l)}catch{}}a(Es,"renderSkinCards");let Ue=[],Ba=!1;function Cs(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,i=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(s=>{if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).finally(()=>{i&&clearTimeout(i)})}a(Cs,"fetchWithTimeout");function Ps(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(i=>{i.status>=200&&i.status<400?r(i.responseText||""):o(new Error("HTTP "+i.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(i){o(i)}})}a(Ps,"gmRequestForUpdate");function zs(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),Cs(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return Ps(t,r);throw o})}a(zs,"fetchTextForUpdate");async function Fa(t,e,r=1e3){let o=[],i=t[0],s=t.slice(1),l=a(z=>zs(z,e).then(D=>({url:z,text:D})).catch(D=>(o.push((z.split("/")[2]||z)+": "+(D&&D.message||D)),null)),"grab"),h=l(i),m=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),A=await Promise.race([h,m]);if(A!=="__TIMEOUT__"){if(A&&A.text&&A.text.length>0)return A.text;let D=(await Promise.all(s.map(l))).find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let q=Promise.all(s.map(l)).then(z=>{let D=z.find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),N=h.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([N,q])}a(Fa,"fetchFirstAvailable");function Ee(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(Ee,"setUpdateStatus");async function Da(){let t=p,e="",r=!1,o="";try{let s=await Fa(n.sourceUrls(n.versionJson)),l=JSON.parse(s);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let s=await Fa(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=no(s)}if(!e)throw new Error("无法解析远程主插件版本");let i=wr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:i>0?"update":i===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:r?o:""}}a(Da,"checkMainUpdate");function xn(t,e,r){let o=String(t||"").replace(/\r\n/g,`
...
`).trim()}a(xn,"extractChangelogRange");function yn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(yn,"ensureUpdateToastStyles");function Ls(t){let e=String(t||"").replace(/\r\n/g,`
...
`),i=[],s=!1,l=a(()=>{s&&(i.push("</ul>"),s=!1)},"closeList");for(let h=0;h<o.length;h++){let A=o[h].replace(/\s+$/,"");if(!A.trim()){l();continue}let q=A.match(/^(#{2,3})\s+(.+)$/);if(q){l();let z=q[1].length,D=q[2];i.push(z===2?`<h2>${r(D)}</h2>`:`<h3>${r(D)}</h3>`);continue}let N=A.match(/^[-*]\s+(.+)$/);if(N){s||(i.push("<ul>"),s=!0),i.push(`<li>${r(N[1])}</li>`);continue}l(),i.push(`<p>${r(A)}</p>`)}return l(),i.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(Ls,"renderChangelogMarkdown");function vn(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(vn,"hideUpdateToast");function qs(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="background-color"&&i.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(qs,"hideChangelogModal");function wn(t,e){yn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>vn(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let i=o.getAttribute("data-act"),s=e.__pack||{};if(i==="later"){vn(e);return}if(i==="go"){let l=s.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(i==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=s.changelogMd;l||(l=await Fa(n.sourceUrls("CHANGELOG.md")),s.changelogMd=l);let h=xn(l,s.local,s.remote),m=h?Ls(h):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';wn("更新日志 "+s.local+" → "+s.remote,m)}catch(l){wn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(ja,"showUpdateToast");async function Oa(){if(ha()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await Da();t&&t.status==="update"&&ja(t);let e=await Ts();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Oa,"maybeAutoCheckUpdate");function Ts(){let t=(window.__urpppUpdateCheckers||Ue||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?_t.update("assist"):null).catch(()=>null)}a(Ts,"hotUpdateAssist");async function Ha(){if(Ba)return;Ba=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Ee("正在从多源检查更新…");try{let e=[Da()];(Ue||[]).forEach(m=>{m&&typeof m.check=="function"&&e.push(Promise.resolve().then(()=>m.check()).then(A=>A||{id:m.id||"extra",name:m.name||"扩展",status:"err",message:"无结果"}).catch(A=>({id:m.id||"extra",name:m.name||"扩展",status:"err",message:String(A&&A.message||A)})))});let r=await Promise.all(e),o=r.map(m=>{if(!m)return"";if(m.status==="err")return`• <b>${at(m.name||m.id)}</b>：检查失败（${at(m.message||"unknown")}）`;if(m.status==="update"){let A="";if(m.id==="assist"&&_t&&_t.loaded("assist"))A=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let q=m.updateUrl?` <a href="${at(m.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",N=m.pageUrl?` <a href="${at(m.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";A=q+N}return`• <b>${at(m.name)}</b>：发现新版本 <b>${at(m.remote)}</b>（当前 ${at(m.local)}）${A}`}return m.status==="ahead"?`• <b>${at(m.name)}</b>：本地 ${at(m.local)} 新于远程 ${at(m.remote)}`:`• <b>${at(m.name)}</b>：已是最新（${at(m.local)}）`}).filter(Boolean),i=r.some(m=>m&&m.status==="update"),s=r.some(m=>m&&m.status==="err");Ee(`${i?"检查完成：发现更新":s?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,s?"err":"ok");let h=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');h&&h.addEventListener("click",()=>{try{Ee("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{Ee("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(m=>{Ee("重新装载失败："+(m&&m.message?m.message:m),"err")})}catch(m){Ee("重新装载失败："+(m&&m.message?m.message:m),"err")}})}catch(e){Ee("检查失败："+at(e&&e.message||e),"err")}finally{Ba=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(Ha,"checkForUpdates");function kn(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+p,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(kn,"refreshUpdateStatusHint");function $s(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=Ue.findIndex(i=>i&&i.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?Ue[r]=o:Ue.push(o);try{let i=document.getElementById("urppp-set-update-status");i&&o.localVersion&&e==="assist"&&i.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{kn()}catch{}return!0}a($s,"registerUpdateChecker");function Ms(){let t={version:p,urls:n,check:Ha,checkMain:Da,registerChecker:$s,compareVersions:wr,parseUserscriptVersion:no,extractChangelogRange:xn,showUpdateToast:ja,maybeAutoCheckUpdate:Oa,listCheckers:a(()=>Ue.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(Ms,"publishUpdateApi"),Ms();let{rebuildSidebarCompletely:An,syncMobileContentOffset:We,syncSidebarUnderNavbar:Ce}=Bi({}),{rebuildDashboard:Is}=Ci({deps:{statCardPrivacyMarkup:js}}),Ns="urppp-clean-open",Ra={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ie(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ie,"isUnevaluatedScore");function Or(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Or,"isValidOfficialGpa");function Hr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Hr,"firstContentChar");function Ua(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Ua,"weekBitmapActive");function Ge(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ie(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Ra[o]!=null?Ra[o]:Ra[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ge,"scoreToGpa");function Je(t){let e=String(t||"").trim();if(!e||ie(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(Je,"scoreToNumber");function Pe(t){return Math.round((Number(t)||0)*100)/100}a(Pe,"round2");function Sn(t){return/必修/.test(String(t||""))}a(Sn,"isRequiredAttr");function re(t){let e=0,r=0,o=0,i=0,s=0,l=0,h=0,m=0;return(t||[]).forEach(A=>{if(A&&(A.unevaluated||ie(A.score)))return;let q=Number(A.credit)||0,N=Je(A.score),z=Or(A.officialGpa)?Number(A.officialGpa):Ge(A.score);N==null||q<=0||(e+=q,r+=N*q,z!=null&&(o+=z*q,i+=q),A.required&&(s+=q,l+=N*q,z!=null&&(h+=z*q,m+=q)))}),{totalCredit:Pe(e),avgScore:Pe(e?r/e:0),avgGpa:Pe(i?o/i:0),requiredCredit:Pe(s),requiredGpa:Pe(m?h/m:0),requiredAvg:Pe(s?l/s:0),count:(t||[]).length}}a(re,"summarizeCourses");function Wa(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Wa,"absUrl");function Vt(t,e){let r=Wa(t),o=e&&e.method||"GET",i=e&&e.data||null;return new Promise((s,l)=>{let h=a((m,A)=>m?s(A):l(new Error(A||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:i||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(m=>{m.status>=200&&m.status<400?h(!0,m.responseText||""):h(!1,"HTTP "+m.status)},"onload"),onerror:a(()=>h(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:i||void 0}).then(m=>{if(!m.ok)throw new Error("HTTP "+m.status);return m.text()}).then(m=>h(!0,m)).catch(m=>h(!1,m&&m.message))})}a(Vt,"fetchText");function Rr(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Rr,"parseHtml");function _n(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=ei,(document.head||document.documentElement).appendChild(t)}a(_n,"ensureFeatureStyles");function Bs(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=oi,(document.head||document.documentElement).appendChild(t)}a(Bs,"ensureScheduleExportStyles");function Fs(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=ni,(document.head||document.documentElement).appendChild(t)}a(Fs,"ensureSettingsStyles");function En(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let i=r.cloneNode(!0);i.querySelectorAll("small, i, img, b, .badge").forEach(h=>h.remove());let s=(i.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(h=>{h.nodeType===Node.TEXT_NODE&&h.textContent.trim()&&h.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=s||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(En,"ensureNavNameTarget");function Ur(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Ur,"classifyPrivacyLabel");function Ds(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(Ds,"classifyHomeDataKey");function Wr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Wr,"homePrivateValueSpan");function js(t,e){let r=at(t),o=at(e),i=Ds(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[i]||Ur(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:Wr("organization",i,o)}:{valueHtml:Wr("organization",i,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let h=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&h){let A=h.index||0,q=String(e).slice(0,A),N=String(e).slice(A+h[0].length);return{valueHtml:r,labelHtml:`${at(q)}${Wr(l,i,at(h[0]))}${at(N)}`}}return{valueHtml:Wr(l,i,r),labelHtml:o}}a(js,"statCardPrivacyMarkup");function ze(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||_r;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||_r)}a(ze,"privacyReplacement");function mr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(mr,"markPrivateText");function Cn(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||_r);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(Cn,"markPrivateAvatar");function Os(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(Os,"markPrivateBlock");function Hs(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(Hs,"markDirectEditable");let xe=null;function Pn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;xe&&xe.__finish&&xe.__finish(!1);let r=Ae();if(r.mode!=="custom"||!r.directEdit.enabled)return;let i=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),s=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),h=s.height>=8||!l?s:{left:s.left,top:l.top,width:Math.max(s.width,40),height:l.height},m=document.createElement("input"),A=getComputedStyle(t),q=Math.min(Math.max(h.width+64,140),Math.max(140,window.innerWidth-24)),N=Math.min(Math.max(12,h.left),Math.max(12,window.innerWidth-q-12)),z=Math.min(Math.max(12,h.top+(h.height-36)/2),Math.max(12,window.innerHeight-48));m.type="text",m.maxLength=80,m.className="urppp-direct-edit-input",m.value=i,m.setAttribute("aria-label","修改"+U[e]+"显示值"),m.style.left=N+"px",m.style.top=z+"px",m.style.setProperty("--urppp-direct-edit-width",q+"px"),m.style.fontFamily=A.fontFamily,m.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(A.fontSize)||14)))+"px";let D=!1,J=a(j=>{if(D||(D=!0,m.remove(),xe===m&&(xe=null),j))return;let R=Ae();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(m.value||"").trim().slice(0,80),ba(R),Yt(document),Qa(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");m.__finish=J,m.addEventListener("click",j=>j.stopPropagation()),m.addEventListener("blur",()=>J(!1)),m.addEventListener("keydown",j=>{j.key==="Enter"&&(j.preventDefault(),J(!1)),j.key==="Escape"&&(j.preventDefault(),J(!0))}),document.documentElement.appendChild(m),xe=m,m.focus(),m.select()}a(Pn,"openDirectEditInput");function Rs(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Pn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Pn(e))},!0))}a(Rs,"bindDirectEditInteraction");function Us(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(Us,"clearPrivacyDisplay");function zn(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(zn,"applyCustomText");function Ws(t){let e=t&&t.querySelectorAll?t:document,r=Ne(),i=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?En(e):null);zn(i,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(h=>{let m=h.querySelector(".profile-info-name"),A=h.querySelector(".profile-info-value");!m||!A||String(m.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||zn(A,r.nameEnabled,r.name)});let s=or(r.avatar),l=r.avatarEnabled&&!!s;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(h=>{let m=h.getAttribute("src")||"";m&&m!==h.__urpppAppliedCustomSrc&&(h.__urpppOriginalSrc=m),l?(h.__urpppOriginalSrc==null&&(h.__urpppOriginalSrc=m),m!==s&&h.setAttribute("src",s),h.__urpppAppliedCustomSrc=s):h.__urpppAppliedCustomSrc!=null&&(h.__urpppOriginalSrc&&h.setAttribute("src",h.__urpppOriginalSrc),delete h.__urpppAppliedCustomSrc)})}a(Ws,"applyCustomIdentityDisplay");function Gs(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),i=r.querySelector(".profile-info-value, td:last-child");if(!o||!i||o===i)return;let s=Ur(o.textContent),l=ze(e,s);l&&mr(i,l)})}a(Gs,"applyProfilePrivacy");function Js(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let i=o.map(s=>{let l=Ur(s.textContent);return["grade","gpa","credit"].includes(l)?l:""});i.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(s=>{let l=s.querySelectorAll("td");i.forEach((h,m)=>{let A=ze(e,h);h&&A&&mr(l[m],A)})})})}a(Js,"applyScoreTablePrivacy");function Vs(t){let e=t&&t.querySelectorAll?t:document,r=Ae();if(r.mode==="off")return;let o=ze(r,"name"),i=ze(r,"avatar"),s=ze(r,"schedule"),l=o?En(e):e.querySelector?.(".urppp-user-name-value");o&&mr(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([A,q])=>{let N=ze(r,q);N&&e.querySelectorAll(A).forEach(z=>mr(z,N))}),Js(e,r);let m=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(A=>{let q=A.getAttribute("data-urppp-private"),N=A.getAttribute("data-urppp-edit-key"),D=(m&&N?String(r.directEdit.values[N]||"").trim():"")||ze(r,q);!["avatar","schedule"].includes(q)&&D&&mr(A,D),m&&N&&Hs(A,N)}),m&&Rs(),Gs(e,r),i&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(A=>{let q=A.matches("img")?A:A.querySelector("img");q?Cn(q,i):(A.classList.add("urppp-private-avatar-block"),A.setAttribute("data-urppp-private-mask",i))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(A=>Cn(A,i))),s){let A=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));A.filter(q=>!A.some(N=>N!==q&&N.contains(q))).forEach(q=>Os(q,s))}}a(Vs,"applyPrivacyDisplay");let Ga=0,se=[];function Ln(){let t=Ae(),e=Ne();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(Ln,"personalDisplayIsEnabled");function Ys(){se=se.filter(({root:t})=>t&&t.isConnected),se.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(Ys,"resumePersonalDisplayObservers");function Yt(t){let e=t||document;se.forEach(({observer:r})=>r.disconnect());try{_n()}catch{}try{Us(e)}catch{}try{Ws(e)}catch(r){console.warn("[URP++] custom identity",r)}try{Vs(e)}catch(r){console.warn("[URP++] privacy",r)}Ln()?(Ys(),Xs()):(clearTimeout(Ga),se=[])}a(Yt,"applyPersonalDisplay");function Qs(t){clearTimeout(Ga),Ga=setTimeout(()=>Yt(t||document),140)}a(Qs,"schedulePersonalDisplay");function Ja(){try{nt&&nt.open&&Ze()}catch{}}a(Ja,"refreshCleanPersonalDisplay");function Xs(){if(!Ln()){se.forEach(({observer:t})=>t.disconnect()),se=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(se.some(r=>r.root===t))return;let e=new MutationObserver(()=>Qs(document));se.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(Xs,"bindPersonalDisplayObservers");function Ks(t){let e=Object.assign({},t||{}),r=Ne();r.nameEnabled&&r.name&&(e.name=r.name);let o=or(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(Ks,"personalizedProfile");let qn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",Zs="/student/courseSelect/thisSemesterCurriculum/callback",tl="/student/courseSelect/thisSemesterCurriculum/index";async function el(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Vt(Zs),r=JSON.parse(e),o=ar(r);if(o)return o}catch{}return""}a(el,"resolveSchedulePlanCode");async function Tn(t){let e=await el(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Vt(qn,r),i;try{i=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=ar(i)),(!i.jcsjbs||!i.jcsjbs.length)&&e&&(i=JSON.parse(await Vt(qn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let s=Mn(i,e,t);if(!s.courses.length)throw new Error("没有读取到可导出的课表数据");return s}a(Tn,"loadScheduleExportData");function Va(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(Va,"safeScheduleFilename");function Ya(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(Ya,"downloadBlob");function rl(t){let e=Kr(t),r=qr(),o=r.enabled?ta(e,r.mapping):Zr(e),i=JSON.stringify(o,null,2)+`
`;return Ya(new Blob([i],{type:"application/json;charset=utf-8"}),Va(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(rl,"exportScheduleJson");function $n(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let i=Number(r[4]);if(i<1||i>30)return"";let s=so(new Date);return s.setDate(s.getDate()-(i-1)*7),Sr(s)}a($n,"deriveCurrentSemesterMonday");function Mn(t,e,r){let o=e||ar(t),i=$n(o)||fa()[o]||"";return wp(t,o,r,{firstMonday:i})}a(Mn,"normalizeScheduleDataForPage");function al(t){let e=t.semester.planCode,r=fa()[e],o=$n(e);return o?(Ao(e,o),Promise.resolve(o)):rr(r)?Promise.resolve(r):new Promise((i,s)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||fp(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let h=a((m,A)=>{l.remove(),m?s(m):i(A)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>h(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let m=l.querySelector("input").value;rr(m)&&(Ao(e,m),h(null,m))}),l.addEventListener("click",m=>{m.target===l&&h(new Error("已取消导出"))})})}a(al,"requestScheduleFirstMonday");async function ol(t){let e=await al(t),r=xp(t,e);return Ya(new Blob([r],{type:"text/calendar;charset=utf-8"}),Va(t.semester.label)+".ics"),yp(t)}a(ol,"exportScheduleIcs");let nl={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function le(t,e,r){if(typeof document>"u")return Gt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let i=getComputedStyle(o).color;o.remove();let s=String(i||"").match(/[\d.]+/g)?.map(Number)||[];if(s.length>=3){let l=vr(s[0],s[1],s[2]),h=s.length>3?Math.max(0,Math.min(1,s[3])):1;return h<1?Bt(r||e,l,h):l}return Gt(i)||Gt(e)||"#000000"}a(le,"resolvedScheduleImageColor");function In(){let t=Jt(),e=Zt(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},i={bg:le("--bg",o.bg),surface:le(e==="neu"?"--neu-base":"--surface",o.surface),input:le("--input-bg",o.input),text:le("--text",o.text),secondary:le("--text-secondary",o.secondary),muted:le("--text-muted",o.muted),border:le("--border",o.border,le(e==="neu"?"--neu-base":"--surface",o.surface)),primary:le("--primary",o.primary)},s={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(nl[e]||e)+" · "+(Ct[t]&&Ct[t].name||t),colors:i,shape:s[e]||s.apple}}a(In,"currentScheduleImageTheme");function Nn(t,e){return Lp(t,e||In())}a(Nn,"buildScheduleSvg");function pl(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),i=URL.createObjectURL(o),s=new Image;s.onload=()=>{try{let h=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),m=document.createElement("canvas");m.width=Math.floor(t.width*h),m.height=Math.floor(t.height*h);let A=m.getContext("2d");A.scale(m.width/t.width,m.height/t.height),A.fillStyle=t.background||"#F8FAFC",A.fillRect(0,0,t.width,t.height),A.drawImage(s,0,0,t.width,t.height),m.toBlob(q=>q?e(q):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(i)}},s.onerror=()=>{URL.revokeObjectURL(i),r(new Error("课表图片渲染失败"))},s.src=i})}a(pl,"svgToPngBlob");async function il(t){let e=await pl(Nn(t));Ya(e,Va(t.semester.label)+".png")}a(il,"exportSchedulePng");function Qa(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(Qa,"showFeatureToast");let Xa=qp({document,window,ensureStyles:Bs,loadData:Tn,exportJson:rl,exportIcs:ol,exportPng:il,showToast:Qa,nativePageUrl:tl,navigate:a(t=>{location.href=t},"navigate"),logger:console});function sl(t,e,r,o){return Xa.run(t,e,r,o)}a(sl,"runScheduleExport");function ll(t){return Xa.createMenu(t)}a(ll,"createScheduleExportMenu");function cl(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(cl,"disposeNativePdfCapture");function dl(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let i=Xp(e);t.stage="ok",t.stageCards=i.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=i.target.querySelector("table")?i.target.querySelector("table").id:"none",cl(i)}catch(i){t.stage="failed",t.stageError=i&&i.message||String(i)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(dl,"bindNativePdfDiagnose");function ul(t){return t?(dl(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await ti(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:cr})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Qa("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(ul,"pagePdfExportHandler");function Ka(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Ka,"isPersonalSchedulePage");function ml(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(ml,"isScoreQueryPage");function Za(){if(!Ka())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let i=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),s=ll({source:"native",pdfHandler:ul(i)});if(s.id="urppp-native-schedule-export",i&&i.parentElement){i.__urpppNativeExportState||(i.__urpppNativeExportState={display:i.style.getPropertyValue("display"),displayPriority:i.style.getPropertyPriority("display"),ariaHidden:i.getAttribute("aria-hidden"),tabIndex:i.getAttribute("tabindex")}),i.setAttribute("data-urppp-native-export-source","1"),i.style.setProperty("display","none","important"),i.setAttribute("aria-hidden","true"),i.setAttribute("tabindex","-1"),i.parentElement.insertBefore(s,i.nextSibling);return}if(e)e.appendChild(s);else if(t)t.appendChild(s);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let h=document.createElement("div");h.className="urppp-export-fallback",h.appendChild(s),l.prepend(h)}}}a(Za,"patchNativeScheduleExport");let Ve=null,Gr=0;function to(){clearTimeout(Gr),Gr=0,Ve&&Ve.observer.disconnect(),Ve=null}a(to,"disconnectNativeScheduleExportObserver");function hl(){if(!Ka()){to();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ve&&Ve.root===t&&t.isConnected)return;to();let e=new MutationObserver(()=>{clearTimeout(Gr),Gr=setTimeout(()=>Za(),80)});e.observe(t,{childList:!0,subtree:!0}),Ve={root:t,observer:e}}a(hl,"bindNativeScheduleExportObserver");function Bn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(Bn,"restoreOptionalAttribute");function bl(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let i=o.__urpppNativeExportState;i&&(i.display?o.style.setProperty("display",i.display,i.displayPriority):o.style.removeProperty("display"),Bn(o,"aria-hidden",i.ariaHidden),Bn(o,"tabindex",i.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(bl,"removeNativeScheduleExport");let Fn=Ii({deps:{styles:ci,loadScores:Kn,loadProfile:Dn,scoreToNumber:Je,scoreToGpa:Ge,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),fl=lp([Qr({id:"schedule-export",matches:a(t=>Ka(t.location),"matches"),mount:a(()=>{Za(),hl()},"mount"),unmount:a(t=>{to(),bl(t?.lifecycleKey)},"unmount")}),Qr({id:"score-analysis",matches:a(t=>ml(t.location),"matches"),mount:a(()=>{try{Fn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Fn.unmount()}catch{}},"unmount")})]);function Jr(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return fl.refresh({document,location,window,lifecycleKey:t})}a(Jr,"refreshRouteFeatures");function gl(t){Xa.bindHosts(t)}a(gl,"bindScheduleExportHosts");function hr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(hr,"normalizeProfileValue");function Vr(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(i=>hr(i).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let i=0;i<o.length;i++){let s=o[i],l=s.querySelector(".profile-info-name, th, label"),h=s.querySelector(".profile-info-value, td:last-child");if(!l||!h||l===h)continue;let m=hr(l.textContent).replace(/[：:]/g,"");if(!r.some(q=>m===q||m.endsWith(q)))continue;let A=hr(h.textContent);if(A&&A!=="—"&&A!=="-")return A}return""}a(Vr,"readLabeledProfileValue");function Ye(t){return hr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Ye,"cleanMajorPlanName");function xl(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),i=hr(o);if(/主修必修GPA/.test(i)){let s=i.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||i.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(s){let l=Number(s[1]),h=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||h===0||l>0)&&(e.majorGpa=s[1])}}if(/主修为|培养方案/.test(i)){let s=i.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||i.match(/^(.{2,60}?)\s*主修为/)||i.match(/主修为\s*(.{2,60})$/),l=Ye(s&&s[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let h=/培养方案|教学计划/.test(l);(!e.majorPlan||h)&&(e.majorPlan=l)}}}),e}a(xl,"extractAcademicOverview");async function Dn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let s=r.querySelector(".urppp-user-name-value"),l=s&&s.__urpppOriginalText;l&&(t.name=String(l).trim());let h=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),m=t.name?null:h.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!m){let A=r.cloneNode(!0);A.querySelectorAll("small, i, img, b, .badge").forEach(N=>N.remove());let q=(A.textContent||"").replace(/\s+/g," ").trim();q=q.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),m=q.match(/([\u4e00-\u9fa5·]{2,12})/)}m&&m[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(m[1])&&(t.name=m[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let i=xl(document);t.majorPlan=i.majorPlan,t.majorGpa=i.majorGpa}catch{}try{let r=await Vt("/student/rollManagement/rollInfo/index"),o=Rr(r),i=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Vr(o,["姓名"]),!t.name)){let m=i.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);m&&(t.name=m[1].trim())}let s=Vr(o,["主修方案名称"]),l=Vr(o,["专业"]);t.studentId=Vr(o,["学号"]),s?t.majorPlan=Ye(s):!t.majorPlan&&l&&(t.majorPlan=Ye(l));let h=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(h&&h.getAttribute("src")&&!t.avatar){let m=h.getAttribute("src");t.avatar=/^https?:/i.test(m)?m:Wa(m)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(Dn,"loadProfile");let jn=["周日","周一","周二","周三","周四","周五","周六"];function eo(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(i=>{let s=String(i.id||"").match(/^(\d+)_(\d+)$/);if(!s)return;let l=parseInt(s[1],10),h=parseInt(s[2],10),m=l===7?0:l,A=i.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),q=A.length?A:[];if(!q.length&&(i.textContent||"").trim()){let N=(i.textContent||"").replace(/\s+/g," ").trim();N&&e.push({name:N.slice(0,40),teacher:"",place:"",week:"",day:m,section:h});return}q.forEach(N=>{let z=Array.from(N.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),D=(N.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(N.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",j=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=z.find(K=>/周/.test(K))||"",F=String(D).replace(/_\d+\s*$/,"").trim();!F||F.length<2||e.push({name:F,teacher:String(j).trim(),place:String(J||"").trim(),week:String(R).trim(),day:m,section:h})})});let o=new Set;return e.filter(i=>{let s=[i.day,i.section,i.name,i.place].join("|");return o.has(s)?!1:(o.add(s),!0)})}a(eo,"parseScheduleFromDoc");let On="urppp_term_week_v1";function Qe(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(On,e)}catch{}return e}a(Qe,"rememberTermWeek");function br(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(On,0))||0;if(t>=1&&t<=30)return Qe(t)}catch{}return 0}a(br,"readRememberedTermWeek");function fr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let i=e.match(r[o]);if(i){let s=parseInt(i[1],10);if(s>=1&&s<=30)return s}}return 0}a(fr,"extractTermWeekFromText");function Le(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let h=t[l],m=fr(h.innerText||h.textContent||"")||fr(h.innerHTML||"");if(m)return Qe(m)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=fr(e);if(r)return Qe(r);let o=document.body&&document.body.innerText||"",i=fr(o);if(i)return Qe(i);let s=br();if(s)return s}catch{}return 0}a(Le,"getCurrentWeekNumber");let Xe=null;function yl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(yl,"calTodayStr");function vl(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(i=>String(i).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(vl,"calAddDays");function gr(t){if(Xe)return Xe;let e=t||yl();return e>="2027-02-06"&&e<=vl("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(gr,"calVacation");function wl(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(wl,"festiveDecorHtml");function Hn(){let t=typeof document<"u"?document:null;if(!t)return;let e=gr()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",wl()):!e&&r&&r.remove()}a(Hn,"syncFestiveDecor");function Rn(t){Xe=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Xe&&Xe!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{Hn()}catch{}try{typeof Ze=="function"&&Ze()}catch{}return Xe}a(Rn,"setCalendarPhase");function kl(){return gr()}a(kl,"getCalendarPhase");function Un(){if(gr()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=Le()||br()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(Un,"getViewWeekNumber");async function Al(){let t=Le();if(t>=1)return t;try{let e=await Vt("/index");if(t=fr(e),t)return Qe(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),i=await Vt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),s=JSON.parse(i),l=Number(s&&s.jxzc);if(l>=1&&l<=30)return Qe(l)}catch{}return br()||0}a(Al,"ensureTermWeekResolved");function Sl(t){let e=Le()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let i=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);i&&(e=Math.max(e,parseInt(i[2],10)||0));let s=String(r.week||"").match(/\d{1,2}/g);s&&s.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(Sl,"inferMaxWeek");function Wn(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Wn,"weekBitActive");let Gn=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function Jn(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return Gn[e%Gn.length]}a(Jn,"courseColor");function _l(t){let e=[],r=Le();(t&&t.xkxx||[]).forEach(s=>{Object.keys(s||{}).forEach(l=>{let h=s[l];if(!h)return;let m=h.courseName||h.englishCourseName||l,A=h.attendClassTeacher||"";(h.timeAndPlaceList||[]).forEach(N=>{let z=Number(N.classDay)||0,D=z===7?0:z,J=Number(N.classSessions)||1,j=Math.max(1,Number(N.continuingSession)||1),R=[N.campusName,N.teachingBuildingName,N.classroomName].filter(Boolean).join(""),F=N.weekDescription||h.skzcs||"",K=Wn(N.classWeek,r)||r&&F.indexOf(String(r))>=0;e.push({name:String(m).trim(),teacher:String(A).trim(),place:String(R).trim(),week:String(F).trim(),classWeek:String(N.classWeek||""),day:D,section:J,span:j,thisWeek:!!K,color:Jn(m)})})})});let i=new Set;return e.filter(s=>{let l=[s.day,s.section,s.span,s.name,s.place,s.week].join("|");return i.has(l)?!1:(i.add(l),!0)})}a(_l,"parseScheduleFromJson");async function El(){try{let t=await Vt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let i=Number(r&&(r.jxzc||r.zc||r.currentWeek));i>=1&&i<=30&&(nt._termWeek=Math.max(nt._termWeek||0,i),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=_l(r)}catch{e=eo(Rr(t))}e.length||(e=eo(document));let o=r?Mn(r,ar(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=eo(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(El,"loadSchedule");function Cl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),i=r.match(o);if(i&&i[1])return i[1];let s=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(s);return l?l[1]:""}a(Cl,"extractScoreCallback");function Pl(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let i=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",s=[];(o.cjList||[]).forEach(l=>{let h=l.courseName||l.englishCourseName||"";if(!h)return;let m=l.cj!=null&&l.cj!==""?String(l.cj):"";!m&&l.courseScore!=null&&(m=String(l.courseScore)),!m&&l.gradeName&&(m=String(l.gradeName)),!m&&l.zscj!=null&&(m=String(l.zscj));let A=l.courseAttributeName||l.xkcsxmc||"",q=parseFloat(l.credit)||0,N=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",D=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ie(m)||ie(l.gradeName)||D!=null&&D<0,j=J?"未评估":m;s.push({code:N,seq:String(z||""),name:h,attr:A,credit:q,score:j,unevaluated:J,required:Sn(A),officialGpa:Or(D)?D:null,evalUrl:""})}),s.length&&e.push({title:String(i).slice(0,100),courses:s,summary:re(s),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(Pl,"parseScoreJson");async function Vn(t,e){let r=await Vt(t),o=Yn(Rr(r));if(o.length)return o;let i=Cl(r,e);if(!i)return[];let s=await Vt(i);try{let l=JSON.parse(s);o=Pl(l).map(h=>(h.summary=re(h.courses),h))}catch{o=Yn(Rr(s))}return o}a(Vn,"loadScoreByIndex");function Yn(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map(q=>(q.textContent||"").replace(/\s+/g,""));if(!o.length)return;let i=o.join("|");if(!/课程名/.test(i)||!/成绩/.test(i))return;let s={code:o.findIndex(q=>q==="课程号"),name:o.findIndex(q=>q==="课程名"),attr:o.findIndex(q=>/课程属性|属性/.test(q)),credit:o.findIndex(q=>q==="学分"),score:o.findIndex(q=>q==="成绩")};if(s.name<0||s.score<0)return;let l="成绩",h=r.previousElementSibling;for(let q=0;q<8&&h;q++,h=h.previousElementSibling)if(/^H[1-4]$/.test(h.tagName)||h.classList&&h.classList.contains("header")){l=(h.textContent||"").replace(/\s+/g," ").trim();break}let m=[],A=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(A).forEach(q=>{let N=Array.from(q.cells||q.querySelectorAll("td"));if(N.length<4)return;let z=a(F=>F>=0&&N[F]?(N[F].textContent||"").replace(/\s+/g," ").trim():"","get"),D=z(s.name),J=z(s.score);if(!D||!J||/课程名|序号/.test(D))return;let j=z(s.attr),R=ie(J);m.push({code:z(s.code),name:D,attr:j,credit:parseFloat(z(s.credit))||0,score:R?"未评估":J,unevaluated:R,required:Sn(j),officialGpa:null,evalUrl:""})}),m.length&&e.push({title:l.slice(0,100),courses:m,summary:re(m)})}),e}a(Yn,"parseScoreTables");function xr(t){return Ye(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(xr,"schemePlanName");function Qn(t,e){if(!t||!t.length)return 0;let r=Ye(e),o=t.findIndex(l=>{let h=xr(l);return/培养方案/.test(h)&&!/微专业|辅修|双学位/.test(h)});if(o>=0&&(!r||xr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let h=xr(l);return h.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(h.slice(0,4))||h.includes(r.slice(0,4))}),o>=0))return o;let i=0,s=-1;return t.forEach((l,h)=>{if(/微专业|辅修/.test(xr(l)))return;let m=(l.courses||[]).length;m>s&&(s=m,i=h)}),i}a(Qn,"pickMajorSchemeIndex");async function zl(){let t={};try{let e=await Vt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(i=>{let s=String(i.KCH||"").trim();if(!s)return;let l=String(i.SFPG)==="1",h=String(i.KTID||"").trim();if(!t[s]){t[s]={ktid:h,kxh:String(i.KXH||""),kcm:i.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&h?"/student/teachingEvaluation/newEvaluation/evaluation/"+h:"/student/teachingEvaluation/newEvaluation/index"};return}t[s].total+=1,l||(t[s].pending+=1,t[s].done=!1,h&&(t[s].ktid=h,t[s].url="/student/teachingEvaluation/newEvaluation/evaluation/"+h))}),Object.keys(t).forEach(i=>{let s=t[i];s.done=!(s.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(zl,"loadEvaluationMap");function Ll(t){if(!t)return!1;if(t.officialGpa!=null&&Or(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ie(e)?!1:Je(e)!=null||Ge(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(Ll,"hasDisplayableScore");function ql(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(i=>{if(!i||!i.code)return;let s=e[i.code];if(s){if(Ll(i)){i.unevaluated=!1,s.done?i.evalUrl=i.evalUrl||"":i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index";return}s.done||(i.unevaluated=!0,i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index",(!i.score||i.score===""||ie(i.score))&&(i.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(ql,"attachEvaluationLinks");function Xn(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=re(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=re(e.courses),e)),t)}a(Xn,"refreshScoreSummaries");async function Tl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await zl();return ql(t,e),t.evalMap=e,t.evaluationReady=!0,Xn(t)}finally{t.evaluationLoading=!1}}a(Tl,"enrichScoresWithEvaluation");function $l(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=Qn(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let i=xr(o),s=Ye(nt.profile.majorPlan);/培养方案|教学计划/.test(i)&&(!/培养方案|教学计划/.test(s)||s==="主修方案")&&(nt.profile.majorPlan=i);let l=o.summary||{},h=Number(l.requiredCredit),m=Number(l.requiredGpa),A=Number(nt.profile.majorGpa);h>0&&Number.isFinite(m)&&m>=0&&m<=5&&(!Number.isFinite(A)||A<=0)&&(nt.profile.majorGpa=String(Pe(m)))}a($l,"reconcileProfileAndScores");let Ke=null;async function Kn(t){return t&&(Ke=null),Ke&&!Ke.error||(Ke=await Ml()),Ke}a(Kn,"loadScores");async function Ml(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([Vn("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),Vn("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(i=>i.courses.forEach(s=>{o.push(Object.assign({term:i.title},s))})),t.passing=[{title:"全部及格成绩",courses:o,summary:re(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:re(o)}]),Xn(t),t.majorIdx=Qn(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(Ml,"loadScoresImpl");function qe(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(qe,"parseJsonArrayLoose");function Zn(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let i=0;for(let s=o;s<t.length&&s<o+3e5;s++){let l=t[s];if(l==="[")i++;else if(l==="]"&&(i--,i===0))return t.slice(o,s+1)}return""}a(Zn,"extractBalancedArray");async function Il(){let t=await Vt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let s=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(s&&(e=qe(s)),l&&(r=qe(l)),!e.length){let h=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(e=qe(h[1]))}if(!r.length){let h=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(r=qe(h[1]))}if(!r.length){let h=Zn(t,"teachingBuildingName");h&&(r=qe(h))}if(!e.length){let h=Zn(t,"campusName");h&&(e=qe(h))}}catch(s){console.warn("[URP++] classroom json parse",s)}if(!r.length){let s=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=s;let l=[];for(let h of s)try{let m=await Vt("/student/teachingResources/classroomCurriculum/"+h.campusNumber+"/teachingBuildingJson");qe(m).forEach(q=>{l.push({id:{campusNumber:h.campusNumber,teachingBuildingNumber:String(q.id&&q.id.teachingBuildingNumber||q.teachingBuildingNumber||"")},teachingBuildingName:q.teachingBuildingName||q.name||""})})}catch(m){console.warn("[URP++] building json",h.campusNumber,m)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(s=>({campus:s.campusName||s.campusNumber,campusNumber:String(s.campusNumber||s.id&&s.id.campusNumber||""),buildings:[]}));r.forEach(s=>{let l=String(s.id&&s.id.campusNumber||s.campusNumber||""),h=String(s.id&&s.id.teachingBuildingNumber||s.teachingBuildingNumber||""),m=s.teachingBuildingName||s.name||h;if(!l||!h||!m)return;let A=o.find(N=>N.campusNumber===l);A||(A={campus:l,campusNumber:l,buildings:[]},o.push(A));let q="/student/teachingResources/classroomUseStatus/"+l+"/"+h+"/"+encodeURI(encodeURI(A.campus||l))+"/"+encodeURI(encodeURI(m));A.buildings.push({name:m,path:q,campusNumber:l,buildingNumber:h})});let i=o.filter(s=>s.buildings.length);if(!i.length)throw new Error("未解析到教学楼，请刷新后重试");return i}a(Il,"loadClassroomCatalog");function yr(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(yr,"occupancyTypeLabel");function Nl(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return yr(t)}a(Nl,"occupancyReason");async function Bl(t,e,r,o){let i=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),s=await Vt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+i.toString());try{let l=JSON.parse(s);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(h=>h&&typeof h=="object"&&(h.kcm||h.id&&h.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(Bl,"fetchClassroomCurriculum");function Fl(t,e,r){let o=t||[],i=Number(e.xq)||0,s=Number(e.start)||0,l=Number(r)||0,h=[];return o.forEach(m=>{let A=m.id||{},q=Number(A.skxq!=null?A.skxq:m.skxq)||0,N=Number(A.skjc!=null?A.skjc:m.skjc)||0,z=Math.max(1,Number(m.cxjc)||1),D=A.skzc||m.skzc||"";i&&q&&i!==q||s&&(s<N||s>=N+z)||l&&D&&!Ua(D,l)||h.push(m)}),h.length?(h.sort((m,A)=>{let q=Ua(m.id&&m.id.skzc||m.skzc,l)?0:1,N=Ua(A.id&&A.id.skzc||A.skzc,l)?0:1;return q-N}),h[0]):null}a(Fl,"matchCurriculumCourse");async function Dl(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),i=String(e.buildingNumber||""),s=r||t.planNumber||"";if(!o||!i||!s)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(D=>D.busy)),h={},m=a(async z=>{if(h[z])return h[z];try{h[z]=await Bl(s,o,i,z)}catch{h[z]=[]}return h[z]},"queue"),A=4,q=0,N=new Array(Math.min(A,Math.max(l.length,1))).fill(0).map(async()=>{for(;q<l.length;){let z=q++,D=l[z],J=await m(D.name);(D.slots||[]).forEach(j=>{if(!j.busy)return;let R={xq:j.detail&&j.detail.xq||j.xq||0,start:j.section,week:t.jxzc};j.detail&&j.detail.xq!=null&&(R.xq=j.detail.xq);let F=Fl(J,R,t.jxzc);if(F&&F.kcm){let K=String(F.kcm).trim();j.contentName=K,j.reason=K,j.displayChar=Hr(K),j.detail&&(j.detail.contentName=K,j.detail.reason=K,j.detail.teacher=F.jsm||"",j.detail.weeks=F.zcsm||"",j.detail.courseNo=F.id&&F.id.kch||"",j.detail.typeLabel=yr({occupancymoduleId:j.module}))}else j.displayChar=Hr(j.reason||"占用"),j.detail&&(j.detail.typeLabel=yr({occupancymoduleId:j.module}))})}});return await Promise.all(N),t}a(Dl,"enrichOccupancyWithCurriculum");function jl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(jl,"occupancyKindClass");async function Ol(t){let e="",r="",o="",i="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",i=t.path||"";else{i=String(t||"");let F=i.match(/classroomUseStatus\/(\d+)\/(\d+)\//);F&&(e=F[1],r=F[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let s=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=Hl(tp(new Date,s)),h="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),m=await new Promise((F,K)=>{let ut=Wa("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:h,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?F(vt.responseText||""):K(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:h}).then(vt=>vt.text()).then(F).catch(K)}),A;try{A=JSON.parse(m)}catch{throw new Error("jasInfo 非 JSON")}let q=(A.classrooms||[]).map(F=>{let K=F.classroomName||F.id&&F.id.classroomNumber||"",ut=F.placeNum||"",vt=F.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:K,seats:ut,type:vt,slots:Et,map:{}}}),N={};q.forEach(F=>{N[F.name]=F}),(A.classroomTime||[]).forEach(F=>{let K=F.id||{},ut=K.classroomNumber||"",vt=Number(K.sessionstart)||1,Et=Math.max(1,Number(F.continuingsession)||1),Lt=N[ut];if(!Lt)return;let qt=yr(F),Ot=Nl(F);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let $t=Lt.slots.find(ae=>ae.section===Ht);$t&&($t.busy=!0,$t.kind=F.timestatenumber||F.occupancymoduleId||"",$t.module=F.occupancymoduleId||"",$t.reason=Ot,$t.typeLabel=qt,$t.displayChar=Hr(Ot),$t.xq=K.xq,$t.weekBitmap=K.week||"",$t.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:K.week||"",xq:K.xq||"",state:F.timestatenumber||"",module:F.occupancymoduleId||""})}});let z="";try{let F=A.jhZxjxjhb;typeof F=="string"&&/\d{4}-\d{4}-\d-\d/.test(F)?z=F:F&&typeof F=="object"&&(z=String(F.zxjxjhh||F.jhxnxq||F.executiveEducationPlanNumber||F.planNumber||""))}catch{}if(!z&&A.classrooms&&A.classrooms[0]&&A.classrooms[0].id&&(z=A.classrooms[0].id.executiveEducationPlanNumber||""),A.jxzc!=null&&Number(A.jxzc)>=1){let F=Number(A.jxzc);nt._termWeek=Math.max(nt._termWeek||0,F),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let D=["日","一","二","三","四","五","六"],J=Rl(A.date||l)||tp(new Date,s),j=A.week!=null?Number(A.week):J.getDay(),R=s===1?"明天":s===2?"后天":"今天";return{rooms:q,dateLabel:(A.date||l)+"（周"+(D[j]||j)+" · "+R+"）",jxzc:A.jxzc,planNumber:z,week:A.week!=null?A.week:j,searchDate:A.date||l,dateOffset:s}}a(Ol,"loadBuildingOccupancy");function tp(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(tp,"addDays");function Hl(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(Hl,"formatLocalDate");function Rl(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(Rl,"parseLocalDate");let ep={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function rp(t){return ep[t]||ep.more}a(rp,"ico");let nt=ui();function Ul(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=si,(document.head||document.documentElement).appendChild(t)}a(Ul,"ensureStyle");let Wl=ia({deps:{scoreToNumber:Je,scoreToGpa:Ge}}),{metricHtml:Gl,occupancyHtml:Jl,render:Ze,renderScheduleBoard:Hc,roomPickerHtml:Vl,scheduleRender:Yl}=Si({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:jn,analyzeScores:a(t=>Wl.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Yt,bandsChartSvg:la,bindUI:a(t=>Xl(t),"bindUI"),classifyPrivacyLabel:Ur,courseColor:Jn,ensureRoot:a(()=>op(),"ensureRoot"),escapeHtml:at,firstContentChar:Hr,getViewWeekNumber:Un,ico:rp,isCleanAnalysisDirect:ma,occupancyKindClass:jl,occupancyTypeLabel:yr,personalizedProfile:Ks,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Je,summarizeCourses:re,trendChartSvg:sa,weekBitActive:Wn,calVacation:gr,setCalendarPhase:Rn}}),{ensureRoomCatalogLoaded:ap,loadAll:Ql}=hi({state:nt,deps:{ensureTermWeekResolved:Al,enrichScoresWithEvaluation:Tl,getCurrentWeekNumber:Le,loadClassroomCatalog:Il,loadProfile:Dn,loadSchedule:El,loadScores:Kn,readRememberedTermWeek:br,reconcileProfileAndScores:$l,render:Ze,scheduleRender:Yl}}),{bindUI:Xl,closeModal:Kl,getRoomHost:Rc,openModal:Uc,openRoomModal:Wc,openScoreModal:Gc,showBuilding:Jc}=_i({state:nt,deps:{DAY_NAMES:jn,applyPersonalDisplay:Yt,bindScheduleExportHosts:gl,closeCleanMode:a(()=>tc(),"closeCleanMode"),ensureRoomCatalogLoaded:ap,enrichOccupancyWithCurriculum:Dl,ensureRoot:a(()=>op(),"ensureRoot"),escapeHtml:at,fetchText:Vt,getCurrentWeekNumber:Le,getViewWeekNumber:Un,inferMaxWeek:Sl,isUnevaluatedScore:ie,isValidOfficialGpa:Or,loadBuildingOccupancy:Ol,metricHtml:Gl,occupancyHtml:Jl,render:Ze,rootEl:a(()=>ec(),"rootEl"),roomPickerHtml:Vl,scoreToGpa:Ge,scoreToNumber:Je,summarizeCourses:re,summarizeCoursesPreferOfficial:re}}),{cleanModeApi:Zl,closeCleanMode:tc,ensureRoot:op,injectCleanEntry:Vc,openCleanMode:Yc,rootEl:ec}=Ei({state:nt,deps:{CLEAN_FLAG:Ns,applySkinAttr:ee,closeModal:Kl,ensureRoomCatalogLoaded:ap,ensureStyle:Ul,getCurrentWeekNumber:Le,getSkin:Zt,handleThemeDotClick:ct,ico:rp,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:_o,loadAll:Ql,openSettingsPanel:en,readRememberedTermWeek:br,refreshCleanPersonalDisplay:Ja,render:Ze,scoreToGpa:Ge,summarizeCourses:re,syncNavbarThemeUI:gt,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=Zl;function ro(){if(!document.body){setTimeout(ro,10);return}if(Co(),Wt(Jt()),setTimeout(()=>{try{ge().then(e=>Se(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],i=r.parentElement;for(;i;){let s=i.scrollTop,l=i.scrollLeft;(s||l||i.scrollHeight>i.clientHeight||i.scrollWidth>i.clientWidth)&&o.push({el:i,top:s,left:l}),i=i.parentElement}requestAnimationFrame(()=>{o.forEach(s=>{s.el.scrollTop=s.top,s.el.scrollLeft=s.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))$o();else{ps();try{_n()}catch{}try{Jr()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Yt(document)}catch{}try{Hn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{Jr()}catch{}try{Yt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{ua()&&_o()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(ro,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(Ce,50)}),window.addEventListener("load",()=>{Ce(),We(),setTimeout(Ce,100),setTimeout(Ce,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(We,0),setTimeout(We,50),setTimeout(We,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(We,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function np(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let i=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),s=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));i&&!s&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){Ce(),An(),st(),Ce();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(s=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},s)),_a(),Xo(),Ko(),Ro(),Zo(),Qo(),Wo(),document.querySelectorAll(".page-content, #page-content-template").forEach(s=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);s.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),s.style.setProperty("box-sizing","border-box","important")}),Mr(),Br(),je(),setTimeout(je,300),setTimeout(je,1e3),Bo(),fe(),sr(),jo(),setTimeout(sr,300),lr(),setTimeout(()=>lr(),500),$r(),Do();try{Jr()}catch{}try{Yt(document)}catch{}setTimeout(()=>{try{Jr()}catch{}try{Yt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...i){let s=r.apply(this,i);return e(),s},history.replaceState=function(...i){let s=o.apply(this,i);return e(),s}}a(np,"watchRouteChanges");let tr=typeof unsafeWindow<"u"?unsafeWindow:window;tr.__urpppDebug=tr.__urpppDebug||{},tr.__urpppDebug.setCalendarPhase=t=>Rn(t),tr.__urpppDebug.getCalendarPhase=()=>kl(),tr.__urpppDebug.calVacation=t=>gr(t),tr.urppp={version:p,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Wt(t)},"apply"),setAccent:Di,getAccent:Qt,getCurrent:Jt,list:a(()=>Object.entries(Ct).map(([t,e])=>({name:t,displayName:e.name,current:t===Jt()})),"list")},update:{check:Ha,auto:Oa,showToast:ja},privacy:{get:Ae,set(t){return ba(t),Yt(document),Ae()},apply:a(()=>Yt(document),"apply"),identity:{get:Ne,set(t){return ko(t),Yt(document),Ja(),Ne()}}},scheduleExport:{load:a(()=>Tn("api"),"load"),run:a(t=>sl(t,"api",null,null),"run"),patch:Za,image:{theme:In,build:a((t,e)=>Nn(t,e),"build")},jsonFormat:{get:qr,set:So,validate:$e,build(t,e){let r=Kr(t);if(e)return ta(r,$e(e));let o=qr();return o.enabled?ta(r,o.mapping):Zr(r)},buildDefault(t){return Zr(Kr(t))}}}};function pp(){setTimeout(()=>{try{Oa()}catch{}},1800)}a(pp,"scheduleAutoUpdateCheck");try{Co()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{ro(),np(),pp()}):(ro(),np(),pp())})();})();
