...
#urppp-toast{position:fixed;left:50%;bottom:24px;transform:translateX(-50%) translateY(16px);z-index:99999;max-width:min(560px,90vw);padding:10px 18px;border-radius:var(--radius,10px);background:var(--surface,#2b2f36);color:var(--text,#fff);font-size:13px;font-family:inherit;opacity:0;pointer-events:none;transition:.22s;box-shadow:var(--shadow,0 8px 28px rgba(0,0,0,.24))}
...
#urppp-confirm .urppp-confirm-card{width:min(420px,100%);padding:16px 18px;border-radius:var(--radius,12px);background:var(--surface,#fff);border:1px solid var(--border,#e6e8ec);box-shadow:var(--shadow,0 22px 60px rgba(15,23,42,.24));font-family:inherit}
