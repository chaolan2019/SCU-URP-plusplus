...
(()=>{var hc=Object.defineProperty;var a=(n,i)=>hc(n,"name",{value:i,configurable:!0});function or(n){let i=String(n).replace("#","").match(/^([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i);return i?{r:parseInt(i[1],16),g:parseInt(i[2],16),b:parseInt(i[3],16)}:{r:30,g:58,b:95}}a(or,"hexToRgb");function Sr(n,i,l){return"#"+[n,i,l].map(d=>Math.max(0,Math.min(255,Math.round(d))).toString(16).padStart(2,"0")).join("")}a(Sr,"rgbToHex");function Jt(n){let i=String(n||"").trim();return i?(i[0]!=="#"&&(i="#"+i),/^#[0-9a-fA-F]{6}$/.test(i)?i.toUpperCase():""):""}a(Jt,"normalizeHexColor");function lo(n,i){let{r:l,g:d,b:u}=or(n),k=1-i;return Sr(l*k,d*k,u*k)}a(lo,"darken");function Ae(n,i){let{r:l,g:d,b:u}=or(n);return`rgba(${l},${d},${u},${i})`}a(Ae,"alpha");function Ft(n,i,l){let d=or(Jt(n)||"#FFFFFF"),u=or(Jt(i)||"#FFFFFF"),k=Math.max(0,Math.min(1,Number(l)||0));return Sr(d.r+(u.r-d.r)*k,d.g+(u.g-d.g)*k,d.b+(u.b-d.b)*k)}a(Ft,"mixHex");function co(n,i){if(typeof n!="function")throw new TypeError(`${i} must be a function`)}a(co,"assertFunction");function aa(n){if(!n||typeof n!="object")throw new TypeError("feature definition must be an object");let i=String(n.id||"").trim();if(!i)throw new TypeError("feature id is required");return co(n.matches,`${i}.matches`),co(n.mount,`${i}.mount`),co(n.unmount,`${i}.unmount`),Object.freeze({id:i,matches:n.matches,mount:n.mount,unmount:n.unmount})}a(aa,"defineFeature");function gi(n){if(!Array.isArray(n))throw new TypeError("features must be an array");let i=n.map(aa),l=new Set;i.forEach(A=>{if(l.has(A.id))throw new Error(`duplicate feature id: ${A.id}`);l.add(A.id)});let d=null,u=null;function k(){if(!d)return;let A=d,y=u;d=null,u=null,A.unmount(y)}a(k,"unmount");function P(A={}){let y=i.find(g=>g.matches(A));if(y&&d===y&&A.lifecycleKey!==void 0&&u?.lifecycleKey===A.lifecycleKey)try{return y.mount(A),u=A,y.id}catch(g){throw k(),g}if(k(),!y)return null;try{return y.mount(A),d=y,u=A,y.id}catch(g){try{y.unmount(A)}catch{}throw g}}return a(P,"refresh"),Object.freeze({refresh:P,unmount:k,getActiveFeatureId:a(()=>d?.id||null,"getActiveFeatureId"),listFeatureIds:a(()=>i.map(A=>A.id),"listFeatureIds")})}a(gi,"createFeatureRuntime");function at(n){return String(n||"").replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i])}a(at,"escapeHtml");function uo(n){let i=String(n||"").match(/@version\s+([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)/i);return i?i[1]:""}a(uo,"parseUserscriptVersion");function xi(n){return String(n||"0").replace(/^v/i,"").split(/[.+\-]/).filter(Boolean).map(i=>/^\d+$/.test(i)?parseInt(i,10):i)}a(xi,"normalizeVersionParts");function _r(n,i){let l=xi(n),d=xi(i),u=Math.max(l.length,d.length);for(let k=0;k<u;k+=1){let P=l[k]==null?0:l[k],A=d[k]==null?0:d[k];if(typeof P=="number"&&typeof A=="number"){if(P>A)return 1;if(P<A)return-1;continue}let g=String(P),v=String(A);if(g>v)return 1;if(g<v)return-1}return 0}a(_r,"compareVersions");var fc=typeof TextEncoder<"u"?new TextEncoder:{encode:a(n=>Uint8Array.from(Buffer.from(n,"utf8")),"encode")};function Er(n){return typeof n=="string"?fc.encode(n):n instanceof Uint8Array?n:ArrayBuffer.isView(n)?new Uint8Array(n.buffer,n.byteOffset,n.byteLength):new Uint8Array(n)}a(Er,"toBytes");var gc=new Uint32Array([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]);function ie(n,i){return n>>>i|n<<32-i}a(ie,"rotr");function wi(n){let i=Er(n),l=new Uint32Array([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]),d=i.length,u=Math.floor(d/536870912),k=d<<3>>>0,P=(d+8>>6<<6)+64,A=new Uint8Array(P);A.set(i),A[d]=128;let y=new DataView(A.buffer);y.setUint32(P-8,u),y.setUint32(P-4,k);let S=new Uint32Array(64);for(let v=0;v<P;v+=64){for(let $=0;$<16;$+=1)S[$]=y.getUint32(v+$*4);for(let $=16;$<64;$+=1){let T=ie(S[$-15],7)^ie(S[$-15],18)^S[$-15]>>>3,j=ie(S[$-2],17)^ie(S[$-2],19)^S[$-2]>>>10;S[$]=S[$-16]+T+S[$-7]+j>>>0}let q=l[0],C=l[1],f=l[2],m=l[3],w=l[4],x=l[5],E=l[6],z=l[7];for(let $=0;$<64;$+=1){let T=ie(w,6)^ie(w,11)^ie(w,25),j=w&x^~w&E,I=z+T+j+gc[$]+S[$]>>>0,H=ie(q,2)^ie(q,13)^ie(q,22),G=q&C^q&f^C&f,U=H+G>>>0;z=E,E=x,x=w,w=m+I>>>0,m=f,f=C,C=q,q=I+U>>>0}l[0]=l[0]+q>>>0,l[1]=l[1]+C>>>0,l[2]=l[2]+f>>>0,l[3]=l[3]+m>>>0,l[4]=l[4]+w>>>0,l[5]=l[5]+x>>>0,l[6]=l[6]+E>>>0,l[7]=l[7]+z>>>0}let g=new Uint8Array(32);for(let v=0;v<8;v+=1)g[v*4]=l[v]>>>24,g[v*4+1]=l[v]>>>16,g[v*4+2]=l[v]>>>8,g[v*4+3]=l[v];return g}a(wi,"sha256Bytes");var xc=[0x428a2f98d728ae22n,0x7137449123ef65cdn,0xb5c0fbcfec4d3b2fn,0xe9b5dba58189dbbcn,0x3956c25bf348b538n,0x59f111f1b605d019n,0x923f82a4af194f9bn,0xab1c5ed5da6d8118n,0xd807aa98a3030242n,0x12835b0145706fben,0x243185be4ee4b28cn,0x550c7dc3d5ffb4e2n,0x72be5d74f27b896fn,0x80deb1fe3b1696b1n,0x9bdc06a725c71235n,0xc19bf174cf692694n,0xe49b69c19ef14ad2n,0xefbe4786384f25e3n,0x0fc19dc68b8cd5b5n,0x240ca1cc77ac9c65n,0x2de92c6f592b0275n,0x4a7484aa6ea6e483n,0x5cb0a9dcbd41fbd4n,0x76f988da831153b5n,0x983e5152ee66dfabn,0xa831c66d2db43210n,0xb00327c898fb213fn,0xbf597fc7beef0ee4n,0xc6e00bf33da88fc2n,0xd5a79147930aa725n,0x06ca6351e003826fn,0x142929670a0e6e70n,0x27b70a8546d22ffcn,0x2e1b21385c26c926n,0x4d2c6dfc5ac42aedn,0x53380d139d95b3dfn,0x650a73548baf63den,0x766a0abb3c77b2a8n,0x81c2c92e47edaee6n,0x92722c851482353bn,0xa2bfe8a14cf10364n,0xa81a664bbc423001n,0xc24b8b70d0f89791n,0xc76c51a30654be30n,0xd192e819d6ef5218n,0xd69906245565a910n,0xf40e35855771202an,0x106aa07032bbd1b8n,0x19a4c116b8d2d0c8n,0x1e376c085141ab53n,0x2748774cdf8eeb99n,0x34b0bcb5e19b48a8n,0x391c0cb3c5c95a63n,0x4ed8aa4ae3418acbn,0x5b9cca4f7763e373n,0x682e6ff3d6b2b8a3n,0x748f82ee5defb2fcn,0x78a5636f43172f60n,0x84c87814a1f0ab72n,0x8cc702081a6439ecn,0x90befffa23631e28n,0xa4506cebde82bde9n,0xbef9a3f7b2c67915n,0xc67178f2e372532bn,0xca273eceea26619cn,0xd186b8c721c0c207n,0xeada7dd6cde0eb1en,0xf57d4f7fee6ed178n,0x06f067aa72176fban,0x0a637dc5a2c898a6n,0x113f9804bef90daen,0x1b710b35131c471bn,0x28db77f523047d84n,0x32caab7b40c72493n,0x3c9ebe0a15c9bebcn,0x431d67c49c100d4cn,0x4cc5d4becb3e42b6n,0x597f299cfc657e2an,0x5fcb6fab3ad6faecn,0x6c44198c4a475817n].map(n=>BigInt(n));function pe(n,i){return(n>>BigInt(i)|n<<BigInt(64-i))&0xffffffffffffffffn}a(pe,"rotr64");function yc(n){let i=Er(n),l=[0x6a09e667f3bcc908n,0xbb67ae8584caa73bn,0x3c6ef372fe94f82bn,0xa54ff53a5f1d36f1n,0x510e527fade682d1n,0x9b05688c2b3e6c1fn,0x1f83d9abfb41bd6bn,0x5be0cd19137e2179n],d=i.length,u=BigInt(d)*8n,k=d+8+15>>4<<4,P=new Uint8Array(k+16);P.set(i),P[d]=128;let A=new DataView(P.buffer);A.setBigUint64(P.length-8,u);let y=new Array(80);for(let g=0;g<P.length;g+=128){for(let z=0;z<16;z+=1)y[z]=A.getBigUint64(g+z*8);for(let z=16;z<80;z+=1){let $=pe(y[z-15],1)^pe(y[z-15],8)^y[z-15]>>7n,T=pe(y[z-2],19)^pe(y[z-2],61)^y[z-2]>>6n;y[z]=y[z-16]+$+y[z-7]+T&0xffffffffffffffffn}let v=l[0],q=l[1],C=l[2],f=l[3],m=l[4],w=l[5],x=l[6],E=l[7];for(let z=0;z<80;z+=1){let $=pe(m,14)^pe(m,18)^pe(m,41),T=m&w^~m&x,j=E+$+T+xc[z]+y[z]&0xffffffffffffffffn,I=pe(v,28)^pe(v,34)^pe(v,39),H=v&q^v&C^q&C,G=I+H&0xffffffffffffffffn;E=x,x=w,w=m,m=f+j&0xffffffffffffffffn,f=C,C=q,q=v,v=j+G&0xffffffffffffffffn}l[0]=l[0]+v&0xffffffffffffffffn,l[1]=l[1]+q&0xffffffffffffffffn,l[2]=l[2]+C&0xffffffffffffffffn,l[3]=l[3]+f&0xffffffffffffffffn,l[4]=l[4]+m&0xffffffffffffffffn,l[5]=l[5]+w&0xffffffffffffffffn,l[6]=l[6]+x&0xffffffffffffffffn,l[7]=l[7]+E&0xffffffffffffffffn}let S=new Uint8Array(64);for(let g=0;g<8;g+=1){let v=l[g]&0xffffffffffffffffn;for(let q=0;q<8;q+=1)S[g*8+q]=Number(v>>BigInt(56-q*8)&0xffn)}return S}a(yc,"sha512Bytes");var mt=2n**255n-19n,yi=2n**252n+27742317777372353535851937790883648493n;function nr(n,i,l){let d=1n;for(n%=l;i;i>>=1n)i&1n&&(d=d*n%l),n=n*n%l;return d}a(nr,"powmod");var ki=(mt-121665n)*nr(121666n,mt-2n,mt)%mt,vc=nr(2n,(mt-1n)/4n,mt);function mo(n){let i=0n;for(let l=0;l<n.length;l+=1)i|=BigInt(n[l])<<BigInt(8*l);return i}a(mo,"fromLE");function wc(n,i){let l=new Uint8Array(i);for(let d=0;d<i;d+=1)l[d]=Number(n&255n),n>>=8n;return l}a(wc,"toLE");function bo(n){if(n.length!==32)return null;let i=(n[31]&128)!==0,l=mo(n)&(1n<<255n)-1n;if(l>=mt)return null;let d=l*l%mt,u=(d-1n+mt)%mt,k=(ki*d+1n)%mt,P=u*nr(k,mt-2n,mt)%mt,A=nr(P,(mt+3n)/8n,mt);return A*A%mt!==P&&(A=A*vc%mt),A*A%mt!==P?null:(!!(A&1n)!==i&&(A=mt-A),{X:A,Y:l})}a(bo,"edDecompress");function ho(n,i){let l=n.X%mt,d=n.Y%mt,u=i.X%mt,k=i.Y%mt,P=ki*l%mt*u%mt*d%mt*k%mt,A=(l*k+u*d)%mt*nr((1n+P+mt)%mt,mt-2n,mt)%mt,y=(d*k%mt+l*u%mt)%mt*nr((1n-P+mt)%mt,mt-2n,mt)%mt;return{X:A,Y:y}}a(ho,"edAdd");function vi(n,i){let l=null,d={X:n.X%mt,Y:n.Y%mt};for(;i>0n;i>>=1n)i&1n&&(l=l?ho(l,d):d),d=ho(d,d);return l}a(vi,"edMul");var kc=bo(wc(46316835694926478169428394003475163141307993866256225615783033603165251855960n,32));function Ai(n,i,l){if(!n||!i||!l)return!1;let d=Er(n),u=Er(i),k=Er(l);if(d.length!==64||u.length!==32)return!1;let P=bo(u);if(!P)return!1;let A=bo(d.slice(0,32));if(!A)return!1;let y=mo(d.slice(32));if(y>=yi)return!1;let S=mo(yc(Ac(d.slice(0,32),u,k)))%yi,g=vi(kc,y),v=vi(P,S),q=v?{X:(mt-v.X%mt)%mt,Y:v.Y%mt}:null,C=g&&q?ho(g,q):g||q;return!C||!A?!1:C.X%mt===A.X%mt&&C.Y%mt===A.Y%mt}a(Ai,"ed25519Verify");function Ac(...n){let i=0;for(let u of n)i+=u.length;let l=new Uint8Array(i),d=0;for(let u of n)l.set(u,d),d+=u.length;return l}a(Ac,"concatBytes");var Pr={base:{},coursesPath:"courses",schedulePath:"schedule",courseFields:{name:"name",teacher:"teacher",position:"position",day:"day",sections:"sections",weeks:"weeks"},scheduleFields:{morningNum:"morningNum",afternoonNum:"afternoonNum",nightNum:"nightNum",sections:"sections"}},Sc=["name","teacher","position","day","sections","weeks","code","sequence","englishName","attribute","category","credit","status","campus","building","classroom","startSection","endSection","weekList"],_c=["morningNum","afternoonNum","nightNum","sections","sectionList"];function go(n){return JSON.parse(JSON.stringify(n))}a(go,"cloneJsonValue");function Ci(n,i){return n===i||n.startsWith(`${i}.`)||i.startsWith(`${n}.`)}a(Ci,"scheduleJsonPathsOverlap");function oa(n,i){let l=String(n??"").trim();if(!l){if(i)return"";throw new Error("课程数组输出路径不能为空")}if(l.length>120)throw new Error("JSON 输出路径不能超过 120 个字符");let d=l.split("."),u=new Set(["__proto__","prototype","constructor"]);if(d.some(P=>!P||/^\d+$/.test(P)||/[\[\]\x00-\x1f]/.test(P)||u.has(P)))throw new Error(`JSON 输出路径包含无效片段：${l}`);return d.join(".")}a(oa,"validateScheduleJsonPath");function Ec(n,i){for(let l=0;l<n.length;l+=1)for(let d=l+1;d<n.length;d+=1)if(Ci(n[l],n[d]))throw new Error(`${i}目标路径不能重叠：${n[l]} / ${n[d]}`)}a(Ec,"validateScheduleJsonTargetPaths");function Si(n,i,l){let d=i.split("."),u=n;for(let k=0;k<d.length;k+=1){let P=d[k];if(!Object.prototype.hasOwnProperty.call(u,P))return;if(k===d.length-1)throw new Error(`${l}输出路径与 base 字段重叠：${i}`);if(u=u[P],!u||typeof u!="object"||Array.isArray(u)){let A=d.slice(0,k+1).join(".");throw new Error(`${l}输出路径无法穿过 base 中的非对象字段：${A}`)}}}a(Si,"validateScheduleJsonBasePath");function _i(n,i,l){if(!n||typeof n!="object"||Array.isArray(n))throw new Error(`${l}字段映射必须是对象`);let d={};return Object.entries(n).forEach(([u,k])=>{if(!i.includes(u))throw new Error(`${l}不支持源字段：${u}`);let P=oa(k,!0);P&&(d[u]=P)}),Ec(Object.values(d),`${l}字段`),d}a(_i,"validateScheduleJsonFieldMap");function Ne(n){if(!n||typeof n!="object"||Array.isArray(n))throw new Error("自定义 JSON 映射必须是对象");let i=n.base==null?{}:n.base;if(!i||typeof i!="object"||Array.isArray(i))throw new Error("base 必须是 JSON 对象");let l={base:go(i),coursesPath:oa(n.coursesPath,!1),schedulePath:oa(n.schedulePath,!0),courseFields:_i(n.courseFields,Sc,"课程"),scheduleFields:_i(n.scheduleFields||{},_c,"时间表")};if(!Object.keys(l.courseFields).length)throw new Error("至少保留一个课程字段映射");if(l.schedulePath&&Ci(l.schedulePath,l.coursesPath))throw new Error("课程与时间表输出路径不能重叠");return Si(l.base,l.coursesPath,"课程"),l.schedulePath&&Si(l.base,l.schedulePath,"时间表"),l}a(Ne,"validateScheduleJsonMapping");function Cr(n){let i=String(n||"").replace(/\D/g,"").padStart(4,"0").slice(-4),l=`${i.slice(0,2)}:${i.slice(2)}`;return/^(?:[01]\d|2[0-3]):[0-5]\d$/.test(l)?l:""}a(Cr,"normalizeSectionTime");function fo(n,i,l){let d=oa(i,!1).split("."),u=n;d.forEach((k,P)=>{if(P===d.length-1){u[k]=l;return}(!u[k]||typeof u[k]!="object"||Array.isArray(u[k]))&&(u[k]={}),u=u[k]})}a(fo,"setScheduleJsonPath");function Ei(n,i){let l={};return Object.entries(i||{}).forEach(([d,u])=>{!Object.prototype.hasOwnProperty.call(n,d)||n[d]===void 0||fo(l,u,go(n[d]))}),l}a(Ei,"mappedScheduleJsonObject");function Cc(n){return[n.campus,n.building,n.classroom].map(i=>String(i||"").trim()).filter(Boolean).join(" ")}a(Cc,"scheduleJsonPosition");function Pc(n){let i=Number(n.startSection)||0,l=Number(n.endSection)||i;return i<1||l<i?"":Array.from({length:l-i+1},(d,u)=>i+u).join(",")}a(Pc,"scheduleJsonSectionString");function Lc(n,i){let l=Number(i.day)||0,d=Pc(i),u=Array.from(new Set((i.weeks||[]).map(Number).filter(k=>Number.isInteger(k)&&k>=1&&k<=60))).sort((k,P)=>k-P);return l<1||l>7||!d?{error:"invalid"}:u.length?{value:{name:n.name,teacher:n.teacher,position:Cc(i),day:l,sections:d,weeks:u.join(","),code:n.code,sequence:n.sequence,englishName:n.englishName,attribute:n.attribute,category:n.category,credit:n.credit,status:n.status,campus:i.campus,building:i.building,classroom:i.classroom,startSection:i.startSection,endSection:i.endSection,weekList:u}}:{error:"weeks"}}a(Lc,"scheduleJsonCourseRecord");function zc(n,i){let l=[];return n.courses.forEach(d=>{if(!d.arrangements.length){i.unscheduledCourses+=1;return}d.arrangements.forEach(u=>{let k=Lc(d,u);k.error==="weeks"?i.missingWeeks+=1:k.error?i.invalidArrangements+=1:l.push(k.value)})}),l}a(zc,"buildScheduleJsonCourses");function qc(n){let i=new Map;return(n||[]).forEach(l=>{let d=Number(l.section),u=Cr(l.start),k=Cr(l.end);!Number.isInteger(d)||d<1||d>20||!u||!k||i.set(d,{i:d,s:u,e:k})}),Array.from(i.values()).sort((l,d)=>l.i-d.i)}a(qc,"buildScheduleJsonSections");function Tc(n){let i=qc(n);if(!i.length)return{};let l={sections:JSON.stringify(i),sectionList:i};if(!i.every((u,k)=>u.i===k+1))return l;let d={morningNum:0,afternoonNum:0,nightNum:0};return i.forEach(u=>{let[k,P]=u.s.split(":").map(Number),A=k*60+P;A<720?d.morningNum+=1:A>=1080?d.nightNum+=1:d.afternoonNum+=1}),d.morningNum&&d.afternoonNum&&d.nightNum?Object.assign(l,d):l}a(Tc,"buildScheduleJsonSchedule");function na(n){let i={unscheduledCourses:0,missingWeeks:0,invalidArrangements:0},l=zc(n,i);if(!l.length)throw new Error("没有符合导入格式的已排课课程");return{courses:l,schedule:Tc(n.sections),stats:i}}a(na,"buildScheduleJsonSource");function ia(n){let i={courses:n.courses.map(d=>({name:d.name,teacher:d.teacher,position:d.position,day:d.day,sections:d.sections,weeks:d.weeks}))},l={};return["morningNum","afternoonNum","nightNum","sections"].forEach(d=>{Object.prototype.hasOwnProperty.call(n.schedule,d)&&(l[d]=n.schedule[d])}),Object.keys(l).length&&(i.schedule=l),i}a(ia,"buildXiaoAiScheduleJson");function pa(n,i){let l=go(i.base||{}),d=n.courses.map(u=>Ei(u,i.courseFields));if(fo(l,i.coursesPath,d),i.schedulePath&&Object.keys(n.schedule).length){let u=Ei(n.schedule,i.scheduleFields);Object.keys(u).length&&fo(l,i.schedulePath,u)}return l}a(pa,"buildCustomScheduleJson");function Lr(n){return n.getFullYear()+"-"+String(n.getMonth()+1).padStart(2,"0")+"-"+String(n.getDate()).padStart(2,"0")}a(Lr,"localDateIso");function ir(n){let i=String(n||"").match(/^(\d{4})-(\d{2})-(\d{2})$/);if(!i)return null;let l=new Date(Number(i[1]),Number(i[2])-1,Number(i[3]));return Number.isNaN(l.getTime())||Lr(l)!==String(n)?null:l}a(ir,"parseLocalIsoDate");function xo(n){let i=new Date(n.getFullYear(),n.getMonth(),n.getDate()),l=i.getDay();return i.setDate(i.getDate()-(l===0?6:l-1)),i}a(xo,"mondayOfDate");function Li(n){let i=String(n||"").match(/^(\d{4})-(\d{4})-(\d)/);if(!i)return Lr(xo(new Date));let l=i[3]==="1"?Number(i[1]):Number(i[2]),d=i[3]==="1"?8:2,u=new Date(l,d,1);for(;u.getDay()!==1;)u.setDate(u.getDate()+1);return Lr(u)}a(Li,"defaultSemesterMonday");function Pi(n){return n.getFullYear()+String(n.getMonth()+1).padStart(2,"0")+String(n.getDate()).padStart(2,"0")+"T"+String(n.getHours()).padStart(2,"0")+String(n.getMinutes()).padStart(2,"0")+"00"}a(Pi,"formatIcsLocal");function sa(n){return String(n||"").replace(/\\/g,"\\\\").replace(/;/g,"\\;").replace(/,/g,"\\,").replace(/\r?\n/g,"\\n")}a(sa,"escapeIcsText");function Mc(n){if(typeof TextEncoder!="function")return n;let i=new TextEncoder,l=[],d="",u=73;for(let k of String(n))i.encode(d+k).length>u&&d?(l.push(d),d=" "+k,u=74):d+=k;return d&&l.push(d),l.join(`\r
`)}a(Mc,"foldIcsLine");function $c(n){let i=2166136261,l=String(n||"");for(let d=0;d<l.length;d+=1)i=Math.imul(i^l.charCodeAt(d),16777619);return(i>>>0).toString(16)+"@scu-urppp"}a($c,"scheduleUid");function zi(n){let i=new Map;return n.sections.forEach(l=>i.set(l.section,l)),i}a(zi,"scheduleSectionMap");function Ic(n){return n.toISOString().replace(/[-:]/g,"").replace(/\.\d{3}/,"")}a(Ic,"formatTimestamp");function qi(n,i,l={}){let d=ir(i);if(!d)throw new Error("第一教学周日期无效");let u=zi(n);if(!u.size)throw new Error("教务接口没有返回节次时间，无法生成 ICS");let k=Ic(l.now instanceof Date?l.now:new Date),P=0,A=["BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//SCU URP++//Schedule Export//CN","CALSCALE:GREGORIAN","METHOD:PUBLISH","X-WR-CALNAME:"+sa(n.semester.label+"课表"),"X-WR-TIMEZONE:Asia/Shanghai","BEGIN:VTIMEZONE","TZID:Asia/Shanghai","X-LIC-LOCATION:Asia/Shanghai","BEGIN:STANDARD","TZOFFSETFROM:+0800","TZOFFSETTO:+0800","TZNAME:CST","DTSTART:19700101T000000","END:STANDARD","END:VTIMEZONE"];if(n.courses.forEach(y=>y.arrangements.forEach(S=>{let g=u.get(S.startSection),v=u.get(S.endSection);!g||!v||S.weeks.forEach(q=>{let C=new Date(d);C.setDate(d.getDate()+(q-1)*7+S.day-1);let f=new Date(C),m=new Date(C),w=g.start.split(":").map(Number),x=v.end.split(":").map(Number);f.setHours(w[0],w[1],0,0),m.setHours(x[0],x[1],0,0);let E=[S.campus,S.building,S.classroom].filter(Boolean).join(" "),z=["教师："+y.teacher,"周次："+S.weekDescription,"课程号："+y.code+(y.sequence?"_"+y.sequence:""),"学分："+y.credit,"课程属性："+y.attribute].filter(T=>!/[：:]$/.test(T)).join(`
`),$=[n.semester.planCode,y.code,y.sequence,S.day,S.startSection,S.endSection,q,S.campus,S.building,S.classroom].join("|");P+=1,A.push("BEGIN:VEVENT","UID:"+$c($),"DTSTAMP:"+k,"SUMMARY:"+sa(y.name),"LOCATION:"+sa(E),"DESCRIPTION:"+sa(z),"DTSTART;TZID=Asia/Shanghai:"+Pi(f),"DTEND;TZID=Asia/Shanghai:"+Pi(m),"END:VEVENT")})})),!P)throw new Error("课表中没有已安排时间的课程，无法生成 ICS");return A.push("END:VCALENDAR"),A.map(Mc).join(`\r
`)+`\r
`}a(qi,"buildScheduleIcs");function Ti(n){let i=zi(n),l=0,d=0;return n.courses.forEach(u=>u.arrangements.forEach(k=>{k.weeks.length||(l+=1),(!i.has(k.startSection)||!i.has(k.endSection))&&(d+=1)})),{missingWeeks:l,missingTimes:d}}a(Ti,"scheduleIcsOmissionStats");function Nc(n){let i=String(n||"").replace(/[—–]/g,"-"),l=/单周|单数周|[（(]单[）)]/.test(i)?1:/双周|双数周|[（(]双[）)]/.test(i)?0:-1,d=new Set,u=a(k=>{let P=Number(k);P>=1&&P<=30&&(l<0||P%2===l)&&d.add(P)},"add");return i.replace(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/g,(k,P,A)=>{let y=Math.min(Number(P),Number(A)),S=Math.max(Number(P),Number(A));for(let g=y;g<=S;g+=1)u(g);return k}),(i.match(/\d{1,2}/g)||[]).forEach(u),Array.from(d).sort((k,P)=>k-P)}a(Nc,"scheduleWeeksFromDescription");function Mi(n,i){let l=String(n||"").trim();if(/^[01]+$/.test(l)){let d=[];for(let u=0;u<l.length;u+=1)l.charAt(u)==="1"&&d.push(u+1);return d}return Nc(i||l)}a(Mi,"scheduleWeeks");function Bc(n){let i=n&&Array.isArray(n.xkxx)?n.xkxx:[];for(let l of i){let d=Object.values(l||{});if(d.length)return d[0]}return null}a(Bc,"firstScheduleCourse");function pr(n){let i=Bc(n);if(!i)return"";let l=Array.isArray(i.timeAndPlaceList)?i.timeAndPlaceList[0]:null;return String(i.zxjxjhh||i.executiveEducationPlanNumber||i.id&&(i.id.zxjxjhh||i.id.executiveEducationPlanNumber)||l&&(l.zxjxjhh||l.executiveEducationPlanNumber)||"").trim()}a(pr,"schedulePlanCodeFromData");function Fc(n){let i=String(n||"").match(/^(\d{4})-(\d{4})-(\d)/);if(!i)return"学生课表";let l=i[3]==="1"?"秋季学期":i[3]==="2"?"春季学期":"学期";return i[1]+"-"+i[2]+"学年"+l}a(Fc,"semesterLabelFromPlanCode");function $i(n,i,l,d={}){let u=i||pr(n),k=(Array.isArray(n&&n.jcsjbs)?n.jcsjbs:[]).map(y=>({section:Number(y.jc)||0,start:Cr(y.kssj),end:Cr(y.jssj)})).filter(y=>y.section>=1&&y.section<=20&&y.start&&y.end).sort((y,S)=>y.section-S.section),P=[];(Array.isArray(n&&n.xkxx)?n.xkxx:[]).forEach(y=>{Object.keys(y||{}).forEach(S=>{let g=y[S];if(!g)return;let v=g.id||{},q=(g.timeAndPlaceList||[]).map(C=>({day:Number(C.classDay)||0,startSection:Number(C.classSessions)||1,endSection:Math.min(12,(Number(C.classSessions)||1)+Math.max(1,Number(C.continuingSession)||1)-1),weeks:Mi(C.classWeek,C.weekDescription||g.skzcs),weekDescription:String(C.weekDescription||g.skzcs||"").trim(),campus:String(C.campusName||"").trim(),building:String(C.teachingBuildingName||"").trim(),classroom:String(C.classroomName||"").trim()})).filter(C=>C.day>=1&&C.day<=7&&C.startSection>=1&&C.startSection<=12);P.push({code:String(v.coureNumber||g.zkch||"").trim(),sequence:String(v.coureSequenceNumber||g.zkxh||"").trim(),name:String(g.courseName||g.englishCourseName||S).trim(),englishName:String(g.englishCourseName||"").trim(),teacher:String(g.attendClassTeacher||"").trim(),attribute:String(g.coursePropertiesName||"").trim(),category:String(g.courseCategoryName||"").trim(),credit:Number(g.unit)||0,status:String(g.selectCourseStatusName||"").trim(),arrangements:q})})});let A=String(d.firstMonday||"").trim();return{schemaVersion:1,exportedAt:(d.now instanceof Date?d.now:new Date).toISOString(),source:l||"SCU URP++",semester:{planCode:u,label:Fc(u),firstMonday:ir(A)?A:""},sections:k,courses:P}}a($i,"normalizeScheduleExportData");function Ii(n,i,l,d=0){let u=Math.max(0,Number(n)||0),k=Math.max(1,Math.floor(Number(i)||1)),P=Math.max(0,Math.min(k-1,Math.floor(Number(l)||0))),A=-Math.max(0,Number(d)||0),y=A+u*P/k,S=A+u*(P+1)/k;return{left:y,width:Math.max(0,S-y)}}a(Ii,"scheduleCardLaneGeometry");function la(n,i,l){let d=[],u=String(n||""),k=Math.max(4,Number(i)||4);for(;u;)d.push({text:u.slice(0,k),kind:l}),u=u.slice(k);return d}a(la,"wrapField");function ca(n,i){let l=n.slice(0,Math.max(0,i)).map(d=>({...d}));if(l.length&&l.length<n.length){let d=l[l.length-1];d.text=d.text.length>1?d.text.slice(0,-1)+"…":"…"}return l}a(ca,"takeLines");var Ni=["#2563EB","#059669","#D97706","#DC2626","#7C3AED","#0891B2","#DB2777","#4D7C0F","#EA580C","#4F46E5"];function Fi(n){let i=0,l=String(n||"");for(let d=0;d<l.length;d+=1)i=i*31+l.charCodeAt(d)>>>0;return Ni[i%Ni.length]}a(Fi,"exportCourseColor");function Bi(n){let i=[];n.forEach(l=>{let d=i.findIndex(u=>u<l.startSection);d<0&&(d=i.length,i.push(0)),i[d]=l.endSection,l.lane=d}),n.forEach(l=>{l.laneCount=Math.max(1,i.length)})}a(Bi,"assignScheduleLanes");function Di(n){let i=n.slice().sort((u,k)=>u.startSection-k.startSection||u.endSection-k.endSection||u.course.name.localeCompare(k.course.name)),l=[],d=0;return i.forEach(u=>{l.length&&u.startSection>d&&(Bi(l),l=[],d=0),l.push(u),d=Math.max(d,u.endSection)}),l.length&&Bi(l),i}a(Di,"layoutScheduleDay");function ji(n){let i=[];return n.courses.forEach(l=>l.arrangements.forEach(d=>{i.push({course:l,arrangement:d,startSection:d.startSection,endSection:d.endSection,day:d.day})})),i}a(ji,"scheduleExportEvents");function Oi(n,i){let l=[],d=String(n||"");for(;d;)l.push(d.slice(0,i)),d=d.slice(i);return l}a(Oi,"wrapScheduleFooter");function Hi(n,i,l){let d=n.startSection===n.endSection?n.startSection+"节":n.startSection+"-"+n.endSection+"节",u=la(n.name,Math.max(5,i),"title"),k=la(n.teacher,Math.max(6,i+2),"teacher"),P=la([n.weekDescription,d].filter(Boolean).join(" · "),Math.max(6,i+2),"schedule"),A=la([n.campus,n.building,n.classroom].filter(Boolean).join(" "),Math.max(6,i+2),"location"),y=Math.max(1,Number(l)||1),S=A.length&&y>=2?Math.min(2,A.length):0,g=P.length&&y>=3?1:0,v=k.length&&y>=4?1:0,q=Math.max(1,y-S-g-v),C=ca(u,q),f=y-C.length,m=Math.min(k.length,Math.max(0,f-g-S));C.push(...ca(k,m)),f=y-C.length;let w=Math.min(P.length,Math.max(0,f-S));return C.push(...ca(P,w)),f=y-C.length,C.push(...ca(A,f)),C.slice(0,y)}a(Hi,"scheduleImageTextLines");function Dc(n,i){let l=Fi(i),d=n.colors,u=n.skin;return u==="brutal"?{fill:Ft(d.surface,l,.48),stroke:"#000000",text:"#111111",secondary:"#242424",stripe:l}:u==="flat"?{fill:Ft(d.surface,l,n.dark?.24:.16),stroke:d.text,text:d.text,secondary:d.secondary,stripe:l}:u==="editorial"?{fill:Ft(d.surface,l,n.dark?.16:.08),stroke:d.border,text:d.text,secondary:d.secondary,stripe:l}:{fill:Ft(d.surface,l,n.dark?.28:u==="organic"?.2:.14),stroke:Ft(d.border,l,n.dark?.52:.42),text:d.text,secondary:d.secondary,stripe:l}}a(Dc,"scheduleImageCourseStyle");function Ri(n,i,l={}){if(!i||!i.colors||!i.shape)throw new Error("课表图片主题未解析");let d=i.colors,u=i.shape,k=l.now instanceof Date?l.now:new Date,P=1960,A=40,y=136,S=P-A*2,g=A+24,v=64,q=8,C=g+v+12,f=A+S-24,m=(f-C-q*6)/7,w=y+88,x=108,E=102,$=w+x*12-y+24,T=n.courses.filter(ot=>!ot.arrangements.length).map(ot=>ot.name),j=Oi(T.join("、"),92),I=j.length?74+j.length*27:44,H=y+$+I,G=["星期一","星期二","星期三","星期四","星期五","星期六","星期日"],U=u.serif?"Georgia,Noto Serif SC,Songti SC,STSong,SimSun,serif":"Microsoft YaHei,Segoe UI,sans-serif",et="Microsoft YaHei,Segoe UI,sans-serif",pt=["soft","warm","neu"].includes(u.shadow)?' filter="url(#schedule-frame-shadow)"':"",bt=["soft","warm","neu"].includes(u.shadow)?' filter="url(#schedule-card-shadow)"':"",V=[`<svg xmlns="http://www.w3.org/2000/svg" width="${P}" height="${H}" viewBox="0 0 ${P} ${H}">`,"<defs>",`<filter id="schedule-frame-shadow" x="-20%" y="-20%" width="140%" height="150%"><feDropShadow dx="0" dy="${i.dark?10:7}" stdDeviation="${i.dark?16:11}" flood-color="${i.dark?"#000000":d.text}" flood-opacity="${i.dark?.48:.1}"/></filter>`,`<filter id="schedule-card-shadow" x="-20%" y="-20%" width="140%" height="150%"><feDropShadow dx="0" dy="3" stdDeviation="5" flood-color="${i.dark?"#000000":d.text}" flood-opacity="${i.dark?.34:.1}"/></filter>`,"</defs>",`<rect width="100%" height="100%" fill="${d.bg}"/>`,`<rect x="${A}" y="32" width="142" height="36" rx="${u.headerRadius}" fill="${d.primary}"/>`,`<text x="${A+71}" y="56" text-anchor="middle" fill="#FFFFFF" font-size="15" font-weight="700" font-family="${et}">SCU URP++</text>`,`<text x="${A}" y="106" fill="${d.text}" font-size="36" font-weight="700" font-family="${U}">${at(n.semester.label)}课表</text>`,`<text x="${P-A}" y="54" text-anchor="end" fill="${d.secondary}" font-size="16" font-family="${et}">${at(i.label)}</text>`,`<text x="${P-A}" y="83" text-anchor="end" fill="${d.muted}" font-size="14" font-family="${et}">${at(k.toLocaleString("zh-CN",{hour12:!1}))}</text>`];u.shadow==="hard"&&V.push(`<rect x="${A+8}" y="${y+8}" width="${S}" height="${$}" fill="#000000"/>`),V.push(`<rect x="${A}" y="${y}" width="${S}" height="${$}" rx="${u.frameRadius}" fill="${d.surface}" stroke="${u.shadow==="hard"?"#000000":d.border}" stroke-width="${u.frameStroke}"${pt}/>`),G.forEach((ot,X)=>{let ct=C+X*(m+q);V.push(`<rect x="${ct}" y="${y+22}" width="${m}" height="48" rx="${u.headerRadius}" fill="${d.input}" stroke="${d.border}" stroke-width="${u.frameStroke?1:0}"/>`,`<text x="${ct+m/2}" y="${y+53}" text-anchor="middle" fill="${d.secondary}" font-size="17" font-weight="600" font-family="${et}">${ot}</text>`)});for(let ot=1;ot<=12;ot+=1){let X=w+(ot-1)*x;V.push(`<rect x="${g}" y="${X}" width="${v}" height="${E}" rx="${u.gridRadius}" fill="${d.input}" stroke="${d.border}" stroke-width="${u.frameStroke?1:0}"/>`,`<text x="${g+v/2}" y="${X+E/2+6}" text-anchor="middle" fill="${d.muted}" font-size="16" font-weight="600" font-family="${et}">${ot}</text>`),G.forEach((ct,rt)=>{let st=C+rt*(m+q);V.push(`<rect x="${st}" y="${X}" width="${m}" height="${E}" rx="${u.gridRadius}" fill="${d.input}" stroke="${d.border}" stroke-width="${u.frameStroke?1:0}"/>`)})}[4,9].forEach(ot=>{let X=w+ot*x-3;V.push(`<line x1="${C}" y1="${X}" x2="${f}" y2="${X}" stroke="${d.primary}" stroke-opacity=".42" stroke-width="2" stroke-dasharray="10 9"/>`)});for(let ot=1;ot<=7;ot+=1)Di(ji(n).filter(ct=>ct.day===ot)).forEach((ct,rt)=>{let st=m/ct.laneCount,xt=C+(ot-1)*(m+q)+ct.lane*st,Z=w+(ct.startSection-1)*x,dt=st,At=Math.max(E,(ct.endSection-ct.startSection)*x+E),kt=Dc(i,ct.course.name),Pt="course-clip-"+ot+"-"+rt,B=Math.max(1,Math.floor((At-18)/23)),Y=Hi({name:ct.course.name,teacher:ct.course.teacher,weekDescription:ct.arrangement.weekDescription,startSection:ct.startSection,endSection:ct.endSection,campus:ct.arrangement.campus,building:ct.arrangement.building,classroom:ct.arrangement.classroom},Math.floor((dt-22)/16),B);V.push(`<clipPath id="${Pt}"><rect x="${xt+11}" y="${Z+8}" width="${Math.max(10,dt-22)}" height="${Math.max(18,At-16)}" rx="${Math.max(0,u.cardRadius-5)}"/></clipPath>`,`<rect data-course-card="1" data-day="${ot}" data-start="${ct.startSection}" data-end="${ct.endSection}" x="${xt}" y="${Z}" width="${dt}" height="${At}" rx="${u.cardRadius}" fill="${kt.fill}" stroke="${kt.stroke}" stroke-width="${u.cardStroke}"${bt}/>`),i.skin==="brutal"&&V.push(`<path d="M ${xt+dt-4} ${Z+4} V ${Z+At-4} H ${xt+4}" fill="none" stroke="#000000" stroke-opacity=".28" stroke-width="5"/>`),i.skin==="editorial"&&V.push(`<rect x="${xt}" y="${Z}" width="6" height="${At}" fill="${kt.stripe}"/>`),i.skin==="neu"&&V.push(`<path d="M ${xt+u.cardRadius} ${Z+1} H ${xt+dt-u.cardRadius}" stroke="#FFFFFF" stroke-opacity=".32" stroke-width="2"/>`),V.push('<g clip-path="url(#'+Pt+')">'),Y.forEach((tt,ft)=>{let ht=tt.kind==="title";V.push(`<text data-kind="${tt.kind}" x="${xt+14}" y="${Z+28+ft*23}" fill="${ht?kt.text:kt.secondary}" font-size="${ht?16:13}" font-weight="${ht?700:500}" font-family="${ht&&u.serif?U:et}">${at(tt.text)}</text>`)}),V.push("</g>")});let Q=y+$+30;return j.length?(V.push(`<text x="${A}" y="${Q}" fill="${d.secondary}" font-size="15" font-weight="700" font-family="${et}">未排定时间的课程</text>`),j.forEach((ot,X)=>V.push(`<text x="${A}" y="${Q+29+X*27}" fill="${d.muted}" font-size="14" font-family="${et}">${at(ot)}</text>`))):V.push(`<text x="${A}" y="${Q}" fill="${d.muted}" font-size="14" font-family="${et}">由 SCU URP++ 基于结构化课表数据生成</text>`),V.push("</svg>"),{svg:V.join(""),width:P,height:H,background:d.bg,theme:i}}a(Ri,"buildScheduleSvg");function jc(n,i,l={}){let d=[],u=l.json||null,k=l.ics||null,P=n==="ics"?i.courses.filter(A=>!A.arrangements.length).length:0;return P&&d.push(P+" 门未排定时间的课程未写入日历"),u&&u.unscheduledCourses&&d.push(u.unscheduledCourses+" 门未排定时间的课程未写入 JSON"),u&&u.missingWeeks&&d.push(u.missingWeeks+" 个上课安排缺少周次"),u&&u.invalidArrangements&&d.push(u.invalidArrangements+" 个上课安排缺少日期或节次"),k&&k.missingWeeks&&d.push(k.missingWeeks+" 个上课安排缺少周次"),k&&k.missingTimes&&d.push(k.missingTimes+" 个上课安排缺少节次时间"),d}a(jc,"scheduleExportCompletionNotes");function da(n,i,l,d,u){return`<button type="button" class="urppp-export-option" role="menuitem" data-export-type="${n}"${u?" disabled":""}><i class="fa ${i}" aria-hidden="true"></i><span><strong>${l}</strong><small>${d}</small></span></button>`}a(da,"exportOptionHtml");function Ui(n){let{document:i,window:l,ensureStyles:d,loadData:u,exportJson:k,exportIcs:P,exportPng:A,showToast:y,nativePageUrl:S,navigate:g,logger:v=console}=n;function q(x){x&&(x.classList.remove("open"),x.querySelector(".urppp-export-trigger")?.setAttribute("aria-expanded","false"))}a(q,"closeMenu");function C(){l.__urpppExportDismissBound||(l.__urpppExportDismissBound=!0,i.addEventListener("click",x=>{i.querySelectorAll(".urppp-export-wrap.open").forEach(E=>{E.contains(x.target)||q(E)})},!0),i.addEventListener("keydown",x=>{x.key==="Escape"&&i.querySelectorAll(".urppp-export-wrap.open").forEach(q)}))}a(C,"bindDismiss");async function f(x,E,z,$){if($&&$.disabled)return;let T=$&&$.innerHTML;try{if($&&($.disabled=!0,$.innerHTML='<i class="fa fa-spinner fa-spin"></i> 准备中'),x==="pdf"){if(typeof z!="function")throw new Error("当前页面不提供原生 PDF 导出");await z();return}let j=await u(E),I={};if(x==="json")I.json=await k(j);else if(x==="ics")I.ics=await P(j);else if(x==="png")await A(j);else throw new Error("未知导出格式");let H=jc(x,j,I);y("课表已导出："+x.toUpperCase()+(H.length?"；"+H.join("，"):""))}catch(j){if(j&&j.message==="已取消导出")return;v.warn("[URP++] schedule export",j),y(j&&j.message||String(j),!0)}finally{$&&($.disabled=!1,$.innerHTML=T)}}a(f,"run");function m(x={}){d();let E=x.source||"native",z=x.pdfHandler,$=typeof z=="function",T=i.createElement("span"),j=E==="native"?"导出课表":"导出";T.className="urppp-export-wrap",T.innerHTML=`<button type="button" class="urppp-export-trigger" aria-haspopup="menu" aria-expanded="false" title="导出课表"><i class="fa fa-cloud-download" aria-hidden="true"></i><span>${j}</span><i class="fa fa-angle-down" aria-hidden="true"></i></button><div class="urppp-export-menu" role="menu">${da("ics","fa-calendar","ICS 日历","导入系统日历或日历应用",!1)}${da("json","fa-code","JSON 数据","兼容小爱课程导入，可自定义格式",!1)}${da("png","fa-image","PNG 图片","完整学期课表高清图片",!1)}${da("pdf","fa-file-pdf-o","PDF",$?"使用教务系统原生导出":"仅原教务课表页面可用",!$)}${$?"":'<div class="urppp-export-guide">PDF 依赖原教务课表页面。<button type="button" data-export-native="1">前往本学期课表</button></div>'}</div>`;let I=T.querySelector(".urppp-export-trigger");I.addEventListener("click",G=>{G.preventDefault(),G.stopPropagation();let U=!T.classList.contains("open");i.querySelectorAll(".urppp-export-wrap.open").forEach(q),T.classList.toggle("open",U),I.setAttribute("aria-expanded",U?"true":"false")}),T.querySelectorAll("[data-export-type]:not(:disabled)").forEach(G=>{G.addEventListener("click",()=>{q(T),f(G.getAttribute("data-export-type"),E,z,I)})});let H=T.querySelector("[data-export-native]");return H&&H.addEventListener("click",()=>g(S)),C(),T}a(m,"createMenu");function w(x){(x&&x.querySelectorAll?x:i).querySelectorAll("[data-schedule-export-host]").forEach(z=>{z.querySelector(".urppp-export-wrap")||z.appendChild(m({source:z.getAttribute("data-schedule-export-host")||"clean"}))})}return a(w,"bindHosts"),{bindHosts:w,closeMenu:q,createMenu:m,run:f}}a(Ui,"createScheduleExportUi");function Wi(n){let i=a(l=>{n.querySelectorAll(".urppp-set-tab").forEach(d=>{let u=d.dataset.tab===l;d.classList.toggle("ac",u),d.setAttribute("aria-selected",u?"true":"false")}),n.querySelectorAll(".urppp-set-pane").forEach(d=>{d.classList.toggle("ac",d.dataset.pane===l)});try{let d=n.querySelector(".urppp-set-body");d&&(d.scrollTop=0)}catch{}},"switchTab");return n.querySelectorAll(".urppp-set-tab").forEach(l=>{l.addEventListener("click",()=>i(l.dataset.tab))}),n.__urpppSwitchTab=i,i}a(Wi,"bindSettingsTabs");function Gi(n){let{document:i,ensurePanel:l,syncPanel:d,refreshUpdateStatus:u,defaultTab:k="theme"}=n;function P(){l();let y=i.getElementById("urppp-settings-panel"),S=i.getElementById("urppp-settings-mask");if(!y||!S)return!1;d();try{u()}catch{}try{y.__urpppSwitchTab&&y.__urpppSwitchTab(k)}catch{}S.classList.remove("open"),y.classList.remove("open"),y.offsetWidth,S.classList.add("open"),y.classList.add("open");try{let g=y.querySelector(".urppp-set-body");g&&(g.scrollTop=0)}catch{}return!0}a(P,"open");function A(){let y=i.getElementById("urppp-settings-panel"),S=i.getElementById("urppp-settings-mask");y&&y.classList.remove("open"),S&&S.classList.remove("open")}return a(A,"close"),{close:A,open:P}}a(Gi,"createSettingsPanelController");function Ji(n){let{logoData:i,repositoryUrl:l,version:d}=n;return['<div class="urppp-set-head">','  <div class="urppp-set-title">设置</div>','  <button type="button" class="urppp-set-close" id="urppp-set-close" aria-label="关闭">×</button>',"</div>",'<div class="urppp-set-tabs" role="tablist">','  <button type="button" class="urppp-set-tab ac" data-tab="theme" role="tab" aria-selected="true">主题设置</button>','  <button type="button" class="urppp-set-tab" data-tab="skin" role="tab" aria-selected="false">主题选择</button>','  <button type="button" class="urppp-set-tab" data-tab="system" role="tab" aria-selected="false">系统设置</button>','  <button type="button" class="urppp-set-tab" data-tab="about" role="tab" aria-selected="false">关于</button>',"</div>",'<div class="urppp-set-body">','  <div class="urppp-set-pane ac" data-pane="theme">','    <section class="urppp-set-sec">',"      <h3>主题模式</h3>",'      <div class="urppp-set-modes" id="urppp-set-modes">','        <button type="button" class="urppp-set-mode" data-theme="default">简约白</button>','        <button type="button" class="urppp-set-mode" data-theme="dark">深邃暗</button>','        <button type="button" class="urppp-set-mode" data-theme="scu-red">动态配色</button>',"      </div>",'      <div class="urppp-set-follow-row">','        <button type="button" class="urppp-set-follow" id="urppp-set-follow" aria-pressed="false">跟随系统：关</button>','        <button type="button" class="urppp-set-follow" id="urppp-set-follow-dynamic" aria-pressed="false">浅色用动态配色：关</button>',"      </div>",'      <button type="button" class="urppp-set-follow" id="urppp-set-clean-default" aria-pressed="false" style="margin-top:12px;width:100%">默认进入清爽模式：关</button>','      <button type="button" class="urppp-set-follow" id="urppp-set-clean-analysis" aria-pressed="false" style="margin-top:12px;width:100%">清爽成绩分析展示：选项卡</button>','      <button type="button" class="urppp-set-follow" id="urppp-set-apple-edge" aria-pressed="true" style="margin-top:12px;width:100%">类Apple边缘线条：开</button>',"    </section>",'    <section class="urppp-set-sec" id="urppp-set-dynamic">',"      <h3>种子色</h3>",'      <p class="urppp-set-tip">选一个颜色，自动生成背景、卡片、强调色等多套方案</p>','      <div class="urppp-set-presets" id="urppp-set-presets"></div>','      <div class="urppp-set-custom">','        <input type="color" id="urppp-set-color" value="#B53434" />','        <input type="text" id="urppp-set-hex" maxlength="7" value="#B53434" spellcheck="false" />','        <button type="button" class="urppp-set-btn" id="urppp-set-gen">生成方案</button>','        <button type="button" class="urppp-set-btn ghost" id="urppp-set-save">存为预设</button>',"      </div>",'      <h3 style="margin-top:16px">配色方案</h3>','      <div class="urppp-set-schemes" id="urppp-set-schemes"></div>',"    </section>",'    <section class="urppp-set-sec" id="urppp-set-brutal" style="display:none">',"      <h3>高对比配色</h3>",'      <p class="urppp-set-tip">默认圆点使用高能粉；选择一种备用配色后，可由左上第三个圆点快速切换。</p>','      <div class="urppp-set-schemes" id="urppp-set-brutal-palettes"></div>',"    </section>","  </div>",'  <div class="urppp-set-pane" data-pane="skin">','    <section class="urppp-set-sec">',"      <h3>界面风格</h3>",'      <p class="urppp-set-tip">在同一布局上切换视觉气质。因适配规模较大，仅保证清爽模式的完整适配，如有影响请使用默认类Apple风格并选择性开启边缘线条。</p>','      <div class="urppp-theme-store-bar"><button type="button" class="urppp-set-btn ghost" id="urppp-theme-store">主题商店</button></div>','      <div id="urppp-theme-store-inline" class="urppp-store-inline" style="display:none"></div>','      <div class="urppp-skin-list" id="urppp-skin-list"></div>',"    </section>","  </div>",'  <div class="urppp-set-pane" data-pane="system">','    <section class="urppp-set-sec" id="urppp-set-privacy">',"      <h3>隐私模式</h3>",'      <div class="urppp-set-modes" id="urppp-set-privacy-modes">','        <button type="button" class="urppp-set-follow urppp-privacy-mode" data-privacy-mode="off">关闭</button>','        <button type="button" class="urppp-set-follow urppp-privacy-mode" data-privacy-mode="one">一键隐私</button>','        <button type="button" class="urppp-set-follow urppp-privacy-mode" data-privacy-mode="custom">自定义</button>',"      </div>",'      <div class="urppp-privacy-groups" id="urppp-set-privacy-custom">','        <div class="urppp-privacy-group">','          <div class="urppp-privacy-group-title">身份信息</div>','          <div class="urppp-privacy-group-fields">','            <div class="urppp-privacy-field"><input id="urppp-privacy-identity" type="checkbox" data-privacy-field="identity" aria-label="隐藏学号和证件"><label for="urppp-privacy-identity">学号/证件</label><input class="urppp-feature-input" data-privacy-value="identity" maxlength="40" aria-label="学号和证件替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-organization" type="checkbox" data-privacy-field="organization" aria-label="隐藏学院和专业"><label for="urppp-privacy-organization">学院/专业</label><input class="urppp-feature-input" data-privacy-value="organization" maxlength="40" aria-label="学院和专业替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-contact" type="checkbox" data-privacy-field="contact" aria-label="隐藏联系和个人信息"><label for="urppp-privacy-contact">联系/个人信息</label><input class="urppp-feature-input" data-privacy-value="contact" maxlength="40" aria-label="联系和个人信息替换内容"></div>',"          </div>","        </div>",'        <div class="urppp-privacy-group">','          <div class="urppp-privacy-group-title">学业信息</div>','          <div class="urppp-privacy-group-fields">','            <div class="urppp-privacy-field"><input id="urppp-privacy-grade" type="checkbox" data-privacy-field="grade" aria-label="隐藏成绩"><label for="urppp-privacy-grade">成绩</label><input class="urppp-feature-input" data-privacy-value="grade" maxlength="40" aria-label="成绩替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-gpa" type="checkbox" data-privacy-field="gpa" aria-label="隐藏绩点"><label for="urppp-privacy-gpa">绩点</label><input class="urppp-feature-input" data-privacy-value="gpa" maxlength="40" aria-label="绩点替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-credit" type="checkbox" data-privacy-field="credit" aria-label="隐藏学分"><label for="urppp-privacy-credit">学分</label><input class="urppp-feature-input" data-privacy-value="credit" maxlength="40" aria-label="学分替换内容"></div>',"          </div>","        </div>",'        <div class="urppp-privacy-group">','          <div class="urppp-privacy-group-title">页面内容</div>','          <div class="urppp-privacy-group-fields">','            <div class="urppp-privacy-field"><input id="urppp-privacy-other" type="checkbox" data-privacy-field="other" aria-label="隐藏其他数据"><label for="urppp-privacy-other">其他数据</label><input class="urppp-feature-input" data-privacy-value="other" maxlength="40" aria-label="其他数据替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-schedule" type="checkbox" data-privacy-field="schedule" aria-label="隐藏课表"><label for="urppp-privacy-schedule">课表</label><input class="urppp-feature-input" data-privacy-value="schedule" maxlength="40" aria-label="课表替换内容"></div>','            <div class="urppp-privacy-field urppp-privacy-field-static"><input id="urppp-privacy-avatar" type="checkbox" data-privacy-field="avatar" aria-label="隐藏头像"><label for="urppp-privacy-avatar">头像</label><span class="urppp-privacy-note">使用统一遮罩</span></div>',"          </div>","        </div>","      </div>",'      <div class="urppp-direct-edit-control">',"        <div><strong>自由修改显示数据</strong><span>开启后，直接点击首页或清爽模式中带标记的数据进行修改</span></div>",'        <button type="button" class="urppp-set-follow" id="urppp-set-direct-edit-toggle" aria-pressed="false">页面内修改：关</button>',"      </div>","    </section>",'    <section class="urppp-set-sec" id="urppp-set-identity">',"      <h3>自定义姓名与头像</h3>",'      <div class="urppp-identity-editor">','        <div class="urppp-identity-fields">','          <div class="urppp-feature-row"><label><input type="checkbox" id="urppp-set-name-enabled"> 自定义姓名</label><input class="urppp-feature-input" id="urppp-set-custom-name" maxlength="40" placeholder="输入显示姓名"></div>','          <div class="urppp-feature-row"><label><input type="checkbox" id="urppp-set-avatar-enabled"> 自定义头像</label><input class="urppp-feature-input" id="urppp-set-custom-avatar-url" placeholder="https://... 图片地址"></div>','          <div class="urppp-feature-row"><label for="urppp-set-custom-avatar-file">本地图片</label><input class="urppp-feature-input" type="file" id="urppp-set-custom-avatar-file" accept="image/png,image/jpeg,image/webp,image/gif"></div>',"        </div>",'        <div class="urppp-identity-preview">','          <span class="urppp-identity-preview-label">头像预览</span>','          <div class="urppp-avatar-preview-shell"><span>未设置</span><img class="urppp-avatar-preview" id="urppp-set-avatar-preview" alt="自定义头像预览"></div>',"        </div>","      </div>",'      <div class="urppp-feature-actions"><button type="button" class="urppp-set-btn" id="urppp-set-privacy-save">保存隐私与显示设置</button><button type="button" class="urppp-set-btn ghost" id="urppp-set-avatar-clear">清除自定义头像</button></div>','      <div class="urppp-set-tip" id="urppp-set-privacy-status" style="margin-top:8px"></div>',"    </section>",'    <section class="urppp-set-sec" id="urppp-set-json-export">',"      <h3>JSON 导出格式</h3>",'      <button type="button" class="urppp-set-follow" id="urppp-set-json-custom" aria-pressed="false" style="width:100%">自定义 JSON：关</button>','      <div class="urppp-json-mapping-editor" id="urppp-set-json-editor">','        <label for="urppp-set-json-mapping">字段映射</label>','        <textarea id="urppp-set-json-mapping" spellcheck="false" aria-label="自定义 JSON 字段映射"></textarea>','        <p class="urppp-set-tip">源字段包括 name、teacher、position、day、sections、weeks、code、credit、campus、building、classroom、weekList 等；目标值支持 data.courses 形式的嵌套路径。</p>','        <div class="urppp-feature-actions"><button type="button" class="urppp-set-btn" id="urppp-set-json-save">保存映射</button><button type="button" class="urppp-set-btn ghost" id="urppp-set-json-reset">恢复默认映射</button></div>',"      </div>",'      <div class="urppp-set-tip" id="urppp-set-json-status" style="margin-top:8px"></div>',"    </section>",'    <section class="urppp-set-sec" id="urppp-set-update">',"      <h3>更新</h3>",'      <button type="button" class="urppp-set-follow" id="urppp-set-auto-update" aria-pressed="false" style="width:100%">自动检测更新：关</button>','      <button type="button" class="urppp-set-btn" id="urppp-set-check-update" style="margin-top:12px;width:100%">检查更新</button>','      <div id="urppp-set-update-status" class="urppp-set-tip" style="margin-top:8px"></div>',"    </section>",'    <div id="urppp-set-assist-slot"></div>',"  </div>",'  <div class="urppp-set-pane" data-pane="about">','    <div class="urppp-about">','      <img class="urppp-about-logo" id="urppp-about-logo" src="'+i+'" alt="SCU URP++" referrerpolicy="no-referrer" />','      <a class="urppp-about-ver" id="urppp-about-ver" href="'+l+'" target="_blank" rel="noopener noreferrer">SCU URP++ v'+d+"</a>",'      <p class="urppp-about-author">作者：Chao_Lan · Hanako</p>','      <p class="urppp-about-contact">QQ：2718748334</p>',`      <p class="urppp-about-msg">有任何问题欢迎及时反馈！
半夜Vibe有点爽怎么回事。</p>`,"    </div>","  </div>","</div>"].join("")}a(Ji,"buildSettingsPanelHtml");var ee="urppp_plugin_",Oc="1.0.0";function yo({GM:n,doc:i,hostInfo:l,uiDeps:d}){let{getValue:u=a(()=>null,"getValue"),setValue:k=a(()=>{},"setValue"),xmlHttp:P,addStyle:A}=n||{},y=(typeof d=="function"?d:d&&d.openSubpanel)||null,S=new Map,g=new Map,v=new Map,q=[],C=null;function f(B,Y){let tt=v.get(B);tt&&tt.forEach(ft=>{try{ft(Y)}catch{}})}a(f,"emit");function m(B,Y){return v.has(B)||v.set(B,new Set),v.get(B).add(Y),()=>v.get(B).delete(Y)}a(m,"on");function w(B,Y){return u(`${ee}${B}_${Y}`)}a(w,"storageGet");function x(B,Y,tt){k(`${ee}${B}_${Y}`,tt)}a(x,"storageSet");function E(){return B=>({get:a(Y=>w(B,Y),"get"),set:a((Y,tt)=>x(B,Y,tt),"set"),remove:a(Y=>k(`${ee}${B}_${Y}`,void 0),"remove")})}a(E,"storage");function z(B,Y={}){return new Promise((tt,ft)=>{if(typeof P!="function"){ft(new Error("GM_xmlhttpRequest 不可用（未授权跨域？）"));return}P({method:Y.method||"GET",url:B,headers:Y.headers||{},data:Y.data,timeout:Y.timeout||8e3,onload:a(ht=>ht.status>=200&&ht.status<300?tt(ht.responseText):ft(new Error(`HTTP ${ht.status}`)),"onload"),onerror:a(()=>ft(new Error("网络错误")),"onerror"),ontimeout:a(()=>ft(new Error("超时(8s)")),"ontimeout")})})}a(z,"request");async function $(B,Y){let tt=Array.isArray(B)?B:[B],ft=[];for(let ht=0;ht<tt.length;ht+=1){let zt=tt[ht];Y&&Y({stage:"downloading",index:ht+1,total:tt.length,url:zt});try{let vt=await z(zt);return Y&&Y({stage:"downloaded",url:zt,size:vt.length}),vt}catch(vt){ft.push(`源${ht+1}(${T(zt)})失败: ${vt&&vt.message?vt.message:vt}`),Y&&Y({stage:"source_failed",index:ht+1,total:tt.length,error:vt&&vt.message?vt.message:vt})}}throw new Error("所有下载源失败 → "+ft.join(" ｜ "))}a($,"fetchWithFallback");function T(B){try{return new URL(B).host}catch{return B}}a(T,"shortHost");function j(B){let Y=String(B||"").match(/\/\/\s*==UserScript==[\s\S]*?\/\/\s*==\/UserScript==/);return Y?B.replace(Y[0],""):B}a(j,"stripMetadata");function I(B,Y){try{let tt=j(B),ft=["GM_getValue","GM_setValue","GM_xmlhttpRequest","GM_registerMenuCommand","GM_addStyle","unsafeWindow"],ht=[typeof GM_getValue=="function"?GM_getValue:void 0,typeof GM_setValue=="function"?GM_setValue:void 0,typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:void 0,typeof GM_registerMenuCommand=="function"?GM_registerMenuCommand:void 0,typeof GM_addStyle=="function"?GM_addStyle:void 0,typeof unsafeWindow<"u"?unsafeWindow:null];return new Function(...ft,tt)(...ht),!0}catch(tt){return console.warn("[URP++ plugin] 注入失败",Y,tt),!1}}a(I,"inject");function H(B,Y){let tt=g.get(B);return tt?(tt.enabled=!!Y,k(`${ee}${B}_enabled`,tt.enabled),f(Y?"enabled":"disabled",B),!0):!1}a(H,"setEnabled");function G(B){let Y=g.get(B);return!!Y&&Y.enabled}a(G,"isEnabled");function U(B){if(!B||!B.id)return!1;if(S.has(B.id)&&S.get(B.id).__urpppRegistered)return!0;let Y=Object.assign({type:"plugin"},B);Y.__urpppRegistered=!0,S.set(B.id,Y);let tt=g.get(B.id)||{loaded:!1,enabled:!1,version:B.version||""};return tt.version=Y.version||tt.version,g.set(B.id,tt),f("registered",Y.id),!0}a(U,"register");function et(B){return S.get(B)||null}a(et,"get");function pt(B){let Y=[];for(let tt of S.values())(!B||tt.type===B)&&Y.push(tt);return Y}a(pt,"list");function bt(B){let Y=g.get(B);return!!Y&&Y.loaded}a(bt,"loaded");async function V(B,Y,tt){tt&&tt({stage:"start",id:B});let ft=Array.isArray(Y)?Y:Y?[Y]:rt(B),ht=await $(ft,tt);k(`${ee}${B}_code`,ht),tt&&tt({stage:"injecting",id:B});let zt=I(ht,B),vt=g.get(B)||{loaded:!1,enabled:!1,version:""};return vt.loaded=zt,vt.enabled=zt,vt.code=ht,vt.version=vt.version||Q(ht),g.set(B,vt),k(`${ee}${B}_enabled`,zt),f("loaded",B),zt}a(V,"install");function Q(B){let Y=String(B||"").match(/@version\s+(\S+)/);return Y?Y[1]:""}a(Q,"detectVersion");async function ot(B,Y,tt){let ft=Array.isArray(Y)?Y:Y?[Y]:rt(B),ht=await $(ft,tt);k(`${ee}${B}_code`,ht);let zt=Q(ht),vt=g.get(B)||{loaded:!1,enabled:!1,version:""};return vt.version=zt||vt.version,vt.code=ht,g.set(B,vt),f("updated",B),{ok:!0,version:zt||vt.version}}a(ot,"update");function X(B){let Y=u(`${ee}${B}_code`);if(!Y)return!1;let tt=g.get(B);if(tt&&tt.loaded)return!0;let ft=I(Y,B),ht=g.get(B)||{loaded:!1,enabled:!1,version:Q(Y)};return ht.loaded=ft,ht.enabled=ft&&u(`${ee}${B}_enabled`)!==!1,ht.code=Y,g.set(B,ht),f("loaded",B),ft}a(X,"bootFromCache");function ct(B){let Y=S.get(B);return S.delete(B),g.delete(B),k(`${ee}${B}_enabled`,!1),f("unregistered",B),!!Y}a(ct,"unregister");function rt(B){return B==="assist"?["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/plugins/urpppp.plugin.js","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/plugins/urpppp.plugin.js","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/plugins/urpppp.plugin.js"]:[]}a(rt,"pluginSource");let st={protocolVersion:Oc,register:U,unregister:ct,get:et,list:pt,loaded:bt,isEnabled:G,enable:a((B,Y=!0)=>H(B,Y),"enable"),disable:a(B=>H(B,!1),"disable"),install:V,update:ot,bootFromCache:X,storage:a(()=>u&&{get:a(B=>u(B),"get"),set:a((B,Y)=>k(B,Y),"set")},"storage"),pluginStorage:a(B=>E()(B),"pluginStorage"),request:z,addStyle:a(B=>{try{A&&A(B)}catch{}},"addStyle"),log:a((...B)=>{console.log("[URP++ plugin]",...B)},"log"),on:m,emit:f,hostInfo:Object.assign({name:"SCU URP++"},l||{}),getSubpanel:a(()=>y,"getSubpanel")};try{window.__urpppPlugin=st}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppPlugin=st)}catch{}function xt(B){if(!B||!i||B.querySelector(".urppp-plugin-sec, .urpppp-entry-sec"))return;let Y=i.createElement("section");Y.className="urppp-set-sec urppp-plugin-sec",Y.id="urppp-plugin-sec",Y.innerHTML=`
      <h3>辅助插件</h3>
    ...
    `,B.appendChild(Y);let tt=Y.querySelector("#urppp-plugin-status"),ft=Y.querySelector("#urppp-plugin-install"),ht=Y.querySelector("#urppp-plugin-store"),zt=Y.querySelector("#urppp-plugin-panels"),vt=Y.querySelector("#urppp-plugin-tip");function Dt(){let Lt=g.get("assist"),Nt=S.has("assist");Lt&&Lt.loaded||Nt?(tt.textContent=`辅助插件 v${Lt&&Lt.version?Lt.version:et("assist")&&et("assist").version||""} 已装载`,tt.className="urppp-plugin-status ok",ft.textContent="重新装载",ft.dataset.state="loaded",vt.textContent="已装载。下方为扩展入口。"):(tt.textContent=C||"未装载",tt.className=C?"urppp-plugin-status err":"urppp-plugin-status",ft.textContent="装载辅助插件",ft.dataset.state="notloaded",vt.textContent=C?"装载失败，可就近重试或放回本地安装。下方为装载/商店入口。":"点击装载后，主插件会下载并注入辅助插件（登录助手/评教/会话保持/2FA），无需再单独安装。"),zt.innerHTML="";let Zt=Pt();if(Zt&&Object.keys(Zt).length){let Be=i.createElement("div");Be.className="urppp-plugin-sub",Object.keys(Zt).forEach(he=>{let Xt=i.createElement("button");Xt.type="button",Xt.className="urppp-set-btn ghost",Xt.textContent=Zt[he].label||he,Xt.addEventListener("click",()=>{try{Zt[he]&&typeof Zt[he].open=="function"?Zt[he].open():y&&y(he)}catch{}}),Be.appendChild(Xt)}),zt.appendChild(Be)}}a(Dt,"refresh"),ft.addEventListener("click",async()=>{ft.disabled=!0,ft.textContent="装载中…",tt.className="urppp-plugin-status",tt.textContent="正在开始装载…";try{if(await V("assist",null,Nt=>{try{Nt.stage==="downloading"?tt.textContent=`下载中… 源${Nt.index}/${Nt.total}（${T(Nt.url)}）`:Nt.stage==="downloaded"?tt.textContent=`已下载（${Nt.size} 字节），注入中…`:Nt.stage==="source_failed"?tt.textContent=`源${Nt.index}失败（${Nt.error||""}），切换下一源…`:Nt.stage==="injecting"?tt.textContent="注入中…":Nt.stage==="start"&&(tt.textContent="正在开始装载…"),console.log("[URP++ plugin] assist 装载进度",Nt)}catch{}}))C=null,tt.textContent="辅助插件已装载 v"+(et("assist")&&et("assist").version||""),console.log("[URP++ plugin] assist 装载成功");else throw new Error("注入失败")}catch(Lt){C="装载失败："+(Lt&&Lt.message?Lt.message:Lt),tt.textContent=C,tt.className="urppp-plugin-status err",console.warn("[URP++ plugin] assist 装载失败",Lt)}finally{ft.disabled=!1,Dt()}}),ht.addEventListener("click",()=>{y&&y("plugin-store")}),m("loaded",Lt=>{Lt==="assist"&&Dt()}),m("registered",Lt=>{Lt==="assist"&&Dt()}),m("unregistered",Lt=>{Lt==="assist"&&Dt()}),Dt()}a(xt,"renderAssistUi");function Z(B){return String(B??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}a(Z,"escapeHtml");function dt(B){if(B){if(At(),B.dataset.rendered==="1"){B.style.display=B.style.display==="none"?"":"none";return}B.dataset.rendered="1",B.innerHTML=`
    ...
    `,(i.head||i.documentElement).appendChild(B)}a(At,"ensureStoreStyle");function kt(B){if(!B)return;B.innerHTML="";let Y=Array.from(S.values());if(!Y.length){B.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}Y.forEach(tt=>{let ft=g.get(tt.id)||{},ht=i.createElement("div");ht.className="urppp-store-item";let zt=i.createElement("div");zt.className="urppp-store-info",zt.innerHTML="<strong>"+Z(tt.name||tt.id)+'</strong><span class="urppp-store-ver">'+(tt.version?"v"+Z(tt.version):"")+'</span><span class="urppp-store-state'+(ft.loaded?" ok":"")+'">'+(ft.loaded?"已装载":"未装载")+"</span>";let vt=i.createElement("div");vt.className="urppp-store-ops";let Dt=i.createElement("button");Dt.type="button",Dt.textContent="重新装载",Dt.addEventListener("click",async()=>{Dt.disabled=!0,Dt.textContent="装载中…";try{let Nt=await V(tt.id,null);Dt.textContent=Nt?"已装载":"装载失败",f("loaded",tt.id)}catch{Dt.textContent="装载失败"}setTimeout(()=>{Dt.disabled=!1,Dt.textContent="重新装载"},1400)});let Lt=i.createElement("button");Lt.type="button",Lt.className="danger",Lt.textContent="卸载",Lt.addEventListener("click",()=>{ct(tt.id),k(`${ee}${tt.id}_code`,""),k(`${ee}${tt.id}_enabled`,!1),f("unregistered",tt.id),kt(B)}),vt.appendChild(Dt),vt.appendChild(Lt),ht.appendChild(zt),ht.appendChild(vt),B.appendChild(ht)})}a(kt,"renderStoreManage");function Pt(){let B={};return S.forEach(Y=>{if(Y.subpanels&&typeof Y.subpanels=="function"){let tt=Y.subpanels();Object.keys(tt||{}).forEach(ft=>{B[ft]=tt[ft]})}else Y.subpanels&&typeof Y.subpanels=="object"&&Object.keys(Y.subpanels).forEach(tt=>{B[tt]=Y.subpanels[tt]})}),B}return a(Pt,"collectSubpanels"),{api:st,install:V,update:ot,renderAssistUi:xt,openPluginStore:dt,bootFromCache:X,register:U}}a(yo,"createPluginManager");function Vi(n){let{document:i,getSettings:l,setSettings:d,validateMapping:u,defaultMapping:k,getRecoveryMessage:P=a(()=>"","getRecoveryMessage")}=n;function A(g,v,q){let C=g&&g.querySelector("#urppp-set-json-status");C&&(C.textContent=v||"",C.classList.toggle("urppp-status-error",!!q),C.style.color=q?"var(--danger,#b91c1c)":"var(--text-muted)")}a(A,"setStatus");function y(g,v){if(!g)return;let q=l(),C=g.querySelector("#urppp-set-json-custom"),f=g.querySelector("#urppp-set-json-editor"),m=g.querySelector("#urppp-set-json-mapping");C&&(C.classList.toggle("ac",q.enabled),C.setAttribute("aria-pressed",q.enabled?"true":"false"),C.textContent="自定义 JSON："+(q.enabled?"开":"关")),f&&(f.style.display=q.enabled?"grid":"none"),m&&(v||!g.__urpppJsonMappingDirty&&i.activeElement!==m)&&(m.value=JSON.stringify(q.mapping,null,2),g.__urpppJsonMappingDirty=!1);let w=P();w&&A(g,w,!0)}a(y,"sync");function S(g){if(!g||g.__urpppJsonSettingsBound)return;g.__urpppJsonSettingsBound=!0;let v=g.querySelector("#urppp-set-json-custom"),q=g.querySelector("#urppp-set-json-mapping"),C=g.querySelector("#urppp-set-json-save"),f=g.querySelector("#urppp-set-json-reset");q&&q.addEventListener("input",()=>{g.__urpppJsonMappingDirty=!0}),v&&v.addEventListener("click",()=>{let m=l();m.enabled=!m.enabled;let w=!!g.__urpppJsonMappingDirty;d(m),y(g,!1);let x=m.enabled?"已启用自定义 JSON 格式":"已恢复小爱课程兼容格式";A(g,w?x+"；未保存草稿已保留":x)}),C&&C.addEventListener("click",()=>{try{let m=JSON.parse(String(q&&q.value||"").trim()),w=l();w.mapping=u(m),d(w),g.__urpppJsonMappingDirty=!1,y(g,!0),A(g,"自定义 JSON 映射已保存")}catch(m){A(g,m&&m.message||String(m),!0)}}),f&&f.addEventListener("click",()=>{let m=l();m.mapping=u(k),d(m),g.__urpppJsonMappingDirty=!1,y(g,!0),A(g,"已恢复默认字段映射")})}return a(S,"bind"),{bind:S,setStatus:A,sync:y}}a(Vi,"createJsonSettingsController");var zr="••••";var Yi={name:{enabled:!1,replacement:"同学"},identity:{enabled:!0,replacement:"已隐藏"},organization:{enabled:!0,replacement:"已隐藏"},contact:{enabled:!0,replacement:"已隐藏"},grade:{enabled:!0,replacement:"已隐藏"},gpa:{enabled:!0,replacement:"••••"},credit:{enabled:!0,replacement:"••••"},other:{enabled:!0,replacement:"已隐藏"},avatar:{enabled:!0,replacement:""},schedule:{enabled:!1,replacement:"课表已隐藏"}},Hc=["completedCourses","failedCourses","majorGpa","majorPlan","remainingCourses","passingTotalCredit","passingAvgScore","passingAvgGpa","passingRequiredCredit","passingRequiredAvg","passingRequiredGpa","schemeTotalCredit","schemeAvgScore","schemeAvgGpa","schemeRequiredCredit","schemeRequiredAvg","schemeRequiredGpa"];function vo(n){let i=n&&typeof n=="object"?n:{},l=["off","one","custom"].includes(i.mode)?i.mode:"off",d={},u=i.fields&&typeof i.fields=="object"?i.fields:{},k=u.score&&typeof u.score=="object"?u.score:null;Object.keys(Yi).forEach(g=>{let v=Yi[g],q=["grade","gpa","credit"].includes(g)?k:null,C=g==="other"&&u.grade&&typeof u.grade=="object"?u.grade:null,f=u[g]&&typeof u[g]=="object"?u[g]:q||C||{};d[g]={enabled:g==="name"?!1:f.enabled==null?v.enabled:!!f.enabled,replacement:String(f.replacement==null?v.replacement:f.replacement).slice(0,80)}});let P=i.homepage&&typeof i.homepage=="object"?i.homepage:{},A=i.directEdit&&typeof i.directEdit=="object"?i.directEdit:P,y=A.values&&typeof A.values=="object"?A.values:{},S={};return Hc.forEach(g=>{S[g]=String(y[g]==null?"":y[g]).trim().slice(0,80)}),{mode:l,mask:zr,fields:d,directEdit:{enabled:!!A.enabled,values:S}}}a(vo,"normalizePrivacySettings");function qr(n){let i=n&&typeof n=="object"?n:{},l=String(i.avatar||"").trim();return{nameEnabled:!!i.nameEnabled,name:String(i.name||"").trim().slice(0,40),avatarEnabled:!!i.avatarEnabled,avatar:l.length<=3145728?l:"",avatarName:String(i.avatarName||"").trim().slice(0,120)}}a(qr,"normalizeCustomIdentity");function sr(n){let i=String(n||"").trim();return i.length>3145728?"":/^(https?:\/\/|data:image\/(?:png|jpe?g|gif|webp);base64,)/i.test(i)?i:""}a(sr,"validCustomAvatar");function Rc(n,i=globalThis.FileReader){return new Promise((l,d)=>{if(!n||!/^image\/(png|jpeg|webp|gif)$/i.test(n.type||"")){d(new Error("请选择 PNG、JPG、WebP 或 GIF 图片"));return}if(n.size>2*1024*1024){d(new Error("本地头像不能超过 2MB"));return}let u=new i;u.onload=()=>l(String(u.result||"")),u.onerror=()=>d(new Error("读取头像失败")),u.readAsDataURL(n)})}a(Rc,"readAvatarFile");function Qi(n){let{getPrivacySettings:i,setPrivacySettings:l,getCustomIdentity:d,setCustomIdentity:u,applyDisplay:k,refreshCleanDisplay:P,finishActiveDirectEdit:A,readAvatar:y=Rc}=n;function S(f,m){let w=m.mode==="custom",x=f.querySelector(".urppp-direct-edit-control"),E=f.querySelector("#urppp-set-direct-edit-toggle");x&&(x.style.display=w?"flex":"none"),E&&(E.dataset.enabled=m.directEdit.enabled?"1":"0",E.classList.toggle("ac",m.directEdit.enabled),E.setAttribute("aria-pressed",m.directEdit.enabled?"true":"false"),E.textContent="页面内修改："+(m.directEdit.enabled?"开":"关"))}a(S,"syncDirectEdit");function g(f){if(!f)return;let m=i();f.querySelectorAll("[data-privacy-mode]").forEach(I=>{let H=I.getAttribute("data-privacy-mode")===m.mode;I.classList.toggle("ac",H),I.setAttribute("aria-pressed",H?"true":"false")});let w=f.querySelector("#urppp-set-privacy-custom");w&&(w.style.display=m.mode==="custom"?"grid":"none"),Object.keys(m.fields).forEach(I=>{let H=m.fields[I],G=f.querySelector('[data-privacy-field="'+I+'"]'),U=f.querySelector('[data-privacy-value="'+I+'"]');G&&(G.checked=!!H.enabled),U&&(U.value=H.replacement||"",U.disabled=!H.enabled)}),S(f,m);let x=d(),E=f.querySelector("#urppp-set-name-enabled"),z=f.querySelector("#urppp-set-custom-name"),$=f.querySelector("#urppp-set-avatar-enabled"),T=f.querySelector("#urppp-set-custom-avatar-url"),j=f.querySelector("#urppp-set-avatar-preview");if(E&&(E.checked=x.nameEnabled),z&&(z.value=x.name,z.disabled=!x.nameEnabled),$&&($.checked=x.avatarEnabled),T&&(T.value=/^data:image\//i.test(x.avatar)?"":x.avatar,T.disabled=!x.avatarEnabled),f.__urpppAvatarSource=x.avatar,j){let I=sr(x.avatar);j.style.display=I?"block":"none",I?j.src=I:j.removeAttribute("src")}}a(g,"sync");function v(f){let m=i();Object.keys(m.fields).forEach(x=>{let E=f.querySelector('[data-privacy-field="'+x+'"]'),z=f.querySelector('[data-privacy-value="'+x+'"]');E&&(m.fields[x].enabled=!!E.checked),z&&(m.fields[x].replacement=String(z.value||"").trim().slice(0,80))});let w=f.querySelector("#urppp-set-direct-edit-toggle");return m.directEdit.enabled=!!(w&&w.dataset.enabled==="1"),m}a(v,"collect");function q(f,m,w){let x=f&&f.querySelector("#urppp-set-privacy-status");x&&(x.textContent=m||"",x.style.color=w?"#b91c1c":"var(--text-muted)")}a(q,"setStatus");function C(f){if(!f||f.__urpppPrivacyBound)return;f.__urpppPrivacyBound=!0,f.querySelectorAll("[data-privacy-mode]").forEach(T=>{T.addEventListener("click",()=>{let j=i();j.mode=T.getAttribute("data-privacy-mode")||"off",l(j),g(f),k()})}),f.querySelectorAll("[data-privacy-field]").forEach(T=>{T.addEventListener("change",()=>{let j=T.getAttribute("data-privacy-field"),I=f.querySelector('[data-privacy-value="'+j+'"]');I&&(I.disabled=!T.checked)})});let m=f.querySelector("#urppp-set-direct-edit-toggle");m&&m.addEventListener("click",()=>{let T=m.dataset.enabled!=="1";m.dataset.enabled=T?"1":"0",m.classList.toggle("ac",T),m.setAttribute("aria-pressed",T?"true":"false"),m.textContent="页面内修改："+(T?"开":"关")});let w=f.querySelector("#urppp-set-name-enabled"),x=f.querySelector("#urppp-set-avatar-enabled");w&&w.addEventListener("change",()=>{let T=f.querySelector("#urppp-set-custom-name");T&&(T.disabled=!w.checked)}),x&&x.addEventListener("change",()=>{let T=f.querySelector("#urppp-set-custom-avatar-url");T&&(T.disabled=!x.checked)});let E=f.querySelector("#urppp-set-custom-avatar-file");E&&E.addEventListener("change",async()=>{try{let T=await y(E.files&&E.files[0]);f.__urpppAvatarSource=T;let j=f.querySelector("#urppp-set-avatar-preview");j&&(j.src=T,j.style.display="block"),x&&(x.checked=!0),q(f,"本地头像已读取，点击保存后生效")}catch(T){q(f,T&&T.message||String(T),!0)}});let z=f.querySelector("#urppp-set-avatar-clear");z&&z.addEventListener("click",()=>{try{let T=d();T.avatarEnabled=!1,T.avatar="",T.avatarName="",u(T),f.__urpppAvatarSource="",g(f),k(),P(),q(f,"已清除自定义头像")}catch(T){q(f,T&&T.message||"清除自定义头像失败",!0)}});let $=f.querySelector("#urppp-set-privacy-save");$&&$.addEventListener("click",()=>{let T=i(),j=d();try{let I=v(f),H=f.querySelector("#urppp-set-custom-avatar-url"),U=String(H&&H.value||"").trim()||f.__urpppAvatarSource||"",et=qr({nameEnabled:!!(w&&w.checked),name:String(f.querySelector("#urppp-set-custom-name")?.value||"").trim(),avatarEnabled:!!(x&&x.checked),avatar:U,avatarName:j.avatarName});if(et.avatarEnabled&&!sr(et.avatar))throw new Error("头像地址必须是 http(s) 图片或已选择的本地图片");T.directEdit.enabled&&!I.directEdit.enabled&&A(!0);try{u(et),l(I)}catch(pt){try{u(j),l(T)}catch{}throw pt}k(),P(),g(f),q(f,"隐私与显示设置已保存")}catch(I){q(f,I&&I.message||String(I),!0)}})}return a(C,"bind"),{bind:C,collect:v,setStatus:q,sync:g}}a(Qi,"createPrivacySettingsController");function Xi(n){let{document:i,theme:l,preferences:d,accent:u,syncPanel:k}=n;function P(){l.getFollowSystem()?l.apply(l.resolveFollowTheme(),{system:!0}):l.apply("scu-red",{manual:!0})}a(P,"applyAccentTheme");function A(S,g){let v=S.querySelector("#urppp-set-schemes");if(!v)return;let q=u.getScheme();v.innerHTML="",u.listSchemePreviews(g).forEach(C=>{let f=i.createElement("button");f.type="button",f.className="urppp-set-scheme"+(C.id===q?" ac":""),f.innerHTML=['<div class="urppp-set-scheme-preview">','  <span style="background:'+C.bg+'"></span>','  <span style="background:'+C.surface+";border-color:"+C.border+'"></span>','  <span style="background:'+C.primary+'"></span>',"</div>",'<div class="urppp-set-scheme-meta">',"  <strong>"+C.name+"</strong>","  <em>"+C.desc+"</em>","</div>"].join(""),f.addEventListener("click",()=>{u.setAccent(g),u.setScheme(C.id),P(),k()}),v.appendChild(f)})}a(A,"renderSchemeChoices");function y(S){S.querySelectorAll(".urppp-set-mode").forEach(T=>{T.addEventListener("click",()=>{l.isModeAvailable(T.dataset.theme)&&(l.apply(T.dataset.theme,{manual:!0}),k())})});let g=S.querySelector("#urppp-set-follow");g&&g.addEventListener("click",()=>{if(!l.supportsDark())return;let T=!l.getFollowSystem();l.setFollowSystem(T),T?l.apply(l.resolveFollowTheme(),{system:!0}):l.apply(l.getCurrent(),{manual:!0}),k(),l.syncNavbar()});let v=S.querySelector("#urppp-set-follow-dynamic");v&&v.addEventListener("click",()=>{l.supportsDynamic()&&(l.getFollowSystem()?l.setFollowDynamic(!l.getFollowDynamic()):(l.setFollowSystem(!0),l.setFollowDynamic(!0)),l.apply(l.resolveFollowTheme(),{system:!0}),k(),l.syncNavbar())});let q=S.querySelector("#urppp-set-clean-default");q&&q.addEventListener("click",()=>{d.setCleanDefault(!d.getCleanDefault()),k()});let C=S.querySelector("#urppp-set-clean-analysis");C&&C.addEventListener("click",()=>{let T=d.getCleanAnalysis()==="direct";d.setCleanAnalysis(T?"tab":"direct"),k()});let f=S.querySelector("#urppp-set-apple-edge");f&&f.addEventListener("click",()=>{d.setAppleEdge(!d.getAppleEdge());try{d.applySkin()}catch{}k()});let m=S.querySelector("#urppp-set-auto-update");m&&m.addEventListener("click",()=>{d.setAutoUpdate(!d.getAutoUpdate()),k()});let w=S.querySelector("#urppp-set-check-update");w&&!w.__urpppBound&&(w.__urpppBound=!0,w.addEventListener("click",()=>{d.checkUpdates()}));let x=S.querySelector("#urppp-set-color"),E=S.querySelector("#urppp-set-hex");if(!x||!E)return;x.addEventListener("input",()=>{E.value=x.value.toUpperCase()}),E.addEventListener("change",()=>{let T=u.normalize(E.value);T&&(E.value=T,x.value=T)});let z=S.querySelector("#urppp-set-gen");z&&z.addEventListener("click",()=>{let T=u.normalize(E.value)||x.value;T&&(u.setAccent(u.normalize(T)),P(),k())});let $=S.querySelector("#urppp-set-save");$&&$.addEventListener("click",()=>{let T=u.normalize(E.value)||x.value;T&&(u.savePreset(T),u.setAccent(u.normalize(T)),P(),k())}),x.addEventListener("change",()=>{let T=u.normalize(x.value);T&&(E.value=T,A(S,T))})}return a(y,"bind"),{bind:y,renderSchemeChoices:A}}a(Xi,"createThemeSettingsController");function Ki(n,i){let{seed:l,currentTheme:d,followSystem:u,skinId:k,darkSupported:P,dynamicSupported:A,fixedPalettes:y,followUseDynamic:S,cleanDefault:g,cleanAnalysis:v,appleEdge:q,autoUpdate:C,modeAvailability:f}=i,m=n.querySelector("#urppp-set-color"),w=n.querySelector("#urppp-set-hex");m&&(m.value=l),w&&(w.value=l),n.querySelectorAll(".urppp-set-mode").forEach(U=>{let et=U.dataset.theme,pt=f[et]!==!1,bt=!u&&et===d&&pt;U.disabled=!pt,U.classList.toggle("ac",bt),U.classList.toggle("urppp-dyn-disabled",!pt),U.setAttribute("aria-disabled",pt?"false":"true"),pt?U.removeAttribute("title"):U.title=et==="dark"?"当前界面风格不支持暗色模式":"当前界面风格不支持动态配色"});let x=n.querySelector("#urppp-set-follow");x&&(x.disabled=!P,x.classList.toggle("ac",u&&P),x.classList.toggle("urppp-dyn-disabled",!P),x.setAttribute("aria-pressed",u&&P?"true":"false"),x.textContent=u&&P?"跟随系统：开":"跟随系统：关",x.title=P?"":"当前界面风格不支持暗色模式");let E=n.querySelector("#urppp-set-follow-dynamic");E&&(E.classList.toggle("ac",S&&A),E.setAttribute("aria-pressed",S&&A?"true":"false"),E.textContent=S?"浅色用动态配色：开":"浅色用动态配色：关",E.disabled=!u||!A,E.classList.toggle("urppp-dyn-disabled",!A),E.style.opacity=A&&u?"1":"0.5",E.title=A?"":"当前界面风格不支持动态配色");let z=n.querySelector("#urppp-set-dynamic");z&&(z.style.display=A?"":"none",z.style.opacity="1",z.classList.toggle("urppp-dyn-disabled",!1),z.querySelectorAll("button, input, .urppp-set-scheme, .urppp-set-swatch").forEach(U=>{U.disabled=!1,U.classList.toggle("urppp-dyn-disabled",!1)}),z.querySelectorAll("h3, .urppp-set-tip, label").forEach(U=>{U.classList.toggle("urppp-dyn-disabled",!1)}));let $=n.querySelector("#urppp-set-brutal");$&&($.style.display=y?"":"none");let T=n.querySelector("#urppp-set-clean-default");T&&(T.classList.toggle("ac",g),T.setAttribute("aria-pressed",g?"true":"false"),T.textContent=g?"默认进入清爽模式：开":"默认进入清爽模式：关");let j=n.querySelector("#urppp-set-clean-analysis");if(j){let U=v==="direct";j.classList.toggle("ac",U),j.setAttribute("aria-pressed",U?"true":"false"),j.textContent=U?"清爽成绩分析展示：直接显示":"清爽成绩分析展示：选项卡"}let I=n.querySelector("#urppp-set-apple-edge"),H=n.querySelector("#urppp-set-apple-edge-tip");if(I){let U=k==="apple";I.style.display=U?"":"none",H&&(H.style.display=U?"":"none"),U&&(I.classList.toggle("ac",q),I.setAttribute("aria-pressed",q?"true":"false"),I.textContent=q?"类Apple边缘线条：开":"类Apple边缘线条：关")}let G=n.querySelector("#urppp-set-auto-update");G&&(G.classList.toggle("ac",C),G.setAttribute("aria-pressed",C?"true":"false"),G.textContent=C?"自动检测更新：开":"自动检测更新：关")}a(Ki,"syncThemeSettingsControls");function wo(n){let i=String(n||"").replace(/\s+/g,"");return/^[•·●○▪◆★\-–]$/.test(i)||/^\d{1,4}$/.test(i)}a(wo,"isNoticeBulletText");function Uc(n){return/\d{4}[-/.年]\d{1,2}([-/.月]\d{1,2})?/.test(String(n||""))}a(Uc,"isNoticeDateText");function Zi({pathname:n="",href:i="",title:l="",headingText:d=""}={}){return/courseSelectNotice|evaluationNotice|notice\/index/i.test(`${n} ${i}`)?!0:/评估公告|通知公告|选课公告|公告|通知/.test(`${l} ${d}`)}a(Zi,"isNoticePageContext");function ko(n,{noticePage:i=!1}={}){if(!n)return!1;let d=(n.querySelector("thead")?.textContent||"").replace(/\s+/g,"");if(/标题/.test(d)&&/发布时间|发布日期|日期|时间/.test(d)||i&&/标题|公告|通知/.test(d)&&!/教室|教学楼|课程号|成绩|学号|座位数/.test(d))return!0;let u=n.querySelectorAll("tbody tr, tr"),k=0;if(u.forEach(A=>{let y=A.querySelectorAll("td");y.length<2||y.length>4||wo(y[0].textContent)&&A.querySelector("a")&&Uc(A.textContent)&&(k+=1)}),k<1)return!1;if(i||k===u.length)return!0;let P=n.getAttribute("style")||"";return/dashed/i.test(P)||n.classList.contains("no-border-top")||!!n.getAttribute("width")}a(ko,"isNoticeListTable");function tp(n,{noticePage:i=!1}={}){if(!n)return!0;if(n.classList?.contains("urppp-notice-table")||ko(n,{noticePage:i}))return!1;let l=`${n.id||""} ${n.getAttribute("class")||""}`;if(/freeClassroom|courseTable|codeTable|jszhpjdf|score|grade|exam|drag|classroom/i.test(l)||n.querySelector('#tbodyFreeClassroom, tbody[id*="FreeClassroom"], tbody[id*="Classroom"], tbody[id*="course"], tbody[id*="Code"]'))return!0;let d=n.querySelector("tbody tr, tr");if(d&&d.querySelectorAll("td,th").length>=5)return!0;let k=(n.querySelector("thead")?.textContent||"").replace(/\s+/g,"");return!!(k&&(/校区|教学楼|教室|座位数|类型|课表|操作|课程号|课程名|成绩|学号|姓名|教师|周次|节次/.test(k)||/序号/.test(k)&&!/标题|公告|通知|发布时间/.test(k))||n.querySelector("a")&&/课表|教室信息|查看/.test(n.textContent||"")&&!i&&/座位数|教学楼|教室号|校区名/.test(n.textContent||""))}a(tp,"isBusinessDataTable");function ep({isNativePdfIsolationActive:n,isBusinessDataTable:i,documentRef:l=document,windowRef:d=window,MutationObserverRef:u=MutationObserver,getComputedStyleRef:k=getComputedStyle}){function P(){n()||l.querySelectorAll("table.table, table.table-bordered, table.dataTable").forEach(y=>{if(!y||y.closest(".urppp-table-wrap")||y.id==="courseTable"||y.closest(".modal, .modal-dialog, .modal-content, .modal-body, #work_rest_schedule_modal")||y.classList.contains("urppp-wrs-table")||y.classList.contains("urppp-notice-table"))return;i(y);let S=y.parentElement;if(!S)return;let g=S.style?.overflow||k(S).overflow;if(S.id?.endsWith("_scroll")||g==="auto"||g==="scroll"){S.classList.add("urppp-scroll-table-host");return}let q=l.createElement("div");q.className="urppp-table-wrap",S.insertBefore(q,y),q.appendChild(y)})}a(P,"wrapTables");function A(){let y=l.getElementById("page-content-template")||l.querySelector(".page-content")||l.body;if(!y)return;let S=d.__urpppTableObsRoot;if(d.__urpppTableObs&&S===y&&y.isConnected)return;d.__urpppTableObs&&d.__urpppTableObs.disconnect();let g=0,v=new u(()=>{clearTimeout(g),g=setTimeout(P,80)});v.observe(y,{childList:!0,subtree:!0}),d.__urpppTableObs=v,d.__urpppTableObsRoot=y}return a(A,"bindTableWrapObserver"),{bindTableWrapObserver:A,wrapTables:P}}a(ep,"createTableWrapper");function rp(n){let i=String(n||"").trim().toLowerCase();if(!i||i==="transparent"||i==="inherit"||i==="initial")return!1;if(/#(?:f{3,6}|e[0-9a-f]{5}|d[89a-f][0-9a-f]{4}|c[89a-f][0-9a-f]{4})/i.test(i))return!0;let l=i.match(/rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/i);if(!l)return!1;let d=Number(l[1]),u=Number(l[2]),k=Number(l[3]);return(d+u+k)/3>=200}a(rp,"isLightInlineColor");function Wc(n){if(!n?.style)return;let i=n.getAttribute("style")||"";if(!i||!/background/i.test(i))return;let l=n.style.backgroundColor||n.style.background||"";(rp(l)||/background(-color|-image)?\s*:/i.test(i))&&(n.style.removeProperty("background"),n.style.removeProperty("background-color"),n.style.removeProperty("background-image")),["borderColor","borderTopColor","borderRightColor","borderBottomColor","borderLeftColor"].forEach(d=>{let u=n.style[d];!u||!rp(u)||n.style.removeProperty(d.replace(/[A-Z]/g,k=>`-${k.toLowerCase()}`))}),/border(-color)?\s*:/i.test(i)&&/#e6e6e6|#eee|#ddd|#ccc/i.test(i)&&(n.style.removeProperty("border-color"),n.style.removeProperty("border-top-color"),n.style.removeProperty("border-right-color"),n.style.removeProperty("border-bottom-color"),n.style.removeProperty("border-left-color"))}a(Wc,"scrubLightInlineBackground");function ap({isNativePdfIsolationActive:n,documentRef:i=document,windowRef:l=window,MutationObserverRef:d=MutationObserver}){function u(){if(!n())try{let P=i.documentElement.classList.contains("urppp-theme-dark"),A=i.body?.classList.contains("urppp-dark");if(!P&&!A)return;i.querySelectorAll("table, table thead, table thead tr, table thead th, table thead td, table tbody, table tbody tr, table tbody td, table tbody th, .table-box, .table-box table, .table-box td, .table-box th").forEach(Wc)}catch{}}a(u,"scrubTableHeaderInlineBg");function k(){[0,200,800,1600].forEach(P=>setTimeout(()=>{try{u()}catch{}},P));try{let P=i.querySelector(".page-content, #page-content-template, .main-content")||i.body;if(!P)return;let A=l.__urpppTableScrubObs;if(A&&A.root===P&&P.isConnected)return;A?.observer&&A.observer.disconnect();let y=new d(()=>{clearTimeout(l.__urpppTableScrubTimer),l.__urpppTableScrubTimer=setTimeout(()=>{try{u()}catch{}},120)});y.observe(P,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class"]}),l.__urpppTableScrubObs={root:P,observer:y}}catch{}}return a(k,"scheduleScrubTableInlineBg"),{scheduleScrubTableInlineBg:k,scrubTableHeaderInlineBg:u}}a(ap,"createTableInlineStyleScrubber");function op({beautifyPagebar:n,documentRef:i=document,windowRef:l=window,MutationObserverRef:d=MutationObserver,setTimeoutRef:u=setTimeout,clearTimeoutRef:k=clearTimeout}){function P(){n(),i.querySelectorAll("#urppagebar").forEach(y=>{if(y.__urpppPagebarObs)return;y.__urpppPagebarObs=!0,new d(()=>{k(l.__urpppPagebarTimer),l.__urpppPagebarTimer=u(()=>n(y.parentElement||i),150)}).observe(y,{childList:!0,subtree:!0})})}a(P,"run");function A(){if(l.__urpppPagebarBound){u(P,0);return}l.__urpppPagebarBound=!0,[0,300,1e3,2500].forEach(y=>u(P,y))}return a(A,"scheduleBeautifyPagebar"),{scheduleBeautifyPagebar:A}}a(op,"createPagebarLifecycle");function np({destroyPagebarChosen:n,documentRef:i=document,logger:l=console}){function d(u){try{(u?.querySelectorAll?u.querySelectorAll("#urppagebar"):i.querySelectorAll("#urppagebar")).forEach(P=>{if(!P)return;P.classList.add("urppp-pagebar"),P.style.setProperty("display","block","important"),P.style.setProperty("width","100%","important"),P.style.setProperty("line-height","1.5","important");let A=P.querySelector('.dataTables_paginate, [id^="sample-table-2_paginate_"]')||P,y=Array.from(P.querySelectorAll('[id^="span_page_txt_"]')).map(f=>String(f.textContent||"").trim()).join(""),S=P.querySelector('select[id^="pagination_pageSize_"]'),g=S?String(S.value||""):"",v=P.querySelector('[id^="turnpageto_"]'),q=!!(v&&(v.readOnly||v.hasAttribute("readonly")));if(!(y.includes("转到")&&!q&&!g.includes("_"))){P.classList.add("urppp-pagebar-scroll"),P.classList.remove("urppp-pagebar-jump"),P.querySelectorAll('ul.pagination, [id^="pagination_ul_"]').forEach(f=>{f.style.setProperty("display","none","important")}),P.querySelectorAll("select").forEach(f=>{n(f),f.style.setProperty("width","128px","important"),f.style.setProperty("min-width","128px","important"),f.style.setProperty("max-width","128px","important")}),P.querySelectorAll(".chosen-container").forEach(f=>{try{f.style.setProperty("display","none","important")}catch{}});return}P.classList.add("urppp-pagebar-jump"),P.classList.remove("urppp-pagebar-scroll"),A.style.setProperty("display","flex","important"),A.style.setProperty("align-items","center","important"),A.style.setProperty("flex-wrap","wrap","important"),A.style.setProperty("gap","8px","important"),A.style.setProperty("position","relative","important"),A.style.setProperty("line-height","1.5","important"),P.querySelectorAll("ul.pagination").forEach(f=>{f.classList.add("urppp-pagination"),f.style.cssText=["display:inline-flex !important","align-items:center !important","flex-wrap:wrap !important","gap:4px !important","margin:0 !important","padding:0 !important","list-style:none !important","float:none !important","position:static !important"].join(";")}),P.querySelectorAll("ul.pagination > li").forEach(f=>{let m=f.classList.contains("active"),w=f.classList.contains("disabled"),x=f.classList.contains("previous")||/previous/i.test(f.getAttribute("name")||""),E=f.classList.contains("next")||/next/i.test(f.getAttribute("name")||"");f.classList.add("urppp-page-li"),m&&f.classList.add("urppp-page-li-active"),w&&f.classList.add("urppp-page-li-disabled"),x&&f.classList.add("urppp-page-li-prev"),E&&f.classList.add("urppp-page-li-next"),f.style.cssText=["display:inline-flex !important","align-items:center !important","justify-content:center !important","float:none !important","position:static !important","margin:0 !important","padding:0 !important","list-style:none !important","border:none !important","background:transparent !important","height:auto !important","min-height:0 !important"].join(";");let z=f.querySelector(":scope > span, :scope > a")||f.firstElementChild;if(!z)return;z.classList.add("urppp-page-chip"),m&&z.classList.add("urppp-page-chip-active"),w&&z.classList.add("urppp-page-chip-disabled"),(x||E)&&z.classList.add("urppp-page-chip-nav");let $=x||E?"72px":"40px",T=m?"var(--pagination-active-bg, var(--primary))":"var(--surface)",j=m?"var(--pagination-active-border, var(--primary))":"var(--border)",I=m?"var(--pagination-active-foreground, var(--primary-foreground, #fff))":w?"var(--text-muted)":"var(--text)";z.style.cssText=["display:inline-flex !important","align-items:center !important","justify-content:center !important","box-sizing:border-box !important","float:none !important","position:static !important","width:auto !important",`min-width:${$} !important`,"height:36px !important","min-height:36px !important","max-height:36px !important","padding:0 12px !important","margin:0 !important","line-height:36px !important","font-size:14px !important","font-weight:600 !important","border-radius:8px !important",`border:1px solid ${j} !important`,`background:${T} !important`,`color:${I} !important`,"box-shadow:none !important","text-decoration:none !important",`cursor:${w?"default":"pointer"} !important`,"white-space:nowrap !important","overflow:hidden !important"].join(";")}),P.querySelectorAll('[id^="btn_turnpageto_"]').forEach(f=>{f.classList.add("urppp-page-confirm"),f.style.setProperty("position","static","important"),f.style.setProperty("left","auto","important"),f.style.setProperty("top","auto","important"),f.style.setProperty("float","none","important"),f.style.setProperty("height","32px","important"),f.style.setProperty("min-width","52px","important"),f.style.setProperty("padding","0 12px","important"),f.style.setProperty("margin","0 4px","important"),f.style.setProperty("font-size","13px","important"),f.style.setProperty("line-height","1","important"),f.style.setProperty("vertical-align","middle","important")}),P.querySelectorAll('[id^="turnpageto_"]').forEach(f=>{f.classList.add("urppp-page-goto"),f.style.setProperty("position","static","important"),f.style.setProperty("display","inline-block","important"),f.style.setProperty("height","32px","important"),f.style.setProperty("width","48px","important"),f.style.setProperty("margin","0 4px","important"),f.style.setProperty("padding","4px 8px","important"),f.style.setProperty("font-size","14px","important"),f.style.setProperty("line-height","1.2","important"),f.style.setProperty("box-sizing","border-box","important"),f.style.setProperty("vertical-align","middle","important");let m=f.parentElement;m?.tagName==="SPAN"&&(m.style.setProperty("position","static","important"),m.style.setProperty("display","inline-flex","important"),m.style.setProperty("align-items","center","important"),m.style.setProperty("width","auto","important"),m.style.setProperty("height","auto","important"),m.style.setProperty("min-height","0","important"),m.style.setProperty("vertical-align","middle","important"))}),P.querySelectorAll('[id^="totalPage_show_"], [id^="span_page_txt_"]').forEach(f=>{f.style.setProperty("display","inline","important"),f.style.setProperty("border","none","important"),f.style.setProperty("background","transparent","important"),f.style.setProperty("padding","0","important"),f.style.setProperty("margin","0","important"),f.style.setProperty("height","auto","important"),f.style.setProperty("line-height","1.5","important"),f.style.setProperty("font-size","13px","important"),f.style.setProperty("color","var(--text-secondary, var(--text-muted))","important")})})}catch(k){l.warn("[URP++] pagebar beautify failed",k)}}return a(d,"beautifyPagebar"),{beautifyPagebar:d}}a(np,"createPagebarBeautifier");function ip({beautifyNoticeTables:n,pinNoticeRowSurface:i,documentRef:l=document,windowRef:d=window,MutationObserverRef:u=MutationObserver,requestAnimationFrameRef:k=requestAnimationFrame,setTimeoutRef:P=setTimeout,clearTimeoutRef:A=clearTimeout}){function y(){d.__urpppNoticeHoverScrub||(d.__urpppNoticeHoverScrub=!0,l.addEventListener("mouseout",g=>{let v=g.target?.closest?g.target.closest("table.urppp-notice-table tr.urppp-notice-row"):null;v&&k(()=>i(v))},!0))}a(y,"bindNoticeHoverScrub");function S(){[0,400,1500].forEach(g=>P(()=>{try{n()}catch{}},g));try{let g=l.getElementById("page-content-template")||l.querySelector(".page-content, .main-content")||l.body;if(!g)return;let v=d.__urpppNoticeObs;if(v&&v.root===g&&g.isConnected)return;v?.observer&&v.observer.disconnect();let q=new u(()=>{A(d.__urpppNoticeTimer),d.__urpppNoticeTimer=P(()=>{try{n()}catch{}},180)});q.observe(g,{childList:!0,subtree:!0}),d.__urpppNoticeObs={root:g,observer:q}}catch{}}return a(S,"scheduleBeautifyNoticeTables"),{bindNoticeHoverScrub:y,scheduleBeautifyNoticeTables:S}}a(ip,"createNoticeTableLifecycle");function pp({getCurrentTheme:n,documentRef:i=document,getComputedStyleRef:l=getComputedStyle}){function d(){try{return l(i.documentElement).getPropertyValue("--surface").trim()||(n()==="dark"?"#151A24":"#FFFFFF")}catch{return n()==="dark"?"#151A24":"#FFFFFF"}}a(d,"noticeSurfaceColor");function u(y){if(!y?.classList?.contains("urppp-notice-row"))return;let S=d();y.classList.remove("hover"),y.style.setProperty("background",S,"important"),y.style.setProperty("background-color",S,"important"),y.querySelectorAll("td, th").forEach(g=>{g.classList.remove("hover"),g.style.setProperty("background","transparent","important"),g.style.setProperty("background-color","transparent","important")})}a(u,"pinNoticeRowSurface");function k(y){try{let S=y||i;if(S.matches?.("tr.urppp-notice-row")){u(S);return}S.querySelectorAll("table.urppp-notice-table tr.urppp-notice-row").forEach(u)}catch{}}a(k,"scrubNoticeInlineBg");function P(y){y&&(y.classList.remove("table-hover","table-striped"),y.classList.add("urppp-notice-nohover"),y.querySelectorAll("tr.urppp-notice-row").forEach(S=>{S.classList.remove("hover"),u(S)}))}a(P,"disarmNoticeTableHover");function A(y){if(!y)return;y.classList.remove("urppp-notice-table"),delete y.dataset.urpppNoticeScan,y.style.removeProperty("border"),y.style.removeProperty("border-left"),y.style.removeProperty("background");let S=y.closest(".urppp-table-wrap.urppp-notice-wrap");S&&(S.classList.remove("urppp-notice-wrap"),S.style.removeProperty("border"),S.style.removeProperty("background"),S.style.removeProperty("box-shadow"),S.style.removeProperty("overflow"),S.style.removeProperty("border-radius")),y.querySelectorAll("tr.urppp-notice-row, td.urppp-notice-title-cell, td.urppp-notice-date-cell, td.urppp-notice-bullet-cell, a.urppp-notice-link, .urppp-notice-time, .urppp-notice-card").forEach(g=>{g.classList.remove("urppp-notice-row","urppp-notice-title-cell","urppp-notice-date-cell","urppp-notice-bullet-cell","urppp-notice-link","urppp-notice-time","urppp-notice-card","urppp-notice-card-row","urppp-notice-main","urppp-notice-meta","urppp-notice-title","urppp-notice-body"),(g.tagName==="TR"||g.tagName==="TD")&&["display","border","background","padding","margin","width","box-shadow","border-radius","float","position"].forEach(v=>{g.style.getPropertyPriority(v)==="important"&&g.style.removeProperty(v)}),delete g.dataset.urpppNoticeDone})}return a(A,"stripMistakenNoticeTable"),{disarmNoticeTableHover:P,pinNoticeRowSurface:u,scrubNoticeInlineBg:k,stripMistakenNoticeTable:A}}a(pp,"createNoticeTableSurface");function sp({isNativePdfIsolationActive:n,bindNoticeHoverScrub:i,scrubNoticeInlineBg:l,stripMistakenNoticeTable:d,disarmNoticeTableHover:u,pinNoticeRowSurface:k,isBusinessDataTable:P,isNoticeListTable:A,isNoticePageContext:y,isNoticeBulletText:S,documentRef:g=document,windowRef:v=window,logger:q=console}){function C(){if(!n())try{i(),l(),g.querySelectorAll("table.urppp-notice-table, table.table").forEach(m=>{P(m)&&(m.classList.contains("urppp-notice-table")||m.querySelector(".urppp-notice-row, .urppp-notice-title-cell"))&&d(m)});let f=new Set(g.querySelectorAll('.page-content table, #page-content-template table, .main-content table, table.table, table.urppp-notice-table, table[style*="dashed"], table.no-border-top'));y()?g.querySelectorAll("table").forEach(m=>f.add(m)):g.querySelectorAll("table").forEach(m=>{A(m)&&f.add(m)}),Array.from(f).forEach(m=>{if(!m||P(m))return;if(m.querySelector("thead th")&&m.querySelectorAll("thead th").length>=3){let T=m.querySelector("thead")?.textContent||"";if(!A(m)&&/序号|课程|成绩|教室|校区|学号|姓名|教学楼|座位|操作|类型/.test(T)&&!/标题|公告|通知/.test(T))return}let w=Array.from(m.querySelectorAll("tbody > tr, tr")).filter(T=>T.querySelector("td"));if(!w.length)return;let x=0;w.slice(0,12).forEach(T=>{let j=Array.from(T.children).filter(et=>et.tagName==="TD"||et.tagName==="TH");if(j.length>=5)return;let I=(T.textContent||"").replace(/\s+/g," ").trim(),H=!!T.querySelector("a[href], a[onclick], a"),G=/\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}/.test(I),U=j.some(et=>S(et.textContent));(H&&G||U&&H||U&&G)&&(x+=1)});let E=m.classList.contains("no-border-top")||/dashed|border-left-style/.test(m.getAttribute("style")||""),z=y();if(x<1){if(z){if(w.slice(0,8).filter(j=>{let I=Array.from(j.children).filter(G=>G.tagName==="TD"||G.tagName==="TH");if(I.length<1||I.length>4)return!1;let H=(j.textContent||"").replace(/\s+/g," ").trim();return!!j.querySelector("a")||/\d{4}/.test(H)}).length<1&&!E)return}else if(!(E&&/公告|通知/.test(g.title||"")))return}if(P(m))return;m.classList.add("urppp-notice-table"),m.dataset.urpppNoticeScan="1",u(m),m.style.setProperty("border","none","important"),m.style.setProperty("border-left","none","important"),m.style.setProperty("background","transparent","important"),m.style.setProperty("width","100%","important");let $=m.closest(".urppp-table-wrap");$&&($.classList.add("urppp-notice-wrap"),$.style.setProperty("border","none","important"),$.style.setProperty("background","transparent","important"),$.style.setProperty("box-shadow","none","important"),$.style.setProperty("overflow","visible","important"),$.style.setProperty("border-radius","0","important")),w.forEach(T=>{if(T.dataset.urpppNoticeDone==="1")return;let j=Array.from(T.children).filter(V=>V.tagName==="TD"||V.tagName==="TH");if(!j.length)return;let I=a(V=>(V||"").replace(/\u00AD/g,"").replace(/\u200B/g,"").replace(/\s+/g," ").trim(),"clean");if(j.length>=2){let V=null,Q=null,ot=null;if(j.forEach((X,ct)=>{let rt=I(X.textContent),st=!!X.querySelector("a");if(!V&&S(rt)&&(ct===0||j.length>=2)){V=X;return}if(!ot&&(/\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}/.test(rt)||/\d{4}-\d{1,2}-\d{1,2}\s+\d{1,2}:\d{2}/.test(rt)||/text-align\s*:\s*right/i.test(X.getAttribute("style")||"")||ct===j.length-1&&rt.length<=28&&/\d{4}/.test(rt))&&/\d{4}/.test(rt)&&rt.length<=32){ot=X;return}!Q&&(st||rt.length>4)&&(Q=X)}),Q||(Q=j.find(X=>X!==V&&X!==ot)||j[0]),!ot&&j.length>=2){let X=j[j.length-1];X!==Q&&X!==V&&(ot=X)}if(T.classList.add("urppp-notice-row"),k(T),T.removeAttribute("width"),T.style.setProperty("flex-wrap","nowrap","important"),j.forEach(X=>{X.removeAttribute("width"),X.removeAttribute("height"),X.removeAttribute("align"),X.style.setProperty("border","none","important"),X.style.setProperty("background","transparent","important"),X.style.setProperty("vertical-align","middle","important"),X.style.removeProperty("width"),X.style.setProperty("width","auto","important")}),V&&(V.classList.add("urppp-notice-bullet-cell"),V.style.setProperty("display","none","important"),V.style.setProperty("width","0","important"),V.style.setProperty("padding","0","important")),Q){Q.classList.add("urppp-notice-title-cell"),Q.removeAttribute("width"),Q.style.setProperty("width","auto","important"),Q.style.setProperty("max-width","100%","important"),Q.style.setProperty("min-width","0","important"),Q.style.setProperty("flex","1 1 0%","important"),Q.style.setProperty("overflow","hidden","important"),Q.style.setProperty("padding","0","important"),Q.style.setProperty("pointer-events","auto","important"),Q.style.setProperty("white-space","nowrap","important");let X=Q.querySelector("a[href], a[onclick], a");if(X||(X=T.querySelector("a[href], a[onclick], a")),X){Q.contains(X)||(Q.innerHTML="",Q.appendChild(X)),X.classList.add("urppp-notice-link");let ct=X.getAttribute("href"),rt=X.getAttribute("onclick"),st=X.getAttribute("target"),xt=I(X.textContent);X.textContent=xt,ct!=null&&X.setAttribute("href",ct),rt!=null&&X.setAttribute("onclick",rt),st!=null&&X.setAttribute("target",st),X.style.setProperty("color","var(--text)","important"),X.style.setProperty("text-decoration","none","important"),X.style.setProperty("font-size","14px","important"),X.style.setProperty("font-weight","500","important"),X.style.setProperty("line-height","1.5","important"),X.style.setProperty("pointer-events","auto","important"),X.style.setProperty("cursor","pointer","important"),X.style.setProperty("position","relative","important"),X.style.setProperty("z-index","2","important"),X.style.setProperty("display","block","important"),X.style.setProperty("white-space","nowrap","important"),X.style.setProperty("overflow","hidden","important"),X.style.setProperty("text-overflow","ellipsis","important"),T.dataset.urpppNoticeClickBound!=="1"&&(T.dataset.urpppNoticeClickBound="1",T.style.setProperty("cursor","pointer","important"),T.addEventListener("click",Z=>{if(Z.target&&Z.target.closest&&Z.target.closest("a,button,input,select,textarea,label"))return;if(X.getAttribute("onclick")){X.click();return}let dt=X.getAttribute("href");if(!dt||dt==="#"||dt.indexOf("javascript:")===0){X.click();return}X.target==="_blank"?v.open(dt,"_blank"):v.location.href=dt}))}else{let ct=I(Q.textContent);ct&&!Q.querySelector("button, input, select")&&(!Q.querySelector("*")||Q.children.length===0)&&(Q.textContent=ct)}}if(ot){ot.classList.add("urppp-notice-date-cell"),ot.style.cssText=["display:flex !important","align-items:center !important","justify-content:flex-end !important","flex:0 0 auto !important","width:auto !important","max-width:none !important","white-space:nowrap !important","text-align:right !important","padding:0 !important","margin:0 0 0 auto !important","border:none !important","background:transparent !important","float:none !important","position:static !important","right:auto !important","left:auto !important","top:auto !important"].join(";");let X=I(ot.textContent);ot.innerHTML="";let ct=g.createElement("span");ct.className="urppp-notice-time",ct.textContent=X,ot.appendChild(ct)}Q&&(Q.style.setProperty("flex","1 1 auto","important"),Q.style.setProperty("min-width","0","important"),Q.style.setProperty("margin","0","important"),Q.style.setProperty("float","none","important"),Q.style.setProperty("position","static","important")),T.style.setProperty("display","flex","important"),T.style.setProperty("align-items","center","important"),T.style.setProperty("justify-content","space-between","important"),T.style.setProperty("gap","16px","important"),T.style.setProperty("max-width","100%","important"),T.style.setProperty("box-sizing","border-box","important"),T.style.setProperty("overflow","hidden","important"),T.dataset.urpppNoticeDone="1";return}let H=j[0],G=Array.from(H.querySelectorAll(":scope > span"));if(G.length<2){let V=H.querySelector("a"),Q=I(H.textContent),ot=Q.match(/(\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}(?:\s+\d{1,2}:\d{2}(?::\d{2})?)?)/);if(V||ot){T.classList.add("urppp-notice-row");let X=g.createElement("div");X.className="urppp-notice-card urppp-notice-card-row";let ct=g.createElement("div");if(ct.className="urppp-notice-main",V){V.classList.add("urppp-notice-link");let rt=V.getAttribute("href"),st=V.getAttribute("onclick"),xt=I(V.textContent);V.textContent=xt,rt!=null&&V.setAttribute("href",rt),st!=null&&V.setAttribute("onclick",st),V.style.setProperty("pointer-events","auto","important"),V.style.setProperty("cursor","pointer","important"),ct.appendChild(V),T.dataset.urpppNoticeClickBound!=="1"&&(T.dataset.urpppNoticeClickBound="1",T.style.setProperty("cursor","pointer","important"),T.addEventListener("click",Z=>{if(!(Z.target&&Z.target.closest&&Z.target.closest("a,button,input,select"))){if(V.getAttribute("onclick")||!V.getAttribute("href")||V.getAttribute("href")==="#"){V.click();return}v.location.href=V.getAttribute("href")}}))}else{let rt=g.createElement("div");rt.className="urppp-notice-title",rt.textContent=ot?Q.replace(ot[0],"").trim():Q,ct.appendChild(rt)}if(X.appendChild(ct),ot){let rt=g.createElement("div");rt.className="urppp-notice-meta";let st=g.createElement("span");st.className="urppp-notice-time",st.textContent=ot[1],rt.appendChild(st),X.appendChild(rt)}H.innerHTML="",H.appendChild(X),H.dataset.urpppNoticeDone="1",T.dataset.urpppNoticeDone="1"}return}let U=null,et=null,pt=[];if(G.forEach(V=>{let Q=(V.getAttribute("style")||"")+" "+(V.style.cssText||""),ot=I(V.textContent);if(ot){if(/font-size\s*:\s*18/i.test(Q)||!U&&/font-size\s*:\s*1[6-9]/i.test(Q)){U=V;return}if(/font-size\s*:\s*12/i.test(Q)||/float\s*:\s*right/i.test(Q)||/^\d{4}-\d{2}-\d{2}/.test(ot)){et=V;return}pt.push(V)}}),U||(U=G[0]),!et){let V=G[G.length-1];V!==U&&(et=V)}let bt=g.createElement("div");if(bt.className="urppp-notice-card",U){let V=g.createElement("div");V.className="urppp-notice-title",V.textContent=I(U.textContent),bt.appendChild(V)}if((pt.length?pt:G.filter(V=>V!==U&&V!==et)).forEach(V=>{let Q=g.createElement("div");Q.className="urppp-notice-body",Q.textContent=I(V.textContent),Q.textContent&&bt.appendChild(Q)}),et){let V=g.createElement("div");V.className="urppp-notice-meta";let Q=g.createElement("span");Q.className="urppp-notice-time",Q.textContent=I(et.textContent),V.appendChild(Q),bt.appendChild(V)}H.innerHTML="",H.appendChild(bt),H.dataset.urpppNoticeDone="1",T.dataset.urpppNoticeDone="1",T.classList.add("urppp-notice-row")})})}catch(f){q.warn("[URP++] notice table beautify failed",f)}}return a(C,"beautifyNoticeTables"),{beautifyNoticeTables:C}}a(sp,"createNoticeTableBeautifier");var lp={"page-content-template":"urppp-pdf-page",mycoursetable:"urppp-pdf-mycoursetable",courseTable:"urppp-pdf-courseTable",courseTableBody:"urppp-pdf-courseTableBody",h4_id1:"urppp-pdf-h4-1",h4_id2:"urppp-pdf-h4-2",infoTable:"urppp-pdf-info-table","rwskxxbg-course":"urppp-pdf-rwskxxbg","other-course":"urppp-pdf-other-course",temp_title:"urppp-pdf-temp-title",temp_subtitle:"urppp-pdf-temp-subtitle"};function Gc(n){return n.querySelectorAll('script, iframe, object, embed, [id^="urppp-"], [data-urppp]').forEach(i=>i.remove()),[n,...n.querySelectorAll("*")].forEach(i=>{Array.from(i.classList||[]).forEach(l=>{/^urppp(?:-|$)/.test(l)&&i.classList.remove(l)}),Array.from(i.attributes||[]).forEach(l=>{/^data-urppp(?:-|$)/.test(l.name)&&i.removeAttribute(l.name)}),i.style&&Array.from(i.style).forEach(l=>{i.style.getPropertyPriority(l)==="important"&&i.style.removeProperty(l)})}),n}a(Gc,"sanitizeNativePdfClone");function Jc(n){return[n,...n.querySelectorAll("*")].forEach(i=>{i.id&&lp[i.id]&&(i.id=lp[i.id]),i.classList.contains("class_div")&&(i.classList.remove("class_div"),i.classList.remove("box_font"),i.classList.add("urppp-pdf-card")),i.classList.contains("course")&&(i.classList.remove("course"),i.classList.add("urppp-pdf-course"))}),n}a(Jc,"renameNativePdfClone");function Vc(){let n=[];document.querySelectorAll('style[id^="urppp-"]').forEach(d=>{d.sheet&&!d.sheet.disabled&&(n.push(d),d.sheet.disabled=!0)});let i=0,l=document.getElementById("mycoursetable");return l&&(i=l.getBoundingClientRect().width),n.forEach(d=>{d.sheet.disabled=!1}),i}a(Vc,"measureNativeScheduleWidth");var Yc=`
...
`;function Qc(n){n.querySelectorAll("td, th").forEach(i=>{i.style.removeProperty("background"),i.style.removeProperty("background-color")}),n.querySelectorAll("th[rowspan]").forEach(i=>{i.style.removeProperty("width"),i.style.setProperty("white-space","nowrap"),i.style.setProperty("text-align","center")}),n.querySelectorAll("table").forEach(i=>{i.style.setProperty("background","#ffffff","important"),i.style.setProperty("background-color","#ffffff","important"),i.style.setProperty("border","none","important"),i.style.setProperty("color","#000000","important")}),n.querySelectorAll("th").forEach(i=>{if(i.style.setProperty("color","#000000","important"),i.style.setProperty("border","1px solid #dddddd","important"),i.style.setProperty("font-weight","normal","important"),i.childNodes.length===1&&i.firstChild&&i.firstChild.nodeType===3){let l=document.createElement("span");l.textContent=i.textContent,i.textContent="",i.appendChild(l)}}),n.querySelectorAll("thead th").forEach(i=>{i.style.setProperty("background","#dddddd","important"),i.style.setProperty("background-color","#dddddd","important")}),n.querySelectorAll("tbody th").forEach(i=>{i.style.setProperty("background","transparent","important"),i.style.setProperty("background-color","transparent","important")}),n.querySelectorAll("td").forEach(i=>{i.style.setProperty("background","transparent","important"),i.style.setProperty("background-color","transparent","important"),i.style.setProperty("color","#000000","important"),i.style.setProperty("border","1px solid #dddddd","important")})}a(Qc,"normalizeNativePdfStage");function cp(n){let i=Vc(),l=document.createElement("div");l.id="urppp-pdf-stage",l.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(i||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=n.cloneNode(!0);Gc(u),Jc(u),d.appendChild(u),l.appendChild(d),Qc(u);let k=document.createElement("style");k.id="urppp-pdf-reset-style",k.textContent=Yc,document.head.appendChild(k),document.body.appendChild(l);let P=l.querySelector("#urppp-pdf-mycoursetable"),A=l.querySelector("#urppp-pdf-page")||l;if(!P)throw l.remove(),new Error("无法建立原生课表捕获节点");return{stage:l,target:P,page:A,sourceHost:n}}a(cp,"cloneNativePdfStage");var ua=0;function be(){return ua>0}a(be,"isNativePdfIsolationActive");function Xc(n){return!n||n.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(n.id||"")||n.hasAttribute("data-urppp-style")?!0:(n.textContent||"").includes("urppp-")}a(Xc,"isUrpppOwnedStyle");function dp(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(dp,"defaultPage");function up(n,i){let l=n&&typeof n.requestAnimationFrame=="function"?n.requestAnimationFrame.bind(n):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return l?l(i):setTimeout(i,0)}a(up,"scheduleFrame");function Kc(n={}){let i=n.document||(typeof document<"u"?document:null),l=n.page||dp();if(!i)throw new Error("原生 PDF 隔离缺少 document");let d=i.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");ua+=1;let u=[d,...d.querySelectorAll("*")],k=[],P=i.getElementById("soliderbox");P&&k.push(P);let A=d.parentElement;for(;A&&A!==i.documentElement;){let x=A.classList;(A.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&k.push(A),A=A.parentElement}let y=i.getElementById("page-content-template")||i.querySelector(".page-content");y&&!k.includes(y)&&k.push(y);let S=[...u,...k],g=S.map(x=>({element:x,style:x.getAttribute("style")})),v=Array.from(i.querySelectorAll("style")).filter(Xc).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),q=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=l&&l.divBuild,f=l&&l.__urpppOriginalDivBuild,m=!1,w=a(()=>{m||(m=!0,l&&l.divBuild===f&&typeof C=="function"&&(l.divBuild=C),g.forEach(({element:x,style:E})=>{x.isConnected&&(E===null?x.removeAttribute("style"):x.setAttribute("style",E))}),q.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),v.forEach(({style:x,disabled:E,media:z})=>{try{z===null?x.removeAttribute("media"):x.setAttribute("media",z),x.sheet&&(x.sheet.disabled=E)}catch{}}),ua=Math.max(0,ua-1),up(l,()=>{try{typeof n.onAfterRestore=="function"&&n.onAfterRestore()}catch{}}))},"restore");try{return v.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),S.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(E=>{x.style.getPropertyPriority(E)==="important"&&(E==="height"&&x.matches("td, th")||x.style.removeProperty(E))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),q.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),l&&typeof f=="function"&&(l.divBuild=f),w}catch(x){throw w(),x}}a(Kc,"isolateScheduleForNativeExport");function mp(n,i={}){return new Promise((l,d)=>{let u=i.page||dp(),k=u&&u.back,P=u&&u.html2canvas;if(!n||typeof k!="function"){d(new Error("教务原生导出依赖未就绪"));return}let A=null;try{A=Kc(i)}catch(f){d(f);return}let y=0,S=!1,g=null,v=null,q=a(f=>{if(!S){S=!0,y&&clearTimeout(y),u&&g&&u.back===g&&(u.back=k),v&&u.html2canvas===v&&(u.html2canvas=P);try{A&&A()}catch{}f?d(f):l()}},"settle"),C=a(f=>q(f instanceof Error?f:new Error(String(f))),"fail");typeof P=="function"&&(v=a(function(){let f=P.apply(this,arguments);return f&&typeof f.catch=="function"&&f.catch(C),f},"scopedCanvas"),u.html2canvas=v),g=a(function(){try{return k.apply(this,arguments)}finally{setTimeout(()=>q(),0)}},"wrappedBack"),u.back=g,y=setTimeout(()=>{try{k.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},i.timeoutMs||60*1e3),up(u,()=>{try{n.click()}catch(f){C(f)}})})}a(mp,"exportNativePdfIsolated");var bp=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
#urppp-settings-panel .urppp-src-item{display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:8px;background:var(--bg-card-soft,#f6f7f9);border:1px solid var(--border,#e6e8ec)}
...
#urppp-toast{position:fixed;left:50%;bottom:24px;transform:translateX(-50%) translateY(16px);z-index:99999;max-width:min(560px,90vw);padding:10px 18px;border-radius:10px;background:#2b2f36;color:#fff;font-size:13px;opacity:0;pointer-events:none;transition:.22s;box-shadow:0 8px 28px rgba(0,0,0,.24)}
#urppp-toast.show{opacity:1;transform:translateX(-50%) translateY(0);pointer-events:auto}
...
html.urppp-theme-dark #urppp-confirm .urppp-confirm-ops button[data-ok]{background:var(--accent,var(--link,#4a7bfa));border-color:var(--accent,var(--link,#4a7bfa));color:#fff}
...
`;var yp=`      /* 表格美化：业务表格、分页、公告卡片（table-beautify） */
...
`;var vp=`      /* 导航：顶栏、侧栏、面包屑（navigation） */
      /* 顶栏 —— 基于真实 DOM */
...
`;var wp=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function _p(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(_p,"createCleanModeState");function Ep(n){n.profile=null,n.schedule=null,n.scores=null,n.catalog=null,n.occupancy=null,n._termWeekResolved=!1,n._schemeUserSelected=!1,n._schemeInited=!1}a(Ep,"resetCleanModeData");function Cp({state:n,deps:i}){async function l(u){if(!u&&n.catalog&&n.catalog.length||n.loading.room)return n.catalog;n.loading.room=!0;try{i.render()}catch{}try{n.catalog=await i.loadClassroomCatalog(),n.roomError=""}catch(k){n.catalog=n.catalog||[],n.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{n.loading.room=!1;try{i.scheduleRender()}catch{}}return n.catalog}a(l,"ensureRoomCatalogLoaded");async function d(u){u&&Ep(n),n.loading.profile=n.loading.schedule=n.loading.scores=!0;try{let k=await i.ensureTermWeekResolved();!n.weekLocked&&k>=1&&(n.viewWeek=k)}catch{}if(i.render(),await Promise.all([(async()=>{try{n.profile&&!u||(n.profile=await i.loadProfile()),i.reconcileProfileAndScores()}catch(k){n.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{n.loading.profile=!1,i.scheduleRender()}})(),(async()=>{try{n.schedule&&!u||(n.schedule=await i.loadSchedule())}catch(k){n.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(n.loading.schedule=!1,!n.weekLocked){let k=i.getCurrentWeekNumber()||i.readRememberedTermWeek();k>=1&&(n.viewWeek=k)}i.scheduleRender()}})(),(async()=>{let k=null;try{n.scores&&!u||(n.scores=await i.loadScores(u)),k=n.scores,i.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&i.enrichScoresWithEvaluation(k).then(()=>{n.scores===k&&(i.reconcileProfileAndScores(),i.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){n.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{n.loading.scores=!1,i.scheduleRender()}})()]),i.reconcileProfileAndScores(),!n.weekLocked){let k=i.getCurrentWeekNumber()||i.readRememberedTermWeek();k>=1&&(n.viewWeek=k)}i.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:l,loadAll:d}}a(Cp,"createCleanModeDataLoader");var lr={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},Zc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Tr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function zp(){let n=new Date,i=a(l=>String(l).padStart(2,"0"),"p");return`${n.getFullYear()}-${i(n.getMonth()+1)}-${i(n.getDate())}`}a(zp,"calToday");function _o(n,i){return Math.round((Date.parse(i)-Date.parse(n))/864e5)}a(_o,"calDayDiff");function Eo(n,i){let l=_o(lr[n].start,i);return l<0?0:Math.floor(l/7)+1}a(Eo,"calWeekNo");function Ao(n){return Zc[n]||""}a(Ao,"calLunar");function Pp(n){return String(n||"").slice(5)}a(Pp,"calYY");function td(n){let i=n||zp(),[l,d]=i.split("-").map(Number);return d===8&&i>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(td,"calActiveTerm");function Co(n,i){let l=n&&lr[n]?n:"autumn",d=lr[l],u=i||zp(),k=d.events.map(g=>({e:g,d:_o(u,g.start)})).filter(g=>g.d>=-0).sort((g,v)=>g.d-v.d)[0],P=k?_o(u,k.e.start):null,A=Eo(l,u),y=Math.max(0,Math.min(100,A/d.weeks*100)),S=u>=d.start;return{term:d,termId:l,next:k,daysLeft:P,weekNo:A,progress:y,started:S,today:u}}a(Co,"calStatus");function qp(n,i){let l=Co(n,i),d=l.next?Tr[l.next.e.t].color:"#c9cdd4",u=l.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(qp,"calendarSummaryHtml");function Tp(n,i){let l=Co(n,i);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
    <span class="cal-c-dot" style="background:${l.next?Tr[l.next.e.t].color:"#c9cdd4"}"></span>
  ...
  </button>`}a(Tp,"calendarSummaryCompactHtml");function Lp(n,i){let l=Co(n,i),d=l.next?Tr[l.next.e.t].color:"#c9cdd4",u=l.term,k=Object.keys(lr).map(v=>`<button type="button" class="cal-term${v===l.termId?" ac":""}" data-cal-term="${v}">${lr[v].name}</button>`).join(""),P=`<div class="cal-widget">
    <div class="cal-w-left">
      ...
      <div class="cal-w-sub">${l.next?l.next.e.start+(l.next.e.end&&l.next.e.end!==l.next.e.start?" ~ "+l.next.e.end:""):""}${l.next&&Ao(l.next.e.start)?" · "+Ao(l.next.e.start):""}</div>
    </div>
    <div class="cal-w-mid">
  ...
  </div>`,A=u.events.slice().sort((v,q)=>v.start<q.start?-1:1),y={};A.forEach(v=>{(y[v.start.slice(0,7)]=y[v.start.slice(0,7)]||[]).push(v)});let S=a(v=>v===l.today?" cal-today":"","todayFlag"),g=Object.keys(y).map(v=>{let[,q]=v.split("-");return`<div class="cal-mon">
      <div class="cal-mon-label">${Number(q)} 月</div>
      <div class="cal-mon-items">${y[v].map(C=>{let f=Tr[C.t].color,m=C.end&&C.end!==C.start?"~"+Pp(C.end):"",w=Eo(l.termId,C.start)>0?`第 ${Eo(l.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
          <span class="cal-ev-dot" style="background:${f}"></span>
          <span class="cal-ev-date">${Pp(C.start)}${m||""}<em>${Ao(C.start)||"&nbsp;"}</em></span>
          <span class="cal-ev-name">${C.name}</span>
          <span class="cal-ev-tag" style="color:${f};background:${f}1a">${Tr[C.t].label}</span>
  ...
  </div>`}a(Lp,"calendarModalHtml");function Mp(n,i){let l=typeof document<"u"?document:null;if(!l)return;So();let d=n&&lr[n]?n:td(i),u=l.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${Lp(d,i)}</div></div>`,l.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>So()),u.addEventListener("click",k=>{let P=k.target;if(P&&P.closest&&P.closest(".cal-close")){So();return}let A=P&&P.closest?P.closest("[data-cal-term]"):null;if(A){let y=u.querySelector(".cal-body");y&&(y.innerHTML=Lp(A.dataset.calTerm,i)),u.querySelectorAll("[data-cal-term]").forEach(S=>S.classList.toggle("ac",S.dataset.calTerm===A.dataset.calTerm))}})}a(Mp,"openCalendarModal");function So(){let n=typeof document<"u"?document:null;if(!n)return;let i=n.getElementById("urppp-cal-modal");i&&(i.classList.remove("open"),i.classList.add("closing"),setTimeout(()=>{i.remove()},200))}a(So,"closeCalendarModal");function $p(n,i){let l=n||(typeof document<"u"?document:null);l&&l.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),Mp())})}a($p,"bindCalendarOpen");var ma=!1;function Po(){let n=typeof document<"u"?document:null;if(!n||ma)return ma;try{let i=n.createElement("style");if(i&&i.id!==void 0){i.id="urppp-cal-style",i.textContent=`
  ...
  `,i.id="urppp-cal-style";let l=n.head||n.documentElement;l&&l.appendChild(i),ma=!0}}catch{}return ma}a(Po,"ensureCalendarStyle");function Ip(){let n=typeof document<"u"?document:null;if(!n)return;let i=n.getElementById("urppp-nav-theme")||n.querySelector("#navbar .navbar-header")||n.getElementById("navbar"),l=n.getElementById("urppp-nav-clean"),d=n.getElementById("urppp-nav-cal");if(!i&&!l)return;let u=l&&l.parentElement||i;d&&d.parentElement===u||(d&&d.remove(),d=n.createElement("button"),d.type="button",d.id="urppp-nav-cal",d.title="校历时间线",d.setAttribute("aria-label","校历时间线"),d.innerHTML='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3.5" y="5" width="17" height="15.5" rx="2.5"/><path d="M3.5 9.5h17"/><path d="M8 3v3M16 3v3"/><circle cx="12" cy="15" r="1.2" fill="currentColor" stroke="none"/></svg><span>校历</span>',Object.entries({display:"inline-flex","align-items":"center",height:"28px","min-height":"28px",padding:"0 12px","font-size":"12px",gap:"6px",width:"auto",float:"none",margin:"0 0 0 8px","vertical-align":"middle"}).forEach(([k,P])=>d.style.setProperty(k,P,"important")),d.addEventListener("click",k=>{k.preventDefault(),k.stopPropagation(),Mp()}),l&&l.parentElement?l.after(d):u&&u.appendChild(d))}a(Ip,"mountCalendarButton");function Np(){let n=typeof document<"u"?document:null;if(!n)return;let i=n.getElementById("urppp-nav-cal");i&&i.remove()}a(Np,"removeCalendarButton");function Bp({state:n,deps:i}){let l=0,d={gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)"};function u(x,E){let z=x||i.summarizeCourses([]);return`<div class="uc-metrics">${[["TotalCredit","总学分",z.totalCredit],["AvgScore","平均成绩",z.avgScore],["AvgGpa","平均绩点",z.avgGpa],["RequiredCredit","必修学分",z.requiredCredit],["RequiredAvg","必修平均",z.requiredAvg],["RequiredGpa","必修绩点",z.requiredGpa]].map(([T,j,I])=>{let H=i.classifyPrivacyLabel(j)||"grade",G=E&&i.DIRECT_EDIT_LABELS[E+T]?` data-urppp-edit-key="${E+T}"`:"";return`<div class="uc-metric"><em>${j}</em><b data-urppp-private="${H}"${G}>${I}</b></div>`}).join("")}</div>`}a(u,"metricHtml");function k(){let x=n.scores;if(!x||x.error)return`<div class="uc-sa-empty">${i.escapeHtml(x&&x.error||"暂无成绩数据")}</div>`;let E=null;try{E=i.analyzeScores({scorePack:x,profile:n.profile})}catch{}if(!E||E.empty)return'<div class="uc-sa-empty">暂无可用成绩数据，请先查询成绩后再试。</div>';let z=typeof i.scoreChartLayout=="function"?i.scoreChartLayout():null;return`<div class="uc-sa-charts">
      <div class="uc-sa-chart-card"><h5>学期趋势</h5><div class="uc-sa-chart-scroll">${i.trendChartSvg({trend:E.trend,palette:i.scoreChartPalette||d,layout:z})}</div></div>
      <div class="uc-sa-chart-card"><h5>成绩分段分布</h5><div class="uc-sa-chart-scroll">${i.bandsChartSvg({bands:E.bands,palette:i.scoreChartPalette||d,layout:z})}</div></div>
    </div>
    <div class="uc-sa-more-row"><a class="uc-sa-more" data-href="/student/integratedQuery/scoreQuery/allPassingScores/index?urppp=sa">点击此处跳转到详细分析界面 →</a></div>`}a(k,"analysisHtml");function P(x){let E=!!i.isCleanAnalysisDirect(),z=n.scoreAnalysisTab==="analysis";return E?`<div class="uc-hd"><span>成绩总览</span><span class="uc-sub">点击查看明细</span></div>
  <div class="uc-bd">
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${z?"":" hidden"}>${k()}</div>
  </div>`}a(P,"scoreSectionHtml");function A(){try{if(window.matchMedia&&window.matchMedia("(max-width:900px)").matches)return 40}catch{}return 56}a(A,"getScheduleRowHeight");function y(x){let E=i.getViewWeekNumber(),z=A(),$=Math.max(z-4,28),T=(x||[]).map(H=>Object.assign({},H,{thisWeek:i.weekBitActive(H.classWeek,E)||!H.classWeek&&String(H.week||"").indexOf(String(E))>=0,span:Math.max(1,H.span||1),color:H.color||i.courseColor(H.name)})),j={};T.forEach(H=>{let G=H.day+"_"+H.section;(j[G]||(j[G]=[])).push(H)});let I=`<div class="uc-week" data-urppp-private="schedule" data-week="${E}" data-row="${z}">`;I+='<div class="uc-week-head"><div class="h"></div>';for(let H=0;H<7;H++)I+=`<div class="h">${i.DAY_NAMES[H]}</div>`;I+='</div><div class="uc-week-body">',I+='<div class="uc-sec-col">';for(let H=1;H<=12;H++)I+=`<div class="s" style="height:${z}px">${H}</div>`;I+="</div>";for(let H=0;H<7;H++){I+=`<div class="uc-day-col" data-day="${H}" style="height:${z*12}px">`;for(let G=1;G<=12;G++)I+=`<div class="uc-grid-cell" data-sec="${G}" style="top:${(G-1)*z}px;height:${$}px"></div>`;I+=`<div class="uc-part-line" style="top:${4*z-2}px"></div>`,I+=`<div class="uc-part-line" style="top:${9*z-2}px"></div>`;for(let G=1;G<=12;G++){let U=(j[H+"_"+G]||[]).slice().sort((xt,Z)=>xt.thisWeek!==Z.thisWeek?(Z.thisWeek?1:0)-(xt.thisWeek?1:0):(Z.span||1)-(xt.span||1));if(!U.length)continue;let pt=U.filter(xt=>xt.thisWeek)[0]||U[0],bt=U.filter(xt=>xt!==pt),V=pt.span,Q=(G-1)*z+1,ot=V*z-6,X=pt.thisWeek?8:2,ct=pt.thisWeek?`--uc-course-color:${pt.color};top:${Q}px;height:${ot}px;z-index:${X};background:${pt.color}26;border-color:${pt.color}80`:`--uc-course-color:${pt.color};top:${Q}px;height:${ot}px;z-index:${X};background:color-mix(in srgb,${pt.color} 8%,var(--input-bg));border-color:var(--border);opacity:.48`,rt=bt.length?`<span class="uc-badge">+${bt.length}</span>`:"",st=i.escapeHtml(JSON.stringify({name:pt.name,teacher:pt.teacher,place:pt.place,week:pt.week,day:pt.day,section:pt.section,span:pt.span,thisWeek:pt.thisWeek,others:bt.map(xt=>({name:xt.name,teacher:xt.teacher,place:xt.place,week:xt.week,thisWeek:xt.thisWeek,section:xt.section,span:xt.span}))}));I+=`<div class="uc-lesson${pt.thisWeek?"":" is-fade"}" style="${ct}" data-course='${st}'>
          <b>${i.escapeHtml(pt.name)}</b>
          <i>${i.escapeHtml([pt.place,pt.week].filter(Boolean).join(" · "))}</i>
          ${rt}
        </div>`}I+="</div>"}return I+="</div></div>",I}a(y,"renderScheduleBoard");function S(){try{if(n.loading&&n.loading.schedule)return"";let x=i.calVacation?i.calVacation():"term";if(x==="term"||i.getViewWeekNumber()!==0)return"";let E={summer:{title:"放暑假啦~",sub:"课表先歇一歇，好好享受生活",svg:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/></svg>'},winter:{title:"放寒假啦~",sub:"课表先歇一歇，好好享受生活",svg:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12h20"/><path d="M12 2v20"/><path d="M20 16l-4-4 4-4"/><path d="M4 8l4 4-4 4"/><path d="M16 4l-4 4-4-4"/><path d="M8 20l4-4 4 4"/></svg>'},springfestival:{title:"春节快乐！",sub:"",svg:'<svg viewBox="0 0 72 72"><rect x="16" y="16" width="40" height="40" rx="7" fill="#b71c1c" stroke="#f5b301" stroke-width="2.4" transform="rotate(45 36 36)"/><path d="M36 16v40M16 36h40" stroke="#f5b301" stroke-width="1" opacity=".5"/><path d="M24 24l24 24M48 24L24 48" stroke="#f5b301" stroke-width="1" opacity=".35"/><text x="36" y="47" text-anchor="middle" font-size="30" font-weight="900" fill="#ffd54f" font-family="Noto Serif SC,STKaiti,KaiTi,serif" transform="rotate(180 36 36)">福</text></svg>',couplet:{scroll:"万象纳祥",right:"望江听雨华西看杏海纳百川享人间烟火",left:"江安漫步眉山泛舟有容乃大过锦绣新年"}}}[x];if(!E)return"";if(x==="springfestival"&&E.couplet){let $=E.couplet;return`<div class="uc-schedule-mask uc-mask-springfestival">
      ...
      <button type="button" class="uc-svc" data-action="${E.a||""}" data-href="${E.h||""}">
        ${i.ico(E.i)}<strong>${E.t}</strong>
      </button>`).join("")}</div>`}a(g,"servicesHtml");function v(){let x=i.personalizedProfile(n.profile||{}),E=n.schedule&&n.schedule.courses||[],z=n.scores&&n.scores.passing&&n.scores.passing[0]||{summary:i.summarizeCourses([])},$=n.scores&&n.scores.schemes||[];n.scores&&n.scores.majorIdx!=null&&n._schemeInited!==!0&&(n.activeSchemeIdx=n.scores.majorIdx||0,n._schemeInited=!0);let T=$[n.activeSchemeIdx]||$[0]||{summary:i.summarizeCourses([]),title:"方案成绩"},j=x.avatar?`<img src="${i.escapeHtml(x.avatar)}" alt="">`:`<span>${i.escapeHtml((x.name||"同")[0])}</span>`,I=n.loading.scores?'<div class="uc-loading">成绩加载中</div>':n.scores&&n.scores.error?`<div class="uc-empty">${i.escapeHtml(n.scores.error)}</div>`:`<div class="uc-score-grid">
            <div class="uc-score-pane" data-score="passing"><h5>全部及格成绩</h5>${u(z.summary,"passing")}</div>
            <div class="uc-score-pane" data-score="scheme"><h5>${i.escapeHtml((T.title||"方案成绩").split(/通过|获得|不通过/)[0].trim()||"方案成绩")}</h5>${u(T.summary,"scheme")}</div>
      ...
      <div class="uc-col">
        <div class="uc-card uc-profile-card"><div class="uc-bd"><div class="uc-profile">
          ...
          <div>
            <div class="uc-name" data-urppp-private="name">${i.escapeHtml(x.name||"同学")}</div>
            <div class="uc-sub">主修方案：<span data-urppp-private="organization" data-urppp-edit-key="majorPlan">${i.escapeHtml(x.majorPlan||"—")}</span></div>
            <div class="uc-gpa">主修必修绩点 <span data-urppp-private="gpa" data-urppp-edit-key="majorGpa">${i.escapeHtml(String(x.majorGpa||"—"))}</span></div>
          </div>
        </div>${(()=>{try{return qp()}catch{return""}})()}</div></div>
        <div class="uc-card grow">
          <div class="uc-hd">
            ...
            <div class="uc-week-nav">
              ...
              <span class="uc-week-label">第${i.getViewWeekNumber()}周</span>
          ...
          <div class="uc-bd"><div class="uc-schedule-wrap">${n.loading.schedule?'<div class="uc-loading">课表加载中</div>':E.length?y(E):`<div class="uc-empty">${i.escapeHtml(n.schedule&&n.schedule.error||"暂无课表数据")}</div>`}${S()}</div></div>
        </div>
      </div>
      <div class="uc-col">
        <div class="uc-card">
    ...
    </div>`}a(v,"renderDesktop");function q(){let x=i.personalizedProfile(n.profile||{}),E=n.schedule&&n.schedule.courses||[],z=n.scores&&n.scores.passing&&n.scores.passing[0]||{summary:i.summarizeCourses([])},$=(n.scores&&n.scores.schemes||[])[n.activeSchemeIdx]||{summary:i.summarizeCourses([])},T=x.avatar?`<img src="${i.escapeHtml(x.avatar)}" alt="">`:`<span>${i.escapeHtml((x.name||"同")[0])}</span>`;if(n.mobileTab==="scores"){let j=`<div class="uc-score-grid uc-score-grid-mobile">
      ...
      <div class="uc-card uc-profile-card" style="margin-bottom:12px"><div class="uc-bd"><div class="uc-profile">
        ...
        <div><div class="uc-name" data-urppp-private="name">${i.escapeHtml(x.name||"同学")}</div>
        <div class="uc-sub">主修方案：<span data-urppp-private="organization" data-urppp-edit-key="majorPlan">${i.escapeHtml(x.majorPlan||"—")}</span></div>
        <div class="uc-gpa">主修必修绩点 <span data-urppp-private="gpa" data-urppp-edit-key="majorGpa">${i.escapeHtml(String(x.majorGpa||"—"))}</span></div></div>
      </div>${(()=>{try{return Tp()}catch{return""}})()}</div></div>
      ...
      </div><div class="uc-bd"><div class="uc-schedule-wrap">${n.loading.schedule?'<div class="uc-loading">课表加载中</div>':E.length?y(E):`<div class="uc-empty">${i.escapeHtml(n.schedule&&n.schedule.error||"暂无课表数据")}</div>`}${S()}</div></div></div>
    </div>`}a(q,"renderMobile");function C(){if(n.loading.room)return'<div class="uc-loading">教学楼加载中</div>';let x=n.catalog||[];return x.length?x.slice().sort((z,$)=>(/江安/.test(z.campus)?-1:0)-(/江安/.test($.campus)?-1:0)).map(z=>`
      <div style="margin-bottom:14px">
        <div style="font-weight:700;margin:0 0 8px">${i.escapeHtml(z.campus)}</div>
        <div class="uc-build-grid">
          ${z.buildings.map($=>`<button type="button" data-build-path="${i.escapeHtml($.path)}" data-cn="${i.escapeHtml($.campusNumber||"")}" data-bn="${i.escapeHtml($.buildingNumber||"")}">${i.escapeHtml($.name)}</button>`).join("")}
        </div>
      </div>`).join(""):`<div class="uc-empty">${i.escapeHtml(n.roomError||"未读到教学楼列表")}<div style="margin-top:10px"><button type="button" class="uc-btn" data-room-reload="1">重新加载</button></div></div>`}a(C,"roomPickerHtml");function f(x,E){if(!x||!x.rooms||!x.rooms.length)return'<div class="uc-empty">该楼暂无教室占用数据</div>';let z='<tr><th class="sticky">教室</th><th class="sticky2">座位</th>';for(let I=1;I<=12;I++)z+=`<th class="sec">${I}</th>`;z+="</tr>";let $=x.rooms.map(I=>{let H=`<tr><th class="sticky">${i.escapeHtml(I.name)}</th><th class="sticky2">${i.escapeHtml(I.seats)}</th>`;for(let G=1;G<=12;G++){let U=(I.slots||[]).find(et=>et.section===G)||{busy:!1};if(U.busy){let et=U.reason||U.typeLabel||"占用",pt=U.typeLabel||i.occupancyTypeLabel({occupancymoduleId:U.module}),bt=U.displayChar||i.firstContentChar(et)||i.firstContentChar(pt)||"占",V=Object.assign({},U.detail||{room:I.name,section:G,reason:et},{reason:et,typeLabel:pt,contentName:U.contentName||U.detail&&U.detail.contentName||""}),Q=i.escapeHtml(JSON.stringify(V));H+=`<td><button type="button" class="uc-slot busy ${i.occupancyKindClass(pt)}" data-occ='${Q}' title="${i.escapeHtml(I.name)} 第${G}节 · ${i.escapeHtml(et)}">${i.escapeHtml(bt)}</button></td>`}else H+=`<td><div class="uc-slot free" title="${i.escapeHtml(I.name)} 第${G}节 · 空闲"></div></td>`}return H+"</tr>"}).join(""),T=Number(x.dateOffset!=null?x.dateOffset:n.roomDateOffset)||0,j=a((I,H)=>`<button type="button" class="uc-btn${T===I?" primary":""}" data-room-day="${I}">${H}</button>`,"dayBtn");return`
      <div class="uc-occ-head">
        <div>
          <div class="uc-occ-title">${i.escapeHtml(E||"")}</div>
          <div class="uc-sub">${i.escapeHtml(x.dateLabel||"")}${x.jxzc?" · 教学第"+x.jxzc+"周":""}</div>
      ...
      <div class="uc-occ"><table class="uc-occ-table">${z}${$}</table></div>`}a(f,"occupancyHtml");function m(){let x=i.ensureRoot(),E=x.querySelector("#uc-body");i.getViewWeekNumber();let z=typeof window<"u"&&window.matchMedia?window.matchMedia:null,$=z&&z("(max-width:900px)").matches,T=!n.uiReady;E.innerHTML=$?q():v(),T?(n.uiReady=!0,x.classList.remove("uc-settled"),clearTimeout(x.__ucSettleTimer),x.__ucSettleTimer=setTimeout(()=>{n.open&&x.classList.add("uc-settled")},480)):x.classList.add("uc-settled"),i.bindUI(E),i.applyPersonalDisplay(E)}a(m,"render");function w(){if(!n.open||l)return;let x=a(()=>{l=0,n.open&&m()},"run"),E=typeof requestAnimationFrame=="function"?requestAnimationFrame:null;l=E?E(x):setTimeout(x,0)}return a(w,"scheduleRender"),{analysisHtml:k,metricHtml:u,occupancyHtml:f,render:m,renderScheduleBoard:y,roomPickerHtml:C,scheduleRender:w,scoreSectionHtml:P}}a(Bp,"createCleanModeRenderer");function Fp({state:n,deps:i}){function l(v,q){return!v||(v.__urpppCleanUiBindings||(v.__urpppCleanUiBindings=new Set),v.__urpppCleanUiBindings.has(q))?!1:(v.__urpppCleanUiBindings.add(q),!0)}a(l,"markCleanUiBound");function d(v){if(!v)return;try{i.bindScheduleExportHosts(v)}catch(C){console.warn("[URP++] schedule export menu",C)}v.querySelectorAll("[data-score]").forEach(C=>{l(C,"score")&&C.addEventListener("click",()=>A(C.getAttribute("data-score")))}),v.querySelectorAll("[data-sa-tab]").forEach(C=>{l(C,"saTab")&&C.addEventListener("click",()=>{n.scoreAnalysisTab=C.getAttribute("data-sa-tab")==="analysis"?"analysis":"overview",i.render()})}),v.querySelectorAll("[data-href]").forEach(C=>{l(C,"href")&&C.addEventListener("click",f=>{let m=C.getAttribute("data-href");m&&(f.preventDefault(),i.closeCleanMode(),location.href=m)})}),v.querySelectorAll("[data-eval-url]").forEach(C=>{l(C,"eval")&&C.addEventListener("click",f=>{let m=C.getAttribute("data-eval-url");m&&(f.preventDefault(),f.stopPropagation(),i.closeCleanMode(),location.href=m)})}),v.querySelectorAll('[data-action="room"]').forEach(C=>{l(C,"room")&&C.addEventListener("click",()=>y())}),v.querySelectorAll("[data-room-reload]").forEach(C=>{l(C,"roomReload")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),i.ensureRoomCatalogLoaded(!0)})}),v.querySelectorAll("[data-build-path]").forEach(C=>{l(C,"building")&&C.addEventListener("click",async()=>{let f=C.getAttribute("data-build-path"),m=(C.textContent||"").trim(),w=C.getAttribute("data-cn")||"",x=C.getAttribute("data-bn")||"",E=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;n.roomDateOffset=0,await g({path:f,name:m,campusNumber:w,buildingNumber:x,dateOffset:0},m,E)})}),v.querySelectorAll("[data-room-day]").forEach(C=>{l(C,"roomDay")&&C.addEventListener("click",async f=>{f.preventDefault(),f.stopPropagation();let m=parseInt(C.getAttribute("data-room-day")||"0",10)||0;if(!n.currentBuilding)return;n.roomDateOffset=m;let w=Object.assign({},n.currentBuilding,{dateOffset:m}),x=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;await g(w,w.name||"",x)})});let q=v.querySelector("#uc-room-back");q&&(q.onclick=()=>{n.occupancy=null,n.currentBuilding=null;let C=q.closest("#uc-room-panel")||document.querySelector("#uc-room-panel")||document.querySelector("#uc-modal-body");C&&C.id==="uc-modal-body"||C&&C.id==="uc-room-panel"?(C.innerHTML=i.roomPickerHtml(),d(C)):i.render()}),v.querySelectorAll(".uc-slot.busy[data-occ]").forEach(C=>{l(C,"occupancy")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();try{let m=JSON.parse(C.getAttribute("data-occ")||"{}");k("占用详情",`
            <div class="uc-occ-detail">
              <div class="uc-name">${i.escapeHtml(m.room||"")}</div>
              <div class="uc-sub" style="margin-top:8px">节次：第${i.escapeHtml(String(m.section||m.start||""))}${m.span>1?"-"+(Number(m.start||m.section)+Number(m.span)-1):""}节</div>
              <div class="uc-sub">占用类型：${i.escapeHtml(m.typeLabel||m.reason||"占用")}</div>
              <div class="uc-sub">具体内容：${i.escapeHtml(m.contentName||m.reason||"—")}</div>
              ${m.teacher?`<div class="uc-sub">教师：${i.escapeHtml(m.teacher)}</div>`:""}
              ${m.weeks?`<div class="uc-sub">周次：${i.escapeHtml(m.weeks)}</div>`:""}
              ${m.courseNo?`<div class="uc-sub">课程号：${i.escapeHtml(m.courseNo)}</div>`:""}
            </div>
          `,"",{stack:!0})}catch{}})}),v.querySelectorAll(".uc-lesson[data-course]").forEach(C=>{l(C,"course")&&C.addEventListener("click",f=>{f.stopPropagation();try{let m=JSON.parse(C.getAttribute("data-course")||"{}"),w=`第${m.section||"?"}${m.span>1?"-"+(Number(m.section)+Number(m.span)-1):""}节`,x=(m.others||[]).map(E=>`<div class="uc-course-sub ${E.thisWeek?"":"is-fade"}">
              <div class="uc-cd-name">${i.escapeHtml(E.name||"")}</div>
              <div class="uc-cd-meta">${i.escapeHtml([E.place,E.week,E.teacher].filter(Boolean).join(" · "))||"—"}</div>
              <div class="uc-cd-chip">${E.thisWeek?"当前周有课":"当前周无课"}</div>
            </div>`).join("");k("课程详情",`
            <div class="uc-course-detail">
              <div class="uc-cd-name">${i.escapeHtml(m.name||"")}</div>
              <div class="uc-cd-meta">${i.escapeHtml([m.place,m.teacher,m.week].filter(Boolean).join(" · "))||"—"}</div>
              <div class="uc-cd-chip">${m.thisWeek?"当前周有课":"当前周无课"} · ${i.escapeHtml(w)} · ${i.escapeHtml(i.DAY_NAMES[m.day]||"")}</div>
            </div>
            ${x?'<div class="uc-hd" style="border:0;padding:14px 0 6px">同时段其他课程</div>'+x:""}
          `,"")}catch{}})}),v.querySelectorAll("[data-week-delta]").forEach(C=>{l(C,"weekDelta")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();let m=parseInt(C.getAttribute("data-week-delta")||"0",10)||0,w=n.schedule&&n.schedule.courses||[],x=i.inferMaxWeek(w),E=i.getViewWeekNumber();n.weekLocked=!0,n.viewWeek=Math.min(x,Math.max(1,E+m)),i.render();let z=document.querySelector("#urppp-clean-root .uc-week-label");z&&(z.classList.remove("uc-pop"),z.offsetWidth,z.classList.add("uc-pop"))})}),v.querySelectorAll("[data-week-reset]").forEach(C=>{l(C,"weekReset")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),n.weekLocked=!1;let m=i.getCurrentWeekNumber()||n._termWeek||1;n.viewWeek=m,i.render();let w=document.querySelector("#urppp-clean-root .uc-week-label");w&&(w.classList.remove("uc-pop"),w.offsetWidth,w.classList.add("uc-pop"))})})}a(d,"bindUI");let u=[];function k(v,q,C,f){f=f||{};let m=i.ensureRoot(),w=m.querySelector("#uc-mask"),x=m.querySelector("#uc-modal");f.stack&&x.classList.contains("open")?u.push({title:m.querySelector("#uc-modal-title").textContent,body:m.querySelector("#uc-modal-body").innerHTML,ft:m.querySelector("#uc-modal-ft").innerHTML}):f.stack||(u.length=0),w.classList.add("open"),x.classList.add("open"),m.querySelector("#uc-modal-title").textContent=v,m.querySelector("#uc-modal-body").innerHTML=q,m.querySelector("#uc-modal-ft").innerHTML=C||"",d(m.querySelector("#uc-modal-body")),d(m.querySelector("#uc-modal-ft")),i.applyPersonalDisplay(m.querySelector("#uc-modal"))}a(k,"openModal");function P(){let v=i.rootEl();if(v){if(u.length){let q=u.pop();v.querySelector("#uc-modal-title").textContent=q.title,v.querySelector("#uc-modal-body").innerHTML=q.body,v.querySelector("#uc-modal-ft").innerHTML=q.ft||"",d(v.querySelector("#uc-modal-body")),d(v.querySelector("#uc-modal-ft"));return}v.querySelector("#uc-mask").classList.remove("open"),v.querySelector("#uc-modal").classList.remove("open")}}a(P,"closeModal");function A(v){let q=n.scores&&n.scores.passing&&n.scores.passing[0]||{courses:[],summary:i.summarizeCourses([])},C=n.scores&&n.scores.schemes||[];v==="scheme"&&n.scores&&n.scores.majorIdx!=null&&n._schemeInited!==!0&&(n.activeSchemeIdx=n.scores.majorIdx||0,n._schemeInited=!0);let f=C[n.activeSchemeIdx]||C[0]||{courses:[],summary:i.summarizeCourses([]),title:"方案成绩"},m=v==="scheme"?f:q,w=v==="scheme"?"scheme":"passing";n.selected[w]||(n.selected[w]=new Set);let x=v==="scheme"&&C.length>1?`<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">${C.map((Z,dt)=>`<button type="button" class="uc-btn ${dt===n.activeSchemeIdx?"primary":""}" data-scheme-idx="${dt}"><span data-urppp-private="organization">${i.escapeHtml((Z.title||"方案").slice(0,28))}</span></button>`).join("")}</div>`:"",E=a(Z=>{let dt=!!(Z&&(Z.unevaluated||i.isUnevaluatedScore(Z.score))),At=i.scoreToNumber(Z&&Z.score),kt="";dt?kt=At!=null&&At<60?"uneval-fail":"uneval":At!=null?kt=At>=60?"pass":"fail":/不及格|不合格|不通过/.test(String(Z&&Z.score||""))?kt="fail":Z&&Z.score&&(kt="pass");let Pt=i.escapeHtml(Z&&Z.score||"—"),B=dt?Z.evalUrl||"/student/teachingEvaluation/newEvaluation/index":"";return B?`<span class="uc-score-cell ${kt}" data-eval-url="${i.escapeHtml(B)}" title="未评教，点击前往评教">${Pt}</span>`:`<span class="uc-score-cell ${kt}">${Pt}</span>`},"scoreCellHtml"),z=(m.courses||[]).map((Z,dt)=>{let At=n.selected[w].has(dt),kt=i.isValidOfficialGpa(Z.officialGpa)?Z.officialGpa:i.scoreToGpa(Z.score),Pt=!!(Z.unevaluated||i.isUnevaluatedScore(Z.score));return`<tr class="${At?"is-on":""}${Pt?" is-uneval":""}" data-idx="${dt}">
        <td class="uc-namecell"><span class="uc-selmark" aria-hidden="true">${At?"✓":""}</span><span class="uc-cname">${i.escapeHtml(Z.name)}</span></td>
        <td><span class="uc-attr-pill">${i.escapeHtml(Z.attr||"—")}</span></td>
      ...
      ${x}${i.metricHtml(m.summary,v==="scheme"?"scheme":"passing")}
      ...
      </div>`,'<div id="uc-calc">已选 0 门</div><button type="button" class="uc-btn" id="uc-clear">清空</button>');let $=document.querySelector("#uc-modal-title");$&&(v==="scheme"?$.setAttribute("data-urppp-private","organization"):$.removeAttribute("data-urppp-private"),i.applyPersonalDisplay($.parentElement||$));let T=document.querySelector("#uc-modal-body"),j=document.getElementById("uc-calc"),I=document.getElementById("uc-score-table"),H=document.getElementById("uc-score-wrap"),G=document.getElementById("uc-select-box"),U=a(()=>{I.querySelectorAll("tbody tr[data-idx]").forEach(At=>{let kt=parseInt(At.getAttribute("data-idx"),10),Pt=n.selected[w].has(kt);At.classList.toggle("is-on",Pt);let B=At.querySelector(".uc-selmark");B&&(B.textContent=Pt?"✓":"")});let Z=[];n.selected[w].forEach(At=>{m.courses[At]&&Z.push(m.courses[At])});let dt=i.summarizeCoursesPreferOfficial(Z);j&&(j.className="uc-calc",j.innerHTML=Z.length?`已选 <b>${Z.length}</b> 门 · 学分 <b data-urppp-private="credit">${dt.totalCredit}</b> · 均分 <b data-urppp-private="grade">${dt.avgScore}</b> · 绩点 <b data-urppp-private="gpa">${dt.avgGpa}</b>`:"已选 0 门")},"paint"),et=a((Z,dt)=>{dt===!0?n.selected[w].add(Z):dt===!1||n.selected[w].has(Z)?n.selected[w].delete(Z):n.selected[w].add(Z)},"toggleIdx"),pt=!1;I.querySelectorAll("tbody tr[data-idx]").forEach(Z=>{Z.addEventListener("click",dt=>{if(pt){pt=!1;return}let At=parseInt(Z.getAttribute("data-idx"),10);et(At),U()})});let bt=!1,V=0,Q=0,ot=null,X=a(()=>Array.from(I.querySelectorAll("tbody tr[data-idx]")),"rowsEls"),ct=a((Z,dt)=>{if(!G||!H)return{left:0,top:0,right:0,bottom:0,w:0,h:0};let At=H.getBoundingClientRect(),kt=Math.min(V,Z),Pt=Math.min(Q,dt),B=Math.max(V,Z),Y=Math.max(Q,dt),tt=B-kt,ft=Y-Pt,ht=kt-At.left+H.scrollLeft,zt=Pt-At.top+H.scrollTop;return G.style.display=tt>3||ft>3?"block":"none",G.style.left=ht+"px",G.style.top=zt+"px",G.style.width=tt+"px",G.style.height=ft+"px",{left:kt,top:Pt,right:B,bottom:Y,w:tt,h:ft}},"placeBox"),rt=a(Z=>{if(!bt)return;Z.preventDefault();let dt=ct(Z.clientX,Z.clientY);dt.w<=3&&dt.h<=3||(n.selected[w]=new Set(ot),X().forEach(At=>{let kt=At.getBoundingClientRect();if(!!(kt.right<dt.left||kt.left>dt.right||kt.bottom<dt.top||kt.top>dt.bottom))return;let B=parseInt(At.getAttribute("data-idx"),10);ot.has(B)?n.selected[w].delete(B):n.selected[w].add(B)}),U())},"onMoveSel"),st=a(Z=>{let dt=Math.abs(Z.clientX-V)>3||Math.abs(Z.clientY-Q)>3;bt=!1,G&&(G.style.display="none"),document.removeEventListener("mousemove",rt,!0),document.removeEventListener("mouseup",st,!0),dt&&(pt=!0),U()},"onUpSel");H.addEventListener("mousedown",Z=>{Z.button===0&&(bt=!0,V=Z.clientX,Q=Z.clientY,ot=new Set(n.selected[w]),ct(V,Q),document.addEventListener("mousemove",rt,!0),document.addEventListener("mouseup",st,!0))}),T.querySelectorAll("[data-scheme-idx]").forEach(Z=>Z.addEventListener("click",()=>{n.activeSchemeIdx=parseInt(Z.getAttribute("data-scheme-idx"),10)||0,n._schemeUserSelected=!0,A("scheme")}));let xt=document.getElementById("uc-clear");xt&&(xt.onclick=()=>{n.selected[w]=new Set,U()}),U()}a(A,"openScoreModal");async function y(){k("空闲教室",'<div class="uc-loading">加载教学楼</div>',"");try{await i.ensureRoomCatalogLoaded(!1),k("空闲教室",i.roomPickerHtml(),'<span class="uc-sub">选择楼栋查看教室×节次占用（对齐教室使用状况）</span>')}catch(v){k("空闲教室",`<div class="uc-empty">${i.escapeHtml(v&&v.message||v)}</div>`,"")}}a(y,"openRoomModal");function S(v){if(v&&v.isConnected)return v;let q=document.querySelector("#uc-room-panel");if(q&&q.offsetParent!==null||q&&n.mobileTab==="room")return q;let C=document.querySelector("#uc-modal-body"),f=document.querySelector("#uc-modal");return f&&f.classList.contains("open")&&C?C:q||C||null}a(S,"getRoomHost");async function g(v,q,C){let f=S(C);if(!f){console.warn("[URP++] no room host");return}f.innerHTML='<div class="uc-loading">加载占用网格</div>';try{let m=await i.loadBuildingOccupancy(v);f.innerHTML='<div class="uc-loading">匹配课程名称</div>';let w=m.planNumber||"";if(!w)try{let z=await i.fetchText("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),$=JSON.parse(z);if(w=$&&($.zxjxjhh||$.xnxq||$.dateList&&$.dateList[0]&&$.dateList[0].zxjxjhh)||"",!w&&$&&$.xkxx&&$.xkxx[0]){let T=Object.keys($.xkxx[0]||{}),j=T.length?$.xkxx[0][T[0]]:null;w=j&&(j.zxjxjhh||j.executiveEducationPlanNumber)||""}}catch{}w||(w="2025-2026-2-1"),m.planNumber=w;try{m=await i.enrichOccupancyWithCurriculum(m,typeof v=="object"?v:{},w)}catch(z){console.warn("[URP++] enrich occupancy",z)}n.occupancy=m,n.roomDateOffset=Number(m.dateOffset!=null?m.dateOffset:n.roomDateOffset)||0;let x=typeof v=="object"?v:{path:v,name:q};n.currentBuilding=Object.assign({},x,{name:q||x.name||"",dateOffset:n.roomDateOffset}),q=q||v&&v.name||"";let E=S(f)||f;E.innerHTML=i.occupancyHtml(m,q),d(E)}catch(m){let w=S(f)||f;w&&(w.innerHTML=`<div class="uc-empty">${i.escapeHtml(m&&m.message||m)}</div>`)}}return a(g,"showBuilding"),{bindUI:d,closeModal:P,getRoomHost:S,openModal:k,openRoomModal:y,openScoreModal:A,showBuilding:g}}a(Fp,"createCleanModeUI");function Dp({state:n,deps:i}){function l(){return document.getElementById("urppp-clean-root")}a(l,"rootEl");function d(){i.ensureStyle();let y=l();if(y)return y;y=document.createElement("div"),y.id="urppp-clean-root",y.innerHTML=`
      <div class="uc-top">
        ...
        <div class="uc-top-actions">
          <button type="button" class="uc-btn" id="uc-refresh">${i.ico("refresh")}<span>刷新</span></button>
          <button type="button" class="uc-btn primary" id="uc-exit">${i.ico("exit")}<span>退出</span></button>
        </div>
      </div>
      <div class="uc-shell"><div class="uc-shell-inner" id="uc-body"></div></div>
      <div class="uc-tabbar" id="uc-tabbar">
        <button type="button" data-tab="home" class="ac">${i.ico("home")}<span>首页</span></button>
        <button type="button" data-tab="scores">${i.ico("score")}<span>成绩</span></button>
        <button type="button" data-tab="room">${i.ico("room")}<span>教室</span></button>
        <button type="button" data-tab="more">${i.ico("more")}<span>其他</span></button>
      </div>
      <div class="uc-mask" id="uc-mask"></div>
      <div class="uc-modal" id="uc-modal">
        <div class="uc-modal-hd"><span id="uc-modal-title">详情</span><button type="button" class="uc-btn" id="uc-modal-close">${i.ico("close")}</button></div>
        <div class="uc-modal-bd" id="uc-modal-body"></div>
        <div class="uc-modal-ft" id="uc-modal-ft"></div>
      </div>`,document.documentElement.appendChild(y),y.querySelector("#uc-exit").onclick=k,y.querySelector("#uc-refresh").onclick=()=>u(!0),y.querySelector("#uc-mask").onclick=i.closeModal,y.querySelector("#uc-modal-close").onclick=i.closeModal;let S=a(()=>{i.syncThemeDotGroup(y.querySelector("#uc-top-theme"))},"syncCleanThemeDots");y.querySelectorAll("#uc-top-theme .urppp-nav-dot[data-theme]").forEach(w=>{w.addEventListener("click",()=>{i.handleThemeDotClick(w.dataset.theme),S();try{i.syncNavbarThemeUI()}catch{}try{i.syncSettingsPanelUI()}catch{}})});let g=y.querySelector("#uc-settings");g&&g.addEventListener("click",w=>{w.preventDefault(),w.stopPropagation();try{i.openSettingsPanel()}catch{}});let v=y.querySelector("#uc-menu-toggle"),q=a(w=>{w.classList.remove("urppp-clean-sidebar");let x=w.__urpppCleanInline;if(x){let z=w.style,$=a((T,j)=>{let I=x[j];I&&I.v?z.setProperty(T,I.v,I.p||""):z.removeProperty(T)},"restore");$("top","top"),$("height","height"),$("z-index","z"),$("position","pos"),$("transform","transform"),$("visibility","vis"),$("pointer-events","pe"),$("transition","transition"),delete w.__urpppCleanInline}let E=w.__urpppCleanOrigin;E&&E.parent&&w.parentElement!==E.parent&&(E.next&&E.next.parentElement===E.parent?E.parent.insertBefore(w,E.next):E.parent.appendChild(w)),delete w.__urpppCleanOrigin},"restoreCleanSidebarInline"),C=a(()=>{let w=document.getElementById("sidebar");if(w)if(n.open){if(w.classList.add("urppp-clean-sidebar"),!w.__urpppCleanInline){let j=w.style,I=a(H=>({v:j.getPropertyValue(H),p:j.getPropertyPriority(H)}),"grab");w.__urpppCleanInline={top:I("top"),height:I("height"),z:I("z-index"),pos:I("position"),transform:I("transform"),vis:I("visibility"),pe:I("pointer-events"),transition:I("transition")},w.__urpppCleanOrigin={parent:w.parentElement,next:w.nextSibling}}if(w.parentElement!==y){let j=y.querySelector(".uc-shell");y.insertBefore(w,j||null)}let x=y.getBoundingClientRect(),E=y.querySelector(".uc-top"),z=E?E.getBoundingClientRect():null,$=Math.max(44,Math.round(z?z.bottom-x.top:60)),T=Math.max(0,Math.round(x.height-$));w.style.setProperty("top",$+"px","important"),w.style.setProperty("height",T+"px","important"),w.style.setProperty("z-index","12030","important"),w.style.setProperty("position","fixed","important")}else q(w)},"syncCleanSidebarZ"),f=a(()=>{let w=document.getElementById("sidebar");if(!w)return;try{i.stopDrawerAnimation(w)}catch{}w.classList.remove("display","urppp-drawer-closing"),q(w),v&&(v.setAttribute("aria-expanded","false"),v.setAttribute("aria-label","打开菜单"));let x=document.getElementById("urppp-mobile-menu-button");x&&(x.setAttribute("aria-expanded","false"),x.setAttribute("aria-label","打开菜单"))},"closeCleanSidebar");v&&v.addEventListener("click",w=>{w.preventDefault(),w.stopImmediatePropagation();let x=document.getElementById("sidebar");if(!x)return;x.__urpppCleanMenuBound||(x.__urpppCleanMenuBound=!0,x.addEventListener("click",$=>{if(!n.open)return;let T=$.target&&$.target.closest?$.target.closest("a[href]"):null;if(!T||T.closest("#urppp-mobile-search-panel"))return;let j=String(T.getAttribute("href")||"").trim();if(T.closest("#urppp-mobile-quick, #urppp-mobile-user")){if(!j||j==="#"||j.startsWith("javascript")||T.target==="_blank"||/^https?:\/\//i.test(j))return;k();return}!j||j==="#"||j.startsWith("javascript")||T.target==="_blank"||/^https?:\/\//i.test(j)||k()},!0));let E=!x.classList.contains("display");C(),i.setDrawerOpen(x,v,E);let z=document.getElementById("urppp-mobile-menu-button");z&&(z.setAttribute("aria-expanded",E?"true":"false"),z.setAttribute("aria-label",E?"关闭菜单":"打开菜单"))}),y.__closeCleanDrawer=f,y.__syncCleanSidebarZ=C,y.__syncCleanThemeDots=S;let m=globalThis.ResizeObserver;if(typeof m=="function"){let w=new m(()=>{n.open&&C()});w.observe(y);let x=y.querySelector(".uc-top");x&&w.observe(x),y.__cleanSidebarResizeObserver=w}try{let w=window.matchMedia&&window.matchMedia("(max-width: 900px)");if(w){let x=a(()=>{n.open&&(C(),i.render())},"onLayoutChange");typeof w.addEventListener=="function"?w.addEventListener("change",x):typeof w.addListener=="function"&&w.addListener(x),y.__scoreLayoutMedia=w,y.__scoreLayoutChange=x}}catch{}try{i.applySkinAttr()}catch{}return S(),y.querySelectorAll("#uc-tabbar button").forEach(w=>{w.onclick=()=>{n.mobileTab=w.dataset.tab,y.querySelectorAll("#uc-tabbar button").forEach(x=>x.classList.toggle("ac",x===w)),i.render(),n.mobileTab==="room"&&i.ensureRoomCatalogLoaded()}}),Po(),$p(y),y}a(d,"ensureRoot");function u(y){d();let S=n.open;n.open=!0,n.uiReady=!1,n.weekLocked=!1;let g=i.getCurrentWeekNumber()||i.readRememberedTermWeek();n.viewWeek=g>=1?g:n.viewWeek>=1?n.viewWeek:0,document.documentElement.classList.add("urppp-clean-lock",i.CLEAN_FLAG);let v=l();v.classList.remove("closing"),S||(v.classList.remove("uc-settled","open"),v.offsetWidth,v.classList.add("open"));try{i.stopDrawerAnimation(document.getElementById("sidebar"))}catch{}try{v.__syncCleanThemeDots&&v.__syncCleanThemeDots()}catch{}try{v.__syncCleanSidebarZ&&v.__syncCleanSidebarZ()}catch{}try{i.injectCleanSidebarSections(document.getElementById("sidebar"))}catch{}i.loadAll(!!y);try{i.ensureRoomCatalogLoaded()}catch{}}a(u,"openCleanMode");function k(){n.open=!1,n.uiReady=!1,i.closeModal(),document.documentElement.classList.remove("urppp-clean-lock",i.CLEAN_FLAG);let y=l();if(y){y.classList.remove("open","uc-settled","uc-drawer-open"),y.classList.add("closing"),clearTimeout(y.__ucSettleTimer);try{y.__closeCleanDrawer&&y.__closeCleanDrawer()}catch{}setTimeout(()=>{y.classList.remove("closing")},360)}try{i.refreshMobileNavbar()}catch{}}a(k,"closeCleanMode");function P(){try{i.ensureStyle();let y=document.getElementById("urppp-nav-clean");if(!i.isHomePage()){y&&y.remove(),Np();return}let S=document.getElementById("urppp-nav-theme")||document.querySelector("#navbar .navbar-header")||document.querySelector("#navbar");if(!S)return;y||(y=document.createElement("button"),y.type="button",y.id="urppp-nav-clean",y.title="清爽模式",y.innerHTML=`${i.ico("clean")}<span>清爽</span>`,y.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation(),u(!1)}),S.appendChild(y)),Object.entries({display:"inline-flex","align-items":"center",height:"28px","min-height":"28px",padding:"0 12px","font-size":"12px",gap:"6px",width:"auto",float:"none"}).forEach(([g,v])=>y.style.setProperty(g,v,"important")),Po();try{Ip()}catch{}}catch(y){console.warn("[URP++] clean entry",y)}}return a(P,"injectCleanEntry"),{cleanModeApi:{open:u,close:k,inject:P,refresh:i.refreshCleanPersonalDisplay,refreshRender:a(()=>{try{i.render()}catch{}},"refreshRender"),scoreToGpa:i.scoreToGpa,summarizeCourses:i.summarizeCourses},closeCleanMode:k,ensureRoot:d,injectCleanEntry:P,openCleanMode:u,rootEl:l}}a(Dp,"createCleanModeController");function jp({deps:n}){function i(){if(window.__urpppScheduleHoverNear)return;window.__urpppScheduleHoverNear=!0;let P=12,A=16,y=0,S=0,g=!1,v=0,q=a(()=>document.getElementById("schedule-hover"),"hoverEl"),C=a(w=>{if(!w||w.style&&w.style.display==="none")return!1;let x=window.getComputedStyle(w);return x.display!=="none"&&x.visibility!=="hidden"},"isShown"),f=a(()=>{let w=q();if(!w||!C(w)){g=!1;return}g=!0;let x=window.innerWidth||1200,E=window.innerHeight||800,z=y+P,$=S+A,T=Math.min(320,w.offsetWidth||280),j=Math.min(220,w.offsetHeight||160);z+T>x-8&&(z=x-T-8),$+j>E-8&&($=E-j-8),z<8&&(z=8),$<8&&($=8),w.style.setProperty("position","fixed","important"),w.style.setProperty("left",Math.round(z)+"px","important"),w.style.setProperty("top",Math.round($)+"px","important"),w.style.setProperty("right","auto","important"),w.style.setProperty("bottom","auto","important"),w.style.setProperty("margin","0","important"),w.style.setProperty("z-index","3000","important"),w.style.setProperty("pointer-events","none","important")},"place"),m=a(()=>{v||(v=requestAnimationFrame(()=>{v=0,f()}))},"schedulePlace");document.addEventListener("mousemove",w=>{if(y=w.clientX,S=w.clientY,!g){let x=q();x&&x.style&&x.style.display&&x.style.display!=="none"&&(g=!0)}g&&m()},!0),document.addEventListener("mouseover",w=>{w.target&&w.target.closest&&w.target.closest(".fc-event, .fc-time-grid-event")&&(y=w.clientX,S=w.clientY,setTimeout(()=>{g=!0,f()},0),setTimeout(f,40))},!0),document.addEventListener("mouseout",w=>{w.target&&w.target.closest&&w.target.closest(".fc-event, .fc-time-grid-event")&&setTimeout(()=>{let E=q();C(E)||(g=!1)},50)},!0)}a(i,"bindScheduleHoverNearCursor");function l(P){try{let A=!!(P&&P.force),y=typeof unsafeWindow<"u"&&unsafeWindow.jQuery?unsafeWindow.jQuery:window.jQuery||null;if(!y||!y.fn||!y.fn.fullCalendar)return!1;let S=document.getElementById("main-calendar")||document.querySelector("#urppp-left .fc, #urppp-dashboard .fc");if(!S)return!1;if(!A&&S.dataset.urpppFcSized==="1")return!0;let g=y(S);if(!(g.data("fullCalendar")||g.hasClass("fc")))return!1;let q=Array.from(S.querySelectorAll(".fc-scroller")).map(f=>({el:f,top:f.scrollTop,left:f.scrollLeft}));if(A||S.dataset.urpppFcRendered!=="1"){try{g.fullCalendar("render")}catch{}S.dataset.urpppFcRendered="1"}else try{g.fullCalendar("updateSize")}catch{}return requestAnimationFrame(()=>{q.forEach(f=>{try{f.el.scrollTop=f.top,f.el.scrollLeft=f.left}catch{}})}),(S.getBoundingClientRect().height||0)>=300&&(S.dataset.urpppFcSized="1"),!0}catch(A){return console.warn("[URP++] fullCalendar refresh failed",A),!1}}a(l,"refreshHomeFullCalendar");function d(){window.__urpppFcRefreshBound||(window.__urpppFcRefreshBound=!0,setTimeout(()=>l({force:!0}),0),setTimeout(()=>l({force:!1}),300))}a(d,"scheduleHomeFullCalendarRefresh");function u(P,A,y){let S=P.querySelector(".widget-header"),g=S?S.querySelector(".widget-toolbar"):null,v=document.createElement("div");v.className="urppp-card",v.innerHTML=`
      <div class="urppp-card-header">
        <h4>${y}</h4>
        <div class="urppp-card-tools"></div>
      </div>
      <div class="urppp-card-body"></div>
    `,g&&(g.style.display="inline-block",v.querySelector(".urppp-card-tools").appendChild(g)),v.querySelector(".urppp-card-body").appendChild(P),A.appendChild(v)}a(u,"wrapWidget");function k(){try{i()}catch{}if(document.getElementById("urppp-dashboard"))return;let P=document.querySelector(".page-content");if(!P)return;let A=Array.from(P.querySelectorAll(".widget-box"));if(A.length<6)return;let y=A[4],S=y?Array.from(y.querySelectorAll(".infobox")):[],g=document.createElement("div");g.id="urppp-dashboard",g.innerHTML=`
    ...
    `,P.appendChild(g);let v=P.querySelector("#warningInfo");v&&document.body.appendChild(v),A.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let q=g.querySelector("#urppp-stats"),C=Math.max(S.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',q.appendChild(E)}function f(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&(q.innerHTML="",x.forEach(E=>{let z=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),$=z[0]||"",T=z.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),I=/[\u4e00-\u9fa5]/.test($)||$.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=n.statCardPrivacyMarkup($,T);G.innerHTML=`<div class="${I}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,q.appendChild(G)}))}if(a(f,"updateStats"),f(),y){let x=new MutationObserver(()=>f());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let m=g.querySelector("#urppp-left"),w=g.querySelector("#urppp-right");u(A[5],m,"我的日程安排"),u(A[0],w,"通知公告"),u(A[1],w,"我的待办任务"),u(A[2],w,"可申请业务"),u(A[3],w,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(k,"rebuildDashboard"),{rebuildDashboard:k,refreshHomeFullCalendar:l,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(jp,"createDashboardController");function Se(n){return Math.round((Number(n)||0)*100)/100}a(Se,"round2");var ed=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],Op={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},rd=[{key:"required",label:"必修",test:a(n=>/必修/.test(n),"test")},{key:"elective",label:"任选",test:a(n=>/任选/.test(n),"test")},{key:"optional",label:"选修",test:a(n=>/选修/.test(n),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function Hp(n){let i=String(n||"").match(/^(\d{4})-(\d{4})-(\d+)/);return i?`${i[1].slice(2)}-${i[2].slice(2)}-${i[3]}`:String(n||"")}a(Hp,"shortTerm");function ba({deps:n}){let i=n.scoreToNumber,l=n.scoreToGpa;function d(f){let m=i(f);if(m!=null)return m;let w=String(f||"").trim().toUpperCase();return Op[w]!=null?Op[w]:null}a(d,"scoreToNumberWithLevels");function u(f){return!f||f.unevaluated?!1:d(f.score)!=null}a(u,"hasScore");function k(f){let m=String(f||"").match(/^(\d{4})-(\d{4})-(\d+)/);return m?[Number(m[1]),Number(m[3])]:[9999,9999]}a(k,"termOrderKey");function P(f){let m=f&&f.passing&&f.passing[0];return m&&m.courses||[]}a(P,"allCourses");function A(f){let m=f&&f.officialGpa,w=Number(m);return m!=null&&Number.isFinite(w)&&w>=0&&w<=5?w:null}a(A,"officialGpa");function y(f){let m=A(f);return m??l(f.score)}a(y,"courseGpa");function S({scorePack:f,profile:m}){let w=P(f),x=m&&m.majorGpa?String(m.majorGpa).trim():"",E=0,z=0,$=0,T=0,j=0,I=0;return w.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,z+=U*G;let et=y(H);et!=null&&($+=et*G,T+=G,H.required&&(j+=et*G,I+=G))}),{majorGpa:x,requiredGpa:Se(I?j/I:0),avgGpa:Se(T?$/T:0),avgScore:Se(E?z/E:0),totalCredit:Se(E),courseCount:w.length}}a(S,"computeMetrics");function g(f){let m=new Map;return(f||[]).forEach(w=>{if(!u(w))return;let x=w.term||"未分组",E=m.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},m.set(x,E));let z=Number(w.credit)||0,$=d(w.score);if($==null||(E.count+=1,z<=0))return;E.credit+=z,E.scoreW+=$*z;let T=y(w);T!=null&&(E.gpaW+=T*z,E.gpaCredit+=z)}),Array.from(m.values()).map(w=>({term:w.term,label:Hp(w.term),count:w.count,credit:Se(w.credit),avgScore:Se(w.credit?w.scoreW/w.credit:0),avgGpa:Se(w.gpaCredit?w.gpaW/w.gpaCredit:0)})).sort((w,x)=>{let E=k(w.term),z=k(x.term);return E[0]-z[0]||E[1]-z[1]})}a(g,"computeTrend");function v(f){let m=ed.map(x=>({...x,count:0,credit:0}));(f||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let z=m.find($=>E>=$.min&&E<=$.max);z&&(z.count+=1,z.credit+=Number(x.credit)||0)});let w=m.reduce((x,E)=>Math.max(x,E.count),1);return m.map(x=>({...x,ratio:Math.round(x.count/w*100)}))}a(v,"computeBands");function q(f){let m=rd.map(z=>({...z,credit:0,count:0}));(f||[]).forEach(z=>{if(!u(z))return;let $=String(z.attr||""),T=m.find(j=>j.test($));T&&(T.credit+=Number(z.credit)||0,T.count+=1)});let w=m.reduce((z,$)=>z+$.credit,0)||1,x=m.filter(z=>z.count>0).map(z=>({key:z.key,label:z.label,credit:Se(z.credit),count:z.count,ratio:Math.round(z.credit/w*100)})),E=x.find(z=>z.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a(q,"computeShare");function C({scorePack:f,profile:m}){let w=P(f);return{metrics:S({scorePack:f,profile:m}),trend:g(w),bands:v(w),share:q(w),empty:w.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:A,scoreToNumberWithLevels:d,shortTerm:Hp}}a(ba,"createScoreAnalysisData");var se="var(--text-secondary)",zo="var(--border)";function le(n){return at(String(n??""))}a(le,"escapeLabel");function Rp(n,i,l){let d=!!(n&&n.variant==="mobile");if(i==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},A=Math.max(56,Number(n&&n.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,l)*A),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},k=Math.max(44,Number(n&&n.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,l)*k),height:236,pad:u}}a(Rp,"resolveChartLayout");function Lo({width:n,height:i,mobile:l,kind:d,label:u}){let k=l?` data-urppp-chart-layout="mobile" style="width:max(100%,${n}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${n} ${i}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${k}>`}a(Lo,"openSvg");function ha({trend:n,palette:i,layout:l}){let d=(n||[]).filter(rt=>rt&&rt.avgScore!=null),u=Rp(l,"trend",d.length),{width:k,height:P,pad:A,mobile:y}=u,S=k-A.left-A.right,g=P-A.top-A.bottom;if(!d.length)return`${Lo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let v=d.length,q=a(rt=>A.left+(rt+.5)*(S/v),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),f=d.map(rt=>Number(rt.avgScore)||0),m=d.map(rt=>Number(rt.credit)||0),w=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...f)-4),z=Math.min(100,Math.max(...f)+4),$=Math.max(1,...m),T=x-w||1,j=z-E||1,I=a(rt=>A.top+g-(rt-w)/T*g,"yGpa"),H=a(rt=>A.top+g-(rt-E)/j*g,"yScore"),G=a(rt=>A.top+g-rt/$*g*.9,"yCredit"),U=d.map((rt,st)=>`${q(st)},${I(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${q(st)},${H(rt.avgScore)}`).join(" "),pt=[0,.25,.5,.75,1].map(rt=>{let st=A.top+g-rt*g;return`<line x1="${A.left}" y1="${st.toFixed(1)}" x2="${k-A.right}" y2="${st.toFixed(1)}" stroke="${zo}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),bt=d.map((rt,st)=>{let xt=q(st),Z=y?Math.min(30,S/v*.42):Math.min(26,S/v*.32),dt=G(rt.credit);return`<rect x="${(xt-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(A.top+g-dt).toFixed(1)}" rx="3" fill="${i.credit}" opacity="0.55"/>
<text x="${xt.toFixed(1)}" y="${(dt-4).toFixed(1)}" text-anchor="middle" font-size="12" fill="${se}">${le(rt.credit)}</text>`}).join(""),V=d.map((rt,st)=>`<text x="${q(st).toFixed(1)}" y="${P-16}" text-anchor="middle" font-size="12" fill="${se}">${le(rt.label)}</text>`).join(""),Q=d.map((rt,st)=>{let xt=S/v,Z=q(st)-xt/2,dt=[`学期 ${rt.label}`,`课程 ${rt.count} 门`,`修读学分 ${rt.credit}`,`加权均分 ${rt.avgScore}`,`平均绩点 ${rt.avgGpa}`].join(`
`);return`<rect class="urppp-sa-hover" x="${Z.toFixed(1)}" y="${A.top}" width="${xt.toFixed(1)}" height="${g.toFixed(1)}" fill="transparent"><title>${le(dt)}</title></rect>`}).join(""),ot=d.map((rt,st)=>`<circle cx="${q(st).toFixed(1)}" cy="${I(rt.avgGpa).toFixed(1)}" r="3.5" fill="${i.gpaLine}"/><text x="${q(st).toFixed(1)}" y="${(I(rt.avgGpa)-9).toFixed(1)}" text-anchor="middle" font-size="11.5" font-weight="600" fill="${i.gpaLine}">${le(rt.avgGpa)}</text>`).join(""),X=d.map((rt,st)=>`<circle cx="${q(st).toFixed(1)}" cy="${H(rt.avgScore).toFixed(1)}" r="3" fill="${i.scoreLine}"/><text x="${q(st).toFixed(1)}" y="${(H(rt.avgScore)+17).toFixed(1)}" text-anchor="middle" font-size="11.5" fill="${i.scoreLine}">${le(rt.avgScore)}</text>`).join(""),ct=y?`<g font-size="12">
  <rect x="${A.left}" y="30" width="12" height="12" rx="3" fill="${i.gpaLine}"/><text x="${A.left+18}" y="40" fill="${se}">学期平均绩点</text>
  <rect x="${A.left+132}" y="30" width="12" height="12" rx="3" fill="${i.scoreLine}"/><text x="${A.left+150}" y="40" fill="${se}">加权均分</text>
</g>`:`<g font-size="12">
  <rect x="${k-A.right-176}" y="8" width="12" height="12" rx="3" fill="${i.gpaLine}"/><text x="${k-A.right-158}" y="18" fill="${se}">学期平均绩点</text>
  <rect x="${k-A.right-82}" y="8" width="12" height="12" rx="3" fill="${i.scoreLine}"/><text x="${k-A.right-64}" y="18" fill="${se}">加权均分</text>
</g>`;return`${Lo({...u,kind:"trend",label:"学期成绩趋势"})}
${pt}
${bt}
<g>${Q}</g>
<text x="${A.left}" y="18" font-size="12" fill="${se}">每学期修读学分（柱）</text>
<g stroke="${i.gpaLine}" stroke-width="2.2" fill="none"><polyline points="${U}"/></g>
<g stroke="${i.scoreLine}" stroke-width="1.8" stroke-dasharray="5 4" fill="none"><polyline points="${et}"/></g>
<g>${ot}</g>
<g>${X}</g>
<g>${V}</g>
${ct}
</svg>`}a(ha,"trendChartSvg");function fa({bands:n,palette:i,layout:l}){let d=n||[],u=Rp(l,"bands",d.length),{width:k,height:P,pad:A,mobile:y}=u,S=k-A.left-A.right,g=P-A.top-A.bottom,v=d.length||1,q=Math.max(1,...d.map(m=>m.count)),C=y?Math.min(32,S/v*.62):Math.min(40,S/v*.52),f=d.map((m,w)=>{let x=A.left+(w+.5)*(S/v),E=m.count?Math.max(8,m.count/q*g):0,z=A.top+g-E,$=(.4+(1-w/(v-1))*.6).toFixed(2),T=m.range||(m.min===0?"<60":`${m.min}-${m.max===100?"100":m.max}`),j=[`${m.level||""}（绩点 ${m.gpa}）`,`百分制 ${T}`,`课程 ${m.count} 门`].join(`
`);return`<rect class="urppp-sa-band" x="${(x-C/2).toFixed(1)}" y="${z.toFixed(1)}" width="${C.toFixed(1)}" height="${E.toFixed(1)}" rx="4" fill="${i.primary}" opacity="${$}"><title>${le(j)}</title></rect>
<text x="${x.toFixed(1)}" y="${(z-6).toFixed(1)}" text-anchor="middle" font-size="12.5" font-weight="600" fill="var(--text)">${le(m.count)}</text>
<text x="${x.toFixed(1)}" y="${P-26}" text-anchor="middle" font-size="11" font-weight="600" fill="${se}">${le(T)}</text>
<text x="${x.toFixed(1)}" y="${P-12}" text-anchor="middle" font-size="12" fill="${se}">${le(m.gpa)}</text>`}).join("");return`${Lo({...u,kind:"bands",label:"成绩分段分布"})}
<line x1="${A.left}" y1="${(A.top+g).toFixed(1)}" x2="${k-A.right}" y2="${(A.top+g).toFixed(1)}" stroke="${zo}" stroke-width="1"/>
${f}
</svg>`}a(fa,"bandsChartSvg");function Up({items:n,requiredRatio:i,palette:l}){let A=2*Math.PI*56,y=(n||[]).filter(q=>q&&q.ratio>0),S=Math.max(0,Math.min(100,Math.round(Number(i)||0)));if(!y.length)return'<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成"></svg>';let g=-90,v=y.map(q=>{let C=q.ratio/100*A,m=`<circle cx="75" cy="75" r="56" fill="none" stroke="${l.share&&l.share[q.key]||l.required}" stroke-width="24"
  stroke-dasharray="${C.toFixed(2)} ${A.toFixed(2)}"
  stroke-linecap="butt" transform="rotate(${g.toFixed(2)} 75 75)"/>`;return g+=q.ratio/100*360,m}).join("");return`<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成">
<circle cx="75" cy="75" r="56" fill="none" stroke="${zo}" stroke-width="24"/>
${v}
...
</svg>`}a(Up,"donutSvg");var ad=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),od='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',nd='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function Wp({deps:n}){let i=n&&n.palette||ad;function l(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
  <button type="button" class="urppp-sa-toggle" aria-expanded="false">
    <span class="urppp-sa-icon">${od}</span>
    <span class="urppp-sa-title">成绩分析</span>
    <span class="urppp-sa-summary" data-urppp-sa-summary>点击展开，查看成绩指标与学期变化</span>
    <span class="urppp-sa-chevron">${nd}</span>
  </button>
  <div class="urppp-sa-body" data-urppp-sa-body hidden>
    <div class="urppp-sa-content" data-urppp-sa-content></div>
  </div>
</div>`}a(l,"panelShellHtml");function d(){return'<div class="urppp-sa-loading"><span class="urppp-sa-spinner"></span><span>正在计算成绩分析…</span></div>'}a(d,"loadingHtml");function u(S){return`<div class="urppp-sa-error">${at(String(S||"成绩数据加载失败"))}
...
<div class="urppp-sa-grid">
  <section class="urppp-sa-card urppp-sa-bands">
    ...
    <div class="urppp-sa-chart-scroll">${fa({bands:S.bands,palette:i,layout:q})}</div>
  </section>
  <section class="urppp-sa-card urppp-sa-detail">
    <h5 class="urppp-sa-card-title">各学期明细</h5>
    ${P(S.trend)}
  </section>
</div>`}return a(y,"analysisHtml"),{panelShellHtml:l,loadingHtml:d,errorHtml:u,analysisHtml:y,palette:i}}a(Wp,"createScoreAnalysisRenderer");function Gp(){function n(i,l){let d=i.querySelector(".urppp-sa-toggle"),u=i.querySelector("[data-urppp-sa-body]");if(!d||!u)return{isExpanded:a(()=>!1,"isExpanded"),setExpanded:a(()=>{},"setExpanded"),syncShareLayout:a(()=>{},"syncShareLayout")};let k=a(A=>{let y=A?"expanded":"collapsed";i.dataset.urpppSaState=y,d.setAttribute("aria-expanded",String(A)),u.hidden=!A,A&&typeof l.onExpand=="function"&&l.onExpand()},"setExpanded");d.addEventListener("click",()=>{let A=d.getAttribute("aria-expanded")==="true";k(!A)}),u.addEventListener("click",A=>{let y=A.target;y&&y.closest&&y.closest("[data-urppp-sa-retry]")&&typeof l.onRetry=="function"&&l.onRetry()});function P(){let A=i.querySelector(".urppp-sa-donut"),y=i.querySelector(".urppp-sa-legend"),S=!!(A&&y&&y.getBoundingClientRect().top>=A.getBoundingClientRect().bottom);i.classList.toggle("urppp-sa-share-stacked",S)}return a(P,"syncShareLayout"),{setExpanded:k,syncShareLayout:P,isExpanded:a(()=>d.getAttribute("aria-expanded")==="true","isExpanded")}}return a(n,"bindPanel"),{bindPanel:n}}a(Gp,"createScoreAnalysisUI");var Jp="urppp-score-analysis";function Vp({deps:n}){let i=ba({deps:n}),l=Wp({deps:n}),d=Gp(),u=null,k="idle",P=null,A=null,y=null,S=!1,g=0,v="desktop";function q(){if(!n.styles||document.getElementById("urppp-score-analysis-style"))return;let U=document.createElement("style");U.id="urppp-score-analysis-style",U.textContent=n.styles,(document.head||document.documentElement).appendChild(U)}a(q,"ensureStyle");function C(){if(typeof n.getInsertHost=="function"){let U=n.getInsertHost();if(U)return U}return document.querySelector(".page-content")||document.getElementById("page-content-template")||document.body}a(C,"findHost");function f(){return u&&u.querySelector("[data-urppp-sa-content]")}a(f,"contentEl");function m(){return P||(k="loading",P=(async()=>{try{let[U,et]=await Promise.all([n.loadScores(),n.loadProfile()]);if(U&&U.error)throw new Error(U.error);let pt=i.analyzeScores({scorePack:U,profile:et});return A=pt,k="ready",pt}catch(U){throw k="error",U}finally{P=null}})(),P)}a(m,"startLoad");function w(){k==="idle"&&m().catch(()=>{})}a(w,"warmup");function x(){if(y&&typeof y.syncShareLayout=="function")try{y.syncShareLayout()}catch{}}a(x,"syncShareLayout");function E(){try{if(window.matchMedia&&window.matchMedia("(max-width: 720px)").matches)return{variant:"mobile"}}catch{}return null}a(E,"currentChartLayout");function z(){let U=f();if(!U||!A)return;let et=E();v=et?et.variant:"desktop",U.innerHTML=l.analysisHtml(A,{chartLayout:et}),x()}a(z,"renderReadyAnalysis");function $(){clearTimeout(g),g=setTimeout(()=>{if(x(),!A||!y||!y.isExpanded())return;let U=E();(U?U.variant:"desktop")!==v&&z()},120)}a($,"handleResize");function T(){S||(S=!0,window.addEventListener("resize",$))}a(T,"bindResize");function j(){S&&(S=!1,clearTimeout(g),g=0,window.removeEventListener("resize",$))}a(j,"unbindResize");async function I(){let U=f();if(U){if(k==="ready"&&A){z();return}U.innerHTML=l.loadingHtml();try{await m(),z()}catch(et){U.innerHTML=l.errorHtml(et&&et.message||String(et))}}}a(I,"handleExpand");function H(){if(q(),u&&u.isConnected)return u;if(document.getElementById(Jp))return document.getElementById(Jp);let U=C();if(!U)return null;let et=document.createElement("div");return et.innerHTML=l.panelShellHtml(),u=et.firstElementChild,U.insertBefore(u,U.firstChild),y=d.bindPanel(u,{onExpand:I,onRetry:I}),T(),w(),n.shouldAutoExpand&&n.shouldAutoExpand()&&(typeof requestAnimationFrame=="function"?requestAnimationFrame:bt=>setTimeout(bt,0))(()=>{try{y.setExpanded(!0)}catch{}}),u}a(H,"mount");function G(){j(),u&&u.isConnected&&u.remove(),u=null,y=null,k="idle",P=null,A=null,v="desktop"}return a(G,"unmount"),{mount:H,unmount:G,getPanel:a(()=>u,"getPanel"),reset:G}}a(Vp,"createScoreAnalysisController");function Yp({documentRef:n=document,locationRef:i=location,windowRef:l=window}){function d(S){return String(S||"").replace(/[\u00a0\s]+/g," ").replace(/^[>\u25b8\u203a·•\u00bb]+/,"").replace(/^\s*[\u25b8>]\s*/,"").trim()}a(d,"cleanMenuLabel");function u(S){if(!S)return"";let g=S.querySelector(":scope > a");if(!g)return"";let v=g.querySelector(".menu-text, .urppp-nav-text");if(v)return d(v.textContent);let q=g.cloneNode(!0);return q.querySelectorAll("i, b, .badge, .arrow, .menu-icon, .urppp-nav-arrow").forEach(C=>C.remove()),d(q.textContent)}a(u,"getMenuLiLabel");function k(S){let g=[],v=S,q=n.getElementById("menus")||n.getElementById("urppp-menus");for(;v&&v!==q;){if(v.tagName==="LI"){let C=u(v);C&&!/^(首页|一级菜单|二级菜单|三级菜单)$/.test(C)&&g.unshift(C)}v=v.parentElement}return g.filter((C,f)=>C&&C!==g[f-1])}a(k,"walkMenuAncestors");function P(){let S=i.pathname.replace(/\/+$/,"")||"/",g=i.search||"",v=[];return[n.getElementById("menus"),n.getElementById("urppp-menus")].filter(Boolean).forEach(C=>{C.querySelectorAll("a[href]").forEach(f=>{let m=f.getAttribute("href")||"";if(!(!m||m==="#"||m.startsWith("javascript")))try{let w=new URL(m,i.origin),x=w.pathname.replace(/\/+$/,"")||"/";if(x==="/"&&S!=="/")return;let E=0;S===x?E=1e3+x.length:S.startsWith(x+"/")?E=500+x.length:S.includes(x)&&x.length>8&&(E=200+x.length),E&&g&&w.search&&g.indexOf(w.search.slice(1))>=0&&(E+=50),E>0&&v.push({score:E,li:f.closest("li")})}catch{}})}),v.sort((C,f)=>f.score-C.score),v.length?v[0].li:null}a(P,"findMenuLiByPath");function A(){let S=P();if(S){let m=k(S);if(m.length)return m}let g="";try{let m=n.cookie.match(/(?:^|;\s*)selectionBar=([^;]+)/);m&&(g=decodeURIComponent(m[1]))}catch{}if(g&&g!=="0"){let m=n.getElementById(g);if(m){let w=k(m);if(w.length)return w}}let v=null,q=Array.from(n.querySelectorAll("#menus li.active"));if(q.length){v=q[q.length-1];for(let m=q.length-1;m>=0;m--)if(!q[m].querySelector("li.active")){v=q[m];break}}if(!v){let m=Array.from(n.querySelectorAll("#urppp-menus .urppp-nav-item.active"));if(m.length){v=m[m.length-1];for(let w=m.length-1;w>=0;w--)if(!m[w].querySelector(".urppp-nav-item.active")){v=m[w];break}}}if(v){let m=k(v);if(m.length)return m}let C=n.getElementById("breadcrumbs")||n.querySelector(".breadcrumbs"),f=C&&(C.querySelector("ul.breadcrumb")||C.querySelector(".breadcrumb"));if(f){let m=[];if(Array.from(f.children).forEach((w,x)=>{if(x===0)return;let E=d(w.textContent);!E||/^(首页|一级菜单|二级菜单|三级菜单)$/.test(E)||m[m.length-1]!==E&&m.push(E)}),m.length)return m}return[]}a(A,"getBreadcrumbTrail");function y(){let S=n.getElementById("breadcrumbs")||n.querySelector(".breadcrumbs");if(!S)return;S.classList.remove("hide"),S.style.removeProperty("display"),S.style.setProperty("display","flex","important");let g=S.querySelector("ul.breadcrumb")||S.querySelector(".breadcrumb");g||(g=n.createElement("ul"),g.className="breadcrumb",S.appendChild(g));let v=A();if(!v.length&&Array.from(g.children).map(m=>d(m.textContent)).filter(Boolean).some(m=>m!=="首页"&&!/^(一级菜单|二级菜单|三级菜单)$/.test(m)))return;g.innerHTML="";let q=n.createElement("li");q.style.cursor="pointer",q.innerHTML='<span class="urppp-bc-label"><i class="ace-icon fa fa-home home-icon"></i>首页</span>',q.addEventListener("click",()=>{l.location.href="/"}),g.appendChild(q),v.forEach((C,f)=>{let m=n.createElement("li");f===v.length-1&&m.classList.add("active");let w=n.createElement("span");w.className="urppp-bc-label",w.textContent=C,m.appendChild(w),g.appendChild(m)})}return a(y,"beautifyBreadcrumbs"),{beautifyBreadcrumbs:y}}a(Yp,"createBreadcrumbController");function Qp({documentRef:n=document,windowRef:i=window,MutationObserverRef:l=MutationObserver,nodeTypeRef:d=Node}){function u(){try{let A=n.getElementById("sidebar"),y=n.querySelectorAll(".main-content");if(!y.length)return;let S=i.matchMedia&&i.matchMedia("(max-width: 991px)").matches,g="260px";S?g="0px":A&&(g=A.classList.contains("menu-min")?"50px":"260px"),y.forEach(v=>v.style.setProperty("margin-left",g,"important"))}catch{}}a(u,"syncMobileContentOffset");function k(){try{let A=n.getElementById("sidebar"),y=n.querySelector("#navbar, .navbar.navbar-default, .navbar-fixed-top");if(!A||!y||A.classList.contains("urppp-clean-sidebar"))return;let S=y.getBoundingClientRect(),g=Math.max(45,Math.round(S.height||y.offsetHeight||45));n.documentElement.style.setProperty("--urppp-navbar-height",g+"px"),A.style.setProperty("top",g+"px","important"),A.style.setProperty("height","calc(100vh - "+g+"px)","important"),A.style.setProperty("margin-top","0","important"),y.style.setProperty("z-index","1100","important"),A.style.setProperty("z-index","1030","important"),u()}catch{}}a(k,"syncSidebarUnderNavbar");function P(){let A=n.getElementById("sidebar"),y=n.getElementById("menus");if(!A||!y)return;if(i.__urpppSidebarMenuObserver){try{i.__urpppSidebarMenuObserver.disconnect()}catch{}i.__urpppSidebarMenuObserver=null}let S=n.getElementById("urppp-menus"),g=A.querySelector(".urppp-sidebar-header");S&&S.remove(),g&&g.remove(),k();let v=new Set;y.querySelectorAll("li.active").forEach(I=>{I.id&&v.add(I.id)});function q(I){return Array.from(I.children).filter(H=>H.tagName==="LI").map(H=>{let G=H.querySelector(":scope > a"),U=G?.querySelector(".menu-text"),et=U?U.textContent.trim():G?Array.from(G.childNodes).filter(st=>st.nodeType===d.TEXT_NODE).map(st=>st.textContent).join("").trim():"",pt=G?.querySelector(".menu-icon"),bt=pt?Array.from(pt.classList).filter(st=>st!=="menu-icon").join(" "):"",V=H.querySelector(":scope > .submenu"),Q=V?q(V):[];Q=Q.filter(st=>st.text&&(st.text.trim()||st.href&&st.href!=="#"));let ot=G?.getAttribute("href")||"#",X=G?.getAttribute("target")||"",ct=H.getAttribute("onclick")||G?.getAttribute("onclick")||"",rt=H.id;return ot!=="#"&&!ot.startsWith("javascript")?{id:rt,text:et,iconClass:bt,children:[],href:ot,target:X,onclick:ct}:Q.length===1&&Q[0].children.length===0?{id:rt||Q[0].id,text:et,iconClass:bt||Q[0].iconClass,children:[],href:Q[0].href||ot,target:Q[0].target||X,onclick:Q[0].onclick||ct}:{id:rt,text:et,iconClass:bt,children:Q,href:ot,target:X,onclick:ct}})}a(q,"parseMenu");let C=q(y);y.style.display="none";let f=n.createElement("div");f.className="urppp-sidebar-header",f.style.cssText="position:absolute;top:0;left:0;right:0;z-index:100;display:flex;align-items:center;justify-content:flex-end;padding:14px 14px 12px;border-bottom:1px solid var(--border);background:var(--surface)";let m=n.createElement("button");m.type="button",m.className="urppp-sidebar-toggle",m.innerHTML='<i class="fa fa-angle-left" aria-hidden="true"></i>',m.title="收起侧边栏",typeof m.setAttribute=="function"&&m.setAttribute("aria-label","收起侧边栏");let w=a(()=>!!(i.matchMedia&&i.matchMedia("(max-width: 991px)").matches),"isNarrow"),x=a(I=>{if(I&&(I.preventDefault(),I.stopPropagation()),w()){A.classList.remove("display"),u();return}let H=n.getElementById("sidebar-collapse");H&&H.click()},"doToggle");m.addEventListener("click",x),f.appendChild(m);let E=a(()=>{let I=w(),H=n.body.classList.contains("menu-min")||A.classList.contains("menu-min"),G=I?"关闭菜单":H?"展开侧边栏":"收起侧边栏";m.innerHTML=I?'<i class="fa fa-times" aria-hidden="true"></i>':H?'<i class="fa fa-angle-right" aria-hidden="true"></i>':'<i class="fa fa-angle-left" aria-hidden="true"></i>',m.title=G,typeof m.setAttribute=="function"&&m.setAttribute("aria-label",G),!I&&H?(f.style.justifyContent="center",f.style.padding="12px 0"):(f.style.justifyContent="flex-end",f.style.padding="")},"syncToggle"),z=new l(E);z.observe(n.body,{attributes:!0,attributeFilter:["class"]}),z.observe(A,{attributes:!0,attributeFilter:["class"]}),i.__urpppSidebarMenuObserver=z,E();let $=n.createElement("ul");$.id="urppp-menus",$.style.cssText="margin-top:50px;list-style:none;padding:10px 12px 24px;overflow-y:auto;max-height:calc(100vh - 64px)";function T(I){n.querySelectorAll("#urppp-menus .urppp-nav-item").forEach(G=>G.classList.remove("active"));let H=I;for(;H&&H.id!=="urppp-menus";)H.classList.contains("urppp-nav-item")&&H.classList.add("active"),H=H.parentElement}a(T,"setActiveBranch");function j(I,H){let G=n.createElement("li");G.className="urppp-nav-item",I.id&&(G.id=I.id);let U=I.children.length>0,et=I.href||"#",pt=et!=="#"&&!et.startsWith("javascript"),bt=n.createElement("a");if(bt.className="urppp-nav-link",bt.href=pt?et:"javascript:void(0)",I.target&&bt.setAttribute("target",I.target),I.iconClass){let Q=n.createElement("i");I.iconClass.split(" ").forEach(ot=>{ot&&Q.classList.add(ot)}),bt.appendChild(Q)}let V=n.createElement("span");if(V.className="urppp-nav-text",V.textContent=I.text,V.title=I.text,bt.appendChild(V),U){let Q=n.createElement("i");Q.className="urppp-nav-arrow fa fa-angle-down",Q.addEventListener("click",ot=>{ot.preventDefault(),ot.stopPropagation(),G.classList.toggle("open")}),bt.appendChild(Q)}if(G.appendChild(bt),bt.addEventListener("click",Q=>{if(T(G),!pt&&U)Q.preventDefault(),G.classList.toggle("open");else if(pt)return}),U){let Q=n.createElement("ul");Q.className="urppp-nav-submenu",I.children.forEach(ot=>j(ot,Q)),G.appendChild(Q)}I.id&&v.has(I.id)&&G.classList.add("active"),H.appendChild(G)}a(j,"buildItem"),C.forEach(I=>j(I,$)),$.querySelectorAll(".urppp-nav-item.open").forEach(I=>I.classList.remove("open")),A.insertBefore(f,A.firstChild),A.appendChild($)}return a(P,"rebuildSidebarCompletely"),{rebuildSidebarCompletely:P,syncMobileContentOffset:u,syncSidebarUnderNavbar:k}}a(Qp,"createSidebarController");function Xp({theme:n,settings:i,documentRef:l=document,windowRef:d=window}){function u(S){if(!S)return;let g=n.getSkin(),v=n.skinSupportsFixedPalettes(g),q=n.getCurrent(),C=v?n.getBrutalActivePalette():null,f=v?n.getBrutalSelectedPalette():null;S.querySelectorAll(".urppp-nav-dot[data-theme]").forEach(m=>{let w=m.dataset.theme,x=w==="dark",E=w==="scu-red",z=x&&!n.skinSupportsDark(g)||E&&!n.skinSupportsDynamic(g)&&!v,$=w===q;if(v&&($=w==="default"&&C.id===n.BRUTAL_DEFAULT_PALETTE||E&&C.id!==n.BRUTAL_DEFAULT_PALETTE),m.disabled=z,m.classList.toggle("urppp-theme-disabled",z),m.classList.toggle("ac",$&&!z),m.setAttribute("aria-disabled",z?"true":"false"),w==="default")m.style.background=v?n.getBrutalPaletteById(n.BRUTAL_DEFAULT_PALETTE).accent:"#F1F3F5",m.title=v?"默认高能粉":"简约白";else if(x)m.style.background=z?"#A7A7A7":"#0B0F14",m.title=z?"当前界面风格不支持暗色模式":"深邃暗";else if(E)if(z)m.style.background="#A7A7A7",m.title="当前界面风格不支持动态配色";else if(v)m.style.background=f.accent,m.title="高对比配色："+f.name;else{let T=n.getAccent()||n.DEFAULT_SEED;try{let j=n.buildSchemePreview(T,n.getScheme());m.style.background="linear-gradient(135deg, "+j.primary+" 0 55%, "+j.surface+" 55% 100%)"}catch{m.style.background=T}m.title="动态配色"}})}a(u,"syncThemeDotGroup");function k(S){let g=n.getSkin();if(n.skinSupportsFixedPalettes(g)){if(S==="dark")return;n.getCurrent()!=="default"&&n.applyTheme("default",{manual:!0}),S==="default"&&n.setBrutalPalette(n.BRUTAL_DEFAULT_PALETTE),S==="scu-red"&&n.setBrutalPalette(n.getBrutalSelectedPalette().id);return}n.isThemeModeAvailable(S,g)&&n.applyTheme(S,{manual:!0})}a(k,"handleThemeDotClick");function P(){u(l.getElementById("urppp-nav-theme"))}a(P,"syncNavbarThemeUI");function A(){try{let S=l.getElementById("navbar")||l.querySelector(".navbar");if(!S)return;if(l.getElementById("urppp-nav-theme")){P();return}let g=S.querySelector(".navbar-header .navbar-brand")||S.querySelector(".navbar-brand")||S.querySelector(".navbar-header");if(!g)return;let v=l.createElement("div");v.id="urppp-nav-theme",v.innerHTML=['<button type="button" class="urppp-nav-dot" data-theme="default" title="简约白" style="background:#F1F5F9"></button>','<button type="button" class="urppp-nav-dot" data-theme="dark" title="深邃暗" style="background:#0B0F17"></button>','<button type="button" class="urppp-nav-dot" data-theme="scu-red" title="动态配色" style="background:#B53434"></button>','<button type="button" class="urppp-nav-settings" id="urppp-nav-settings" title="设置" aria-label="设置">','  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">','    <circle cx="12" cy="12" r="3"></circle>','    <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"></path>',"  </svg>","</button>"].join(""),g.parentElement?(g.parentElement.style.setProperty("display","flex","important"),g.parentElement.style.setProperty("align-items","center","important"),g.nextSibling?g.parentElement.insertBefore(v,g.nextSibling):g.parentElement.appendChild(v)):g.appendChild(v),v.style.setProperty("display","inline-flex","important"),v.style.setProperty("align-items","center","important"),v.style.setProperty("height","36px","important"),v.querySelectorAll(".urppp-nav-dot[data-theme]").forEach(q=>{q.addEventListener("click",()=>{k(q.dataset.theme),P();try{i.syncSettingsPanelUI()}catch{}})}),v.querySelector("#urppp-nav-settings").addEventListener("click",q=>{q.preventDefault(),q.stopPropagation(),i.openSettingsPanel()}),i.ensureSettingsPanel(),P();try{d.__urpppCleanMode&&d.__urpppCleanMode.inject()}catch{}}catch(S){console.warn("[URP++] navbar theme switch inject failed",S)}}a(A,"injectNavbarThemeSwitch");function y(){let g=l.getElementById("navbar")?.querySelector(".ace-nav");try{A()}catch{}if(!g)return;function v(E,z){Object.entries(z).forEach(([$,T])=>E.style.setProperty($,T,"important"))}a(v,"force"),Array.from(g.childNodes).forEach(E=>{E.nodeType===Node.TEXT_NODE&&!E.textContent.trim()&&E.remove()}),g.querySelectorAll(":scope > li").forEach(E=>{v(E,{display:"inline-flex","align-items":"center","vertical-align":"middle",margin:"0",padding:"0","text-align":"left"})}),g.querySelectorAll(":scope > li > a").forEach(E=>{v(E,{display:"inline-flex","align-items":"center","justify-content":"center",height:"36px",padding:"0 4px","flex-wrap":"nowrap","vertical-align":"middle","text-decoration":"none"}),E.style.lineHeight="1"}),g.querySelectorAll(":scope > li > a > .ace-icon, :scope > li > a > .glyphicon, :scope > li > a > .fa").forEach(E=>{v(E,{top:"auto","vertical-align":"middle","line-height":"1","margin-top":"0"})});let q=g.querySelector(':scope > li > a[href*="customerServiceCenter"]');q&&(v(q,{width:"28px","justify-content":"center"}),q.style.padding="0 4px");let C=l.getElementById("clickdiv"),f=l.getElementById("form-search"),m=l.getElementById("search-input"),w=l.getElementById("intellegenceUDiv");if(w&&(w.style.setProperty("position","relative","important"),w.style.setProperty("z-index","30","important"),w.style.setProperty("display","inline-flex","important"),w.style.setProperty("align-items","center","important"),w.style.setProperty("justify-content","center","important"),w.style.setProperty("width","32px","important"),w.style.setProperty("height","36px","important"),w.style.setProperty("vertical-align","middle","important"),w.style.setProperty("margin","0","important"),w.style.setProperty("padding","0","important")),C&&f){C.removeAttribute("onclick"),v(C,{"background-color":"transparent",position:"relative",display:"inline-flex","align-items":"center","justify-content":"center",width:"32px",height:"32px","border-radius":"8px","line-height":"1","z-index":"30"});let E=l.getElementById("clicki");E&&v(E,{color:"var(--text-secondary)","margin-top":"0"}),C.__urpppNavbarClickBound||(C.__urpppNavbarClickBound=!0,C.addEventListener("mouseenter",()=>C.style.setProperty("background-color","var(--input-bg)","important")),C.addEventListener("mouseleave",()=>C.style.setProperty("background-color","transparent","important")),C.addEventListener("click",T=>{T.preventDefault(),T.stopPropagation(),f.dataset.open==="1"?(f.style.width="0px",f.style.opacity="0",f.dataset.open="0"):(f.style.width="180px",f.style.opacity="1",f.dataset.open="1",m&&setTimeout(()=>m.focus(),50))})),d.__urpppNavbarOutsideClickBound||(d.__urpppNavbarOutsideClickBound=!0,l.addEventListener("click",T=>{let j=l.getElementById("clickdiv"),I=l.getElementById("form-search");!j||!I||I.dataset.open!=="1"||!j.contains(T.target)&&!I.contains(T.target)&&(I.style.width="0px",I.style.opacity="0",I.dataset.open="0")})),v(f,{position:"absolute",right:"34px",top:"50%",transform:"translateY(-50%)",left:"auto",margin:"0","z-index":"10",background:"transparent",border:"none","box-shadow":"none",overflow:"hidden",padding:"0",transition:"width .2s ease, opacity .2s ease"});let z=f.dataset.open==="1"?"160px":"0px";f.style.width!==z&&(f.style.width=z,f.style.opacity=f.dataset.open==="1"?"1":"0"),m&&v(m,{"background-color":"var(--input-bg)",border:"1px solid var(--border)",color:"var(--text)","border-radius":"8px",height:"32px",padding:"0 12px","line-height":"32px",width:"100%"});let $=f.querySelector(".input-icon > .ace-icon.fa-search");$&&($.style.display="none")}let x=g.querySelector(":scope > li.light-blue > a");if(x){v(x,{display:"inline-flex","align-items":"center",gap:"6px"});let E=x.querySelector(".user-info");E&&(v(E,{display:"inline-flex","align-items":"center",gap:"4px","max-width":"none","white-space":"nowrap","vertical-align":"middle","line-height":"1","margin-top":"-12px"}),Array.from(E.childNodes).forEach($=>{$.nodeType===Node.TEXT_NODE&&($.textContent=$.textContent.replace(/\s+/g,"").trim())}),Array.from(E.children).forEach($=>{v($,{display:"inline","white-space":"nowrap","vertical-align":"middle","line-height":"1",margin:"0",padding:"0"}),$.tagName==="SMALL"&&$.style.setProperty("font-size","inherit","important")}));let z=x.querySelector(".nav-user-photo");z&&(z.alt=(z.alt||"").replace(/\s+/g,"").trim(),v(z,{"vertical-align":"middle",display:"inline-block",width:"30px",height:"30px"}))}}return a(y,"rebuildNavbar"),{handleThemeDotClick:k,injectNavbarThemeSwitch:A,rebuildNavbar:y,syncNavbarThemeUI:P,syncThemeDotGroup:u}}a(Xp,"createNavbarController");(function(){"use strict";try{let t=typeof navigator<"u"&&navigator.userAgent||"";if(/Android|iPhone|iPad|iPod|Mobile/i.test(t)){document.documentElement&&document.documentElement.classList.add("urppp-mobile");let e=document.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",e.content="width=device-width, initial-scale=1",(document.head||document.documentElement||document).appendChild(e))}}catch{}let n="1.9.5";if(/^id\./i.test(String(location.hostname||""))){try{let t=yo({GM:{getValue:typeof GM_getValue=="function"?GM_getValue:null,setValue:typeof GM_setValue=="function"?GM_setValue:null,xmlHttp:typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:null,addStyle:typeof GM_addStyle=="function"?GM_addStyle:null},doc:document,hostInfo:{version:n},uiDeps:{openSubpanel:a(()=>{},"openSubpanel")}}),e=a(()=>{try{t.bootFromCache("assist")}catch{}},"boot");document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}catch{}return}let i={mainRaw:"https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/urppp.user.js",assistRaw:"https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/urpppp.user.js",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",changelogPage:"https://github.com/chaolan2019/SCU-URP-plusplus/blob/main/CHANGELOG.md",greasySearch:"https://greasyfork.org/zh-CN/scripts?q=SCU+URP%2B%2B",versionJson:"version.json",sourceUrls:a(t=>[`https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/${t}`,`https://cdn.jsdelivr.net/gh/chaolan2019/SCU-URP-plusplus@main/${t}`,`https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/${t}`],"sourceUrls")},l="urppp_auto_update_check_v1",d="urppp_skin_v1",u=[{id:"apple",name:"类Apple风格",desc:"系统灰底、链接蓝、大圆角与轻阴影，默认精修方向。",ready:!0,dark:!0,dynamic:!0,installed:!0,builtin:!0,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"editorial",name:"编辑杂志",desc:"衬线标题、无框版面与淡分割线。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!0,builtin:!0,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"flat",name:"极简扁平",desc:"无阴影、硬边与纯色层次，冷硬清晰。",ready:!0,dark:!0,dynamic:!0,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"organic",name:"自然有机",desc:"奶油底与大地色，温暖圆角。不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"brutal",name:"新野兽派",desc:"高对比画布、粗边框与硬阴影。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,palettes:!0,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"neu",name:"新拟物",desc:"同色双阴影凸起/内凹，立体柔和。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}}],k=GM_addStyle(`
  ...
  `;function A(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(A,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function g(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let p=A("");p.style.minHeight="0",p.style.padding="0",r.parentElement&&r.parentElement.replaceChild(p,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=A("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(g,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{g(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let v="urppp_theme_v3",q="urppp_accent_v1",C="urppp_accent_presets_v1",f="urppp_scheme_v1",m="urppp_theme_follow_system_v1",w="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",z="urppp_follow_use_dynamic_v1",$="urppp_brutal_palette_v1",T="urppp_brutal_active_palette_v1",j="urppp_privacy_v1",I="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",pt=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],bt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:xt,syncThemeDotGroup:Z}=Xp({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:bt,applyTheme:Gt,buildSchemePreview:Zt,getAccent:Xt,getBrutalActivePalette:Do,getBrutalPaletteById:dr,getBrutalSelectedPalette:Fo,getCurrent:Vt,getScheme:Fe,getSkin:te,isThemeModeAvailable:cr,setBrutalPalette:jo,skinSupportsDark:je,skinSupportsDynamic:Oe,skinSupportsFixedPalettes:Bo},settings:{ensureSettingsPanel:bn,openSettingsPanel:dn,syncSettingsPanelUI:jt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),p=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let O=document.createElement("li");O.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",O.appendChild(o),r.appendChild(O)}let c=o.closest("li")||o.parentElement,h=Array.from(r.children).find(O=>{let R=O.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),b=Array.from(r.children).find(O=>O.classList.contains("light-blue")),_=h||b||null;_&&c&&_!==c&&((c.compareDocumentPosition(_)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(c,_)),c&&!c.classList.contains("urppp-search-item")&&c.classList.add("urppp-search-item");let M=c;p?(p.removeAttribute("onclick"),p.setAttribute("role","button"),p.setAttribute("aria-label","搜索功能")):(p=document.createElement("button"),p.type="button",p.id="clickdiv",p.setAttribute("aria-label","搜索功能"),p.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(p)),p.style.setProperty("left","8px","important"),p.style.setProperty("position","relative","important"),p.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),M&&s.parentElement!==M&&M.appendChild(s),M&&M.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let N=s.querySelector("#search-input"),L=s.querySelector("form");if(!N||!L)return;L.style.setProperty("display","block","important"),L.style.setProperty("margin","0","important"),L.style.setProperty("padding","10px","important");let D=s.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),N.style.setProperty("display","block","important"),N.style.setProperty("width","100%","important"),N.style.setProperty("height","36px","important"),N.style.setProperty("box-sizing","border-box","important"),N.style.setProperty("padding","0 12px","important"),N.style.setProperty("border","1px solid var(--border)","important"),N.style.setProperty("border-radius","var(--radius-sm)","important"),N.style.setProperty("background","var(--input-bg)","important"),N.style.setProperty("color","var(--text)","important");let J=a(O=>{s.dataset.open=O?"1":"0",s.style.setProperty("width",O?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",O?"1":"0","important"),s.style.setProperty("pointer-events",O?"auto":"none","important"),p.setAttribute("aria-expanded",O?"true":"false"),O&&setTimeout(()=>N.focus(),30)},"setOpen");p.__urpppSearchBound||(p.__urpppSearchBound=!0,p.addEventListener("click",O=>{O.preventDefault(),O.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",O=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(O.target)||F?.contains(O.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function At(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(At,"ensureBootLoader");function kt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(kt,"hideBootLoader");try{At()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{kt()}catch{}},2500));let Pt={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function B(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),p=Math.min(t,e,r),s=0,c=0,h=(o+p)/2;if(o!==p){let b=o-p;switch(c=h>.5?b/(2-o-p):b/(o+p),o){case t:s=(e-r)/b+(e<r?6:0);break;case e:s=(r-t)/b+2;break;default:s=(t-e)/b+4;break}s/=6}return{h:s*360,s:c,l:h}}a(B,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,p=o*(1-Math.abs(t/60%2-1)),s=r-o/2,c=0,h=0,b=0;return t<60?(c=o,h=p):t<120?(c=p,h=o):t<180?(h=o,b=p):t<240?(h=p,b=o):t<300?(c=p,b=o):(c=o,b=p),{r:Math.round((c+s)*255),g:Math.round((h+s)*255),b:Math.round((b+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:p,b:s}=Y(t,e,r);return Sr(o,p,s)}a(tt,"hslHex");function ft(t){let{r:e,g:r,b:o}=or(Jt(t)||bt),p=B(e,r,o);return p.s<.12&&(p.s=.18),p}a(ft,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,p=Math.max(0,Math.min(.95,e));return tt(t,p,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function vt(t,e){let r=Jt(t)||bt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Ft("#FFFFFF",r,o)}a(vt,"tintFromHex");function Dt(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Dt,"companionHue");function Lt(t){let e=Jt(t)||bt,{h:r,s:o}=ft(e),p=Dt(r),s=Math.min(.72,Math.max(.28,o*.78));return ht(p,s,42)}a(Lt,"companionColor");function Nt(t,e){let r=Jt(t)||bt,{h:o,s:p}=ft(r),c=zt(e||ot),h=Math.min(.92,Math.max(.35,p*c.chroma)),b=Lt(r),{h:_}=ft(b),M=ht(o,h,c.primaryTone),N=ht(o,h,Math.max(24,c.primaryTone-10)),L=Ft("#FFFFFF",r,.18),D,J,O;c.whiteCard?(D=Ft("#F1F5F9",Ft("#FFFFFF",r,.08),.5),J="#FFFFFF",O="#E5E7EB"):c.duo?(D=Ft(vt(b,c.bgSeed+.04),"#EEF1F4",.1),J=Ft(vt(r,c.surfaceSeed),"#FFFFFF",.1),O=Ft("#E5E7EB",b,.16)):(D=Ft(vt(r,c.bgSeed),"#E8EBEF",.12),J=Ft(vt(r,c.surfaceSeed),"#FFFFFF",.12),O=Ft("#E5E7EB",r,Math.max(.08,c.borderSeed*.7)));let R=c.whiteCard?"#F8FAFC":Ft(J,vt(c.duo?b:r,Math.max(.05,(c.surfaceSeed||.1)*.55)),.35),F=ht(o,Math.min(.45,h*.55),14),K=Ae(ht(o,h*.3,34),.88),ut=Ae(ht(o,h*.22,46),.76),wt=Ae(M,.18),Ct="0 4px 12px "+Ae(M,.1)+", 0 1px 2px "+Ae(M,.05);return{"--bg":D,"--surface":J,"--text":F,"--text-secondary":K,"--text-muted":ut,"--border":O,"--border-focus":M,"--input-bg":R,"--primary":M,"--primary-hover":N,"--ring":wt,"--shadow":Ct,"--radius":"18px","--radius-sm":"12px","--primary-container":L,"--secondary":b}}a(Nt,"buildMaterialSchemeVars");function Zt(t,e){let r=Nt(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Zt,"buildSchemePreview");function Be(t){let e=Jt(t)||Xt()||bt;return X.map(r=>Object.assign({},r,Zt(e,r.id)))}a(Be,"listSchemePreviews");function he(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(he,"clearInlinePrimaryOverrides");function Xt(){return Jt(GM_getValue(q,""))||""}a(Xt,"getAccent");function Fe(){let t=String(GM_getValue(f,ot)||ot);return X.some(e=>e.id===t)?t:ot}a(Fe,"getScheme");function ga(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(f,e),e}a(ga,"setScheme");function Kp(t,e){if(!t)return;let r=Jt(t);if(r){if(GM_setValue(q,r),e&&e.scheme&&ga(e.scheme),e&&e.skipTheme){let o=lo(r,.15),p=Ae(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",p);try{xt()}catch{}try{jt()}catch{}return}Gt("scu-red");try{xt()}catch{}try{jt()}catch{}}}a(Kp,"applyAccent");function xa(){try{let t=GM_getValue(C,"");if(!t)return pt.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):pt.slice()}catch{return pt.slice()}}a(xa,"getAccentPresets");function Zp(t){let e=Jt(t||Xt()||bt);if(!e)return xa();let r=xa();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(Zp,"saveAccentPreset");function Kt(){try{return!!GM_getValue(m,!1)}catch{return!1}}a(Kt,"isThemeFollowSystem");function Mr(t){return GM_setValue(m,!!t),!!t}a(Mr,"setThemeFollowSystem");function ya(){try{return!!GM_getValue(w,!1)}catch{return!1}}a(ya,"isCleanDefault");function ts(t){return GM_setValue(w,!!t),!!t}a(ts,"setCleanDefault");function va(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(va,"isCleanAnalysisDirect");function es(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(es,"setCleanAnalysis");function _e(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(_e,"isAppleEdgeLine");function rs(t){return GM_setValue(E,!!t),!!t}a(rs,"setAppleEdgeLine");function wa(){try{return!!GM_getValue(l,!1)}catch{return!1}}a(wa,"isAutoUpdateCheck");function as(t){return GM_setValue(l,!!t),!!t}a(as,"setAutoUpdateCheck");function $r(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a($r,"readJsonSetting");function Ir(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(Ir,"writeJsonSetting");function Ee(){return vo($r(j,null))}a(Ee,"getPrivacySettings");function ka(t){return Ir(j,vo(t))}a(ka,"setPrivacySettings");function De(){return qr($r(I,null))}a(De,"getCustomIdentity");function qo(t){return Ir(I,qr(t))}a(qo,"setCustomIdentity");function Aa(){let t=$r(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(Aa,"getScheduleFirstMondayMap");function To(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=Aa();r[String(t)]=String(e),Ir(H,r)}a(To,"rememberScheduleFirstMonday");function Nr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=$r(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},p={enabled:!!o.enabled,mapping:Ne(o.mapping||Pr)};return et="",p}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:Ne(Pr)}}}a(Nr,"getScheduleJsonFormatSettings");function Mo(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:Ne(e.mapping||Pr)};return et="",Ir(G,r)}a(Mo,"setScheduleJsonFormatSettings");function $o(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a($o,"isHomePage");function Br(){try{return!!GM_getValue(z,!1)}catch{return!1}}a(Br,"isFollowUseDynamic");function Sa(t){return GM_setValue(z,!!t),!!t}a(Sa,"setFollowUseDynamic");function os(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(os,"systemPrefersDark");function fe(){return os()&&je()?"dark":Br()&&Oe()?"scu-red":"default"}a(fe,"resolveFollowThemeName");function cr(t,e){return t==="dark"?je(e):t==="scu-red"?Oe(e):t==="default"}a(cr,"isThemeModeAvailable");function Gt(t,e){e=e||{},!je()&&Kt()&&Mr(!1),!Oe()&&Br()&&Sa(!1),e.manual&&Mr(!1);let r;e.system||Kt()&&!e.manual?r=fe():(r=Pt[t]?t:Vt()||"default",Pt[r]||(r="default")),cr(r)||(r="default");let o=Pt[r]||Pt.default;e.skipPersist||GM_setValue(v,r),he();let p=document.getElementById("urppp-theme-vars")||(()=>{let _=document.createElement("style");return _.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(_),_})(),s=Xt(),c=Object.assign({},o.vars);if(r==="scu-red"){let _=s||bt,M=Fe();c=Object.assign(c,Nt(_,M));let N=c["--primary"]||_,L=c["--primary-hover"]||lo(N,.12);document.documentElement.style.setProperty("--urppp-accent",N),document.documentElement.style.setProperty("--urppp-accent-hover",L),document.documentElement.style.setProperty("--urppp-accent-ring",c["--ring"]||Ae(N,.15)),document.documentElement.style.setProperty("--urppp-seed",_),document.documentElement.style.setProperty("--urppp-scheme",M)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let h=":root {";for(let[_,M]of Object.entries(c))h+=`${_}:${M};`;h+="}",p.textContent=h,document.body&&(document.body.style.fontFamily=o.font);try{let _=document.documentElement;_.dataset.urpppTheme=r,_.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),_.classList.add("urppp-theme-"+r),_.classList.toggle("urppp-theme-follow",Kt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Kt()))}catch{}try{re()}catch{}try{xt()}catch{}try{jt()}catch{}try{rn()}catch{}try{bs()}catch{}let b=document.getElementById("urppp-boot-loader");b&&(b.style.fontFamily=o.font)}a(Gt,"applyTheme");function Vt(){return GM_getValue(v,"default")}a(Vt,"getCurrent");function ge(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(ge,"themeDownloaded");function xe(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(xe,"localThemes");function Io(t,e){try{let r=xe();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Io,"saveLocalTheme");function ns(t){try{let e=xe();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(ns,"removeLocalTheme");function is(){try{if(typeof GM_listValues!="function")return;let t=xe(),e=!1;GM_listValues().forEach(r=>{let o=/^urppp_theme_css_(.+)$/.exec(r);if(!o)return;let p=o[1];u.some(s=>s.id===p)||t[p]||(t[p]={name:p,desc:"下载主题",author:"",version:"1.0.0"},e=!0)}),e&&GM_setValue("urppp_local_themes",JSON.stringify(t))}catch{}}a(is,"migrateDownloadedThemes");function _a(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(_a,"storeThemeStyleEl");function ps(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(ps,"removeStoreThemeStyle");function No(){is();let t=new Set,e=a(r=>{if(t.has(r))return;t.add(r);let o="";try{o=GM_getValue("urppp_theme_css_"+r,"")||""}catch{}o&&(_a(r).textContent=o);let p="";try{p=GM_getValue("urppp_card_css_"+r,"")||""}catch{}p&&Ce([{id:r,cardCss:p}])},"injectOne");u.forEach(r=>e(r.id)),Object.keys(xe()).forEach(r=>e(r));try{re()}catch{}}a(No,"injectAllStoreThemeStyles");function te(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||ge(e.id))||xe()[t]&&ge(t)?t:"apple"}a(te,"getSkin");function Ea(t,e){let r=t||te(),o=u.find(p=>p.id===r);return!!(o&&o[e])}a(Ea,"getSkinCapability");function je(t){return Ea(t,"dark")}a(je,"skinSupportsDark");function Oe(t){return Ea(t,"dynamic")}a(Oe,"skinSupportsDynamic");function Bo(t){return Ea(t,"palettes")}a(Bo,"skinSupportsFixedPalettes");function dr(t){return Q.find(e=>e.id===t)||Q[0]}a(dr,"getBrutalPaletteById");function Fo(){let t=String(GM_getValue($,"acid")||"acid"),e=dr(t);return e.id===V?dr("acid"):e}a(Fo,"getBrutalSelectedPalette");function Do(){let t=String(GM_getValue(T,V)||V);return dr(t)}a(Do,"getBrutalActivePalette");function jo(t,e){let r=e||{},o=dr(t);r.select&&o.id!==V&&GM_setValue($,o.id),GM_setValue(T,o.id);try{re()}catch{}try{xt()}catch{}try{jt()}catch{}try{let p=document.getElementById("urppp-clean-root");p&&typeof p.__syncCleanThemeDots=="function"&&p.__syncCleanThemeDots()}catch{}}a(jo,"setBrutalPalette");function ss(t){let e=t||te();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&_e()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&_e()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(ss,"getSkinShapeOverrides");function He(){try{let t=te();if(t==="apple")return _e()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(He,"urpppCardBorderValue");function re(){let t=te();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&_e();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=ss(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=Do();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=_e(),c=s?"1px solid rgba(0,0,0,0.08)":"none",h=s?"1px solid rgba(255,255,255,0.10)":"none",b=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+c+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+h+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+c+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+b+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let p=document.head||document.documentElement;e.parentNode===p&&p.lastElementChild!==e&&p.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Qt(document)}catch{}},0)}a(re,"applySkinAttr");function Oo(t){let e=u.find(p=>p.id===t&&p.ready&&(p.installed!==!1||ge(p.id))),r=!e&&xe()[t]&&ge(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||Sa(!1),!o.dark&&Kt()&&Mr(!1);let p=Kt(),s=p?fe():Vt(),c=cr(s,e.id)?s:"default";re(),Gt(c,{system:p})}catch{try{re()}catch{}}try{jt()}catch{}try{xt()}catch{}try{let p=document.getElementById("urppp-clean-root");p&&typeof p.__syncCleanThemeDots=="function"&&p.__syncCleanThemeDots()}catch{}return!0}a(Oo,"setSkin");function ls(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Kt())try{Gt(fe(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(ls,"bindSystemThemeListener");try{Kt()?Gt(fe(),{system:!0}):Gt(Vt())}catch{}try{re()}catch{}try{ls()}catch{}function cs(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let p=e.match(o);if(p)return p[0].trim()}return""}a(cs,"extractLoginErrorMessage");function Ho(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(Ho,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=cs(e),p=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),c=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let h=location.pathname==="/loginEn",b=a((R,F)=>h?F:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      <div class="uc">
    ...
    </div>`);let _=e.querySelector("#urppp-root");[["#urppp-user","#input_username"],["#urppp-pass","#input_password"],["#urppp-cap","#input_checkcode"]].forEach(([R,F])=>{let K=_.querySelector(R),ut=document.querySelector(F);K&&ut&&(ut.value&&(K.value=ut.value),K.addEventListener("input",()=>{ut.value=K.value}))});let M=_.querySelector("#urppp-capimg"),N=_.querySelector("#urppp-capwrap"),L=document.querySelector(".form-signin img");if(M&&L){M.src=L.src;let R=a(()=>{let F=L.src.replace(/\?.*/,"")+"?"+Date.now();L.src=F,M.src=F},"refreshCap");N?N.addEventListener("click",R):M.addEventListener("click",R)}_.querySelectorAll(".ut button").forEach(R=>{R.addEventListener("click",()=>{if(R.dataset.mode==="sso"){location.href=c;return}_.querySelectorAll(".ut button").forEach(ut=>ut.classList.remove("ac")),R.classList.add("ac");let F=_.querySelector("#urppp-form"),K=_.querySelector("#urppp-sso");F&&(F.style.display="block"),K&&(K.style.display="none")})});let D=_.querySelector("#urppp-submit");D.addEventListener("click",()=>{if(D.dataset.submitting==="1")return;D.dataset.submitting="1",D.disabled=!0;let R=document.getElementById("loginButton");R?R.click():typeof r.requestSubmit=="function"?r.requestSubmit():r.submit(),setTimeout(()=>{D.dataset.submitting="0",D.disabled=!1},1500)}),_.querySelectorAll(".ui").forEach(R=>{R.addEventListener("keydown",F=>{F.key==="Enter"&&D.click()})}),_.querySelector("#urppp-forgot").addEventListener("click",R=>{R.preventDefault(),p&&p.click()});let J=_.querySelector("#urppp-dots"),O=a(()=>{if(!J)return;let R=Vt();J.querySelectorAll("span").forEach(K=>{K.classList.toggle("ac",K.dataset.theme===R)});let F=J.querySelector('span[data-theme="scu-red"]');if(F){let K=Xt()||bt;try{let ut=Zt(K,Fe());F.style.background="linear-gradient(135deg, "+ut.primary+" 0 55%, "+ut.surface+" 55% 100%)"}catch{F.style.background=K}}},"syncLoginDots");J&&(J.querySelectorAll("span").forEach(R=>{R.addEventListener("click",()=>{Gt(R.dataset.theme,{manual:!0}),O()})}),O()),console.log("[URP++] 登录界面已重建"),setTimeout(()=>{document.body.classList.add("urppp-ready"),kt()},100)}a(Ho,"rebuild");let{beautifyBreadcrumbs:Fr}=Yp({});function Ca(){try{document.querySelectorAll(".profile-user-info, .profile-user-info-striped").forEach(t=>{if(t.classList.contains("setLabelWidth")||t.classList.contains("urppp-query-form")||t.querySelector(".urppp-query-pair"))return;let e=Array.from(t.querySelectorAll(":scope > .profile-info-row, .profile-info-row"));!e.length||e.some(o=>Array.from(o.children).filter(p=>p.classList&&p.classList.contains("profile-info-name")).length>=2)||(t.classList.remove("urppp-query-form"),t.style.setProperty("width","100%","important"),t.style.setProperty("max-width","100%","important"),t.style.setProperty("display","block","important"),Or(t),e.forEach(o=>{o.classList.remove("urppp-query-row","urppp-dual-pair"),delete o.dataset.urpppQueryDone,delete o.dataset.urpppQueryCols;let p=Array.from(o.querySelectorAll(":scope > .urppp-query-pair"));if(p.length){let s=[];for(p.forEach(c=>Array.from(c.children).forEach(h=>s.push(h)));o.firstChild;)o.removeChild(o.firstChild);s.forEach(c=>o.appendChild(c))}o.style.setProperty("display","grid","important"),o.style.setProperty("grid-template-columns","140px minmax(0,1fr)","important"),o.style.setProperty("align-items","stretch","important"),o.style.setProperty("width","100%","important"),Array.from(o.children).forEach(s=>{s.classList&&(s.style.setProperty("float","none","important"),s.style.setProperty("margin-left","0","important"),s.style.setProperty("width","auto","important"),s.style.setProperty("max-width","none","important"),s.style.setProperty("display","flex","important"),s.style.setProperty("align-items","center","important"),s.style.setProperty("box-sizing","border-box","important"))})}))})}catch(t){console.warn("[URP++] single pair profile fix failed",t)}}a(Ca,"fixSinglePairProfileForms");function Dr(){let t=document.querySelector(".page-content")||document.getElementById("page-content-template");t&&(t.querySelectorAll(".col-xs-4, .col-xs-8, .col-sm-4, .col-sm-8, .col-md-4, .col-md-8").forEach(e=>{if(!e.querySelector(".setLabelWidth"))return;let r=e.querySelector(".setLabelWidth");r&&(e.querySelectorAll("h4.header, h3.header, .header.smaller, .header").forEach(o=>{r.contains(o)||o.compareDocumentPosition(r)&Node.DOCUMENT_POSITION_FOLLOWING&&(o.classList.add("urppp-section-label"),["background","background-color","background-image","border","box-shadow","border-radius","padding","margin","min-height"].forEach(p=>{o.style.removeProperty(p)}),o.style.setProperty("background","transparent","important"),o.style.setProperty("background-color","transparent","important"),o.style.setProperty("background-image","none","important"),o.style.setProperty("border","0 none transparent","important"),o.style.setProperty("box-shadow","none","important"),o.style.setProperty("border-radius","0","important"),o.style.setProperty("padding","4px 2px 10px","important"),o.style.setProperty("margin","0 0 8px 0","important"),o.style.setProperty("min-height","0","important"))}),r.classList.remove("urppp-query-form"),r.style.setProperty("padding","0","important"),r.style.setProperty("overflow","hidden","important"),r.style.setProperty("background","var(--surface)","important"),r.style.setProperty("border",He(),"important"),r.style.setProperty("border-radius","12px","important"),r.style.setProperty("box-shadow","none","important"))}),t.querySelectorAll(".profile-user-info.setLabelWidth, .profile-user-info-striped.setLabelWidth").forEach(e=>{e.classList.remove("urppp-query-form"),e.querySelectorAll(".profile-info-row").forEach(r=>{r.classList.remove("urppp-query-row"),delete r.dataset.urpppQueryDone,delete r.dataset.urpppQueryCols;let o=Array.from(r.querySelectorAll(":scope > .urppp-query-pair"));if(o.length){let p=[];for(o.forEach(s=>{Array.from(s.children).forEach(c=>p.push(c))});r.firstChild;)r.removeChild(r.firstChild);p.forEach(s=>r.appendChild(s))}})}),t.querySelectorAll(".setLabelWidth .profile-info-row, .profile-user-info.setLabelWidth .profile-info-row, .profile-user-info-striped.setLabelWidth .profile-info-row").forEach(e=>{let r=Array.from(e.querySelectorAll(":scope > .urppp-query-pair"));if(r.length){let s=[];for(r.forEach(c=>{Array.from(c.children).forEach(h=>s.push(h))});e.firstChild;)e.removeChild(e.firstChild);s.forEach(c=>e.appendChild(c))}e.classList.remove("urppp-query-row"),delete e.dataset.urpppQueryDone,delete e.dataset.urpppQueryCols;let o=Array.from(e.children).filter(s=>s.classList&&(s.classList.contains("profile-info-name")||s.classList.contains("profile-info-value")));o.filter(s=>s.classList.contains("profile-info-name")).length>=2?(e.classList.add("urppp-dual-pair"),e.style.setProperty("display","grid","important"),e.style.setProperty("grid-template-columns","112px minmax(140px,1fr) 112px minmax(140px,1fr)","important"),e.style.setProperty("align-items","stretch","important"),e.style.setProperty("width","100%","important"),e.style.setProperty("max-width","100%","important"),e.style.setProperty("float","none","important"),o.forEach(s=>{s.style.setProperty("float","none","important"),s.style.setProperty("clear","none","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("margin-left","0","important"),s.style.setProperty("width","auto","important"),s.style.setProperty("max-width","none","important"),s.style.setProperty("min-width","0","important"),s.style.setProperty("box-sizing","border-box","important"),s.style.setProperty("display","flex","important"),s.style.setProperty("align-items","center","important"),s.classList.contains("profile-info-value")?(s.style.removeProperty("width"),s.style.setProperty("width","auto","important"),s.style.setProperty("justify-content","flex-start","important"),s.style.setProperty("white-space","normal","important"),s.style.setProperty("word-break","normal","important")):(s.style.setProperty("justify-content","flex-end","important"),s.style.setProperty("white-space","nowrap","important"))})):e.classList.remove("urppp-dual-pair")}),t.querySelectorAll(".profile-user-info.setLabelWidth, .profile-user-info-striped.setLabelWidth").forEach(e=>{e.classList.remove("urppp-query-form"),e.style.cssText=(e.getAttribute("style")||"").replace(/padding\s*:[^;]+;?/gi,""),e.style.setProperty("background","var(--surface)","important"),e.style.setProperty("border-radius","12px","important"),e.style.setProperty("overflow","hidden","important"),e.style.setProperty("border",He(),"important"),e.style.setProperty("box-shadow","none","important"),e.style.setProperty("width","100%","important"),e.style.setProperty("max-width","100%","important"),e.style.setProperty("box-sizing","border-box","important"),e.style.setProperty("margin","0 0 16px 0","important"),e.style.setProperty("padding","0","important");let r=e.closest(".col-xs-4, .col-xs-8, .col-sm-4, .col-sm-8, .col-md-4, .col-md-8")||e.parentElement;r&&Array.from(r.querySelectorAll("h4.header, h3.header, .header.smaller")).forEach(o=>{e.contains(o)||o.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_FOLLOWING&&(o.classList.add("urppp-section-label"),o.style.setProperty("background","transparent","important"),o.style.setProperty("background-color","transparent","important"),o.style.setProperty("background-image","none","important"),o.style.setProperty("border","0 none transparent","important"),o.style.setProperty("box-shadow","none","important"),o.style.setProperty("border-radius","0","important"),o.style.setProperty("padding","4px 2px 10px","important"),o.style.setProperty("margin","0 0 8px 0","important"),o.style.setProperty("min-height","0","important"))})}),t.querySelectorAll(".urppp-col-row").forEach(e=>{e.classList.remove("urppp-col-row"),["display","flex-wrap","gap","align-items","width","box-sizing"].forEach(r=>e.style.removeProperty(r))}),t.querySelectorAll('[class*="col-xs-"], [class*="col-sm-"], [class*="col-md-"], [class*="col-lg-"]').forEach(e=>{["float","flex","width","max-width","padding-left","padding-right","box-sizing"].forEach(r=>{e.style.getPropertyPriority(r)==="important"&&e.style.removeProperty(r)}),e.style.setProperty("padding-left","0","important"),e.style.setProperty("box-sizing","border-box","important")}),t.querySelectorAll(".col-xs-4, .col-sm-4, .col-md-4").forEach(e=>{e.style.setProperty("padding-right","16px","important")}),t.querySelectorAll(".col-xs-8, .col-sm-8, .col-md-8").forEach(e=>{e.style.setProperty("padding-left","0","important"),e.style.setProperty("padding-right","0","important")}),t.querySelectorAll(".col-xs-4, .col-xs-8, .col-sm-4, .col-sm-8, .col-md-4, .col-md-8").forEach(e=>{e.querySelector(".setLabelWidth")&&e.querySelectorAll(":scope > h4.header, :scope > .header, :scope > .header.smaller").forEach(r=>{r.style.cssText+=";background:transparent!important;background-color:transparent!important;border:none!important;box-shadow:none!important;border-radius:0!important;padding:4px 2px 10px!important;margin:0 0 8px 0!important;min-height:0!important;"})}),t.querySelectorAll(".urppp-section-title-wrap").forEach(e=>{let r=e.querySelector("h4.header, h3.header, h5.header, .header.smaller");if(!r){e.remove();return}let o=e.nextElementSibling;for(;o&&!o.querySelector?.('.col-xs-4, .col-sm-4, .col-md-4, [class*="col-xs-"], [class*="col-sm-"]');)o=o.nextElementSibling;let p=o&&(o.querySelector(".col-xs-4, .col-sm-4, .col-md-4")||Array.from(o.children).find(s=>/col-(?:xs|sm|md|lg)-([1-9]|1[01])\b/.test(s.className||"")));p&&(p.insertBefore(r,p.firstChild),delete r.dataset.urpppHoisted,r.style.removeProperty("width"),r.style.removeProperty("max-width"),r.style.removeProperty("margin-left"),r.style.removeProperty("margin-right"),r.style.removeProperty("box-sizing"),r.style.removeProperty("position"),r.style.removeProperty("left")),e.remove()}))}a(Dr,"alignRollInfoLayout");function jr(){let t=typeof unsafeWindow<"u"?unsafeWindow:window;return t.jQuery||t.$||window.jQuery||window.$||null}a(jr,"pageJQuery");function ds(t){return t?t.id&&String(t.id).indexOf("pagination_pageSize_")===0?!0:!!(t.closest&&t.closest('#urppagebar, .urppagebreak, .dataTables_paginate, [id^="sample-table-2_paginate_"]')):!1}a(ds,"isPagebarSelect");function Ro(t){if(t){try{let e=jr();e&&e.fn&&e(t).data("chosen")&&e(t).chosen("destroy")}catch{}try{if(t.parentElement&&t.parentElement.querySelectorAll(":scope > .chosen-container").forEach(e=>{try{e.remove()}catch{}}),t.nextElementSibling&&t.nextElementSibling.classList.contains("chosen-container"))try{t.nextElementSibling.remove()}catch{}}catch{}t.classList.remove("urppp-chosen-hidden","chzn-done","chosen");try{delete t.dataset.urpppChosen}catch{}t.style.setProperty("display","inline-block","important")}}a(Ro,"destroyPagebarChosen");let Uo=0,Wo=!1;function us(){if(Wo)return;Wo=!0;let t=a(e=>{if(Date.now()<Uo){try{e.preventDefault()}catch{}try{e.stopPropagation()}catch{}}},"guard");document.addEventListener("mousedown",t,!0),document.addEventListener("mouseup",t,!0),document.addEventListener("click",t,!0)}a(us,"bindChosenPickGuard");function Pa(t){if(!t||t.__urpppChosenNoPierce)return;t.__urpppChosenNoPierce=!0,us();let e=t.querySelector(".chosen-drop"),r=a(o=>{let p=o.target;!p||!p.closest||!p.closest(".chosen-results li")||(Uo=Date.now()+350)},"onPick");t.addEventListener("mouseup",r,!1),t.addEventListener("touchend",r,!1),e&&(e.addEventListener("mouseup",r,!1),e.addEventListener("touchend",r,!1))}a(Pa,"bindChosenNoPierce");function La(t=document){try{t.querySelectorAll(".chosen-container").forEach(Pa)}catch{}}a(La,"bindAllChosenNoPierce");function ye(){try{let t=jr();if(!t||!t.fn||typeof t.fn.chosen!="function")return!1;let e=document.querySelectorAll(".profile-user-info, .urppp-query-form, .profile-info-row, form"),r=new Set,o=[];if(e.forEach(p=>{p.querySelectorAll("select").forEach(s=>{r.has(s)||(r.add(s),o.push(s))})}),document.querySelectorAll("select.value_element, .profile-info-value > select").forEach(p=>{r.has(p)||(r.add(p),o.push(p))}),o.forEach(p=>{if(!p||p.multiple||p.disabled||p.size&&p.size>1)return;if(ds(p)){Ro(p);return}let s=t(p);if(!!s.data("chosen")||p.classList.contains("chzn-done")||!!(p.nextElementSibling&&p.nextElementSibling.classList.contains("chosen-container"))||!!(p.parentElement&&p.parentElement.querySelector(":scope > .chosen-container"))){p.dataset.urpppChosen="1",p.classList.add("urppp-chosen-hidden"),p.style.setProperty("display","none","important");let h=p.nextElementSibling&&p.nextElementSibling.classList.contains("chosen-container")?p.nextElementSibling:p.parentElement&&p.parentElement.querySelector(":scope > .chosen-container");h&&Pa(h);return}try{p.classList.contains("select")||p.classList.add("select");try{s.data("chosen")&&s.chosen("destroy")}catch{}s.chosen({allow_single_deselect:!0,search_contains:!0,width:"100%",no_results_text:"无匹配项",disable_search_threshold:0}),p.dataset.urpppChosen="1",p.classList.add("urppp-chosen-hidden"),p.style.setProperty("display","none","important");let h=p.nextElementSibling&&p.nextElementSibling.classList.contains("chosen-container")?p.nextElementSibling:p.parentElement&&p.parentElement.querySelector(".chosen-container");h&&(h.style.setProperty("width","100%","important"),h.style.setProperty("min-width","0","important"),h.style.setProperty("display","block","important")),h&&Pa(h)}catch(h){console.warn("[URP++] chosen init failed",p,h)}}),!window.__urpppChosenHtmlPatch){window.__urpppChosenHtmlPatch=!0;let p=t.fn.html;t.fn.html=function(){let s=p.apply(this,arguments);if(arguments.length)try{this.filter("select").add(this.find("select")).each(function(){let c=t(this);if(c.data("chosen")||c.next(".chosen-container").length)try{c.trigger("chosen:updated")}catch{}})}catch{}return s}}return!0}catch(t){return console.warn("[URP++] ensureQueryChosen failed",t),!1}}a(ye,"ensureQueryChosen");function Go(){if(window.__urpppChosenScheduleBound)return;window.__urpppChosenScheduleBound=!0,[0,200,600,1500,3e3].forEach(o=>setTimeout(()=>{ye(),La()},o));let e=0,r=setInterval(()=>{e+=1;let o=ye();La(),(o&&e>3||e>15)&&clearInterval(r)},500)}a(Go,"scheduleEnsureQueryChosen");let{beautifyPagebar:Jo}=np({destroyPagebarChosen:Ro}),{scheduleBeautifyPagebar:Vo}=op({beautifyPagebar:Jo});function za(){try{document.querySelectorAll("#drag-ul, ul#drag-ul").forEach(t=>{if(!t)return;let e=Array.from(t.children).filter(r=>r.tagName==="LI");if(!e.length){t.classList.add("urppp-empty"),t.style.setProperty("display","none","important");let r=t.closest("#xq-section, .widget-main, .widget-body");r&&!r.querySelector("li")&&(r.classList.add("urppp-empty"),r.style.setProperty("display","none","important"));return}t.classList.remove("urppp-empty"),t.classList.add("urppp-drag-ul"),t.style.removeProperty("display"),t.style.setProperty("height","auto","important"),t.style.setProperty("min-height","0","important"),e.forEach(r=>{let o=(r.textContent||"").replace(/\s+/g," ").trim(),p=(r.getAttribute("onclick")||"").includes("goDetail")||r.classList.contains("ui-selectee")||r.classList.contains("jc-future")||!!r.querySelector("a");!p&&/校区/.test(o)&&o.length<=12?(r.classList.add("xq-section"),r.classList.remove("ui-selectee","jc-future","urppp-building-active")):p&&!r.classList.contains("jc-future")&&r.classList.add("ui-selectee")})}),window.__urpppBuildingActiveBound||(window.__urpppBuildingActiveBound=!0,document.addEventListener("click",t=>{let e=t.target&&t.target.closest?t.target.closest("#drag-ul > li"):null;if(!e||e.classList.contains("xq-section")||e.classList.contains("jc-future"))return;let r=e.parentElement;r&&(r.querySelectorAll("li.urppp-building-active, li.ui-selected").forEach(o=>{o.classList.remove("urppp-building-active","ui-selected")}),e.classList.add("urppp-building-active","ui-selected"))},!0))}catch(t){console.warn("[URP++] free classroom list beautify failed",t)}}a(za,"beautifyFreeClassroomList");function Or(t){if(!t||!t.style)return;if(t.classList.contains("setLabelWidth")){t.classList.remove("urppp-query-form"),t.style.setProperty("width","100%","important"),t.style.setProperty("max-width","100%","important"),t.style.setProperty("box-sizing","border-box","important"),t.style.setProperty("float","none","important"),t.style.setProperty("display","block","important"),t.style.setProperty("background","var(--surface)","important"),t.style.setProperty("border",He(),"important"),t.style.setProperty("border-radius","12px","important"),t.style.setProperty("box-shadow","none","important"),t.style.setProperty("margin","0 0 16px 0","important"),t.style.setProperty("padding","0","important"),t.style.setProperty("overflow","hidden","important");return}let e=!!(t.closest&&t.closest(".widget-box, .widget-main, .widget-body, .panel"));t.style.setProperty("width","100%","important"),t.style.setProperty("max-width","100%","important"),t.style.setProperty("min-width","0","important"),t.style.setProperty("box-sizing","border-box","important"),t.style.setProperty("float","none","important"),t.style.setProperty("display","block","important"),t.style.setProperty("clear","both","important");let r=t.parentElement&&t.parentElement.tagName==="FORM"?t.parentElement:null;r&&(r.style.setProperty("width","100%","important"),r.style.setProperty("max-width","100%","important"),r.style.setProperty("display","block","important"),r.style.setProperty("float","none","important"),r.style.setProperty("box-sizing","border-box","important"),r.style.setProperty("margin","0","important"));let o=t.closest&&t.closest(".tab-pane, .tab-content");if(o&&(o.style.setProperty("width","100%","important"),o.style.setProperty("max-width","100%","important"),o.style.setProperty("box-sizing","border-box","important")),e){t.style.setProperty("background","transparent","important"),t.style.setProperty("border","none","important"),t.style.setProperty("border-radius","0","important"),t.style.setProperty("padding","0","important"),t.style.setProperty("margin","0","important"),t.style.setProperty("box-shadow","none","important");return}t.style.setProperty("background","var(--surface)","important"),t.style.setProperty("border",He(),"important"),t.style.setProperty("border-radius","12px","important"),t.style.setProperty("box-shadow","none","important"),t.style.setProperty("margin","0 0 18px 0","important"),!t.classList.contains("setLabelWidth")&&(t.classList.contains("urppp-query-form")||!!t.querySelector(".urppp-query-pair, .chosen-container"))?(t.style.setProperty("padding","14px 16px","important"),t.style.setProperty("overflow","visible","important")):(t.style.setProperty("padding","0","important"),t.style.setProperty("overflow","hidden","important"))}a(Or,"ensureProfileCardShell");function ur(){try{ye(),document.querySelectorAll(".page-content .profile-user-info, #page-content-template .profile-user-info").forEach(o=>{Or(o)});let t=a(o=>{let p=o.closest(".profile-user-info, .urppp-query-form")||o.parentElement;if(!p)return Math.min(Math.max(o.querySelectorAll(":scope > .urppp-query-pair").length,1),4);let s=0;return p.querySelectorAll(":scope > .profile-info-row, .profile-info-row").forEach(c=>{let h=c.querySelectorAll(":scope > .urppp-query-pair").length;h>s&&(s=h)}),Math.min(Math.max(s,1),4)},"getFormQueryCols"),e=a(o=>{let p=Array.from(o.querySelectorAll(":scope > .urppp-query-pair")),s=t(o);o.classList.add("urppp-query-row"),o.style.setProperty("display","grid","important"),o.style.removeProperty("grid-template-columns"),o.style.setProperty("column-gap","14px","important"),o.style.setProperty("row-gap","10px","important"),o.style.setProperty("align-items","center","important"),o.style.setProperty("width","100%","important"),o.style.setProperty("max-width","100%","important"),o.style.setProperty("box-sizing","border-box","important"),o.dataset.urpppQueryCols=String(s),p.forEach(c=>{c.style.removeProperty("grid-column")}),p.forEach(c=>{c.style.setProperty("display","flex","important"),c.style.setProperty("align-items","center","important"),c.style.setProperty("width","100%","important"),c.style.setProperty("min-width","0","important"),c.style.setProperty("max-width","100%","important"),c.style.setProperty("box-sizing","border-box","important"),c.style.removeProperty("flex");let h=c.querySelector(".profile-info-name"),b=c.querySelector(".profile-info-value");h&&(h.style.setProperty("float","none","important"),h.style.setProperty("display","flex","important"),h.style.setProperty("align-items","center","important"),h.style.setProperty("justify-content","flex-end","important"),h.style.setProperty("flex","0 0 var(--urppp-qlabel, 84px)","important"),h.style.setProperty("width","var(--urppp-qlabel, 84px)","important"),h.style.setProperty("min-width","var(--urppp-qlabel, 84px)","important"),h.style.setProperty("max-width","var(--urppp-qlabel-max, 96px)","important"),h.style.setProperty("margin","0","important"),h.style.setProperty("margin-left","0","important"),h.style.setProperty("padding","0 8px 0 0","important"),h.style.setProperty("background","transparent","important"),h.style.setProperty("border","none","important"),h.style.setProperty("border-right","none","important")),b&&(b.style.setProperty("float","none","important"),b.style.setProperty("display","flex","important"),b.style.setProperty("align-items","center","important"),b.style.setProperty("flex","1 1 auto","important"),b.style.setProperty("width","auto","important"),b.style.setProperty("min-width","0","important"),b.style.setProperty("max-width","none","important"),b.style.setProperty("margin","0","important"),b.style.setProperty("margin-left","0","important"),b.style.setProperty("padding","0","important"),b.style.setProperty("background","transparent","important"),b.style.setProperty("border","none","important"),b.querySelectorAll("input, select, .chosen-container, .form-control").forEach(_=>{_.style.setProperty("width","100%","important"),_.style.setProperty("min-width","0","important"),_.style.setProperty("max-width","none","important")})),c.querySelectorAll(".chosen-container").forEach(_=>{let M=_.previousElementSibling;M&&M.tagName==="SELECT"&&(M.style.setProperty("display","none","important"),M.classList.add("urppp-chosen-hidden"));let N=_.parentElement&&_.parentElement.querySelector("select");N&&(N.style.setProperty("display","none","important"),N.classList.add("urppp-chosen-hidden")),_.style.setProperty("width","100%","important"),_.style.setProperty("min-width","0","important"),_.style.setProperty("max-width","none","important");let L=_.querySelector(".chosen-single");if(L){L.style.setProperty("width","100%","important"),L.style.setProperty("max-width","none","important"),L.style.setProperty("display","flex","important"),L.style.setProperty("align-items","center","important"),L.style.setProperty("height","34px","important"),L.style.setProperty("line-height","normal","important");let D=L.querySelector(":scope > span, span");D&&(D.style.setProperty("line-height","normal","important"),D.style.setProperty("height","auto","important"),D.style.setProperty("margin-top","0","important"),D.style.setProperty("padding-top","0","important"));let J=L.querySelector("div");if(J){J.style.setProperty("display","flex","important"),J.style.setProperty("align-items","center","important"),J.style.setProperty("justify-content","center","important"),J.style.setProperty("top","0","important"),J.style.setProperty("bottom","0","important"),J.style.setProperty("height","auto","important");let O=J.querySelector("b");O&&(O.style.setProperty("margin","0","important"),O.style.setProperty("background-position","center center","important"),O.style.setProperty("background-size","12px 12px","important"),O.style.setProperty("width","14px","important"),O.style.setProperty("height","14px","important"))}}})})},"applyRowLayout");document.querySelectorAll(".profile-user-info.self, .profile-user-info-striped.self, .profile-user-info:has(.value_element)").forEach(o=>{if(o.classList.contains("setLabelWidth")||o.closest&&o.closest("#curriculumInfo-divcon, #curriculumInfo-divcon1, #curriculumInfo-divcon2, #fajh, #xnxq, #kz, #kc, #kcfa"))return;let p=Array.from(o.querySelectorAll(".profile-info-row")).some(c=>Array.from(c.children).filter(h=>h.classList&&h.classList.contains("profile-info-name")).length>=2),s=!!o.querySelector("select.chosen, select.select, .chosen-container");if(!p&&!s){o.classList.remove("urppp-query-form");return}o.querySelector('select, input:not([type="hidden"]), .chosen-container, .value_element, textarea')&&(o.classList.add("urppp-query-form"),Or(o),o.querySelectorAll(".profile-info-row").forEach(c=>{if(c.dataset.urpppQueryDone==="1"){c.querySelector(":scope > .urppp-query-pair")&&e(c);return}let h=Array.from(c.children).filter(N=>N.classList&&(N.classList.contains("profile-info-name")||N.classList.contains("profile-info-value"))),b=[];for(let N=0;N<h.length;){let L=h[N],D=h[N+1];L&&D&&L.classList.contains("profile-info-name")&&D.classList.contains("profile-info-value")?(b.push([L,D]),N+=2):N+=1}if(!b.length){c.dataset.urpppQueryDone="1";return}let _=document.createDocumentFragment(),M=new Set;for(b.forEach(([N,L])=>{let D=document.createElement("div");D.className="urppp-query-pair",D.appendChild(N),D.appendChild(L),M.add(N),M.add(L),_.appendChild(D)}),h.forEach(N=>{M.has(N)||_.appendChild(N)});c.firstChild;)c.removeChild(c.firstChild);c.appendChild(_),c.dataset.urpppQueryDone="1",e(c)}))}),ye()}catch(t){console.warn("[URP++] query form beautify failed",t)}}a(ur,"beautifyQueryForms");function Yo(){if(window.__urpppChosenAlignBound)return;window.__urpppChosenAlignBound=!0;let t=!1,e=a(r=>{if(!t){t=!0;try{let o=r&&r.querySelectorAll?r:document,p=document.getElementById("urppp-chosen-li-style");p||(p=document.createElement("style"),p.id="urppp-chosen-li-style",document.documentElement.appendChild(p)),p.textContent=[".self div.profile-info-value a.chosen-single > span,","body .self div.profile-info-value a.chosen-single > span {","  line-height: normal !important;","  height: auto !important;","  margin-top: 0 !important;","  padding-top: 0 !important;","}",".self div.profile-info-value a.chosen-single,","body .self div.profile-info-value a.chosen-single {","  display: flex !important;","  align-items: center !important;","  height: 34px !important;","  line-height: normal !important;","}","body .chosen-container .chosen-results li,","body .chosen-with-drop .chosen-results li,","html body .chosen-container .chosen-results li.active-result {","  display:flex !important;","  align-items:center !important;","  justify-content:flex-start !important;","  height:36px !important;","  min-height:36px !important;","  max-height:36px !important;","  line-height:1 !important;","  padding:0 12px !important;","  margin:0 !important;","  box-sizing:border-box !important;","}","body .chosen-container .chosen-results li.highlighted,","body .chosen-container .chosen-results li.result-selected {","  display:flex !important;","  align-items:center !important;","  height:36px !important;","  line-height:1 !important;","  padding:0 12px !important;","}"].join(""),o.querySelectorAll(".chosen-results li").forEach(s=>{s.style.cssText=["display:flex !important","align-items:center !important","justify-content:flex-start !important","height:36px !important","min-height:36px !important","max-height:36px !important","line-height:1 !important","padding:0 12px !important","margin:0 !important","box-sizing:border-box !important"].join(";")}),o.querySelectorAll("a.chosen-single").forEach(s=>{s.style.setProperty("display","flex","important"),s.style.setProperty("align-items","center","important"),s.style.setProperty("height","34px","important"),s.style.setProperty("min-height","34px","important"),s.style.setProperty("line-height","normal","important"),s.style.setProperty("padding-top","0","important"),s.style.setProperty("padding-bottom","0","important");let c=s.querySelector(":scope > span");c&&(c.style.setProperty("line-height","normal","important"),c.style.setProperty("height","auto","important"),c.style.setProperty("margin-top","0","important"),c.style.setProperty("margin-bottom","0","important"),c.style.setProperty("padding-top","0","important"),c.style.setProperty("padding-bottom","0","important"))}),o.querySelectorAll(".chosen-search").forEach(s=>{if(!s.querySelector(".urppp-chosen-search-icon")){let c=document.createElement("i");c.className="fa fa-search urppp-chosen-search-icon",c.setAttribute("aria-hidden","true"),s.appendChild(c)}})}finally{setTimeout(()=>{t=!1},0)}}},"apply");document.addEventListener("mousedown",r=>{let o=r.target&&r.target.closest?r.target.closest(".chosen-container"):null;o&&(setTimeout(()=>e(o),0),setTimeout(()=>e(o),30),setTimeout(()=>e(o),100),setTimeout(()=>e(o),200))},!0);try{let r=window.jQuery||window.$;r&&r.fn&&r(document).off("chosen:showing_dropdown.urppp chosen:updated.urppp").on("chosen:showing_dropdown.urppp chosen:updated.urppp",o=>{let p=o.target&&o.target.parentElement?o.target.parentElement:document;setTimeout(()=>e(p),0),setTimeout(()=>e(p),60)})}catch{}}a(Yo,"patchChosenDropdownAlign");function qa(){try{let t=document.getElementById("work_rest_schedule_modal");if(!t)return;(t.classList.contains("in")||t.classList.contains("show"))&&t.style.setProperty("display","block","important");let e=t.querySelector(".modal-body")||t,r=Array.from(e.querySelectorAll("table"));if(!r.length)return;let o=a(c=>(c||"").replace(/\s+/g," ").trim(),"norm"),p=a(c=>String(c??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),"esc");if(e.dataset.urpppWrsDone==="1")return;e.dataset.urpppWrsDone="1",r.forEach(c=>{let h=c.closest(".urppp-table-wrap");h&&t.contains(h)&&h.parentElement&&(h.parentElement.insertBefore(c,h),h.remove()),c.classList.add("urppp-wrs-table"),c.style.setProperty("width","100%","important");let b=Array.from(c.rows||[]);if(!b.length)return;let _=0;b.forEach(M=>{let N=o(M.textContent);if(!/\d{1,2}:\d{2}/.test(N))return;let L=0;Array.from(M.cells||[]).forEach(D=>{L+=D.colSpan||1}),L>_&&(_=L)}),_<4&&b.forEach(M=>{let N=0;Array.from(M.cells||[]).forEach(L=>{N+=L.colSpan||1}),N>_&&(_=N)}),_<1&&(_=1),Array.from(c.rows||[]).forEach(M=>{let N=Array.from(M.cells||[]);if(!N.length)return;let L=o(M.textContent);if(!/\d{1,2}:\d{2}/.test(L)&&(/作息时间|学年/.test(L)||/(望江|华西|江安)/.test(L)&&/校区|时间|安排|作息/.test(L))){let O=L;M.className="urppp-wrs-title-row",M.innerHTML='<td class="urppp-wrs-title" colspan="'+_+'" align="center">'+p(O)+"</td>";return}N.forEach(O=>{["border","borderTop","borderRight","borderBottom","borderLeft","textAlign","verticalAlign","width"].forEach(F=>{try{O.style[F]=""}catch{}}),O.classList.remove("urppp-wrs-title","urppp-wrs-period","urppp-wrs-time","urppp-wrs-head");let R=o(O.textContent);R&&(/^(上午|下午|晚上|中午)$/.test(R)||(O.rowSpan||1)>1&&/上午|下午|晚上|中午/.test(R)?O.classList.add("urppp-wrs-period"):/节次|大节|时间|校区/.test(R)&&!/\d{1,2}:\d{2}/.test(R)&&!/第\d/.test(R)?/节次|时间|大节|校区/.test(L)&&!/\d{1,2}:\d{2}/.test(L)&&O.classList.add("urppp-wrs-head"):/\d{1,2}:\d{2}/.test(R)&&O.classList.add("urppp-wrs-time"),O.style.setProperty("text-align","center","important"),O.style.setProperty("vertical-align","middle","important"))})})});let s=t.querySelector(".modal-title");s&&(s.style.setProperty("text-align","center","important"),s.style.setProperty("width","100%","important")),e.dataset.urpppWrsDone="1"}catch{}}a(qa,"beautifyWorkRestSchedule");let Qo="https://jwc.scu.edu.cn/cdxl.htm";function Ta(){let t=['a[onclick*="jwc.scu.edu.cn/article/206"]','a[href*="jwc.scu.edu.cn/article/206"]',".cdsj a",".ace-nav a"],e=new Set;t.forEach(r=>{document.querySelectorAll(r).forEach(o=>{if(e.has(o))return;e.add(o);let p=(o.textContent||"").replace(/\s+/g,""),s=o.getAttribute("onclick")||"",c=o.getAttribute("href")||"";(p.includes("学校校历")||s.includes("article/206")||c.includes("article/206")||s.includes("jwc.scu.edu.cn")&&p.includes("校历"))&&(o.setAttribute("href",Qo),o.setAttribute("target","_blank"),o.setAttribute("rel","noopener noreferrer"),o.setAttribute("onclick",`window.open('${Qo}');return false;`))})})}a(Ta,"patchSchoolCalendarLink");function Hr(){document.querySelectorAll("#navbar-example, .page-content .navbar.navbar-static, #page-content-template .navbar.navbar-static").forEach(t=>{if(!t.querySelector(".nav-tabs"))return;["background","background-color","background-image","border","border-radius","box-shadow"].forEach(o=>{t.style.setProperty(o,o.startsWith("background")||o==="box-shadow"?o==="box-shadow"?"none":"transparent":o==="border"?"none":"0","important")}),t.style.setProperty("background","transparent","important"),t.style.setProperty("background-color","transparent","important"),t.style.setProperty("border","none","important"),t.style.setProperty("border-radius","0","important"),t.style.setProperty("box-shadow","none","important"),t.style.setProperty("width","100%","important"),t.style.setProperty("margin","0 0 14px 0","important"),t.style.setProperty("padding","0","important"),t.style.setProperty("min-height","0","important"),t.style.setProperty("box-sizing","border-box","important");let e=t.querySelector(".navbar-inner");e&&(e.style.setProperty("background","transparent","important"),e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important"),e.style.setProperty("padding","0","important"),e.style.setProperty("min-height","0","important"),e.style.setProperty("filter","none","important"),e.style.setProperty("width","100%","important")),t.querySelectorAll(".container, .container-fluid").forEach(o=>{o.style.setProperty("width","100%","important"),o.style.setProperty("max-width","100%","important"),o.style.setProperty("margin","0","important"),o.style.setProperty("margin-left","0","important"),o.style.setProperty("padding","0","important"),o.style.setProperty("background","transparent","important"),o.style.setProperty("box-sizing","border-box","important")});let r=t.querySelector(".nav-tabs");r&&(r.style.setProperty("width","100%","important"),r.style.setProperty("margin","0","important"),r.style.setProperty("padding","8px 10px","important"),r.style.setProperty("background","var(--surface)","important"),r.style.setProperty("background-color","var(--surface)","important"),r.style.setProperty("border",He(),"important"),r.style.setProperty("border-radius","12px","important"),r.style.setProperty("box-sizing","border-box","important"))})}a(Hr,"patchAceTabNavbars");function Re(){let t=a(e=>{let r=NaN,o=[e.getAttribute("data-percent"),e.querySelector("[data-percent]")?.getAttribute("data-percent"),e.querySelector(".percent")?.textContent,e.querySelector(".urppp-pct-text")?.textContent];for(let p of o){if(p==null||p==="")continue;let s=parseFloat(String(p).replace(/[^\d.]/g,""));if(!Number.isNaN(s)){r=s;break}}if(Number.isNaN(r)){let p=(e.textContent||"").match(/(\d+(?:\.\d+)?)\s*%/);p&&(r=parseFloat(p[1]))}if(Number.isNaN(r)){let p=e.querySelector('.progress-bar, .infobox-progress [style*="width"], .urppp-pct-fill');if(p){let s=String(p.style.width||"").match(/([\d.]+)%/);s&&(r=parseFloat(s[1]))}}return Number.isNaN(r)?null:Math.max(0,Math.min(100,r))},"readPct");document.querySelectorAll(".infobox").forEach(e=>{let r=t(e);if(r==null)return;e.querySelectorAll("canvas").forEach(c=>c.remove()),e.querySelectorAll(".easy-pie-chart, .percentage, .infobox-progress").forEach(c=>{c.classList.contains("urppp-pct-bar")||c.remove()}),e.querySelectorAll(".urppp-pct-text, .urppp-pct-bar").forEach(c=>c.remove());let o=e.querySelector(".infobox-data")||e,p=document.createElement("div");p.className="urppp-pct-text",p.textContent=Math.round(r)+"%";let s=document.createElement("div");if(s.className="urppp-pct-bar"+(r<=0?" is-empty":""),r>0){let c=document.createElement("span");c.className="urppp-pct-fill",c.style.width=r+"%",s.appendChild(c)}o.insertBefore(s,o.firstChild),o.insertBefore(p,o.firstChild),e.dataset.urpppPctDone="1"})}a(Re,"restyleInfoboxPercentages");function mr(t){let e=document.getElementById("treeDemo");if(!e)return;let r=!!(t&&t.force);if(e.dataset.urpppBusy==="1"&&!(t&&t.ignoreBusy))return;let o=e.closest('div[style*="border"]')||e.closest("#tree_div")?.parentElement||e.parentElement;o&&o.classList.add("urppp-plan-tree-shell"),e.classList.add("urppp-ztree");let p=typeof unsafeWindow<"u"?unsafeWindow:window,s=a(()=>{try{return(p.jQuery||p.$||window.jQuery||window.$)?.fn?.zTree?.getZTreeObj?.("treeDemo")||null}catch{return null}},"getZTree"),c=a(()=>{let R=Array.from(e.querySelectorAll('span.button.switch[class*="_open"]')).filter(F=>!/_docu\b/.test(F.className));return R.reverse().forEach(F=>{try{F.click()}catch{}}),R.length>0},"collapseAllDom"),h=a(()=>{let R=s();if(R)try{R.expandAll(!1)}catch{}return e.querySelector('span.button.switch[class*="_open"]:not([class*="_docu"])')&&c(),!0},"collapseAll");if(!window.__urpppExpandKzPatched){window.__urpppExpandKzPatched=!0;let R=a(()=>{let F=typeof unsafeWindow<"u"?unsafeWindow:window;try{F.expandKzByRule=function(){e.dataset.urpppUserExpanded||h()}}catch{}},"patch");R(),setTimeout(R,0),setTimeout(R,200)}e.dataset.urpppCollapsedOnce||(e.dataset.urpppCollapsedOnce="1",[0,80,200,500,1e3].forEach(R=>setTimeout(()=>{e.dataset.urpppUserExpanded||h()},R)));let b=document.querySelector("#two h4.header, #two .header");if(b&&!b.dataset.urpppLegendDone){let R=b.querySelector("font");if(R){let F=document.createElement("div");F.className="urppp-plan-legend",F.innerHTML=['<span class="urppp-lg done"><i class="ace-icon fa fa-check-square-o"></i>已完成课组</span>','<span class="urppp-lg todo"><i class="ace-icon fa fa-folder-o"></i>尚未完成课组</span>','<span class="urppp-lg pass"><i class="ace-icon fa fa-smile-o"></i>已修读及格</span>','<span class="urppp-lg fail"><i class="ace-icon fa fa-frown-o"></i>已修读未及格</span>','<span class="urppp-lg pending"><i class="ace-icon fa fa-meh-o"></i>尚未修读</span>'].join(""),R.replaceWith(F)}b.classList.add("urppp-plan-header"),b.dataset.urpppLegendDone="1"}let _=a(()=>{if(e.dataset.urpppBusy="1",window.__urpppPlanTreeObs)try{window.__urpppPlanTreeObs.disconnect()}catch{}},"pauseObs"),M=a(()=>{e.dataset.urpppBusy="0";let R=document.getElementById("tree_div")||e;if(window.__urpppPlanTreeObs&&R)try{window.__urpppPlanTreeObs.observe(R,{childList:!0,subtree:!0})}catch{}},"resumeObs"),N=a(R=>{let F=R;return F=F.replace(/\((最低修读学分:[^)]+)\)/g,(K,ut)=>{let wt=ut.split(",").map(Tt=>Tt.trim()).filter(Boolean),Ct=[];return wt.forEach(Tt=>{/最低修读学分|通过学分|必修课未修读|已及格课程门数/.test(Tt)&&Ct.push(Tt)}),`<span class="urppp-sub">${(Ct.length?Ct:wt).map(Tt=>{let Ht=Tt.match(/^([^:：]+)[:：]\s*(.+)$/);if(!Ht)return Tt;let Rt=Ht[1].trim(),$t=Ht[2].trim(),oe="neutral";return/通过|已及格/.test(Rt)?oe="ok":/未修读|未及格/.test(Rt)?oe=Number($t)>0?"warn":"muted":/最低/.test(Rt)&&(oe="req"),`<span class="urppp-kv ${oe}"><em>${Rt}</em><b>${$t}</b></span>`}).join("")}</span>`}),F=F.replace(/\[(\d{6,})\]/g,'<span class="urppp-code">$1</span>'),F=F.replace(/\[(\d+(?:\.\d+)?学分(?:,[^\]\[]*)?)\]/g,'<span class="urppp-meta">$1</span>'),F=F.replace(/\((必修|任选|限选),((?:[^()]|\([^()]*\))*)\)/g,(K,ut,wt)=>{let Ct=String(wt).trim(),qt=Ct.match(/^(.+?)(?:\((\d{6,8})\))?$/),Tt=(qt?qt[1]:Ct).trim(),Ht=qt&&qt[2]?qt[2]:"",Rt=parseFloat(Tt),$t=!1;Number.isNaN(Rt)?/不及格|未通过|不通过/.test(Tt)?$t=!1:(/^(?:[A-D][+]?|优秀|良好|中等|及格|通过)/.test(Tt),$t=!0):$t=Rt>=60;let oe=Ht?`<i>${Ht}</i>`:"";return`<span class="urppp-score ${$t?"pass":"fail"}"><b>${ut}</b><em>${Tt}</em>${oe}</span>`}),F=F.replace(/(<span class="urppp-code">[^<]*<\/span>)\s*([^<]+?)(?=\s*(?:<span class="urppp-meta"|<span class="urppp-score"|$))/g,'$1<span class="urppp-title">$2</span>'),F=F.replace(/(<\/i>)(?:&nbsp;|\s)*([^<]+?)(?=<span class="urppp-sub")/g,'$1 <span class="urppp-gname">$2</span>'),F=F.replace(/(<\/i>)(?:&nbsp;|\s)+(?=<span class="urppp-gname")/g,"$1 "),F},"formatNodeHtml"),L=a(R=>{let F=R.querySelector("i.fa, i.ace-icon"),K=R.closest("li");K&&(K.classList.remove("urppp-node-done","urppp-node-todo","urppp-node-pass","urppp-node-fail","urppp-node-pending"),F&&(F.classList.contains("fa-check-square-o")?K.classList.add("urppp-node-done"):F.classList.contains("fa-smile-o")?K.classList.add("urppp-node-pass"):F.classList.contains("fa-frown-o")?K.classList.add("urppp-node-fail"):F.classList.contains("fa-meh-o")?K.classList.add("urppp-node-pending"):F.classList.contains("fa-kz")&&K.classList.add("urppp-node-todo")))},"markStatus"),D=a(R=>{if(!R||!r&&R.dataset.urpppNodeDone==="1")return!1;L(R);let F=R.querySelector("span.node_name")||R;if(!F)return!1;if(!r&&F.querySelector(".urppp-score, .urppp-code, .urppp-sub, .urppp-title, .urppp-gname"))R.dataset.urpppNodeDone="1";else{let ut=F.dataset.urpppRaw;ut||(F.querySelector(".urppp-score, .urppp-code, .urppp-sub")?(R.dataset.urpppNodeDone="1",ut=null):(ut=F.innerHTML,ut&&(F.dataset.urpppRaw=ut))),ut&&(F.innerHTML=N(ut),R.dataset.urpppNodeDone="1")}let K=R.parentElement&&R.parentElement.querySelector(":scope > span.button.switch");return K&&(K.dataset.urpppSw||(K.dataset.urpppSw="1",/_docu\b/.test(K.className)&&(K.classList.add("urppp-switch-leaf"),K.style.setProperty("display","none","important"))),/_docu\b/.test(K.className)||K.classList.contains("urppp-switch-leaf")?R.classList.remove("urppp-expandable"):R.classList.add("urppp-expandable")),!0},"paintOne"),J=a((R,F)=>{let K=Array.from(R||[]),ut=0,wt=a(()=>{let Ct=Math.min(ut+48,K.length);for(;ut<Ct;ut++)D(K[ut]);ut<K.length?window.requestIdleCallback?requestIdleCallback(wt,{timeout:120}):setTimeout(wt,0):F&&F()},"step");wt()},"paintList"),O=a(R=>{let F=R||e;F.querySelectorAll("span.button.switch:not([data-urppp-sw])").forEach(K=>{K.dataset.urpppSw="1",/_docu\b/.test(K.className)&&(K.classList.add("urppp-switch-leaf"),K.style.setProperty("display","none","important"))}),F.querySelectorAll("li > a").forEach(K=>D(K))},"paintScopeSync");_();try{O(e),e.dataset.urpppExpandClick||(e.dataset.urpppExpandClick="1",e.addEventListener("click",F=>{if(F.target.closest&&F.target.closest("span.button.switch")){let qt=F.target.closest("span.button.switch"),Tt=qt&&qt.parentElement;if(!Tt||/_docu\b/.test(qt.className))return;if(e.dataset.urpppUserExpanded="1",e.dataset.urpppBusy="1",window.__urpppPlanTreeObs)try{window.__urpppPlanTreeObs.disconnect()}catch{}setTimeout(()=>{O(Tt),e.dataset.urpppBusy="0";let Ht=document.getElementById("tree_div")||e;if(window.__urpppPlanTreeObs&&Ht)try{window.__urpppPlanTreeObs.observe(Ht,{childList:!0,subtree:!0})}catch{}},0);return}let K=F.target&&F.target.closest?F.target.closest("li > a"):null;if(!K||!e.contains(K))return;let ut=K.parentElement;if(!ut)return;let wt=ut.querySelector(":scope > span.button.switch");if(!wt||/_docu\b/.test(wt.className)||wt.classList.contains("urppp-switch-leaf")||!K.classList.contains("urppp-expandable")&&!/_open|_close/.test(wt.className))return;if(F.preventDefault(),F.stopImmediatePropagation(),e.dataset.urpppUserExpanded="1",e.dataset.urpppBusy="1",window.__urpppPlanTreeObs)try{window.__urpppPlanTreeObs.disconnect()}catch{}wt.click(),O(ut),e.dataset.urpppBusy="0";let Ct=document.getElementById("tree_div")||e;if(window.__urpppPlanTreeObs&&Ct)try{window.__urpppPlanTreeObs.observe(Ct,{childList:!0,subtree:!0})}catch{}},!0));let R=a((F,K)=>{let ut=document.getElementById(F);return!ut||ut.dataset.urpppBound==="1"?!1:(ut.dataset.urpppBound="1",ut.addEventListener("click",wt=>{wt.preventDefault(),wt.stopImmediatePropagation(),e.dataset.urpppUserExpanded="1",_();try{let Ct=s();if(K){Ct?Ct.expandAll(!0):e.querySelectorAll('span.button.switch[class*="_close"]').forEach(Tt=>{/_docu\b/.test(Tt.className)||Tt.click()});let qt=e.querySelectorAll('li > a:not([data-urppp-node-done="1"])');J(qt,M)}else{if(Ct)try{Ct.expandAll(!1)}catch{}c(),setTimeout(()=>{e.querySelector('span.button.switch[class*="_open"]:not([class*="docu"])')&&c(),M()},0)}}catch{K||c(),M()}},!0),!0)},"bindAll");R("expandAllBtn",!0),R("collapseAllBtn",!1),e.dataset.urpppAllBtnsRetry||(e.dataset.urpppAllBtnsRetry="1",setTimeout(()=>{R("expandAllBtn",!0),R("collapseAllBtn",!1)},300),setTimeout(()=>{R("expandAllBtn",!0),R("collapseAllBtn",!1)},1e3))}finally{requestAnimationFrame(()=>{requestAnimationFrame(M)})}}a(mr,"beautifyPlanTree");function br(){if(!be())try{let t=document.getElementById("soliderbox");if(t){t.style.setProperty("width","100%","important"),t.style.setProperty("max-width","720px","important"),t.style.setProperty("min-width","0","important"),t.classList.remove("container");let p=t.closest(".profile-info-row");p&&(p.style.setProperty("display","flex","important"),p.style.setProperty("align-items","center","important"),p.style.setProperty("width","100%","important"),p.style.setProperty("max-width","100%","important"));let s=t.closest(".profile-info-value");s&&(s.style.setProperty("width","auto","important"),s.style.setProperty("max-width","100%","important"),s.style.setProperty("flex","1 1 auto","important"),s.style.setProperty("min-width","0","important"))}let e=document.getElementById("mycoursetable");if(!e)return;let r=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches);e.classList.toggle("urppp-mobile-schedule-scroll",r),e.style.setProperty("position","relative","important"),e.style.setProperty("width","100%","important");let o=72;r||e.querySelectorAll("#courseTableBody tr, table tbody tr").forEach(p=>{let s=p.offsetHeight||0;s>o&&(o=s)}),o<56&&(o=72),e.querySelectorAll("div.class_div").forEach(p=>{let s=parseInt(p.getAttribute("classNum")||"1",10)||1,c=p.scrollHeight||0;if(c>0){let h=Math.ceil(c/s);o=r?Math.max(o,Math.min(h,88)):Math.max(o,h)}}),r?o=Math.min(Math.max(o,72),88):(o<64&&(o=72),o>160&&(o=120)),e.querySelectorAll("#courseTableBody tr, table tbody tr").forEach(p=>{p.style.setProperty("height",o+"px","important")}),e.querySelectorAll("td").forEach(p=>{let s=Array.from(p.querySelectorAll(":scope > div.class_div"));if(!s.length)return;p.style.setProperty("position","relative","important"),p.style.setProperty("vertical-align","top","important"),p.style.setProperty("overflow","visible","important");let c=p.getBoundingClientRect().width||p.offsetWidth||p.clientWidth||0,h=getComputedStyle(p),b=p.closest("table"),_=b?getComputedStyle(b):null,M=parseFloat(h.borderLeftWidth)||0,N=_&&_.borderCollapse==="collapse"?M/2:M,L=Math.max(1,s.length);s.forEach((D,J)=>{let O=parseInt(D.getAttribute("classNum")||"1",10)||1,R=Ii(c,L,J,N),F=R.left,K=R.width;D.style.setProperty("position","absolute","important"),D.style.setProperty("top","0px","important"),D.style.setProperty("left",F+"px","important"),D.style.setProperty("right","auto","important"),D.style.setProperty("bottom","auto","important"),D.style.setProperty("transform","none","important"),D.style.setProperty("width",K+"px","important"),D.style.setProperty("max-width","none","important"),D.style.setProperty("height",o*O+"px","important"),D.style.setProperty("margin","0","important"),D.style.setProperty("box-sizing","border-box","important"),D.style.setProperty("z-index","2","important"),D.style.setProperty("overflow","hidden","important")})})}catch(t){console.warn("[URP++] week schedule fix failed",t)}}a(br,"fixWeekScheduleLayout");function Ma(){try{let t=typeof unsafeWindow<"u"?unsafeWindow:window;if(!t||t.__urpppDivBuildPatched||typeof t.divBuild!="function")return;t.__urpppDivBuildPatched=!0;let e=t.divBuild;t.__urpppOriginalDivBuild=e,t.divBuild=function(){try{br()}catch{try{return e.apply(this,arguments)}catch{}}};try{t.divBuild._urppp=!0}catch{}}catch(t){console.warn("[URP++] patch divBuild failed",t)}}a(Ma,"patchSiteDivBuild");let Ue=null,Xo=!1;function Ko(){let t=document.getElementById("mycoursetable")||document.getElementById("page-content-template")||document.body;if(Ue&&Ue.root===t&&t?.isConnected){br();return}Ue&&Ue.disconnect(),Ue=null;let e=!Xo;Xo=!0;let r=!1,o=a(()=>{if(!(r||be())&&!(!document.getElementById("soliderbox")&&!document.getElementById("mycoursetable"))){r=!0;try{Ma(),br()}finally{setTimeout(()=>{r=!1},40)}}},"run");Ma(),[0,50,150,400,1e3,2e3].forEach(c=>setTimeout(()=>{Ma(),o()},c)),e&&window.addEventListener("resize",()=>{clearTimeout(window.__urpppWeekSchedResize),window.__urpppWeekSchedResize=setTimeout(o,120)});let p=a(c=>{if(!c||be())return;let h=[];c.nodeType===1&&(c.matches&&c.matches("div.class_div")&&h.push(c),c.querySelectorAll&&c.querySelectorAll("div.class_div").forEach(b=>h.push(b))),h.forEach(b=>{let _=b.parentElement;_&&_.tagName==="TD"&&_.style.setProperty("position","relative","important"),b.style.setProperty("position","absolute","important"),b.style.setProperty("top","0px","important"),b.style.setProperty("left","0px","important"),b.style.setProperty("right","auto","important"),b.style.setProperty("transform","none","important"),b.style.setProperty("width","100%","important"),b.style.setProperty("margin","0","important"),b.style.setProperty("box-sizing","border-box","important")})},"pinNew"),s=new MutationObserver(c=>{if(be())return;let h=!1;c.forEach(b=>{if(b.type==="childList"&&b.addedNodes.forEach(_=>{p(_),h=!0}),b.type==="attributes"&&b.attributeName==="style"&&b.target&&b.target.classList&&b.target.classList.contains("class_div")){let _=b.target,M=_.style.left||"",N=parseFloat(M);(!M||M==="auto"||Number.isFinite(N)&&N>200)&&(_.style.setProperty("left","0px","important"),_.style.setProperty("top","0px","important"),_.style.setProperty("position","absolute","important")),h=!0}}),h&&(clearTimeout(window.__urpppWeekSchedMut),window.__urpppWeekSchedMut=setTimeout(()=>{requestAnimationFrame(o)},16))});if(t){s.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class"]});let c=null,h=0,b=0;if(t.id==="mycoursetable"&&typeof window.ResizeObserver=="function"){let _=t.getBoundingClientRect().width||0;c=new window.ResizeObserver(M=>{let N=M[0]?.contentRect?.width||t.getBoundingClientRect().width||0;!N||Math.abs(N-_)<.5||(_=N,h||(h=requestAnimationFrame(()=>{h=0,o()})),clearTimeout(b),b=setTimeout(o,80))}),c.observe(t)}Ue={root:t,observer:s,disconnect(){s.disconnect(),c&&c.disconnect(),h&&cancelAnimationFrame(h),clearTimeout(b)}}}e&&document.addEventListener("mouseup",()=>{document.getElementById("soliderbox")&&(setTimeout(o,200),setTimeout(o,500))},!0)}a(Ko,"scheduleWeekScheduleFix");function Zo(){try{let t=document.getElementById("curriculumInfo-divcon2");if(!t)return;let e=parseFloat(t.style.width||getComputedStyle(t).width||"0");if(!e||e<40)return;t.classList.add("urppp-curriculum-drawer");let r=t.querySelector(".modal-body");if(!r)return;let o=r.querySelector(":scope > .col-xs-12 > .row")||r.querySelector(".col-xs-12 > .row")||r.querySelector(".row");if(!o)return;o.classList.add("urppp-drawer-layout");let p=o.querySelector(":scope > .urppp-drawer-toolbar, :scope > p");p&&p.tagName==="P"&&p.classList.add("urppp-drawer-toolbar");let s=o.querySelector(":scope > .urppp-drawer-body"),c=o.querySelector(".urppp-drawer-left"),h=o.querySelector(".urppp-drawer-right");s||(s=document.createElement("div"),s.className="urppp-drawer-body"),c||(c=document.createElement("div"),c.className="urppp-drawer-left"),h||(h=document.createElement("div"),h.className="urppp-drawer-right"),s.contains(c)||s.appendChild(c),s.contains(h)||s.appendChild(h),s.parentElement!==o&&(p&&p.parentElement===o?o.insertBefore(s,p.nextSibling):o.appendChild(s)),p&&o.firstElementChild!==p&&o.insertBefore(p,o.firstElementChild);let b=o.querySelector("#treeDemo, .ztree")||t.querySelector("#treeDemo, .ztree"),_=null;if(b){_=b.closest(".col-xs-6, .col-sm-6, .widget-box")||b.parentElement;let J=b.closest(".col-xs-6, .col-sm-6");J&&(_=J)}let M=["fajh","xnxq","kz","kc","kcfa"],N=M.map(J=>document.getElementById(J)).filter(J=>J&&t.contains(J));_&&_.parentElement!==c&&c.appendChild(_),Array.from(c.children).forEach(J=>{(M.includes(J.id)||J.id&&M.includes(J.id)||J!==_&&J.querySelector&&!J.querySelector("#treeDemo, .ztree")&&J.classList&&J.classList.contains("col-xs-6"))&&h.appendChild(J)}),M.forEach(J=>{let O=document.getElementById(J);!O||!t.contains(O)||(O.parentElement!==h&&h.appendChild(O),O.style.setProperty("width","100%","important"),O.style.setProperty("max-width","100%","important"),O.style.setProperty("float","none","important"),O.style.setProperty("margin","0","important"),O.style.setProperty("padding","0","important"),O.style.setProperty("box-sizing","border-box","important"),O.style.display!=="none"&&getComputedStyle(O).display!=="none"&&O.style.setProperty("display","block","important"))});let L=document.getElementById("fajh");L&&t.contains(L)&&(L.parentElement!==h&&h.appendChild(L),(!L.innerHTML||!L.innerHTML.trim())&&!L.querySelector(".urppp-drawer-skeleton, .profile-user-info, .widget-box")&&(L.innerHTML=["<div class='widget-box transparent urppp-drawer-skeleton'>","  <div class='widget-header widget-header-small'>","    <h4 class='widget-title smaller grey'>方案计划信息</h4>","  </div>","</div>","<div class='self profile-user-info profile-user-info-striped urppp-drawer-skeleton-card'>","  <div class='profile-info-row'><div class='profile-info-name'>加载中</div><div class='profile-info-value'>正在获取方案信息…</div></div>","</div>"].join(""),L.style.setProperty("display","block","important"),L.dataset.urpppSkeleton="1"),L.dataset.urpppSkeleton==="1"&&L.querySelector(".profile-info-value")&&/方案名称|计划名称|年级|院系/.test(L.textContent||"")&&(delete L.dataset.urpppSkeleton,L.querySelectorAll(".urppp-drawer-skeleton, .urppp-drawer-skeleton-card").forEach(O=>O.remove())),L.innerHTML&&L.innerHTML.trim()&&L.style.display==="none"&&(L.dataset.urpppSkeleton==="1"||L.querySelector(".profile-user-info"))&&L.style.setProperty("display","block","important")),h.style.setProperty("min-height","240px","important"),c.style.setProperty("min-height","240px","important"),_&&(_.style.setProperty("width","100%","important"),_.style.setProperty("max-width","100%","important"),_.style.setProperty("float","none","important"),_.style.setProperty("margin","0","important"),_.style.setProperty("padding","0","important"),_.style.setProperty("border","none","important"),_.style.setProperty("box-sizing","border-box","important"));let D=c.querySelector(".widget-box");D&&(D.style.setProperty("width","100%","important"),D.style.setProperty("margin","0","important"),D.style.setProperty("border",He(),"important"),D.style.setProperty("border-radius","12px","important"),D.style.setProperty("overflow","hidden","important"),D.style.setProperty("background","var(--surface)","important")),t.querySelectorAll(".profile-info-row").forEach(J=>{J.classList.remove("urppp-query-row","urppp-dual-pair"),J.style.setProperty("display","grid","important"),J.style.setProperty("grid-template-columns","112px minmax(0,1fr)","important"),J.style.setProperty("width","100%","important"),Array.from(J.children).forEach(O=>{O.classList&&(O.style.setProperty("float","none","important"),O.style.setProperty("margin-left","0","important"),O.style.setProperty("width","auto","important"),O.style.setProperty("max-width","none","important"))})}),t.querySelectorAll(".profile-user-info, .profile-user-info-striped").forEach(J=>{J.classList.remove("urppp-query-form");try{Or(J)}catch{}J.querySelectorAll(".profile-info-value, .profile-info-value span, span.editable").forEach(O=>{O.style.setProperty("color","var(--text)","important"),O.style.setProperty("opacity","1","important"),O.style.setProperty("visibility","visible","important")}),J.style.setProperty("border-radius","12px","important"),J.style.setProperty("overflow","hidden","important"),J.style.setProperty("width","100%","important"),J.style.setProperty("max-width","100%","important"),J.style.setProperty("display","block","important"),J.style.setProperty("box-sizing","border-box","important")})}catch(t){console.warn("[URP++] curriculum drawer beautify failed",t)}}a(Zo,"beautifyCurriculumDrawer");function ms(){if(window.__urpppCurriculumDrawerBound)return;window.__urpppCurriculumDrawerBound=!0;let t=a(()=>Zo(),"run");[0,50,150,350,800,1600].forEach(o=>setTimeout(t,o));let e=new MutationObserver(o=>{o.some(s=>!!(s.type==="childList"||s.type==="attributes"&&s.target&&(s.target.id==="curriculumInfo-divcon2"||s.target.id==="fajh")))&&(clearTimeout(window.__urpppCurriculumDrawerTimer),window.__urpppCurriculumDrawerTimer=setTimeout(()=>requestAnimationFrame(t),16))}),r=document.getElementById("curriculumInfo-divcon2");r&&e.observe(r,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("click",o=>{if(!document.getElementById("curriculumInfo-divcon2"))return;let p=o.target&&o.target.closest?o.target.closest("a,button,span,div"):null,s=(p&&p.textContent||"").replace(/\s+/g,"");(/培养方案|与我相关|方案计划|自动化培养/.test(s)||p&&p.closest&&p.closest("#curriculumInfo-divcon2"))&&(setTimeout(t,0),setTimeout(t,50),setTimeout(t,150),setTimeout(t,400))},!0)}a(ms,"scheduleCurriculumDrawerBeautify");let{scheduleScrubTableInlineBg:tn,scrubTableHeaderInlineBg:bs}=ap({isNativePdfIsolationActive:be}),{disarmNoticeTableHover:hs,pinNoticeRowSurface:en,scrubNoticeInlineBg:rn,stripMistakenNoticeTable:an}=pp({getCurrentTheme:Vt});function $a(){try{let t=document.querySelector("h4.header, h3.header, h4, h3, .breadcrumb, .page-header");return Zi({pathname:location.pathname,href:location.href,title:document.title,headingText:t?.textContent||""})}catch{return!1}}a($a,"isNoticePageContext");function fs(t){return ko(t,{noticePage:$a()})}a(fs,"isNoticeListTable");function Ia(t){return tp(t,{noticePage:$a()})}a(Ia,"isBusinessDataTable");let on,{bindNoticeHoverScrub:gs,scheduleBeautifyNoticeTables:nn}=ip({beautifyNoticeTables:a(t=>on(t),"beautifyNoticeTables"),pinNoticeRowSurface:en});({beautifyNoticeTables:on}=sp({isNativePdfIsolationActive:be,bindNoticeHoverScrub:gs,scrubNoticeInlineBg:rn,stripMistakenNoticeTable:an,disarmNoticeTableHover:hs,pinNoticeRowSurface:en,isBusinessDataTable:Ia,isNoticeListTable:fs,isNoticePageContext:$a,isNoticeBulletText:wo}));let{wrapTables:pn,bindTableWrapObserver:sn}=ep({isNativePdfIsolationActive:be,isBusinessDataTable:Ia});function hr(){try{document.querySelectorAll(".modal").forEach(e=>{if(!e||!e.style)return;e.style.getPropertyPriority("display")==="important"&&e.style.removeProperty("display"),e.classList.contains("in")||e.classList.contains("show")?e.style.display==="none"&&e.style.removeProperty("display"):(e.style.display==="block"||getComputedStyle(e).display!=="none")&&(e.style.setProperty("display","none","important"),setTimeout(()=>{try{!e.classList.contains("in")&&!e.classList.contains("show")&&(e.style.getPropertyPriority("display")==="important"&&e.style.removeProperty("display"),e.style.display="none")}catch{}},0))}),document.querySelector(".modal.in, .modal.show")||(document.querySelectorAll(".modal-backdrop").forEach(e=>{try{e.parentElement&&e.parentElement.removeChild(e)}catch{}}),document.body&&(document.body.classList.remove("modal-open"),document.body.style.removeProperty("padding-right")))}catch{}}a(hr,"cleanupStuckModals");function xs(){if(window.__urpppModalOpenPatched)return;window.__urpppModalOpenPatched=!0;let t=a(s=>{!s||!s.style||(s.style.getPropertyPriority("display")==="important"&&s.style.removeProperty("display"),s.style.getPropertyPriority("opacity")==="important"&&s.style.removeProperty("opacity"),s.style.getPropertyPriority("pointer-events")==="important"&&s.style.removeProperty("pointer-events"),s.style.getPropertyPriority("visibility")==="important"&&s.style.removeProperty("visibility"))},"unlock"),e=a(s=>{if(!(!s||!s.classList))try{s.classList.remove("in","show"),s.setAttribute("aria-hidden","true"),s.style.removeProperty("display"),s.style.setProperty("display","none","important"),setTimeout(()=>{try{!s.classList.contains("in")&&!s.classList.contains("show")&&(s.style.getPropertyPriority("display")==="important"&&s.style.removeProperty("display"),s.style.display="none")}catch{}},30)}catch{}},"forceHide"),r=a(()=>{document.querySelectorAll(".modal-backdrop").forEach(s=>{try{s.parentElement&&s.parentElement.removeChild(s)}catch{}}),document.body&&(document.body.classList.remove("modal-open"),document.body.style.removeProperty("padding-right"),document.body.style.removeProperty("overflow"))},"clearBackdrops"),o=a(s=>{if(s){if(s.classList&&s.classList.contains("modal-backdrop")&&(s=document.querySelector(".modal.in, .modal.show")||s),!s||!s.classList||!s.classList.contains("modal")){r();return}t(s),e(s),r();try{let c=typeof jr=="function"&&jr()||typeof unsafeWindow<"u"&&(unsafeWindow.jQuery||unsafeWindow.$)||window.jQuery||window.$;if(c&&c.fn&&typeof c.fn.modal=="function"){try{c(s).trigger("hide.bs.modal")}catch{}try{c(s).modal("hide")}catch{}try{c(s).trigger("hidden.bs.modal")}catch{}}}catch{}setTimeout(()=>{e(s),document.querySelector(".modal.in, .modal.show")||r();try{hr()}catch{}},0)}},"hideModalEl");document.addEventListener("show.bs.modal",s=>{let c=s.target;if(!(!c||!c.classList||!c.classList.contains("modal"))){t(c),c.style.display==="none"&&c.style.removeProperty("display");try{c.getAttribute("data-backdrop")==="static"&&c.setAttribute("data-backdrop","true"),c.dataset&&(c.dataset.backdrop="true")}catch{}}},!0),document.addEventListener("hide.bs.modal",s=>{let c=s.target;!c||!c.classList||!c.classList.contains("modal")||t(c)},!0),document.addEventListener("hidden.bs.modal",s=>{let c=s.target;!c||!c.classList||!c.classList.contains("modal")||(e(c),document.querySelector(".modal.in, .modal.show")||(document.querySelectorAll(".modal-backdrop").forEach(h=>{try{h.parentElement&&h.parentElement.removeChild(h)}catch{}}),document.body&&(document.body.classList.remove("modal-open"),document.body.style.removeProperty("padding-right"))))},!0);let p=a(s=>{let c=s.target;if(!c||!c.closest||c.closest(".modal-dialog, .modal-content, .modal-header, .modal-body, .modal-footer")&&!c.closest('[data-dismiss="modal"], .modal .close, .modal [aria-label="Close"]'))return;if(c.classList&&c.classList.contains("modal-backdrop")){let M=document.querySelector(".modal.in, .modal.show")||document.querySelector('.modal[style*="display: block"], .modal[style*="display:block"]');M?(s.preventDefault(),s.stopPropagation(),o(M)):(s.preventDefault(),r(),hr());return}let h=null;if(c.classList&&c.classList.contains("modal")?h=c:h=c.closest(".modal.in, .modal.show, .modal"),!h||!h.classList.contains("modal")||!(h.classList.contains("in")||h.classList.contains("show")||getComputedStyle(h).display!=="none"))return;let _=h.querySelector(".modal-dialog");if(_){let M=_.getBoundingClientRect(),N=s.clientX,L=s.clientY;if(N>=M.left&&N<=M.right&&L>=M.top&&L<=M.bottom&&!c.closest('[data-dismiss="modal"], .modal .close, .modal [aria-label="Close"]'))return}else if(c.closest(".modal-content"))return;s.preventDefault(),s.stopPropagation(),o(h)},"onBlankClose");document.addEventListener("pointerdown",p,!0),document.addEventListener("mousedown",p,!0),document.addEventListener("click",p,!0),document.addEventListener("click",s=>{let c=s.target&&s.target.closest?s.target.closest('[data-dismiss="modal"], .modal .close, .modal [aria-label="Close"]'):null;if(!c)return;let h=c.closest(".modal");h&&(s.preventDefault(),s.stopPropagation(),o(h)),setTimeout(()=>{try{hr()}catch{}},50),setTimeout(()=>{try{hr()}catch{}},220)},!0),document.addEventListener("click",s=>{let c=s.target&&s.target.closest?s.target.closest("a,button,td,span,div,i"):null;if(!c)return;["curriculumInfo-divcon","curriculumInfo-divcon1","curriculumInfo-divcon2","calssInfo-divcon","classroomInfo-divcon","billContainer"].forEach(b=>{let _=document.getElementById(b);_&&(t(_),_.style.opacity==="0"&&_.style.removeProperty("opacity"),_.style.pointerEvents==="none"&&_.style.removeProperty("pointer-events"))}),document.querySelectorAll(".modal").forEach(b=>t(b));let h=c.getAttribute&&(c.getAttribute("data-target")||c.getAttribute("href")||"");if(h&&h.charAt(0)==="#"){let b=document.querySelector(h);b&&t(b)}},!0)}a(xs,"patchModalOpenPath");let We=null,Na=0;function Ba(){if(be())return;let t=document.getElementById("courseTable");t&&t.querySelectorAll("td").forEach(e=>{let r=e.style.backgroundColor;if(!r||!r.includes("rgba"))return;let o=r.match(/rgba\((\d+),\s*(\d+),\s*(\d+),\s*[\d.]+\)/);o&&(e.style.backgroundColor=`rgba(${o[1]},${o[2]},${o[3]},0.5)`)})}a(Ba,"applyCourseTableOpacity");function ln(){let t=document.getElementById("mycoursetable")||document.getElementById("courseTable");if(We&&We.root===t&&t?.isConnected){Ba();return}if(clearTimeout(Na),We&&We.observer.disconnect(),We=null,!t)return;let e=new MutationObserver(()=>{clearTimeout(Na),Na=setTimeout(Ba,60)});e.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style"]}),We={root:t,observer:e},Ba()}a(ln,"bindCourseTableOpacityObserver");function ys(){try{let L=Vt();document.documentElement.dataset.urpppTheme=L,document.documentElement.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),document.documentElement.classList.add("urppp-theme-"+L),document.body&&(document.body.dataset.urpppTheme=L,document.body.classList.toggle("urppp-dark",L==="dark"))}catch{}let t=document.getElementById("urppp-internal-style");t||(t=document.createElement("style"),t.id="urppp-internal-style",document.head.appendChild(t));{let L=t;L.textContent=hp}let e=document.getElementById("urppp-table-beautify-style");e||(e=document.createElement("style"),e.id="urppp-table-beautify-style",document.head.appendChild(e)),e.textContent=yp;let r=document.getElementById("urppp-navigation-style");r||(r=document.createElement("style"),r.id="urppp-navigation-style",document.head.appendChild(r)),r.textContent=vp;let o=document.getElementById("urppp-dashboard-style");o||(o=document.createElement("style"),o.id="urppp-dashboard-style",document.head.appendChild(o)),o.textContent=kp;let p=document.getElementById("urppp-schedule-card-style");p||(p=document.createElement("style"),p.id="urppp-schedule-card-style",document.head.appendChild(p)),p.textContent=fp;let s=document.getElementById("urppp-mobile-style");s||(s=document.createElement("style"),s.id="urppp-mobile-style",document.head.appendChild(s)),s.textContent=Sp;try{re()}catch{}hr(),xs(),["curriculumInfo-divcon","curriculumInfo-divcon1","curriculumInfo-divcon2","calssInfo-divcon","classroomInfo-divcon"].forEach(L=>{let D=document.getElementById(L);!D||!D.style||(["display","opacity","pointer-events","visibility"].forEach(J=>{D.style.getPropertyPriority(J)==="important"&&D.style.removeProperty(J)}),D.style.opacity==="0"&&D.style.removeProperty("opacity"),D.style.pointerEvents==="none"&&D.style.removeProperty("pointer-events"))}),document.querySelectorAll(".modal").forEach(L=>{L.style&&L.style.getPropertyPriority("display")==="important"&&L.style.removeProperty("display")}),pn(),nn(),tn(),setTimeout(()=>document.querySelectorAll("table").forEach(L=>{Ia(L)&&an(L)}),500),Ko(),br(),ms(),Zo(),sn();let c=document.querySelector(".page-content");c&&c.querySelectorAll(".widget-box").length>=4&&setTimeout(Vs,500),qn(),ze(),b();function b(){let L="(max-width: 640px)",D=a(()=>!!(window.matchMedia&&window.matchMedia(L).matches),"isNarrow"),J=a((W,it)=>{if(!(!W||!document.body)){if(it){Object.hasOwn(W.dataset,"urpppDesktopSidebarMin")||(W.dataset.urpppDesktopSidebarMin=W.classList.contains("menu-min")?"1":"0",W.dataset.urpppDesktopBodyMin=document.body.classList.contains("menu-min")?"1":"0"),W.classList.remove("menu-min"),document.body.classList.remove("menu-min");return}Object.hasOwn(W.dataset,"urpppDesktopSidebarMin")&&(W.classList.toggle("menu-min",W.dataset.urpppDesktopSidebarMin==="1"),document.body.classList.toggle("menu-min",W.dataset.urpppDesktopBodyMin==="1"),delete W.dataset.urpppDesktopSidebarMin,delete W.dataset.urpppDesktopBodyMin)}},"syncMobileSidebarMode"),O=new WeakMap,R=a(W=>{let it=O.get(W);it&&cancelAnimationFrame(it),O.delete(W)},"stopDrawerAnimation"),F=a((W,it)=>{R(W);let lt=W.getBoundingClientRect(),yt=Math.max(lt.width,W.offsetWidth||0,260),gt=Math.max(-yt,Math.min(0,lt.left)),_t=it?0:-yt,Mt=Math.abs(_t-gt),Ot=Math.max(140,Math.round(260*Mt/yt)),me=performance.now(),Ut=W.classList.contains("urppp-clean-sidebar"),ne=Ut?"12030":"1200",Bt=Ut?"12030":"1030";W.style.setProperty("display","block","important"),W.style.setProperty("transition","none","important"),W.style.setProperty("visibility","visible","important"),W.style.setProperty("pointer-events",it?"auto":"none","important"),W.style.setProperty("z-index",ne,"important"),W.style.setProperty("transform",`translate3d(${gt}px, 0, 0)`,"important"),W.classList.toggle("urppp-drawer-closing",!it),W.classList.add("display");let St=a(()=>{W.style.setProperty("transform",`translate3d(${_t}px, 0, 0)`,"important"),it?(W.classList.remove("urppp-drawer-closing"),W.style.setProperty("pointer-events","auto","important")):(W.classList.remove("display","urppp-drawer-closing"),W.style.setProperty("visibility","hidden","important"),W.style.setProperty("z-index",Bt,"important")),O.delete(W)},"finish");if(Mt<1){St();return}let ke=a(It=>{if(!W.isConnected){O.delete(W);return}let Wt=Math.min(1,(It-me)/Ot),fi=Wt<.5?4*Wt*Wt*Wt:1-Math.pow(-2*Wt+2,3)/2,ra=gt+(_t-gt)*fi;if(W.style.setProperty("transform",`translate3d(${ra}px, 0, 0)`,"important"),Wt>=1){St();return}O.set(W,requestAnimationFrame(ke))},"step");O.set(W,requestAnimationFrame(ke))},"animateDrawer"),K=a((W,it,lt)=>{if(W){F(W,lt),it&&(it.setAttribute("aria-expanded",lt?"true":"false"),it.setAttribute("aria-label",lt?"关闭菜单":"打开菜单"));try{Ve()}catch{}}},"setDrawerOpen"),ut=a(()=>{K(document.getElementById("sidebar"),document.getElementById("urppp-mobile-menu-button"),!1)},"closeDrawer"),wt=a(()=>{let it=document.getElementById("urppp-mobile-search-panel")?.querySelector("#form-search");if(!it)return;Object.entries({position:"relative",right:"auto",top:"auto",left:"auto",transform:"none",width:"100%","min-width":"0","max-width":"none",height:"36px",opacity:"1",margin:"0",overflow:"visible","z-index":"1"}).forEach(([yt,gt])=>it.style.setProperty(yt,gt,"important")),[it.querySelector("form"),it.querySelector(".input-icon")].forEach(yt=>{yt&&Object.entries({display:"block",position:"relative",width:"100%","min-width":"0","max-width":"none",height:"36px",margin:"0",padding:"0","box-sizing":"border-box"}).forEach(([gt,_t])=>yt.style.setProperty(gt,_t,"important"))});let lt=it.querySelector("#search-input");lt&&(lt.style.setProperty("display","block","important"),lt.style.setProperty("width","100%","important"),lt.style.setProperty("min-width","0","important"),lt.style.setProperty("max-width","none","important"),lt.style.setProperty("height","36px","important"),lt.style.setProperty("box-sizing","border-box","important"))},"syncMobileSearchLayout"),Ct=a(()=>{let W=document.getElementById("form-search");if(!W||!W.__urpppMobileParent)return;let it=W.__urpppMobileParent,lt=W.__urpppMobileNext;it.isConnected&&(lt&&lt.parentElement===it?it.insertBefore(W,lt):it.appendChild(W)),W.classList.remove("urppp-mobile-form-search"),W.dataset.open="0",W.removeAttribute("style"),delete W.__urpppMobileParent,delete W.__urpppMobileNext;try{dt()}catch{}},"restoreMobileSearch"),qt=a(()=>{let W=document.querySelector("#navbar .menu-toggler");!W||W.dataset.urpppMobileHidden!=="1"||(W.style.removeProperty("display"),W.removeAttribute("aria-hidden"),W.dataset.urpppPreviousTabindex?W.setAttribute("tabindex",W.dataset.urpppPreviousTabindex):W.removeAttribute("tabindex"),delete W.dataset.urpppPreviousTabindex,delete W.dataset.urpppMobileHidden)},"restoreNativeMenuToggler"),Tt=a(()=>{let W=document.getElementById("urppp-mobile-menu-button");if(!D())return W?.remove(),qt(),null;if(W)return W;let it=document.getElementById("navbar"),lt=document.getElementById("sidebar");if(!it||!lt)return null;let yt=it.querySelector(".menu-toggler");yt&&(yt.dataset.urpppMobileHidden="1",yt.dataset.urpppPreviousTabindex=yt.getAttribute("tabindex")||"",yt.style.setProperty("display","none","important"),yt.setAttribute("aria-hidden","true"),yt.setAttribute("tabindex","-1"));let gt=document.createElement("button");gt.type="button",gt.id="urppp-mobile-menu-button",gt.className="urppp-mobile-menu-button",gt.setAttribute("aria-label","打开菜单"),gt.setAttribute("aria-expanded","false");let _t=it.querySelector(".navbar-container")||it;return _t.insertBefore(gt,_t.firstChild),gt},"ensureMenuToggler"),Ht=a(W=>{!W||W.dataset.urpppIconReady||(W.dataset.urpppIconReady="1",W.innerHTML=['<span class="urppp-menu-icon" aria-hidden="true">','<svg class="urppp-menu-icon-open" viewBox="0 0 24 24" focusable="false">','<path d="M5 8h14"></path><path d="M5 16h10"></path>',"</svg>",'<svg class="urppp-menu-icon-close" viewBox="0 0 24 24" focusable="false">','<path d="M7 7l10 10"></path><path d="M17 7 7 17"></path>',"</svg>","</span>"].join(""))},"ensureMenuButtonIcon"),Rt=a(()=>{let W=Tt(),it=document.getElementById("sidebar");W&&Ht(W),W&&it&&!W.__urpppToggleHandler&&(W.setAttribute("aria-label","打开菜单"),W.setAttribute("aria-expanded",it.classList.contains("display")?"true":"false"),W.__urpppToggleHandler=lt=>{lt.preventDefault(),lt.stopImmediatePropagation(),D()&&J(it,!0);let yt=W.getAttribute("aria-expanded")!=="true";K(it,W,yt)},W.addEventListener("click",W.__urpppToggleHandler,!0)),document.__urpppMobileDrawerOutsideBound||(document.__urpppMobileDrawerOutsideBound=!0,document.addEventListener("click",lt=>{if(!D()||!lt.target.closest)return;let yt=document.getElementById("sidebar");if(!yt||!yt.classList.contains("display"))return;let gt=document.getElementById("urppp-clean-root");gt&&gt.classList.contains("open")||lt.target.closest("#sidebar, #urppp-mobile-menu-button")||ut()},!0)),document.__urpppMobileRouteCloseBound||(document.__urpppMobileRouteCloseBound=!0,document.addEventListener("click",lt=>{if(!D()||!lt.target.closest)return;let yt=document.getElementById("urppp-clean-root");if(yt&&yt.classList.contains("open"))return;let gt=lt.target.closest("#sidebar a[href]");if(!gt)return;let _t=String(gt.getAttribute("href")||"").trim();!_t||_t==="#"||_t.startsWith("javascript")||ut()}))},"bindDrawerControls"),$t=a((W,it)=>{let lt=W?W.cloneNode(!0):document.createElement("a");return lt.className="urppp-mobile-user-action",lt.removeAttribute("style"),lt.removeAttribute("id"),!W&&it&&(lt.href=it.href,it.onclick&&lt.setAttribute("onclick",it.onclick),lt.innerHTML='<i class="ace-icon fa '+it.icon+'" aria-hidden="true"></i><span>'+it.label+"</span>"),lt},"createActionLink"),oe=a((W,it)=>{if(document.getElementById("urppp-mobile-user"))return;let lt=W.querySelector(":scope > li.light-blue")||Array.from(W.children).find(Wt=>Wt.querySelector&&Wt.querySelector(".nav-user-photo, .user-menu, .dropdown-menu")),yt=document.createElement("section");yt.id="urppp-mobile-user",yt.className="urppp-mobile-user";let gt=document.createElement("div");gt.className="urppp-mobile-user-identity";let _t=lt?.querySelector(".nav-user-photo")||document.querySelector("#navbar .nav-user-photo"),Mt=_t?_t.cloneNode(!0):document.createElement("img");Mt.className="nav-user-photo",Mt.removeAttribute("style"),Mt.getAttribute("src")||Mt.setAttribute("src","/main/queryStudent/img"),Mt.setAttribute("data-urppp-private","avatar"),Mt.alt=_t?.alt?.replace(/\s+/g," ").trim()||"用户头像";let Ot=lt?.querySelector(".user-info")||document.querySelector("#navbar .user-info"),me=document.createElement("span");me.className="urppp-mobile-user-copy";let Ut=document.createElement("small");Ut.className="urppp-mobile-user-welcome",Ut.textContent="欢迎您，";let ne=document.createElement("span");ne.className="user-info urppp-user-name-value",ne.setAttribute("data-urppp-private","name"),ne.textContent=Ot?.textContent?.replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim()||_t?.alt?.replace(/\s+/g," ").trim()||"我的账户",me.append(Ut,ne),gt.append(Mt,me),yt.appendChild(gt);let Bt=document.createElement("div");Bt.className="urppp-mobile-user-actions";let St=lt?Array.from(lt.querySelectorAll(".user-menu a, .dropdown-menu a")):[],ke=[{label:"首页",href:"/",icon:"fa-home"},{label:"在线反馈",href:"/main/systemQuestion/index",icon:"fa-question-circle"},{label:"修改密码",href:"javascript:changePassword('/student/rollManagement/personalInfoUpdate/updatePassword')",icon:"fa-user"},{label:"注销",href:"/logout",icon:"fa-power-off"}];St.length?St.forEach(Wt=>Bt.appendChild($t(Wt))):ke.forEach(Wt=>Bt.appendChild($t(null,Wt))),yt.appendChild(Bt);let It=it.querySelector(".urppp-sidebar-header");It&&It.nextSibling?it.insertBefore(yt,It.nextSibling):It?it.appendChild(yt):it.insertBefore(yt,it.firstChild);try{Qt(yt)}catch{}},"ensureMobileUser"),hi=a((W,it,lt,yt={})=>{if(!lt||document.getElementById("urppp-mobile-quick"))return;let gt=document.createElement("section");gt.id="urppp-mobile-quick",gt.className="urppp-mobile-quick",gt.innerHTML='<div class="urppp-mobile-quick-title">快捷功能</div>';let _t=document.createElement("div");_t.className="urppp-mobile-tool-row";let Mt=W.querySelector(':scope > li > a[href*="customerServiceCenter"]'),Ot=Mt?Mt.cloneNode(!0):document.createElement("a");Ot.className="urppp-mobile-tool-button urppp-mobile-help-button",Ot.removeAttribute("style"),Ot.removeAttribute("onclick"),Ot.removeAttribute("data-toggle"),Ot.removeAttribute("target"),Ot.querySelectorAll("[style]").forEach(St=>St.removeAttribute("style"));let me=String(Ot.getAttribute("href")||"").trim();(!me||me==="#"||me.startsWith("javascript"))&&(Ot.href="/main/customerServiceCenter"),Ot.querySelector("i")||(Ot.innerHTML='<i class="ace-icon glyphicon glyphicon-headphones" aria-hidden="true"></i>'),Ot.querySelectorAll("span").forEach(St=>St.remove()),Ot.insertAdjacentHTML("beforeend","<span>帮助</span>"),_t.appendChild(Ot);let Ut=document.createElement("button");Ut.type="button",Ut.id="urppp-mobile-search-button",Ut.className="urppp-mobile-tool-button",Ut.setAttribute("aria-expanded","false"),Ut.innerHTML='<i class="ace-icon fa fa-search" aria-hidden="true"></i><span>搜索</span>',_t.appendChild(Ut),gt.appendChild(_t);let ne=document.createElement("div");ne.className="urppp-mobile-quick-links",Array.from(W.querySelectorAll(":scope > li > a")).forEach(St=>{let ke=St.closest("li");if(ke?.classList.contains("light-blue")||ke?.querySelector("#intellegenceUDiv, #form-search")||St===Mt||St.classList.contains("dropdown-toggle")||!St.getAttribute("href")&&!St.getAttribute("onclick"))return;let It=St.cloneNode(!0);It.className="urppp-mobile-quick-link",It.removeAttribute("style");let Wt=String(St.getAttribute("onclick")||"");if(/openWorkRestSchedule|open\w*Schedule/i.test(Wt)||It.removeAttribute("onclick"),yt.cleanMode){let ra=String(St.getAttribute("href")||"");(ra==="/holiday"||/holiday/i.test(ra)||/假期/.test(St.textContent||""))&&(It.removeAttribute("href"),It.removeAttribute("target"),It.style.cursor="default",It.style.pointerEvents="none")}ne.appendChild(It)});let Bt=document.createElement("div");Bt.id="urppp-mobile-search-panel",Bt.className="urppp-mobile-search-panel",Bt.hidden=!0;{let St=document.getElementById("form-search");St&&(St.__urpppMobileParent||(St.__urpppMobileParent=St.parentElement,St.__urpppMobileNext=St.nextSibling),St.classList.add("urppp-mobile-form-search"),St.dataset.open="0",Bt.appendChild(St),wt())}gt.appendChild(Bt),ne.children.length&&gt.appendChild(ne),Ut.addEventListener("click",St=>{if(St.preventDefault(),St.stopPropagation(),Bt.hidden){wt();let It=Bt.querySelector("#form-search");It&&(It.dataset.open="0",It.style.setProperty("pointer-events","auto","important"),It.style.setProperty("opacity","1","important"),It.style.setProperty("width","100%","important"),It.style.setProperty("min-width","0","important")),Bt.hidden=!1,Bt.classList.add("open"),setTimeout(()=>Bt.querySelector("#search-input")?.focus(),30),Ut.setAttribute("aria-expanded","true")}else Bt.hidden=!0,Bt.classList.remove("open"),Ut.setAttribute("aria-expanded","false")}),it.insertBefore(gt,lt)},"ensureMobileQuick"),Ie=a(()=>{let W=D(),it=document.querySelector("#navbar .navbar-buttons .ace-nav"),lt=document.getElementById("sidebar"),yt=document.getElementById("urppp-menus");if(lt&&J(lt,W),Rt(),!W){let gt=document.documentElement.classList.contains("urppp-clean-open");gt||Ct(),gt||(document.getElementById("urppp-mobile-quick")?.remove(),document.getElementById("urppp-mobile-user")?.remove());let _t=document.getElementById("urppp-nav-clean"),Mt=document.getElementById("urppp-nav-theme");_t&&Mt&&_t.parentElement!==Mt&&Mt.appendChild(_t),Mt&&Mt.style.setProperty("display","inline-flex","important");return}if(!(!it||!lt)){try{let gt=document.getElementById("urppp-nav-clean"),_t=document.querySelector("#navbar .navbar-header"),Mt=document.getElementById("urppp-nav-theme");gt&&_t&&gt.parentElement!==_t&&_t.appendChild(gt),Mt&&Mt.style.setProperty("display","inline-flex","important"),document.getElementById("urppp-nav-cal")?.remove()}catch{}oe(it,lt),hi(it,lt,yt),wt()}},"apply");window.__urpppRefreshMobileNavbar=Ie,window.__urpppCloseMobileDrawer=ut,window.__urpppSetDrawerOpen=(W,it,lt)=>{K(W,it,lt)},window.__urpppStopDrawerAnimation=W=>{W&&R(W)},window.__urpppInjectCleanSidebarSections=W=>{let it=document.querySelector("#navbar .navbar-buttons .ace-nav")||document.querySelector("#navbar .ace-nav"),lt=document.getElementById("urppp-menus");if(!it||!W)return;try{oe(it,W)}catch{}let yt=document.getElementById("urppp-mobile-quick");if(yt){let gt=yt.querySelector("#urppp-mobile-search-panel");if(gt&&gt.querySelector("#form-search"))try{Ct()}catch{}yt.remove()}try{hi(it,W,lt,{cleanMode:!0})}catch{}};try{Ie()}catch{}if(setTimeout(Ie,300),setTimeout(Ie,900),setTimeout(Ie,1800),window.matchMedia){let W=window.matchMedia(L),it=a(()=>Ie(),"onChange");typeof W.addEventListener=="function"?W.addEventListener("change",it):typeof W.addListener=="function"&&W.addListener(it)}try{window.__urpppMobileNavbarObserver&&window.__urpppMobileNavbarObserver.disconnect();let W=0,it=new MutationObserver(()=>{clearTimeout(W),W=setTimeout(()=>{try{Ie()}catch{}},40)}),lt=document.getElementById("navbar"),yt=document.getElementById("sidebar");lt&&it.observe(lt,{childList:!0,subtree:!0}),yt&&it.observe(yt,{childList:!0}),window.__urpppMobileNavbarObserver=it}catch{}}a(b,"setupMobileNavbar");let M=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches)?"8px 8px 24px":"16px 64px 40px";if(document.querySelectorAll(".page-content, #page-content-template").forEach(L=>{L.style.setProperty("padding",M,"important"),L.style.setProperty("box-sizing","border-box","important")}),Dr(),Ca(),Hr(),Re(),za(),setTimeout(()=>{Re(),za()},300),setTimeout(()=>{Re(),za()},1e3),Vo(),Jo(),Go(),ye(),La(),ur(),Yo(),setTimeout(()=>{ye(),ur()},200),setTimeout(()=>{ye(),ur()},800),setTimeout(Ca,350),setTimeout(Ca,1e3),mr(),setTimeout(()=>mr(),400),!window.__urpppPlanTreeObs){let L=0;window.__urpppPlanTreeObs=new MutationObserver(()=>{let J=document.getElementById("treeDemo");!J||J.dataset.urpppBusy==="1"||J.querySelector('li > a:not([data-urppp-node-done="1"])')&&(clearTimeout(L),L=setTimeout(()=>mr(),220))});let D=document.getElementById("tree_div")||document.getElementById("treeDemo");D&&window.__urpppPlanTreeObs.observe(D,{childList:!0,subtree:!0})}window.__urpppWrsBound||(window.__urpppWrsBound=!0,document.addEventListener("shown.bs.modal",L=>{L.target&&(L.target.id==="work_rest_schedule_modal"||L.target.querySelector?.("#work_rest_schedule_modal"))&&setTimeout(qa,30)},!0),document.addEventListener("click",L=>{let D=L.target&&L.target.closest?L.target.closest("a,button"):null;if(!D)return;let J=D.getAttribute("onclick")||"",O=(D.textContent||"").trim();(J.includes("openWorkRestSchedule")||O.includes("作息时间表"))&&(setTimeout(qa,80),setTimeout(qa,300))},!0)),Fr(),st(),dt(),Ta();let N=a(()=>{Dr(),Hr(),Fr()},"layoutWave");setTimeout(N,200),setTimeout(N,800),window.__urpppLoadBound||(window.__urpppLoadBound=!0,window.addEventListener("load",()=>{st(),dt(),rt(),Ta(),Fr(),Dr(),Hr()})),setTimeout(()=>{document.body.classList.add("urppp-ready"),kt()},600),console.log("[URP++] style applied apple-leaning");try{bindScheduleHoverNearCursor()}catch{}ln()}a(ys,"beautifyInternal");function vs(t){if(!t)return;let e=t.querySelector("#urppp-set-brutal-palettes");if(!e)return;let r=Fo();e.innerHTML="",Q.filter(o=>o.id!==V).forEach(o=>{let p=document.createElement("button");p.type="button",p.className="urppp-set-scheme"+(o.id===r.id?" ac":""),p.dataset.palette=o.id,p.innerHTML=['<div class="urppp-set-scheme-preview">','  <span style="background:#000"></span>','  <span style="background:'+o.accent+'"></span>','  <span style="background:'+o.secondary+'"></span>',"</div>",'<div class="urppp-set-scheme-meta">',"  <strong>"+o.name+"</strong>","  <em>"+o.desc+"</em>","</div>"].join(""),p.addEventListener("click",()=>jo(o.id,{select:!0})),e.appendChild(p)})}a(vs,"renderBrutalPaletteCards");let Rr=Qi({getPrivacySettings:Ee,setPrivacySettings:ka,getCustomIdentity:De,setCustomIdentity:qo,applyDisplay:a(()=>Qt(document),"applyDisplay"),refreshCleanDisplay:Za,finishActiveDirectEdit:a(t=>{we?.__finish&&we.__finish(t)},"finishActiveDirectEdit")}),ws=Rr.sync,id=Rr.collect,pd=Rr.setStatus,ks=Rr.bind,Fa=Vi({document,getSettings:Nr,setSettings:Mo,validateMapping:Ne,defaultMapping:Pr,getRecoveryMessage:a(()=>et,"getRecoveryMessage")}),sd=Fa.setStatus,As=Fa.sync,Ss=Fa.bind;function jt(){let t=document.getElementById("urppp-settings-panel");if(!t)return;let e=Xt()||bt,r=Fe(),o=Vt(),p=Kt(),s=te(),c=je(s),h=Oe(s),b=Bo(s),_={};t.querySelectorAll(".urppp-set-mode").forEach(L=>{_[L.dataset.theme]=cr(L.dataset.theme,s)}),Ki(t,{seed:e,currentTheme:o,followSystem:p,skinId:s,darkSupported:c,dynamicSupported:h,fixedPalettes:b,followUseDynamic:Br(),cleanDefault:ya(),cleanAnalysis:va()?"direct":"tab",appleEdge:_e(),autoUpdate:wa(),modeAvailability:_}),b&&vs(t);try{ws(t)}catch{}try{As(t)}catch{}try{window.__urpppCleanMode&&typeof window.__urpppCleanMode.refreshRender=="function"&&window.__urpppCleanMode.refreshRender()}catch{}let M=t.querySelector("#urppp-set-presets");M&&(M.innerHTML="",xa().forEach(L=>{let D=document.createElement("button");D.type="button",D.className="urppp-set-swatch"+(L.toLowerCase()===e.toLowerCase()?" ac":""),D.title=L,D.style.background=L,D.addEventListener("click",()=>{GM_setValue(q,L),Kt()?Gt(fe(),{system:!0}):Gt("scu-red",{manual:!0}),jt()}),M.appendChild(D)}));let N=t.querySelector("#urppp-set-schemes");N&&(N.innerHTML="",Be(e).forEach(L=>{let D=document.createElement("button");D.type="button",D.className="urppp-set-scheme"+(L.id===r?" ac":""),D.dataset.scheme=L.id,D.innerHTML=['<div class="urppp-set-scheme-preview">','  <span style="background:'+L.bg+'"></span>','  <span style="background:'+L.surface+";border-color:"+L.border+'"></span>','  <span style="background:'+L.primary+'"></span>',"</div>",'<div class="urppp-set-scheme-meta">',"  <strong>"+L.name+"</strong>","  <em>"+L.desc+"</em>","</div>"].join(""),D.addEventListener("click",()=>{ga(L.id),GM_setValue(q,e),Kt()?Gt(fe(),{system:!0}):Gt("scu-red",{manual:!0}),jt()}),N.appendChild(D)}));try{Ds(t)}catch(L){try{console.warn("[URP++] renderSkinCards",L)}catch{}}try{let L=t.querySelector(".urppp-about-ver, #urppp-about-ver");L&&(L.textContent="SCU URP++ v"+n,L.tagName==="A"&&(L.setAttribute("href",i.repo),L.setAttribute("target","_blank"),L.setAttribute("rel","noopener noreferrer")))}catch{}try{mn(t)}catch{}}a(jt,"syncSettingsPanelUI");let cn=Gi({document,ensurePanel:bn,syncPanel:jt,refreshUpdateStatus:zn}),_s=Xi({document,theme:{isModeAvailable:cr,apply:Gt,supportsDark:je,supportsDynamic:Oe,getFollowSystem:Kt,setFollowSystem:Mr,resolveFollowTheme:fe,getCurrent:Vt,getFollowDynamic:Br,setFollowDynamic:Sa,syncNavbar:xt},preferences:{getCleanDefault:ya,setCleanDefault:ts,getCleanAnalysis:a(()=>va()?"direct":"tab","getCleanAnalysis"),setCleanAnalysis:es,getAppleEdge:_e,setAppleEdge:rs,applySkin:re,getAutoUpdate:wa,setAutoUpdate:as,checkUpdates:Va},accent:{normalize:Jt,setAccent:a(t=>GM_setValue(q,t),"setAccent"),savePreset:Zp,getScheme:Fe,setScheme:ga,listSchemePreviews:Be},syncPanel:jt}),Et=yo({GM:{getValue:typeof GM_getValue=="function"?GM_getValue:null,setValue:typeof GM_setValue=="function"?GM_setValue:null,xmlHttp:typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:null,addStyle:typeof GM_addStyle=="function"?GM_addStyle:null},doc:document,hostInfo:{version:n},uiDeps:{openSubpanel:a(t=>{t==="plugin-store"&&Da("plugin")},"openSubpanel")}});a((function(){let e=a(()=>{try{Et.bootFromCache("assist")}catch{}},"run");document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}),"bootstrapPlugins")();function dn(){return cn.open()}a(dn,"openSettingsPanel");function un(){cn.close()}a(un,"closeSettingsPanel");let Ur="data:image/png;base64,";function mn(t){let e=t&&t.querySelector?t.querySelector("#urppp-about-logo"):document.getElementById("urppp-about-logo");e&&(e.getAttribute("src")!==Ur&&e.setAttribute("src",Ur),e.removeAttribute("referrerpolicy"),e.alt="SCU URP++",e.style.maxWidth="100%",e.style.height="auto",e.style.display="block")}a(mn,"ensureAboutLogo");function bn(){if(document.getElementById("urppp-settings-panel"))return;Xs();try{re()}catch{}try{Pe&&Pe.length&&Ce(Pe)}catch{}let t=document.createElement("div");t.id="urppp-settings-mask",t.addEventListener("click",un);let e=document.createElement("div");e.id="urppp-settings-panel",e.setAttribute("role","dialog"),e.setAttribute("aria-label","URP++ 设置");let r=Ur;e.innerHTML=Ji({logoData:Ur,repositoryUrl:i.repo,version:n}),document.documentElement.appendChild(t),document.documentElement.appendChild(e),Wi(e),e.querySelector("#urppp-set-close").addEventListener("click",un);try{ks(e)}catch(p){console.warn("[URP++] privacy settings",p)}try{Ss(e)}catch(p){console.warn("[URP++] JSON settings",p)}try{mn(e)}catch{}let o=e.querySelector("#urppp-about-logo");o&&!o.__urpppFallback&&(o.__urpppFallback=!0,o.addEventListener("error",()=>{o.dataset.fallback!=="1"&&(o.dataset.fallback="1",o.src=r)})),_s.bind(e);try{Et.renderAssistUi(e.querySelector("#urppp-set-assist-slot"))}catch(p){console.warn("[URP++] plugin manager",p)}}a(bn,"ensureSettingsPanel");function Da(t){let e=document.getElementById("urppp-settings-panel");if(!e)return;let r=document.getElementById("urppp-store-subpanel");r||(r=document.createElement("div"),r.id="urppp-store-subpanel",r.className="urppp-store-subpanel",r.innerHTML=`
        ...
        <div class="urppp-store-sub-body" id="urppp-store-sub-body"></div>`,e.appendChild(r),r.querySelector("#urppp-store-sub-back").onclick=Es);let o=r.querySelector("#urppp-store-sub-title"),p=r.querySelector("#urppp-store-sub-body");o.textContent=t==="theme"?"主题商店":"插件商店",p.innerHTML="",t==="theme"?$s(p):_n(p),r.classList.add("open")}a(Da,"openStoreSubPanel");function Es(){let t=document.getElementById("urppp-store-subpanel");if(!t)return;t.classList.remove("open");let e=t.querySelector("#urppp-store-sub-body");e&&(e.innerHTML="")}a(Es,"closeStoreSubPanel");function hn(t){t.querySelectorAll(".urppp-store-tab").forEach(e=>{e.addEventListener("click",()=>{t.querySelectorAll(".urppp-store-tab").forEach(o=>o.className="urppp-store-tab"),e.className="urppp-store-tab ac",t.querySelectorAll(".urppp-store-pane").forEach(o=>o.style.display="none");let r=t.querySelector('.urppp-store-pane[data-pane="'+e.dataset.tab+'"]');r&&(r.style.display="")})})}a(hn,"bindStoreTabs");function Ce(t){Array.isArray(t)&&t.forEach(e=>{if(!e||!e.id)return;let r="";try{r=GM_getValue("urppp_card_css_"+e.id,"")||""}catch{}let o=r||e.cardCss||"";if(!o)return;let p=document.getElementById("urppp-store-card-css-"+e.id);p||(p=document.createElement("style"),p.id="urppp-store-card-css-"+e.id,(document.head||document.documentElement).appendChild(p)),p.textContent!==o&&(p.textContent=o)})}a(Ce,"ensureStoreCardStyles");function Cs(t,e){let r=(u.find(s=>s.id===t.id)||{}).repo,o=t.repo||r,p=o?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(o)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-skin="${at(t.id)}">
      ...
      ${p}
    </div>`}a(Cs,"themeStoreCard");async function ja(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await ve()).filter(o=>o.type==="theme"&&!ge(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Ce(r),e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>Cs(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>Ps(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(ja,"fetchCatalogThemes");async function Ps(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await ve()).find(c=>c.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o=await xn(r);if(o==="fail"){Ge("签名校验失败：该条目可能被篡改，已停止下载","error"),e.disabled=!1,e.textContent="下载";return}if(o==="unknown"&&r._srcPub&&!await gn("该源无有效签名校验，可能被篡改。是否自担风险继续下载？")){e.disabled=!1,e.textContent="下载";return}let p="";for(let c of r.entry)try{let h=await fetch(c,{cache:"no-store"});if(h.ok){p=await h.text();break}}catch{}if(!p){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,p)}catch{}if(u.some(c=>c.id===t)||Io(t,{name:r.name||t,desc:r.desc||"下载主题",author:r.author||"",version:r.version||"1.0.0"}),r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{_a(t).textContent=p}catch{}try{Ce([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;let s=e.closest&&e.closest(".urppp-store-inline");if(s){try{let c=s.querySelector("#urppp-theme-manage");c&&await Wr(c)}catch{}try{ja(s)}catch{}}try{jt()}catch{}}a(Ps,"downloadStoreTheme");function Ls(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,p=e&&e.repo||t.repo,s=p?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(p)}">仓库</button>`:"",c=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"",h=te()===t.id;return`<div class="urppp-skin-card${h?" is-active":""}" data-skin="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name)}</div>
      <div class="urppp-skin-meta">${at(e&&e.author||"")}${e&&e.author&&t.version?" · ":""}v${at(t.version||"")}${c?" · "+c:""}</div>
      <p class="urppp-skin-desc">${at(t.desc||"")}</p>
      <button type="button" class="urppp-skin-apply${h?" is-current":""}" data-theme-use="${at(t.id)}"${h?" disabled":""}>${h?"使用中":"使用"}</button>
      ${o}${s}
    </div>`}a(Ls,"themeManageCardHtml");async function Wr(t){if(!t)return;let e=[];try{e=await ve()}catch{}let r=xe(),o=Object.keys(r).map(s=>({id:s,name:r[s].name||s,desc:r[s].desc||"本地主题",version:r[s].version||"1.0.0",author:r[s].author||"本地",installed:!1})),p=u.filter(s=>s.installed!==!1||ge(s.id)).concat(o.filter(s=>!u.some(c=>c.id===s.id)));if(!p.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}Ce(p.map(s=>e.find(c=>c.id===s.id))),t.innerHTML=`<div class="urppp-store-theme-grid">${p.map(s=>Ls(s,e.find(c=>c.id===s.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(s=>s.addEventListener("click",()=>{if(Oo(s.dataset.themeUse)){try{jt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(c=>{let h=c.dataset.skin,b=c.querySelector(".urppp-skin-apply"),_=te()===h;c.classList.toggle("is-active",_),b&&(b.classList.toggle("is-current",_),b.disabled=_,b.textContent=_?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(s=>s.addEventListener("click",()=>{let c=s.dataset.themeDel,h=te()===c;try{GM_setValue("urppp_theme_css_"+c,"")}catch{}try{GM_setValue("urppp_card_css_"+c,"")}catch{}ns(c),ps(c);try{if(h){GM_setValue(d,"apple");try{document.documentElement.removeAttribute("data-urppp-skin")}catch{}try{document.body&&document.body.removeAttribute("data-urppp-skin")}catch{}re();let _=Kt(),M=_?fe():Vt();Gt(M,{system:_})}}catch{}try{jt()}catch{}let b=t.closest(".urppp-store-inline");if(b){try{Wr(t)}catch{}try{ja(b)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(s=>s.addEventListener("click",()=>{try{window.open(s.dataset.repo,"_blank","noopener")}catch{}}))}a(Wr,"fetchThemeManage");function fn(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(fn,"storeManageSettingsHtml");let zs=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];function fr(){try{let t=JSON.parse(GM_getValue("urppp_store_sources","[]"));return Array.isArray(t)?t:[]}catch{return[]}}a(fr,"getCustomSources");function Oa(t){try{GM_setValue("urppp_store_sources",JSON.stringify(t))}catch{}}a(Oa,"saveCustomSources");let Pe=null;async function ve(t){if(Pe&&!t)return Pe;let e=a((M,N)=>Promise.race([M,new Promise((L,D)=>setTimeout(()=>D(new Error("timeout")),N))]),"withTimeout"),r=a(async M=>{try{let N=await e(fetch(M,{cache:"no-store"}),5e3);if(!(N&&N.ok))return null;let L=await N.json();return L&&Array.isArray(L.items)?L:null}catch{return null}},"fetchCatalogDoc"),o=await Promise.allSettled(zs.map(M=>r(M))),p=null;for(let M of o){if(!(M.status==="fulfilled"&&M.value&&Array.isArray(M.value.items)))continue;let N=M.value.items.some(L=>L.type==="theme"&&L.cardCss);(!p||N&&!p.items.some(L=>L.type==="theme"&&L.cardCss))&&(p=M.value)}let s=p&&p.items||[],c=fr().filter(M=>M&&M.url&&M.enabled!==!1),h=await Promise.allSettled(c.map(async M=>{let N=await r(M.url);return{doc:N,pubkey:N?N.pubkey:""}})),b=[...s],_=new Set(b.map(M=>M&&M.id).filter(Boolean));for(let M of h){if(!(M.status==="fulfilled"&&M.value&&M.value.doc))continue;let N=M.value.pubkey||"";for(let L of M.value.doc.items)!L||!L.id||_.has(L.id)||(_.add(L.id),N&&(L._srcPub=N),b.push(L))}return Pe=b,b}a(ve,"fetchCatalogList");function qs(){try{if(typeof crypto<"u"&&crypto&&crypto.subtle)return crypto.subtle;let t=typeof unsafeWindow<"u"&&unsafeWindow?unsafeWindow:typeof window<"u"?window:null;if(t&&t.crypto&&t.crypto.subtle)return t.crypto.subtle}catch{}return null}a(qs,"getWebCrypto");function Gr(t){if(Array.isArray(t))return t.map(Gr);if(t&&typeof t=="object"){let e={};for(let r of Object.keys(t).filter(o=>o!=="signature"&&o!=="_srcPub").sort())e[r]=Gr(t[r]);return e}return t}a(Gr,"normalizeEntry");function Jr(t){try{let e=atob(t),r=new Uint8Array(e.length);for(let o=0;o<e.length;o+=1)r[o]=e.charCodeAt(o);return r}catch{return null}}a(Jr,"b64ToU8");async function Ts(t,e){let r=qs();if(!r)try{if(!e||!t||!t.signature)return!1;let o=Jr(e),p=Jr(t.signature);if(!o||!p)return!1;let s=JSON.stringify(Gr(t));return Ai(p,o,wi(s))}catch{return null}if(!e||!t||!t.signature)return!1;try{let o=Jr(e);if(!o)return null;let p=await r.importKey("raw",o,{name:"Ed25519"},!1,["verify"]),s=Jr(t.signature);if(!s)return!1;let c=JSON.stringify(Gr(t)),h=await r.digest("SHA-256",new TextEncoder().encode(c)),b=new Uint8Array(h);return await r.verify({name:"Ed25519"},p,s,b)}catch{return null}}a(Ts,"verifyEntrySignature");function Ge(t,e){try{let r=document.getElementById("urppp-toast");r||(r=document.createElement("div"),r.id="urppp-toast",r.className="urppp-toast",(document.body||document.documentElement).appendChild(r)),r.textContent=t,r.className="urppp-toast show"+(e==="error"?" error":""),clearTimeout(r._t),r._t=setTimeout(()=>{r.className="urppp-toast"},3200)}catch{try{window.alert(t)}catch{}}}a(Ge,"toast");function gn(t){return new Promise(e=>{try{let r=document.getElementById("urppp-confirm");r||(r=document.createElement("div"),r.id="urppp-confirm",r.className="urppp-confirm",r.innerHTML='<div class="urppp-confirm-txt"></div><div class="urppp-confirm-ops"><button type="button" class="urppp-set-btn ghost" data-cac>取消</button><button type="button" class="urppp-set-btn" data-ok>继续</button></div>',(document.body||document.documentElement).appendChild(r)),r.querySelector(".urppp-confirm-txt").textContent=t,r.classList.add("show");let o=a(p=>{r.classList.remove("show"),r.querySelector("[data-ok]").onclick=r.querySelector("[data-cac]").onclick=null,e(p)},"done");r.querySelector("[data-ok]").onclick=()=>o(!0),r.querySelector("[data-cac]").onclick=()=>o(!1)}catch{try{e(window.confirm(t))}catch{e(!1)}}})}a(gn,"confirmBottom");async function xn(t){let e=t&&t._srcPub;if(!e)return"trust";let r=await Ts(t,e);return r===!0?"ok":r===!1?"fail":"unknown"}a(xn,"guardEntrySignature");function yn(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let p=0;p<Math.max(r.length,o.length);p+=1){let s=r[p]||0,c=o[p]||0;if(s!==c)return s>c}return!1}a(yn,"versionGt");function Ms(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let p=t.querySelector('[data-theme-use="'+o.id+'"]');p&&yn(o.version,u.find(c=>c.id===o.id)&&u.find(c=>c.id===o.id).version)&&(vn(p.closest(".urppp-skin-card"),"主题"),r+=1);let s=t.querySelector('[data-plugin-id="'+o.id+'"]');if(s){let c=Et&&Et.api&&Et.api.get&&Et.api.get(o.id);c&&yn(o.version,c.version)&&(vn(s.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(Ms,"applyStoreUpdateBadges");function vn(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(vn,"addUpdateBadge");function wn(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),p=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");p(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),p()}),r.addEventListener("click",async()=>{r.disabled=!0;let s=r.textContent;r.textContent="检查中…";try{let c=await ve(),h=Ms(t,c);r.textContent=h?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=s,r.disabled=!1},1600)})}a(wn,"bindStoreManageSettings");function $s(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${fn()}<button type="button" class="urppp-set-btn ghost" data-add-local-theme style="width:100%;margin:0 0 10px">＋ 添加本地主题</button><input type="file" accept=".css,.txt" data-local-theme-file style="display:none"><div class="urppp-store-bd"><div id="urppp-theme-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div></div>
          <div class="urppp-store-pane" data-pane="sources" style="display:none">${kn()}</div>
        </div>
      </div>`,hn(t),wn(t),Is(t),An(t),ja(t),Wr(t.querySelector("#urppp-theme-manage"))}a($s,"renderThemeStoreBody");function kn(){let t=fr();return`<div class="urppp-src-manage">
    ...
    </div>`}a(kn,"storeSourcesHtml");function An(t){let e=t.querySelector("[data-src-add]");if(e){let r=t.querySelector("[data-src-url]"),o=t.querySelector("[data-src-name]");e.addEventListener("click",async()=>{let p=(r.value||"").trim();if(!p)return;e.disabled=!0;let s=e.textContent;e.textContent="验证中…";try{let c=await fetch(p,{cache:"no-store"});if(!(c&&c.ok))throw new Error("无法访问");let h=await c.json();if(!(h&&Array.isArray(h.items)))throw new Error("不是合法 catalog（无 items）");let b=fr();if(b.some(_=>_.url===p)){Ge("该源已存在");return}b.push({name:(o.value||"").trim()||p,url:p,enabled:!0}),Oa(b),Pe=null,Ha(t)}catch(c){Ge("添加失败："+(c&&c.message?c.message:c),"error")}finally{e.disabled=!1,e.textContent=s}})}t.querySelectorAll("[data-src-toggle]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcToggle),p=fr();p[o]&&(p[o].enabled=p[o].enabled===!1,Oa(p),Ha(t))})),t.querySelectorAll("[data-src-del]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcDel),p=fr();p[o]&&(p.splice(o,1),Oa(p),Ha(t))}))}a(An,"bindStoreSources");function Ha(t){let e=t.querySelector('[data-pane="sources"]');if(e){let r=t;e.innerHTML=kn(),An(r)}}a(Ha,"refreshStoreSources");function Is(t){let e=t.querySelector("[data-add-local-theme]"),r=t.querySelector("[data-local-theme-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let p=await o.text(),s=p.match(/html\[data-urppp-skin="([\w-]+)"\]/);if(!s){Ge('未能从 CSS 中识别主题 id（需要 html[data-urppp-skin="…"]）',"error"),r.value="";return}let c=s[1];try{GM_setValue("urppp_theme_css_"+c,p)}catch{}Io(c,{name:c,desc:"本地主题",author:"本地",version:"1.0.0"});try{_a(c).textContent=p}catch{}r.value="";try{Wr(t.querySelector("#urppp-theme-manage"))}catch{}}))}a(Is,"bindLocalThemeImport");function Ns(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
      ...
      <button type="button" class="urppp-skin-apply" data-plugin-apply="${at(t.id)}">安装</button>
    </div>`}a(Ns,"pluginStoreCard");async function Bs(t){if(!t)return;let e=[];try{e=(await ve()).filter(r=>r.type==="plugin"&&!(Et&&Et.api&&Et.api.isEnabled&&Et.api.isEnabled(r.id)))}catch{}if(!e.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载插件</p><p class="urppp-store-sub">已安装的插件不会再显示在这里。</p></div>';return}t.innerHTML=`<div class="urppp-store-theme-grid">${e.map(r=>Ns(r)).join("")}</div>`,t.querySelectorAll("[data-plugin-apply]").forEach(r=>r.addEventListener("click",async()=>{r.disabled=!0;let o=r.textContent;r.textContent="下载中…";try{let p=(await ve()).find(c=>c.id===r.dataset.pluginApply),s=p?await xn(p):"trust";if(s==="fail"){Ge("签名校验失败：该插件可能被篡改，已停止装载","error"),r.textContent="下载",r.disabled=!1;return}if(s==="unknown"&&p&&p._srcPub&&!await gn("该源无有效签名校验，可能被篡改。是否自担风险继续装载？")){r.textContent="下载",r.disabled=!1;return}Et&&Et.api&&Et.api.install&&await Et.api.install(r.dataset.pluginApply,null),r.textContent="已安装";try{jt()}catch{}}catch{r.textContent="失败"}setTimeout(()=>{r.textContent=o,r.disabled=!1},1200)})),t.querySelectorAll("[data-repo]").forEach(r=>r.addEventListener("click",()=>{try{window.open(r.dataset.repo,"_blank","noopener")}catch{}}))}a(Bs,"fetchCatalogPlugins");async function Sn(t){if(!t)return;let e=[];try{e=await ve()}catch{}let r=Et&&Et.api&&Et.api.list&&Et.api.list()||[];if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}t.innerHTML=r.map(o=>{let p=e.find(h=>h.id===o.id),s=p&&p.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(p.downloads))}</span>`:"",c=o.repo||p&&p.repo?`<button type="button" class="urppp-set-btn ghost" data-repo="${at(o.repo||p.repo)}">仓库</button>`:"";return`<div class="urppp-store-item">
        <div class="urppp-store-row">
          ...
          <div class="urppp-store-ops"><button type="button" class="urppp-set-btn" data-plugin-op="reload" data-plugin-id="${at(o.id)}">重新装载</button><button type="button" class="urppp-set-btn ghost" data-plugin-op="unload" data-plugin-id="${at(o.id)}">卸载</button>${c}</div>
        </div>
        ${o.description?`<p class="urppp-store-item-desc">${at(o.description)}</p>`:""}
      </div>`}).join(""),t.querySelectorAll('[data-plugin-op="reload"]').forEach(o=>o.addEventListener("click",async()=>{o.disabled=!0;let p=o.textContent;o.textContent="装载中…";try{Et&&Et.api&&Et.api.install&&await Et.api.install(o.dataset.pluginId,null),o.textContent="已装载";try{jt()}catch{}}catch{o.textContent="失败"}setTimeout(()=>{o.textContent=p,o.disabled=!1},1200)})),t.querySelectorAll('[data-plugin-op="unload"]').forEach(o=>o.addEventListener("click",()=>{try{Et&&Et.api&&Et.api.unregister&&Et.api.unregister(o.dataset.pluginId)}catch{}try{jt()}catch{}let p=t.closest(".urppp-store-inline");try{_n(p)}catch{}})),t.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(Sn,"fetchPluginManage");function _n(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
          <button type="button" class="urppp-store-tab ac" data-tab="download">插件下载</button>
          <button type="button" class="urppp-store-tab" data-tab="manage">插件管理</button>
        ...
        <div class="urppp-store-body">
          <div class="urppp-store-pane" data-pane="download"><div class="urppp-store-empty"><p class="urppp-store-empty-title">加载中…</p></div></div>
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${fn()}<button type="button" class="urppp-set-btn ghost" data-add-local-plugin style="width:100%;margin:0 0 10px">＋ 添加本地插件</button><input type="file" accept=".js,.txt" data-local-plugin-file style="display:none"><div class="urppp-store-bd" id="urppp-plugin-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div>
        </div>
      </div>`,hn(t),wn(t),Fs(t),Bs(t.querySelector('[data-pane="download"]')),Sn(t.querySelector("#urppp-plugin-manage"))}a(_n,"renderPluginStoreBody");function Fs(t){let e=t.querySelector("[data-add-local-plugin]"),r=t.querySelector("[data-local-plugin-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let p=await o.text();r.value="";try{new Function(p)()}catch(s){Ge("本地插件加载失败："+(s&&s.message?s.message:s),"error")}try{Sn(t.querySelector("#urppp-plugin-manage"))}catch{}}))}a(Fs,"bindLocalPluginImport");function Ds(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>Da("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=te();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}let p=xe(),s=u.filter(c=>c.installed!==!1||ge(c.id)).concat(Object.keys(p).filter(c=>!u.some(h=>h.id===c)).map(c=>({id:c,name:p[c].name||c,desc:p[c].desc||"本地主题",version:p[c].version||"1.0.0",installed:!1})));s.forEach(c=>{let h=!!p[c.id],b=document.createElement("div");b.className="urppp-skin-card"+(c.id===o?" is-active":""),b.dataset.skin=c.id;let _=document.createElement("button");_.type="button",_.className="urppp-skin-apply";let M=c.installed!==!1||ge(c.id)||h;M?c.id===o&&(c.ready||h)?(_.classList.add("is-current"),_.textContent="使用中",_.disabled=!0):_.textContent="应用主题":(_.classList.add("is-disabled"),_.textContent="去下载"),_.addEventListener("click",N=>{if(N.preventDefault(),N.stopPropagation(),!M){Da("theme");return}if(!(c.id===o&&c.ready)&&Oo(c.id)){jt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),b.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),b.querySelector(".urppp-skin-name").textContent=c.name,b.querySelector(".urppp-skin-desc").textContent=c.desc,b.appendChild(_),r.appendChild(b)});try{let c=s.map(h=>{let b="";try{b=GM_getValue("urppp_card_css_"+h.id,"")||""}catch{}return{id:h.id,cardCss:b}});Ce(c)}catch{}}a(Ds,"renderSkinCards");let Je=[],Ra=!1;function js(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,p=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(s=>{if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).finally(()=>{p&&clearTimeout(p)})}a(js,"fetchWithTimeout");function Os(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(p=>{p.status>=200&&p.status<400?r(p.responseText||""):o(new Error("HTTP "+p.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(p){o(p)}})}a(Os,"gmRequestForUpdate");function Hs(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),js(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return Os(t,r);throw o})}a(Hs,"fetchTextForUpdate");async function Ua(t,e,r=1e3){let o=[],p=t[0],s=t.slice(1),c=a(L=>Hs(L,e).then(D=>({url:L,text:D})).catch(D=>(o.push((L.split("/")[2]||L)+": "+(D&&D.message||D)),null)),"grab"),h=c(p),b=new Promise(L=>setTimeout(()=>L("__TIMEOUT__"),r)),_=await Promise.race([h,b]);if(_!=="__TIMEOUT__"){if(_&&_.text&&_.text.length>0)return _.text;let D=(await Promise.all(s.map(c))).find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let M=Promise.all(s.map(c)).then(L=>{let D=L.find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),N=h.then(L=>{if(L&&L.text&&L.text.length>0)return L.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([N,M])}a(Ua,"fetchFirstAvailable");function Le(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(Le,"setUpdateStatus");async function Wa(){let t=n,e="",r=!1,o="";try{let s=await Ua(i.sourceUrls(i.versionJson)),c=JSON.parse(s);e=String(c&&c.version||"").trim(),c&&String(c.prevVersion||"").trim()===t&&(r=!0),c&&typeof c.changelog=="string"&&c.changelog.trim()&&(o=c.changelog)}catch{}if(!e){let s=await Ua(i.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=uo(s)}if(!e)throw new Error("无法解析远程主插件版本");let p=_r(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:p>0?"update":p===0?"latest":"ahead",updateUrl:i.mainRaw,pageUrl:i.greasySearch,changelogMd:r?o:""}}a(Wa,"checkMainUpdate");function En(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let p=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,s=[],c;for(;(c=p.exec(o))!==null;)s.push({ver:c[1],index:c.index,headEnd:p.lastIndex});if(!s.length)return"";for(let b=0;b<s.length;b++){let _=b+1<s.length?s[b+1].index:o.length;s[b].body=o.slice(s[b].index,_).trim()}let h=[];for(let b of s)_r(b.ver,r)>0||_r(b.ver,e)<=0||h.push(b.body);return h.join(`

`).trim()}a(En,"extractChangelogRange");function Cn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(Cn,"ensureUpdateToastStyles");function Rs(t){let e=String(t||"").replace(/\r\n/g,`
`).trim();if(!e)return'<p class="uuc-meta">暂无更新日志</p>';let r=a(h=>{let b=at(h);return b=b.replace(/`([^`]+)`/g,"<code>$1</code>"),b=b.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),b=b.replace(/\[([^\]]+)\]\((https?:\/\/[^)\s]+)\)/g,'<a href="$2" target="_blank" rel="noopener noreferrer">$1</a>'),b=b.replace(/(^|[^"'>])(https?:\/\/[^\s<]+)/g,'$1<a href="$2" target="_blank" rel="noopener noreferrer">$2</a>'),b},"inline"),o=e.split(`
`),p=[],s=!1,c=a(()=>{s&&(p.push("</ul>"),s=!1)},"closeList");for(let h=0;h<o.length;h++){let _=o[h].replace(/\s+$/,"");if(!_.trim()){c();continue}let M=_.match(/^(#{2,3})\s+(.+)$/);if(M){c();let L=M[1].length,D=M[2];p.push(L===2?`<h2>${r(D)}</h2>`:`<h3>${r(D)}</h3>`);continue}let N=_.match(/^[-*]\s+(.+)$/);if(N){s||(p.push("<ul>"),s=!0),p.push(`<li>${r(N[1])}</li>`);continue}c(),p.push(`<p>${r(_)}</p>`)}return c(),p.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(Rs,"renderChangelogMarkdown");function Pn(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(p=>{p&&p.target!==e||p&&p.propertyName&&p.propertyName!=="opacity"&&p.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(Pn,"hideUpdateToast");function Us(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(p=>{p&&p.target!==e||p&&p.propertyName&&p.propertyName!=="opacity"&&p.propertyName!=="background-color"&&p.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(Us,"hideChangelogModal");function Ln(t,e){Cn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,r.addEventListener("click",o=>{(o.target===r||o.target&&o.target.getAttribute&&o.target.getAttribute("data-close")==="1")&&Us(r)}),document.documentElement.appendChild(r)),r.querySelector("h3").textContent=t||"更新日志",r.querySelector(".uuc-body").innerHTML=e||'<p class="uuc-meta">暂无更新日志</p>',r.__closing=!1,r.classList.remove("open","closing"),r.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add("open"))})}a(Ln,"openChangelogModal");function Ga(t){Cn();let e=document.getElementById("urppp-update-toast");e||(e=document.createElement("div"),e.id="urppp-update-toast",e.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>Pn(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let p=o.getAttribute("data-act"),s=e.__pack||{};if(p==="later"){Pn(e);return}if(p==="go"){let c=s.updateUrl||i.mainRaw;try{window.open(c,"_blank","noopener,noreferrer")}catch{location.href=c}return}if(p==="log"){o.disabled=!0,o.textContent="加载中…";try{let c=s.changelogMd;c||(c=await Ua(i.sourceUrls("CHANGELOG.md")),s.changelogMd=c);let h=En(c,s.local,s.remote),b=h?Rs(h):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+i.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';Ln("更新日志 "+s.local+" → "+s.remote,b)}catch(c){Ln("更新日志","<p>加载失败："+at(c&&c.message||c)+'</p><p><a href="'+i.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(Ga,"showUpdateToast");async function Ja(){if(wa()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await Wa();t&&t.status==="update"&&Ga(t);let e=await Ws();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Ja,"maybeAutoCheckUpdate");function Ws(){let t=(window.__urpppUpdateCheckers||Je||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?Et.update("assist"):null).catch(()=>null)}a(Ws,"hotUpdateAssist");async function Va(){if(Ra)return;Ra=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Le("正在从多源检查更新…");try{let e=[Wa()];(Je||[]).forEach(b=>{b&&typeof b.check=="function"&&e.push(Promise.resolve().then(()=>b.check()).then(_=>_||{id:b.id||"extra",name:b.name||"扩展",status:"err",message:"无结果"}).catch(_=>({id:b.id||"extra",name:b.name||"扩展",status:"err",message:String(_&&_.message||_)})))});let r=await Promise.all(e),o=r.map(b=>{if(!b)return"";if(b.status==="err")return`• <b>${at(b.name||b.id)}</b>：检查失败（${at(b.message||"unknown")}）`;if(b.status==="update"){let _="";if(b.id==="assist"&&Et&&Et.loaded("assist"))_=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let M=b.updateUrl?` <a href="${at(b.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",N=b.pageUrl?` <a href="${at(b.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";_=M+N}return`• <b>${at(b.name)}</b>：发现新版本 <b>${at(b.remote)}</b>（当前 ${at(b.local)}）${_}`}return b.status==="ahead"?`• <b>${at(b.name)}</b>：本地 ${at(b.local)} 新于远程 ${at(b.remote)}`:`• <b>${at(b.name)}</b>：已是最新（${at(b.local)}）`}).filter(Boolean),p=r.some(b=>b&&b.status==="update"),s=r.some(b=>b&&b.status==="err");Le(`${p?"检查完成：发现更新":s?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${i.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,s?"err":"ok");let h=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');h&&h.addEventListener("click",()=>{try{Le("正在重新装载辅助插件…",""),Et.install("assist").then(()=>{Le("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(b=>{Le("重新装载失败："+(b&&b.message?b.message:b),"err")})}catch(b){Le("重新装载失败："+(b&&b.message?b.message:b),"err")}})}catch(e){Le("检查失败："+at(e&&e.message||e),"err")}finally{Ra=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(Va,"checkForUpdates");function zn(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+n,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(zn,"refreshUpdateStatusHint");function Gs(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=Je.findIndex(p=>p&&p.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?Je[r]=o:Je.push(o);try{let p=document.getElementById("urppp-set-update-status");p&&o.localVersion&&e==="assist"&&p.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{zn()}catch{}return!0}a(Gs,"registerUpdateChecker");function Js(){let t={version:n,urls:i,check:Va,checkMain:Wa,registerChecker:Gs,compareVersions:_r,parseUserscriptVersion:uo,extractChangelogRange:En,showUpdateToast:Ga,maybeAutoCheckUpdate:Ja,listCheckers:a(()=>Je.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(Js,"publishUpdateApi"),Js();let{rebuildSidebarCompletely:qn,syncMobileContentOffset:Ve,syncSidebarUnderNavbar:ze}=Qp({}),{rebuildDashboard:Vs}=jp({deps:{statCardPrivacyMarkup:Zs}}),Ys="urppp-clean-open",Ya={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ce(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ce,"isUnevaluatedScore");function Vr(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Vr,"isValidOfficialGpa");function Yr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Yr,"firstContentChar");function Qa(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Qa,"weekBitmapActive");function Ye(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ce(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Ya[o]!=null?Ya[o]:Ya[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ye,"scoreToGpa");function Qe(t){let e=String(t||"").trim();if(!e||ce(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(Qe,"scoreToNumber");function qe(t){return Math.round((Number(t)||0)*100)/100}a(qe,"round2");function Tn(t){return/必修/.test(String(t||""))}a(Tn,"isRequiredAttr");function ae(t){let e=0,r=0,o=0,p=0,s=0,c=0,h=0,b=0;return(t||[]).forEach(_=>{if(_&&(_.unevaluated||ce(_.score)))return;let M=Number(_.credit)||0,N=Qe(_.score),L=Vr(_.officialGpa)?Number(_.officialGpa):Ye(_.score);N==null||M<=0||(e+=M,r+=N*M,L!=null&&(o+=L*M,p+=M),_.required&&(s+=M,c+=N*M,L!=null&&(h+=L*M,b+=M)))}),{totalCredit:qe(e),avgScore:qe(e?r/e:0),avgGpa:qe(p?o/p:0),requiredCredit:qe(s),requiredGpa:qe(b?h/b:0),requiredAvg:qe(s?c/s:0),count:(t||[]).length}}a(ae,"summarizeCourses");function Xa(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Xa,"absUrl");function Yt(t,e){let r=Xa(t),o=e&&e.method||"GET",p=e&&e.data||null;return new Promise((s,c)=>{let h=a((b,_)=>b?s(_):c(new Error(_||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:p||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(b=>{b.status>=200&&b.status<400?h(!0,b.responseText||""):h(!1,"HTTP "+b.status)},"onload"),onerror:a(()=>h(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:p||void 0}).then(b=>{if(!b.ok)throw new Error("HTTP "+b.status);return b.text()}).then(b=>h(!0,b)).catch(b=>h(!1,b&&b.message))})}a(Yt,"fetchText");function Qr(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Qr,"parseHtml");function Mn(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=bp,(document.head||document.documentElement).appendChild(t)}a(Mn,"ensureFeatureStyles");function Qs(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=gp,(document.head||document.documentElement).appendChild(t)}a(Qs,"ensureScheduleExportStyles");function Xs(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=xp,(document.head||document.documentElement).appendChild(t)}a(Xs,"ensureSettingsStyles");function $n(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let p=r.cloneNode(!0);p.querySelectorAll("small, i, img, b, .badge").forEach(h=>h.remove());let s=(p.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(h=>{h.nodeType===Node.TEXT_NODE&&h.textContent.trim()&&h.remove()});let c=document.createElement("span");return c.className="urppp-user-name-value",c.textContent=s||"同学",c.__urpppOriginalText=c.textContent,r.appendChild(c),c}a($n,"ensureNavNameTarget");function Xr(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Xr,"classifyPrivacyLabel");function Ks(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(Ks,"classifyHomeDataKey");function Kr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Kr,"homePrivateValueSpan");function Zs(t,e){let r=at(t),o=at(e),p=Ks(t,e),c={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[p]||Xr(String(t||"")+" "+String(e||""));if(c==="organization")return e?{valueHtml:r,labelHtml:Kr("organization",p,o)}:{valueHtml:Kr("organization",p,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(c))return{valueHtml:r,labelHtml:o};let h=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&h){let _=h.index||0,M=String(e).slice(0,_),N=String(e).slice(_+h[0].length);return{valueHtml:r,labelHtml:`${at(M)}${Kr(c,p,at(h[0]))}${at(N)}`}}return{valueHtml:Kr(c,p,r),labelHtml:o}}a(Zs,"statCardPrivacyMarkup");function Te(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||zr;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||zr)}a(Te,"privacyReplacement");function gr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(gr,"markPrivateText");function In(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||zr);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(In,"markPrivateAvatar");function tl(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(tl,"markPrivateBlock");function el(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(el,"markDirectEditable");let we=null;function Nn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;we&&we.__finish&&we.__finish(!1);let r=Ee();if(r.mode!=="custom"||!r.directEdit.enabled)return;let p=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),s=t.getBoundingClientRect(),c=t.parentElement?.getBoundingClientRect(),h=s.height>=8||!c?s:{left:s.left,top:c.top,width:Math.max(s.width,40),height:c.height},b=document.createElement("input"),_=getComputedStyle(t),M=Math.min(Math.max(h.width+64,140),Math.max(140,window.innerWidth-24)),N=Math.min(Math.max(12,h.left),Math.max(12,window.innerWidth-M-12)),L=Math.min(Math.max(12,h.top+(h.height-36)/2),Math.max(12,window.innerHeight-48));b.type="text",b.maxLength=80,b.className="urppp-direct-edit-input",b.value=p,b.setAttribute("aria-label","修改"+U[e]+"显示值"),b.style.left=N+"px",b.style.top=L+"px",b.style.setProperty("--urppp-direct-edit-width",M+"px"),b.style.fontFamily=_.fontFamily,b.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(_.fontSize)||14)))+"px";let D=!1,J=a(O=>{if(D||(D=!0,b.remove(),we===b&&(we=null),O))return;let R=Ee();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(b.value||"").trim().slice(0,80),ka(R),Qt(document),ro(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");b.__finish=J,b.addEventListener("click",O=>O.stopPropagation()),b.addEventListener("blur",()=>J(!1)),b.addEventListener("keydown",O=>{O.key==="Enter"&&(O.preventDefault(),J(!1)),O.key==="Escape"&&(O.preventDefault(),J(!0))}),document.documentElement.appendChild(b),we=b,b.focus(),b.select()}a(Nn,"openDirectEditInput");function rl(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Nn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Nn(e))},!0))}a(rl,"bindDirectEditInteraction");function al(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(al,"clearPrivacyDisplay");function Bn(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(Bn,"applyCustomText");function ol(t){let e=t&&t.querySelectorAll?t:document,r=De(),p=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?$n(e):null);Bn(p,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(h=>{let b=h.querySelector(".profile-info-name"),_=h.querySelector(".profile-info-value");!b||!_||String(b.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||Bn(_,r.nameEnabled,r.name)});let s=sr(r.avatar),c=r.avatarEnabled&&!!s;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(h=>{let b=h.getAttribute("src")||"";b&&b!==h.__urpppAppliedCustomSrc&&(h.__urpppOriginalSrc=b),c?(h.__urpppOriginalSrc==null&&(h.__urpppOriginalSrc=b),b!==s&&h.setAttribute("src",s),h.__urpppAppliedCustomSrc=s):h.__urpppAppliedCustomSrc!=null&&(h.__urpppOriginalSrc&&h.setAttribute("src",h.__urpppOriginalSrc),delete h.__urpppAppliedCustomSrc)})}a(ol,"applyCustomIdentityDisplay");function nl(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),p=r.querySelector(".profile-info-value, td:last-child");if(!o||!p||o===p)return;let s=Xr(o.textContent),c=Te(e,s);c&&gr(p,c)})}a(nl,"applyProfilePrivacy");function il(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let p=o.map(s=>{let c=Xr(s.textContent);return["grade","gpa","credit"].includes(c)?c:""});p.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(s=>{let c=s.querySelectorAll("td");p.forEach((h,b)=>{let _=Te(e,h);h&&_&&gr(c[b],_)})})})}a(il,"applyScoreTablePrivacy");function pl(t){let e=t&&t.querySelectorAll?t:document,r=Ee();if(r.mode==="off")return;let o=Te(r,"name"),p=Te(r,"avatar"),s=Te(r,"schedule"),c=o?$n(e):e.querySelector?.(".urppp-user-name-value");o&&gr(c,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([_,M])=>{let N=Te(r,M);N&&e.querySelectorAll(_).forEach(L=>gr(L,N))}),il(e,r);let b=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(_=>{let M=_.getAttribute("data-urppp-private"),N=_.getAttribute("data-urppp-edit-key"),D=(b&&N?String(r.directEdit.values[N]||"").trim():"")||Te(r,M);!["avatar","schedule"].includes(M)&&D&&gr(_,D),b&&N&&el(_,N)}),b&&rl(),nl(e,r),p&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(_=>{let M=_.matches("img")?_:_.querySelector("img");M?In(M,p):(_.classList.add("urppp-private-avatar-block"),_.setAttribute("data-urppp-private-mask",p))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(_=>In(_,p))),s){let _=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));_.filter(M=>!_.some(N=>N!==M&&N.contains(M))).forEach(M=>tl(M,s))}}a(pl,"applyPrivacyDisplay");let Ka=0,de=[];function Fn(){let t=Ee(),e=De();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(Fn,"personalDisplayIsEnabled");function sl(){de=de.filter(({root:t})=>t&&t.isConnected),de.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(sl,"resumePersonalDisplayObservers");function Qt(t){let e=t||document;de.forEach(({observer:r})=>r.disconnect());try{Mn()}catch{}try{al(e)}catch{}try{ol(e)}catch(r){console.warn("[URP++] custom identity",r)}try{pl(e)}catch(r){console.warn("[URP++] privacy",r)}Fn()?(sl(),cl()):(clearTimeout(Ka),de=[])}a(Qt,"applyPersonalDisplay");function ll(t){clearTimeout(Ka),Ka=setTimeout(()=>Qt(t||document),140)}a(ll,"schedulePersonalDisplay");function Za(){try{nt&&nt.open&&rr()}catch{}}a(Za,"refreshCleanPersonalDisplay");function cl(){if(!Fn()){de.forEach(({observer:t})=>t.disconnect()),de=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(de.some(r=>r.root===t))return;let e=new MutationObserver(()=>ll(document));de.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(cl,"bindPersonalDisplayObservers");function dl(t){let e=Object.assign({},t||{}),r=De();r.nameEnabled&&r.name&&(e.name=r.name);let o=sr(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(dl,"personalizedProfile");let Dn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",ul="/student/courseSelect/thisSemesterCurriculum/callback",ml="/student/courseSelect/thisSemesterCurriculum/index";async function bl(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Yt(ul),r=JSON.parse(e),o=pr(r);if(o)return o}catch{}return""}a(bl,"resolveSchedulePlanCode");async function jn(t){let e=await bl(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Yt(Dn,r),p;try{p=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=pr(p)),(!p.jcsjbs||!p.jcsjbs.length)&&e&&(p=JSON.parse(await Yt(Dn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let s=Hn(p,e,t);if(!s.courses.length)throw new Error("没有读取到可导出的课表数据");return s}a(jn,"loadScheduleExportData");function to(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(to,"safeScheduleFilename");function eo(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(eo,"downloadBlob");function hl(t){let e=na(t),r=Nr(),o=r.enabled?pa(e,r.mapping):ia(e),p=JSON.stringify(o,null,2)+`
`;return eo(new Blob([p],{type:"application/json;charset=utf-8"}),to(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(hl,"exportScheduleJson");function On(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(c=>c.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let p=Number(r[4]);if(p<1||p>30)return"";let s=xo(new Date);return s.setDate(s.getDate()-(p-1)*7),Lr(s)}a(On,"deriveCurrentSemesterMonday");function Hn(t,e,r){let o=e||pr(t),p=On(o)||Aa()[o]||"";return $i(t,o,r,{firstMonday:p})}a(Hn,"normalizeScheduleDataForPage");function fl(t){let e=t.semester.planCode,r=Aa()[e],o=On(e);return o?(To(e,o),Promise.resolve(o)):ir(r)?Promise.resolve(r):new Promise((p,s)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let c=document.createElement("div");c.className="urppp-dialog-mask",c.dataset.dialog="schedule-date",c.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||Li(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(c);let h=a((b,_)=>{c.remove(),b?s(b):p(_)},"close");c.querySelector('[data-action="cancel"]').addEventListener("click",()=>h(new Error("已取消导出"))),c.querySelector('[data-action="ok"]').addEventListener("click",()=>{let b=c.querySelector("input").value;ir(b)&&(To(e,b),h(null,b))}),c.addEventListener("click",b=>{b.target===c&&h(new Error("已取消导出"))})})}a(fl,"requestScheduleFirstMonday");async function gl(t){let e=await fl(t),r=qi(t,e);return eo(new Blob([r],{type:"text/calendar;charset=utf-8"}),to(t.semester.label)+".ics"),Ti(t)}a(gl,"exportScheduleIcs");let xl={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function ue(t,e,r){if(typeof document>"u")return Jt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let p=getComputedStyle(o).color;o.remove();let s=String(p||"").match(/[\d.]+/g)?.map(Number)||[];if(s.length>=3){let c=Sr(s[0],s[1],s[2]),h=s.length>3?Math.max(0,Math.min(1,s[3])):1;return h<1?Ft(r||e,c,h):c}return Jt(p)||Jt(e)||"#000000"}a(ue,"resolvedScheduleImageColor");function Rn(){let t=Vt(),e=te(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},p={bg:ue("--bg",o.bg),surface:ue(e==="neu"?"--neu-base":"--surface",o.surface),input:ue("--input-bg",o.input),text:ue("--text",o.text),secondary:ue("--text-secondary",o.secondary),muted:ue("--text-muted",o.muted),border:ue("--border",o.border,ue(e==="neu"?"--neu-base":"--surface",o.surface)),primary:ue("--primary",o.primary)},s={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(xl[e]||e)+" · "+(Pt[t]&&Pt[t].name||t),colors:p,shape:s[e]||s.apple}}a(Rn,"currentScheduleImageTheme");function Un(t,e){return Ri(t,e||Rn())}a(Un,"buildScheduleSvg");function yl(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),p=URL.createObjectURL(o),s=new Image;s.onload=()=>{try{let h=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),b=document.createElement("canvas");b.width=Math.floor(t.width*h),b.height=Math.floor(t.height*h);let _=b.getContext("2d");_.scale(b.width/t.width,b.height/t.height),_.fillStyle=t.background||"#F8FAFC",_.fillRect(0,0,t.width,t.height),_.drawImage(s,0,0,t.width,t.height),b.toBlob(M=>M?e(M):r(new Error("无法生成课表图片")),"image/png")}catch(c){r(c)}finally{URL.revokeObjectURL(p)}},s.onerror=()=>{URL.revokeObjectURL(p),r(new Error("课表图片渲染失败"))},s.src=p})}a(yl,"svgToPngBlob");async function vl(t){let e=await yl(Un(t));eo(e,to(t.semester.label)+".png")}a(vl,"exportSchedulePng");function ro(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(ro,"showFeatureToast");let ao=Ui({document,window,ensureStyles:Qs,loadData:jn,exportJson:hl,exportIcs:gl,exportPng:vl,showToast:ro,nativePageUrl:ml,navigate:a(t=>{location.href=t},"navigate"),logger:console});function wl(t,e,r,o){return ao.run(t,e,r,o)}a(wl,"runScheduleExport");function kl(t){return ao.createMenu(t)}a(kl,"createScheduleExportMenu");function Al(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(Al,"disposeNativePdfCapture");function Sl(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let p=cp(e);t.stage="ok",t.stageCards=p.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=p.target.querySelector("table")?p.target.querySelector("table").id:"none",Al(p)}catch(p){t.stage="failed",t.stageError=p&&p.message||String(p)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(Sl,"bindNativePdfDiagnose");function _l(t){return t?(Sl(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await mp(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:br})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),ro("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(_l,"pagePdfExportHandler");function oo(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(oo,"isPersonalSchedulePage");function El(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(El,"isScoreQueryPage");function no(){if(!oo())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(c=>[c.textContent,c.getAttribute("title"),c.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(c=>{/打印.*课表|\bdy\s*\(/i.test(o(c))&&c.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let p=r.find(c=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(c))),s=kl({source:"native",pdfHandler:_l(p)});if(s.id="urppp-native-schedule-export",p&&p.parentElement){p.__urpppNativeExportState||(p.__urpppNativeExportState={display:p.style.getPropertyValue("display"),displayPriority:p.style.getPropertyPriority("display"),ariaHidden:p.getAttribute("aria-hidden"),tabIndex:p.getAttribute("tabindex")}),p.setAttribute("data-urppp-native-export-source","1"),p.style.setProperty("display","none","important"),p.setAttribute("aria-hidden","true"),p.setAttribute("tabindex","-1"),p.parentElement.insertBefore(s,p.nextSibling);return}if(e)e.appendChild(s);else if(t)t.appendChild(s);else{let c=document.getElementById("page-content-template")||document.querySelector(".page-content");if(c){let h=document.createElement("div");h.className="urppp-export-fallback",h.appendChild(s),c.prepend(h)}}}a(no,"patchNativeScheduleExport");let Xe=null,Zr=0;function io(){clearTimeout(Zr),Zr=0,Xe&&Xe.observer.disconnect(),Xe=null}a(io,"disconnectNativeScheduleExportObserver");function Cl(){if(!oo()){io();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Xe&&Xe.root===t&&t.isConnected)return;io();let e=new MutationObserver(()=>{clearTimeout(Zr),Zr=setTimeout(()=>no(),80)});e.observe(t,{childList:!0,subtree:!0}),Xe={root:t,observer:e}}a(Cl,"bindNativeScheduleExportObserver");function Wn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(Wn,"restoreOptionalAttribute");function Pl(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let p=o.__urpppNativeExportState;p&&(p.display?o.style.setProperty("display",p.display,p.displayPriority):o.style.removeProperty("display"),Wn(o,"aria-hidden",p.ariaHidden),Wn(o,"tabindex",p.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(Pl,"removeNativeScheduleExport");let Gn=Vp({deps:{styles:Ap,loadScores:ii,loadProfile:Jn,scoreToNumber:Qe,scoreToGpa:Ye,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),Ll=gi([aa({id:"schedule-export",matches:a(t=>oo(t.location),"matches"),mount:a(()=>{no(),Cl()},"mount"),unmount:a(t=>{io(),Pl(t?.lifecycleKey)},"unmount")}),aa({id:"score-analysis",matches:a(t=>El(t.location),"matches"),mount:a(()=>{try{Gn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Gn.unmount()}catch{}},"unmount")})]);function ta(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return Ll.refresh({document,location,window,lifecycleKey:t})}a(ta,"refreshRouteFeatures");function zl(t){ao.bindHosts(t)}a(zl,"bindScheduleExportHosts");function xr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(xr,"normalizeProfileValue");function ea(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(p=>xr(p).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let p=0;p<o.length;p++){let s=o[p],c=s.querySelector(".profile-info-name, th, label"),h=s.querySelector(".profile-info-value, td:last-child");if(!c||!h||c===h)continue;let b=xr(c.textContent).replace(/[：:]/g,"");if(!r.some(M=>b===M||b.endsWith(M)))continue;let _=xr(h.textContent);if(_&&_!=="—"&&_!=="-")return _}return""}a(ea,"readLabeledProfileValue");function Ke(t){return xr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Ke,"cleanMajorPlanName");function ql(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),p=xr(o);if(/主修必修GPA/.test(p)){let s=p.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||p.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(s){let c=Number(s[1]),h=Number(e.majorGpa);Number.isFinite(c)&&c>=0&&c<=5&&(!e.majorGpa||h===0||c>0)&&(e.majorGpa=s[1])}}if(/主修为|培养方案/.test(p)){let s=p.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||p.match(/^(.{2,60}?)\s*主修为/)||p.match(/主修为\s*(.{2,60})$/),c=Ke(s&&s[1]);if(c&&!/GPA|已修读|尚不及格|本学期/.test(c)){let h=/培养方案|教学计划/.test(c);(!e.majorPlan||h)&&(e.majorPlan=c)}}}),e}a(ql,"extractAcademicOverview");async function Jn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let s=r.querySelector(".urppp-user-name-value"),c=s&&s.__urpppOriginalText;c&&(t.name=String(c).trim());let h=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),b=t.name?null:h.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!b){let _=r.cloneNode(!0);_.querySelectorAll("small, i, img, b, .badge").forEach(N=>N.remove());let M=(_.textContent||"").replace(/\s+/g," ").trim();M=M.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),b=M.match(/([\u4e00-\u9fa5·]{2,12})/)}b&&b[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(b[1])&&(t.name=b[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let p=ql(document);t.majorPlan=p.majorPlan,t.majorGpa=p.majorGpa}catch{}try{let r=await Yt("/student/rollManagement/rollInfo/index"),o=Qr(r),p=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=ea(o,["姓名"]),!t.name)){let b=p.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);b&&(t.name=b[1].trim())}let s=ea(o,["主修方案名称"]),c=ea(o,["专业"]);t.studentId=ea(o,["学号"]),s?t.majorPlan=Ke(s):!t.majorPlan&&c&&(t.majorPlan=Ke(c));let h=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(h&&h.getAttribute("src")&&!t.avatar){let b=h.getAttribute("src");t.avatar=/^https?:/i.test(b)?b:Xa(b)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(Jn,"loadProfile");let Vn=["周日","周一","周二","周三","周四","周五","周六"];function po(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(p=>{let s=String(p.id||"").match(/^(\d+)_(\d+)$/);if(!s)return;let c=parseInt(s[1],10),h=parseInt(s[2],10),b=c===7?0:c,_=p.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),M=_.length?_:[];if(!M.length&&(p.textContent||"").trim()){let N=(p.textContent||"").replace(/\s+/g," ").trim();N&&e.push({name:N.slice(0,40),teacher:"",place:"",week:"",day:b,section:h});return}M.forEach(N=>{let L=Array.from(N.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),D=(N.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||L[0]||"",J=(N.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",O=L.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=L.find(K=>/周/.test(K))||"",F=String(D).replace(/_\d+\s*$/,"").trim();!F||F.length<2||e.push({name:F,teacher:String(O).trim(),place:String(J||"").trim(),week:String(R).trim(),day:b,section:h})})});let o=new Set;return e.filter(p=>{let s=[p.day,p.section,p.name,p.place].join("|");return o.has(s)?!1:(o.add(s),!0)})}a(po,"parseScheduleFromDoc");let Yn="urppp_term_week_v1";function Ze(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(Yn,e)}catch{}return e}a(Ze,"rememberTermWeek");function yr(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(Yn,0))||0;if(t>=1&&t<=30)return Ze(t)}catch{}return 0}a(yr,"readRememberedTermWeek");function vr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let p=e.match(r[o]);if(p){let s=parseInt(p[1],10);if(s>=1&&s<=30)return s}}return 0}a(vr,"extractTermWeekFromText");function Me(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let c=0;c<t.length;c++){let h=t[c],b=vr(h.innerText||h.textContent||"")||vr(h.innerHTML||"");if(b)return Ze(b)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=vr(e);if(r)return Ze(r);let o=document.body&&document.body.innerText||"",p=vr(o);if(p)return Ze(p);let s=yr();if(s)return s}catch{}return 0}a(Me,"getCurrentWeekNumber");let tr=null;function Tl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(Tl,"calTodayStr");function Ml(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(p=>String(p).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(Ml,"calAddDays");function wr(t){if(tr)return tr;let e=t||Tl();return e>="2027-02-06"&&e<=Ml("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(wr,"calVacation");function $l(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a($l,"festiveDecorHtml");function Qn(){let t=typeof document<"u"?document:null;if(!t)return;let e=wr()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",$l()):!e&&r&&r.remove()}a(Qn,"syncFestiveDecor");function Xn(t){tr=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,tr&&tr!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{Qn()}catch{}try{typeof rr=="function"&&rr()}catch{}return tr}a(Xn,"setCalendarPhase");function Il(){return wr()}a(Il,"getCalendarPhase");function Kn(){if(wr()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=Me()||yr()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(Kn,"getViewWeekNumber");async function Nl(){let t=Me();if(t>=1)return t;try{let e=await Yt("/index");if(t=vr(e),t)return Ze(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),p=await Yt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),s=JSON.parse(p),c=Number(s&&s.jxzc);if(c>=1&&c<=30)return Ze(c)}catch{}return yr()||0}a(Nl,"ensureTermWeekResolved");function Bl(t){let e=Me()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let p=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);p&&(e=Math.max(e,parseInt(p[2],10)||0));let s=String(r.week||"").match(/\d{1,2}/g);s&&s.forEach(c=>{e=Math.max(e,parseInt(c,10)||0)})}),Math.min(Math.max(e,1),30)}a(Bl,"inferMaxWeek");function Zn(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Zn,"weekBitActive");let ti=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function ei(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return ti[e%ti.length]}a(ei,"courseColor");function Fl(t){let e=[],r=Me();(t&&t.xkxx||[]).forEach(s=>{Object.keys(s||{}).forEach(c=>{let h=s[c];if(!h)return;let b=h.courseName||h.englishCourseName||c,_=h.attendClassTeacher||"";(h.timeAndPlaceList||[]).forEach(N=>{let L=Number(N.classDay)||0,D=L===7?0:L,J=Number(N.classSessions)||1,O=Math.max(1,Number(N.continuingSession)||1),R=[N.campusName,N.teachingBuildingName,N.classroomName].filter(Boolean).join(""),F=N.weekDescription||h.skzcs||"",K=Zn(N.classWeek,r)||r&&F.indexOf(String(r))>=0;e.push({name:String(b).trim(),teacher:String(_).trim(),place:String(R).trim(),week:String(F).trim(),classWeek:String(N.classWeek||""),day:D,section:J,span:O,thisWeek:!!K,color:ei(b)})})})});let p=new Set;return e.filter(s=>{let c=[s.day,s.section,s.span,s.name,s.place,s.week].join("|");return p.has(c)?!1:(p.add(c),!0)})}a(Fl,"parseScheduleFromJson");async function Dl(){try{let t=await Yt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let p=Number(r&&(r.jxzc||r.zc||r.currentWeek));p>=1&&p<=30&&(nt._termWeek=Math.max(nt._termWeek||0,p),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=Fl(r)}catch{e=po(Qr(t))}e.length||(e=po(document));let o=r?Hn(r,pr(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=po(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(Dl,"loadSchedule");function jl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),p=r.match(o);if(p&&p[1])return p[1];let s=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),c=r.match(s);return c?c[1]:""}a(jl,"extractScoreCallback");function Ol(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let p=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",s=[];(o.cjList||[]).forEach(c=>{let h=c.courseName||c.englishCourseName||"";if(!h)return;let b=c.cj!=null&&c.cj!==""?String(c.cj):"";!b&&c.courseScore!=null&&(b=String(c.courseScore)),!b&&c.gradeName&&(b=String(c.gradeName)),!b&&c.zscj!=null&&(b=String(c.zscj));let _=c.courseAttributeName||c.xkcsxmc||"",M=parseFloat(c.credit)||0,N=c.id&&(c.id.courseNumber||c.id.kch_zj)||"",L=c.id&&(c.id.coureSequenceNumber||c.id.courseSequenceNumber||c.id.kxh)||c.classNo||"",D=c.gradePointScore!=null?Number(c.gradePointScore):null,J=ce(b)||ce(c.gradeName)||D!=null&&D<0,O=J?"未评估":b;s.push({code:N,seq:String(L||""),name:h,attr:_,credit:M,score:O,unevaluated:J,required:Tn(_),officialGpa:Vr(D)?D:null,evalUrl:""})}),s.length&&e.push({title:String(p).slice(0,100),courses:s,summary:ae(s),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(Ol,"parseScoreJson");async function ri(t,e){let r=await Yt(t),o=ai(Qr(r));if(o.length)return o;let p=jl(r,e);if(!p)return[];let s=await Yt(p);try{let c=JSON.parse(s);o=Ol(c).map(h=>(h.summary=ae(h.courses),h))}catch{o=ai(Qr(s))}return o}a(ri,"loadScoreByIndex");function ai(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map(M=>(M.textContent||"").replace(/\s+/g,""));if(!o.length)return;let p=o.join("|");if(!/课程名/.test(p)||!/成绩/.test(p))return;let s={code:o.findIndex(M=>M==="课程号"),name:o.findIndex(M=>M==="课程名"),attr:o.findIndex(M=>/课程属性|属性/.test(M)),credit:o.findIndex(M=>M==="学分"),score:o.findIndex(M=>M==="成绩")};if(s.name<0||s.score<0)return;let c="成绩",h=r.previousElementSibling;for(let M=0;M<8&&h;M++,h=h.previousElementSibling)if(/^H[1-4]$/.test(h.tagName)||h.classList&&h.classList.contains("header")){c=(h.textContent||"").replace(/\s+/g," ").trim();break}let b=[],_=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(_).forEach(M=>{let N=Array.from(M.cells||M.querySelectorAll("td"));if(N.length<4)return;let L=a(F=>F>=0&&N[F]?(N[F].textContent||"").replace(/\s+/g," ").trim():"","get"),D=L(s.name),J=L(s.score);if(!D||!J||/课程名|序号/.test(D))return;let O=L(s.attr),R=ce(J);b.push({code:L(s.code),name:D,attr:O,credit:parseFloat(L(s.credit))||0,score:R?"未评估":J,unevaluated:R,required:Tn(O),officialGpa:null,evalUrl:""})}),b.length&&e.push({title:c.slice(0,100),courses:b,summary:ae(b)})}),e}a(ai,"parseScoreTables");function kr(t){return Ke(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(kr,"schemePlanName");function oi(t,e){if(!t||!t.length)return 0;let r=Ke(e),o=t.findIndex(c=>{let h=kr(c);return/培养方案/.test(h)&&!/微专业|辅修|双学位/.test(h)});if(o>=0&&(!r||kr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(c=>{let h=kr(c);return h.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(h.slice(0,4))||h.includes(r.slice(0,4))}),o>=0))return o;let p=0,s=-1;return t.forEach((c,h)=>{if(/微专业|辅修/.test(kr(c)))return;let b=(c.courses||[]).length;b>s&&(s=b,p=h)}),p}a(oi,"pickMajorSchemeIndex");async function Hl(){let t={};try{let e=await Yt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(p=>{let s=String(p.KCH||"").trim();if(!s)return;let c=String(p.SFPG)==="1",h=String(p.KTID||"").trim();if(!t[s]){t[s]={ktid:h,kxh:String(p.KXH||""),kcm:p.KCM||"",done:c,pending:c?0:1,total:1,url:!c&&h?"/student/teachingEvaluation/newEvaluation/evaluation/"+h:"/student/teachingEvaluation/newEvaluation/index"};return}t[s].total+=1,c||(t[s].pending+=1,t[s].done=!1,h&&(t[s].ktid=h,t[s].url="/student/teachingEvaluation/newEvaluation/evaluation/"+h))}),Object.keys(t).forEach(p=>{let s=t[p];s.done=!(s.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(Hl,"loadEvaluationMap");function Rl(t){if(!t)return!1;if(t.officialGpa!=null&&Vr(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ce(e)?!1:Qe(e)!=null||Ye(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(Rl,"hasDisplayableScore");function Ul(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(p=>{if(!p||!p.code)return;let s=e[p.code];if(s){if(Rl(p)){p.unevaluated=!1,s.done?p.evalUrl=p.evalUrl||"":p.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index";return}s.done||(p.unevaluated=!0,p.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index",(!p.score||p.score===""||ce(p.score))&&(p.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(Ul,"attachEvaluationLinks");function ni(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=ae(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=ae(e.courses),e)),t)}a(ni,"refreshScoreSummaries");async function Wl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await Hl();return Ul(t,e),t.evalMap=e,t.evaluationReady=!0,ni(t)}finally{t.evaluationLoading=!1}}a(Wl,"enrichScoresWithEvaluation");function Gl(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=oi(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let p=kr(o),s=Ke(nt.profile.majorPlan);/培养方案|教学计划/.test(p)&&(!/培养方案|教学计划/.test(s)||s==="主修方案")&&(nt.profile.majorPlan=p);let c=o.summary||{},h=Number(c.requiredCredit),b=Number(c.requiredGpa),_=Number(nt.profile.majorGpa);h>0&&Number.isFinite(b)&&b>=0&&b<=5&&(!Number.isFinite(_)||_<=0)&&(nt.profile.majorGpa=String(qe(b)))}a(Gl,"reconcileProfileAndScores");let er=null;async function ii(t){return t&&(er=null),er&&!er.error||(er=await Jl()),er}a(ii,"loadScores");async function Jl(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([ri("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),ri("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(p=>p.courses.forEach(s=>{o.push(Object.assign({term:p.title},s))})),t.passing=[{title:"全部及格成绩",courses:o,summary:ae(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:ae(o)}]),ni(t),t.majorIdx=oi(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(Jl,"loadScoresImpl");function $e(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a($e,"parseJsonArrayLoose");function pi(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let p=0;for(let s=o;s<t.length&&s<o+3e5;s++){let c=t[s];if(c==="[")p++;else if(c==="]"&&(p--,p===0))return t.slice(o,s+1)}return""}a(pi,"extractBalancedArray");async function Vl(){let t=await Yt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let s=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],c=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(s&&(e=$e(s)),c&&(r=$e(c)),!e.length){let h=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(e=$e(h[1]))}if(!r.length){let h=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);h&&(r=$e(h[1]))}if(!r.length){let h=pi(t,"teachingBuildingName");h&&(r=$e(h))}if(!e.length){let h=pi(t,"campusName");h&&(e=$e(h))}}catch(s){console.warn("[URP++] classroom json parse",s)}if(!r.length){let s=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=s;let c=[];for(let h of s)try{let b=await Yt("/student/teachingResources/classroomCurriculum/"+h.campusNumber+"/teachingBuildingJson");$e(b).forEach(M=>{c.push({id:{campusNumber:h.campusNumber,teachingBuildingNumber:String(M.id&&M.id.teachingBuildingNumber||M.teachingBuildingNumber||"")},teachingBuildingName:M.teachingBuildingName||M.name||""})})}catch(b){console.warn("[URP++] building json",h.campusNumber,b)}r=c}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(s=>({campus:s.campusName||s.campusNumber,campusNumber:String(s.campusNumber||s.id&&s.id.campusNumber||""),buildings:[]}));r.forEach(s=>{let c=String(s.id&&s.id.campusNumber||s.campusNumber||""),h=String(s.id&&s.id.teachingBuildingNumber||s.teachingBuildingNumber||""),b=s.teachingBuildingName||s.name||h;if(!c||!h||!b)return;let _=o.find(N=>N.campusNumber===c);_||(_={campus:c,campusNumber:c,buildings:[]},o.push(_));let M="/student/teachingResources/classroomUseStatus/"+c+"/"+h+"/"+encodeURI(encodeURI(_.campus||c))+"/"+encodeURI(encodeURI(b));_.buildings.push({name:b,path:M,campusNumber:c,buildingNumber:h})});let p=o.filter(s=>s.buildings.length);if(!p.length)throw new Error("未解析到教学楼，请刷新后重试");return p}a(Vl,"loadClassroomCatalog");function Ar(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(Ar,"occupancyTypeLabel");function Yl(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return Ar(t)}a(Yl,"occupancyReason");async function Ql(t,e,r,o){let p=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),s=await Yt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+p.toString());try{let c=JSON.parse(s);return Array.isArray(c)?c.length&&Array.isArray(c[0])?c[0]:c.filter(h=>h&&typeof h=="object"&&(h.kcm||h.id&&h.id.kch)):c&&Array.isArray(c.list)?c.list:[]}catch{return[]}}a(Ql,"fetchClassroomCurriculum");function Xl(t,e,r){let o=t||[],p=Number(e.xq)||0,s=Number(e.start)||0,c=Number(r)||0,h=[];return o.forEach(b=>{let _=b.id||{},M=Number(_.skxq!=null?_.skxq:b.skxq)||0,N=Number(_.skjc!=null?_.skjc:b.skjc)||0,L=Math.max(1,Number(b.cxjc)||1),D=_.skzc||b.skzc||"";p&&M&&p!==M||s&&(s<N||s>=N+L)||c&&D&&!Qa(D,c)||h.push(b)}),h.length?(h.sort((b,_)=>{let M=Qa(b.id&&b.id.skzc||b.skzc,c)?0:1,N=Qa(_.id&&_.id.skzc||_.skzc,c)?0:1;return M-N}),h[0]):null}a(Xl,"matchCurriculumCourse");async function Kl(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),p=String(e.buildingNumber||""),s=r||t.planNumber||"";if(!o||!p||!s)return t;let c=t.rooms.filter(L=>(L.slots||[]).some(D=>D.busy)),h={},b=a(async L=>{if(h[L])return h[L];try{h[L]=await Ql(s,o,p,L)}catch{h[L]=[]}return h[L]},"queue"),_=4,M=0,N=new Array(Math.min(_,Math.max(c.length,1))).fill(0).map(async()=>{for(;M<c.length;){let L=M++,D=c[L],J=await b(D.name);(D.slots||[]).forEach(O=>{if(!O.busy)return;let R={xq:O.detail&&O.detail.xq||O.xq||0,start:O.section,week:t.jxzc};O.detail&&O.detail.xq!=null&&(R.xq=O.detail.xq);let F=Xl(J,R,t.jxzc);if(F&&F.kcm){let K=String(F.kcm).trim();O.contentName=K,O.reason=K,O.displayChar=Yr(K),O.detail&&(O.detail.contentName=K,O.detail.reason=K,O.detail.teacher=F.jsm||"",O.detail.weeks=F.zcsm||"",O.detail.courseNo=F.id&&F.id.kch||"",O.detail.typeLabel=Ar({occupancymoduleId:O.module}))}else O.displayChar=Yr(O.reason||"占用"),O.detail&&(O.detail.typeLabel=Ar({occupancymoduleId:O.module}))})}});return await Promise.all(N),t}a(Kl,"enrichOccupancyWithCurriculum");function Zl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(Zl,"occupancyKindClass");async function tc(t){let e="",r="",o="",p="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",p=t.path||"";else{p=String(t||"");let F=p.match(/classroomUseStatus\/(\d+)\/(\d+)\//);F&&(e=F[1],r=F[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let s=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,c=ec(si(new Date,s)),h="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(c),b=await new Promise((F,K)=>{let ut=Xa("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:h,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(wt=>wt.status>=200&&wt.status<400?F(wt.responseText||""):K(new Error("HTTP "+wt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:h}).then(wt=>wt.text()).then(F).catch(K)}),_;try{_=JSON.parse(b)}catch{throw new Error("jasInfo 非 JSON")}let M=(_.classrooms||[]).map(F=>{let K=F.classroomName||F.id&&F.id.classroomNumber||"",ut=F.placeNum||"",wt=F.remark||"",Ct=[];for(let qt=1;qt<=12;qt++)Ct.push({section:qt,busy:!1});return{name:K,seats:ut,type:wt,slots:Ct,map:{}}}),N={};M.forEach(F=>{N[F.name]=F}),(_.classroomTime||[]).forEach(F=>{let K=F.id||{},ut=K.classroomNumber||"",wt=Number(K.sessionstart)||1,Ct=Math.max(1,Number(F.continuingsession)||1),qt=N[ut];if(!qt)return;let Tt=Ar(F),Ht=Yl(F);for(let Rt=wt;Rt<wt+Ct&&Rt<=12;Rt++){let $t=qt.slots.find(oe=>oe.section===Rt);$t&&($t.busy=!0,$t.kind=F.timestatenumber||F.occupancymoduleId||"",$t.module=F.occupancymoduleId||"",$t.reason=Ht,$t.typeLabel=Tt,$t.displayChar=Yr(Ht),$t.xq=K.xq,$t.weekBitmap=K.week||"",$t.detail={room:ut,section:Rt,start:wt,span:Ct,reason:Ht,typeLabel:Tt,week:K.week||"",xq:K.xq||"",state:F.timestatenumber||"",module:F.occupancymoduleId||""})}});let L="";try{let F=_.jhZxjxjhb;typeof F=="string"&&/\d{4}-\d{4}-\d-\d/.test(F)?L=F:F&&typeof F=="object"&&(L=String(F.zxjxjhh||F.jhxnxq||F.executiveEducationPlanNumber||F.planNumber||""))}catch{}if(!L&&_.classrooms&&_.classrooms[0]&&_.classrooms[0].id&&(L=_.classrooms[0].id.executiveEducationPlanNumber||""),_.jxzc!=null&&Number(_.jxzc)>=1){let F=Number(_.jxzc);nt._termWeek=Math.max(nt._termWeek||0,F),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let D=["日","一","二","三","四","五","六"],J=rc(_.date||c)||si(new Date,s),O=_.week!=null?Number(_.week):J.getDay(),R=s===1?"明天":s===2?"后天":"今天";return{rooms:M,dateLabel:(_.date||c)+"（周"+(D[O]||O)+" · "+R+"）",jxzc:_.jxzc,planNumber:L,week:_.week!=null?_.week:O,searchDate:_.date||c,dateOffset:s}}a(tc,"loadBuildingOccupancy");function si(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(si,"addDays");function ec(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(ec,"formatLocalDate");function rc(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(rc,"parseLocalDate");let li={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function ci(t){return li[t]||li.more}a(ci,"ico");let nt=_p();function ac(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=wp,(document.head||document.documentElement).appendChild(t)}a(ac,"ensureStyle");let oc=ba({deps:{scoreToNumber:Qe,scoreToGpa:Ye}}),{metricHtml:nc,occupancyHtml:ic,render:rr,renderScheduleBoard:ld,roomPickerHtml:pc,scheduleRender:sc}=Bp({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:Vn,analyzeScores:a(t=>oc.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Qt,bandsChartSvg:fa,bindUI:a(t=>cc(t),"bindUI"),classifyPrivacyLabel:Xr,courseColor:ei,ensureRoot:a(()=>ui(),"ensureRoot"),escapeHtml:at,firstContentChar:Yr,getViewWeekNumber:Kn,ico:ci,isCleanAnalysisDirect:va,occupancyKindClass:Zl,occupancyTypeLabel:Ar,personalizedProfile:dl,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Qe,summarizeCourses:ae,trendChartSvg:ha,weekBitActive:Zn,calVacation:wr,setCalendarPhase:Xn}}),{ensureRoomCatalogLoaded:di,loadAll:lc}=Cp({state:nt,deps:{ensureTermWeekResolved:Nl,enrichScoresWithEvaluation:Wl,getCurrentWeekNumber:Me,loadClassroomCatalog:Vl,loadProfile:Jn,loadSchedule:Dl,loadScores:ii,readRememberedTermWeek:yr,reconcileProfileAndScores:Gl,render:rr,scheduleRender:sc}}),{bindUI:cc,closeModal:dc,getRoomHost:cd,openModal:dd,openRoomModal:ud,openScoreModal:md,showBuilding:bd}=Fp({state:nt,deps:{DAY_NAMES:Vn,applyPersonalDisplay:Qt,bindScheduleExportHosts:zl,closeCleanMode:a(()=>mc(),"closeCleanMode"),ensureRoomCatalogLoaded:di,enrichOccupancyWithCurriculum:Kl,ensureRoot:a(()=>ui(),"ensureRoot"),escapeHtml:at,fetchText:Yt,getCurrentWeekNumber:Me,getViewWeekNumber:Kn,inferMaxWeek:Bl,isUnevaluatedScore:ce,isValidOfficialGpa:Vr,loadBuildingOccupancy:tc,metricHtml:nc,occupancyHtml:ic,render:rr,rootEl:a(()=>bc(),"rootEl"),roomPickerHtml:pc,scoreToGpa:Ye,scoreToNumber:Qe,summarizeCourses:ae,summarizeCoursesPreferOfficial:ae}}),{cleanModeApi:uc,closeCleanMode:mc,ensureRoot:ui,injectCleanEntry:hd,openCleanMode:fd,rootEl:bc}=Dp({state:nt,deps:{CLEAN_FLAG:Ys,applySkinAttr:re,closeModal:dc,ensureRoomCatalogLoaded:di,ensureStyle:ac,getCurrentWeekNumber:Me,getSkin:te,handleThemeDotClick:ct,ico:ci,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:$o,loadAll:lc,openSettingsPanel:dn,readRememberedTermWeek:yr,refreshCleanPersonalDisplay:Za,render:rr,scoreToGpa:Ye,summarizeCourses:ae,syncNavbarThemeUI:xt,syncSettingsPanelUI:jt,syncThemeDotGroup:Z}});window.__urpppCleanMode=uc;function so(){if(!document.body){setTimeout(so,10);return}if(No(),Gt(Vt()),setTimeout(()=>{try{ve().then(e=>Ce(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],p=r.parentElement;for(;p;){let s=p.scrollTop,c=p.scrollLeft;(s||c||p.scrollHeight>p.clientHeight||p.scrollWidth>p.clientWidth)&&o.push({el:p,top:s,left:c}),p=p.parentElement}requestAnimationFrame(()=>{o.forEach(s=>{s.el.scrollTop=s.top,s.el.scrollLeft=s.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))Ho();else{ys();try{Mn()}catch{}try{ta()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Qt(document)}catch{}try{Qn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{ta()}catch{}try{Qt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{ya()&&$o()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(so,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(ze,50)}),window.addEventListener("load",()=>{ze(),Ve(),setTimeout(ze,100),setTimeout(ze,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Ve,0),setTimeout(Ve,50),setTimeout(Ve,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Ve,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function mi(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let p=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),s=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));p&&!s&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){ze(),qn(),st(),ze();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(s=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},s)),Ta(),pn(),sn(),Ko(),ln(),nn(),tn(),document.querySelectorAll(".page-content, #page-content-template").forEach(s=>{let c=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);s.style.setProperty("padding",c?"8px 8px 24px":"16px 64px 40px","important"),s.style.setProperty("box-sizing","border-box","important")}),Dr(),Hr(),Re(),setTimeout(Re,300),setTimeout(Re,1e3),Go(),ye(),ur(),Yo(),setTimeout(ur,300),mr(),setTimeout(()=>mr(),500),Fr(),Vo();try{ta()}catch{}try{Qt(document)}catch{}setTimeout(()=>{try{ta()}catch{}try{Qt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...p){let s=r.apply(this,p);return e(),s},history.replaceState=function(...p){let s=o.apply(this,p);return e(),s}}a(mi,"watchRouteChanges");let ar=typeof unsafeWindow<"u"?unsafeWindow:window;ar.__urpppDebug=ar.__urpppDebug||{},ar.__urpppDebug.setCalendarPhase=t=>Xn(t),ar.__urpppDebug.getCalendarPhase=()=>Il(),ar.__urpppDebug.calVacation=t=>wr(t),ar.urppp={version:n,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Gt(t)},"apply"),setAccent:Kp,getAccent:Xt,getCurrent:Vt,list:a(()=>Object.entries(Pt).map(([t,e])=>({name:t,displayName:e.name,current:t===Vt()})),"list")},update:{check:Va,auto:Ja,showToast:Ga},privacy:{get:Ee,set(t){return ka(t),Qt(document),Ee()},apply:a(()=>Qt(document),"apply"),identity:{get:De,set(t){return qo(t),Qt(document),Za(),De()}}},scheduleExport:{load:a(()=>jn("api"),"load"),run:a(t=>wl(t,"api",null,null),"run"),patch:no,image:{theme:Rn,build:a((t,e)=>Un(t,e),"build")},jsonFormat:{get:Nr,set:Mo,validate:Ne,build(t,e){let r=na(t);if(e)return pa(r,Ne(e));let o=Nr();return o.enabled?pa(r,o.mapping):ia(r)},buildDefault(t){return ia(na(t))}}}};function bi(){setTimeout(()=>{try{Ja()}catch{}},1800)}a(bi,"scheduleAutoUpdateCheck");try{No()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{so(),mi(),bi()}):(so(),mi(),bi())})();})();
