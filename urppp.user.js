...
`;var Hp=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var Rp=`.urppp-export-wrap{position:relative!important;display:inline-flex!important;align-items:center!important;flex:0 0 auto!important;margin-left:7px!important;font-weight:400!important;vertical-align:middle!important;white-space:nowrap!important}
...
#urppp-settings-panel .urppp-store-ops{display:flex;gap:8px;flex:0 0 auto}
`;var Wp=`      /* 表格美化：业务表格、分页、公告卡片（table-beautify） */
...
`;var Gp=`      /* 导航：顶栏、侧栏、面包屑（navigation） */
      /* 顶栏 —— 基于真实 DOM */
...
`;var Jp=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function Xp(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(Xp,"createCleanModeState");function Kp(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(Kp,"resetCleanModeData");function Zp({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(k){p.catalog=p.catalog||[],p.roomError=String(k&&k.message||k),console.warn("[URP++] room catalog",k)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&Kp(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let k=await n.ensureTermWeekResolved();!p.weekLocked&&k>=1&&(p.viewWeek=k)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(k){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(k)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(k){p.schedule={courses:[],error:String(k&&k.message||k)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}})(),(async()=>{let k=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),k=p.scores,n.reconcileProfileAndScores(),k&&!k.error&&!k.evaluationReady&&n.enrichScoresWithEvaluation(k).then(()=>{p.scores===k&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let k=n.getCurrentWeekNumber()||n.readRememberedTermWeek();k>=1&&(p.viewWeek=k)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(Zp,"createCleanModeDataLoader");var er={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},mc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},kr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function ri(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(ri,"calToday");function po(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(po,"calDayDiff");function io(p,n){let c=po(er[p].start,n);return c<0?0:Math.floor(c/7)+1}a(io,"calWeekNo");function oo(p){return mc[p]||""}a(oo,"calLunar");function ti(p){return String(p||"").slice(5)}a(ti,"calYY");function bc(p){let n=p||ri(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(bc,"calActiveTerm");function so(p,n){let c=p&&er[p]?p:"autumn",d=er[c],u=n||ri(),k=d.events.map(f=>({e:f,d:po(u,f.start)})).filter(f=>f.d>=-0).sort((f,w)=>f.d-w.d)[0],P=k?po(u,k.e.start):null,S=io(c,u),y=Math.max(0,Math.min(100,S/d.weeks*100)),A=u>=d.start;return{term:d,termId:c,next:k,daysLeft:P,weekNo:S,progress:y,started:A,today:u}}a(so,"calStatus");function ai(p,n){let c=so(p,n),d=c.next?kr[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(ai,"calendarSummaryHtml");function oi(p,n){let c=so(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(oi,"calendarSummaryCompactHtml");function ei(p,n){let c=so(p,n),d=c.next?kr[c.next.e.t].color:"#c9cdd4",u=c.term,k=Object.keys(er).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${er[w].name}</button>`).join(""),P=`<div class="cal-widget">
    ...
    <div class="cal-w-right">
      ...
      <div class="cal-mon-items">${y[w].map(C=>{let b=kr[C.t].color,m=C.end&&C.end!==C.start?"~"+ti(C.end):"",v=io(c.termId,C.start)>0?`第 ${io(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${A(C.start)}">
          <span class="cal-ev-dot" style="background:${b}"></span>
          <span class="cal-ev-date">${ti(C.start)}${m||""}<em>${oo(C.start)||"&nbsp;"}</em></span>
  ...
  </div>`}a(ei,"calendarModalHtml");function ni(p,n){let c=typeof document<"u"?document:null;if(!c)return;no();let d=p&&er[p]?p:bc(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${ei(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>no()),u.addEventListener("click",k=>{let P=k.target;if(P&&P.closest&&P.closest(".cal-close")){no();return}let S=P&&P.closest?P.closest("[data-cal-term]"):null;if(S){let y=u.querySelector(".cal-body");y&&(y.innerHTML=ei(S.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(A=>A.classList.toggle("ac",A.dataset.calTerm===S.dataset.calTerm))}})}a(ni,"openCalendarModal");function no(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(no,"closeCalendarModal");function pi(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),ni())})}a(pi,"bindCalendarOpen");var ta=!1;function lo(){let p=typeof document<"u"?document:null;if(!p||ta)return ta;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${q?"":" hidden"}>${k()}</div>
      ...
      <div class="uc-col">
        ...
        </div>${(()=>{try{return ai()}catch{return""}})()}</div></div>
...
<g>${V}</g>
${ct}
</svg>`}a(ra,"trendChartSvg");function aa({bands:p,palette:n,layout:c}){let d=p||[],u=hi(c,"bands",d.length),{width:k,height:P,pad:S,mobile:y}=u,A=k-S.left-S.right,f=P-S.top-S.bottom,w=d.length||1,T=Math.max(1,...d.map(m=>m.count)),C=y?Math.min(32,A/w*.62):Math.min(40,A/w*.52),b=d.map((m,v)=>{let x=S.left+(v+.5)*(A/w),_=m.count?Math.max(8,m.count/T*f):0,q=S.top+f-_,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=m.range||(m.min===0?"<60":`${m.min}-${m.max===100?"100":m.max}`),O=[`${m.level||""}（绩点 ${m.gpa}）`,`百分制 ${L}`,`课程 ${m.count} 门`].join(`
...
</svg>`}a(gi,"donutSvg");var fc=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),xc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',yc='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function fi({deps:p}){let n=p&&p.palette||fc;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
...
<div class="urppp-sa-grid">
  ...
  `;function S(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(S,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function A(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(A,"cleanupPageLoadingOverlays");function f(t){try{let e=t&&t.querySelectorAll?t:document;A(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let s=S("");s.style.minHeight="0",s.style.padding="0",r.parentElement&&r.parentElement.replaceChild(s,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=S("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(f,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{f(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",b="urppp_scheme_v1",m="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",_="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",$="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:ft,syncThemeDotGroup:Z}=Ai({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Xt,getAccent:Yt,getBrutalActivePalette:vo,getBrutalPaletteById:ar,getBrutalSelectedPalette:yo,getCurrent:Qt,getScheme:Le,getSkin:oe,isThemeModeAvailable:rr,setBrutalPalette:wo,skinSupportsDark:$e,skinSupportsDynamic:Me,skinSupportsFixedPalettes:xo},settings:{ensureSettingsPanel:Vo,openSettingsPanel:Wo,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),s=document.getElementById("clickdiv"),i=document.getElementById("form-search");if(!o){let D=document.createElement("li");D.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",D.appendChild(o),r.appendChild(D)}let l=o.closest("li")||o.parentElement,g=Array.from(r.children).find(D=>{let R=D.querySelector(":scope > a");if(!R)return!1;let B=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return B.includes("customerServiceCenter")||/help|service|support/i.test(B)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),h=Array.from(r.children).find(D=>D.classList.contains("light-blue")),E=g||h||null;E&&l&&E!==l&&((l.compareDocumentPosition(E)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,E)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let M=l;s?(s.removeAttribute("onclick"),s.setAttribute("role","button"),s.setAttribute("aria-label","搜索功能")):(s=document.createElement("button"),s.type="button",s.id="clickdiv",s.setAttribute("aria-label","搜索功能"),s.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(s)),s.style.setProperty("left","8px","important"),s.style.setProperty("position","relative","important"),s.style.setProperty("z-index","31","important"),i||(i=document.createElement("div"),i.id="form-search",i.className="nav-search",i.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),M&&i.parentElement!==M&&M.appendChild(i),M&&M.style.setProperty("position","relative","important"),i.classList.add("urppp-desktop-search"),i.style.setProperty("position","absolute","important"),i.style.setProperty("top","50%","important"),i.style.setProperty("right","24px","important"),i.style.setProperty("left","auto","important"),i.style.setProperty("transform","translateY(-50%)","important"),i.style.setProperty("width",i.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),i.style.setProperty("max-width","calc(100vw - 24px)","important"),i.style.setProperty("opacity",i.dataset.open==="1"?"1":"0","important"),i.style.setProperty("pointer-events",i.dataset.open==="1"?"auto":"none","important"),i.style.setProperty("z-index","1200","important"),i.style.setProperty("margin","0","important"),i.style.setProperty("background","transparent","important"),i.style.setProperty("border","0 solid transparent","important"),i.style.setProperty("box-shadow","none","important"),i.style.setProperty("overflow","visible","important"),i.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let j=i.querySelector("#search-input"),z=i.querySelector("form");if(!j||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let F=i.querySelector(".input-icon");F&&(F.style.setProperty("display","block","important"),F.style.setProperty("position","relative","important")),j.style.setProperty("display","block","important"),j.style.setProperty("width","100%","important"),j.style.setProperty("height","36px","important"),j.style.setProperty("box-sizing","border-box","important"),j.style.setProperty("padding","0 12px","important"),j.style.setProperty("border","1px solid var(--border)","important"),j.style.setProperty("border-radius","var(--radius-sm)","important"),j.style.setProperty("background","var(--input-bg)","important"),j.style.setProperty("color","var(--text)","important");let J=a(D=>{i.dataset.open=D?"1":"0",i.style.setProperty("width",D?"min(240px, calc(100vw - 24px))":"0px","important"),i.style.setProperty("opacity",D?"1":"0","important"),i.style.setProperty("pointer-events",D?"auto":"none","important"),s.setAttribute("aria-expanded",D?"true":"false"),D&&setTimeout(()=>j.focus(),30)},"setOpen");s.__urpppSearchBound||(s.__urpppSearchBound=!0,s.addEventListener("click",D=>{D.preventDefault(),D.stopImmediatePropagation(),J(i.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",D=>{let R=document.getElementById("form-search"),B=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(D.target)||B?.contains(D.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function N(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),s=Math.min(t,e,r),i=0,l=0,g=(o+s)/2;if(o!==s){let h=o-s;switch(l=g>.5?h/(2-o-s):h/(o+s),o){case t:i=(e-r)/h+(e<r?6:0);break;case e:i=(r-t)/h+2;break;default:i=(t-e)/h+4;break}i/=6}return{h:i*360,s:l,l:g}}a(N,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,s=o*(1-Math.abs(t/60%2-1)),i=r-o/2,l=0,g=0,h=0;return t<60?(l=o,g=s):t<120?(l=s,g=o):t<180?(g=o,h=s):t<240?(g=s,h=o):t<300?(l=s,h=o):(l=o,h=s),{r:Math.round((l+i)*255),g:Math.round((g+i)*255),b:Math.round((h+i)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:s,b:i}=Y(t,e,r);return hr(o,s,i)}a(tt,"hslHex");function ht(t){let{r:e,g:r,b:o}=Xe(Gt(t)||mt),s=N(e,r,o);return s.s<.12&&(s.s=.18),s}a(ht,"seedHsl");function bt(t,e,r){let o=Math.max(0,Math.min(100,r))/100,s=Math.max(0,Math.min(.95,e));return tt(t,s,o)}a(bt,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Gt(t)||mt,{h:r,s:o}=ht(e),s=Ft(r),i=Math.min(.72,Math.max(.28,o*.78));return bt(s,i,42)}a(Pt,"companionColor");function It(t,e){let r=Gt(t)||mt,{h:o,s}=ht(r),l=zt(e||ot),g=Math.min(.92,Math.max(.35,s*l.chroma)),h=Pt(r),{h:E}=ht(h),M=bt(o,g,l.primaryTone),j=bt(o,g,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),F,J,D;l.whiteCard?(F=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",D="#E5E7EB"):l.duo?(F=Bt(yt(h,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),D=Bt("#E5E7EB",h,.16)):(F=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),D=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?h:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),B=bt(o,Math.min(.45,g*.55),14),K=ge(bt(o,g*.3,34),.88),ut=ge(bt(o,g*.22,46),.76),vt=ge(M,.18),Et="0 4px 12px "+ge(M,.1)+", 0 1px 2px "+ge(M,.05);return{"--bg":F,"--surface":J,"--text":B,"--text-secondary":K,"--text-muted":ut,"--border":D,"--border-focus":M,"--input-bg":R,"--primary":M,"--primary-hover":j,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":h}}a(It,"buildMaterialSchemeVars");function Xt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Xt,"buildSchemePreview");function ze(t){let e=Gt(t)||Yt()||mt;return X.map(r=>Object.assign({},r,Xt(e,r.id)))}a(ze,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Yt(){return Gt(GM_getValue(T,""))||""}a(Yt,"getAccent");function Le(){let t=String(GM_getValue(b,ot)||ot);return X.some(e=>e.id===t)?t:ot}a(Le,"getScheme");function oa(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(b,e),e}a(oa,"setScheme");function Si(t,e){if(!t)return;let r=Gt(t);if(r){if(GM_setValue(T,r),e&&e.scheme&&oa(e.scheme),e&&e.skipTheme){let o=Va(r,.15),s=ge(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",s);try{ft()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{ft()}catch{}try{Dt()}catch{}}}a(Si,"applyAccent");function na(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(na,"getAccentPresets");function _i(t){let e=Gt(t||Yt()||mt);if(!e)return na();let r=na();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(_i,"saveAccentPreset");function Kt(){try{return!!GM_getValue(m,!1)}catch{return!1}}a(Kt,"isThemeFollowSystem");function Ar(t){return GM_setValue(m,!!t),!!t}a(Ar,"setThemeFollowSystem");function pa(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(pa,"isCleanDefault");function Ei(t){return GM_setValue(v,!!t),!!t}a(Ei,"setCleanDefault");function ia(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(ia,"isCleanAnalysisDirect");function Ci(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(Ci,"setCleanAnalysis");function xe(){try{let t=GM_getValue(_,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(xe,"isAppleEdgeLine");function Pi(t){return GM_setValue(_,!!t),!!t}a(Pi,"setAppleEdgeLine");function sa(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(sa,"isAutoUpdateCheck");function zi(t){return GM_setValue(c,!!t),!!t}a(zi,"setAutoUpdateCheck");function Sr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(Sr,"readJsonSetting");function _r(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(_r,"writeJsonSetting");function ye(){return eo(Sr(O,null))}a(ye,"getPrivacySettings");function la(t){return _r(O,eo(t))}a(la,"setPrivacySettings");function qe(){return wr(Sr($,null))}a(qe,"getCustomIdentity");function mo(t){return _r($,wr(t))}a(mo,"setCustomIdentity");function ca(){let t=Sr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ca,"getScheduleFirstMondayMap");function bo(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ca();r[String(t)]=String(e),_r(H,r)}a(bo,"rememberScheduleFirstMonday");function Er(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=Sr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},s={enabled:!!o.enabled,mapping:Pe(o.mapping||xr)};return et="",s}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:Pe(xr)}}}a(Er,"getScheduleJsonFormatSettings");function ho(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:Pe(e.mapping||xr)};return et="",_r(G,r)}a(ho,"setScheduleJsonFormatSettings");function go(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(go,"isHomePage");function Cr(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(Cr,"isFollowUseDynamic");function da(t){return GM_setValue(q,!!t),!!t}a(da,"setFollowUseDynamic");function Li(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Li,"systemPrefersDark");function ve(){return Li()&&$e()?"dark":Cr()&&Me()?"scu-red":"default"}a(ve,"resolveFollowThemeName");function rr(t,e){return t==="dark"?$e(e):t==="scu-red"?Me(e):t==="default"}a(rr,"isThemeModeAvailable");function Wt(t,e){e=e||{},!$e()&&Kt()&&Ar(!1),!Me()&&Cr()&&da(!1),e.manual&&Ar(!1);let r;e.system||Kt()&&!e.manual?r=ve():(r=Ct[t]?t:Qt()||"default",Ct[r]||(r="default")),rr(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(w,r),ue();let s=document.getElementById("urppp-theme-vars")||(()=>{let E=document.createElement("style");return E.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(E),E})(),i=Yt(),l=Object.assign({},o.vars);if(r==="scu-red"){let E=i||mt,M=Le();l=Object.assign(l,It(E,M));let j=l["--primary"]||E,z=l["--primary-hover"]||Va(j,.12);document.documentElement.style.setProperty("--urppp-accent",j),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||ge(j,.15)),document.documentElement.style.setProperty("--urppp-seed",E),document.documentElement.style.setProperty("--urppp-scheme",M)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let g=":root {";for(let[E,M]of Object.entries(l))g+=`${E}:${M};`;g+="}",s.textContent=g,document.body&&(document.body.style.fontFamily=o.font);try{let E=document.documentElement;E.dataset.urpppTheme=r,E.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),E.classList.add("urppp-theme-"+r),E.classList.toggle("urppp-theme-follow",Kt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Kt()))}catch{}try{te()}catch{}try{ft()}catch{}try{Dt()}catch{}try{Bo()}catch{}try{Di()}catch{}let h=document.getElementById("urppp-boot-loader");h&&(h.style.fontFamily=o.font)}a(Wt,"applyTheme");function Qt(){return GM_getValue(w,"default")}a(Qt,"getCurrent");function Te(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(Te,"themeDownloaded");function fo(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(fo,"storeThemeStyleEl");function qi(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(qi,"removeStoreThemeStyle");function Ti(){u.forEach(t=>{let e="urppp_theme_css_"+t.id,r="";try{r=GM_getValue(e,"")||""}catch{}r&&(fo(t.id).textContent=r)});try{te()}catch{}}a(Ti,"injectAllStoreThemeStyles");function oe(){let t=GM_getValue(d,"apple"),e=u.find(r=>r.id===t);return e&&e.ready&&(e.installed!==!1||Te(e.id))?t:"apple"}a(oe,"getSkin");function ua(t,e){let r=t||oe(),o=u.find(s=>s.id===r);return!!(o&&o[e])}a(ua,"getSkinCapability");function $e(t){return ua(t,"dark")}a($e,"skinSupportsDark");function Me(t){return ua(t,"dynamic")}a(Me,"skinSupportsDynamic");function xo(t){return ua(t,"palettes")}a(xo,"skinSupportsFixedPalettes");function ar(t){return Q.find(e=>e.id===t)||Q[0]}a(ar,"getBrutalPaletteById");function yo(){let t=String(GM_getValue(I,"acid")||"acid"),e=ar(t);return e.id===V?ar("acid"):e}a(yo,"getBrutalSelectedPalette");function vo(){let t=String(GM_getValue(L,V)||V);return ar(t)}a(vo,"getBrutalActivePalette");function wo(t,e){let r=e||{},o=ar(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{te()}catch{}try{ft()}catch{}try{Dt()}catch{}try{let s=document.getElementById("urppp-clean-root");s&&typeof s.__syncCleanThemeDots=="function"&&s.__syncCleanThemeDots()}catch{}}a(wo,"setBrutalPalette");function $i(t){let e=t||oe();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&xe()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&xe()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a($i,"getSkinShapeOverrides");function Ie(){try{let t=oe();if(t==="apple")return xe()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Ie,"urpppCardBorderValue");function te(){let t=oe();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&xe();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let i=document.createElement("style");return i.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(i),i})(),r=$i(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(i=>{o+=i+":"+r[i]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let i=vo();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+i.accent+";--brutal-secondary:"+i.secondary+";--brutal-info:"+i.info+";--brutal-warning:"+i.warning+";}"}e.textContent=o;return}if(t==="apple"){let i=xe(),l=i?"1px solid rgba(0,0,0,0.08)":"none",g=i?"1px solid rgba(255,255,255,0.10)":"none",h=i?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(i?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(i?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+g+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(i?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+h+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let s=document.head||document.documentElement;e.parentNode===s&&s.lastElementChild!==e&&s.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Vt(document)}catch{}},0)}a(te,"applySkinAttr");function ko(t){let e=u.find(r=>r.id===t&&r.ready&&(r.installed!==!1||Te(r.id)));if(!e)return!1;GM_setValue(d,e.id);try{e.dynamic||da(!1),!e.dark&&Kt()&&Ar(!1);let r=Kt(),o=r?ve():Qt(),s=rr(o,e.id)?o:"default";te(),Wt(s,{system:r})}catch{try{te()}catch{}}try{Dt()}catch{}try{ft()}catch{}try{let r=document.getElementById("urppp-clean-root");r&&typeof r.__syncCleanThemeDots=="function"&&r.__syncCleanThemeDots()}catch{}return!0}a(ko,"setSkin");function Mi(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Kt())try{Wt(ve(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(Mi,"bindSystemThemeListener");try{Kt()?Wt(ve(),{system:!0}):Wt(Qt())}catch{}try{te()}catch{}try{Mi()}catch{}function Ii(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let s=e.match(o);if(s)return s[0].trim()}return""}a(Ii,"extractLoginErrorMessage");function Ao(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout(Ao,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=Ii(e),s=r.querySelector('a[onclick*="toModifyPwd"]'),i=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let g=location.pathname==="/loginEn",h=a((R,B)=>g?B:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      <div class="uc">
        ...
        <div class="urppp-store-sub-body" id="urppp-store-sub-body"></div>`,e.appendChild(r),r.querySelector("#urppp-store-sub-back").onclick=Xi);let o=r.querySelector("#urppp-store-sub-title"),s=r.querySelector("#urppp-store-sub-body");o.textContent=t==="theme"?"主题商店":"插件商店",s.innerHTML="",t==="theme"?as(s):en(s),r.classList.add("open")}a(_a,"openStoreSubPanel");function Xi(){let t=document.getElementById("urppp-store-subpanel");if(!t)return;t.classList.remove("open");let e=t.querySelector("#urppp-store-sub-body");e&&(e.innerHTML="")}a(Xi,"closeStoreSubPanel");function Yo(t){t.querySelectorAll(".urppp-store-tab").forEach(e=>{e.addEventListener("click",()=>{t.querySelectorAll(".urppp-store-tab").forEach(o=>o.className="urppp-store-tab"),e.className="urppp-store-tab ac",t.querySelectorAll(".urppp-store-pane").forEach(o=>o.style.display="none");let r=t.querySelector('.urppp-store-pane[data-pane="'+e.dataset.tab+'"]');r&&(r.style.display="")})})}a(Yo,"bindStoreTabs");function Qo(t){Array.isArray(t)&&t.forEach(e=>{if(!e||!e.cardCss||!e.id)return;let r=document.getElementById("urppp-store-card-css-"+e.id);r||(r=document.createElement("style"),r.id="urppp-store-card-css-"+e.id,(document.head||document.documentElement).appendChild(r)),r.textContent!==e.cardCss&&(r.textContent=e.cardCss)})}a(Qo,"ensureStoreCardStyles");function Ki(t,e){let r=t.repo?`<div class="urppp-store-ops" style="position:absolute;left:12px;bottom:12px"><button type="button" class="urppp-set-btn ghost" data-repo="${at(t.repo)}">仓库</button></div>`:"";return`<div class="urppp-skin-card" data-skin="${at(t.id)}">
      ...
      <button type="button" class="urppp-skin-apply" data-theme-use="${at(t.id)}">使用</button>
      <div class="urppp-store-ops" style="position:absolute;left:12px;bottom:12px">${o}${i}</div>
    </div>`}a(ts,"themeManageCardHtml");async function Ca(t){if(!t)return;let e=[];try{e=await De()}catch{}let r=u.filter(o=>o.installed!==!1||Te(o.id));if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}Qo(r.map(o=>e.find(s=>s.id===o.id))),t.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>ts(o,e.find(s=>s.id===o.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(o=>o.addEventListener("click",()=>{ko(o.dataset.themeUse)&&Dt()})),t.querySelectorAll("[data-theme-del]").forEach(o=>o.addEventListener("click",()=>{let s=o.dataset.themeDel;try{GM_setValue("urppp_theme_css_"+s,"")}catch{}qi(s);try{oe()===s&&(GM_setValue(d,"apple"),te(),Wt("default",{manual:!0}))}catch{}try{Dt()}catch{}let i=t.closest(".urppp-store-inline");if(i){try{Ca(t)}catch{}try{Ea(i)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(Ca,"fetchThemeManage");function Xo(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(Xo,"storeManageSettingsHtml");let es=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];async function De(){for(let t of es)try{let e=await fetch(t,{cache:"no-store"});if(e.ok){let r=await e.json();if(r&&Array.isArray(r.items))return r.items}}catch{}return[]}a(De,"fetchCatalogList");function Ko(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let s=0;s<Math.max(r.length,o.length);s+=1){let i=r[s]||0,l=o[s]||0;if(i!==l)return i>l}return!1}a(Ko,"versionGt");function rs(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let s=t.querySelector('[data-theme-use="'+o.id+'"]');s&&Ko(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(Zo(s.closest(".urppp-skin-card"),"主题"),r+=1);let i=t.querySelector('[data-plugin-id="'+o.id+'"]');if(i){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&Ko(o.version,l.version)&&(Zo(i.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(rs,"applyStoreUpdateBadges");function Zo(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(Zo,"addUpdateBadge");function tn(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),s=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");s(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),s()}),r.addEventListener("click",async()=>{r.disabled=!0;let i=r.textContent;r.textContent="检查中…";try{let l=await De(),g=rs(t,l);r.textContent=g?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=i,r.disabled=!1},1600)})}a(tn,"bindStoreManageSettings");function as(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${Xo()}<div class="urppp-store-bd"><div id="urppp-theme-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div></div>
        </div>
      </div>`,Yo(t),tn(t),Ea(t),Ca(t.querySelector("#urppp-theme-manage"))}a(as,"renderThemeStoreBody");function os(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
      ...
      <div class="urppp-store-inline">
        ...
        <div class="urppp-store-body">
          <div class="urppp-store-pane" data-pane="download"><div class="urppp-store-empty"><p class="urppp-store-empty-title">加载中…</p></div></div>
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${Xo()}<div class="urppp-store-bd" id="urppp-plugin-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div>
        </div>
      </div>`,Yo(t),tn(t),ns(t.querySelector('[data-pane="download"]')),ps(t.querySelector("#urppp-plugin-manage"))}a(en,"renderPluginStoreBody");function is(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>_a("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=oe();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}u.filter(s=>s.installed!==!1||Te(s.id)).forEach(s=>{let i=document.createElement("div");i.className="urppp-skin-card"+(s.id===o?" is-active":""),i.dataset.skin=s.id;let l=document.createElement("button");l.type="button",l.className="urppp-skin-apply";let g=s.installed!==!1||Te(s.id);g?s.id===o&&s.ready?(l.classList.add("is-current"),l.textContent="使用中",l.disabled=!0):l.textContent="应用主题":(l.classList.add("is-disabled"),l.textContent="去下载"),l.addEventListener("click",h=>{if(h.preventDefault(),h.stopPropagation(),!g){_a("theme");return}if(!(s.id===o&&s.ready)&&ko(s.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),i.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),i.querySelector(".urppp-skin-name").textContent=s.name,i.querySelector(".urppp-skin-desc").textContent=s.desc,i.appendChild(l),r.appendChild(i)})}a(is,"renderSkinCards");let je=[],Pa=!1;function ss(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,s=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(i=>{if(!i.ok)throw new Error("HTTP "+i.status);return i.text()}).finally(()=>{s&&clearTimeout(s)})}a(ss,"fetchWithTimeout");function ls(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(s=>{s.status>=200&&s.status<400?r(s.responseText||""):o(new Error("HTTP "+s.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(s){o(s)}})}a(ls,"gmRequestForUpdate");function cs(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),ss(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return ls(t,r);throw o})}a(cs,"fetchTextForUpdate");async function za(t,e,r=1e3){let o=[],s=t[0],i=t.slice(1),l=a(z=>cs(z,e).then(F=>({url:z,text:F})).catch(F=>(o.push((z.split("/")[2]||z)+": "+(F&&F.message||F)),null)),"grab"),g=l(s),h=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),E=await Promise.race([g,h]);if(E!=="__TIMEOUT__"){if(E&&E.text&&E.text.length>0)return E.text;let F=(await Promise.all(i.map(l))).find(J=>J&&J.text&&J.text.length>0);if(F)return F.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let M=Promise.all(i.map(l)).then(z=>{let F=z.find(J=>J&&J.text&&J.text.length>0);if(F)return F.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),j=g.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([j,M])}a(za,"fetchFirstAvailable");function we(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(we,"setUpdateStatus");async function La(){let t=p,e="",r=!1,o="";try{let i=await za(n.sourceUrls(n.versionJson)),l=JSON.parse(i);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let i=await za(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=Qa(i)}if(!e)throw new Error("无法解析远程主插件版本");let s=gr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:s>0?"update":s===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:r?o:""}}a(La,"checkMainUpdate");function rn(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let s=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,i=[],l;for(;(l=s.exec(o))!==null;)i.push({ver:l[1],index:l.index,headEnd:s.lastIndex});if(!i.length)return"";for(let h=0;h<i.length;h++){let E=h+1<i.length?i[h+1].index:o.length;i[h].body=o.slice(i[h].index,E).trim()}let g=[];for(let h of i)gr(h.ver,r)>0||gr(h.ver,e)<=0||g.push(h.body);return g.join(`

`).trim()}a(rn,"extractChangelogRange");function an(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(an,"ensureUpdateToastStyles");function ds(t){let e=String(t||"").replace(/\r\n/g,`
...
`),s=[],i=!1,l=a(()=>{i&&(s.push("</ul>"),i=!1)},"closeList");for(let g=0;g<o.length;g++){let E=o[g].replace(/\s+$/,"");if(!E.trim()){l();continue}let M=E.match(/^(#{2,3})\s+(.+)$/);if(M){l();let z=M[1].length,F=M[2];s.push(z===2?`<h2>${r(F)}</h2>`:`<h3>${r(F)}</h3>`);continue}let j=E.match(/^[-*]\s+(.+)$/);if(j){i||(s.push("<ul>"),i=!0),s.push(`<li>${r(j[1])}</li>`);continue}l(),s.push(`<p>${r(E)}</p>`)}return l(),s.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(ds,"renderChangelogMarkdown");function on(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(s=>{s&&s.target!==e||s&&s.propertyName&&s.propertyName!=="opacity"&&s.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(on,"hideUpdateToast");function us(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(s=>{s&&s.target!==e||s&&s.propertyName&&s.propertyName!=="opacity"&&s.propertyName!=="background-color"&&s.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(us,"hideChangelogModal");function nn(t,e){an();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>on(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let s=o.getAttribute("data-act"),i=e.__pack||{};if(s==="later"){on(e);return}if(s==="go"){let l=i.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(s==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=i.changelogMd;l||(l=await za(n.sourceUrls("CHANGELOG.md")),i.changelogMd=l);let g=rn(l,i.local,i.remote),h=g?ds(g):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';nn("更新日志 "+i.local+" → "+i.remote,h)}catch(l){nn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(qa,"showUpdateToast");async function Ta(){if(sa()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await La();t&&t.status==="update"&&qa(t);let e=await ms();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Ta,"maybeAutoCheckUpdate");function ms(){let t=(window.__urpppUpdateCheckers||je||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?_t.update("assist"):null).catch(()=>null)}a(ms,"hotUpdateAssist");async function $a(){if(Pa)return;Pa=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),we("正在从多源检查更新…");try{let e=[La()];(je||[]).forEach(h=>{h&&typeof h.check=="function"&&e.push(Promise.resolve().then(()=>h.check()).then(E=>E||{id:h.id||"extra",name:h.name||"扩展",status:"err",message:"无结果"}).catch(E=>({id:h.id||"extra",name:h.name||"扩展",status:"err",message:String(E&&E.message||E)})))});let r=await Promise.all(e),o=r.map(h=>{if(!h)return"";if(h.status==="err")return`• <b>${at(h.name||h.id)}</b>：检查失败（${at(h.message||"unknown")}）`;if(h.status==="update"){let E="";if(h.id==="assist"&&_t&&_t.loaded("assist"))E=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let M=h.updateUrl?` <a href="${at(h.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",j=h.pageUrl?` <a href="${at(h.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";E=M+j}return`• <b>${at(h.name)}</b>：发现新版本 <b>${at(h.remote)}</b>（当前 ${at(h.local)}）${E}`}return h.status==="ahead"?`• <b>${at(h.name)}</b>：本地 ${at(h.local)} 新于远程 ${at(h.remote)}`:`• <b>${at(h.name)}</b>：已是最新（${at(h.local)}）`}).filter(Boolean),s=r.some(h=>h&&h.status==="update"),i=r.some(h=>h&&h.status==="err");we(`${s?"检查完成：发现更新":i?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,i?"err":"ok");let g=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');g&&g.addEventListener("click",()=>{try{we("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{we("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(h=>{we("重新装载失败："+(h&&h.message?h.message:h),"err")})}catch(h){we("重新装载失败："+(h&&h.message?h.message:h),"err")}})}catch(e){we("检查失败："+at(e&&e.message||e),"err")}finally{Pa=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a($a,"checkForUpdates");function pn(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+p,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(pn,"refreshUpdateStatusHint");function bs(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=je.findIndex(s=>s&&s.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?je[r]=o:je.push(o);try{let s=document.getElementById("urppp-set-update-status");s&&o.localVersion&&e==="assist"&&s.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{pn()}catch{}return!0}a(bs,"registerUpdateChecker");function hs(){let t={version:p,urls:n,check:$a,checkMain:La,registerChecker:bs,compareVersions:gr,parseUserscriptVersion:Qa,extractChangelogRange:rn,showUpdateToast:qa,maybeAutoCheckUpdate:Ta,listCheckers:a(()=>je.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(hs,"publishUpdateApi"),hs();let{rebuildSidebarCompletely:sn,syncMobileContentOffset:Oe,syncSidebarUnderNavbar:ke}=ki({}),{rebuildDashboard:gs}=ui({deps:{statCardPrivacyMarkup:ws}}),fs="urppp-clean-open",Ma={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ie(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ie,"isUnevaluatedScore");function Ir(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Ir,"isValidOfficialGpa");function Nr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Nr,"firstContentChar");function Ia(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Ia,"weekBitmapActive");function He(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ie(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Ma[o]!=null?Ma[o]:Ma[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(He,"scoreToGpa");function Re(t){let e=String(t||"").trim();if(!e||ie(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(Re,"scoreToNumber");function Ae(t){return Math.round((Number(t)||0)*100)/100}a(Ae,"round2");function ln(t){return/必修/.test(String(t||""))}a(ln,"isRequiredAttr");function ee(t){let e=0,r=0,o=0,s=0,i=0,l=0,g=0,h=0;return(t||[]).forEach(E=>{if(E&&(E.unevaluated||ie(E.score)))return;let M=Number(E.credit)||0,j=Re(E.score),z=Ir(E.officialGpa)?Number(E.officialGpa):He(E.score);j==null||M<=0||(e+=M,r+=j*M,z!=null&&(o+=z*M,s+=M),E.required&&(i+=M,l+=j*M,z!=null&&(g+=z*M,h+=M)))}),{totalCredit:Ae(e),avgScore:Ae(e?r/e:0),avgGpa:Ae(s?o/s:0),requiredCredit:Ae(i),requiredGpa:Ae(h?g/h:0),requiredAvg:Ae(i?l/i:0),count:(t||[]).length}}a(ee,"summarizeCourses");function Na(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Na,"absUrl");function Jt(t,e){let r=Na(t),o=e&&e.method||"GET",s=e&&e.data||null;return new Promise((i,l)=>{let g=a((h,E)=>h?i(E):l(new Error(E||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:s||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(h=>{h.status>=200&&h.status<400?g(!0,h.responseText||""):g(!1,"HTTP "+h.status)},"onload"),onerror:a(()=>g(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:s||void 0}).then(h=>{if(!h.ok)throw new Error("HTTP "+h.status);return h.text()}).then(h=>g(!0,h)).catch(h=>g(!1,h&&h.message))})}a(Jt,"fetchText");function Br(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Br,"parseHtml");function cn(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=jp,(document.head||document.documentElement).appendChild(t)}a(cn,"ensureFeatureStyles");function xs(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=Rp,(document.head||document.documentElement).appendChild(t)}a(xs,"ensureScheduleExportStyles");function ys(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=Up,(document.head||document.documentElement).appendChild(t)}a(ys,"ensureSettingsStyles");function dn(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let s=r.cloneNode(!0);s.querySelectorAll("small, i, img, b, .badge").forEach(g=>g.remove());let i=(s.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(g=>{g.nodeType===Node.TEXT_NODE&&g.textContent.trim()&&g.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=i||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(dn,"ensureNavNameTarget");function Fr(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Fr,"classifyPrivacyLabel");function vs(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(vs,"classifyHomeDataKey");function Dr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Dr,"homePrivateValueSpan");function ws(t,e){let r=at(t),o=at(e),s=vs(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[s]||Fr(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:Dr("organization",s,o)}:{valueHtml:Dr("organization",s,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let g=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&g){let E=g.index||0,M=String(e).slice(0,E),j=String(e).slice(E+g[0].length);return{valueHtml:r,labelHtml:`${at(M)}${Dr(l,s,at(g[0]))}${at(j)}`}}return{valueHtml:Dr(l,s,r),labelHtml:o}}a(ws,"statCardPrivacyMarkup");function Se(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||vr;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||vr)}a(Se,"privacyReplacement");function sr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(sr,"markPrivateText");function un(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||vr);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(un,"markPrivateAvatar");function ks(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(ks,"markPrivateBlock");function As(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(As,"markDirectEditable");let be=null;function mn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;be&&be.__finish&&be.__finish(!1);let r=ye();if(r.mode!=="custom"||!r.directEdit.enabled)return;let s=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),i=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),g=i.height>=8||!l?i:{left:i.left,top:l.top,width:Math.max(i.width,40),height:l.height},h=document.createElement("input"),E=getComputedStyle(t),M=Math.min(Math.max(g.width+64,140),Math.max(140,window.innerWidth-24)),j=Math.min(Math.max(12,g.left),Math.max(12,window.innerWidth-M-12)),z=Math.min(Math.max(12,g.top+(g.height-36)/2),Math.max(12,window.innerHeight-48));h.type="text",h.maxLength=80,h.className="urppp-direct-edit-input",h.value=s,h.setAttribute("aria-label","修改"+U[e]+"显示值"),h.style.left=j+"px",h.style.top=z+"px",h.style.setProperty("--urppp-direct-edit-width",M+"px"),h.style.fontFamily=E.fontFamily,h.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(E.fontSize)||14)))+"px";let F=!1,J=a(D=>{if(F||(F=!0,h.remove(),be===h&&(be=null),D))return;let R=ye();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(h.value||"").trim().slice(0,80),la(R),Vt(document),Oa(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");h.__finish=J,h.addEventListener("click",D=>D.stopPropagation()),h.addEventListener("blur",()=>J(!1)),h.addEventListener("keydown",D=>{D.key==="Enter"&&(D.preventDefault(),J(!1)),D.key==="Escape"&&(D.preventDefault(),J(!0))}),document.documentElement.appendChild(h),be=h,h.focus(),h.select()}a(mn,"openDirectEditInput");function Ss(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),mn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),mn(e))},!0))}a(Ss,"bindDirectEditInteraction");function _s(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(_s,"clearPrivacyDisplay");function bn(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(bn,"applyCustomText");function Es(t){let e=t&&t.querySelectorAll?t:document,r=qe(),s=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?dn(e):null);bn(s,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(g=>{let h=g.querySelector(".profile-info-name"),E=g.querySelector(".profile-info-value");!h||!E||String(h.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||bn(E,r.nameEnabled,r.name)});let i=tr(r.avatar),l=r.avatarEnabled&&!!i;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(g=>{let h=g.getAttribute("src")||"";h&&h!==g.__urpppAppliedCustomSrc&&(g.__urpppOriginalSrc=h),l?(g.__urpppOriginalSrc==null&&(g.__urpppOriginalSrc=h),h!==i&&g.setAttribute("src",i),g.__urpppAppliedCustomSrc=i):g.__urpppAppliedCustomSrc!=null&&(g.__urpppOriginalSrc&&g.setAttribute("src",g.__urpppOriginalSrc),delete g.__urpppAppliedCustomSrc)})}a(Es,"applyCustomIdentityDisplay");function Cs(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),s=r.querySelector(".profile-info-value, td:last-child");if(!o||!s||o===s)return;let i=Fr(o.textContent),l=Se(e,i);l&&sr(s,l)})}a(Cs,"applyProfilePrivacy");function Ps(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let s=o.map(i=>{let l=Fr(i.textContent);return["grade","gpa","credit"].includes(l)?l:""});s.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(i=>{let l=i.querySelectorAll("td");s.forEach((g,h)=>{let E=Se(e,g);g&&E&&sr(l[h],E)})})})}a(Ps,"applyScoreTablePrivacy");function zs(t){let e=t&&t.querySelectorAll?t:document,r=ye();if(r.mode==="off")return;let o=Se(r,"name"),s=Se(r,"avatar"),i=Se(r,"schedule"),l=o?dn(e):e.querySelector?.(".urppp-user-name-value");o&&sr(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([E,M])=>{let j=Se(r,M);j&&e.querySelectorAll(E).forEach(z=>sr(z,j))}),Ps(e,r);let h=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(E=>{let M=E.getAttribute("data-urppp-private"),j=E.getAttribute("data-urppp-edit-key"),F=(h&&j?String(r.directEdit.values[j]||"").trim():"")||Se(r,M);!["avatar","schedule"].includes(M)&&F&&sr(E,F),h&&j&&As(E,j)}),h&&Ss(),Cs(e,r),s&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(E=>{let M=E.matches("img")?E:E.querySelector("img");M?un(M,s):(E.classList.add("urppp-private-avatar-block"),E.setAttribute("data-urppp-private-mask",s))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(E=>un(E,s))),i){let E=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));E.filter(M=>!E.some(j=>j!==M&&j.contains(M))).forEach(M=>ks(M,i))}}a(zs,"applyPrivacyDisplay");let Ba=0,se=[];function hn(){let t=ye(),e=qe();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(hn,"personalDisplayIsEnabled");function Ls(){se=se.filter(({root:t})=>t&&t.isConnected),se.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(Ls,"resumePersonalDisplayObservers");function Vt(t){let e=t||document;se.forEach(({observer:r})=>r.disconnect());try{cn()}catch{}try{_s(e)}catch{}try{Es(e)}catch(r){console.warn("[URP++] custom identity",r)}try{zs(e)}catch(r){console.warn("[URP++] privacy",r)}hn()?(Ls(),Ts()):(clearTimeout(Ba),se=[])}a(Vt,"applyPersonalDisplay");function qs(t){clearTimeout(Ba),Ba=setTimeout(()=>Vt(t||document),140)}a(qs,"schedulePersonalDisplay");function Fa(){try{nt&&nt.open&&Ye()}catch{}}a(Fa,"refreshCleanPersonalDisplay");function Ts(){if(!hn()){se.forEach(({observer:t})=>t.disconnect()),se=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(se.some(r=>r.root===t))return;let e=new MutationObserver(()=>qs(document));se.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(Ts,"bindPersonalDisplayObservers");function $s(t){let e=Object.assign({},t||{}),r=qe();r.nameEnabled&&r.name&&(e.name=r.name);let o=tr(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a($s,"personalizedProfile");let gn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",Ms="/student/courseSelect/thisSemesterCurriculum/callback",Is="/student/courseSelect/thisSemesterCurriculum/index";async function Ns(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Jt(Ms),r=JSON.parse(e),o=Ze(r);if(o)return o}catch{}return""}a(Ns,"resolveSchedulePlanCode");async function fn(t){let e=await Ns(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Jt(gn,r),s;try{s=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=Ze(s)),(!s.jcsjbs||!s.jcsjbs.length)&&e&&(s=JSON.parse(await Jt(gn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let i=yn(s,e,t);if(!i.courses.length)throw new Error("没有读取到可导出的课表数据");return i}a(fn,"loadScheduleExportData");function Da(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(Da,"safeScheduleFilename");function ja(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(ja,"downloadBlob");function Bs(t){let e=Gr(t),r=Er(),o=r.enabled?Vr(e,r.mapping):Jr(e),s=JSON.stringify(o,null,2)+`
`;return ja(new Blob([s],{type:"application/json;charset=utf-8"}),Da(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(Bs,"exportScheduleJson");function xn(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let s=Number(r[4]);if(s<1||s>30)return"";let i=Za(new Date);return i.setDate(i.getDate()-(s-1)*7),yr(i)}a(xn,"deriveCurrentSemesterMonday");function yn(t,e,r){let o=e||Ze(t),s=xn(o)||ca()[o]||"";return pp(t,o,r,{firstMonday:s})}a(yn,"normalizeScheduleDataForPage");function Fs(t){let e=t.semester.planCode,r=ca()[e],o=xn(e);return o?(bo(e,o),Promise.resolve(o)):Ke(r)?Promise.resolve(r):new Promise((s,i)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||ep(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let g=a((h,E)=>{l.remove(),h?i(h):s(E)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>g(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let h=l.querySelector("input").value;Ke(h)&&(bo(e,h),g(null,h))}),l.addEventListener("click",h=>{h.target===l&&g(new Error("已取消导出"))})})}a(Fs,"requestScheduleFirstMonday");async function Ds(t){let e=await Fs(t),r=ap(t,e);return ja(new Blob([r],{type:"text/calendar;charset=utf-8"}),Da(t.semester.label)+".ics"),op(t)}a(Ds,"exportScheduleIcs");let js={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function le(t,e,r){if(typeof document>"u")return Gt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let s=getComputedStyle(o).color;o.remove();let i=String(s||"").match(/[\d.]+/g)?.map(Number)||[];if(i.length>=3){let l=hr(i[0],i[1],i[2]),g=i.length>3?Math.max(0,Math.min(1,i[3])):1;return g<1?Bt(r||e,l,g):l}return Gt(s)||Gt(e)||"#000000"}a(le,"resolvedScheduleImageColor");function vn(){let t=Qt(),e=oe(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},s={bg:le("--bg",o.bg),surface:le(e==="neu"?"--neu-base":"--surface",o.surface),input:le("--input-bg",o.input),text:le("--text",o.text),secondary:le("--text-secondary",o.secondary),muted:le("--text-muted",o.muted),border:le("--border",o.border,le(e==="neu"?"--neu-base":"--surface",o.surface)),primary:le("--primary",o.primary)},i={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(js[e]||e)+" · "+(Ct[t]&&Ct[t].name||t),colors:s,shape:i[e]||i.apple}}a(vn,"currentScheduleImageTheme");function wn(t,e){return hp(t,e||vn())}a(wn,"buildScheduleSvg");function Os(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),s=URL.createObjectURL(o),i=new Image;i.onload=()=>{try{let g=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),h=document.createElement("canvas");h.width=Math.floor(t.width*g),h.height=Math.floor(t.height*g);let E=h.getContext("2d");E.scale(h.width/t.width,h.height/t.height),E.fillStyle=t.background||"#F8FAFC",E.fillRect(0,0,t.width,t.height),E.drawImage(i,0,0,t.width,t.height),h.toBlob(M=>M?e(M):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(s)}},i.onerror=()=>{URL.revokeObjectURL(s),r(new Error("课表图片渲染失败"))},i.src=s})}a(Os,"svgToPngBlob");async function Hs(t){let e=await Os(wn(t));ja(e,Da(t.semester.label)+".png")}a(Hs,"exportSchedulePng");function Oa(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(Oa,"showFeatureToast");let Ha=gp({document,window,ensureStyles:xs,loadData:fn,exportJson:Bs,exportIcs:Ds,exportPng:Hs,showToast:Oa,nativePageUrl:Is,navigate:a(t=>{location.href=t},"navigate"),logger:console});function Rs(t,e,r,o){return Ha.run(t,e,r,o)}a(Rs,"runScheduleExport");function Us(t){return Ha.createMenu(t)}a(Us,"createScheduleExportMenu");function Ws(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(Ws,"disposeNativePdfCapture");function Gs(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let s=Np(e);t.stage="ok",t.stageCards=s.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=s.target.querySelector("table")?s.target.querySelector("table").id:"none",Ws(s)}catch(s){t.stage="failed",t.stageError=s&&s.message||String(s)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(Gs,"bindNativePdfDiagnose");function Js(t){return t?(Gs(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await Dp(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:pr})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Oa("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(Js,"pagePdfExportHandler");function Ra(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Ra,"isPersonalSchedulePage");function Vs(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(Vs,"isScoreQueryPage");function Ua(){if(!Ra())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let s=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),i=Us({source:"native",pdfHandler:Js(s)});if(i.id="urppp-native-schedule-export",s&&s.parentElement){s.__urpppNativeExportState||(s.__urpppNativeExportState={display:s.style.getPropertyValue("display"),displayPriority:s.style.getPropertyPriority("display"),ariaHidden:s.getAttribute("aria-hidden"),tabIndex:s.getAttribute("tabindex")}),s.setAttribute("data-urppp-native-export-source","1"),s.style.setProperty("display","none","important"),s.setAttribute("aria-hidden","true"),s.setAttribute("tabindex","-1"),s.parentElement.insertBefore(i,s.nextSibling);return}if(e)e.appendChild(i);else if(t)t.appendChild(i);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let g=document.createElement("div");g.className="urppp-export-fallback",g.appendChild(i),l.prepend(g)}}}a(Ua,"patchNativeScheduleExport");let Ue=null,jr=0;function Wa(){clearTimeout(jr),jr=0,Ue&&Ue.observer.disconnect(),Ue=null}a(Wa,"disconnectNativeScheduleExportObserver");function Ys(){if(!Ra()){Wa();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ue&&Ue.root===t&&t.isConnected)return;Wa();let e=new MutationObserver(()=>{clearTimeout(jr),jr=setTimeout(()=>Ua(),80)});e.observe(t,{childList:!0,subtree:!0}),Ue={root:t,observer:e}}a(Ys,"bindNativeScheduleExportObserver");function kn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(kn,"restoreOptionalAttribute");function Qs(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let s=o.__urpppNativeExportState;s&&(s.display?o.style.setProperty("display",s.display,s.displayPriority):o.style.removeProperty("display"),kn(o,"aria-hidden",s.ariaHidden),kn(o,"tabindex",s.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(Qs,"removeNativeScheduleExport");let An=vi({deps:{styles:Yp,loadScores:Bn,loadProfile:Sn,scoreToNumber:Re,scoreToGpa:He,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),Xs=Vn([Ur({id:"schedule-export",matches:a(t=>Ra(t.location),"matches"),mount:a(()=>{Ua(),Ys()},"mount"),unmount:a(t=>{Wa(),Qs(t?.lifecycleKey)},"unmount")}),Ur({id:"score-analysis",matches:a(t=>Vs(t.location),"matches"),mount:a(()=>{try{An.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{An.unmount()}catch{}},"unmount")})]);function Or(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return Xs.refresh({document,location,window,lifecycleKey:t})}a(Or,"refreshRouteFeatures");function Ks(t){Ha.bindHosts(t)}a(Ks,"bindScheduleExportHosts");function lr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(lr,"normalizeProfileValue");function Hr(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(s=>lr(s).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let s=0;s<o.length;s++){let i=o[s],l=i.querySelector(".profile-info-name, th, label"),g=i.querySelector(".profile-info-value, td:last-child");if(!l||!g||l===g)continue;let h=lr(l.textContent).replace(/[：:]/g,"");if(!r.some(M=>h===M||h.endsWith(M)))continue;let E=lr(g.textContent);if(E&&E!=="—"&&E!=="-")return E}return""}a(Hr,"readLabeledProfileValue");function We(t){return lr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(We,"cleanMajorPlanName");function Zs(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),s=lr(o);if(/主修必修GPA/.test(s)){let i=s.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||s.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(i){let l=Number(i[1]),g=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||g===0||l>0)&&(e.majorGpa=i[1])}}if(/主修为|培养方案/.test(s)){let i=s.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||s.match(/^(.{2,60}?)\s*主修为/)||s.match(/主修为\s*(.{2,60})$/),l=We(i&&i[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let g=/培养方案|教学计划/.test(l);(!e.majorPlan||g)&&(e.majorPlan=l)}}}),e}a(Zs,"extractAcademicOverview");async function Sn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let i=r.querySelector(".urppp-user-name-value"),l=i&&i.__urpppOriginalText;l&&(t.name=String(l).trim());let g=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),h=t.name?null:g.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!h){let E=r.cloneNode(!0);E.querySelectorAll("small, i, img, b, .badge").forEach(j=>j.remove());let M=(E.textContent||"").replace(/\s+/g," ").trim();M=M.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),h=M.match(/([\u4e00-\u9fa5·]{2,12})/)}h&&h[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(h[1])&&(t.name=h[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let s=Zs(document);t.majorPlan=s.majorPlan,t.majorGpa=s.majorGpa}catch{}try{let r=await Jt("/student/rollManagement/rollInfo/index"),o=Br(r),s=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Hr(o,["姓名"]),!t.name)){let h=s.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);h&&(t.name=h[1].trim())}let i=Hr(o,["主修方案名称"]),l=Hr(o,["专业"]);t.studentId=Hr(o,["学号"]),i?t.majorPlan=We(i):!t.majorPlan&&l&&(t.majorPlan=We(l));let g=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(g&&g.getAttribute("src")&&!t.avatar){let h=g.getAttribute("src");t.avatar=/^https?:/i.test(h)?h:Na(h)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(Sn,"loadProfile");let _n=["周日","周一","周二","周三","周四","周五","周六"];function Ga(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(s=>{let i=String(s.id||"").match(/^(\d+)_(\d+)$/);if(!i)return;let l=parseInt(i[1],10),g=parseInt(i[2],10),h=l===7?0:l,E=s.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),M=E.length?E:[];if(!M.length&&(s.textContent||"").trim()){let j=(s.textContent||"").replace(/\s+/g," ").trim();j&&e.push({name:j.slice(0,40),teacher:"",place:"",week:"",day:h,section:g});return}M.forEach(j=>{let z=Array.from(j.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),F=(j.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(j.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",D=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=z.find(K=>/周/.test(K))||"",B=String(F).replace(/_\d+\s*$/,"").trim();!B||B.length<2||e.push({name:B,teacher:String(D).trim(),place:String(J||"").trim(),week:String(R).trim(),day:h,section:g})})});let o=new Set;return e.filter(s=>{let i=[s.day,s.section,s.name,s.place].join("|");return o.has(i)?!1:(o.add(i),!0)})}a(Ga,"parseScheduleFromDoc");let En="urppp_term_week_v1";function Ge(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(En,e)}catch{}return e}a(Ge,"rememberTermWeek");function cr(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(En,0))||0;if(t>=1&&t<=30)return Ge(t)}catch{}return 0}a(cr,"readRememberedTermWeek");function dr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let s=e.match(r[o]);if(s){let i=parseInt(s[1],10);if(i>=1&&i<=30)return i}}return 0}a(dr,"extractTermWeekFromText");function _e(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let g=t[l],h=dr(g.innerText||g.textContent||"")||dr(g.innerHTML||"");if(h)return Ge(h)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=dr(e);if(r)return Ge(r);let o=document.body&&document.body.innerText||"",s=dr(o);if(s)return Ge(s);let i=cr();if(i)return i}catch{}return 0}a(_e,"getCurrentWeekNumber");let Je=null;function tl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(tl,"calTodayStr");function el(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(s=>String(s).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(el,"calAddDays");function ur(t){if(Je)return Je;let e=t||tl();return e>="2027-02-06"&&e<=el("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(ur,"calVacation");function rl(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(rl,"festiveDecorHtml");function Cn(){let t=typeof document<"u"?document:null;if(!t)return;let e=ur()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",rl()):!e&&r&&r.remove()}a(Cn,"syncFestiveDecor");function Pn(t){Je=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Je&&Je!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{Cn()}catch{}try{typeof Ye=="function"&&Ye()}catch{}return Je}a(Pn,"setCalendarPhase");function al(){return ur()}a(al,"getCalendarPhase");function zn(){if(ur()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=_e()||cr()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(zn,"getViewWeekNumber");async function ol(){let t=_e();if(t>=1)return t;try{let e=await Jt("/index");if(t=dr(e),t)return Ge(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),s=await Jt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),i=JSON.parse(s),l=Number(i&&i.jxzc);if(l>=1&&l<=30)return Ge(l)}catch{}return cr()||0}a(ol,"ensureTermWeekResolved");function nl(t){let e=_e()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let s=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);s&&(e=Math.max(e,parseInt(s[2],10)||0));let i=String(r.week||"").match(/\d{1,2}/g);i&&i.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(nl,"inferMaxWeek");function Ln(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Ln,"weekBitActive");let qn=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function Tn(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return qn[e%qn.length]}a(Tn,"courseColor");function pl(t){let e=[],r=_e();(t&&t.xkxx||[]).forEach(i=>{Object.keys(i||{}).forEach(l=>{let g=i[l];if(!g)return;let h=g.courseName||g.englishCourseName||l,E=g.attendClassTeacher||"";(g.timeAndPlaceList||[]).forEach(j=>{let z=Number(j.classDay)||0,F=z===7?0:z,J=Number(j.classSessions)||1,D=Math.max(1,Number(j.continuingSession)||1),R=[j.campusName,j.teachingBuildingName,j.classroomName].filter(Boolean).join(""),B=j.weekDescription||g.skzcs||"",K=Ln(j.classWeek,r)||r&&B.indexOf(String(r))>=0;e.push({name:String(h).trim(),teacher:String(E).trim(),place:String(R).trim(),week:String(B).trim(),classWeek:String(j.classWeek||""),day:F,section:J,span:D,thisWeek:!!K,color:Tn(h)})})})});let s=new Set;return e.filter(i=>{let l=[i.day,i.section,i.span,i.name,i.place,i.week].join("|");return s.has(l)?!1:(s.add(l),!0)})}a(pl,"parseScheduleFromJson");async function il(){try{let t=await Jt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let s=Number(r&&(r.jxzc||r.zc||r.currentWeek));s>=1&&s<=30&&(nt._termWeek=Math.max(nt._termWeek||0,s),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=pl(r)}catch{e=Ga(Br(t))}e.length||(e=Ga(document));let o=r?yn(r,Ze(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=Ga(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(il,"loadSchedule");function sl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),s=r.match(o);if(s&&s[1])return s[1];let i=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(i);return l?l[1]:""}a(sl,"extractScoreCallback");function ll(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let s=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",i=[];(o.cjList||[]).forEach(l=>{let g=l.courseName||l.englishCourseName||"";if(!g)return;let h=l.cj!=null&&l.cj!==""?String(l.cj):"";!h&&l.courseScore!=null&&(h=String(l.courseScore)),!h&&l.gradeName&&(h=String(l.gradeName)),!h&&l.zscj!=null&&(h=String(l.zscj));let E=l.courseAttributeName||l.xkcsxmc||"",M=parseFloat(l.credit)||0,j=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",F=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ie(h)||ie(l.gradeName)||F!=null&&F<0,D=J?"未评估":h;i.push({code:j,seq:String(z||""),name:g,attr:E,credit:M,score:D,unevaluated:J,required:ln(E),officialGpa:Ir(F)?F:null,evalUrl:""})}),i.length&&e.push({title:String(s).slice(0,100),courses:i,summary:ee(i),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(ll,"parseScoreJson");async function $n(t,e){let r=await Jt(t),o=Mn(Br(r));if(o.length)return o;let s=sl(r,e);if(!s)return[];let i=await Jt(s);try{let l=JSON.parse(i);o=ll(l).map(g=>(g.summary=ee(g.courses),g))}catch{o=Mn(Br(i))}return o}a($n,"loadScoreByIndex");function Mn(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map(M=>(M.textContent||"").replace(/\s+/g,""));if(!o.length)return;let s=o.join("|");if(!/课程名/.test(s)||!/成绩/.test(s))return;let i={code:o.findIndex(M=>M==="课程号"),name:o.findIndex(M=>M==="课程名"),attr:o.findIndex(M=>/课程属性|属性/.test(M)),credit:o.findIndex(M=>M==="学分"),score:o.findIndex(M=>M==="成绩")};if(i.name<0||i.score<0)return;let l="成绩",g=r.previousElementSibling;for(let M=0;M<8&&g;M++,g=g.previousElementSibling)if(/^H[1-4]$/.test(g.tagName)||g.classList&&g.classList.contains("header")){l=(g.textContent||"").replace(/\s+/g," ").trim();break}let h=[],E=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(E).forEach(M=>{let j=Array.from(M.cells||M.querySelectorAll("td"));if(j.length<4)return;let z=a(B=>B>=0&&j[B]?(j[B].textContent||"").replace(/\s+/g," ").trim():"","get"),F=z(i.name),J=z(i.score);if(!F||!J||/课程名|序号/.test(F))return;let D=z(i.attr),R=ie(J);h.push({code:z(i.code),name:F,attr:D,credit:parseFloat(z(i.credit))||0,score:R?"未评估":J,unevaluated:R,required:ln(D),officialGpa:null,evalUrl:""})}),h.length&&e.push({title:l.slice(0,100),courses:h,summary:ee(h)})}),e}a(Mn,"parseScoreTables");function mr(t){return We(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(mr,"schemePlanName");function In(t,e){if(!t||!t.length)return 0;let r=We(e),o=t.findIndex(l=>{let g=mr(l);return/培养方案/.test(g)&&!/微专业|辅修|双学位/.test(g)});if(o>=0&&(!r||mr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let g=mr(l);return g.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(g.slice(0,4))||g.includes(r.slice(0,4))}),o>=0))return o;let s=0,i=-1;return t.forEach((l,g)=>{if(/微专业|辅修/.test(mr(l)))return;let h=(l.courses||[]).length;h>i&&(i=h,s=g)}),s}a(In,"pickMajorSchemeIndex");async function cl(){let t={};try{let e=await Jt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(s=>{let i=String(s.KCH||"").trim();if(!i)return;let l=String(s.SFPG)==="1",g=String(s.KTID||"").trim();if(!t[i]){t[i]={ktid:g,kxh:String(s.KXH||""),kcm:s.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&g?"/student/teachingEvaluation/newEvaluation/evaluation/"+g:"/student/teachingEvaluation/newEvaluation/index"};return}t[i].total+=1,l||(t[i].pending+=1,t[i].done=!1,g&&(t[i].ktid=g,t[i].url="/student/teachingEvaluation/newEvaluation/evaluation/"+g))}),Object.keys(t).forEach(s=>{let i=t[s];i.done=!(i.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(cl,"loadEvaluationMap");function dl(t){if(!t)return!1;if(t.officialGpa!=null&&Ir(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ie(e)?!1:Re(e)!=null||He(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(dl,"hasDisplayableScore");function ul(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(s=>{if(!s||!s.code)return;let i=e[s.code];if(i){if(dl(s)){s.unevaluated=!1,i.done?s.evalUrl=s.evalUrl||"":s.evalUrl=i.url||"/student/teachingEvaluation/newEvaluation/index";return}i.done||(s.unevaluated=!0,s.evalUrl=i.url||"/student/teachingEvaluation/newEvaluation/index",(!s.score||s.score===""||ie(s.score))&&(s.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(ul,"attachEvaluationLinks");function Nn(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=ee(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=ee(e.courses),e)),t)}a(Nn,"refreshScoreSummaries");async function ml(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await cl();return ul(t,e),t.evalMap=e,t.evaluationReady=!0,Nn(t)}finally{t.evaluationLoading=!1}}a(ml,"enrichScoresWithEvaluation");function bl(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=In(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let s=mr(o),i=We(nt.profile.majorPlan);/培养方案|教学计划/.test(s)&&(!/培养方案|教学计划/.test(i)||i==="主修方案")&&(nt.profile.majorPlan=s);let l=o.summary||{},g=Number(l.requiredCredit),h=Number(l.requiredGpa),E=Number(nt.profile.majorGpa);g>0&&Number.isFinite(h)&&h>=0&&h<=5&&(!Number.isFinite(E)||E<=0)&&(nt.profile.majorGpa=String(Ae(h)))}a(bl,"reconcileProfileAndScores");let Ve=null;async function Bn(t){return t&&(Ve=null),Ve&&!Ve.error||(Ve=await hl()),Ve}a(Bn,"loadScores");async function hl(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([$n("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),$n("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(s=>s.courses.forEach(i=>{o.push(Object.assign({term:s.title},i))})),t.passing=[{title:"全部及格成绩",courses:o,summary:ee(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:ee(o)}]),Nn(t),t.majorIdx=In(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(hl,"loadScoresImpl");function Ee(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(Ee,"parseJsonArrayLoose");function Fn(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let s=0;for(let i=o;i<t.length&&i<o+3e5;i++){let l=t[i];if(l==="[")s++;else if(l==="]"&&(s--,s===0))return t.slice(o,i+1)}return""}a(Fn,"extractBalancedArray");async function gl(){let t=await Jt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let i=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(i&&(e=Ee(i)),l&&(r=Ee(l)),!e.length){let g=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);g&&(e=Ee(g[1]))}if(!r.length){let g=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);g&&(r=Ee(g[1]))}if(!r.length){let g=Fn(t,"teachingBuildingName");g&&(r=Ee(g))}if(!e.length){let g=Fn(t,"campusName");g&&(e=Ee(g))}}catch(i){console.warn("[URP++] classroom json parse",i)}if(!r.length){let i=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=i;let l=[];for(let g of i)try{let h=await Jt("/student/teachingResources/classroomCurriculum/"+g.campusNumber+"/teachingBuildingJson");Ee(h).forEach(M=>{l.push({id:{campusNumber:g.campusNumber,teachingBuildingNumber:String(M.id&&M.id.teachingBuildingNumber||M.teachingBuildingNumber||"")},teachingBuildingName:M.teachingBuildingName||M.name||""})})}catch(h){console.warn("[URP++] building json",g.campusNumber,h)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(i=>({campus:i.campusName||i.campusNumber,campusNumber:String(i.campusNumber||i.id&&i.id.campusNumber||""),buildings:[]}));r.forEach(i=>{let l=String(i.id&&i.id.campusNumber||i.campusNumber||""),g=String(i.id&&i.id.teachingBuildingNumber||i.teachingBuildingNumber||""),h=i.teachingBuildingName||i.name||g;if(!l||!g||!h)return;let E=o.find(j=>j.campusNumber===l);E||(E={campus:l,campusNumber:l,buildings:[]},o.push(E));let M="/student/teachingResources/classroomUseStatus/"+l+"/"+g+"/"+encodeURI(encodeURI(E.campus||l))+"/"+encodeURI(encodeURI(h));E.buildings.push({name:h,path:M,campusNumber:l,buildingNumber:g})});let s=o.filter(i=>i.buildings.length);if(!s.length)throw new Error("未解析到教学楼，请刷新后重试");return s}a(gl,"loadClassroomCatalog");function br(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(br,"occupancyTypeLabel");function fl(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return br(t)}a(fl,"occupancyReason");async function xl(t,e,r,o){let s=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),i=await Jt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+s.toString());try{let l=JSON.parse(i);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(g=>g&&typeof g=="object"&&(g.kcm||g.id&&g.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(xl,"fetchClassroomCurriculum");function yl(t,e,r){let o=t||[],s=Number(e.xq)||0,i=Number(e.start)||0,l=Number(r)||0,g=[];return o.forEach(h=>{let E=h.id||{},M=Number(E.skxq!=null?E.skxq:h.skxq)||0,j=Number(E.skjc!=null?E.skjc:h.skjc)||0,z=Math.max(1,Number(h.cxjc)||1),F=E.skzc||h.skzc||"";s&&M&&s!==M||i&&(i<j||i>=j+z)||l&&F&&!Ia(F,l)||g.push(h)}),g.length?(g.sort((h,E)=>{let M=Ia(h.id&&h.id.skzc||h.skzc,l)?0:1,j=Ia(E.id&&E.id.skzc||E.skzc,l)?0:1;return M-j}),g[0]):null}a(yl,"matchCurriculumCourse");async function vl(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),s=String(e.buildingNumber||""),i=r||t.planNumber||"";if(!o||!s||!i)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(F=>F.busy)),g={},h=a(async z=>{if(g[z])return g[z];try{g[z]=await xl(i,o,s,z)}catch{g[z]=[]}return g[z]},"queue"),E=4,M=0,j=new Array(Math.min(E,Math.max(l.length,1))).fill(0).map(async()=>{for(;M<l.length;){let z=M++,F=l[z],J=await h(F.name);(F.slots||[]).forEach(D=>{if(!D.busy)return;let R={xq:D.detail&&D.detail.xq||D.xq||0,start:D.section,week:t.jxzc};D.detail&&D.detail.xq!=null&&(R.xq=D.detail.xq);let B=yl(J,R,t.jxzc);if(B&&B.kcm){let K=String(B.kcm).trim();D.contentName=K,D.reason=K,D.displayChar=Nr(K),D.detail&&(D.detail.contentName=K,D.detail.reason=K,D.detail.teacher=B.jsm||"",D.detail.weeks=B.zcsm||"",D.detail.courseNo=B.id&&B.id.kch||"",D.detail.typeLabel=br({occupancymoduleId:D.module}))}else D.displayChar=Nr(D.reason||"占用"),D.detail&&(D.detail.typeLabel=br({occupancymoduleId:D.module}))})}});return await Promise.all(j),t}a(vl,"enrichOccupancyWithCurriculum");function wl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(wl,"occupancyKindClass");async function kl(t){let e="",r="",o="",s="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",s=t.path||"";else{s=String(t||"");let B=s.match(/classroomUseStatus\/(\d+)\/(\d+)\//);B&&(e=B[1],r=B[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let i=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=Al(Dn(new Date,i)),g="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),h=await new Promise((B,K)=>{let ut=Na("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:g,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?B(vt.responseText||""):K(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:g}).then(vt=>vt.text()).then(B).catch(K)}),E;try{E=JSON.parse(h)}catch{throw new Error("jasInfo 非 JSON")}let M=(E.classrooms||[]).map(B=>{let K=B.classroomName||B.id&&B.id.classroomNumber||"",ut=B.placeNum||"",vt=B.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:K,seats:ut,type:vt,slots:Et,map:{}}}),j={};M.forEach(B=>{j[B.name]=B}),(E.classroomTime||[]).forEach(B=>{let K=B.id||{},ut=K.classroomNumber||"",vt=Number(K.sessionstart)||1,Et=Math.max(1,Number(B.continuingsession)||1),Lt=j[ut];if(!Lt)return;let qt=br(B),Ot=fl(B);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let $t=Lt.slots.find(re=>re.section===Ht);$t&&($t.busy=!0,$t.kind=B.timestatenumber||B.occupancymoduleId||"",$t.module=B.occupancymoduleId||"",$t.reason=Ot,$t.typeLabel=qt,$t.displayChar=Nr(Ot),$t.xq=K.xq,$t.weekBitmap=K.week||"",$t.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:K.week||"",xq:K.xq||"",state:B.timestatenumber||"",module:B.occupancymoduleId||""})}});let z="";try{let B=E.jhZxjxjhb;typeof B=="string"&&/\d{4}-\d{4}-\d-\d/.test(B)?z=B:B&&typeof B=="object"&&(z=String(B.zxjxjhh||B.jhxnxq||B.executiveEducationPlanNumber||B.planNumber||""))}catch{}if(!z&&E.classrooms&&E.classrooms[0]&&E.classrooms[0].id&&(z=E.classrooms[0].id.executiveEducationPlanNumber||""),E.jxzc!=null&&Number(E.jxzc)>=1){let B=Number(E.jxzc);nt._termWeek=Math.max(nt._termWeek||0,B),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let F=["日","一","二","三","四","五","六"],J=Sl(E.date||l)||Dn(new Date,i),D=E.week!=null?Number(E.week):J.getDay(),R=i===1?"明天":i===2?"后天":"今天";return{rooms:M,dateLabel:(E.date||l)+"（周"+(F[D]||D)+" · "+R+"）",jxzc:E.jxzc,planNumber:z,week:E.week!=null?E.week:D,searchDate:E.date||l,dateOffset:i}}a(kl,"loadBuildingOccupancy");function Dn(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(Dn,"addDays");function Al(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(Al,"formatLocalDate");function Sl(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(Sl,"parseLocalDate");let jn={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function On(t){return jn[t]||jn.more}a(On,"ico");let nt=Xp();function _l(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=Jp,(document.head||document.documentElement).appendChild(t)}a(_l,"ensureStyle");let El=ea({deps:{scoreToNumber:Re,scoreToGpa:He}}),{metricHtml:Cl,occupancyHtml:Pl,render:Ye,renderScheduleBoard:Ac,roomPickerHtml:zl,scheduleRender:Ll}=li({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:_n,analyzeScores:a(t=>El.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Vt,bandsChartSvg:aa,bindUI:a(t=>Tl(t),"bindUI"),classifyPrivacyLabel:Fr,courseColor:Tn,ensureRoot:a(()=>Rn(),"ensureRoot"),escapeHtml:at,firstContentChar:Nr,getViewWeekNumber:zn,ico:On,isCleanAnalysisDirect:ia,occupancyKindClass:wl,occupancyTypeLabel:br,personalizedProfile:$s,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Re,summarizeCourses:ee,trendChartSvg:ra,weekBitActive:Ln,calVacation:ur,setCalendarPhase:Pn}}),{ensureRoomCatalogLoaded:Hn,loadAll:ql}=Zp({state:nt,deps:{ensureTermWeekResolved:ol,enrichScoresWithEvaluation:ml,getCurrentWeekNumber:_e,loadClassroomCatalog:gl,loadProfile:Sn,loadSchedule:il,loadScores:Bn,readRememberedTermWeek:cr,reconcileProfileAndScores:bl,render:Ye,scheduleRender:Ll}}),{bindUI:Tl,closeModal:$l,getRoomHost:Sc,openModal:_c,openRoomModal:Ec,openScoreModal:Cc,showBuilding:Pc}=ci({state:nt,deps:{DAY_NAMES:_n,applyPersonalDisplay:Vt,bindScheduleExportHosts:Ks,closeCleanMode:a(()=>Il(),"closeCleanMode"),ensureRoomCatalogLoaded:Hn,enrichOccupancyWithCurriculum:vl,ensureRoot:a(()=>Rn(),"ensureRoot"),escapeHtml:at,fetchText:Jt,getCurrentWeekNumber:_e,getViewWeekNumber:zn,inferMaxWeek:nl,isUnevaluatedScore:ie,isValidOfficialGpa:Ir,loadBuildingOccupancy:kl,metricHtml:Cl,occupancyHtml:Pl,render:Ye,rootEl:a(()=>Nl(),"rootEl"),roomPickerHtml:zl,scoreToGpa:He,scoreToNumber:Re,summarizeCourses:ee,summarizeCoursesPreferOfficial:ee}}),{cleanModeApi:Ml,closeCleanMode:Il,ensureRoot:Rn,injectCleanEntry:zc,openCleanMode:Lc,rootEl:Nl}=di({state:nt,deps:{CLEAN_FLAG:fs,applySkinAttr:te,closeModal:$l,ensureRoomCatalogLoaded:Hn,ensureStyle:_l,getCurrentWeekNumber:_e,getSkin:oe,handleThemeDotClick:ct,ico:On,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:go,loadAll:ql,openSettingsPanel:Wo,readRememberedTermWeek:cr,refreshCleanPersonalDisplay:Fa,render:Ye,scoreToGpa:He,summarizeCourses:ee,syncNavbarThemeUI:ft,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=Ml;function Ja(){if(!document.body){setTimeout(Ja,10);return}if(Ti(),Wt(Qt()),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],s=r.parentElement;for(;s;){let i=s.scrollTop,l=s.scrollLeft;(i||l||s.scrollHeight>s.clientHeight||s.scrollWidth>s.clientWidth)&&o.push({el:s,top:i,left:l}),s=s.parentElement}requestAnimationFrame(()=>{o.forEach(i=>{i.el.scrollTop=i.top,i.el.scrollLeft=i.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))Ao();else{Ui();try{cn()}catch{}try{Or()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Vt(document)}catch{}try{Cn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{Or()}catch{}try{Vt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{pa()&&go()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(Ja,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(ke,50)}),window.addEventListener("load",()=>{ke(),Oe(),setTimeout(ke,100),setTimeout(ke,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Oe,0),setTimeout(Oe,50),setTimeout(Oe,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Oe,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function Un(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let s=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),i=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));s&&!i&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){ke(),sn(),st(),ke();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(i=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},i)),xa(),Oo(),Ho(),$o(),Ro(),jo(),Io(),document.querySelectorAll(".page-content, #page-content-template").forEach(i=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);i.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),i.style.setProperty("box-sizing","border-box","important")}),zr(),Tr(),Ne(),setTimeout(Ne,300),setTimeout(Ne,1e3),Co(),me(),or(),Lo(),setTimeout(or,300),nr(),setTimeout(()=>nr(),500),Pr(),zo();try{Or()}catch{}try{Vt(document)}catch{}setTimeout(()=>{try{Or()}catch{}try{Vt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...s){let i=r.apply(this,s);return e(),i},history.replaceState=function(...s){let i=o.apply(this,s);return e(),i}}a(Un,"watchRouteChanges");let Qe=typeof unsafeWindow<"u"?unsafeWindow:window;Qe.__urpppDebug=Qe.__urpppDebug||{},Qe.__urpppDebug.setCalendarPhase=t=>Pn(t),Qe.__urpppDebug.getCalendarPhase=()=>al(),Qe.__urpppDebug.calVacation=t=>ur(t),Qe.urppp={version:p,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Wt(t)},"apply"),setAccent:Si,getAccent:Yt,getCurrent:Qt,list:a(()=>Object.entries(Ct).map(([t,e])=>({name:t,displayName:e.name,current:t===Qt()})),"list")},update:{check:$a,auto:Ta,showToast:qa},privacy:{get:ye,set(t){return la(t),Vt(document),ye()},apply:a(()=>Vt(document),"apply"),identity:{get:qe,set(t){return mo(t),Vt(document),Fa(),qe()}}},scheduleExport:{load:a(()=>fn("api"),"load"),run:a(t=>Rs(t,"api",null,null),"run"),patch:Ua,image:{theme:vn,build:a((t,e)=>wn(t,e),"build")},jsonFormat:{get:Er,set:ho,validate:Pe,build(t,e){let r=Gr(t);if(e)return Vr(r,Pe(e));let o=Er();return o.enabled?Vr(r,o.mapping):Jr(r)},buildDefault(t){return Jr(Gr(t))}}}};function Wn(){setTimeout(()=>{try{Ta()}catch{}},1800)}a(Wn,"scheduleAutoUpdateCheck"),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ja(),Un(),Wn()}):(Ja(),Un(),Wn())})();})();
