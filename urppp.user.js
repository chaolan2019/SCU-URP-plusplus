...
半夜Vibe有点爽怎么回事。</p>`,"    </div>","  </div>","</div>"].join("")}a($p,"buildSettingsPanelHtml");var te="urppp_plugin_",fc="1.0.0";function lo({GM:p,doc:n,hostInfo:c,uiDeps:d}){let{getValue:u=a(()=>null,"getValue"),setValue:A=a(()=>{},"setValue"),xmlHttp:P,addStyle:_}=p||{},y=(typeof d=="function"?d:d&&d.openSubpanel)||null,S=new Map,f=new Map,w=new Map,T=[],C=null;function g(N,Y){let tt=w.get(N);tt&&tt.forEach(bt=>{try{bt(Y)}catch{}})}a(g,"emit");function b(N,Y){return w.has(N)||w.set(N,new Set),w.get(N).add(Y),()=>w.get(N).delete(Y)}a(b,"on");function v(N,Y){return u(`${te}${N}_${Y}`)}a(v,"storageGet");function x(N,Y,tt){A(`${te}${N}_${Y}`,tt)}a(x,"storageSet");function E(){return N=>({get:a(Y=>v(N,Y),"get"),set:a((Y,tt)=>x(N,Y,tt),"set"),remove:a(Y=>A(`${te}${N}_${Y}`,void 0),"remove")})}a(E,"storage");function q(N,Y={}){return new Promise((tt,bt)=>{if(typeof P!="function"){bt(new Error("GM_xmlhttpRequest 不可用（未授权跨域？）"));return}P({method:Y.method||"GET",url:N,headers:Y.headers||{},data:Y.data,timeout:Y.timeout||8e3,onload:a(ht=>ht.status>=200&&ht.status<300?tt(ht.responseText):bt(new Error(`HTTP ${ht.status}`)),"onload"),onerror:a(()=>bt(new Error("网络错误")),"onerror"),ontimeout:a(()=>bt(new Error("超时(8s)")),"ontimeout")})})}a(q,"request");async function I(N,Y){let tt=Array.isArray(N)?N:[N],bt=[];for(let ht=0;ht<tt.length;ht+=1){let zt=tt[ht];Y&&Y({stage:"downloading",index:ht+1,total:tt.length,url:zt});try{let yt=await q(zt);return Y&&Y({stage:"downloaded",url:zt,size:yt.length}),yt}catch(yt){bt.push(`源${ht+1}(${L(zt)})失败: ${yt&&yt.message?yt.message:yt}`),Y&&Y({stage:"source_failed",index:ht+1,total:tt.length,error:yt&&yt.message?yt.message:yt})}}throw new Error("所有下载源失败 → "+bt.join(" ｜ "))}a(I,"fetchWithFallback");function L(N){try{return new URL(N).host}catch{return N}}a(L,"shortHost");function O(N){let Y=String(N||"").match(/\/\/\s*==UserScript==[\s\S]*?\/\/\s*==\/UserScript==/);return Y?N.replace(Y[0],""):N}a(O,"stripMetadata");function M(N,Y){try{let tt=O(N),bt=["GM_getValue","GM_setValue","GM_xmlhttpRequest","GM_registerMenuCommand","GM_addStyle","unsafeWindow"],ht=[typeof GM_getValue=="function"?GM_getValue:void 0,typeof GM_setValue=="function"?GM_setValue:void 0,typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:void 0,typeof GM_registerMenuCommand=="function"?GM_registerMenuCommand:void 0,typeof GM_addStyle=="function"?GM_addStyle:void 0,typeof unsafeWindow<"u"?unsafeWindow:null];return new Function(...bt,tt)(...ht),!0}catch(tt){return console.warn("[URP++ plugin] 注入失败",Y,tt),!1}}a(M,"inject");function H(N,Y){let tt=f.get(N);return tt?(tt.enabled=!!Y,A(`${te}${N}_enabled`,tt.enabled),g(Y?"enabled":"disabled",N),!0):!1}a(H,"setEnabled");function G(N){let Y=f.get(N);return!!Y&&Y.enabled}a(G,"isEnabled");function U(N){if(!N||!N.id)return!1;if(S.has(N.id)&&S.get(N.id).__urpppRegistered)return!0;let Y=Object.assign({type:"plugin"},N);Y.__urpppRegistered=!0,S.set(N.id,Y);let tt=f.get(N.id)||{loaded:!1,enabled:!1,version:N.version||""};return tt.version=Y.version||tt.version,f.set(N.id,tt),g("registered",Y.id),!0}a(U,"register");function et(N){return S.get(N)||null}a(et,"get");function it(N){let Y=[];for(let tt of S.values())(!N||tt.type===N)&&Y.push(tt);return Y}a(it,"list");function mt(N){let Y=f.get(N);return!!Y&&Y.loaded}a(mt,"loaded");async function V(N,Y,tt){tt&&tt({stage:"start",id:N});let bt=Array.isArray(Y)?Y:Y?[Y]:rt(N),ht=await I(bt,tt);A(`${te}${N}_code`,ht),tt&&tt({stage:"injecting",id:N});let zt=M(ht,N),yt=f.get(N)||{loaded:!1,enabled:!1,version:""};return yt.loaded=zt,yt.enabled=zt,yt.code=ht,yt.version=yt.version||Q(ht),f.set(N,yt),A(`${te}${N}_enabled`,zt),g("loaded",N),zt}a(V,"install");function Q(N){let Y=String(N||"").match(/@version\s+(\S+)/);return Y?Y[1]:""}a(Q,"detectVersion");async function ot(N,Y,tt){let bt=Array.isArray(Y)?Y:Y?[Y]:rt(N),ht=await I(bt,tt);A(`${te}${N}_code`,ht);let zt=Q(ht),yt=f.get(N)||{loaded:!1,enabled:!1,version:""};return yt.version=zt||yt.version,yt.code=ht,f.set(N,yt),g("updated",N),{ok:!0,version:zt||yt.version}}a(ot,"update");function K(N){let Y=u(`${te}${N}_code`);if(!Y)return!1;let tt=f.get(N);if(tt&&tt.loaded)return!0;let bt=M(Y,N),ht=f.get(N)||{loaded:!1,enabled:!1,version:Q(Y)};return ht.loaded=bt,ht.enabled=bt&&u(`${te}${N}_enabled`)!==!1,ht.code=Y,f.set(N,ht),g("loaded",N),bt}a(K,"bootFromCache");function ct(N){let Y=S.get(N);return S.delete(N),f.delete(N),A(`${te}${N}_enabled`,!1),g("unregistered",N),!!Y}a(ct,"unregister");function rt(N){return N==="assist"?["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/plugins/urpppp.plugin.js","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/plugins/urpppp.plugin.js","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/plugins/urpppp.plugin.js"]:[]}a(rt,"pluginSource");let st={protocolVersion:fc,register:U,unregister:ct,get:et,list:it,loaded:mt,isEnabled:G,enable:a((N,Y=!0)=>H(N,Y),"enable"),disable:a(N=>H(N,!1),"disable"),install:V,update:ot,bootFromCache:K,storage:a(()=>u&&{get:a(N=>u(N),"get"),set:a((N,Y)=>A(N,Y),"set")},"storage"),pluginStorage:a(N=>E()(N),"pluginStorage"),request:q,addStyle:a(N=>{try{_&&_(N)}catch{}},"addStyle"),log:a((...N)=>{console.log("[URP++ plugin]",...N)},"log"),on:b,emit:g,hostInfo:Object.assign({name:"SCU URP++"},c||{}),getSubpanel:a(()=>y,"getSubpanel")};try{window.__urpppPlugin=st}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppPlugin=st)}catch{}function ft(N){if(!N||!n||N.querySelector(".urppp-plugin-sec, .urpppp-entry-sec"))return;let Y=n.createElement("section");Y.className="urppp-set-sec urppp-plugin-sec",Y.id="urppp-plugin-sec",Y.innerHTML=`
    ...
    `,(n.head||n.documentElement).appendChild(N)}a(kt,"ensureStoreStyle");function wt(N){if(!N)return;N.innerHTML="";let Y=Array.from(S.values());if(!Y.length){N.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}Y.forEach(tt=>{let bt=f.get(tt.id)||{},ht=n.createElement("div");ht.className="urppp-store-item";let zt=n.createElement("div");zt.className="urppp-store-info",zt.innerHTML="<strong>"+Z(tt.name||tt.id)+'</strong><span class="urppp-store-ver">'+(tt.version?"v"+Z(tt.version):"")+'</span><span class="urppp-store-state'+(bt.loaded?" ok":"")+'">'+(bt.loaded?"已装载":"未装载")+"</span>";let yt=n.createElement("div");yt.className="urppp-store-ops";let Ft=n.createElement("button");Ft.type="button",Ft.textContent="重新装载",Ft.addEventListener("click",async()=>{Ft.disabled=!0,Ft.textContent="装载中…";try{let It=await V(tt.id,null);Ft.textContent=It?"已装载":"装载失败",g("loaded",tt.id)}catch{Ft.textContent="装载失败"}setTimeout(()=>{Ft.disabled=!1,Ft.textContent="重新装载"},1400)});let Pt=n.createElement("button");Pt.type="button",Pt.className="danger",Pt.textContent="卸载",Pt.addEventListener("click",()=>{ct(tt.id),A(`${te}${tt.id}_code`,""),A(`${te}${tt.id}_enabled`,!1),g("unregistered",tt.id),wt(N)}),yt.appendChild(Ft),yt.appendChild(Pt),ht.appendChild(zt),ht.appendChild(yt),N.appendChild(ht)})}a(wt,"renderStoreManage");function Ct(){let N={};return S.forEach(Y=>{if(Y.subpanels&&typeof Y.subpanels=="function"){let tt=Y.subpanels();Object.keys(tt||{}).forEach(bt=>{N[bt]=tt[bt]})}else Y.subpanels&&typeof Y.subpanels=="object"&&Object.keys(Y.subpanels).forEach(tt=>{N[tt]=Y.subpanels[tt]})}),N}return a(Ct,"collectSubpanels"),{api:st,install:V,update:ot,renderAssistUi:ft,openPluginStore:dt,bootFromCache:K,register:U}}a(lo,"createPluginManager");function Mp(p){let{document:n,getSettings:c,setSettings:d,validateMapping:u,defaultMapping:A,getRecoveryMessage:P=a(()=>"","getRecoveryMessage")}=p;function _(f,w,T){let C=f&&f.querySelector("#urppp-set-json-status");C&&(C.textContent=w||"",C.classList.toggle("urppp-status-error",!!T),C.style.color=T?"var(--danger,#b91c1c)":"var(--text-muted)")}a(_,"setStatus");function y(f,w){if(!f)return;let T=c(),C=f.querySelector("#urppp-set-json-custom"),g=f.querySelector("#urppp-set-json-editor"),b=f.querySelector("#urppp-set-json-mapping");C&&(C.classList.toggle("ac",T.enabled),C.setAttribute("aria-pressed",T.enabled?"true":"false"),C.textContent="自定义 JSON："+(T.enabled?"开":"关")),g&&(g.style.display=T.enabled?"grid":"none"),b&&(w||!f.__urpppJsonMappingDirty&&n.activeElement!==b)&&(b.value=JSON.stringify(T.mapping,null,2),f.__urpppJsonMappingDirty=!1);let v=P();v&&_(f,v,!0)}a(y,"sync");function S(f){if(!f||f.__urpppJsonSettingsBound)return;f.__urpppJsonSettingsBound=!0;let w=f.querySelector("#urppp-set-json-custom"),T=f.querySelector("#urppp-set-json-mapping"),C=f.querySelector("#urppp-set-json-save"),g=f.querySelector("#urppp-set-json-reset");T&&T.addEventListener("input",()=>{f.__urpppJsonMappingDirty=!0}),w&&w.addEventListener("click",()=>{let b=c();b.enabled=!b.enabled;let v=!!f.__urpppJsonMappingDirty;d(b),y(f,!1);let x=b.enabled?"已启用自定义 JSON 格式":"已恢复小爱课程兼容格式";_(f,v?x+"；未保存草稿已保留":x)}),C&&C.addEventListener("click",()=>{try{let b=JSON.parse(String(T&&T.value||"").trim()),v=c();v.mapping=u(b),d(v),f.__urpppJsonMappingDirty=!1,y(f,!0),_(f,"自定义 JSON 映射已保存")}catch(b){_(f,b&&b.message||String(b),!0)}}),g&&g.addEventListener("click",()=>{let b=c();b.mapping=u(A),d(b),f.__urpppJsonMappingDirty=!1,y(f,!0),_(f,"已恢复默认字段映射")})}return a(S,"bind"),{bind:S,setStatus:_,sync:y}}a(Mp,"createJsonSettingsController");var Sr="••••";var Ip={name:{enabled:!1,replacement:"同学"},identity:{enabled:!0,replacement:"已隐藏"},organization:{enabled:!0,replacement:"已隐藏"},contact:{enabled:!0,replacement:"已隐藏"},grade:{enabled:!0,replacement:"已隐藏"},gpa:{enabled:!0,replacement:"••••"},credit:{enabled:!0,replacement:"••••"},other:{enabled:!0,replacement:"已隐藏"},avatar:{enabled:!0,replacement:""},schedule:{enabled:!1,replacement:"课表已隐藏"}},xc=["completedCourses","failedCourses","majorGpa","majorPlan","remainingCourses","passingTotalCredit","passingAvgScore","passingAvgGpa","passingRequiredCredit","passingRequiredAvg","passingRequiredGpa","schemeTotalCredit","schemeAvgScore","schemeAvgGpa","schemeRequiredCredit","schemeRequiredAvg","schemeRequiredGpa"];function co(p){let n=p&&typeof p=="object"?p:{},c=["off","one","custom"].includes(n.mode)?n.mode:"off",d={},u=n.fields&&typeof n.fields=="object"?n.fields:{},A=u.score&&typeof u.score=="object"?u.score:null;Object.keys(Ip).forEach(f=>{let w=Ip[f],T=["grade","gpa","credit"].includes(f)?A:null,C=f==="other"&&u.grade&&typeof u.grade=="object"?u.grade:null,g=u[f]&&typeof u[f]=="object"?u[f]:T||C||{};d[f]={enabled:f==="name"?!1:g.enabled==null?w.enabled:!!g.enabled,replacement:String(g.replacement==null?w.replacement:g.replacement).slice(0,80)}});let P=n.homepage&&typeof n.homepage=="object"?n.homepage:{},_=n.directEdit&&typeof n.directEdit=="object"?n.directEdit:P,y=_.values&&typeof _.values=="object"?_.values:{},S={};return xc.forEach(f=>{S[f]=String(y[f]==null?"":y[f]).trim().slice(0,80)}),{mode:c,mask:Sr,fields:d,directEdit:{enabled:!!_.enabled,values:S}}}a(co,"normalizePrivacySettings");function _r(p){let n=p&&typeof p=="object"?p:{},c=String(n.avatar||"").trim();return{nameEnabled:!!n.nameEnabled,name:String(n.name||"").trim().slice(0,40),avatarEnabled:!!n.avatarEnabled,avatar:c.length<=3145728?c:"",avatarName:String(n.avatarName||"").trim().slice(0,120)}}a(_r,"normalizeCustomIdentity");function rr(p){let n=String(p||"").trim();return n.length>3145728?"":/^(https?:\/\/|data:image\/(?:png|jpe?g|gif|webp);base64,)/i.test(n)?n:""}a(rr,"validCustomAvatar");function yc(p,n=globalThis.FileReader){return new Promise((c,d)=>{if(!p||!/^image\/(png|jpeg|webp|gif)$/i.test(p.type||"")){d(new Error("请选择 PNG、JPG、WebP 或 GIF 图片"));return}if(p.size>2*1024*1024){d(new Error("本地头像不能超过 2MB"));return}let u=new n;u.onload=()=>c(String(u.result||"")),u.onerror=()=>d(new Error("读取头像失败")),u.readAsDataURL(p)})}a(yc,"readAvatarFile");function Np(p){let{getPrivacySettings:n,setPrivacySettings:c,getCustomIdentity:d,setCustomIdentity:u,applyDisplay:A,refreshCleanDisplay:P,finishActiveDirectEdit:_,readAvatar:y=yc}=p;function S(g,b){let v=b.mode==="custom",x=g.querySelector(".urppp-direct-edit-control"),E=g.querySelector("#urppp-set-direct-edit-toggle");x&&(x.style.display=v?"flex":"none"),E&&(E.dataset.enabled=b.directEdit.enabled?"1":"0",E.classList.toggle("ac",b.directEdit.enabled),E.setAttribute("aria-pressed",b.directEdit.enabled?"true":"false"),E.textContent="页面内修改："+(b.directEdit.enabled?"开":"关"))}a(S,"syncDirectEdit");function f(g){if(!g)return;let b=n();g.querySelectorAll("[data-privacy-mode]").forEach(M=>{let H=M.getAttribute("data-privacy-mode")===b.mode;M.classList.toggle("ac",H),M.setAttribute("aria-pressed",H?"true":"false")});let v=g.querySelector("#urppp-set-privacy-custom");v&&(v.style.display=b.mode==="custom"?"grid":"none"),Object.keys(b.fields).forEach(M=>{let H=b.fields[M],G=g.querySelector('[data-privacy-field="'+M+'"]'),U=g.querySelector('[data-privacy-value="'+M+'"]');G&&(G.checked=!!H.enabled),U&&(U.value=H.replacement||"",U.disabled=!H.enabled)}),S(g,b);let x=d(),E=g.querySelector("#urppp-set-name-enabled"),q=g.querySelector("#urppp-set-custom-name"),I=g.querySelector("#urppp-set-avatar-enabled"),L=g.querySelector("#urppp-set-custom-avatar-url"),O=g.querySelector("#urppp-set-avatar-preview");if(E&&(E.checked=x.nameEnabled),q&&(q.value=x.name,q.disabled=!x.nameEnabled),I&&(I.checked=x.avatarEnabled),L&&(L.value=/^data:image\//i.test(x.avatar)?"":x.avatar,L.disabled=!x.avatarEnabled),g.__urpppAvatarSource=x.avatar,O){let M=rr(x.avatar);O.style.display=M?"block":"none",M?O.src=M:O.removeAttribute("src")}}a(f,"sync");function w(g){let b=n();Object.keys(b.fields).forEach(x=>{let E=g.querySelector('[data-privacy-field="'+x+'"]'),q=g.querySelector('[data-privacy-value="'+x+'"]');E&&(b.fields[x].enabled=!!E.checked),q&&(b.fields[x].replacement=String(q.value||"").trim().slice(0,80))});let v=g.querySelector("#urppp-set-direct-edit-toggle");return b.directEdit.enabled=!!(v&&v.dataset.enabled==="1"),b}a(w,"collect");function T(g,b,v){let x=g&&g.querySelector("#urppp-set-privacy-status");x&&(x.textContent=b||"",x.style.color=v?"#b91c1c":"var(--text-muted)")}a(T,"setStatus");function C(g){if(!g||g.__urpppPrivacyBound)return;g.__urpppPrivacyBound=!0,g.querySelectorAll("[data-privacy-mode]").forEach(L=>{L.addEventListener("click",()=>{let O=n();O.mode=L.getAttribute("data-privacy-mode")||"off",c(O),f(g),A()})}),g.querySelectorAll("[data-privacy-field]").forEach(L=>{L.addEventListener("change",()=>{let O=L.getAttribute("data-privacy-field"),M=g.querySelector('[data-privacy-value="'+O+'"]');M&&(M.disabled=!L.checked)})});let b=g.querySelector("#urppp-set-direct-edit-toggle");b&&b.addEventListener("click",()=>{let L=b.dataset.enabled!=="1";b.dataset.enabled=L?"1":"0",b.classList.toggle("ac",L),b.setAttribute("aria-pressed",L?"true":"false"),b.textContent="页面内修改："+(L?"开":"关")});let v=g.querySelector("#urppp-set-name-enabled"),x=g.querySelector("#urppp-set-avatar-enabled");v&&v.addEventListener("change",()=>{let L=g.querySelector("#urppp-set-custom-name");L&&(L.disabled=!v.checked)}),x&&x.addEventListener("change",()=>{let L=g.querySelector("#urppp-set-custom-avatar-url");L&&(L.disabled=!x.checked)});let E=g.querySelector("#urppp-set-custom-avatar-file");E&&E.addEventListener("change",async()=>{try{let L=await y(E.files&&E.files[0]);g.__urpppAvatarSource=L;let O=g.querySelector("#urppp-set-avatar-preview");O&&(O.src=L,O.style.display="block"),x&&(x.checked=!0),T(g,"本地头像已读取，点击保存后生效")}catch(L){T(g,L&&L.message||String(L),!0)}});let q=g.querySelector("#urppp-set-avatar-clear");q&&q.addEventListener("click",()=>{try{let L=d();L.avatarEnabled=!1,L.avatar="",L.avatarName="",u(L),g.__urpppAvatarSource="",f(g),A(),P(),T(g,"已清除自定义头像")}catch(L){T(g,L&&L.message||"清除自定义头像失败",!0)}});let I=g.querySelector("#urppp-set-privacy-save");I&&I.addEventListener("click",()=>{let L=n(),O=d();try{let M=w(g),H=g.querySelector("#urppp-set-custom-avatar-url"),U=String(H&&H.value||"").trim()||g.__urpppAvatarSource||"",et=_r({nameEnabled:!!(v&&v.checked),name:String(g.querySelector("#urppp-set-custom-name")?.value||"").trim(),avatarEnabled:!!(x&&x.checked),avatar:U,avatarName:O.avatarName});if(et.avatarEnabled&&!rr(et.avatar))throw new Error("头像地址必须是 http(s) 图片或已选择的本地图片");L.directEdit.enabled&&!M.directEdit.enabled&&_(!0);try{u(et),c(M)}catch(it){try{u(O),c(L)}catch{}throw it}A(),P(),f(g),T(g,"隐私与显示设置已保存")}catch(M){T(g,M&&M.message||String(M),!0)}})}return a(C,"bind"),{bind:C,collect:w,setStatus:T,sync:f}}a(Np,"createPrivacySettingsController");function Bp(p){let{document:n,theme:c,preferences:d,accent:u,syncPanel:A}=p;function P(){c.getFollowSystem()?c.apply(c.resolveFollowTheme(),{system:!0}):c.apply("scu-red",{manual:!0})}a(P,"applyAccentTheme");function _(S,f){let w=S.querySelector("#urppp-set-schemes");if(!w)return;let T=u.getScheme();w.innerHTML="",u.listSchemePreviews(f).forEach(C=>{let g=n.createElement("button");g.type="button",g.className="urppp-set-scheme"+(C.id===T?" ac":""),g.innerHTML=['<div class="urppp-set-scheme-preview">','  <span style="background:'+C.bg+'"></span>','  <span style="background:'+C.surface+";border-color:"+C.border+'"></span>','  <span style="background:'+C.primary+'"></span>',"</div>",'<div class="urppp-set-scheme-meta">',"  <strong>"+C.name+"</strong>","  <em>"+C.desc+"</em>","</div>"].join(""),g.addEventListener("click",()=>{u.setAccent(f),u.setScheme(C.id),P(),A()}),w.appendChild(g)})}a(_,"renderSchemeChoices");function y(S){S.querySelectorAll(".urppp-set-mode").forEach(L=>{L.addEventListener("click",()=>{c.isModeAvailable(L.dataset.theme)&&(c.apply(L.dataset.theme,{manual:!0}),A())})});let f=S.querySelector("#urppp-set-follow");f&&f.addEventListener("click",()=>{if(!c.supportsDark())return;let L=!c.getFollowSystem();c.setFollowSystem(L),L?c.apply(c.resolveFollowTheme(),{system:!0}):c.apply(c.getCurrent(),{manual:!0}),A(),c.syncNavbar()});let w=S.querySelector("#urppp-set-follow-dynamic");w&&w.addEventListener("click",()=>{c.supportsDynamic()&&(c.getFollowSystem()?c.setFollowDynamic(!c.getFollowDynamic()):(c.setFollowSystem(!0),c.setFollowDynamic(!0)),c.apply(c.resolveFollowTheme(),{system:!0}),A(),c.syncNavbar())});let T=S.querySelector("#urppp-set-clean-default");T&&T.addEventListener("click",()=>{d.setCleanDefault(!d.getCleanDefault()),A()});let C=S.querySelector("#urppp-set-clean-analysis");C&&C.addEventListener("click",()=>{let L=d.getCleanAnalysis()==="direct";d.setCleanAnalysis(L?"tab":"direct"),A()});let g=S.querySelector("#urppp-set-apple-edge");g&&g.addEventListener("click",()=>{d.setAppleEdge(!d.getAppleEdge());try{d.applySkin()}catch{}A()});let b=S.querySelector("#urppp-set-auto-update");b&&b.addEventListener("click",()=>{d.setAutoUpdate(!d.getAutoUpdate()),A()});let v=S.querySelector("#urppp-set-check-update");v&&!v.__urpppBound&&(v.__urpppBound=!0,v.addEventListener("click",()=>{d.checkUpdates()}));let x=S.querySelector("#urppp-set-color"),E=S.querySelector("#urppp-set-hex");if(!x||!E)return;x.addEventListener("input",()=>{E.value=x.value.toUpperCase()}),E.addEventListener("change",()=>{let L=u.normalize(E.value);L&&(E.value=L,x.value=L)});let q=S.querySelector("#urppp-set-gen");q&&q.addEventListener("click",()=>{let L=u.normalize(E.value)||x.value;L&&(u.setAccent(u.normalize(L)),P(),A())});let I=S.querySelector("#urppp-set-save");I&&I.addEventListener("click",()=>{let L=u.normalize(E.value)||x.value;L&&(u.savePreset(L),u.setAccent(u.normalize(L)),P(),A())}),x.addEventListener("change",()=>{let L=u.normalize(x.value);L&&(E.value=L,_(S,L))})}return a(y,"bind"),{bind:y,renderSchemeChoices:_}}a(Bp,"createThemeSettingsController");function Fp(p,n){let{seed:c,currentTheme:d,followSystem:u,skinId:A,darkSupported:P,dynamicSupported:_,fixedPalettes:y,followUseDynamic:S,cleanDefault:f,cleanAnalysis:w,appleEdge:T,autoUpdate:C,modeAvailability:g}=n,b=p.querySelector("#urppp-set-color"),v=p.querySelector("#urppp-set-hex");b&&(b.value=c),v&&(v.value=c),p.querySelectorAll(".urppp-set-mode").forEach(U=>{let et=U.dataset.theme,it=g[et]!==!1,mt=!u&&et===d&&it;U.disabled=!it,U.classList.toggle("ac",mt),U.classList.toggle("urppp-dyn-disabled",!it),U.setAttribute("aria-disabled",it?"false":"true"),it?U.removeAttribute("title"):U.title=et==="dark"?"当前界面风格不支持暗色模式":"当前界面风格不支持动态配色"});let x=p.querySelector("#urppp-set-follow");x&&(x.disabled=!P,x.classList.toggle("ac",u&&P),x.classList.toggle("urppp-dyn-disabled",!P),x.setAttribute("aria-pressed",u&&P?"true":"false"),x.textContent=u&&P?"跟随系统：开":"跟随系统：关",x.title=P?"":"当前界面风格不支持暗色模式");let E=p.querySelector("#urppp-set-follow-dynamic");E&&(E.classList.toggle("ac",S&&_),E.setAttribute("aria-pressed",S&&_?"true":"false"),E.textContent=S?"浅色用动态配色：开":"浅色用动态配色：关",E.disabled=!u||!_,E.classList.toggle("urppp-dyn-disabled",!_),E.style.opacity=_&&u?"1":"0.5",E.title=_?"":"当前界面风格不支持动态配色");let q=p.querySelector("#urppp-set-dynamic");q&&(q.style.display=_?"":"none",q.style.opacity="1",q.classList.toggle("urppp-dyn-disabled",!1),q.querySelectorAll("button, input, .urppp-set-scheme, .urppp-set-swatch").forEach(U=>{U.disabled=!1,U.classList.toggle("urppp-dyn-disabled",!1)}),q.querySelectorAll("h3, .urppp-set-tip, label").forEach(U=>{U.classList.toggle("urppp-dyn-disabled",!1)}));let I=p.querySelector("#urppp-set-brutal");I&&(I.style.display=y?"":"none");let L=p.querySelector("#urppp-set-clean-default");L&&(L.classList.toggle("ac",f),L.setAttribute("aria-pressed",f?"true":"false"),L.textContent=f?"默认进入清爽模式：开":"默认进入清爽模式：关");let O=p.querySelector("#urppp-set-clean-analysis");if(O){let U=w==="direct";O.classList.toggle("ac",U),O.setAttribute("aria-pressed",U?"true":"false"),O.textContent=U?"清爽成绩分析展示：直接显示":"清爽成绩分析展示：选项卡"}let M=p.querySelector("#urppp-set-apple-edge"),H=p.querySelector("#urppp-set-apple-edge-tip");if(M){let U=A==="apple";M.style.display=U?"":"none",H&&(H.style.display=U?"":"none"),U&&(M.classList.toggle("ac",T),M.setAttribute("aria-pressed",T?"true":"false"),M.textContent=T?"类Apple边缘线条：开":"类Apple边缘线条：关")}let G=p.querySelector("#urppp-set-auto-update");G&&(G.classList.toggle("ac",C),G.setAttribute("aria-pressed",C?"true":"false"),G.textContent=C?"自动检测更新：开":"自动检测更新：关")}a(Fp,"syncThemeSettingsControls");function uo(p){let n=String(p||"").replace(/\s+/g,"");return/^[•·●○▪◆★\-–]$/.test(n)||/^\d{1,4}$/.test(n)}a(uo,"isNoticeBulletText");function vc(p){return/\d{4}[-/.年]\d{1,2}([-/.月]\d{1,2})?/.test(String(p||""))}a(vc,"isNoticeDateText");function Dp({pathname:p="",href:n="",title:c="",headingText:d=""}={}){return/courseSelectNotice|evaluationNotice|notice\/index/i.test(`${p} ${n}`)?!0:/评估公告|通知公告|选课公告|公告|通知/.test(`${c} ${d}`)}a(Dp,"isNoticePageContext");function mo(p,{noticePage:n=!1}={}){if(!p)return!1;let d=(p.querySelector("thead")?.textContent||"").replace(/\s+/g,"");if(/标题/.test(d)&&/发布时间|发布日期|日期|时间/.test(d)||n&&/标题|公告|通知/.test(d)&&!/教室|教学楼|课程号|成绩|学号|座位数/.test(d))return!0;let u=p.querySelectorAll("tbody tr, tr"),A=0;if(u.forEach(_=>{let y=_.querySelectorAll("td");y.length<2||y.length>4||uo(y[0].textContent)&&_.querySelector("a")&&vc(_.textContent)&&(A+=1)}),A<1)return!1;if(n||A===u.length)return!0;let P=p.getAttribute("style")||"";return/dashed/i.test(P)||p.classList.contains("no-border-top")||!!p.getAttribute("width")}a(mo,"isNoticeListTable");function jp(p,{noticePage:n=!1}={}){if(!p)return!0;if(p.classList?.contains("urppp-notice-table")||mo(p,{noticePage:n}))return!1;let c=`${p.id||""} ${p.getAttribute("class")||""}`;if(/freeClassroom|courseTable|codeTable|jszhpjdf|score|grade|exam|drag|classroom/i.test(c)||p.querySelector('#tbodyFreeClassroom, tbody[id*="FreeClassroom"], tbody[id*="Classroom"], tbody[id*="course"], tbody[id*="Code"]'))return!0;let d=p.querySelector("tbody tr, tr");if(d&&d.querySelectorAll("td,th").length>=5)return!0;let A=(p.querySelector("thead")?.textContent||"").replace(/\s+/g,"");return!!(A&&(/校区|教学楼|教室|座位数|类型|课表|操作|课程号|课程名|成绩|学号|姓名|教师|周次|节次/.test(A)||/序号/.test(A)&&!/标题|公告|通知|发布时间/.test(A))||p.querySelector("a")&&/课表|教室信息|查看/.test(p.textContent||"")&&!n&&/座位数|教学楼|教室号|校区名/.test(p.textContent||""))}a(jp,"isBusinessDataTable");function Op({isNativePdfIsolationActive:p,isBusinessDataTable:n,documentRef:c=document,windowRef:d=window,MutationObserverRef:u=MutationObserver,getComputedStyleRef:A=getComputedStyle}){function P(){p()||c.querySelectorAll("table.table, table.table-bordered, table.dataTable").forEach(y=>{if(!y||y.closest(".urppp-table-wrap")||y.id==="courseTable"||y.closest(".modal, .modal-dialog, .modal-content, .modal-body, #work_rest_schedule_modal")||y.classList.contains("urppp-wrs-table")||y.classList.contains("urppp-notice-table"))return;n(y);let S=y.parentElement;if(!S)return;let f=S.style?.overflow||A(S).overflow;if(S.id?.endsWith("_scroll")||f==="auto"||f==="scroll"){S.classList.add("urppp-scroll-table-host");return}let T=c.createElement("div");T.className="urppp-table-wrap",S.insertBefore(T,y),T.appendChild(y)})}a(P,"wrapTables");function _(){let y=c.getElementById("page-content-template")||c.querySelector(".page-content")||c.body;if(!y)return;let S=d.__urpppTableObsRoot;if(d.__urpppTableObs&&S===y&&y.isConnected)return;d.__urpppTableObs&&d.__urpppTableObs.disconnect();let f=0,w=new u(()=>{clearTimeout(f),f=setTimeout(P,80)});w.observe(y,{childList:!0,subtree:!0}),d.__urpppTableObs=w,d.__urpppTableObsRoot=y}return a(_,"bindTableWrapObserver"),{bindTableWrapObserver:_,wrapTables:P}}a(Op,"createTableWrapper");function Hp(p){let n=String(p||"").trim().toLowerCase();if(!n||n==="transparent"||n==="inherit"||n==="initial")return!1;if(/#(?:f{3,6}|e[0-9a-f]{5}|d[89a-f][0-9a-f]{4}|c[89a-f][0-9a-f]{4})/i.test(n))return!0;let c=n.match(/rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/i);if(!c)return!1;let d=Number(c[1]),u=Number(c[2]),A=Number(c[3]);return(d+u+A)/3>=200}a(Hp,"isLightInlineColor");function wc(p){if(!p?.style)return;let n=p.getAttribute("style")||"";if(!n||!/background/i.test(n))return;let c=p.style.backgroundColor||p.style.background||"";(Hp(c)||/background(-color|-image)?\s*:/i.test(n))&&(p.style.removeProperty("background"),p.style.removeProperty("background-color"),p.style.removeProperty("background-image")),["borderColor","borderTopColor","borderRightColor","borderBottomColor","borderLeftColor"].forEach(d=>{let u=p.style[d];!u||!Hp(u)||p.style.removeProperty(d.replace(/[A-Z]/g,A=>`-${A.toLowerCase()}`))}),/border(-color)?\s*:/i.test(n)&&/#e6e6e6|#eee|#ddd|#ccc/i.test(n)&&(p.style.removeProperty("border-color"),p.style.removeProperty("border-top-color"),p.style.removeProperty("border-right-color"),p.style.removeProperty("border-bottom-color"),p.style.removeProperty("border-left-color"))}a(wc,"scrubLightInlineBackground");function Rp({isNativePdfIsolationActive:p,documentRef:n=document,windowRef:c=window,MutationObserverRef:d=MutationObserver}){function u(){if(!p())try{let P=n.documentElement.classList.contains("urppp-theme-dark"),_=n.body?.classList.contains("urppp-dark");if(!P&&!_)return;n.querySelectorAll("table, table thead, table thead tr, table thead th, table thead td, table tbody, table tbody tr, table tbody td, table tbody th, .table-box, .table-box table, .table-box td, .table-box th").forEach(wc)}catch{}}a(u,"scrubTableHeaderInlineBg");function A(){[0,200,800,1600].forEach(P=>setTimeout(()=>{try{u()}catch{}},P));try{let P=n.querySelector(".page-content, #page-content-template, .main-content")||n.body;if(!P)return;let _=c.__urpppTableScrubObs;if(_&&_.root===P&&P.isConnected)return;_?.observer&&_.observer.disconnect();let y=new d(()=>{clearTimeout(c.__urpppTableScrubTimer),c.__urpppTableScrubTimer=setTimeout(()=>{try{u()}catch{}},120)});y.observe(P,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class"]}),c.__urpppTableScrubObs={root:P,observer:y}}catch{}}return a(A,"scheduleScrubTableInlineBg"),{scheduleScrubTableInlineBg:A,scrubTableHeaderInlineBg:u}}a(Rp,"createTableInlineStyleScrubber");function Up({beautifyPagebar:p,documentRef:n=document,windowRef:c=window,MutationObserverRef:d=MutationObserver,setTimeoutRef:u=setTimeout,clearTimeoutRef:A=clearTimeout}){function P(){p(),n.querySelectorAll("#urppagebar").forEach(y=>{if(y.__urpppPagebarObs)return;y.__urpppPagebarObs=!0,new d(()=>{A(c.__urpppPagebarTimer),c.__urpppPagebarTimer=u(()=>p(y.parentElement||n),150)}).observe(y,{childList:!0,subtree:!0})})}a(P,"run");function _(){if(c.__urpppPagebarBound){u(P,0);return}c.__urpppPagebarBound=!0,[0,300,1e3,2500].forEach(y=>u(P,y))}return a(_,"scheduleBeautifyPagebar"),{scheduleBeautifyPagebar:_}}a(Up,"createPagebarLifecycle");function Wp({destroyPagebarChosen:p,documentRef:n=document,logger:c=console}){function d(u){try{(u?.querySelectorAll?u.querySelectorAll("#urppagebar"):n.querySelectorAll("#urppagebar")).forEach(P=>{if(!P)return;P.classList.add("urppp-pagebar"),P.style.setProperty("display","block","important"),P.style.setProperty("width","100%","important"),P.style.setProperty("line-height","1.5","important");let _=P.querySelector('.dataTables_paginate, [id^="sample-table-2_paginate_"]')||P,y=Array.from(P.querySelectorAll('[id^="span_page_txt_"]')).map(g=>String(g.textContent||"").trim()).join(""),S=P.querySelector('select[id^="pagination_pageSize_"]'),f=S?String(S.value||""):"",w=P.querySelector('[id^="turnpageto_"]'),T=!!(w&&(w.readOnly||w.hasAttribute("readonly")));if(!(y.includes("转到")&&!T&&!f.includes("_"))){P.classList.add("urppp-pagebar-scroll"),P.classList.remove("urppp-pagebar-jump"),P.querySelectorAll('ul.pagination, [id^="pagination_ul_"]').forEach(g=>{g.style.setProperty("display","none","important")}),P.querySelectorAll("select").forEach(g=>{p(g),g.style.setProperty("width","128px","important"),g.style.setProperty("min-width","128px","important"),g.style.setProperty("max-width","128px","important")}),P.querySelectorAll(".chosen-container").forEach(g=>{try{g.style.setProperty("display","none","important")}catch{}});return}P.classList.add("urppp-pagebar-jump"),P.classList.remove("urppp-pagebar-scroll"),_.style.setProperty("display","flex","important"),_.style.setProperty("align-items","center","important"),_.style.setProperty("flex-wrap","wrap","important"),_.style.setProperty("gap","8px","important"),_.style.setProperty("position","relative","important"),_.style.setProperty("line-height","1.5","important"),P.querySelectorAll("ul.pagination").forEach(g=>{g.classList.add("urppp-pagination"),g.style.cssText=["display:inline-flex !important","align-items:center !important","flex-wrap:wrap !important","gap:4px !important","margin:0 !important","padding:0 !important","list-style:none !important","float:none !important","position:static !important"].join(";")}),P.querySelectorAll("ul.pagination > li").forEach(g=>{let b=g.classList.contains("active"),v=g.classList.contains("disabled"),x=g.classList.contains("previous")||/previous/i.test(g.getAttribute("name")||""),E=g.classList.contains("next")||/next/i.test(g.getAttribute("name")||"");g.classList.add("urppp-page-li"),b&&g.classList.add("urppp-page-li-active"),v&&g.classList.add("urppp-page-li-disabled"),x&&g.classList.add("urppp-page-li-prev"),E&&g.classList.add("urppp-page-li-next"),g.style.cssText=["display:inline-flex !important","align-items:center !important","justify-content:center !important","float:none !important","position:static !important","margin:0 !important","padding:0 !important","list-style:none !important","border:none !important","background:transparent !important","height:auto !important","min-height:0 !important"].join(";");let q=g.querySelector(":scope > span, :scope > a")||g.firstElementChild;if(!q)return;q.classList.add("urppp-page-chip"),b&&q.classList.add("urppp-page-chip-active"),v&&q.classList.add("urppp-page-chip-disabled"),(x||E)&&q.classList.add("urppp-page-chip-nav");let I=x||E?"72px":"40px",L=b?"var(--pagination-active-bg, var(--primary))":"var(--surface)",O=b?"var(--pagination-active-border, var(--primary))":"var(--border)",M=b?"var(--pagination-active-foreground, var(--primary-foreground, #fff))":v?"var(--text-muted)":"var(--text)";q.style.cssText=["display:inline-flex !important","align-items:center !important","justify-content:center !important","box-sizing:border-box !important","float:none !important","position:static !important","width:auto !important",`min-width:${I} !important`,"height:36px !important","min-height:36px !important","max-height:36px !important","padding:0 12px !important","margin:0 !important","line-height:36px !important","font-size:14px !important","font-weight:600 !important","border-radius:8px !important",`border:1px solid ${O} !important`,`background:${L} !important`,`color:${M} !important`,"box-shadow:none !important","text-decoration:none !important",`cursor:${v?"default":"pointer"} !important`,"white-space:nowrap !important","overflow:hidden !important"].join(";")}),P.querySelectorAll('[id^="btn_turnpageto_"]').forEach(g=>{g.classList.add("urppp-page-confirm"),g.style.setProperty("position","static","important"),g.style.setProperty("left","auto","important"),g.style.setProperty("top","auto","important"),g.style.setProperty("float","none","important"),g.style.setProperty("height","32px","important"),g.style.setProperty("min-width","52px","important"),g.style.setProperty("padding","0 12px","important"),g.style.setProperty("margin","0 4px","important"),g.style.setProperty("font-size","13px","important"),g.style.setProperty("line-height","1","important"),g.style.setProperty("vertical-align","middle","important")}),P.querySelectorAll('[id^="turnpageto_"]').forEach(g=>{g.classList.add("urppp-page-goto"),g.style.setProperty("position","static","important"),g.style.setProperty("display","inline-block","important"),g.style.setProperty("height","32px","important"),g.style.setProperty("width","48px","important"),g.style.setProperty("margin","0 4px","important"),g.style.setProperty("padding","4px 8px","important"),g.style.setProperty("font-size","14px","important"),g.style.setProperty("line-height","1.2","important"),g.style.setProperty("box-sizing","border-box","important"),g.style.setProperty("vertical-align","middle","important");let b=g.parentElement;b?.tagName==="SPAN"&&(b.style.setProperty("position","static","important"),b.style.setProperty("display","inline-flex","important"),b.style.setProperty("align-items","center","important"),b.style.setProperty("width","auto","important"),b.style.setProperty("height","auto","important"),b.style.setProperty("min-height","0","important"),b.style.setProperty("vertical-align","middle","important"))}),P.querySelectorAll('[id^="totalPage_show_"], [id^="span_page_txt_"]').forEach(g=>{g.style.setProperty("display","inline","important"),g.style.setProperty("border","none","important"),g.style.setProperty("background","transparent","important"),g.style.setProperty("padding","0","important"),g.style.setProperty("margin","0","important"),g.style.setProperty("height","auto","important"),g.style.setProperty("line-height","1.5","important"),g.style.setProperty("font-size","13px","important"),g.style.setProperty("color","var(--text-secondary, var(--text-muted))","important")})})}catch(A){c.warn("[URP++] pagebar beautify failed",A)}}return a(d,"beautifyPagebar"),{beautifyPagebar:d}}a(Wp,"createPagebarBeautifier");function Gp({beautifyNoticeTables:p,pinNoticeRowSurface:n,documentRef:c=document,windowRef:d=window,MutationObserverRef:u=MutationObserver,requestAnimationFrameRef:A=requestAnimationFrame,setTimeoutRef:P=setTimeout,clearTimeoutRef:_=clearTimeout}){function y(){d.__urpppNoticeHoverScrub||(d.__urpppNoticeHoverScrub=!0,c.addEventListener("mouseout",f=>{let w=f.target?.closest?f.target.closest("table.urppp-notice-table tr.urppp-notice-row"):null;w&&A(()=>n(w))},!0))}a(y,"bindNoticeHoverScrub");function S(){[0,400,1500].forEach(f=>P(()=>{try{p()}catch{}},f));try{let f=c.getElementById("page-content-template")||c.querySelector(".page-content, .main-content")||c.body;if(!f)return;let w=d.__urpppNoticeObs;if(w&&w.root===f&&f.isConnected)return;w?.observer&&w.observer.disconnect();let T=new u(()=>{_(d.__urpppNoticeTimer),d.__urpppNoticeTimer=P(()=>{try{p()}catch{}},180)});T.observe(f,{childList:!0,subtree:!0}),d.__urpppNoticeObs={root:f,observer:T}}catch{}}return a(S,"scheduleBeautifyNoticeTables"),{bindNoticeHoverScrub:y,scheduleBeautifyNoticeTables:S}}a(Gp,"createNoticeTableLifecycle");function Jp({getCurrentTheme:p,documentRef:n=document,getComputedStyleRef:c=getComputedStyle}){function d(){try{return c(n.documentElement).getPropertyValue("--surface").trim()||(p()==="dark"?"#151A24":"#FFFFFF")}catch{return p()==="dark"?"#151A24":"#FFFFFF"}}a(d,"noticeSurfaceColor");function u(y){if(!y?.classList?.contains("urppp-notice-row"))return;let S=d();y.classList.remove("hover"),y.style.setProperty("background",S,"important"),y.style.setProperty("background-color",S,"important"),y.querySelectorAll("td, th").forEach(f=>{f.classList.remove("hover"),f.style.setProperty("background","transparent","important"),f.style.setProperty("background-color","transparent","important")})}a(u,"pinNoticeRowSurface");function A(y){try{let S=y||n;if(S.matches?.("tr.urppp-notice-row")){u(S);return}S.querySelectorAll("table.urppp-notice-table tr.urppp-notice-row").forEach(u)}catch{}}a(A,"scrubNoticeInlineBg");function P(y){y&&(y.classList.remove("table-hover","table-striped"),y.classList.add("urppp-notice-nohover"),y.querySelectorAll("tr.urppp-notice-row").forEach(S=>{S.classList.remove("hover"),u(S)}))}a(P,"disarmNoticeTableHover");function _(y){if(!y)return;y.classList.remove("urppp-notice-table"),delete y.dataset.urpppNoticeScan,y.style.removeProperty("border"),y.style.removeProperty("border-left"),y.style.removeProperty("background");let S=y.closest(".urppp-table-wrap.urppp-notice-wrap");S&&(S.classList.remove("urppp-notice-wrap"),S.style.removeProperty("border"),S.style.removeProperty("background"),S.style.removeProperty("box-shadow"),S.style.removeProperty("overflow"),S.style.removeProperty("border-radius")),y.querySelectorAll("tr.urppp-notice-row, td.urppp-notice-title-cell, td.urppp-notice-date-cell, td.urppp-notice-bullet-cell, a.urppp-notice-link, .urppp-notice-time, .urppp-notice-card").forEach(f=>{f.classList.remove("urppp-notice-row","urppp-notice-title-cell","urppp-notice-date-cell","urppp-notice-bullet-cell","urppp-notice-link","urppp-notice-time","urppp-notice-card","urppp-notice-card-row","urppp-notice-main","urppp-notice-meta","urppp-notice-title","urppp-notice-body"),(f.tagName==="TR"||f.tagName==="TD")&&["display","border","background","padding","margin","width","box-shadow","border-radius","float","position"].forEach(w=>{f.style.getPropertyPriority(w)==="important"&&f.style.removeProperty(w)}),delete f.dataset.urpppNoticeDone})}return a(_,"stripMistakenNoticeTable"),{disarmNoticeTableHover:P,pinNoticeRowSurface:u,scrubNoticeInlineBg:A,stripMistakenNoticeTable:_}}a(Jp,"createNoticeTableSurface");function Vp({isNativePdfIsolationActive:p,bindNoticeHoverScrub:n,scrubNoticeInlineBg:c,stripMistakenNoticeTable:d,disarmNoticeTableHover:u,pinNoticeRowSurface:A,isBusinessDataTable:P,isNoticeListTable:_,isNoticePageContext:y,isNoticeBulletText:S,documentRef:f=document,windowRef:w=window,logger:T=console}){function C(){if(!p())try{n(),c(),f.querySelectorAll("table.urppp-notice-table, table.table").forEach(b=>{P(b)&&(b.classList.contains("urppp-notice-table")||b.querySelector(".urppp-notice-row, .urppp-notice-title-cell"))&&d(b)});let g=new Set(f.querySelectorAll('.page-content table, #page-content-template table, .main-content table, table.table, table.urppp-notice-table, table[style*="dashed"], table.no-border-top'));y()?f.querySelectorAll("table").forEach(b=>g.add(b)):f.querySelectorAll("table").forEach(b=>{_(b)&&g.add(b)}),Array.from(g).forEach(b=>{if(!b||P(b))return;if(b.querySelector("thead th")&&b.querySelectorAll("thead th").length>=3){let L=b.querySelector("thead")?.textContent||"";if(!_(b)&&/序号|课程|成绩|教室|校区|学号|姓名|教学楼|座位|操作|类型/.test(L)&&!/标题|公告|通知/.test(L))return}let v=Array.from(b.querySelectorAll("tbody > tr, tr")).filter(L=>L.querySelector("td"));if(!v.length)return;let x=0;v.slice(0,12).forEach(L=>{let O=Array.from(L.children).filter(et=>et.tagName==="TD"||et.tagName==="TH");if(O.length>=5)return;let M=(L.textContent||"").replace(/\s+/g," ").trim(),H=!!L.querySelector("a[href], a[onclick], a"),G=/\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}/.test(M),U=O.some(et=>S(et.textContent));(H&&G||U&&H||U&&G)&&(x+=1)});let E=b.classList.contains("no-border-top")||/dashed|border-left-style/.test(b.getAttribute("style")||""),q=y();if(x<1){if(q){if(v.slice(0,8).filter(O=>{let M=Array.from(O.children).filter(G=>G.tagName==="TD"||G.tagName==="TH");if(M.length<1||M.length>4)return!1;let H=(O.textContent||"").replace(/\s+/g," ").trim();return!!O.querySelector("a")||/\d{4}/.test(H)}).length<1&&!E)return}else if(!(E&&/公告|通知/.test(f.title||"")))return}if(P(b))return;b.classList.add("urppp-notice-table"),b.dataset.urpppNoticeScan="1",u(b),b.style.setProperty("border","none","important"),b.style.setProperty("border-left","none","important"),b.style.setProperty("background","transparent","important"),b.style.setProperty("width","100%","important");let I=b.closest(".urppp-table-wrap");I&&(I.classList.add("urppp-notice-wrap"),I.style.setProperty("border","none","important"),I.style.setProperty("background","transparent","important"),I.style.setProperty("box-shadow","none","important"),I.style.setProperty("overflow","visible","important"),I.style.setProperty("border-radius","0","important")),v.forEach(L=>{if(L.dataset.urpppNoticeDone==="1")return;let O=Array.from(L.children).filter(V=>V.tagName==="TD"||V.tagName==="TH");if(!O.length)return;let M=a(V=>(V||"").replace(/\u00AD/g,"").replace(/\u200B/g,"").replace(/\s+/g," ").trim(),"clean");if(O.length>=2){let V=null,Q=null,ot=null;if(O.forEach((K,ct)=>{let rt=M(K.textContent),st=!!K.querySelector("a");if(!V&&S(rt)&&(ct===0||O.length>=2)){V=K;return}if(!ot&&(/\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}/.test(rt)||/\d{4}-\d{1,2}-\d{1,2}\s+\d{1,2}:\d{2}/.test(rt)||/text-align\s*:\s*right/i.test(K.getAttribute("style")||"")||ct===O.length-1&&rt.length<=28&&/\d{4}/.test(rt))&&/\d{4}/.test(rt)&&rt.length<=32){ot=K;return}!Q&&(st||rt.length>4)&&(Q=K)}),Q||(Q=O.find(K=>K!==V&&K!==ot)||O[0]),!ot&&O.length>=2){let K=O[O.length-1];K!==Q&&K!==V&&(ot=K)}if(L.classList.add("urppp-notice-row"),A(L),L.removeAttribute("width"),L.style.setProperty("flex-wrap","nowrap","important"),O.forEach(K=>{K.removeAttribute("width"),K.removeAttribute("height"),K.removeAttribute("align"),K.style.setProperty("border","none","important"),K.style.setProperty("background","transparent","important"),K.style.setProperty("vertical-align","middle","important"),K.style.removeProperty("width"),K.style.setProperty("width","auto","important")}),V&&(V.classList.add("urppp-notice-bullet-cell"),V.style.setProperty("display","none","important"),V.style.setProperty("width","0","important"),V.style.setProperty("padding","0","important")),Q){Q.classList.add("urppp-notice-title-cell"),Q.removeAttribute("width"),Q.style.setProperty("width","auto","important"),Q.style.setProperty("max-width","100%","important"),Q.style.setProperty("min-width","0","important"),Q.style.setProperty("flex","1 1 0%","important"),Q.style.setProperty("overflow","hidden","important"),Q.style.setProperty("padding","0","important"),Q.style.setProperty("pointer-events","auto","important"),Q.style.setProperty("white-space","nowrap","important");let K=Q.querySelector("a[href], a[onclick], a");if(K||(K=L.querySelector("a[href], a[onclick], a")),K){Q.contains(K)||(Q.innerHTML="",Q.appendChild(K)),K.classList.add("urppp-notice-link");let ct=K.getAttribute("href"),rt=K.getAttribute("onclick"),st=K.getAttribute("target"),ft=M(K.textContent);K.textContent=ft,ct!=null&&K.setAttribute("href",ct),rt!=null&&K.setAttribute("onclick",rt),st!=null&&K.setAttribute("target",st),K.style.setProperty("color","var(--text)","important"),K.style.setProperty("text-decoration","none","important"),K.style.setProperty("font-size","14px","important"),K.style.setProperty("font-weight","500","important"),K.style.setProperty("line-height","1.5","important"),K.style.setProperty("pointer-events","auto","important"),K.style.setProperty("cursor","pointer","important"),K.style.setProperty("position","relative","important"),K.style.setProperty("z-index","2","important"),K.style.setProperty("display","block","important"),K.style.setProperty("white-space","nowrap","important"),K.style.setProperty("overflow","hidden","important"),K.style.setProperty("text-overflow","ellipsis","important"),L.dataset.urpppNoticeClickBound!=="1"&&(L.dataset.urpppNoticeClickBound="1",L.style.setProperty("cursor","pointer","important"),L.addEventListener("click",Z=>{if(Z.target&&Z.target.closest&&Z.target.closest("a,button,input,select,textarea,label"))return;if(K.getAttribute("onclick")){K.click();return}let dt=K.getAttribute("href");if(!dt||dt==="#"||dt.indexOf("javascript:")===0){K.click();return}K.target==="_blank"?w.open(dt,"_blank"):w.location.href=dt}))}else{let ct=M(Q.textContent);ct&&!Q.querySelector("button, input, select")&&(!Q.querySelector("*")||Q.children.length===0)&&(Q.textContent=ct)}}if(ot){ot.classList.add("urppp-notice-date-cell"),ot.style.cssText=["display:flex !important","align-items:center !important","justify-content:flex-end !important","flex:0 0 auto !important","width:auto !important","max-width:none !important","white-space:nowrap !important","text-align:right !important","padding:0 !important","margin:0 0 0 auto !important","border:none !important","background:transparent !important","float:none !important","position:static !important","right:auto !important","left:auto !important","top:auto !important"].join(";");let K=M(ot.textContent);ot.innerHTML="";let ct=f.createElement("span");ct.className="urppp-notice-time",ct.textContent=K,ot.appendChild(ct)}Q&&(Q.style.setProperty("flex","1 1 auto","important"),Q.style.setProperty("min-width","0","important"),Q.style.setProperty("margin","0","important"),Q.style.setProperty("float","none","important"),Q.style.setProperty("position","static","important")),L.style.setProperty("display","flex","important"),L.style.setProperty("align-items","center","important"),L.style.setProperty("justify-content","space-between","important"),L.style.setProperty("gap","16px","important"),L.style.setProperty("max-width","100%","important"),L.style.setProperty("box-sizing","border-box","important"),L.style.setProperty("overflow","hidden","important"),L.dataset.urpppNoticeDone="1";return}let H=O[0],G=Array.from(H.querySelectorAll(":scope > span"));if(G.length<2){let V=H.querySelector("a"),Q=M(H.textContent),ot=Q.match(/(\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}(?:\s+\d{1,2}:\d{2}(?::\d{2})?)?)/);if(V||ot){L.classList.add("urppp-notice-row");let K=f.createElement("div");K.className="urppp-notice-card urppp-notice-card-row";let ct=f.createElement("div");if(ct.className="urppp-notice-main",V){V.classList.add("urppp-notice-link");let rt=V.getAttribute("href"),st=V.getAttribute("onclick"),ft=M(V.textContent);V.textContent=ft,rt!=null&&V.setAttribute("href",rt),st!=null&&V.setAttribute("onclick",st),V.style.setProperty("pointer-events","auto","important"),V.style.setProperty("cursor","pointer","important"),ct.appendChild(V),L.dataset.urpppNoticeClickBound!=="1"&&(L.dataset.urpppNoticeClickBound="1",L.style.setProperty("cursor","pointer","important"),L.addEventListener("click",Z=>{if(!(Z.target&&Z.target.closest&&Z.target.closest("a,button,input,select"))){if(V.getAttribute("onclick")||!V.getAttribute("href")||V.getAttribute("href")==="#"){V.click();return}w.location.href=V.getAttribute("href")}}))}else{let rt=f.createElement("div");rt.className="urppp-notice-title",rt.textContent=ot?Q.replace(ot[0],"").trim():Q,ct.appendChild(rt)}if(K.appendChild(ct),ot){let rt=f.createElement("div");rt.className="urppp-notice-meta";let st=f.createElement("span");st.className="urppp-notice-time",st.textContent=ot[1],rt.appendChild(st),K.appendChild(rt)}H.innerHTML="",H.appendChild(K),H.dataset.urpppNoticeDone="1",L.dataset.urpppNoticeDone="1"}return}let U=null,et=null,it=[];if(G.forEach(V=>{let Q=(V.getAttribute("style")||"")+" "+(V.style.cssText||""),ot=M(V.textContent);if(ot){if(/font-size\s*:\s*18/i.test(Q)||!U&&/font-size\s*:\s*1[6-9]/i.test(Q)){U=V;return}if(/font-size\s*:\s*12/i.test(Q)||/float\s*:\s*right/i.test(Q)||/^\d{4}-\d{2}-\d{2}/.test(ot)){et=V;return}it.push(V)}}),U||(U=G[0]),!et){let V=G[G.length-1];V!==U&&(et=V)}let mt=f.createElement("div");if(mt.className="urppp-notice-card",U){let V=f.createElement("div");V.className="urppp-notice-title",V.textContent=M(U.textContent),mt.appendChild(V)}if((it.length?it:G.filter(V=>V!==U&&V!==et)).forEach(V=>{let Q=f.createElement("div");Q.className="urppp-notice-body",Q.textContent=M(V.textContent),Q.textContent&&mt.appendChild(Q)}),et){let V=f.createElement("div");V.className="urppp-notice-meta";let Q=f.createElement("span");Q.className="urppp-notice-time",Q.textContent=M(et.textContent),V.appendChild(Q),mt.appendChild(V)}H.innerHTML="",H.appendChild(mt),H.dataset.urpppNoticeDone="1",L.dataset.urpppNoticeDone="1",L.classList.add("urppp-notice-row")})})}catch(g){T.warn("[URP++] notice table beautify failed",g)}}return a(C,"beautifyNoticeTables"),{beautifyNoticeTables:C}}a(Vp,"createNoticeTableBeautifier");var Yp={"page-content-template":"urppp-pdf-page",mycoursetable:"urppp-pdf-mycoursetable",courseTable:"urppp-pdf-courseTable",courseTableBody:"urppp-pdf-courseTableBody",h4_id1:"urppp-pdf-h4-1",h4_id2:"urppp-pdf-h4-2",infoTable:"urppp-pdf-info-table","rwskxxbg-course":"urppp-pdf-rwskxxbg","other-course":"urppp-pdf-other-course",temp_title:"urppp-pdf-temp-title",temp_subtitle:"urppp-pdf-temp-subtitle"};function kc(p){return p.querySelectorAll('script, iframe, object, embed, [id^="urppp-"], [data-urppp]').forEach(n=>n.remove()),[p,...p.querySelectorAll("*")].forEach(n=>{Array.from(n.classList||[]).forEach(c=>{/^urppp(?:-|$)/.test(c)&&n.classList.remove(c)}),Array.from(n.attributes||[]).forEach(c=>{/^data-urppp(?:-|$)/.test(c.name)&&n.removeAttribute(c.name)}),n.style&&Array.from(n.style).forEach(c=>{n.style.getPropertyPriority(c)==="important"&&n.style.removeProperty(c)})}),p}a(kc,"sanitizeNativePdfClone");function Ac(p){return[p,...p.querySelectorAll("*")].forEach(n=>{n.id&&Yp[n.id]&&(n.id=Yp[n.id]),n.classList.contains("class_div")&&(n.classList.remove("class_div"),n.classList.remove("box_font"),n.classList.add("urppp-pdf-card")),n.classList.contains("course")&&(n.classList.remove("course"),n.classList.add("urppp-pdf-course"))}),p}a(Ac,"renameNativePdfClone");function Sc(){let p=[];document.querySelectorAll('style[id^="urppp-"]').forEach(d=>{d.sheet&&!d.sheet.disabled&&(p.push(d),d.sheet.disabled=!0)});let n=0,c=document.getElementById("mycoursetable");return c&&(n=c.getBoundingClientRect().width),p.forEach(d=>{d.sheet.disabled=!1}),n}a(Sc,"measureNativeScheduleWidth");var _c=`
...
`;function Ec(p){p.querySelectorAll("td, th").forEach(n=>{n.style.removeProperty("background"),n.style.removeProperty("background-color")}),p.querySelectorAll("th[rowspan]").forEach(n=>{n.style.removeProperty("width"),n.style.setProperty("white-space","nowrap"),n.style.setProperty("text-align","center")}),p.querySelectorAll("table").forEach(n=>{n.style.setProperty("background","#ffffff","important"),n.style.setProperty("background-color","#ffffff","important"),n.style.setProperty("border","none","important"),n.style.setProperty("color","#000000","important")}),p.querySelectorAll("th").forEach(n=>{if(n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important"),n.style.setProperty("font-weight","normal","important"),n.childNodes.length===1&&n.firstChild&&n.firstChild.nodeType===3){let c=document.createElement("span");c.textContent=n.textContent,n.textContent="",n.appendChild(c)}}),p.querySelectorAll("thead th").forEach(n=>{n.style.setProperty("background","#dddddd","important"),n.style.setProperty("background-color","#dddddd","important")}),p.querySelectorAll("tbody th").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important")}),p.querySelectorAll("td").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important"),n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important")})}a(Ec,"normalizeNativePdfStage");function Qp(p){let n=Sc(),c=document.createElement("div");c.id="urppp-pdf-stage",c.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(n||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=p.cloneNode(!0);kc(u),Ac(u),d.appendChild(u),c.appendChild(d),Ec(u);let A=document.createElement("style");A.id="urppp-pdf-reset-style",A.textContent=_c,document.head.appendChild(A),document.body.appendChild(c);let P=c.querySelector("#urppp-pdf-mycoursetable"),_=c.querySelector("#urppp-pdf-page")||c;if(!P)throw c.remove(),new Error("无法建立原生课表捕获节点");return{stage:c,target:P,page:_,sourceHost:p}}a(Qp,"cloneNativePdfStage");var na=0;function de(){return na>0}a(de,"isNativePdfIsolationActive");function Cc(p){return!p||p.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(p.id||"")||p.hasAttribute("data-urppp-style")?!0:(p.textContent||"").includes("urppp-")}a(Cc,"isUrpppOwnedStyle");function Kp(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(Kp,"defaultPage");function Xp(p,n){let c=p&&typeof p.requestAnimationFrame=="function"?p.requestAnimationFrame.bind(p):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return c?c(n):setTimeout(n,0)}a(Xp,"scheduleFrame");function Pc(p={}){let n=p.document||(typeof document<"u"?document:null),c=p.page||Kp();if(!n)throw new Error("原生 PDF 隔离缺少 document");let d=n.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");na+=1;let u=[d,...d.querySelectorAll("*")],A=[],P=n.getElementById("soliderbox");P&&A.push(P);let _=d.parentElement;for(;_&&_!==n.documentElement;){let x=_.classList;(_.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&A.push(_),_=_.parentElement}let y=n.getElementById("page-content-template")||n.querySelector(".page-content");y&&!A.includes(y)&&A.push(y);let S=[...u,...A],f=S.map(x=>({element:x,style:x.getAttribute("style")})),w=Array.from(n.querySelectorAll("style")).filter(Cc).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),T=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=c&&c.divBuild,g=c&&c.__urpppOriginalDivBuild,b=!1,v=a(()=>{b||(b=!0,c&&c.divBuild===g&&typeof C=="function"&&(c.divBuild=C),f.forEach(({element:x,style:E})=>{x.isConnected&&(E===null?x.removeAttribute("style"):x.setAttribute("style",E))}),T.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),w.forEach(({style:x,disabled:E,media:q})=>{try{q===null?x.removeAttribute("media"):x.setAttribute("media",q),x.sheet&&(x.sheet.disabled=E)}catch{}}),na=Math.max(0,na-1),Xp(c,()=>{try{typeof p.onAfterRestore=="function"&&p.onAfterRestore()}catch{}}))},"restore");try{return w.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),S.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(E=>{x.style.getPropertyPriority(E)==="important"&&(E==="height"&&x.matches("td, th")||x.style.removeProperty(E))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),T.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),c&&typeof g=="function"&&(c.divBuild=g),v}catch(x){throw v(),x}}a(Pc,"isolateScheduleForNativeExport");function Zp(p,n={}){return new Promise((c,d)=>{let u=n.page||Kp(),A=u&&u.back,P=u&&u.html2canvas;if(!p||typeof A!="function"){d(new Error("教务原生导出依赖未就绪"));return}let _=null;try{_=Pc(n)}catch(g){d(g);return}let y=0,S=!1,f=null,w=null,T=a(g=>{if(!S){S=!0,y&&clearTimeout(y),u&&f&&u.back===f&&(u.back=A),w&&u.html2canvas===w&&(u.html2canvas=P);try{_&&_()}catch{}g?d(g):c()}},"settle"),C=a(g=>T(g instanceof Error?g:new Error(String(g))),"fail");typeof P=="function"&&(w=a(function(){let g=P.apply(this,arguments);return g&&typeof g.catch=="function"&&g.catch(C),g},"scopedCanvas"),u.html2canvas=w),f=a(function(){try{return A.apply(this,arguments)}finally{setTimeout(()=>T(),0)}},"wrappedBack"),u.back=f,y=setTimeout(()=>{try{A.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},n.timeoutMs||60*1e3),Xp(u,()=>{try{p.click()}catch(g){C(g)}})})}a(Zp,"exportNativePdfIsolated");var ti=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
`;var ri=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var ni=`      /* 表格美化：业务表格、分页、公告卡片（table-beautify） */
...
`;var pi=`      /* 导航：顶栏、侧栏、面包屑（navigation） */
      /* 顶栏 —— 基于真实 DOM */
...
`;var ii=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function di(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(di,"createCleanModeState");function ui(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(ui,"resetCleanModeData");function mi({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(A){p.catalog=p.catalog||[],p.roomError=String(A&&A.message||A),console.warn("[URP++] room catalog",A)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&ui(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let A=await n.ensureTermWeekResolved();!p.weekLocked&&A>=1&&(p.viewWeek=A)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(A){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(A)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(A){p.schedule={courses:[],error:String(A&&A.message||A)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}})(),(async()=>{let A=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),A=p.scores,n.reconcileProfileAndScores(),A&&!A.error&&!A.evaluationReady&&n.enrichScoresWithEvaluation(A).then(()=>{p.scores===A&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(mi,"createCleanModeDataLoader");var ar={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},zc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Er={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function gi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(gi,"calToday");function go(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(go,"calDayDiff");function fo(p,n){let c=go(ar[p].start,n);return c<0?0:Math.floor(c/7)+1}a(fo,"calWeekNo");function ho(p){return zc[p]||""}a(ho,"calLunar");function hi(p){return String(p||"").slice(5)}a(hi,"calYY");function Lc(p){let n=p||gi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(Lc,"calActiveTerm");function xo(p,n){let c=p&&ar[p]?p:"autumn",d=ar[c],u=n||gi(),A=d.events.map(f=>({e:f,d:go(u,f.start)})).filter(f=>f.d>=-0).sort((f,w)=>f.d-w.d)[0],P=A?go(u,A.e.start):null,_=fo(c,u),y=Math.max(0,Math.min(100,_/d.weeks*100)),S=u>=d.start;return{term:d,termId:c,next:A,daysLeft:P,weekNo:_,progress:y,started:S,today:u}}a(xo,"calStatus");function fi(p,n){let c=xo(p,n),d=c.next?Er[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(fi,"calendarSummaryHtml");function xi(p,n){let c=xo(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
    <span class="cal-c-dot" style="background:${c.next?Er[c.next.e.t].color:"#c9cdd4"}"></span>
  ...
  </button>`}a(xi,"calendarSummaryCompactHtml");function bi(p,n){let c=xo(p,n),d=c.next?Er[c.next.e.t].color:"#c9cdd4",u=c.term,A=Object.keys(ar).map(w=>`<button type="button" class="cal-term${w===c.termId?" ac":""}" data-cal-term="${w}">${ar[w].name}</button>`).join(""),P=`<div class="cal-widget">
  ...
  </div>`,_=u.events.slice().sort((w,T)=>w.start<T.start?-1:1),y={};_.forEach(w=>{(y[w.start.slice(0,7)]=y[w.start.slice(0,7)]||[]).push(w)});let S=a(w=>w===c.today?" cal-today":"","todayFlag"),f=Object.keys(y).map(w=>{let[,T]=w.split("-");return`<div class="cal-mon">
      <div class="cal-mon-label">${Number(T)} 月</div>
      <div class="cal-mon-items">${y[w].map(C=>{let g=Er[C.t].color,b=C.end&&C.end!==C.start?"~"+hi(C.end):"",v=fo(c.termId,C.start)>0?`第 ${fo(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
          <span class="cal-ev-dot" style="background:${g}"></span>
          <span class="cal-ev-date">${hi(C.start)}${b||""}<em>${ho(C.start)||"&nbsp;"}</em></span>
          <span class="cal-ev-name">${C.name}</span>
          <span class="cal-ev-tag" style="color:${g};background:${g}1a">${Er[C.t].label}</span>
  ...
  </div>`}a(bi,"calendarModalHtml");function yi(p,n){let c=typeof document<"u"?document:null;if(!c)return;bo();let d=p&&ar[p]?p:Lc(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${bi(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>bo()),u.addEventListener("click",A=>{let P=A.target;if(P&&P.closest&&P.closest(".cal-close")){bo();return}let _=P&&P.closest?P.closest("[data-cal-term]"):null;if(_){let y=u.querySelector(".cal-body");y&&(y.innerHTML=bi(_.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(S=>S.classList.toggle("ac",S.dataset.calTerm===_.dataset.calTerm))}})}a(yi,"openCalendarModal");function bo(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(bo,"closeCalendarModal");function vi(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),yi())})}a(vi,"bindCalendarOpen");var pa=!1;function yo(){let p=typeof document<"u"?document:null;if(!p||pa)return pa;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${q?"":" hidden"}>${A()}</div>
      ...
      <div class="uc-occ"><table class="uc-occ-table">${q}${I}</table></div>`}a(g,"occupancyHtml");function b(){let x=n.ensureRoot(),E=x.querySelector("#uc-body");n.getViewWeekNumber();let q=typeof window<"u"&&window.matchMedia?window.matchMedia:null,I=q&&q("(max-width:900px)").matches,L=!p.uiReady;E.innerHTML=I?T():w(),L?(p.uiReady=!0,x.classList.remove("uc-settled"),clearTimeout(x.__ucSettleTimer),x.__ucSettleTimer=setTimeout(()=>{p.open&&x.classList.add("uc-settled")},480)):x.classList.add("uc-settled"),n.bindUI(E),n.applyPersonalDisplay(E)}a(b,"render");function v(){if(!p.open||c)return;let x=a(()=>{c=0,p.open&&b()},"run"),E=typeof requestAnimationFrame=="function"?requestAnimationFrame:null;c=E?E(x):setTimeout(x,0)}return a(v,"scheduleRender"),{analysisHtml:A,metricHtml:u,occupancyHtml:g,render:b,renderScheduleBoard:y,roomPickerHtml:C,scheduleRender:v,scoreSectionHtml:P}}a(Ai,"createCleanModeRenderer");function Si({state:p,deps:n}){function c(w,T){return!w||(w.__urpppCleanUiBindings||(w.__urpppCleanUiBindings=new Set),w.__urpppCleanUiBindings.has(T))?!1:(w.__urpppCleanUiBindings.add(T),!0)}a(c,"markCleanUiBound");function d(w){if(!w)return;try{n.bindScheduleExportHosts(w)}catch(C){console.warn("[URP++] schedule export menu",C)}w.querySelectorAll("[data-score]").forEach(C=>{c(C,"score")&&C.addEventListener("click",()=>_(C.getAttribute("data-score")))}),w.querySelectorAll("[data-sa-tab]").forEach(C=>{c(C,"saTab")&&C.addEventListener("click",()=>{p.scoreAnalysisTab=C.getAttribute("data-sa-tab")==="analysis"?"analysis":"overview",n.render()})}),w.querySelectorAll("[data-href]").forEach(C=>{c(C,"href")&&C.addEventListener("click",g=>{let b=C.getAttribute("data-href");b&&(g.preventDefault(),n.closeCleanMode(),location.href=b)})}),w.querySelectorAll("[data-eval-url]").forEach(C=>{c(C,"eval")&&C.addEventListener("click",g=>{let b=C.getAttribute("data-eval-url");b&&(g.preventDefault(),g.stopPropagation(),n.closeCleanMode(),location.href=b)})}),w.querySelectorAll('[data-action="room"]').forEach(C=>{c(C,"room")&&C.addEventListener("click",()=>y())}),w.querySelectorAll("[data-room-reload]").forEach(C=>{c(C,"roomReload")&&C.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation(),n.ensureRoomCatalogLoaded(!0)})}),w.querySelectorAll("[data-build-path]").forEach(C=>{c(C,"building")&&C.addEventListener("click",async()=>{let g=C.getAttribute("data-build-path"),b=(C.textContent||"").trim(),v=C.getAttribute("data-cn")||"",x=C.getAttribute("data-bn")||"",E=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;p.roomDateOffset=0,await f({path:g,name:b,campusNumber:v,buildingNumber:x,dateOffset:0},b,E)})}),w.querySelectorAll("[data-room-day]").forEach(C=>{c(C,"roomDay")&&C.addEventListener("click",async g=>{g.preventDefault(),g.stopPropagation();let b=parseInt(C.getAttribute("data-room-day")||"0",10)||0;if(!p.currentBuilding)return;p.roomDateOffset=b;let v=Object.assign({},p.currentBuilding,{dateOffset:b}),x=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;await f(v,v.name||"",x)})});let T=w.querySelector("#uc-room-back");T&&(T.onclick=()=>{p.occupancy=null,p.currentBuilding=null;let C=T.closest("#uc-room-panel")||document.querySelector("#uc-room-panel")||document.querySelector("#uc-modal-body");C&&C.id==="uc-modal-body"||C&&C.id==="uc-room-panel"?(C.innerHTML=n.roomPickerHtml(),d(C)):n.render()}),w.querySelectorAll(".uc-slot.busy[data-occ]").forEach(C=>{c(C,"occupancy")&&C.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation();try{let b=JSON.parse(C.getAttribute("data-occ")||"{}");A("占用详情",`
          ...
          `,"",{stack:!0})}catch{}})}),w.querySelectorAll(".uc-lesson[data-course]").forEach(C=>{c(C,"course")&&C.addEventListener("click",g=>{g.stopPropagation();try{let b=JSON.parse(C.getAttribute("data-course")||"{}"),v=`第${b.section||"?"}${b.span>1?"-"+(Number(b.section)+Number(b.span)-1):""}节`,x=(b.others||[]).map(E=>`<div class="uc-course-sub ${E.thisWeek?"":"is-fade"}">
      ...
      </tr>`}).join("");A(w==="scheme"?"方案成绩 · "+(g.title||""):"全部及格成绩",`
      ...
      </div>`,document.documentElement.appendChild(y),y.querySelector("#uc-exit").onclick=A,y.querySelector("#uc-refresh").onclick=()=>u(!0),y.querySelector("#uc-mask").onclick=n.closeModal,y.querySelector("#uc-modal-close").onclick=n.closeModal;let S=a(()=>{n.syncThemeDotGroup(y.querySelector("#uc-top-theme"))},"syncCleanThemeDots");y.querySelectorAll("#uc-top-theme .urppp-nav-dot[data-theme]").forEach(v=>{v.addEventListener("click",()=>{n.handleThemeDotClick(v.dataset.theme),S();try{n.syncNavbarThemeUI()}catch{}try{n.syncSettingsPanelUI()}catch{}})});let f=y.querySelector("#uc-settings");f&&f.addEventListener("click",v=>{v.preventDefault(),v.stopPropagation();try{n.openSettingsPanel()}catch{}});let w=y.querySelector("#uc-menu-toggle"),T=a(v=>{v.classList.remove("urppp-clean-sidebar");let x=v.__urpppCleanInline;if(x){let q=v.style,I=a((L,O)=>{let M=x[O];M&&M.v?q.setProperty(L,M.v,M.p||""):q.removeProperty(L)},"restore");I("top","top"),I("height","height"),I("z-index","z"),I("position","pos"),I("transform","transform"),I("visibility","vis"),I("pointer-events","pe"),I("transition","transition"),delete v.__urpppCleanInline}let E=v.__urpppCleanOrigin;E&&E.parent&&v.parentElement!==E.parent&&(E.next&&E.next.parentElement===E.parent?E.parent.insertBefore(v,E.next):E.parent.appendChild(v)),delete v.__urpppCleanOrigin},"restoreCleanSidebarInline"),C=a(()=>{let v=document.getElementById("sidebar");if(v)if(p.open){if(v.classList.add("urppp-clean-sidebar"),!v.__urpppCleanInline){let O=v.style,M=a(H=>({v:O.getPropertyValue(H),p:O.getPropertyPriority(H)}),"grab");v.__urpppCleanInline={top:M("top"),height:M("height"),z:M("z-index"),pos:M("position"),transform:M("transform"),vis:M("visibility"),pe:M("pointer-events"),transition:M("transition")},v.__urpppCleanOrigin={parent:v.parentElement,next:v.nextSibling}}if(v.parentElement!==y){let O=y.querySelector(".uc-shell");y.insertBefore(v,O||null)}let x=y.getBoundingClientRect(),E=y.querySelector(".uc-top"),q=E?E.getBoundingClientRect():null,I=Math.max(44,Math.round(q?q.bottom-x.top:60)),L=Math.max(0,Math.round(x.height-I));v.style.setProperty("top",I+"px","important"),v.style.setProperty("height",L+"px","important"),v.style.setProperty("z-index","12030","important"),v.style.setProperty("position","fixed","important")}else T(v)},"syncCleanSidebarZ"),g=a(()=>{let v=document.getElementById("sidebar");if(!v)return;try{n.stopDrawerAnimation(v)}catch{}v.classList.remove("display","urppp-drawer-closing"),T(v),w&&(w.setAttribute("aria-expanded","false"),w.setAttribute("aria-label","打开菜单"));let x=document.getElementById("urppp-mobile-menu-button");x&&(x.setAttribute("aria-expanded","false"),x.setAttribute("aria-label","打开菜单"))},"closeCleanSidebar");w&&w.addEventListener("click",v=>{v.preventDefault(),v.stopImmediatePropagation();let x=document.getElementById("sidebar");if(!x)return;x.__urpppCleanMenuBound||(x.__urpppCleanMenuBound=!0,x.addEventListener("click",I=>{if(!p.open)return;let L=I.target&&I.target.closest?I.target.closest("a[href]"):null;if(!L||L.closest("#urppp-mobile-search-panel"))return;let O=String(L.getAttribute("href")||"").trim();if(L.closest("#urppp-mobile-quick, #urppp-mobile-user")){if(!O||O==="#"||O.startsWith("javascript")||L.target==="_blank"||/^https?:\/\//i.test(O))return;A();return}!O||O==="#"||O.startsWith("javascript")||L.target==="_blank"||/^https?:\/\//i.test(O)||A()},!0));let E=!x.classList.contains("display");C(),n.setDrawerOpen(x,w,E);let q=document.getElementById("urppp-mobile-menu-button");q&&(q.setAttribute("aria-expanded",E?"true":"false"),q.setAttribute("aria-label",E?"关闭菜单":"打开菜单"))}),y.__closeCleanDrawer=g,y.__syncCleanSidebarZ=C,y.__syncCleanThemeDots=S;let b=globalThis.ResizeObserver;if(typeof b=="function"){let v=new b(()=>{p.open&&C()});v.observe(y);let x=y.querySelector(".uc-top");x&&v.observe(x),y.__cleanSidebarResizeObserver=v}try{let v=window.matchMedia&&window.matchMedia("(max-width: 900px)");if(v){let x=a(()=>{p.open&&(C(),n.render())},"onLayoutChange");typeof v.addEventListener=="function"?v.addEventListener("change",x):typeof v.addListener=="function"&&v.addListener(x),y.__scoreLayoutMedia=v,y.__scoreLayoutChange=x}}catch{}try{n.applySkinAttr()}catch{}return S(),y.querySelectorAll("#uc-tabbar button").forEach(v=>{v.onclick=()=>{p.mobileTab=v.dataset.tab,y.querySelectorAll("#uc-tabbar button").forEach(x=>x.classList.toggle("ac",x===v)),n.render(),p.mobileTab==="room"&&n.ensureRoomCatalogLoaded()}}),yo(),vi(y),y}a(d,"ensureRoot");function u(y){d();let S=p.open;p.open=!0,p.uiReady=!1,p.weekLocked=!1;let f=n.getCurrentWeekNumber()||n.readRememberedTermWeek();p.viewWeek=f>=1?f:p.viewWeek>=1?p.viewWeek:0,document.documentElement.classList.add("urppp-clean-lock",n.CLEAN_FLAG);let w=c();w.classList.remove("closing"),S||(w.classList.remove("uc-settled","open"),w.offsetWidth,w.classList.add("open"));try{n.stopDrawerAnimation(document.getElementById("sidebar"))}catch{}try{w.__syncCleanThemeDots&&w.__syncCleanThemeDots()}catch{}try{w.__syncCleanSidebarZ&&w.__syncCleanSidebarZ()}catch{}try{n.injectCleanSidebarSections(document.getElementById("sidebar"))}catch{}n.loadAll(!!y);try{n.ensureRoomCatalogLoaded()}catch{}}a(u,"openCleanMode");function A(){p.open=!1,p.uiReady=!1,n.closeModal(),document.documentElement.classList.remove("urppp-clean-lock",n.CLEAN_FLAG);let y=c();if(y){y.classList.remove("open","uc-settled","uc-drawer-open"),y.classList.add("closing"),clearTimeout(y.__ucSettleTimer);try{y.__closeCleanDrawer&&y.__closeCleanDrawer()}catch{}setTimeout(()=>{y.classList.remove("closing")},360)}try{n.refreshMobileNavbar()}catch{}}a(A,"closeCleanMode");function P(){try{n.ensureStyle();let y=document.getElementById("urppp-nav-clean");if(!n.isHomePage()){y&&y.remove(),ki();return}let S=document.getElementById("urppp-nav-theme")||document.querySelector("#navbar .navbar-header")||document.querySelector("#navbar");if(!S)return;y||(y=document.createElement("button"),y.type="button",y.id="urppp-nav-clean",y.title="清爽模式",y.innerHTML=`${n.ico("clean")}<span>清爽</span>`,y.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),u(!1)}),S.appendChild(y)),Object.entries({display:"inline-flex","align-items":"center",height:"28px","min-height":"28px",padding:"0 12px","font-size":"12px",gap:"6px",width:"auto",float:"none"}).forEach(([f,w])=>y.style.setProperty(f,w,"important")),yo();try{wi()}catch{}}catch(y){console.warn("[URP++] clean entry",y)}}return a(P,"injectCleanEntry"),{cleanModeApi:{open:u,close:A,inject:P,refresh:n.refreshCleanPersonalDisplay,refreshRender:a(()=>{try{n.render()}catch{}},"refreshRender"),scoreToGpa:n.scoreToGpa,summarizeCourses:n.summarizeCourses},closeCleanMode:A,ensureRoot:d,injectCleanEntry:P,openCleanMode:u,rootEl:c}}a(_i,"createCleanModeController");function Ei({deps:p}){function n(){if(window.__urpppScheduleHoverNear)return;window.__urpppScheduleHoverNear=!0;let P=12,_=16,y=0,S=0,f=!1,w=0,T=a(()=>document.getElementById("schedule-hover"),"hoverEl"),C=a(v=>{if(!v||v.style&&v.style.display==="none")return!1;let x=window.getComputedStyle(v);return x.display!=="none"&&x.visibility!=="hidden"},"isShown"),g=a(()=>{let v=T();if(!v||!C(v)){f=!1;return}f=!0;let x=window.innerWidth||1200,E=window.innerHeight||800,q=y+P,I=S+_,L=Math.min(320,v.offsetWidth||280),O=Math.min(220,v.offsetHeight||160);q+L>x-8&&(q=x-L-8),I+O>E-8&&(I=E-O-8),q<8&&(q=8),I<8&&(I=8),v.style.setProperty("position","fixed","important"),v.style.setProperty("left",Math.round(q)+"px","important"),v.style.setProperty("top",Math.round(I)+"px","important"),v.style.setProperty("right","auto","important"),v.style.setProperty("bottom","auto","important"),v.style.setProperty("margin","0","important"),v.style.setProperty("z-index","3000","important"),v.style.setProperty("pointer-events","none","important")},"place"),b=a(()=>{w||(w=requestAnimationFrame(()=>{w=0,g()}))},"schedulePlace");document.addEventListener("mousemove",v=>{if(y=v.clientX,S=v.clientY,!f){let x=T();x&&x.style&&x.style.display&&x.style.display!=="none"&&(f=!0)}f&&b()},!0),document.addEventListener("mouseover",v=>{v.target&&v.target.closest&&v.target.closest(".fc-event, .fc-time-grid-event")&&(y=v.clientX,S=v.clientY,setTimeout(()=>{f=!0,g()},0),setTimeout(g,40))},!0),document.addEventListener("mouseout",v=>{v.target&&v.target.closest&&v.target.closest(".fc-event, .fc-time-grid-event")&&setTimeout(()=>{let E=T();C(E)||(f=!1)},50)},!0)}a(n,"bindScheduleHoverNearCursor");function c(P){try{let _=!!(P&&P.force),y=typeof unsafeWindow<"u"&&unsafeWindow.jQuery?unsafeWindow.jQuery:window.jQuery||null;if(!y||!y.fn||!y.fn.fullCalendar)return!1;let S=document.getElementById("main-calendar")||document.querySelector("#urppp-left .fc, #urppp-dashboard .fc");if(!S)return!1;if(!_&&S.dataset.urpppFcSized==="1")return!0;let f=y(S);if(!(f.data("fullCalendar")||f.hasClass("fc")))return!1;let T=Array.from(S.querySelectorAll(".fc-scroller")).map(g=>({el:g,top:g.scrollTop,left:g.scrollLeft}));if(_||S.dataset.urpppFcRendered!=="1"){try{f.fullCalendar("render")}catch{}S.dataset.urpppFcRendered="1"}else try{f.fullCalendar("updateSize")}catch{}return requestAnimationFrame(()=>{T.forEach(g=>{try{g.el.scrollTop=g.top,g.el.scrollLeft=g.left}catch{}})}),(S.getBoundingClientRect().height||0)>=300&&(S.dataset.urpppFcSized="1"),!0}catch(_){return console.warn("[URP++] fullCalendar refresh failed",_),!1}}a(c,"refreshHomeFullCalendar");function d(){window.__urpppFcRefreshBound||(window.__urpppFcRefreshBound=!0,setTimeout(()=>c({force:!0}),0),setTimeout(()=>c({force:!1}),300))}a(d,"scheduleHomeFullCalendarRefresh");function u(P,_,y){let S=P.querySelector(".widget-header"),f=S?S.querySelector(".widget-toolbar"):null,w=document.createElement("div");w.className="urppp-card",w.innerHTML=`
    ...
    `,P.appendChild(f);let w=P.querySelector("#warningInfo");w&&document.body.appendChild(w),_.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let T=f.querySelector("#urppp-stats"),C=Math.max(S.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',T.appendChild(E)}function g(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&(T.innerHTML="",x.forEach(E=>{let q=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),I=q[0]||"",L=q.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),M=/[\u4e00-\u9fa5]/.test(I)||I.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=p.statCardPrivacyMarkup(I,L);G.innerHTML=`<div class="${M}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,T.appendChild(G)}))}if(a(g,"updateStats"),g(),y){let x=new MutationObserver(()=>g());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let b=f.querySelector("#urppp-left"),v=f.querySelector("#urppp-right");u(_[5],b,"我的日程安排"),u(_[0],v,"通知公告"),u(_[1],v,"我的待办任务"),u(_[2],v,"可申请业务"),u(_[3],v,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(A,"rebuildDashboard"),{rebuildDashboard:A,refreshHomeFullCalendar:c,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(Ei,"createDashboardController");function ve(p){return Math.round((Number(p)||0)*100)/100}a(ve,"round2");var qc=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],Ci={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},Tc=[{key:"required",label:"必修",test:a(p=>/必修/.test(p),"test")},{key:"elective",label:"任选",test:a(p=>/任选/.test(p),"test")},{key:"optional",label:"选修",test:a(p=>/选修/.test(p),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function Pi(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d+)/);return n?`${n[1].slice(2)}-${n[2].slice(2)}-${n[3]}`:String(p||"")}a(Pi,"shortTerm");function ia({deps:p}){let n=p.scoreToNumber,c=p.scoreToGpa;function d(g){let b=n(g);if(b!=null)return b;let v=String(g||"").trim().toUpperCase();return Ci[v]!=null?Ci[v]:null}a(d,"scoreToNumberWithLevels");function u(g){return!g||g.unevaluated?!1:d(g.score)!=null}a(u,"hasScore");function A(g){let b=String(g||"").match(/^(\d{4})-(\d{4})-(\d+)/);return b?[Number(b[1]),Number(b[3])]:[9999,9999]}a(A,"termOrderKey");function P(g){let b=g&&g.passing&&g.passing[0];return b&&b.courses||[]}a(P,"allCourses");function _(g){let b=g&&g.officialGpa,v=Number(b);return b!=null&&Number.isFinite(v)&&v>=0&&v<=5?v:null}a(_,"officialGpa");function y(g){let b=_(g);return b??c(g.score)}a(y,"courseGpa");function S({scorePack:g,profile:b}){let v=P(g),x=b&&b.majorGpa?String(b.majorGpa).trim():"",E=0,q=0,I=0,L=0,O=0,M=0;return v.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,q+=U*G;let et=y(H);et!=null&&(I+=et*G,L+=G,H.required&&(O+=et*G,M+=G))}),{majorGpa:x,requiredGpa:ve(M?O/M:0),avgGpa:ve(L?I/L:0),avgScore:ve(E?q/E:0),totalCredit:ve(E),courseCount:v.length}}a(S,"computeMetrics");function f(g){let b=new Map;return(g||[]).forEach(v=>{if(!u(v))return;let x=v.term||"未分组",E=b.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},b.set(x,E));let q=Number(v.credit)||0,I=d(v.score);if(I==null||(E.count+=1,q<=0))return;E.credit+=q,E.scoreW+=I*q;let L=y(v);L!=null&&(E.gpaW+=L*q,E.gpaCredit+=q)}),Array.from(b.values()).map(v=>({term:v.term,label:Pi(v.term),count:v.count,credit:ve(v.credit),avgScore:ve(v.credit?v.scoreW/v.credit:0),avgGpa:ve(v.gpaCredit?v.gpaW/v.gpaCredit:0)})).sort((v,x)=>{let E=A(v.term),q=A(x.term);return E[0]-q[0]||E[1]-q[1]})}a(f,"computeTrend");function w(g){let b=qc.map(x=>({...x,count:0,credit:0}));(g||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let q=b.find(I=>E>=I.min&&E<=I.max);q&&(q.count+=1,q.credit+=Number(x.credit)||0)});let v=b.reduce((x,E)=>Math.max(x,E.count),1);return b.map(x=>({...x,ratio:Math.round(x.count/v*100)}))}a(w,"computeBands");function T(g){let b=Tc.map(q=>({...q,credit:0,count:0}));(g||[]).forEach(q=>{if(!u(q))return;let I=String(q.attr||""),L=b.find(O=>O.test(I));L&&(L.credit+=Number(q.credit)||0,L.count+=1)});let v=b.reduce((q,I)=>q+I.credit,0)||1,x=b.filter(q=>q.count>0).map(q=>({key:q.key,label:q.label,credit:ve(q.credit),count:q.count,ratio:Math.round(q.credit/v*100)})),E=x.find(q=>q.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a(T,"computeShare");function C({scorePack:g,profile:b}){let v=P(g);return{metrics:S({scorePack:g,profile:b}),trend:f(v),bands:w(v),share:T(v),empty:v.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:_,scoreToNumberWithLevels:d,shortTerm:Pi}}a(ia,"createScoreAnalysisData");var ne="var(--text-secondary)",wo="var(--border)";function pe(p){return at(String(p??""))}a(pe,"escapeLabel");function zi(p,n,c){let d=!!(p&&p.variant==="mobile");if(n==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},_=Math.max(56,Number(p&&p.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,c)*_),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},A=Math.max(44,Number(p&&p.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,c)*A),height:236,pad:u}}a(zi,"resolveChartLayout");function vo({width:p,height:n,mobile:c,kind:d,label:u}){let A=c?` data-urppp-chart-layout="mobile" style="width:max(100%,${p}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${p} ${n}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${A}>`}a(vo,"openSvg");function sa({trend:p,palette:n,layout:c}){let d=(p||[]).filter(rt=>rt&&rt.avgScore!=null),u=zi(c,"trend",d.length),{width:A,height:P,pad:_,mobile:y}=u,S=A-_.left-_.right,f=P-_.top-_.bottom;if(!d.length)return`${vo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let w=d.length,T=a(rt=>_.left+(rt+.5)*(S/w),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),g=d.map(rt=>Number(rt.avgScore)||0),b=d.map(rt=>Number(rt.credit)||0),v=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...g)-4),q=Math.min(100,Math.max(...g)+4),I=Math.max(1,...b),L=x-v||1,O=q-E||1,M=a(rt=>_.top+f-(rt-v)/L*f,"yGpa"),H=a(rt=>_.top+f-(rt-E)/O*f,"yScore"),G=a(rt=>_.top+f-rt/I*f*.9,"yCredit"),U=d.map((rt,st)=>`${T(st)},${M(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${T(st)},${H(rt.avgScore)}`).join(" "),it=[0,.25,.5,.75,1].map(rt=>{let st=_.top+f-rt*f;return`<line x1="${_.left}" y1="${st.toFixed(1)}" x2="${A-_.right}" y2="${st.toFixed(1)}" stroke="${wo}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),mt=d.map((rt,st)=>{let ft=T(st),Z=y?Math.min(30,S/w*.42):Math.min(26,S/w*.32),dt=G(rt.credit);return`<rect x="${(ft-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(_.top+f-dt).toFixed(1)}" rx="3" fill="${n.credit}" opacity="0.55"/>
<text x="${ft.toFixed(1)}" y="${(dt-4).toFixed(1)}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.credit)}</text>`}).join(""),V=d.map((rt,st)=>`<text x="${T(st).toFixed(1)}" y="${P-16}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.label)}</text>`).join(""),Q=d.map((rt,st)=>{let ft=S/w,Z=T(st)-ft/2,dt=[`学期 ${rt.label}`,`课程 ${rt.count} 门`,`修读学分 ${rt.credit}`,`加权均分 ${rt.avgScore}`,`平均绩点 ${rt.avgGpa}`].join(`
`);return`<rect class="urppp-sa-hover" x="${Z.toFixed(1)}" y="${_.top}" width="${ft.toFixed(1)}" height="${f.toFixed(1)}" fill="transparent"><title>${pe(dt)}</title></rect>`}).join(""),ot=d.map((rt,st)=>`<circle cx="${T(st).toFixed(1)}" cy="${M(rt.avgGpa).toFixed(1)}" r="3.5" fill="${n.gpaLine}"/><text x="${T(st).toFixed(1)}" y="${(M(rt.avgGpa)-9).toFixed(1)}" text-anchor="middle" font-size="11.5" font-weight="600" fill="${n.gpaLine}">${pe(rt.avgGpa)}</text>`).join(""),K=d.map((rt,st)=>`<circle cx="${T(st).toFixed(1)}" cy="${H(rt.avgScore).toFixed(1)}" r="3" fill="${n.scoreLine}"/><text x="${T(st).toFixed(1)}" y="${(H(rt.avgScore)+17).toFixed(1)}" text-anchor="middle" font-size="11.5" fill="${n.scoreLine}">${pe(rt.avgScore)}</text>`).join(""),ct=y?`<g font-size="12">
...
<g>${V}</g>
${ct}
</svg>`}a(sa,"trendChartSvg");function la({bands:p,palette:n,layout:c}){let d=p||[],u=zi(c,"bands",d.length),{width:A,height:P,pad:_,mobile:y}=u,S=A-_.left-_.right,f=P-_.top-_.bottom,w=d.length||1,T=Math.max(1,...d.map(b=>b.count)),C=y?Math.min(32,S/w*.62):Math.min(40,S/w*.52),g=d.map((b,v)=>{let x=_.left+(v+.5)*(S/w),E=b.count?Math.max(8,b.count/T*f):0,q=_.top+f-E,I=(.4+(1-v/(w-1))*.6).toFixed(2),L=b.range||(b.min===0?"<60":`${b.min}-${b.max===100?"100":b.max}`),O=[`${b.level||""}（绩点 ${b.gpa}）`,`百分制 ${L}`,`课程 ${b.count} 门`].join(`
...
<line x1="${_.left}" y1="${(_.top+f).toFixed(1)}" x2="${A-_.right}" y2="${(_.top+f).toFixed(1)}" stroke="${wo}" stroke-width="1"/>
${g}
</svg>`}a(la,"bandsChartSvg");function Li({items:p,requiredRatio:n,palette:c}){let _=2*Math.PI*56,y=(p||[]).filter(T=>T&&T.ratio>0),S=Math.max(0,Math.min(100,Math.round(Number(n)||0)));if(!y.length)return'<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成"></svg>';let f=-90,w=y.map(T=>{let C=T.ratio/100*_,b=`<circle cx="75" cy="75" r="56" fill="none" stroke="${c.share&&c.share[T.key]||c.required}" stroke-width="24"
  stroke-dasharray="${C.toFixed(2)} ${_.toFixed(2)}"
  stroke-linecap="butt" transform="rotate(${f.toFixed(2)} 75 75)"/>`;return f+=T.ratio/100*360,b}).join("");return`<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成">
...
</svg>`}a(Li,"donutSvg");var $c=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),Mc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',Ic='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function qi({deps:p}){let n=p&&p.palette||$c;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
  <button type="button" class="urppp-sa-toggle" aria-expanded="false">
    <span class="urppp-sa-icon">${Mc}</span>
    <span class="urppp-sa-title">成绩分析</span>
    <span class="urppp-sa-summary" data-urppp-sa-summary>点击展开，查看成绩指标与学期变化</span>
    <span class="urppp-sa-chevron">${Ic}</span>
  </button>
...
<tbody>${(S||[]).map(w=>`<tr><td>${at(w.label)}</td><td>${at(w.count)}</td><td>${at(w.credit)}</td><td>${at(w.avgScore)}</td><td>${at(w.avgGpa)}</td></tr>`).join("")}</tbody></table>`}a(P,"detailTable");function _(S){return(S||[]).map(f=>`<div class="urppp-sa-legend-item"><i class="urppp-sa-legend-dot" style="background:${n.share&&n.share[f.key]||n.primary}"></i>${at(f.label)} ${at(f.credit)} 学分 · ${at(f.count)} 门</div>`).join("")}a(_,"shareLegend");function y(S,f={}){if(!S||S.empty)return'<div class="urppp-sa-empty">暂无可用成绩数据，请先在教务系统查询成绩后再试。</div>';let w=S.share||{items:[],requiredRatio:0},T=f.chartLayout||null;return`<div class="urppp-sa-metrics">${A(S.metrics)}</div>
<div class="urppp-sa-grid">
  <section class="urppp-sa-card urppp-sa-trend">
    <h5 class="urppp-sa-card-title">学期趋势</h5>
    <div class="urppp-sa-chart-scroll">${sa({trend:S.trend,palette:n,layout:T})}</div>
  </section>
  <section class="urppp-sa-card urppp-sa-share">
    <h5 class="urppp-sa-card-title">课程类型构成</h5>
    <div class="urppp-sa-share-body">
      <div class="urppp-sa-donut">${Li({items:w.items,requiredRatio:w.requiredRatio,palette:n})}</div>
...
<div class="urppp-sa-grid">
  ...
  `;function _(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(_,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function f(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=_("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=_("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(f,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{f(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let w="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",g="urppp_scheme_v1",b="urppp_theme_follow_system_v1",v="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",M="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",K=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:ft,syncThemeDotGroup:Z}=Bi({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Xt,getAccent:Qt,getBrutalActivePalette:Lo,getBrutalPaletteById:pr,getBrutalSelectedPalette:zo,getCurrent:Jt,getScheme:$e,getSkin:Zt,isThemeModeAvailable:or,setBrutalPalette:qo,skinSupportsDark:Ie,skinSupportsDynamic:Ne,skinSupportsFixedPalettes:Po},settings:{ensureSettingsPanel:on,openSettingsPanel:en,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let j=document.createElement("li");j.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",j.appendChild(o),r.appendChild(j)}let l=o.closest("li")||o.parentElement,m=Array.from(r.children).find(j=>{let R=j.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",X=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(X)}),h=Array.from(r.children).find(j=>j.classList.contains("light-blue")),k=m||h||null;k&&l&&k!==l&&((l.compareDocumentPosition(k)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,k)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let $=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),$&&s.parentElement!==$&&$.appendChild(s),$&&$.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let B=s.querySelector("#search-input"),z=s.querySelector("form");if(!B||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let D=s.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),B.style.setProperty("display","block","important"),B.style.setProperty("width","100%","important"),B.style.setProperty("height","36px","important"),B.style.setProperty("box-sizing","border-box","important"),B.style.setProperty("padding","0 12px","important"),B.style.setProperty("border","1px solid var(--border)","important"),B.style.setProperty("border-radius","var(--radius-sm)","important"),B.style.setProperty("background","var(--input-bg)","important"),B.style.setProperty("color","var(--text)","important");let J=a(j=>{s.dataset.open=j?"1":"0",s.style.setProperty("width",j?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",j?"1":"0","important"),s.style.setProperty("pointer-events",j?"auto":"none","important"),i.setAttribute("aria-expanded",j?"true":"false"),j&&setTimeout(()=>B.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",j=>{j.preventDefault(),j.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",j=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(j.target)||F?.contains(j.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function N(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,l=0,m=(o+i)/2;if(o!==i){let h=o-i;switch(l=m>.5?h/(2-o-i):h/(o+i),o){case t:s=(e-r)/h+(e<r?6:0);break;case e:s=(r-t)/h+2;break;default:s=(t-e)/h+4;break}s/=6}return{h:s*360,s:l,l:m}}a(N,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,i=o*(1-Math.abs(t/60%2-1)),s=r-o/2,l=0,m=0,h=0;return t<60?(l=o,m=i):t<120?(l=i,m=o):t<180?(m=o,h=i):t<240?(m=i,h=o):t<300?(l=i,h=o):(l=o,h=i),{r:Math.round((l+s)*255),g:Math.round((m+s)*255),b:Math.round((h+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:i,b:s}=Y(t,e,r);return yr(o,i,s)}a(tt,"hslHex");function bt(t){let{r:e,g:r,b:o}=Ze(Gt(t)||mt),i=N(e,r,o);return i.s<.12&&(i.s=.18),i}a(bt,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,i=Math.max(0,Math.min(.95,e));return tt(t,i,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Gt(t)||mt,{h:r,s:o}=bt(e),i=Ft(r),s=Math.min(.72,Math.max(.28,o*.78));return ht(i,s,42)}a(Pt,"companionColor");function It(t,e){let r=Gt(t)||mt,{h:o,s:i}=bt(r),l=zt(e||ot),m=Math.min(.92,Math.max(.35,i*l.chroma)),h=Pt(r),{h:k}=bt(h),$=ht(o,m,l.primaryTone),B=ht(o,m,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),D,J,j;l.whiteCard?(D=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",j="#E5E7EB"):l.duo?(D=Bt(yt(h,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),j=Bt("#E5E7EB",h,.16)):(D=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),j=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?h:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),F=ht(o,Math.min(.45,m*.55),14),X=ye(ht(o,m*.3,34),.88),ut=ye(ht(o,m*.22,46),.76),vt=ye($,.18),Et="0 4px 12px "+ye($,.1)+", 0 1px 2px "+ye($,.05);return{"--bg":D,"--surface":J,"--text":F,"--text-secondary":X,"--text-muted":ut,"--border":j,"--border-focus":$,"--input-bg":R,"--primary":$,"--primary-hover":B,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":h}}a(It,"buildMaterialSchemeVars");function Xt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Xt,"buildSchemePreview");function Te(t){let e=Gt(t)||Qt()||mt;return K.map(r=>Object.assign({},r,Xt(e,r.id)))}a(Te,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Qt(){return Gt(GM_getValue(T,""))||""}a(Qt,"getAccent");function $e(){let t=String(GM_getValue(g,ot)||ot);return K.some(e=>e.id===t)?t:ot}a($e,"getScheme");function ca(t){let e=K.some(r=>r.id===t)?t:ot;return GM_setValue(g,e),e}a(ca,"setScheme");function Fi(t,e){if(!t)return;let r=Gt(t);if(r){if(GM_setValue(T,r),e&&e.scheme&&ca(e.scheme),e&&e.skipTheme){let o=ao(r,.15),i=ye(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",i);try{ft()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{ft()}catch{}try{Dt()}catch{}}}a(Fi,"applyAccent");function da(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(da,"getAccentPresets");function Di(t){let e=Gt(t||Qt()||mt);if(!e)return da();let r=da();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(Di,"saveAccentPreset");function Kt(){try{return!!GM_getValue(b,!1)}catch{return!1}}a(Kt,"isThemeFollowSystem");function Cr(t){return GM_setValue(b,!!t),!!t}a(Cr,"setThemeFollowSystem");function ua(){try{return!!GM_getValue(v,!1)}catch{return!1}}a(ua,"isCleanDefault");function ji(t){return GM_setValue(v,!!t),!!t}a(ji,"setCleanDefault");function ma(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(ma,"isCleanAnalysisDirect");function Oi(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(Oi,"setCleanAnalysis");function we(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(we,"isAppleEdgeLine");function Hi(t){return GM_setValue(E,!!t),!!t}a(Hi,"setAppleEdgeLine");function ha(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(ha,"isAutoUpdateCheck");function Ri(t){return GM_setValue(c,!!t),!!t}a(Ri,"setAutoUpdateCheck");function Pr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(Pr,"readJsonSetting");function zr(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(zr,"writeJsonSetting");function ke(){return co(Pr(O,null))}a(ke,"getPrivacySettings");function ba(t){return zr(O,co(t))}a(ba,"setPrivacySettings");function Me(){return _r(Pr(M,null))}a(Me,"getCustomIdentity");function ko(t){return zr(M,_r(t))}a(ko,"setCustomIdentity");function ga(){let t=Pr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ga,"getScheduleFirstMondayMap");function Ao(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ga();r[String(t)]=String(e),zr(H,r)}a(Ao,"rememberScheduleFirstMonday");function Lr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=Pr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},i={enabled:!!o.enabled,mapping:qe(o.mapping||kr)};return et="",i}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:qe(kr)}}}a(Lr,"getScheduleJsonFormatSettings");function So(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:qe(e.mapping||kr)};return et="",zr(G,r)}a(So,"setScheduleJsonFormatSettings");function _o(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(_o,"isHomePage");function qr(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(qr,"isFollowUseDynamic");function fa(t){return GM_setValue(q,!!t),!!t}a(fa,"setFollowUseDynamic");function Ui(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Ui,"systemPrefersDark");function me(){return Ui()&&Ie()?"dark":qr()&&Ne()?"scu-red":"default"}a(me,"resolveFollowThemeName");function or(t,e){return t==="dark"?Ie(e):t==="scu-red"?Ne(e):t==="default"}a(or,"isThemeModeAvailable");function Wt(t,e){e=e||{},!Ie()&&Kt()&&Cr(!1),!Ne()&&qr()&&fa(!1),e.manual&&Cr(!1);let r;e.system||Kt()&&!e.manual?r=me():(r=Ct[t]?t:Jt()||"default",Ct[r]||(r="default")),or(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(w,r),ue();let i=document.getElementById("urppp-theme-vars")||(()=>{let k=document.createElement("style");return k.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(k),k})(),s=Qt(),l=Object.assign({},o.vars);if(r==="scu-red"){let k=s||mt,$=$e();l=Object.assign(l,It(k,$));let B=l["--primary"]||k,z=l["--primary-hover"]||ao(B,.12);document.documentElement.style.setProperty("--urppp-accent",B),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||ye(B,.15)),document.documentElement.style.setProperty("--urppp-seed",k),document.documentElement.style.setProperty("--urppp-scheme",$)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let m=":root {";for(let[k,$]of Object.entries(l))m+=`${k}:${$};`;m+="}",i.textContent=m,document.body&&(document.body.style.fontFamily=o.font);try{let k=document.documentElement;k.dataset.urpppTheme=r,k.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),k.classList.add("urppp-theme-"+r),k.classList.toggle("urppp-theme-follow",Kt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Kt()))}catch{}try{ee()}catch{}try{ft()}catch{}try{Dt()}catch{}try{Jo()}catch{}try{Zi()}catch{}let h=document.getElementById("urppp-boot-loader");h&&(h.style.fontFamily=o.font)}a(Wt,"applyTheme");function Jt(){return GM_getValue(w,"default")}a(Jt,"getCurrent");function he(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(he,"themeDownloaded");function nr(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(nr,"localThemes");function Eo(t,e){try{let r=nr();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Eo,"saveLocalTheme");function Wi(t){try{let e=nr();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(Wi,"removeLocalTheme");function xa(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(xa,"storeThemeStyleEl");function Gi(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(Gi,"removeStoreThemeStyle");function Co(){u.forEach(t=>{let e="urppp_theme_css_"+t.id,r="";try{r=GM_getValue(e,"")||""}catch{}r&&(xa(t.id).textContent=r);let o="";try{o=GM_getValue("urppp_card_css_"+t.id,"")||""}catch{}o&&Oe([{id:t.id,cardCss:o}])});try{ee()}catch{}}a(Co,"injectAllStoreThemeStyles");function Zt(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||he(e.id))||nr()[t]&&he(t)?t:"apple"}a(Zt,"getSkin");function ya(t,e){let r=t||Zt(),o=u.find(i=>i.id===r);return!!(o&&o[e])}a(ya,"getSkinCapability");function Ie(t){return ya(t,"dark")}a(Ie,"skinSupportsDark");function Ne(t){return ya(t,"dynamic")}a(Ne,"skinSupportsDynamic");function Po(t){return ya(t,"palettes")}a(Po,"skinSupportsFixedPalettes");function pr(t){return Q.find(e=>e.id===t)||Q[0]}a(pr,"getBrutalPaletteById");function zo(){let t=String(GM_getValue(I,"acid")||"acid"),e=pr(t);return e.id===V?pr("acid"):e}a(zo,"getBrutalSelectedPalette");function Lo(){let t=String(GM_getValue(L,V)||V);return pr(t)}a(Lo,"getBrutalActivePalette");function qo(t,e){let r=e||{},o=pr(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{ee()}catch{}try{ft()}catch{}try{Dt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}}a(qo,"setBrutalPalette");function Ji(t){let e=t||Zt();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&we()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&we()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Ji,"getSkinShapeOverrides");function Be(){try{let t=Zt();if(t==="apple")return we()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(Be,"urpppCardBorderValue");function ee(){let t=Zt();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&we();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=Ji(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=Lo();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=we(),l=s?"1px solid rgba(0,0,0,0.08)":"none",m=s?"1px solid rgba(255,255,255,0.10)":"none",h=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+m+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+h+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let i=document.head||document.documentElement;e.parentNode===i&&i.lastElementChild!==e&&i.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Yt(document)}catch{}},0)}a(ee,"applySkinAttr");function To(t){let e=u.find(i=>i.id===t&&i.ready&&(i.installed!==!1||he(i.id))),r=!e&&nr()[t]&&he(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||fa(!1),!o.dark&&Kt()&&Cr(!1);let i=Kt(),s=i?me():Jt(),l=or(s,e.id)?s:"default";ee(),Wt(l,{system:i})}catch{try{ee()}catch{}}try{Dt()}catch{}try{ft()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}return!0}a(To,"setSkin");function Vi(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Kt())try{Wt(me(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(Vi,"bindSystemThemeListener");try{Kt()?Wt(me(),{system:!0}):Wt(Jt())}catch{}try{ee()}catch{}try{Vi()}catch{}function Yi(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let i=e.match(o);if(i)return i[0].trim()}return""}a(Yi,"extractLoginErrorMessage");function $o(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout($o,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=Yi(e),i=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let m=location.pathname==="/loginEn",h=a((R,F)=>m?F:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      ${i}
    </div>`}a(us,"themeStoreCard");async function $a(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await ge()).filter(o=>o.type==="theme"&&!he(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Oe(r),e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>us(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>ms(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a($a,"fetchCatalogThemes");async function ms(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await ge()).find(l=>l.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o=await ln(r);if(o==="fail"){alert("签名校验失败：该条目可能被篡改，已停止下载"),e.disabled=!1,e.textContent="下载";return}if(o==="unknown"&&r._srcPub&&!confirm("该源无有效签名校验，可能被篡改。是否自担风险继续下载？")){e.disabled=!1,e.textContent="下载";return}let i="";for(let l of r.entry)try{let m=await fetch(l,{cache:"no-store"});if(m.ok){i=await m.text();break}}catch{}if(!i){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,i)}catch{}if(u.some(l=>l.id===t)||Eo(t,{name:r.name||t,desc:r.desc||"下载主题",author:r.author||"",version:r.version||"1.0.0"}),r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{xa(t).textContent=i}catch{}try{Oe([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;let s=e.closest&&e.closest(".urppp-store-inline");if(s){try{let l=s.querySelector("#urppp-theme-manage");l&&await Dr(l)}catch{}try{$a(s)}catch{}}try{Dt()}catch{}}a(ms,"downloadStoreTheme");function hs(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,i=e&&e.repo||t.repo,s=i?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(i)}">仓库</button>`:"",l=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"",m=Zt()===t.id;return`<div class="urppp-skin-card${m?" is-active":""}" data-skin="${at(t.id)}">
      ...
      ${o}${s}
    </div>`}a(hs,"themeManageCardHtml");async function Dr(t){if(!t)return;let e=[];try{e=await ge()}catch{}let r=nr(),o=Object.keys(r).map(s=>({id:s,name:r[s].name||s,desc:r[s].desc||"本地主题",version:r[s].version||"1.0.0",author:r[s].author||"本地",installed:!1})),i=u.filter(s=>s.installed!==!1||he(s.id)).concat(o.filter(s=>!u.some(l=>l.id===s.id)));if(!i.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}Oe(i.map(s=>e.find(l=>l.id===s.id))),t.innerHTML=`<div class="urppp-store-theme-grid">${i.map(s=>hs(s,e.find(l=>l.id===s.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(s=>s.addEventListener("click",()=>{if(To(s.dataset.themeUse)){try{Dt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(l=>{let m=l.dataset.skin,h=l.querySelector(".urppp-skin-apply"),k=Zt()===m;l.classList.toggle("is-active",k),h&&(h.classList.toggle("is-current",k),h.disabled=k,h.textContent=k?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(s=>s.addEventListener("click",()=>{let l=s.dataset.themeDel,m=Zt()===l;try{GM_setValue("urppp_theme_css_"+l,"")}catch{}try{GM_setValue("urppp_card_css_"+l,"")}catch{}Wi(l),Gi(l);try{if(m){GM_setValue(d,"apple");try{document.documentElement.removeAttribute("data-urppp-skin")}catch{}try{document.body&&document.body.removeAttribute("data-urppp-skin")}catch{}ee();let k=Kt(),$=k?me():Jt();Wt($,{system:k})}}catch{}try{Dt()}catch{}let h=t.closest(".urppp-store-inline");if(h){try{Dr(t)}catch{}try{$a(h)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(s=>s.addEventListener("click",()=>{try{window.open(s.dataset.repo,"_blank","noopener")}catch{}}))}a(Dr,"fetchThemeManage");function pn(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(pn,"storeManageSettingsHtml");let bs=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];function dr(){try{let t=JSON.parse(GM_getValue("urppp_store_sources","[]"));return Array.isArray(t)?t:[]}catch{return[]}}a(dr,"getCustomSources");function Ma(t){try{GM_setValue("urppp_store_sources",JSON.stringify(t))}catch{}}a(Ma,"saveCustomSources");let Ae=null;async function ge(t){if(Ae&&!t)return Ae;let e=a((k,$)=>Promise.race([k,new Promise((B,z)=>setTimeout(()=>z(new Error("timeout")),$))]),"withTimeout"),r=a(async k=>{try{let $=await e(fetch(k,{cache:"no-store"}),5e3);if(!($&&$.ok))return null;let B=await $.json();return B&&Array.isArray(B.items)?B:null}catch{return null}},"fetchCatalogDoc"),o=null;for(let k of bs){let $=await r(k);if($&&(o=$,$.items.some(B=>B.type==="theme"&&B.cardCss)))break}let i=o&&o.items||[],s=dr().filter(k=>k&&k.url&&k.enabled!==!1),l=await Promise.allSettled(s.map(async k=>{let $=await r(k.url);return{doc:$,pubkey:$?$.pubkey:""}})),m=[...i],h=new Set(m.map(k=>k&&k.id).filter(Boolean));for(let k of l){if(!(k.status==="fulfilled"&&k.value&&k.value.doc))continue;let $=k.value.pubkey||"";for(let B of k.value.doc.items)!B||!B.id||h.has(B.id)||(h.add(B.id),$&&(B._srcPub=$),m.push(B))}return Ae=m,m}a(ge,"fetchCatalogList");let jr=(function(){try{if(typeof crypto<"u"&&crypto&&crypto.subtle)return crypto.subtle;let t=typeof unsafeWindow<"u"&&unsafeWindow?unsafeWindow:typeof window<"u"?window:null;if(t&&t.crypto&&t.crypto.subtle)return t.crypto.subtle}catch{}return null})();function Ia(t){if(Array.isArray(t))return t.map(Ia);if(t&&typeof t=="object"){let e={};for(let r of Object.keys(t).filter(o=>o!=="signature"&&o!=="_srcPub").sort())e[r]=Ia(t[r]);return e}return t}a(Ia,"normalizeEntry");function sn(t){try{let e=atob(t),r=new Uint8Array(e.length);for(let o=0;o<e.length;o+=1)r[o]=e.charCodeAt(o);return r}catch{return null}}a(sn,"b64ToU8");async function gs(t,e){if(!jr)return null;if(!e||!t||!t.signature)return!1;try{let r=sn(e);if(!r)return null;let o=await jr.importKey("raw",r,{name:"Ed25519"},!1,["verify"]),i=sn(t.signature);if(!i)return!1;let s=JSON.stringify(Ia(t)),l=await jr.digest("SHA-256",new TextEncoder().encode(s)),m=new Uint8Array(l);return await jr.verify({name:"Ed25519"},o,i,m)}catch{return null}}a(gs,"verifyEntrySignature");async function ln(t){let e=t&&t._srcPub;if(!e)return"trust";let r=await gs(t,e);return r===!0?"ok":r===!1?"fail":"unknown"}a(ln,"guardEntrySignature");function cn(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let i=0;i<Math.max(r.length,o.length);i+=1){let s=r[i]||0,l=o[i]||0;if(s!==l)return s>l}return!1}a(cn,"versionGt");function fs(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let i=t.querySelector('[data-theme-use="'+o.id+'"]');i&&cn(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(dn(i.closest(".urppp-skin-card"),"主题"),r+=1);let s=t.querySelector('[data-plugin-id="'+o.id+'"]');if(s){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&cn(o.version,l.version)&&(dn(s.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(fs,"applyStoreUpdateBadges");function dn(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(dn,"addUpdateBadge");function un(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),i=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");i(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),i()}),r.addEventListener("click",async()=>{r.disabled=!0;let s=r.textContent;r.textContent="检查中…";try{let l=await ge(),m=fs(t,l);r.textContent=m?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=s,r.disabled=!1},1600)})}a(un,"bindStoreManageSettings");function xs(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="sources" style="display:none">${mn()}</div>
        </div>
      </div>`,nn(t),un(t),ys(t),hn(t),$a(t),Dr(t.querySelector("#urppp-theme-manage"))}a(xs,"renderThemeStoreBody");function mn(){let t=dr();return`<div class="urppp-src-manage">
    ...
    </div>`}a(mn,"storeSourcesHtml");function hn(t){let e=t.querySelector("[data-src-add]");if(e){let r=t.querySelector("[data-src-url]"),o=t.querySelector("[data-src-name]");e.addEventListener("click",async()=>{let i=(r.value||"").trim();if(!i)return;e.disabled=!0;let s=e.textContent;e.textContent="验证中…";try{let l=await fetch(i,{cache:"no-store"});if(!(l&&l.ok))throw new Error("无法访问");let m=await l.json();if(!(m&&Array.isArray(m.items)))throw new Error("不是合法 catalog（无 items）");let h=dr();if(h.some(k=>k.url===i)){alert("该源已存在");return}h.push({name:(o.value||"").trim()||i,url:i,enabled:!0}),Ma(h),Ae=null,Na(t)}catch(l){alert("添加失败："+(l&&l.message?l.message:l))}finally{e.disabled=!1,e.textContent=s}})}t.querySelectorAll("[data-src-toggle]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcToggle),i=dr();i[o]&&(i[o].enabled=i[o].enabled===!1,Ma(i),Na(t))})),t.querySelectorAll("[data-src-del]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcDel),i=dr();i[o]&&(i.splice(o,1),Ma(i),Na(t))}))}a(hn,"bindStoreSources");function Na(t){let e=t.querySelector('[data-pane="sources"]');if(e){let r=t;e.innerHTML=mn(),hn(r)}}a(Na,"refreshStoreSources");function ys(t){let e=t.querySelector("[data-add-local-theme]"),r=t.querySelector("[data-local-theme-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text(),s=i.match(/html\[data-urppp-skin="([\w-]+)"\]/);if(!s){alert('未能从 CSS 中识别主题 id（需要 html[data-urppp-skin="…"]）'),r.value="";return}let l=s[1];try{GM_setValue("urppp_theme_css_"+l,i)}catch{}Eo(l,{name:l,desc:"本地主题",author:"本地",version:"1.0.0"});try{xa(l).textContent=i}catch{}r.value="";try{Dr(t.querySelector("#urppp-theme-manage"))}catch{}}))}a(ys,"bindLocalThemeImport");function vs(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
      ...
      </div>`,nn(t),un(t),ks(t),ws(t.querySelector('[data-pane="download"]')),bn(t.querySelector("#urppp-plugin-manage"))}a(gn,"renderPluginStoreBody");function ks(t){let e=t.querySelector("[data-add-local-plugin]"),r=t.querySelector("[data-local-plugin-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text();r.value="";try{new Function(i)()}catch(s){alert("本地插件加载失败："+(s&&s.message?s.message:s))}try{bn(t.querySelector("#urppp-plugin-manage"))}catch{}}))}a(ks,"bindLocalPluginImport");function As(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>Ta("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=Zt();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}u.filter(i=>i.installed!==!1||he(i.id)).forEach(i=>{let s=document.createElement("div");s.className="urppp-skin-card"+(i.id===o?" is-active":""),s.dataset.skin=i.id;let l=document.createElement("button");l.type="button",l.className="urppp-skin-apply";let m=i.installed!==!1||he(i.id);m?i.id===o&&i.ready?(l.classList.add("is-current"),l.textContent="使用中",l.disabled=!0):l.textContent="应用主题":(l.classList.add("is-disabled"),l.textContent="去下载"),l.addEventListener("click",h=>{if(h.preventDefault(),h.stopPropagation(),!m){Ta("theme");return}if(!(i.id===o&&i.ready)&&To(i.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),s.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),s.querySelector(".urppp-skin-name").textContent=i.name,s.querySelector(".urppp-skin-desc").textContent=i.desc,s.appendChild(l),r.appendChild(s)})}a(As,"renderSkinCards");let He=[],Ba=!1;function Ss(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,i=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(s=>{if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).finally(()=>{i&&clearTimeout(i)})}a(Ss,"fetchWithTimeout");function _s(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(i=>{i.status>=200&&i.status<400?r(i.responseText||""):o(new Error("HTTP "+i.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(i){o(i)}})}a(_s,"gmRequestForUpdate");function Es(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),Ss(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return _s(t,r);throw o})}a(Es,"fetchTextForUpdate");async function Fa(t,e,r=1e3){let o=[],i=t[0],s=t.slice(1),l=a(z=>Es(z,e).then(D=>({url:z,text:D})).catch(D=>(o.push((z.split("/")[2]||z)+": "+(D&&D.message||D)),null)),"grab"),m=l(i),h=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),k=await Promise.race([m,h]);if(k!=="__TIMEOUT__"){if(k&&k.text&&k.text.length>0)return k.text;let D=(await Promise.all(s.map(l))).find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let $=Promise.all(s.map(l)).then(z=>{let D=z.find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),B=m.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([B,$])}a(Fa,"fetchFirstAvailable");function Se(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(Se,"setUpdateStatus");async function Da(){let t=p,e="",r=!1,o="";try{let s=await Fa(n.sourceUrls(n.versionJson)),l=JSON.parse(s);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let s=await Fa(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=no(s)}if(!e)throw new Error("无法解析远程主插件版本");let i=vr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:i>0?"update":i===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:r?o:""}}a(Da,"checkMainUpdate");function fn(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let i=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,s=[],l;for(;(l=i.exec(o))!==null;)s.push({ver:l[1],index:l.index,headEnd:i.lastIndex});if(!s.length)return"";for(let h=0;h<s.length;h++){let k=h+1<s.length?s[h+1].index:o.length;s[h].body=o.slice(s[h].index,k).trim()}let m=[];for(let h of s)vr(h.ver,r)>0||vr(h.ver,e)<=0||m.push(h.body);return m.join(`

`).trim()}a(fn,"extractChangelogRange");function xn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(xn,"ensureUpdateToastStyles");function Cs(t){let e=String(t||"").replace(/\r\n/g,`
...
`),i=[],s=!1,l=a(()=>{s&&(i.push("</ul>"),s=!1)},"closeList");for(let m=0;m<o.length;m++){let k=o[m].replace(/\s+$/,"");if(!k.trim()){l();continue}let $=k.match(/^(#{2,3})\s+(.+)$/);if($){l();let z=$[1].length,D=$[2];i.push(z===2?`<h2>${r(D)}</h2>`:`<h3>${r(D)}</h3>`);continue}let B=k.match(/^[-*]\s+(.+)$/);if(B){s||(i.push("<ul>"),s=!0),i.push(`<li>${r(B[1])}</li>`);continue}l(),i.push(`<p>${r(k)}</p>`)}return l(),i.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(Cs,"renderChangelogMarkdown");function yn(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(yn,"hideUpdateToast");function Ps(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="background-color"&&i.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(Ps,"hideChangelogModal");function vn(t,e){xn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,r.addEventListener("click",o=>{(o.target===r||o.target&&o.target.getAttribute&&o.target.getAttribute("data-close")==="1")&&Ps(r)}),document.documentElement.appendChild(r)),r.querySelector("h3").textContent=t||"更新日志",r.querySelector(".uuc-body").innerHTML=e||'<p class="uuc-meta">暂无更新日志</p>',r.__closing=!1,r.classList.remove("open","closing"),r.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add("open"))})}a(vn,"openChangelogModal");function ja(t){xn();let e=document.getElementById("urppp-update-toast");e||(e=document.createElement("div"),e.id="urppp-update-toast",e.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>yn(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let i=o.getAttribute("data-act"),s=e.__pack||{};if(i==="later"){yn(e);return}if(i==="go"){let l=s.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(i==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=s.changelogMd;l||(l=await Fa(n.sourceUrls("CHANGELOG.md")),s.changelogMd=l);let m=fn(l,s.local,s.remote),h=m?Cs(m):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';vn("更新日志 "+s.local+" → "+s.remote,h)}catch(l){vn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(ja,"showUpdateToast");async function Oa(){if(ha()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await Da();t&&t.status==="update"&&ja(t);let e=await zs();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Oa,"maybeAutoCheckUpdate");function zs(){let t=(window.__urpppUpdateCheckers||He||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?_t.update("assist"):null).catch(()=>null)}a(zs,"hotUpdateAssist");async function Ha(){if(Ba)return;Ba=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Se("正在从多源检查更新…");try{let e=[Da()];(He||[]).forEach(h=>{h&&typeof h.check=="function"&&e.push(Promise.resolve().then(()=>h.check()).then(k=>k||{id:h.id||"extra",name:h.name||"扩展",status:"err",message:"无结果"}).catch(k=>({id:h.id||"extra",name:h.name||"扩展",status:"err",message:String(k&&k.message||k)})))});let r=await Promise.all(e),o=r.map(h=>{if(!h)return"";if(h.status==="err")return`• <b>${at(h.name||h.id)}</b>：检查失败（${at(h.message||"unknown")}）`;if(h.status==="update"){let k="";if(h.id==="assist"&&_t&&_t.loaded("assist"))k=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let $=h.updateUrl?` <a href="${at(h.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",B=h.pageUrl?` <a href="${at(h.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";k=$+B}return`• <b>${at(h.name)}</b>：发现新版本 <b>${at(h.remote)}</b>（当前 ${at(h.local)}）${k}`}return h.status==="ahead"?`• <b>${at(h.name)}</b>：本地 ${at(h.local)} 新于远程 ${at(h.remote)}`:`• <b>${at(h.name)}</b>：已是最新（${at(h.local)}）`}).filter(Boolean),i=r.some(h=>h&&h.status==="update"),s=r.some(h=>h&&h.status==="err");Se(`${i?"检查完成：发现更新":s?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,s?"err":"ok");let m=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');m&&m.addEventListener("click",()=>{try{Se("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{Se("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(h=>{Se("重新装载失败："+(h&&h.message?h.message:h),"err")})}catch(h){Se("重新装载失败："+(h&&h.message?h.message:h),"err")}})}catch(e){Se("检查失败："+at(e&&e.message||e),"err")}finally{Ba=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(Ha,"checkForUpdates");function wn(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+p,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(wn,"refreshUpdateStatusHint");function Ls(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=He.findIndex(i=>i&&i.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?He[r]=o:He.push(o);try{let i=document.getElementById("urppp-set-update-status");i&&o.localVersion&&e==="assist"&&i.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{wn()}catch{}return!0}a(Ls,"registerUpdateChecker");function qs(){let t={version:p,urls:n,check:Ha,checkMain:Da,registerChecker:Ls,compareVersions:vr,parseUserscriptVersion:no,extractChangelogRange:fn,showUpdateToast:ja,maybeAutoCheckUpdate:Oa,listCheckers:a(()=>He.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(qs,"publishUpdateApi"),qs();let{rebuildSidebarCompletely:kn,syncMobileContentOffset:Re,syncSidebarUnderNavbar:_e}=Ni({}),{rebuildDashboard:Ts}=Ei({deps:{statCardPrivacyMarkup:Bs}}),$s="urppp-clean-open",Ra={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ie(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ie,"isUnevaluatedScore");function Or(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Or,"isValidOfficialGpa");function Hr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Hr,"firstContentChar");function Ua(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Ua,"weekBitmapActive");function Ue(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ie(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Ra[o]!=null?Ra[o]:Ra[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ue,"scoreToGpa");function We(t){let e=String(t||"").trim();if(!e||ie(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(We,"scoreToNumber");function Ee(t){return Math.round((Number(t)||0)*100)/100}a(Ee,"round2");function An(t){return/必修/.test(String(t||""))}a(An,"isRequiredAttr");function re(t){let e=0,r=0,o=0,i=0,s=0,l=0,m=0,h=0;return(t||[]).forEach(k=>{if(k&&(k.unevaluated||ie(k.score)))return;let $=Number(k.credit)||0,B=We(k.score),z=Or(k.officialGpa)?Number(k.officialGpa):Ue(k.score);B==null||$<=0||(e+=$,r+=B*$,z!=null&&(o+=z*$,i+=$),k.required&&(s+=$,l+=B*$,z!=null&&(m+=z*$,h+=$)))}),{totalCredit:Ee(e),avgScore:Ee(e?r/e:0),avgGpa:Ee(i?o/i:0),requiredCredit:Ee(s),requiredGpa:Ee(h?m/h:0),requiredAvg:Ee(s?l/s:0),count:(t||[]).length}}a(re,"summarizeCourses");function Wa(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Wa,"absUrl");function Vt(t,e){let r=Wa(t),o=e&&e.method||"GET",i=e&&e.data||null;return new Promise((s,l)=>{let m=a((h,k)=>h?s(k):l(new Error(k||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:i||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(h=>{h.status>=200&&h.status<400?m(!0,h.responseText||""):m(!1,"HTTP "+h.status)},"onload"),onerror:a(()=>m(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:i||void 0}).then(h=>{if(!h.ok)throw new Error("HTTP "+h.status);return h.text()}).then(h=>m(!0,h)).catch(h=>m(!1,h&&h.message))})}a(Vt,"fetchText");function Rr(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Rr,"parseHtml");function Sn(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=ti,(document.head||document.documentElement).appendChild(t)}a(Sn,"ensureFeatureStyles");function Ms(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=ai,(document.head||document.documentElement).appendChild(t)}a(Ms,"ensureScheduleExportStyles");function Is(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=oi,(document.head||document.documentElement).appendChild(t)}a(Is,"ensureSettingsStyles");function _n(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let i=r.cloneNode(!0);i.querySelectorAll("small, i, img, b, .badge").forEach(m=>m.remove());let s=(i.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(m=>{m.nodeType===Node.TEXT_NODE&&m.textContent.trim()&&m.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=s||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(_n,"ensureNavNameTarget");function Ur(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Ur,"classifyPrivacyLabel");function Ns(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(Ns,"classifyHomeDataKey");function Wr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Wr,"homePrivateValueSpan");function Bs(t,e){let r=at(t),o=at(e),i=Ns(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[i]||Ur(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:Wr("organization",i,o)}:{valueHtml:Wr("organization",i,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let m=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&m){let k=m.index||0,$=String(e).slice(0,k),B=String(e).slice(k+m[0].length);return{valueHtml:r,labelHtml:`${at($)}${Wr(l,i,at(m[0]))}${at(B)}`}}return{valueHtml:Wr(l,i,r),labelHtml:o}}a(Bs,"statCardPrivacyMarkup");function Ce(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||Sr;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||Sr)}a(Ce,"privacyReplacement");function ur(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(ur,"markPrivateText");function En(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||Sr);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(En,"markPrivateAvatar");function Fs(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(Fs,"markPrivateBlock");function Ds(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(Ds,"markDirectEditable");let fe=null;function Cn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;fe&&fe.__finish&&fe.__finish(!1);let r=ke();if(r.mode!=="custom"||!r.directEdit.enabled)return;let i=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),s=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),m=s.height>=8||!l?s:{left:s.left,top:l.top,width:Math.max(s.width,40),height:l.height},h=document.createElement("input"),k=getComputedStyle(t),$=Math.min(Math.max(m.width+64,140),Math.max(140,window.innerWidth-24)),B=Math.min(Math.max(12,m.left),Math.max(12,window.innerWidth-$-12)),z=Math.min(Math.max(12,m.top+(m.height-36)/2),Math.max(12,window.innerHeight-48));h.type="text",h.maxLength=80,h.className="urppp-direct-edit-input",h.value=i,h.setAttribute("aria-label","修改"+U[e]+"显示值"),h.style.left=B+"px",h.style.top=z+"px",h.style.setProperty("--urppp-direct-edit-width",$+"px"),h.style.fontFamily=k.fontFamily,h.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(k.fontSize)||14)))+"px";let D=!1,J=a(j=>{if(D||(D=!0,h.remove(),fe===h&&(fe=null),j))return;let R=ke();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(h.value||"").trim().slice(0,80),ba(R),Yt(document),Qa(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");h.__finish=J,h.addEventListener("click",j=>j.stopPropagation()),h.addEventListener("blur",()=>J(!1)),h.addEventListener("keydown",j=>{j.key==="Enter"&&(j.preventDefault(),J(!1)),j.key==="Escape"&&(j.preventDefault(),J(!0))}),document.documentElement.appendChild(h),fe=h,h.focus(),h.select()}a(Cn,"openDirectEditInput");function js(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Cn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),Cn(e))},!0))}a(js,"bindDirectEditInteraction");function Os(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(Os,"clearPrivacyDisplay");function Pn(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(Pn,"applyCustomText");function Hs(t){let e=t&&t.querySelectorAll?t:document,r=Me(),i=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?_n(e):null);Pn(i,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(m=>{let h=m.querySelector(".profile-info-name"),k=m.querySelector(".profile-info-value");!h||!k||String(h.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||Pn(k,r.nameEnabled,r.name)});let s=rr(r.avatar),l=r.avatarEnabled&&!!s;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(m=>{let h=m.getAttribute("src")||"";h&&h!==m.__urpppAppliedCustomSrc&&(m.__urpppOriginalSrc=h),l?(m.__urpppOriginalSrc==null&&(m.__urpppOriginalSrc=h),h!==s&&m.setAttribute("src",s),m.__urpppAppliedCustomSrc=s):m.__urpppAppliedCustomSrc!=null&&(m.__urpppOriginalSrc&&m.setAttribute("src",m.__urpppOriginalSrc),delete m.__urpppAppliedCustomSrc)})}a(Hs,"applyCustomIdentityDisplay");function Rs(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),i=r.querySelector(".profile-info-value, td:last-child");if(!o||!i||o===i)return;let s=Ur(o.textContent),l=Ce(e,s);l&&ur(i,l)})}a(Rs,"applyProfilePrivacy");function Us(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let i=o.map(s=>{let l=Ur(s.textContent);return["grade","gpa","credit"].includes(l)?l:""});i.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(s=>{let l=s.querySelectorAll("td");i.forEach((m,h)=>{let k=Ce(e,m);m&&k&&ur(l[h],k)})})})}a(Us,"applyScoreTablePrivacy");function Ws(t){let e=t&&t.querySelectorAll?t:document,r=ke();if(r.mode==="off")return;let o=Ce(r,"name"),i=Ce(r,"avatar"),s=Ce(r,"schedule"),l=o?_n(e):e.querySelector?.(".urppp-user-name-value");o&&ur(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([k,$])=>{let B=Ce(r,$);B&&e.querySelectorAll(k).forEach(z=>ur(z,B))}),Us(e,r);let h=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(k=>{let $=k.getAttribute("data-urppp-private"),B=k.getAttribute("data-urppp-edit-key"),D=(h&&B?String(r.directEdit.values[B]||"").trim():"")||Ce(r,$);!["avatar","schedule"].includes($)&&D&&ur(k,D),h&&B&&Ds(k,B)}),h&&js(),Rs(e,r),i&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(k=>{let $=k.matches("img")?k:k.querySelector("img");$?En($,i):(k.classList.add("urppp-private-avatar-block"),k.setAttribute("data-urppp-private-mask",i))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(k=>En(k,i))),s){let k=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));k.filter($=>!k.some(B=>B!==$&&B.contains($))).forEach($=>Fs($,s))}}a(Ws,"applyPrivacyDisplay");let Ga=0,se=[];function zn(){let t=ke(),e=Me();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(zn,"personalDisplayIsEnabled");function Gs(){se=se.filter(({root:t})=>t&&t.isConnected),se.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(Gs,"resumePersonalDisplayObservers");function Yt(t){let e=t||document;se.forEach(({observer:r})=>r.disconnect());try{Sn()}catch{}try{Os(e)}catch{}try{Hs(e)}catch(r){console.warn("[URP++] custom identity",r)}try{Ws(e)}catch(r){console.warn("[URP++] privacy",r)}zn()?(Gs(),Vs()):(clearTimeout(Ga),se=[])}a(Yt,"applyPersonalDisplay");function Js(t){clearTimeout(Ga),Ga=setTimeout(()=>Yt(t||document),140)}a(Js,"schedulePersonalDisplay");function Ja(){try{nt&&nt.open&&Ke()}catch{}}a(Ja,"refreshCleanPersonalDisplay");function Vs(){if(!zn()){se.forEach(({observer:t})=>t.disconnect()),se=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(se.some(r=>r.root===t))return;let e=new MutationObserver(()=>Js(document));se.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(Vs,"bindPersonalDisplayObservers");function Ys(t){let e=Object.assign({},t||{}),r=Me();r.nameEnabled&&r.name&&(e.name=r.name);let o=rr(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(Ys,"personalizedProfile");let Ln="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",Qs="/student/courseSelect/thisSemesterCurriculum/callback",Ks="/student/courseSelect/thisSemesterCurriculum/index";async function Xs(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Vt(Qs),r=JSON.parse(e),o=er(r);if(o)return o}catch{}return""}a(Xs,"resolveSchedulePlanCode");async function qn(t){let e=await Xs(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Vt(Ln,r),i;try{i=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=er(i)),(!i.jcsjbs||!i.jcsjbs.length)&&e&&(i=JSON.parse(await Vt(Ln,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let s=$n(i,e,t);if(!s.courses.length)throw new Error("没有读取到可导出的课表数据");return s}a(qn,"loadScheduleExportData");function Va(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(Va,"safeScheduleFilename");function Ya(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(Ya,"downloadBlob");function Zs(t){let e=Xr(t),r=Lr(),o=r.enabled?ta(e,r.mapping):Zr(e),i=JSON.stringify(o,null,2)+`
`;return Ya(new Blob([i],{type:"application/json;charset=utf-8"}),Va(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(Zs,"exportScheduleJson");function Tn(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let i=Number(r[4]);if(i<1||i>30)return"";let s=so(new Date);return s.setDate(s.getDate()-(i-1)*7),Ar(s)}a(Tn,"deriveCurrentSemesterMonday");function $n(t,e,r){let o=e||er(t),i=Tn(o)||ga()[o]||"";return vp(t,o,r,{firstMonday:i})}a($n,"normalizeScheduleDataForPage");function tl(t){let e=t.semester.planCode,r=ga()[e],o=Tn(e);return o?(Ao(e,o),Promise.resolve(o)):tr(r)?Promise.resolve(r):new Promise((i,s)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||bp(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let m=a((h,k)=>{l.remove(),h?s(h):i(k)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>m(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let h=l.querySelector("input").value;tr(h)&&(Ao(e,h),m(null,h))}),l.addEventListener("click",h=>{h.target===l&&m(new Error("已取消导出"))})})}a(tl,"requestScheduleFirstMonday");async function el(t){let e=await tl(t),r=fp(t,e);return Ya(new Blob([r],{type:"text/calendar;charset=utf-8"}),Va(t.semester.label)+".ics"),xp(t)}a(el,"exportScheduleIcs");let rl={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function le(t,e,r){if(typeof document>"u")return Gt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let i=getComputedStyle(o).color;o.remove();let s=String(i||"").match(/[\d.]+/g)?.map(Number)||[];if(s.length>=3){let l=yr(s[0],s[1],s[2]),m=s.length>3?Math.max(0,Math.min(1,s[3])):1;return m<1?Bt(r||e,l,m):l}return Gt(i)||Gt(e)||"#000000"}a(le,"resolvedScheduleImageColor");function Mn(){let t=Jt(),e=Zt(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},i={bg:le("--bg",o.bg),surface:le(e==="neu"?"--neu-base":"--surface",o.surface),input:le("--input-bg",o.input),text:le("--text",o.text),secondary:le("--text-secondary",o.secondary),muted:le("--text-muted",o.muted),border:le("--border",o.border,le(e==="neu"?"--neu-base":"--surface",o.surface)),primary:le("--primary",o.primary)},s={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(rl[e]||e)+" · "+(Ct[t]&&Ct[t].name||t),colors:i,shape:s[e]||s.apple}}a(Mn,"currentScheduleImageTheme");function In(t,e){return zp(t,e||Mn())}a(In,"buildScheduleSvg");function al(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),i=URL.createObjectURL(o),s=new Image;s.onload=()=>{try{let m=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),h=document.createElement("canvas");h.width=Math.floor(t.width*m),h.height=Math.floor(t.height*m);let k=h.getContext("2d");k.scale(h.width/t.width,h.height/t.height),k.fillStyle=t.background||"#F8FAFC",k.fillRect(0,0,t.width,t.height),k.drawImage(s,0,0,t.width,t.height),h.toBlob($=>$?e($):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(i)}},s.onerror=()=>{URL.revokeObjectURL(i),r(new Error("课表图片渲染失败"))},s.src=i})}a(al,"svgToPngBlob");async function ol(t){let e=await al(In(t));Ya(e,Va(t.semester.label)+".png")}a(ol,"exportSchedulePng");function Qa(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(Qa,"showFeatureToast");let Ka=Lp({document,window,ensureStyles:Ms,loadData:qn,exportJson:Zs,exportIcs:el,exportPng:ol,showToast:Qa,nativePageUrl:Ks,navigate:a(t=>{location.href=t},"navigate"),logger:console});function nl(t,e,r,o){return Ka.run(t,e,r,o)}a(nl,"runScheduleExport");function pl(t){return Ka.createMenu(t)}a(pl,"createScheduleExportMenu");function il(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(il,"disposeNativePdfCapture");function sl(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let i=Qp(e);t.stage="ok",t.stageCards=i.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=i.target.querySelector("table")?i.target.querySelector("table").id:"none",il(i)}catch(i){t.stage="failed",t.stageError=i&&i.message||String(i)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(sl,"bindNativePdfDiagnose");function ll(t){return t?(sl(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await Zp(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:lr})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Qa("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(ll,"pagePdfExportHandler");function Xa(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Xa,"isPersonalSchedulePage");function cl(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(cl,"isScoreQueryPage");function Za(){if(!Xa())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let i=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),s=pl({source:"native",pdfHandler:ll(i)});if(s.id="urppp-native-schedule-export",i&&i.parentElement){i.__urpppNativeExportState||(i.__urpppNativeExportState={display:i.style.getPropertyValue("display"),displayPriority:i.style.getPropertyPriority("display"),ariaHidden:i.getAttribute("aria-hidden"),tabIndex:i.getAttribute("tabindex")}),i.setAttribute("data-urppp-native-export-source","1"),i.style.setProperty("display","none","important"),i.setAttribute("aria-hidden","true"),i.setAttribute("tabindex","-1"),i.parentElement.insertBefore(s,i.nextSibling);return}if(e)e.appendChild(s);else if(t)t.appendChild(s);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let m=document.createElement("div");m.className="urppp-export-fallback",m.appendChild(s),l.prepend(m)}}}a(Za,"patchNativeScheduleExport");let Ge=null,Gr=0;function to(){clearTimeout(Gr),Gr=0,Ge&&Ge.observer.disconnect(),Ge=null}a(to,"disconnectNativeScheduleExportObserver");function dl(){if(!Xa()){to();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ge&&Ge.root===t&&t.isConnected)return;to();let e=new MutationObserver(()=>{clearTimeout(Gr),Gr=setTimeout(()=>Za(),80)});e.observe(t,{childList:!0,subtree:!0}),Ge={root:t,observer:e}}a(dl,"bindNativeScheduleExportObserver");function Nn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(Nn,"restoreOptionalAttribute");function ul(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let i=o.__urpppNativeExportState;i&&(i.display?o.style.setProperty("display",i.display,i.displayPriority):o.style.removeProperty("display"),Nn(o,"aria-hidden",i.ariaHidden),Nn(o,"tabindex",i.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(ul,"removeNativeScheduleExport");let Bn=Mi({deps:{styles:li,loadScores:Kn,loadProfile:Fn,scoreToNumber:We,scoreToGpa:Ue,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),ml=sp([Qr({id:"schedule-export",matches:a(t=>Xa(t.location),"matches"),mount:a(()=>{Za(),dl()},"mount"),unmount:a(t=>{to(),ul(t?.lifecycleKey)},"unmount")}),Qr({id:"score-analysis",matches:a(t=>cl(t.location),"matches"),mount:a(()=>{try{Bn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Bn.unmount()}catch{}},"unmount")})]);function Jr(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return ml.refresh({document,location,window,lifecycleKey:t})}a(Jr,"refreshRouteFeatures");function hl(t){Ka.bindHosts(t)}a(hl,"bindScheduleExportHosts");function mr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(mr,"normalizeProfileValue");function Vr(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(i=>mr(i).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let i=0;i<o.length;i++){let s=o[i],l=s.querySelector(".profile-info-name, th, label"),m=s.querySelector(".profile-info-value, td:last-child");if(!l||!m||l===m)continue;let h=mr(l.textContent).replace(/[：:]/g,"");if(!r.some($=>h===$||h.endsWith($)))continue;let k=mr(m.textContent);if(k&&k!=="—"&&k!=="-")return k}return""}a(Vr,"readLabeledProfileValue");function Je(t){return mr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Je,"cleanMajorPlanName");function bl(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),i=mr(o);if(/主修必修GPA/.test(i)){let s=i.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||i.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(s){let l=Number(s[1]),m=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||m===0||l>0)&&(e.majorGpa=s[1])}}if(/主修为|培养方案/.test(i)){let s=i.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||i.match(/^(.{2,60}?)\s*主修为/)||i.match(/主修为\s*(.{2,60})$/),l=Je(s&&s[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let m=/培养方案|教学计划/.test(l);(!e.majorPlan||m)&&(e.majorPlan=l)}}}),e}a(bl,"extractAcademicOverview");async function Fn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let s=r.querySelector(".urppp-user-name-value"),l=s&&s.__urpppOriginalText;l&&(t.name=String(l).trim());let m=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),h=t.name?null:m.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!h){let k=r.cloneNode(!0);k.querySelectorAll("small, i, img, b, .badge").forEach(B=>B.remove());let $=(k.textContent||"").replace(/\s+/g," ").trim();$=$.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),h=$.match(/([\u4e00-\u9fa5·]{2,12})/)}h&&h[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(h[1])&&(t.name=h[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let i=bl(document);t.majorPlan=i.majorPlan,t.majorGpa=i.majorGpa}catch{}try{let r=await Vt("/student/rollManagement/rollInfo/index"),o=Rr(r),i=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Vr(o,["姓名"]),!t.name)){let h=i.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);h&&(t.name=h[1].trim())}let s=Vr(o,["主修方案名称"]),l=Vr(o,["专业"]);t.studentId=Vr(o,["学号"]),s?t.majorPlan=Je(s):!t.majorPlan&&l&&(t.majorPlan=Je(l));let m=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(m&&m.getAttribute("src")&&!t.avatar){let h=m.getAttribute("src");t.avatar=/^https?:/i.test(h)?h:Wa(h)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(Fn,"loadProfile");let Dn=["周日","周一","周二","周三","周四","周五","周六"];function eo(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(i=>{let s=String(i.id||"").match(/^(\d+)_(\d+)$/);if(!s)return;let l=parseInt(s[1],10),m=parseInt(s[2],10),h=l===7?0:l,k=i.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),$=k.length?k:[];if(!$.length&&(i.textContent||"").trim()){let B=(i.textContent||"").replace(/\s+/g," ").trim();B&&e.push({name:B.slice(0,40),teacher:"",place:"",week:"",day:h,section:m});return}$.forEach(B=>{let z=Array.from(B.querySelectorAll("p")).map(X=>(X.textContent||"").trim()).filter(Boolean),D=(B.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(B.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",j=z.find((X,ut)=>ut>0&&!/周|节/.test(X)&&X!==J)||"",R=z.find(X=>/周/.test(X))||"",F=String(D).replace(/_\d+\s*$/,"").trim();!F||F.length<2||e.push({name:F,teacher:String(j).trim(),place:String(J||"").trim(),week:String(R).trim(),day:h,section:m})})});let o=new Set;return e.filter(i=>{let s=[i.day,i.section,i.name,i.place].join("|");return o.has(s)?!1:(o.add(s),!0)})}a(eo,"parseScheduleFromDoc");let jn="urppp_term_week_v1";function Ve(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(jn,e)}catch{}return e}a(Ve,"rememberTermWeek");function hr(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(jn,0))||0;if(t>=1&&t<=30)return Ve(t)}catch{}return 0}a(hr,"readRememberedTermWeek");function br(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let i=e.match(r[o]);if(i){let s=parseInt(i[1],10);if(s>=1&&s<=30)return s}}return 0}a(br,"extractTermWeekFromText");function Pe(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let m=t[l],h=br(m.innerText||m.textContent||"")||br(m.innerHTML||"");if(h)return Ve(h)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=br(e);if(r)return Ve(r);let o=document.body&&document.body.innerText||"",i=br(o);if(i)return Ve(i);let s=hr();if(s)return s}catch{}return 0}a(Pe,"getCurrentWeekNumber");let Ye=null;function gl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(gl,"calTodayStr");function fl(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(i=>String(i).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(fl,"calAddDays");function gr(t){if(Ye)return Ye;let e=t||gl();return e>="2027-02-06"&&e<=fl("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(gr,"calVacation");function xl(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(xl,"festiveDecorHtml");function On(){let t=typeof document<"u"?document:null;if(!t)return;let e=gr()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",xl()):!e&&r&&r.remove()}a(On,"syncFestiveDecor");function Hn(t){Ye=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Ye&&Ye!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{On()}catch{}try{typeof Ke=="function"&&Ke()}catch{}return Ye}a(Hn,"setCalendarPhase");function yl(){return gr()}a(yl,"getCalendarPhase");function Rn(){if(gr()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=Pe()||hr()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(Rn,"getViewWeekNumber");async function vl(){let t=Pe();if(t>=1)return t;try{let e=await Vt("/index");if(t=br(e),t)return Ve(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),i=await Vt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),s=JSON.parse(i),l=Number(s&&s.jxzc);if(l>=1&&l<=30)return Ve(l)}catch{}return hr()||0}a(vl,"ensureTermWeekResolved");function wl(t){let e=Pe()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let i=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);i&&(e=Math.max(e,parseInt(i[2],10)||0));let s=String(r.week||"").match(/\d{1,2}/g);s&&s.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(wl,"inferMaxWeek");function Un(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Un,"weekBitActive");let Wn=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function Gn(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return Wn[e%Wn.length]}a(Gn,"courseColor");function kl(t){let e=[],r=Pe();(t&&t.xkxx||[]).forEach(s=>{Object.keys(s||{}).forEach(l=>{let m=s[l];if(!m)return;let h=m.courseName||m.englishCourseName||l,k=m.attendClassTeacher||"";(m.timeAndPlaceList||[]).forEach(B=>{let z=Number(B.classDay)||0,D=z===7?0:z,J=Number(B.classSessions)||1,j=Math.max(1,Number(B.continuingSession)||1),R=[B.campusName,B.teachingBuildingName,B.classroomName].filter(Boolean).join(""),F=B.weekDescription||m.skzcs||"",X=Un(B.classWeek,r)||r&&F.indexOf(String(r))>=0;e.push({name:String(h).trim(),teacher:String(k).trim(),place:String(R).trim(),week:String(F).trim(),classWeek:String(B.classWeek||""),day:D,section:J,span:j,thisWeek:!!X,color:Gn(h)})})})});let i=new Set;return e.filter(s=>{let l=[s.day,s.section,s.span,s.name,s.place,s.week].join("|");return i.has(l)?!1:(i.add(l),!0)})}a(kl,"parseScheduleFromJson");async function Al(){try{let t=await Vt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let i=Number(r&&(r.jxzc||r.zc||r.currentWeek));i>=1&&i<=30&&(nt._termWeek=Math.max(nt._termWeek||0,i),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=kl(r)}catch{e=eo(Rr(t))}e.length||(e=eo(document));let o=r?$n(r,er(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=eo(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(Al,"loadSchedule");function Sl(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),i=r.match(o);if(i&&i[1])return i[1];let s=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(s);return l?l[1]:""}a(Sl,"extractScoreCallback");function _l(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let i=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",s=[];(o.cjList||[]).forEach(l=>{let m=l.courseName||l.englishCourseName||"";if(!m)return;let h=l.cj!=null&&l.cj!==""?String(l.cj):"";!h&&l.courseScore!=null&&(h=String(l.courseScore)),!h&&l.gradeName&&(h=String(l.gradeName)),!h&&l.zscj!=null&&(h=String(l.zscj));let k=l.courseAttributeName||l.xkcsxmc||"",$=parseFloat(l.credit)||0,B=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",D=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ie(h)||ie(l.gradeName)||D!=null&&D<0,j=J?"未评估":h;s.push({code:B,seq:String(z||""),name:m,attr:k,credit:$,score:j,unevaluated:J,required:An(k),officialGpa:Or(D)?D:null,evalUrl:""})}),s.length&&e.push({title:String(i).slice(0,100),courses:s,summary:re(s),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(_l,"parseScoreJson");async function Jn(t,e){let r=await Vt(t),o=Vn(Rr(r));if(o.length)return o;let i=Sl(r,e);if(!i)return[];let s=await Vt(i);try{let l=JSON.parse(s);o=_l(l).map(m=>(m.summary=re(m.courses),m))}catch{o=Vn(Rr(s))}return o}a(Jn,"loadScoreByIndex");function Vn(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map($=>($.textContent||"").replace(/\s+/g,""));if(!o.length)return;let i=o.join("|");if(!/课程名/.test(i)||!/成绩/.test(i))return;let s={code:o.findIndex($=>$==="课程号"),name:o.findIndex($=>$==="课程名"),attr:o.findIndex($=>/课程属性|属性/.test($)),credit:o.findIndex($=>$==="学分"),score:o.findIndex($=>$==="成绩")};if(s.name<0||s.score<0)return;let l="成绩",m=r.previousElementSibling;for(let $=0;$<8&&m;$++,m=m.previousElementSibling)if(/^H[1-4]$/.test(m.tagName)||m.classList&&m.classList.contains("header")){l=(m.textContent||"").replace(/\s+/g," ").trim();break}let h=[],k=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(k).forEach($=>{let B=Array.from($.cells||$.querySelectorAll("td"));if(B.length<4)return;let z=a(F=>F>=0&&B[F]?(B[F].textContent||"").replace(/\s+/g," ").trim():"","get"),D=z(s.name),J=z(s.score);if(!D||!J||/课程名|序号/.test(D))return;let j=z(s.attr),R=ie(J);h.push({code:z(s.code),name:D,attr:j,credit:parseFloat(z(s.credit))||0,score:R?"未评估":J,unevaluated:R,required:An(j),officialGpa:null,evalUrl:""})}),h.length&&e.push({title:l.slice(0,100),courses:h,summary:re(h)})}),e}a(Vn,"parseScoreTables");function fr(t){return Je(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(fr,"schemePlanName");function Yn(t,e){if(!t||!t.length)return 0;let r=Je(e),o=t.findIndex(l=>{let m=fr(l);return/培养方案/.test(m)&&!/微专业|辅修|双学位/.test(m)});if(o>=0&&(!r||fr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let m=fr(l);return m.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(m.slice(0,4))||m.includes(r.slice(0,4))}),o>=0))return o;let i=0,s=-1;return t.forEach((l,m)=>{if(/微专业|辅修/.test(fr(l)))return;let h=(l.courses||[]).length;h>s&&(s=h,i=m)}),i}a(Yn,"pickMajorSchemeIndex");async function El(){let t={};try{let e=await Vt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(i=>{let s=String(i.KCH||"").trim();if(!s)return;let l=String(i.SFPG)==="1",m=String(i.KTID||"").trim();if(!t[s]){t[s]={ktid:m,kxh:String(i.KXH||""),kcm:i.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&m?"/student/teachingEvaluation/newEvaluation/evaluation/"+m:"/student/teachingEvaluation/newEvaluation/index"};return}t[s].total+=1,l||(t[s].pending+=1,t[s].done=!1,m&&(t[s].ktid=m,t[s].url="/student/teachingEvaluation/newEvaluation/evaluation/"+m))}),Object.keys(t).forEach(i=>{let s=t[i];s.done=!(s.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(El,"loadEvaluationMap");function Cl(t){if(!t)return!1;if(t.officialGpa!=null&&Or(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ie(e)?!1:We(e)!=null||Ue(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(Cl,"hasDisplayableScore");function Pl(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(i=>{if(!i||!i.code)return;let s=e[i.code];if(s){if(Cl(i)){i.unevaluated=!1,s.done?i.evalUrl=i.evalUrl||"":i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index";return}s.done||(i.unevaluated=!0,i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index",(!i.score||i.score===""||ie(i.score))&&(i.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(Pl,"attachEvaluationLinks");function Qn(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=re(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=re(e.courses),e)),t)}a(Qn,"refreshScoreSummaries");async function zl(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await El();return Pl(t,e),t.evalMap=e,t.evaluationReady=!0,Qn(t)}finally{t.evaluationLoading=!1}}a(zl,"enrichScoresWithEvaluation");function Ll(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=Yn(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let i=fr(o),s=Je(nt.profile.majorPlan);/培养方案|教学计划/.test(i)&&(!/培养方案|教学计划/.test(s)||s==="主修方案")&&(nt.profile.majorPlan=i);let l=o.summary||{},m=Number(l.requiredCredit),h=Number(l.requiredGpa),k=Number(nt.profile.majorGpa);m>0&&Number.isFinite(h)&&h>=0&&h<=5&&(!Number.isFinite(k)||k<=0)&&(nt.profile.majorGpa=String(Ee(h)))}a(Ll,"reconcileProfileAndScores");let Qe=null;async function Kn(t){return t&&(Qe=null),Qe&&!Qe.error||(Qe=await ql()),Qe}a(Kn,"loadScores");async function ql(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([Jn("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),Jn("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(i=>i.courses.forEach(s=>{o.push(Object.assign({term:i.title},s))})),t.passing=[{title:"全部及格成绩",courses:o,summary:re(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:re(o)}]),Qn(t),t.majorIdx=Yn(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(ql,"loadScoresImpl");function ze(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(ze,"parseJsonArrayLoose");function Xn(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let i=0;for(let s=o;s<t.length&&s<o+3e5;s++){let l=t[s];if(l==="[")i++;else if(l==="]"&&(i--,i===0))return t.slice(o,s+1)}return""}a(Xn,"extractBalancedArray");async function Tl(){let t=await Vt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let s=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(s&&(e=ze(s)),l&&(r=ze(l)),!e.length){let m=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);m&&(e=ze(m[1]))}if(!r.length){let m=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);m&&(r=ze(m[1]))}if(!r.length){let m=Xn(t,"teachingBuildingName");m&&(r=ze(m))}if(!e.length){let m=Xn(t,"campusName");m&&(e=ze(m))}}catch(s){console.warn("[URP++] classroom json parse",s)}if(!r.length){let s=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=s;let l=[];for(let m of s)try{let h=await Vt("/student/teachingResources/classroomCurriculum/"+m.campusNumber+"/teachingBuildingJson");ze(h).forEach($=>{l.push({id:{campusNumber:m.campusNumber,teachingBuildingNumber:String($.id&&$.id.teachingBuildingNumber||$.teachingBuildingNumber||"")},teachingBuildingName:$.teachingBuildingName||$.name||""})})}catch(h){console.warn("[URP++] building json",m.campusNumber,h)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(s=>({campus:s.campusName||s.campusNumber,campusNumber:String(s.campusNumber||s.id&&s.id.campusNumber||""),buildings:[]}));r.forEach(s=>{let l=String(s.id&&s.id.campusNumber||s.campusNumber||""),m=String(s.id&&s.id.teachingBuildingNumber||s.teachingBuildingNumber||""),h=s.teachingBuildingName||s.name||m;if(!l||!m||!h)return;let k=o.find(B=>B.campusNumber===l);k||(k={campus:l,campusNumber:l,buildings:[]},o.push(k));let $="/student/teachingResources/classroomUseStatus/"+l+"/"+m+"/"+encodeURI(encodeURI(k.campus||l))+"/"+encodeURI(encodeURI(h));k.buildings.push({name:h,path:$,campusNumber:l,buildingNumber:m})});let i=o.filter(s=>s.buildings.length);if(!i.length)throw new Error("未解析到教学楼，请刷新后重试");return i}a(Tl,"loadClassroomCatalog");function xr(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(xr,"occupancyTypeLabel");function $l(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return xr(t)}a($l,"occupancyReason");async function Ml(t,e,r,o){let i=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),s=await Vt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+i.toString());try{let l=JSON.parse(s);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(m=>m&&typeof m=="object"&&(m.kcm||m.id&&m.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(Ml,"fetchClassroomCurriculum");function Il(t,e,r){let o=t||[],i=Number(e.xq)||0,s=Number(e.start)||0,l=Number(r)||0,m=[];return o.forEach(h=>{let k=h.id||{},$=Number(k.skxq!=null?k.skxq:h.skxq)||0,B=Number(k.skjc!=null?k.skjc:h.skjc)||0,z=Math.max(1,Number(h.cxjc)||1),D=k.skzc||h.skzc||"";i&&$&&i!==$||s&&(s<B||s>=B+z)||l&&D&&!Ua(D,l)||m.push(h)}),m.length?(m.sort((h,k)=>{let $=Ua(h.id&&h.id.skzc||h.skzc,l)?0:1,B=Ua(k.id&&k.id.skzc||k.skzc,l)?0:1;return $-B}),m[0]):null}a(Il,"matchCurriculumCourse");async function Nl(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),i=String(e.buildingNumber||""),s=r||t.planNumber||"";if(!o||!i||!s)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(D=>D.busy)),m={},h=a(async z=>{if(m[z])return m[z];try{m[z]=await Ml(s,o,i,z)}catch{m[z]=[]}return m[z]},"queue"),k=4,$=0,B=new Array(Math.min(k,Math.max(l.length,1))).fill(0).map(async()=>{for(;$<l.length;){let z=$++,D=l[z],J=await h(D.name);(D.slots||[]).forEach(j=>{if(!j.busy)return;let R={xq:j.detail&&j.detail.xq||j.xq||0,start:j.section,week:t.jxzc};j.detail&&j.detail.xq!=null&&(R.xq=j.detail.xq);let F=Il(J,R,t.jxzc);if(F&&F.kcm){let X=String(F.kcm).trim();j.contentName=X,j.reason=X,j.displayChar=Hr(X),j.detail&&(j.detail.contentName=X,j.detail.reason=X,j.detail.teacher=F.jsm||"",j.detail.weeks=F.zcsm||"",j.detail.courseNo=F.id&&F.id.kch||"",j.detail.typeLabel=xr({occupancymoduleId:j.module}))}else j.displayChar=Hr(j.reason||"占用"),j.detail&&(j.detail.typeLabel=xr({occupancymoduleId:j.module}))})}});return await Promise.all(B),t}a(Nl,"enrichOccupancyWithCurriculum");function Bl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(Bl,"occupancyKindClass");async function Fl(t){let e="",r="",o="",i="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",i=t.path||"";else{i=String(t||"");let F=i.match(/classroomUseStatus\/(\d+)\/(\d+)\//);F&&(e=F[1],r=F[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let s=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=Dl(Zn(new Date,s)),m="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),h=await new Promise((F,X)=>{let ut=Wa("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:m,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?F(vt.responseText||""):X(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>X(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:m}).then(vt=>vt.text()).then(F).catch(X)}),k;try{k=JSON.parse(h)}catch{throw new Error("jasInfo 非 JSON")}let $=(k.classrooms||[]).map(F=>{let X=F.classroomName||F.id&&F.id.classroomNumber||"",ut=F.placeNum||"",vt=F.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:X,seats:ut,type:vt,slots:Et,map:{}}}),B={};$.forEach(F=>{B[F.name]=F}),(k.classroomTime||[]).forEach(F=>{let X=F.id||{},ut=X.classroomNumber||"",vt=Number(X.sessionstart)||1,Et=Math.max(1,Number(F.continuingsession)||1),Lt=B[ut];if(!Lt)return;let qt=xr(F),Ot=$l(F);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let $t=Lt.slots.find(ae=>ae.section===Ht);$t&&($t.busy=!0,$t.kind=F.timestatenumber||F.occupancymoduleId||"",$t.module=F.occupancymoduleId||"",$t.reason=Ot,$t.typeLabel=qt,$t.displayChar=Hr(Ot),$t.xq=X.xq,$t.weekBitmap=X.week||"",$t.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:X.week||"",xq:X.xq||"",state:F.timestatenumber||"",module:F.occupancymoduleId||""})}});let z="";try{let F=k.jhZxjxjhb;typeof F=="string"&&/\d{4}-\d{4}-\d-\d/.test(F)?z=F:F&&typeof F=="object"&&(z=String(F.zxjxjhh||F.jhxnxq||F.executiveEducationPlanNumber||F.planNumber||""))}catch{}if(!z&&k.classrooms&&k.classrooms[0]&&k.classrooms[0].id&&(z=k.classrooms[0].id.executiveEducationPlanNumber||""),k.jxzc!=null&&Number(k.jxzc)>=1){let F=Number(k.jxzc);nt._termWeek=Math.max(nt._termWeek||0,F),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let D=["日","一","二","三","四","五","六"],J=jl(k.date||l)||Zn(new Date,s),j=k.week!=null?Number(k.week):J.getDay(),R=s===1?"明天":s===2?"后天":"今天";return{rooms:$,dateLabel:(k.date||l)+"（周"+(D[j]||j)+" · "+R+"）",jxzc:k.jxzc,planNumber:z,week:k.week!=null?k.week:j,searchDate:k.date||l,dateOffset:s}}a(Fl,"loadBuildingOccupancy");function Zn(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(Zn,"addDays");function Dl(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(Dl,"formatLocalDate");function jl(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(jl,"parseLocalDate");let tp={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function ep(t){return tp[t]||tp.more}a(ep,"ico");let nt=di();function Ol(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=ii,(document.head||document.documentElement).appendChild(t)}a(Ol,"ensureStyle");let Hl=ia({deps:{scoreToNumber:We,scoreToGpa:Ue}}),{metricHtml:Rl,occupancyHtml:Ul,render:Ke,renderScheduleBoard:Dc,roomPickerHtml:Wl,scheduleRender:Gl}=Ai({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:Dn,analyzeScores:a(t=>Hl.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Yt,bandsChartSvg:la,bindUI:a(t=>Vl(t),"bindUI"),classifyPrivacyLabel:Ur,courseColor:Gn,ensureRoot:a(()=>ap(),"ensureRoot"),escapeHtml:at,firstContentChar:Hr,getViewWeekNumber:Rn,ico:ep,isCleanAnalysisDirect:ma,occupancyKindClass:Bl,occupancyTypeLabel:xr,personalizedProfile:Ys,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:We,summarizeCourses:re,trendChartSvg:sa,weekBitActive:Un,calVacation:gr,setCalendarPhase:Hn}}),{ensureRoomCatalogLoaded:rp,loadAll:Jl}=mi({state:nt,deps:{ensureTermWeekResolved:vl,enrichScoresWithEvaluation:zl,getCurrentWeekNumber:Pe,loadClassroomCatalog:Tl,loadProfile:Fn,loadSchedule:Al,loadScores:Kn,readRememberedTermWeek:hr,reconcileProfileAndScores:Ll,render:Ke,scheduleRender:Gl}}),{bindUI:Vl,closeModal:Yl,getRoomHost:jc,openModal:Oc,openRoomModal:Hc,openScoreModal:Rc,showBuilding:Uc}=Si({state:nt,deps:{DAY_NAMES:Dn,applyPersonalDisplay:Yt,bindScheduleExportHosts:hl,closeCleanMode:a(()=>Kl(),"closeCleanMode"),ensureRoomCatalogLoaded:rp,enrichOccupancyWithCurriculum:Nl,ensureRoot:a(()=>ap(),"ensureRoot"),escapeHtml:at,fetchText:Vt,getCurrentWeekNumber:Pe,getViewWeekNumber:Rn,inferMaxWeek:wl,isUnevaluatedScore:ie,isValidOfficialGpa:Or,loadBuildingOccupancy:Fl,metricHtml:Rl,occupancyHtml:Ul,render:Ke,rootEl:a(()=>Xl(),"rootEl"),roomPickerHtml:Wl,scoreToGpa:Ue,scoreToNumber:We,summarizeCourses:re,summarizeCoursesPreferOfficial:re}}),{cleanModeApi:Ql,closeCleanMode:Kl,ensureRoot:ap,injectCleanEntry:Wc,openCleanMode:Gc,rootEl:Xl}=_i({state:nt,deps:{CLEAN_FLAG:$s,applySkinAttr:ee,closeModal:Yl,ensureRoomCatalogLoaded:rp,ensureStyle:Ol,getCurrentWeekNumber:Pe,getSkin:Zt,handleThemeDotClick:ct,ico:ep,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:_o,loadAll:Jl,openSettingsPanel:en,readRememberedTermWeek:hr,refreshCleanPersonalDisplay:Ja,render:Ke,scoreToGpa:Ue,summarizeCourses:re,syncNavbarThemeUI:ft,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=Ql;function ro(){if(!document.body){setTimeout(ro,10);return}if(Co(),Wt(Jt()),setTimeout(()=>{try{ge().then(e=>Oe(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],i=r.parentElement;for(;i;){let s=i.scrollTop,l=i.scrollLeft;(s||l||i.scrollHeight>i.clientHeight||i.scrollWidth>i.clientWidth)&&o.push({el:i,top:s,left:l}),i=i.parentElement}requestAnimationFrame(()=>{o.forEach(s=>{s.el.scrollTop=s.top,s.el.scrollLeft=s.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))$o();else{os();try{Sn()}catch{}try{Jr()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Yt(document)}catch{}try{On()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{Jr()}catch{}try{Yt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{ua()&&_o()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(ro,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(_e,50)}),window.addEventListener("load",()=>{_e(),Re(),setTimeout(_e,100),setTimeout(_e,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(Re,0),setTimeout(Re,50),setTimeout(Re,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(Re,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function op(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let i=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),s=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));i&&!s&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){_e(),kn(),st(),_e();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(s=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},s)),_a(),Ko(),Xo(),Ro(),Zo(),Qo(),Wo(),document.querySelectorAll(".page-content, #page-content-template").forEach(s=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);s.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),s.style.setProperty("box-sizing","border-box","important")}),$r(),Nr(),Fe(),setTimeout(Fe,300),setTimeout(Fe,1e3),Bo(),be(),ir(),jo(),setTimeout(ir,300),sr(),setTimeout(()=>sr(),500),Tr(),Do();try{Jr()}catch{}try{Yt(document)}catch{}setTimeout(()=>{try{Jr()}catch{}try{Yt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...i){let s=r.apply(this,i);return e(),s},history.replaceState=function(...i){let s=o.apply(this,i);return e(),s}}a(op,"watchRouteChanges");let Xe=typeof unsafeWindow<"u"?unsafeWindow:window;Xe.__urpppDebug=Xe.__urpppDebug||{},Xe.__urpppDebug.setCalendarPhase=t=>Hn(t),Xe.__urpppDebug.getCalendarPhase=()=>yl(),Xe.__urpppDebug.calVacation=t=>gr(t),Xe.urppp={version:p,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Wt(t)},"apply"),setAccent:Fi,getAccent:Qt,getCurrent:Jt,list:a(()=>Object.entries(Ct).map(([t,e])=>({name:t,displayName:e.name,current:t===Jt()})),"list")},update:{check:Ha,auto:Oa,showToast:ja},privacy:{get:ke,set(t){return ba(t),Yt(document),ke()},apply:a(()=>Yt(document),"apply"),identity:{get:Me,set(t){return ko(t),Yt(document),Ja(),Me()}}},scheduleExport:{load:a(()=>qn("api"),"load"),run:a(t=>nl(t,"api",null,null),"run"),patch:Za,image:{theme:Mn,build:a((t,e)=>In(t,e),"build")},jsonFormat:{get:Lr,set:So,validate:qe,build(t,e){let r=Xr(t);if(e)return ta(r,qe(e));let o=Lr();return o.enabled?ta(r,o.mapping):Zr(r)},buildDefault(t){return Zr(Xr(t))}}}};function np(){setTimeout(()=>{try{Oa()}catch{}},1800)}a(np,"scheduleAutoUpdateCheck");try{Co()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{ro(),op(),np()}):(ro(),op(),np())})();})();
