...
(()=>{var ec=Object.defineProperty;var a=(p,n)=>ec(p,"name",{value:n,configurable:!0});function er(p){let n=String(p).replace("#","").match(/^([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i);return n?{r:parseInt(n[1],16),g:parseInt(n[2],16),b:parseInt(n[3],16)}:{r:30,g:58,b:95}}a(er,"hexToRgb");function vr(p,n,c){return"#"+[p,n,c].map(d=>Math.max(0,Math.min(255,Math.round(d))).toString(16).padStart(2,"0")).join("")}a(vr,"rgbToHex");function Gt(p){let n=String(p||"").trim();return n?(n[0]!=="#"&&(n="#"+n),/^#[0-9a-fA-F]{6}$/.test(n)?n.toUpperCase():""):""}a(Gt,"normalizeHexColor");function oo(p,n){let{r:c,g:d,b:u}=er(p),A=1-n;return vr(c*A,d*A,u*A)}a(oo,"darken");function ye(p,n){let{r:c,g:d,b:u}=er(p);return`rgba(${c},${d},${u},${n})`}a(ye,"alpha");function Bt(p,n,c){let d=er(Gt(p)||"#FFFFFF"),u=er(Gt(n)||"#FFFFFF"),A=Math.max(0,Math.min(1,Number(c)||0));return vr(d.r+(u.r-d.r)*A,d.g+(u.g-d.g)*A,d.b+(u.b-d.b)*A)}a(Bt,"mixHex");function no(p,n){if(typeof p!="function")throw new TypeError(`${n} must be a function`)}a(no,"assertFunction");function Xr(p){if(!p||typeof p!="object")throw new TypeError("feature definition must be an object");let n=String(p.id||"").trim();if(!n)throw new TypeError("feature id is required");return no(p.matches,`${n}.matches`),no(p.mount,`${n}.mount`),no(p.unmount,`${n}.unmount`),Object.freeze({id:n,matches:p.matches,mount:p.mount,unmount:p.unmount})}a(Xr,"defineFeature");function cp(p){if(!Array.isArray(p))throw new TypeError("features must be an array");let n=p.map(Xr),c=new Set;n.forEach(_=>{if(c.has(_.id))throw new Error(`duplicate feature id: ${_.id}`);c.add(_.id)});let d=null,u=null;function A(){if(!d)return;let _=d,y=u;d=null,u=null,_.unmount(y)}a(A,"unmount");function P(_={}){let y=n.find(g=>g.matches(_));if(y&&d===y&&_.lifecycleKey!==void 0&&u?.lifecycleKey===_.lifecycleKey)try{return y.mount(_),u=_,y.id}catch(g){throw A(),g}if(A(),!y)return null;try{return y.mount(_),d=y,u=_,y.id}catch(g){try{y.unmount(_)}catch{}throw g}}return a(P,"refresh"),Object.freeze({refresh:P,unmount:A,getActiveFeatureId:a(()=>d?.id||null,"getActiveFeatureId"),listFeatureIds:a(()=>n.map(_=>_.id),"listFeatureIds")})}a(cp,"createFeatureRuntime");function at(p){return String(p||"").replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n])}a(at,"escapeHtml");function po(p){let n=String(p||"").match(/@version\s+([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)/i);return n?n[1]:""}a(po,"parseUserscriptVersion");function dp(p){return String(p||"0").replace(/^v/i,"").split(/[.+\-]/).filter(Boolean).map(n=>/^\d+$/.test(n)?parseInt(n,10):n)}a(dp,"normalizeVersionParts");function wr(p,n){let c=dp(p),d=dp(n),u=Math.max(c.length,d.length);for(let A=0;A<u;A+=1){let P=c[A]==null?0:c[A],_=d[A]==null?0:d[A];if(typeof P=="number"&&typeof _=="number"){if(P>_)return 1;if(P<_)return-1;continue}let g=String(P),k=String(_);if(g>k)return 1;if(g<k)return-1}return 0}a(wr,"compareVersions");var Ar={base:{},coursesPath:"courses",schedulePath:"schedule",courseFields:{name:"name",teacher:"teacher",position:"position",day:"day",sections:"sections",weeks:"weeks"},scheduleFields:{morningNum:"morningNum",afternoonNum:"afternoonNum",nightNum:"nightNum",sections:"sections"}},rc=["name","teacher","position","day","sections","weeks","code","sequence","englishName","attribute","category","credit","status","campus","building","classroom","startSection","endSection","weekList"],ac=["morningNum","afternoonNum","nightNum","sections","sectionList"];function so(p){return JSON.parse(JSON.stringify(p))}a(so,"cloneJsonValue");function bp(p,n){return p===n||p.startsWith(`${n}.`)||n.startsWith(`${p}.`)}a(bp,"scheduleJsonPathsOverlap");function Kr(p,n){let c=String(p??"").trim();if(!c){if(n)return"";throw new Error("课程数组输出路径不能为空")}if(c.length>120)throw new Error("JSON 输出路径不能超过 120 个字符");let d=c.split("."),u=new Set(["__proto__","prototype","constructor"]);if(d.some(P=>!P||/^\d+$/.test(P)||/[\[\]\x00-\x1f]/.test(P)||u.has(P)))throw new Error(`JSON 输出路径包含无效片段：${c}`);return d.join(".")}a(Kr,"validateScheduleJsonPath");function oc(p,n){for(let c=0;c<p.length;c+=1)for(let d=c+1;d<p.length;d+=1)if(bp(p[c],p[d]))throw new Error(`${n}目标路径不能重叠：${p[c]} / ${p[d]}`)}a(oc,"validateScheduleJsonTargetPaths");function up(p,n,c){let d=n.split("."),u=p;for(let A=0;A<d.length;A+=1){let P=d[A];if(!Object.prototype.hasOwnProperty.call(u,P))return;if(A===d.length-1)throw new Error(`${c}输出路径与 base 字段重叠：${n}`);if(u=u[P],!u||typeof u!="object"||Array.isArray(u)){let _=d.slice(0,A+1).join(".");throw new Error(`${c}输出路径无法穿过 base 中的非对象字段：${_}`)}}}a(up,"validateScheduleJsonBasePath");function mp(p,n,c){if(!p||typeof p!="object"||Array.isArray(p))throw new Error(`${c}字段映射必须是对象`);let d={};return Object.entries(p).forEach(([u,A])=>{if(!n.includes(u))throw new Error(`${c}不支持源字段：${u}`);let P=Kr(A,!0);P&&(d[u]=P)}),oc(Object.values(d),`${c}字段`),d}a(mp,"validateScheduleJsonFieldMap");function Me(p){if(!p||typeof p!="object"||Array.isArray(p))throw new Error("自定义 JSON 映射必须是对象");let n=p.base==null?{}:p.base;if(!n||typeof n!="object"||Array.isArray(n))throw new Error("base 必须是 JSON 对象");let c={base:so(n),coursesPath:Kr(p.coursesPath,!1),schedulePath:Kr(p.schedulePath,!0),courseFields:mp(p.courseFields,rc,"课程"),scheduleFields:mp(p.scheduleFields||{},ac,"时间表")};if(!Object.keys(c.courseFields).length)throw new Error("至少保留一个课程字段映射");if(c.schedulePath&&bp(c.schedulePath,c.coursesPath))throw new Error("课程与时间表输出路径不能重叠");return up(c.base,c.coursesPath,"课程"),c.schedulePath&&up(c.base,c.schedulePath,"时间表"),c}a(Me,"validateScheduleJsonMapping");function kr(p){let n=String(p||"").replace(/\D/g,"").padStart(4,"0").slice(-4),c=`${n.slice(0,2)}:${n.slice(2)}`;return/^(?:[01]\d|2[0-3]):[0-5]\d$/.test(c)?c:""}a(kr,"normalizeSectionTime");function io(p,n,c){let d=Kr(n,!1).split("."),u=p;d.forEach((A,P)=>{if(P===d.length-1){u[A]=c;return}(!u[A]||typeof u[A]!="object"||Array.isArray(u[A]))&&(u[A]={}),u=u[A]})}a(io,"setScheduleJsonPath");function hp(p,n){let c={};return Object.entries(n||{}).forEach(([d,u])=>{!Object.prototype.hasOwnProperty.call(p,d)||p[d]===void 0||io(c,u,so(p[d]))}),c}a(hp,"mappedScheduleJsonObject");function nc(p){return[p.campus,p.building,p.classroom].map(n=>String(n||"").trim()).filter(Boolean).join(" ")}a(nc,"scheduleJsonPosition");function pc(p){let n=Number(p.startSection)||0,c=Number(p.endSection)||n;return n<1||c<n?"":Array.from({length:c-n+1},(d,u)=>n+u).join(",")}a(pc,"scheduleJsonSectionString");function ic(p,n){let c=Number(n.day)||0,d=pc(n),u=Array.from(new Set((n.weeks||[]).map(Number).filter(A=>Number.isInteger(A)&&A>=1&&A<=60))).sort((A,P)=>A-P);return c<1||c>7||!d?{error:"invalid"}:u.length?{value:{name:p.name,teacher:p.teacher,position:nc(n),day:c,sections:d,weeks:u.join(","),code:p.code,sequence:p.sequence,englishName:p.englishName,attribute:p.attribute,category:p.category,credit:p.credit,status:p.status,campus:n.campus,building:n.building,classroom:n.classroom,startSection:n.startSection,endSection:n.endSection,weekList:u}}:{error:"weeks"}}a(ic,"scheduleJsonCourseRecord");function sc(p,n){let c=[];return p.courses.forEach(d=>{if(!d.arrangements.length){n.unscheduledCourses+=1;return}d.arrangements.forEach(u=>{let A=ic(d,u);A.error==="weeks"?n.missingWeeks+=1:A.error?n.invalidArrangements+=1:c.push(A.value)})}),c}a(sc,"buildScheduleJsonCourses");function lc(p){let n=new Map;return(p||[]).forEach(c=>{let d=Number(c.section),u=kr(c.start),A=kr(c.end);!Number.isInteger(d)||d<1||d>20||!u||!A||n.set(d,{i:d,s:u,e:A})}),Array.from(n.values()).sort((c,d)=>c.i-d.i)}a(lc,"buildScheduleJsonSections");function cc(p){let n=lc(p);if(!n.length)return{};let c={sections:JSON.stringify(n),sectionList:n};if(!n.every((u,A)=>u.i===A+1))return c;let d={morningNum:0,afternoonNum:0,nightNum:0};return n.forEach(u=>{let[A,P]=u.s.split(":").map(Number),_=A*60+P;_<720?d.morningNum+=1:_>=1080?d.nightNum+=1:d.afternoonNum+=1}),d.morningNum&&d.afternoonNum&&d.nightNum?Object.assign(c,d):c}a(cc,"buildScheduleJsonSchedule");function Zr(p){let n={unscheduledCourses:0,missingWeeks:0,invalidArrangements:0},c=sc(p,n);if(!c.length)throw new Error("没有符合导入格式的已排课课程");return{courses:c,schedule:cc(p.sections),stats:n}}a(Zr,"buildScheduleJsonSource");function ta(p){let n={courses:p.courses.map(d=>({name:d.name,teacher:d.teacher,position:d.position,day:d.day,sections:d.sections,weeks:d.weeks}))},c={};return["morningNum","afternoonNum","nightNum","sections"].forEach(d=>{Object.prototype.hasOwnProperty.call(p.schedule,d)&&(c[d]=p.schedule[d])}),Object.keys(c).length&&(n.schedule=c),n}a(ta,"buildXiaoAiScheduleJson");function ea(p,n){let c=so(n.base||{}),d=p.courses.map(u=>hp(u,n.courseFields));if(io(c,n.coursesPath,d),n.schedulePath&&Object.keys(p.schedule).length){let u=hp(p.schedule,n.scheduleFields);Object.keys(u).length&&io(c,n.schedulePath,u)}return c}a(ea,"buildCustomScheduleJson");function Sr(p){return p.getFullYear()+"-"+String(p.getMonth()+1).padStart(2,"0")+"-"+String(p.getDate()).padStart(2,"0")}a(Sr,"localDateIso");function rr(p){let n=String(p||"").match(/^(\d{4})-(\d{2})-(\d{2})$/);if(!n)return null;let c=new Date(Number(n[1]),Number(n[2])-1,Number(n[3]));return Number.isNaN(c.getTime())||Sr(c)!==String(p)?null:c}a(rr,"parseLocalIsoDate");function lo(p){let n=new Date(p.getFullYear(),p.getMonth(),p.getDate()),c=n.getDay();return n.setDate(n.getDate()-(c===0?6:c-1)),n}a(lo,"mondayOfDate");function gp(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d)/);if(!n)return Sr(lo(new Date));let c=n[3]==="1"?Number(n[1]):Number(n[2]),d=n[3]==="1"?8:2,u=new Date(c,d,1);for(;u.getDay()!==1;)u.setDate(u.getDate()+1);return Sr(u)}a(gp,"defaultSemesterMonday");function fp(p){return p.getFullYear()+String(p.getMonth()+1).padStart(2,"0")+String(p.getDate()).padStart(2,"0")+"T"+String(p.getHours()).padStart(2,"0")+String(p.getMinutes()).padStart(2,"0")+"00"}a(fp,"formatIcsLocal");function ra(p){return String(p||"").replace(/\\/g,"\\\\").replace(/;/g,"\\;").replace(/,/g,"\\,").replace(/\r?\n/g,"\\n")}a(ra,"escapeIcsText");function dc(p){if(typeof TextEncoder!="function")return p;let n=new TextEncoder,c=[],d="",u=73;for(let A of String(p))n.encode(d+A).length>u&&d?(c.push(d),d=" "+A,u=74):d+=A;return d&&c.push(d),c.join(`\r
`)}a(dc,"foldIcsLine");function uc(p){let n=2166136261,c=String(p||"");for(let d=0;d<c.length;d+=1)n=Math.imul(n^c.charCodeAt(d),16777619);return(n>>>0).toString(16)+"@scu-urppp"}a(uc,"scheduleUid");function xp(p){let n=new Map;return p.sections.forEach(c=>n.set(c.section,c)),n}a(xp,"scheduleSectionMap");function mc(p){return p.toISOString().replace(/[-:]/g,"").replace(/\.\d{3}/,"")}a(mc,"formatTimestamp");function yp(p,n,c={}){let d=rr(n);if(!d)throw new Error("第一教学周日期无效");let u=xp(p);if(!u.size)throw new Error("教务接口没有返回节次时间，无法生成 ICS");let A=mc(c.now instanceof Date?c.now:new Date),P=0,_=["BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//SCU URP++//Schedule Export//CN","CALSCALE:GREGORIAN","METHOD:PUBLISH","X-WR-CALNAME:"+ra(p.semester.label+"课表"),"X-WR-TIMEZONE:Asia/Shanghai","BEGIN:VTIMEZONE","TZID:Asia/Shanghai","X-LIC-LOCATION:Asia/Shanghai","BEGIN:STANDARD","TZOFFSETFROM:+0800","TZOFFSETTO:+0800","TZNAME:CST","DTSTART:19700101T000000","END:STANDARD","END:VTIMEZONE"];if(p.courses.forEach(y=>y.arrangements.forEach(S=>{let g=u.get(S.startSection),k=u.get(S.endSection);!g||!k||S.weeks.forEach(T=>{let C=new Date(d);C.setDate(d.getDate()+(T-1)*7+S.day-1);let f=new Date(C),b=new Date(C),w=g.start.split(":").map(Number),x=k.end.split(":").map(Number);f.setHours(w[0],w[1],0,0),b.setHours(x[0],x[1],0,0);let E=[S.campus,S.building,S.classroom].filter(Boolean).join(" "),q=["教师："+y.teacher,"周次："+S.weekDescription,"课程号："+y.code+(y.sequence?"_"+y.sequence:""),"学分："+y.credit,"课程属性："+y.attribute].filter(L=>!/[：:]$/.test(L)).join(`
`),I=[p.semester.planCode,y.code,y.sequence,S.day,S.startSection,S.endSection,T,S.campus,S.building,S.classroom].join("|");P+=1,_.push("BEGIN:VEVENT","UID:"+uc(I),"DTSTAMP:"+A,"SUMMARY:"+ra(y.name),"LOCATION:"+ra(E),"DESCRIPTION:"+ra(q),"DTSTART;TZID=Asia/Shanghai:"+fp(f),"DTEND;TZID=Asia/Shanghai:"+fp(b),"END:VEVENT")})})),!P)throw new Error("课表中没有已安排时间的课程，无法生成 ICS");return _.push("END:VCALENDAR"),_.map(dc).join(`\r
`)+`\r
`}a(yp,"buildScheduleIcs");function vp(p){let n=xp(p),c=0,d=0;return p.courses.forEach(u=>u.arrangements.forEach(A=>{A.weeks.length||(c+=1),(!n.has(A.startSection)||!n.has(A.endSection))&&(d+=1)})),{missingWeeks:c,missingTimes:d}}a(vp,"scheduleIcsOmissionStats");function hc(p){let n=String(p||"").replace(/[—–]/g,"-"),c=/单周|单数周|[（(]单[）)]/.test(n)?1:/双周|双数周|[（(]双[）)]/.test(n)?0:-1,d=new Set,u=a(A=>{let P=Number(A);P>=1&&P<=30&&(c<0||P%2===c)&&d.add(P)},"add");return n.replace(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/g,(A,P,_)=>{let y=Math.min(Number(P),Number(_)),S=Math.max(Number(P),Number(_));for(let g=y;g<=S;g+=1)u(g);return A}),(n.match(/\d{1,2}/g)||[]).forEach(u),Array.from(d).sort((A,P)=>A-P)}a(hc,"scheduleWeeksFromDescription");function wp(p,n){let c=String(p||"").trim();if(/^[01]+$/.test(c)){let d=[];for(let u=0;u<c.length;u+=1)c.charAt(u)==="1"&&d.push(u+1);return d}return hc(n||c)}a(wp,"scheduleWeeks");function bc(p){let n=p&&Array.isArray(p.xkxx)?p.xkxx:[];for(let c of n){let d=Object.values(c||{});if(d.length)return d[0]}return null}a(bc,"firstScheduleCourse");function ar(p){let n=bc(p);if(!n)return"";let c=Array.isArray(n.timeAndPlaceList)?n.timeAndPlaceList[0]:null;return String(n.zxjxjhh||n.executiveEducationPlanNumber||n.id&&(n.id.zxjxjhh||n.id.executiveEducationPlanNumber)||c&&(c.zxjxjhh||c.executiveEducationPlanNumber)||"").trim()}a(ar,"schedulePlanCodeFromData");function fc(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d)/);if(!n)return"学生课表";let c=n[3]==="1"?"秋季学期":n[3]==="2"?"春季学期":"学期";return n[1]+"-"+n[2]+"学年"+c}a(fc,"semesterLabelFromPlanCode");function kp(p,n,c,d={}){let u=n||ar(p),A=(Array.isArray(p&&p.jcsjbs)?p.jcsjbs:[]).map(y=>({section:Number(y.jc)||0,start:kr(y.kssj),end:kr(y.jssj)})).filter(y=>y.section>=1&&y.section<=20&&y.start&&y.end).sort((y,S)=>y.section-S.section),P=[];(Array.isArray(p&&p.xkxx)?p.xkxx:[]).forEach(y=>{Object.keys(y||{}).forEach(S=>{let g=y[S];if(!g)return;let k=g.id||{},T=(g.timeAndPlaceList||[]).map(C=>({day:Number(C.classDay)||0,startSection:Number(C.classSessions)||1,endSection:Math.min(12,(Number(C.classSessions)||1)+Math.max(1,Number(C.continuingSession)||1)-1),weeks:wp(C.classWeek,C.weekDescription||g.skzcs),weekDescription:String(C.weekDescription||g.skzcs||"").trim(),campus:String(C.campusName||"").trim(),building:String(C.teachingBuildingName||"").trim(),classroom:String(C.classroomName||"").trim()})).filter(C=>C.day>=1&&C.day<=7&&C.startSection>=1&&C.startSection<=12);P.push({code:String(k.coureNumber||g.zkch||"").trim(),sequence:String(k.coureSequenceNumber||g.zkxh||"").trim(),name:String(g.courseName||g.englishCourseName||S).trim(),englishName:String(g.englishCourseName||"").trim(),teacher:String(g.attendClassTeacher||"").trim(),attribute:String(g.coursePropertiesName||"").trim(),category:String(g.courseCategoryName||"").trim(),credit:Number(g.unit)||0,status:String(g.selectCourseStatusName||"").trim(),arrangements:T})})});let _=String(d.firstMonday||"").trim();return{schemaVersion:1,exportedAt:(d.now instanceof Date?d.now:new Date).toISOString(),source:c||"SCU URP++",semester:{planCode:u,label:fc(u),firstMonday:rr(_)?_:""},sections:A,courses:P}}a(kp,"normalizeScheduleExportData");function Ap(p,n,c,d=0){let u=Math.max(0,Number(p)||0),A=Math.max(1,Math.floor(Number(n)||1)),P=Math.max(0,Math.min(A-1,Math.floor(Number(c)||0))),_=-Math.max(0,Number(d)||0),y=_+u*P/A,S=_+u*(P+1)/A;return{left:y,width:Math.max(0,S-y)}}a(Ap,"scheduleCardLaneGeometry");function aa(p,n,c){let d=[],u=String(p||""),A=Math.max(4,Number(n)||4);for(;u;)d.push({text:u.slice(0,A),kind:c}),u=u.slice(A);return d}a(aa,"wrapField");function oa(p,n){let c=p.slice(0,Math.max(0,n)).map(d=>({...d}));if(c.length&&c.length<p.length){let d=c[c.length-1];d.text=d.text.length>1?d.text.slice(0,-1)+"…":"…"}return c}a(oa,"takeLines");var Sp=["#2563EB","#059669","#D97706","#DC2626","#7C3AED","#0891B2","#DB2777","#4D7C0F","#EA580C","#4F46E5"];function Ep(p){let n=0,c=String(p||"");for(let d=0;d<c.length;d+=1)n=n*31+c.charCodeAt(d)>>>0;return Sp[n%Sp.length]}a(Ep,"exportCourseColor");function _p(p){let n=[];p.forEach(c=>{let d=n.findIndex(u=>u<c.startSection);d<0&&(d=n.length,n.push(0)),n[d]=c.endSection,c.lane=d}),p.forEach(c=>{c.laneCount=Math.max(1,n.length)})}a(_p,"assignScheduleLanes");function Cp(p){let n=p.slice().sort((u,A)=>u.startSection-A.startSection||u.endSection-A.endSection||u.course.name.localeCompare(A.course.name)),c=[],d=0;return n.forEach(u=>{c.length&&u.startSection>d&&(_p(c),c=[],d=0),c.push(u),d=Math.max(d,u.endSection)}),c.length&&_p(c),n}a(Cp,"layoutScheduleDay");function Pp(p){let n=[];return p.courses.forEach(c=>c.arrangements.forEach(d=>{n.push({course:c,arrangement:d,startSection:d.startSection,endSection:d.endSection,day:d.day})})),n}a(Pp,"scheduleExportEvents");function zp(p,n){let c=[],d=String(p||"");for(;d;)c.push(d.slice(0,n)),d=d.slice(n);return c}a(zp,"wrapScheduleFooter");function Lp(p,n,c){let d=p.startSection===p.endSection?p.startSection+"节":p.startSection+"-"+p.endSection+"节",u=aa(p.name,Math.max(5,n),"title"),A=aa(p.teacher,Math.max(6,n+2),"teacher"),P=aa([p.weekDescription,d].filter(Boolean).join(" · "),Math.max(6,n+2),"schedule"),_=aa([p.campus,p.building,p.classroom].filter(Boolean).join(" "),Math.max(6,n+2),"location"),y=Math.max(1,Number(c)||1),S=_.length&&y>=2?Math.min(2,_.length):0,g=P.length&&y>=3?1:0,k=A.length&&y>=4?1:0,T=Math.max(1,y-S-g-k),C=oa(u,T),f=y-C.length,b=Math.min(A.length,Math.max(0,f-g-S));C.push(...oa(A,b)),f=y-C.length;let w=Math.min(P.length,Math.max(0,f-S));return C.push(...oa(P,w)),f=y-C.length,C.push(...oa(_,f)),C.slice(0,y)}a(Lp,"scheduleImageTextLines");function gc(p,n){let c=Ep(n),d=p.colors,u=p.skin;return u==="brutal"?{fill:Bt(d.surface,c,.48),stroke:"#000000",text:"#111111",secondary:"#242424",stripe:c}:u==="flat"?{fill:Bt(d.surface,c,p.dark?.24:.16),stroke:d.text,text:d.text,secondary:d.secondary,stripe:c}:u==="editorial"?{fill:Bt(d.surface,c,p.dark?.16:.08),stroke:d.border,text:d.text,secondary:d.secondary,stripe:c}:{fill:Bt(d.surface,c,p.dark?.28:u==="organic"?.2:.14),stroke:Bt(d.border,c,p.dark?.52:.42),text:d.text,secondary:d.secondary,stripe:c}}a(gc,"scheduleImageCourseStyle");function qp(p,n,c={}){if(!n||!n.colors||!n.shape)throw new Error("课表图片主题未解析");let d=n.colors,u=n.shape,A=c.now instanceof Date?c.now:new Date,P=1960,_=40,y=136,S=P-_*2,g=_+24,k=64,T=8,C=g+k+12,f=_+S-24,b=(f-C-T*6)/7,w=y+88,x=108,E=102,I=w+x*12-y+24,L=p.courses.filter(ot=>!ot.arrangements.length).map(ot=>ot.name),O=zp(L.join("、"),92),$=O.length?74+O.length*27:44,H=y+I+$,G=["星期一","星期二","星期三","星期四","星期五","星期六","星期日"],U=u.serif?"Georgia,Noto Serif SC,Songti SC,STSong,SimSun,serif":"Microsoft YaHei,Segoe UI,sans-serif",et="Microsoft YaHei,Segoe UI,sans-serif",it=["soft","warm","neu"].includes(u.shadow)?' filter="url(#schedule-frame-shadow)"':"",mt=["soft","warm","neu"].includes(u.shadow)?' filter="url(#schedule-card-shadow)"':"",V=[`<svg xmlns="http://www.w3.org/2000/svg" width="${P}" height="${H}" viewBox="0 0 ${P} ${H}">`,"<defs>",`<filter id="schedule-frame-shadow" x="-20%" y="-20%" width="140%" height="150%"><feDropShadow dx="0" dy="${n.dark?10:7}" stdDeviation="${n.dark?16:11}" flood-color="${n.dark?"#000000":d.text}" flood-opacity="${n.dark?.48:.1}"/></filter>`,`<filter id="schedule-card-shadow" x="-20%" y="-20%" width="140%" height="150%"><feDropShadow dx="0" dy="3" stdDeviation="5" flood-color="${n.dark?"#000000":d.text}" flood-opacity="${n.dark?.34:.1}"/></filter>`,"</defs>",`<rect width="100%" height="100%" fill="${d.bg}"/>`,`<rect x="${_}" y="32" width="142" height="36" rx="${u.headerRadius}" fill="${d.primary}"/>`,`<text x="${_+71}" y="56" text-anchor="middle" fill="#FFFFFF" font-size="15" font-weight="700" font-family="${et}">SCU URP++</text>`,`<text x="${_}" y="106" fill="${d.text}" font-size="36" font-weight="700" font-family="${U}">${at(p.semester.label)}课表</text>`,`<text x="${P-_}" y="54" text-anchor="end" fill="${d.secondary}" font-size="16" font-family="${et}">${at(n.label)}</text>`,`<text x="${P-_}" y="83" text-anchor="end" fill="${d.muted}" font-size="14" font-family="${et}">${at(A.toLocaleString("zh-CN",{hour12:!1}))}</text>`];u.shadow==="hard"&&V.push(`<rect x="${_+8}" y="${y+8}" width="${S}" height="${I}" fill="#000000"/>`),V.push(`<rect x="${_}" y="${y}" width="${S}" height="${I}" rx="${u.frameRadius}" fill="${d.surface}" stroke="${u.shadow==="hard"?"#000000":d.border}" stroke-width="${u.frameStroke}"${it}/>`),G.forEach((ot,X)=>{let ct=C+X*(b+T);V.push(`<rect x="${ct}" y="${y+22}" width="${b}" height="48" rx="${u.headerRadius}" fill="${d.input}" stroke="${d.border}" stroke-width="${u.frameStroke?1:0}"/>`,`<text x="${ct+b/2}" y="${y+53}" text-anchor="middle" fill="${d.secondary}" font-size="17" font-weight="600" font-family="${et}">${ot}</text>`)});for(let ot=1;ot<=12;ot+=1){let X=w+(ot-1)*x;V.push(`<rect x="${g}" y="${X}" width="${k}" height="${E}" rx="${u.gridRadius}" fill="${d.input}" stroke="${d.border}" stroke-width="${u.frameStroke?1:0}"/>`,`<text x="${g+k/2}" y="${X+E/2+6}" text-anchor="middle" fill="${d.muted}" font-size="16" font-weight="600" font-family="${et}">${ot}</text>`),G.forEach((ct,rt)=>{let st=C+rt*(b+T);V.push(`<rect x="${st}" y="${X}" width="${b}" height="${E}" rx="${u.gridRadius}" fill="${d.input}" stroke="${d.border}" stroke-width="${u.frameStroke?1:0}"/>`)})}[4,9].forEach(ot=>{let X=w+ot*x-3;V.push(`<line x1="${C}" y1="${X}" x2="${f}" y2="${X}" stroke="${d.primary}" stroke-opacity=".42" stroke-width="2" stroke-dasharray="10 9"/>`)});for(let ot=1;ot<=7;ot+=1)Cp(Pp(p).filter(ct=>ct.day===ot)).forEach((ct,rt)=>{let st=b/ct.laneCount,gt=C+(ot-1)*(b+T)+ct.lane*st,Z=w+(ct.startSection-1)*x,dt=st,kt=Math.max(E,(ct.endSection-ct.startSection)*x+E),wt=gc(n,ct.course.name),Ct="course-clip-"+ot+"-"+rt,B=Math.max(1,Math.floor((kt-18)/23)),Y=Lp({name:ct.course.name,teacher:ct.course.teacher,weekDescription:ct.arrangement.weekDescription,startSection:ct.startSection,endSection:ct.endSection,campus:ct.arrangement.campus,building:ct.arrangement.building,classroom:ct.arrangement.classroom},Math.floor((dt-22)/16),B);V.push(`<clipPath id="${Ct}"><rect x="${gt+11}" y="${Z+8}" width="${Math.max(10,dt-22)}" height="${Math.max(18,kt-16)}" rx="${Math.max(0,u.cardRadius-5)}"/></clipPath>`,`<rect data-course-card="1" data-day="${ot}" data-start="${ct.startSection}" data-end="${ct.endSection}" x="${gt}" y="${Z}" width="${dt}" height="${kt}" rx="${u.cardRadius}" fill="${wt.fill}" stroke="${wt.stroke}" stroke-width="${u.cardStroke}"${mt}/>`),n.skin==="brutal"&&V.push(`<path d="M ${gt+dt-4} ${Z+4} V ${Z+kt-4} H ${gt+4}" fill="none" stroke="#000000" stroke-opacity=".28" stroke-width="5"/>`),n.skin==="editorial"&&V.push(`<rect x="${gt}" y="${Z}" width="6" height="${kt}" fill="${wt.stripe}"/>`),n.skin==="neu"&&V.push(`<path d="M ${gt+u.cardRadius} ${Z+1} H ${gt+dt-u.cardRadius}" stroke="#FFFFFF" stroke-opacity=".32" stroke-width="2"/>`),V.push('<g clip-path="url(#'+Ct+')">'),Y.forEach((tt,bt)=>{let ht=tt.kind==="title";V.push(`<text data-kind="${tt.kind}" x="${gt+14}" y="${Z+28+bt*23}" fill="${ht?wt.text:wt.secondary}" font-size="${ht?16:13}" font-weight="${ht?700:500}" font-family="${ht&&u.serif?U:et}">${at(tt.text)}</text>`)}),V.push("</g>")});let Q=y+I+30;return O.length?(V.push(`<text x="${_}" y="${Q}" fill="${d.secondary}" font-size="15" font-weight="700" font-family="${et}">未排定时间的课程</text>`),O.forEach((ot,X)=>V.push(`<text x="${_}" y="${Q+29+X*27}" fill="${d.muted}" font-size="14" font-family="${et}">${at(ot)}</text>`))):V.push(`<text x="${_}" y="${Q}" fill="${d.muted}" font-size="14" font-family="${et}">由 SCU URP++ 基于结构化课表数据生成</text>`),V.push("</svg>"),{svg:V.join(""),width:P,height:H,background:d.bg,theme:n}}a(qp,"buildScheduleSvg");function xc(p,n,c={}){let d=[],u=c.json||null,A=c.ics||null,P=p==="ics"?n.courses.filter(_=>!_.arrangements.length).length:0;return P&&d.push(P+" 门未排定时间的课程未写入日历"),u&&u.unscheduledCourses&&d.push(u.unscheduledCourses+" 门未排定时间的课程未写入 JSON"),u&&u.missingWeeks&&d.push(u.missingWeeks+" 个上课安排缺少周次"),u&&u.invalidArrangements&&d.push(u.invalidArrangements+" 个上课安排缺少日期或节次"),A&&A.missingWeeks&&d.push(A.missingWeeks+" 个上课安排缺少周次"),A&&A.missingTimes&&d.push(A.missingTimes+" 个上课安排缺少节次时间"),d}a(xc,"scheduleExportCompletionNotes");function na(p,n,c,d,u){return`<button type="button" class="urppp-export-option" role="menuitem" data-export-type="${p}"${u?" disabled":""}><i class="fa ${n}" aria-hidden="true"></i><span><strong>${c}</strong><small>${d}</small></span></button>`}a(na,"exportOptionHtml");function Tp(p){let{document:n,window:c,ensureStyles:d,loadData:u,exportJson:A,exportIcs:P,exportPng:_,showToast:y,nativePageUrl:S,navigate:g,logger:k=console}=p;function T(x){x&&(x.classList.remove("open"),x.querySelector(".urppp-export-trigger")?.setAttribute("aria-expanded","false"))}a(T,"closeMenu");function C(){c.__urpppExportDismissBound||(c.__urpppExportDismissBound=!0,n.addEventListener("click",x=>{n.querySelectorAll(".urppp-export-wrap.open").forEach(E=>{E.contains(x.target)||T(E)})},!0),n.addEventListener("keydown",x=>{x.key==="Escape"&&n.querySelectorAll(".urppp-export-wrap.open").forEach(T)}))}a(C,"bindDismiss");async function f(x,E,q,I){if(I&&I.disabled)return;let L=I&&I.innerHTML;try{if(I&&(I.disabled=!0,I.innerHTML='<i class="fa fa-spinner fa-spin"></i> 准备中'),x==="pdf"){if(typeof q!="function")throw new Error("当前页面不提供原生 PDF 导出");await q();return}let O=await u(E),$={};if(x==="json")$.json=await A(O);else if(x==="ics")$.ics=await P(O);else if(x==="png")await _(O);else throw new Error("未知导出格式");let H=xc(x,O,$);y("课表已导出："+x.toUpperCase()+(H.length?"；"+H.join("，"):""))}catch(O){if(O&&O.message==="已取消导出")return;k.warn("[URP++] schedule export",O),y(O&&O.message||String(O),!0)}finally{I&&(I.disabled=!1,I.innerHTML=L)}}a(f,"run");function b(x={}){d();let E=x.source||"native",q=x.pdfHandler,I=typeof q=="function",L=n.createElement("span"),O=E==="native"?"导出课表":"导出";L.className="urppp-export-wrap",L.innerHTML=`<button type="button" class="urppp-export-trigger" aria-haspopup="menu" aria-expanded="false" title="导出课表"><i class="fa fa-cloud-download" aria-hidden="true"></i><span>${O}</span><i class="fa fa-angle-down" aria-hidden="true"></i></button><div class="urppp-export-menu" role="menu">${na("ics","fa-calendar","ICS 日历","导入系统日历或日历应用",!1)}${na("json","fa-code","JSON 数据","兼容小爱课程导入，可自定义格式",!1)}${na("png","fa-image","PNG 图片","完整学期课表高清图片",!1)}${na("pdf","fa-file-pdf-o","PDF",I?"使用教务系统原生导出":"仅原教务课表页面可用",!I)}${I?"":'<div class="urppp-export-guide">PDF 依赖原教务课表页面。<button type="button" data-export-native="1">前往本学期课表</button></div>'}</div>`;let $=L.querySelector(".urppp-export-trigger");$.addEventListener("click",G=>{G.preventDefault(),G.stopPropagation();let U=!L.classList.contains("open");n.querySelectorAll(".urppp-export-wrap.open").forEach(T),L.classList.toggle("open",U),$.setAttribute("aria-expanded",U?"true":"false")}),L.querySelectorAll("[data-export-type]:not(:disabled)").forEach(G=>{G.addEventListener("click",()=>{T(L),f(G.getAttribute("data-export-type"),E,q,$)})});let H=L.querySelector("[data-export-native]");return H&&H.addEventListener("click",()=>g(S)),C(),L}a(b,"createMenu");function w(x){(x&&x.querySelectorAll?x:n).querySelectorAll("[data-schedule-export-host]").forEach(q=>{q.querySelector(".urppp-export-wrap")||q.appendChild(b({source:q.getAttribute("data-schedule-export-host")||"clean"}))})}return a(w,"bindHosts"),{bindHosts:w,closeMenu:T,createMenu:b,run:f}}a(Tp,"createScheduleExportUi");function Mp(p){let n=a(c=>{p.querySelectorAll(".urppp-set-tab").forEach(d=>{let u=d.dataset.tab===c;d.classList.toggle("ac",u),d.setAttribute("aria-selected",u?"true":"false")}),p.querySelectorAll(".urppp-set-pane").forEach(d=>{d.classList.toggle("ac",d.dataset.pane===c)});try{let d=p.querySelector(".urppp-set-body");d&&(d.scrollTop=0)}catch{}},"switchTab");return p.querySelectorAll(".urppp-set-tab").forEach(c=>{c.addEventListener("click",()=>n(c.dataset.tab))}),p.__urpppSwitchTab=n,n}a(Mp,"bindSettingsTabs");function $p(p){let{document:n,ensurePanel:c,syncPanel:d,refreshUpdateStatus:u,defaultTab:A="theme"}=p;function P(){c();let y=n.getElementById("urppp-settings-panel"),S=n.getElementById("urppp-settings-mask");if(!y||!S)return!1;d();try{u()}catch{}try{y.__urpppSwitchTab&&y.__urpppSwitchTab(A)}catch{}S.classList.remove("open"),y.classList.remove("open"),y.offsetWidth,S.classList.add("open"),y.classList.add("open");try{let g=y.querySelector(".urppp-set-body");g&&(g.scrollTop=0)}catch{}return!0}a(P,"open");function _(){let y=n.getElementById("urppp-settings-panel"),S=n.getElementById("urppp-settings-mask");y&&y.classList.remove("open"),S&&S.classList.remove("open")}return a(_,"close"),{close:_,open:P}}a($p,"createSettingsPanelController");function Ip(p){let{logoData:n,repositoryUrl:c,version:d}=p;return['<div class="urppp-set-head">','  <div class="urppp-set-title">设置</div>','  <button type="button" class="urppp-set-close" id="urppp-set-close" aria-label="关闭">×</button>',"</div>",'<div class="urppp-set-tabs" role="tablist">','  <button type="button" class="urppp-set-tab ac" data-tab="theme" role="tab" aria-selected="true">主题设置</button>','  <button type="button" class="urppp-set-tab" data-tab="skin" role="tab" aria-selected="false">主题选择</button>','  <button type="button" class="urppp-set-tab" data-tab="system" role="tab" aria-selected="false">系统设置</button>','  <button type="button" class="urppp-set-tab" data-tab="about" role="tab" aria-selected="false">关于</button>',"</div>",'<div class="urppp-set-body">','  <div class="urppp-set-pane ac" data-pane="theme">','    <section class="urppp-set-sec">',"      <h3>主题模式</h3>",'      <div class="urppp-set-modes" id="urppp-set-modes">','        <button type="button" class="urppp-set-mode" data-theme="default">简约白</button>','        <button type="button" class="urppp-set-mode" data-theme="dark">深邃暗</button>','        <button type="button" class="urppp-set-mode" data-theme="scu-red">动态配色</button>',"      </div>",'      <div class="urppp-set-follow-row">','        <button type="button" class="urppp-set-follow" id="urppp-set-follow" aria-pressed="false">跟随系统：关</button>','        <button type="button" class="urppp-set-follow" id="urppp-set-follow-dynamic" aria-pressed="false">浅色用动态配色：关</button>',"      </div>",'      <button type="button" class="urppp-set-follow" id="urppp-set-clean-default" aria-pressed="false" style="margin-top:12px;width:100%">默认进入清爽模式：关</button>','      <button type="button" class="urppp-set-follow" id="urppp-set-clean-analysis" aria-pressed="false" style="margin-top:12px;width:100%">清爽成绩分析展示：选项卡</button>','      <button type="button" class="urppp-set-follow" id="urppp-set-apple-edge" aria-pressed="true" style="margin-top:12px;width:100%">类Apple边缘线条：开</button>',"    </section>",'    <section class="urppp-set-sec" id="urppp-set-dynamic">',"      <h3>种子色</h3>",'      <p class="urppp-set-tip">选一个颜色，自动生成背景、卡片、强调色等多套方案</p>','      <div class="urppp-set-presets" id="urppp-set-presets"></div>','      <div class="urppp-set-custom">','        <input type="color" id="urppp-set-color" value="#B53434" />','        <input type="text" id="urppp-set-hex" maxlength="7" value="#B53434" spellcheck="false" />','        <button type="button" class="urppp-set-btn" id="urppp-set-gen">生成方案</button>','        <button type="button" class="urppp-set-btn ghost" id="urppp-set-save">存为预设</button>',"      </div>",'      <h3 style="margin-top:16px">配色方案</h3>','      <div class="urppp-set-schemes" id="urppp-set-schemes"></div>',"    </section>",'    <section class="urppp-set-sec" id="urppp-set-brutal" style="display:none">',"      <h3>高对比配色</h3>",'      <p class="urppp-set-tip">默认圆点使用高能粉；选择一种备用配色后，可由左上第三个圆点快速切换。</p>','      <div class="urppp-set-schemes" id="urppp-set-brutal-palettes"></div>',"    </section>","  </div>",'  <div class="urppp-set-pane" data-pane="skin">','    <section class="urppp-set-sec">',"      <h3>界面风格</h3>",'      <p class="urppp-set-tip">在同一布局上切换视觉气质。因适配规模较大，仅保证清爽模式的完整适配，如有影响请使用默认类Apple风格并选择性开启边缘线条。</p>','      <div class="urppp-theme-store-bar"><button type="button" class="urppp-set-btn ghost" id="urppp-theme-store">主题商店</button></div>','      <div id="urppp-theme-store-inline" class="urppp-store-inline" style="display:none"></div>','      <div class="urppp-skin-list" id="urppp-skin-list"></div>',"    </section>","  </div>",'  <div class="urppp-set-pane" data-pane="system">','    <section class="urppp-set-sec" id="urppp-set-privacy">',"      <h3>隐私模式</h3>",'      <div class="urppp-set-modes" id="urppp-set-privacy-modes">','        <button type="button" class="urppp-set-follow urppp-privacy-mode" data-privacy-mode="off">关闭</button>','        <button type="button" class="urppp-set-follow urppp-privacy-mode" data-privacy-mode="one">一键隐私</button>','        <button type="button" class="urppp-set-follow urppp-privacy-mode" data-privacy-mode="custom">自定义</button>',"      </div>",'      <div class="urppp-privacy-groups" id="urppp-set-privacy-custom">','        <div class="urppp-privacy-group">','          <div class="urppp-privacy-group-title">身份信息</div>','          <div class="urppp-privacy-group-fields">','            <div class="urppp-privacy-field"><input id="urppp-privacy-identity" type="checkbox" data-privacy-field="identity" aria-label="隐藏学号和证件"><label for="urppp-privacy-identity">学号/证件</label><input class="urppp-feature-input" data-privacy-value="identity" maxlength="40" aria-label="学号和证件替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-organization" type="checkbox" data-privacy-field="organization" aria-label="隐藏学院和专业"><label for="urppp-privacy-organization">学院/专业</label><input class="urppp-feature-input" data-privacy-value="organization" maxlength="40" aria-label="学院和专业替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-contact" type="checkbox" data-privacy-field="contact" aria-label="隐藏联系和个人信息"><label for="urppp-privacy-contact">联系/个人信息</label><input class="urppp-feature-input" data-privacy-value="contact" maxlength="40" aria-label="联系和个人信息替换内容"></div>',"          </div>","        </div>",'        <div class="urppp-privacy-group">','          <div class="urppp-privacy-group-title">学业信息</div>','          <div class="urppp-privacy-group-fields">','            <div class="urppp-privacy-field"><input id="urppp-privacy-grade" type="checkbox" data-privacy-field="grade" aria-label="隐藏成绩"><label for="urppp-privacy-grade">成绩</label><input class="urppp-feature-input" data-privacy-value="grade" maxlength="40" aria-label="成绩替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-gpa" type="checkbox" data-privacy-field="gpa" aria-label="隐藏绩点"><label for="urppp-privacy-gpa">绩点</label><input class="urppp-feature-input" data-privacy-value="gpa" maxlength="40" aria-label="绩点替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-credit" type="checkbox" data-privacy-field="credit" aria-label="隐藏学分"><label for="urppp-privacy-credit">学分</label><input class="urppp-feature-input" data-privacy-value="credit" maxlength="40" aria-label="学分替换内容"></div>',"          </div>","        </div>",'        <div class="urppp-privacy-group">','          <div class="urppp-privacy-group-title">页面内容</div>','          <div class="urppp-privacy-group-fields">','            <div class="urppp-privacy-field"><input id="urppp-privacy-other" type="checkbox" data-privacy-field="other" aria-label="隐藏其他数据"><label for="urppp-privacy-other">其他数据</label><input class="urppp-feature-input" data-privacy-value="other" maxlength="40" aria-label="其他数据替换内容"></div>','            <div class="urppp-privacy-field"><input id="urppp-privacy-schedule" type="checkbox" data-privacy-field="schedule" aria-label="隐藏课表"><label for="urppp-privacy-schedule">课表</label><input class="urppp-feature-input" data-privacy-value="schedule" maxlength="40" aria-label="课表替换内容"></div>','            <div class="urppp-privacy-field urppp-privacy-field-static"><input id="urppp-privacy-avatar" type="checkbox" data-privacy-field="avatar" aria-label="隐藏头像"><label for="urppp-privacy-avatar">头像</label><span class="urppp-privacy-note">使用统一遮罩</span></div>',"          </div>","        </div>","      </div>",'      <div class="urppp-direct-edit-control">',"        <div><strong>自由修改显示数据</strong><span>开启后，直接点击首页或清爽模式中带标记的数据进行修改</span></div>",'        <button type="button" class="urppp-set-follow" id="urppp-set-direct-edit-toggle" aria-pressed="false">页面内修改：关</button>',"      </div>","    </section>",'    <section class="urppp-set-sec" id="urppp-set-identity">',"      <h3>自定义姓名与头像</h3>",'      <div class="urppp-identity-editor">','        <div class="urppp-identity-fields">','          <div class="urppp-feature-row"><label><input type="checkbox" id="urppp-set-name-enabled"> 自定义姓名</label><input class="urppp-feature-input" id="urppp-set-custom-name" maxlength="40" placeholder="输入显示姓名"></div>','          <div class="urppp-feature-row"><label><input type="checkbox" id="urppp-set-avatar-enabled"> 自定义头像</label><input class="urppp-feature-input" id="urppp-set-custom-avatar-url" placeholder="https://... 图片地址"></div>','          <div class="urppp-feature-row"><label for="urppp-set-custom-avatar-file">本地图片</label><input class="urppp-feature-input" type="file" id="urppp-set-custom-avatar-file" accept="image/png,image/jpeg,image/webp,image/gif"></div>',"        </div>",'        <div class="urppp-identity-preview">','          <span class="urppp-identity-preview-label">头像预览</span>','          <div class="urppp-avatar-preview-shell"><span>未设置</span><img class="urppp-avatar-preview" id="urppp-set-avatar-preview" alt="自定义头像预览"></div>',"        </div>","      </div>",'      <div class="urppp-feature-actions"><button type="button" class="urppp-set-btn" id="urppp-set-privacy-save">保存隐私与显示设置</button><button type="button" class="urppp-set-btn ghost" id="urppp-set-avatar-clear">清除自定义头像</button></div>','      <div class="urppp-set-tip" id="urppp-set-privacy-status" style="margin-top:8px"></div>',"    </section>",'    <section class="urppp-set-sec" id="urppp-set-json-export">',"      <h3>JSON 导出格式</h3>",'      <button type="button" class="urppp-set-follow" id="urppp-set-json-custom" aria-pressed="false" style="width:100%">自定义 JSON：关</button>','      <div class="urppp-json-mapping-editor" id="urppp-set-json-editor">','        <label for="urppp-set-json-mapping">字段映射</label>','        <textarea id="urppp-set-json-mapping" spellcheck="false" aria-label="自定义 JSON 字段映射"></textarea>','        <p class="urppp-set-tip">源字段包括 name、teacher、position、day、sections、weeks、code、credit、campus、building、classroom、weekList 等；目标值支持 data.courses 形式的嵌套路径。</p>','        <div class="urppp-feature-actions"><button type="button" class="urppp-set-btn" id="urppp-set-json-save">保存映射</button><button type="button" class="urppp-set-btn ghost" id="urppp-set-json-reset">恢复默认映射</button></div>',"      </div>",'      <div class="urppp-set-tip" id="urppp-set-json-status" style="margin-top:8px"></div>',"    </section>",'    <section class="urppp-set-sec" id="urppp-set-update">',"      <h3>更新</h3>",'      <button type="button" class="urppp-set-follow" id="urppp-set-auto-update" aria-pressed="false" style="width:100%">自动检测更新：关</button>','      <button type="button" class="urppp-set-btn" id="urppp-set-check-update" style="margin-top:12px;width:100%">检查更新</button>','      <div id="urppp-set-update-status" class="urppp-set-tip" style="margin-top:8px"></div>',"    </section>",'    <div id="urppp-set-assist-slot"></div>',"  </div>",'  <div class="urppp-set-pane" data-pane="about">','    <div class="urppp-about">','      <img class="urppp-about-logo" id="urppp-about-logo" src="'+n+'" alt="SCU URP++" referrerpolicy="no-referrer" />','      <a class="urppp-about-ver" id="urppp-about-ver" href="'+c+'" target="_blank" rel="noopener noreferrer">SCU URP++ v'+d+"</a>",'      <p class="urppp-about-author">作者：Chao_Lan · Hanako</p>','      <p class="urppp-about-contact">QQ：2718748334</p>',`      <p class="urppp-about-msg">有任何问题欢迎及时反馈！
半夜Vibe有点爽怎么回事。</p>`,"    </div>","  </div>","</div>"].join("")}a(Ip,"buildSettingsPanelHtml");var te="urppp_plugin_",yc="1.0.0";function co({GM:p,doc:n,hostInfo:c,uiDeps:d}){let{getValue:u=a(()=>null,"getValue"),setValue:A=a(()=>{},"setValue"),xmlHttp:P,addStyle:_}=p||{},y=(typeof d=="function"?d:d&&d.openSubpanel)||null,S=new Map,g=new Map,k=new Map,T=[],C=null;function f(B,Y){let tt=k.get(B);tt&&tt.forEach(bt=>{try{bt(Y)}catch{}})}a(f,"emit");function b(B,Y){return k.has(B)||k.set(B,new Set),k.get(B).add(Y),()=>k.get(B).delete(Y)}a(b,"on");function w(B,Y){return u(`${te}${B}_${Y}`)}a(w,"storageGet");function x(B,Y,tt){A(`${te}${B}_${Y}`,tt)}a(x,"storageSet");function E(){return B=>({get:a(Y=>w(B,Y),"get"),set:a((Y,tt)=>x(B,Y,tt),"set"),remove:a(Y=>A(`${te}${B}_${Y}`,void 0),"remove")})}a(E,"storage");function q(B,Y={}){return new Promise((tt,bt)=>{if(typeof P!="function"){bt(new Error("GM_xmlhttpRequest 不可用（未授权跨域？）"));return}P({method:Y.method||"GET",url:B,headers:Y.headers||{},data:Y.data,timeout:Y.timeout||8e3,onload:a(ht=>ht.status>=200&&ht.status<300?tt(ht.responseText):bt(new Error(`HTTP ${ht.status}`)),"onload"),onerror:a(()=>bt(new Error("网络错误")),"onerror"),ontimeout:a(()=>bt(new Error("超时(8s)")),"ontimeout")})})}a(q,"request");async function I(B,Y){let tt=Array.isArray(B)?B:[B],bt=[];for(let ht=0;ht<tt.length;ht+=1){let zt=tt[ht];Y&&Y({stage:"downloading",index:ht+1,total:tt.length,url:zt});try{let yt=await q(zt);return Y&&Y({stage:"downloaded",url:zt,size:yt.length}),yt}catch(yt){bt.push(`源${ht+1}(${L(zt)})失败: ${yt&&yt.message?yt.message:yt}`),Y&&Y({stage:"source_failed",index:ht+1,total:tt.length,error:yt&&yt.message?yt.message:yt})}}throw new Error("所有下载源失败 → "+bt.join(" ｜ "))}a(I,"fetchWithFallback");function L(B){try{return new URL(B).host}catch{return B}}a(L,"shortHost");function O(B){let Y=String(B||"").match(/\/\/\s*==UserScript==[\s\S]*?\/\/\s*==\/UserScript==/);return Y?B.replace(Y[0],""):B}a(O,"stripMetadata");function $(B,Y){try{let tt=O(B),bt=["GM_getValue","GM_setValue","GM_xmlhttpRequest","GM_registerMenuCommand","GM_addStyle","unsafeWindow"],ht=[typeof GM_getValue=="function"?GM_getValue:void 0,typeof GM_setValue=="function"?GM_setValue:void 0,typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:void 0,typeof GM_registerMenuCommand=="function"?GM_registerMenuCommand:void 0,typeof GM_addStyle=="function"?GM_addStyle:void 0,typeof unsafeWindow<"u"?unsafeWindow:null];return new Function(...bt,tt)(...ht),!0}catch(tt){return console.warn("[URP++ plugin] 注入失败",Y,tt),!1}}a($,"inject");function H(B,Y){let tt=g.get(B);return tt?(tt.enabled=!!Y,A(`${te}${B}_enabled`,tt.enabled),f(Y?"enabled":"disabled",B),!0):!1}a(H,"setEnabled");function G(B){let Y=g.get(B);return!!Y&&Y.enabled}a(G,"isEnabled");function U(B){if(!B||!B.id)return!1;if(S.has(B.id)&&S.get(B.id).__urpppRegistered)return!0;let Y=Object.assign({type:"plugin"},B);Y.__urpppRegistered=!0,S.set(B.id,Y);let tt=g.get(B.id)||{loaded:!1,enabled:!1,version:B.version||""};return tt.version=Y.version||tt.version,g.set(B.id,tt),f("registered",Y.id),!0}a(U,"register");function et(B){return S.get(B)||null}a(et,"get");function it(B){let Y=[];for(let tt of S.values())(!B||tt.type===B)&&Y.push(tt);return Y}a(it,"list");function mt(B){let Y=g.get(B);return!!Y&&Y.loaded}a(mt,"loaded");async function V(B,Y,tt){tt&&tt({stage:"start",id:B});let bt=Array.isArray(Y)?Y:Y?[Y]:rt(B),ht=await I(bt,tt);A(`${te}${B}_code`,ht),tt&&tt({stage:"injecting",id:B});let zt=$(ht,B),yt=g.get(B)||{loaded:!1,enabled:!1,version:""};return yt.loaded=zt,yt.enabled=zt,yt.code=ht,yt.version=yt.version||Q(ht),g.set(B,yt),A(`${te}${B}_enabled`,zt),f("loaded",B),zt}a(V,"install");function Q(B){let Y=String(B||"").match(/@version\s+(\S+)/);return Y?Y[1]:""}a(Q,"detectVersion");async function ot(B,Y,tt){let bt=Array.isArray(Y)?Y:Y?[Y]:rt(B),ht=await I(bt,tt);A(`${te}${B}_code`,ht);let zt=Q(ht),yt=g.get(B)||{loaded:!1,enabled:!1,version:""};return yt.version=zt||yt.version,yt.code=ht,g.set(B,yt),f("updated",B),{ok:!0,version:zt||yt.version}}a(ot,"update");function X(B){let Y=u(`${te}${B}_code`);if(!Y)return!1;let tt=g.get(B);if(tt&&tt.loaded)return!0;let bt=$(Y,B),ht=g.get(B)||{loaded:!1,enabled:!1,version:Q(Y)};return ht.loaded=bt,ht.enabled=bt&&u(`${te}${B}_enabled`)!==!1,ht.code=Y,g.set(B,ht),f("loaded",B),bt}a(X,"bootFromCache");function ct(B){let Y=S.get(B);return S.delete(B),g.delete(B),A(`${te}${B}_enabled`,!1),f("unregistered",B),!!Y}a(ct,"unregister");function rt(B){return B==="assist"?["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/plugins/urpppp.plugin.js","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/plugins/urpppp.plugin.js","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/plugins/urpppp.plugin.js"]:[]}a(rt,"pluginSource");let st={protocolVersion:yc,register:U,unregister:ct,get:et,list:it,loaded:mt,isEnabled:G,enable:a((B,Y=!0)=>H(B,Y),"enable"),disable:a(B=>H(B,!1),"disable"),install:V,update:ot,bootFromCache:X,storage:a(()=>u&&{get:a(B=>u(B),"get"),set:a((B,Y)=>A(B,Y),"set")},"storage"),pluginStorage:a(B=>E()(B),"pluginStorage"),request:q,addStyle:a(B=>{try{_&&_(B)}catch{}},"addStyle"),log:a((...B)=>{console.log("[URP++ plugin]",...B)},"log"),on:b,emit:f,hostInfo:Object.assign({name:"SCU URP++"},c||{}),getSubpanel:a(()=>y,"getSubpanel")};try{window.__urpppPlugin=st}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppPlugin=st)}catch{}function gt(B){if(!B||!n||B.querySelector(".urppp-plugin-sec, .urpppp-entry-sec"))return;let Y=n.createElement("section");Y.className="urppp-set-sec urppp-plugin-sec",Y.id="urppp-plugin-sec",Y.innerHTML=`
      <h3>辅助插件</h3>
    ...
    `,B.appendChild(Y);let tt=Y.querySelector("#urppp-plugin-status"),bt=Y.querySelector("#urppp-plugin-install"),ht=Y.querySelector("#urppp-plugin-store"),zt=Y.querySelector("#urppp-plugin-panels"),yt=Y.querySelector("#urppp-plugin-tip");function Ft(){let Pt=g.get("assist"),It=S.has("assist");Pt&&Pt.loaded||It?(tt.textContent=`辅助插件 v${Pt&&Pt.version?Pt.version:et("assist")&&et("assist").version||""} 已装载`,tt.className="urppp-plugin-status ok",bt.textContent="重新装载",bt.dataset.state="loaded",yt.textContent="已装载。下方为扩展入口。"):(tt.textContent=C||"未装载",tt.className=C?"urppp-plugin-status err":"urppp-plugin-status",bt.textContent="装载辅助插件",bt.dataset.state="notloaded",yt.textContent=C?"装载失败，可就近重试或放回本地安装。下方为装载/商店入口。":"点击装载后，主插件会下载并注入辅助插件（登录助手/评教/会话保持/2FA），无需再单独安装。"),zt.innerHTML="";let Kt=Ct();if(Kt&&Object.keys(Kt).length){let $e=n.createElement("div");$e.className="urppp-plugin-sub",Object.keys(Kt).forEach(ue=>{let Qt=n.createElement("button");Qt.type="button",Qt.className="urppp-set-btn ghost",Qt.textContent=Kt[ue].label||ue,Qt.addEventListener("click",()=>{try{Kt[ue]&&typeof Kt[ue].open=="function"?Kt[ue].open():y&&y(ue)}catch{}}),$e.appendChild(Qt)}),zt.appendChild($e)}}a(Ft,"refresh"),bt.addEventListener("click",async()=>{bt.disabled=!0,bt.textContent="装载中…",tt.className="urppp-plugin-status",tt.textContent="正在开始装载…";try{if(await V("assist",null,It=>{try{It.stage==="downloading"?tt.textContent=`下载中… 源${It.index}/${It.total}（${L(It.url)}）`:It.stage==="downloaded"?tt.textContent=`已下载（${It.size} 字节），注入中…`:It.stage==="source_failed"?tt.textContent=`源${It.index}失败（${It.error||""}），切换下一源…`:It.stage==="injecting"?tt.textContent="注入中…":It.stage==="start"&&(tt.textContent="正在开始装载…"),console.log("[URP++ plugin] assist 装载进度",It)}catch{}}))C=null,tt.textContent="辅助插件已装载 v"+(et("assist")&&et("assist").version||""),console.log("[URP++ plugin] assist 装载成功");else throw new Error("注入失败")}catch(Pt){C="装载失败："+(Pt&&Pt.message?Pt.message:Pt),tt.textContent=C,tt.className="urppp-plugin-status err",console.warn("[URP++ plugin] assist 装载失败",Pt)}finally{bt.disabled=!1,Ft()}}),ht.addEventListener("click",()=>{y&&y("plugin-store")}),b("loaded",Pt=>{Pt==="assist"&&Ft()}),b("registered",Pt=>{Pt==="assist"&&Ft()}),b("unregistered",Pt=>{Pt==="assist"&&Ft()}),Ft()}a(gt,"renderAssistUi");function Z(B){return String(B??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}a(Z,"escapeHtml");function dt(B){if(B){if(kt(),B.dataset.rendered==="1"){B.style.display=B.style.display==="none"?"":"none";return}B.dataset.rendered="1",B.innerHTML=`
      ...
      </div>`,B.querySelectorAll(".urppp-store-tab").forEach(Y=>{Y.addEventListener("click",()=>{B.querySelectorAll(".urppp-store-tab").forEach(bt=>bt.className="urppp-store-tab"),Y.className="urppp-store-tab ac",B.querySelectorAll(".urppp-store-pane").forEach(bt=>bt.style.display="none");let tt=B.querySelector('.urppp-store-pane[data-pane="'+Y.dataset.tab+'"]');tt&&(tt.style.display="")})}),wt(B.querySelector("#urppp-store-manage-list")),B.style.display=""}}a(dt,"togglePluginStore");function kt(){if(n.getElementById("urppp-store-style"))return;let B=n.createElement("style");B.id="urppp-store-style",B.textContent=`
    ...
    `,(n.head||n.documentElement).appendChild(B)}a(kt,"ensureStoreStyle");function wt(B){if(!B)return;B.innerHTML="";let Y=Array.from(S.values());if(!Y.length){B.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}Y.forEach(tt=>{let bt=g.get(tt.id)||{},ht=n.createElement("div");ht.className="urppp-store-item";let zt=n.createElement("div");zt.className="urppp-store-info",zt.innerHTML="<strong>"+Z(tt.name||tt.id)+'</strong><span class="urppp-store-ver">'+(tt.version?"v"+Z(tt.version):"")+'</span><span class="urppp-store-state'+(bt.loaded?" ok":"")+'">'+(bt.loaded?"已装载":"未装载")+"</span>";let yt=n.createElement("div");yt.className="urppp-store-ops";let Ft=n.createElement("button");Ft.type="button",Ft.textContent="重新装载",Ft.addEventListener("click",async()=>{Ft.disabled=!0,Ft.textContent="装载中…";try{let It=await V(tt.id,null);Ft.textContent=It?"已装载":"装载失败",f("loaded",tt.id)}catch{Ft.textContent="装载失败"}setTimeout(()=>{Ft.disabled=!1,Ft.textContent="重新装载"},1400)});let Pt=n.createElement("button");Pt.type="button",Pt.className="danger",Pt.textContent="卸载",Pt.addEventListener("click",()=>{ct(tt.id),A(`${te}${tt.id}_code`,""),A(`${te}${tt.id}_enabled`,!1),f("unregistered",tt.id),wt(B)}),yt.appendChild(Ft),yt.appendChild(Pt),ht.appendChild(zt),ht.appendChild(yt),B.appendChild(ht)})}a(wt,"renderStoreManage");function Ct(){let B={};return S.forEach(Y=>{if(Y.subpanels&&typeof Y.subpanels=="function"){let tt=Y.subpanels();Object.keys(tt||{}).forEach(bt=>{B[bt]=tt[bt]})}else Y.subpanels&&typeof Y.subpanels=="object"&&Object.keys(Y.subpanels).forEach(tt=>{B[tt]=Y.subpanels[tt]})}),B}return a(Ct,"collectSubpanels"),{api:st,install:V,update:ot,renderAssistUi:gt,openPluginStore:dt,bootFromCache:X,register:U}}a(co,"createPluginManager");function Np(p){let{document:n,getSettings:c,setSettings:d,validateMapping:u,defaultMapping:A,getRecoveryMessage:P=a(()=>"","getRecoveryMessage")}=p;function _(g,k,T){let C=g&&g.querySelector("#urppp-set-json-status");C&&(C.textContent=k||"",C.classList.toggle("urppp-status-error",!!T),C.style.color=T?"var(--danger,#b91c1c)":"var(--text-muted)")}a(_,"setStatus");function y(g,k){if(!g)return;let T=c(),C=g.querySelector("#urppp-set-json-custom"),f=g.querySelector("#urppp-set-json-editor"),b=g.querySelector("#urppp-set-json-mapping");C&&(C.classList.toggle("ac",T.enabled),C.setAttribute("aria-pressed",T.enabled?"true":"false"),C.textContent="自定义 JSON："+(T.enabled?"开":"关")),f&&(f.style.display=T.enabled?"grid":"none"),b&&(k||!g.__urpppJsonMappingDirty&&n.activeElement!==b)&&(b.value=JSON.stringify(T.mapping,null,2),g.__urpppJsonMappingDirty=!1);let w=P();w&&_(g,w,!0)}a(y,"sync");function S(g){if(!g||g.__urpppJsonSettingsBound)return;g.__urpppJsonSettingsBound=!0;let k=g.querySelector("#urppp-set-json-custom"),T=g.querySelector("#urppp-set-json-mapping"),C=g.querySelector("#urppp-set-json-save"),f=g.querySelector("#urppp-set-json-reset");T&&T.addEventListener("input",()=>{g.__urpppJsonMappingDirty=!0}),k&&k.addEventListener("click",()=>{let b=c();b.enabled=!b.enabled;let w=!!g.__urpppJsonMappingDirty;d(b),y(g,!1);let x=b.enabled?"已启用自定义 JSON 格式":"已恢复小爱课程兼容格式";_(g,w?x+"；未保存草稿已保留":x)}),C&&C.addEventListener("click",()=>{try{let b=JSON.parse(String(T&&T.value||"").trim()),w=c();w.mapping=u(b),d(w),g.__urpppJsonMappingDirty=!1,y(g,!0),_(g,"自定义 JSON 映射已保存")}catch(b){_(g,b&&b.message||String(b),!0)}}),f&&f.addEventListener("click",()=>{let b=c();b.mapping=u(A),d(b),g.__urpppJsonMappingDirty=!1,y(g,!0),_(g,"已恢复默认字段映射")})}return a(S,"bind"),{bind:S,setStatus:_,sync:y}}a(Np,"createJsonSettingsController");var _r="••••";var Bp={name:{enabled:!1,replacement:"同学"},identity:{enabled:!0,replacement:"已隐藏"},organization:{enabled:!0,replacement:"已隐藏"},contact:{enabled:!0,replacement:"已隐藏"},grade:{enabled:!0,replacement:"已隐藏"},gpa:{enabled:!0,replacement:"••••"},credit:{enabled:!0,replacement:"••••"},other:{enabled:!0,replacement:"已隐藏"},avatar:{enabled:!0,replacement:""},schedule:{enabled:!1,replacement:"课表已隐藏"}},vc=["completedCourses","failedCourses","majorGpa","majorPlan","remainingCourses","passingTotalCredit","passingAvgScore","passingAvgGpa","passingRequiredCredit","passingRequiredAvg","passingRequiredGpa","schemeTotalCredit","schemeAvgScore","schemeAvgGpa","schemeRequiredCredit","schemeRequiredAvg","schemeRequiredGpa"];function uo(p){let n=p&&typeof p=="object"?p:{},c=["off","one","custom"].includes(n.mode)?n.mode:"off",d={},u=n.fields&&typeof n.fields=="object"?n.fields:{},A=u.score&&typeof u.score=="object"?u.score:null;Object.keys(Bp).forEach(g=>{let k=Bp[g],T=["grade","gpa","credit"].includes(g)?A:null,C=g==="other"&&u.grade&&typeof u.grade=="object"?u.grade:null,f=u[g]&&typeof u[g]=="object"?u[g]:T||C||{};d[g]={enabled:g==="name"?!1:f.enabled==null?k.enabled:!!f.enabled,replacement:String(f.replacement==null?k.replacement:f.replacement).slice(0,80)}});let P=n.homepage&&typeof n.homepage=="object"?n.homepage:{},_=n.directEdit&&typeof n.directEdit=="object"?n.directEdit:P,y=_.values&&typeof _.values=="object"?_.values:{},S={};return vc.forEach(g=>{S[g]=String(y[g]==null?"":y[g]).trim().slice(0,80)}),{mode:c,mask:_r,fields:d,directEdit:{enabled:!!_.enabled,values:S}}}a(uo,"normalizePrivacySettings");function Er(p){let n=p&&typeof p=="object"?p:{},c=String(n.avatar||"").trim();return{nameEnabled:!!n.nameEnabled,name:String(n.name||"").trim().slice(0,40),avatarEnabled:!!n.avatarEnabled,avatar:c.length<=3145728?c:"",avatarName:String(n.avatarName||"").trim().slice(0,120)}}a(Er,"normalizeCustomIdentity");function or(p){let n=String(p||"").trim();return n.length>3145728?"":/^(https?:\/\/|data:image\/(?:png|jpe?g|gif|webp);base64,)/i.test(n)?n:""}a(or,"validCustomAvatar");function wc(p,n=globalThis.FileReader){return new Promise((c,d)=>{if(!p||!/^image\/(png|jpeg|webp|gif)$/i.test(p.type||"")){d(new Error("请选择 PNG、JPG、WebP 或 GIF 图片"));return}if(p.size>2*1024*1024){d(new Error("本地头像不能超过 2MB"));return}let u=new n;u.onload=()=>c(String(u.result||"")),u.onerror=()=>d(new Error("读取头像失败")),u.readAsDataURL(p)})}a(wc,"readAvatarFile");function Fp(p){let{getPrivacySettings:n,setPrivacySettings:c,getCustomIdentity:d,setCustomIdentity:u,applyDisplay:A,refreshCleanDisplay:P,finishActiveDirectEdit:_,readAvatar:y=wc}=p;function S(f,b){let w=b.mode==="custom",x=f.querySelector(".urppp-direct-edit-control"),E=f.querySelector("#urppp-set-direct-edit-toggle");x&&(x.style.display=w?"flex":"none"),E&&(E.dataset.enabled=b.directEdit.enabled?"1":"0",E.classList.toggle("ac",b.directEdit.enabled),E.setAttribute("aria-pressed",b.directEdit.enabled?"true":"false"),E.textContent="页面内修改："+(b.directEdit.enabled?"开":"关"))}a(S,"syncDirectEdit");function g(f){if(!f)return;let b=n();f.querySelectorAll("[data-privacy-mode]").forEach($=>{let H=$.getAttribute("data-privacy-mode")===b.mode;$.classList.toggle("ac",H),$.setAttribute("aria-pressed",H?"true":"false")});let w=f.querySelector("#urppp-set-privacy-custom");w&&(w.style.display=b.mode==="custom"?"grid":"none"),Object.keys(b.fields).forEach($=>{let H=b.fields[$],G=f.querySelector('[data-privacy-field="'+$+'"]'),U=f.querySelector('[data-privacy-value="'+$+'"]');G&&(G.checked=!!H.enabled),U&&(U.value=H.replacement||"",U.disabled=!H.enabled)}),S(f,b);let x=d(),E=f.querySelector("#urppp-set-name-enabled"),q=f.querySelector("#urppp-set-custom-name"),I=f.querySelector("#urppp-set-avatar-enabled"),L=f.querySelector("#urppp-set-custom-avatar-url"),O=f.querySelector("#urppp-set-avatar-preview");if(E&&(E.checked=x.nameEnabled),q&&(q.value=x.name,q.disabled=!x.nameEnabled),I&&(I.checked=x.avatarEnabled),L&&(L.value=/^data:image\//i.test(x.avatar)?"":x.avatar,L.disabled=!x.avatarEnabled),f.__urpppAvatarSource=x.avatar,O){let $=or(x.avatar);O.style.display=$?"block":"none",$?O.src=$:O.removeAttribute("src")}}a(g,"sync");function k(f){let b=n();Object.keys(b.fields).forEach(x=>{let E=f.querySelector('[data-privacy-field="'+x+'"]'),q=f.querySelector('[data-privacy-value="'+x+'"]');E&&(b.fields[x].enabled=!!E.checked),q&&(b.fields[x].replacement=String(q.value||"").trim().slice(0,80))});let w=f.querySelector("#urppp-set-direct-edit-toggle");return b.directEdit.enabled=!!(w&&w.dataset.enabled==="1"),b}a(k,"collect");function T(f,b,w){let x=f&&f.querySelector("#urppp-set-privacy-status");x&&(x.textContent=b||"",x.style.color=w?"#b91c1c":"var(--text-muted)")}a(T,"setStatus");function C(f){if(!f||f.__urpppPrivacyBound)return;f.__urpppPrivacyBound=!0,f.querySelectorAll("[data-privacy-mode]").forEach(L=>{L.addEventListener("click",()=>{let O=n();O.mode=L.getAttribute("data-privacy-mode")||"off",c(O),g(f),A()})}),f.querySelectorAll("[data-privacy-field]").forEach(L=>{L.addEventListener("change",()=>{let O=L.getAttribute("data-privacy-field"),$=f.querySelector('[data-privacy-value="'+O+'"]');$&&($.disabled=!L.checked)})});let b=f.querySelector("#urppp-set-direct-edit-toggle");b&&b.addEventListener("click",()=>{let L=b.dataset.enabled!=="1";b.dataset.enabled=L?"1":"0",b.classList.toggle("ac",L),b.setAttribute("aria-pressed",L?"true":"false"),b.textContent="页面内修改："+(L?"开":"关")});let w=f.querySelector("#urppp-set-name-enabled"),x=f.querySelector("#urppp-set-avatar-enabled");w&&w.addEventListener("change",()=>{let L=f.querySelector("#urppp-set-custom-name");L&&(L.disabled=!w.checked)}),x&&x.addEventListener("change",()=>{let L=f.querySelector("#urppp-set-custom-avatar-url");L&&(L.disabled=!x.checked)});let E=f.querySelector("#urppp-set-custom-avatar-file");E&&E.addEventListener("change",async()=>{try{let L=await y(E.files&&E.files[0]);f.__urpppAvatarSource=L;let O=f.querySelector("#urppp-set-avatar-preview");O&&(O.src=L,O.style.display="block"),x&&(x.checked=!0),T(f,"本地头像已读取，点击保存后生效")}catch(L){T(f,L&&L.message||String(L),!0)}});let q=f.querySelector("#urppp-set-avatar-clear");q&&q.addEventListener("click",()=>{try{let L=d();L.avatarEnabled=!1,L.avatar="",L.avatarName="",u(L),f.__urpppAvatarSource="",g(f),A(),P(),T(f,"已清除自定义头像")}catch(L){T(f,L&&L.message||"清除自定义头像失败",!0)}});let I=f.querySelector("#urppp-set-privacy-save");I&&I.addEventListener("click",()=>{let L=n(),O=d();try{let $=k(f),H=f.querySelector("#urppp-set-custom-avatar-url"),U=String(H&&H.value||"").trim()||f.__urpppAvatarSource||"",et=Er({nameEnabled:!!(w&&w.checked),name:String(f.querySelector("#urppp-set-custom-name")?.value||"").trim(),avatarEnabled:!!(x&&x.checked),avatar:U,avatarName:O.avatarName});if(et.avatarEnabled&&!or(et.avatar))throw new Error("头像地址必须是 http(s) 图片或已选择的本地图片");L.directEdit.enabled&&!$.directEdit.enabled&&_(!0);try{u(et),c($)}catch(it){try{u(O),c(L)}catch{}throw it}A(),P(),g(f),T(f,"隐私与显示设置已保存")}catch($){T(f,$&&$.message||String($),!0)}})}return a(C,"bind"),{bind:C,collect:k,setStatus:T,sync:g}}a(Fp,"createPrivacySettingsController");function Dp(p){let{document:n,theme:c,preferences:d,accent:u,syncPanel:A}=p;function P(){c.getFollowSystem()?c.apply(c.resolveFollowTheme(),{system:!0}):c.apply("scu-red",{manual:!0})}a(P,"applyAccentTheme");function _(S,g){let k=S.querySelector("#urppp-set-schemes");if(!k)return;let T=u.getScheme();k.innerHTML="",u.listSchemePreviews(g).forEach(C=>{let f=n.createElement("button");f.type="button",f.className="urppp-set-scheme"+(C.id===T?" ac":""),f.innerHTML=['<div class="urppp-set-scheme-preview">','  <span style="background:'+C.bg+'"></span>','  <span style="background:'+C.surface+";border-color:"+C.border+'"></span>','  <span style="background:'+C.primary+'"></span>',"</div>",'<div class="urppp-set-scheme-meta">',"  <strong>"+C.name+"</strong>","  <em>"+C.desc+"</em>","</div>"].join(""),f.addEventListener("click",()=>{u.setAccent(g),u.setScheme(C.id),P(),A()}),k.appendChild(f)})}a(_,"renderSchemeChoices");function y(S){S.querySelectorAll(".urppp-set-mode").forEach(L=>{L.addEventListener("click",()=>{c.isModeAvailable(L.dataset.theme)&&(c.apply(L.dataset.theme,{manual:!0}),A())})});let g=S.querySelector("#urppp-set-follow");g&&g.addEventListener("click",()=>{if(!c.supportsDark())return;let L=!c.getFollowSystem();c.setFollowSystem(L),L?c.apply(c.resolveFollowTheme(),{system:!0}):c.apply(c.getCurrent(),{manual:!0}),A(),c.syncNavbar()});let k=S.querySelector("#urppp-set-follow-dynamic");k&&k.addEventListener("click",()=>{c.supportsDynamic()&&(c.getFollowSystem()?c.setFollowDynamic(!c.getFollowDynamic()):(c.setFollowSystem(!0),c.setFollowDynamic(!0)),c.apply(c.resolveFollowTheme(),{system:!0}),A(),c.syncNavbar())});let T=S.querySelector("#urppp-set-clean-default");T&&T.addEventListener("click",()=>{d.setCleanDefault(!d.getCleanDefault()),A()});let C=S.querySelector("#urppp-set-clean-analysis");C&&C.addEventListener("click",()=>{let L=d.getCleanAnalysis()==="direct";d.setCleanAnalysis(L?"tab":"direct"),A()});let f=S.querySelector("#urppp-set-apple-edge");f&&f.addEventListener("click",()=>{d.setAppleEdge(!d.getAppleEdge());try{d.applySkin()}catch{}A()});let b=S.querySelector("#urppp-set-auto-update");b&&b.addEventListener("click",()=>{d.setAutoUpdate(!d.getAutoUpdate()),A()});let w=S.querySelector("#urppp-set-check-update");w&&!w.__urpppBound&&(w.__urpppBound=!0,w.addEventListener("click",()=>{d.checkUpdates()}));let x=S.querySelector("#urppp-set-color"),E=S.querySelector("#urppp-set-hex");if(!x||!E)return;x.addEventListener("input",()=>{E.value=x.value.toUpperCase()}),E.addEventListener("change",()=>{let L=u.normalize(E.value);L&&(E.value=L,x.value=L)});let q=S.querySelector("#urppp-set-gen");q&&q.addEventListener("click",()=>{let L=u.normalize(E.value)||x.value;L&&(u.setAccent(u.normalize(L)),P(),A())});let I=S.querySelector("#urppp-set-save");I&&I.addEventListener("click",()=>{let L=u.normalize(E.value)||x.value;L&&(u.savePreset(L),u.setAccent(u.normalize(L)),P(),A())}),x.addEventListener("change",()=>{let L=u.normalize(x.value);L&&(E.value=L,_(S,L))})}return a(y,"bind"),{bind:y,renderSchemeChoices:_}}a(Dp,"createThemeSettingsController");function jp(p,n){let{seed:c,currentTheme:d,followSystem:u,skinId:A,darkSupported:P,dynamicSupported:_,fixedPalettes:y,followUseDynamic:S,cleanDefault:g,cleanAnalysis:k,appleEdge:T,autoUpdate:C,modeAvailability:f}=n,b=p.querySelector("#urppp-set-color"),w=p.querySelector("#urppp-set-hex");b&&(b.value=c),w&&(w.value=c),p.querySelectorAll(".urppp-set-mode").forEach(U=>{let et=U.dataset.theme,it=f[et]!==!1,mt=!u&&et===d&&it;U.disabled=!it,U.classList.toggle("ac",mt),U.classList.toggle("urppp-dyn-disabled",!it),U.setAttribute("aria-disabled",it?"false":"true"),it?U.removeAttribute("title"):U.title=et==="dark"?"当前界面风格不支持暗色模式":"当前界面风格不支持动态配色"});let x=p.querySelector("#urppp-set-follow");x&&(x.disabled=!P,x.classList.toggle("ac",u&&P),x.classList.toggle("urppp-dyn-disabled",!P),x.setAttribute("aria-pressed",u&&P?"true":"false"),x.textContent=u&&P?"跟随系统：开":"跟随系统：关",x.title=P?"":"当前界面风格不支持暗色模式");let E=p.querySelector("#urppp-set-follow-dynamic");E&&(E.classList.toggle("ac",S&&_),E.setAttribute("aria-pressed",S&&_?"true":"false"),E.textContent=S?"浅色用动态配色：开":"浅色用动态配色：关",E.disabled=!u||!_,E.classList.toggle("urppp-dyn-disabled",!_),E.style.opacity=_&&u?"1":"0.5",E.title=_?"":"当前界面风格不支持动态配色");let q=p.querySelector("#urppp-set-dynamic");q&&(q.style.display=_?"":"none",q.style.opacity="1",q.classList.toggle("urppp-dyn-disabled",!1),q.querySelectorAll("button, input, .urppp-set-scheme, .urppp-set-swatch").forEach(U=>{U.disabled=!1,U.classList.toggle("urppp-dyn-disabled",!1)}),q.querySelectorAll("h3, .urppp-set-tip, label").forEach(U=>{U.classList.toggle("urppp-dyn-disabled",!1)}));let I=p.querySelector("#urppp-set-brutal");I&&(I.style.display=y?"":"none");let L=p.querySelector("#urppp-set-clean-default");L&&(L.classList.toggle("ac",g),L.setAttribute("aria-pressed",g?"true":"false"),L.textContent=g?"默认进入清爽模式：开":"默认进入清爽模式：关");let O=p.querySelector("#urppp-set-clean-analysis");if(O){let U=k==="direct";O.classList.toggle("ac",U),O.setAttribute("aria-pressed",U?"true":"false"),O.textContent=U?"清爽成绩分析展示：直接显示":"清爽成绩分析展示：选项卡"}let $=p.querySelector("#urppp-set-apple-edge"),H=p.querySelector("#urppp-set-apple-edge-tip");if($){let U=A==="apple";$.style.display=U?"":"none",H&&(H.style.display=U?"":"none"),U&&($.classList.toggle("ac",T),$.setAttribute("aria-pressed",T?"true":"false"),$.textContent=T?"类Apple边缘线条：开":"类Apple边缘线条：关")}let G=p.querySelector("#urppp-set-auto-update");G&&(G.classList.toggle("ac",C),G.setAttribute("aria-pressed",C?"true":"false"),G.textContent=C?"自动检测更新：开":"自动检测更新：关")}a(jp,"syncThemeSettingsControls");function mo(p){let n=String(p||"").replace(/\s+/g,"");return/^[•·●○▪◆★\-–]$/.test(n)||/^\d{1,4}$/.test(n)}a(mo,"isNoticeBulletText");function kc(p){return/\d{4}[-/.年]\d{1,2}([-/.月]\d{1,2})?/.test(String(p||""))}a(kc,"isNoticeDateText");function Op({pathname:p="",href:n="",title:c="",headingText:d=""}={}){return/courseSelectNotice|evaluationNotice|notice\/index/i.test(`${p} ${n}`)?!0:/评估公告|通知公告|选课公告|公告|通知/.test(`${c} ${d}`)}a(Op,"isNoticePageContext");function ho(p,{noticePage:n=!1}={}){if(!p)return!1;let d=(p.querySelector("thead")?.textContent||"").replace(/\s+/g,"");if(/标题/.test(d)&&/发布时间|发布日期|日期|时间/.test(d)||n&&/标题|公告|通知/.test(d)&&!/教室|教学楼|课程号|成绩|学号|座位数/.test(d))return!0;let u=p.querySelectorAll("tbody tr, tr"),A=0;if(u.forEach(_=>{let y=_.querySelectorAll("td");y.length<2||y.length>4||mo(y[0].textContent)&&_.querySelector("a")&&kc(_.textContent)&&(A+=1)}),A<1)return!1;if(n||A===u.length)return!0;let P=p.getAttribute("style")||"";return/dashed/i.test(P)||p.classList.contains("no-border-top")||!!p.getAttribute("width")}a(ho,"isNoticeListTable");function Hp(p,{noticePage:n=!1}={}){if(!p)return!0;if(p.classList?.contains("urppp-notice-table")||ho(p,{noticePage:n}))return!1;let c=`${p.id||""} ${p.getAttribute("class")||""}`;if(/freeClassroom|courseTable|codeTable|jszhpjdf|score|grade|exam|drag|classroom/i.test(c)||p.querySelector('#tbodyFreeClassroom, tbody[id*="FreeClassroom"], tbody[id*="Classroom"], tbody[id*="course"], tbody[id*="Code"]'))return!0;let d=p.querySelector("tbody tr, tr");if(d&&d.querySelectorAll("td,th").length>=5)return!0;let A=(p.querySelector("thead")?.textContent||"").replace(/\s+/g,"");return!!(A&&(/校区|教学楼|教室|座位数|类型|课表|操作|课程号|课程名|成绩|学号|姓名|教师|周次|节次/.test(A)||/序号/.test(A)&&!/标题|公告|通知|发布时间/.test(A))||p.querySelector("a")&&/课表|教室信息|查看/.test(p.textContent||"")&&!n&&/座位数|教学楼|教室号|校区名/.test(p.textContent||""))}a(Hp,"isBusinessDataTable");function Rp({isNativePdfIsolationActive:p,isBusinessDataTable:n,documentRef:c=document,windowRef:d=window,MutationObserverRef:u=MutationObserver,getComputedStyleRef:A=getComputedStyle}){function P(){p()||c.querySelectorAll("table.table, table.table-bordered, table.dataTable").forEach(y=>{if(!y||y.closest(".urppp-table-wrap")||y.id==="courseTable"||y.closest(".modal, .modal-dialog, .modal-content, .modal-body, #work_rest_schedule_modal")||y.classList.contains("urppp-wrs-table")||y.classList.contains("urppp-notice-table"))return;n(y);let S=y.parentElement;if(!S)return;let g=S.style?.overflow||A(S).overflow;if(S.id?.endsWith("_scroll")||g==="auto"||g==="scroll"){S.classList.add("urppp-scroll-table-host");return}let T=c.createElement("div");T.className="urppp-table-wrap",S.insertBefore(T,y),T.appendChild(y)})}a(P,"wrapTables");function _(){let y=c.getElementById("page-content-template")||c.querySelector(".page-content")||c.body;if(!y)return;let S=d.__urpppTableObsRoot;if(d.__urpppTableObs&&S===y&&y.isConnected)return;d.__urpppTableObs&&d.__urpppTableObs.disconnect();let g=0,k=new u(()=>{clearTimeout(g),g=setTimeout(P,80)});k.observe(y,{childList:!0,subtree:!0}),d.__urpppTableObs=k,d.__urpppTableObsRoot=y}return a(_,"bindTableWrapObserver"),{bindTableWrapObserver:_,wrapTables:P}}a(Rp,"createTableWrapper");function Up(p){let n=String(p||"").trim().toLowerCase();if(!n||n==="transparent"||n==="inherit"||n==="initial")return!1;if(/#(?:f{3,6}|e[0-9a-f]{5}|d[89a-f][0-9a-f]{4}|c[89a-f][0-9a-f]{4})/i.test(n))return!0;let c=n.match(/rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/i);if(!c)return!1;let d=Number(c[1]),u=Number(c[2]),A=Number(c[3]);return(d+u+A)/3>=200}a(Up,"isLightInlineColor");function Ac(p){if(!p?.style)return;let n=p.getAttribute("style")||"";if(!n||!/background/i.test(n))return;let c=p.style.backgroundColor||p.style.background||"";(Up(c)||/background(-color|-image)?\s*:/i.test(n))&&(p.style.removeProperty("background"),p.style.removeProperty("background-color"),p.style.removeProperty("background-image")),["borderColor","borderTopColor","borderRightColor","borderBottomColor","borderLeftColor"].forEach(d=>{let u=p.style[d];!u||!Up(u)||p.style.removeProperty(d.replace(/[A-Z]/g,A=>`-${A.toLowerCase()}`))}),/border(-color)?\s*:/i.test(n)&&/#e6e6e6|#eee|#ddd|#ccc/i.test(n)&&(p.style.removeProperty("border-color"),p.style.removeProperty("border-top-color"),p.style.removeProperty("border-right-color"),p.style.removeProperty("border-bottom-color"),p.style.removeProperty("border-left-color"))}a(Ac,"scrubLightInlineBackground");function Wp({isNativePdfIsolationActive:p,documentRef:n=document,windowRef:c=window,MutationObserverRef:d=MutationObserver}){function u(){if(!p())try{let P=n.documentElement.classList.contains("urppp-theme-dark"),_=n.body?.classList.contains("urppp-dark");if(!P&&!_)return;n.querySelectorAll("table, table thead, table thead tr, table thead th, table thead td, table tbody, table tbody tr, table tbody td, table tbody th, .table-box, .table-box table, .table-box td, .table-box th").forEach(Ac)}catch{}}a(u,"scrubTableHeaderInlineBg");function A(){[0,200,800,1600].forEach(P=>setTimeout(()=>{try{u()}catch{}},P));try{let P=n.querySelector(".page-content, #page-content-template, .main-content")||n.body;if(!P)return;let _=c.__urpppTableScrubObs;if(_&&_.root===P&&P.isConnected)return;_?.observer&&_.observer.disconnect();let y=new d(()=>{clearTimeout(c.__urpppTableScrubTimer),c.__urpppTableScrubTimer=setTimeout(()=>{try{u()}catch{}},120)});y.observe(P,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class"]}),c.__urpppTableScrubObs={root:P,observer:y}}catch{}}return a(A,"scheduleScrubTableInlineBg"),{scheduleScrubTableInlineBg:A,scrubTableHeaderInlineBg:u}}a(Wp,"createTableInlineStyleScrubber");function Gp({beautifyPagebar:p,documentRef:n=document,windowRef:c=window,MutationObserverRef:d=MutationObserver,setTimeoutRef:u=setTimeout,clearTimeoutRef:A=clearTimeout}){function P(){p(),n.querySelectorAll("#urppagebar").forEach(y=>{if(y.__urpppPagebarObs)return;y.__urpppPagebarObs=!0,new d(()=>{A(c.__urpppPagebarTimer),c.__urpppPagebarTimer=u(()=>p(y.parentElement||n),150)}).observe(y,{childList:!0,subtree:!0})})}a(P,"run");function _(){if(c.__urpppPagebarBound){u(P,0);return}c.__urpppPagebarBound=!0,[0,300,1e3,2500].forEach(y=>u(P,y))}return a(_,"scheduleBeautifyPagebar"),{scheduleBeautifyPagebar:_}}a(Gp,"createPagebarLifecycle");function Jp({destroyPagebarChosen:p,documentRef:n=document,logger:c=console}){function d(u){try{(u?.querySelectorAll?u.querySelectorAll("#urppagebar"):n.querySelectorAll("#urppagebar")).forEach(P=>{if(!P)return;P.classList.add("urppp-pagebar"),P.style.setProperty("display","block","important"),P.style.setProperty("width","100%","important"),P.style.setProperty("line-height","1.5","important");let _=P.querySelector('.dataTables_paginate, [id^="sample-table-2_paginate_"]')||P,y=Array.from(P.querySelectorAll('[id^="span_page_txt_"]')).map(f=>String(f.textContent||"").trim()).join(""),S=P.querySelector('select[id^="pagination_pageSize_"]'),g=S?String(S.value||""):"",k=P.querySelector('[id^="turnpageto_"]'),T=!!(k&&(k.readOnly||k.hasAttribute("readonly")));if(!(y.includes("转到")&&!T&&!g.includes("_"))){P.classList.add("urppp-pagebar-scroll"),P.classList.remove("urppp-pagebar-jump"),P.querySelectorAll('ul.pagination, [id^="pagination_ul_"]').forEach(f=>{f.style.setProperty("display","none","important")}),P.querySelectorAll("select").forEach(f=>{p(f),f.style.setProperty("width","128px","important"),f.style.setProperty("min-width","128px","important"),f.style.setProperty("max-width","128px","important")}),P.querySelectorAll(".chosen-container").forEach(f=>{try{f.style.setProperty("display","none","important")}catch{}});return}P.classList.add("urppp-pagebar-jump"),P.classList.remove("urppp-pagebar-scroll"),_.style.setProperty("display","flex","important"),_.style.setProperty("align-items","center","important"),_.style.setProperty("flex-wrap","wrap","important"),_.style.setProperty("gap","8px","important"),_.style.setProperty("position","relative","important"),_.style.setProperty("line-height","1.5","important"),P.querySelectorAll("ul.pagination").forEach(f=>{f.classList.add("urppp-pagination"),f.style.cssText=["display:inline-flex !important","align-items:center !important","flex-wrap:wrap !important","gap:4px !important","margin:0 !important","padding:0 !important","list-style:none !important","float:none !important","position:static !important"].join(";")}),P.querySelectorAll("ul.pagination > li").forEach(f=>{let b=f.classList.contains("active"),w=f.classList.contains("disabled"),x=f.classList.contains("previous")||/previous/i.test(f.getAttribute("name")||""),E=f.classList.contains("next")||/next/i.test(f.getAttribute("name")||"");f.classList.add("urppp-page-li"),b&&f.classList.add("urppp-page-li-active"),w&&f.classList.add("urppp-page-li-disabled"),x&&f.classList.add("urppp-page-li-prev"),E&&f.classList.add("urppp-page-li-next"),f.style.cssText=["display:inline-flex !important","align-items:center !important","justify-content:center !important","float:none !important","position:static !important","margin:0 !important","padding:0 !important","list-style:none !important","border:none !important","background:transparent !important","height:auto !important","min-height:0 !important"].join(";");let q=f.querySelector(":scope > span, :scope > a")||f.firstElementChild;if(!q)return;q.classList.add("urppp-page-chip"),b&&q.classList.add("urppp-page-chip-active"),w&&q.classList.add("urppp-page-chip-disabled"),(x||E)&&q.classList.add("urppp-page-chip-nav");let I=x||E?"72px":"40px",L=b?"var(--pagination-active-bg, var(--primary))":"var(--surface)",O=b?"var(--pagination-active-border, var(--primary))":"var(--border)",$=b?"var(--pagination-active-foreground, var(--primary-foreground, #fff))":w?"var(--text-muted)":"var(--text)";q.style.cssText=["display:inline-flex !important","align-items:center !important","justify-content:center !important","box-sizing:border-box !important","float:none !important","position:static !important","width:auto !important",`min-width:${I} !important`,"height:36px !important","min-height:36px !important","max-height:36px !important","padding:0 12px !important","margin:0 !important","line-height:36px !important","font-size:14px !important","font-weight:600 !important","border-radius:8px !important",`border:1px solid ${O} !important`,`background:${L} !important`,`color:${$} !important`,"box-shadow:none !important","text-decoration:none !important",`cursor:${w?"default":"pointer"} !important`,"white-space:nowrap !important","overflow:hidden !important"].join(";")}),P.querySelectorAll('[id^="btn_turnpageto_"]').forEach(f=>{f.classList.add("urppp-page-confirm"),f.style.setProperty("position","static","important"),f.style.setProperty("left","auto","important"),f.style.setProperty("top","auto","important"),f.style.setProperty("float","none","important"),f.style.setProperty("height","32px","important"),f.style.setProperty("min-width","52px","important"),f.style.setProperty("padding","0 12px","important"),f.style.setProperty("margin","0 4px","important"),f.style.setProperty("font-size","13px","important"),f.style.setProperty("line-height","1","important"),f.style.setProperty("vertical-align","middle","important")}),P.querySelectorAll('[id^="turnpageto_"]').forEach(f=>{f.classList.add("urppp-page-goto"),f.style.setProperty("position","static","important"),f.style.setProperty("display","inline-block","important"),f.style.setProperty("height","32px","important"),f.style.setProperty("width","48px","important"),f.style.setProperty("margin","0 4px","important"),f.style.setProperty("padding","4px 8px","important"),f.style.setProperty("font-size","14px","important"),f.style.setProperty("line-height","1.2","important"),f.style.setProperty("box-sizing","border-box","important"),f.style.setProperty("vertical-align","middle","important");let b=f.parentElement;b?.tagName==="SPAN"&&(b.style.setProperty("position","static","important"),b.style.setProperty("display","inline-flex","important"),b.style.setProperty("align-items","center","important"),b.style.setProperty("width","auto","important"),b.style.setProperty("height","auto","important"),b.style.setProperty("min-height","0","important"),b.style.setProperty("vertical-align","middle","important"))}),P.querySelectorAll('[id^="totalPage_show_"], [id^="span_page_txt_"]').forEach(f=>{f.style.setProperty("display","inline","important"),f.style.setProperty("border","none","important"),f.style.setProperty("background","transparent","important"),f.style.setProperty("padding","0","important"),f.style.setProperty("margin","0","important"),f.style.setProperty("height","auto","important"),f.style.setProperty("line-height","1.5","important"),f.style.setProperty("font-size","13px","important"),f.style.setProperty("color","var(--text-secondary, var(--text-muted))","important")})})}catch(A){c.warn("[URP++] pagebar beautify failed",A)}}return a(d,"beautifyPagebar"),{beautifyPagebar:d}}a(Jp,"createPagebarBeautifier");function Vp({beautifyNoticeTables:p,pinNoticeRowSurface:n,documentRef:c=document,windowRef:d=window,MutationObserverRef:u=MutationObserver,requestAnimationFrameRef:A=requestAnimationFrame,setTimeoutRef:P=setTimeout,clearTimeoutRef:_=clearTimeout}){function y(){d.__urpppNoticeHoverScrub||(d.__urpppNoticeHoverScrub=!0,c.addEventListener("mouseout",g=>{let k=g.target?.closest?g.target.closest("table.urppp-notice-table tr.urppp-notice-row"):null;k&&A(()=>n(k))},!0))}a(y,"bindNoticeHoverScrub");function S(){[0,400,1500].forEach(g=>P(()=>{try{p()}catch{}},g));try{let g=c.getElementById("page-content-template")||c.querySelector(".page-content, .main-content")||c.body;if(!g)return;let k=d.__urpppNoticeObs;if(k&&k.root===g&&g.isConnected)return;k?.observer&&k.observer.disconnect();let T=new u(()=>{_(d.__urpppNoticeTimer),d.__urpppNoticeTimer=P(()=>{try{p()}catch{}},180)});T.observe(g,{childList:!0,subtree:!0}),d.__urpppNoticeObs={root:g,observer:T}}catch{}}return a(S,"scheduleBeautifyNoticeTables"),{bindNoticeHoverScrub:y,scheduleBeautifyNoticeTables:S}}a(Vp,"createNoticeTableLifecycle");function Yp({getCurrentTheme:p,documentRef:n=document,getComputedStyleRef:c=getComputedStyle}){function d(){try{return c(n.documentElement).getPropertyValue("--surface").trim()||(p()==="dark"?"#151A24":"#FFFFFF")}catch{return p()==="dark"?"#151A24":"#FFFFFF"}}a(d,"noticeSurfaceColor");function u(y){if(!y?.classList?.contains("urppp-notice-row"))return;let S=d();y.classList.remove("hover"),y.style.setProperty("background",S,"important"),y.style.setProperty("background-color",S,"important"),y.querySelectorAll("td, th").forEach(g=>{g.classList.remove("hover"),g.style.setProperty("background","transparent","important"),g.style.setProperty("background-color","transparent","important")})}a(u,"pinNoticeRowSurface");function A(y){try{let S=y||n;if(S.matches?.("tr.urppp-notice-row")){u(S);return}S.querySelectorAll("table.urppp-notice-table tr.urppp-notice-row").forEach(u)}catch{}}a(A,"scrubNoticeInlineBg");function P(y){y&&(y.classList.remove("table-hover","table-striped"),y.classList.add("urppp-notice-nohover"),y.querySelectorAll("tr.urppp-notice-row").forEach(S=>{S.classList.remove("hover"),u(S)}))}a(P,"disarmNoticeTableHover");function _(y){if(!y)return;y.classList.remove("urppp-notice-table"),delete y.dataset.urpppNoticeScan,y.style.removeProperty("border"),y.style.removeProperty("border-left"),y.style.removeProperty("background");let S=y.closest(".urppp-table-wrap.urppp-notice-wrap");S&&(S.classList.remove("urppp-notice-wrap"),S.style.removeProperty("border"),S.style.removeProperty("background"),S.style.removeProperty("box-shadow"),S.style.removeProperty("overflow"),S.style.removeProperty("border-radius")),y.querySelectorAll("tr.urppp-notice-row, td.urppp-notice-title-cell, td.urppp-notice-date-cell, td.urppp-notice-bullet-cell, a.urppp-notice-link, .urppp-notice-time, .urppp-notice-card").forEach(g=>{g.classList.remove("urppp-notice-row","urppp-notice-title-cell","urppp-notice-date-cell","urppp-notice-bullet-cell","urppp-notice-link","urppp-notice-time","urppp-notice-card","urppp-notice-card-row","urppp-notice-main","urppp-notice-meta","urppp-notice-title","urppp-notice-body"),(g.tagName==="TR"||g.tagName==="TD")&&["display","border","background","padding","margin","width","box-shadow","border-radius","float","position"].forEach(k=>{g.style.getPropertyPriority(k)==="important"&&g.style.removeProperty(k)}),delete g.dataset.urpppNoticeDone})}return a(_,"stripMistakenNoticeTable"),{disarmNoticeTableHover:P,pinNoticeRowSurface:u,scrubNoticeInlineBg:A,stripMistakenNoticeTable:_}}a(Yp,"createNoticeTableSurface");function Qp({isNativePdfIsolationActive:p,bindNoticeHoverScrub:n,scrubNoticeInlineBg:c,stripMistakenNoticeTable:d,disarmNoticeTableHover:u,pinNoticeRowSurface:A,isBusinessDataTable:P,isNoticeListTable:_,isNoticePageContext:y,isNoticeBulletText:S,documentRef:g=document,windowRef:k=window,logger:T=console}){function C(){if(!p())try{n(),c(),g.querySelectorAll("table.urppp-notice-table, table.table").forEach(b=>{P(b)&&(b.classList.contains("urppp-notice-table")||b.querySelector(".urppp-notice-row, .urppp-notice-title-cell"))&&d(b)});let f=new Set(g.querySelectorAll('.page-content table, #page-content-template table, .main-content table, table.table, table.urppp-notice-table, table[style*="dashed"], table.no-border-top'));y()?g.querySelectorAll("table").forEach(b=>f.add(b)):g.querySelectorAll("table").forEach(b=>{_(b)&&f.add(b)}),Array.from(f).forEach(b=>{if(!b||P(b))return;if(b.querySelector("thead th")&&b.querySelectorAll("thead th").length>=3){let L=b.querySelector("thead")?.textContent||"";if(!_(b)&&/序号|课程|成绩|教室|校区|学号|姓名|教学楼|座位|操作|类型/.test(L)&&!/标题|公告|通知/.test(L))return}let w=Array.from(b.querySelectorAll("tbody > tr, tr")).filter(L=>L.querySelector("td"));if(!w.length)return;let x=0;w.slice(0,12).forEach(L=>{let O=Array.from(L.children).filter(et=>et.tagName==="TD"||et.tagName==="TH");if(O.length>=5)return;let $=(L.textContent||"").replace(/\s+/g," ").trim(),H=!!L.querySelector("a[href], a[onclick], a"),G=/\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}/.test($),U=O.some(et=>S(et.textContent));(H&&G||U&&H||U&&G)&&(x+=1)});let E=b.classList.contains("no-border-top")||/dashed|border-left-style/.test(b.getAttribute("style")||""),q=y();if(x<1){if(q){if(w.slice(0,8).filter(O=>{let $=Array.from(O.children).filter(G=>G.tagName==="TD"||G.tagName==="TH");if($.length<1||$.length>4)return!1;let H=(O.textContent||"").replace(/\s+/g," ").trim();return!!O.querySelector("a")||/\d{4}/.test(H)}).length<1&&!E)return}else if(!(E&&/公告|通知/.test(g.title||"")))return}if(P(b))return;b.classList.add("urppp-notice-table"),b.dataset.urpppNoticeScan="1",u(b),b.style.setProperty("border","none","important"),b.style.setProperty("border-left","none","important"),b.style.setProperty("background","transparent","important"),b.style.setProperty("width","100%","important");let I=b.closest(".urppp-table-wrap");I&&(I.classList.add("urppp-notice-wrap"),I.style.setProperty("border","none","important"),I.style.setProperty("background","transparent","important"),I.style.setProperty("box-shadow","none","important"),I.style.setProperty("overflow","visible","important"),I.style.setProperty("border-radius","0","important")),w.forEach(L=>{if(L.dataset.urpppNoticeDone==="1")return;let O=Array.from(L.children).filter(V=>V.tagName==="TD"||V.tagName==="TH");if(!O.length)return;let $=a(V=>(V||"").replace(/\u00AD/g,"").replace(/\u200B/g,"").replace(/\s+/g," ").trim(),"clean");if(O.length>=2){let V=null,Q=null,ot=null;if(O.forEach((X,ct)=>{let rt=$(X.textContent),st=!!X.querySelector("a");if(!V&&S(rt)&&(ct===0||O.length>=2)){V=X;return}if(!ot&&(/\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}/.test(rt)||/\d{4}-\d{1,2}-\d{1,2}\s+\d{1,2}:\d{2}/.test(rt)||/text-align\s*:\s*right/i.test(X.getAttribute("style")||"")||ct===O.length-1&&rt.length<=28&&/\d{4}/.test(rt))&&/\d{4}/.test(rt)&&rt.length<=32){ot=X;return}!Q&&(st||rt.length>4)&&(Q=X)}),Q||(Q=O.find(X=>X!==V&&X!==ot)||O[0]),!ot&&O.length>=2){let X=O[O.length-1];X!==Q&&X!==V&&(ot=X)}if(L.classList.add("urppp-notice-row"),A(L),L.removeAttribute("width"),L.style.setProperty("flex-wrap","nowrap","important"),O.forEach(X=>{X.removeAttribute("width"),X.removeAttribute("height"),X.removeAttribute("align"),X.style.setProperty("border","none","important"),X.style.setProperty("background","transparent","important"),X.style.setProperty("vertical-align","middle","important"),X.style.removeProperty("width"),X.style.setProperty("width","auto","important")}),V&&(V.classList.add("urppp-notice-bullet-cell"),V.style.setProperty("display","none","important"),V.style.setProperty("width","0","important"),V.style.setProperty("padding","0","important")),Q){Q.classList.add("urppp-notice-title-cell"),Q.removeAttribute("width"),Q.style.setProperty("width","auto","important"),Q.style.setProperty("max-width","100%","important"),Q.style.setProperty("min-width","0","important"),Q.style.setProperty("flex","1 1 0%","important"),Q.style.setProperty("overflow","hidden","important"),Q.style.setProperty("padding","0","important"),Q.style.setProperty("pointer-events","auto","important"),Q.style.setProperty("white-space","nowrap","important");let X=Q.querySelector("a[href], a[onclick], a");if(X||(X=L.querySelector("a[href], a[onclick], a")),X){Q.contains(X)||(Q.innerHTML="",Q.appendChild(X)),X.classList.add("urppp-notice-link");let ct=X.getAttribute("href"),rt=X.getAttribute("onclick"),st=X.getAttribute("target"),gt=$(X.textContent);X.textContent=gt,ct!=null&&X.setAttribute("href",ct),rt!=null&&X.setAttribute("onclick",rt),st!=null&&X.setAttribute("target",st),X.style.setProperty("color","var(--text)","important"),X.style.setProperty("text-decoration","none","important"),X.style.setProperty("font-size","14px","important"),X.style.setProperty("font-weight","500","important"),X.style.setProperty("line-height","1.5","important"),X.style.setProperty("pointer-events","auto","important"),X.style.setProperty("cursor","pointer","important"),X.style.setProperty("position","relative","important"),X.style.setProperty("z-index","2","important"),X.style.setProperty("display","block","important"),X.style.setProperty("white-space","nowrap","important"),X.style.setProperty("overflow","hidden","important"),X.style.setProperty("text-overflow","ellipsis","important"),L.dataset.urpppNoticeClickBound!=="1"&&(L.dataset.urpppNoticeClickBound="1",L.style.setProperty("cursor","pointer","important"),L.addEventListener("click",Z=>{if(Z.target&&Z.target.closest&&Z.target.closest("a,button,input,select,textarea,label"))return;if(X.getAttribute("onclick")){X.click();return}let dt=X.getAttribute("href");if(!dt||dt==="#"||dt.indexOf("javascript:")===0){X.click();return}X.target==="_blank"?k.open(dt,"_blank"):k.location.href=dt}))}else{let ct=$(Q.textContent);ct&&!Q.querySelector("button, input, select")&&(!Q.querySelector("*")||Q.children.length===0)&&(Q.textContent=ct)}}if(ot){ot.classList.add("urppp-notice-date-cell"),ot.style.cssText=["display:flex !important","align-items:center !important","justify-content:flex-end !important","flex:0 0 auto !important","width:auto !important","max-width:none !important","white-space:nowrap !important","text-align:right !important","padding:0 !important","margin:0 0 0 auto !important","border:none !important","background:transparent !important","float:none !important","position:static !important","right:auto !important","left:auto !important","top:auto !important"].join(";");let X=$(ot.textContent);ot.innerHTML="";let ct=g.createElement("span");ct.className="urppp-notice-time",ct.textContent=X,ot.appendChild(ct)}Q&&(Q.style.setProperty("flex","1 1 auto","important"),Q.style.setProperty("min-width","0","important"),Q.style.setProperty("margin","0","important"),Q.style.setProperty("float","none","important"),Q.style.setProperty("position","static","important")),L.style.setProperty("display","flex","important"),L.style.setProperty("align-items","center","important"),L.style.setProperty("justify-content","space-between","important"),L.style.setProperty("gap","16px","important"),L.style.setProperty("max-width","100%","important"),L.style.setProperty("box-sizing","border-box","important"),L.style.setProperty("overflow","hidden","important"),L.dataset.urpppNoticeDone="1";return}let H=O[0],G=Array.from(H.querySelectorAll(":scope > span"));if(G.length<2){let V=H.querySelector("a"),Q=$(H.textContent),ot=Q.match(/(\d{4}[-/.年]\d{1,2}[-/.月]\d{1,2}(?:\s+\d{1,2}:\d{2}(?::\d{2})?)?)/);if(V||ot){L.classList.add("urppp-notice-row");let X=g.createElement("div");X.className="urppp-notice-card urppp-notice-card-row";let ct=g.createElement("div");if(ct.className="urppp-notice-main",V){V.classList.add("urppp-notice-link");let rt=V.getAttribute("href"),st=V.getAttribute("onclick"),gt=$(V.textContent);V.textContent=gt,rt!=null&&V.setAttribute("href",rt),st!=null&&V.setAttribute("onclick",st),V.style.setProperty("pointer-events","auto","important"),V.style.setProperty("cursor","pointer","important"),ct.appendChild(V),L.dataset.urpppNoticeClickBound!=="1"&&(L.dataset.urpppNoticeClickBound="1",L.style.setProperty("cursor","pointer","important"),L.addEventListener("click",Z=>{if(!(Z.target&&Z.target.closest&&Z.target.closest("a,button,input,select"))){if(V.getAttribute("onclick")||!V.getAttribute("href")||V.getAttribute("href")==="#"){V.click();return}k.location.href=V.getAttribute("href")}}))}else{let rt=g.createElement("div");rt.className="urppp-notice-title",rt.textContent=ot?Q.replace(ot[0],"").trim():Q,ct.appendChild(rt)}if(X.appendChild(ct),ot){let rt=g.createElement("div");rt.className="urppp-notice-meta";let st=g.createElement("span");st.className="urppp-notice-time",st.textContent=ot[1],rt.appendChild(st),X.appendChild(rt)}H.innerHTML="",H.appendChild(X),H.dataset.urpppNoticeDone="1",L.dataset.urpppNoticeDone="1"}return}let U=null,et=null,it=[];if(G.forEach(V=>{let Q=(V.getAttribute("style")||"")+" "+(V.style.cssText||""),ot=$(V.textContent);if(ot){if(/font-size\s*:\s*18/i.test(Q)||!U&&/font-size\s*:\s*1[6-9]/i.test(Q)){U=V;return}if(/font-size\s*:\s*12/i.test(Q)||/float\s*:\s*right/i.test(Q)||/^\d{4}-\d{2}-\d{2}/.test(ot)){et=V;return}it.push(V)}}),U||(U=G[0]),!et){let V=G[G.length-1];V!==U&&(et=V)}let mt=g.createElement("div");if(mt.className="urppp-notice-card",U){let V=g.createElement("div");V.className="urppp-notice-title",V.textContent=$(U.textContent),mt.appendChild(V)}if((it.length?it:G.filter(V=>V!==U&&V!==et)).forEach(V=>{let Q=g.createElement("div");Q.className="urppp-notice-body",Q.textContent=$(V.textContent),Q.textContent&&mt.appendChild(Q)}),et){let V=g.createElement("div");V.className="urppp-notice-meta";let Q=g.createElement("span");Q.className="urppp-notice-time",Q.textContent=$(et.textContent),V.appendChild(Q),mt.appendChild(V)}H.innerHTML="",H.appendChild(mt),H.dataset.urpppNoticeDone="1",L.dataset.urpppNoticeDone="1",L.classList.add("urppp-notice-row")})})}catch(f){T.warn("[URP++] notice table beautify failed",f)}}return a(C,"beautifyNoticeTables"),{beautifyNoticeTables:C}}a(Qp,"createNoticeTableBeautifier");var Xp={"page-content-template":"urppp-pdf-page",mycoursetable:"urppp-pdf-mycoursetable",courseTable:"urppp-pdf-courseTable",courseTableBody:"urppp-pdf-courseTableBody",h4_id1:"urppp-pdf-h4-1",h4_id2:"urppp-pdf-h4-2",infoTable:"urppp-pdf-info-table","rwskxxbg-course":"urppp-pdf-rwskxxbg","other-course":"urppp-pdf-other-course",temp_title:"urppp-pdf-temp-title",temp_subtitle:"urppp-pdf-temp-subtitle"};function Sc(p){return p.querySelectorAll('script, iframe, object, embed, [id^="urppp-"], [data-urppp]').forEach(n=>n.remove()),[p,...p.querySelectorAll("*")].forEach(n=>{Array.from(n.classList||[]).forEach(c=>{/^urppp(?:-|$)/.test(c)&&n.classList.remove(c)}),Array.from(n.attributes||[]).forEach(c=>{/^data-urppp(?:-|$)/.test(c.name)&&n.removeAttribute(c.name)}),n.style&&Array.from(n.style).forEach(c=>{n.style.getPropertyPriority(c)==="important"&&n.style.removeProperty(c)})}),p}a(Sc,"sanitizeNativePdfClone");function _c(p){return[p,...p.querySelectorAll("*")].forEach(n=>{n.id&&Xp[n.id]&&(n.id=Xp[n.id]),n.classList.contains("class_div")&&(n.classList.remove("class_div"),n.classList.remove("box_font"),n.classList.add("urppp-pdf-card")),n.classList.contains("course")&&(n.classList.remove("course"),n.classList.add("urppp-pdf-course"))}),p}a(_c,"renameNativePdfClone");function Ec(){let p=[];document.querySelectorAll('style[id^="urppp-"]').forEach(d=>{d.sheet&&!d.sheet.disabled&&(p.push(d),d.sheet.disabled=!0)});let n=0,c=document.getElementById("mycoursetable");return c&&(n=c.getBoundingClientRect().width),p.forEach(d=>{d.sheet.disabled=!1}),n}a(Ec,"measureNativeScheduleWidth");var Cc=`
...
`;function Pc(p){p.querySelectorAll("td, th").forEach(n=>{n.style.removeProperty("background"),n.style.removeProperty("background-color")}),p.querySelectorAll("th[rowspan]").forEach(n=>{n.style.removeProperty("width"),n.style.setProperty("white-space","nowrap"),n.style.setProperty("text-align","center")}),p.querySelectorAll("table").forEach(n=>{n.style.setProperty("background","#ffffff","important"),n.style.setProperty("background-color","#ffffff","important"),n.style.setProperty("border","none","important"),n.style.setProperty("color","#000000","important")}),p.querySelectorAll("th").forEach(n=>{if(n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important"),n.style.setProperty("font-weight","normal","important"),n.childNodes.length===1&&n.firstChild&&n.firstChild.nodeType===3){let c=document.createElement("span");c.textContent=n.textContent,n.textContent="",n.appendChild(c)}}),p.querySelectorAll("thead th").forEach(n=>{n.style.setProperty("background","#dddddd","important"),n.style.setProperty("background-color","#dddddd","important")}),p.querySelectorAll("tbody th").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important")}),p.querySelectorAll("td").forEach(n=>{n.style.setProperty("background","transparent","important"),n.style.setProperty("background-color","transparent","important"),n.style.setProperty("color","#000000","important"),n.style.setProperty("border","1px solid #dddddd","important")})}a(Pc,"normalizeNativePdfStage");function Kp(p){let n=Ec(),c=document.createElement("div");c.id="urppp-pdf-stage",c.style.cssText="position:fixed;left:-20000px;top:0;z-index:-1;pointer-events:none;width:"+(n||window.innerWidth||1440)+"px;";let d=document.createElement("div");d.id="urppp-pdf-page",d.style.cssText="position:relative;width:100%;box-sizing:border-box;";let u=p.cloneNode(!0);Sc(u),_c(u),d.appendChild(u),c.appendChild(d),Pc(u);let A=document.createElement("style");A.id="urppp-pdf-reset-style",A.textContent=Cc,document.head.appendChild(A),document.body.appendChild(c);let P=c.querySelector("#urppp-pdf-mycoursetable"),_=c.querySelector("#urppp-pdf-page")||c;if(!P)throw c.remove(),new Error("无法建立原生课表捕获节点");return{stage:c,target:P,page:_,sourceHost:p}}a(Kp,"cloneNativePdfStage");var pa=0;function de(){return pa>0}a(de,"isNativePdfIsolationActive");function zc(p){return!p||p.tagName!=="STYLE"?!1:/^urppp(?:-|$)/.test(p.id||"")||p.hasAttribute("data-urppp-style")?!0:(p.textContent||"").includes("urppp-")}a(zc,"isUrpppOwnedStyle");function Zp(){try{if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow}catch{}return typeof window<"u"?window:null}a(Zp,"defaultPage");function ti(p,n){let c=p&&typeof p.requestAnimationFrame=="function"?p.requestAnimationFrame.bind(p):typeof requestAnimationFrame=="function"?requestAnimationFrame:null;return c?c(n):setTimeout(n,0)}a(ti,"scheduleFrame");function Lc(p={}){let n=p.document||(typeof document<"u"?document:null),c=p.page||Zp();if(!n)throw new Error("原生 PDF 隔离缺少 document");let d=n.getElementById("mycoursetable");if(!d)throw new Error("当前页面没有课表节点");pa+=1;let u=[d,...d.querySelectorAll("*")],A=[],P=n.getElementById("soliderbox");P&&A.push(P);let _=d.parentElement;for(;_&&_!==n.documentElement;){let x=_.classList;(_.id==="page-content-template"||x&&(x.contains("page-content")||x.contains("profile-info-row")||x.contains("profile-info-value")))&&A.push(_),_=_.parentElement}let y=n.getElementById("page-content-template")||n.querySelector(".page-content");y&&!A.includes(y)&&A.push(y);let S=[...u,...A],g=S.map(x=>({element:x,style:x.getAttribute("style")})),k=Array.from(n.querySelectorAll("style")).filter(zc).map(x=>({style:x,disabled:x.sheet?x.sheet.disabled:!1,media:x.getAttribute("media")})),T=Array.from(d.querySelectorAll('[id^="urppp-"], [data-urppp]')),C=c&&c.divBuild,f=c&&c.__urpppOriginalDivBuild,b=!1,w=a(()=>{b||(b=!0,c&&c.divBuild===f&&typeof C=="function"&&(c.divBuild=C),g.forEach(({element:x,style:E})=>{x.isConnected&&(E===null?x.removeAttribute("style"):x.setAttribute("style",E))}),T.forEach(x=>x.removeAttribute("data-urppp-pdf-hidden")),k.forEach(({style:x,disabled:E,media:q})=>{try{q===null?x.removeAttribute("media"):x.setAttribute("media",q),x.sheet&&(x.sheet.disabled=E)}catch{}}),pa=Math.max(0,pa-1),ti(c,()=>{try{typeof p.onAfterRestore=="function"&&p.onAfterRestore()}catch{}}))},"restore");try{return k.forEach(({style:x})=>{try{x.setAttribute("media","not all"),x.sheet&&(x.sheet.disabled=!0)}catch{}}),S.forEach(x=>{!x.style||!x.style.length||Array.from(x.style).forEach(E=>{x.style.getPropertyPriority(E)==="important"&&(E==="height"&&x.matches("td, th")||x.style.removeProperty(E))})}),d.querySelectorAll("td").forEach(x=>{x.style.removeProperty("background"),x.style.removeProperty("background-color")}),y&&y.style.setProperty("position","relative","important"),d.style.setProperty("position","static","important"),d.querySelectorAll("td").forEach(x=>{x.style.setProperty("position","static","important")}),T.forEach(x=>{x.setAttribute("data-urppp-pdf-hidden","1"),x.style.setProperty("display","none","important")}),c&&typeof f=="function"&&(c.divBuild=f),w}catch(x){throw w(),x}}a(Lc,"isolateScheduleForNativeExport");function ei(p,n={}){return new Promise((c,d)=>{let u=n.page||Zp(),A=u&&u.back,P=u&&u.html2canvas;if(!p||typeof A!="function"){d(new Error("教务原生导出依赖未就绪"));return}let _=null;try{_=Lc(n)}catch(f){d(f);return}let y=0,S=!1,g=null,k=null,T=a(f=>{if(!S){S=!0,y&&clearTimeout(y),u&&g&&u.back===g&&(u.back=A),k&&u.html2canvas===k&&(u.html2canvas=P);try{_&&_()}catch{}f?d(f):c()}},"settle"),C=a(f=>T(f instanceof Error?f:new Error(String(f))),"fail");typeof P=="function"&&(k=a(function(){let f=P.apply(this,arguments);return f&&typeof f.catch=="function"&&f.catch(C),f},"scopedCanvas"),u.html2canvas=k),g=a(function(){try{return A.apply(this,arguments)}finally{setTimeout(()=>T(),0)}},"wrappedBack"),u.back=g,y=setTimeout(()=>{try{A.call(u)}catch{}C(new Error("原生 PDF 生成超时"))},n.timeoutMs||60*1e3),ti(u,()=>{try{p.click()}catch(f){C(f)}})})}a(ei,"exportNativePdfIsolated");var ri=`.urppp-private-value{font-family:inherit!important;font-size:inherit!important;font-weight:inherit!important;font-style:inherit!important;line-height:inherit!important;letter-spacing:0!important;color:inherit!important}
...
`;var oi=`/* Personal and resource schedule course cards. Keep table cells and table surfaces untouched. */
#courseTable .class_div.box_font {
  box-sizing: border-box !important;
...
`;var ni=`.urppp-export-wrap{position:relative!important;display:inline-flex!important;align-items:center!important;flex:0 0 auto!important;margin-left:7px!important;font-weight:400!important;vertical-align:middle!important;white-space:nowrap!important}
...
#urppp-confirm .urppp-confirm-ops .urppp-set-btn{flex:1}
...
`;var li=`/* ===== 插件弹窗统一进入动画：淡入+缩放 + 内容逐条浮现 ===== */
...
`;function mi(){return{open:!1,mobileTab:"home",scoreAnalysisTab:"overview",profile:null,schedule:null,scores:null,catalog:null,occupancy:null,currentBuilding:null,loading:{profile:!1,schedule:!1,scores:!1,room:!1},roomError:"",roomDateOffset:0,selected:{passing:new Set,scheme:new Set},activeSchemeIdx:0,_schemeUserSelected:!1,viewWeek:0,weekLocked:!1,_termWeek:0,_termWeekResolved:!1,uiReady:!1}}a(mi,"createCleanModeState");function hi(p){p.profile=null,p.schedule=null,p.scores=null,p.catalog=null,p.occupancy=null,p._termWeekResolved=!1,p._schemeUserSelected=!1,p._schemeInited=!1}a(hi,"resetCleanModeData");function bi({state:p,deps:n}){async function c(u){if(!u&&p.catalog&&p.catalog.length||p.loading.room)return p.catalog;p.loading.room=!0;try{n.render()}catch{}try{p.catalog=await n.loadClassroomCatalog(),p.roomError=""}catch(A){p.catalog=p.catalog||[],p.roomError=String(A&&A.message||A),console.warn("[URP++] room catalog",A)}finally{p.loading.room=!1;try{n.scheduleRender()}catch{}}return p.catalog}a(c,"ensureRoomCatalogLoaded");async function d(u){u&&hi(p),p.loading.profile=p.loading.schedule=p.loading.scores=!0;try{let A=await n.ensureTermWeekResolved();!p.weekLocked&&A>=1&&(p.viewWeek=A)}catch{}if(n.render(),await Promise.all([(async()=>{try{p.profile&&!u||(p.profile=await n.loadProfile()),n.reconcileProfileAndScores()}catch(A){p.profile={name:"同学",majorPlan:"主修方案",majorGpa:"—",avatar:""},console.warn(A)}finally{p.loading.profile=!1,n.scheduleRender()}})(),(async()=>{try{p.schedule&&!u||(p.schedule=await n.loadSchedule())}catch(A){p.schedule={courses:[],error:String(A&&A.message||A)}}finally{if(p.loading.schedule=!1,!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}})(),(async()=>{let A=null;try{p.scores&&!u||(p.scores=await n.loadScores(u)),A=p.scores,n.reconcileProfileAndScores(),A&&!A.error&&!A.evaluationReady&&n.enrichScoresWithEvaluation(A).then(()=>{p.scores===A&&(n.reconcileProfileAndScores(),n.scheduleRender())}).catch(P=>{console.warn("[URP++] attach evaluation",P)})}catch(P){p.scores={passing:[],schemes:[],error:String(P&&P.message||P)}}finally{p.loading.scores=!1,n.scheduleRender()}})()]),n.reconcileProfileAndScores(),!p.weekLocked){let A=n.getCurrentWeekNumber()||n.readRememberedTermWeek();A>=1&&(p.viewWeek=A)}n.scheduleRender()}return a(d,"loadAll"),{ensureRoomCatalogLoaded:c,loadAll:d}}a(bi,"createCleanModeDataLoader");var nr={autumn:{name:"秋季学期",weeks:20,start:"2026-08-31",end:"2027-02-20",events:[{t:"reg",name:"本科生新生报到",start:"2026-08-24",end:"2026-08-25"},{t:"reg",name:"在校生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"研究生新生报到",start:"2026-08-27",end:"2026-08-28"},{t:"reg",name:"在校本科补缓考",start:"2026-08-28",end:"2026-08-30"},{t:"term",name:"本科生开学典礼",start:"2026-09-01"},{t:"term",name:"研究生开学典礼",start:"2026-09-04"},{t:"term",name:"在校生正式行课",start:"2026-08-31",end:"2026-09-06"},{t:"holiday",name:"中秋节",start:"2026-09-25"},{t:"holiday",name:"国庆节假期",start:"2026-10-01",end:"2026-10-07"},{t:"sport",name:"校秋季田径运动会",start:"2026-10-23",end:"2026-10-24"},{t:"exam",name:"本科生期末集中考试周",start:"2027-01-04",end:"2027-01-15"},{t:"holiday",name:"寒假",start:"2027-01-18",end:"2027-02-20"},{t:"holiday",name:"春节",start:"2027-02-06"}]},spring:{name:"春季学期",weeks:18,start:"2027-03-01",end:"2027-07-03",events:[{t:"reg",name:"在校生报到",start:"2027-02-25",end:"2027-02-26"},{t:"term",name:"正式行课",start:"2027-03-01",end:"2027-03-07"},{t:"holiday",name:"清明节",start:"2027-04-05"},{t:"holiday",name:"劳动节假期",start:"2027-05-01",end:"2027-05-05"},{t:"holiday",name:"端午节",start:"2027-06-09"},{t:"exam",name:"期末集中考试",start:"2027-06-21",end:"2027-06-27"},{t:"term",name:"毕业典礼",start:"2027-06-25"},{t:"holiday",name:"暑假开始",start:"2027-07-04"}]}},qc={"2026-08-24":"农历七月十二","2026-08-25":"农历七月十三","2026-08-27":"农历七月十五","2026-08-28":"农历七月十六","2026-08-30":"农历七月十八","2026-08-31":"农历七月十九","2026-09-01":"农历七月二十","2026-09-04":"农历七月廿三","2026-09-25":"农历八月十五","2026-10-01":"农历八月廿一","2026-10-07":"农历八月廿七","2026-10-23":"农历九月十四","2026-10-24":"农历九月十五","2027-01-04":"农历冬月廿七","2027-01-15":"农历腊月初八","2027-01-18":"农历腊月十一","2027-02-06":"农历正月初一","2027-02-20":"农历正月十五","2027-02-25":"农历正月二十","2027-02-26":"农历正月廿一","2027-03-01":"农历正月廿四","2027-04-05":"农历二月廿九","2027-05-01":"农历三月廿五","2027-05-05":"农历三月廿九","2027-06-09":"农历五月初五","2027-06-21":"农历五月十七","2027-06-25":"农历五月廿一","2027-06-27":"农历五月廿三","2027-07-03":"农历五月廿九","2027-07-04":"农历六月初一"},Cr={term:{color:"#44616f",label:"教学/开学"},reg:{color:"#8a74bd",label:"报到"},exam:{color:"#c08a3f",label:"考试周"},holiday:{color:"#d0716a",label:"假期"},sport:{color:"#778e63",label:"运动会"}};function xi(){let p=new Date,n=a(c=>String(c).padStart(2,"0"),"p");return`${p.getFullYear()}-${n(p.getMonth()+1)}-${n(p.getDate())}`}a(xi,"calToday");function go(p,n){return Math.round((Date.parse(n)-Date.parse(p))/864e5)}a(go,"calDayDiff");function xo(p,n){let c=go(nr[p].start,n);return c<0?0:Math.floor(c/7)+1}a(xo,"calWeekNo");function bo(p){return qc[p]||""}a(bo,"calLunar");function fi(p){return String(p||"").slice(5)}a(fi,"calYY");function Tc(p){let n=p||xi(),[c,d]=n.split("-").map(Number);return d===8&&n>="2026-08-15"||d>=9||d<=2?"autumn":"spring"}a(Tc,"calActiveTerm");function yo(p,n){let c=p&&nr[p]?p:"autumn",d=nr[c],u=n||xi(),A=d.events.map(g=>({e:g,d:go(u,g.start)})).filter(g=>g.d>=-0).sort((g,k)=>g.d-k.d)[0],P=A?go(u,A.e.start):null,_=xo(c,u),y=Math.max(0,Math.min(100,_/d.weeks*100)),S=u>=d.start;return{term:d,termId:c,next:A,daysLeft:P,weekNo:_,progress:y,started:S,today:u}}a(yo,"calStatus");function yi(p,n){let c=yo(p,n),d=c.next?Cr[c.next.e.t].color:"#c9cdd4",u=c.term;return`<button type="button" class="uc-cal-summary" data-urppp-cal-open aria-label="打开校历时间线">
  ...
  </button>`}a(yi,"calendarSummaryHtml");function vi(p,n){let c=yo(p,n);return`<button type="button" class="uc-cal-summary uc-cal-summary-compact" data-urppp-cal-open aria-label="打开校历时间线">
    <span class="cal-c-dot" style="background:${c.next?Cr[c.next.e.t].color:"#c9cdd4"}"></span>
  ...
  </button>`}a(vi,"calendarSummaryCompactHtml");function gi(p,n){let c=yo(p,n),d=c.next?Cr[c.next.e.t].color:"#c9cdd4",u=c.term,A=Object.keys(nr).map(k=>`<button type="button" class="cal-term${k===c.termId?" ac":""}" data-cal-term="${k}">${nr[k].name}</button>`).join(""),P=`<div class="cal-widget">
    <div class="cal-w-left">
      ...
      <div class="cal-w-sub">${c.next?c.next.e.start+(c.next.e.end&&c.next.e.end!==c.next.e.start?" ~ "+c.next.e.end:""):""}${c.next&&bo(c.next.e.start)?" · "+bo(c.next.e.start):""}</div>
    </div>
    <div class="cal-w-mid">
  ...
  </div>`,_=u.events.slice().sort((k,T)=>k.start<T.start?-1:1),y={};_.forEach(k=>{(y[k.start.slice(0,7)]=y[k.start.slice(0,7)]||[]).push(k)});let S=a(k=>k===c.today?" cal-today":"","todayFlag"),g=Object.keys(y).map(k=>{let[,T]=k.split("-");return`<div class="cal-mon">
      <div class="cal-mon-label">${Number(T)} 月</div>
      <div class="cal-mon-items">${y[k].map(C=>{let f=Cr[C.t].color,b=C.end&&C.end!==C.start?"~"+fi(C.end):"",w=xo(c.termId,C.start)>0?`第 ${xo(c.termId,C.start)} 周`:"开学前";return`<div class="cal-ev${S(C.start)}">
          <span class="cal-ev-dot" style="background:${f}"></span>
          <span class="cal-ev-date">${fi(C.start)}${b||""}<em>${bo(C.start)||"&nbsp;"}</em></span>
          <span class="cal-ev-name">${C.name}</span>
          <span class="cal-ev-tag" style="color:${f};background:${f}1a">${Cr[C.t].label}</span>
    ...
    <div class="cal-modal-top">
      ...
      <span class="cal-right"><span class="cal-term-pills">${A}</span><button type="button" class="cal-close" aria-label="关闭">✕</button></span>
    </div>
    ${P}
    <div class="cal-timeline">${g}</div>
  </div>`}a(gi,"calendarModalHtml");function wi(p,n){let c=typeof document<"u"?document:null;if(!c)return;fo();let d=p&&nr[p]?p:Tc(n),u=c.createElement("div");u.id="urppp-cal-modal",u.innerHTML=`<div class="cal-overlay"></div>
    <div class="cal-dialog"><div class="cal-body">${gi(d,n)}</div></div>`,c.documentElement.appendChild(u),setTimeout(()=>u.classList.add("open"),20),u.querySelector(".cal-overlay").addEventListener("click",()=>fo()),u.addEventListener("click",A=>{let P=A.target;if(P&&P.closest&&P.closest(".cal-close")){fo();return}let _=P&&P.closest?P.closest("[data-cal-term]"):null;if(_){let y=u.querySelector(".cal-body");y&&(y.innerHTML=gi(_.dataset.calTerm,n)),u.querySelectorAll("[data-cal-term]").forEach(S=>S.classList.toggle("ac",S.dataset.calTerm===_.dataset.calTerm))}})}a(wi,"openCalendarModal");function fo(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-cal-modal");n&&(n.classList.remove("open"),n.classList.add("closing"),setTimeout(()=>{n.remove()},200))}a(fo,"closeCalendarModal");function ki(p,n){let c=p||(typeof document<"u"?document:null);c&&c.addEventListener("click",d=>{let u=d.target;u&&u.closest&&u.closest("[data-urppp-cal-open]")&&(d.preventDefault(),d.stopPropagation(),wi())})}a(ki,"bindCalendarOpen");var ia=!1;function vo(){let p=typeof document<"u"?document:null;if(!p||ia)return ia;try{let n=p.createElement("style");if(n&&n.id!==void 0){n.id="urppp-cal-style",n.textContent=`
  ...
  `,n.id="urppp-cal-style";let c=p.head||p.documentElement;c&&c.appendChild(n),ia=!0}}catch{}return ia}a(vo,"ensureCalendarStyle");function Ai(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-nav-theme")||p.querySelector("#navbar .navbar-header")||p.getElementById("navbar"),c=p.getElementById("urppp-nav-clean"),d=p.getElementById("urppp-nav-cal");if(!n&&!c)return;let u=c&&c.parentElement||n;d&&d.parentElement===u||(d&&d.remove(),d=p.createElement("button"),d.type="button",d.id="urppp-nav-cal",d.title="校历时间线",d.setAttribute("aria-label","校历时间线"),d.innerHTML='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3.5" y="5" width="17" height="15.5" rx="2.5"/><path d="M3.5 9.5h17"/><path d="M8 3v3M16 3v3"/><circle cx="12" cy="15" r="1.2" fill="currentColor" stroke="none"/></svg><span>校历</span>',Object.entries({display:"inline-flex","align-items":"center",height:"28px","min-height":"28px",padding:"0 12px","font-size":"12px",gap:"6px",width:"auto",float:"none",margin:"0 0 0 8px","vertical-align":"middle"}).forEach(([A,P])=>d.style.setProperty(A,P,"important")),d.addEventListener("click",A=>{A.preventDefault(),A.stopPropagation(),wi()}),c&&c.parentElement?c.after(d):u&&u.appendChild(d))}a(Ai,"mountCalendarButton");function Si(){let p=typeof document<"u"?document:null;if(!p)return;let n=p.getElementById("urppp-nav-cal");n&&n.remove()}a(Si,"removeCalendarButton");function _i({state:p,deps:n}){let c=0,d={gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)"};function u(x,E){let q=x||n.summarizeCourses([]);return`<div class="uc-metrics">${[["TotalCredit","总学分",q.totalCredit],["AvgScore","平均成绩",q.avgScore],["AvgGpa","平均绩点",q.avgGpa],["RequiredCredit","必修学分",q.requiredCredit],["RequiredAvg","必修平均",q.requiredAvg],["RequiredGpa","必修绩点",q.requiredGpa]].map(([L,O,$])=>{let H=n.classifyPrivacyLabel(O)||"grade",G=E&&n.DIRECT_EDIT_LABELS[E+L]?` data-urppp-edit-key="${E+L}"`:"";return`<div class="uc-metric"><em>${O}</em><b data-urppp-private="${H}"${G}>${$}</b></div>`}).join("")}</div>`}a(u,"metricHtml");function A(){let x=p.scores;if(!x||x.error)return`<div class="uc-sa-empty">${n.escapeHtml(x&&x.error||"暂无成绩数据")}</div>`;let E=null;try{E=n.analyzeScores({scorePack:x,profile:p.profile})}catch{}if(!E||E.empty)return'<div class="uc-sa-empty">暂无可用成绩数据，请先查询成绩后再试。</div>';let q=typeof n.scoreChartLayout=="function"?n.scoreChartLayout():null;return`<div class="uc-sa-charts">
    ...
    <div class="uc-sa-more-row"><a class="uc-sa-more" data-href="/student/integratedQuery/scoreQuery/allPassingScores/index?urppp=sa">点击此处跳转到详细分析界面 →</a></div>`}a(A,"analysisHtml");function P(x){let E=!!n.isCleanAnalysisDirect(),q=p.scoreAnalysisTab==="analysis";return E?`<div class="uc-hd"><span>成绩总览</span><span class="uc-sub">点击查看明细</span></div>
  <div class="uc-bd">
    <div class="uc-sa-pane">${x}</div>
    <div class="uc-sa-pane uc-sa-pane-analysis">${A()}</div>
  ...
  <div class="uc-bd">
    ...
    <div class="uc-sa-pane uc-sa-pane-analysis"${q?"":" hidden"}>${A()}</div>
  </div>`}a(P,"scoreSectionHtml");function _(){try{if(window.matchMedia&&window.matchMedia("(max-width:900px)").matches)return 40}catch{}return 56}a(_,"getScheduleRowHeight");function y(x){let E=n.getViewWeekNumber(),q=_(),I=Math.max(q-4,28),L=(x||[]).map(H=>Object.assign({},H,{thisWeek:n.weekBitActive(H.classWeek,E)||!H.classWeek&&String(H.week||"").indexOf(String(E))>=0,span:Math.max(1,H.span||1),color:H.color||n.courseColor(H.name)})),O={};L.forEach(H=>{let G=H.day+"_"+H.section;(O[G]||(O[G]=[])).push(H)});let $=`<div class="uc-week" data-urppp-private="schedule" data-week="${E}" data-row="${q}">`;$+='<div class="uc-week-head"><div class="h"></div>';for(let H=0;H<7;H++)$+=`<div class="h">${n.DAY_NAMES[H]}</div>`;$+='</div><div class="uc-week-body">',$+='<div class="uc-sec-col">';for(let H=1;H<=12;H++)$+=`<div class="s" style="height:${q}px">${H}</div>`;$+="</div>";for(let H=0;H<7;H++){$+=`<div class="uc-day-col" data-day="${H}" style="height:${q*12}px">`;for(let G=1;G<=12;G++)$+=`<div class="uc-grid-cell" data-sec="${G}" style="top:${(G-1)*q}px;height:${I}px"></div>`;$+=`<div class="uc-part-line" style="top:${4*q-2}px"></div>`,$+=`<div class="uc-part-line" style="top:${9*q-2}px"></div>`;for(let G=1;G<=12;G++){let U=(O[H+"_"+G]||[]).slice().sort((gt,Z)=>gt.thisWeek!==Z.thisWeek?(Z.thisWeek?1:0)-(gt.thisWeek?1:0):(Z.span||1)-(gt.span||1));if(!U.length)continue;let it=U.filter(gt=>gt.thisWeek)[0]||U[0],mt=U.filter(gt=>gt!==it),V=it.span,Q=(G-1)*q+1,ot=V*q-6,X=it.thisWeek?8:2,ct=it.thisWeek?`--uc-course-color:${it.color};top:${Q}px;height:${ot}px;z-index:${X};background:${it.color}26;border-color:${it.color}80`:`--uc-course-color:${it.color};top:${Q}px;height:${ot}px;z-index:${X};background:color-mix(in srgb,${it.color} 8%,var(--input-bg));border-color:var(--border);opacity:.48`,rt=mt.length?`<span class="uc-badge">+${mt.length}</span>`:"",st=n.escapeHtml(JSON.stringify({name:it.name,teacher:it.teacher,place:it.place,week:it.week,day:it.day,section:it.section,span:it.span,thisWeek:it.thisWeek,others:mt.map(gt=>({name:gt.name,teacher:gt.teacher,place:gt.place,week:gt.week,thisWeek:gt.thisWeek,section:gt.section,span:gt.span}))}));$+=`<div class="uc-lesson${it.thisWeek?"":" is-fade"}" style="${ct}" data-course='${st}'>
          <b>${n.escapeHtml(it.name)}</b>
          <i>${n.escapeHtml([it.place,it.week].filter(Boolean).join(" · "))}</i>
          ${rt}
        </div>`}$+="</div>"}return $+="</div></div>",$}a(y,"renderScheduleBoard");function S(){try{if(p.loading&&p.loading.schedule)return"";let x=n.calVacation?n.calVacation():"term";if(x==="term"||n.getViewWeekNumber()!==0)return"";let E={summer:{title:"放暑假啦~",sub:"课表先歇一歇，好好享受生活",svg:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/></svg>'},winter:{title:"放寒假啦~",sub:"课表先歇一歇，好好享受生活",svg:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12h20"/><path d="M12 2v20"/><path d="M20 16l-4-4 4-4"/><path d="M4 8l4 4-4 4"/><path d="M16 4l-4 4-4-4"/><path d="M8 20l4-4 4 4"/></svg>'},springfestival:{title:"春节快乐！",sub:"",svg:'<svg viewBox="0 0 72 72"><rect x="16" y="16" width="40" height="40" rx="7" fill="#b71c1c" stroke="#f5b301" stroke-width="2.4" transform="rotate(45 36 36)"/><path d="M36 16v40M16 36h40" stroke="#f5b301" stroke-width="1" opacity=".5"/><path d="M24 24l24 24M48 24L24 48" stroke="#f5b301" stroke-width="1" opacity=".35"/><text x="36" y="47" text-anchor="middle" font-size="30" font-weight="900" fill="#ffd54f" font-family="Noto Serif SC,STKaiti,KaiTi,serif" transform="rotate(180 36 36)">福</text></svg>',couplet:{scroll:"万象纳祥",right:"望江听雨华西看杏海纳百川享人间烟火",left:"江安漫步眉山泛舟有容乃大过锦绣新年"}}}[x];if(!E)return"";if(x==="springfestival"&&E.couplet){let I=E.couplet;return`<div class="uc-schedule-mask uc-mask-springfestival">
      ...
      <button type="button" class="uc-svc" data-action="${E.a||""}" data-href="${E.h||""}">
        ${n.ico(E.i)}<strong>${E.t}</strong>
      </button>`).join("")}</div>`}a(g,"servicesHtml");function k(){let x=n.personalizedProfile(p.profile||{}),E=p.schedule&&p.schedule.courses||[],q=p.scores&&p.scores.passing&&p.scores.passing[0]||{summary:n.summarizeCourses([])},I=p.scores&&p.scores.schemes||[];p.scores&&p.scores.majorIdx!=null&&p._schemeInited!==!0&&(p.activeSchemeIdx=p.scores.majorIdx||0,p._schemeInited=!0);let L=I[p.activeSchemeIdx]||I[0]||{summary:n.summarizeCourses([]),title:"方案成绩"},O=x.avatar?`<img src="${n.escapeHtml(x.avatar)}" alt="">`:`<span>${n.escapeHtml((x.name||"同")[0])}</span>`,$=p.loading.scores?'<div class="uc-loading">成绩加载中</div>':p.scores&&p.scores.error?`<div class="uc-empty">${n.escapeHtml(p.scores.error)}</div>`:`<div class="uc-score-grid">
          ...
          </div>`,H=P($);return`<div class="uc-desktop">
      <div class="uc-col">
        ...
        </div>${(()=>{try{return yi()}catch{return""}})()}</div></div>
        <div class="uc-card grow">
          ...
          <div class="uc-bd"><div class="uc-schedule-wrap">${p.loading.schedule?'<div class="uc-loading">课表加载中</div>':E.length?y(E):`<div class="uc-empty">${n.escapeHtml(p.schedule&&p.schedule.error||"暂无课表数据")}</div>`}${S()}</div></div>
        </div>
      </div>
      <div class="uc-col">
        <div class="uc-card">
    ...
    </div>`}a(k,"renderDesktop");function T(){let x=n.personalizedProfile(p.profile||{}),E=p.schedule&&p.schedule.courses||[],q=p.scores&&p.scores.passing&&p.scores.passing[0]||{summary:n.summarizeCourses([])},I=(p.scores&&p.scores.schemes||[])[p.activeSchemeIdx]||{summary:n.summarizeCourses([])},L=x.avatar?`<img src="${n.escapeHtml(x.avatar)}" alt="">`:`<span>${n.escapeHtml((x.name||"同")[0])}</span>`;if(p.mobileTab==="scores"){let O=`<div class="uc-score-grid uc-score-grid-mobile">
      ...
      </div><div class="uc-bd"><div class="uc-schedule-wrap">${p.loading.schedule?'<div class="uc-loading">课表加载中</div>':E.length?y(E):`<div class="uc-empty">${n.escapeHtml(p.schedule&&p.schedule.error||"暂无课表数据")}</div>`}${S()}</div></div></div>
      ...
      </div>`).join(""):`<div class="uc-empty">${n.escapeHtml(p.roomError||"未读到教学楼列表")}<div style="margin-top:10px"><button type="button" class="uc-btn" data-room-reload="1">重新加载</button></div></div>`}a(C,"roomPickerHtml");function f(x,E){if(!x||!x.rooms||!x.rooms.length)return'<div class="uc-empty">该楼暂无教室占用数据</div>';let q='<tr><th class="sticky">教室</th><th class="sticky2">座位</th>';for(let $=1;$<=12;$++)q+=`<th class="sec">${$}</th>`;q+="</tr>";let I=x.rooms.map($=>{let H=`<tr><th class="sticky">${n.escapeHtml($.name)}</th><th class="sticky2">${n.escapeHtml($.seats)}</th>`;for(let G=1;G<=12;G++){let U=($.slots||[]).find(et=>et.section===G)||{busy:!1};if(U.busy){let et=U.reason||U.typeLabel||"占用",it=U.typeLabel||n.occupancyTypeLabel({occupancymoduleId:U.module}),mt=U.displayChar||n.firstContentChar(et)||n.firstContentChar(it)||"占",V=Object.assign({},U.detail||{room:$.name,section:G,reason:et},{reason:et,typeLabel:it,contentName:U.contentName||U.detail&&U.detail.contentName||""}),Q=n.escapeHtml(JSON.stringify(V));H+=`<td><button type="button" class="uc-slot busy ${n.occupancyKindClass(it)}" data-occ='${Q}' title="${n.escapeHtml($.name)} 第${G}节 · ${n.escapeHtml(et)}">${n.escapeHtml(mt)}</button></td>`}else H+=`<td><div class="uc-slot free" title="${n.escapeHtml($.name)} 第${G}节 · 空闲"></div></td>`}return H+"</tr>"}).join(""),L=Number(x.dateOffset!=null?x.dateOffset:p.roomDateOffset)||0,O=a(($,H)=>`<button type="button" class="uc-btn${L===$?" primary":""}" data-room-day="${$}">${H}</button>`,"dayBtn");return`
      ...
      <div class="uc-occ"><table class="uc-occ-table">${q}${I}</table></div>`}a(f,"occupancyHtml");function b(){let x=n.ensureRoot(),E=x.querySelector("#uc-body");n.getViewWeekNumber();let q=typeof window<"u"&&window.matchMedia?window.matchMedia:null,I=q&&q("(max-width:900px)").matches,L=!p.uiReady;E.innerHTML=I?T():k(),L?(p.uiReady=!0,x.classList.remove("uc-settled"),clearTimeout(x.__ucSettleTimer),x.__ucSettleTimer=setTimeout(()=>{p.open&&x.classList.add("uc-settled")},480)):x.classList.add("uc-settled"),n.bindUI(E),n.applyPersonalDisplay(E)}a(b,"render");function w(){if(!p.open||c)return;let x=a(()=>{c=0,p.open&&b()},"run"),E=typeof requestAnimationFrame=="function"?requestAnimationFrame:null;c=E?E(x):setTimeout(x,0)}return a(w,"scheduleRender"),{analysisHtml:A,metricHtml:u,occupancyHtml:f,render:b,renderScheduleBoard:y,roomPickerHtml:C,scheduleRender:w,scoreSectionHtml:P}}a(_i,"createCleanModeRenderer");function Ei({state:p,deps:n}){function c(k,T){return!k||(k.__urpppCleanUiBindings||(k.__urpppCleanUiBindings=new Set),k.__urpppCleanUiBindings.has(T))?!1:(k.__urpppCleanUiBindings.add(T),!0)}a(c,"markCleanUiBound");function d(k){if(!k)return;try{n.bindScheduleExportHosts(k)}catch(C){console.warn("[URP++] schedule export menu",C)}k.querySelectorAll("[data-score]").forEach(C=>{c(C,"score")&&C.addEventListener("click",()=>_(C.getAttribute("data-score")))}),k.querySelectorAll("[data-sa-tab]").forEach(C=>{c(C,"saTab")&&C.addEventListener("click",()=>{p.scoreAnalysisTab=C.getAttribute("data-sa-tab")==="analysis"?"analysis":"overview",n.render()})}),k.querySelectorAll("[data-href]").forEach(C=>{c(C,"href")&&C.addEventListener("click",f=>{let b=C.getAttribute("data-href");b&&(f.preventDefault(),n.closeCleanMode(),location.href=b)})}),k.querySelectorAll("[data-eval-url]").forEach(C=>{c(C,"eval")&&C.addEventListener("click",f=>{let b=C.getAttribute("data-eval-url");b&&(f.preventDefault(),f.stopPropagation(),n.closeCleanMode(),location.href=b)})}),k.querySelectorAll('[data-action="room"]').forEach(C=>{c(C,"room")&&C.addEventListener("click",()=>y())}),k.querySelectorAll("[data-room-reload]").forEach(C=>{c(C,"roomReload")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),n.ensureRoomCatalogLoaded(!0)})}),k.querySelectorAll("[data-build-path]").forEach(C=>{c(C,"building")&&C.addEventListener("click",async()=>{let f=C.getAttribute("data-build-path"),b=(C.textContent||"").trim(),w=C.getAttribute("data-cn")||"",x=C.getAttribute("data-bn")||"",E=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;p.roomDateOffset=0,await g({path:f,name:b,campusNumber:w,buildingNumber:x,dateOffset:0},b,E)})}),k.querySelectorAll("[data-room-day]").forEach(C=>{c(C,"roomDay")&&C.addEventListener("click",async f=>{f.preventDefault(),f.stopPropagation();let b=parseInt(C.getAttribute("data-room-day")||"0",10)||0;if(!p.currentBuilding)return;p.roomDateOffset=b;let w=Object.assign({},p.currentBuilding,{dateOffset:b}),x=C.closest("#uc-room-panel")||C.closest("#uc-modal-body")||null;await g(w,w.name||"",x)})});let T=k.querySelector("#uc-room-back");T&&(T.onclick=()=>{p.occupancy=null,p.currentBuilding=null;let C=T.closest("#uc-room-panel")||document.querySelector("#uc-room-panel")||document.querySelector("#uc-modal-body");C&&C.id==="uc-modal-body"||C&&C.id==="uc-room-panel"?(C.innerHTML=n.roomPickerHtml(),d(C)):n.render()}),k.querySelectorAll(".uc-slot.busy[data-occ]").forEach(C=>{c(C,"occupancy")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();try{let b=JSON.parse(C.getAttribute("data-occ")||"{}");A("占用详情",`
          ...
          `,"",{stack:!0})}catch{}})}),k.querySelectorAll(".uc-lesson[data-course]").forEach(C=>{c(C,"course")&&C.addEventListener("click",f=>{f.stopPropagation();try{let b=JSON.parse(C.getAttribute("data-course")||"{}"),w=`第${b.section||"?"}${b.span>1?"-"+(Number(b.section)+Number(b.span)-1):""}节`,x=(b.others||[]).map(E=>`<div class="uc-course-sub ${E.thisWeek?"":"is-fade"}">
          ...
          `,"")}catch{}})}),k.querySelectorAll("[data-week-delta]").forEach(C=>{c(C,"weekDelta")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();let b=parseInt(C.getAttribute("data-week-delta")||"0",10)||0,w=p.schedule&&p.schedule.courses||[],x=n.inferMaxWeek(w),E=n.getViewWeekNumber();p.weekLocked=!0,p.viewWeek=Math.min(x,Math.max(1,E+b)),n.render();let q=document.querySelector("#urppp-clean-root .uc-week-label");q&&(q.classList.remove("uc-pop"),q.offsetWidth,q.classList.add("uc-pop"))})}),k.querySelectorAll("[data-week-reset]").forEach(C=>{c(C,"weekReset")&&C.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),p.weekLocked=!1;let b=n.getCurrentWeekNumber()||p._termWeek||1;p.viewWeek=b,n.render();let w=document.querySelector("#urppp-clean-root .uc-week-label");w&&(w.classList.remove("uc-pop"),w.offsetWidth,w.classList.add("uc-pop"))})})}a(d,"bindUI");let u=[];function A(k,T,C,f){f=f||{};let b=n.ensureRoot(),w=b.querySelector("#uc-mask"),x=b.querySelector("#uc-modal");f.stack&&x.classList.contains("open")?u.push({title:b.querySelector("#uc-modal-title").textContent,body:b.querySelector("#uc-modal-body").innerHTML,ft:b.querySelector("#uc-modal-ft").innerHTML}):f.stack||(u.length=0),w.classList.add("open"),x.classList.add("open"),b.querySelector("#uc-modal-title").textContent=k,b.querySelector("#uc-modal-body").innerHTML=T,b.querySelector("#uc-modal-ft").innerHTML=C||"",d(b.querySelector("#uc-modal-body")),d(b.querySelector("#uc-modal-ft")),n.applyPersonalDisplay(b.querySelector("#uc-modal"))}a(A,"openModal");function P(){let k=n.rootEl();if(k){if(u.length){let T=u.pop();k.querySelector("#uc-modal-title").textContent=T.title,k.querySelector("#uc-modal-body").innerHTML=T.body,k.querySelector("#uc-modal-ft").innerHTML=T.ft||"",d(k.querySelector("#uc-modal-body")),d(k.querySelector("#uc-modal-ft"));return}k.querySelector("#uc-mask").classList.remove("open"),k.querySelector("#uc-modal").classList.remove("open")}}a(P,"closeModal");function _(k){let T=p.scores&&p.scores.passing&&p.scores.passing[0]||{courses:[],summary:n.summarizeCourses([])},C=p.scores&&p.scores.schemes||[];k==="scheme"&&p.scores&&p.scores.majorIdx!=null&&p._schemeInited!==!0&&(p.activeSchemeIdx=p.scores.majorIdx||0,p._schemeInited=!0);let f=C[p.activeSchemeIdx]||C[0]||{courses:[],summary:n.summarizeCourses([]),title:"方案成绩"},b=k==="scheme"?f:T,w=k==="scheme"?"scheme":"passing";p.selected[w]||(p.selected[w]=new Set);let x=k==="scheme"&&C.length>1?`<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">${C.map((Z,dt)=>`<button type="button" class="uc-btn ${dt===p.activeSchemeIdx?"primary":""}" data-scheme-idx="${dt}"><span data-urppp-private="organization">${n.escapeHtml((Z.title||"方案").slice(0,28))}</span></button>`).join("")}</div>`:"",E=a(Z=>{let dt=!!(Z&&(Z.unevaluated||n.isUnevaluatedScore(Z.score))),kt=n.scoreToNumber(Z&&Z.score),wt="";dt?wt=kt!=null&&kt<60?"uneval-fail":"uneval":kt!=null?wt=kt>=60?"pass":"fail":/不及格|不合格|不通过/.test(String(Z&&Z.score||""))?wt="fail":Z&&Z.score&&(wt="pass");let Ct=n.escapeHtml(Z&&Z.score||"—"),B=dt?Z.evalUrl||"/student/teachingEvaluation/newEvaluation/index":"";return B?`<span class="uc-score-cell ${wt}" data-eval-url="${n.escapeHtml(B)}" title="未评教，点击前往评教">${Ct}</span>`:`<span class="uc-score-cell ${wt}">${Ct}</span>`},"scoreCellHtml"),q=(b.courses||[]).map((Z,dt)=>{let kt=p.selected[w].has(dt),wt=n.isValidOfficialGpa(Z.officialGpa)?Z.officialGpa:n.scoreToGpa(Z.score),Ct=!!(Z.unevaluated||n.isUnevaluatedScore(Z.score));return`<tr class="${kt?"is-on":""}${Ct?" is-uneval":""}" data-idx="${dt}">
      ...
      </tr>`}).join("");A(k==="scheme"?"方案成绩 · "+(f.title||""):"全部及格成绩",`
      ${x}${n.metricHtml(b.summary,k==="scheme"?"scheme":"passing")}
      ...
      </div>`,'<div id="uc-calc">已选 0 门</div><button type="button" class="uc-btn" id="uc-clear">清空</button>');let I=document.querySelector("#uc-modal-title");I&&(k==="scheme"?I.setAttribute("data-urppp-private","organization"):I.removeAttribute("data-urppp-private"),n.applyPersonalDisplay(I.parentElement||I));let L=document.querySelector("#uc-modal-body"),O=document.getElementById("uc-calc"),$=document.getElementById("uc-score-table"),H=document.getElementById("uc-score-wrap"),G=document.getElementById("uc-select-box"),U=a(()=>{$.querySelectorAll("tbody tr[data-idx]").forEach(kt=>{let wt=parseInt(kt.getAttribute("data-idx"),10),Ct=p.selected[w].has(wt);kt.classList.toggle("is-on",Ct);let B=kt.querySelector(".uc-selmark");B&&(B.textContent=Ct?"✓":"")});let Z=[];p.selected[w].forEach(kt=>{b.courses[kt]&&Z.push(b.courses[kt])});let dt=n.summarizeCoursesPreferOfficial(Z);O&&(O.className="uc-calc",O.innerHTML=Z.length?`已选 <b>${Z.length}</b> 门 · 学分 <b data-urppp-private="credit">${dt.totalCredit}</b> · 均分 <b data-urppp-private="grade">${dt.avgScore}</b> · 绩点 <b data-urppp-private="gpa">${dt.avgGpa}</b>`:"已选 0 门")},"paint"),et=a((Z,dt)=>{dt===!0?p.selected[w].add(Z):dt===!1||p.selected[w].has(Z)?p.selected[w].delete(Z):p.selected[w].add(Z)},"toggleIdx"),it=!1;$.querySelectorAll("tbody tr[data-idx]").forEach(Z=>{Z.addEventListener("click",dt=>{if(it){it=!1;return}let kt=parseInt(Z.getAttribute("data-idx"),10);et(kt),U()})});let mt=!1,V=0,Q=0,ot=null,X=a(()=>Array.from($.querySelectorAll("tbody tr[data-idx]")),"rowsEls"),ct=a((Z,dt)=>{if(!G||!H)return{left:0,top:0,right:0,bottom:0,w:0,h:0};let kt=H.getBoundingClientRect(),wt=Math.min(V,Z),Ct=Math.min(Q,dt),B=Math.max(V,Z),Y=Math.max(Q,dt),tt=B-wt,bt=Y-Ct,ht=wt-kt.left+H.scrollLeft,zt=Ct-kt.top+H.scrollTop;return G.style.display=tt>3||bt>3?"block":"none",G.style.left=ht+"px",G.style.top=zt+"px",G.style.width=tt+"px",G.style.height=bt+"px",{left:wt,top:Ct,right:B,bottom:Y,w:tt,h:bt}},"placeBox"),rt=a(Z=>{if(!mt)return;Z.preventDefault();let dt=ct(Z.clientX,Z.clientY);dt.w<=3&&dt.h<=3||(p.selected[w]=new Set(ot),X().forEach(kt=>{let wt=kt.getBoundingClientRect();if(!!(wt.right<dt.left||wt.left>dt.right||wt.bottom<dt.top||wt.top>dt.bottom))return;let B=parseInt(kt.getAttribute("data-idx"),10);ot.has(B)?p.selected[w].delete(B):p.selected[w].add(B)}),U())},"onMoveSel"),st=a(Z=>{let dt=Math.abs(Z.clientX-V)>3||Math.abs(Z.clientY-Q)>3;mt=!1,G&&(G.style.display="none"),document.removeEventListener("mousemove",rt,!0),document.removeEventListener("mouseup",st,!0),dt&&(it=!0),U()},"onUpSel");H.addEventListener("mousedown",Z=>{Z.button===0&&(mt=!0,V=Z.clientX,Q=Z.clientY,ot=new Set(p.selected[w]),ct(V,Q),document.addEventListener("mousemove",rt,!0),document.addEventListener("mouseup",st,!0))}),L.querySelectorAll("[data-scheme-idx]").forEach(Z=>Z.addEventListener("click",()=>{p.activeSchemeIdx=parseInt(Z.getAttribute("data-scheme-idx"),10)||0,p._schemeUserSelected=!0,_("scheme")}));let gt=document.getElementById("uc-clear");gt&&(gt.onclick=()=>{p.selected[w]=new Set,U()}),U()}a(_,"openScoreModal");async function y(){A("空闲教室",'<div class="uc-loading">加载教学楼</div>',"");try{await n.ensureRoomCatalogLoaded(!1),A("空闲教室",n.roomPickerHtml(),'<span class="uc-sub">选择楼栋查看教室×节次占用（对齐教室使用状况）</span>')}catch(k){A("空闲教室",`<div class="uc-empty">${n.escapeHtml(k&&k.message||k)}</div>`,"")}}a(y,"openRoomModal");function S(k){if(k&&k.isConnected)return k;let T=document.querySelector("#uc-room-panel");if(T&&T.offsetParent!==null||T&&p.mobileTab==="room")return T;let C=document.querySelector("#uc-modal-body"),f=document.querySelector("#uc-modal");return f&&f.classList.contains("open")&&C?C:T||C||null}a(S,"getRoomHost");async function g(k,T,C){let f=S(C);if(!f){console.warn("[URP++] no room host");return}f.innerHTML='<div class="uc-loading">加载占用网格</div>';try{let b=await n.loadBuildingOccupancy(k);f.innerHTML='<div class="uc-loading">匹配课程名称</div>';let w=b.planNumber||"";if(!w)try{let q=await n.fetchText("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),I=JSON.parse(q);if(w=I&&(I.zxjxjhh||I.xnxq||I.dateList&&I.dateList[0]&&I.dateList[0].zxjxjhh)||"",!w&&I&&I.xkxx&&I.xkxx[0]){let L=Object.keys(I.xkxx[0]||{}),O=L.length?I.xkxx[0][L[0]]:null;w=O&&(O.zxjxjhh||O.executiveEducationPlanNumber)||""}}catch{}w||(w="2025-2026-2-1"),b.planNumber=w;try{b=await n.enrichOccupancyWithCurriculum(b,typeof k=="object"?k:{},w)}catch(q){console.warn("[URP++] enrich occupancy",q)}p.occupancy=b,p.roomDateOffset=Number(b.dateOffset!=null?b.dateOffset:p.roomDateOffset)||0;let x=typeof k=="object"?k:{path:k,name:T};p.currentBuilding=Object.assign({},x,{name:T||x.name||"",dateOffset:p.roomDateOffset}),T=T||k&&k.name||"";let E=S(f)||f;E.innerHTML=n.occupancyHtml(b,T),d(E)}catch(b){let w=S(f)||f;w&&(w.innerHTML=`<div class="uc-empty">${n.escapeHtml(b&&b.message||b)}</div>`)}}return a(g,"showBuilding"),{bindUI:d,closeModal:P,getRoomHost:S,openModal:A,openRoomModal:y,openScoreModal:_,showBuilding:g}}a(Ei,"createCleanModeUI");function Ci({state:p,deps:n}){function c(){return document.getElementById("urppp-clean-root")}a(c,"rootEl");function d(){n.ensureStyle();let y=c();if(y)return y;y=document.createElement("div"),y.id="urppp-clean-root",y.innerHTML=`
      <div class="uc-top">
      ...
      </div>`,document.documentElement.appendChild(y),y.querySelector("#uc-exit").onclick=A,y.querySelector("#uc-refresh").onclick=()=>u(!0),y.querySelector("#uc-mask").onclick=n.closeModal,y.querySelector("#uc-modal-close").onclick=n.closeModal;let S=a(()=>{n.syncThemeDotGroup(y.querySelector("#uc-top-theme"))},"syncCleanThemeDots");y.querySelectorAll("#uc-top-theme .urppp-nav-dot[data-theme]").forEach(w=>{w.addEventListener("click",()=>{n.handleThemeDotClick(w.dataset.theme),S();try{n.syncNavbarThemeUI()}catch{}try{n.syncSettingsPanelUI()}catch{}})});let g=y.querySelector("#uc-settings");g&&g.addEventListener("click",w=>{w.preventDefault(),w.stopPropagation();try{n.openSettingsPanel()}catch{}});let k=y.querySelector("#uc-menu-toggle"),T=a(w=>{w.classList.remove("urppp-clean-sidebar");let x=w.__urpppCleanInline;if(x){let q=w.style,I=a((L,O)=>{let $=x[O];$&&$.v?q.setProperty(L,$.v,$.p||""):q.removeProperty(L)},"restore");I("top","top"),I("height","height"),I("z-index","z"),I("position","pos"),I("transform","transform"),I("visibility","vis"),I("pointer-events","pe"),I("transition","transition"),delete w.__urpppCleanInline}let E=w.__urpppCleanOrigin;E&&E.parent&&w.parentElement!==E.parent&&(E.next&&E.next.parentElement===E.parent?E.parent.insertBefore(w,E.next):E.parent.appendChild(w)),delete w.__urpppCleanOrigin},"restoreCleanSidebarInline"),C=a(()=>{let w=document.getElementById("sidebar");if(w)if(p.open){if(w.classList.add("urppp-clean-sidebar"),!w.__urpppCleanInline){let O=w.style,$=a(H=>({v:O.getPropertyValue(H),p:O.getPropertyPriority(H)}),"grab");w.__urpppCleanInline={top:$("top"),height:$("height"),z:$("z-index"),pos:$("position"),transform:$("transform"),vis:$("visibility"),pe:$("pointer-events"),transition:$("transition")},w.__urpppCleanOrigin={parent:w.parentElement,next:w.nextSibling}}if(w.parentElement!==y){let O=y.querySelector(".uc-shell");y.insertBefore(w,O||null)}let x=y.getBoundingClientRect(),E=y.querySelector(".uc-top"),q=E?E.getBoundingClientRect():null,I=Math.max(44,Math.round(q?q.bottom-x.top:60)),L=Math.max(0,Math.round(x.height-I));w.style.setProperty("top",I+"px","important"),w.style.setProperty("height",L+"px","important"),w.style.setProperty("z-index","12030","important"),w.style.setProperty("position","fixed","important")}else T(w)},"syncCleanSidebarZ"),f=a(()=>{let w=document.getElementById("sidebar");if(!w)return;try{n.stopDrawerAnimation(w)}catch{}w.classList.remove("display","urppp-drawer-closing"),T(w),k&&(k.setAttribute("aria-expanded","false"),k.setAttribute("aria-label","打开菜单"));let x=document.getElementById("urppp-mobile-menu-button");x&&(x.setAttribute("aria-expanded","false"),x.setAttribute("aria-label","打开菜单"))},"closeCleanSidebar");k&&k.addEventListener("click",w=>{w.preventDefault(),w.stopImmediatePropagation();let x=document.getElementById("sidebar");if(!x)return;x.__urpppCleanMenuBound||(x.__urpppCleanMenuBound=!0,x.addEventListener("click",I=>{if(!p.open)return;let L=I.target&&I.target.closest?I.target.closest("a[href]"):null;if(!L||L.closest("#urppp-mobile-search-panel"))return;let O=String(L.getAttribute("href")||"").trim();if(L.closest("#urppp-mobile-quick, #urppp-mobile-user")){if(!O||O==="#"||O.startsWith("javascript")||L.target==="_blank"||/^https?:\/\//i.test(O))return;A();return}!O||O==="#"||O.startsWith("javascript")||L.target==="_blank"||/^https?:\/\//i.test(O)||A()},!0));let E=!x.classList.contains("display");C(),n.setDrawerOpen(x,k,E);let q=document.getElementById("urppp-mobile-menu-button");q&&(q.setAttribute("aria-expanded",E?"true":"false"),q.setAttribute("aria-label",E?"关闭菜单":"打开菜单"))}),y.__closeCleanDrawer=f,y.__syncCleanSidebarZ=C,y.__syncCleanThemeDots=S;let b=globalThis.ResizeObserver;if(typeof b=="function"){let w=new b(()=>{p.open&&C()});w.observe(y);let x=y.querySelector(".uc-top");x&&w.observe(x),y.__cleanSidebarResizeObserver=w}try{let w=window.matchMedia&&window.matchMedia("(max-width: 900px)");if(w){let x=a(()=>{p.open&&(C(),n.render())},"onLayoutChange");typeof w.addEventListener=="function"?w.addEventListener("change",x):typeof w.addListener=="function"&&w.addListener(x),y.__scoreLayoutMedia=w,y.__scoreLayoutChange=x}}catch{}try{n.applySkinAttr()}catch{}return S(),y.querySelectorAll("#uc-tabbar button").forEach(w=>{w.onclick=()=>{p.mobileTab=w.dataset.tab,y.querySelectorAll("#uc-tabbar button").forEach(x=>x.classList.toggle("ac",x===w)),n.render(),p.mobileTab==="room"&&n.ensureRoomCatalogLoaded()}}),vo(),ki(y),y}a(d,"ensureRoot");function u(y){d();let S=p.open;p.open=!0,p.uiReady=!1,p.weekLocked=!1;let g=n.getCurrentWeekNumber()||n.readRememberedTermWeek();p.viewWeek=g>=1?g:p.viewWeek>=1?p.viewWeek:0,document.documentElement.classList.add("urppp-clean-lock",n.CLEAN_FLAG);let k=c();k.classList.remove("closing"),S||(k.classList.remove("uc-settled","open"),k.offsetWidth,k.classList.add("open"));try{n.stopDrawerAnimation(document.getElementById("sidebar"))}catch{}try{k.__syncCleanThemeDots&&k.__syncCleanThemeDots()}catch{}try{k.__syncCleanSidebarZ&&k.__syncCleanSidebarZ()}catch{}try{n.injectCleanSidebarSections(document.getElementById("sidebar"))}catch{}n.loadAll(!!y);try{n.ensureRoomCatalogLoaded()}catch{}}a(u,"openCleanMode");function A(){p.open=!1,p.uiReady=!1,n.closeModal(),document.documentElement.classList.remove("urppp-clean-lock",n.CLEAN_FLAG);let y=c();if(y){y.classList.remove("open","uc-settled","uc-drawer-open"),y.classList.add("closing"),clearTimeout(y.__ucSettleTimer);try{y.__closeCleanDrawer&&y.__closeCleanDrawer()}catch{}setTimeout(()=>{y.classList.remove("closing")},360)}try{n.refreshMobileNavbar()}catch{}}a(A,"closeCleanMode");function P(){try{n.ensureStyle();let y=document.getElementById("urppp-nav-clean");if(!n.isHomePage()){y&&y.remove(),Si();return}let S=document.getElementById("urppp-nav-theme")||document.querySelector("#navbar .navbar-header")||document.querySelector("#navbar");if(!S)return;y||(y=document.createElement("button"),y.type="button",y.id="urppp-nav-clean",y.title="清爽模式",y.innerHTML=`${n.ico("clean")}<span>清爽</span>`,y.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation(),u(!1)}),S.appendChild(y)),Object.entries({display:"inline-flex","align-items":"center",height:"28px","min-height":"28px",padding:"0 12px","font-size":"12px",gap:"6px",width:"auto",float:"none"}).forEach(([g,k])=>y.style.setProperty(g,k,"important")),vo();try{Ai()}catch{}}catch(y){console.warn("[URP++] clean entry",y)}}return a(P,"injectCleanEntry"),{cleanModeApi:{open:u,close:A,inject:P,refresh:n.refreshCleanPersonalDisplay,refreshRender:a(()=>{try{n.render()}catch{}},"refreshRender"),scoreToGpa:n.scoreToGpa,summarizeCourses:n.summarizeCourses},closeCleanMode:A,ensureRoot:d,injectCleanEntry:P,openCleanMode:u,rootEl:c}}a(Ci,"createCleanModeController");function Pi({deps:p}){function n(){if(window.__urpppScheduleHoverNear)return;window.__urpppScheduleHoverNear=!0;let P=12,_=16,y=0,S=0,g=!1,k=0,T=a(()=>document.getElementById("schedule-hover"),"hoverEl"),C=a(w=>{if(!w||w.style&&w.style.display==="none")return!1;let x=window.getComputedStyle(w);return x.display!=="none"&&x.visibility!=="hidden"},"isShown"),f=a(()=>{let w=T();if(!w||!C(w)){g=!1;return}g=!0;let x=window.innerWidth||1200,E=window.innerHeight||800,q=y+P,I=S+_,L=Math.min(320,w.offsetWidth||280),O=Math.min(220,w.offsetHeight||160);q+L>x-8&&(q=x-L-8),I+O>E-8&&(I=E-O-8),q<8&&(q=8),I<8&&(I=8),w.style.setProperty("position","fixed","important"),w.style.setProperty("left",Math.round(q)+"px","important"),w.style.setProperty("top",Math.round(I)+"px","important"),w.style.setProperty("right","auto","important"),w.style.setProperty("bottom","auto","important"),w.style.setProperty("margin","0","important"),w.style.setProperty("z-index","3000","important"),w.style.setProperty("pointer-events","none","important")},"place"),b=a(()=>{k||(k=requestAnimationFrame(()=>{k=0,f()}))},"schedulePlace");document.addEventListener("mousemove",w=>{if(y=w.clientX,S=w.clientY,!g){let x=T();x&&x.style&&x.style.display&&x.style.display!=="none"&&(g=!0)}g&&b()},!0),document.addEventListener("mouseover",w=>{w.target&&w.target.closest&&w.target.closest(".fc-event, .fc-time-grid-event")&&(y=w.clientX,S=w.clientY,setTimeout(()=>{g=!0,f()},0),setTimeout(f,40))},!0),document.addEventListener("mouseout",w=>{w.target&&w.target.closest&&w.target.closest(".fc-event, .fc-time-grid-event")&&setTimeout(()=>{let E=T();C(E)||(g=!1)},50)},!0)}a(n,"bindScheduleHoverNearCursor");function c(P){try{let _=!!(P&&P.force),y=typeof unsafeWindow<"u"&&unsafeWindow.jQuery?unsafeWindow.jQuery:window.jQuery||null;if(!y||!y.fn||!y.fn.fullCalendar)return!1;let S=document.getElementById("main-calendar")||document.querySelector("#urppp-left .fc, #urppp-dashboard .fc");if(!S)return!1;if(!_&&S.dataset.urpppFcSized==="1")return!0;let g=y(S);if(!(g.data("fullCalendar")||g.hasClass("fc")))return!1;let T=Array.from(S.querySelectorAll(".fc-scroller")).map(f=>({el:f,top:f.scrollTop,left:f.scrollLeft}));if(_||S.dataset.urpppFcRendered!=="1"){try{g.fullCalendar("render")}catch{}S.dataset.urpppFcRendered="1"}else try{g.fullCalendar("updateSize")}catch{}return requestAnimationFrame(()=>{T.forEach(f=>{try{f.el.scrollTop=f.top,f.el.scrollLeft=f.left}catch{}})}),(S.getBoundingClientRect().height||0)>=300&&(S.dataset.urpppFcSized="1"),!0}catch(_){return console.warn("[URP++] fullCalendar refresh failed",_),!1}}a(c,"refreshHomeFullCalendar");function d(){window.__urpppFcRefreshBound||(window.__urpppFcRefreshBound=!0,setTimeout(()=>c({force:!0}),0),setTimeout(()=>c({force:!1}),300))}a(d,"scheduleHomeFullCalendarRefresh");function u(P,_,y){let S=P.querySelector(".widget-header"),g=S?S.querySelector(".widget-toolbar"):null,k=document.createElement("div");k.className="urppp-card",k.innerHTML=`
      <div class="urppp-card-header">
        <h4>${y}</h4>
        <div class="urppp-card-tools"></div>
      </div>
      <div class="urppp-card-body"></div>
    `,g&&(g.style.display="inline-block",k.querySelector(".urppp-card-tools").appendChild(g)),k.querySelector(".urppp-card-body").appendChild(P),_.appendChild(k)}a(u,"wrapWidget");function A(){try{n()}catch{}if(document.getElementById("urppp-dashboard"))return;let P=document.querySelector(".page-content");if(!P)return;let _=Array.from(P.querySelectorAll(".widget-box"));if(_.length<6)return;let y=_[4],S=y?Array.from(y.querySelectorAll(".infobox")):[],g=document.createElement("div");g.id="urppp-dashboard",g.innerHTML=`
    ...
    `,P.appendChild(g);let k=P.querySelector("#warningInfo");k&&document.body.appendChild(k),_.forEach(x=>{let E=x.closest('.widget-container-col, [class*="col-"]');E&&(E.style.display="none")}),P.querySelectorAll(":scope > .row").forEach(x=>{x.style.display="none"});let T=g.querySelector("#urppp-stats"),C=Math.max(S.length,5);for(let x=0;x<C;x++){let E=document.createElement("div");E.className="urppp-stat-card urppp-stat-skeleton",E.innerHTML='<div class="value">-</div><div class="label">加载中</div>',T.appendChild(E)}function f(){let x=y?Array.from(y.querySelectorAll(".infobox")):[];x.length!==0&&(T.innerHTML="",x.forEach(E=>{let q=E.innerText.trim().split(/\n+/).map(et=>et.trim()).filter(et=>et),I=q[0]||"",L=q.slice(1).join(" ").replace(/更多\.\.\./g,"").trim(),$=/[\u4e00-\u9fa5]/.test(I)||I.length>5?"value urppp-stat-value-text":"value",H=E.closest("a"),G=document.createElement(H?"a":"div");H&&(G.href=H.href||"javascript:void(0)",G.onclick=H.onclick,G.style.textDecoration="none"),G.className="urppp-stat-card";let U=p.statCardPrivacyMarkup(I,L);G.innerHTML=`<div class="${$}">${U.valueHtml}</div><div class="label">${U.labelHtml}</div>`,T.appendChild(G)}))}if(a(f,"updateStats"),f(),y){let x=new MutationObserver(()=>f());x.observe(y,{childList:!0,subtree:!0}),setTimeout(()=>x.disconnect(),5e3)}let b=g.querySelector("#urppp-left"),w=g.querySelector("#urppp-right");u(_[5],b,"我的日程安排"),u(_[0],w,"通知公告"),u(_[1],w,"我的待办任务"),u(_[2],w,"可申请业务"),u(_[3],w,"常用下载"),y&&(y.style.display="none"),d(),console.log("[URP++] 首页仪表板已重构")}return a(A,"rebuildDashboard"),{rebuildDashboard:A,refreshHomeFullCalendar:c,scheduleHomeFullCalendarRefresh:d,wrapWidget:u}}a(Pi,"createDashboardController");function ve(p){return Math.round((Number(p)||0)*100)/100}a(ve,"round2");var Mc=[{key:"a",level:"A",range:"90-100",gpa:4,min:90,max:100},{key:"am",level:"A-",range:"85-89",gpa:3.7,min:85,max:89.999},{key:"bp",level:"B+",range:"82-84",gpa:3.3,min:82,max:84.999},{key:"b",level:"B",range:"78-81",gpa:3,min:78,max:81.999},{key:"bm",level:"B-",range:"75-77",gpa:2.7,min:75,max:77.999},{key:"cp",level:"C+",range:"72-74",gpa:2.3,min:72,max:74.999},{key:"c",level:"C",range:"68-71",gpa:2,min:68,max:71.999},{key:"cm",level:"C-",range:"64-67",gpa:1.7,min:64,max:67.999},{key:"dp",level:"D+",range:"60-63",gpa:1.3,min:60,max:63.999},{key:"d",level:"D",range:"60-62",gpa:1,min:60,max:62.999},{key:"f",level:"F",range:"<60",gpa:0,min:0,max:59.999}],zi={优秀:95,"A+":98,A:95,"A-":87,良好:85,"B+":83,B:79,"B-":76,中等:73,"C+":73,C:69,"C-":65,及格:62,"D+":62,D:60,不及格:50,F:50},$c=[{key:"required",label:"必修",test:a(p=>/必修/.test(p),"test")},{key:"elective",label:"任选",test:a(p=>/任选/.test(p),"test")},{key:"optional",label:"选修",test:a(p=>/选修/.test(p),"test")},{key:"other",label:"其他",test:a(()=>!0,"test")}];function Li(p){let n=String(p||"").match(/^(\d{4})-(\d{4})-(\d+)/);return n?`${n[1].slice(2)}-${n[2].slice(2)}-${n[3]}`:String(p||"")}a(Li,"shortTerm");function sa({deps:p}){let n=p.scoreToNumber,c=p.scoreToGpa;function d(f){let b=n(f);if(b!=null)return b;let w=String(f||"").trim().toUpperCase();return zi[w]!=null?zi[w]:null}a(d,"scoreToNumberWithLevels");function u(f){return!f||f.unevaluated?!1:d(f.score)!=null}a(u,"hasScore");function A(f){let b=String(f||"").match(/^(\d{4})-(\d{4})-(\d+)/);return b?[Number(b[1]),Number(b[3])]:[9999,9999]}a(A,"termOrderKey");function P(f){let b=f&&f.passing&&f.passing[0];return b&&b.courses||[]}a(P,"allCourses");function _(f){let b=f&&f.officialGpa,w=Number(b);return b!=null&&Number.isFinite(w)&&w>=0&&w<=5?w:null}a(_,"officialGpa");function y(f){let b=_(f);return b??c(f.score)}a(y,"courseGpa");function S({scorePack:f,profile:b}){let w=P(f),x=b&&b.majorGpa?String(b.majorGpa).trim():"",E=0,q=0,I=0,L=0,O=0,$=0;return w.forEach(H=>{if(!u(H))return;let G=Number(H.credit)||0,U=d(H.score);if(U==null||G<=0)return;E+=G,q+=U*G;let et=y(H);et!=null&&(I+=et*G,L+=G,H.required&&(O+=et*G,$+=G))}),{majorGpa:x,requiredGpa:ve($?O/$:0),avgGpa:ve(L?I/L:0),avgScore:ve(E?q/E:0),totalCredit:ve(E),courseCount:w.length}}a(S,"computeMetrics");function g(f){let b=new Map;return(f||[]).forEach(w=>{if(!u(w))return;let x=w.term||"未分组",E=b.get(x);E||(E={term:x,count:0,credit:0,scoreW:0,gpaW:0,gpaCredit:0},b.set(x,E));let q=Number(w.credit)||0,I=d(w.score);if(I==null||(E.count+=1,q<=0))return;E.credit+=q,E.scoreW+=I*q;let L=y(w);L!=null&&(E.gpaW+=L*q,E.gpaCredit+=q)}),Array.from(b.values()).map(w=>({term:w.term,label:Li(w.term),count:w.count,credit:ve(w.credit),avgScore:ve(w.credit?w.scoreW/w.credit:0),avgGpa:ve(w.gpaCredit?w.gpaW/w.gpaCredit:0)})).sort((w,x)=>{let E=A(w.term),q=A(x.term);return E[0]-q[0]||E[1]-q[1]})}a(g,"computeTrend");function k(f){let b=Mc.map(x=>({...x,count:0,credit:0}));(f||[]).forEach(x=>{if(!u(x))return;let E=d(x.score);if(E==null)return;let q=b.find(I=>E>=I.min&&E<=I.max);q&&(q.count+=1,q.credit+=Number(x.credit)||0)});let w=b.reduce((x,E)=>Math.max(x,E.count),1);return b.map(x=>({...x,ratio:Math.round(x.count/w*100)}))}a(k,"computeBands");function T(f){let b=$c.map(q=>({...q,credit:0,count:0}));(f||[]).forEach(q=>{if(!u(q))return;let I=String(q.attr||""),L=b.find(O=>O.test(I));L&&(L.credit+=Number(q.credit)||0,L.count+=1)});let w=b.reduce((q,I)=>q+I.credit,0)||1,x=b.filter(q=>q.count>0).map(q=>({key:q.key,label:q.label,credit:ve(q.credit),count:q.count,ratio:Math.round(q.credit/w*100)})),E=x.find(q=>q.key==="required");return{items:x,requiredCredit:E?E.credit:0,requiredRatio:E?E.ratio:0}}a(T,"computeShare");function C({scorePack:f,profile:b}){let w=P(f);return{metrics:S({scorePack:f,profile:b}),trend:g(w),bands:k(w),share:T(w),empty:w.length===0}}return a(C,"analyzeScores"),{analyzeScores:C,hasScore:u,officialGpa:_,scoreToNumberWithLevels:d,shortTerm:Li}}a(sa,"createScoreAnalysisData");var ne="var(--text-secondary)",ko="var(--border)";function pe(p){return at(String(p??""))}a(pe,"escapeLabel");function qi(p,n,c){let d=!!(p&&p.variant==="mobile");if(n==="trend"){if(!d)return{mobile:d,width:920,height:330,pad:{top:36,right:30,bottom:46,left:30}};let P={top:58,right:20,bottom:44,left:20},_=Math.max(56,Number(p&&p.slotWidth)||72);return{mobile:d,width:Math.max(300,P.left+P.right+Math.max(1,c)*_),height:286,pad:P}}if(!d)return{mobile:d,width:660,height:236,pad:{top:28,right:14,bottom:44,left:14}};let u={top:28,right:14,bottom:44,left:14},A=Math.max(44,Number(p&&p.slotWidth)||48);return{mobile:d,width:Math.max(320,u.left+u.right+Math.max(1,c)*A),height:236,pad:u}}a(qi,"resolveChartLayout");function wo({width:p,height:n,mobile:c,kind:d,label:u}){let A=c?` data-urppp-chart-layout="mobile" style="width:max(100%,${p}px);max-width:none;height:auto"`:"";return`<svg viewBox="0 0 ${p} ${n}" class="urppp-sa-chart" role="img" aria-label="${u}" data-urppp-chart-kind="${d}"${A}>`}a(wo,"openSvg");function la({trend:p,palette:n,layout:c}){let d=(p||[]).filter(rt=>rt&&rt.avgScore!=null),u=qi(c,"trend",d.length),{width:A,height:P,pad:_,mobile:y}=u,S=A-_.left-_.right,g=P-_.top-_.bottom;if(!d.length)return`${wo({...u,kind:"trend",label:"学期成绩趋势"})}</svg>`;let k=d.length,T=a(rt=>_.left+(rt+.5)*(S/k),"xAt"),C=d.map(rt=>Number(rt.avgGpa)||0),f=d.map(rt=>Number(rt.avgScore)||0),b=d.map(rt=>Number(rt.credit)||0),w=Math.max(0,Math.min(...C)-.2),x=Math.min(5,Math.max(...C)+.2),E=Math.max(0,Math.min(...f)-4),q=Math.min(100,Math.max(...f)+4),I=Math.max(1,...b),L=x-w||1,O=q-E||1,$=a(rt=>_.top+g-(rt-w)/L*g,"yGpa"),H=a(rt=>_.top+g-(rt-E)/O*g,"yScore"),G=a(rt=>_.top+g-rt/I*g*.9,"yCredit"),U=d.map((rt,st)=>`${T(st)},${$(rt.avgGpa)}`).join(" "),et=d.map((rt,st)=>`${T(st)},${H(rt.avgScore)}`).join(" "),it=[0,.25,.5,.75,1].map(rt=>{let st=_.top+g-rt*g;return`<line x1="${_.left}" y1="${st.toFixed(1)}" x2="${A-_.right}" y2="${st.toFixed(1)}" stroke="${ko}" stroke-width="1" stroke-dasharray="3 4"/>`}).join(""),mt=d.map((rt,st)=>{let gt=T(st),Z=y?Math.min(30,S/k*.42):Math.min(26,S/k*.32),dt=G(rt.credit);return`<rect x="${(gt-Z/2).toFixed(1)}" y="${dt.toFixed(1)}" width="${Z.toFixed(1)}" height="${(_.top+g-dt).toFixed(1)}" rx="3" fill="${n.credit}" opacity="0.55"/>
<text x="${gt.toFixed(1)}" y="${(dt-4).toFixed(1)}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.credit)}</text>`}).join(""),V=d.map((rt,st)=>`<text x="${T(st).toFixed(1)}" y="${P-16}" text-anchor="middle" font-size="12" fill="${ne}">${pe(rt.label)}</text>`).join(""),Q=d.map((rt,st)=>{let gt=S/k,Z=T(st)-gt/2,dt=[`学期 ${rt.label}`,`课程 ${rt.count} 门`,`修读学分 ${rt.credit}`,`加权均分 ${rt.avgScore}`,`平均绩点 ${rt.avgGpa}`].join(`
`);return`<rect class="urppp-sa-hover" x="${Z.toFixed(1)}" y="${_.top}" width="${gt.toFixed(1)}" height="${g.toFixed(1)}" fill="transparent"><title>${pe(dt)}</title></rect>`}).join(""),ot=d.map((rt,st)=>`<circle cx="${T(st).toFixed(1)}" cy="${$(rt.avgGpa).toFixed(1)}" r="3.5" fill="${n.gpaLine}"/><text x="${T(st).toFixed(1)}" y="${($(rt.avgGpa)-9).toFixed(1)}" text-anchor="middle" font-size="11.5" font-weight="600" fill="${n.gpaLine}">${pe(rt.avgGpa)}</text>`).join(""),X=d.map((rt,st)=>`<circle cx="${T(st).toFixed(1)}" cy="${H(rt.avgScore).toFixed(1)}" r="3" fill="${n.scoreLine}"/><text x="${T(st).toFixed(1)}" y="${(H(rt.avgScore)+17).toFixed(1)}" text-anchor="middle" font-size="11.5" fill="${n.scoreLine}">${pe(rt.avgScore)}</text>`).join(""),ct=y?`<g font-size="12">
  <rect x="${_.left}" y="30" width="12" height="12" rx="3" fill="${n.gpaLine}"/><text x="${_.left+18}" y="40" fill="${ne}">学期平均绩点</text>
  <rect x="${_.left+132}" y="30" width="12" height="12" rx="3" fill="${n.scoreLine}"/><text x="${_.left+150}" y="40" fill="${ne}">加权均分</text>
</g>`:`<g font-size="12">
  <rect x="${A-_.right-176}" y="8" width="12" height="12" rx="3" fill="${n.gpaLine}"/><text x="${A-_.right-158}" y="18" fill="${ne}">学期平均绩点</text>
  <rect x="${A-_.right-82}" y="8" width="12" height="12" rx="3" fill="${n.scoreLine}"/><text x="${A-_.right-64}" y="18" fill="${ne}">加权均分</text>
</g>`;return`${wo({...u,kind:"trend",label:"学期成绩趋势"})}
${it}
${mt}
<g>${Q}</g>
<text x="${_.left}" y="18" font-size="12" fill="${ne}">每学期修读学分（柱）</text>
...
<g>${V}</g>
${ct}
</svg>`}a(la,"trendChartSvg");function ca({bands:p,palette:n,layout:c}){let d=p||[],u=qi(c,"bands",d.length),{width:A,height:P,pad:_,mobile:y}=u,S=A-_.left-_.right,g=P-_.top-_.bottom,k=d.length||1,T=Math.max(1,...d.map(b=>b.count)),C=y?Math.min(32,S/k*.62):Math.min(40,S/k*.52),f=d.map((b,w)=>{let x=_.left+(w+.5)*(S/k),E=b.count?Math.max(8,b.count/T*g):0,q=_.top+g-E,I=(.4+(1-w/(k-1))*.6).toFixed(2),L=b.range||(b.min===0?"<60":`${b.min}-${b.max===100?"100":b.max}`),O=[`${b.level||""}（绩点 ${b.gpa}）`,`百分制 ${L}`,`课程 ${b.count} 门`].join(`
...
<text x="${x.toFixed(1)}" y="${(q-6).toFixed(1)}" text-anchor="middle" font-size="12.5" font-weight="600" fill="var(--text)">${pe(b.count)}</text>
<text x="${x.toFixed(1)}" y="${P-26}" text-anchor="middle" font-size="11" font-weight="600" fill="${ne}">${pe(L)}</text>
<text x="${x.toFixed(1)}" y="${P-12}" text-anchor="middle" font-size="12" fill="${ne}">${pe(b.gpa)}</text>`}).join("");return`${wo({...u,kind:"bands",label:"成绩分段分布"})}
<line x1="${_.left}" y1="${(_.top+g).toFixed(1)}" x2="${A-_.right}" y2="${(_.top+g).toFixed(1)}" stroke="${ko}" stroke-width="1"/>
${f}
</svg>`}a(ca,"bandsChartSvg");function Ti({items:p,requiredRatio:n,palette:c}){let _=2*Math.PI*56,y=(p||[]).filter(T=>T&&T.ratio>0),S=Math.max(0,Math.min(100,Math.round(Number(n)||0)));if(!y.length)return'<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成"></svg>';let g=-90,k=y.map(T=>{let C=T.ratio/100*_,b=`<circle cx="75" cy="75" r="56" fill="none" stroke="${c.share&&c.share[T.key]||c.required}" stroke-width="24"
  stroke-dasharray="${C.toFixed(2)} ${_.toFixed(2)}"
  stroke-linecap="butt" transform="rotate(${g.toFixed(2)} 75 75)"/>`;return g+=T.ratio/100*360,b}).join("");return`<svg viewBox="0 0 150 150" class="urppp-sa-chart" role="img" aria-label="课程类型构成">
<circle cx="75" cy="75" r="56" fill="none" stroke="${ko}" stroke-width="24"/>
${k}
<text x="75" y="69" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text)">${pe(S)}%</text>
<text x="75" y="91" text-anchor="middle" font-size="11.5" fill="${ne}">必修学分占比</text>
</svg>`}a(Ti,"donutSvg");var Ic=Object.freeze({gpaLine:"var(--primary)",scoreLine:"var(--text-secondary)",credit:"var(--primary)",primary:"var(--primary)",share:Object.freeze({required:"var(--primary)",elective:"var(--text-muted)",optional:"var(--text-secondary)",other:"var(--border)"})}),Nc='<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-8"/><path d="M22 20H2"/></svg>',Bc='<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>';function Mi({deps:p}){let n=p&&p.palette||Ic;function c(){return`<div id="urppp-score-analysis" class="urppp-sa" data-urppp-sa-state="collapsed">
  <button type="button" class="urppp-sa-toggle" aria-expanded="false">
    <span class="urppp-sa-icon">${Nc}</span>
    <span class="urppp-sa-title">成绩分析</span>
    <span class="urppp-sa-summary" data-urppp-sa-summary>点击展开，查看成绩指标与学期变化</span>
    <span class="urppp-sa-chevron">${Bc}</span>
  </button>
  ...
  <button type="button" class="urppp-sa-retry" data-urppp-sa-retry>重试</button></div>`}a(u,"errorHtml");function A(S){return[{label:"主修必修绩点",value:S.requiredGpa>0?String(S.requiredGpa):"—",hint:"必修课程加权"},{label:"平均绩点",value:S.avgGpa!=null?String(S.avgGpa):"—",hint:"全部及格加权"},{label:"加权均分",value:S.avgScore!=null?String(S.avgScore):"—",hint:"学分加权"},{label:"已修学分",value:S.totalCredit!=null?String(S.totalCredit):"—",hint:"及格课程学分"},{label:"已修课程",value:String(S.courseCount||0),hint:"含未评估"}].map(k=>`<div class="urppp-sa-metric">
  <div class="urppp-sa-metric-value">${at(k.value)}</div>
  <div class="urppp-sa-metric-label">${at(k.label)}</div>
  <div class="urppp-sa-metric-hint">${at(k.hint)}</div>
</div>`).join("")}a(A,"metricCards");function P(S){return`<table class="urppp-sa-table">
<thead><tr><th>学期</th><th>课程</th><th>学分</th><th>加权均分</th><th>平均绩点</th></tr></thead>
<tbody>${(S||[]).map(k=>`<tr><td>${at(k.label)}</td><td>${at(k.count)}</td><td>${at(k.credit)}</td><td>${at(k.avgScore)}</td><td>${at(k.avgGpa)}</td></tr>`).join("")}</tbody></table>`}a(P,"detailTable");function _(S){return(S||[]).map(g=>`<div class="urppp-sa-legend-item"><i class="urppp-sa-legend-dot" style="background:${n.share&&n.share[g.key]||n.primary}"></i>${at(g.label)} ${at(g.credit)} 学分 · ${at(g.count)} 门</div>`).join("")}a(_,"shareLegend");function y(S,g={}){if(!S||S.empty)return'<div class="urppp-sa-empty">暂无可用成绩数据，请先在教务系统查询成绩后再试。</div>';let k=S.share||{items:[],requiredRatio:0},T=g.chartLayout||null;return`<div class="urppp-sa-metrics">${A(S.metrics)}</div>
<div class="urppp-sa-grid">
  <section class="urppp-sa-card urppp-sa-trend">
    <h5 class="urppp-sa-card-title">学期趋势</h5>
    <div class="urppp-sa-chart-scroll">${la({trend:S.trend,palette:n,layout:T})}</div>
  </section>
  <section class="urppp-sa-card urppp-sa-share">
    <h5 class="urppp-sa-card-title">课程类型构成</h5>
    <div class="urppp-sa-share-body">
      <div class="urppp-sa-donut">${Ti({items:k.items,requiredRatio:k.requiredRatio,palette:n})}</div>
      <div class="urppp-sa-legend">${_(k.items)}</div>
    </div>
  </section>
</div>
<div class="urppp-sa-grid">
  <section class="urppp-sa-card urppp-sa-bands">
    ...
    <div class="urppp-sa-chart-scroll">${ca({bands:S.bands,palette:n,layout:T})}</div>
  </section>
  <section class="urppp-sa-card urppp-sa-detail">
    <h5 class="urppp-sa-card-title">各学期明细</h5>
    ${P(S.trend)}
  </section>
</div>`}return a(y,"analysisHtml"),{panelShellHtml:c,loadingHtml:d,errorHtml:u,analysisHtml:y,palette:n}}a(Mi,"createScoreAnalysisRenderer");function $i(){function p(n,c){let d=n.querySelector(".urppp-sa-toggle"),u=n.querySelector("[data-urppp-sa-body]");if(!d||!u)return{isExpanded:a(()=>!1,"isExpanded"),setExpanded:a(()=>{},"setExpanded"),syncShareLayout:a(()=>{},"syncShareLayout")};let A=a(_=>{let y=_?"expanded":"collapsed";n.dataset.urpppSaState=y,d.setAttribute("aria-expanded",String(_)),u.hidden=!_,_&&typeof c.onExpand=="function"&&c.onExpand()},"setExpanded");d.addEventListener("click",()=>{let _=d.getAttribute("aria-expanded")==="true";A(!_)}),u.addEventListener("click",_=>{let y=_.target;y&&y.closest&&y.closest("[data-urppp-sa-retry]")&&typeof c.onRetry=="function"&&c.onRetry()});function P(){let _=n.querySelector(".urppp-sa-donut"),y=n.querySelector(".urppp-sa-legend"),S=!!(_&&y&&y.getBoundingClientRect().top>=_.getBoundingClientRect().bottom);n.classList.toggle("urppp-sa-share-stacked",S)}return a(P,"syncShareLayout"),{setExpanded:A,syncShareLayout:P,isExpanded:a(()=>d.getAttribute("aria-expanded")==="true","isExpanded")}}return a(p,"bindPanel"),{bindPanel:p}}a($i,"createScoreAnalysisUI");var Ii="urppp-score-analysis";function Ni({deps:p}){let n=sa({deps:p}),c=Mi({deps:p}),d=$i(),u=null,A="idle",P=null,_=null,y=null,S=!1,g=0,k="desktop";function T(){if(!p.styles||document.getElementById("urppp-score-analysis-style"))return;let U=document.createElement("style");U.id="urppp-score-analysis-style",U.textContent=p.styles,(document.head||document.documentElement).appendChild(U)}a(T,"ensureStyle");function C(){if(typeof p.getInsertHost=="function"){let U=p.getInsertHost();if(U)return U}return document.querySelector(".page-content")||document.getElementById("page-content-template")||document.body}a(C,"findHost");function f(){return u&&u.querySelector("[data-urppp-sa-content]")}a(f,"contentEl");function b(){return P||(A="loading",P=(async()=>{try{let[U,et]=await Promise.all([p.loadScores(),p.loadProfile()]);if(U&&U.error)throw new Error(U.error);let it=n.analyzeScores({scorePack:U,profile:et});return _=it,A="ready",it}catch(U){throw A="error",U}finally{P=null}})(),P)}a(b,"startLoad");function w(){A==="idle"&&b().catch(()=>{})}a(w,"warmup");function x(){if(y&&typeof y.syncShareLayout=="function")try{y.syncShareLayout()}catch{}}a(x,"syncShareLayout");function E(){try{if(window.matchMedia&&window.matchMedia("(max-width: 720px)").matches)return{variant:"mobile"}}catch{}return null}a(E,"currentChartLayout");function q(){let U=f();if(!U||!_)return;let et=E();k=et?et.variant:"desktop",U.innerHTML=c.analysisHtml(_,{chartLayout:et}),x()}a(q,"renderReadyAnalysis");function I(){clearTimeout(g),g=setTimeout(()=>{if(x(),!_||!y||!y.isExpanded())return;let U=E();(U?U.variant:"desktop")!==k&&q()},120)}a(I,"handleResize");function L(){S||(S=!0,window.addEventListener("resize",I))}a(L,"bindResize");function O(){S&&(S=!1,clearTimeout(g),g=0,window.removeEventListener("resize",I))}a(O,"unbindResize");async function $(){let U=f();if(U){if(A==="ready"&&_){q();return}U.innerHTML=c.loadingHtml();try{await b(),q()}catch(et){U.innerHTML=c.errorHtml(et&&et.message||String(et))}}}a($,"handleExpand");function H(){if(T(),u&&u.isConnected)return u;if(document.getElementById(Ii))return document.getElementById(Ii);let U=C();if(!U)return null;let et=document.createElement("div");return et.innerHTML=c.panelShellHtml(),u=et.firstElementChild,U.insertBefore(u,U.firstChild),y=d.bindPanel(u,{onExpand:$,onRetry:$}),L(),w(),p.shouldAutoExpand&&p.shouldAutoExpand()&&(typeof requestAnimationFrame=="function"?requestAnimationFrame:mt=>setTimeout(mt,0))(()=>{try{y.setExpanded(!0)}catch{}}),u}a(H,"mount");function G(){O(),u&&u.isConnected&&u.remove(),u=null,y=null,A="idle",P=null,_=null,k="desktop"}return a(G,"unmount"),{mount:H,unmount:G,getPanel:a(()=>u,"getPanel"),reset:G}}a(Ni,"createScoreAnalysisController");function Bi({documentRef:p=document,locationRef:n=location,windowRef:c=window}){function d(S){return String(S||"").replace(/[\u00a0\s]+/g," ").replace(/^[>\u25b8\u203a·•\u00bb]+/,"").replace(/^\s*[\u25b8>]\s*/,"").trim()}a(d,"cleanMenuLabel");function u(S){if(!S)return"";let g=S.querySelector(":scope > a");if(!g)return"";let k=g.querySelector(".menu-text, .urppp-nav-text");if(k)return d(k.textContent);let T=g.cloneNode(!0);return T.querySelectorAll("i, b, .badge, .arrow, .menu-icon, .urppp-nav-arrow").forEach(C=>C.remove()),d(T.textContent)}a(u,"getMenuLiLabel");function A(S){let g=[],k=S,T=p.getElementById("menus")||p.getElementById("urppp-menus");for(;k&&k!==T;){if(k.tagName==="LI"){let C=u(k);C&&!/^(首页|一级菜单|二级菜单|三级菜单)$/.test(C)&&g.unshift(C)}k=k.parentElement}return g.filter((C,f)=>C&&C!==g[f-1])}a(A,"walkMenuAncestors");function P(){let S=n.pathname.replace(/\/+$/,"")||"/",g=n.search||"",k=[];return[p.getElementById("menus"),p.getElementById("urppp-menus")].filter(Boolean).forEach(C=>{C.querySelectorAll("a[href]").forEach(f=>{let b=f.getAttribute("href")||"";if(!(!b||b==="#"||b.startsWith("javascript")))try{let w=new URL(b,n.origin),x=w.pathname.replace(/\/+$/,"")||"/";if(x==="/"&&S!=="/")return;let E=0;S===x?E=1e3+x.length:S.startsWith(x+"/")?E=500+x.length:S.includes(x)&&x.length>8&&(E=200+x.length),E&&g&&w.search&&g.indexOf(w.search.slice(1))>=0&&(E+=50),E>0&&k.push({score:E,li:f.closest("li")})}catch{}})}),k.sort((C,f)=>f.score-C.score),k.length?k[0].li:null}a(P,"findMenuLiByPath");function _(){let S=P();if(S){let b=A(S);if(b.length)return b}let g="";try{let b=p.cookie.match(/(?:^|;\s*)selectionBar=([^;]+)/);b&&(g=decodeURIComponent(b[1]))}catch{}if(g&&g!=="0"){let b=p.getElementById(g);if(b){let w=A(b);if(w.length)return w}}let k=null,T=Array.from(p.querySelectorAll("#menus li.active"));if(T.length){k=T[T.length-1];for(let b=T.length-1;b>=0;b--)if(!T[b].querySelector("li.active")){k=T[b];break}}if(!k){let b=Array.from(p.querySelectorAll("#urppp-menus .urppp-nav-item.active"));if(b.length){k=b[b.length-1];for(let w=b.length-1;w>=0;w--)if(!b[w].querySelector(".urppp-nav-item.active")){k=b[w];break}}}if(k){let b=A(k);if(b.length)return b}let C=p.getElementById("breadcrumbs")||p.querySelector(".breadcrumbs"),f=C&&(C.querySelector("ul.breadcrumb")||C.querySelector(".breadcrumb"));if(f){let b=[];if(Array.from(f.children).forEach((w,x)=>{if(x===0)return;let E=d(w.textContent);!E||/^(首页|一级菜单|二级菜单|三级菜单)$/.test(E)||b[b.length-1]!==E&&b.push(E)}),b.length)return b}return[]}a(_,"getBreadcrumbTrail");function y(){let S=p.getElementById("breadcrumbs")||p.querySelector(".breadcrumbs");if(!S)return;S.classList.remove("hide"),S.style.removeProperty("display"),S.style.setProperty("display","flex","important");let g=S.querySelector("ul.breadcrumb")||S.querySelector(".breadcrumb");g||(g=p.createElement("ul"),g.className="breadcrumb",S.appendChild(g));let k=_();if(!k.length&&Array.from(g.children).map(b=>d(b.textContent)).filter(Boolean).some(b=>b!=="首页"&&!/^(一级菜单|二级菜单|三级菜单)$/.test(b)))return;g.innerHTML="";let T=p.createElement("li");T.style.cursor="pointer",T.innerHTML='<span class="urppp-bc-label"><i class="ace-icon fa fa-home home-icon"></i>首页</span>',T.addEventListener("click",()=>{c.location.href="/"}),g.appendChild(T),k.forEach((C,f)=>{let b=p.createElement("li");f===k.length-1&&b.classList.add("active");let w=p.createElement("span");w.className="urppp-bc-label",w.textContent=C,b.appendChild(w),g.appendChild(b)})}return a(y,"beautifyBreadcrumbs"),{beautifyBreadcrumbs:y}}a(Bi,"createBreadcrumbController");function Fi({documentRef:p=document,windowRef:n=window,MutationObserverRef:c=MutationObserver,nodeTypeRef:d=Node}){function u(){try{let _=p.getElementById("sidebar"),y=p.querySelectorAll(".main-content");if(!y.length)return;let S=n.matchMedia&&n.matchMedia("(max-width: 991px)").matches,g="260px";S?g="0px":_&&(g=_.classList.contains("menu-min")?"50px":"260px"),y.forEach(k=>k.style.setProperty("margin-left",g,"important"))}catch{}}a(u,"syncMobileContentOffset");function A(){try{let _=p.getElementById("sidebar"),y=p.querySelector("#navbar, .navbar.navbar-default, .navbar-fixed-top");if(!_||!y||_.classList.contains("urppp-clean-sidebar"))return;let S=y.getBoundingClientRect(),g=Math.max(45,Math.round(S.height||y.offsetHeight||45));p.documentElement.style.setProperty("--urppp-navbar-height",g+"px"),_.style.setProperty("top",g+"px","important"),_.style.setProperty("height","calc(100vh - "+g+"px)","important"),_.style.setProperty("margin-top","0","important"),y.style.setProperty("z-index","1100","important"),_.style.setProperty("z-index","1030","important"),u()}catch{}}a(A,"syncSidebarUnderNavbar");function P(){let _=p.getElementById("sidebar"),y=p.getElementById("menus");if(!_||!y)return;if(n.__urpppSidebarMenuObserver){try{n.__urpppSidebarMenuObserver.disconnect()}catch{}n.__urpppSidebarMenuObserver=null}let S=p.getElementById("urppp-menus"),g=_.querySelector(".urppp-sidebar-header");S&&S.remove(),g&&g.remove(),A();let k=new Set;y.querySelectorAll("li.active").forEach($=>{$.id&&k.add($.id)});function T($){return Array.from($.children).filter(H=>H.tagName==="LI").map(H=>{let G=H.querySelector(":scope > a"),U=G?.querySelector(".menu-text"),et=U?U.textContent.trim():G?Array.from(G.childNodes).filter(st=>st.nodeType===d.TEXT_NODE).map(st=>st.textContent).join("").trim():"",it=G?.querySelector(".menu-icon"),mt=it?Array.from(it.classList).filter(st=>st!=="menu-icon").join(" "):"",V=H.querySelector(":scope > .submenu"),Q=V?T(V):[];Q=Q.filter(st=>st.text&&(st.text.trim()||st.href&&st.href!=="#"));let ot=G?.getAttribute("href")||"#",X=G?.getAttribute("target")||"",ct=H.getAttribute("onclick")||G?.getAttribute("onclick")||"",rt=H.id;return ot!=="#"&&!ot.startsWith("javascript")?{id:rt,text:et,iconClass:mt,children:[],href:ot,target:X,onclick:ct}:Q.length===1&&Q[0].children.length===0?{id:rt||Q[0].id,text:et,iconClass:mt||Q[0].iconClass,children:[],href:Q[0].href||ot,target:Q[0].target||X,onclick:Q[0].onclick||ct}:{id:rt,text:et,iconClass:mt,children:Q,href:ot,target:X,onclick:ct}})}a(T,"parseMenu");let C=T(y);y.style.display="none";let f=p.createElement("div");f.className="urppp-sidebar-header",f.style.cssText="position:absolute;top:0;left:0;right:0;z-index:100;display:flex;align-items:center;justify-content:flex-end;padding:14px 14px 12px;border-bottom:1px solid var(--border);background:var(--surface)";let b=p.createElement("button");b.type="button",b.className="urppp-sidebar-toggle",b.innerHTML='<i class="fa fa-angle-left" aria-hidden="true"></i>',b.title="收起侧边栏",typeof b.setAttribute=="function"&&b.setAttribute("aria-label","收起侧边栏");let w=a(()=>!!(n.matchMedia&&n.matchMedia("(max-width: 991px)").matches),"isNarrow"),x=a($=>{if($&&($.preventDefault(),$.stopPropagation()),w()){_.classList.remove("display"),u();return}let H=p.getElementById("sidebar-collapse");H&&H.click()},"doToggle");b.addEventListener("click",x),f.appendChild(b);let E=a(()=>{let $=w(),H=p.body.classList.contains("menu-min")||_.classList.contains("menu-min"),G=$?"关闭菜单":H?"展开侧边栏":"收起侧边栏";b.innerHTML=$?'<i class="fa fa-times" aria-hidden="true"></i>':H?'<i class="fa fa-angle-right" aria-hidden="true"></i>':'<i class="fa fa-angle-left" aria-hidden="true"></i>',b.title=G,typeof b.setAttribute=="function"&&b.setAttribute("aria-label",G),!$&&H?(f.style.justifyContent="center",f.style.padding="12px 0"):(f.style.justifyContent="flex-end",f.style.padding="")},"syncToggle"),q=new c(E);q.observe(p.body,{attributes:!0,attributeFilter:["class"]}),q.observe(_,{attributes:!0,attributeFilter:["class"]}),n.__urpppSidebarMenuObserver=q,E();let I=p.createElement("ul");I.id="urppp-menus",I.style.cssText="margin-top:50px;list-style:none;padding:10px 12px 24px;overflow-y:auto;max-height:calc(100vh - 64px)";function L($){p.querySelectorAll("#urppp-menus .urppp-nav-item").forEach(G=>G.classList.remove("active"));let H=$;for(;H&&H.id!=="urppp-menus";)H.classList.contains("urppp-nav-item")&&H.classList.add("active"),H=H.parentElement}a(L,"setActiveBranch");function O($,H){let G=p.createElement("li");G.className="urppp-nav-item",$.id&&(G.id=$.id);let U=$.children.length>0,et=$.href||"#",it=et!=="#"&&!et.startsWith("javascript"),mt=p.createElement("a");if(mt.className="urppp-nav-link",mt.href=it?et:"javascript:void(0)",$.target&&mt.setAttribute("target",$.target),$.iconClass){let Q=p.createElement("i");$.iconClass.split(" ").forEach(ot=>{ot&&Q.classList.add(ot)}),mt.appendChild(Q)}let V=p.createElement("span");if(V.className="urppp-nav-text",V.textContent=$.text,V.title=$.text,mt.appendChild(V),U){let Q=p.createElement("i");Q.className="urppp-nav-arrow fa fa-angle-down",Q.addEventListener("click",ot=>{ot.preventDefault(),ot.stopPropagation(),G.classList.toggle("open")}),mt.appendChild(Q)}if(G.appendChild(mt),mt.addEventListener("click",Q=>{if(L(G),!it&&U)Q.preventDefault(),G.classList.toggle("open");else if(it)return}),U){let Q=p.createElement("ul");Q.className="urppp-nav-submenu",$.children.forEach(ot=>O(ot,Q)),G.appendChild(Q)}$.id&&k.has($.id)&&G.classList.add("active"),H.appendChild(G)}a(O,"buildItem"),C.forEach($=>O($,I)),I.querySelectorAll(".urppp-nav-item.open").forEach($=>$.classList.remove("open")),_.insertBefore(f,_.firstChild),_.appendChild(I)}return a(P,"rebuildSidebarCompletely"),{rebuildSidebarCompletely:P,syncMobileContentOffset:u,syncSidebarUnderNavbar:A}}a(Fi,"createSidebarController");function Di({theme:p,settings:n,documentRef:c=document,windowRef:d=window}){function u(S){if(!S)return;let g=p.getSkin(),k=p.skinSupportsFixedPalettes(g),T=p.getCurrent(),C=k?p.getBrutalActivePalette():null,f=k?p.getBrutalSelectedPalette():null;S.querySelectorAll(".urppp-nav-dot[data-theme]").forEach(b=>{let w=b.dataset.theme,x=w==="dark",E=w==="scu-red",q=x&&!p.skinSupportsDark(g)||E&&!p.skinSupportsDynamic(g)&&!k,I=w===T;if(k&&(I=w==="default"&&C.id===p.BRUTAL_DEFAULT_PALETTE||E&&C.id!==p.BRUTAL_DEFAULT_PALETTE),b.disabled=q,b.classList.toggle("urppp-theme-disabled",q),b.classList.toggle("ac",I&&!q),b.setAttribute("aria-disabled",q?"true":"false"),w==="default")b.style.background=k?p.getBrutalPaletteById(p.BRUTAL_DEFAULT_PALETTE).accent:"#F1F3F5",b.title=k?"默认高能粉":"简约白";else if(x)b.style.background=q?"#A7A7A7":"#0B0F14",b.title=q?"当前界面风格不支持暗色模式":"深邃暗";else if(E)if(q)b.style.background="#A7A7A7",b.title="当前界面风格不支持动态配色";else if(k)b.style.background=f.accent,b.title="高对比配色："+f.name;else{let L=p.getAccent()||p.DEFAULT_SEED;try{let O=p.buildSchemePreview(L,p.getScheme());b.style.background="linear-gradient(135deg, "+O.primary+" 0 55%, "+O.surface+" 55% 100%)"}catch{b.style.background=L}b.title="动态配色"}})}a(u,"syncThemeDotGroup");function A(S){let g=p.getSkin();if(p.skinSupportsFixedPalettes(g)){if(S==="dark")return;p.getCurrent()!=="default"&&p.applyTheme("default",{manual:!0}),S==="default"&&p.setBrutalPalette(p.BRUTAL_DEFAULT_PALETTE),S==="scu-red"&&p.setBrutalPalette(p.getBrutalSelectedPalette().id);return}p.isThemeModeAvailable(S,g)&&p.applyTheme(S,{manual:!0})}a(A,"handleThemeDotClick");function P(){u(c.getElementById("urppp-nav-theme"))}a(P,"syncNavbarThemeUI");function _(){try{let S=c.getElementById("navbar")||c.querySelector(".navbar");if(!S)return;if(c.getElementById("urppp-nav-theme")){P();return}let g=S.querySelector(".navbar-header .navbar-brand")||S.querySelector(".navbar-brand")||S.querySelector(".navbar-header");if(!g)return;let k=c.createElement("div");k.id="urppp-nav-theme",k.innerHTML=['<button type="button" class="urppp-nav-dot" data-theme="default" title="简约白" style="background:#F1F5F9"></button>','<button type="button" class="urppp-nav-dot" data-theme="dark" title="深邃暗" style="background:#0B0F17"></button>','<button type="button" class="urppp-nav-dot" data-theme="scu-red" title="动态配色" style="background:#B53434"></button>','<button type="button" class="urppp-nav-settings" id="urppp-nav-settings" title="设置" aria-label="设置">','  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">','    <circle cx="12" cy="12" r="3"></circle>','    <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"></path>',"  </svg>","</button>"].join(""),g.parentElement?(g.parentElement.style.setProperty("display","flex","important"),g.parentElement.style.setProperty("align-items","center","important"),g.nextSibling?g.parentElement.insertBefore(k,g.nextSibling):g.parentElement.appendChild(k)):g.appendChild(k),k.style.setProperty("display","inline-flex","important"),k.style.setProperty("align-items","center","important"),k.style.setProperty("height","36px","important"),k.querySelectorAll(".urppp-nav-dot[data-theme]").forEach(T=>{T.addEventListener("click",()=>{A(T.dataset.theme),P();try{n.syncSettingsPanelUI()}catch{}})}),k.querySelector("#urppp-nav-settings").addEventListener("click",T=>{T.preventDefault(),T.stopPropagation(),n.openSettingsPanel()}),n.ensureSettingsPanel(),P();try{d.__urpppCleanMode&&d.__urpppCleanMode.inject()}catch{}}catch(S){console.warn("[URP++] navbar theme switch inject failed",S)}}a(_,"injectNavbarThemeSwitch");function y(){let g=c.getElementById("navbar")?.querySelector(".ace-nav");try{_()}catch{}if(!g)return;function k(E,q){Object.entries(q).forEach(([I,L])=>E.style.setProperty(I,L,"important"))}a(k,"force"),Array.from(g.childNodes).forEach(E=>{E.nodeType===Node.TEXT_NODE&&!E.textContent.trim()&&E.remove()}),g.querySelectorAll(":scope > li").forEach(E=>{k(E,{display:"inline-flex","align-items":"center","vertical-align":"middle",margin:"0",padding:"0","text-align":"left"})}),g.querySelectorAll(":scope > li > a").forEach(E=>{k(E,{display:"inline-flex","align-items":"center","justify-content":"center",height:"36px",padding:"0 4px","flex-wrap":"nowrap","vertical-align":"middle","text-decoration":"none"}),E.style.lineHeight="1"}),g.querySelectorAll(":scope > li > a > .ace-icon, :scope > li > a > .glyphicon, :scope > li > a > .fa").forEach(E=>{k(E,{top:"auto","vertical-align":"middle","line-height":"1","margin-top":"0"})});let T=g.querySelector(':scope > li > a[href*="customerServiceCenter"]');T&&(k(T,{width:"28px","justify-content":"center"}),T.style.padding="0 4px");let C=c.getElementById("clickdiv"),f=c.getElementById("form-search"),b=c.getElementById("search-input"),w=c.getElementById("intellegenceUDiv");if(w&&(w.style.setProperty("position","relative","important"),w.style.setProperty("z-index","30","important"),w.style.setProperty("display","inline-flex","important"),w.style.setProperty("align-items","center","important"),w.style.setProperty("justify-content","center","important"),w.style.setProperty("width","32px","important"),w.style.setProperty("height","36px","important"),w.style.setProperty("vertical-align","middle","important"),w.style.setProperty("margin","0","important"),w.style.setProperty("padding","0","important")),C&&f){C.removeAttribute("onclick"),k(C,{"background-color":"transparent",position:"relative",display:"inline-flex","align-items":"center","justify-content":"center",width:"32px",height:"32px","border-radius":"8px","line-height":"1","z-index":"30"});let E=c.getElementById("clicki");E&&k(E,{color:"var(--text-secondary)","margin-top":"0"}),C.__urpppNavbarClickBound||(C.__urpppNavbarClickBound=!0,C.addEventListener("mouseenter",()=>C.style.setProperty("background-color","var(--input-bg)","important")),C.addEventListener("mouseleave",()=>C.style.setProperty("background-color","transparent","important")),C.addEventListener("click",L=>{L.preventDefault(),L.stopPropagation(),f.dataset.open==="1"?(f.style.width="0px",f.style.opacity="0",f.dataset.open="0"):(f.style.width="180px",f.style.opacity="1",f.dataset.open="1",b&&setTimeout(()=>b.focus(),50))})),d.__urpppNavbarOutsideClickBound||(d.__urpppNavbarOutsideClickBound=!0,c.addEventListener("click",L=>{let O=c.getElementById("clickdiv"),$=c.getElementById("form-search");!O||!$||$.dataset.open!=="1"||!O.contains(L.target)&&!$.contains(L.target)&&($.style.width="0px",$.style.opacity="0",$.dataset.open="0")})),k(f,{position:"absolute",right:"34px",top:"50%",transform:"translateY(-50%)",left:"auto",margin:"0","z-index":"10",background:"transparent",border:"none","box-shadow":"none",overflow:"hidden",padding:"0",transition:"width .2s ease, opacity .2s ease"});let q=f.dataset.open==="1"?"160px":"0px";f.style.width!==q&&(f.style.width=q,f.style.opacity=f.dataset.open==="1"?"1":"0"),b&&k(b,{"background-color":"var(--input-bg)",border:"1px solid var(--border)",color:"var(--text)","border-radius":"8px",height:"32px",padding:"0 12px","line-height":"32px",width:"100%"});let I=f.querySelector(".input-icon > .ace-icon.fa-search");I&&(I.style.display="none")}let x=g.querySelector(":scope > li.light-blue > a");if(x){k(x,{display:"inline-flex","align-items":"center",gap:"6px"});let E=x.querySelector(".user-info");E&&(k(E,{display:"inline-flex","align-items":"center",gap:"4px","max-width":"none","white-space":"nowrap","vertical-align":"middle","line-height":"1","margin-top":"-12px"}),Array.from(E.childNodes).forEach(I=>{I.nodeType===Node.TEXT_NODE&&(I.textContent=I.textContent.replace(/\s+/g,"").trim())}),Array.from(E.children).forEach(I=>{k(I,{display:"inline","white-space":"nowrap","vertical-align":"middle","line-height":"1",margin:"0",padding:"0"}),I.tagName==="SMALL"&&I.style.setProperty("font-size","inherit","important")}));let q=x.querySelector(".nav-user-photo");q&&(q.alt=(q.alt||"").replace(/\s+/g,"").trim(),k(q,{"vertical-align":"middle",display:"inline-block",width:"30px",height:"30px"}))}}return a(y,"rebuildNavbar"),{handleThemeDotClick:A,injectNavbarThemeSwitch:_,rebuildNavbar:y,syncNavbarThemeUI:P,syncThemeDotGroup:u}}a(Di,"createNavbarController");(function(){"use strict";try{let t=typeof navigator<"u"&&navigator.userAgent||"";if(/Android|iPhone|iPad|iPod|Mobile/i.test(t)){document.documentElement&&document.documentElement.classList.add("urppp-mobile");let e=document.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",e.content="width=device-width, initial-scale=1",(document.head||document.documentElement||document).appendChild(e))}}catch{}let p="1.9.5";if(/^id\./i.test(String(location.hostname||""))){try{let t=co({GM:{getValue:typeof GM_getValue=="function"?GM_getValue:null,setValue:typeof GM_setValue=="function"?GM_setValue:null,xmlHttp:typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:null,addStyle:typeof GM_addStyle=="function"?GM_addStyle:null},doc:document,hostInfo:{version:p},uiDeps:{openSubpanel:a(()=>{},"openSubpanel")}}),e=a(()=>{try{t.bootFromCache("assist")}catch{}},"boot");document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}catch{}return}let n={mainRaw:"https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/urppp.user.js",assistRaw:"https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/urpppp.user.js",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",changelogPage:"https://github.com/chaolan2019/SCU-URP-plusplus/blob/main/CHANGELOG.md",greasySearch:"https://greasyfork.org/zh-CN/scripts?q=SCU+URP%2B%2B",versionJson:"version.json",sourceUrls:a(t=>[`https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/${t}`,`https://cdn.jsdelivr.net/gh/chaolan2019/SCU-URP-plusplus@main/${t}`,`https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/SCU-URP-plusplus/main/${t}`],"sourceUrls")},c="urppp_auto_update_check_v1",d="urppp_skin_v1",u=[{id:"apple",name:"类Apple风格",desc:"系统灰底、链接蓝、大圆角与轻阴影，默认精修方向。",ready:!0,dark:!0,dynamic:!0,installed:!0,builtin:!0,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"editorial",name:"编辑杂志",desc:"衬线标题、无框版面与淡分割线。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!0,builtin:!0,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"flat",name:"极简扁平",desc:"无阴影、硬边与纯色层次，冷硬清晰。",ready:!0,dark:!0,dynamic:!0,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"organic",name:"自然有机",desc:"奶油底与大地色，温暖圆角。不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"brutal",name:"新野兽派",desc:"高对比画布、粗边框与硬阴影。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,palettes:!0,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}},{id:"neu",name:"新拟物",desc:"同色双阴影凸起/内凹，立体柔和。支持暗色，不支持动态配色。",ready:!0,dark:!0,dynamic:!1,installed:!1,version:"1.0.0",author:"Chao_Lan",repo:"https://github.com/chaolan2019/SCU-URP-plusplus",caps:{scope:"app",allowJS:!1}}],A=GM_addStyle(`
  ...
  `);A&&(A.id="urppp-early-style");let P=`
  ...
  `;function _(t){let e=document.createElement("div");return e.className="urppp-inline-loader",e.innerHTML=P+(t?`<div>${t}</div>`:""),e}a(_,"makeInlineLoader");function y(t){return!t||!t.closest?!1:!!t.closest('[id^="div_page_loading"], [id*="page_loading"], [id*="PageLoading"]')}a(y,"isPageLoadingOverlay");function S(t){try{(t&&t.querySelectorAll?t:document).querySelectorAll('[id^="div_page_loading"], [id*="page_loading"]').forEach(r=>{r.querySelectorAll(".urppp-inline-loader").forEach(o=>{try{o.remove()}catch{}}),r.classList.remove("urppp-loading-active")})}catch{}}a(S,"cleanupPageLoadingOverlays");function g(t){try{let e=t&&t.querySelectorAll?t:document;S(e),e.querySelectorAll("img").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1"||y(r))return;let o=(r.getAttribute("src")||r.src||"").toLowerCase();if(!o||!(o.includes("pageloading")||o.includes("page-loading")||o.includes("loading.gif")||o.includes("loading-0")||o.includes("loading-1"))||o.includes("/loading")&&!o.includes("pageloading")&&!o.includes("loading.gif")&&!o.includes("loading-0"))return;r.dataset.urpppReplaced="1";let i=_("");i.style.minHeight="0",i.style.padding="0",r.parentElement&&r.parentElement.replaceChild(i,r)}catch{}}),e.querySelectorAll(".layui-layer-content.layui-layer-loading0, .layui-layer-content.layui-layer-loading1, .layui-layer-content.layui-layer-loading2, .layui-layer-loading .layui-layer-content").forEach(r=>{try{if(!r||r.dataset.urpppReplaced==="1")return;if(r.dataset.urpppReplaced="1",r.style.setProperty("background","transparent","important"),r.style.setProperty("background-image","none","important"),!r.querySelector(".urppp-inline-loader")){let o=_("");o.style.minHeight="0",o.style.padding="0",r.appendChild(o)}}catch{}})}catch{}}if(a(g,"replaceNativeLoaders"),!window.__urpppLoaderObs){window.__urpppLoaderObs=!0;let t=!1,e=a(()=>{if(!t){t=!0;try{g(document)}catch{}t=!1}},"run");document.body&&setTimeout(e,0),document.addEventListener("DOMContentLoaded",()=>setTimeout(e,0),{once:!0});let r=a(()=>{new MutationObserver(()=>{clearTimeout(window.__urpppLoaderTimer),window.__urpppLoaderTimer=setTimeout(e,200)}).observe(document.documentElement,{childList:!0,subtree:!0})},"startObs");document.body?r():document.addEventListener("DOMContentLoaded",r,{once:!0})}let k="urppp_theme_v3",T="urppp_accent_v1",C="urppp_accent_presets_v1",f="urppp_scheme_v1",b="urppp_theme_follow_system_v1",w="urppp_clean_default_v1",x="urppp_clean_analysis_v1",E="urppp_apple_edge_line_v1",q="urppp_follow_use_dynamic_v1",I="urppp_brutal_palette_v1",L="urppp_brutal_active_palette_v1",O="urppp_privacy_v1",$="urppp_custom_identity_v1",H="urppp_schedule_first_monday_v1",G="urppp_schedule_json_format_v1",U={completedCourses:"已修课程",failedCourses:"未及格课程",majorGpa:"主修绩点",majorPlan:"主修方案",remainingCourses:"待修课程",passingTotalCredit:"全部及格总学分",passingAvgScore:"全部及格平均成绩",passingAvgGpa:"全部及格平均绩点",passingRequiredCredit:"全部及格必修学分",passingRequiredAvg:"全部及格必修平均",passingRequiredGpa:"全部及格必修绩点",schemeTotalCredit:"方案总学分",schemeAvgScore:"方案平均成绩",schemeAvgGpa:"方案平均绩点",schemeRequiredCredit:"方案必修学分",schemeRequiredAvg:"方案必修平均",schemeRequiredGpa:"方案必修绩点"},et="",it=["#1E3A5F","#B53434","#0F766E","#7C3AED","#C2410C","#0369A1","#BE185D","#365314"],mt="#B53434",V="pink",Q=[{id:"pink",name:"高能粉",desc:"默认配色，热粉强调与酸性绿辅助",accent:"#FF006E",secondary:"#CCFF00",info:"#00D9FF",warning:"#FF9500"},{id:"acid",name:"酸性绿",desc:"酸性绿强调与热粉辅助",accent:"#CCFF00",secondary:"#FF006E",info:"#00D9FF",warning:"#FF9500"},{id:"cyan",name:"电子蓝",desc:"电子蓝强调与亮橙辅助",accent:"#00D9FF",secondary:"#FF9500",info:"#CCFF00",warning:"#FF006E"},{id:"orange",name:"亮橙",desc:"亮橙强调与电子蓝辅助",accent:"#FF9500",secondary:"#00D9FF",info:"#CCFF00",warning:"#FF006E"}],ot="tonal",X=[{id:"paper",name:"纯白卡片",desc:"卡片保持白，仅强调色跟种子"},{id:"tonal",name:"色调点缀",desc:"背景轻染，卡片带同色相浅底"},{id:"soft",name:"柔和粉彩",desc:"卡片明显粉彩/浅色，低对比"},{id:"vibrant",name:"鲜艳",desc:"背景与卡片都更有色，主色更饱和"},{id:"expressive",name:"表现力",desc:"双色拼色：卡片跟主色，背景走协调次色"}],{handleThemeDotClick:ct,injectNavbarThemeSwitch:rt,rebuildNavbar:st,syncNavbarThemeUI:gt,syncThemeDotGroup:Z}=Di({theme:{BRUTAL_DEFAULT_PALETTE:V,DEFAULT_SEED:mt,applyTheme:Wt,buildSchemePreview:Kt,getAccent:Qt,getBrutalActivePalette:qo,getBrutalPaletteById:ir,getBrutalSelectedPalette:Lo,getCurrent:Jt,getScheme:Ie,getSkin:Zt,isThemeModeAvailable:pr,setBrutalPalette:To,skinSupportsDark:Be,skinSupportsDynamic:Fe,skinSupportsFixedPalettes:zo},settings:{ensureSettingsPanel:nn,openSettingsPanel:rn,syncSettingsPanelUI:Dt}});function dt(){try{if(!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches))return;let e=document.getElementById("navbar"),r=e?.querySelector(".ace-nav");if(!e||!r)return;let o=document.getElementById("intellegenceUDiv"),i=document.getElementById("clickdiv"),s=document.getElementById("form-search");if(!o){let j=document.createElement("li");j.className="green urppp-search-item",o=document.createElement("div"),o.id="intellegenceUDiv",j.appendChild(o),r.appendChild(j)}let l=o.closest("li")||o.parentElement,m=Array.from(r.children).find(j=>{let R=j.querySelector(":scope > a");if(!R)return!1;let F=R.getAttribute("href")||"",K=(R.getAttribute("title")||"")+" "+(R.textContent||"");return F.includes("customerServiceCenter")||/help|service|support/i.test(F)||!!R.querySelector(".glyphicon-headphones, .fa-headphones, .fa-question-circle, .fa-life-ring")||/帮助|客服|服务|帮助中心/i.test(K)}),h=Array.from(r.children).find(j=>j.classList.contains("light-blue")),v=m||h||null;v&&l&&v!==l&&((l.compareDocumentPosition(v)&Node.DOCUMENT_POSITION_FOLLOWING)!==0||r.insertBefore(l,v)),l&&!l.classList.contains("urppp-search-item")&&l.classList.add("urppp-search-item");let M=l;i?(i.removeAttribute("onclick"),i.setAttribute("role","button"),i.setAttribute("aria-label","搜索功能")):(i=document.createElement("button"),i.type="button",i.id="clickdiv",i.setAttribute("aria-label","搜索功能"),i.innerHTML='<i class="fa fa-search" id="clicki" aria-hidden="true"></i>',o.appendChild(i)),i.style.setProperty("left","8px","important"),i.style.setProperty("position","relative","important"),i.style.setProperty("z-index","31","important"),s||(s=document.createElement("div"),s.id="form-search",s.className="nav-search",s.innerHTML='<form class="form-search"><span class="input-icon"><input type="text" placeholder="查找功能..." class="nav-search-input" id="search-input" autocomplete="off"><i class="ace-icon fa fa-search" aria-hidden="true"></i></span></form>'),M&&s.parentElement!==M&&M.appendChild(s),M&&M.style.setProperty("position","relative","important"),s.classList.add("urppp-desktop-search"),s.style.setProperty("position","absolute","important"),s.style.setProperty("top","50%","important"),s.style.setProperty("right","24px","important"),s.style.setProperty("left","auto","important"),s.style.setProperty("transform","translateY(-50%)","important"),s.style.setProperty("width",s.dataset.open==="1"?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("max-width","calc(100vw - 24px)","important"),s.style.setProperty("opacity",s.dataset.open==="1"?"1":"0","important"),s.style.setProperty("pointer-events",s.dataset.open==="1"?"auto":"none","important"),s.style.setProperty("z-index","1200","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("background","transparent","important"),s.style.setProperty("border","0 solid transparent","important"),s.style.setProperty("box-shadow","none","important"),s.style.setProperty("overflow","visible","important"),s.style.setProperty("transition","width .2s ease, opacity .2s ease","important");let N=s.querySelector("#search-input"),z=s.querySelector("form");if(!N||!z)return;z.style.setProperty("display","block","important"),z.style.setProperty("margin","0","important"),z.style.setProperty("padding","10px","important");let D=s.querySelector(".input-icon");D&&(D.style.setProperty("display","block","important"),D.style.setProperty("position","relative","important")),N.style.setProperty("display","block","important"),N.style.setProperty("width","100%","important"),N.style.setProperty("height","36px","important"),N.style.setProperty("box-sizing","border-box","important"),N.style.setProperty("padding","0 12px","important"),N.style.setProperty("border","1px solid var(--border)","important"),N.style.setProperty("border-radius","var(--radius-sm)","important"),N.style.setProperty("background","var(--input-bg)","important"),N.style.setProperty("color","var(--text)","important");let J=a(j=>{s.dataset.open=j?"1":"0",s.style.setProperty("width",j?"min(240px, calc(100vw - 24px))":"0px","important"),s.style.setProperty("opacity",j?"1":"0","important"),s.style.setProperty("pointer-events",j?"auto":"none","important"),i.setAttribute("aria-expanded",j?"true":"false"),j&&setTimeout(()=>N.focus(),30)},"setOpen");i.__urpppSearchBound||(i.__urpppSearchBound=!0,i.addEventListener("click",j=>{j.preventDefault(),j.stopImmediatePropagation(),J(s.dataset.open!=="1")},!0)),document.__urpppDesktopSearchOutsideBound||(document.__urpppDesktopSearchOutsideBound=!0,document.addEventListener("click",j=>{let R=document.getElementById("form-search"),F=document.getElementById("clickdiv");!R||R.dataset.open!=="1"||R.classList.contains("urppp-mobile-form-search")||R.closest("#urppp-mobile-search-panel")||R.contains(j.target)||F?.contains(j.target)||J(!1)},!0))}catch(t){console.warn("[URP++] desktop search bind failed",t)}}a(dt,"bindDesktopNavbarSearch");function kt(){if(document.getElementById("urppp-boot-loader"))return;let t=document.createElement("div");t.id="urppp-boot-loader",t.setAttribute("aria-busy","true"),t.innerHTML=`
    ...
    `;let e=document.documentElement||document.body;e&&e.appendChild(t)}a(kt,"ensureBootLoader");function wt(){try{document.documentElement.classList.add("urppp-ready"),document.body&&(document.body.classList.add("urppp-ready"),document.body.style.removeProperty("opacity"));let t=document.getElementById("urppp-boot-loader");if(!t)return;t.classList.add("urppp-boot-hide"),setTimeout(()=>{try{t.remove()}catch{}},280)}catch{}}a(wt,"hideBootLoader");try{kt()}catch{}window.__urpppBootSafety||(window.__urpppBootSafety=setTimeout(()=>{try{wt()}catch{}},2500));let Ct={default:{name:"简约白",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"#0071E3","--input-bg":"#F5F5F7","--primary":"#0071E3","--primary-hover":"#0077ED","--ring":"rgba(0,113,227,0.28)","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px","--border-w":"0px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},dark:{name:"深邃暗",vars:{"--bg":"#000000","--surface":"#1C1C1E","--text":"#F5F5F7","--text-secondary":"#A1A1A6","--text-muted":"#8E8E93","--border":"#38383A","--border-focus":"#0A84FF","--input-bg":"#2C2C2E","--primary":"#0A84FF","--primary-hover":"#409CFF","--ring":"rgba(10,132,255,0.32)","--shadow":"0 8px 24px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.06)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'},"scu-red":{name:"动态配色",vars:{"--bg":"#F5F5F7","--surface":"#FFFFFF","--text":"#1D1D1F","--text-secondary":"#6E6E73","--text-muted":"#86868B","--border":"#D2D2D7","--border-focus":"var(--urppp-accent, #B53434)","--input-bg":"#F5F5F7","--primary":"var(--urppp-accent, #B53434)","--primary-hover":"var(--urppp-accent-hover, #962929)","--ring":"var(--urppp-accent-ring, rgba(181,52,52,0.18))","--shadow":"0 4px 12px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.04)","--radius":"18px","--radius-sm":"12px"},font:'-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Segoe UI", "PingFang SC", "Helvetica Neue", "Microsoft YaHei", sans-serif'}};function B(t,e,r){t/=255,e/=255,r/=255;let o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,l=0,m=(o+i)/2;if(o!==i){let h=o-i;switch(l=m>.5?h/(2-o-i):h/(o+i),o){case t:s=(e-r)/h+(e<r?6:0);break;case e:s=(r-t)/h+2;break;default:s=(t-e)/h+4;break}s/=6}return{h:s*360,s:l,l:m}}a(B,"rgbToHsl");function Y(t,e,r){t=(t%360+360)%360,e=Math.max(0,Math.min(1,e)),r=Math.max(0,Math.min(1,r));let o=(1-Math.abs(2*r-1))*e,i=o*(1-Math.abs(t/60%2-1)),s=r-o/2,l=0,m=0,h=0;return t<60?(l=o,m=i):t<120?(l=i,m=o):t<180?(m=o,h=i):t<240?(m=i,h=o):t<300?(l=i,h=o):(l=o,h=i),{r:Math.round((l+s)*255),g:Math.round((m+s)*255),b:Math.round((h+s)*255)}}a(Y,"hslToRgb");function tt(t,e,r){let{r:o,g:i,b:s}=Y(t,e,r);return vr(o,i,s)}a(tt,"hslHex");function bt(t){let{r:e,g:r,b:o}=er(Gt(t)||mt),i=B(e,r,o);return i.s<.12&&(i.s=.18),i}a(bt,"seedHsl");function ht(t,e,r){let o=Math.max(0,Math.min(100,r))/100,i=Math.max(0,Math.min(.95,e));return tt(t,i,o)}a(ht,"tone");function zt(t){switch(t){case"paper":case"neutral":return{chroma:1,secShift:0,primaryTone:38,whiteCard:!0,bgSeed:.05,surfaceSeed:0,borderSeed:.08};case"soft":return{chroma:1,secShift:10,primaryTone:42,bgSeed:.14,surfaceSeed:.16,borderSeed:.18};case"vibrant":return{chroma:1.15,secShift:14,primaryTone:36,bgSeed:.2,surfaceSeed:.22,borderSeed:.26};case"expressive":return{chroma:1.08,secShift:0,primaryTone:36,duo:!0,bgSeed:.12,surfaceSeed:.15,borderSeed:.18};default:return{chroma:1,secShift:18,primaryTone:40,bgSeed:.12,surfaceSeed:.13,borderSeed:.16}}}a(zt,"schemeProfile");function yt(t,e){let r=Gt(t)||mt,o=Math.max(0,Math.min(.45,Number(e)||0));return o<=.001?"#FFFFFF":Bt("#FFFFFF",r,o)}a(yt,"tintFromHex");function Ft(t){return t<25||t>=345?(t+28)%360:t<55?(t+22)%360:t<90?(t+160)%360:t<160?(t+40)%360:t<210?(t+35)%360:t<265?(t+48)%360:t<310?(t+40)%360:(t+24)%360}a(Ft,"companionHue");function Pt(t){let e=Gt(t)||mt,{h:r,s:o}=bt(e),i=Ft(r),s=Math.min(.72,Math.max(.28,o*.78));return ht(i,s,42)}a(Pt,"companionColor");function It(t,e){let r=Gt(t)||mt,{h:o,s:i}=bt(r),l=zt(e||ot),m=Math.min(.92,Math.max(.35,i*l.chroma)),h=Pt(r),{h:v}=bt(h),M=ht(o,m,l.primaryTone),N=ht(o,m,Math.max(24,l.primaryTone-10)),z=Bt("#FFFFFF",r,.18),D,J,j;l.whiteCard?(D=Bt("#F1F5F9",Bt("#FFFFFF",r,.08),.5),J="#FFFFFF",j="#E5E7EB"):l.duo?(D=Bt(yt(h,l.bgSeed+.04),"#EEF1F4",.1),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.1),j=Bt("#E5E7EB",h,.16)):(D=Bt(yt(r,l.bgSeed),"#E8EBEF",.12),J=Bt(yt(r,l.surfaceSeed),"#FFFFFF",.12),j=Bt("#E5E7EB",r,Math.max(.08,l.borderSeed*.7)));let R=l.whiteCard?"#F8FAFC":Bt(J,yt(l.duo?h:r,Math.max(.05,(l.surfaceSeed||.1)*.55)),.35),F=ht(o,Math.min(.45,m*.55),14),K=ye(ht(o,m*.3,34),.88),ut=ye(ht(o,m*.22,46),.76),vt=ye(M,.18),Et="0 4px 12px "+ye(M,.1)+", 0 1px 2px "+ye(M,.05);return{"--bg":D,"--surface":J,"--text":F,"--text-secondary":K,"--text-muted":ut,"--border":j,"--border-focus":M,"--input-bg":R,"--primary":M,"--primary-hover":N,"--ring":vt,"--shadow":Et,"--radius":"18px","--radius-sm":"12px","--primary-container":z,"--secondary":h}}a(It,"buildMaterialSchemeVars");function Kt(t,e){let r=It(t,e);return{id:e,primary:r["--primary"],bg:r["--bg"],surface:r["--surface"],border:r["--border"],text:r["--text"]}}a(Kt,"buildSchemePreview");function $e(t){let e=Gt(t)||Qt()||mt;return X.map(r=>Object.assign({},r,Kt(e,r.id)))}a($e,"listSchemePreviews");function ue(){let t=document.documentElement;["--primary","--primary-hover","--border-focus","--ring","--bg","--surface","--text","--text-secondary","--text-muted","--border","--input-bg","--shadow","--primary-container","--secondary"].forEach(e=>t.style.removeProperty(e))}a(ue,"clearInlinePrimaryOverrides");function Qt(){return Gt(GM_getValue(T,""))||""}a(Qt,"getAccent");function Ie(){let t=String(GM_getValue(f,ot)||ot);return X.some(e=>e.id===t)?t:ot}a(Ie,"getScheme");function da(t){let e=X.some(r=>r.id===t)?t:ot;return GM_setValue(f,e),e}a(da,"setScheme");function ji(t,e){if(!t)return;let r=Gt(t);if(r){if(GM_setValue(T,r),e&&e.scheme&&da(e.scheme),e&&e.skipTheme){let o=oo(r,.15),i=ye(r,.15);document.documentElement.style.setProperty("--urppp-accent",r),document.documentElement.style.setProperty("--urppp-accent-hover",o),document.documentElement.style.setProperty("--urppp-accent-ring",i);try{gt()}catch{}try{Dt()}catch{}return}Wt("scu-red");try{gt()}catch{}try{Dt()}catch{}}}a(ji,"applyAccent");function ua(){try{let t=GM_getValue(C,"");if(!t)return it.slice();let e=JSON.parse(t);return Array.isArray(e)?e.filter(r=>typeof r=="string"&&/^#?[0-9a-fA-F]{6}$/i.test(r.replace("#",""))).map(r=>r.startsWith("#")?r.toUpperCase():"#"+r.toUpperCase()):it.slice()}catch{return it.slice()}}a(ua,"getAccentPresets");function Oi(t){let e=Gt(t||Qt()||mt);if(!e)return ua();let r=ua();return r=[e].concat(r.filter(o=>o.toLowerCase()!==e.toLowerCase())),r=r.slice(0,12),GM_setValue(C,JSON.stringify(r)),r}a(Oi,"saveAccentPreset");function Xt(){try{return!!GM_getValue(b,!1)}catch{return!1}}a(Xt,"isThemeFollowSystem");function Pr(t){return GM_setValue(b,!!t),!!t}a(Pr,"setThemeFollowSystem");function ma(){try{return!!GM_getValue(w,!1)}catch{return!1}}a(ma,"isCleanDefault");function Hi(t){return GM_setValue(w,!!t),!!t}a(Hi,"setCleanDefault");function ha(){try{return GM_getValue(x,"tab")==="direct"}catch{return!1}}a(ha,"isCleanAnalysisDirect");function Ri(t){return GM_setValue(x,t==="direct"?"direct":"tab"),t==="direct"?"direct":"tab"}a(Ri,"setCleanAnalysis");function we(){try{let t=GM_getValue(E,!0);return t!==!1&&t!==0&&t!=="0"}catch{return!0}}a(we,"isAppleEdgeLine");function Ui(t){return GM_setValue(E,!!t),!!t}a(Ui,"setAppleEdgeLine");function ba(){try{return!!GM_getValue(c,!1)}catch{return!1}}a(ba,"isAutoUpdateCheck");function Wi(t){return GM_setValue(c,!!t),!!t}a(Wi,"setAutoUpdateCheck");function zr(t,e){try{let r=GM_getValue(t,"");if(r&&typeof r=="object")return r;if(typeof r=="string"&&r.trim())return JSON.parse(r)}catch{}return e}a(zr,"readJsonSetting");function Lr(t,e){return GM_setValue(t,JSON.stringify(e)),e}a(Lr,"writeJsonSetting");function ke(){return uo(zr(O,null))}a(ke,"getPrivacySettings");function fa(t){return Lr(O,uo(t))}a(fa,"setPrivacySettings");function Ne(){return Er(zr($,null))}a(Ne,"getCustomIdentity");function Ao(t){return Lr($,Er(t))}a(Ao,"setCustomIdentity");function ga(){let t=zr(H,{});return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}a(ga,"getScheduleFirstMondayMap");function So(t,e){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(String(e||"")))return;let r=ga();r[String(t)]=String(e),Lr(H,r)}a(So,"rememberScheduleFirstMonday");function qr(){let t="";try{t=GM_getValue(G,"")}catch{}let e=!!(t&&(typeof t!="string"||t.trim())),r=zr(G,null);try{if(e&&(!r||typeof r!="object"||Array.isArray(r)))throw new Error("配置不是 JSON 对象");let o=r&&typeof r=="object"?r:{},i={enabled:!!o.enabled,mapping:Me(o.mapping||Ar)};return et="",i}catch{return et=e?"JSON 映射配置损坏，已回退小爱课程兼容格式":"",{enabled:!1,mapping:Me(Ar)}}}a(qr,"getScheduleJsonFormatSettings");function _o(t){let e=t&&typeof t=="object"?t:{},r={enabled:!!e.enabled,mapping:Me(e.mapping||Ar)};return et="",Lr(G,r)}a(_o,"setScheduleJsonFormatSettings");function Eo(){try{let t=String(location.pathname||"").replace(/\/+$/,"")||"/";return t==="/"||t==="/index"||/\/index\.html?$/i.test(t)}catch{return!1}}a(Eo,"isHomePage");function Tr(){try{return!!GM_getValue(q,!1)}catch{return!1}}a(Tr,"isFollowUseDynamic");function xa(t){return GM_setValue(q,!!t),!!t}a(xa,"setFollowUseDynamic");function Gi(){try{return!!(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches)}catch{return!1}}a(Gi,"systemPrefersDark");function me(){return Gi()&&Be()?"dark":Tr()&&Fe()?"scu-red":"default"}a(me,"resolveFollowThemeName");function pr(t,e){return t==="dark"?Be(e):t==="scu-red"?Fe(e):t==="default"}a(pr,"isThemeModeAvailable");function Wt(t,e){e=e||{},!Be()&&Xt()&&Pr(!1),!Fe()&&Tr()&&xa(!1),e.manual&&Pr(!1);let r;e.system||Xt()&&!e.manual?r=me():(r=Ct[t]?t:Jt()||"default",Ct[r]||(r="default")),pr(r)||(r="default");let o=Ct[r]||Ct.default;e.skipPersist||GM_setValue(k,r),ue();let i=document.getElementById("urppp-theme-vars")||(()=>{let v=document.createElement("style");return v.id="urppp-theme-vars",(document.head||document.documentElement).appendChild(v),v})(),s=Qt(),l=Object.assign({},o.vars);if(r==="scu-red"){let v=s||mt,M=Ie();l=Object.assign(l,It(v,M));let N=l["--primary"]||v,z=l["--primary-hover"]||oo(N,.12);document.documentElement.style.setProperty("--urppp-accent",N),document.documentElement.style.setProperty("--urppp-accent-hover",z),document.documentElement.style.setProperty("--urppp-accent-ring",l["--ring"]||ye(N,.15)),document.documentElement.style.setProperty("--urppp-seed",v),document.documentElement.style.setProperty("--urppp-scheme",M)}else r==="default"?(document.documentElement.style.setProperty("--urppp-accent","#0071E3"),document.documentElement.style.setProperty("--urppp-accent-hover","#0077ED"),document.documentElement.style.setProperty("--urppp-accent-ring","rgba(0,113,227,0.28)"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme")):(document.documentElement.style.removeProperty("--urppp-accent"),document.documentElement.style.removeProperty("--urppp-accent-hover"),document.documentElement.style.removeProperty("--urppp-accent-ring"),document.documentElement.style.removeProperty("--urppp-seed"),document.documentElement.style.removeProperty("--urppp-scheme"));let m=":root {";for(let[v,M]of Object.entries(l))m+=`${v}:${M};`;m+="}",i.textContent=m,document.body&&(document.body.style.fontFamily=o.font);try{let v=document.documentElement;v.dataset.urpppTheme=r,v.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),v.classList.add("urppp-theme-"+r),v.classList.toggle("urppp-theme-follow",Xt()),document.body&&(document.body.dataset.urpppTheme=r,document.body.classList.toggle("urppp-dark",r==="dark"),document.body.classList.toggle("urppp-theme-follow",Xt()))}catch{}try{ee()}catch{}try{gt()}catch{}try{Dt()}catch{}try{Vo()}catch{}try{es()}catch{}let h=document.getElementById("urppp-boot-loader");h&&(h.style.fontFamily=o.font)}a(Wt,"applyTheme");function Jt(){return GM_getValue(k,"default")}a(Jt,"getCurrent");function he(t){try{return!!GM_getValue("urppp_theme_css_"+t,"")}catch{return!1}}a(he,"themeDownloaded");function Ae(){try{let t=GM_getValue("urppp_local_themes","");return t?JSON.parse(t)||{}:{}}catch{return{}}}a(Ae,"localThemes");function Co(t,e){try{let r=Ae();r[t]=e,GM_setValue("urppp_local_themes",JSON.stringify(r))}catch{}}a(Co,"saveLocalTheme");function Ji(t){try{let e=Ae();delete e[t],GM_setValue("urppp_local_themes",JSON.stringify(e))}catch{}}a(Ji,"removeLocalTheme");function ya(t){let e=document.getElementById("urppp-store-theme-"+t);return e||(e=document.createElement("style"),e.id="urppp-store-theme-"+t,e.dataset.urpppStoreTheme=t,(document.head||document.documentElement).appendChild(e)),e}a(ya,"storeThemeStyleEl");function Vi(t){let e=document.getElementById("urppp-store-theme-"+t);e&&e.remove()}a(Vi,"removeStoreThemeStyle");function Po(){let t=new Set,e=a(r=>{if(t.has(r))return;t.add(r);let o="";try{o=GM_getValue("urppp_theme_css_"+r,"")||""}catch{}o&&(ya(r).textContent=o);let i="";try{i=GM_getValue("urppp_card_css_"+r,"")||""}catch{}i&&Se([{id:r,cardCss:i}])},"injectOne");u.forEach(r=>e(r.id)),Object.keys(Ae()).forEach(r=>e(r));try{ee()}catch{}}a(Po,"injectAllStoreThemeStyles");function Zt(){let t=GM_getValue(d,"apple"),e=u.find(o=>o.id===t);return e&&e.ready&&(e.installed!==!1||he(e.id))||Ae()[t]&&he(t)?t:"apple"}a(Zt,"getSkin");function va(t,e){let r=t||Zt(),o=u.find(i=>i.id===r);return!!(o&&o[e])}a(va,"getSkinCapability");function Be(t){return va(t,"dark")}a(Be,"skinSupportsDark");function Fe(t){return va(t,"dynamic")}a(Fe,"skinSupportsDynamic");function zo(t){return va(t,"palettes")}a(zo,"skinSupportsFixedPalettes");function ir(t){return Q.find(e=>e.id===t)||Q[0]}a(ir,"getBrutalPaletteById");function Lo(){let t=String(GM_getValue(I,"acid")||"acid"),e=ir(t);return e.id===V?ir("acid"):e}a(Lo,"getBrutalSelectedPalette");function qo(){let t=String(GM_getValue(L,V)||V);return ir(t)}a(qo,"getBrutalActivePalette");function To(t,e){let r=e||{},o=ir(t);r.select&&o.id!==V&&GM_setValue(I,o.id),GM_setValue(L,o.id);try{ee()}catch{}try{gt()}catch{}try{Dt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}}a(To,"setBrutalPalette");function Yi(t){let e=t||Zt();return e==="flat"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"2px","--urppp-card-border":"2px solid var(--text)","--urppp-input-border":"2px solid var(--text)","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="organic"?{"--radius":"22px","--radius-sm":"14px","--shadow":"0 2px 10px rgba(92,64,51,0.06)","--border-w":"1px","--urppp-card-border":"1px solid #E7E0D6","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"1px solid var(--border)","--urppp-action-shadow":"none","--urppp-action-bg":"var(--input-bg)","--urppp-action-color":"var(--primary)","--urppp-menu-radius":"14px","--urppp-menu-border":"1px solid var(--border)","--urppp-menu-shadow":"none","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}:e==="editorial"?{"--radius":"0px","--radius-sm":"0px","--shadow":"none","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"none","--urppp-action-radius":"0px","--urppp-action-border":"none","--urppp-action-shadow":"none","--urppp-action-bg":"transparent","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"1px solid var(--text)","--urppp-menu-shadow":"none","--urppp-menu-bg":"transparent","--urppp-menu-color":"var(--text)"}:e==="brutal"?{"--radius":"0px","--radius-sm":"0px","--shadow":"6px 6px 0 #000","--border-w":"3px","--urppp-card-border":"3px solid #000","--urppp-input-border":"2px solid #000","--urppp-action-radius":"0px","--urppp-action-border":"2px solid var(--text)","--urppp-action-shadow":"3px 3px 0 var(--text)","--urppp-action-bg":"var(--surface)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"0px","--urppp-menu-border":"2px solid var(--text)","--urppp-menu-shadow":"3px 3px 0 var(--text)","--urppp-menu-bg":"var(--surface)","--urppp-menu-color":"var(--text)"}:e==="neu"?{"--radius":"16px","--radius-sm":"12px","--shadow":"5px 5px 10px #BEC3CA, -5px -5px 10px #F7F9FC","--border-w":"0px","--urppp-card-border":"none","--urppp-input-border":"1px solid rgba(38,49,66,.16)","--urppp-input-shadow":"inset 2px 2px 4px rgba(38,49,66,.16), inset -2px -2px 4px rgba(255,255,255,.72)","--urppp-action-radius":"12px","--urppp-action-border":"none","--urppp-action-shadow":"var(--shadow)","--urppp-action-bg":"var(--bg)","--urppp-action-color":"var(--text)","--urppp-menu-radius":"12px","--urppp-menu-border":"none","--urppp-menu-shadow":"var(--shadow)","--urppp-menu-bg":"var(--bg)","--urppp-menu-color":"var(--text)"}:{"--radius":"18px","--radius-sm":"12px","--shadow":"0 4px 16px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)","--border-w":"0px","--urppp-card-border":e==="apple"&&we()?"1px solid rgba(0,0,0,0.08)":"none","--urppp-input-border":"1px solid var(--border)","--urppp-action-radius":"999px","--urppp-action-border":"none","--urppp-action-shadow":"0 2px 6px var(--ring)","--urppp-action-bg":"var(--primary)","--urppp-action-color":"var(--surface)","--urppp-menu-radius":"12px","--urppp-menu-border":e==="apple"&&we()?"1px solid var(--border)":"none","--urppp-menu-shadow":"0 1px 3px rgba(0,0,0,.08)","--urppp-menu-bg":"var(--input-bg)","--urppp-menu-color":"var(--text)"}}a(Yi,"getSkinShapeOverrides");function De(){try{let t=Zt();if(t==="apple")return we()?"1px solid rgba(0,0,0,0.08)":"none";if(t==="flat")return"2px solid var(--text)";if(t==="organic")return"1px solid #E7E0D6";if(t==="brutal")return"3px solid var(--text)";if(t==="editorial"||t==="neu")return"none"}catch{}return"1px solid var(--border)"}a(De,"urpppCardBorderValue");function ee(){let t=Zt();try{document.documentElement.setAttribute("data-urppp-skin",t)}catch{}try{document.body&&document.body.setAttribute("data-urppp-skin",t)}catch{}try{let e=t==="apple"&&we();document.documentElement.setAttribute("data-urppp-apple-edge",e?"1":"0"),document.body&&document.body.setAttribute("data-urppp-apple-edge",e?"1":"0")}catch{}try{let e=document.getElementById("urppp-skin-vars")||(()=>{let s=document.createElement("style");return s.id="urppp-skin-vars",(document.head||document.documentElement).appendChild(s),s})(),r=Yi(t),o=":root, html[data-urppp-skin] {";if(Object.keys(r).forEach(s=>{o+=s+":"+r[s]+";"}),o+="}",o+=".urppp-nav-dot.urppp-theme-disabled{opacity:.42!important;cursor:not-allowed!important;box-shadow:none!important;filter:grayscale(1)!important;transform:none!important;}",t==="flat"||t==="organic"||t==="brutal"||t==="neu"){if(t==="brutal"){let s=qo();o+='html[data-urppp-skin="brutal"]{--brutal-accent:'+s.accent+";--brutal-secondary:"+s.secondary+";--brutal-info:"+s.info+";--brutal-warning:"+s.warning+";}"}e.textContent=o;return}if(t==="apple"){let s=we(),l=s?"1px solid rgba(0,0,0,0.08)":"none",m=s?"1px solid rgba(255,255,255,0.10)":"none",h=s?"1px solid rgba(0,0,0,0.06)":"none";o+=['html[data-urppp-skin="apple"]{--shadow:0 6px 20px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04);--border:'+(s?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.04)")+";}",'html[data-urppp-skin="apple"].urppp-theme-dark,html.urppp-theme-dark[data-urppp-skin="apple"]{--shadow:0 10px 28px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.04);--border:'+(s?"rgba(255,255,255,0.10)":"rgba(255,255,255,0.06)")+";}",'html[data-urppp-skin="apple"] .widget-box,html[data-urppp-skin="apple"] .widget-box.transparent,html[data-urppp-skin="apple"] .panel,html[data-urppp-skin="apple"] .panel-default,html[data-urppp-skin="apple"] .well,html[data-urppp-skin="apple"] .thumbnail,html[data-urppp-skin="apple"] .infobox,html[data-urppp-skin="apple"] .profile-user-info,html[data-urppp-skin="apple"] .profile-user-info-striped,html[data-urppp-skin="apple"] .modal-content,html[data-urppp-skin="apple"] fieldset,html[data-urppp-skin="apple"] .urppp-stat-card,html[data-urppp-skin="apple"] .urppp-db-card,html[data-urppp-skin="apple"] .urppp-db-panel,html[data-urppp-skin="apple"] #urppp-dashboard .widget-box,html[data-urppp-skin="apple"] #urppp-root .uc,html[data-urppp-skin="apple"] #urppp-clean-root .uc-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-modal,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top,html[data-urppp-skin="apple"] #urppp-clean-root .uc-tabbar,html[data-urppp-skin="apple"] .urppp-card,html[data-urppp-skin="apple"] #urppp-dashboard .urppp-card,html[data-urppp-skin="apple"] #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"].urppp-theme-dark .widget-box,html[data-urppp-skin="apple"].urppp-theme-dark .panel,html[data-urppp-skin="apple"].urppp-theme-dark .profile-user-info,html[data-urppp-skin="apple"].urppp-theme-dark .modal-content,html[data-urppp-skin="apple"].urppp-theme-dark .urppp-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-card,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-clean-root .uc-score-pane,html[data-urppp-skin="apple"].urppp-theme-dark #urppp-root .uc{border:'+m+"!important;}",'html[data-urppp-skin="apple"] .page-content .widget-box,html[data-urppp-skin="apple"] #page-content-template .widget-box,html[data-urppp-skin="apple"] html body .page-content .profile-user-info.setLabelWidth{border:'+l+"!important;box-shadow:var(--shadow)!important;}",'html[data-urppp-skin="apple"] .btn,html[data-urppp-skin="apple"] .btn-default,html[data-urppp-skin="apple"] .btn-white,html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] .btn-success,html[data-urppp-skin="apple"] .btn-warning,html[data-urppp-skin="apple"] .btn-danger,html[data-urppp-skin="apple"] a.btn,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn{border-color:transparent!important;box-shadow:0 1px 2px rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"] .btn-primary,html[data-urppp-skin="apple"] .btn-info,html[data-urppp-skin="apple"] #urppp-clean-root .uc-btn.primary{border:none!important;}','html[data-urppp-skin="apple"] .table,html[data-urppp-skin="apple"] table,html[data-urppp-skin="apple"] .table-bordered,html[data-urppp-skin="apple"] .table-bordered>thead>tr>th,html[data-urppp-skin="apple"] .table-bordered>tbody>tr>td{border-color:rgba(0,0,0,.05)!important;}','html[data-urppp-skin="apple"].urppp-theme-dark .table,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>thead>tr>th,html[data-urppp-skin="apple"].urppp-theme-dark .table-bordered>tbody>tr>td{border-color:rgba(255,255,255,.06)!important;}','html[data-urppp-skin="apple"] .nav-tabs>li>a,html[data-urppp-skin="apple"] .nav-tabs{border-color:transparent!important;}','html[data-urppp-skin="apple"] .urppp-nav-link{border:none!important;}','html[data-urppp-skin="apple"] #urppp-clean-root .uc-lesson,html[data-urppp-skin="apple"] #urppp-clean-root .uc-grid-cell{border-color:'+(s?"rgba(0,0,0,0.06)":"transparent")+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] #urppp-clean-root .uc-svc{border:'+h+"!important;box-shadow:0 2px 8px rgba(0,0,0,.05)!important;}",'html[data-urppp-skin="apple"] .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot,html[data-urppp-skin="apple"] #urppp-dots span{border-radius:50%!important;border:2px solid var(--border)!important;box-shadow:none!important;width:18px!important;height:18px!important;min-width:18px!important;min-height:18px!important;padding:0!important;overflow:hidden!important;background-clip:padding-box!important;flex:0 0 auto!important;}','html[data-urppp-skin="apple"] .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot.ac,html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot.ac{border-color:var(--primary)!important;box-shadow:0 0 0 3px var(--ring)!important;}','html[data-urppp-skin="apple"] #urppp-nav-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-clean-root .uc-top-theme .urppp-nav-dot[data-theme="scu-red"],html[data-urppp-skin="apple"] #urppp-dots span[data-theme="scu-red"]{border-radius:50%!important;border:2px solid var(--border)!important;}'].join("")}else t==="editorial"&&(o+=`
        ...
        `);e.textContent=o;let i=document.head||document.documentElement;e.parentNode===i&&i.lastElementChild!==e&&i.appendChild(e)}catch(e){try{console.warn("[URP++] applySkinAttr",e)}catch{}}setTimeout(()=>{try{Yt(document)}catch{}},0)}a(ee,"applySkinAttr");function Mo(t){let e=u.find(i=>i.id===t&&i.ready&&(i.installed!==!1||he(i.id))),r=!e&&Ae()[t]&&he(t)?{id:t,ready:!0,installed:!1}:null,o=e||r;if(!o)return!1;GM_setValue(d,o.id);try{o.dynamic||xa(!1),!o.dark&&Xt()&&Pr(!1);let i=Xt(),s=i?me():Jt(),l=pr(s,e.id)?s:"default";ee(),Wt(l,{system:i})}catch{try{ee()}catch{}}try{Dt()}catch{}try{gt()}catch{}try{let i=document.getElementById("urppp-clean-root");i&&typeof i.__syncCleanThemeDots=="function"&&i.__syncCleanThemeDots()}catch{}return!0}a(Mo,"setSkin");function Qi(){if(!window.__urpppSystemThemeBound&&window.matchMedia){window.__urpppSystemThemeBound=!0;try{let t=window.matchMedia("(prefers-color-scheme: dark)"),e=a(()=>{if(Xt())try{Wt(me(),{system:!0})}catch{}},"onChange");t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}}}a(Qi,"bindSystemThemeListener");try{Xt()?Wt(me(),{system:!0}):Wt(Jt())}catch{}try{ee()}catch{}try{Qi()}catch{}function Xi(t){let e=String(document.body&&document.body.innerText||t&&t.innerText||"").replace(/\s+/g," ").trim(),r=[/token\s*校验失败[！!]?/i,/令牌\s*校验失败[！!]?/i,/验证码.{0,12}(?:错误|失败|过期)[！!]?/i,/(?:用户名|账号|学号).{0,12}(?:密码).{0,12}(?:错误|失败)[！!]?/i,/登录.{0,12}(?:错误|失败)[！!]?/i];for(let o of r){let i=e.match(o);if(i)return i[0].trim()}return""}a(Xi,"extractLoginErrorMessage");function $o(){let t=location.pathname,e=document.getElementById("formContent"),r=document.querySelector(".form-signin");if(!e||!r){setTimeout($o,50);return}if(e.querySelector(":scope > #urppp-root"))return;let o=Xi(e),i=r.querySelector('a[onclick*="toModifyPwd"]'),s=(()=>{let R=e.querySelector(".fadeIn.first svg");return R?R.outerHTML:""})(),l=(()=>{let R=document.querySelector("#tocas a");return R?R.href:"https://id.scu.edu.cn/"})();for(let R of e.children)R.style.display="none";e.style.cssText="max-width:420px;width:90%;margin:0 auto;background:transparent;box-shadow:none;border-radius:0;position:relative;z-index:1;";let m=location.pathname==="/loginEn",h=a((R,F)=>m?F:R,"t");e.insertAdjacentHTML("afterbegin",`
    <div id="urppp-root">
      <style>
      ...
      <div class="uc">
    ...
    </div>`);let v=e.querySelector("#urppp-root");[["#urppp-user","#input_username"],["#urppp-pass","#input_password"],["#urppp-cap","#input_checkcode"]].forEach(([R,F])=>{let K=v.querySelector(R),ut=document.querySelector(F);K&&ut&&(ut.value&&(K.value=ut.value),K.addEventListener("input",()=>{ut.value=K.value}))});let M=v.querySelector("#urppp-capimg"),N=v.querySelector("#urppp-capwrap"),z=document.querySelector(".form-signin img");if(M&&z){M.src=z.src;let R=a(()=>{let F=z.src.replace(/\?.*/,"")+"?"+Date.now();z.src=F,M.src=F},"refreshCap");N?N.addEventListener("click",R):M.addEventListener("click",R)}v.querySelectorAll(".ut button").forEach(R=>{R.addEventListener("click",()=>{if(R.dataset.mode==="sso"){location.href=l;return}v.querySelectorAll(".ut button").forEach(ut=>ut.classList.remove("ac")),R.classList.add("ac");let F=v.querySelector("#urppp-form"),K=v.querySelector("#urppp-sso");F&&(F.style.display="block"),K&&(K.style.display="none")})});let D=v.querySelector("#urppp-submit");D.addEventListener("click",()=>{if(D.dataset.submitting==="1")return;D.dataset.submitting="1",D.disabled=!0;let R=document.getElementById("loginButton");R?R.click():typeof r.requestSubmit=="function"?r.requestSubmit():r.submit(),setTimeout(()=>{D.dataset.submitting="0",D.disabled=!1},1500)}),v.querySelectorAll(".ui").forEach(R=>{R.addEventListener("keydown",F=>{F.key==="Enter"&&D.click()})}),v.querySelector("#urppp-forgot").addEventListener("click",R=>{R.preventDefault(),i&&i.click()});let J=v.querySelector("#urppp-dots"),j=a(()=>{if(!J)return;let R=Jt();J.querySelectorAll("span").forEach(K=>{K.classList.toggle("ac",K.dataset.theme===R)});let F=J.querySelector('span[data-theme="scu-red"]');if(F){let K=Qt()||mt;try{let ut=Kt(K,Ie());F.style.background="linear-gradient(135deg, "+ut.primary+" 0 55%, "+ut.surface+" 55% 100%)"}catch{F.style.background=K}}},"syncLoginDots");J&&(J.querySelectorAll("span").forEach(R=>{R.addEventListener("click",()=>{Wt(R.dataset.theme,{manual:!0}),j()})}),j()),console.log("[URP++] 登录界面已重建"),setTimeout(()=>{document.body.classList.add("urppp-ready"),wt()},100)}a($o,"rebuild");let{beautifyBreadcrumbs:Mr}=Bi({});function wa(){try{document.querySelectorAll(".profile-user-info, .profile-user-info-striped").forEach(t=>{if(t.classList.contains("setLabelWidth")||t.classList.contains("urppp-query-form")||t.querySelector(".urppp-query-pair"))return;let e=Array.from(t.querySelectorAll(":scope > .profile-info-row, .profile-info-row"));!e.length||e.some(o=>Array.from(o.children).filter(i=>i.classList&&i.classList.contains("profile-info-name")).length>=2)||(t.classList.remove("urppp-query-form"),t.style.setProperty("width","100%","important"),t.style.setProperty("max-width","100%","important"),t.style.setProperty("display","block","important"),Nr(t),e.forEach(o=>{o.classList.remove("urppp-query-row","urppp-dual-pair"),delete o.dataset.urpppQueryDone,delete o.dataset.urpppQueryCols;let i=Array.from(o.querySelectorAll(":scope > .urppp-query-pair"));if(i.length){let s=[];for(i.forEach(l=>Array.from(l.children).forEach(m=>s.push(m)));o.firstChild;)o.removeChild(o.firstChild);s.forEach(l=>o.appendChild(l))}o.style.setProperty("display","grid","important"),o.style.setProperty("grid-template-columns","140px minmax(0,1fr)","important"),o.style.setProperty("align-items","stretch","important"),o.style.setProperty("width","100%","important"),Array.from(o.children).forEach(s=>{s.classList&&(s.style.setProperty("float","none","important"),s.style.setProperty("margin-left","0","important"),s.style.setProperty("width","auto","important"),s.style.setProperty("max-width","none","important"),s.style.setProperty("display","flex","important"),s.style.setProperty("align-items","center","important"),s.style.setProperty("box-sizing","border-box","important"))})}))})}catch(t){console.warn("[URP++] single pair profile fix failed",t)}}a(wa,"fixSinglePairProfileForms");function $r(){let t=document.querySelector(".page-content")||document.getElementById("page-content-template");t&&(t.querySelectorAll(".col-xs-4, .col-xs-8, .col-sm-4, .col-sm-8, .col-md-4, .col-md-8").forEach(e=>{if(!e.querySelector(".setLabelWidth"))return;let r=e.querySelector(".setLabelWidth");r&&(e.querySelectorAll("h4.header, h3.header, .header.smaller, .header").forEach(o=>{r.contains(o)||o.compareDocumentPosition(r)&Node.DOCUMENT_POSITION_FOLLOWING&&(o.classList.add("urppp-section-label"),["background","background-color","background-image","border","box-shadow","border-radius","padding","margin","min-height"].forEach(i=>{o.style.removeProperty(i)}),o.style.setProperty("background","transparent","important"),o.style.setProperty("background-color","transparent","important"),o.style.setProperty("background-image","none","important"),o.style.setProperty("border","0 none transparent","important"),o.style.setProperty("box-shadow","none","important"),o.style.setProperty("border-radius","0","important"),o.style.setProperty("padding","4px 2px 10px","important"),o.style.setProperty("margin","0 0 8px 0","important"),o.style.setProperty("min-height","0","important"))}),r.classList.remove("urppp-query-form"),r.style.setProperty("padding","0","important"),r.style.setProperty("overflow","hidden","important"),r.style.setProperty("background","var(--surface)","important"),r.style.setProperty("border",De(),"important"),r.style.setProperty("border-radius","12px","important"),r.style.setProperty("box-shadow","none","important"))}),t.querySelectorAll(".profile-user-info.setLabelWidth, .profile-user-info-striped.setLabelWidth").forEach(e=>{e.classList.remove("urppp-query-form"),e.querySelectorAll(".profile-info-row").forEach(r=>{r.classList.remove("urppp-query-row"),delete r.dataset.urpppQueryDone,delete r.dataset.urpppQueryCols;let o=Array.from(r.querySelectorAll(":scope > .urppp-query-pair"));if(o.length){let i=[];for(o.forEach(s=>{Array.from(s.children).forEach(l=>i.push(l))});r.firstChild;)r.removeChild(r.firstChild);i.forEach(s=>r.appendChild(s))}})}),t.querySelectorAll(".setLabelWidth .profile-info-row, .profile-user-info.setLabelWidth .profile-info-row, .profile-user-info-striped.setLabelWidth .profile-info-row").forEach(e=>{let r=Array.from(e.querySelectorAll(":scope > .urppp-query-pair"));if(r.length){let s=[];for(r.forEach(l=>{Array.from(l.children).forEach(m=>s.push(m))});e.firstChild;)e.removeChild(e.firstChild);s.forEach(l=>e.appendChild(l))}e.classList.remove("urppp-query-row"),delete e.dataset.urpppQueryDone,delete e.dataset.urpppQueryCols;let o=Array.from(e.children).filter(s=>s.classList&&(s.classList.contains("profile-info-name")||s.classList.contains("profile-info-value")));o.filter(s=>s.classList.contains("profile-info-name")).length>=2?(e.classList.add("urppp-dual-pair"),e.style.setProperty("display","grid","important"),e.style.setProperty("grid-template-columns","112px minmax(140px,1fr) 112px minmax(140px,1fr)","important"),e.style.setProperty("align-items","stretch","important"),e.style.setProperty("width","100%","important"),e.style.setProperty("max-width","100%","important"),e.style.setProperty("float","none","important"),o.forEach(s=>{s.style.setProperty("float","none","important"),s.style.setProperty("clear","none","important"),s.style.setProperty("margin","0","important"),s.style.setProperty("margin-left","0","important"),s.style.setProperty("width","auto","important"),s.style.setProperty("max-width","none","important"),s.style.setProperty("min-width","0","important"),s.style.setProperty("box-sizing","border-box","important"),s.style.setProperty("display","flex","important"),s.style.setProperty("align-items","center","important"),s.classList.contains("profile-info-value")?(s.style.removeProperty("width"),s.style.setProperty("width","auto","important"),s.style.setProperty("justify-content","flex-start","important"),s.style.setProperty("white-space","normal","important"),s.style.setProperty("word-break","normal","important")):(s.style.setProperty("justify-content","flex-end","important"),s.style.setProperty("white-space","nowrap","important"))})):e.classList.remove("urppp-dual-pair")}),t.querySelectorAll(".profile-user-info.setLabelWidth, .profile-user-info-striped.setLabelWidth").forEach(e=>{e.classList.remove("urppp-query-form"),e.style.cssText=(e.getAttribute("style")||"").replace(/padding\s*:[^;]+;?/gi,""),e.style.setProperty("background","var(--surface)","important"),e.style.setProperty("border-radius","12px","important"),e.style.setProperty("overflow","hidden","important"),e.style.setProperty("border",De(),"important"),e.style.setProperty("box-shadow","none","important"),e.style.setProperty("width","100%","important"),e.style.setProperty("max-width","100%","important"),e.style.setProperty("box-sizing","border-box","important"),e.style.setProperty("margin","0 0 16px 0","important"),e.style.setProperty("padding","0","important");let r=e.closest(".col-xs-4, .col-xs-8, .col-sm-4, .col-sm-8, .col-md-4, .col-md-8")||e.parentElement;r&&Array.from(r.querySelectorAll("h4.header, h3.header, .header.smaller")).forEach(o=>{e.contains(o)||o.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_FOLLOWING&&(o.classList.add("urppp-section-label"),o.style.setProperty("background","transparent","important"),o.style.setProperty("background-color","transparent","important"),o.style.setProperty("background-image","none","important"),o.style.setProperty("border","0 none transparent","important"),o.style.setProperty("box-shadow","none","important"),o.style.setProperty("border-radius","0","important"),o.style.setProperty("padding","4px 2px 10px","important"),o.style.setProperty("margin","0 0 8px 0","important"),o.style.setProperty("min-height","0","important"))})}),t.querySelectorAll(".urppp-col-row").forEach(e=>{e.classList.remove("urppp-col-row"),["display","flex-wrap","gap","align-items","width","box-sizing"].forEach(r=>e.style.removeProperty(r))}),t.querySelectorAll('[class*="col-xs-"], [class*="col-sm-"], [class*="col-md-"], [class*="col-lg-"]').forEach(e=>{["float","flex","width","max-width","padding-left","padding-right","box-sizing"].forEach(r=>{e.style.getPropertyPriority(r)==="important"&&e.style.removeProperty(r)}),e.style.setProperty("padding-left","0","important"),e.style.setProperty("box-sizing","border-box","important")}),t.querySelectorAll(".col-xs-4, .col-sm-4, .col-md-4").forEach(e=>{e.style.setProperty("padding-right","16px","important")}),t.querySelectorAll(".col-xs-8, .col-sm-8, .col-md-8").forEach(e=>{e.style.setProperty("padding-left","0","important"),e.style.setProperty("padding-right","0","important")}),t.querySelectorAll(".col-xs-4, .col-xs-8, .col-sm-4, .col-sm-8, .col-md-4, .col-md-8").forEach(e=>{e.querySelector(".setLabelWidth")&&e.querySelectorAll(":scope > h4.header, :scope > .header, :scope > .header.smaller").forEach(r=>{r.style.cssText+=";background:transparent!important;background-color:transparent!important;border:none!important;box-shadow:none!important;border-radius:0!important;padding:4px 2px 10px!important;margin:0 0 8px 0!important;min-height:0!important;"})}),t.querySelectorAll(".urppp-section-title-wrap").forEach(e=>{let r=e.querySelector("h4.header, h3.header, h5.header, .header.smaller");if(!r){e.remove();return}let o=e.nextElementSibling;for(;o&&!o.querySelector?.('.col-xs-4, .col-sm-4, .col-md-4, [class*="col-xs-"], [class*="col-sm-"]');)o=o.nextElementSibling;let i=o&&(o.querySelector(".col-xs-4, .col-sm-4, .col-md-4")||Array.from(o.children).find(s=>/col-(?:xs|sm|md|lg)-([1-9]|1[01])\b/.test(s.className||"")));i&&(i.insertBefore(r,i.firstChild),delete r.dataset.urpppHoisted,r.style.removeProperty("width"),r.style.removeProperty("max-width"),r.style.removeProperty("margin-left"),r.style.removeProperty("margin-right"),r.style.removeProperty("box-sizing"),r.style.removeProperty("position"),r.style.removeProperty("left")),e.remove()}))}a($r,"alignRollInfoLayout");function Ir(){let t=typeof unsafeWindow<"u"?unsafeWindow:window;return t.jQuery||t.$||window.jQuery||window.$||null}a(Ir,"pageJQuery");function Ki(t){return t?t.id&&String(t.id).indexOf("pagination_pageSize_")===0?!0:!!(t.closest&&t.closest('#urppagebar, .urppagebreak, .dataTables_paginate, [id^="sample-table-2_paginate_"]')):!1}a(Ki,"isPagebarSelect");function Io(t){if(t){try{let e=Ir();e&&e.fn&&e(t).data("chosen")&&e(t).chosen("destroy")}catch{}try{if(t.parentElement&&t.parentElement.querySelectorAll(":scope > .chosen-container").forEach(e=>{try{e.remove()}catch{}}),t.nextElementSibling&&t.nextElementSibling.classList.contains("chosen-container"))try{t.nextElementSibling.remove()}catch{}}catch{}t.classList.remove("urppp-chosen-hidden","chzn-done","chosen");try{delete t.dataset.urpppChosen}catch{}t.style.setProperty("display","inline-block","important")}}a(Io,"destroyPagebarChosen");let No=0,Bo=!1;function Zi(){if(Bo)return;Bo=!0;let t=a(e=>{if(Date.now()<No){try{e.preventDefault()}catch{}try{e.stopPropagation()}catch{}}},"guard");document.addEventListener("mousedown",t,!0),document.addEventListener("mouseup",t,!0),document.addEventListener("click",t,!0)}a(Zi,"bindChosenPickGuard");function ka(t){if(!t||t.__urpppChosenNoPierce)return;t.__urpppChosenNoPierce=!0,Zi();let e=t.querySelector(".chosen-drop"),r=a(o=>{let i=o.target;!i||!i.closest||!i.closest(".chosen-results li")||(No=Date.now()+350)},"onPick");t.addEventListener("mouseup",r,!1),t.addEventListener("touchend",r,!1),e&&(e.addEventListener("mouseup",r,!1),e.addEventListener("touchend",r,!1))}a(ka,"bindChosenNoPierce");function Aa(t=document){try{t.querySelectorAll(".chosen-container").forEach(ka)}catch{}}a(Aa,"bindAllChosenNoPierce");function be(){try{let t=Ir();if(!t||!t.fn||typeof t.fn.chosen!="function")return!1;let e=document.querySelectorAll(".profile-user-info, .urppp-query-form, .profile-info-row, form"),r=new Set,o=[];if(e.forEach(i=>{i.querySelectorAll("select").forEach(s=>{r.has(s)||(r.add(s),o.push(s))})}),document.querySelectorAll("select.value_element, .profile-info-value > select").forEach(i=>{r.has(i)||(r.add(i),o.push(i))}),o.forEach(i=>{if(!i||i.multiple||i.disabled||i.size&&i.size>1)return;if(Ki(i)){Io(i);return}let s=t(i);if(!!s.data("chosen")||i.classList.contains("chzn-done")||!!(i.nextElementSibling&&i.nextElementSibling.classList.contains("chosen-container"))||!!(i.parentElement&&i.parentElement.querySelector(":scope > .chosen-container"))){i.dataset.urpppChosen="1",i.classList.add("urppp-chosen-hidden"),i.style.setProperty("display","none","important");let m=i.nextElementSibling&&i.nextElementSibling.classList.contains("chosen-container")?i.nextElementSibling:i.parentElement&&i.parentElement.querySelector(":scope > .chosen-container");m&&ka(m);return}try{i.classList.contains("select")||i.classList.add("select");try{s.data("chosen")&&s.chosen("destroy")}catch{}s.chosen({allow_single_deselect:!0,search_contains:!0,width:"100%",no_results_text:"无匹配项",disable_search_threshold:0}),i.dataset.urpppChosen="1",i.classList.add("urppp-chosen-hidden"),i.style.setProperty("display","none","important");let m=i.nextElementSibling&&i.nextElementSibling.classList.contains("chosen-container")?i.nextElementSibling:i.parentElement&&i.parentElement.querySelector(".chosen-container");m&&(m.style.setProperty("width","100%","important"),m.style.setProperty("min-width","0","important"),m.style.setProperty("display","block","important")),m&&ka(m)}catch(m){console.warn("[URP++] chosen init failed",i,m)}}),!window.__urpppChosenHtmlPatch){window.__urpppChosenHtmlPatch=!0;let i=t.fn.html;t.fn.html=function(){let s=i.apply(this,arguments);if(arguments.length)try{this.filter("select").add(this.find("select")).each(function(){let l=t(this);if(l.data("chosen")||l.next(".chosen-container").length)try{l.trigger("chosen:updated")}catch{}})}catch{}return s}}return!0}catch(t){return console.warn("[URP++] ensureQueryChosen failed",t),!1}}a(be,"ensureQueryChosen");function Fo(){if(window.__urpppChosenScheduleBound)return;window.__urpppChosenScheduleBound=!0,[0,200,600,1500,3e3].forEach(o=>setTimeout(()=>{be(),Aa()},o));let e=0,r=setInterval(()=>{e+=1;let o=be();Aa(),(o&&e>3||e>15)&&clearInterval(r)},500)}a(Fo,"scheduleEnsureQueryChosen");let{beautifyPagebar:Do}=Jp({destroyPagebarChosen:Io}),{scheduleBeautifyPagebar:jo}=Gp({beautifyPagebar:Do});function Sa(){try{document.querySelectorAll("#drag-ul, ul#drag-ul").forEach(t=>{if(!t)return;let e=Array.from(t.children).filter(r=>r.tagName==="LI");if(!e.length){t.classList.add("urppp-empty"),t.style.setProperty("display","none","important");let r=t.closest("#xq-section, .widget-main, .widget-body");r&&!r.querySelector("li")&&(r.classList.add("urppp-empty"),r.style.setProperty("display","none","important"));return}t.classList.remove("urppp-empty"),t.classList.add("urppp-drag-ul"),t.style.removeProperty("display"),t.style.setProperty("height","auto","important"),t.style.setProperty("min-height","0","important"),e.forEach(r=>{let o=(r.textContent||"").replace(/\s+/g," ").trim(),i=(r.getAttribute("onclick")||"").includes("goDetail")||r.classList.contains("ui-selectee")||r.classList.contains("jc-future")||!!r.querySelector("a");!i&&/校区/.test(o)&&o.length<=12?(r.classList.add("xq-section"),r.classList.remove("ui-selectee","jc-future","urppp-building-active")):i&&!r.classList.contains("jc-future")&&r.classList.add("ui-selectee")})}),window.__urpppBuildingActiveBound||(window.__urpppBuildingActiveBound=!0,document.addEventListener("click",t=>{let e=t.target&&t.target.closest?t.target.closest("#drag-ul > li"):null;if(!e||e.classList.contains("xq-section")||e.classList.contains("jc-future"))return;let r=e.parentElement;r&&(r.querySelectorAll("li.urppp-building-active, li.ui-selected").forEach(o=>{o.classList.remove("urppp-building-active","ui-selected")}),e.classList.add("urppp-building-active","ui-selected"))},!0))}catch(t){console.warn("[URP++] free classroom list beautify failed",t)}}a(Sa,"beautifyFreeClassroomList");function Nr(t){if(!t||!t.style)return;if(t.classList.contains("setLabelWidth")){t.classList.remove("urppp-query-form"),t.style.setProperty("width","100%","important"),t.style.setProperty("max-width","100%","important"),t.style.setProperty("box-sizing","border-box","important"),t.style.setProperty("float","none","important"),t.style.setProperty("display","block","important"),t.style.setProperty("background","var(--surface)","important"),t.style.setProperty("border",De(),"important"),t.style.setProperty("border-radius","12px","important"),t.style.setProperty("box-shadow","none","important"),t.style.setProperty("margin","0 0 16px 0","important"),t.style.setProperty("padding","0","important"),t.style.setProperty("overflow","hidden","important");return}let e=!!(t.closest&&t.closest(".widget-box, .widget-main, .widget-body, .panel"));t.style.setProperty("width","100%","important"),t.style.setProperty("max-width","100%","important"),t.style.setProperty("min-width","0","important"),t.style.setProperty("box-sizing","border-box","important"),t.style.setProperty("float","none","important"),t.style.setProperty("display","block","important"),t.style.setProperty("clear","both","important");let r=t.parentElement&&t.parentElement.tagName==="FORM"?t.parentElement:null;r&&(r.style.setProperty("width","100%","important"),r.style.setProperty("max-width","100%","important"),r.style.setProperty("display","block","important"),r.style.setProperty("float","none","important"),r.style.setProperty("box-sizing","border-box","important"),r.style.setProperty("margin","0","important"));let o=t.closest&&t.closest(".tab-pane, .tab-content");if(o&&(o.style.setProperty("width","100%","important"),o.style.setProperty("max-width","100%","important"),o.style.setProperty("box-sizing","border-box","important")),e){t.style.setProperty("background","transparent","important"),t.style.setProperty("border","none","important"),t.style.setProperty("border-radius","0","important"),t.style.setProperty("padding","0","important"),t.style.setProperty("margin","0","important"),t.style.setProperty("box-shadow","none","important");return}t.style.setProperty("background","var(--surface)","important"),t.style.setProperty("border",De(),"important"),t.style.setProperty("border-radius","12px","important"),t.style.setProperty("box-shadow","none","important"),t.style.setProperty("margin","0 0 18px 0","important"),!t.classList.contains("setLabelWidth")&&(t.classList.contains("urppp-query-form")||!!t.querySelector(".urppp-query-pair, .chosen-container"))?(t.style.setProperty("padding","14px 16px","important"),t.style.setProperty("overflow","visible","important")):(t.style.setProperty("padding","0","important"),t.style.setProperty("overflow","hidden","important"))}a(Nr,"ensureProfileCardShell");function sr(){try{be(),document.querySelectorAll(".page-content .profile-user-info, #page-content-template .profile-user-info").forEach(o=>{Nr(o)});let t=a(o=>{let i=o.closest(".profile-user-info, .urppp-query-form")||o.parentElement;if(!i)return Math.min(Math.max(o.querySelectorAll(":scope > .urppp-query-pair").length,1),4);let s=0;return i.querySelectorAll(":scope > .profile-info-row, .profile-info-row").forEach(l=>{let m=l.querySelectorAll(":scope > .urppp-query-pair").length;m>s&&(s=m)}),Math.min(Math.max(s,1),4)},"getFormQueryCols"),e=a(o=>{let i=Array.from(o.querySelectorAll(":scope > .urppp-query-pair")),s=t(o);o.classList.add("urppp-query-row"),o.style.setProperty("display","grid","important"),o.style.removeProperty("grid-template-columns"),o.style.setProperty("column-gap","14px","important"),o.style.setProperty("row-gap","10px","important"),o.style.setProperty("align-items","center","important"),o.style.setProperty("width","100%","important"),o.style.setProperty("max-width","100%","important"),o.style.setProperty("box-sizing","border-box","important"),o.dataset.urpppQueryCols=String(s),i.forEach(l=>{l.style.removeProperty("grid-column")}),i.forEach(l=>{l.style.setProperty("display","flex","important"),l.style.setProperty("align-items","center","important"),l.style.setProperty("width","100%","important"),l.style.setProperty("min-width","0","important"),l.style.setProperty("max-width","100%","important"),l.style.setProperty("box-sizing","border-box","important"),l.style.removeProperty("flex");let m=l.querySelector(".profile-info-name"),h=l.querySelector(".profile-info-value");m&&(m.style.setProperty("float","none","important"),m.style.setProperty("display","flex","important"),m.style.setProperty("align-items","center","important"),m.style.setProperty("justify-content","flex-end","important"),m.style.setProperty("flex","0 0 var(--urppp-qlabel, 84px)","important"),m.style.setProperty("width","var(--urppp-qlabel, 84px)","important"),m.style.setProperty("min-width","var(--urppp-qlabel, 84px)","important"),m.style.setProperty("max-width","var(--urppp-qlabel-max, 96px)","important"),m.style.setProperty("margin","0","important"),m.style.setProperty("margin-left","0","important"),m.style.setProperty("padding","0 8px 0 0","important"),m.style.setProperty("background","transparent","important"),m.style.setProperty("border","none","important"),m.style.setProperty("border-right","none","important")),h&&(h.style.setProperty("float","none","important"),h.style.setProperty("display","flex","important"),h.style.setProperty("align-items","center","important"),h.style.setProperty("flex","1 1 auto","important"),h.style.setProperty("width","auto","important"),h.style.setProperty("min-width","0","important"),h.style.setProperty("max-width","none","important"),h.style.setProperty("margin","0","important"),h.style.setProperty("margin-left","0","important"),h.style.setProperty("padding","0","important"),h.style.setProperty("background","transparent","important"),h.style.setProperty("border","none","important"),h.querySelectorAll("input, select, .chosen-container, .form-control").forEach(v=>{v.style.setProperty("width","100%","important"),v.style.setProperty("min-width","0","important"),v.style.setProperty("max-width","none","important")})),l.querySelectorAll(".chosen-container").forEach(v=>{let M=v.previousElementSibling;M&&M.tagName==="SELECT"&&(M.style.setProperty("display","none","important"),M.classList.add("urppp-chosen-hidden"));let N=v.parentElement&&v.parentElement.querySelector("select");N&&(N.style.setProperty("display","none","important"),N.classList.add("urppp-chosen-hidden")),v.style.setProperty("width","100%","important"),v.style.setProperty("min-width","0","important"),v.style.setProperty("max-width","none","important");let z=v.querySelector(".chosen-single");if(z){z.style.setProperty("width","100%","important"),z.style.setProperty("max-width","none","important"),z.style.setProperty("display","flex","important"),z.style.setProperty("align-items","center","important"),z.style.setProperty("height","34px","important"),z.style.setProperty("line-height","normal","important");let D=z.querySelector(":scope > span, span");D&&(D.style.setProperty("line-height","normal","important"),D.style.setProperty("height","auto","important"),D.style.setProperty("margin-top","0","important"),D.style.setProperty("padding-top","0","important"));let J=z.querySelector("div");if(J){J.style.setProperty("display","flex","important"),J.style.setProperty("align-items","center","important"),J.style.setProperty("justify-content","center","important"),J.style.setProperty("top","0","important"),J.style.setProperty("bottom","0","important"),J.style.setProperty("height","auto","important");let j=J.querySelector("b");j&&(j.style.setProperty("margin","0","important"),j.style.setProperty("background-position","center center","important"),j.style.setProperty("background-size","12px 12px","important"),j.style.setProperty("width","14px","important"),j.style.setProperty("height","14px","important"))}}})})},"applyRowLayout");document.querySelectorAll(".profile-user-info.self, .profile-user-info-striped.self, .profile-user-info:has(.value_element)").forEach(o=>{if(o.classList.contains("setLabelWidth")||o.closest&&o.closest("#curriculumInfo-divcon, #curriculumInfo-divcon1, #curriculumInfo-divcon2, #fajh, #xnxq, #kz, #kc, #kcfa"))return;let i=Array.from(o.querySelectorAll(".profile-info-row")).some(l=>Array.from(l.children).filter(m=>m.classList&&m.classList.contains("profile-info-name")).length>=2),s=!!o.querySelector("select.chosen, select.select, .chosen-container");if(!i&&!s){o.classList.remove("urppp-query-form");return}o.querySelector('select, input:not([type="hidden"]), .chosen-container, .value_element, textarea')&&(o.classList.add("urppp-query-form"),Nr(o),o.querySelectorAll(".profile-info-row").forEach(l=>{if(l.dataset.urpppQueryDone==="1"){l.querySelector(":scope > .urppp-query-pair")&&e(l);return}let m=Array.from(l.children).filter(N=>N.classList&&(N.classList.contains("profile-info-name")||N.classList.contains("profile-info-value"))),h=[];for(let N=0;N<m.length;){let z=m[N],D=m[N+1];z&&D&&z.classList.contains("profile-info-name")&&D.classList.contains("profile-info-value")?(h.push([z,D]),N+=2):N+=1}if(!h.length){l.dataset.urpppQueryDone="1";return}let v=document.createDocumentFragment(),M=new Set;for(h.forEach(([N,z])=>{let D=document.createElement("div");D.className="urppp-query-pair",D.appendChild(N),D.appendChild(z),M.add(N),M.add(z),v.appendChild(D)}),m.forEach(N=>{M.has(N)||v.appendChild(N)});l.firstChild;)l.removeChild(l.firstChild);l.appendChild(v),l.dataset.urpppQueryDone="1",e(l)}))}),be()}catch(t){console.warn("[URP++] query form beautify failed",t)}}a(sr,"beautifyQueryForms");function Oo(){if(window.__urpppChosenAlignBound)return;window.__urpppChosenAlignBound=!0;let t=!1,e=a(r=>{if(!t){t=!0;try{let o=r&&r.querySelectorAll?r:document,i=document.getElementById("urppp-chosen-li-style");i||(i=document.createElement("style"),i.id="urppp-chosen-li-style",document.documentElement.appendChild(i)),i.textContent=[".self div.profile-info-value a.chosen-single > span,","body .self div.profile-info-value a.chosen-single > span {","  line-height: normal !important;","  height: auto !important;","  margin-top: 0 !important;","  padding-top: 0 !important;","}",".self div.profile-info-value a.chosen-single,","body .self div.profile-info-value a.chosen-single {","  display: flex !important;","  align-items: center !important;","  height: 34px !important;","  line-height: normal !important;","}","body .chosen-container .chosen-results li,","body .chosen-with-drop .chosen-results li,","html body .chosen-container .chosen-results li.active-result {","  display:flex !important;","  align-items:center !important;","  justify-content:flex-start !important;","  height:36px !important;","  min-height:36px !important;","  max-height:36px !important;","  line-height:1 !important;","  padding:0 12px !important;","  margin:0 !important;","  box-sizing:border-box !important;","}","body .chosen-container .chosen-results li.highlighted,","body .chosen-container .chosen-results li.result-selected {","  display:flex !important;","  align-items:center !important;","  height:36px !important;","  line-height:1 !important;","  padding:0 12px !important;","}"].join(""),o.querySelectorAll(".chosen-results li").forEach(s=>{s.style.cssText=["display:flex !important","align-items:center !important","justify-content:flex-start !important","height:36px !important","min-height:36px !important","max-height:36px !important","line-height:1 !important","padding:0 12px !important","margin:0 !important","box-sizing:border-box !important"].join(";")}),o.querySelectorAll("a.chosen-single").forEach(s=>{s.style.setProperty("display","flex","important"),s.style.setProperty("align-items","center","important"),s.style.setProperty("height","34px","important"),s.style.setProperty("min-height","34px","important"),s.style.setProperty("line-height","normal","important"),s.style.setProperty("padding-top","0","important"),s.style.setProperty("padding-bottom","0","important");let l=s.querySelector(":scope > span");l&&(l.style.setProperty("line-height","normal","important"),l.style.setProperty("height","auto","important"),l.style.setProperty("margin-top","0","important"),l.style.setProperty("margin-bottom","0","important"),l.style.setProperty("padding-top","0","important"),l.style.setProperty("padding-bottom","0","important"))}),o.querySelectorAll(".chosen-search").forEach(s=>{if(!s.querySelector(".urppp-chosen-search-icon")){let l=document.createElement("i");l.className="fa fa-search urppp-chosen-search-icon",l.setAttribute("aria-hidden","true"),s.appendChild(l)}})}finally{setTimeout(()=>{t=!1},0)}}},"apply");document.addEventListener("mousedown",r=>{let o=r.target&&r.target.closest?r.target.closest(".chosen-container"):null;o&&(setTimeout(()=>e(o),0),setTimeout(()=>e(o),30),setTimeout(()=>e(o),100),setTimeout(()=>e(o),200))},!0);try{let r=window.jQuery||window.$;r&&r.fn&&r(document).off("chosen:showing_dropdown.urppp chosen:updated.urppp").on("chosen:showing_dropdown.urppp chosen:updated.urppp",o=>{let i=o.target&&o.target.parentElement?o.target.parentElement:document;setTimeout(()=>e(i),0),setTimeout(()=>e(i),60)})}catch{}}a(Oo,"patchChosenDropdownAlign");function _a(){try{let t=document.getElementById("work_rest_schedule_modal");if(!t)return;(t.classList.contains("in")||t.classList.contains("show"))&&t.style.setProperty("display","block","important");let e=t.querySelector(".modal-body")||t,r=Array.from(e.querySelectorAll("table"));if(!r.length)return;let o=a(l=>(l||"").replace(/\s+/g," ").trim(),"norm"),i=a(l=>String(l??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),"esc");if(e.dataset.urpppWrsDone==="1")return;e.dataset.urpppWrsDone="1",r.forEach(l=>{let m=l.closest(".urppp-table-wrap");m&&t.contains(m)&&m.parentElement&&(m.parentElement.insertBefore(l,m),m.remove()),l.classList.add("urppp-wrs-table"),l.style.setProperty("width","100%","important");let h=Array.from(l.rows||[]);if(!h.length)return;let v=0;h.forEach(M=>{let N=o(M.textContent);if(!/\d{1,2}:\d{2}/.test(N))return;let z=0;Array.from(M.cells||[]).forEach(D=>{z+=D.colSpan||1}),z>v&&(v=z)}),v<4&&h.forEach(M=>{let N=0;Array.from(M.cells||[]).forEach(z=>{N+=z.colSpan||1}),N>v&&(v=N)}),v<1&&(v=1),Array.from(l.rows||[]).forEach(M=>{let N=Array.from(M.cells||[]);if(!N.length)return;let z=o(M.textContent);if(!/\d{1,2}:\d{2}/.test(z)&&(/作息时间|学年/.test(z)||/(望江|华西|江安)/.test(z)&&/校区|时间|安排|作息/.test(z))){let j=z;M.className="urppp-wrs-title-row",M.innerHTML='<td class="urppp-wrs-title" colspan="'+v+'" align="center">'+i(j)+"</td>";return}N.forEach(j=>{["border","borderTop","borderRight","borderBottom","borderLeft","textAlign","verticalAlign","width"].forEach(F=>{try{j.style[F]=""}catch{}}),j.classList.remove("urppp-wrs-title","urppp-wrs-period","urppp-wrs-time","urppp-wrs-head");let R=o(j.textContent);R&&(/^(上午|下午|晚上|中午)$/.test(R)||(j.rowSpan||1)>1&&/上午|下午|晚上|中午/.test(R)?j.classList.add("urppp-wrs-period"):/节次|大节|时间|校区/.test(R)&&!/\d{1,2}:\d{2}/.test(R)&&!/第\d/.test(R)?/节次|时间|大节|校区/.test(z)&&!/\d{1,2}:\d{2}/.test(z)&&j.classList.add("urppp-wrs-head"):/\d{1,2}:\d{2}/.test(R)&&j.classList.add("urppp-wrs-time"),j.style.setProperty("text-align","center","important"),j.style.setProperty("vertical-align","middle","important"))})})});let s=t.querySelector(".modal-title");s&&(s.style.setProperty("text-align","center","important"),s.style.setProperty("width","100%","important")),e.dataset.urpppWrsDone="1"}catch{}}a(_a,"beautifyWorkRestSchedule");let Ho="https://jwc.scu.edu.cn/cdxl.htm";function Ea(){let t=['a[onclick*="jwc.scu.edu.cn/article/206"]','a[href*="jwc.scu.edu.cn/article/206"]',".cdsj a",".ace-nav a"],e=new Set;t.forEach(r=>{document.querySelectorAll(r).forEach(o=>{if(e.has(o))return;e.add(o);let i=(o.textContent||"").replace(/\s+/g,""),s=o.getAttribute("onclick")||"",l=o.getAttribute("href")||"";(i.includes("学校校历")||s.includes("article/206")||l.includes("article/206")||s.includes("jwc.scu.edu.cn")&&i.includes("校历"))&&(o.setAttribute("href",Ho),o.setAttribute("target","_blank"),o.setAttribute("rel","noopener noreferrer"),o.setAttribute("onclick",`window.open('${Ho}');return false;`))})})}a(Ea,"patchSchoolCalendarLink");function Br(){document.querySelectorAll("#navbar-example, .page-content .navbar.navbar-static, #page-content-template .navbar.navbar-static").forEach(t=>{if(!t.querySelector(".nav-tabs"))return;["background","background-color","background-image","border","border-radius","box-shadow"].forEach(o=>{t.style.setProperty(o,o.startsWith("background")||o==="box-shadow"?o==="box-shadow"?"none":"transparent":o==="border"?"none":"0","important")}),t.style.setProperty("background","transparent","important"),t.style.setProperty("background-color","transparent","important"),t.style.setProperty("border","none","important"),t.style.setProperty("border-radius","0","important"),t.style.setProperty("box-shadow","none","important"),t.style.setProperty("width","100%","important"),t.style.setProperty("margin","0 0 14px 0","important"),t.style.setProperty("padding","0","important"),t.style.setProperty("min-height","0","important"),t.style.setProperty("box-sizing","border-box","important");let e=t.querySelector(".navbar-inner");e&&(e.style.setProperty("background","transparent","important"),e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important"),e.style.setProperty("padding","0","important"),e.style.setProperty("min-height","0","important"),e.style.setProperty("filter","none","important"),e.style.setProperty("width","100%","important")),t.querySelectorAll(".container, .container-fluid").forEach(o=>{o.style.setProperty("width","100%","important"),o.style.setProperty("max-width","100%","important"),o.style.setProperty("margin","0","important"),o.style.setProperty("margin-left","0","important"),o.style.setProperty("padding","0","important"),o.style.setProperty("background","transparent","important"),o.style.setProperty("box-sizing","border-box","important")});let r=t.querySelector(".nav-tabs");r&&(r.style.setProperty("width","100%","important"),r.style.setProperty("margin","0","important"),r.style.setProperty("padding","8px 10px","important"),r.style.setProperty("background","var(--surface)","important"),r.style.setProperty("background-color","var(--surface)","important"),r.style.setProperty("border",De(),"important"),r.style.setProperty("border-radius","12px","important"),r.style.setProperty("box-sizing","border-box","important"))})}a(Br,"patchAceTabNavbars");function je(){let t=a(e=>{let r=NaN,o=[e.getAttribute("data-percent"),e.querySelector("[data-percent]")?.getAttribute("data-percent"),e.querySelector(".percent")?.textContent,e.querySelector(".urppp-pct-text")?.textContent];for(let i of o){if(i==null||i==="")continue;let s=parseFloat(String(i).replace(/[^\d.]/g,""));if(!Number.isNaN(s)){r=s;break}}if(Number.isNaN(r)){let i=(e.textContent||"").match(/(\d+(?:\.\d+)?)\s*%/);i&&(r=parseFloat(i[1]))}if(Number.isNaN(r)){let i=e.querySelector('.progress-bar, .infobox-progress [style*="width"], .urppp-pct-fill');if(i){let s=String(i.style.width||"").match(/([\d.]+)%/);s&&(r=parseFloat(s[1]))}}return Number.isNaN(r)?null:Math.max(0,Math.min(100,r))},"readPct");document.querySelectorAll(".infobox").forEach(e=>{let r=t(e);if(r==null)return;e.querySelectorAll("canvas").forEach(l=>l.remove()),e.querySelectorAll(".easy-pie-chart, .percentage, .infobox-progress").forEach(l=>{l.classList.contains("urppp-pct-bar")||l.remove()}),e.querySelectorAll(".urppp-pct-text, .urppp-pct-bar").forEach(l=>l.remove());let o=e.querySelector(".infobox-data")||e,i=document.createElement("div");i.className="urppp-pct-text",i.textContent=Math.round(r)+"%";let s=document.createElement("div");if(s.className="urppp-pct-bar"+(r<=0?" is-empty":""),r>0){let l=document.createElement("span");l.className="urppp-pct-fill",l.style.width=r+"%",s.appendChild(l)}o.insertBefore(s,o.firstChild),o.insertBefore(i,o.firstChild),e.dataset.urpppPctDone="1"})}a(je,"restyleInfoboxPercentages");function lr(t){let e=document.getElementById("treeDemo");if(!e)return;let r=!!(t&&t.force);if(e.dataset.urpppBusy==="1"&&!(t&&t.ignoreBusy))return;let o=e.closest('div[style*="border"]')||e.closest("#tree_div")?.parentElement||e.parentElement;o&&o.classList.add("urppp-plan-tree-shell"),e.classList.add("urppp-ztree");let i=typeof unsafeWindow<"u"?unsafeWindow:window,s=a(()=>{try{return(i.jQuery||i.$||window.jQuery||window.$)?.fn?.zTree?.getZTreeObj?.("treeDemo")||null}catch{return null}},"getZTree"),l=a(()=>{let R=Array.from(e.querySelectorAll('span.button.switch[class*="_open"]')).filter(F=>!/_docu\b/.test(F.className));return R.reverse().forEach(F=>{try{F.click()}catch{}}),R.length>0},"collapseAllDom"),m=a(()=>{let R=s();if(R)try{R.expandAll(!1)}catch{}return e.querySelector('span.button.switch[class*="_open"]:not([class*="_docu"])')&&l(),!0},"collapseAll");if(!window.__urpppExpandKzPatched){window.__urpppExpandKzPatched=!0;let R=a(()=>{let F=typeof unsafeWindow<"u"?unsafeWindow:window;try{F.expandKzByRule=function(){e.dataset.urpppUserExpanded||m()}}catch{}},"patch");R(),setTimeout(R,0),setTimeout(R,200)}e.dataset.urpppCollapsedOnce||(e.dataset.urpppCollapsedOnce="1",[0,80,200,500,1e3].forEach(R=>setTimeout(()=>{e.dataset.urpppUserExpanded||m()},R)));let h=document.querySelector("#two h4.header, #two .header");if(h&&!h.dataset.urpppLegendDone){let R=h.querySelector("font");if(R){let F=document.createElement("div");F.className="urppp-plan-legend",F.innerHTML=['<span class="urppp-lg done"><i class="ace-icon fa fa-check-square-o"></i>已完成课组</span>','<span class="urppp-lg todo"><i class="ace-icon fa fa-folder-o"></i>尚未完成课组</span>','<span class="urppp-lg pass"><i class="ace-icon fa fa-smile-o"></i>已修读及格</span>','<span class="urppp-lg fail"><i class="ace-icon fa fa-frown-o"></i>已修读未及格</span>','<span class="urppp-lg pending"><i class="ace-icon fa fa-meh-o"></i>尚未修读</span>'].join(""),R.replaceWith(F)}h.classList.add("urppp-plan-header"),h.dataset.urpppLegendDone="1"}let v=a(()=>{if(e.dataset.urpppBusy="1",window.__urpppPlanTreeObs)try{window.__urpppPlanTreeObs.disconnect()}catch{}},"pauseObs"),M=a(()=>{e.dataset.urpppBusy="0";let R=document.getElementById("tree_div")||e;if(window.__urpppPlanTreeObs&&R)try{window.__urpppPlanTreeObs.observe(R,{childList:!0,subtree:!0})}catch{}},"resumeObs"),N=a(R=>{let F=R;return F=F.replace(/\((最低修读学分:[^)]+)\)/g,(K,ut)=>{let vt=ut.split(",").map(qt=>qt.trim()).filter(Boolean),Et=[];return vt.forEach(qt=>{/最低修读学分|通过学分|必修课未修读|已及格课程门数/.test(qt)&&Et.push(qt)}),`<span class="urppp-sub">${(Et.length?Et:vt).map(qt=>{let Ot=qt.match(/^([^:：]+)[:：]\s*(.+)$/);if(!Ot)return qt;let Ht=Ot[1].trim(),Mt=Ot[2].trim(),ae="neutral";return/通过|已及格/.test(Ht)?ae="ok":/未修读|未及格/.test(Ht)?ae=Number(Mt)>0?"warn":"muted":/最低/.test(Ht)&&(ae="req"),`<span class="urppp-kv ${ae}"><em>${Ht}</em><b>${Mt}</b></span>`}).join("")}</span>`}),F=F.replace(/\[(\d{6,})\]/g,'<span class="urppp-code">$1</span>'),F=F.replace(/\[(\d+(?:\.\d+)?学分(?:,[^\]\[]*)?)\]/g,'<span class="urppp-meta">$1</span>'),F=F.replace(/\((必修|任选|限选),((?:[^()]|\([^()]*\))*)\)/g,(K,ut,vt)=>{let Et=String(vt).trim(),Lt=Et.match(/^(.+?)(?:\((\d{6,8})\))?$/),qt=(Lt?Lt[1]:Et).trim(),Ot=Lt&&Lt[2]?Lt[2]:"",Ht=parseFloat(qt),Mt=!1;Number.isNaN(Ht)?/不及格|未通过|不通过/.test(qt)?Mt=!1:(/^(?:[A-D][+]?|优秀|良好|中等|及格|通过)/.test(qt),Mt=!0):Mt=Ht>=60;let ae=Ot?`<i>${Ot}</i>`:"";return`<span class="urppp-score ${Mt?"pass":"fail"}"><b>${ut}</b><em>${qt}</em>${ae}</span>`}),F=F.replace(/(<span class="urppp-code">[^<]*<\/span>)\s*([^<]+?)(?=\s*(?:<span class="urppp-meta"|<span class="urppp-score"|$))/g,'$1<span class="urppp-title">$2</span>'),F=F.replace(/(<\/i>)(?:&nbsp;|\s)*([^<]+?)(?=<span class="urppp-sub")/g,'$1 <span class="urppp-gname">$2</span>'),F=F.replace(/(<\/i>)(?:&nbsp;|\s)+(?=<span class="urppp-gname")/g,"$1 "),F},"formatNodeHtml"),z=a(R=>{let F=R.querySelector("i.fa, i.ace-icon"),K=R.closest("li");K&&(K.classList.remove("urppp-node-done","urppp-node-todo","urppp-node-pass","urppp-node-fail","urppp-node-pending"),F&&(F.classList.contains("fa-check-square-o")?K.classList.add("urppp-node-done"):F.classList.contains("fa-smile-o")?K.classList.add("urppp-node-pass"):F.classList.contains("fa-frown-o")?K.classList.add("urppp-node-fail"):F.classList.contains("fa-meh-o")?K.classList.add("urppp-node-pending"):F.classList.contains("fa-kz")&&K.classList.add("urppp-node-todo")))},"markStatus"),D=a(R=>{if(!R||!r&&R.dataset.urpppNodeDone==="1")return!1;z(R);let F=R.querySelector("span.node_name")||R;if(!F)return!1;if(!r&&F.querySelector(".urppp-score, .urppp-code, .urppp-sub, .urppp-title, .urppp-gname"))R.dataset.urpppNodeDone="1";else{let ut=F.dataset.urpppRaw;ut||(F.querySelector(".urppp-score, .urppp-code, .urppp-sub")?(R.dataset.urpppNodeDone="1",ut=null):(ut=F.innerHTML,ut&&(F.dataset.urpppRaw=ut))),ut&&(F.innerHTML=N(ut),R.dataset.urpppNodeDone="1")}let K=R.parentElement&&R.parentElement.querySelector(":scope > span.button.switch");return K&&(K.dataset.urpppSw||(K.dataset.urpppSw="1",/_docu\b/.test(K.className)&&(K.classList.add("urppp-switch-leaf"),K.style.setProperty("display","none","important"))),/_docu\b/.test(K.className)||K.classList.contains("urppp-switch-leaf")?R.classList.remove("urppp-expandable"):R.classList.add("urppp-expandable")),!0},"paintOne"),J=a((R,F)=>{let K=Array.from(R||[]),ut=0,vt=a(()=>{let Et=Math.min(ut+48,K.length);for(;ut<Et;ut++)D(K[ut]);ut<K.length?window.requestIdleCallback?requestIdleCallback(vt,{timeout:120}):setTimeout(vt,0):F&&F()},"step");vt()},"paintList"),j=a(R=>{let F=R||e;F.querySelectorAll("span.button.switch:not([data-urppp-sw])").forEach(K=>{K.dataset.urpppSw="1",/_docu\b/.test(K.className)&&(K.classList.add("urppp-switch-leaf"),K.style.setProperty("display","none","important"))}),F.querySelectorAll("li > a").forEach(K=>D(K))},"paintScopeSync");v();try{j(e),e.dataset.urpppExpandClick||(e.dataset.urpppExpandClick="1",e.addEventListener("click",F=>{if(F.target.closest&&F.target.closest("span.button.switch")){let Lt=F.target.closest("span.button.switch"),qt=Lt&&Lt.parentElement;if(!qt||/_docu\b/.test(Lt.className))return;if(e.dataset.urpppUserExpanded="1",e.dataset.urpppBusy="1",window.__urpppPlanTreeObs)try{window.__urpppPlanTreeObs.disconnect()}catch{}setTimeout(()=>{j(qt),e.dataset.urpppBusy="0";let Ot=document.getElementById("tree_div")||e;if(window.__urpppPlanTreeObs&&Ot)try{window.__urpppPlanTreeObs.observe(Ot,{childList:!0,subtree:!0})}catch{}},0);return}let K=F.target&&F.target.closest?F.target.closest("li > a"):null;if(!K||!e.contains(K))return;let ut=K.parentElement;if(!ut)return;let vt=ut.querySelector(":scope > span.button.switch");if(!vt||/_docu\b/.test(vt.className)||vt.classList.contains("urppp-switch-leaf")||!K.classList.contains("urppp-expandable")&&!/_open|_close/.test(vt.className))return;if(F.preventDefault(),F.stopImmediatePropagation(),e.dataset.urpppUserExpanded="1",e.dataset.urpppBusy="1",window.__urpppPlanTreeObs)try{window.__urpppPlanTreeObs.disconnect()}catch{}vt.click(),j(ut),e.dataset.urpppBusy="0";let Et=document.getElementById("tree_div")||e;if(window.__urpppPlanTreeObs&&Et)try{window.__urpppPlanTreeObs.observe(Et,{childList:!0,subtree:!0})}catch{}},!0));let R=a((F,K)=>{let ut=document.getElementById(F);return!ut||ut.dataset.urpppBound==="1"?!1:(ut.dataset.urpppBound="1",ut.addEventListener("click",vt=>{vt.preventDefault(),vt.stopImmediatePropagation(),e.dataset.urpppUserExpanded="1",v();try{let Et=s();if(K){Et?Et.expandAll(!0):e.querySelectorAll('span.button.switch[class*="_close"]').forEach(qt=>{/_docu\b/.test(qt.className)||qt.click()});let Lt=e.querySelectorAll('li > a:not([data-urppp-node-done="1"])');J(Lt,M)}else{if(Et)try{Et.expandAll(!1)}catch{}l(),setTimeout(()=>{e.querySelector('span.button.switch[class*="_open"]:not([class*="docu"])')&&l(),M()},0)}}catch{K||l(),M()}},!0),!0)},"bindAll");R("expandAllBtn",!0),R("collapseAllBtn",!1),e.dataset.urpppAllBtnsRetry||(e.dataset.urpppAllBtnsRetry="1",setTimeout(()=>{R("expandAllBtn",!0),R("collapseAllBtn",!1)},300),setTimeout(()=>{R("expandAllBtn",!0),R("collapseAllBtn",!1)},1e3))}finally{requestAnimationFrame(()=>{requestAnimationFrame(M)})}}a(lr,"beautifyPlanTree");function cr(){if(!de())try{let t=document.getElementById("soliderbox");if(t){t.style.setProperty("width","100%","important"),t.style.setProperty("max-width","720px","important"),t.style.setProperty("min-width","0","important"),t.classList.remove("container");let i=t.closest(".profile-info-row");i&&(i.style.setProperty("display","flex","important"),i.style.setProperty("align-items","center","important"),i.style.setProperty("width","100%","important"),i.style.setProperty("max-width","100%","important"));let s=t.closest(".profile-info-value");s&&(s.style.setProperty("width","auto","important"),s.style.setProperty("max-width","100%","important"),s.style.setProperty("flex","1 1 auto","important"),s.style.setProperty("min-width","0","important"))}let e=document.getElementById("mycoursetable");if(!e)return;let r=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches);e.classList.toggle("urppp-mobile-schedule-scroll",r),e.style.setProperty("position","relative","important"),e.style.setProperty("width","100%","important");let o=72;r||e.querySelectorAll("#courseTableBody tr, table tbody tr").forEach(i=>{let s=i.offsetHeight||0;s>o&&(o=s)}),o<56&&(o=72),e.querySelectorAll("div.class_div").forEach(i=>{let s=parseInt(i.getAttribute("classNum")||"1",10)||1,l=i.scrollHeight||0;if(l>0){let m=Math.ceil(l/s);o=r?Math.max(o,Math.min(m,88)):Math.max(o,m)}}),r?o=Math.min(Math.max(o,72),88):(o<64&&(o=72),o>160&&(o=120)),e.querySelectorAll("#courseTableBody tr, table tbody tr").forEach(i=>{i.style.setProperty("height",o+"px","important")}),e.querySelectorAll("td").forEach(i=>{let s=Array.from(i.querySelectorAll(":scope > div.class_div"));if(!s.length)return;i.style.setProperty("position","relative","important"),i.style.setProperty("vertical-align","top","important"),i.style.setProperty("overflow","visible","important");let l=i.getBoundingClientRect().width||i.offsetWidth||i.clientWidth||0,m=getComputedStyle(i),h=i.closest("table"),v=h?getComputedStyle(h):null,M=parseFloat(m.borderLeftWidth)||0,N=v&&v.borderCollapse==="collapse"?M/2:M,z=Math.max(1,s.length);s.forEach((D,J)=>{let j=parseInt(D.getAttribute("classNum")||"1",10)||1,R=Ap(l,z,J,N),F=R.left,K=R.width;D.style.setProperty("position","absolute","important"),D.style.setProperty("top","0px","important"),D.style.setProperty("left",F+"px","important"),D.style.setProperty("right","auto","important"),D.style.setProperty("bottom","auto","important"),D.style.setProperty("transform","none","important"),D.style.setProperty("width",K+"px","important"),D.style.setProperty("max-width","none","important"),D.style.setProperty("height",o*j+"px","important"),D.style.setProperty("margin","0","important"),D.style.setProperty("box-sizing","border-box","important"),D.style.setProperty("z-index","2","important"),D.style.setProperty("overflow","hidden","important")})})}catch(t){console.warn("[URP++] week schedule fix failed",t)}}a(cr,"fixWeekScheduleLayout");function Ca(){try{let t=typeof unsafeWindow<"u"?unsafeWindow:window;if(!t||t.__urpppDivBuildPatched||typeof t.divBuild!="function")return;t.__urpppDivBuildPatched=!0;let e=t.divBuild;t.__urpppOriginalDivBuild=e,t.divBuild=function(){try{cr()}catch{try{return e.apply(this,arguments)}catch{}}};try{t.divBuild._urppp=!0}catch{}}catch(t){console.warn("[URP++] patch divBuild failed",t)}}a(Ca,"patchSiteDivBuild");let Oe=null,Ro=!1;function Uo(){let t=document.getElementById("mycoursetable")||document.getElementById("page-content-template")||document.body;if(Oe&&Oe.root===t&&t?.isConnected){cr();return}Oe&&Oe.disconnect(),Oe=null;let e=!Ro;Ro=!0;let r=!1,o=a(()=>{if(!(r||de())&&!(!document.getElementById("soliderbox")&&!document.getElementById("mycoursetable"))){r=!0;try{Ca(),cr()}finally{setTimeout(()=>{r=!1},40)}}},"run");Ca(),[0,50,150,400,1e3,2e3].forEach(l=>setTimeout(()=>{Ca(),o()},l)),e&&window.addEventListener("resize",()=>{clearTimeout(window.__urpppWeekSchedResize),window.__urpppWeekSchedResize=setTimeout(o,120)});let i=a(l=>{if(!l||de())return;let m=[];l.nodeType===1&&(l.matches&&l.matches("div.class_div")&&m.push(l),l.querySelectorAll&&l.querySelectorAll("div.class_div").forEach(h=>m.push(h))),m.forEach(h=>{let v=h.parentElement;v&&v.tagName==="TD"&&v.style.setProperty("position","relative","important"),h.style.setProperty("position","absolute","important"),h.style.setProperty("top","0px","important"),h.style.setProperty("left","0px","important"),h.style.setProperty("right","auto","important"),h.style.setProperty("transform","none","important"),h.style.setProperty("width","100%","important"),h.style.setProperty("margin","0","important"),h.style.setProperty("box-sizing","border-box","important")})},"pinNew"),s=new MutationObserver(l=>{if(de())return;let m=!1;l.forEach(h=>{if(h.type==="childList"&&h.addedNodes.forEach(v=>{i(v),m=!0}),h.type==="attributes"&&h.attributeName==="style"&&h.target&&h.target.classList&&h.target.classList.contains("class_div")){let v=h.target,M=v.style.left||"",N=parseFloat(M);(!M||M==="auto"||Number.isFinite(N)&&N>200)&&(v.style.setProperty("left","0px","important"),v.style.setProperty("top","0px","important"),v.style.setProperty("position","absolute","important")),m=!0}}),m&&(clearTimeout(window.__urpppWeekSchedMut),window.__urpppWeekSchedMut=setTimeout(()=>{requestAnimationFrame(o)},16))});if(t){s.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class"]});let l=null,m=0,h=0;if(t.id==="mycoursetable"&&typeof window.ResizeObserver=="function"){let v=t.getBoundingClientRect().width||0;l=new window.ResizeObserver(M=>{let N=M[0]?.contentRect?.width||t.getBoundingClientRect().width||0;!N||Math.abs(N-v)<.5||(v=N,m||(m=requestAnimationFrame(()=>{m=0,o()})),clearTimeout(h),h=setTimeout(o,80))}),l.observe(t)}Oe={root:t,observer:s,disconnect(){s.disconnect(),l&&l.disconnect(),m&&cancelAnimationFrame(m),clearTimeout(h)}}}e&&document.addEventListener("mouseup",()=>{document.getElementById("soliderbox")&&(setTimeout(o,200),setTimeout(o,500))},!0)}a(Uo,"scheduleWeekScheduleFix");function Wo(){try{let t=document.getElementById("curriculumInfo-divcon2");if(!t)return;let e=parseFloat(t.style.width||getComputedStyle(t).width||"0");if(!e||e<40)return;t.classList.add("urppp-curriculum-drawer");let r=t.querySelector(".modal-body");if(!r)return;let o=r.querySelector(":scope > .col-xs-12 > .row")||r.querySelector(".col-xs-12 > .row")||r.querySelector(".row");if(!o)return;o.classList.add("urppp-drawer-layout");let i=o.querySelector(":scope > .urppp-drawer-toolbar, :scope > p");i&&i.tagName==="P"&&i.classList.add("urppp-drawer-toolbar");let s=o.querySelector(":scope > .urppp-drawer-body"),l=o.querySelector(".urppp-drawer-left"),m=o.querySelector(".urppp-drawer-right");s||(s=document.createElement("div"),s.className="urppp-drawer-body"),l||(l=document.createElement("div"),l.className="urppp-drawer-left"),m||(m=document.createElement("div"),m.className="urppp-drawer-right"),s.contains(l)||s.appendChild(l),s.contains(m)||s.appendChild(m),s.parentElement!==o&&(i&&i.parentElement===o?o.insertBefore(s,i.nextSibling):o.appendChild(s)),i&&o.firstElementChild!==i&&o.insertBefore(i,o.firstElementChild);let h=o.querySelector("#treeDemo, .ztree")||t.querySelector("#treeDemo, .ztree"),v=null;if(h){v=h.closest(".col-xs-6, .col-sm-6, .widget-box")||h.parentElement;let J=h.closest(".col-xs-6, .col-sm-6");J&&(v=J)}let M=["fajh","xnxq","kz","kc","kcfa"],N=M.map(J=>document.getElementById(J)).filter(J=>J&&t.contains(J));v&&v.parentElement!==l&&l.appendChild(v),Array.from(l.children).forEach(J=>{(M.includes(J.id)||J.id&&M.includes(J.id)||J!==v&&J.querySelector&&!J.querySelector("#treeDemo, .ztree")&&J.classList&&J.classList.contains("col-xs-6"))&&m.appendChild(J)}),M.forEach(J=>{let j=document.getElementById(J);!j||!t.contains(j)||(j.parentElement!==m&&m.appendChild(j),j.style.setProperty("width","100%","important"),j.style.setProperty("max-width","100%","important"),j.style.setProperty("float","none","important"),j.style.setProperty("margin","0","important"),j.style.setProperty("padding","0","important"),j.style.setProperty("box-sizing","border-box","important"),j.style.display!=="none"&&getComputedStyle(j).display!=="none"&&j.style.setProperty("display","block","important"))});let z=document.getElementById("fajh");z&&t.contains(z)&&(z.parentElement!==m&&m.appendChild(z),(!z.innerHTML||!z.innerHTML.trim())&&!z.querySelector(".urppp-drawer-skeleton, .profile-user-info, .widget-box")&&(z.innerHTML=["<div class='widget-box transparent urppp-drawer-skeleton'>","  <div class='widget-header widget-header-small'>","    <h4 class='widget-title smaller grey'>方案计划信息</h4>","  </div>","</div>","<div class='self profile-user-info profile-user-info-striped urppp-drawer-skeleton-card'>","  <div class='profile-info-row'><div class='profile-info-name'>加载中</div><div class='profile-info-value'>正在获取方案信息…</div></div>","</div>"].join(""),z.style.setProperty("display","block","important"),z.dataset.urpppSkeleton="1"),z.dataset.urpppSkeleton==="1"&&z.querySelector(".profile-info-value")&&/方案名称|计划名称|年级|院系/.test(z.textContent||"")&&(delete z.dataset.urpppSkeleton,z.querySelectorAll(".urppp-drawer-skeleton, .urppp-drawer-skeleton-card").forEach(j=>j.remove())),z.innerHTML&&z.innerHTML.trim()&&z.style.display==="none"&&(z.dataset.urpppSkeleton==="1"||z.querySelector(".profile-user-info"))&&z.style.setProperty("display","block","important")),m.style.setProperty("min-height","240px","important"),l.style.setProperty("min-height","240px","important"),v&&(v.style.setProperty("width","100%","important"),v.style.setProperty("max-width","100%","important"),v.style.setProperty("float","none","important"),v.style.setProperty("margin","0","important"),v.style.setProperty("padding","0","important"),v.style.setProperty("border","none","important"),v.style.setProperty("box-sizing","border-box","important"));let D=l.querySelector(".widget-box");D&&(D.style.setProperty("width","100%","important"),D.style.setProperty("margin","0","important"),D.style.setProperty("border",De(),"important"),D.style.setProperty("border-radius","12px","important"),D.style.setProperty("overflow","hidden","important"),D.style.setProperty("background","var(--surface)","important")),t.querySelectorAll(".profile-info-row").forEach(J=>{J.classList.remove("urppp-query-row","urppp-dual-pair"),J.style.setProperty("display","grid","important"),J.style.setProperty("grid-template-columns","112px minmax(0,1fr)","important"),J.style.setProperty("width","100%","important"),Array.from(J.children).forEach(j=>{j.classList&&(j.style.setProperty("float","none","important"),j.style.setProperty("margin-left","0","important"),j.style.setProperty("width","auto","important"),j.style.setProperty("max-width","none","important"))})}),t.querySelectorAll(".profile-user-info, .profile-user-info-striped").forEach(J=>{J.classList.remove("urppp-query-form");try{Nr(J)}catch{}J.querySelectorAll(".profile-info-value, .profile-info-value span, span.editable").forEach(j=>{j.style.setProperty("color","var(--text)","important"),j.style.setProperty("opacity","1","important"),j.style.setProperty("visibility","visible","important")}),J.style.setProperty("border-radius","12px","important"),J.style.setProperty("overflow","hidden","important"),J.style.setProperty("width","100%","important"),J.style.setProperty("max-width","100%","important"),J.style.setProperty("display","block","important"),J.style.setProperty("box-sizing","border-box","important")})}catch(t){console.warn("[URP++] curriculum drawer beautify failed",t)}}a(Wo,"beautifyCurriculumDrawer");function ts(){if(window.__urpppCurriculumDrawerBound)return;window.__urpppCurriculumDrawerBound=!0;let t=a(()=>Wo(),"run");[0,50,150,350,800,1600].forEach(o=>setTimeout(t,o));let e=new MutationObserver(o=>{o.some(s=>!!(s.type==="childList"||s.type==="attributes"&&s.target&&(s.target.id==="curriculumInfo-divcon2"||s.target.id==="fajh")))&&(clearTimeout(window.__urpppCurriculumDrawerTimer),window.__urpppCurriculumDrawerTimer=setTimeout(()=>requestAnimationFrame(t),16))}),r=document.getElementById("curriculumInfo-divcon2");r&&e.observe(r,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("click",o=>{if(!document.getElementById("curriculumInfo-divcon2"))return;let i=o.target&&o.target.closest?o.target.closest("a,button,span,div"):null,s=(i&&i.textContent||"").replace(/\s+/g,"");(/培养方案|与我相关|方案计划|自动化培养/.test(s)||i&&i.closest&&i.closest("#curriculumInfo-divcon2"))&&(setTimeout(t,0),setTimeout(t,50),setTimeout(t,150),setTimeout(t,400))},!0)}a(ts,"scheduleCurriculumDrawerBeautify");let{scheduleScrubTableInlineBg:Go,scrubTableHeaderInlineBg:es}=Wp({isNativePdfIsolationActive:de}),{disarmNoticeTableHover:rs,pinNoticeRowSurface:Jo,scrubNoticeInlineBg:Vo,stripMistakenNoticeTable:Yo}=Yp({getCurrentTheme:Jt});function Pa(){try{let t=document.querySelector("h4.header, h3.header, h4, h3, .breadcrumb, .page-header");return Op({pathname:location.pathname,href:location.href,title:document.title,headingText:t?.textContent||""})}catch{return!1}}a(Pa,"isNoticePageContext");function as(t){return ho(t,{noticePage:Pa()})}a(as,"isNoticeListTable");function za(t){return Hp(t,{noticePage:Pa()})}a(za,"isBusinessDataTable");let Qo,{bindNoticeHoverScrub:os,scheduleBeautifyNoticeTables:Xo}=Vp({beautifyNoticeTables:a(t=>Qo(t),"beautifyNoticeTables"),pinNoticeRowSurface:Jo});({beautifyNoticeTables:Qo}=Qp({isNativePdfIsolationActive:de,bindNoticeHoverScrub:os,scrubNoticeInlineBg:Vo,stripMistakenNoticeTable:Yo,disarmNoticeTableHover:rs,pinNoticeRowSurface:Jo,isBusinessDataTable:za,isNoticeListTable:as,isNoticePageContext:Pa,isNoticeBulletText:mo}));let{wrapTables:Ko,bindTableWrapObserver:Zo}=Rp({isNativePdfIsolationActive:de,isBusinessDataTable:za});function dr(){try{document.querySelectorAll(".modal").forEach(e=>{if(!e||!e.style)return;e.style.getPropertyPriority("display")==="important"&&e.style.removeProperty("display"),e.classList.contains("in")||e.classList.contains("show")?e.style.display==="none"&&e.style.removeProperty("display"):(e.style.display==="block"||getComputedStyle(e).display!=="none")&&(e.style.setProperty("display","none","important"),setTimeout(()=>{try{!e.classList.contains("in")&&!e.classList.contains("show")&&(e.style.getPropertyPriority("display")==="important"&&e.style.removeProperty("display"),e.style.display="none")}catch{}},0))}),document.querySelector(".modal.in, .modal.show")||(document.querySelectorAll(".modal-backdrop").forEach(e=>{try{e.parentElement&&e.parentElement.removeChild(e)}catch{}}),document.body&&(document.body.classList.remove("modal-open"),document.body.style.removeProperty("padding-right")))}catch{}}a(dr,"cleanupStuckModals");function ns(){if(window.__urpppModalOpenPatched)return;window.__urpppModalOpenPatched=!0;let t=a(s=>{!s||!s.style||(s.style.getPropertyPriority("display")==="important"&&s.style.removeProperty("display"),s.style.getPropertyPriority("opacity")==="important"&&s.style.removeProperty("opacity"),s.style.getPropertyPriority("pointer-events")==="important"&&s.style.removeProperty("pointer-events"),s.style.getPropertyPriority("visibility")==="important"&&s.style.removeProperty("visibility"))},"unlock"),e=a(s=>{if(!(!s||!s.classList))try{s.classList.remove("in","show"),s.setAttribute("aria-hidden","true"),s.style.removeProperty("display"),s.style.setProperty("display","none","important"),setTimeout(()=>{try{!s.classList.contains("in")&&!s.classList.contains("show")&&(s.style.getPropertyPriority("display")==="important"&&s.style.removeProperty("display"),s.style.display="none")}catch{}},30)}catch{}},"forceHide"),r=a(()=>{document.querySelectorAll(".modal-backdrop").forEach(s=>{try{s.parentElement&&s.parentElement.removeChild(s)}catch{}}),document.body&&(document.body.classList.remove("modal-open"),document.body.style.removeProperty("padding-right"),document.body.style.removeProperty("overflow"))},"clearBackdrops"),o=a(s=>{if(s){if(s.classList&&s.classList.contains("modal-backdrop")&&(s=document.querySelector(".modal.in, .modal.show")||s),!s||!s.classList||!s.classList.contains("modal")){r();return}t(s),e(s),r();try{let l=typeof Ir=="function"&&Ir()||typeof unsafeWindow<"u"&&(unsafeWindow.jQuery||unsafeWindow.$)||window.jQuery||window.$;if(l&&l.fn&&typeof l.fn.modal=="function"){try{l(s).trigger("hide.bs.modal")}catch{}try{l(s).modal("hide")}catch{}try{l(s).trigger("hidden.bs.modal")}catch{}}}catch{}setTimeout(()=>{e(s),document.querySelector(".modal.in, .modal.show")||r();try{dr()}catch{}},0)}},"hideModalEl");document.addEventListener("show.bs.modal",s=>{let l=s.target;if(!(!l||!l.classList||!l.classList.contains("modal"))){t(l),l.style.display==="none"&&l.style.removeProperty("display");try{l.getAttribute("data-backdrop")==="static"&&l.setAttribute("data-backdrop","true"),l.dataset&&(l.dataset.backdrop="true")}catch{}}},!0),document.addEventListener("hide.bs.modal",s=>{let l=s.target;!l||!l.classList||!l.classList.contains("modal")||t(l)},!0),document.addEventListener("hidden.bs.modal",s=>{let l=s.target;!l||!l.classList||!l.classList.contains("modal")||(e(l),document.querySelector(".modal.in, .modal.show")||(document.querySelectorAll(".modal-backdrop").forEach(m=>{try{m.parentElement&&m.parentElement.removeChild(m)}catch{}}),document.body&&(document.body.classList.remove("modal-open"),document.body.style.removeProperty("padding-right"))))},!0);let i=a(s=>{let l=s.target;if(!l||!l.closest||l.closest(".modal-dialog, .modal-content, .modal-header, .modal-body, .modal-footer")&&!l.closest('[data-dismiss="modal"], .modal .close, .modal [aria-label="Close"]'))return;if(l.classList&&l.classList.contains("modal-backdrop")){let M=document.querySelector(".modal.in, .modal.show")||document.querySelector('.modal[style*="display: block"], .modal[style*="display:block"]');M?(s.preventDefault(),s.stopPropagation(),o(M)):(s.preventDefault(),r(),dr());return}let m=null;if(l.classList&&l.classList.contains("modal")?m=l:m=l.closest(".modal.in, .modal.show, .modal"),!m||!m.classList.contains("modal")||!(m.classList.contains("in")||m.classList.contains("show")||getComputedStyle(m).display!=="none"))return;let v=m.querySelector(".modal-dialog");if(v){let M=v.getBoundingClientRect(),N=s.clientX,z=s.clientY;if(N>=M.left&&N<=M.right&&z>=M.top&&z<=M.bottom&&!l.closest('[data-dismiss="modal"], .modal .close, .modal [aria-label="Close"]'))return}else if(l.closest(".modal-content"))return;s.preventDefault(),s.stopPropagation(),o(m)},"onBlankClose");document.addEventListener("pointerdown",i,!0),document.addEventListener("mousedown",i,!0),document.addEventListener("click",i,!0),document.addEventListener("click",s=>{let l=s.target&&s.target.closest?s.target.closest('[data-dismiss="modal"], .modal .close, .modal [aria-label="Close"]'):null;if(!l)return;let m=l.closest(".modal");m&&(s.preventDefault(),s.stopPropagation(),o(m)),setTimeout(()=>{try{dr()}catch{}},50),setTimeout(()=>{try{dr()}catch{}},220)},!0),document.addEventListener("click",s=>{let l=s.target&&s.target.closest?s.target.closest("a,button,td,span,div,i"):null;if(!l)return;["curriculumInfo-divcon","curriculumInfo-divcon1","curriculumInfo-divcon2","calssInfo-divcon","classroomInfo-divcon","billContainer"].forEach(h=>{let v=document.getElementById(h);v&&(t(v),v.style.opacity==="0"&&v.style.removeProperty("opacity"),v.style.pointerEvents==="none"&&v.style.removeProperty("pointer-events"))}),document.querySelectorAll(".modal").forEach(h=>t(h));let m=l.getAttribute&&(l.getAttribute("data-target")||l.getAttribute("href")||"");if(m&&m.charAt(0)==="#"){let h=document.querySelector(m);h&&t(h)}},!0)}a(ns,"patchModalOpenPath");let He=null,La=0;function qa(){if(de())return;let t=document.getElementById("courseTable");t&&t.querySelectorAll("td").forEach(e=>{let r=e.style.backgroundColor;if(!r||!r.includes("rgba"))return;let o=r.match(/rgba\((\d+),\s*(\d+),\s*(\d+),\s*[\d.]+\)/);o&&(e.style.backgroundColor=`rgba(${o[1]},${o[2]},${o[3]},0.5)`)})}a(qa,"applyCourseTableOpacity");function tn(){let t=document.getElementById("mycoursetable")||document.getElementById("courseTable");if(He&&He.root===t&&t?.isConnected){qa();return}if(clearTimeout(La),He&&He.observer.disconnect(),He=null,!t)return;let e=new MutationObserver(()=>{clearTimeout(La),La=setTimeout(qa,60)});e.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style"]}),He={root:t,observer:e},qa()}a(tn,"bindCourseTableOpacityObserver");function ps(){try{let z=Jt();document.documentElement.dataset.urpppTheme=z,document.documentElement.classList.remove("urppp-theme-default","urppp-theme-dark","urppp-theme-scu-red"),document.documentElement.classList.add("urppp-theme-"+z),document.body&&(document.body.dataset.urpppTheme=z,document.body.classList.toggle("urppp-dark",z==="dark"))}catch{}let t=document.getElementById("urppp-internal-style");t||(t=document.createElement("style"),t.id="urppp-internal-style",document.head.appendChild(t));{let z=t;z.textContent=ai}let e=document.getElementById("urppp-table-beautify-style");e||(e=document.createElement("style"),e.id="urppp-table-beautify-style",document.head.appendChild(e)),e.textContent=ii;let r=document.getElementById("urppp-navigation-style");r||(r=document.createElement("style"),r.id="urppp-navigation-style",document.head.appendChild(r)),r.textContent=si;let o=document.getElementById("urppp-dashboard-style");o||(o=document.createElement("style"),o.id="urppp-dashboard-style",document.head.appendChild(o)),o.textContent=ci;let i=document.getElementById("urppp-schedule-card-style");i||(i=document.createElement("style"),i.id="urppp-schedule-card-style",document.head.appendChild(i)),i.textContent=oi;let s=document.getElementById("urppp-mobile-style");s||(s=document.createElement("style"),s.id="urppp-mobile-style",document.head.appendChild(s)),s.textContent=ui;try{ee()}catch{}dr(),ns(),["curriculumInfo-divcon","curriculumInfo-divcon1","curriculumInfo-divcon2","calssInfo-divcon","classroomInfo-divcon"].forEach(z=>{let D=document.getElementById(z);!D||!D.style||(["display","opacity","pointer-events","visibility"].forEach(J=>{D.style.getPropertyPriority(J)==="important"&&D.style.removeProperty(J)}),D.style.opacity==="0"&&D.style.removeProperty("opacity"),D.style.pointerEvents==="none"&&D.style.removeProperty("pointer-events"))}),document.querySelectorAll(".modal").forEach(z=>{z.style&&z.style.getPropertyPriority("display")==="important"&&z.style.removeProperty("display")}),Ko(),Xo(),Go(),setTimeout(()=>document.querySelectorAll("table").forEach(z=>{za(z)&&Yo(z)}),500),Uo(),cr(),ts(),Wo(),Zo();let l=document.querySelector(".page-content");l&&l.querySelectorAll(".widget-box").length>=4&&setTimeout($s,500),Sn(),Ce(),h();function h(){let z="(max-width: 640px)",D=a(()=>!!(window.matchMedia&&window.matchMedia(z).matches),"isNarrow"),J=a((W,pt)=>{if(!(!W||!document.body)){if(pt){Object.hasOwn(W.dataset,"urpppDesktopSidebarMin")||(W.dataset.urpppDesktopSidebarMin=W.classList.contains("menu-min")?"1":"0",W.dataset.urpppDesktopBodyMin=document.body.classList.contains("menu-min")?"1":"0"),W.classList.remove("menu-min"),document.body.classList.remove("menu-min");return}Object.hasOwn(W.dataset,"urpppDesktopSidebarMin")&&(W.classList.toggle("menu-min",W.dataset.urpppDesktopSidebarMin==="1"),document.body.classList.toggle("menu-min",W.dataset.urpppDesktopBodyMin==="1"),delete W.dataset.urpppDesktopSidebarMin,delete W.dataset.urpppDesktopBodyMin)}},"syncMobileSidebarMode"),j=new WeakMap,R=a(W=>{let pt=j.get(W);pt&&cancelAnimationFrame(pt),j.delete(W)},"stopDrawerAnimation"),F=a((W,pt)=>{R(W);let lt=W.getBoundingClientRect(),xt=Math.max(lt.width,W.offsetWidth||0,260),ft=Math.max(-xt,Math.min(0,lt.left)),St=pt?0:-xt,Tt=Math.abs(St-ft),jt=Math.max(140,Math.round(260*Tt/xt)),ce=performance.now(),Rt=W.classList.contains("urppp-clean-sidebar"),oe=Rt?"12030":"1200",Nt=Rt?"12030":"1030";W.style.setProperty("display","block","important"),W.style.setProperty("transition","none","important"),W.style.setProperty("visibility","visible","important"),W.style.setProperty("pointer-events",pt?"auto":"none","important"),W.style.setProperty("z-index",oe,"important"),W.style.setProperty("transform",`translate3d(${ft}px, 0, 0)`,"important"),W.classList.toggle("urppp-drawer-closing",!pt),W.classList.add("display");let At=a(()=>{W.style.setProperty("transform",`translate3d(${St}px, 0, 0)`,"important"),pt?(W.classList.remove("urppp-drawer-closing"),W.style.setProperty("pointer-events","auto","important")):(W.classList.remove("display","urppp-drawer-closing"),W.style.setProperty("visibility","hidden","important"),W.style.setProperty("z-index",Nt,"important")),j.delete(W)},"finish");if(Tt<1){At();return}let xe=a($t=>{if(!W.isConnected){j.delete(W);return}let Ut=Math.min(1,($t-ce)/jt),lp=Ut<.5?4*Ut*Ut*Ut:1-Math.pow(-2*Ut+2,3)/2,Qr=ft+(St-ft)*lp;if(W.style.setProperty("transform",`translate3d(${Qr}px, 0, 0)`,"important"),Ut>=1){At();return}j.set(W,requestAnimationFrame(xe))},"step");j.set(W,requestAnimationFrame(xe))},"animateDrawer"),K=a((W,pt,lt)=>{if(W){F(W,lt),pt&&(pt.setAttribute("aria-expanded",lt?"true":"false"),pt.setAttribute("aria-label",lt?"关闭菜单":"打开菜单"));try{We()}catch{}}},"setDrawerOpen"),ut=a(()=>{K(document.getElementById("sidebar"),document.getElementById("urppp-mobile-menu-button"),!1)},"closeDrawer"),vt=a(()=>{let pt=document.getElementById("urppp-mobile-search-panel")?.querySelector("#form-search");if(!pt)return;Object.entries({position:"relative",right:"auto",top:"auto",left:"auto",transform:"none",width:"100%","min-width":"0","max-width":"none",height:"36px",opacity:"1",margin:"0",overflow:"visible","z-index":"1"}).forEach(([xt,ft])=>pt.style.setProperty(xt,ft,"important")),[pt.querySelector("form"),pt.querySelector(".input-icon")].forEach(xt=>{xt&&Object.entries({display:"block",position:"relative",width:"100%","min-width":"0","max-width":"none",height:"36px",margin:"0",padding:"0","box-sizing":"border-box"}).forEach(([ft,St])=>xt.style.setProperty(ft,St,"important"))});let lt=pt.querySelector("#search-input");lt&&(lt.style.setProperty("display","block","important"),lt.style.setProperty("width","100%","important"),lt.style.setProperty("min-width","0","important"),lt.style.setProperty("max-width","none","important"),lt.style.setProperty("height","36px","important"),lt.style.setProperty("box-sizing","border-box","important"))},"syncMobileSearchLayout"),Et=a(()=>{let W=document.getElementById("form-search");if(!W||!W.__urpppMobileParent)return;let pt=W.__urpppMobileParent,lt=W.__urpppMobileNext;pt.isConnected&&(lt&&lt.parentElement===pt?pt.insertBefore(W,lt):pt.appendChild(W)),W.classList.remove("urppp-mobile-form-search"),W.dataset.open="0",W.removeAttribute("style"),delete W.__urpppMobileParent,delete W.__urpppMobileNext;try{dt()}catch{}},"restoreMobileSearch"),Lt=a(()=>{let W=document.querySelector("#navbar .menu-toggler");!W||W.dataset.urpppMobileHidden!=="1"||(W.style.removeProperty("display"),W.removeAttribute("aria-hidden"),W.dataset.urpppPreviousTabindex?W.setAttribute("tabindex",W.dataset.urpppPreviousTabindex):W.removeAttribute("tabindex"),delete W.dataset.urpppPreviousTabindex,delete W.dataset.urpppMobileHidden)},"restoreNativeMenuToggler"),qt=a(()=>{let W=document.getElementById("urppp-mobile-menu-button");if(!D())return W?.remove(),Lt(),null;if(W)return W;let pt=document.getElementById("navbar"),lt=document.getElementById("sidebar");if(!pt||!lt)return null;let xt=pt.querySelector(".menu-toggler");xt&&(xt.dataset.urpppMobileHidden="1",xt.dataset.urpppPreviousTabindex=xt.getAttribute("tabindex")||"",xt.style.setProperty("display","none","important"),xt.setAttribute("aria-hidden","true"),xt.setAttribute("tabindex","-1"));let ft=document.createElement("button");ft.type="button",ft.id="urppp-mobile-menu-button",ft.className="urppp-mobile-menu-button",ft.setAttribute("aria-label","打开菜单"),ft.setAttribute("aria-expanded","false");let St=pt.querySelector(".navbar-container")||pt;return St.insertBefore(ft,St.firstChild),ft},"ensureMenuToggler"),Ot=a(W=>{!W||W.dataset.urpppIconReady||(W.dataset.urpppIconReady="1",W.innerHTML=['<span class="urppp-menu-icon" aria-hidden="true">','<svg class="urppp-menu-icon-open" viewBox="0 0 24 24" focusable="false">','<path d="M5 8h14"></path><path d="M5 16h10"></path>',"</svg>",'<svg class="urppp-menu-icon-close" viewBox="0 0 24 24" focusable="false">','<path d="M7 7l10 10"></path><path d="M17 7 7 17"></path>',"</svg>","</span>"].join(""))},"ensureMenuButtonIcon"),Ht=a(()=>{let W=qt(),pt=document.getElementById("sidebar");W&&Ot(W),W&&pt&&!W.__urpppToggleHandler&&(W.setAttribute("aria-label","打开菜单"),W.setAttribute("aria-expanded",pt.classList.contains("display")?"true":"false"),W.__urpppToggleHandler=lt=>{lt.preventDefault(),lt.stopImmediatePropagation(),D()&&J(pt,!0);let xt=W.getAttribute("aria-expanded")!=="true";K(pt,W,xt)},W.addEventListener("click",W.__urpppToggleHandler,!0)),document.__urpppMobileDrawerOutsideBound||(document.__urpppMobileDrawerOutsideBound=!0,document.addEventListener("click",lt=>{if(!D()||!lt.target.closest)return;let xt=document.getElementById("sidebar");if(!xt||!xt.classList.contains("display"))return;let ft=document.getElementById("urppp-clean-root");ft&&ft.classList.contains("open")||lt.target.closest("#sidebar, #urppp-mobile-menu-button")||ut()},!0)),document.__urpppMobileRouteCloseBound||(document.__urpppMobileRouteCloseBound=!0,document.addEventListener("click",lt=>{if(!D()||!lt.target.closest)return;let xt=document.getElementById("urppp-clean-root");if(xt&&xt.classList.contains("open"))return;let ft=lt.target.closest("#sidebar a[href]");if(!ft)return;let St=String(ft.getAttribute("href")||"").trim();!St||St==="#"||St.startsWith("javascript")||ut()}))},"bindDrawerControls"),Mt=a((W,pt)=>{let lt=W?W.cloneNode(!0):document.createElement("a");return lt.className="urppp-mobile-user-action",lt.removeAttribute("style"),lt.removeAttribute("id"),!W&&pt&&(lt.href=pt.href,pt.onclick&&lt.setAttribute("onclick",pt.onclick),lt.innerHTML='<i class="ace-icon fa '+pt.icon+'" aria-hidden="true"></i><span>'+pt.label+"</span>"),lt},"createActionLink"),ae=a((W,pt)=>{if(document.getElementById("urppp-mobile-user"))return;let lt=W.querySelector(":scope > li.light-blue")||Array.from(W.children).find(Ut=>Ut.querySelector&&Ut.querySelector(".nav-user-photo, .user-menu, .dropdown-menu")),xt=document.createElement("section");xt.id="urppp-mobile-user",xt.className="urppp-mobile-user";let ft=document.createElement("div");ft.className="urppp-mobile-user-identity";let St=lt?.querySelector(".nav-user-photo")||document.querySelector("#navbar .nav-user-photo"),Tt=St?St.cloneNode(!0):document.createElement("img");Tt.className="nav-user-photo",Tt.removeAttribute("style"),Tt.getAttribute("src")||Tt.setAttribute("src","/main/queryStudent/img"),Tt.setAttribute("data-urppp-private","avatar"),Tt.alt=St?.alt?.replace(/\s+/g," ").trim()||"用户头像";let jt=lt?.querySelector(".user-info")||document.querySelector("#navbar .user-info"),ce=document.createElement("span");ce.className="urppp-mobile-user-copy";let Rt=document.createElement("small");Rt.className="urppp-mobile-user-welcome",Rt.textContent="欢迎您，";let oe=document.createElement("span");oe.className="user-info urppp-user-name-value",oe.setAttribute("data-urppp-private","name"),oe.textContent=jt?.textContent?.replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim()||St?.alt?.replace(/\s+/g," ").trim()||"我的账户",ce.append(Rt,oe),ft.append(Tt,ce),xt.appendChild(ft);let Nt=document.createElement("div");Nt.className="urppp-mobile-user-actions";let At=lt?Array.from(lt.querySelectorAll(".user-menu a, .dropdown-menu a")):[],xe=[{label:"首页",href:"/",icon:"fa-home"},{label:"在线反馈",href:"/main/systemQuestion/index",icon:"fa-question-circle"},{label:"修改密码",href:"javascript:changePassword('/student/rollManagement/personalInfoUpdate/updatePassword')",icon:"fa-user"},{label:"注销",href:"/logout",icon:"fa-power-off"}];At.length?At.forEach(Ut=>Nt.appendChild(Mt(Ut))):xe.forEach(Ut=>Nt.appendChild(Mt(null,Ut))),xt.appendChild(Nt);let $t=pt.querySelector(".urppp-sidebar-header");$t&&$t.nextSibling?pt.insertBefore(xt,$t.nextSibling):$t?pt.appendChild(xt):pt.insertBefore(xt,pt.firstChild);try{Yt(xt)}catch{}},"ensureMobileUser"),sp=a((W,pt,lt,xt={})=>{if(!lt||document.getElementById("urppp-mobile-quick"))return;let ft=document.createElement("section");ft.id="urppp-mobile-quick",ft.className="urppp-mobile-quick",ft.innerHTML='<div class="urppp-mobile-quick-title">快捷功能</div>';let St=document.createElement("div");St.className="urppp-mobile-tool-row";let Tt=W.querySelector(':scope > li > a[href*="customerServiceCenter"]'),jt=Tt?Tt.cloneNode(!0):document.createElement("a");jt.className="urppp-mobile-tool-button urppp-mobile-help-button",jt.removeAttribute("style"),jt.removeAttribute("onclick"),jt.removeAttribute("data-toggle"),jt.removeAttribute("target"),jt.querySelectorAll("[style]").forEach(At=>At.removeAttribute("style"));let ce=String(jt.getAttribute("href")||"").trim();(!ce||ce==="#"||ce.startsWith("javascript"))&&(jt.href="/main/customerServiceCenter"),jt.querySelector("i")||(jt.innerHTML='<i class="ace-icon glyphicon glyphicon-headphones" aria-hidden="true"></i>'),jt.querySelectorAll("span").forEach(At=>At.remove()),jt.insertAdjacentHTML("beforeend","<span>帮助</span>"),St.appendChild(jt);let Rt=document.createElement("button");Rt.type="button",Rt.id="urppp-mobile-search-button",Rt.className="urppp-mobile-tool-button",Rt.setAttribute("aria-expanded","false"),Rt.innerHTML='<i class="ace-icon fa fa-search" aria-hidden="true"></i><span>搜索</span>',St.appendChild(Rt),ft.appendChild(St);let oe=document.createElement("div");oe.className="urppp-mobile-quick-links",Array.from(W.querySelectorAll(":scope > li > a")).forEach(At=>{let xe=At.closest("li");if(xe?.classList.contains("light-blue")||xe?.querySelector("#intellegenceUDiv, #form-search")||At===Tt||At.classList.contains("dropdown-toggle")||!At.getAttribute("href")&&!At.getAttribute("onclick"))return;let $t=At.cloneNode(!0);$t.className="urppp-mobile-quick-link",$t.removeAttribute("style");let Ut=String(At.getAttribute("onclick")||"");if(/openWorkRestSchedule|open\w*Schedule/i.test(Ut)||$t.removeAttribute("onclick"),xt.cleanMode){let Qr=String(At.getAttribute("href")||"");(Qr==="/holiday"||/holiday/i.test(Qr)||/假期/.test(At.textContent||""))&&($t.removeAttribute("href"),$t.removeAttribute("target"),$t.style.cursor="default",$t.style.pointerEvents="none")}oe.appendChild($t)});let Nt=document.createElement("div");Nt.id="urppp-mobile-search-panel",Nt.className="urppp-mobile-search-panel",Nt.hidden=!0;{let At=document.getElementById("form-search");At&&(At.__urpppMobileParent||(At.__urpppMobileParent=At.parentElement,At.__urpppMobileNext=At.nextSibling),At.classList.add("urppp-mobile-form-search"),At.dataset.open="0",Nt.appendChild(At),vt())}ft.appendChild(Nt),oe.children.length&&ft.appendChild(oe),Rt.addEventListener("click",At=>{if(At.preventDefault(),At.stopPropagation(),Nt.hidden){vt();let $t=Nt.querySelector("#form-search");$t&&($t.dataset.open="0",$t.style.setProperty("pointer-events","auto","important"),$t.style.setProperty("opacity","1","important"),$t.style.setProperty("width","100%","important"),$t.style.setProperty("min-width","0","important")),Nt.hidden=!1,Nt.classList.add("open"),setTimeout(()=>Nt.querySelector("#search-input")?.focus(),30),Rt.setAttribute("aria-expanded","true")}else Nt.hidden=!0,Nt.classList.remove("open"),Rt.setAttribute("aria-expanded","false")}),pt.insertBefore(ft,lt)},"ensureMobileQuick"),Te=a(()=>{let W=D(),pt=document.querySelector("#navbar .navbar-buttons .ace-nav"),lt=document.getElementById("sidebar"),xt=document.getElementById("urppp-menus");if(lt&&J(lt,W),Ht(),!W){let ft=document.documentElement.classList.contains("urppp-clean-open");ft||Et(),ft||(document.getElementById("urppp-mobile-quick")?.remove(),document.getElementById("urppp-mobile-user")?.remove());let St=document.getElementById("urppp-nav-clean"),Tt=document.getElementById("urppp-nav-theme");St&&Tt&&St.parentElement!==Tt&&Tt.appendChild(St),Tt&&Tt.style.setProperty("display","inline-flex","important");return}if(!(!pt||!lt)){try{let ft=document.getElementById("urppp-nav-clean"),St=document.querySelector("#navbar .navbar-header"),Tt=document.getElementById("urppp-nav-theme");ft&&St&&ft.parentElement!==St&&St.appendChild(ft),Tt&&Tt.style.setProperty("display","inline-flex","important"),document.getElementById("urppp-nav-cal")?.remove()}catch{}ae(pt,lt),sp(pt,lt,xt),vt()}},"apply");window.__urpppRefreshMobileNavbar=Te,window.__urpppCloseMobileDrawer=ut,window.__urpppSetDrawerOpen=(W,pt,lt)=>{K(W,pt,lt)},window.__urpppStopDrawerAnimation=W=>{W&&R(W)},window.__urpppInjectCleanSidebarSections=W=>{let pt=document.querySelector("#navbar .navbar-buttons .ace-nav")||document.querySelector("#navbar .ace-nav"),lt=document.getElementById("urppp-menus");if(!pt||!W)return;try{ae(pt,W)}catch{}let xt=document.getElementById("urppp-mobile-quick");if(xt){let ft=xt.querySelector("#urppp-mobile-search-panel");if(ft&&ft.querySelector("#form-search"))try{Et()}catch{}xt.remove()}try{sp(pt,W,lt,{cleanMode:!0})}catch{}};try{Te()}catch{}if(setTimeout(Te,300),setTimeout(Te,900),setTimeout(Te,1800),window.matchMedia){let W=window.matchMedia(z),pt=a(()=>Te(),"onChange");typeof W.addEventListener=="function"?W.addEventListener("change",pt):typeof W.addListener=="function"&&W.addListener(pt)}try{window.__urpppMobileNavbarObserver&&window.__urpppMobileNavbarObserver.disconnect();let W=0,pt=new MutationObserver(()=>{clearTimeout(W),W=setTimeout(()=>{try{Te()}catch{}},40)}),lt=document.getElementById("navbar"),xt=document.getElementById("sidebar");lt&&pt.observe(lt,{childList:!0,subtree:!0}),xt&&pt.observe(xt,{childList:!0}),window.__urpppMobileNavbarObserver=pt}catch{}}a(h,"setupMobileNavbar");let M=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches)?"8px 8px 24px":"16px 64px 40px";if(document.querySelectorAll(".page-content, #page-content-template").forEach(z=>{z.style.setProperty("padding",M,"important"),z.style.setProperty("box-sizing","border-box","important")}),$r(),wa(),Br(),je(),Sa(),setTimeout(()=>{je(),Sa()},300),setTimeout(()=>{je(),Sa()},1e3),jo(),Do(),Fo(),be(),Aa(),sr(),Oo(),setTimeout(()=>{be(),sr()},200),setTimeout(()=>{be(),sr()},800),setTimeout(wa,350),setTimeout(wa,1e3),lr(),setTimeout(()=>lr(),400),!window.__urpppPlanTreeObs){let z=0;window.__urpppPlanTreeObs=new MutationObserver(()=>{let J=document.getElementById("treeDemo");!J||J.dataset.urpppBusy==="1"||J.querySelector('li > a:not([data-urppp-node-done="1"])')&&(clearTimeout(z),z=setTimeout(()=>lr(),220))});let D=document.getElementById("tree_div")||document.getElementById("treeDemo");D&&window.__urpppPlanTreeObs.observe(D,{childList:!0,subtree:!0})}window.__urpppWrsBound||(window.__urpppWrsBound=!0,document.addEventListener("shown.bs.modal",z=>{z.target&&(z.target.id==="work_rest_schedule_modal"||z.target.querySelector?.("#work_rest_schedule_modal"))&&setTimeout(_a,30)},!0),document.addEventListener("click",z=>{let D=z.target&&z.target.closest?z.target.closest("a,button"):null;if(!D)return;let J=D.getAttribute("onclick")||"",j=(D.textContent||"").trim();(J.includes("openWorkRestSchedule")||j.includes("作息时间表"))&&(setTimeout(_a,80),setTimeout(_a,300))},!0)),Mr(),st(),dt(),Ea();let N=a(()=>{$r(),Br(),Mr()},"layoutWave");setTimeout(N,200),setTimeout(N,800),window.__urpppLoadBound||(window.__urpppLoadBound=!0,window.addEventListener("load",()=>{st(),dt(),rt(),Ea(),Mr(),$r(),Br()})),setTimeout(()=>{document.body.classList.add("urppp-ready"),wt()},600),console.log("[URP++] style applied apple-leaning");try{bindScheduleHoverNearCursor()}catch{}tn()}a(ps,"beautifyInternal");function is(t){if(!t)return;let e=t.querySelector("#urppp-set-brutal-palettes");if(!e)return;let r=Lo();e.innerHTML="",Q.filter(o=>o.id!==V).forEach(o=>{let i=document.createElement("button");i.type="button",i.className="urppp-set-scheme"+(o.id===r.id?" ac":""),i.dataset.palette=o.id,i.innerHTML=['<div class="urppp-set-scheme-preview">','  <span style="background:#000"></span>','  <span style="background:'+o.accent+'"></span>','  <span style="background:'+o.secondary+'"></span>',"</div>",'<div class="urppp-set-scheme-meta">',"  <strong>"+o.name+"</strong>","  <em>"+o.desc+"</em>","</div>"].join(""),i.addEventListener("click",()=>To(o.id,{select:!0})),e.appendChild(i)})}a(is,"renderBrutalPaletteCards");let Fr=Fp({getPrivacySettings:ke,setPrivacySettings:fa,getCustomIdentity:Ne,setCustomIdentity:Ao,applyDisplay:a(()=>Yt(document),"applyDisplay"),refreshCleanDisplay:Va,finishActiveDirectEdit:a(t=>{ge?.__finish&&ge.__finish(t)},"finishActiveDirectEdit")}),ss=Fr.sync,Fc=Fr.collect,Dc=Fr.setStatus,ls=Fr.bind,Ta=Np({document,getSettings:qr,setSettings:_o,validateMapping:Me,defaultMapping:Ar,getRecoveryMessage:a(()=>et,"getRecoveryMessage")}),jc=Ta.setStatus,cs=Ta.sync,ds=Ta.bind;function Dt(){let t=document.getElementById("urppp-settings-panel");if(!t)return;let e=Qt()||mt,r=Ie(),o=Jt(),i=Xt(),s=Zt(),l=Be(s),m=Fe(s),h=zo(s),v={};t.querySelectorAll(".urppp-set-mode").forEach(z=>{v[z.dataset.theme]=pr(z.dataset.theme,s)}),jp(t,{seed:e,currentTheme:o,followSystem:i,skinId:s,darkSupported:l,dynamicSupported:m,fixedPalettes:h,followUseDynamic:Tr(),cleanDefault:ma(),cleanAnalysis:ha()?"direct":"tab",appleEdge:we(),autoUpdate:ba(),modeAvailability:v}),h&&is(t);try{ss(t)}catch{}try{cs(t)}catch{}try{window.__urpppCleanMode&&typeof window.__urpppCleanMode.refreshRender=="function"&&window.__urpppCleanMode.refreshRender()}catch{}let M=t.querySelector("#urppp-set-presets");M&&(M.innerHTML="",ua().forEach(z=>{let D=document.createElement("button");D.type="button",D.className="urppp-set-swatch"+(z.toLowerCase()===e.toLowerCase()?" ac":""),D.title=z,D.style.background=z,D.addEventListener("click",()=>{GM_setValue(T,z),Xt()?Wt(me(),{system:!0}):Wt("scu-red",{manual:!0}),Dt()}),M.appendChild(D)}));let N=t.querySelector("#urppp-set-schemes");N&&(N.innerHTML="",$e(e).forEach(z=>{let D=document.createElement("button");D.type="button",D.className="urppp-set-scheme"+(z.id===r?" ac":""),D.dataset.scheme=z.id,D.innerHTML=['<div class="urppp-set-scheme-preview">','  <span style="background:'+z.bg+'"></span>','  <span style="background:'+z.surface+";border-color:"+z.border+'"></span>','  <span style="background:'+z.primary+'"></span>',"</div>",'<div class="urppp-set-scheme-meta">',"  <strong>"+z.name+"</strong>","  <em>"+z.desc+"</em>","</div>"].join(""),D.addEventListener("click",()=>{da(z.id),GM_setValue(T,e),Xt()?Wt(me(),{system:!0}):Wt("scu-red",{manual:!0}),Dt()}),N.appendChild(D)}));try{_s(t)}catch(z){try{console.warn("[URP++] renderSkinCards",z)}catch{}}try{let z=t.querySelector(".urppp-about-ver, #urppp-about-ver");z&&(z.textContent="SCU URP++ v"+p,z.tagName==="A"&&(z.setAttribute("href",n.repo),z.setAttribute("target","_blank"),z.setAttribute("rel","noopener noreferrer")))}catch{}try{on(t)}catch{}}a(Dt,"syncSettingsPanelUI");let en=$p({document,ensurePanel:nn,syncPanel:Dt,refreshUpdateStatus:An}),us=Dp({document,theme:{isModeAvailable:pr,apply:Wt,supportsDark:Be,supportsDynamic:Fe,getFollowSystem:Xt,setFollowSystem:Pr,resolveFollowTheme:me,getCurrent:Jt,getFollowDynamic:Tr,setFollowDynamic:xa,syncNavbar:gt},preferences:{getCleanDefault:ma,setCleanDefault:Hi,getCleanAnalysis:a(()=>ha()?"direct":"tab","getCleanAnalysis"),setCleanAnalysis:Ri,getAppleEdge:we,setAppleEdge:Ui,applySkin:ee,getAutoUpdate:ba,setAutoUpdate:Wi,checkUpdates:Ra},accent:{normalize:Gt,setAccent:a(t=>GM_setValue(T,t),"setAccent"),savePreset:Oi,getScheme:Ie,setScheme:da,listSchemePreviews:$e},syncPanel:Dt}),_t=co({GM:{getValue:typeof GM_getValue=="function"?GM_getValue:null,setValue:typeof GM_setValue=="function"?GM_setValue:null,xmlHttp:typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest:null,addStyle:typeof GM_addStyle=="function"?GM_addStyle:null},doc:document,hostInfo:{version:p},uiDeps:{openSubpanel:a(t=>{t==="plugin-store"&&Ma("plugin")},"openSubpanel")}});a((function(){let e=a(()=>{try{_t.bootFromCache("assist")}catch{}},"run");document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}),"bootstrapPlugins")();function rn(){return en.open()}a(rn,"openSettingsPanel");function an(){en.close()}a(an,"closeSettingsPanel");let Dr="data:image/png;base64,";function on(t){let e=t&&t.querySelector?t.querySelector("#urppp-about-logo"):document.getElementById("urppp-about-logo");e&&(e.getAttribute("src")!==Dr&&e.setAttribute("src",Dr),e.removeAttribute("referrerpolicy"),e.alt="SCU URP++",e.style.maxWidth="100%",e.style.height="auto",e.style.display="block")}a(on,"ensureAboutLogo");function nn(){if(document.getElementById("urppp-settings-panel"))return;Bs();try{ee()}catch{}try{_e&&_e.length&&Se(_e)}catch{}let t=document.createElement("div");t.id="urppp-settings-mask",t.addEventListener("click",an);let e=document.createElement("div");e.id="urppp-settings-panel",e.setAttribute("role","dialog"),e.setAttribute("aria-label","URP++ 设置");let r=Dr;e.innerHTML=Ip({logoData:Dr,repositoryUrl:n.repo,version:p}),document.documentElement.appendChild(t),document.documentElement.appendChild(e),Mp(e),e.querySelector("#urppp-set-close").addEventListener("click",an);try{ls(e)}catch(i){console.warn("[URP++] privacy settings",i)}try{ds(e)}catch(i){console.warn("[URP++] JSON settings",i)}try{on(e)}catch{}let o=e.querySelector("#urppp-about-logo");o&&!o.__urpppFallback&&(o.__urpppFallback=!0,o.addEventListener("error",()=>{o.dataset.fallback!=="1"&&(o.dataset.fallback="1",o.src=r)})),us.bind(e);try{_t.renderAssistUi(e.querySelector("#urppp-set-assist-slot"))}catch(i){console.warn("[URP++] plugin manager",i)}}a(nn,"ensureSettingsPanel");function Ma(t){let e=document.getElementById("urppp-settings-panel");if(!e)return;let r=document.getElementById("urppp-store-subpanel");r||(r=document.createElement("div"),r.id="urppp-store-subpanel",r.className="urppp-store-subpanel",r.innerHTML=`
        ...
        <div class="urppp-store-sub-body" id="urppp-store-sub-body"></div>`,e.appendChild(r),r.querySelector("#urppp-store-sub-back").onclick=ms);let o=r.querySelector("#urppp-store-sub-title"),i=r.querySelector("#urppp-store-sub-body");o.textContent=t==="theme"?"主题商店":"插件商店",i.innerHTML="",t==="theme"?vs(i):xn(i),r.classList.add("open")}a(Ma,"openStoreSubPanel");function ms(){let t=document.getElementById("urppp-store-subpanel");if(!t)return;t.classList.remove("open");let e=t.querySelector("#urppp-store-sub-body");e&&(e.innerHTML="")}a(ms,"closeStoreSubPanel");function pn(t){t.querySelectorAll(".urppp-store-tab").forEach(e=>{e.addEventListener("click",()=>{t.querySelectorAll(".urppp-store-tab").forEach(o=>o.className="urppp-store-tab"),e.className="urppp-store-tab ac",t.querySelectorAll(".urppp-store-pane").forEach(o=>o.style.display="none");let r=t.querySelector('.urppp-store-pane[data-pane="'+e.dataset.tab+'"]');r&&(r.style.display="")})})}a(pn,"bindStoreTabs");function Se(t){Array.isArray(t)&&t.forEach(e=>{if(!e||!e.id)return;let r="";try{r=GM_getValue("urppp_card_css_"+e.id,"")||""}catch{}let o=r||e.cardCss||"";if(!o)return;let i=document.getElementById("urppp-store-card-css-"+e.id);i||(i=document.createElement("style"),i.id="urppp-store-card-css-"+e.id,(document.head||document.documentElement).appendChild(i)),i.textContent!==o&&(i.textContent=o)})}a(Se,"ensureStoreCardStyles");function hs(t,e){let r=(u.find(s=>s.id===t.id)||{}).repo,o=t.repo||r,i=o?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(o)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-skin="${at(t.id)}">
      ...
      ${i}
    </div>`}a(hs,"themeStoreCard");async function $a(t){let e=t.querySelector('[data-pane="download"]');if(!e)return;let r=[];try{r=(await fe()).filter(o=>o.type==="theme"&&!he(o.id))}catch{}if(!r.length){e.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载主题</p><p class="urppp-store-sub">已安装的主题不会再显示在这里。</p></div>';return}Se(r),e.innerHTML=`<div class="urppp-store-theme-grid">${r.map(o=>hs(o,!1)).join("")}</div>`,e.querySelectorAll("[data-store-theme]").forEach(o=>{o.addEventListener("click",()=>bs(o.dataset.storeTheme,o))}),e.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a($a,"fetchCatalogThemes");async function bs(t,e){if(!e||e.disabled)return;e.disabled=!0,e.textContent="下载中…";let r=(await fe()).find(l=>l.id===t);if(!r||!Array.isArray(r.entry)||!r.entry.length){e.disabled=!1,e.textContent="下载";return}let o=await dn(r);if(o==="fail"){Re("签名校验失败：该条目可能被篡改，已停止下载","error"),e.disabled=!1,e.textContent="下载";return}if(o==="unknown"&&r._srcPub&&!await cn("该源无有效签名校验，可能被篡改。是否自担风险继续下载？")){e.disabled=!1,e.textContent="下载";return}let i="";for(let l of r.entry)try{let m=await fetch(l,{cache:"no-store"});if(m.ok){i=await m.text();break}}catch{}if(!i){e.textContent="下载失败",setTimeout(()=>{e.textContent="下载",e.disabled=!1},1400);return}try{GM_setValue("urppp_theme_css_"+t,i)}catch{}if(u.some(l=>l.id===t)||Co(t,{name:r.name||t,desc:r.desc||"下载主题",author:r.author||"",version:r.version||"1.0.0"}),r.cardCss)try{GM_setValue("urppp_card_css_"+t,r.cardCss)}catch{}try{ya(t).textContent=i}catch{}try{Se([{id:t,cardCss:r.cardCss||""}])}catch{}e.textContent="已安装",e.disabled=!0;let s=e.closest&&e.closest(".urppp-store-inline");if(s){try{let l=s.querySelector("#urppp-theme-manage");l&&await jr(l)}catch{}try{$a(s)}catch{}}try{Dt()}catch{}}a(bs,"downloadStoreTheme");function fs(t,e){let o=t.installed!==!1?"":`<button type="button" class="urppp-skin-apply urppp-store-del" data-theme-del="${at(t.id)}">删除</button>`,i=e&&e.repo||t.repo,s=i?`<button type="button" class="urppp-skin-apply urppp-store-repo" data-repo="${at(i)}">仓库</button>`:"",l=e&&e.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(e.downloads))}</span>`:"",m=Zt()===t.id;return`<div class="urppp-skin-card${m?" is-active":""}" data-skin="${at(t.id)}">
      ...
      <button type="button" class="urppp-skin-apply${m?" is-current":""}" data-theme-use="${at(t.id)}"${m?" disabled":""}>${m?"使用中":"使用"}</button>
      ${o}${s}
    </div>`}a(fs,"themeManageCardHtml");async function jr(t){if(!t)return;let e=[];try{e=await fe()}catch{}let r=Ae(),o=Object.keys(r).map(s=>({id:s,name:r[s].name||s,desc:r[s].desc||"本地主题",version:r[s].version||"1.0.0",author:r[s].author||"本地",installed:!1})),i=u.filter(s=>s.installed!==!1||he(s.id)).concat(o.filter(s=>!u.some(l=>l.id===s.id)));if(!i.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无已装主题</p></div>';return}Se(i.map(s=>e.find(l=>l.id===s.id))),t.innerHTML=`<div class="urppp-store-theme-grid">${i.map(s=>fs(s,e.find(l=>l.id===s.id))).join("")}</div>`,t.querySelectorAll("[data-theme-use]").forEach(s=>s.addEventListener("click",()=>{if(Mo(s.dataset.themeUse)){try{Dt()}catch{}t.querySelectorAll(".urppp-skin-card").forEach(l=>{let m=l.dataset.skin,h=l.querySelector(".urppp-skin-apply"),v=Zt()===m;l.classList.toggle("is-active",v),h&&(h.classList.toggle("is-current",v),h.disabled=v,h.textContent=v?"使用中":"使用")})}})),t.querySelectorAll("[data-theme-del]").forEach(s=>s.addEventListener("click",()=>{let l=s.dataset.themeDel,m=Zt()===l;try{GM_setValue("urppp_theme_css_"+l,"")}catch{}try{GM_setValue("urppp_card_css_"+l,"")}catch{}Ji(l),Vi(l);try{if(m){GM_setValue(d,"apple");try{document.documentElement.removeAttribute("data-urppp-skin")}catch{}try{document.body&&document.body.removeAttribute("data-urppp-skin")}catch{}ee();let v=Xt(),M=v?me():Jt();Wt(M,{system:v})}}catch{}try{Dt()}catch{}let h=t.closest(".urppp-store-inline");if(h){try{jr(t)}catch{}try{$a(h)}catch{}}})),t.querySelectorAll("[data-repo]").forEach(s=>s.addEventListener("click",()=>{try{window.open(s.dataset.repo,"_blank","noopener")}catch{}}))}a(jr,"fetchThemeManage");function sn(){return`<div class="urppp-store-settings">
    ...
    </div>`}a(sn,"storeManageSettingsHtml");let gs=["https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json","https://cdn.jsdelivr.net/gh/chaolan2019/URP-plusplus-Repository@main/catalog.json","https://gh-proxy.com/https://raw.githubusercontent.com/chaolan2019/URP-plusplus-Repository/main/catalog.json"];function ur(){try{let t=JSON.parse(GM_getValue("urppp_store_sources","[]"));return Array.isArray(t)?t:[]}catch{return[]}}a(ur,"getCustomSources");function Ia(t){try{GM_setValue("urppp_store_sources",JSON.stringify(t))}catch{}}a(Ia,"saveCustomSources");let _e=null;async function fe(t){if(_e&&!t)return _e;let e=a((v,M)=>Promise.race([v,new Promise((N,z)=>setTimeout(()=>z(new Error("timeout")),M))]),"withTimeout"),r=a(async v=>{try{let M=await e(fetch(v,{cache:"no-store"}),5e3);if(!(M&&M.ok))return null;let N=await M.json();return N&&Array.isArray(N.items)?N:null}catch{return null}},"fetchCatalogDoc"),o=null;for(let v of gs){let M=await r(v);if(M&&(o=M,M.items.some(N=>N.type==="theme"&&N.cardCss)))break}let i=o&&o.items||[],s=ur().filter(v=>v&&v.url&&v.enabled!==!1),l=await Promise.allSettled(s.map(async v=>{let M=await r(v.url);return{doc:M,pubkey:M?M.pubkey:""}})),m=[...i],h=new Set(m.map(v=>v&&v.id).filter(Boolean));for(let v of l){if(!(v.status==="fulfilled"&&v.value&&v.value.doc))continue;let M=v.value.pubkey||"";for(let N of v.value.doc.items)!N||!N.id||h.has(N.id)||(h.add(N.id),M&&(N._srcPub=M),m.push(N))}return _e=m,m}a(fe,"fetchCatalogList");let Or=(function(){try{if(typeof crypto<"u"&&crypto&&crypto.subtle)return crypto.subtle;let t=typeof unsafeWindow<"u"&&unsafeWindow?unsafeWindow:typeof window<"u"?window:null;if(t&&t.crypto&&t.crypto.subtle)return t.crypto.subtle}catch{}return null})();function Na(t){if(Array.isArray(t))return t.map(Na);if(t&&typeof t=="object"){let e={};for(let r of Object.keys(t).filter(o=>o!=="signature"&&o!=="_srcPub").sort())e[r]=Na(t[r]);return e}return t}a(Na,"normalizeEntry");function ln(t){try{let e=atob(t),r=new Uint8Array(e.length);for(let o=0;o<e.length;o+=1)r[o]=e.charCodeAt(o);return r}catch{return null}}a(ln,"b64ToU8");async function xs(t,e){if(!Or)return null;if(!e||!t||!t.signature)return!1;try{let r=ln(e);if(!r)return null;let o=await Or.importKey("raw",r,{name:"Ed25519"},!1,["verify"]),i=ln(t.signature);if(!i)return!1;let s=JSON.stringify(Na(t)),l=await Or.digest("SHA-256",new TextEncoder().encode(s)),m=new Uint8Array(l);return await Or.verify({name:"Ed25519"},o,i,m)}catch{return null}}a(xs,"verifyEntrySignature");function Re(t,e){try{let r=document.getElementById("urppp-toast");r||(r=document.createElement("div"),r.id="urppp-toast",r.className="urppp-toast",(document.body||document.documentElement).appendChild(r)),r.textContent=t,r.className="urppp-toast show"+(e==="error"?" error":""),clearTimeout(r._t),r._t=setTimeout(()=>{r.className="urppp-toast"},3200)}catch{try{window.alert(t)}catch{}}}a(Re,"toast");function cn(t){return new Promise(e=>{try{let r=document.getElementById("urppp-confirm");r||(r=document.createElement("div"),r.id="urppp-confirm",r.className="urppp-confirm",r.innerHTML='<div class="urppp-confirm-txt"></div><div class="urppp-confirm-ops"><button type="button" class="urppp-set-btn ghost" data-cac>取消</button><button type="button" class="urppp-set-btn" data-ok>继续</button></div>',(document.body||document.documentElement).appendChild(r)),r.querySelector(".urppp-confirm-txt").textContent=t,r.classList.add("show");let o=a(i=>{r.classList.remove("show"),r.querySelector("[data-ok]").onclick=r.querySelector("[data-cac]").onclick=null,e(i)},"done");r.querySelector("[data-ok]").onclick=()=>o(!0),r.querySelector("[data-cac]").onclick=()=>o(!1)}catch{try{e(window.confirm(t))}catch{e(!1)}}})}a(cn,"confirmBottom");async function dn(t){let e=t&&t._srcPub;if(!e)return"trust";let r=await xs(t,e);return r===!0?"ok":r===!1?"fail":"unknown"}a(dn,"guardEntrySignature");function un(t,e){let r=String(t||"0").split(".").map(Number),o=String(e||"0").split(".").map(Number);for(let i=0;i<Math.max(r.length,o.length);i+=1){let s=r[i]||0,l=o[i]||0;if(s!==l)return s>l}return!1}a(un,"versionGt");function ys(t,e){let r=0;return e.forEach(o=>{if(!o.id)return;let i=t.querySelector('[data-theme-use="'+o.id+'"]');i&&un(o.version,u.find(l=>l.id===o.id)&&u.find(l=>l.id===o.id).version)&&(mn(i.closest(".urppp-skin-card"),"主题"),r+=1);let s=t.querySelector('[data-plugin-id="'+o.id+'"]');if(s){let l=_t&&_t.api&&_t.api.get&&_t.api.get(o.id);l&&un(o.version,l.version)&&(mn(s.closest(".urppp-store-item"),"插件"),r+=1)}}),r}a(ys,"applyStoreUpdateBadges");function mn(t,e){if(!t||t.querySelector(".urppp-store-update"))return;let r=t.querySelector(".urppp-store-ops");if(!r)return;let o=document.createElement("button");o.type="button",o.className="urppp-set-btn urppp-store-update",o.textContent="有新更新",o.addEventListener("click",()=>{try{o.textContent="更新中…"}catch{}}),r.appendChild(o)}a(mn,"addUpdateBadge");function hn(t){let e=t.querySelector("[data-store-auto-update]"),r=t.querySelector("[data-store-check-update]");if(!e||!r)return;let o=GM_getValue("urppp_store_auto_update",!1),i=a(()=>{e.textContent="自动检测更新："+(o?"开":"关")},"sync");i(),e.addEventListener("click",()=>{o=!o,GM_setValue("urppp_store_auto_update",o),i()}),r.addEventListener("click",async()=>{r.disabled=!0;let s=r.textContent;r.textContent="检查中…";try{let l=await fe(),m=ys(t,l);r.textContent=m?"发现更新":"已是最新"}catch{r.textContent="检查失败"}setTimeout(()=>{r.textContent=s,r.disabled=!1},1600)})}a(hn,"bindStoreManageSettings");function vs(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
        ...
        <div class="urppp-store-body">
          ...
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${sn()}<button type="button" class="urppp-set-btn ghost" data-add-local-theme style="width:100%;margin:0 0 10px">＋ 添加本地主题</button><input type="file" accept=".css,.txt" data-local-theme-file style="display:none"><div class="urppp-store-bd"><div id="urppp-theme-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div></div>
          <div class="urppp-store-pane" data-pane="sources" style="display:none">${bn()}</div>
        </div>
      </div>`,pn(t),hn(t),ws(t),fn(t),$a(t),jr(t.querySelector("#urppp-theme-manage"))}a(vs,"renderThemeStoreBody");function bn(){let t=ur();return`<div class="urppp-src-manage">
    ...
    </div>`}a(bn,"storeSourcesHtml");function fn(t){let e=t.querySelector("[data-src-add]");if(e){let r=t.querySelector("[data-src-url]"),o=t.querySelector("[data-src-name]");e.addEventListener("click",async()=>{let i=(r.value||"").trim();if(!i)return;e.disabled=!0;let s=e.textContent;e.textContent="验证中…";try{let l=await fetch(i,{cache:"no-store"});if(!(l&&l.ok))throw new Error("无法访问");let m=await l.json();if(!(m&&Array.isArray(m.items)))throw new Error("不是合法 catalog（无 items）");let h=ur();if(h.some(v=>v.url===i)){Re("该源已存在");return}h.push({name:(o.value||"").trim()||i,url:i,enabled:!0}),Ia(h),_e=null,Ba(t)}catch(l){Re("添加失败："+(l&&l.message?l.message:l),"error")}finally{e.disabled=!1,e.textContent=s}})}t.querySelectorAll("[data-src-toggle]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcToggle),i=ur();i[o]&&(i[o].enabled=i[o].enabled===!1,Ia(i),Ba(t))})),t.querySelectorAll("[data-src-del]").forEach(r=>r.addEventListener("click",()=>{let o=Number(r.dataset.srcDel),i=ur();i[o]&&(i.splice(o,1),Ia(i),Ba(t))}))}a(fn,"bindStoreSources");function Ba(t){let e=t.querySelector('[data-pane="sources"]');if(e){let r=t;e.innerHTML=bn(),fn(r)}}a(Ba,"refreshStoreSources");function ws(t){let e=t.querySelector("[data-add-local-theme]"),r=t.querySelector("[data-local-theme-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text(),s=i.match(/html\[data-urppp-skin="([\w-]+)"\]/);if(!s){Re('未能从 CSS 中识别主题 id（需要 html[data-urppp-skin="…"]）',"error"),r.value="";return}let l=s[1];try{GM_setValue("urppp_theme_css_"+l,i)}catch{}Co(l,{name:l,desc:"本地主题",author:"本地",version:"1.0.0"});try{ya(l).textContent=i}catch{}r.value="";try{jr(t.querySelector("#urppp-theme-manage"))}catch{}}))}a(ws,"bindLocalThemeImport");function ks(t){let e=t.downloads!=null?`${at(String(t.downloads))}`:"",r=t.repo?`<button type="button" class="urppp-store-repo" data-repo="${at(t.repo)}">仓库</button>`:"";return`<div class="urppp-skin-card" data-plugin-card="${at(t.id)}">
      <div class="urppp-skin-name">${at(t.name||t.id)}</div>
    ...
    </div>`}a(ks,"pluginStoreCard");async function As(t){if(!t)return;let e=[];try{e=(await fe()).filter(r=>r.type==="plugin"&&!(_t&&_t.api&&_t.api.isEnabled&&_t.api.isEnabled(r.id)))}catch{}if(!e.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无待下载插件</p><p class="urppp-store-sub">已安装的插件不会再显示在这里。</p></div>';return}t.innerHTML=`<div class="urppp-store-theme-grid">${e.map(r=>ks(r)).join("")}</div>`,t.querySelectorAll("[data-plugin-apply]").forEach(r=>r.addEventListener("click",async()=>{r.disabled=!0;let o=r.textContent;r.textContent="下载中…";try{let i=(await fe()).find(l=>l.id===r.dataset.pluginApply),s=i?await dn(i):"trust";if(s==="fail"){Re("签名校验失败：该插件可能被篡改，已停止装载","error"),r.textContent="下载",r.disabled=!1;return}if(s==="unknown"&&i&&i._srcPub&&!await cn("该源无有效签名校验，可能被篡改。是否自担风险继续装载？")){r.textContent="下载",r.disabled=!1;return}_t&&_t.api&&_t.api.install&&await _t.api.install(r.dataset.pluginApply,null),r.textContent="已安装";try{Dt()}catch{}}catch{r.textContent="失败"}setTimeout(()=>{r.textContent=o,r.disabled=!1},1200)})),t.querySelectorAll("[data-repo]").forEach(r=>r.addEventListener("click",()=>{try{window.open(r.dataset.repo,"_blank","noopener")}catch{}}))}a(As,"fetchCatalogPlugins");async function gn(t){if(!t)return;let e=[];try{e=await fe()}catch{}let r=_t&&_t.api&&_t.api.list&&_t.api.list()||[];if(!r.length){t.innerHTML='<div class="urppp-store-empty"><p class="urppp-store-empty-title">暂无插件</p><p class="urppp-store-sub">已装载的插件会显示在这里。</p></div>';return}t.innerHTML=r.map(o=>{let i=e.find(m=>m.id===o.id),s=i&&i.downloads!=null?`<span class="urppp-store-dl">↓ ${at(String(i.downloads))}</span>`:"",l=o.repo||i&&i.repo?`<button type="button" class="urppp-set-btn ghost" data-repo="${at(o.repo||i.repo)}">仓库</button>`:"";return`<div class="urppp-store-item">
      ...
      </div>`}).join(""),t.querySelectorAll('[data-plugin-op="reload"]').forEach(o=>o.addEventListener("click",async()=>{o.disabled=!0;let i=o.textContent;o.textContent="装载中…";try{_t&&_t.api&&_t.api.install&&await _t.api.install(o.dataset.pluginId,null),o.textContent="已装载";try{Dt()}catch{}}catch{o.textContent="失败"}setTimeout(()=>{o.textContent=i,o.disabled=!1},1200)})),t.querySelectorAll('[data-plugin-op="unload"]').forEach(o=>o.addEventListener("click",()=>{try{_t&&_t.api&&_t.api.unregister&&_t.api.unregister(o.dataset.pluginId)}catch{}try{Dt()}catch{}let i=t.closest(".urppp-store-inline");try{xn(i)}catch{}})),t.querySelectorAll("[data-repo]").forEach(o=>o.addEventListener("click",()=>{try{window.open(o.dataset.repo,"_blank","noopener")}catch{}}))}a(gn,"fetchPluginManage");function xn(t){t.innerHTML=`
      <div class="urppp-store-inline">
        <div class="urppp-store-tabs">
          <button type="button" class="urppp-store-tab ac" data-tab="download">插件下载</button>
          <button type="button" class="urppp-store-tab" data-tab="manage">插件管理</button>
        ...
        <div class="urppp-store-body">
          <div class="urppp-store-pane" data-pane="download"><div class="urppp-store-empty"><p class="urppp-store-empty-title">加载中…</p></div></div>
          <div class="urppp-store-pane" data-pane="manage" style="display:none">${sn()}<button type="button" class="urppp-set-btn ghost" data-add-local-plugin style="width:100%;margin:0 0 10px">＋ 添加本地插件</button><input type="file" accept=".js,.txt" data-local-plugin-file style="display:none"><div class="urppp-store-bd" id="urppp-plugin-manage"><div class="urppp-store-empty"><p>加载中…</p></div></div></div>
        </div>
      </div>`,pn(t),hn(t),Ss(t),As(t.querySelector('[data-pane="download"]')),gn(t.querySelector("#urppp-plugin-manage"))}a(xn,"renderPluginStoreBody");function Ss(t){let e=t.querySelector("[data-add-local-plugin]"),r=t.querySelector("[data-local-plugin-file]");!e||!r||(e.addEventListener("click",()=>r.click()),r.addEventListener("change",async()=>{let o=r.files&&r.files[0];if(!o)return;let i=await o.text();r.value="";try{new Function(i)()}catch(s){Re("本地插件加载失败："+(s&&s.message?s.message:s),"error")}try{gn(t.querySelector("#urppp-plugin-manage"))}catch{}}))}a(Ss,"bindLocalPluginImport");function _s(t){if(!t)return;let e=t.querySelector("#urppp-theme-store");e&&!e.dataset.bound&&(e.dataset.bound="1",e.addEventListener("click",()=>Ma("theme")));let r=t.querySelector("#urppp-skin-list");if(!r)return;let o=Zt();if(r.innerHTML="",!u||!u.length){r.innerHTML='<p class="urppp-set-tip">暂无可用风格</p>';return}let i=Ae();u.filter(l=>l.installed!==!1||he(l.id)).concat(Object.keys(i).filter(l=>!u.some(m=>m.id===l)).map(l=>({id:l,name:i[l].name||l,desc:i[l].desc||"本地主题",version:i[l].version||"1.0.0",installed:!1}))).forEach(l=>{let m=!!i[l.id],h=document.createElement("div");h.className="urppp-skin-card"+(l.id===o?" is-active":""),h.dataset.skin=l.id;let v=document.createElement("button");v.type="button",v.className="urppp-skin-apply";let M=l.installed!==!1||he(l.id)||m;if(M?l.id===o&&(l.ready||m)?(v.classList.add("is-current"),v.textContent="使用中",v.disabled=!0):v.textContent="应用主题":(v.classList.add("is-disabled"),v.textContent="去下载"),v.addEventListener("click",N=>{if(N.preventDefault(),N.stopPropagation(),!M){Ma("theme");return}if(!(l.id===o&&l.ready)&&Mo(l.id)){Dt();try{window.__urpppCleanMode&&window.__urpppCleanMode.inject&&window.__urpppCleanMode.inject()}catch{}}}),h.innerHTML=['<div class="urppp-skin-name"></div>','<p class="urppp-skin-desc"></p>'].join(""),h.querySelector(".urppp-skin-name").textContent=l.name,h.querySelector(".urppp-skin-desc").textContent=l.desc,h.appendChild(v),r.appendChild(h),m)try{let N="";try{N=GM_getValue("urppp_card_css_"+l.id,"")||""}catch{}N&&Se([{id:l.id,cardCss:N}])}catch{}})}a(_s,"renderSkinCards");let Ue=[],Fa=!1;function Es(t,e,r){let o=typeof AbortController=="function"?new AbortController:null,i=o?setTimeout(()=>o.abort(),r):null;return fetch(t,{cache:"no-store",headers:e,signal:o?o.signal:void 0}).then(s=>{if(!s.ok)throw new Error("HTTP "+s.status);return s.text()}).finally(()=>{i&&clearTimeout(i)})}a(Es,"fetchWithTimeout");function Cs(t,e){return new Promise((r,o)=>{try{GM_xmlhttpRequest({method:"GET",url:t,timeout:12e3,headers:e,onload:a(i=>{i.status>=200&&i.status<400?r(i.responseText||""):o(new Error("HTTP "+i.status))},"onload"),onerror:a(()=>o(new Error("network error")),"onerror"),ontimeout:a(()=>o(new Error("timeout")),"ontimeout")})}catch(i){o(i)}})}a(Cs,"gmRequestForUpdate");function Ps(t,e){let r={"Cache-Control":"no-cache"};return e&&e.range&&(r.Range=e.range),Es(t,r,12e3).catch(o=>{if(typeof GM_xmlhttpRequest=="function")return Cs(t,r);throw o})}a(Ps,"fetchTextForUpdate");async function Da(t,e,r=1e3){let o=[],i=t[0],s=t.slice(1),l=a(z=>Ps(z,e).then(D=>({url:z,text:D})).catch(D=>(o.push((z.split("/")[2]||z)+": "+(D&&D.message||D)),null)),"grab"),m=l(i),h=new Promise(z=>setTimeout(()=>z("__TIMEOUT__"),r)),v=await Promise.race([m,h]);if(v!=="__TIMEOUT__"){if(v&&v.text&&v.text.length>0)return v.text;let D=(await Promise.all(s.map(l))).find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}let M=Promise.all(s.map(l)).then(z=>{let D=z.find(J=>J&&J.text&&J.text.length>0);if(D)return D.text;throw new Error("所有更新源均不可用（"+o.join("; ")+"）")}),N=m.then(z=>{if(z&&z.text&&z.text.length>0)return z.text;throw new Error("主源内容无效")}).catch(()=>new Promise(()=>{}));return Promise.race([N,M])}a(Da,"fetchFirstAvailable");function Ee(t,e){let r=document.getElementById("urppp-set-update-status");r&&(r.dataset.locked=t?"1":"",r.innerHTML=t||"",r.style.color=e==="err"?"#b91c1c":e==="ok"?"#15803d":"var(--text-muted)")}a(Ee,"setUpdateStatus");async function ja(){let t=p,e="",r=!1,o="";try{let s=await Da(n.sourceUrls(n.versionJson)),l=JSON.parse(s);e=String(l&&l.version||"").trim(),l&&String(l.prevVersion||"").trim()===t&&(r=!0),l&&typeof l.changelog=="string"&&l.changelog.trim()&&(o=l.changelog)}catch{}if(!e){let s=await Da(n.sourceUrls("urppp.user.js"),{range:"bytes=0-2048"});e=po(s)}if(!e)throw new Error("无法解析远程主插件版本");let i=wr(e,t);return{id:"main",name:"主插件",local:t,remote:e,status:i>0?"update":i===0?"latest":"ahead",updateUrl:n.mainRaw,pageUrl:n.greasySearch,changelogMd:r?o:""}}a(ja,"checkMainUpdate");function yn(t,e,r){let o=String(t||"").replace(/\r\n/g,`
`);if(!o.trim())return"";let i=/^##\s*\[?v?([0-9]+(?:\.[0-9]+){0,3}[\w\-]*)\]?[^\n]*$/gim,s=[],l;for(;(l=i.exec(o))!==null;)s.push({ver:l[1],index:l.index,headEnd:i.lastIndex});if(!s.length)return"";for(let h=0;h<s.length;h++){let v=h+1<s.length?s[h+1].index:o.length;s[h].body=o.slice(s[h].index,v).trim()}let m=[];for(let h of s)wr(h.ver,r)>0||wr(h.ver,e)<=0||m.push(h.body);return m.join(`

`).trim()}a(yn,"extractChangelogRange");function vn(){let t=document.getElementById("urppp-update-toast-style");t&&t.remove();let e=document.createElement("style");e.id="urppp-update-toast-style",e.textContent=`
      #urppp-update-toast{
    ...
    `,document.documentElement.appendChild(e)}a(vn,"ensureUpdateToastStyles");function zs(t){let e=String(t||"").replace(/\r\n/g,`
`).trim();if(!e)return'<p class="uuc-meta">暂无更新日志</p>';let r=a(m=>{let h=at(m);return h=h.replace(/`([^`]+)`/g,"<code>$1</code>"),h=h.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),h=h.replace(/\[([^\]]+)\]\((https?:\/\/[^)\s]+)\)/g,'<a href="$2" target="_blank" rel="noopener noreferrer">$1</a>'),h=h.replace(/(^|[^"'>])(https?:\/\/[^\s<]+)/g,'$1<a href="$2" target="_blank" rel="noopener noreferrer">$2</a>'),h},"inline"),o=e.split(`
`),i=[],s=!1,l=a(()=>{s&&(i.push("</ul>"),s=!1)},"closeList");for(let m=0;m<o.length;m++){let v=o[m].replace(/\s+$/,"");if(!v.trim()){l();continue}let M=v.match(/^(#{2,3})\s+(.+)$/);if(M){l();let z=M[1].length,D=M[2];i.push(z===2?`<h2>${r(D)}</h2>`:`<h3>${r(D)}</h3>`);continue}let N=v.match(/^[-*]\s+(.+)$/);if(N){s||(i.push("<ul>"),s=!0),i.push(`<li>${r(N[1])}</li>`);continue}l(),i.push(`<p>${r(v)}</p>`)}return l(),i.join("")||'<p class="uuc-meta">暂无更新日志</p>'}a(zs,"renderChangelogMarkdown");function wn(t){let e=t||document.getElementById("urppp-update-toast");if(!e||!e.classList.contains("open")){e&&e.classList.remove("open","closing");return}if(e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="transform"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,380)}a(wn,"hideUpdateToast");function Ls(t){let e=t||document.getElementById("urppp-update-changelog");if(!e||!e.classList.contains("open")&&!e.classList.contains("closing")||e.__closing)return;e.__closing=!0,e.classList.add("closing"),e.classList.remove("open");let r=a(()=>{e.classList.remove("closing"),e.__closing=!1,e.removeEventListener("transitionend",o)},"done"),o=a(i=>{i&&i.target!==e||i&&i.propertyName&&i.propertyName!=="opacity"&&i.propertyName!=="background-color"&&i.propertyName!=="background"||r()},"onEnd");e.addEventListener("transitionend",o),setTimeout(r,360)}a(Ls,"hideChangelogModal");function kn(t,e){vn();let r=document.getElementById("urppp-update-changelog");r||(r=document.createElement("div"),r.id="urppp-update-changelog",r.innerHTML=`
        ...
        </div>`,r.addEventListener("click",o=>{(o.target===r||o.target&&o.target.getAttribute&&o.target.getAttribute("data-close")==="1")&&Ls(r)}),document.documentElement.appendChild(r)),r.querySelector("h3").textContent=t||"更新日志",r.querySelector(".uuc-body").innerHTML=e||'<p class="uuc-meta">暂无更新日志</p>',r.__closing=!1,r.classList.remove("open","closing"),r.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add("open"))})}a(kn,"openChangelogModal");function Oa(t){vn();let e=document.getElementById("urppp-update-toast");e||(e=document.createElement("div"),e.id="urppp-update-toast",e.innerHTML=`
        ...
        </div>`,e.querySelector(".uut-close").addEventListener("click",()=>wn(e)),e.addEventListener("click",async r=>{let o=r.target&&r.target.closest?r.target.closest("[data-act]"):null;if(!o)return;let i=o.getAttribute("data-act"),s=e.__pack||{};if(i==="later"){wn(e);return}if(i==="go"){let l=s.updateUrl||n.mainRaw;try{window.open(l,"_blank","noopener,noreferrer")}catch{location.href=l}return}if(i==="log"){o.disabled=!0,o.textContent="加载中…";try{let l=s.changelogMd;l||(l=await Da(n.sourceUrls("CHANGELOG.md")),s.changelogMd=l);let m=yn(l,s.local,s.remote),h=m?zs(m):'<p class="uuc-meta">未找到区间日志。</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开完整 CHANGELOG</a></p>';kn("更新日志 "+s.local+" → "+s.remote,h)}catch(l){kn("更新日志","<p>加载失败："+at(l&&l.message||l)+'</p><p><a href="'+n.changelogPage+'" target="_blank" rel="noopener noreferrer">打开 GitHub CHANGELOG</a></p>')}finally{o.disabled=!1,o.textContent="更新日志"}}}),document.documentElement.appendChild(e)),e.__pack=t||{},e.querySelector(".uut-title").textContent="发现新版本 "+(t&&t.remote||""),e.querySelector(".uut-sub").textContent="当前 "+(t&&t.local||"")+" · 主插件可更新",e.__closing=!1,e.classList.remove("open","closing"),e.offsetWidth,requestAnimationFrame(()=>{requestAnimationFrame(()=>e.classList.add("open"))})}a(Oa,"showUpdateToast");async function Ha(){if(ba()&&!window.__urpppAutoUpdateTried){window.__urpppAutoUpdateTried=!0;try{let t=await ja();t&&t.status==="update"&&Oa(t);let e=await qs();if(e)try{console.log("[URP++] 辅助插件热更新到",e.version)}catch{}}catch(t){try{console.debug("[URP++] auto update check failed",t)}catch{}}}}a(Ha,"maybeAutoCheckUpdate");function qs(){let t=(window.__urpppUpdateCheckers||Ue||[]).find(e=>e&&e.id==="assist");return!t||typeof t.check!="function"?Promise.resolve(null):Promise.resolve().then(()=>t.check()).then(e=>e&&e.status==="update"?_t.update("assist"):null).catch(()=>null)}a(qs,"hotUpdateAssist");async function Ra(){if(Fa)return;Fa=!0;let t=document.getElementById("urppp-set-check-update");t&&(t.disabled=!0,t.textContent="检查中…"),Ee("正在从多源检查更新…");try{let e=[ja()];(Ue||[]).forEach(h=>{h&&typeof h.check=="function"&&e.push(Promise.resolve().then(()=>h.check()).then(v=>v||{id:h.id||"extra",name:h.name||"扩展",status:"err",message:"无结果"}).catch(v=>({id:h.id||"extra",name:h.name||"扩展",status:"err",message:String(v&&v.message||v)})))});let r=await Promise.all(e),o=r.map(h=>{if(!h)return"";if(h.status==="err")return`• <b>${at(h.name||h.id)}</b>：检查失败（${at(h.message||"unknown")}）`;if(h.status==="update"){let v="";if(h.id==="assist"&&_t&&_t.loaded("assist"))v=' <a class="urppp-update-relaunch" href="javascript:void(0)" data-urppp-relaunch="assist" rel="nofollow">重新装载</a>';else{let M=h.updateUrl?` <a href="${at(h.updateUrl)}" target="_blank" rel="noopener noreferrer">打开更新源</a>`:"",N=h.pageUrl?` <a href="${at(h.pageUrl)}" target="_blank" rel="noopener noreferrer">Greasy Fork</a>`:"";v=M+N}return`• <b>${at(h.name)}</b>：发现新版本 <b>${at(h.remote)}</b>（当前 ${at(h.local)}）${v}`}return h.status==="ahead"?`• <b>${at(h.name)}</b>：本地 ${at(h.local)} 新于远程 ${at(h.remote)}`:`• <b>${at(h.name)}</b>：已是最新（${at(h.local)}）`}).filter(Boolean),i=r.some(h=>h&&h.status==="update"),s=r.some(h=>h&&h.status==="err");Ee(`${i?"检查完成：发现更新":s?"检查完成：部分失败":"检查完成：全部最新"}<br>${o.join("<br>")}<br><span style="opacity:.85">仓库：<a href="${n.repo}" target="_blank" rel="noopener noreferrer">SCU-URP-plusplus</a></span>`,s?"err":"ok");let m=document.querySelector('#urppp-set-update-status .urppp-update-relaunch[data-urppp-relaunch="assist"]');m&&m.addEventListener("click",()=>{try{Ee("正在重新装载辅助插件…",""),_t.install("assist").then(()=>{Ee("辅助插件已重新装载，刷新页面后生效。","ok")}).catch(h=>{Ee("重新装载失败："+(h&&h.message?h.message:h),"err")})}catch(h){Ee("重新装载失败："+(h&&h.message?h.message:h),"err")}})}catch(e){Ee("检查失败："+at(e&&e.message||e),"err")}finally{Fa=!1,t&&(t.disabled=!1,t.textContent="检查更新")}}a(Ra,"checkForUpdates");function An(){let t=document.getElementById("urppp-set-update-status");if(!t||t.dataset.locked==="1")return;let e="当前主插件："+p,r=t.getAttribute("data-assist-version")||"";r&&(e+="；辅助插件："+r),t.textContent=e,t.style.color="var(--text-muted)"}a(An,"refreshUpdateStatusHint");function Ts(t){if(!t||typeof t.check!="function")return!1;let e=String(t.id||t.name||"").trim();if(!e)return!1;let r=Ue.findIndex(i=>i&&i.id===e),o={id:e,name:t.name||e,check:t.check,localVersion:t.localVersion||""};r>=0?Ue[r]=o:Ue.push(o);try{let i=document.getElementById("urppp-set-update-status");i&&o.localVersion&&e==="assist"&&i.setAttribute("data-assist-version",String(o.localVersion))}catch{}try{An()}catch{}return!0}a(Ts,"registerUpdateChecker");function Ms(){let t={version:p,urls:n,check:Ra,checkMain:ja,registerChecker:Ts,compareVersions:wr,parseUserscriptVersion:po,extractChangelogRange:yn,showUpdateToast:Oa,maybeAutoCheckUpdate:Ha,listCheckers:a(()=>Ue.slice(),"listCheckers")};try{window.__urpppUpdate=t}catch{}try{typeof unsafeWindow<"u"&&unsafeWindow&&(unsafeWindow.__urpppUpdate=t)}catch{}return t}a(Ms,"publishUpdateApi"),Ms();let{rebuildSidebarCompletely:Sn,syncMobileContentOffset:We,syncSidebarUnderNavbar:Ce}=Fi({}),{rebuildDashboard:$s}=Pi({deps:{statCardPrivacyMarkup:Ds}}),Is="urppp-clean-open",Ua={100:4,99:4,98:4,97:4,96:4,95:4,94:3.9,93:3.8,92:3.7,91:3.6,90:3.5,89:3.4,88:3.3,87:3.2,86:3.1,85:3,84:2.9,83:2.8,82:2.7,81:2.6,80:2.5,79:2.4,78:2.3,77:2.2,76:2.1,75:2,74:1.9,73:1.8,72:1.7,71:1.6,70:1.5,69:1.4,68:1.3,67:1.2,66:1.1,65:1,64:.9,63:.8,62:.7,61:.6,60:.5};function ie(t){if(t==null||t==="")return!1;let e=String(t).trim();if(!e)return!1;if(/未评估|未评教|待评估|待评教/.test(e))return!0;let r=Number(e);return!Number.isNaN(r)&&r<0}a(ie,"isUnevaluatedScore");function Hr(t){if(t==null||t==="")return!1;let e=Number(t);return!Number.isNaN(e)&&e>=0&&e<=5}a(Hr,"isValidOfficialGpa");function Rr(t){let e=String(t||"").trim();if(!e)return"";let r=e.match(/[\u4e00-\u9fffA-Za-z0-9]/);return r?r[0]:e.charAt(0)}a(Rr,"firstContentChar");function Wa(t,e){let r=String(t||""),o=Number(e)||0;return!r||o<=0||o>r.length?!1:r.charAt(o-1)==="1"}a(Wa,"weekBitmapActive");function Ge(t){if(t==null||t==="")return null;let e=String(t).trim();if(!e||ie(e)||/^免修$|^通过$|^取消$|^缓考$|^旷考$|^缺考$/.test(e))return null;if(/^A\+$/i.test(e)||/^A$/i.test(e))return 4;if(/^A-$/i.test(e))return 3.7;if(/^B\+$/i.test(e))return 3.3;if(/^B$/i.test(e))return 3;if(/^B-$/i.test(e))return 2.7;if(/^C\+$/i.test(e))return 2.3;if(/^C$/i.test(e))return 2;if(/^C-$/i.test(e))return 1.7;if(/^D$/i.test(e))return 1.3;if(/^F$/i.test(e))return 0;if(/优秀/.test(e))return 4;if(/良好/.test(e))return 3;if(/中等/.test(e))return 2;if(/及格/.test(e)&&!/不及格/.test(e))return 1;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 1;let r=parseFloat(e.replace(/[^\d.]/g,""));if(Number.isNaN(r)||r<0)return null;let o=Math.round(r);return o<60?0:o>100?4:Ua[o]!=null?Ua[o]:Ua[Math.max(60,Math.min(100,Math.floor(r)))]||0}a(Ge,"scoreToGpa");function Je(t){let e=String(t||"").trim();if(!e||ie(e))return null;if(/优秀/.test(e))return 95;if(/良好/.test(e))return 85;if(/中等/.test(e))return 75;if(/及格/.test(e)&&!/不及格/.test(e))return 65;if(/不及格|不合格|不通过/.test(e))return 0;if(/合格/.test(e))return 70;if(/^A/i.test(e))return 95;if(/^B/i.test(e))return 85;if(/^C/i.test(e))return 75;if(/^D/i.test(e))return 65;if(/^F/i.test(e))return 0;let r=parseFloat(e.replace(/[^\d.]/g,""));return Number.isNaN(r)||r<0?null:r}a(Je,"scoreToNumber");function Pe(t){return Math.round((Number(t)||0)*100)/100}a(Pe,"round2");function _n(t){return/必修/.test(String(t||""))}a(_n,"isRequiredAttr");function re(t){let e=0,r=0,o=0,i=0,s=0,l=0,m=0,h=0;return(t||[]).forEach(v=>{if(v&&(v.unevaluated||ie(v.score)))return;let M=Number(v.credit)||0,N=Je(v.score),z=Hr(v.officialGpa)?Number(v.officialGpa):Ge(v.score);N==null||M<=0||(e+=M,r+=N*M,z!=null&&(o+=z*M,i+=M),v.required&&(s+=M,l+=N*M,z!=null&&(m+=z*M,h+=M)))}),{totalCredit:Pe(e),avgScore:Pe(e?r/e:0),avgGpa:Pe(i?o/i:0),requiredCredit:Pe(s),requiredGpa:Pe(h?m/h:0),requiredAvg:Pe(s?l/s:0),count:(t||[]).length}}a(re,"summarizeCourses");function Ga(t){let e=String(t||"");return/^https?:\/\//i.test(e)?e:e.startsWith("//")?location.protocol+e:e.startsWith("/")?location.origin+e:location.origin+"/"+e.replace(/^\.\//,"")}a(Ga,"absUrl");function Vt(t,e){let r=Ga(t),o=e&&e.method||"GET",i=e&&e.data||null;return new Promise((s,l)=>{let m=a((h,v)=>h?s(v):l(new Error(v||"fetch failed")),"done");try{if(typeof GM_xmlhttpRequest=="function"){GM_xmlhttpRequest({method:o,url:r,data:i||void 0,headers:e&&e.headers?e.headers:{},withCredentials:!0,onload:a(h=>{h.status>=200&&h.status<400?m(!0,h.responseText||""):m(!1,"HTTP "+h.status)},"onload"),onerror:a(()=>m(!1,"network error"),"onerror")});return}}catch{}fetch(r,{method:o,credentials:"include",cache:"no-store",headers:e&&e.headers?e.headers:{},body:i||void 0}).then(h=>{if(!h.ok)throw new Error("HTTP "+h.status);return h.text()}).then(h=>m(!0,h)).catch(h=>m(!1,h&&h.message))})}a(Vt,"fetchText");function Ur(t){return new DOMParser().parseFromString(String(t||""),"text/html")}a(Ur,"parseHtml");function En(){if(document.getElementById("urppp-feature-style"))return;let t=document.createElement("style");t.id="urppp-feature-style",t.textContent=ri,(document.head||document.documentElement).appendChild(t)}a(En,"ensureFeatureStyles");function Ns(){if(document.getElementById("urppp-schedule-export-style"))return;let t=document.createElement("style");t.id="urppp-schedule-export-style",t.textContent=ni,(document.head||document.documentElement).appendChild(t)}a(Ns,"ensureScheduleExportStyles");function Bs(){if(document.getElementById("urppp-settings-style"))return;let t=document.createElement("style");t.id="urppp-settings-style",t.textContent=pi,(document.head||document.documentElement).appendChild(t)}a(Bs,"ensureSettingsStyles");function Cn(t){let r=(t&&t.querySelector?t:document).querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(!r)return null;let o=r.querySelector(".urppp-user-name-value");if(o)return o;let i=r.cloneNode(!0);i.querySelectorAll("small, i, img, b, .badge").forEach(m=>m.remove());let s=(i.textContent||"").replace(/^\s*欢迎您[，,]?\s*/g,"").replace(/\s+/g," ").trim();Array.from(r.childNodes).forEach(m=>{m.nodeType===Node.TEXT_NODE&&m.textContent.trim()&&m.remove()});let l=document.createElement("span");return l.className="urppp-user-name-value",l.textContent=s||"同学",l.__urpppOriginalText=l.textContent,r.appendChild(l),l}a(Cn,"ensureNavNameTarget");function Wr(t){let e=String(t||"").replace(/[\s:：]/g,"");return e?/姓名|英文姓名|姓名拼音/.test(e)?"name":/学号|证件|身份证|护照|证书编号|考生号|录取号|学籍号/.test(e)?"identity":/学院|院系|专业|班级|年级|主修方案|培养方案|专业方向|分流方向|毕业中学/.test(e)?"organization":/电话|手机|电子邮件|邮箱|QQ|地址|家长|个人主页|出生日期|入学日期|乘车区间|性别|籍贯|民族|政治面貌|国籍|户口|户籍|生源|出生地|健康|宗教|血型|婚姻|联系人|家庭/.test(e)?"contact":/绩点|GPA/.test(e)?"gpa":/学分/.test(e)?"credit":/成绩|分数|高考总分|均分|平均分|必修平均|课程门数|及格课程|不及格课程|待修读课程|已修读课程/.test(e)?"grade":/课表|日程安排/.test(e)?"schedule":"":""}a(Wr,"classifyPrivacyLabel");function Fs(t,e){let r=String(t||"")+" "+String(e||"");return/绩点|GPA/.test(r)?"majorGpa":/主修为|培养方案|方案/.test(r)?"majorPlan":/尚不及格|未及格/.test(r)?"failedCourses":/待修读课程/.test(r)?"remainingCourses":/已修读课程/.test(r)?"completedCourses":""}a(Fs,"classifyHomeDataKey");function Gr(t,e,r){let o=e?` data-urppp-edit-key="${e}"`:"";return`<span class="urppp-private-value" data-urppp-private="${t}"${o}>${r}</span>`}a(Gr,"homePrivateValueSpan");function Ds(t,e){let r=at(t),o=at(e),i=Fs(t,e),l={completedCourses:"other",failedCourses:"other",majorGpa:"gpa",majorPlan:"organization",remainingCourses:"other"}[i]||Wr(String(t||"")+" "+String(e||""));if(l==="organization")return e?{valueHtml:r,labelHtml:Gr("organization",i,o)}:{valueHtml:Gr("organization",i,r),labelHtml:o};if(!["grade","gpa","credit","other"].includes(l))return{valueHtml:r,labelHtml:o};let m=String(e||"").match(/-?\d+(?:\.\d+)?/);if(!(/^-?\d+(?:\.\d+)?$/.test(String(t||"").trim())||/^(优秀|良好|中等|及格|不及格|合格|不合格)$/.test(String(t||"").trim()))&&m){let v=m.index||0,M=String(e).slice(0,v),N=String(e).slice(v+m[0].length);return{valueHtml:r,labelHtml:`${at(M)}${Gr(l,i,at(m[0]))}${at(N)}`}}return{valueHtml:Gr(l,i,r),labelHtml:o}}a(Ds,"statCardPrivacyMarkup");function ze(t,e){if(!t||t.mode==="off")return"";if(t.mode==="one")return t.mask||_r;if(e==="name")return"";let r=t.fields&&t.fields[e];return!r||!r.enabled?"":String(r.replacement||t.mask||_r)}a(ze,"privacyReplacement");function mr(t,e){if(!(!t||!e)&&!(t.querySelector&&t.querySelector("input,select,textarea,button"))){if(!t.classList.contains("urppp-private-text")){let r=getComputedStyle(t).fontSize;r&&r!=="0px"&&t.style.setProperty("--urppp-private-font-size",r)}t.classList.add("urppp-private-text"),t.setAttribute("data-urppp-private-mask",e)}}a(mr,"markPrivateText");function Pn(t,e){if(!t||!t.parentElement)return;let r=t.parentElement;t.classList.add("urppp-private-avatar"),r.classList.add("urppp-private-avatar-host"),r.setAttribute("data-urppp-private-mask",e||_r);let o=t.getBoundingClientRect();r.style.setProperty("--urppp-avatar-left",t.offsetLeft+"px"),r.style.setProperty("--urppp-avatar-top",t.offsetTop+"px"),r.style.setProperty("--urppp-avatar-width",Math.max(1,o.width)+"px"),r.style.setProperty("--urppp-avatar-height",Math.max(1,o.height)+"px"),r.style.setProperty("--urppp-avatar-radius",getComputedStyle(t).borderRadius||"50%")}a(Pn,"markPrivateAvatar");function js(t,e){if(!t||!e)return;let r=t.matches("table")&&t.closest(".table-responsive, .urppp-table-wrap")||t;r.classList.add("urppp-private-block"),r.setAttribute("data-urppp-private-mask",e)}a(js,"markPrivateBlock");function Os(t,e){if(!(!t||!U[e])){if(!t.hasAttribute("data-urppp-direct-tabindex")){let r=t.getAttribute("tabindex");t.setAttribute("data-urppp-direct-tabindex",r??"__none__"),t.__urpppDirectTitle=t.getAttribute("title"),t.__urpppDirectAriaLabel=t.getAttribute("aria-label")}t.classList.add("urppp-direct-editable"),t.setAttribute("tabindex","0"),t.setAttribute("data-urppp-edit-key",e),t.setAttribute("aria-label","修改"+U[e]+"显示值"),t.title="点击修改显示值"}}a(Os,"markDirectEditable");let ge=null;function zn(t){let e=t&&t.getAttribute("data-urppp-edit-key");if(!e||!U[e])return;ge&&ge.__finish&&ge.__finish(!1);let r=ke();if(r.mode!=="custom"||!r.directEdit.enabled)return;let i=String(r.directEdit.values[e]||"")||t.getAttribute("data-urppp-private-mask")||String(t.textContent||"").trim(),s=t.getBoundingClientRect(),l=t.parentElement?.getBoundingClientRect(),m=s.height>=8||!l?s:{left:s.left,top:l.top,width:Math.max(s.width,40),height:l.height},h=document.createElement("input"),v=getComputedStyle(t),M=Math.min(Math.max(m.width+64,140),Math.max(140,window.innerWidth-24)),N=Math.min(Math.max(12,m.left),Math.max(12,window.innerWidth-M-12)),z=Math.min(Math.max(12,m.top+(m.height-36)/2),Math.max(12,window.innerHeight-48));h.type="text",h.maxLength=80,h.className="urppp-direct-edit-input",h.value=i,h.setAttribute("aria-label","修改"+U[e]+"显示值"),h.style.left=N+"px",h.style.top=z+"px",h.style.setProperty("--urppp-direct-edit-width",M+"px"),h.style.fontFamily=v.fontFamily,h.style.fontSize=(window.innerWidth<=520?16:Math.min(18,Math.max(13,parseFloat(v.fontSize)||14)))+"px";let D=!1,J=a(j=>{if(D||(D=!0,h.remove(),ge===h&&(ge=null),j))return;let R=ke();R.mode!=="custom"||!R.directEdit.enabled||(R.directEdit.values[e]=String(h.value||"").trim().slice(0,80),fa(R),Yt(document),Xa(R.directEdit.values[e]?"显示值已更新":"已恢复分类设置"))},"finish");h.__finish=J,h.addEventListener("click",j=>j.stopPropagation()),h.addEventListener("blur",()=>J(!1)),h.addEventListener("keydown",j=>{j.key==="Enter"&&(j.preventDefault(),J(!1)),j.key==="Escape"&&(j.preventDefault(),J(!0))}),document.documentElement.appendChild(h),ge=h,h.focus(),h.select()}a(zn,"openDirectEditInput");function Hs(){document.__urpppDirectEditBound||(document.__urpppDirectEditBound=!0,document.addEventListener("click",t=>{let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),zn(e))},!0),document.addEventListener("keydown",t=>{if(!["Enter"," "].includes(t.key))return;let e=t.target?.closest?.(".urppp-direct-editable");e&&(t.preventDefault(),t.stopPropagation(),zn(e))},!0))}a(Hs,"bindDirectEditInteraction");function Rs(t){let e=t&&t.querySelectorAll?t:document;e.querySelectorAll(".urppp-direct-editable").forEach(r=>{let o=r.getAttribute("data-urppp-direct-tabindex");r.classList.remove("urppp-direct-editable"),r.removeAttribute("data-urppp-direct-tabindex"),o==="__none__"?r.removeAttribute("tabindex"):o!=null&&r.setAttribute("tabindex",o),r.__urpppDirectTitle==null?r.removeAttribute("title"):r.setAttribute("title",r.__urpppDirectTitle),r.__urpppDirectAriaLabel==null?r.removeAttribute("aria-label"):r.setAttribute("aria-label",r.__urpppDirectAriaLabel),delete r.__urpppDirectTitle,delete r.__urpppDirectAriaLabel}),e.querySelectorAll(".urppp-private-text").forEach(r=>{r.classList.remove("urppp-private-text"),r.removeAttribute("data-urppp-private-mask"),r.style.removeProperty("--urppp-private-font-size")}),e.querySelectorAll(".urppp-private-avatar").forEach(r=>r.classList.remove("urppp-private-avatar")),e.querySelectorAll(".urppp-private-avatar-host").forEach(r=>{r.classList.remove("urppp-private-avatar-host"),r.removeAttribute("data-urppp-private-mask"),["--urppp-avatar-left","--urppp-avatar-top","--urppp-avatar-width","--urppp-avatar-height","--urppp-avatar-radius"].forEach(o=>r.style.removeProperty(o))}),e.querySelectorAll(".urppp-private-avatar-block").forEach(r=>{r.classList.remove("urppp-private-avatar-block"),r.removeAttribute("data-urppp-private-mask")}),e.querySelectorAll(".urppp-private-block").forEach(r=>{r.classList.remove("urppp-private-block"),r.removeAttribute("data-urppp-private-mask")})}a(Rs,"clearPrivacyDisplay");function Ln(t,e,r){if(!t||t.matches?.("input,select,textarea,button")||t.querySelector?.("input,select,textarea,button"))return;if(t.__urpppOriginalText==null){if(!e)return;t.__urpppOriginalText=t.textContent||""}let o=e&&r?r:t.__urpppOriginalText;t.textContent!==o&&(t.textContent=o)}a(Ln,"applyCustomText");function Us(t){let e=t&&t.querySelectorAll?t:document,r=Ne(),i=e.querySelector?.(".urppp-user-name-value")||(r.nameEnabled?Cn(e):null);Ln(i,r.nameEnabled,r.name),e.querySelectorAll(".profile-info-row").forEach(m=>{let h=m.querySelector(".profile-info-name"),v=m.querySelector(".profile-info-value");!h||!v||String(h.textContent||"").replace(/[\s:：]/g,"")!=="姓名"||Ln(v,r.nameEnabled,r.name)});let s=or(r.avatar),l=r.avatarEnabled&&!!s;e.querySelectorAll("#navbar img.nav-user-photo, #urppp-mobile-user img.nav-user-photo, img#avatar, .profile-picture img").forEach(m=>{let h=m.getAttribute("src")||"";h&&h!==m.__urpppAppliedCustomSrc&&(m.__urpppOriginalSrc=h),l?(m.__urpppOriginalSrc==null&&(m.__urpppOriginalSrc=h),h!==s&&m.setAttribute("src",s),m.__urpppAppliedCustomSrc=s):m.__urpppAppliedCustomSrc!=null&&(m.__urpppOriginalSrc&&m.setAttribute("src",m.__urpppOriginalSrc),delete m.__urpppAppliedCustomSrc)})}a(Us,"applyCustomIdentityDisplay");function Ws(t,e){t.querySelectorAll(".profile-info-row").forEach(r=>{let o=r.querySelector(".profile-info-name, th, label"),i=r.querySelector(".profile-info-value, td:last-child");if(!o||!i||o===i)return;let s=Wr(o.textContent),l=ze(e,s);l&&mr(i,l)})}a(Ws,"applyProfilePrivacy");function Gs(t,e){t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.querySelectorAll("thead th, thead td, tr:first-child th, tr:first-child td"));if(!o.length)return;let i=o.map(s=>{let l=Wr(s.textContent);return["grade","gpa","credit"].includes(l)?l:""});i.some(Boolean)&&r.querySelectorAll("tbody tr").forEach(s=>{let l=s.querySelectorAll("td");i.forEach((m,h)=>{let v=ze(e,m);m&&v&&mr(l[h],v)})})})}a(Gs,"applyScoreTablePrivacy");function Js(t){let e=t&&t.querySelectorAll?t:document,r=ke();if(r.mode==="off")return;let o=ze(r,"name"),i=ze(r,"avatar"),s=ze(r,"schedule"),l=o?Cn(e):e.querySelector?.(".urppp-user-name-value");o&&mr(l,o),[["#courseNum, #coursePas, #xy_kcms","other"],["#gpa","gpa"],["#bottom","organization"]].forEach(([v,M])=>{let N=ze(r,M);N&&e.querySelectorAll(v).forEach(z=>mr(z,N))}),Gs(e,r);let h=r.mode==="custom"&&r.directEdit.enabled;if(e.querySelectorAll("[data-urppp-private]").forEach(v=>{let M=v.getAttribute("data-urppp-private"),N=v.getAttribute("data-urppp-edit-key"),D=(h&&N?String(r.directEdit.values[N]||"").trim():"")||ze(r,M);!["avatar","schedule"].includes(M)&&D&&mr(v,D),h&&N&&Os(v,N)}),h&&Hs(),Ws(e,r),i&&(e.querySelectorAll('[data-urppp-private="avatar"]').forEach(v=>{let M=v.matches("img")?v:v.querySelector("img");M?Pn(M,i):(v.classList.add("urppp-private-avatar-block"),v.setAttribute("data-urppp-private-mask",i))}),e.querySelectorAll("#navbar img.nav-user-photo, img#avatar, .profile-picture img, .uc-avatar img").forEach(v=>Pn(v,i))),s){let v=Array.from(e.querySelectorAll('[data-urppp-private="schedule"], #main-calendar, #courseTable'));v.filter(M=>!v.some(N=>N!==M&&N.contains(M))).forEach(M=>js(M,s))}}a(Js,"applyPrivacyDisplay");let Ja=0,se=[];function qn(){let t=ke(),e=Ne();return t.mode!=="off"||e.nameEnabled||e.avatarEnabled}a(qn,"personalDisplayIsEnabled");function Vs(){se=se.filter(({root:t})=>t&&t.isConnected),se.forEach(({root:t,observer:e})=>e.observe(t,{childList:!0,subtree:!0}))}a(Vs,"resumePersonalDisplayObservers");function Yt(t){let e=t||document;se.forEach(({observer:r})=>r.disconnect());try{En()}catch{}try{Rs(e)}catch{}try{Us(e)}catch(r){console.warn("[URP++] custom identity",r)}try{Js(e)}catch(r){console.warn("[URP++] privacy",r)}qn()?(Vs(),Qs()):(clearTimeout(Ja),se=[])}a(Yt,"applyPersonalDisplay");function Ys(t){clearTimeout(Ja),Ja=setTimeout(()=>Yt(t||document),140)}a(Ys,"schedulePersonalDisplay");function Va(){try{nt&&nt.open&&Ze()}catch{}}a(Va,"refreshCleanPersonalDisplay");function Qs(){if(!qn()){se.forEach(({observer:t})=>t.disconnect()),se=[];return}[document.getElementById("navbar"),document.getElementById("page-content-template"),document.getElementById("urppp-clean-root")].filter(Boolean).forEach(t=>{if(se.some(r=>r.root===t))return;let e=new MutationObserver(()=>Ys(document));se.push({root:t,observer:e}),e.observe(t,{childList:!0,subtree:!0})})}a(Qs,"bindPersonalDisplayObservers");function Xs(t){let e=Object.assign({},t||{}),r=Ne();r.nameEnabled&&r.name&&(e.name=r.name);let o=or(r.avatar);return r.avatarEnabled&&o&&(e.avatar=o),e}a(Xs,"personalizedProfile");let Tn="/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback",Ks="/student/courseSelect/thisSemesterCurriculum/callback",Zs="/student/courseSelect/thisSemesterCurriculum/index";async function tl(){let t=document.querySelector("#planCode, #zxjxjhh");if(t&&t.value&&t.value!=="no")return String(t.value);try{let e=new URLSearchParams(location.search),r=e.get("planCode")||e.get("zxjxjhh");if(r)return r}catch{}if(nt&&nt.schedule&&nt.schedule.exportData){let e=nt.schedule.exportData.semester&&nt.schedule.exportData.semester.planCode;if(e)return e}if(/\/student\/courseSelect\/courseSelectResult\//.test(location.pathname))try{let e=await Vt(Ks),r=JSON.parse(e),o=ar(r);if(o)return o}catch{}return""}a(tl,"resolveSchedulePlanCode");async function Mn(t){let e=await tl(),r=e?{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}}:null,o=await Vt(Tn,r),i;try{i=JSON.parse(o)}catch{throw new Error("课表接口返回了非 JSON 内容，请刷新教务页面后重试")}e||(e=ar(i)),(!i.jcsjbs||!i.jcsjbs.length)&&e&&(i=JSON.parse(await Vt(Tn,{method:"POST",data:"planCode="+encodeURIComponent(e),headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"}})));let s=In(i,e,t);if(!s.courses.length)throw new Error("没有读取到可导出的课表数据");return s}a(Mn,"loadScheduleExportData");function Ya(t){return String(t||"学生课表").replace(/[\\/:*?"<>|]+/g,"-").replace(/\s+/g,"").slice(0,80)||"学生课表"}a(Ya,"safeScheduleFilename");function Qa(t,e){let r=URL.createObjectURL(t),o=document.createElement("a");o.href=r,o.download=e,o.style.display="none",document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(r),1200)}a(Qa,"downloadBlob");function el(t){let e=Zr(t),r=qr(),o=r.enabled?ea(e,r.mapping):ta(e),i=JSON.stringify(o,null,2)+`
`;return Qa(new Blob([i],{type:"application/json;charset=utf-8"}),Ya(t.semester.label)+".json"),Object.assign({customFormat:r.enabled},e.stats)}a(el,"exportScheduleJson");function $n(t){let r=(Array.from(document.querySelectorAll(".span_bbzx")).map(l=>l.textContent||"").join(" ")+" "+(document.querySelector("#navbar")?.textContent||"")).replace(/\s+/g," ").match(/(\d{4})-(\d{4})\s*(春|秋).*?第\s*(\d{1,2})\s*周/);if(!r)return"";let o=r[3]==="秋"?"1":"2";if(t&&!String(t).startsWith(r[1]+"-"+r[2]+"-"+o))return"";let i=Number(r[4]);if(i<1||i>30)return"";let s=lo(new Date);return s.setDate(s.getDate()-(i-1)*7),Sr(s)}a($n,"deriveCurrentSemesterMonday");function In(t,e,r){let o=e||ar(t),i=$n(o)||ga()[o]||"";return kp(t,o,r,{firstMonday:i})}a(In,"normalizeScheduleDataForPage");function rl(t){let e=t.semester.planCode,r=ga()[e],o=$n(e);return o?(So(e,o),Promise.resolve(o)):rr(r)?Promise.resolve(r):new Promise((i,s)=>{document.querySelector('.urppp-dialog-mask[data-dialog="schedule-date"]')?.remove();let l=document.createElement("div");l.className="urppp-dialog-mask",l.dataset.dialog="schedule-date",l.innerHTML=`<div class="urppp-dialog" role="dialog" aria-modal="true"><h3>确认第一教学周周一</h3><p>${at(t.semester.label)}没有可可靠推导的起始日期。该日期决定 ICS 中每节课的实际日历时间；预填值仅为估算，请对照校历核对。</p><input type="date" value="${at(r||gp(e))}"><div class="urppp-dialog-actions"><button type="button" class="urppp-set-btn ghost" data-action="cancel">取消</button><button type="button" class="urppp-set-btn" data-action="ok">确认并导出</button></div></div>`,document.documentElement.appendChild(l);let m=a((h,v)=>{l.remove(),h?s(h):i(v)},"close");l.querySelector('[data-action="cancel"]').addEventListener("click",()=>m(new Error("已取消导出"))),l.querySelector('[data-action="ok"]').addEventListener("click",()=>{let h=l.querySelector("input").value;rr(h)&&(So(e,h),m(null,h))}),l.addEventListener("click",h=>{h.target===l&&m(new Error("已取消导出"))})})}a(rl,"requestScheduleFirstMonday");async function al(t){let e=await rl(t),r=yp(t,e);return Qa(new Blob([r],{type:"text/calendar;charset=utf-8"}),Ya(t.semester.label)+".ics"),vp(t)}a(al,"exportScheduleIcs");let ol={apple:"类 Apple",flat:"极简扁平",organic:"自然有机",brutal:"新野兽派",editorial:"编辑杂志",neu:"新拟物"};function le(t,e,r){if(typeof document>"u")return Gt(e)||"#000000";let o=document.createElement("span");o.style.cssText="position:fixed;left:-9999px;visibility:hidden;color:var("+t+","+e+")",(document.body||document.documentElement).appendChild(o);let i=getComputedStyle(o).color;o.remove();let s=String(i||"").match(/[\d.]+/g)?.map(Number)||[];if(s.length>=3){let l=vr(s[0],s[1],s[2]),m=s.length>3?Math.max(0,Math.min(1,s[3])):1;return m<1?Bt(r||e,l,m):l}return Gt(i)||Gt(e)||"#000000"}a(le,"resolvedScheduleImageColor");function Nn(){let t=Jt(),e=Zt(),r=t==="dark",o=r?{bg:"#000000",surface:"#1C1C1E",input:"#2C2C2E",text:"#F5F5F7",secondary:"#A1A1A6",muted:"#8E8E93",border:"#38383A",primary:"#0A84FF"}:{bg:"#F5F5F7",surface:"#FFFFFF",input:"#F5F5F7",text:"#1D1D1F",secondary:"#6E6E73",muted:"#86868B",border:"#D2D2D7",primary:"#0071E3"},i={bg:le("--bg",o.bg),surface:le(e==="neu"?"--neu-base":"--surface",o.surface),input:le("--input-bg",o.input),text:le("--text",o.text),secondary:le("--text-secondary",o.secondary),muted:le("--text-muted",o.muted),border:le("--border",o.border,le(e==="neu"?"--neu-base":"--surface",o.surface)),primary:le("--primary",o.primary)},s={apple:{frameRadius:24,headerRadius:13,gridRadius:10,cardRadius:12,frameStroke:1,cardStroke:1,shadow:"soft"},flat:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:2,cardStroke:2,shadow:"none"},organic:{frameRadius:30,headerRadius:18,gridRadius:14,cardRadius:18,frameStroke:1,cardStroke:1,shadow:"warm"},brutal:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:3,cardStroke:3,shadow:"hard"},editorial:{frameRadius:0,headerRadius:0,gridRadius:0,cardRadius:0,frameStroke:1,cardStroke:1,shadow:"none",serif:!0},neu:{frameRadius:22,headerRadius:14,gridRadius:10,cardRadius:14,frameStroke:0,cardStroke:0,shadow:"neu"}};return{id:t,skin:e,dark:r,label:(ol[e]||e)+" · "+(Ct[t]&&Ct[t].name||t),colors:i,shape:s[e]||s.apple}}a(Nn,"currentScheduleImageTheme");function Bn(t,e){return qp(t,e||Nn())}a(Bn,"buildScheduleSvg");function nl(t){return new Promise((e,r)=>{let o=new Blob([t.svg],{type:"image/svg+xml;charset=utf-8"}),i=URL.createObjectURL(o),s=new Image;s.onload=()=>{try{let m=Math.min(2,Math.sqrt(15e6/(t.width*t.height))),h=document.createElement("canvas");h.width=Math.floor(t.width*m),h.height=Math.floor(t.height*m);let v=h.getContext("2d");v.scale(h.width/t.width,h.height/t.height),v.fillStyle=t.background||"#F8FAFC",v.fillRect(0,0,t.width,t.height),v.drawImage(s,0,0,t.width,t.height),h.toBlob(M=>M?e(M):r(new Error("无法生成课表图片")),"image/png")}catch(l){r(l)}finally{URL.revokeObjectURL(i)}},s.onerror=()=>{URL.revokeObjectURL(i),r(new Error("课表图片渲染失败"))},s.src=i})}a(nl,"svgToPngBlob");async function pl(t){let e=await nl(Bn(t));Qa(e,Ya(t.semester.label)+".png")}a(pl,"exportSchedulePng");function Xa(t,e){document.getElementById("urppp-feature-toast")?.remove();let r=document.createElement("div");r.id="urppp-feature-toast",r.textContent=String(t||""),r.className=e?"error":"",document.documentElement.appendChild(r),requestAnimationFrame(()=>r.classList.add("open")),setTimeout(()=>{r.classList.remove("open"),setTimeout(()=>r.remove(),220)},e?4200:2400)}a(Xa,"showFeatureToast");let Ka=Tp({document,window,ensureStyles:Ns,loadData:Mn,exportJson:el,exportIcs:al,exportPng:pl,showToast:Xa,nativePageUrl:Zs,navigate:a(t=>{location.href=t},"navigate"),logger:console});function il(t,e,r,o){return Ka.run(t,e,r,o)}a(il,"runScheduleExport");function sl(t){return Ka.createMenu(t)}a(sl,"createScheduleExportMenu");function ll(t){if(t){try{t.stage.remove()}catch{}try{document.getElementById("urppp-pdf-reset-style")?.remove()}catch{}}}a(ll,"disposeNativePdfCapture");function cl(){window.__urpppPdfDiagnose||(window.__urpppPdfDiagnose=async()=>{let t={time:new Date().toISOString()},e=document.getElementById("mycoursetable"),r=document.getElementById("page-content-template");t.host=!!e,t.pageSource=!!r,t.hostCards=e?e.querySelectorAll("div.class_div").length:-1,t.hostHasCourseTable=e?!!e.querySelector("#courseTable"):!1,t.hostHasCourseTableBody=e?!!e.querySelector("#courseTableBody"):!1,t.hostTableId=e&&e.querySelector("table")?e.querySelector("table").id:"none";try{let i=Kp(e);t.stage="ok",t.stageCards=i.target.querySelectorAll(".urppp-pdf-card").length,t.stageTableId=i.target.querySelector("table")?i.target.querySelector("table").id:"none",ll(i)}catch(i){t.stage="failed",t.stageError=i&&i.message||String(i)}let o=typeof unsafeWindow<"u"?unsafeWindow:window;return t.deps={dollar:typeof o.$,loadFileList:typeof(o.Import&&o.Import.LoadFileList),back:typeof o.back,html2canvas:typeof o.html2canvas,originalDivBuild:typeof o.__urpppOriginalDivBuild},t})}a(cl,"bindNativePdfDiagnose");function dl(t){return t?(cl(),async()=>{let e=document.getElementById("urppp-settings-panel"),r=document.getElementById("urppp-settings-mask");e&&e.classList.contains("open")&&e.classList.remove("open"),r&&r.classList.contains("open")&&r.classList.remove("open");try{await ei(t,{document,page:typeof unsafeWindow<"u"?unsafeWindow:window,onAfterRestore:cr})}catch(o){console.warn("[URP++] isolated native PDF export failed",o),Xa("原生 PDF 隔离导出失败："+(o&&o.message||String(o))+"，请重试",!0)}}):null}a(dl,"pagePdfExportHandler");function Za(t=location){return/\/(?:student\/courseSelect\/(?:thisSemesterCurriculum|courseSelectResult|calendarSemesterCurriculum)|student\/personalSenate\/giveLessonInfo\/thisSemesterSchedule)\//.test(t.pathname)}a(Za,"isPersonalSchedulePage");function ul(t=location){return/\/student\/integratedQuery\/scoreQuery\/[^/]+\/index$/.test(t.pathname)}a(ul,"isScoreQueryPage");function to(){if(!Za())return;let t=document.querySelector("#h4_id1")?.closest("h4")||document.querySelector("h4.header"),e=t?.querySelector(".right_top_oper")||document.querySelector("#mainDIV .right_top_oper, .page-content .right_top_oper"),r=Array.from((e||document).querySelectorAll("button, a")),o=a(l=>[l.textContent,l.getAttribute("title"),l.getAttribute("onclick")].filter(Boolean).join(" ").replace(/\s+/g," "),"signatureOf");if(r.forEach(l=>{/打印.*课表|\bdy\s*\(/i.test(o(l))&&l.setAttribute("data-urppp-native-print-source","1")}),document.getElementById("urppp-native-schedule-export"))return;let i=r.find(l=>/导出.*(?:课表|PDF)|exportTableToPdf|\bdc\s*\(/i.test(o(l))),s=sl({source:"native",pdfHandler:dl(i)});if(s.id="urppp-native-schedule-export",i&&i.parentElement){i.__urpppNativeExportState||(i.__urpppNativeExportState={display:i.style.getPropertyValue("display"),displayPriority:i.style.getPropertyPriority("display"),ariaHidden:i.getAttribute("aria-hidden"),tabIndex:i.getAttribute("tabindex")}),i.setAttribute("data-urppp-native-export-source","1"),i.style.setProperty("display","none","important"),i.setAttribute("aria-hidden","true"),i.setAttribute("tabindex","-1"),i.parentElement.insertBefore(s,i.nextSibling);return}if(e)e.appendChild(s);else if(t)t.appendChild(s);else{let l=document.getElementById("page-content-template")||document.querySelector(".page-content");if(l){let m=document.createElement("div");m.className="urppp-export-fallback",m.appendChild(s),l.prepend(m)}}}a(to,"patchNativeScheduleExport");let Ve=null,Jr=0;function eo(){clearTimeout(Jr),Jr=0,Ve&&Ve.observer.disconnect(),Ve=null}a(eo,"disconnectNativeScheduleExportObserver");function ml(){if(!Za()){eo();return}let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;if(!t||Ve&&Ve.root===t&&t.isConnected)return;eo();let e=new MutationObserver(()=>{clearTimeout(Jr),Jr=setTimeout(()=>to(),80)});e.observe(t,{childList:!0,subtree:!0}),Ve={root:t,observer:e}}a(ml,"bindNativeScheduleExportObserver");function Fn(t,e,r){r===null?t.removeAttribute(e):t.setAttribute(e,r)}a(Fn,"restoreOptionalAttribute");function hl(t=document){let e=t&&t.querySelectorAll?t:document,r=e.matches?.("#urppp-native-schedule-export")?e:e.querySelector("#urppp-native-schedule-export");if(r){let o=r.closest(".urppp-export-fallback");r.remove(),o&&!o.children.length&&o.remove()}e.querySelectorAll("[data-urppp-native-export-source]").forEach(o=>{let i=o.__urpppNativeExportState;i&&(i.display?o.style.setProperty("display",i.display,i.displayPriority):o.style.removeProperty("display"),Fn(o,"aria-hidden",i.ariaHidden),Fn(o,"tabindex",i.tabIndex)),o.removeAttribute("data-urppp-native-export-source");try{delete o.__urpppNativeExportState}catch{}}),e.querySelectorAll("[data-urppp-native-print-source]").forEach(o=>{o.removeAttribute("data-urppp-native-print-source")})}a(hl,"removeNativeScheduleExport");let Dn=Ni({deps:{styles:di,loadScores:Zn,loadProfile:jn,scoreToNumber:Je,scoreToGpa:Ge,getInsertHost:a(()=>document.querySelector(".page-content")||document.getElementById("page-content-template")||null,"getInsertHost"),shouldAutoExpand:a(()=>{let t=/[?&]urppp=sa(?:&|$)/.test(window.location.search);if(t)try{history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}return t},"shouldAutoExpand")}}),bl=cp([Xr({id:"schedule-export",matches:a(t=>Za(t.location),"matches"),mount:a(()=>{to(),ml()},"mount"),unmount:a(t=>{eo(),hl(t?.lifecycleKey)},"unmount")}),Xr({id:"score-analysis",matches:a(t=>ul(t.location),"matches"),mount:a(()=>{try{Dn.mount()}catch(t){console.warn("[URP++] score analysis mount",t)}},"mount"),unmount:a(()=>{try{Dn.unmount()}catch{}},"unmount")})]);function Vr(){let t=document.getElementById("page-content-template")||document.querySelector(".page-content")||document.body;return bl.refresh({document,location,window,lifecycleKey:t})}a(Vr,"refreshRouteFeatures");function fl(t){Ka.bindHosts(t)}a(fl,"bindScheduleExportHosts");function hr(t){return String(t||"").replace(/\u00a0/g," ").replace(/\s+/g," ").replace(/^[\s:：]+|[\s:：]+$/g,"").trim()}a(hr,"normalizeProfileValue");function Yr(t,e){if(!t||!t.querySelectorAll)return"";let r=(e||[]).map(i=>hr(i).replace(/[：:]/g,"")),o=t.querySelectorAll(".profile-info-row, tr");for(let i=0;i<o.length;i++){let s=o[i],l=s.querySelector(".profile-info-name, th, label"),m=s.querySelector(".profile-info-value, td:last-child");if(!l||!m||l===m)continue;let h=hr(l.textContent).replace(/[：:]/g,"");if(!r.some(M=>h===M||h.endsWith(M)))continue;let v=hr(m.textContent);if(v&&v!=="—"&&v!=="-")return v}return""}a(Yr,"readLabeledProfileValue");function Ye(t){return hr(t).replace(/^主修为\s*/,"").replace(/培养方案概况.*$/,"").replace(/…+/g,"").split(/主修必修GPA|GPA算法|已修读|尚不及格|本学期/)[0].trim()}a(Ye,"cleanMajorPlanName");function gl(t){let e={majorPlan:"",majorGpa:""};return!t||!t.querySelectorAll||t.querySelectorAll(".infobox, .widget-box, .urppp-stat-card").forEach(r=>{let o=(r.innerText||r.textContent||"").trim(),i=hr(o);if(/主修必修GPA/.test(i)){let s=i.match(/(-?\d+(?:\.\d+)?)\s*主修必修GPA/)||i.match(/主修必修GPA[^\d-]{0,20}(-?\d+(?:\.\d+)?)/);if(s){let l=Number(s[1]),m=Number(e.majorGpa);Number.isFinite(l)&&l>=0&&l<=5&&(!e.majorGpa||m===0||l>0)&&(e.majorGpa=s[1])}}if(/主修为|培养方案/.test(i)){let s=i.match(/([\u4e00-\u9fa5A-Za-z0-9（）()·+\-]{2,60}(?:培养方案|教学计划))/)||i.match(/^(.{2,60}?)\s*主修为/)||i.match(/主修为\s*(.{2,60})$/),l=Ye(s&&s[1]);if(l&&!/GPA|已修读|尚不及格|本学期/.test(l)){let m=/培养方案|教学计划/.test(l);(!e.majorPlan||m)&&(e.majorPlan=l)}}}),e}a(gl,"extractAcademicOverview");async function jn(){let t={name:"",avatar:"",majorPlan:"",majorGpa:"",studentId:""};try{let r=document.querySelector("#navbar .user-info, .ace-nav .user-info, .user-info");if(r){let s=r.querySelector(".urppp-user-name-value"),l=s&&s.__urpppOriginalText;l&&(t.name=String(l).trim());let m=(r.innerText||r.textContent||"").replace(/\s+/g," ").trim(),h=t.name?null:m.match(/欢迎您[，,]\s*([\u4e00-\u9fa5·]{2,12})/);if(!t.name&&!h){let v=r.cloneNode(!0);v.querySelectorAll("small, i, img, b, .badge").forEach(N=>N.remove());let M=(v.textContent||"").replace(/\s+/g," ").trim();M=M.replace(/^欢迎您[，,]\s*/g,"").replace(/\d{8,}/g,"").trim(),h=M.match(/([\u4e00-\u9fa5·]{2,12})/)}h&&h[1]&&!/欢迎|同学|首页|反馈|密码|注销/.test(h[1])&&(t.name=h[1])}let o=document.querySelector("#navbar img.nav-user-photo, .ace-nav img.nav-user-photo");o&&(t.avatar=o.__urpppOriginalSrc||o.src||o.getAttribute("src")||"");let i=gl(document);t.majorPlan=i.majorPlan,t.majorGpa=i.majorGpa}catch{}try{let r=await Vt("/student/rollManagement/rollInfo/index"),o=Ur(r),i=o.body&&(o.body.innerText||o.body.textContent)||"";if(!t.name&&(t.name=Yr(o,["姓名"]),!t.name)){let h=i.match(/姓名\s*[：:]?\s*([\u4e00-\u9fa5·]{2,20})/);h&&(t.name=h[1].trim())}let s=Yr(o,["主修方案名称"]),l=Yr(o,["专业"]);t.studentId=Yr(o,["学号"]),s?t.majorPlan=Ye(s):!t.majorPlan&&l&&(t.majorPlan=Ye(l));let m=o.querySelector('.profile-picture img, img#avatar, img[src*="photo" i], img[src*="Photo"]');if(m&&m.getAttribute("src")&&!t.avatar){let h=m.getAttribute("src");t.avatar=/^https?:/i.test(h)?h:Ga(h)}}catch{}let e=Number(t.majorGpa);return t.name||(t.name="同学"),t.majorPlan||(t.majorPlan="主修方案"),(!Number.isFinite(e)||e<=0||e>5)&&(t.majorGpa="—"),t}a(jn,"loadProfile");let On=["周日","周一","周二","周三","周四","周五","周六"];function ro(t){let e=[],r=t.querySelector("#courseTableBody")||t.querySelector("#courseTable tbody");if(!r)return e;r.querySelectorAll("td[id]").forEach(i=>{let s=String(i.id||"").match(/^(\d+)_(\d+)$/);if(!s)return;let l=parseInt(s[1],10),m=parseInt(s[2],10),h=l===7?0:l,v=i.querySelectorAll('.class_div, .div_style, div[class*="div-kcb"]'),M=v.length?v:[];if(!M.length&&(i.textContent||"").trim()){let N=(i.textContent||"").replace(/\s+/g," ").trim();N&&e.push({name:N.slice(0,40),teacher:"",place:"",week:"",day:h,section:m});return}M.forEach(N=>{let z=Array.from(N.querySelectorAll("p")).map(K=>(K.textContent||"").trim()).filter(Boolean),D=(N.querySelector(".p-kcm-1, .p-kcm")||{}).textContent||z[0]||"",J=(N.querySelector('.p-jxl-1, [class*="jxl"]')||{}).textContent||"",j=z.find((K,ut)=>ut>0&&!/周|节/.test(K)&&K!==J)||"",R=z.find(K=>/周/.test(K))||"",F=String(D).replace(/_\d+\s*$/,"").trim();!F||F.length<2||e.push({name:F,teacher:String(j).trim(),place:String(J||"").trim(),week:String(R).trim(),day:h,section:m})})});let o=new Set;return e.filter(i=>{let s=[i.day,i.section,i.name,i.place].join("|");return o.has(s)?!1:(o.add(s),!0)})}a(ro,"parseScheduleFromDoc");let Hn="urppp_term_week_v1";function Qe(t){let e=Number(t)||0;if(e<1||e>30)return 0;nt._termWeek=e,nt._termWeekResolved=!0;try{GM_setValue(Hn,e)}catch{}return e}a(Qe,"rememberTermWeek");function br(){if(nt&&nt._termWeek>=1)return nt._termWeekResolved=!0,nt._termWeek;try{let t=Number(GM_getValue(Hn,0))||0;if(t>=1&&t<=30)return Qe(t)}catch{}return 0}a(br,"readRememberedTermWeek");function fr(t){let e=String(t||"").replace(/\s+/g," ");if(!e)return 0;let r=[/(?:\d{4}\s*[-–]\s*\d{4}).{0,40}?第\s*(\d{1,2})\s*周/,/20\d{2}.{0,40}?第\s*(\d{1,2})\s*周/,/(?:春|秋|夏|冬)\s*第\s*(\d{1,2})\s*周/,/第\s*(\d{1,2})\s*周\s*(?:星期|周[一二三四五六日天])/];for(let o=0;o<r.length;o++){let i=e.match(r[o]);if(i){let s=parseInt(i[1],10);if(s>=1&&s<=30)return s}}return 0}a(fr,"extractTermWeekFromText");function Le(){if(nt._termWeekResolved&&nt._termWeek>=1&&nt._termWeek<=30)return nt._termWeek;try{let t=[document.querySelector("#navbar"),document.querySelector(".navbar-fixed-top"),document.querySelector(".navbar"),document.querySelector("#navbar .navbar-header"),document.querySelector("#navbar .navbar-buttons"),document.querySelector(".ace-nav"),document.querySelector("#breadcrumbs"),document.querySelector("#page-content-header"),document.querySelector(".page-header"),document.querySelector("header")].filter(Boolean);for(let l=0;l<t.length;l++){let m=t[l],h=fr(m.innerText||m.textContent||"")||fr(m.innerHTML||"");if(h)return Qe(h)}let e=document.documentElement&&document.documentElement.innerHTML||"",r=fr(e);if(r)return Qe(r);let o=document.body&&document.body.innerText||"",i=fr(o);if(i)return Qe(i);let s=br();if(s)return s}catch{}return 0}a(Le,"getCurrentWeekNumber");let Xe=null;function xl(){let t=new Date,e=a(r=>String(r).padStart(2,"0"),"p");return`${t.getFullYear()}-${e(t.getMonth()+1)}-${e(t.getDate())}`}a(xl,"calTodayStr");function yl(t,e){let r=new Date(`${t}T00:00:00`);r.setDate(r.getDate()+e);let o=a(i=>String(i).padStart(2,"0"),"p");return`${r.getFullYear()}-${o(r.getMonth()+1)}-${o(r.getDate())}`}a(yl,"calAddDays");function gr(t){if(Xe)return Xe;let e=t||xl();return e>="2027-02-06"&&e<=yl("2027-02-06",6)?"springfestival":e>="2027-01-18"&&e<"2027-03-01"?"winter":e>="2027-07-04"&&e<"2027-08-31"||e>="2026-07-04"&&e<"2026-08-31"?"summer":"term"}a(gr,"calVacation");function vl(){let t='<svg viewBox="0 0 52 190"><path d="M26 0v16" stroke="#c8102e" stroke-width="3"/><rect x="16" y="16" width="20" height="8" rx="4" fill="#c8102e"/><ellipse cx="26" cy="62" rx="22" ry="30" fill="#e63946"/><path d="M26 26v72M14 34q12 12 0 24M38 34q-12 12 0 24" stroke="#ffd75e" stroke-width="1.4" fill="none"/><path d="M14 92h24M17 98h18M20 104h12" stroke="#ffd75e" stroke-width="2.4" stroke-linecap="round"/></svg>';return`<div id="urppp-festive-decor" aria-hidden="true"><div class="ufd ufd-left">${t}</div><div class="ufd ufd-right">${t}</div></div>`}a(vl,"festiveDecorHtml");function Rn(){let t=typeof document<"u"?document:null;if(!t)return;let e=gr()==="springfestival",r=t.getElementById("urppp-festive-decor");e&&!r?t.documentElement.insertAdjacentHTML("beforeend",vl()):!e&&r&&r.remove()}a(Rn,"syncFestiveDecor");function Un(t){Xe=t==="summer"||t==="winter"||t==="springfestival"||t==="term"?t:null,Xe&&Xe!=="term"&&(nt.weekLocked=!1,nt.viewWeek=0);try{Rn()}catch{}try{typeof Ze=="function"&&Ze()}catch{}return Xe}a(Un,"setCalendarPhase");function wl(){return gr()}a(wl,"getCalendarPhase");function Wn(){if(gr()!=="term")return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<0)&&(nt.viewWeek=0):nt.viewWeek=0,nt.viewWeek;let t=Le()||br()||0;return nt.weekLocked?(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=t>=1?t:1):t>=1?nt.viewWeek=t:(!nt.viewWeek||nt.viewWeek<1)&&(nt.viewWeek=1),!nt.weekLocked&&t>1&&nt.viewWeek===1&&(nt.viewWeek=t),nt.viewWeek}a(Wn,"getViewWeekNumber");async function kl(){let t=Le();if(t>=1)return t;try{let e=await Vt("/index");if(t=fr(e),t)return Qe(t)}catch{}try{let e=new Date,r=e.getFullYear()+"-"+String(e.getMonth()+1).padStart(2,"0")+"-"+String(e.getDate()).padStart(2,"0"),o="xqh=03&jxlh=302&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(r),i=await Vt("/student/teachingResources/classroomUseStatus/jasInfo",{method:"POST",data:o,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),s=JSON.parse(i),l=Number(s&&s.jxzc);if(l>=1&&l<=30)return Qe(l)}catch{}return br()||0}a(kl,"ensureTermWeekResolved");function Al(t){let e=Le()||20;return(t||[]).forEach(r=>{let o=String(r.classWeek||"");o.length>e&&(e=o.length);let i=String(r.week||"").match(/(\d{1,2})\s*[-~至到]\s*(\d{1,2})/);i&&(e=Math.max(e,parseInt(i[2],10)||0));let s=String(r.week||"").match(/\d{1,2}/g);s&&s.forEach(l=>{e=Math.max(e,parseInt(l,10)||0)})}),Math.min(Math.max(e,1),30)}a(Al,"inferMaxWeek");function Gn(t,e){if(!e||!t)return!1;let r=String(t);return r.length>=e?r.charAt(e-1)==="1":!1}a(Gn,"weekBitActive");let Jn=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#06B6D4","#EC4899","#84CC16","#F97316","#6366F1"];function Vn(t){let e=0,r=String(t||"");for(let o=0;o<r.length;o++)e=e*31+r.charCodeAt(o)>>>0;return Jn[e%Jn.length]}a(Vn,"courseColor");function Sl(t){let e=[],r=Le();(t&&t.xkxx||[]).forEach(s=>{Object.keys(s||{}).forEach(l=>{let m=s[l];if(!m)return;let h=m.courseName||m.englishCourseName||l,v=m.attendClassTeacher||"";(m.timeAndPlaceList||[]).forEach(N=>{let z=Number(N.classDay)||0,D=z===7?0:z,J=Number(N.classSessions)||1,j=Math.max(1,Number(N.continuingSession)||1),R=[N.campusName,N.teachingBuildingName,N.classroomName].filter(Boolean).join(""),F=N.weekDescription||m.skzcs||"",K=Gn(N.classWeek,r)||r&&F.indexOf(String(r))>=0;e.push({name:String(h).trim(),teacher:String(v).trim(),place:String(R).trim(),week:String(F).trim(),classWeek:String(N.classWeek||""),day:D,section:J,span:j,thisWeek:!!K,color:Vn(h)})})})});let i=new Set;return e.filter(s=>{let l=[s.day,s.section,s.span,s.name,s.place,s.week].join("|");return i.has(l)?!1:(i.add(l),!0)})}a(Sl,"parseScheduleFromJson");async function _l(){try{let t=await Vt("/student/courseSelect/thisSemesterCurriculum/ajaxStudentSchedule/callback"),e=[],r=null;try{r=JSON.parse(t);let i=Number(r&&(r.jxzc||r.zc||r.currentWeek));i>=1&&i<=30&&(nt._termWeek=Math.max(nt._termWeek||0,i),nt.weekLocked||(nt.viewWeek=nt._termWeek)),e=Sl(r)}catch{e=ro(Ur(t))}e.length||(e=ro(document));let o=r?In(r,ar(r),"clean"):null;return{courses:e,exportData:o,rawOk:e.length>0,error:e.length?"":"课表 JSON 无 timeAndPlaceList"}}catch(t){try{let e=ro(document);if(e.length)return{courses:e,rawOk:!0,error:""}}catch{}return{courses:[],rawOk:!1,error:String(t&&t.message||t)}}}a(_l,"loadSchedule");function El(t,e){let r=String(t||""),o=new RegExp(`url\\s*=\\s*["']([^"']*`+e+`[^"']*)["']`,"i"),i=r.match(o);if(i&&i[1])return i[1];let s=new RegExp(`(\\/student\\/integratedQuery\\/scoreQuery\\/[^"'\\s]+`+e+")","i"),l=r.match(s);return l?l[1]:""}a(El,"extractScoreCallback");function Cl(t){let e=[];return(t&&t.lnList||[]).forEach(o=>{let i=o.cjlx||o.cjbh||o.famc||o.zxjxjhh||"成绩",s=[];(o.cjList||[]).forEach(l=>{let m=l.courseName||l.englishCourseName||"";if(!m)return;let h=l.cj!=null&&l.cj!==""?String(l.cj):"";!h&&l.courseScore!=null&&(h=String(l.courseScore)),!h&&l.gradeName&&(h=String(l.gradeName)),!h&&l.zscj!=null&&(h=String(l.zscj));let v=l.courseAttributeName||l.xkcsxmc||"",M=parseFloat(l.credit)||0,N=l.id&&(l.id.courseNumber||l.id.kch_zj)||"",z=l.id&&(l.id.coureSequenceNumber||l.id.courseSequenceNumber||l.id.kxh)||l.classNo||"",D=l.gradePointScore!=null?Number(l.gradePointScore):null,J=ie(h)||ie(l.gradeName)||D!=null&&D<0,j=J?"未评估":h;s.push({code:N,seq:String(z||""),name:m,attr:v,credit:M,score:j,unevaluated:J,required:_n(v),officialGpa:Hr(D)?D:null,evalUrl:""})}),s.length&&e.push({title:String(i).slice(0,100),courses:s,summary:re(s),meta:{zxf:o.zxf,tgms:o.tgms,zms:o.zms,famc:o.famc}})}),e}a(Cl,"parseScoreJson");async function Yn(t,e){let r=await Vt(t),o=Qn(Ur(r));if(o.length)return o;let i=El(r,e);if(!i)return[];let s=await Vt(i);try{let l=JSON.parse(s);o=Cl(l).map(m=>(m.summary=re(m.courses),m))}catch{o=Qn(Ur(s))}return o}a(Yn,"loadScoreByIndex");function Qn(t){let e=[];return t.querySelectorAll("table").forEach(r=>{let o=Array.from(r.tHead&&r.tHead.rows[0]?r.tHead.rows[0].cells:r.rows[0]&&r.rows[0].cells||[]).map(M=>(M.textContent||"").replace(/\s+/g,""));if(!o.length)return;let i=o.join("|");if(!/课程名/.test(i)||!/成绩/.test(i))return;let s={code:o.findIndex(M=>M==="课程号"),name:o.findIndex(M=>M==="课程名"),attr:o.findIndex(M=>/课程属性|属性/.test(M)),credit:o.findIndex(M=>M==="学分"),score:o.findIndex(M=>M==="成绩")};if(s.name<0||s.score<0)return;let l="成绩",m=r.previousElementSibling;for(let M=0;M<8&&m;M++,m=m.previousElementSibling)if(/^H[1-4]$/.test(m.tagName)||m.classList&&m.classList.contains("header")){l=(m.textContent||"").replace(/\s+/g," ").trim();break}let h=[],v=r.tBodies.length?r.tBodies[0].rows:Array.from(r.rows).slice(1);Array.from(v).forEach(M=>{let N=Array.from(M.cells||M.querySelectorAll("td"));if(N.length<4)return;let z=a(F=>F>=0&&N[F]?(N[F].textContent||"").replace(/\s+/g," ").trim():"","get"),D=z(s.name),J=z(s.score);if(!D||!J||/课程名|序号/.test(D))return;let j=z(s.attr),R=ie(J);h.push({code:z(s.code),name:D,attr:j,credit:parseFloat(z(s.credit))||0,score:R?"未评估":J,unevaluated:R,required:_n(j),officialGpa:null,evalUrl:""})}),h.length&&e.push({title:l.slice(0,100),courses:h,summary:re(h)})}),e}a(Qn,"parseScoreTables");function xr(t){return Ye(t&&t.meta&&t.meta.famc||t&&t.title||"")}a(xr,"schemePlanName");function Xn(t,e){if(!t||!t.length)return 0;let r=Ye(e),o=t.findIndex(l=>{let m=xr(l);return/培养方案/.test(m)&&!/微专业|辅修|双学位/.test(m)});if(o>=0&&(!r||xr(t[o]).includes(r.slice(0,4)))||r&&(o=t.findIndex(l=>{let m=xr(l);return m.includes(r.replace(/培养方案.*/,"培养方案"))||r.includes(m.slice(0,4))||m.includes(r.slice(0,4))}),o>=0))return o;let i=0,s=-1;return t.forEach((l,m)=>{if(/微专业|辅修/.test(xr(l)))return;let h=(l.courses||[]).length;h>s&&(s=h,i=m)}),i}a(Xn,"pickMajorSchemeIndex");async function Pl(){let t={};try{let e=await Vt("/student/teachingAssessment/evaluation/queryAll",{method:"POST",data:"pageNum=1&pageSize=200&flag=kt",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"}}),r;try{r=JSON.parse(e)}catch{r=null}(r&&r.data&&r.data.records||[]).forEach(i=>{let s=String(i.KCH||"").trim();if(!s)return;let l=String(i.SFPG)==="1",m=String(i.KTID||"").trim();if(!t[s]){t[s]={ktid:m,kxh:String(i.KXH||""),kcm:i.KCM||"",done:l,pending:l?0:1,total:1,url:!l&&m?"/student/teachingEvaluation/newEvaluation/evaluation/"+m:"/student/teachingEvaluation/newEvaluation/index"};return}t[s].total+=1,l||(t[s].pending+=1,t[s].done=!1,m&&(t[s].ktid=m,t[s].url="/student/teachingEvaluation/newEvaluation/evaluation/"+m))}),Object.keys(t).forEach(i=>{let s=t[i];s.done=!(s.pending>0)})}catch(e){console.warn("[URP++] evaluation map",e)}return t}a(Pl,"loadEvaluationMap");function zl(t){if(!t)return!1;if(t.officialGpa!=null&&Hr(t.officialGpa))return!0;let e=t.score;return e==null||e===""||ie(e)?!1:Je(e)!=null||Ge(e)!=null?!0:!/未评估|未评教|待评估|待评教/.test(String(e))}a(zl,"hasDisplayableScore");function Ll(t,e){if(!t||!e)return t;let r=a(o=>(o||[]).forEach(i=>{if(!i||!i.code)return;let s=e[i.code];if(s){if(zl(i)){i.unevaluated=!1,s.done?i.evalUrl=i.evalUrl||"":i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index";return}s.done||(i.unevaluated=!0,i.evalUrl=s.url||"/student/teachingEvaluation/newEvaluation/index",(!i.score||i.score===""||ie(i.score))&&(i.score="未评估"))}}),"apply");return(t.passing||[]).forEach(o=>r(o.courses)),(t.schemes||[]).forEach(o=>r(o.courses)),t}a(Ll,"attachEvaluationLinks");function Kn(t){return t&&(t.passing&&t.passing[0]&&(t.passing[0].summary=re(t.passing[0].courses)),t.schemes=(t.schemes||[]).map(e=>(e.summary=re(e.courses),e)),t)}a(Kn,"refreshScoreSummaries");async function ql(t){if(!t||t.evaluationLoading)return t;t.evaluationLoading=!0;try{let e=await Pl();return Ll(t,e),t.evalMap=e,t.evaluationReady=!0,Kn(t)}finally{t.evaluationLoading=!1}}a(ql,"enrichScoresWithEvaluation");function Tl(){if(!nt.scores||!nt.scores.schemes)return;let t=nt.scores.schemes,e=nt.profile&&nt.profile.majorPlan,r=Xn(t,e);nt.scores.majorIdx=r,nt._schemeUserSelected||(nt.activeSchemeIdx=r,nt._schemeInited=!0);let o=t[r];if(!o||!nt.profile)return;let i=xr(o),s=Ye(nt.profile.majorPlan);/培养方案|教学计划/.test(i)&&(!/培养方案|教学计划/.test(s)||s==="主修方案")&&(nt.profile.majorPlan=i);let l=o.summary||{},m=Number(l.requiredCredit),h=Number(l.requiredGpa),v=Number(nt.profile.majorGpa);m>0&&Number.isFinite(h)&&h>=0&&h<=5&&(!Number.isFinite(v)||v<=0)&&(nt.profile.majorGpa=String(Pe(h)))}a(Tl,"reconcileProfileAndScores");let Ke=null;async function Zn(t){return t&&(Ke=null),Ke&&!Ke.error||(Ke=await Ml()),Ke}a(Zn,"loadScores");async function Ml(){let t={passing:[],schemes:[],error:"",majorIdx:0,evaluationReady:!1,evaluationLoading:!1};try{let[e,r]=await Promise.all([Yn("/student/integratedQuery/scoreQuery/allPassingScores/index","allPassingScores/callback"),Yn("/student/integratedQuery/scoreQuery/schemeScores/index","schemeScores/callback")]),o=[];e.forEach(i=>i.courses.forEach(s=>{o.push(Object.assign({term:i.title},s))})),t.passing=[{title:"全部及格成绩",courses:o,summary:re(o),groups:e}],t.schemes=r,!t.schemes.length&&o.length&&(t.schemes=[{title:"方案成绩",courses:o,summary:re(o)}]),Kn(t),t.majorIdx=Xn(t.schemes,nt.profile&&nt.profile.majorPlan),!o.length&&!t.schemes.length&&(t.error="成绩 callback 无数据")}catch(e){t.error=String(e&&e.message||e)}return t}a(Ml,"loadScoresImpl");function qe(t){if(!t)return[];let e=String(t).trim();if(!e)return[];e=e.replace(/^['"]|['"]$/g,"");try{return JSON.parse(e)}catch{}try{return JSON.parse(e.replace(/&quot;/g,'"').replace(/&#34;/g,'"'))}catch{}return[]}a(qe,"parseJsonArrayLoose");function tp(t,e){let r=t.indexOf(e);if(r<0)return"";let o=t.indexOf("[",r);if(o<0)return"";let i=0;for(let s=o;s<t.length&&s<o+3e5;s++){let l=t[s];if(l==="[")i++;else if(l==="]"&&(i--,i===0))return t.slice(o,s+1)}return""}a(tp,"extractBalancedArray");async function $l(){let t=await Vt("/student/teachingResources/classroomUseStatus/index");if(/欢迎登录|name=["']j_username["']|loginEn/i.test(t)&&!/jxlList|teachingBuildingName|classroomUseStatus/i.test(t))throw new Error("登录已失效，请刷新页面后重试");let e=[],r=[];try{let s=(t.match(/id=["']xqList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']xqList["'][^>]*value=["']([^"']*)["']/i)||[])[1],l=(t.match(/id=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||t.match(/name=["']jxlList["'][^>]*value=["']([^"']*)["']/i)||[])[1];if(s&&(e=qe(s)),l&&(r=qe(l)),!e.length){let m=t.match(/(?:var\s+)?xqList\s*=\s*(\[[\s\S]*?\])\s*;/);m&&(e=qe(m[1]))}if(!r.length){let m=t.match(/(?:var\s+)?jxlList\s*=\s*(\[[\s\S]*?\])\s*;/);m&&(r=qe(m[1]))}if(!r.length){let m=tp(t,"teachingBuildingName");m&&(r=qe(m))}if(!e.length){let m=tp(t,"campusName");m&&(e=qe(m))}}catch(s){console.warn("[URP++] classroom json parse",s)}if(!r.length){let s=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}];e=s;let l=[];for(let m of s)try{let h=await Vt("/student/teachingResources/classroomCurriculum/"+m.campusNumber+"/teachingBuildingJson");qe(h).forEach(M=>{l.push({id:{campusNumber:m.campusNumber,teachingBuildingNumber:String(M.id&&M.id.teachingBuildingNumber||M.teachingBuildingNumber||"")},teachingBuildingName:M.teachingBuildingName||M.name||""})})}catch(h){console.warn("[URP++] building json",m.campusNumber,h)}r=l}e.length||(e=[{campusNumber:"01",campusName:"望江"},{campusNumber:"02",campusName:"华西"},{campusNumber:"03",campusName:"江安"}]);let o=e.map(s=>({campus:s.campusName||s.campusNumber,campusNumber:String(s.campusNumber||s.id&&s.id.campusNumber||""),buildings:[]}));r.forEach(s=>{let l=String(s.id&&s.id.campusNumber||s.campusNumber||""),m=String(s.id&&s.id.teachingBuildingNumber||s.teachingBuildingNumber||""),h=s.teachingBuildingName||s.name||m;if(!l||!m||!h)return;let v=o.find(N=>N.campusNumber===l);v||(v={campus:l,campusNumber:l,buildings:[]},o.push(v));let M="/student/teachingResources/classroomUseStatus/"+l+"/"+m+"/"+encodeURI(encodeURI(v.campus||l))+"/"+encodeURI(encodeURI(h));v.buildings.push({name:h,path:M,campusNumber:l,buildingNumber:m})});let i=o.filter(s=>s.buildings.length);if(!i.length)throw new Error("未解析到教学楼，请刷新后重试");return i}a($l,"loadClassroomCatalog");function yr(t){let e=String(t&&t.occupancymoduleId||""),r={"06":"有课","07":"考试",14:"实验",room:"借用"};if(r[e])return r[e];if(t&&t.remark){let o=String(t.remark).trim();if(o)return o}return"占用"}a(yr,"occupancyTypeLabel");function Il(t){if(t&&t.contentName)return String(t.contentName).trim();if(t&&t.remark){let e=String(t.remark).trim();if(e)return e}return yr(t)}a(Il,"occupancyReason");async function Nl(t,e,r,o){let i=new URLSearchParams({planNumber:String(t||""),campusNumber:String(e||""),teachingBuildingNumber:String(r||""),classroomNumber:String(o||"")}),s=await Vt("/student/teachingResources/classroomCurriculum/searchCurriculum/callback?"+i.toString());try{let l=JSON.parse(s);return Array.isArray(l)?l.length&&Array.isArray(l[0])?l[0]:l.filter(m=>m&&typeof m=="object"&&(m.kcm||m.id&&m.id.kch)):l&&Array.isArray(l.list)?l.list:[]}catch{return[]}}a(Nl,"fetchClassroomCurriculum");function Bl(t,e,r){let o=t||[],i=Number(e.xq)||0,s=Number(e.start)||0,l=Number(r)||0,m=[];return o.forEach(h=>{let v=h.id||{},M=Number(v.skxq!=null?v.skxq:h.skxq)||0,N=Number(v.skjc!=null?v.skjc:h.skjc)||0,z=Math.max(1,Number(h.cxjc)||1),D=v.skzc||h.skzc||"";i&&M&&i!==M||s&&(s<N||s>=N+z)||l&&D&&!Wa(D,l)||m.push(h)}),m.length?(m.sort((h,v)=>{let M=Wa(h.id&&h.id.skzc||h.skzc,l)?0:1,N=Wa(v.id&&v.id.skzc||v.skzc,l)?0:1;return M-N}),m[0]):null}a(Bl,"matchCurriculumCourse");async function Fl(t,e,r){if(!t||!t.rooms||!t.rooms.length)return t;let o=String(e.campusNumber||""),i=String(e.buildingNumber||""),s=r||t.planNumber||"";if(!o||!i||!s)return t;let l=t.rooms.filter(z=>(z.slots||[]).some(D=>D.busy)),m={},h=a(async z=>{if(m[z])return m[z];try{m[z]=await Nl(s,o,i,z)}catch{m[z]=[]}return m[z]},"queue"),v=4,M=0,N=new Array(Math.min(v,Math.max(l.length,1))).fill(0).map(async()=>{for(;M<l.length;){let z=M++,D=l[z],J=await h(D.name);(D.slots||[]).forEach(j=>{if(!j.busy)return;let R={xq:j.detail&&j.detail.xq||j.xq||0,start:j.section,week:t.jxzc};j.detail&&j.detail.xq!=null&&(R.xq=j.detail.xq);let F=Bl(J,R,t.jxzc);if(F&&F.kcm){let K=String(F.kcm).trim();j.contentName=K,j.reason=K,j.displayChar=Rr(K),j.detail&&(j.detail.contentName=K,j.detail.reason=K,j.detail.teacher=F.jsm||"",j.detail.weeks=F.zcsm||"",j.detail.courseNo=F.id&&F.id.kch||"",j.detail.typeLabel=yr({occupancymoduleId:j.module}))}else j.displayChar=Rr(j.reason||"占用"),j.detail&&(j.detail.typeLabel=yr({occupancymoduleId:j.module}))})}});return await Promise.all(N),t}a(Fl,"enrichOccupancyWithCurriculum");function Dl(t){return t==="有课"?"kind-course":t==="考试"?"kind-exam":t==="实验"?"kind-lab":t==="借用"?"kind-borrow":"kind-busy"}a(Dl,"occupancyKindClass");async function jl(t){let e="",r="",o="",i="";if(t&&typeof t=="object")e=String(t.campusNumber||""),r=String(t.buildingNumber||""),o=t.name||"",i=t.path||"";else{i=String(t||"");let F=i.match(/classroomUseStatus\/(\d+)\/(\d+)\//);F&&(e=F[1],r=F[2])}if(!e||!r)throw new Error("缺少校区/楼栋编号");let s=Number(t&&t.dateOffset!=null?t.dateOffset:nt.roomDateOffset)||0,l=Ol(ep(new Date,s)),m="xqh="+encodeURIComponent(e)+"&jxlh="+encodeURIComponent(r)+"&jslx=&jasm=&zwFrom=&zwTo=&searchDate="+encodeURIComponent(l),h=await new Promise((F,K)=>{let ut=Ga("/student/teachingResources/classroomUseStatus/jasInfo");typeof GM_xmlhttpRequest=="function"?GM_xmlhttpRequest({method:"POST",url:ut,data:m,withCredentials:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},onload:a(vt=>vt.status>=200&&vt.status<400?F(vt.responseText||""):K(new Error("HTTP "+vt.status)),"onload"),onerror:a(()=>K(new Error("network")),"onerror")}):fetch(ut,{method:"POST",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-Requested-With":"XMLHttpRequest"},body:m}).then(vt=>vt.text()).then(F).catch(K)}),v;try{v=JSON.parse(h)}catch{throw new Error("jasInfo 非 JSON")}let M=(v.classrooms||[]).map(F=>{let K=F.classroomName||F.id&&F.id.classroomNumber||"",ut=F.placeNum||"",vt=F.remark||"",Et=[];for(let Lt=1;Lt<=12;Lt++)Et.push({section:Lt,busy:!1});return{name:K,seats:ut,type:vt,slots:Et,map:{}}}),N={};M.forEach(F=>{N[F.name]=F}),(v.classroomTime||[]).forEach(F=>{let K=F.id||{},ut=K.classroomNumber||"",vt=Number(K.sessionstart)||1,Et=Math.max(1,Number(F.continuingsession)||1),Lt=N[ut];if(!Lt)return;let qt=yr(F),Ot=Il(F);for(let Ht=vt;Ht<vt+Et&&Ht<=12;Ht++){let Mt=Lt.slots.find(ae=>ae.section===Ht);Mt&&(Mt.busy=!0,Mt.kind=F.timestatenumber||F.occupancymoduleId||"",Mt.module=F.occupancymoduleId||"",Mt.reason=Ot,Mt.typeLabel=qt,Mt.displayChar=Rr(Ot),Mt.xq=K.xq,Mt.weekBitmap=K.week||"",Mt.detail={room:ut,section:Ht,start:vt,span:Et,reason:Ot,typeLabel:qt,week:K.week||"",xq:K.xq||"",state:F.timestatenumber||"",module:F.occupancymoduleId||""})}});let z="";try{let F=v.jhZxjxjhb;typeof F=="string"&&/\d{4}-\d{4}-\d-\d/.test(F)?z=F:F&&typeof F=="object"&&(z=String(F.zxjxjhh||F.jhxnxq||F.executiveEducationPlanNumber||F.planNumber||""))}catch{}if(!z&&v.classrooms&&v.classrooms[0]&&v.classrooms[0].id&&(z=v.classrooms[0].id.executiveEducationPlanNumber||""),v.jxzc!=null&&Number(v.jxzc)>=1){let F=Number(v.jxzc);nt._termWeek=Math.max(nt._termWeek||0,F),nt.weekLocked||(nt.viewWeek=nt._termWeek)}let D=["日","一","二","三","四","五","六"],J=Hl(v.date||l)||ep(new Date,s),j=v.week!=null?Number(v.week):J.getDay(),R=s===1?"明天":s===2?"后天":"今天";return{rooms:M,dateLabel:(v.date||l)+"（周"+(D[j]||j)+" · "+R+"）",jxzc:v.jxzc,planNumber:z,week:v.week!=null?v.week:j,searchDate:v.date||l,dateOffset:s}}a(jl,"loadBuildingOccupancy");function ep(t,e){let r=new Date(t.getFullYear(),t.getMonth(),t.getDate());return r.setDate(r.getDate()+(Number(e)||0)),r}a(ep,"addDays");function Ol(t){return t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")}a(Ol,"formatLocalDate");function Hl(t){let e=String(t||"").match(/(\d{4})-(\d{1,2})-(\d{1,2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}a(Hl,"parseLocalDate");let rp={clean:'<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M4 7h16M4 12h11M4 17h14"/></svg>',exit:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 6H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/><path d="M14 12H8"/><path d="m14 8 4 4-4 4"/></svg>',refresh:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M20 12a8 8 0 1 1-2.2-5.5"/><path d="M20 4v5h-5"/></svg>',schedule:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 10h17M8 3.5v4M16 3.5v4"/></svg>',score:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h10v17H7z"/><path d="M10 8h4M10 12h4M10 16h3"/></svg>',room:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 20V8l8-4 8 4v12"/><path d="M9 20v-7h6v7"/><path d="M9 10h.01M15 10h.01"/></svg>',eval:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M8 7h11M8 12h11M8 17h8"/><path d="M5 7h.01M5 12h.01M5 17h.01"/></svg>',plan:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M7 3.5h8l3 3V20.5H7z"/><path d="M15 3.5V7h3M10 12h5M10 16h5"/></svg>',apply:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="6" y="3.5" width="12" height="17" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>',home:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="m4 11 8-7 8 7"/><path d="M7 10.5V20h10v-9.5"/></svg>',more:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="6" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="18" cy="12" r="1.6"/></svg>',close:'<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg>'};function ap(t){return rp[t]||rp.more}a(ap,"ico");let nt=mi();function Rl(){if(document.getElementById("urppp-clean-style"))return;let t=document.createElement("style");t.id="urppp-clean-style",t.textContent=li,(document.head||document.documentElement).appendChild(t)}a(Rl,"ensureStyle");let Ul=sa({deps:{scoreToNumber:Je,scoreToGpa:Ge}}),{metricHtml:Wl,occupancyHtml:Gl,render:Ze,renderScheduleBoard:Oc,roomPickerHtml:Jl,scheduleRender:Vl}=_i({state:nt,deps:{DIRECT_EDIT_LABELS:U,DAY_NAMES:On,analyzeScores:a(t=>Ul.analyzeScores(t),"analyzeScores"),applyPersonalDisplay:Yt,bandsChartSvg:ca,bindUI:a(t=>Ql(t),"bindUI"),classifyPrivacyLabel:Wr,courseColor:Vn,ensureRoot:a(()=>np(),"ensureRoot"),escapeHtml:at,firstContentChar:Rr,getViewWeekNumber:Wn,ico:ap,isCleanAnalysisDirect:ha,occupancyKindClass:Dl,occupancyTypeLabel:yr,personalizedProfile:Xs,scoreChartLayout:a(()=>{try{return window.matchMedia&&window.matchMedia("(max-width: 900px)").matches?{variant:"mobile"}:null}catch{return null}},"scoreChartLayout"),scoreToNumber:Je,summarizeCourses:re,trendChartSvg:la,weekBitActive:Gn,calVacation:gr,setCalendarPhase:Un}}),{ensureRoomCatalogLoaded:op,loadAll:Yl}=bi({state:nt,deps:{ensureTermWeekResolved:kl,enrichScoresWithEvaluation:ql,getCurrentWeekNumber:Le,loadClassroomCatalog:$l,loadProfile:jn,loadSchedule:_l,loadScores:Zn,readRememberedTermWeek:br,reconcileProfileAndScores:Tl,render:Ze,scheduleRender:Vl}}),{bindUI:Ql,closeModal:Xl,getRoomHost:Hc,openModal:Rc,openRoomModal:Uc,openScoreModal:Wc,showBuilding:Gc}=Ei({state:nt,deps:{DAY_NAMES:On,applyPersonalDisplay:Yt,bindScheduleExportHosts:fl,closeCleanMode:a(()=>Zl(),"closeCleanMode"),ensureRoomCatalogLoaded:op,enrichOccupancyWithCurriculum:Fl,ensureRoot:a(()=>np(),"ensureRoot"),escapeHtml:at,fetchText:Vt,getCurrentWeekNumber:Le,getViewWeekNumber:Wn,inferMaxWeek:Al,isUnevaluatedScore:ie,isValidOfficialGpa:Hr,loadBuildingOccupancy:jl,metricHtml:Wl,occupancyHtml:Gl,render:Ze,rootEl:a(()=>tc(),"rootEl"),roomPickerHtml:Jl,scoreToGpa:Ge,scoreToNumber:Je,summarizeCourses:re,summarizeCoursesPreferOfficial:re}}),{cleanModeApi:Kl,closeCleanMode:Zl,ensureRoot:np,injectCleanEntry:Jc,openCleanMode:Vc,rootEl:tc}=Ci({state:nt,deps:{CLEAN_FLAG:Is,applySkinAttr:ee,closeModal:Xl,ensureRoomCatalogLoaded:op,ensureStyle:Rl,getCurrentWeekNumber:Le,getSkin:Zt,handleThemeDotClick:ct,ico:ap,injectCleanSidebarSections:a(t=>{try{window.__urpppInjectCleanSidebarSections?.(t)}catch{}},"injectCleanSidebarSections"),refreshMobileNavbar:a(()=>{try{window.__urpppRefreshMobileNavbar?.()}catch{}},"refreshMobileNavbar"),setDrawerOpen:a((t,e,r)=>{try{window.__urpppSetDrawerOpen?.(t,e,r)}catch{}},"setDrawerOpen"),stopDrawerAnimation:a(t=>{try{window.__urpppStopDrawerAnimation?.(t)}catch{}},"stopDrawerAnimation"),isHomePage:Eo,loadAll:Yl,openSettingsPanel:rn,readRememberedTermWeek:br,refreshCleanPersonalDisplay:Va,render:Ze,scoreToGpa:Ge,summarizeCourses:re,syncNavbarThemeUI:gt,syncSettingsPanelUI:Dt,syncThemeDotGroup:Z}});window.__urpppCleanMode=Kl;function ao(){if(!document.body){setTimeout(ao,10);return}if(Po(),Wt(Jt()),setTimeout(()=>{try{fe().then(e=>Se(e))}catch{}},0),document.addEventListener("focusin",e=>{let r=e.target;if(!r||!r.matches||!r.matches(".chosen-search input"))return;let o=[],i=r.parentElement;for(;i;){let s=i.scrollTop,l=i.scrollLeft;(s||l||i.scrollHeight>i.clientHeight||i.scrollWidth>i.clientWidth)&&o.push({el:i,top:s,left:l}),i=i.parentElement}requestAnimationFrame(()=>{o.forEach(s=>{s.el.scrollTop=s.top,s.el.scrollLeft=s.left})})},!0),!!document.getElementById("formContent")&&!!document.querySelector(".form-signin"))$o();else{ps();try{En()}catch{}try{Vr()}catch(e){console.warn("[URP++] route feature refresh",e)}try{Yt(document)}catch{}try{Rn()}catch{}[350,900,1800].forEach(e=>setTimeout(()=>{try{Vr()}catch{}try{Yt(document)}catch{}},e));try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}[400,1200,2500].forEach(e=>setTimeout(()=>{try{window.__urpppCleanMode&&window.__urpppCleanMode.inject()}catch{}},e));try{ma()&&Eo()&&window.__urpppCleanMode&&setTimeout(()=>{try{window.__urpppCleanMode.open(!1)}catch{}},700)}catch{}}}if(a(ao,"init"),!window.__urpppSidebarSyncBound){window.__urpppSidebarSyncBound=!0,window.addEventListener("resize",()=>{clearTimeout(window.__urpppSidebarSyncTimer),window.__urpppSidebarSyncTimer=setTimeout(Ce,50)}),window.addEventListener("load",()=>{Ce(),We(),setTimeout(Ce,100),setTimeout(Ce,400)}),document.addEventListener("click",e=>{e.target&&e.target.closest&&e.target.closest("#menu-toggler, .menu-toggler, .navbar-toggle, .urppp-sidebar-toggle, .sidebar-collapse, #sidebar-collapse")&&(setTimeout(We,0),setTimeout(We,50),setTimeout(We,200))},!0);let t=document.getElementById("sidebar");t&&!t.__urpppMarginObs&&(t.__urpppMarginObs=new MutationObserver(()=>{clearTimeout(window.__urpppMarginObsTimer),window.__urpppMarginObsTimer=setTimeout(We,30)}),t.__urpppMarginObs.observe(t,{attributes:!0,attributeFilter:["class","style"]}))}function pp(){if(window.__urpppRouteWatchBound)return;window.__urpppRouteWatchBound=!0;let t=0,e=a(()=>{try{let i=!!(window.matchMedia&&window.matchMedia("(max-width: 640px)").matches),s=!!(document.getElementById("urppp-clean-root")&&document.getElementById("urppp-clean-root").classList.contains("open"));i&&!s&&window.__urpppCloseMobileDrawer&&window.__urpppCloseMobileDrawer()}catch{}clearTimeout(t),t=setTimeout(()=>{if(nt._termWeekResolved=!1,!!document.getElementById("sidebar")){Ce(),Sn(),st(),Ce();try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}dt(),[250,700].forEach(s=>setTimeout(()=>{try{window.__urpppRefreshMobileNavbar&&window.__urpppRefreshMobileNavbar()}catch{}},s)),Ea(),Ko(),Zo(),Uo(),tn(),Xo(),Go(),document.querySelectorAll(".page-content, #page-content-template").forEach(s=>{let l=!!(window.matchMedia&&window.matchMedia("(max-width: 991px)").matches);s.style.setProperty("padding",l?"8px 8px 24px":"16px 64px 40px","important"),s.style.setProperty("box-sizing","border-box","important")}),$r(),Br(),je(),setTimeout(je,300),setTimeout(je,1e3),Fo(),be(),sr(),Oo(),setTimeout(sr,300),lr(),setTimeout(()=>lr(),500),Mr(),jo();try{Vr()}catch{}try{Yt(document)}catch{}setTimeout(()=>{try{Vr()}catch{}try{Yt(document)}catch{}},500)}},100)},"run");window.addEventListener("popstate",e),window.addEventListener("hashchange",e);let r=history.pushState,o=history.replaceState;history.pushState=function(...i){let s=r.apply(this,i);return e(),s},history.replaceState=function(...i){let s=o.apply(this,i);return e(),s}}a(pp,"watchRouteChanges");let tr=typeof unsafeWindow<"u"?unsafeWindow:window;tr.__urpppDebug=tr.__urpppDebug||{},tr.__urpppDebug.setCalendarPhase=t=>Un(t),tr.__urpppDebug.getCalendarPhase=()=>wl(),tr.__urpppDebug.calVacation=t=>gr(t),tr.urppp={version:p,showLogo(t){let e=document.querySelector("#urppp-brand .ub-logo");e&&e.classList.toggle("show",t)},theme:{apply:a(t=>{Wt(t)},"apply"),setAccent:ji,getAccent:Qt,getCurrent:Jt,list:a(()=>Object.entries(Ct).map(([t,e])=>({name:t,displayName:e.name,current:t===Jt()})),"list")},update:{check:Ra,auto:Ha,showToast:Oa},privacy:{get:ke,set(t){return fa(t),Yt(document),ke()},apply:a(()=>Yt(document),"apply"),identity:{get:Ne,set(t){return Ao(t),Yt(document),Va(),Ne()}}},scheduleExport:{load:a(()=>Mn("api"),"load"),run:a(t=>il(t,"api",null,null),"run"),patch:to,image:{theme:Nn,build:a((t,e)=>Bn(t,e),"build")},jsonFormat:{get:qr,set:_o,validate:Me,build(t,e){let r=Zr(t);if(e)return ea(r,Me(e));let o=qr();return o.enabled?ea(r,o.mapping):ta(r)},buildDefault(t){return ta(Zr(t))}}}};function ip(){setTimeout(()=>{try{Ha()}catch{}},1800)}a(ip,"scheduleAutoUpdateCheck");try{Po()}catch{}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{ao(),pp(),ip()}):(ao(),pp(),ip())})();})();
