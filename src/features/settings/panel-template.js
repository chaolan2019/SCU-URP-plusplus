...
export function buildSettingsPanelHtml(options) {
  ...
  return [
    ...
    '          <div class="urppp-feature-row"><label><input type="checkbox" id="urppp-set-avatar-enabled"> 自定义头像</label><span class="urppp-avatar-input-group"><input class="urppp-feature-input" id="urppp-set-custom-avatar-url" placeholder="网络图片地址"><label class="urppp-avatar-file-btn" for="urppp-set-custom-avatar-file" role="button" tabindex="0">选择文件</label></span><input class="urppp-avatar-file-hidden" type="file" id="urppp-set-custom-avatar-file" accept="image/png,image/jpeg,image/webp,image/gif"></div>',
    '        </div>',
